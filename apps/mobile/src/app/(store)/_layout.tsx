 ...
 * ## Not open yet
 *
 * While `STORE_OPEN` is false the admin Home tile never routes here — it puts
 * up the "coming soon" alert in place, so the shop is not mounted, fetched and
 * then covered just to be left again.
 */
