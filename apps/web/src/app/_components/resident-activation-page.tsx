  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-[#0f172a] font-sans flex flex-col justify-between">
      ...
      <header className="bg-white border-b border-slate-100 shadow-sm sticky top-0 z-50">
        <div className="max-w-[1360px] mx-auto px-4 md:px-8 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 h-full text-sm font-semibold text-slate-500">
            <Link href="/resident/dashboard" className="hover:text-[#0A8A4B] transition flex items-center h-full">
              Dashboard
            </Link>
            <Link href="/resident/profile" className="hover:text-[#0A8A4B] transition flex items-center h-full">
              My Profile
            </Link>
            <Link href="/resident/room-bed" className="hover:text-[#0A8A4B] transition flex items-center h-full">
              My Stays
            </Link>
          ...
          <div className="flex items-center gap-4">
            <button className="relative p-2 text-slate-400 hover:text-slate-600 transition" aria-label="Notifications">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="hidden sm:block text-left">
                <p className="text-xs font-bold text-[#0F172A] leading-tight">Suman Thapa</p>
      ...
      <main className="flex-1 max-w-[1360px] mx-auto w-full px-4 md:px-8 py-8">
        ...
        {/* Title Block */}
        <div className="mb-6">
          <h1 className="font-heading text-3xl font-extrabold text-[#0F172A]">Resident Activation</h1>
          <p className="text-sm text-slate-450 mt-1 max-w-3xl">
            Enter the code generated by your hostel admin to link your account to your hostel bed.
          </p>
        </div>
            ...
            {activated ? (
              <div className="py-12 flex flex-col items-center justify-center text-center space-y-6 animate-in fade-in duration-300">
                ...
                <div className="space-y-2">
                  <h3 className="font-heading text-2xl font-extrabold text-[#0F172A]">Activation complete</h3>
                  <p className="text-sm text-slate-450 max-w-md mx-auto leading-relaxed">
                    Your resident access is now fully activated. You are successfully linked to Room 101, Bed 101-A at Green View Hostel.
                  </p>
                </div>
                <Link
                ...
                {activeTab === "qr" ? (
                  <div className="py-10 text-center space-y-3">
                    ...
                    <p className="text-xs text-slate-450 max-w-[285px] mx-auto leading-relaxed">
                      Please use the camera scan box on the right of this page, or align your device QR code to complete scanning automatically.
                    </p>
                    <button
                      onClick={() => setActiveTab("code")}
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-col sm:flex-row gap-4 p-4 rounded-2xl border border-slate-100 bg-slate-50/50">
                        <div 
                          ...
                          style={{
                            backgroundImage: 'url("https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?auto=format&fit=crop&w=300&q=80")'
                          }}
                        />
                        <div className="space-y-1">
                          <div className="flex items-center gap-1.5">
                            <h4 className="text-sm font-bold text-[#0F172A]">Green View Hostel</h4>
                            <span className="flex items-center justify-center size-3.5 bg-[#0A8A4B] text-white rounded-full">
                              <Check className="size-2.5 stroke-[3]" />
                            </span>
                            <span className="text-[10px] font-semibold text-[#0A8A4B]">Verified</span>
                          </div>
                          ...
                          <p className="text-[11px] text-slate-500 font-medium">
                            Access Type: <span className="font-bold text-[#0F172A]">Resident Access (Standard Room)</span>
                          </p>
                          <p className="text-[11px] text-slate-500 font-medium">
                            Valid for: <span className="font-bold text-[#0F172A]">Academic Year 2026-2027</span>
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-4 p-4 rounded-2xl border border-slate-100 bg-slate-50/50">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-x-4 gap-y-1.5 flex-1 min-w-0">
                          <div>
                            <span className="block text-[9px] text-slate-400 uppercase tracking-wider">Full Name</span>
                            <span className="text-xs font-bold text-[#0F172A] block truncate">Suman Thapa</span>
                          </div>
                          <div>
                            <span className="block text-[9px] text-slate-400 uppercase tracking-wider">Email</span>
                            <span className="text-xs font-bold text-[#0F172A] block truncate">sumanthapa@gmail.com</span>
                          </div>
                          <div>
                            <span className="block text-[9px] text-slate-400 uppercase tracking-wider">Phone</span>
                            <span className="text-xs font-bold text-[#0F172A] block truncate">+977 9801234567</span>
                          </div>
                          <div>
                            <span className="block text-[9px] text-slate-400 uppercase tracking-wider">Room & Bed</span>
                            <span className="text-xs font-bold text-[#0F172A] block truncate">Room 101, Bed 101-A</span>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div className="p-6 md:p-8 bg-[#EAF6F3]/30 flex flex-col justify-between space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="relative flex flex-col items-center justify-center p-6 border-2 border-dashed border-slate-200 rounded-2xl bg-white select-none">
                ...
                <p className="text-[11px] font-bold text-[#0f172a] mt-3">Scan activation QR</p>
            ...
            {/* Code status info */}
            <div className="space-y-3">
              <h3 className="text-sm font-bold text-[#0F172A]">Activation Code Status</h3>
              <div className="space-y-2">
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-slate-450 leading-relaxed">The code is ready to be linked to your account.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-slate-450 leading-relaxed">This code has already been linked to a resident account.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-slate-450 leading-relaxed">The code validity has expired. Request a new code from admin.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-slate-100 flex items-start gap-3 select-none">
              ...
              <div>
                <h4 className="text-xs font-bold text-[#0F172A]">Privacy &amp; Security</h4>
