...
/** `"2026-07"` → `"July 2026"`. Anything unparseable comes back untouched. */
...
/** `"2026-07"` → `"Jul 2026"`, for badges and table cells that cannot take the full word. */
...
/** `"2026-07"` for a `Date`, matching the ledger's period key. */
