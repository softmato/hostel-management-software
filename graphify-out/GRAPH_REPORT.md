...
## Corpus Check
- 2327 files · ~4,847,283 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18669 nodes · 52513 edges · 593 communities (561 shown, 32 thin omitted)
...
## Communities (593 total, 32 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (328): BookingScreen(), whatNext(), loadFinance(), getPlanPayInstructions(), listClaims(), listComplaints(), listInquiries(), listSosAlerts() (+320 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (155): FILTERS, Pending, MANAGE_ROWS, PORTAL_ROWS, Person, SETTINGS_TITLES, THEME_OPTIONS, METHODS (+147 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (216): robots(), otpResendCooldownMs(), requestOtpChallenge(), verifyOtpChallenge(), checkoutDocumentFor(), softmatoDocumentNumbers(), gateway, invoice (+208 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (165): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload (+157 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (227): fileFieldCash(), getOrCreateSubscription(), selectPlan(), Resolver, fromHeaderFor(), replyToFor(), resolveEmailIdentity(), fromAddress() (+219 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (174): CookInviteScreen(), GuardianInviteScreen(), Choice, MapButton(), MapScreen(), ModeTab(), NOTHING_CHOSEN, PreviewCard() (+166 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (192): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, notifyHostelOfNewPost(), resolveHostelCommunityUserIds() (+184 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (180): AdminTabs(), HIDDEN, RoleLayout(), TABS, FILTERS, invalidateFeeds(), NIGHT_ANSWER_LABELS, nightAnswerText() (+172 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (165): summarizeResidentComplaints(), outstandingForResident(), CookServiceError, resolveAdminHostelId(), accessId, accessQuery, adminPrincipal, codes (+157 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (179): AdminAlertsScreen(), ICONS, LABELS, Segment, TONES, AdminHomeScreen(), AdminOverviewScreen(), loadOverview() (+171 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (125): FieldCashRow, PlanPaymentClaim, formatBsAdDate(), AccountDeletionPanel, DeletionPathway, DeletionStatus, PATHWAY_COPY, csvField() (+117 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (150): BubbleBackground(), BubbleBackgroundProps, BubbleColors, StarLayer(), StarLayerProps, StarsBackground(), StarsBackgroundProps, AVATAR_MOTION_TRANSITION (+142 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (139): PATCH(), POST(), RouteContext, POST(), POST(), POST(), POST(), GET() (+131 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (148): POST(), POST(), answerSchema, POST(), attacker, attempt(), headers, jsonRequest() (+140 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (152): cropToGuide(), FILL, GuidedCapture(), GUIDES, GuideShape, loadManipulator(), Manipulator, CentrePin() (+144 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (107): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, COMPARISON_AMENITIES, comparisonAmenities() (+99 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (159): AdminCommunityReportsScreen(), AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), AttendanceScreen(), NightStatusHistoryScreen(), NightStatusForm(), NightStatusScreen() (+151 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (130): HostelAdminCommunityPageContent, HostelAdminComplaintsPage, ConcessionBackfill, describeApplied(), FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, MonthDiscounts (+122 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (130): openStore(), Scanner(), BootGate(), RootShell(), DeletionPanel(), AttachmentGallery(), BrandSplash(), AuthDivider() (+122 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (141): formatBsPeriod(), formatBsPeriodYear(), isBsPeriod(), periodParts(), ManageRatesScreen(), ClearFilters(), CreditRow(), ManageStatementScreen() (+133 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (121): PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), GET(), POST(), RouteContext, GET(), DELETE() (+113 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (129): CommunityPageContent(), PayPlanPanel(), rupees(), VideoSlot(), CollectionQrField(), OperationsConfig, PendingSettingChange, PlanDueReminderSchedule (+121 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (119): generateMetadata(), manifest(), Entry, hostelEntries(), locationEntries(), sitemap(), STATIC_ROUTES, notFound() (+111 more)

### Community 23 - "Community 23"
Cohesion: 0.02
Nodes (100): adminPrincipal, mocks, PLATFORM_LIMITS, hostelToday(), mocks, proofBody, readAs(), readRequest() (+92 more)

### Community 24 - "Community 24"
Cohesion: 0.02
Nodes (106): GET(), ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+98 more)
...
Cohesion: 0.02
Nodes (102): AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, listPlatformHostels(), PaginationMeta, PaginationQuery (+94 more)

### Community 27 - "Community 27"
Cohesion: 0.02
Nodes (111): demoteToPublicAccount(), LIVE_ACCESS, releaseGuardianAccounts(), adminOfA, cases, mocks, pipeline, residentInB (+103 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (91): generateMetadata(), metadata, RefundPolicy, currentBsPeriod(), ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon() (+83 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (104): collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor() (+96 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (79): PATCH(), RouteContext, GET(), POST(), RouteContext, GET(), PATCH(), RouteContext (+71 more)

### Community 31 - "Community 31"
Cohesion: 0.02
Nodes (105): bsMonthStart(), formatBsDayRange(), aswin, bhadra, bs(), card(), currentId, hostelId (+97 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (105): GET(), PLATFORM_ROLES, decodeKey(), decryptPersonalData(), encryptionKey(), encryptPersonalData(), isPersonalDataEncryptionConfigured(), personalLookupHash() (+97 more)
...
Cohesion: 0.03
Nodes (84): AdminCommunityScreen(), ACTION_TONES, CARD_PAD, HostelHero(), ServiceGrid(), WaitingActions(), useReportedCount(), AdminMoneyCard() (+76 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (88): GET(), POST(), GET(), GET(), POST(), POST(), DELETE(), POST() (+80 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (99): AssetViewer(), openIdFor(), openIds, StripThumb(), useViewerState(), ViewerBody(), ViewerPage(), CopyButton() (+91 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (102): cookPrincipal, mocks, resolveCookLabels(), announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError (+94 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (68): GET(), POST(), POST(), PATCH(), RouteContext, GET(), listPayoutAccounts(), POST() (+60 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (84): GetAppDialog(), Platform, GetPlanButton(), monthStartPeriod(), defaultMonth(), ClaimFacts(), FLAG_LABELS, POSITIVE_FLAGS (+76 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (95): ReviewForm(), ReviewScreen(), DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS, MealCard(), MonthEndSpecial() (+87 more)

### Community 41 - "Community 41"
Cohesion: 0.03
Nodes (80): BookButton(), SIZE, BookingAvailabilityView, BookingButton, CLOSED_REASONS, open, HostelSuggestions(), PublicComparePage() (+72 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (81): POST(), RouteContext, DELETE(), GET(), hostelId(), GET(), DELETE(), PATCH() (+73 more)

### Community 43 - "Community 43"
Cohesion: 0.03
Nodes (81): BookingPaymentToCheck, TransferView, HostelBookingView, PlatformBookingView, List(), ReasonAction(), Row(), timeLeft() (+73 more)
...
Cohesion: 0.05
Nodes (86): SORTS, StoreCategoryScreen(), addToCart(), cancelStoreOrder(), Cart, CartLine, CartResult, CartTotals (+78 more)

### Community 46 - "Community 46"
Cohesion: 0.03
Nodes (65): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), SosScreen(), DocumentScreen() (+57 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (72): BrowseProfileScreen(), JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, ProviderStatusCard() (+64 more)

### Community 48 - "Community 48"
Cohesion: 0.07
Nodes (56): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), bookingProofToCheckEmail(), hostelBookingsPausedEmail() (+48 more)

### Community 49 - "Community 49"
Cohesion: 0.03
Nodes (69): BookingQuote, GuestBookingDetail, GuestBookingSummary, metadata, BookingCheckoutPage(), Method, METHODS, nextStep() (+61 more)

### Community 50 - "Community 50"
Cohesion: 0.03
Nodes (77): TIER_TONE, EASE, PlanCards(), PlanLine(), PlansClosingCta(), PlansEditor, PlansFootnote(), PlansHeading() (+69 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (79): BOOKING_DOCUMENT_KINDS, BookingDocumentInput, BookingDocumentKind, renderBookingDocument(), bsFiscalYear(), amountInWords(), GROUPS, ONES (+71 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (73): approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal, checker, eventId (+65 more)

### Community 53 - "Community 53"
Cohesion: 0.03
Nodes (49): deleteHostelObjects(), ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, purgeArchivedHostel(), purgeHostel() (+41 more)

### Community 54 - "Community 54"
Cohesion: 0.04
Nodes (65): POST(), RealtimeConfig, RealtimeContext, RealtimeContextValue, RealtimeNotification, useRealtime(), notificationSchema, notificationCampaignSchema (+57 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (66): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, GATEWAY_ORDER, getHostelPayMethods() (+58 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (65): approveClaim(), assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck(), evidenceCheck(), fileCheck() (+57 more)

### Community 57 - "Community 57"
Cohesion: 0.04
Nodes (55): BillingInvoiceRow, BillingPaymentRow, BillingPlan, BrandMark(), WORDMARK, WORDMARK_SEGMENTS, CheckoutHandoffButton(), Handoff (+47 more)
...
Cohesion: 0.05
Nodes (26): InlineText(), PlatformConfigAnnouncementsPageContent, PlatformConfigContentPageContent, PlatformConfigFacilitiesPageContent, FLAGS, PlatformConfigFeaturesPageContent, PlatformConfigLegalPageContent, PlatformConfigLocationsPageContent (+18 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (60): assertPlanRoom(), countLive(), notifyLimitReached(), NOUN, PlanLimitError, PlanSeat, hostelId, mocks (+52 more)
...
Cohesion: 0.04
Nodes (66): BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodBounds(), bsPeriodOf(), formatBsDate() (+58 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (60): notifyProviderOfAssignment(), notifyProviderOfMaintenanceNote(), notifyProviderOfStatusChange(), notifyStaffOfNewMaintenanceRequest(), providerUserId(), readableCategory(), RequestLike, STATUS_WORDS (+52 more)
...
Cohesion: 0.05
Nodes (62): CHANNELS, ClaimedStep, composeEmail(), composeNotice(), composePlanDueNotice(), deliver(), deliverEmail(), deliverStep() (+54 more)

### Community 67 - "Community 67"
Cohesion: 0.04
Nodes (42): ReviewPayoutAccount(), STATUS_LABEL, FeedPayload, NewPostAlertsToggle(), SidebarPayload, Space, SpacesPayload, Avatar() (+34 more)

### Community 68 - "Community 68"
Cohesion: 0.05
Nodes (55): addComplaintUpdate(), assertComplaintVoiceNote(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput (+47 more)

### Community 69 - "Community 69"
Cohesion: 0.05
Nodes (57): escapeRegex(), objectIdSchema, paginationSchema, phoneSchema, notifyStaffOfJobProgress(), serviceProviderApplicationSchema, serviceProviderDocumentSchema, ServiceProvidersPage() (+49 more)

### Community 70 - "Community 70"
Cohesion: 0.05
Nodes (50): Notification, gregorianSpan(), MonthField, MonthOption(), MonthPicker, PeriodRow, BrowserPushRow(), FILTERS (+42 more)
...
Cohesion: 0.05
Nodes (52): POST(), POST(), RouteContext, DEFAULT_GUARDIAN_PERMISSIONS, guardianAccessCreateSchema, guardianInvitationAcceptSchema, guardianLoginSchema, guardianPermissionsSchema (+44 more)

### Community 74 - "Community 74"
Cohesion: 0.05
Nodes (41): HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), PlatformDashboardPageContent(), PlatformHostelReviewPageContent(), PlatformUsersPageContent(), DashboardCard(), DashboardCardProps, PlatformServiceProvidersPageContent() (+33 more)

### Community 75 - "Community 75"
Cohesion: 0.09
Nodes (59): MESSAGES, POST(), RouteContext, BookingEndCause, HostelBookingClosedCause, announceConfirmed(), announceEnding(), assertAwaitingAnswer() (+51 more)
...
Cohesion: 0.07
Nodes (37): POST(), POST(), POST(), runPlanDueReminders(), bookingDocumentResponse(), POST(), POST(), safeEqual() (+29 more)

### Community 78 - "Community 78"
Cohesion: 0.04
Nodes (44): FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), runGatewayHealthForHostel(), hasProvider(), IntentRow, recheckClosedAttempts(), runSettlementReconForHostel() (+36 more)
...
Cohesion: 0.05
Nodes (54): applicantSchema, billingCycleSchema, HostelRegistrationInput, hostelRegistrationSchema, registrationFields, RegistrationPlanChoice, registrationPlanChoiceSchema, TeamHostelRegistrationInput (+46 more)

### Community 81 - "Community 81"
Cohesion: 0.06
Nodes (51): ComplaintDetail(), ComplaintCard(), CategoryTile(), NewComplaintScreen(), PickedAttachment, SwapButton(), PhotoCapture(), VoiceNotePlayer() (+43 more)

### Community 82 - "Community 82"
Cohesion: 0.05
Nodes (47): hostelDayParts(), COLUMNS, Member, MemberData, RegistrationTrackSheet(), TrackSheetLoader(), metadata, HOSTEL_AGREEMENT_STATUSES (+39 more)

### Community 83 - "Community 83"
Cohesion: 0.06
Nodes (54): arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal, alreadyReviewedError() (+46 more)
...
Cohesion: 0.07
Nodes (50): directionFlags(), evidenceFlags(), payeeFlags(), AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance() (+42 more)
...
Cohesion: 0.06
Nodes (44): otpRateLimitMax(), otpRateLimitWindowMs(), formatPeriodKey(), DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue() (+36 more)
...
Cohesion: 0.09
Nodes (40): bodySchema, POST(), computePerceptualHash(), ImageVariantRecord, optimizeImage(), streamToBuffer(), VARIANT_CONFIG, VariantName (+32 more)

### Community 92 - "Community 92"
Cohesion: 0.06
Nodes (22): LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminResidentsPage(), redirectToWorkspaceScreen() (+14 more)

### Community 93 - "Community 93"
Cohesion: 0.09
Nodes (44): assertMatchesExtension(), beginDownload(), downloadAndShare(), downloadAndShareCsv(), downloadAndShareImage(), downloadToDevice(), forgetDownloadFolder(), LegacyFileSystem (+36 more)
...
Cohesion: 0.08
Nodes (42): mocks, allocateOrderNumber(), applyStatus(), CancelInput, cancelOrder(), CreateInput, hostelNames(), listAllOrders() (+34 more)
...
Cohesion: 0.06
Nodes (39): account, answerBy, before, book(), Booking, compact, confirmed(), Consent (+31 more)

### Community 99 - "Community 99"
Cohesion: 0.06
Nodes (38): bookingDocumentLayout(), refundPolicyNotes(), allowed(), BookingDocumentScope, resolveBookingDocument(), BookingError, ENDED, getPlatformBooking() (+30 more)

### Community 100 - "Community 100"
Cohesion: 0.07
Nodes (40): addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange(), definedUpdate(), FoodFeedbackInput, FoodFeedbackRecord, FoodMenuCreateInput (+32 more)
...
Cohesion: 0.1
Nodes (39): BookableHostel, BookingUnavailableReason, findRoom(), hostelAddress(), HostelAvailability, hostelCoverPhoto(), hostelCoverPhotos(), hostelUnavailableReason() (+31 more)

### Community 103 - "Community 103"
Cohesion: 0.14
Nodes (38): planOverdueEmail(), planSuspensionNoticeEmail(), bookingConfirmedEmail(), bookingEndedEmail(), bookingInvoiceEmail(), bookingMoveInReminderEmail(), bookingPaymentRejectedEmail(), bookingPaymentVerifiedEmail() (+30 more)

### Community 104 - "Community 104"
Cohesion: 0.07
Nodes (30): checkoutSchema, POST(), GET(), GET(), querySchema, focusSchema, POST(), createPaymentIntent() (+22 more)
...
Cohesion: 0.07
Nodes (36): addBsMonths(), bsPeriodsBetween(), approvalPeriod(), getPeriodSummary(), monthsBetween(), periodOf(), PeriodRow, PeriodSummary (+28 more)
...
Cohesion: 0.07
Nodes (34): deliver(), emailFacts(), getHostelPayoutAccount(), hostelOrThrow(), notifyPlatformOfPayoutReview(), PayoutAccountForReview, PayoutAccountStatus, PayoutAccountView (+26 more)

### Community 111 - "Community 111"
Cohesion: 0.09
Nodes (34): CardBooking, checkInBooking(), findCardBooking(), findHeldBooking(), returnHeldBed(), takeHeldBed(), applyStrikeRule(), EndBookingInput (+26 more)

### Community 112 - "Community 112"
Cohesion: 0.08
Nodes (36): formatNPR(), drawCertificationStamp(), footerLine(), formatDate(), formatLongDate(), MONTHS, ReceiptPdfInput, renderReceiptPdf() (+28 more)

### Community 113 - "Community 113"
Cohesion: 0.07
Nodes (34): DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity(), NAME_SUFFIX (+26 more)
...
Cohesion: 0.09
Nodes (37): directionOf(), EMPTY_TALLY, floorToStep(), phaseOf(), shouldRepost(), tallyUploads(), active, done (+29 more)

### Community 116 - "Community 116"
Cohesion: 0.09
Nodes (33): PublicFooter(), buildCityIndex(), CityIndexEntry, HOSTEL_TYPE_PAGES, HostelTypeKey, hostelTypeLabel(), HostelTypePage, LocationCountRow (+25 more)
...
Cohesion: 0.08
Nodes (35): BS_MONTHS, cellAt(), focusCell(), INPUT_MODES, Props, cellAt(), focusCell(), Props (+27 more)

### Community 119 - "Community 119"
Cohesion: 0.06
Nodes (26): currency(), LoadingRows(), Select(), ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent, Complaint (+18 more)
...
Cohesion: 0.1
Nodes (33): nepalMinuteOfDay(), nightStatusPromptSchema, askingEndsMinuteOfNight(), formatPromptTime(), minuteIsDue(), minuteOfNight(), nightEndsAt(), parsePromptTime() (+25 more)

### Community 122 - "Community 122"
Cohesion: 0.07
Nodes (31): NoticeArt(), createNoticePush(), deleteNoticePush(), NoticePush, NoticePushInput, NoticePushRepeat, sendNoticePushNow(), updateNoticePush() (+23 more)

### Community 123 - "Community 123"
Cohesion: 0.09
Nodes (28): POST(), RouteContext, listTrendingTags(), sponsorSchema, GET(), loadPopularHostels(), PopularHostelRecord, DELETE() (+20 more)
...
Cohesion: 0.07
Nodes (35): CREDIT_MARKERS, DEBIT_MARKERS, DirectionRead, directionRefusal(), EvidenceDirection, EvidenceOutcome, matched(), OUTCOME_MARKERS (+27 more)

### Community 126 - "Community 126"
Cohesion: 0.11
Nodes (28): NativeNightPrompt, takeNativePendingAnswers(), isNightStatusPrompt(), NIGHT_STATUS_ACTIONS, NIGHT_STATUS_BUTTONS, NIGHT_STATUS_REASONS, NightStatusActionId, NightStatusAnswer (+20 more)
...
Cohesion: 0.09
Nodes (32): Compass(), maneuverIcon(), NavCard(), cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath() (+24 more)

### Community 130 - "Community 130"
Cohesion: 0.07
Nodes (14): PublicHostelListingPage(), ComparePageSkeleton(), HostelDetailPageSkeleton(), HostelListingPageSkeleton(), InquiryPageSkeleton(), emptyFilters, Filters, generateMetadata() (+6 more)
...
Cohesion: 0.07
Nodes (21): Panel(), TextArea(), field(), HostelAdminReferralsPageContent(), HostelAdminReportsPageContent(), ListingFlag, LoadState, MaintenanceRequest (+13 more)
...
Cohesion: 0.08
Nodes (19): POST(), RouteContext, POST(), RouteContext, calendarDateSchema, emergencyContactCreateSchema, guardianCreateSchema, objectIdSchema (+11 more)
...
Cohesion: 0.07
Nodes (22): LegacyHostelAdminComplaintsPage(), Complaint, ComplaintSummary, field(), FoodMenu, HostelAdminComplaintsPage(), HostelAdminFoodPage(), HostelAdminNoticesPage() (+14 more)
...
Cohesion: 0.12
Nodes (29): mergeBookingConfig(), bookingFee(), BookingSettlement, cancellationSchedule(), cancelRefundPercent(), FULL_REFUND_ENDINGS, holdDayAt(), holdEndsAt() (+21 more)

### Community 143 - "Community 143"
Cohesion: 0.1
Nodes (25): auditFinanceAction(), base, entityId, hostelId, mocks, principal, write(), assertEnablable() (+17 more)
...
Cohesion: 0.12
Nodes (25): refundScope(), assertSuperadmin(), Destination, listTransfersDue(), loadTransfer(), loadTransferProof(), markTransferSent(), PayoutAccountRow (+17 more)

### Community 160 - "Community 160"
Cohesion: 0.1
Nodes (20): applyConcessionToIssuedInvoices(), ConcessionBackfill, EMPTY, InvoiceLine, settledAmountOf(), bill, hostelId, lean() (+12 more)
...
Cohesion: 0.09
Nodes (21): CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS, CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, MOCK_HOSTELS (+13 more)
...
Cohesion: 0.11
Nodes (18): useRealtime(), connectRealtime(), fetchConfig(), PusherModule, REALTIME_EVENT, RealtimeConfig, RealtimeConnection, RealtimeHandlers (+10 more)
...
Cohesion: 0.13
Nodes (15): paymentClearedEmail(), paymentDueReminderEmail(), ReminderStage, wording(), paymentOverdueEmail(), paymentRejectedEmail(), paymentReversedEmail(), paymentProofReceivedEmail() (+7 more)

### Community 194 - "Community 194"
Cohesion: 0.19
Nodes (22): AddInput, addToCart(), CartItemRecord, CartRecord, clearCart(), emptyCart(), getCart(), getCartCount() (+14 more)
...
Cohesion: 0.14
Nodes (19): activeDevicesFor(), activeTokensFor(), androidChannel(), authHeaders(), chunk(), DeviceRow, EMPTY, ExpoDevice (+11 more)
...
Cohesion: 0.24
Nodes (16): resolvePastedLink(), searchCandidates(), lookupLocation(), resolvePastedLink(), searchCandidates(), queryVariants(), searchPlaces(), ParsedMapLink (+8 more)

### Community 227 - "Community 227"
Cohesion: 0.26
Nodes (14): ATTACHED, dueWhen(), payOnWebsite(), PlanDueInput, planDueSoonEmail(), subscriptionClaimReceivedEmail(), subscriptionClaimRejectedEmail(), formatRupees() (+6 more)
...
Cohesion: 0.14
Nodes (15): activateResident(), getResidentProfile(), login(), triggerSOS(), RootStackParamList, LoginScreen(), Props, Props (+7 more)
...
Cohesion: 0.2
Nodes (15): NearbyStatus, Coordinates, hasLocationPermission(), hasPromptedForLocation(), LocationOutcome, NavigationFix, readPosition(), readPrecisePosition() (+7 more)
...
Cohesion: 0.13
Nodes (19): 5.1 SOS Triggered, 5. Safety & Emergency Emails, 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6. Service Provider Emails, 7.1 Attendance Alert (Resident Absent), 7.1 New Hostel Pending Approval (to Superadmin) (+11 more)
...
Cohesion: 0.15
Nodes (16): ApiFailure, ApiSuccess, AuthUser, confirmComplaintResolution(), createResidentComplaint(), listResidentComplaints(), listResidentNotices(), markNoticeAsRead() (+8 more)
...
Cohesion: 0.22
Nodes (18): AuditLog, code:typescript (interface IAuditLog {), code:typescript ({), code:typescript ({), code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({), FoodReadyLog (+10 more)
...
Cohesion: 0.15
Nodes (15): 1.7 Account Upgraded, 2.3 Hostel Rejected, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails (+7 more)
...
Cohesion: 0.16
Nodes (13): apiRequest(), getActivationStatus(), getResidentNightStatus(), listNotifications(), markNotificationRead(), NotificationItem, refreshSession(), ResidentNightStatus (+5 more)
...
Cohesion: 0.22
Nodes (7): hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), systemDocumentKindFromText(), distance, SystemDocumentKind, base
...
Cohesion: 0.17
Nodes (9): ProviderDirectoryData, ServiceProviderRegistrationPage(), categories, fields, DirectoryPageProps, EMPTY, generateMetadata(), metadata (+1 more)
...
Cohesion: 0.2
Nodes (8): AuthSession, submitResidentReview(), AppNavigator(), Stack, ResidentNightStatusScreen(), Props, ResidentReviewsScreen(), ResidentSOSScreen()
...
Cohesion: 0.2
Nodes (8): PlatformHostelsPageContent(), PlatformHostelsPageContent, PortalPlaceholderAction, PortalPlaceholderPage(), PortalPlaceholderPageProps, GuardianScreenPage(), GuardianScreenPageProps, PlatformScreenPageProps
...
Cohesion: 0.25
Nodes (8): isSameNight(), nightKey(), nightHistory(), NightHistoryEntry, NightHistoryLog, previousNight(), entries, getResidentNightStatusHistory()
...
Cohesion: 0.39
Nodes (7): UploadCard(), UploadToaster(), useIsUploading(), useUploads(), UploadRow, uploadRowFraction(), uploadRowMessage()
...
Cohesion: 0.22
Nodes (9): 3.3 Payment Proof Uploaded (to Admin), 4.1 New Notice Posted, 4.2 Complaint Status Updated, 4.3 Complaint Resolved, 4. Resident Activity Emails, code:typescript ({), code:typescript ({), code:typescript ({) (+1 more)
...
Cohesion: 0.25
Nodes (8): 7.3 Privacy/Guardian Permissions Test Template, 9.1 Seed Scripts, 9.2 Test Database Isolation, 9.3 Test Helpers, 9. Test Data & Seeding, code:typescript (describe('GET /api/v1/guardian/linked-resident - privacy', (), code:typescript (// tests/helpers/auth.ts), code:bash (npm run web:build)
...
Cohesion: 0.4
Nodes (6): 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, code:typescript ({), code:block14 (---)
...
- **Why does `cn()` connect `Community 11` to `Community 1`, `Community 130`, `Community 3`, `Community 131`, `Community 133`, `Community 137`, `Community 10`, `Community 395`, `Community 15`, `Community 17`, `Community 276`, `Community 21`, `Community 22`, `Community 28`, `Community 157`, `Community 33`, `Community 39`, `Community 41`, `Community 43`, `Community 49`, `Community 50`, `Community 57`, `Community 59`, `Community 61`, `Community 319`, `Community 67`, `Community 70`, `Community 74`, `Community 88`, `Community 117`, `Community 118`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 1` to `Community 0`, `Community 3`, `Community 5`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 14`, `Community 272`, `Community 17`, `Community 18`, `Community 19`, `Community 149`, `Community 28`, `Community 34`, `Community 36`, `Community 39`, `Community 40`, `Community 43`, `Community 45`, `Community 46`, `Community 47`, `Community 61`, `Community 70`, `Community 81`, `Community 122`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 4` to `Community 2`, `Community 259`, `Community 6`, `Community 8`, `Community 13`, `Community 143`, `Community 145`, `Community 20`, `Community 23`, `Community 24`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 159`, `Community 32`, `Community 31`, `Community 160`, `Community 158`, `Community 35`, `Community 37`, `Community 42`, `Community 172`, `Community 304`, `Community 178`, `Community 51`, `Community 52`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 306`, `Community 60`, `Community 62`, `Community 63`, `Community 64`, `Community 65`, `Community 66`, `Community 194`, `Community 68`, `Community 69`, `Community 72`, `Community 73`, `Community 75`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 205`, `Community 82`, `Community 83`, `Community 214`, `Community 215`, `Community 91`, `Community 95`, `Community 96`, `Community 99`, `Community 100`, `Community 101`, `Community 102`, `Community 108`, `Community 110`, `Community 111`, `Community 112`, `Community 116`, `Community 247`, `Community 121`, `Community 123`?**
