# Graph Report - hostel-management-software  (2026-09-22)

## Corpus Check
- 2313 files · ~4,837,016 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18560 nodes · 52053 edges · 615 communities (580 shown, 35 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 860 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 742 edges
2. `successResponse()` - 715 edges
3. `connectToDatabase()` - 519 edges
4. `useAppTheme()` - 422 edges
5. `cn()` - 342 edges
6. `connectToDatabase()` - 278 edges
7. `unwrap()` - 232 edges
8. `useResource()` - 220 edges
9. `Text()` - 196 edges
10. `requireHostelCapability()` - 186 edges

## Surprising Connections (you probably didn't know these)
- `bs()` --calls--> `formatBsDate()`  [EXTRACTED]
  apps/web/scripts/repair-plan-trial.mjs → packages/shared/src/calendar/bs.ts
...
- `generateMetadata()` --calls--> `getPlan()`  [INFERRED]
  apps/web/src/app/(public)/plans-pricing/[service]/page.tsx → packages/shared/src/plans/catalog.ts
- `generateMetadata()` --calls--> `getServiceModule()`  [INFERRED]
  apps/web/src/app/(public)/plans-pricing/[service]/page.tsx → packages/shared/src/plans/catalog.ts
- `GET()` --calls--> `connectToDatabase()`  [INFERRED]
  apps/web/src/app/api/v1/platform/subscriptions/documents/[kind]/[number]/route.ts → packages/db/src/connection.ts

## Communities (615 total, 35 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (317): POST(), GET(), POST(), PATCH(), POST(), RouteContext, GET(), POST() (+309 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (306): Scanner(), CookInviteScreen(), GuardianInviteScreen(), Choice, Compass(), MapButton(), MapScreen(), ModeTab() (+298 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (322): loadOverview(), loadMoney(), loadToday(), FLAGGED, ReportedPostCard(), loadFinance(), DeletionRequest, DeletionStatus (+314 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (187): ICONS, LABELS, Segment, TONES, FILTERS, Pending, MoneyData, MANAGE_ROWS (+179 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (255): POST(), fileFieldCash(), getOrCreateSubscription(), POST(), GET(), getOpenFeeSchedule(), GET(), POST() (+247 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (145): PlanPaymentClaim, csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, HostelTable(), Inquiry (+137 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (180): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), manifest() (+172 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (172): AdminMoreScreen(), ActivateScreen(), BootGate(), RootShell(), NotificationsScreen(), ApplyBlock(), ServiceProvidersScreen(), SettingsScreen() (+164 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (138): LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminMoveChecklistPage() (+130 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (143): HostelSuggestions(), GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS (+135 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (129): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload (+121 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (151): POST(), POST(), attacker, attempt(), headers, jsonRequest(), routeMocks, appBaseUrl() (+143 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (158): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, loadContext(), notifyHostelOfNewPost() (+150 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (148): AdminAlertsScreen(), AdminCommunityScreen(), AdminHomeScreen(), AdminOverviewScreen(), Overview, AdminTabs(), AdminTodayScreen(), HOSTEL (+140 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (126): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), submitFieldCash(), dueWhen() (+118 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (153): PaymentMonthStrip(), ManageRatesScreen(), ClearFilters(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard() (+145 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (120): ATTENDANCE_DEFAULTS, adminPrincipal, mocks, PLATFORM_LIMITS, afterMidnight, evening, meters, mocks (+112 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (128): DELETE(), RouteContext, GET(), POST(), querySchema, RouteContext, authorUserId, mocks (+120 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (136): AdminCommunityReportsScreen(), AdminResidentsScreen(), AttendanceScreen(), NightStatusHistoryScreen(), NightStatusForm(), NightStatusScreen(), ProfileScreen(), ReferralRow() (+128 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (118): PayoutAccountForReview, ReviewPayoutAccount(), STATUS_LABEL, AttendanceCalendar(), CookAccount, Credentials, HostelAdminCooksPanel, Issued (+110 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (96): ComparePage(), generateMetadata(), hostels, metadata, rows, csvField(), field(), Hostel (+88 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (112): EMPTY_PAYOUT_DRAFT, METHODS, PayoutAccountDraft, PayoutAccountFields(), payoutAccountPayload(), CheckoutHandoffButton(), Handoff, ORDER (+104 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (118): cookPrincipal, mocks, resolveCookLabels(), CookServiceError, resolveAdminHostelId(), announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord (+110 more)

### Community 23 - "Community 23"
Cohesion: 0.02
Nodes (106): GET(), listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), communityHideSchema, DELETE(), PATCH() (+98 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (113): GET(), hashUserAgent(), HostelRef, newVisitorKey(), recordHostelPageView(), resolveVisitorKey(), PLATFORM_ROLES, PlatformIdCardType (+105 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (104): otpResendCooldownMs(), readReturnState(), fail(), findHostelForCheckout(), HostelMatch, paymentState(), PlanCheckoutInput, planCheckoutSchema (+96 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (108): ReviewForm(), ReviewScreen(), DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS, MonthEndSpecial(), RoutineMeal (+100 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (106): demoteToPublicAccount(), LIVE_HOSTEL_FILTER, PlatformStat, findLiveResidency(), LIVE_STATUSES, LiveResidency, liveResidencyMessage(), LiveRow (+98 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (100): HIDDEN, RoleLayout(), TABS, FILTERS, invalidateFeeds(), NIGHT_ANSWER_LABELS, nightAnswerText(), NightPromptAnswer() (+92 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (91): PRIORITIES, STATUS_ACTIONS, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel, HostelAdminReconcilePageContent, labelled() (+83 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (91): Assurance(), money(), PlanCard(), PricingScreen(), metadata, GetPlanButton(), UpgradeDialog(), PlanPicker() (+83 more)

### Community 31 - "Community 31"
Cohesion: 0.02
Nodes (78): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, outstandingForResident(), accessId, accessQuery, adminPrincipal (+70 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (93): POST(), POST(), POST(), runPlanDueReminders(), bulkApproveSchema, POST(), POST(), POST() (+85 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (75): generateMetadata(), fill(), metadata, AccountDeletionPanel, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon() (+67 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (84): CommunityScreen(), Composer(), AttachmentGallery(), AnimatedBlurView, CommunityBoard(), CommunityBoardProps, Composer(), SORTS (+76 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (71): Platform, grabDocument(), InvoiceRow(), PaymentRow(), PlanCard(), rupees(), shortDate(), STATUS_TONE (+63 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (80): BubbleBackground(), BubbleBackgroundProps, BubbleColors, StarLayer(), StarLayerProps, StarsBackground(), StarsBackgroundProps, CommunityReportDialog() (+72 more)
...
Cohesion: 0.04
Nodes (80): answerSchema, POST(), summarizeResidentComplaints(), GET(), listResidentInvoices(), ApiAuthError, auditMoveAction(), createMoveInChecklist() (+72 more)

### Community 39 - "Community 39"
Cohesion: 0.1
Nodes (55): CATEGORIES, isApplicationOpen(), LandingStep(), MeResponse, OwnApplication, ProviderStats, ProviderStatus, renderEmphasis() (+47 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (65): BookingQuote, GuestBookingDetail, GuestBookingSummary, HostelBookingView, metadata, List(), ReasonAction(), Row() (+57 more)

### Community 41 - "Community 41"
Cohesion: 0.03
Nodes (55): DeletionPathway, DeletionStatus, PATHWAY_COPY, ConfirmOptions, useConfirm(), ExistingResidentsPanel(), Props, ExistingResidentsSheet() (+47 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (66): POST(), PaginationMeta, PaginationQuery, querySchema, noticeSchema, noticeReadStatusSchema, sponsorSchema, mocks (+58 more)

### Community 43 - "Community 43"
Cohesion: 0.06
Nodes (79): MESSAGES, POST(), BookingEndCause, HostelBookingClosedCause, announceConfirmed(), announceEnding(), assertAwaitingAnswer(), cancelBookingByHostel() (+71 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (72): deliver(), Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity() (+64 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (63): collectionTotals(), countInvoicesByField(), invoicesByIds(), ledgerPipeline(), monthlySeries(), countListingAppearances(), getHostelViewStats(), complaintSchema (+55 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (68): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), PortalDates, useHostelDayTurn() (+60 more)

### Community 47 - "Community 47"
Cohesion: 0.03
Nodes (63): AnyProps, DOMMotionProps, mergeProps(), mergeRefs(), Slot(), SlotProps, WithAsChild, Align (+55 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (65): AdminAlertsContext, AdminAlertsProvider(), AdminAlertsValue, AlertActions, AlertCard(), EMPTY_COUNTS, ICONS, LABELS (+57 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (60): NotificationsPageContent(), Notification, BrowserPushRow(), FILTERS, Notification, NotificationRow(), PushState, FILTERS (+52 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (56): normalize(), PortalSearch(), PortalTone, scoreEntry(), toneStyles, iconMap, IconName, NavItem (+48 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (70): BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan, BillingSkip (+62 more)

### Community 52 - "Community 52"
Cohesion: 0.03
Nodes (39): deleteHostelObjects(), ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, purgeHostel(), RETAINED_BY_HOSTEL_ID (+31 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (67): CHANNELS, ClaimedStep, composeEmail(), composeNotice(), composePlanDueNotice(), deliverEmail(), deliverStep(), HostelRow (+59 more)

### Community 54 - "Community 54"
Cohesion: 0.04
Nodes (57): AuthGuard(), ActiveSuspension, HostelSuspendedScreen(), HostelSuspensionNotice(), isHostelPortal(), PayPlanPanel, remainingLabel(), useHostelSuspension() (+49 more)

### Community 55 - "Community 55"
Cohesion: 0.04
Nodes (56): POST(), GET(), querySchema, focusSchema, POST(), applicantSchema, billingCycleSchema, HostelRegistrationInput (+48 more)

### Community 56 - "Community 56"
Cohesion: 0.05
Nodes (58): JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, ProviderJobScreen(), AdminNightStatusRow (+50 more)
...
Cohesion: 0.05
Nodes (52): hostelPeriodOf(), existingResidentListSchema, existingResidentRowSchema, BillPreview, CheckContext, CheckedRow, checkExistingResidents(), CheckResult (+44 more)

### Community 59 - "Community 59"
Cohesion: 0.04
Nodes (59): BookingForm(), CheckoutScreen(), METHODS, PackageCard(), PayStep(), roomPhotoUris(), StatusCard(), BookingScreen() (+51 more)

### Community 60 - "Community 60"
Cohesion: 0.04
Nodes (57): hostelDayParts(), COLUMNS, Member, MemberData, RegistrationTrackSheet(), TrackSheetLoader(), cellAt(), focusCell() (+49 more)

### Community 61 - "Community 61"
Cohesion: 0.05
Nodes (58): CardBooking, checkInBooking(), findCardBooking(), findHeldBooking(), returnHeldBed(), takeHeldBed(), account, answerBy (+50 more)

### Community 62 - "Community 62"
Cohesion: 0.05
Nodes (53): ReturnState, ReturnStep, documentUrl(), InvoiceLean, PaymentLean, PlatformInvoiceRow, PlatformPaymentRow, PlatformSubscriptionLedger (+45 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (61): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES (+53 more)

### Community 64 - "Community 64"
Cohesion: 0.04
Nodes (57): pricePlan(), currentBsPeriod(), OfferTab(), Faq, PlatformConfigSeoPageContent, Step, eventRuns(), sellingCatalog() (+49 more)

### Community 65 - "Community 65"
Cohesion: 0.04
Nodes (50): financeIntegrityHash(), appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind, creditOverpayment(), getCreditAmount(), getCreditBalance() (+42 more)

### Community 66 - "Community 66"
Cohesion: 0.05
Nodes (61): continueLabel(), isBlank(), buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, draftFromProfile() (+53 more)

### Community 67 - "Community 67"
Cohesion: 0.04
Nodes (45): EMPTY_DRAFT, HostelAdminPaymentProfilePageContent, PaymentProfile, SECTION_FIELDS, SectionId, BankMark(), EsewaMark(), KhaltiMark() (+37 more)

### Community 68 - "Community 68"
Cohesion: 0.05
Nodes (53): approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal, checker, eventId (+45 more)

### Community 69 - "Community 69"
Cohesion: 0.05
Nodes (52): ComplaintDetail(), ComplaintCard(), CategoryTile(), NewComplaintScreen(), PickedAttachment, SwapButton(), CapturedPhoto, PhotoCapture() (+44 more)
...
Cohesion: 0.06
Nodes (53): GET(), POST(), getFoodRoutine(), getFoodRoutinesByHostelId(), saveFoodRoutine(), serializeRoutine(), addUtcDay(), auditFoodAction() (+45 more)

### Community 72 - "Community 72"
Cohesion: 0.05
Nodes (58): BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodBounds(), bsPeriodOf() (+50 more)

### Community 73 - "Community 73"
Cohesion: 0.05
Nodes (44): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, AuthShell(), AuthShellProps, PANEL_COPY (+36 more)

### Community 74 - "Community 74"
Cohesion: 0.06
Nodes (55): addBsMonths(), formatPeriodKey(), cellAt(), focusCell(), INPUT_MODES, Props, fullYear(), MONTH_SPELLINGS (+47 more)

### Community 75 - "Community 75"
Cohesion: 0.06
Nodes (53): GATEWAY_ORDER, getHostelPayMethods(), getPayInstructions(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod (+45 more)

### Community 76 - "Community 76"
Cohesion: 0.07
Nodes (58): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags(), documentFlags() (+50 more)

### Community 77 - "Community 77"
Cohesion: 0.06
Nodes (55): AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance(), deadline(), DIGIT_CONFUSABLES, EvidenceRead (+47 more)

### Community 78 - "Community 78"
Cohesion: 0.05
Nodes (43): escapeRegex(), objectIdSchema, paginationSchema, phoneSchema, notifyStaffOfJobProgress(), serviceProviderApplicationSchema, serviceProviderDocumentSchema, hostelId (+35 more)

### Community 79 - "Community 79"
Cohesion: 0.05
Nodes (44): referralSchema, referralCodeSchema, referralRewardSchema, activeCode, codeId, hostelId, joinedResidentId, mocks (+36 more)

### Community 80 - "Community 80"
Cohesion: 0.04
Nodes (47): fromBs(), gregorianOf(), bhadra(), filter, hostelId, invoiceId, mocks, otherHostelId (+39 more)

### Community 81 - "Community 81"
Cohesion: 0.05
Nodes (36): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, ENDPOINTS, esewaProvider, SIGNED_FIELDS, attempt, fetchMock (+28 more)

### Community 82 - "Community 82"
Cohesion: 0.08
Nodes (21): PlatformConfigAnnouncementsPageContent, PlatformConfigContentPageContent, PlatformConfigFacilitiesPageContent, FLAGS, PlatformConfigFeaturesPageContent, PlatformConfigLegalPageContent, PlatformConfigLocationsPageContent, PlatformConfigPlanServicePageContent (+13 more)

### Community 83 - "Community 83"
Cohesion: 0.05
Nodes (36): CommunityPageContent(), FeedPayload, NewPostAlertsToggle(), SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+28 more)

### Community 84 - "Community 84"
Cohesion: 0.09
Nodes (41): documentDownloadUrl(), issueInvoiceDocument(), allocateNumber(), ensureInvoiceRaised(), findOpenInvoice(), graceDeadline(), issueSubscriptionInvoice(), PaymentRecord (+33 more)

### Community 85 - "Community 85"
Cohesion: 0.07
Nodes (43): DeviceLocationStatus, Guidance, GuidanceStatus, useGuidance(), hasGeolocation(), LocationOutcome, NavigationFix, OrientationPermission (+35 more)

### Community 86 - "Community 86"
Cohesion: 0.06
Nodes (42): downloadCaption(), DownloadRow, DownloadStack(), progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster() (+34 more)

### Community 87 - "Community 87"
Cohesion: 0.06
Nodes (38): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), methodProvider(), PROVIDER_LABEL, QrPanel() (+30 more)

### Community 88 - "Community 88"
Cohesion: 0.07
Nodes (38): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, metadata, isAuthBypassEnabled(), original, CookieReader, hasSessionCookie(), LEGACY_ACCESS_TOKEN_COOKIES (+30 more)

### Community 89 - "Community 89"
Cohesion: 0.09
Nodes (43): GET(), BookableHostel, BookingUnavailableReason, findRoom(), hostelAddress(), HostelAvailability, hostelCoverPhoto(), hostelCoverPhotos() (+35 more)

### Community 90 - "Community 90"
Cohesion: 0.06
Nodes (39): buildIdCardData(), EMAIL_CHECK_HINTS, EmailCheck, Field(), FIELD_LABELS, formatCardDate(), IdCardPanel(), identityDraftKey() (+31 more)

### Community 91 - "Community 91"
Cohesion: 0.06
Nodes (39): qrActivationSchema, before, expiresAt, mocks, staffPrincipal, activateResident(), ActivationCodeGenerateInput, ActivationCodeInput (+31 more)

### Community 92 - "Community 92"
Cohesion: 0.09
Nodes (40): resolvePastedLink(), searchCandidates(), lookupLocation(), resolvePastedLink(), searchCandidates(), AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim() (+32 more)

### Community 93 - "Community 93"
Cohesion: 0.14
Nodes (39): BookingDocumentInput, bookingDocumentLayout(), refundPolicyNotes(), renderBookingDocument(), bsFiscalYear(), amountInWords(), GROUPS, ONES (+31 more)

### Community 94 - "Community 94"
Cohesion: 0.08
Nodes (34): applyBookingConfig(), BookingCancelStep, bookingCancelStepSchema, BookingConfig, bookingConfigSchema, DEFAULT_BOOKING_CONFIG, DEFAULT_CANCEL_STEPS, percent (+26 more)

### Community 95 - "Community 95"
Cohesion: 0.07
Nodes (42): Offset, PhotoCropper(), VideoSlot(), FileUploadArea(), isActive(), EXTENSION_BY_MIME, FAMILY_BYTES, FAMILY_ORDER (+34 more)

### Community 96 - "Community 96"
Cohesion: 0.09
Nodes (39): AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput, ConsentInput, dayKey() (+31 more)
...
Cohesion: 0.06
Nodes (39): openStore(), createNoticePush(), deleteNoticePush(), NoticePush, NoticePushInput, NoticePushRepeat, sendNoticePushNow(), updateNoticePush() (+31 more)

### Community 100 - "Community 100"
Cohesion: 0.1
Nodes (35): bodySchema, POST(), computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), distance, SystemDocumentKind, ImageVariantRecord (+27 more)

### Community 101 - "Community 101"
Cohesion: 0.07
Nodes (40): GuardianHomeScreen(), GuardianMetrics(), GuardianPaymentsScreen(), GuardianSafetyScreen(), LoginResult, acceptGuardianInvitation(), getGuardianFood(), getGuardianNotices() (+32 more)

### Community 102 - "Community 102"
Cohesion: 0.1
Nodes (34): GET(), periodTotals(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS, neutralize(), csv (+26 more)

### Community 103 - "Community 103"
Cohesion: 0.07
Nodes (41): arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal, alreadyReviewedError() (+33 more)

### Community 104 - "Community 104"
Cohesion: 0.08
Nodes (37): addHistory(), addMaintenanceComment(), assertBedInHostel(), assertProviderApproved(), assertRoomInHostel(), assertVoiceNoteUsable(), assignMaintenanceProvider(), auditMaintenanceAction() (+29 more)

### Community 105 - "Community 105"
Cohesion: 0.07
Nodes (33): DEPRECATED_ALIASES, mocks, dashboardUrl(), notifyWardenAdded(), notifyWardenUpdated(), auditWardenAction(), createHostelWarden(), deactivateHostelWarden() (+25 more)

### Community 106 - "Community 106"
Cohesion: 0.08
Nodes (38): getInvoiceDetailForHostel(), BOOKING_DOCUMENT_KINDS, BookingDocumentKind, allowed(), BookingDocumentScope, HostelScope, ResolvedDocument, resolveInvoiceDocument() (+30 more)
...
Cohesion: 0.07
Nodes (31): buildFormPostHandoff(), FormPostHandoff, HandoffError, IntentRecord, formPostIntent, hostelId, intentId, invoiceId (+23 more)
...
Cohesion: 0.09
Nodes (34): GET(), POST(), assertPrimaryCredentialPrincipal(), PLATFORM_SETTING_CHANGE_STATUSES, platformSettingChangeSchema, GET(), PUT(), saveOperationsConfig() (+26 more)
...
Cohesion: 0.1
Nodes (37): candidateFontDirs(), ensureIdCardFonts(), FONT_DIR_SEGMENTS, FONT_FILES, CARD_NOUNS, CardVariant, drawBack(), drawBrandLockup() (+29 more)

### Community 113 - "Community 113"
Cohesion: 0.07
Nodes (35): bell(), BookingAudience, bookingFacts(), deliver(), hostelBookingsPath(), notifyHostelBookingPause(), when(), BookingSweepResult (+27 more)

### Community 114 - "Community 114"
Cohesion: 0.09
Nodes (36): mocks, applyStatus(), CancelInput, cancelOrder(), CreateInput, hostelNames(), ListQuery, notifyHostelOfOrderStatus() (+28 more)
...
Cohesion: 0.07
Nodes (35): RouteContext, assertSuperadmin(), Destination, loadTransfer(), loadTransferProof(), markTransferSent(), PayoutAccountRow, payoutBlock() (+27 more)
...
Cohesion: 0.09
Nodes (35): maneuverIcon(), NavCard(), haversineMeters(), cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath() (+27 more)
...
Cohesion: 0.07
Nodes (30): ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput, ComplaintListQuery, ComplaintRecord, ComplaintReplyInput, ComplaintResolutionConfirmInput (+22 more)

### Community 121 - "Community 121"
Cohesion: 0.07
Nodes (34): findIndex(), index, indexesOf(), IndexSpec, promote, assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck (+26 more)

### Community 122 - "Community 122"
Cohesion: 0.08
Nodes (21): HostelGeoRecord, sleep(), HostelGeoLocation, resolveHostelGeo(), TYPE_COLORS, fetchNearbyPlaces(), fetchNearbyWithGoogle(), fetchNearbyWithOverpass() (+13 more)

### Community 123 - "Community 123"
Cohesion: 0.11
Nodes (33): noticePushSchema, announceChange(), audit(), CreateInput, createNoticePush(), DEFAULT_PUSHES, deleteNoticePush(), emitNoticePush() (+25 more)
...
Cohesion: 0.11
Nodes (31): cookLoginStem(), generateCookPassword(), mintCookLogin(), pick(), previousCookLabel(), acceptCookInvitation(), addCookAccount(), assertRoomForAnotherCook() (+23 more)
...
Cohesion: 0.08
Nodes (29): describeGrants(), GuardianRow(), PermissionSheet(), InviteGuardianScreen(), inviteGuardian(), listGuardians(), revokeGuardian(), updateGuardianPermissions() (+21 more)

### Community 129 - "Community 129"
Cohesion: 0.11
Nodes (30): storeCategorySchema, storeOrderSchema, storeProductSchema, categoriesFor(), getStoreProduct(), ListQuery, serializeStoreCategory(), serializeStoreProduct() (+22 more)

### Community 130 - "Community 130"
Cohesion: 0.09
Nodes (33): announcedCount(), announcementSummary(), CookFoodPhoto, MealButton, mealButtonLabel(), mealButtons(), MealButtonsInput, mealLockNote() (+25 more)

### Community 131 - "Community 131"
Cohesion: 0.07
Nodes (27): BookingError, ENDED, HOSTEL_BOOKING_TABS, HostelBookingTab, iso(), listHostelBookings(), PLATFORM_BOOKING_TABS, TransferRecord (+19 more)

### Community 132 - "Community 132"
Cohesion: 0.1
Nodes (29): bsMonthStart(), hostelCalendarDay(), hostelToday(), discountRent(), FeeScheduleRecord, hostelCalendarDay(), hostelMonthStart(), hostelToday() (+21 more)
...
Cohesion: 0.09
Nodes (27): classifyCredit(), CreditClassification, LadderClaim, LadderInvoice, MatchContext, normalizeTxnId(), ANITA_CODE, claims (+19 more)
...
Cohesion: 0.08
Nodes (23): CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, isPlanDueNotification(), readId(), body, [drawn, oldBuild, iphone], fetchMock (+15 more)
...
Cohesion: 0.09
Nodes (27): feeUpdateSchema, PATCH(), setResidentMonthlyFee(), GET(), auditPaymentAction(), createPaymentRecord(), generateMonthlyPayments(), getMonthlyPaymentMatrix() (+19 more)

### Community 140 - "Community 140"
Cohesion: 0.15
Nodes (27): changeLabel(), Column, count(), Figure, figureRow(), fittedSize(), hairline(), Ink (+19 more)

### Community 141 - "Community 141"
Cohesion: 0.08
Nodes (26): countInvoicesByStatus(), fromLedgerRow(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor(), LedgerInvoiceRow, LedgerScope, LedgerTotals (+18 more)
...
Cohesion: 0.11
Nodes (23): CSV_COLUMNS, GET(), POST(), RouteContext, POST(), safeEqual(), ClickRecord, dayKey() (+15 more)
...
Cohesion: 0.11
Nodes (26): UploadCard(), useIsUploading(), dismissUpload(), emit(), getUploadRows(), listeners, pruneUploads(), resetUploadQueue() (+18 more)
...
Cohesion: 0.1
Nodes (27): activeDevicesFor(), activeTokensFor(), androidChannel(), authHeaders(), chunk(), DeviceRow, EMPTY, ExpoDevice (+19 more)
...
Cohesion: 0.12
Nodes (22): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), SetResidentFeeInput, assertEnablable(), blockedReasonFor(), deleteGatewayConfig(), GATEWAY_REQUIREMENTS (+14 more)

### Community 150 - "Community 150"
Cohesion: 0.11
Nodes (24): AccountDeletionError, applyImmediateEffects(), cancelAccountDeletionForUser(), cancelUrlFor(), DeletionPathway, DeletionRequestRecord, getAccountDeletionStatus(), loadUser() (+16 more)
...
Cohesion: 0.14
Nodes (26): storeCartSchema, AddInput, addToCart(), CartItemRecord, CartRecord, clearCart(), emptyCart(), getCart() (+18 more)
...
Cohesion: 0.12
Nodes (17): applyUpdate(), clone(), comparable(), Doc, equals(), FakeModel, FakeQuery, getPath() (+9 more)

### Community 157 - "Community 157"
Cohesion: 0.1
Nodes (25): findOrphanClaims(), loadMatchContext(), ApprovedNotInStatementRow, approveMatchedRows(), approverNamesFor(), ClaimedNoTransactionRow, getReconciliation(), MatchedRow (+17 more)

### Community 158 - "Community 158"
Cohesion: 0.1
Nodes (22): formatDistance(), hostelCoordinates(), isUsableCoordinate(), KATHMANDU, fetchRoadRoute(), isRecord(), parseRoadRoute(), parseSteps() (+14 more)

### Community 159 - "Community 159"
Cohesion: 0.12
Nodes (23): IssuedInvoice, openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt, softmatoDocsUrl(), dueBhadra29, filed (+15 more)

### Community 160 - "Community 160"
Cohesion: 0.11
Nodes (22): issueReceiptForEvent(), IssueReceiptInput, nextReceiptNumber(), periodOfDate(), ReceiptRecord, voidReceipt(), asar, coverage (+14 more)

### Community 161 - "Community 161"
Cohesion: 0.13
Nodes (20): FILE_ASSET_KINDS, FileAssetKind, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), isPlatformOnlyAssetKind(), PLATFORM_ONLY_KINDS, DEFAULT_DOCUMENT_MIME_TYPES (+12 more)

### Community 162 - "Community 162"
Cohesion: 0.11
Nodes (21): platformPushScheduleSchema, NotificationCampaignError, PLATFORM_PUSH_AUDIENCES, platformPushSchema, addDays(), nepalWallClockToUtc(), nextOccurrence(), PushRepeat (+13 more)
...
Cohesion: 0.1
Nodes (20): DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), monthLabel(), PreviewColumn(), parseAmount() (+12 more)

### Community 167 - "Community 167"
Cohesion: 0.11
Nodes (19): applyConcessionToIssuedInvoices(), ConcessionBackfill, EMPTY, InvoiceLine, settledAmountOf(), bill, hostelId, lean() (+11 more)

### Community 168 - "Community 168"
Cohesion: 0.11
Nodes (21): analyseLuminanceTable(), containerOf(), EDITOR_MARKERS, editorFrom(), EvidenceProvenance, ExifFacts, ijgEntry(), isScreenShape() (+13 more)

### Community 169 - "Community 169"
Cohesion: 0.1
Nodes (21): ESEWA_CSV_PARSER, both, corrupted, debit, [first], FIXTURE, headerOnly, noDate (+13 more)

### Community 170 - "Community 170"
Cohesion: 0.12
Nodes (21): amountIsClose(), explain(), IDENTITY_SIGNALS, levenshtein(), MatchCandidate, MatchSignal, nameSimilarity(), nearDueDate() (+13 more)
...
Cohesion: 0.12
Nodes (19): ALLOWED_FAMILIES, ascii(), contentTypeMismatch(), Family, looksTextual(), sniffFamily(), startsWith(), CSV (+11 more)
...
Cohesion: 0.13
Nodes (19): listRecentInvoices(), approvalPeriod(), getPeriodSummary(), monthsBetween(), periodOf(), PeriodRow, PeriodSummary, august (+11 more)

### Community 185 - "Community 185"
Cohesion: 0.09
Nodes (19): claimAmount, dirname, dueAmount, eventId, fractional, hostels, invoiceBalances, invoiceId (+11 more)
...
Cohesion: 0.1
Nodes (21): FACILITY_OPTIONS, hasHostelErrors(), hasUsableRooms(), HOSTEL_PLANS, HOSTEL_STEPS, HOSTEL_TYPES, HostelAttachment, HostelErrors (+13 more)

### Community 190 - "Community 190"
Cohesion: 0.13
Nodes (19): buildProviderPayload(), firstIncompleteProviderStep(), hasProviderErrors(), isProviderStepComplete(), PROVIDER_CATEGORIES, PROVIDER_STEPS, ProviderAttachment, ProviderCategory (+11 more)

### Community 191 - "Community 191"
Cohesion: 0.17
Nodes (20): directionOf(), EMPTY_TALLY, floorToStep(), phaseOf(), shouldRepost(), tallyUploads(), UploadNotice, UploadPhase (+12 more)
...
Cohesion: 0.11
Nodes (20): added, arrangeSettlement(), catalog, dueAt, filed, hostelId, invoice(), invoiceId (+12 more)
...
Cohesion: 0.11
Nodes (14): accountDeletionRequestSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, questionCallClickSchema, purgeAccount(), runAccountDeletionPurge(), sweepAbandonedUploads() (+6 more)

### Community 197 - "Community 197"
Cohesion: 0.15
Nodes (15): DeliveryPromise, formatHour(), DEFAULT_STORE_CONFIG, PlatformSettingRecord, StoreConfig, storeConfigSchema, CartTotals, lineTotal() (+7 more)
...
Cohesion: 0.11
Nodes (21): Attendance / Night Safety, Build status (end of Phase 3), Build status (end of Phase 5 — verified 2026-08-02), code:typescript (export enum Role {), code:typescript (interface IQRActivation {), code:typescript (interface INightStatusLog {), code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {) (+13 more)
...
Cohesion: 0.11
Nodes (22): 3.1 Resident Registration, 3.2 QR Activation, 3.3 Resident Dashboard, 3.4 Payment Records, 3.5 Food Transparency, 3.6 Notice System, 3.7 Mobile Tasks, 3.8 QA Tasks (+14 more)
...
Cohesion: 0.12
Nodes (6): PublicHostelListingPage(), ComparePageSkeleton(), HostelDetailPageSkeleton(), HostelListingPageSkeleton(), InquiryPageSkeleton(), generateMetadata()

### Community 207 - "Community 207"
Cohesion: 0.13
Nodes (15): Attempt, billingPeriod(), DEFAULT_MODELS, GeminiRead, GeminiResponse, isGeminiConfigured(), keys(), models() (+7 more)
...
Cohesion: 0.14
Nodes (15): now, count(), describeFanout(), SETTLED_SOS, SosFanoutTone, sosIsFlagged(), sosIsOpen(), sosMessagePayload() (+7 more)

### Community 215 - "Community 215"
Cohesion: 0.17
Nodes (16): ApiFailure, EXTENSION_MIME, isAudio(), PickedFile, resolveFileName(), resolveMimeType(), name, parseEnvelope() (+8 more)

### Community 216 - "Community 216"
Cohesion: 0.14
Nodes (17): isUsableCoordinate(), fetchRoadRoute(), isRecord(), parseRoadRoute(), parseSteps(), RoadRoute, ROUTE_MODES, ROUTERS (+9 more)

### Community 217 - "Community 217"
Cohesion: 0.17
Nodes (17): ExistingCheckedRow, ExistingRow, ExistingRowInput, blankRow(), inputFromRow(), ListSection, listTotals(), monthName() (+9 more)

### Community 218 - "Community 218"
Cohesion: 0.18
Nodes (16): systemDocumentKind(), formatNPR(), drawCertificationStamp(), footerLine(), formatDate(), formatLongDate(), MONTHS, ReceiptPdfInput (+8 more)

### Community 219 - "Community 219"
Cohesion: 0.14
Nodes (16): ApiFailure, ApiSuccess, AuthUser, getResidentReferral(), listResidentPayments(), ResidentFoodRoutine, ResidentPayment, ResidentPaymentProof (+8 more)
...
Cohesion: 0.12
Nodes (16): bsPeriodsBetween(), monthsBetween(), periodOf(), ResidentDoc, ResidentLedger, ResidentLedgerMonth, ResidentLedgerPayment, billed (+8 more)
...
Cohesion: 0.15
Nodes (14): activateResident(), getResidentProfile(), submitResidentReview(), RootStackParamList, Props, Props, ResidentActivationScreen(), styles (+6 more)
...
Cohesion: 0.16
Nodes (15): DayRow(), AttendanceDay, AttendanceMonth, AttendanceSource, AttendanceSummary, AttendanceTone, AttendanceZone, sourceNote() (+7 more)

### Community 228 - "Community 228"
Cohesion: 0.17
Nodes (15): cityCounts(), CitySummary, featuredCities(), inCity(), servingMeals(), showcaseHostels(), counts, hostel() (+7 more)

### Community 229 - "Community 229"
Cohesion: 0.15
Nodes (12): claimNotificationSound(), claims, resetNotificationSoundClaims(), connectRealtime(), fetchConfig(), PusherModule, REALTIME_EVENT, RealtimeConfig (+4 more)
...
Cohesion: 0.16
Nodes (11): BookingReturnState, ProgressSteps(), TransitionScreen(), CheckoutReturnPage(), day(), describe(), moment(), State (+3 more)
...
Cohesion: 0.15
Nodes (18): 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, 7.1 New Hostel Pending Approval (to Superadmin), 7.2 Subscription Expiring Soon, 7. Platform Admin Emails (+10 more)
...
Cohesion: 0.23
Nodes (6): CouldNotCreateFileException, HostelHubDownloadsModule, NoContextException, NothingOpensThisException, UnreadableSourceException, UnsupportedOnThisAndroidException

### Community 240 - "Community 240"
Cohesion: 0.12
Nodes (14): amber, amount, assetId, checks, events, evidence, hostelId, invoice (+6 more)
...
Cohesion: 0.16
Nodes (15): REALTIME_TOPIC_VALUES, Listener, listeners, publishTopics(), resetResourceBus(), subscribeAllTopics(), subscribeTopics(), broken (+7 more)

### Community 244 - "Community 244"
Cohesion: 0.2
Nodes (15): nightStatusPromptSchema, formatPromptTime(), minuteIsDue(), parsePromptTime(), promptIsDue(), reminderIsDue(), duePrompts(), HostelRecord (+7 more)

### Community 245 - "Community 245"
Cohesion: 0.15
Nodes (15): active, done, down(), failed, finished, first, next, notice (+7 more)
...
Cohesion: 0.13
Nodes (15): DunningStage, nextDunningAction(), action, call, chain(), hostelId, invoices, ladder() (+7 more)
...
Cohesion: 0.29
Nodes (12): NativeNightPrompt, takeNativePendingAnswers(), NightStatusAnswer, collapseNightPrompts(), flushNightStatusQueue(), handleNightStatusResponse(), postAnswer(), dequeueNightStatus() (+4 more)
...
Cohesion: 0.16
Nodes (12): registerEmailIdentity(), PRODUCTION_RECOMMENDED, PRODUCTION_REQUIRED, ServerEnv, serverEnvSchema, serverEnvWarnings(), PRODUCTION_MINIMUM, pusher (+4 more)

### Community 261 - "Community 261"
Cohesion: 0.21
Nodes (13): NearbyStatus, hasLocationPermission(), hasPromptedForLocation(), LocationOutcome, NavigationFix, readPosition(), readPrecisePosition(), rememberLocationPrompt() (+5 more)

### Community 263 - "Community 263"
Cohesion: 0.17
Nodes (13): key(), ListingHostel, ListingProjection, projectSchedule(), RoomConfiguration, hostel, result, configuredLevel() (+5 more)

### Community 264 - "Community 264"
Cohesion: 0.18
Nodes (14): parseStatementDate(), buildPresentation(), featuresFor(), fit(), FORBIDDEN_PATTERNS, isSafe(), LIMITS, plain() (+6 more)

### Community 265 - "Community 265"
Cohesion: 0.18
Nodes (16): code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {), code:typescript ({), code:typescript (interface IMoveInChecklistItem {), code:typescript (interface IMoveOutChecklistItem {), code:typescript (interface IServiceProvider {), Complaint, ComplaintUpdate (+8 more)

### Community 266 - "Community 266"
Cohesion: 0.16
Nodes (16): 1.0 Signup One-Time Code, 1.1 Email Verification (PUBLIC Signup), 1.2 Hostel Admin Credentials (Post-Approval), 1.3 Warden Credentials, 1.4 Resident QR Activation, 1.5 Guardian Invitation, 1.6 Password Reset, 1. Authentication & Account Emails (+8 more)
...
Cohesion: 0.14
Nodes (12): nightEndsAt(), nightAnswerData(), { body, title }, chase, due, first, HOSTEL, late (+4 more)
...
Cohesion: 0.21
Nodes (12): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, BED_TYPE_LABELS, BED_TYPE_OCCUPANCY (+4 more)
...
Cohesion: 0.23
Nodes (15): AccountDeletionRequest, code:typescript ({), code:typescript (interface IAccountDeletionRequest {), code:block43 (packages/db/migrations/), code:typescript ({), code:typescript (interface IAccountDeletionRequest {), code:block46 (packages/db/migrations/), Consent & Privacy (+7 more)
...
Cohesion: 0.17
Nodes (15): 2.1 Platform Owner Hostel Approval, 2.2 Public Hostel Listing, 2.3 Inquiry Flow, 2.4 Hostel Profile Management, 2.5 Room + Bed Management, 2.6 QA Tasks, 2.7 Phase 2 Done Means, code:txt (Hostel) (+7 more)
...
Cohesion: 0.24
Nodes (4): Claim, HostelPalikaDownloadsModule, file, intent

### Community 290 - "Community 290"
Cohesion: 0.21
Nodes (12): configureNativeNightPrompt(), createAndroidChannels(), easProjectId(), fetchExpoPushToken(), forgetPushToken(), PUSH_CHANNEL, PushPermission, PushRegistration (+4 more)
...
Cohesion: 0.14
Nodes (12): KATHMANDU, distance, far, input, middle, near, oneDegree, POKHARA (+4 more)
...
Cohesion: 0.21
Nodes (13): findSuspendedHostelIds(), isOpenWhileSuspended(), liftHostelSuspension(), objectIds(), OPEN_WHILE_SUSPENDED, serializeSuspension(), SUSPENDABLE_ROLES, SUSPENSION_REASONS (+5 more)
...
Cohesion: 0.29
Nodes (14): AttendanceAlert, AttendanceLog, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({), code:typescript (interface IQuestionCallClick {), code:typescript ({) (+6 more)

### Community 301 - "Community 301"
Cohesion: 0.14
Nodes (13): 10. Location Tracking Configuration Defaults, 11. Location Tracking Defaults, 1. Prerequisites, 3. Secrets Handling, 5. Development Commands, 8. Monitoring & Logging (Production), 9. Phase 6 (Mobile) Additional Setup, 9. QuestionCall Integration (Phase 5) (+5 more)
...
Cohesion: 0.19
Nodes (9): humanizeNearbyType(), NEARBY_GLYPHS, NEARBY_GROUPS, NEARBY_ICONS, nearbyGlyph(), NearbyGroup, nearbyIcon(), groups (+1 more)

### Community 308 - "Community 308"
Cohesion: 0.26
Nodes (10): isCurrentNight(), isSelfReportable(), NIGHT_STATUS_OPTIONS, nightKey(), nightNote(), NightStanding, SelfReportableStatus, NIGHT_OF_17TH (+2 more)
...
Cohesion: 0.19
Nodes (10): formatDate(), JobCard(), OPEN_STATUSES, Pill(), PRIORITY_TONES, ProviderJob, ProviderJobsPage(), STATUS_TONES (+2 more)

### Community 312 - "Community 312"
Cohesion: 0.22
Nodes (11): candidateRoots, fillMissing(), findRepoRoot(), { loadEnvConfig }, loadRootEnv(), parseEnvFile(), require, filled (+3 more)

### Community 313 - "Community 313"
Cohesion: 0.15
Nodes (8): hostelId, localInvoiceId, now, payload, presentation, softmato, stamp, subscriptionId

### Community 314 - "Community 314"
Cohesion: 0.26
Nodes (11): decodeKey(), decryptPersonalData(), encryptionKey(), encryptPersonalData(), isPersonalDataEncryptionConfigured(), personalLookupHash(), resetPersonalDataKeyCache(), envelope (+3 more)

### Community 315 - "Community 315"
Cohesion: 0.17
Nodes (11): result, maintenanceCategorySchema, maintenanceCommentCreateSchema, maintenanceProviderAssignSchema, maintenanceRequestCreateSchema, maintenanceRequestListQuerySchema, maintenanceSettingsSchema, maintenanceStatusSchema (+3 more)
...
Cohesion: 0.22
Nodes (10): POST(), assignOrphanCredit(), listStatementImports(), GET(), assignOrphanSchema, bulkApproveStatementSchema, STATEMENT_PROVIDERS, StatementImportInput (+2 more)
...
Cohesion: 0.18
Nodes (13): 3.1 Payment Due Reminder, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails, 4.2 Complaint Status Updated, 4.3 Complaint Resolved, 4. Resident Activity Emails (+5 more)
...
Cohesion: 0.17
Nodes (10): getResidentDashboard(), listPublicHostels(), logout(), PublicHostel, ResidentDashboard, Props, PublicHomeScreen(), money() (+2 more)
...
Cohesion: 0.18
Nodes (10): CATEGORY_VISUALS, EVENT_VARIANTS, EventVariant, FALLBACK_VISUAL, NOTIFICATION_CATEGORIES, NotificationTone, comment, mention (+2 more)

### Community 331 - "Community 331"
Cohesion: 0.24
Nodes (10): containsPhrase(), NOISE, normalisePaymentName(), PATTERNS, PAYMENT_LOGO_KEYS, PaymentLogoKey, RANKED, resolvePaymentLogoKey() (+2 more)

### Community 332 - "Community 332"
Cohesion: 0.23
Nodes (10): documents, hostelForm(), many, parsed, result, emptyHostelForm(), emptyRoomRow(), form() (+2 more)
...
Cohesion: 0.17
Nodes (11): advice, bare, creditReceipt, debitReceipt, eblQrReceipt, load, noisy, read (+3 more)
...
Cohesion: 0.2
Nodes (10): listResidentGuardians(), DEFAULT_GUARDIAN_PERMISSIONS, guardianAccessCreateSchema, guardianInvitationAcceptSchema, guardianInviteSchema, guardianLoginSchema, guardianPermissionsSchema, guardianPermissionsUpdateSchema (+2 more)
...
Cohesion: 0.32
Nodes (12): code:typescript ({), code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({), FoodReadyLog, Notification, Notification, Notification (+4 more)
...
Cohesion: 0.18
Nodes (10): brandRoot, calendarRoot, config, foodRoot, { getDefaultConfig }, netinfoShim, nightRoot, path (+2 more)

### Community 352 - "Community 352"
Cohesion: 0.27
Nodes (8): ensureConfigured(), GoogleIdTokenResult, requestGoogleIdToken(), googleFailureMessage(), GoogleStatusCodes, ANDROID, IOS, message
...
Cohesion: 0.22
Nodes (10): buildHostelPayload(), capacitySummary(), firstIncompleteHostelStep(), HostelForm, numberValue(), RULES_TEMPLATES, complete, long (+2 more)

### Community 355 - "Community 355"
Cohesion: 0.29
Nodes (8): reasonLabel(), groupNightsByMonth(), nightDetail(), NightHistoryEntry, NightHistoryMonth, nightInstant(), summarizeNights(), months
...
Cohesion: 0.22
Nodes (7): AuthSession, triggerSOS(), AppNavigator(), Stack, LoginScreen(), Props, ResidentSOSScreen()
...
Cohesion: 0.31
Nodes (8): isNightStatusPrompt(), NIGHT_STATUS_ACTIONS, NIGHT_STATUS_BUTTONS, NIGHT_STATUS_REASONS, NightStatusActionId, parseNightStatusAction(), SelfReportedStatus, withInput

### Community 381 - "Community 381"
Cohesion: 0.2
Nodes (7): fresh, gone, items, next, present, snapshot, stale

### Community 382 - "Community 382"
Cohesion: 0.33
Nodes (9): askingEndsAt(), askingEndsMinuteOfNight(), isCurrentNight(), isSameNight(), minuteOfNight(), nightKey(), promptRound(), REPEAT_EVERY_OPTIONS (+1 more)
...
Cohesion: 0.22
Nodes (9): ProviderDirectoryData, DirectoryPageProps, EMPTY, generateMetadata(), metadata, ServiceProviderDirectoryPage(), ServiceProvidersPage(), getPublicServiceProviderStats() (+1 more)

### Community 385 - "Community 385"
Cohesion: 0.2
Nodes (8): args, claims, expiresAt, now, roleFlag, sessionId, sessions, users

### Community 386 - "Community 386"
Cohesion: 0.27
Nodes (8): MAP_LAYERS, mapLayer(), MapLayerId, KATHMANDU, MapCanvas, MapCanvasProps, MapHandle, MapMarker

### Community 387 - "Community 387"
Cohesion: 0.31
Nodes (10): addComplaintUpdate(), assertComplaintVoiceNote(), attachFiles(), auditComplaintAction(), createComplaint(), findAdminComplaint(), replyToComplaint(), serializeComplaint() (+2 more)

### Community 388 - "Community 388"
Cohesion: 0.2
Nodes (6): adminOfA, cases, mocks, pipeline, residentInB, wardenOfA
...
Cohesion: 0.2
Nodes (10): 7.1 Attendance Alert (Resident Absent), 7. Attendance & Location Tracking Emails, 9.1 Account Deletion Requested, 9.1a Account Deletion Request Needs Review *(added 2026-08-02)*, 9.2 Account Deletion Cancelled, 9.3 Location History Deletion Approved, 9. Account & Privacy Emails, code:typescript ({) (+2 more)
...
Cohesion: 0.27
Nodes (10): 4. Commands, Backend Tests, code:bash (npm run web:test), code:bash (npm --prefix apps/web run test:watch), code:bash (npm --prefix apps/web run test -- attendance-zone), code:bash (npm run web:build), Frontend/Web Tests, Not yet wired up (+2 more)
...
Cohesion: 0.31
Nodes (7): BUCKET_LABELS, BUCKET_ORDER, groupNotifications(), NotificationBucket, NotificationGroup, groups, NOW
...
Cohesion: 0.31
Nodes (7): keys, url, WEB_PORTAL_PATHS, WEB_PUBLIC_PATHS, WebPortalKey, webPortalUrl(), WebPublicKey

### Community 410 - "Community 410"
Cohesion: 0.36
Nodes (6): BookButton(), SIZE, BookingAvailabilityView, BookingButton, CLOSED_REASONS, open
...
Cohesion: 0.31
Nodes (7): GET(), getBillingPeriodSummary(), BillingRunInput, BillingRunQuery, billingRunQuerySchema, billingRunSchema, periodSchema
...
Cohesion: 0.32
Nodes (5): nightHistory(), NightHistoryEntry, NightHistoryLog, previousNight(), entries
...
Cohesion: 0.25
Nodes (5): collected, expiresAt, now, photoKinds, plan
...
Cohesion: 0.29
Nodes (8): 7.1 Multi-Tenant Isolation Test Template, 7.3 Privacy/Guardian Permissions Test Template, 7.5 Payment Precision Test Template, 7. Mandatory Test Templates, code:typescript (describe('GET /api/v1/hostel/rooms/:id - tenant isolation', ), code:typescript (describe('GET /api/v1/guardian/linked-resident - privacy', (), code:typescript (describe('Payment calculations - decimal precision', () => {), code:bash (npm --prefix apps/web run typecheck)
...
Cohesion: 0.43
Nodes (6): ProviderForm, clearRegistrationDraft(), DraftKind, keyFor(), readRegistrationDraft(), saveRegistrationDraft()
...
Cohesion: 0.33
Nodes (3): loadModelCatalogue(), repoRoot, shimMongoose()
...
Cohesion: 0.29
Nodes (3): mocks, principal, requestId
...
Cohesion: 0.29
Nodes (6): Email Opt-In/Opt-Out Matrix, EMAIL_SYSTEM.md — Email Triggers & Templates, Guardian Control, Implementation Checklist, Platform Control (PlatformConfig), Resident Control

### Community 467 - "Community 467"
Cohesion: 0.29
Nodes (7): 3.3 Payment Proof Uploaded (to Admin), 4.1 New Notice Posted, 5.1 SOS Triggered, 5. Safety & Emergency Emails, code:typescript ({), code:typescript ({), code:typescript ({)
...
Cohesion: 0.29
Nodes (6): listNotifications(), markNotificationRead(), NotificationItem, saveDeviceToken(), Props, ResidentNotificationsScreen()
...
Cohesion: 0.33
Nodes (4): memberId, mocks, principal, superadminId
...
Cohesion: 0.33
Nodes (6): 1.7 Account Upgraded, 2.3 Hostel Rejected, 3.2 Payment Overdue, code:typescript ({), code:typescript ({), code:typescript ({)
...
Cohesion: 0.33
Nodes (6): 7.2 Role Gate Test Template, 9.1 Seed Scripts, 9.2 Test Database Isolation, 9. Test Data & Seeding, code:typescript (describe('GET /api/v1/hostel/rooms - role access', () => {), code:bash (npm run web:lint)
...
Cohesion: 0.4
Nodes (5): createPublicInquiry(), getPublicHostel(), Props, PublicHostelDetailScreen(), rentRange()
...
Cohesion: 0.7
Nodes (3): formatMegabytes(), PUBLIC_UPLOAD_TYPES, publicUploadError()
...
## Knowledge Gaps
- **6492 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+6487 more)
...
- **Why does `cn()` connect `Community 36` to `Community 3`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 19`, `Community 20`, `Community 21`, `Community 410`, `Community 155`, `Community 29`, `Community 30`, `Community 33`, `Community 35`, `Community 39`, `Community 40`, `Community 41`, `Community 47`, `Community 49`, `Community 50`, `Community 54`, `Community 311`, `Community 60`, `Community 73`, `Community 74`, `Community 206`, `Community 82`, `Community 83`, `Community 86`, `Community 90`, `Community 95`, `Community 233`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 4` to `Community 0`, `Community 6`, `Community 11`, `Community 12`, `Community 14`, `Community 16`, `Community 17`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 27`, `Community 31`, `Community 32`, `Community 38`, `Community 42`, `Community 43`, `Community 44`, `Community 45`, `Community 51`, `Community 52`, `Community 53`, `Community 55`, `Community 58`, `Community 60`, `Community 61`, `Community 62`, `Community 64`, `Community 65`, `Community 68`, `Community 71`, `Community 75`, `Community 76`, `Community 78`, `Community 79`, `Community 84`, `Community 88`, `Community 89`, `Community 91`, `Community 94`, `Community 96`, `Community 102`, `Community 103`, `Community 104`, `Community 105`, `Community 106`, `Community 108`, `Community 110`, `Community 113`, `Community 114`, `Community 116`, `Community 120`, `Community 121`, `Community 122`, `Community 123`, `Community 125`, `Community 129`, `Community 131`, `Community 132`, `Community 134`, `Community 139`, `Community 142`, `Community 143`, `Community 147`, `Community 149`, `Community 150`, `Community 154`, `Community 157`, `Community 159`, `Community 160`, `Community 161`, `Community 162`, `Community 167`, `Community 184`, `Community 196`, `Community 197`, `Community 222`, `Community 234`, `Community 244`, `Community 297`, `Community 387`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 3` to `Community 1`, `Community 2`, `Community 5`, `Community 7`, `Community 10`, `Community 13`, `Community 15`, `Community 19`, `Community 26`, `Community 28`, `Community 29`, `Community 30`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 48`, `Community 49`, `Community 50`, `Community 59`, `Community 69`, `Community 87`, `Community 92`, `Community 99`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Are the 514 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 514 INFERRED edges - model-reasoned connections that need verification._
- **Are the 7 inferred relationships involving `useAppTheme()` (e.g. with `CommunityPostCard()` and `MediaGrid()`) actually correct?**
  _`useAppTheme()` has 7 INFERRED edges - model-reasoned connections that need verification._
- **Are the 2 inferred relationships involving `cn()` (e.g. with `TooltipContent()` and `InquiryPage()`) actually correct?**
