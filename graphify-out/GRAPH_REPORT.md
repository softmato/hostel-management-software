...
## Corpus Check
- 1932 files · ~3,318,269 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15338 nodes · 42276 edges · 525 communities (503 shown, 22 thin omitted)
...
- `POST()` --calls--> `validateFileAssetMetadata()`  [INFERRED]
  apps/web/src/app/api/v1/files/presign/route.ts → packages/shared/src/utils/file-assets.ts

## Communities (525 total, 22 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (220): PATCH(), POST(), RouteContext, GET(), POST(), PATCH(), POST(), RouteContext (+212 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (175): ICONS, LABELS, Segment, TONES, FILTERS, Pending, Overview, MoneyData (+167 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (284): loadOverview(), loadMoney(), loadToday(), AttachmentGallery(), loadFinance(), DeletionRequest, DeletionStatus, getDeletionStatus() (+276 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (225): PATCH(), RouteContext, POST(), POST(), GET(), getOpenFeeSchedule(), GET(), addHostelAdminProfilePhoto() (+217 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (191): Scanner(), CookInviteScreen(), GuardianInviteScreen(), Choice, Compass(), MapButton(), MapScreen(), ModeTab() (+183 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (129): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel() (+121 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (144): POST(), attacker, attempt(), headers, jsonRequest(), routeMocks, appBaseUrl(), authenticateWithGoogle() (+136 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (112): HostelTable(), Message(), UserRecord, GuardianDashboard, Payment, TABS, CreateWardenResult, PERMISSION_LABELS (+104 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (147): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, dayKey(), overrideAttendance(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply() (+139 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (148): formatBsPeriod(), formatBsPeriodMonth(), formatBsPeriodYear(), isBsPeriod(), periodParts(), PaymentMonthStrip(), ManageRatesScreen(), ClearFilters() (+140 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (137): FILTERS, NotificationRow(), NotificationsScreen(), TILE_GLYPH, TILE_TONES, CommunityScreen(), Composer(), CommunityBoard() (+129 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (89): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, DASHBOARD_ROLES, FACILITY_ICONS (+81 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (131): AdminCommunityReportsScreen(), AdminResidentsScreen(), NightStatusForm(), NightStatusScreen(), NotificationCard(), ProfileScreen(), ReferralRow(), ReferralsScreen() (+123 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (132): deleteResidentLocationHistory(), getResidentAttendance(), listAttendanceAlerts(), listHostelAttendance(), confirmComplaintResolution(), listResidentComplaints(), listFoodForResident(), submitFoodFeedback() (+124 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (104): FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, monthStartPeriod(), Rate, RoomTypeOption, MonthField, Ledger (+96 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (120): cookPrincipal, mocks, resolveCookLabels(), CookServiceError, resolveAdminHostelId(), announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord (+112 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (106): GET(), POST(), querySchema, RouteContext, authorUserId, mocks, postId, residentId (+98 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (101): AdminCommunityScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+93 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (110): Offset, PhotoCropper(), VideoSlot(), CollectionQrField(), FileUploadArea(), uploadPublicFile(), FileUploadArea(), isApplicationOpen() (+102 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (96): AdminMoreScreen(), ActivateScreen(), BootGate(), RootShell(), ApplyBlock(), SettingsScreen(), LoginScreen(), BrowseProfileScreen() (+88 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (100): demoteToPublicAccount(), CapacityError, claimBedForRoomType(), listAllRoomTypes(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary() (+92 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (81): AuthShell(), AuthShellProps, PANEL_COPY, SiteWordmark(), metadata, AccountDeletionPanel, ContentHeader(), ContentIntro() (+73 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (82): csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, Inquiry, LoadState, numberField() (+74 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (89): CommunityReportDialog(), REASONS, ModerationButton(), PagerButton(), normalize(), PortalSearch(), PortalTone, scoreEntry() (+81 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (83): summarizeResidentComplaints(), listResidentInvoices(), renderStatementForResident(), getResidentLedger(), monthsBetween(), periodOf(), ResidentDoc, ResidentLedger (+75 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (82): HostelAdminCooksPanel, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine, formatWeekRange() (+74 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (90): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), sitemap() (+82 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (76): assetId, hostelId, mocks, otherHostelId, principal, base, enabledAt, esewa (+68 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (93): getHostelLedger(), getResidentFinanceView(), HostelLedger, HostelLedgerEntry, InvoiceMatrix, InvoiceMatrixRow, listResidentClaims(), NotBilled (+85 more)
...
Cohesion: 0.03
Nodes (75): HostelRegistrationProgress(), Milestone, milestoneIndex(), MILESTONES, PaymentPanel(), rupees(), SubscriptionState, cityOptions (+67 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (79): GET(), POST(), GET(), POST(), GET(), DELETE(), POST(), getMyExpertConsultationRequest() (+71 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (86): PLATFORM_ROLES, deviceTokenSchema, notificationSchema, notificationCampaignSchema, input, mocks, userId, CampaignListQuery (+78 more)
...
Cohesion: 0.03
Nodes (58): deleteHostelObjects(), ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, purgeArchivedHostel(), purgeHostel() (+50 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (67): PaginationMeta, paginationQuerySchema, querySchema, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex(), HostelRecord, ListingFlagListQuery (+59 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (66): nepalMinuteOfDay(), hostelSettingsSchema, nightStatusPromptSchema, formatPromptTime(), isCurrentNight(), isSameNight(), minuteIsDue(), parsePromptTime() (+58 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (64): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult (+56 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (58): AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry() (+50 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (56): NotificationsPageContent(), Notification, MonthOption(), MonthPicker, PeriodRow, BrowserPushRow(), FILTERS, Notification (+48 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (45): AdminTabs(), HIDDEN, TABS, SosScreen(), TABS, AdminAlertsProvider(), AdminSearchBar(), ViewerBody() (+37 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (55): HostelPhotoReminder(), HostelSuggestions(), inferKind(), LightboxItem, MediaLightbox(), formatHostelAddress(), hostelTypeToUi(), mapPublicHostelToSummary() (+47 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (67): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES (+59 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (65): BAND_WIDTH, DiscoveryHeader(), DiscoveryHeaderProps, IconButton(), MapButton(), IdCardPrompt(), Point(), BLOOD_OPTIONS (+57 more)
...
Cohesion: 0.04
Nodes (62): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, aswin, bhadra (+54 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (54): ProviderStatusCard(), TILE_INK, TILE_TINT, PortalDates, AdminNightStatusRow, PlanBilling, PlanBillingInvoice, PlanBillingPayment (+46 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (65): documents, hostelForm(), many, parsed, result, buildHostelPayload(), capacitySummary(), CITY_OPTIONS (+57 more)
...
Cohesion: 0.04
Nodes (52): ComparePage(), hostels, metadata, rows, AuthGuard(), CurrentUser, MeResponse, PortalAccount() (+44 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (62): SetResidentFeeInput, setResidentMonthlyFee(), approveClaim(), assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck() (+54 more)

### Community 51 - "Community 51"
Cohesion: 0.11
Nodes (42): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), cookInvitationEmail(), guardianInvitationEmail() (+34 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (61): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+53 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (59): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), AdminTodayScreen(), AdminAlertsContext, AdminAlertsValue, AlertActions, EMPTY_COUNTS (+51 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (51): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), ServiceProvidersScreen(), DocumentScreen() (+43 more)

### Community 55 - "Community 55"
Cohesion: 0.04
Nodes (41): CancelDeletionPageContent(), AcceptResult, CookInvitePageContent, AcceptResult, GuardianInvitePageContent, DeletionQueue, DeletionRequest, PlatformAccountDeletionsPageContent (+33 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (59): fromBs(), gregorianOf(), BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary (+51 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (54): ProviderDirectoryData, notifyStaffOfJobProgress(), serviceProviderApplicationSchema, serviceProviderDocumentSchema, DirectoryPageProps, EMPTY, metadata, ServiceProviderDirectoryPage() (+46 more)

### Community 58 - "Community 58"
Cohesion: 0.05
Nodes (49): POST(), GET(), POST(), DELETE(), PATCH(), RouteContext, GET(), PATCH() (+41 more)
...
Cohesion: 0.05
Nodes (55): ReviewForm(), ReviewScreen(), NightStatusReasonCode, filterNotices(), groupNoticesByDay(), noticeCategories(), NoticeDay, NoticeStatus (+47 more)
...
Cohesion: 0.05
Nodes (36): fill(), PricingScreen(), PlanPicker(), InlineText(), PlanMark(), RAFTER, RIDGE, ROWS (+28 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (57): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthStart(), bsPeriodBounds() (+49 more)

### Community 64 - "Community 64"
Cohesion: 0.07
Nodes (44): CSV_COLUMNS, GET(), GET(), periodTotals(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS (+36 more)
...
Cohesion: 0.06
Nodes (50): paymentProofSchema, arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal (+42 more)

### Community 68 - "Community 68"
Cohesion: 0.06
Nodes (47): GATEWAY_ORDER, getHostelPayMethods(), getPayInstructions(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod (+39 more)

### Community 69 - "Community 69"
Cohesion: 0.05
Nodes (41): GET(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), getPlatformSubscriptionLedger(), cookCreateSchema, cookInvitationAcceptSchema, cookNameSchema (+33 more)
...
Cohesion: 0.05
Nodes (37): Claim, CouldNotCreateFileException, HostelHubDownloadsModule, NoContextException, NothingOpensThisException, UnreadableSourceException, UnsupportedOnThisAndroidException, amber (+29 more)

### Community 72 - "Community 72"
Cohesion: 0.06
Nodes (29): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminNoticesPage(), redirectToWorkspaceScreen() (+21 more)

### Community 73 - "Community 73"
Cohesion: 0.05
Nodes (38): financeIntegrityHash(), runGatewayHealthForHostel(), hasProvider(), IntentRow, recheckClosedAttempts(), runSettlementReconForHostel(), SettlementReconSummary, findingSchema (+30 more)
...
Cohesion: 0.06
Nodes (34): secretsMatch(), ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, attempt, fetchMock, forged (+26 more)
...
Cohesion: 0.1
Nodes (30): POST(), POST(), POST(), POST(), POST(), safeEqual(), runBillingCycleForAllHostels(), POST() (+22 more)

### Community 78 - "Community 78"
Cohesion: 0.06
Nodes (31): daysUntil(), HostelSubscriptionDueBanner(), rupees(), State, PortalShell(), navItems, navItems, GUARDIAN_NAV (+23 more)

### Community 79 - "Community 79"
Cohesion: 0.05
Nodes (37): GET(), GET(), querySchema, dayOfWeekSchema, foodFeedbackSchema, foodMenuCreateSchema, foodMenuListQuerySchema, foodMenuUpdateSchema (+29 more)

### Community 80 - "Community 80"
Cohesion: 0.1
Nodes (41): documentDownloadUrl(), issueInvoiceDocument(), openCheckoutSession(), readSettledReceipt(), ownerIdentitiesFor(), resolveOwnedHostel(), allocateReceiptNumber(), applySettlement() (+33 more)
...
Cohesion: 0.08
Nodes (39): hasGeolocation(), LocationOutcome, NavigationFix, OrientationPermission, requestDeviceLocation(), requestHeadingPermission(), Unsubscribe, watchDeviceHeading() (+31 more)
...
Cohesion: 0.09
Nodes (39): HostelScope, ResolvedDocument, resolveInvoiceDocument(), resolveReceiptDocument(), scopeFilter(), settledTotal(), trySoftmato(), InvoiceDocumentInput (+31 more)

### Community 86 - "Community 86"
Cohesion: 0.11
Nodes (34): isFileAssetKind(), isFinancialAssetKind(), DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList(), positiveInteger(), validateFileAssetMetadata() (+26 more)

### Community 87 - "Community 87"
Cohesion: 0.08
Nodes (39): GuardianHomeScreen(), GuardianMetrics(), GuardianPaymentsScreen(), GuardianSafetyScreen(), acceptGuardianInvitation(), getGuardianFood(), getGuardianNotices(), getGuardianPayments() (+31 more)

### Community 88 - "Community 88"
Cohesion: 0.06
Nodes (24): field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminMoveChecklistPage(), LoadState, NightStatusRow, Notification, optionalNumber() (+16 more)

### Community 89 - "Community 89"
Cohesion: 0.07
Nodes (29): POST(), RouteContext, DELETE(), GET(), hostelId(), GET(), RouteContext, requireHostelAdminPrincipal() (+21 more)
...
Cohesion: 0.08
Nodes (26): applyWebhook(), WebhookResult, softmato(), SoftmatoNotConfiguredError, isSoftmatoConfigured(), SoftmatoConfig, softmatoWebhookSecret(), ensureSoftmatoInvoice() (+18 more)
...
Cohesion: 0.06
Nodes (26): currency(), EmptyState(), Input(), ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent, Complaint (+18 more)

### Community 95 - "Community 95"
Cohesion: 0.13
Nodes (33): GET(), resolvePastedLink(), searchCandidates(), lookupLocation(), resolvePastedLink(), searchCandidates(), AddressParts, addressPartsFromGoogle() (+25 more)
...
Cohesion: 0.09
Nodes (36): announcedCount(), announcementSummary(), CookFoodPhoto, CookPhotoDay, FoodReadySent, MealButton, mealButtonLabel(), mealButtons() (+28 more)
...
Cohesion: 0.07
Nodes (26): Choice, HOSTEL_TYPE_LABELS, HostelPanel(), MapButton(), MapCanvas, ModeTab(), NavigationPanel(), NOTHING_CHOSEN (+18 more)

### Community 103 - "Community 103"
Cohesion: 0.07
Nodes (26): EvidenceEngine, EvidenceEngineMode, EvidenceReadFailure, OcrResult, KEYS, saved, IMAGE, lines (+18 more)

### Community 104 - "Community 104"
Cohesion: 0.11
Nodes (32): CsvTable, gridFromCsv(), peekHeaders(), readCsv(), stripBom(), stripPreamble(), buildTable(), tableFromGrid() (+24 more)
...
Cohesion: 0.08
Nodes (27): AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel, HostelAdminReportsPageContent, Overview, Report, REPORT_EXPORTS (+19 more)
...
Cohesion: 0.07
Nodes (21): Panel(), TextArea(), field(), HostelAdminMaintenancePageContent(), HostelAdminServiceProvidersPageContent(), ListingFlag, LoadState, MaintenanceRequest (+13 more)

### Community 112 - "Community 112"
Cohesion: 0.11
Nodes (33): money(), PlanCard(), listHeadingFor(), PlanCard(), CatalogueTab(), CycleDiscount(), PublicServiceDetailPage(), BillingCycle (+25 more)
...
Cohesion: 0.11
Nodes (30): mocks, allocateOrderNumber(), applyStatus(), CancelInput, cancelOrder(), CreateInput, getOrder(), ListQuery (+22 more)
...
Cohesion: 0.11
Nodes (29): ApiFailure, apiRequest(), ApiSuccess, AuthUser, confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listNotifications() (+21 more)

### Community 119 - "Community 119"
Cohesion: 0.11
Nodes (27): hostelCalendarDay(), hostelToday(), rateForRoomType(), hostelCalendarDay(), hostelMonthStart(), hostelPeriodOf(), hostelToday(), once (+19 more)
...
Cohesion: 0.1
Nodes (21): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), systemDocumentKindFromText(), distance (+13 more)

### Community 123 - "Community 123"
Cohesion: 0.11
Nodes (26): UploadCard(), useIsUploading(), dismissUpload(), emit(), getUploadRows(), isUploadActive(), listeners, pruneUploads() (+18 more)

### Community 124 - "Community 124"
Cohesion: 0.09
Nodes (27): userResidentProfileSchema, LEGACY_ROLE_MAP, Role, ROLE_VALUES, ageFromDateOfBirth(), cardPhotoImageUrl(), generateResidentId(), isCardPhotoImage() (+19 more)
...
Cohesion: 0.08
Nodes (24): DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), axisMonth(), monthLabel(), describePreference() (+16 more)
...
Cohesion: 0.13
Nodes (29): AccountDeletionRequest, AttendanceAlert, AttendanceLog, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({), code:typescript (interface IQuestionCallClick {) (+21 more)
...
Cohesion: 0.16
Nodes (26): assertMatchesExtension(), downloadAndShare(), downloadAndShareCsv(), downloadAndShareImage(), downloadToDevice(), forgetDownloadFolder(), LegacyFileSystem, loadLegacyFileSystem() (+18 more)
...
Cohesion: 0.14
Nodes (25): computeInvoiceAmount(), assertWholeRupees(), formatNPR(), isWholeRupees(), prorate(), roundToRupee(), splitAmount(), sumAmounts() (+17 more)

### Community 137 - "Community 137"
Cohesion: 0.1
Nodes (18): ratingReviewSchema, reviewModerationLogSchema, notifyHostelOfReview(), ReviewLike, auditReviewAction(), averageOf(), createResidentReview(), hideReview() (+10 more)

### Community 138 - "Community 138"
Cohesion: 0.12
Nodes (20): geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), geocodeAddress(), geocodeWithGoogle(), geocodeWithNominatim(), HostelGeoLocation (+12 more)

### Community 139 - "Community 139"
Cohesion: 0.09
Nodes (14): RouteContext, calendarDateSchema, emergencyContactCreateSchema, guardianCreateSchema, objectIdSchema, optionalHostelScopeSchema, residentCreateSchema, residentStatusSchema (+6 more)

### Community 140 - "Community 140"
Cohesion: 0.11
Nodes (21): OcrWord, accessToken(), annotateUrl(), assertion(), base64url(), billingPeriod(), boxOf(), isVisionConfigured() (+13 more)

### Community 141 - "Community 141"
Cohesion: 0.12
Nodes (17): EmailAttachment, receiptAttachment(), hostelId, mocks, receiptId, residentId, verified, paymentClearedEmail() (+9 more)
...
Cohesion: 0.15
Nodes (18): isNightStatusPrompt(), NIGHT_STATUS_ACTIONS, NIGHT_STATUS_BUTTONS, NIGHT_STATUS_REASONS, NightStatusActionId, NightStatusAnswer, parseNightStatusAction(), reasonLabel() (+10 more)
...
Cohesion: 0.09
Nodes (22): approveMatchedStatement(), assignOrphanPayment(), ReconciliationView, StatementImport, StatementProvider, Bucket, BUCKET_ORDER, Buckets (+14 more)
...
Cohesion: 0.09
Nodes (19): allBlank, blankable, parsed, paths, result, validProfile, BLOOD_GROUP_VALUES, DIETARY_PREFERENCE_VALUES (+11 more)
...
Cohesion: 0.12
Nodes (21): softmatoDocsUrl(), BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan, CYCLE_LABELS, daysUntil(), getBillingHistory() (+13 more)
...
Cohesion: 0.13
Nodes (22): canonicalize(), CLAIM_METHODS, ClaimDraft, ClaimErrors, ClaimRejection, ClaimRejectionDetails, CODE_REQUIRED_METHODS, hasErrors() (+14 more)
...
Cohesion: 0.11
Nodes (22): GET(), POST(), hostelNames(), listAllOrders(), listOrders(), statusFilter(), deliverySchema, linkUrl (+14 more)
...
Cohesion: 0.18
Nodes (23): AddInput, addToCart(), CartItemRecord, CartRecord, clearCart(), emptyCart(), getCart(), getCartCount() (+15 more)

### Community 167 - "Community 167"
Cohesion: 0.13
Nodes (16): platformSettingSchema, DeliveryPromise, formatHour(), DEFAULT_STORE_CONFIG, PlatformSettingRecord, StoreConfig, storeConfigSchema, CartTotals (+8 more)
...
Cohesion: 0.12
Nodes (18): activateResident(), getResidentProfile(), login(), submitResidentReview(), triggerSOS(), RootStackParamList, LoginScreen(), Props (+10 more)
...
Cohesion: 0.12
Nodes (10): formatDistance(), hostelCoordinates(), isUsableCoordinate(), KATHMANDU, TYPE_COLORS, AddressParts, Coordinates, GeocodePrecision (+2 more)
...
Cohesion: 0.11
Nodes (17): PublicComparePage(), PublicHostelListingPageContent(), PublicHostelQueryParams, PublicHostelReview, PublicHostelReviewData, toSearchString(), useCompareHostels(), useHostels() (+9 more)
...
Cohesion: 0.12
Nodes (16): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse (+8 more)
...
Cohesion: 0.14
Nodes (16): robots(), IssuedInvoice, OpenedCheckout, SettledReceipt, documentUrl(), InvoiceLean, PaymentLean, PlatformInvoiceRow (+8 more)
...
Cohesion: 0.12
Nodes (20): Attendance / Night Safety, Build status (end of Phase 3), Build status (end of Phase 5 — verified 2026-08-02), code:typescript (export enum Role {), code:typescript (interface INightStatusLog {), code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface INotice {) (+12 more)
...
Cohesion: 0.11
Nodes (17): distanceToPath(), hasArrived(), isOffRoute(), nextStep(), progressAlong(), projectOntoSegment(), corner, dogleg (+9 more)
...
Cohesion: 0.1
Nodes (18): both, corrupted, debit, [first], FIXTURE, headerOnly, noDate, paisa (+10 more)
...
Cohesion: 0.19
Nodes (16): IdCardData, IdCardFace, PlatformIdCardType, CardImages, renderIdCardPng(), BASE, PNG_MAGIC, types (+8 more)

### Community 214 - "Community 214"
Cohesion: 0.13
Nodes (15): GET(), getBillingPeriodSummary(), BillingRunInput, BillingRunQuery, billingRunQuerySchema, billingRunSchema, periodSchema, listStatementImports() (+7 more)

### Community 215 - "Community 215"
Cohesion: 0.13
Nodes (15): storeCategorySchema, storeProductSchema, categoriesFor(), escapeRegex(), getStoreHome(), getStoreShelves(), ListQuery, listStoreCategories() (+7 more)
...
Cohesion: 0.15
Nodes (11): ManagedInquiry, { get }, NOW, SCHEDULES, BUCKETS, inquiriesIn(), InquiryAction, inquiryActions() (+3 more)
...
Cohesion: 0.21
Nodes (13): NearbyStatus, Coordinates, hasLocationPermission(), hasPromptedForLocation(), LocationOutcome, NavigationFix, readPosition(), rememberLocationPrompt() (+5 more)
...
Cohesion: 0.22
Nodes (13): dashboardHrefForRole(), dashboardHrefForRole(), destinationForRole(), isAllowedNextPath(), isHostelWorkspacePath(), isSafeLocalPath(), landingPathForRole(), ProtectedRouteRule (+5 more)

### Community 240 - "Community 240"
Cohesion: 0.19
Nodes (15): maneuverIcon(), NavCard(), cardinalFor(), CARDINALS, chooseHeading(), directionWord(), formatManeuverDistance(), headingDifference() (+7 more)

### Community 242 - "Community 242"
Cohesion: 0.16
Nodes (15): added, arrangeSettlement(), catalog, dueAt, hostelId, invoice(), invoiceId, lateUtc (+7 more)
...
Cohesion: 0.14
Nodes (6): Footer(), IdCardFace(), initialsOf(), Portrait(), CARD_COLORS, IdCard

### Community 246 - "Community 246"
Cohesion: 0.19
Nodes (11): appBlurTarget, closeConfirm(), ConfirmRequest, emit(), getConfirmRequest(), listeners, subscribeToConfirm(), AnimatedBlurView (+3 more)

### Community 247 - "Community 247"
Cohesion: 0.19
Nodes (13): registerNightStatusCategory(), createAndroidChannels(), easProjectId(), fetchExpoPushToken(), forgetPushToken(), PUSH_CHANNEL, PushPermission, PushRegistration (+5 more)
...
Cohesion: 0.16
Nodes (15): 2.2 Hostel Approved, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, 4.2 Complaint Status Updated, 4.3 Complaint Resolved (+7 more)
...
Cohesion: 0.15
Nodes (11): AuthSession, listResidentNotices(), markNoticeAsRead(), ResidentNotice, AppNavigator(), Stack, OtpVerificationScreen(), ResidentFoodScreen() (+3 more)
...
Cohesion: 0.22
Nodes (9): isAuthBypassEnabled(), original, accessSecret(), config, proxy(), redirectToLogin(), roleLandingPath, routeAliases (+1 more)
...
Cohesion: 0.23
Nodes (13): code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {), code:typescript ({), code:typescript (interface IMoveInChecklistItem {), code:typescript (interface IMoveOutChecklistItem {), Complaint, ComplaintUpdate, Food (+5 more)
...
Cohesion: 0.39
Nodes (7): formatNpr(), itemsTable(), StoreEmailItem, storeOrderPlacedBuyerEmail(), storeOrderReceivedPlatformEmail(), storeOrderStatusBuyerEmail(), MONTH_NAMES
...
Cohesion: 0.18
Nodes (12): 2.1 Hostel Submission Received, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, 3.3 Payment Proof Uploaded (to Admin), 4.1 New Notice Posted, 5.1 SOS Triggered, 5. Safety & Emergency Emails, code:typescript ({) (+4 more)
...
Cohesion: 0.25
Nodes (10): buildPresentation(), featuresFor(), fit(), FORBIDDEN_PATTERNS, isSafe(), LIMITS, plain(), PlanTier (+2 more)

### Community 317 - "Community 317"
Cohesion: 0.22
Nodes (5): getInvoiceDetailForHostel(), readReturnState(), ReturnState, CheckoutReturnPage(), fetchInvoiceDetail()
...
Cohesion: 0.22
Nodes (8): complaintCategorySchema, complaintCreateSchema, complaintListQuerySchema, complaintReplySchema, complaintResolutionConfirmSchema, complaintStatusSchema, complaintStatusUpdateSchema, objectIdSchema
...
Cohesion: 0.25
Nodes (7): HostelAdminReconcilePageContent, labelled(), PROVIDERS, Reconciliation, StatementImportRow, Suggestion, mimeTypeForStatement()
...
Cohesion: 0.29
Nodes (6): hostelAdminReferralListQuerySchema, objectIdSchema, optionalHostelScopeSchema, referralRewardUpdateSchema, referredInquiryCreateSchema, POST()
...
Cohesion: 0.38
Nodes (5): KNOWN_PATHS, marksRoleChange(), resolvePushPath(), REWRITES, ROLE_CHANGE_TYPES
...
Cohesion: 0.29
Nodes (7): 1.4 Resident QR Activation, 1.7 Account Upgraded, 2.3 Hostel Rejected, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({)
...
Cohesion: 0.47
Nodes (5): categoryLabel(), PROVIDER_CATEGORIES, ProviderCard(), PublicProvider, PublicServiceProviderDirectoryPage()
...
## Knowledge Gaps
- **5398 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+5393 more)
...
- **Why does `cn()` connect `Community 23` to `Community 1`, `Community 5`, `Community 7`, `Community 11`, `Community 14`, `Community 18`, `Community 21`, `Community 22`, `Community 25`, `Community 26`, `Community 154`, `Community 283`, `Community 30`, `Community 39`, `Community 41`, `Community 48`, `Community 49`, `Community 185`, `Community 62`, `Community 70`, `Community 78`, `Community 88`, `Community 93`, `Community 102`, `Community 111`, `Community 112`, `Community 115`, `Community 373`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 1` to `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 14`, `Community 19`, `Community 21`, `Community 150`, `Community 22`, `Community 23`, `Community 25`, `Community 29`, `Community 33`, `Community 39`, `Community 40`, `Community 43`, `Community 46`, `Community 47`, `Community 53`, `Community 54`, `Community 59`, `Community 60`, `Community 373`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 128` to `Community 0`, `Community 2`, `Community 5`, `Community 6`, `Community 9`, `Community 140`, `Community 141`, `Community 14`, `Community 15`, `Community 17`, `Community 18`, `Community 22`, `Community 284`, `Community 28`, `Community 30`, `Community 159`, `Community 36`, `Community 41`, `Community 42`, `Community 45`, `Community 47`, `Community 177`, `Community 49`, `Community 187`, `Community 61`, `Community 63`, `Community 69`, `Community 75`, `Community 90`, `Community 91`, `Community 95`, `Community 103`, `Community 108`, `Community 125`?**
