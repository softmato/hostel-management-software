# Graph Report - hostel-management-software  (2026-08-18)

## Corpus Check
- 1370 files · ~2,187,726 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10808 nodes · 28010 edges · 452 communities (430 shown, 22 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 410 edges (avg confidence: 0.8)
...
3. `connectToDatabase()` - 333 edges
4. `cn()` - 238 edges
5. `connectToDatabase()` - 216 edges
6. `useAppTheme()` - 165 edges
...
## Communities (452 total, 22 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (245): POST(), bulkApproveSchema, POST(), POST(), GET(), GET(), getResidentLedger(), bulkApproveClaims() (+237 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (139): AdminMoreScreen(), ActivateScreen(), Scanner(), GuardianInviteScreen(), CallableRow(), IdentityCard(), PeopleSection(), SettingsScreen() (+131 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (107): ICONS, LABELS, TONES, Overview, AdminResidentsScreen(), NightStatusScreen(), Person, ProfileScreen() (+99 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (107): GET(), POST(), PATCH(), POST(), RouteContext, PATCH(), RouteContext, POST() (+99 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (95): deferLoad(), DemoDataBadge(), Hostel, HostelTable(), Inquiry, LoadState, Message(), PageHeader() (+87 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (103): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel() (+95 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (127): NightStatusForm(), CookTodayScreen(), api, bindSessionHandlers(), ApiEnvelope, unwrap(), expoHostUri(), forEmulator() (+119 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (102): PORTAL_ROWS, RootShell(), FILTERS, NotificationCard(), NotificationsScreen(), DeletionPanel(), NotificationSettings(), THEME_OPTIONS (+94 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (88): GuardianDashboard, ClaimFacts(), FLAG_LABELS, POSITIVE_FLAGS, ProofReviewModal, LedgerMonth, LedgerPayment, MonthRow() (+80 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (92): GET(), GET(), POST(), POST(), POST(), POST(), POST(), POST() (+84 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (82): deleteResidentLocationHistory(), DELETE(), checkoutSchema, POST(), POST(), listTrendingTags(), complaintCategorySchema, complaintCreateSchema (+74 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (95): listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), GET(), POST(), querySchema, RouteContext (+87 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (89): listResidentComplaints(), connectToDatabase(), PaginationMeta, paginationRange(), querySchema, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex() (+81 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (79): CommunityReportDialog(), REASONS, ConfirmOptions, MonthPicker, PeriodRow, FILTERS, Notification, NotificationRow() (+71 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (79): addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine, formatWeekRange(), HostelAdminFoodPage (+71 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (75): summarizeResidentComplaints(), dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, getFoodRoutine(), isMonthEnd() (+67 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (80): POST(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus(), OPEN_STATUSES, OverdueComplaint, runComplaintSlaCheck(), hostelId (+72 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (77): getResidentFinanceView(), InvoiceMatrix, InvoiceMatrixRow, listResidentClaims(), PortalInvoice, ResidentFinanceView, ResidentInvoiceLine, ResidentInvoiceReceipt (+69 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (68): cookPrincipal, mocks, CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError, FoodPhotoUploadInput, FoodReadyInput, getCookPortalSettings() (+60 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (70): hashUserAgent(), HostelRef, newVisitorKey(), recordHostelPageView(), resolveVisitorKey(), hostelPageViewSchema, userResidentProfileSchema, DELETE() (+62 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (60): PRIORITIES, STATUS_ACTIONS, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel, AdminReferral, FILTERS (+52 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (57): HostelSuggestions(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS (+49 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (46): GenericPortalScreen(), portalRows(), portalTitle(), hasFood(), LoadState, PublicInquiryPage(), PublicInquiryPageContent(), categoryLabel() (+38 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (55): csvField(), field(), numberField(), optionalField(), HostelAdminCommunityPageContent, HostelAdminComplaintsPage, HostelAdminDashboardPageContent, FeeSchedule (+47 more)

### Community 24 - "Community 24"
Cohesion: 0.06
Nodes (61): demoteToPublicAccount(), GET(), RouteContext, POST(), RouteContext, POST(), RouteContext, assertActiveReferralCode() (+53 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (59): IdCardFace(), BLOOD_OPTIONS, DIET_OPTIONS, GENDER_OPTIONS, ID_TYPE_OPTIONS, IdentityForm(), OCCUPATION_OPTIONS, IdCardDetail() (+51 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (61): POST(), BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan (+53 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (52): LedgerCard(), methodIcon(), methodLabel(), PayInvoiceScreen(), PROVIDER_LABEL, QrPanel(), HandoffPlan, isCheckoutFinished() (+44 more)

### Community 28 - "Community 28"
Cohesion: 0.07
Nodes (58): CommunityScreen(), Composer(), CommentThread(), CommunityPostCard(), NearbyStatus, useRealtime(), addPostComment(), CommunityComment (+50 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (38): PlatformCommunityPageContent, PlatformConfigAnnouncementsPageContent, PlatformConfigFacilitiesPageContent, FLAGS, PlatformConfigFeaturesPageContent, PlatformConfigLegalPageContent, PlatformConfigLocationsPageContent, PlatformConfigPricingPageContent (+30 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (54): SosScreen(), ViewerBody(), BottomChrome, BottomChromeContext, BottomChromeProvider(), CHROME_TIMING, useBottomChrome(), FilterSheet() (+46 more)
...
Cohesion: 0.04
Nodes (50): FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), SetResidentFeeInput, assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck, claimChecks() (+42 more)

### Community 34 - "Community 34"
Cohesion: 0.05
Nodes (53): PaginationQuery, PLATFORM_ROLES, deviceTokenSchema, notificationSchema, notificationCampaignSchema, input, mocks, userId (+45 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (38): HostelPhotoReminder(), CATEGORY_LABELS, NEARBY_GROUPS, PublicReview, PublicReviewData, RoomCard, ROUTINE_DAYS, ROUTINE_MEALS (+30 more)
...
Cohesion: 0.05
Nodes (41): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery (+33 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (35): AuthShell(), AuthShellProps, SiteWordmark(), GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse, GoogleAuthUser, GoogleCredentialResponse (+27 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (43): normalize(), PortalSearch(), PortalTone, scoreEntry(), toneStyles, iconMap, IconName, NavItem (+35 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (50): GATEWAY_ORDER, getPayInstructions(), InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice(), assertQrAssetUsable() (+42 more)
...
Cohesion: 0.04
Nodes (39): fadeUp, Feature, features, heroSlides, PublicHostelRegistrationLandingPage(), stagger, stats, cityOptions (+31 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (31): CurrentUser, DASHBOARD_ROLES, dashboardHrefForRole(), hasDashboard(), MeResponse, moreItems, navItems, providerNavItems (+23 more)
...
Cohesion: 0.05
Nodes (38): AuthGuard(), CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing (+30 more)
...
Cohesion: 0.07
Nodes (43): UploadCard(), useIsUploading(), EMPTY_TALLY, floorToStep(), phaseOf(), shouldRepost(), tallyUploads(), active (+35 more)

### Community 49 - "Community 49"
Cohesion: 0.06
Nodes (43): dispatchOtpChallenge(), findVerifiedRegistrationChallenge(), generateOtpCode(), GOOGLE_JWKS, hashOtpCode(), normalizeEmail(), normalizeOtpIdentifier(), normalizePhone() (+35 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (42): notificationPreferenceSchema, DEFAULT_NOTIFICATION_PREFERENCE, filterPushRecipients(), NotificationPreference, PreferenceRecord, mocks, night, isWithinQuietHours() (+34 more)
...
Cohesion: 0.06
Nodes (33): ComparePage(), hostels, metadata, rows, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), PlatformDashboardPageContent(), PlatformUsersPageContent() (+25 more)

### Community 54 - "Community 54"
Cohesion: 0.08
Nodes (42): collectionTotals(), invoicesByIds(), platformRollup(), getHostelViewStats(), foodFeedbackSchema, listingFlagSchema, paymentProofSchema, ratingReviewSchema (+34 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (39): serviceProviderApplicationSchema, serviceProviderDocumentSchema, hostelId, mocks, providerId, ACTIVE_APPLICATION_STATUSES, approveServiceProvider(), auditProviderAction() (+31 more)

### Community 56 - "Community 56"
Cohesion: 0.05
Nodes (26): field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminMoveChecklistPage(), HostelAdminSOSAlertsPage(), LoadState, NightStatusRow, Notification (+18 more)

### Community 57 - "Community 57"
Cohesion: 0.06
Nodes (38): addComplaintUpdate(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput, ComplaintListQuery (+30 more)

### Community 58 - "Community 58"
Cohesion: 0.07
Nodes (27): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminNightStatusPage(), redirectToWorkspaceScreen(), HostelAdminMaintenancePageContent(), HostelAdminReferralsPageContent() (+19 more)

### Community 59 - "Community 59"
Cohesion: 0.07
Nodes (40): GET(), POST(), requireSuperadminPrincipal(), resetEmailIdentityCache(), GET(), PUT(), saveOperationsConfig(), updateSiteConfigSection() (+32 more)
...
Cohesion: 0.08
Nodes (36): DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList(), positiveInteger(), validateFileAssetMetadata(), ImageVariantRecord, optimizeImage() (+28 more)
...
Cohesion: 0.09
Nodes (34): appBaseUrl(), AuthServiceError, dispatchVerificationEmail(), requestPasswordReset(), resendVerificationEmail(), resetPasswordWithToken(), revokeAllSessions(), signupWithEmailVerification() (+26 more)

### Community 64 - "Community 64"
Cohesion: 0.07
Nodes (33): GET(), getAttendanceConfig(), getAttendanceSettings(), listAttendanceAlerts(), listHostelAttendance(), overrideAttendance(), recordConsent(), resolveAdminHostelId() (+25 more)

### Community 65 - "Community 65"
Cohesion: 0.08
Nodes (42): directionFlags(), evidenceFlags(), payeeFlags(), AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance() (+34 more)
...
Cohesion: 0.09
Nodes (37): GET(), resolvePastedLink(), searchCandidates(), geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), hostelAdminGeocodeQuerySchema (+29 more)

### Community 68 - "Community 68"
Cohesion: 0.11
Nodes (25): BootGate(), GuardianLoginScreen(), BrandSplash(), AuthDivider(), GoogleSignInButton(), InquiryFields(), logo, accentForAccount() (+17 more)
...
Cohesion: 0.07
Nodes (25): metadata, LegalBody(), buildValues(), PublicAboutPage(), values, buildPosts(), posts, PublicBlogPage() (+17 more)

### Community 71 - "Community 71"
Cohesion: 0.07
Nodes (33): AdminAlertsScreen(), AdminOverviewScreen(), loadOverview(), load, alertCounts(), AlertKind, AlertRow, buildAlertFeed() (+25 more)
...
Cohesion: 0.07
Nodes (26): POST(), POST(), POST(), CronAuthResult, normalizeSecret(), safeEqual(), validateCronRequest(), POST() (+18 more)

### Community 76 - "Community 76"
Cohesion: 0.09
Nodes (29): dateForDay(), MEAL_TYPES, MealType, mealTypeNow(), nepalClock(), ROUTINE_DAYS, RoutineDay, tuesday (+21 more)

### Community 77 - "Community 77"
Cohesion: 0.07
Nodes (27): referralSchema, referralCodeSchema, referralRewardSchema, residentSchema, getResidentReferral(), HostelAdminReferralListQuery, normalizeObjectIds(), referralCodeCandidate() (+19 more)
...
Cohesion: 0.1
Nodes (26): outstandingForResident(), depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, providedItemSchema, auditMoveAction(), createMoveInChecklist(), createMoveOutChecklist() (+18 more)
...
Cohesion: 0.07
Nodes (22): EmptyState(), Select(), TextArea(), field(), HostelAdminReportsPageContent(), HostelAdminServiceProvidersPageContent(), ListingFlag, LoadState (+14 more)

### Community 83 - "Community 83"
Cohesion: 0.21
Nodes (21): POST(), authenticateWithGoogle(), logout(), POST(), loginGuardian(), accessTokenTtlSeconds(), parseDurationSeconds(), refreshTokenTtlSeconds() (+13 more)
...
Cohesion: 0.08
Nodes (29): countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor(), LedgerInvoiceRow, ledgerPipeline() (+21 more)
...
Cohesion: 0.14
Nodes (24): GET(), periodTotals(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS, neutralize(), csv (+16 more)

### Community 91 - "Community 91"
Cohesion: 0.08
Nodes (21): currency(), Input(), StatusBadge(), ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, Complaint, field() (+13 more)

### Community 92 - "Community 92"
Cohesion: 0.1
Nodes (24): buildHtml(), boundsCenter(), haversineMeters(), hostelCoordinates(), HostelWithDistance, isUsableCoordinate(), KATHMANDU, sortByDistance() (+16 more)
...
Cohesion: 0.12
Nodes (24): POST(), accountDeletionRequestSchema, AccountDeletionError, applyImmediateEffects(), cancelAccountDeletionByToken(), cancelAccountDeletionForUser(), cancelUrlFor(), DeletionPathway (+16 more)

### Community 96 - "Community 96"
Cohesion: 0.11
Nodes (22): noticeSchema, noticeReadStatusSchema, auditNoticeAction(), broadcastNotice(), createNotice(), definedUpdate(), markNoticeAsRead(), normalizeObjectIds() (+14 more)
...
Cohesion: 0.08
Nodes (17): csvField(), field(), Hostel, HostelAdminProfilePageContent(), Inquiry, LoadState, numberField(), optionalField() (+9 more)

### Community 100 - "Community 100"
Cohesion: 0.13
Nodes (20): FALLBACK, SiteConfigContext, SiteConfigProvider(), useFeatureFlag(), platformSettingSchema, DEFAULT_SITE_CONFIG, coerceSection(), getPublicSiteConfig() (+12 more)
...
Cohesion: 0.13
Nodes (19): isAuthBypassEnabled(), original, dashboardHrefForRole(), destinationForRole(), isAllowedNextPath(), isHostelWorkspacePath(), isSafeLocalPath(), landingPathForRole() (+11 more)
...
Cohesion: 0.13
Nodes (21): CheckoutStatus, closeIntent(), expireStaleIntents(), handleProviderCallback(), IntentRecord, isUnconfirmable(), markSucceeded(), PaymentIntentView (+13 more)

### Community 106 - "Community 106"
Cohesion: 0.09
Nodes (21): confirmSettlementByStatement(), statementImportSchema, importStatement(), ingest(), loadStatementAsset(), periodOf(), readStatementBytes(), readStatementText() (+13 more)
...
Cohesion: 0.16
Nodes (18): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, POST() (+10 more)
...
Cohesion: 0.13
Nodes (19): DELETE(), POST(), createPlatformNotificationCampaign(), listHostelNotificationCampaigns(), listPlatformNotificationCampaigns(), statsForCampaigns(), revokeDeviceToken(), saveDeviceToken() (+11 more)
...
Cohesion: 0.15
Nodes (8): TABS, TABS, RoleTabs(), TabDef, TABS, TABS, TABS, TABS
...
Cohesion: 0.13
Nodes (15): POST(), POST(), RouteContext, acceptGuardianInvitation(), listResidentGuardians(), revokeGuardianAccess(), DEFAULT_GUARDIAN_PERMISSIONS, guardianAccessCreateSchema (+7 more)
...
Cohesion: 0.14
Nodes (15): progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster(), UploadRow, useIsHydrated(), toast (+7 more)

### Community 155 - "Community 155"
Cohesion: 0.13
Nodes (17): Offset, PhotoCropper(), UploadStack(), isActive(), useUploadStore, AttachedFile(), FileUploaderPresentation, FileUploaderProps (+9 more)

### Community 156 - "Community 156"
Cohesion: 0.15
Nodes (15): listRecentInvoices(), approvalPeriod(), getPeriodSummary(), monthsBetween(), periodOf(), PeriodRow, PeriodSummary, august (+7 more)
...
Cohesion: 0.11
Nodes (18): 1. Blockers — the app is broken in production until these are done, 2. M6 — finish public discovery, 3. M1–M5 — the open items that are code, not a device pass, 4. UI defects from the audit, 5. Screen-by-screen UI pass, 6. Device pass — [device], after everything above, 7. Found along the way, code:bash (npm run mobile:typecheck && npm run mobile:lint && npm run m) (+10 more)
...
Cohesion: 0.13
Nodes (12): ADMIN_ISSUABLE_ROLES, AdminIssuableRole, generateTemporaryPassword(), HIGH_PRIVILEGE_ROLES, loginUrl(), RegisterOrUpgradeInput, registerOrUpgradeUserByEmail(), ROLE_LABELS (+4 more)
...
Cohesion: 0.16
Nodes (13): CSV_COLUMNS, GET(), POST(), RouteContext, POST(), safeEqual(), getQuestionCallAnalytics(), recordQuestionCallConversion() (+5 more)

### Community 170 - "Community 170"
Cohesion: 0.18
Nodes (15): FileUploadArea(), EXTENSION_BY_MIME, FAMILY_BYTES, FAMILY_ORDER, familyOf(), joinTypes(), KIND_RULES, KindRule (+7 more)
...
Cohesion: 0.14
Nodes (17): 2.2 Hostel Approved, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, 4.2 Complaint Status Updated, 4.3 Complaint Resolved (+9 more)

### Community 189 - "Community 189"
Cohesion: 0.14
Nodes (12): AuthSession, getResidentProfile(), requestOtp(), signInWithGoogle(), AppNavigator(), Stack, Profile, Props (+4 more)
...
Cohesion: 0.12
Nodes (15): announcementSchema, emailSchema, facilitiesSchema, featuresSchema, heroSchema, identitySchema, legalSchema, locationsSchema (+7 more)
...
Cohesion: 0.22
Nodes (13): ReferralBody(), ReferralSummary, buildReferralShare(), describeRewards(), referralAppLink(), referralShareUrl(), referralStatusLabel(), referralTiles() (+5 more)
...
Cohesion: 0.17
Nodes (11): buckets, clientKey(), positiveInteger(), publicFormLimit(), PublicFormRateLimitOptions, publicFormWindowMs(), RateLimitBucket, resetPublicFormRateLimitForTests() (+3 more)
...
Cohesion: 0.32
Nodes (12): AttendanceAlert, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript (interface IQuestionCallClick {), code:typescript ({), Community Feature, CommunityComment (+4 more)
...
Cohesion: 0.22
Nodes (8): cookPrincipal, cookUserId, DAY_NAMES, leanResult(), mocks, residentUserId, routineWithLunch(), staffPrincipal
...
Cohesion: 0.27
Nodes (8): cook, assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES, PermissionError, Principal, roleLandingPath
...
Cohesion: 0.22
Nodes (5): MockSessionModel, owner, serviceMocks, session, user
...
## Knowledge Gaps
- **3969 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+3964 more)
...
- **Why does `Button()` connect `Community 2` to `Community 1`, `Community 132`, `Community 5`, `Community 4`, `Community 7`, `Community 8`, `Community 13`, `Community 14`, `Community 23`, `Community 25`, `Community 27`, `Community 29`, `Community 30`, `Community 35`, `Community 39`, `Community 43`, `Community 68`, `Community 73`, `Community 76`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 13` to `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 14`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 154`, `Community 155`, `Community 29`, `Community 31`, `Community 35`, `Community 38`, `Community 39`, `Community 41`, `Community 42`, `Community 43`, `Community 170`, `Community 46`, `Community 53`, `Community 68`, `Community 70`, `Community 78`, `Community 218`, `Community 91`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `Role` connect `Community 69` to `Community 0`, `Community 3`, `Community 4`, `Community 135`, `Community 9`, `Community 10`, `Community 11`, `Community 268`, `Community 269`, `Community 266`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 267`, `Community 21`, `Community 24`, `Community 285`, `Community 288`, `Community 37`, `Community 38`, `Community 167`, `Community 168`, `Community 43`, `Community 44`, `Community 49`, `Community 306`, `Community 307`, `Community 180`, `Community 51`, `Community 179`, `Community 305`, `Community 57`, `Community 59`, `Community 61`, `Community 66`, `Community 323`, `Community 324`, `Community 325`, `Community 326`, `Community 72`, `Community 329`, `Community 210`, `Community 93`, `Community 94`, `Community 95`, `Community 230`, `Community 103`, `Community 106`, `Community 248`, `Community 249`, `Community 250`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Are the 328 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 328 INFERRED edges - model-reasoned connections that need verification._
- **What connects `{ defineConfig }`, `expoConfig`, `path` to the rest of the system?**
  _3969 weakly-connected nodes found - possible documentation gaps or missing edges._
