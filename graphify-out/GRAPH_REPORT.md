...
## Corpus Check
- 2341 files · ~5,129,721 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21153 nodes · 59728 edges · 600 communities (563 shown, 37 thin omitted)
...
## Communities (600 total, 37 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.0
Nodes (505): 978(), [A,P], abort(), Ac(), {actionStateRoute:v,navigationState:P}, activate(), activeThemeId(), {addKeyedListener:i} (+497 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (355): GET(), POST(), GET(), PATCH(), POST(), RouteContext, GET(), GET() (+347 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (419): POST(), bulkApproveSchema, POST(), POST(), POST(), feeUpdateSchema, PATCH(), auditFinanceAction() (+411 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (384): answerSchema, POST(), AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+376 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (201): ICONS, LABELS, Segment, TONES, FILTERS, Pending, MoneyData, MANAGE_ROWS (+193 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (238): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel() (+230 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (224): Scanner(), CookInviteScreen(), GuardianInviteScreen(), Choice, MapButton(), MapScreen(), ModeTab(), NOTHING_CHOSEN (+216 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (270): loadOverview(), loadMoney(), loadToday(), loadFinance(), getAdminFoodRoutine(), getAdminHostel(), getAdminInvoices(), getAdminMaintenance() (+262 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (237): PATCH(), RouteContext, GET(), getOpenFeeSchedule(), GET(), listPublicFoodRoutine(), recordListingAppearances(), addHostelAdminInquiryNote() (+229 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (162): FieldCashRow, PlanPaymentClaim, formatBsAdDate(), DemoDataBadge(), Hostel, HostelTable(), ReportGrid(), ReportRecord (+154 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (231): aa(), Ad(), af(), ai(), Al(), an(), as(), ba() (+223 more)

### Community 11 - "Community 11"
Cohesion: 0.01
Nodes (195): DiscoveryHeader(), MealCard(), cropToGuide(), FILL, GuidedCapture(), GUIDES, GuideShape, loadManipulator() (+187 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (175): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), Overview, AdminTodayScreen(), SosScreen(), HOSTEL, MONTHS (+167 more)

### Community 13 - "Community 13"
Cohesion: 0.01
Nodes (143): LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminMoveChecklistPage() (+135 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (86): number(), toNumber(), toNumber(), _(), 276(), 601(), a(), add() (+78 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (166): generateMetadata(), generateMetadata(), manifest(), Entry, hostelEntries(), locationEntries(), sitemap(), STATIC_ROUTES (+158 more)

### Community 16 - "Community 16"
Cohesion: 0.01
Nodes (144): adminPrincipal, mocks, PLATFORM_LIMITS, authorUserId, leanResult(), mocks, postId, reactorUserId (+136 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (152): AdminMoreScreen(), ActivateScreen(), BootGate(), RootShell(), NotificationsScreen(), DeletionPanel(), NotificationSettings(), SETTINGS_TITLES (+144 more)
...
Cohesion: 0.03
Nodes (151): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, runPlanDueReminders(), notifyHostelOfNewPost() (+143 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (125): POST(), POST(), POST(), POST(), runBillingCycleForAllHostels(), POST(), runGatewayHealth(), POST() (+117 more)

### Community 21 - "Community 21"
Cohesion: 0.06
Nodes (123): accountDeletionCancelledEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), ATTACHED, dueWhen(), payOnWebsite() (+115 more)
...
Cohesion: 0.02
Nodes (132): BookButton(), SIZE, BookingAvailabilityView, BookingButton, CLOSED_REASONS, open, PublicComparePage(), formatHostelAddress() (+124 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (164): MESSAGES, POST(), RouteContext, serializeAuditLog(), BookingEndCause, HostelBookingClosedCause, announceConfirmed(), announceEnding() (+156 more)

### Community 25 - "Community 25"
Cohesion: 0.02
Nodes (137): EMPTY_PAYOUT_DRAFT, METHODS, PayoutAccountDraft, PayoutAccountFields(), payoutAccountPayload(), DescriptionFacts, DescriptionSuggestions(), HostelType (+129 more)

### Community 26 - "Community 26"
Cohesion: 0.02
Nodes (142): NightStatusForm(), ReviewForm(), ReviewScreen(), AlertRow(), describeGrants(), GuardianRow(), PermissionSheet(), InviteGuardianScreen() (+134 more)

### Community 27 - "Community 27"
Cohesion: 0.02
Nodes (27): Render the pamphlet.  One master per side: A4 + 3 mm bleed at 600 dpi. The A4, shoot(), __addChild(), cancelEvent(), composedPath(), forceInvalidate(), __getChildren(), __getNativeConfig() (+19 more)

### Community 28 - "Community 28"
Cohesion: 0.02
Nodes (133): collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor() (+125 more)

### Community 29 - "Community 29"
Cohesion: 0.02
Nodes (127): POST(), AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, summarizeResidentComplaints(), listResidentInvoices() (+119 more)

### Community 30 - "Community 30"
Cohesion: 0.02
Nodes (40): addChangeListener(), addEventListener(), addListenerForTag(), attachGestureHandler(), bf(), clearInteractionHandle(), configureNextLayoutAnimation(), createGestureHandler() (+32 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (137): BookingForm(), CheckoutScreen(), METHODS, PackageCard(), PayStep(), roomPhotoUris(), StatusCard(), SORTS (+129 more)

### Community 32 - "Community 32"
Cohesion: 0.02
Nodes (107): Platform, InvoiceRow(), PaymentRow(), PlanCard(), rupees(), shortDate(), STATUS_TONE, ConcessionBackfill (+99 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (140): 594(), _adopt(), _animationLoop(), ar(), assignAnimationToWorker(), at(), bn(), broadcastMessage() (+132 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (124): CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard(), AmountCard(), AdminLedger, AdminLedgerEntry (+116 more)

### Community 35 - "Community 35"
Cohesion: 0.02
Nodes (139): AdminCommunityReportsScreen(), AdminResidentsScreen(), NightStatusHistoryScreen(), NightStatusScreen(), nightAnswerText(), NightPromptAnswer(), NotificationCard(), NotificationRow() (+131 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (108): AdminCommunityScreen(), CommunityScreen(), Composer(), AttachmentGallery(), useReportedCount(), AnimatedBlurView, CommunityBoard(), CommunityBoardProps (+100 more)

### Community 37 - "Community 37"
Cohesion: 0.02
Nodes (122): AdminMoneyScreen(), AdminAlertsContext, AdminAlertsValue, AlertActions, EMPTY_COUNTS, ICONS, LABELS, QUICK_REJECT_REASONS (+114 more)

### Community 38 - "Community 38"
Cohesion: 0.02
Nodes (96): BubbleBackground(), BubbleBackgroundProps, BubbleColors, StarLayer(), StarLayerProps, StarsBackground(), StarsBackgroundProps, currentBsPeriod() (+88 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (106): AdminTabs(), HIDDEN, RoleLayout(), TABS, invalidateFeeds(), writeFeedRead(), TABS, AdminAlertsProvider() (+98 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (103): PUBLIC_CACHE, escapeRegex(), notifyStaffOfJobProgress(), addHistory(), addMaintenanceComment(), assertBedInHostel(), assertProviderApproved(), assertRoomInHostel() (+95 more)
...
Cohesion: 0.04
Nodes (101): GET(), POST(), querySchema, RouteContext, AnnouncementInput, CommentCreateInput, commentOnPost(), CommentRecord (+93 more)

### Community 43 - "Community 43"
Cohesion: 0.03
Nodes (84): metadata, AccountDeletionPanel, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails() (+76 more)

### Community 44 - "Community 44"
Cohesion: 0.03
Nodes (93): CheckoutHandoffButton(), grabDocument(), PayPlanPanel(), rupees(), HostelRegistrationProgress(), Milestone, milestoneIndex(), MILESTONES (+85 more)
...
Cohesion: 0.02
Nodes (38): assert(), bubbles(), cancelable(), cancelBubble(), composed(), computeBlankness(), currentTarget(), deactivateAndFlush() (+30 more)
...
Cohesion: 0.04
Nodes (94): storeCartSchema, storeCategorySchema, storeProductSchema, DELETE(), PATCH(), RouteContext, AddInput, addToCart() (+86 more)

### Community 49 - "Community 49"
Cohesion: 0.03
Nodes (75): FILTERS, Notification, NotificationRow(), PushState, FILTERS, NotificationCard, NotificationsPageContent, blankRow() (+67 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (88): robots(), documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt (+80 more)

### Community 51 - "Community 51"
Cohesion: 0.03
Nodes (92): CHANNELS, ClaimedStep, composeEmail(), composeNotice(), composePlanDueNotice(), deliver(), deliverEmail(), deliverStep() (+84 more)

### Community 52 - "Community 52"
Cohesion: 0.02
Nodes (11): build(), createInteractionHandle(), getImageAsync(), getStringAsync(), impactAsync(), notificationAsync(), replace(), s (+3 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (82): cookPrincipal, mocks, resolveCookLabels(), announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError (+74 more)

### Community 54 - "Community 54"
Cohesion: 0.04
Nodes (81): CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing, buildIdCardData() (+73 more)

### Community 55 - "Community 55"
Cohesion: 0.04
Nodes (75): GET(), BookableHostel, BookingUnavailableReason, findRoom(), hostelAddress(), HostelAvailability, hostelCoverPhoto(), hostelCoverPhotos() (+67 more)
...
Cohesion: 0.03
Nodes (81): openStore(), CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), methodProvider(), PROVIDER_LABEL (+73 more)

### Community 59 - "Community 59"
Cohesion: 0.03
Nodes (27): activeAnimationId(), addPendingGesture(), animation_id(), ensureConfig(), f(), get_slot_str(), get_slot_type(), get_slots_str() (+19 more)
...
Cohesion: 0.04
Nodes (73): fill(), money(), PlanCard(), PricingScreen(), BillingInvoiceRow, BillingPaymentRow, BillingPlan, metadata (+65 more)

### Community 62 - "Community 62"
Cohesion: 0.03
Nodes (60): ExistingResidentsPanel(), Props, ExistingResidentsSheet(), HostelAdminCooksPanel, HostelAdminExistingResidentsPage(), addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings (+52 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (64): otpResendCooldownMs(), softmatoDocsUrl(), dueBhadra29, filed, throughAswin25, BillingHistory, CYCLE_LABELS, cycleLabel() (+56 more)
...
Cohesion: 0.06
Nodes (53): checkoutDocumentFor(), softmatoDocumentNumbers(), gateway, invoice, updateOne, checkFieldCash(), submitFieldCash(), readReturnState() (+45 more)

### Community 66 - "Community 66"
Cohesion: 0.05
Nodes (69): demoteToPublicAccount(), findCardBooking(), findHeldBooking(), GET(), RouteContext, releaseGuardianAccounts(), emergencyContactSchema, assertActiveReferralCode() (+61 more)
...
Cohesion: 0.04
Nodes (60): CardBooking, checkInBooking(), returnHeldBed(), takeHeldBed(), account, answerBy, before, book() (+52 more)
...
Cohesion: 0.05
Nodes (51): existingResidentListSchema, existingResidentRowSchema, BillPreview, CheckContext, CheckedRow, checkExistingResidents(), CheckResult, monthLabel() (+43 more)
...
Cohesion: 0.03
Nodes (44): ConcessionChange, liveUserIds(), notifyRentConcession(), connect, userSchema, accountId, adminId, booking (+36 more)

### Community 74 - "Community 74"
Cohesion: 0.05
Nodes (56): DetailsCard(), InvoiceDetailScreen(), InvoiceHeaderBlock(), LedgerCard(), CheckoutStatus, getCheckoutStatus(), getPayInstructions(), InvoiceLine (+48 more)
...
Cohesion: 0.07
Nodes (50): resolvePastedLink(), searchCandidates(), geocodeAndCacheHostel(), HostelGeoRecord, lookupLocation(), resolvePastedLink(), searchCandidates(), AddressParts (+42 more)
...
Cohesion: 0.06
Nodes (51): deliver(), hostelOrThrow(), notifyPlatformOfPayoutReview(), PayoutAccountStatus, PayoutAccountView, PayoutActor, PayoutRecord, revealHostelPayoutAccount() (+43 more)

### Community 79 - "Community 79"
Cohesion: 0.07
Nodes (47): getInvoiceDetailForHostel(), BOOKING_DOCUMENT_KINDS, BookingDocumentKind, bookingDocumentLayout(), refundPolicyNotes(), allowed(), bookingDocumentResponse(), BookingDocumentScope (+39 more)

### Community 80 - "Community 80"
Cohesion: 0.06
Nodes (50): GET(), GET(), acceptPlatformAdminInvitation(), AcceptPlatformAdminInvitationInput, appUrl(), checkPlatformAdminEmail(), daysFromNow(), EmailAvailability (+42 more)

### Community 81 - "Community 81"
Cohesion: 0.04
Nodes (49): Faq, PlatformConfigSeoPageContent, Step, CONTENT_ICON_SLUGS, everything, IDENTITY, page, rendered (+41 more)

### Community 82 - "Community 82"
Cohesion: 0.05
Nodes (46): chelseaMarket, geistMono, geistSans, metadata, poppins, RootLayout(), ComparePage(), generateMetadata() (+38 more)
...
Cohesion: 0.07
Nodes (41): appBaseUrl(), CLAIMABLE_STATUSES, dispatchOtpChallenge(), dispatchVerificationEmail(), findVerifiedRegistrationChallenge(), GOOGLE_JWKS, normalizeEmail(), normalizePhone() (+33 more)

### Community 86 - "Community 86"
Cohesion: 0.06
Nodes (48): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES (+40 more)

### Community 87 - "Community 87"
Cohesion: 0.07
Nodes (51): evidenceFlags(), payeeFlags(), AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance(), deadline() (+43 more)

### Community 88 - "Community 88"
Cohesion: 0.06
Nodes (47): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags() (+39 more)

### Community 89 - "Community 89"
Cohesion: 0.06
Nodes (46): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsMonthStart() (+38 more)
...
Cohesion: 0.07
Nodes (41): addComplaintUpdate(), assertComplaintVoiceNote(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput (+33 more)
...
Cohesion: 0.05
Nodes (37): pushTicketSchema, activeDevicesFor(), activeTokensFor(), androidChannel(), authHeaders(), chunk(), DeviceRow, EMPTY (+29 more)
...
Cohesion: 0.1
Nodes (36): bodySchema, POST(), POST(), RouteContext, computePerceptualHash(), r2Configured(), storePublicAsset(), AccessLevel (+28 more)
...
Cohesion: 0.07
Nodes (33): attacker, attempt(), headers, jsonRequest(), routeMocks, generateOtpCode(), hashOtpCode(), normalizeOtpIdentifier() (+25 more)
...
Cohesion: 0.18
Nodes (27): POST(), POST(), authenticateWithGoogle(), AuthServiceError, logout(), POST(), loginGuardian(), errorResponse() (+19 more)
...
Cohesion: 0.09
Nodes (36): hostelSettingsSchema, nightStatusPromptSchema, askingEndsAt(), askingEndsMinuteOfNight(), formatPromptTime(), isCurrentNight(), isSameNight(), minuteIsDue() (+28 more)
...
Cohesion: 0.1
Nodes (37): personalLookupHash(), userResidentProfileSchema, LEGACY_ROLE_MAP, Role, ROLE_VALUES, ageFromDateOfBirth(), ASSET_KINDS, cardPhotoImageUrl() (+29 more)

### Community 108 - "Community 108"
Cohesion: 0.08
Nodes (32): accountDeletionRequestedEmail(), POST(), deviceTokenSchema, AccountDeletionError, applyImmediateEffects(), cancelAccountDeletionByToken(), cancelAccountDeletionForUser(), cancelUrlFor() (+24 more)
...
Cohesion: 0.1
Nodes (32): POST(), RealtimeConfig, RealtimeContext, RealtimeContextValue, RealtimeNotification, RealtimeProvider(), useRealtime(), GET() (+24 more)
...
Cohesion: 0.08
Nodes (28): CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES, avatarTone() (+20 more)
...
Cohesion: 0.1
Nodes (30): assertPrimaryCredentialPrincipal(), PLATFORM_SETTING_CHANGE_STATUSES, platformSettingChangeSchema, GET(), PUT(), saveOperationsConfig(), isSettingChangeKey(), cancelSettingChange() (+22 more)
...
Cohesion: 0.1
Nodes (25): isAuthBypassEnabled(), original, CookieReader, hasSessionCookie(), LEGACY_ACCESS_TOKEN_COOKIES, LEGACY_REFRESH_TOKEN_COOKIES, readAccessTokenCookie(), readRefreshTokenCookieValue() (+17 more)
...
Cohesion: 0.06
Nodes (25): ATTENDANCE_DEFAULTS, afterMidnight, evening, meters, mocks, once, residentId, residentPrincipal (+17 more)
...
Cohesion: 0.11
Nodes (30): cellAt(), focusCell(), INPUT_MODES, Props, ListRow, RowField, amountText(), blankSheetRow() (+22 more)
...
Cohesion: 0.14
Nodes (28): changePassword(), getCurrentUser(), isApprovedServiceProvider(), issueSessionForUser(), login(), publicUser(), refreshAccessToken(), sameIds() (+20 more)
...
Cohesion: 0.11
Nodes (25): UploadCard(), useIsUploading(), dismissUpload(), emit(), getUploadRows(), listeners, pruneUploads(), resetUploadQueue() (+17 more)
...
Cohesion: 0.09
Nodes (21): Handoff, ORDER, ProgressStep, ProgressSteps(), TransitionScreen(), useCheckoutHandoff(), GetAppDialog(), daysUntil() (+13 more)
...
Cohesion: 0.11
Nodes (17): ENDPOINTS, esewaProvider, getJson(), parseAmount(), SIGNED_FIELDS, BASE_URLS, khaltiProvider, postJson() (+9 more)
...
Cohesion: 0.13
Nodes (21): hostelToday(), platformAdminInviteSchema, teamWalletEntrySchema, GET(), commissionFor(), creditTeamCommission(), getAgentWallet(), listTeamWallets() (+13 more)

### Community 151 - "Community 151"
Cohesion: 0.09
Nodes (23): BANK, both, empty, ESEWA, [first], ids, KHALTI, odd (+15 more)
...
Cohesion: 0.12
Nodes (20): DELETE(), revokeDeviceToken(), campaignBaseSchema, deviceTokenRevokeSchema, deviceTokenSaveSchema, nepalDateSchema, notificationPreferenceUpdateSchema, notificationPrioritySchema (+12 more)

### Community 170 - "Community 170"
Cohesion: 0.14
Nodes (18): POST(), RouteContext, POST(), safeEqual(), ClickRecord, QuestionCallAnalyticsQuery, questionCallBaseUrl(), QuestionCallClickInput (+10 more)
...
Cohesion: 0.13
Nodes (18): isUsableCoordinate(), fetchRoadRoute(), isRecord(), parseRoadRoute(), parseSteps(), RoadRoute, ROUTE_MODES, RouteMode (+10 more)
...
Cohesion: 0.16
Nodes (13): authHeaders(), chunk(), ExpoReceipt, fetchReceipts(), isConfigurationFailure(), ReceiptSweepResult, sweepPushReceipts(), errors (+5 more)
...
Cohesion: 0.18
Nodes (13): platformSettingSchema, coerceSection(), getPublicSiteConfig(), getSiteConfig(), invalidateSiteConfigCache(), PlatformSettingRecord, SiteConfigServiceError, updateSiteConfigSection() (+5 more)

### Community 227 - "Community 227"
Cohesion: 0.12
Nodes (15): classifyCredit(), LadderClaim, LadderInvoice, normalizeTxnId(), ANITA_CODE, claims, context(), invoice() (+7 more)
...
Cohesion: 0.18
Nodes (13): 2.3 Hostel Rejected, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails, code:typescript ({) (+5 more)
...
Cohesion: 0.18
Nodes (9): AuthSession, getResidentProfile(), AppNavigator(), Stack, ResidentNotificationsScreen(), Profile, Props, ResidentProfileScreen() (+1 more)
...
Cohesion: 0.24
Nodes (9): DEFAULT_NOTIFICATION_PREFERENCE, filterPushRecipients(), getNotificationPreference(), NotificationPreference, PreferenceRecord, serialize(), updateNotificationPreference(), mocks (+1 more)
...
Cohesion: 0.24
Nodes (10): 4.2 Complaint Status Updated, 4.3 Complaint Resolved, 4. Resident Activity Emails, 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, code:typescript ({) (+2 more)
...
Cohesion: 0.4
Nodes (4): findLiveResidency(), LIVE_STATUSES, LiveResidency, LiveRow
...
## Knowledge Gaps
- **6867 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+6862 more)
...
- **Why does `string()` connect `Community 24` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 12`, `Community 14`, `Community 17`, `Community 19`, `Community 20`, `Community 22`, `Community 23`, `Community 25`, `Community 27`, `Community 28`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 41`, `Community 46`, `Community 47`, `Community 50`, `Community 51`, `Community 52`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 57`, `Community 59`, `Community 63`, `Community 64`, `Community 65`, `Community 66`, `Community 68`, `Community 70`, `Community 71`, `Community 72`, `Community 73`, `Community 74`, `Community 75`, `Community 78`, `Community 79`, `Community 80`, `Community 84`, `Community 85`, `Community 87`, `Community 89`, `Community 90`, `Community 96`, `Community 100`, `Community 101`, `Community 104`, `Community 105`, `Community 106`, `Community 110`, `Community 112`, `Community 118`, `Community 124`, `Community 129`, `Community 131`, `Community 134`, `Community 135`, `Community 144`, `Community 146`, `Community 147`, `Community 149`, `Community 150`, `Community 157`, `Community 163`, `Community 167`, `Community 168`, `Community 178`, `Community 186`, `Community 189`, `Community 198`, `Community 214`, `Community 250`, `Community 258`, `Community 286`, `Community 304`, `Community 305`, `Community 442`, `Community 446`?**
  _High betweenness centrality (0.166) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 14` to `Community 1`, `Community 2`, `Community 5`, `Community 133`, `Community 135`, `Community 134`, `Community 10`, `Community 11`, `Community 12`, `Community 15`, `Community 17`, `Community 18`, `Community 146`, `Community 21`, `Community 24`, `Community 25`, `Community 27`, `Community 28`, `Community 30`, `Community 32`, `Community 34`, `Community 35`, `Community 167`, `Community 43`, `Community 44`, `Community 46`, `Community 47`, `Community 176`, `Community 305`, `Community 178`, `Community 51`, `Community 53`, `Community 54`, `Community 59`, `Community 189`, `Community 63`, `Community 64`, `Community 450`, `Community 198`, `Community 75`, `Community 76`, `Community 206`, `Community 85`, `Community 214`, `Community 86`, `Community 215`, `Community 89`, `Community 91`, `Community 96`, `Community 101`, `Community 103`, `Community 104`, `Community 105`, `Community 236`, `Community 254`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 38` to `Community 129`, `Community 4`, `Community 5`, `Community 6`, `Community 9`, `Community 11`, `Community 13`, `Community 15`, `Community 144`, `Community 18`, `Community 23`, `Community 25`, `Community 32`, `Community 43`, `Community 44`, `Community 45`, `Community 49`, `Community 54`, `Community 56`, `Community 60`, `Community 61`, `Community 62`, `Community 319`, `Community 69`, `Community 72`, `Community 82`, `Community 83`, `Community 91`, `Community 98`, `Community 115`, `Community 121`, `Community 255`?**
