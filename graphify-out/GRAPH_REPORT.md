# Graph Report - hostel-management-software  (2026-09-04)

## Corpus Check
- 1658 files · ~2,761,251 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 13170 nodes · 35968 edges · 495 communities (469 shown, 26 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 525 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 560 edges
2. `successResponse()` - 548 edges
3. `connectToDatabase()` - 373 edges
4. `useAppTheme()` - 296 edges
5. `cn()` - 243 edges
6. `connectToDatabase()` - 224 edges
7. `unwrap()` - 185 edges
8. `useResource()` - 181 edges
9. `requireHostelCapability()` - 166 edges
10. `Text()` - 156 edges
...
## Communities (495 total, 26 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (184): PATCH(), POST(), RouteContext, GET(), GET(), POST(), PATCH(), POST() (+176 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (226): GET(), getOpenFeeSchedule(), GET(), getFoodRoutinesByHostelId(), listPublicFoodRoutine(), addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry() (+218 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (238): loadOverview(), loadMoney(), loadToday(), TodayData, AdminRollCallCard(), loadFinance(), DeletionRequest, DeletionStatus (+230 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (140): ICONS, LABELS, Segment, TONES, FILTERS, Pending, MANAGE_ROWS, PORTAL_ROWS (+132 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (172): AdminCommunityScreen(), AdminMoreScreen(), ActivateScreen(), Scanner(), GuardianInviteScreen(), BootGate(), RootShell(), FILTERS (+164 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (161): POST(), POST(), POST(), attacker, attempt(), headers, jsonRequest(), routeMocks (+153 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (134): DeletionPathway, DeletionStatus, PATHWAY_COPY, DemoDataBadge(), HostelTable(), LoadState, Message(), UserRecord (+126 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (153): GET(), checkoutSchema, POST(), addComplaintUpdate(), auditComplaintAction(), confirmComplaintResolution(), createComplaint(), findAdminComplaint() (+145 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (145): POST(), RouteContext, DELETE(), GET(), hostelId(), GET(), POST(), DELETE() (+137 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (126): CommunityReportDialog(), REASONS, ConfirmOptions, Notification, MonthPicker, PeriodRow, FILTERS, Notification (+118 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (126): NightStatusForm(), ProfileScreen(), ReferralRow(), CheckoutStatusScreen(), DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS (+118 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (131): ReportedPostCard(), ClearFilters(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), PortalDates, SubmitClaimScreen() (+123 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (99): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload (+91 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (110): AdminAlertsScreen(), AdminHomeScreen(), AdminTabs(), HIDDEN, TABS, AdminMoneyScreen(), MoneyData, AdminTodayScreen() (+102 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (103): HostelAdminAttendancePageContent, HostelAdminCommunityPageContent, HostelAdminComplaintsPage, HostelAdminInquiriesPageContent, HostelAdminMaintenancePageContent, PRIORITIES, STATUS_ACTIONS, HostelAdminMoveChecklistPage (+95 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (92): POST(), AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, summarizeResidentComplaints(), acceptGuardianInvitation(), daysFromNow() (+84 more)
...
Cohesion: 0.03
Nodes (94): Choice, HOSTEL_TYPE_LABELS, HostelPanel(), MapButton(), MapCanvas, ModeTab(), NavigationPanel(), NOTHING_CHOSEN (+86 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (92): Overview, InvoiceDetailScreen(), LedgerCard(), methodIcon(), methodLabel(), PayInvoiceScreen(), PROVIDER_LABEL, QrPanel() (+84 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (80): GET(), listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), POST(), GET(), POST() (+72 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (72): MatrixRow, MatrixTotals, PeriodSummary, ClaimFacts(), FLAG_LABELS, POSITIVE_FLAGS, ProofReviewModal, LedgerMonth (+64 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (89): AdminCommunityReportsScreen(), NightStatusScreen(), ReferralsScreen(), SavedHostelsScreen(), NotificationSettings(), SORTS, StoreCategoryScreen(), CommunityScreen() (+81 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (87): defaultDueDate(), DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), monthLabel(), collectionTotals() (+79 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (72): attachFiles(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput, ComplaintListQuery, ComplaintRecord, ComplaintReplyInput (+64 more)

### Community 24 - "Community 24"
Cohesion: 0.1
Nodes (56): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), guardianInvitationEmail(), sosAlertEmail() (+48 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (76): POST(), ApiPrincipal, PLATFORM_ROLES, deviceTokenSchema, notificationSchema, notificationCampaignSchema, input, mocks (+68 more)

### Community 26 - "Community 26"
Cohesion: 0.06
Nodes (76): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply() (+68 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (76): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult (+68 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (59): metadata, AccountDeletionPanel, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails() (+51 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (60): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), ApplyBlock(), ServiceProvidersScreen() (+52 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (66): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, BillableResident, ChargeBasis (+58 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (66): GATEWAY_ORDER, getPayInstructions(), InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice(), assertQrAssetUsable() (+58 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (64): IdCardFace(), initialsOf(), Portrait(), IdCardPrompt(), Point(), BLOOD_OPTIONS, DIET_OPTIONS, EditIdentityScreen() (+56 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (53): csvField(), deferLoad(), field(), Hostel, Inquiry, numberField(), optionalField(), PageHeader() (+45 more)

### Community 34 - "Community 34"
Cohesion: 0.07
Nodes (48): GenericPortalScreen(), portalRows(), portalTitle(), CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS, CITY_OPTIONS (+40 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (59): cookPrincipal, mocks, announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError, FoodPhotoUploadInput (+51 more)
...
Cohesion: 0.05
Nodes (46): HostelSuggestions(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, PublicHostel, LoadState, PublicHostelListingPageContent() (+38 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (50): AdminNightStatusRow, AdminResident, overrideNightStatus(), InquiryStatus, ManagedInquiry, AdminRollCallData, RosterSegment, rosterSegmentRows() (+42 more)
...
Cohesion: 0.06
Nodes (51): CSV_COLUMNS, GET(), GET(), periodTotals(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS (+43 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (60): bindSessionHandlers(), expoHostUri(), forEmulator(), hostOf(), isPrivateHost(), outcome, releaseWaiters(), request (+52 more)
...
Cohesion: 0.05
Nodes (52): AdminOverviewScreen(), AdminAlertsContext, AdminAlertsValue, AlertActions, DeniedNotice(), EMPTY_COUNTS, ICONS, LABELS (+44 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (49): addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine, formatWeekRange(), HostelAdminFoodPage (+41 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (49): AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput, ConsentInput, dayKey() (+41 more)

### Community 49 - "Community 49"
Cohesion: 0.07
Nodes (45): GuardianNotShared(), GuardianWardCard(), GuardianHomeScreen(), GuardianMetrics(), GuardianMoreScreen(), GuardianPaymentsScreen(), GuardianSafetyScreen(), formatMoney() (+37 more)

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (56): demoteToPublicAccount(), raiseAdmissionInvoice(), addEmergencyContact(), addGuardian(), auditResidentAction(), BedRecord, createResident(), definedUpdate() (+48 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (37): CancelDeletionPageContent(), AcceptResult, GuardianInvitePageContent, NEXT_STATUSES, OrdersPayload, OrderStatus, PlatformStoreOrdersPageContent, STATUS_TONE (+29 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (51): BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan, BillingSkip (+43 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (45): notificationPreferenceSchema, DEFAULT_NOTIFICATION_PREFERENCE, filterPushRecipients(), getNotificationPreference(), NotificationPreference, PreferenceRecord, serialize(), updateNotificationPreference() (+37 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (44): inquirySchema, referralSchema, referralCodeSchema, referralRewardSchema, activeCode, codeId, hostelId, joinedResidentId (+36 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (28): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminComplaintsPage(), redirectToWorkspaceScreen() (+20 more)

### Community 56 - "Community 56"
Cohesion: 0.05
Nodes (34): metadata, CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+26 more)
...
Cohesion: 0.05
Nodes (34): AuthGuard(), cityOptions, createDocument(), createRoom(), DocumentConfig, DraftData, FACILITY_MINI, facilityOptions (+26 more)

### Community 59 - "Community 59"
Cohesion: 0.07
Nodes (46): Choice, Compass(), maneuverIcon(), MapButton(), MapScreen(), ModeTab(), NavCard(), NOTHING_CHOSEN (+38 more)

### Community 60 - "Community 60"
Cohesion: 0.07
Nodes (45): POST(), getFoodRoutine(), saveFoodRoutine(), serializeRoutine(), addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange() (+37 more)

### Community 61 - "Community 61"
Cohesion: 0.07
Nodes (42): GET(), POST(), DELETE(), POST(), createExpertConsultationRequest(), getMyExpertConsultationRequest(), GET(), POST() (+34 more)

### Community 62 - "Community 62"
Cohesion: 0.06
Nodes (32): ENDPOINTS, esewaProvider, SIGNED_FIELDS, attempt, fetchMock, forged, live, payload (+24 more)
...
Cohesion: 0.06
Nodes (38): serviceProviderApplicationSchema, serviceProviderDocumentSchema, hostelId, mocks, providerId, ACTIVE_APPLICATION_STATUSES, approveServiceProvider(), auditProviderAction() (+30 more)
...
Cohesion: 0.07
Nodes (32): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, PortalShell(), navItems, useWorkspaceHref(), navItems, canAccessWorkspace(), workspaceHostelName() (+24 more)
...
Cohesion: 0.06
Nodes (28): currency(), EmptyState(), LoadingRows(), ResidentActivationPageContent, ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent (+20 more)

### Community 71 - "Community 71"
Cohesion: 0.07
Nodes (36): ComplaintDetail(), ComplaintCard(), ComplaintsScreen(), needsResident(), OPEN_STATUSES, rank(), ACTOR_LABELS, actorLabel() (+28 more)
...
Cohesion: 0.08
Nodes (29): depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, providedItemSchema, auditMoveAction(), createMoveInChecklist(), createMoveOutChecklist(), findAdminResident() (+21 more)

### Community 74 - "Community 74"
Cohesion: 0.08
Nodes (31): isAuthBypassEnabled(), original, cook, assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES, PermissionError (+23 more)
...
Cohesion: 0.09
Nodes (34): Composer(), Composer(), CommunityPostCard(), relativeTime(), CommunityComment, audienceOptions(), AVATAR_TONES, avatarInitial() (+26 more)
...
Cohesion: 0.08
Nodes (34): formatNPR(), drawCertificationStamp(), footerLine(), formatDate(), formatLongDate(), MONTHS, ReceiptPdfInput, renderReceiptPdf() (+26 more)

### Community 80 - "Community 80"
Cohesion: 0.08
Nodes (37): AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance(), DIGIT_CONFUSABLES, evidenceTextFlags(), EvidenceTextMatch (+29 more)
...
Cohesion: 0.09
Nodes (37): alreadyReviewedError(), approvePaymentProof(), assertProofIsPending(), auditPaymentAction(), computeMonthlyDue(), creditVerifiedAmount(), currentMonth(), definedUpdate() (+29 more)
...
Cohesion: 0.06
Nodes (27): ProviderDirectoryData, CATEGORIES, isApplicationOpen(), LandingStep(), MeResponse, OwnApplication, ProviderStats, ProviderStatus (+19 more)

### Community 85 - "Community 85"
Cohesion: 0.06
Nodes (21): adminPrincipal, mocks, PLATFORM_LIMITS, mocks, readable, selectable, profileMocks, staffPrincipal (+13 more)

### Community 86 - "Community 86"
Cohesion: 0.07
Nodes (33): CONTENT_ICON_SLUGS, everything, IDENTITY, page, rendered, DEFAULT_SITE_CONFIG, PlatformSettingRecord, SiteConfigServiceError (+25 more)

### Community 87 - "Community 87"
Cohesion: 0.08
Nodes (28): AdminResidentsScreen(), AlertCard(), ManageRateHistoryScreen(), ManageRatesScreen(), isProvider(), ManageGatewayScreen(), useDates(), ResidentScan (+20 more)
...
Cohesion: 0.08
Nodes (31): NearbyStatus, boundsCenter(), Coordinates, haversineMeters(), hostelCoordinates(), HostelWithDistance, isUsableCoordinate(), KATHMANDU (+23 more)

### Community 90 - "Community 90"
Cohesion: 0.1
Nodes (32): ApiFailure, apiRequest(), ApiSuccess, AuthUser, getActivationStatus(), getResidentProfile(), listNotifications(), listResidentFood() (+24 more)
...
Cohesion: 0.08
Nodes (27): formatHostelAddress(), hasFood(), hostelTypeToUi(), mapPublicHostelToSummary(), roomTypeLabel(), CATEGORY_LABELS, NEARBY_GROUPS, PublicHostelDetailPage() (+19 more)

### Community 93 - "Community 93"
Cohesion: 0.07
Nodes (26): CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing, buildIdCardData() (+18 more)
...
Cohesion: 0.07
Nodes (25): searchHostels(), rows, ComparedHostel, comparePublicHostels(), definedParams(), Facility, getPublicHostel(), InquiryInput (+17 more)

### Community 97 - "Community 97"
Cohesion: 0.09
Nodes (29): hostelPageViewSchema, userResidentProfileSchema, LEGACY_ROLE_MAP, Role, ROLE_VALUES, ageFromDateOfBirth(), cardPhotoImageUrl(), generateResidentId() (+21 more)
...
Cohesion: 0.1
Nodes (29): geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim(), definedParts() (+21 more)

### Community 101 - "Community 101"
Cohesion: 0.1
Nodes (26): getR2Client(), classifyCredit(), CreditClassification, LadderClaim, LadderInvoice, MatchContext, normalizeTxnId(), ANITA_CODE (+18 more)
...
Cohesion: 0.09
Nodes (24): buildHtml(), Marker, PlaceMarker, buildShell(), MapExplorer, MapExplorerProps, MapHandle, MapMarker (+16 more)

### Community 105 - "Community 105"
Cohesion: 0.07
Nodes (20): Input(), StatusBadge(), field(), HostelAdminServiceProvidersPageContent(), ListingFlag, LoadState, MaintenanceRequest, optionalField() (+12 more)

### Community 106 - "Community 106"
Cohesion: 0.09
Nodes (28): directionFlags(), evidenceFlags(), payeeFlags(), CREDIT_MARKERS, DEBIT_MARKERS, DirectionRead, directionRefusal(), EvidenceDirection (+20 more)
...
Cohesion: 0.07
Nodes (29): §0 Decisions taken — do not re-litigate, §10 Location policy — a release gate, not a nice-to-have, §1 Current state — the honest audit, §2 Blockers — wrong today, cheap to fix, 3.1 Automatic night presence — the feature the hostel is buying, 3.2 Guardians — invite, permissions, revoke, 3.3 Offer Program — the resident's own view, §3 Missing screens (+21 more)

### Community 111 - "Community 111"
Cohesion: 0.1
Nodes (26): seedCommunityPost(), CachedQuery, defined, entries, Entry, fetchQuery(), inflight, invalidateQuery() (+18 more)

### Community 112 - "Community 112"
Cohesion: 0.18
Nodes (12): PlatformConfigLegalPageContent, PlatformConfigPricingPageContent, ConfigCard(), ConfigPage(), LoadState, parseListField(), Repeater(), TextAreaField() (+4 more)

### Community 113 - "Community 113"
Cohesion: 0.1
Nodes (19): robots(), sitemap(), STATIC_ROUTES, buildFormPostHandoff(), FormPostHandoff, HandoffError, IntentRecord, formPostIntent (+11 more)

### Community 114 - "Community 114"
Cohesion: 0.12
Nodes (19): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, base (+11 more)

### Community 115 - "Community 115"
Cohesion: 0.09
Nodes (23): approveClaim(), assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck(), evidenceCheck(), findClaim() (+15 more)
...
Cohesion: 0.12
Nodes (24): FileUploadArea(), EXTENSION_BY_MIME, FAMILY_BYTES, FAMILY_ORDER, familyOf(), formatBytes(), joinTypes(), KIND_RULES (+16 more)
...
Cohesion: 0.13
Nodes (24): UploadCard(), dismissUpload(), emit(), listeners, pruneUploads(), resetUploadQueue(), rows, startDownload() (+16 more)

### Community 123 - "Community 123"
Cohesion: 0.09
Nodes (16): accountDeletionRequestSchema, attendanceLogSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, consentLogSchema, sessionSchema, purgeAccount() (+8 more)
...
Cohesion: 0.12
Nodes (22): CommentThread(), ReportSheet(), ReactionBar(), ReactionChip(), SWING, addPostComment(), CommunityFeed, CommunityMedia (+14 more)
...
Cohesion: 0.1
Nodes (19): configuredLevel(), levelPriority, logger, LogLevel, normalizeMeta(), shouldLog(), write(), PromotableUser (+11 more)
...
Cohesion: 0.12
Nodes (18): native, NativeDownloads, openDownloaded(), SavedDownload, KNOWN_PATHS, resolvePushPath(), REWRITES, createAndroidChannels() (+10 more)

### Community 138 - "Community 138"
Cohesion: 0.15
Nodes (19): useIsUploading(), directionOf(), EMPTY_TALLY, floorToStep(), phaseOf(), shouldRepost(), tallyUploads(), UploadNotice (+11 more)
...
Cohesion: 0.13
Nodes (17): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), MediaViewerProvider() (+9 more)
...
Cohesion: 0.12
Nodes (15): approvalPeriod(), getPeriodSummary(), monthsBetween(), periodOf(), PeriodRow, PeriodSummary, august, hostelId (+7 more)
...
Cohesion: 0.13
Nodes (20): UploadStack(), cancelUpload(), canRetryUpload(), handles, isActive(), retryUpload(), UploadHandle, UploadItem (+12 more)
...
Cohesion: 0.1
Nodes (20): publicApi, ContentPage, ContentSection, EMPTY_PAGE, FALLBACK_SITE_CONFIG, getSiteConfig(), MobileSiteConfig, SiteConfigResponse (+12 more)
...
Cohesion: 0.15
Nodes (15): DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList(), positiveInteger(), validateFileAssetMetadata(), asset, fileAssetSchema (+7 more)

### Community 170 - "Community 170"
Cohesion: 0.2
Nodes (16): isFileAssetKind(), isFinancialAssetKind(), r2Configured(), storePublicAsset(), AccessLevel, bucketForAccessLevel(), deleteFromR2(), generateFileKey() (+8 more)

### Community 171 - "Community 171"
Cohesion: 0.13
Nodes (19): digitsOnly(), extractPayee(), HostelPayeeIdentity, matchesIdentity(), NAME_STOPWORDS, nameTokens(), PayeeRead, payeeRefusal() (+11 more)
...
Cohesion: 0.12
Nodes (21): 4.1 New Notice Posted, 4.2 Complaint Status Updated, 4.3 Complaint Resolved, 4. Resident Activity Emails, 5.1 SOS Triggered, 5. Safety & Emergency Emails, 6.1 Service Provider Registration Received, 6.2 Service Provider Approved (+13 more)
...
Cohesion: 0.1
Nodes (19): Account deletion purge, Attendance maintenance (absence alerts + retention purge), Authentication, Complaint SLA breach check, cron-job.org setup (per job), CRON.md — Scheduled Jobs, Dispatch scheduled notifications, Endpoints (+11 more)
...
Cohesion: 0.14
Nodes (15): CurrentUser, DASHBOARD_ROLES, dashboardHrefForRole(), hasDashboard(), MeResponse, moreItems, navItems, providerNavItems (+7 more)

### Community 185 - "Community 185"
Cohesion: 0.13
Nodes (14): listResidentInvoices(), getResidentLedger(), monthsBetween(), periodOf(), ResidentDoc, ResidentLedger, ResidentLedgerMonth, ResidentLedgerPayment (+6 more)

### Community 186 - "Community 186"
Cohesion: 0.12
Nodes (14): currentId, hostelId, inOctober, july, labelled, mocks, NOW, october (+6 more)

### Community 187 - "Community 187"
Cohesion: 0.16
Nodes (16): GET(), POST(), activeSuperadminCount(), createPlatformAdmin(), CreatePlatformAdminInput, generateTemporaryPassword(), listPlatformAdmins(), loginUrl() (+8 more)
...
Cohesion: 0.16
Nodes (19): code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface INotice {), code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {), code:typescript ({), code:typescript (interface IMoveOutChecklistItem {), Complaint (+11 more)
...
Cohesion: 0.18
Nodes (15): describeGrants(), GuardianRow(), PermissionSheet(), InviteGuardianScreen(), daysUntil(), describeInvitation(), describeSharing(), grantedKeys() (+7 more)
...
Cohesion: 0.16
Nodes (18): code:typescript (interface IMoveInChecklistItem {), code:typescript (interface IServiceProvider {), code:typescript (interface IServiceProvider {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IInquiry {), code:typescript (interface IHostelPageView {), Inquiry (+10 more)
...
Cohesion: 0.17
Nodes (5): CommunityBoard(), CommunityBoardProps, SORTS, emptyFeedMessage(), spaceChips()
...
Cohesion: 0.15
Nodes (13): FILE_ASSET_KINDS, FileAssetKind, FINANCIAL_KINDS, ApiEnvelope, parseEnvelope(), sendUpload(), sendWithProgress(), UploadCanceledError (+5 more)
...
Cohesion: 0.14
Nodes (6): AuthShell(), AuthShellProps, PANEL_COPY, SiteWordmark(), AuthExperiencePage(), metadata
...
Cohesion: 0.2
Nodes (10): triggerSOS(), RootStackParamList, Props, Props, Profile, Props, Props, Props (+2 more)
...
Cohesion: 0.15
Nodes (11): AuthSession, requestOtp(), signInWithGoogle(), AppNavigator(), Stack, LoginScreen(), OtpVerificationScreen(), ResidentProfileScreen() (+3 more)
...
Cohesion: 0.22
Nodes (12): CommunityPostScreen(), CommunityPost, CommunitySpaces, getCommunityPost(), getCommunitySpaces(), COMMUNITY, CommunityQuery, DEFAULT_SORT (+4 more)

### Community 236 - "Community 236"
Cohesion: 0.13
Nodes (8): hostelId, mocks, principal, residentRowId, userId, existing, mocks, pinned
...
Cohesion: 0.17
Nodes (8): ADMIN_DIRS, blind, CALENDAR_BLIND, constructions, declarations, offenders, SRC, tables
...
Cohesion: 0.23
Nodes (9): downloadFile(), DownloadOptions, DownloadOutcome, nextId(), readWithProgress(), saveBlob(), clicked, link (+1 more)
...
Cohesion: 0.2
Nodes (12): 2.2 Hostel Approved, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.3 Payment Proof Uploaded (to Admin), 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, code:block14 (---) (+4 more)
...
Cohesion: 0.29
Nodes (5): hostelId, mocks, principal, residentA, residentB
...
Cohesion: 0.43
Nodes (5): GET(), searchCandidates(), hostelAdminGeocodeQuerySchema, queryVariants(), reverseGeocode()
...
Cohesion: 0.33
Nodes (4): ToastInput, ToastItem, ToastStore, ToastTone
...
## Knowledge Gaps
- **4692 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+4687 more)
...
- **Why does `Button()` connect `Community 3` to `Community 2`, `Community 4`, `Community 6`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 18`, `Community 20`, `Community 28`, `Community 29`, `Community 158`, `Community 32`, `Community 33`, `Community 38`, `Community 46`, `Community 47`, `Community 49`, `Community 59`, `Community 65`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 22` to `Community 0`, `Community 5`, `Community 263`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 20`, `Community 21`, `Community 277`, `Community 152`, `Community 24`, `Community 30`, `Community 33`, `Community 163`, `Community 37`, `Community 41`, `Community 298`, `Community 43`, `Community 44`, `Community 45`, `Community 48`, `Community 53`, `Community 58`, `Community 72`, `Community 336`, `Community 92`, `Community 358`, `Community 120`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 9` to `Community 3`, `Community 4`, `Community 6`, `Community 12`, `Community 14`, `Community 17`, `Community 18`, `Community 20`, `Community 28`, `Community 33`, `Community 34`, `Community 36`, `Community 37`, `Community 38`, `Community 39`, `Community 47`, `Community 51`, `Community 56`, `Community 184`, `Community 58`, `Community 68`, `Community 76`, `Community 84`, `Community 92`, `Community 93`, `Community 99`, `Community 102`, `Community 105`, `Community 112`, `Community 241`, `Community 118`, `Community 120`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Are the 368 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 368 INFERRED edges - model-reasoned connections that need verification._
