...
## Corpus Check
- 1982 files · ~3,617,554 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15999 nodes · 43836 edges · 540 communities (513 shown, 27 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 703 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 641 edges
2. `successResponse()` - 622 edges
3. `connectToDatabase()` - 441 edges
4. `useAppTheme()` - 394 edges
5. `cn()` - 291 edges
6. `connectToDatabase()` - 247 edges
7. `unwrap()` - 198 edges
...
- `POST()` --calls--> `connectToDatabase()`  [INFERRED]
  apps/web/src/app/api/v1/files/presign/route.ts → packages/db/src/connection.ts

## Communities (540 total, 27 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (248): POST(), GET(), POST(), PATCH(), POST(), RouteContext, GET(), GET() (+240 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (224): ICONS, LABELS, Segment, TONES, Overview, MoneyData, MANAGE_ROWS, PORTAL_ROWS (+216 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (287): AdminCommunityReportsScreen(), FILTERS, Pending, loadOverview(), loadMoney(), loadToday(), AttachmentGallery(), ReportedPostCard() (+279 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (241): PATCH(), RouteContext, getOrCreateSubscription(), POST(), GET(), GET(), querySchema, getOpenFeeSchedule() (+233 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (141): DeletionPathway, DeletionStatus, PATHWAY_COPY, csvField(), deferLoad(), DemoDataBadge(), field(), Hostel (+133 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (171): BrowseProfileScreen(), DocumentScreen(), MobileLegal, cropToGuide(), FILL, GuidedCapture(), GUIDES, GuideShape (+163 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (184): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, bsMonthStart(), hostelCalendarDay(), hostelToday(), FinanceAuditInput (+176 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (177): AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), Scanner(), CookInviteScreen(), BootGate(), RootShell(), ApplyBlock() (+169 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (156): MapScreen(), PreviewCard(), ResultRow(), Assurance(), CallableRow(), IdentityCard(), PeopleSection(), SavedHostelsScreen() (+148 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (158): POST(), attacker, attempt(), headers, jsonRequest(), routeMocks, appBaseUrl(), authenticateWithGoogle() (+150 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (146): AdminCommunityScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+138 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (137): PlanPaymentClaim, GuardianDashboard, gregorianSpan(), MonthPicker, PeriodRow, CATEGORIES, Ledger, defaultMonth() (+129 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (149): notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus(), OPEN_STATUSES, OverdueComplaint, runComplaintSlaCheck(), hostelId, mocks (+141 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (144): base, entityId, hostelId, mocks, principal, write(), hostelId, invoice (+136 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (147): GET(), POST(), POST(), RouteContext, DELETE(), GET(), hostelId(), GET() (+139 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (112): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload (+104 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (132): getResidentAttendance(), listResidentComplaints(), outstandingForResident(), addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange(), definedUpdate() (+124 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (130): listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), listPlanPaymentClaims(), GET(), GET(), POST() (+122 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (133): GET(), GET(), readReturnState(), resolveOwnedHostel(), getSubscriptionState(), selectPlan(), createExpertConsultationRequest(), ExpertConsultationCreateInput (+125 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (129): POST(), POST(), POST(), demoteToPublicAccount(), POST(), checkoutSchema, POST(), POST() (+121 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (98): GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, CITY_OPTIONS (+90 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (117): summarizeResidentComplaints(), collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES (+109 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (104): HostelAdminAttendancePageContent, HostelAdminCommunityPageContent, HostelAdminComplaintsPage, FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, monthStartPeriod(), Rate (+96 more)

### Community 23 - "Community 23"
Cohesion: 0.02
Nodes (108): FeeScheduleRecord, key(), ListingHostel, ListingProjection, projectSchedule(), RoomConfiguration, hostel, result (+100 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (87): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, AuthShell(), AuthShellProps, PANEL_COPY (+79 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (88): CommunityReportDialog(), REASONS, MonthOption(), BrowserPushRow(), ModerationButton(), PagerButton(), normalize(), PortalSearch() (+80 more)
...
Cohesion: 0.03
Nodes (87): HIDDEN, RoleLayout(), TABS, FILTERS, NotificationRow(), NotificationsScreen(), TILE_GLYPH, TILE_TONES (+79 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (90): ManageRatesScreen(), ClearFilters(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), AdminLedger, AdminLedgerEntry (+82 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (79): HostelRegistrationProgress(), Milestone, milestoneIndex(), MILESTONES, PaymentPanel(), rupees(), SubscriptionState, cityOptions (+71 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (90): announceFoodReady(), dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, getFoodRoutine(), isMonthEnd() (+82 more)

### Community 31 - "Community 31"
Cohesion: 0.1
Nodes (57): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), subscriptionClaimReceivedEmail(), subscriptionClaimRejectedEmail(), formatRupees() (+49 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (88): NightStatusScreen(), ReferralsScreen(), SosScreen(), SORTS, StoreCategoryScreen(), ComplaintsScreen(), GuardiansScreen(), useResource() (+80 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (72): CommunityScreen(), Composer(), CommunityPostScreen(), CommunityBoard(), CommunityBoardProps, Composer(), NotificationBell(), SORTS (+64 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (75): CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing, buildIdCardData() (+67 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (75): ReviewForm(), ReviewScreen(), DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS, MealCard(), MonthEndSpecial() (+67 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (69): LIVE_ACCESS, releaseGuardianAccounts(), hostelId, mocks, userId, daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess() (+61 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (62): ProviderDirectoryData, GET(), escapeRegex(), objectIdSchema, paginationSchema, phoneSchema, serviceProviderApplicationSchema, serviceProviderDocumentSchema (+54 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (62): notifyProviderOfAssignment(), notifyProviderOfMaintenanceNote(), notifyProviderOfStatusChange(), notifyStaffOfNewMaintenanceRequest(), providerUserId(), readableCategory(), RequestLike, STATUS_WORDS (+54 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (61): verifyPurposeToken(), PaginationMeta, paginationQuerySchema, querySchema, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex(), HostelRecord (+53 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (66): methodProvider(), ReferenceStrip(), createResident(), getIntakeQuote(), IntakeQuote, lookupResidentProfile(), RESIDENT_TYPES, ResidentIntakeResult (+58 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (59): addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery, HostelAdminInquiryStatusInput, InquiryNoteCreateInput, InquiryNoteRecord, InquiryRecord (+51 more)
...
Cohesion: 0.05
Nodes (63): CsvTable, gridFromCsv(), peekHeaders(), readCsv(), stripBom(), stripPreamble(), ESEWA_CSV_PARSER, both (+55 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (50): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, HostelPhotoReminder(), daysUntil(), HostelSubscriptionDueBanner(), rupees(), State, PortalShell() (+42 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (58): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), PROVIDER_LABEL, QrPanel(), QrPanel() (+50 more)
...
Cohesion: 0.06
Nodes (53): POST(), RouteContext, computePerceptualHash(), DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList(), positiveInteger() (+45 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (59): paymentProofSchema, arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal (+51 more)

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (52): CSV_COLUMNS, GET(), GET(), periodTotals(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS (+44 more)
...
Cohesion: 0.04
Nodes (60): Plan, PlanId, Service, ServiceModule, ServiceModuleId, getService(), DEFAULT_PLANS, PLAN_MODULES (+52 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (51): Notification, FILTERS, Notification, NotificationRow(), PushState, FILTERS, NotificationCard, NotificationsPageContent (+43 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (52): ComplaintDetail(), ComplaintDetailScreen(), ComplaintCard(), CategoryTile(), NewComplaintScreen(), PickedAttachment, SwapButton(), CapturedPhoto (+44 more)

### Community 55 - "Community 55"
Cohesion: 0.07
Nodes (53): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt, ownerIdentitiesFor() (+45 more)

### Community 56 - "Community 56"
Cohesion: 0.05
Nodes (38): Claim, CouldNotCreateFileException, HostelHubDownloadsModule, HostelPalikaDownloadsModule, NoContextException, NothingOpensThisException, UnreadableSourceException, UnsupportedOnThisAndroidException (+30 more)
...
Cohesion: 0.04
Nodes (36): ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, RETAINED_BY_HOSTEL_ID, both, covered (+28 more)

### Community 59 - "Community 59"
Cohesion: 0.05
Nodes (40): HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminRoomsPageContent(), PlatformDashboardPageContent(), PlatformUsersPageContent(), DashboardCard(), DashboardCardProps, PlatformServiceProvidersPageContent() (+32 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (50): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), AdminTabs(), AdminMoneyScreen(), AdminTodayScreen(), AdminAlertsContext, AdminAlertsProvider() (+42 more)

### Community 61 - "Community 61"
Cohesion: 0.05
Nodes (48): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery (+40 more)

### Community 62 - "Community 62"
Cohesion: 0.04
Nodes (46): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), CookTodayScreen(), PortalDates (+38 more)
...
Cohesion: 0.05
Nodes (41): EMPTY_DRAFT, HostelAdminPaymentProfilePageContent, PaymentProfile, SECTION_FIELDS, SectionId, BankMark(), EsewaMark(), KhaltiMark() (+33 more)

### Community 65 - "Community 65"
Cohesion: 0.05
Nodes (38): metadata, CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+30 more)

### Community 66 - "Community 66"
Cohesion: 0.06
Nodes (26): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminComplaintsPage(), HostelAdminFoodPage(), HostelAdminNoticesPage() (+18 more)
...
Cohesion: 0.07
Nodes (45): storeOrderSchema, formatNpr(), itemsTable(), StoreEmailItem, mocks, allocateOrderNumber(), applyStatus(), CancelInput (+37 more)

### Community 69 - "Community 69"
Cohesion: 0.06
Nodes (42): nepalDayKey(), isCurrentNight(), isSelfReportable(), NIGHT_STATUS_OPTIONS, nightKey(), nightNote(), NightStanding, SelfReportableStatus (+34 more)

### Community 70 - "Community 70"
Cohesion: 0.06
Nodes (44): downloadCaption(), DownloadRow, DownloadStack(), progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster() (+36 more)

### Community 71 - "Community 71"
Cohesion: 0.08
Nodes (46): idCardIssuedEmail(), candidateFontDirs(), ensureIdCardFonts(), FONT_DIR_SEGMENTS, FONT_FILES, CARD_NOUNS, CardVariant, drawBack() (+38 more)

### Community 72 - "Community 72"
Cohesion: 0.05
Nodes (33): ConfirmOptions, useConfirm(), AUDIENCE_LABEL, PlatformPushPageContent, PushRecord, Repeat, REPEAT_LABEL, ScheduleRecord (+25 more)

### Community 73 - "Community 73"
Cohesion: 0.05
Nodes (36): fill(), PricingScreen(), PlanPicker(), InlineText(), TIER_TONE, PlanMark(), RAFTER, RIDGE (+28 more)
...
Cohesion: 0.07
Nodes (39): DELETE(), POST(), createPlatformNotificationCampaign(), listNotifications(), revokeDeviceToken(), saveDeviceToken(), campaignBaseSchema, deviceTokenRevokeSchema (+31 more)
...
Cohesion: 0.07
Nodes (40): DeviceLocationStatus, hasGeolocation(), LocationOutcome, NavigationFix, OrientationPermission, requestDeviceLocation(), requestHeadingPermission(), Unsubscribe (+32 more)

### Community 78 - "Community 78"
Cohesion: 0.08
Nodes (46): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodOf() (+38 more)
...
Cohesion: 0.05
Nodes (36): Complaint, ComplaintSummary, currency(), field(), FoodMenu, LoadState, Notice, optionalField() (+28 more)

### Community 83 - "Community 83"
Cohesion: 0.07
Nodes (41): GuardianInviteScreen(), GuardianMetrics(), GuardianMoreScreen(), GuardianPaymentsScreen(), GuardianSafetyScreen(), LoginResult, acceptGuardianInvitation(), getGuardianFood() (+33 more)
...
Cohesion: 0.07
Nodes (40): GATEWAY_ORDER, getHostelPayMethods(), getPayInstructions(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod (+32 more)
...
Cohesion: 0.08
Nodes (32): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), sitemap() (+24 more)
...
Cohesion: 0.07
Nodes (33): qrActivationSchema, before, expiresAt, mocks, staffPrincipal, ActivationCodeGenerateInput, ActivationCodeInput, activationSecret() (+25 more)
...
Cohesion: 0.08
Nodes (32): platformAdminInviteSchema, platformAdminInvitationEmail(), acceptPlatformAdminInvitation(), AcceptPlatformAdminInvitationInput, appUrl(), checkPlatformAdminEmail(), daysFromNow(), EmailAvailability (+24 more)
...
Cohesion: 0.11
Nodes (37): directionFlags(), evidenceFlags(), payeeFlags(), AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance() (+29 more)
...
Cohesion: 0.1
Nodes (32): POST(), PaginationQuery, notificationCampaignSchema, CampaignListQuery, CampaignRecord, createCampaign(), createHostelNotificationCampaign(), dispatchCampaign() (+24 more)
...
Cohesion: 0.07
Nodes (21): Input(), field(), HostelAdminReferralsPageContent(), HostelAdminReportsPageContent(), HostelAdminServiceProvidersPageContent(), ListingFlag, LoadState, MaintenanceRequest (+13 more)
...
Cohesion: 0.08
Nodes (25): noticeSchema, noticeReadStatusSchema, mocks, noticeInput, residentUserId, staffPrincipal, auditNoticeAction(), broadcastNotice() (+17 more)
...
Cohesion: 0.08
Nodes (22): inferKind(), MediaLightbox(), Choice, HOSTEL_TYPE_LABELS, MapButton(), MapCanvas, ModeTab(), NavigationPanel() (+14 more)

### Community 111 - "Community 111"
Cohesion: 0.08
Nodes (23): robots(), documentUrl(), InvoiceLean, PaymentLean, PlatformInvoiceRow, PlatformPaymentRow, PlatformSubscriptionLedger, buildFormPostHandoff() (+15 more)

### Community 112 - "Community 112"
Cohesion: 0.1
Nodes (22): applyWebhook(), WebhookResult, softmatoWebhookSecret(), ensureSoftmatoInvoice(), formatPaisa(), paisaToRupees(), rupeesToPaisa(), customerExternalRef() (+14 more)
...
Cohesion: 0.15
Nodes (31): calendarExample(), formatAgoIn(), formatDateIn(), formatDateLongIn(), formatDateTimeIn(), formatDayMonthIn(), formatPeriodMonthIn(), formatPeriodYearIn() (+23 more)
...
Cohesion: 0.08
Nodes (25): AttendanceCalendar(), AvailableRoomType, Claim, FinanceView, Invoice, OPEN_STATUSES, Receipt, ResidentOfferProgramPageContent (+17 more)
...
Cohesion: 0.09
Nodes (27): isDefinitelyNotPaymentEvidence(), looksLikePaymentReceipt(), receiptSignals(), referenceOnEvidence(), canvas, ctx, esewa, ESEWA_PDF_LINES (+19 more)
...
Cohesion: 0.08
Nodes (22): GatewayHealth, GatewayHealthSummary, IntentCounts, plural(), recordHealth(), SEVERITY, verdict(), IntentRow (+14 more)
...
Cohesion: 0.11
Nodes (23): native, NativeDownloads, openDownloaded(), openSavedFile(), SavedDownload, registerNightStatusCategory(), KNOWN_PATHS, marksRoleChange() (+15 more)
...
Cohesion: 0.13
Nodes (21): hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), systemDocumentKindFromText(), distance, formatNPR(), drawCertificationStamp(), footerLine() (+13 more)
...
Cohesion: 0.18
Nodes (25): assertMatchesExtension(), downloadAndShare(), downloadAndShareCsv(), downloadAndShareImage(), downloadToDevice(), forgetDownloadFolder(), LegacyFileSystem, loadLegacyFileSystem() (+17 more)

### Community 135 - "Community 135"
Cohesion: 0.08
Nodes (16): CATEGORIES, isApplicationOpen(), LandingStep(), MeResponse, OwnApplication, ProviderStats, ProviderStatus, renderEmphasis() (+8 more)
...
Cohesion: 0.08
Nodes (19): financeIntegrityHash(), checkAuditChain(), after, broken, claimId, db, entry(), eventId (+11 more)
...
Cohesion: 0.13
Nodes (22): afterResponse(), mocks, activeDevicesFor(), activeTokensFor(), androidChannel(), authHeaders(), chunk(), DeviceRow (+14 more)

### Community 151 - "Community 151"
Cohesion: 0.13
Nodes (17): platformSettingSchema, DeliveryPromise, formatHour(), DEFAULT_STORE_CONFIG, PlatformSettingRecord, StoreConfig, storeConfigSchema, CartTotals (+9 more)
...
Cohesion: 0.13
Nodes (21): BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan, Badge(), grabDocument(), HostelAdminBillingPageContent(), InvoiceRow() (+13 more)
...
Cohesion: 0.13
Nodes (20): Choice, maneuverIcon(), MapButton(), ModeTab(), NavCard(), NOTHING_CHOSEN, RouteCard(), buildHtml() (+12 more)
...
Cohesion: 0.09
Nodes (20): dayOfWeekSchema, foodFeedbackSchema, foodMenuCreateSchema, foodMenuListQuerySchema, foodMenuUpdateSchema, foodRoutineSaveSchema, mealTypeSchema, objectIdSchema (+12 more)
...
Cohesion: 0.1
Nodes (18): fromBs(), gregorianOf(), BillableResident, { amount }, asar(), bhadra(), byRoomType, charge (+10 more)
...
Cohesion: 0.13
Nodes (18): feeUpdateSchema, PATCH(), setResidentMonthlyFee(), POST(), GET(), generateMonthlyPayments(), getMonthlyPaymentMatrix(), resolveAdminHostelId() (+10 more)
...
Cohesion: 0.11
Nodes (20): CREDIT_MARKERS, DEBIT_MARKERS, DirectionRead, directionRefusal(), EvidenceDirection, EvidenceOutcome, matched(), OUTCOME_MARKERS (+12 more)
...
Cohesion: 0.13
Nodes (22): code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {), code:typescript ({), code:typescript (interface IMoveInChecklistItem {), code:typescript (interface IMoveOutChecklistItem {), code:typescript (interface IServiceProvider {), code:typescript (interface IServiceProvider {), code:typescript (interface IMaintenanceRequest {) (+14 more)
...
Cohesion: 0.1
Nodes (18): bsPeriodBounds(), periodStartDate(), defaultDueDate(), DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue() (+10 more)
...
Cohesion: 0.1
Nodes (20): buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, firstIncompleteIdentityStep(), IDENTITY_STEP_FIELDS, IDENTITY_STEPS (+12 more)

### Community 193 - "Community 193"
Cohesion: 0.1
Nodes (18): releaseWaiters(), rotateAccessToken(), body, decoder, EvidenceFields, EvidenceReference, EvidenceStage, FetchLike (+10 more)
...
Cohesion: 0.17
Nodes (17): auditWardenAction(), createHostelWarden(), deactivateHostelWarden(), findScopedWarden(), HostelMemberRecord, hydrateUser(), MemberStatus, serializeWarden() (+9 more)
...
Cohesion: 0.13
Nodes (17): boundsCenter(), haversineMeters(), hostelCoordinates(), HostelWithDistance, isUsableCoordinate(), KATHMANDU, distance, far (+9 more)

### Community 203 - "Community 203"
Cohesion: 0.12
Nodes (17): Compass(), cardinalFor(), chooseHeading(), headingDifference(), normaliseHeading(), smoothHeading(), corner, dogleg (+9 more)

### Community 204 - "Community 204"
Cohesion: 0.16
Nodes (18): Guidance, useGuidance(), NavigationFix, watchDeviceHeading(), watchNavigationPosition(), CARDINALS, directionWord(), distanceToPath() (+10 more)
...
Cohesion: 0.17
Nodes (17): AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim(), buildAddressQuery(), definedParts(), geocodeWithGoogle(), geocodeWithNominatim(), GoogleAddressComponent (+9 more)
...
Cohesion: 0.14
Nodes (17): firstIncompleteProviderStep(), hasProviderErrors(), isProviderStepComplete(), PROVIDER_CATEGORIES, PROVIDER_STEPS, ProviderAttachment, ProviderCategory, providerCategoryLabel() (+9 more)
...
Cohesion: 0.14
Nodes (14): activateResident(), AuthSession, submitResidentReview(), AppNavigator(), RootStackParamList, Stack, Props, ResidentActivationScreen() (+6 more)
...
Cohesion: 0.24
Nodes (17): code:typescript (interface IInquiry {), code:typescript (interface IHostelPageView {), code:typescript (// One per resident, per hostel. Minted lazily on first dash), code:typescript (interface ISubscription {), code:typescript (interface IPlatformSetting {), HostelPageView, Inquiries, Referral, Notifications, Subscriptions, Inquiry (+9 more)
...
Cohesion: 0.2
Nodes (12): deleteTeamMember(), endSessions(), findMember(), reinstateTeamMember(), removeTeamMember(), suspendTeamMember(), memberId, mocks (+4 more)
...
Cohesion: 0.3
Nodes (14): subscriptionReceiptEmail(), hostelVerifiedEmail(), hostelSubmissionReceivedEmail(), appBase(), attach(), deliver(), formatEmailDate(), hostelListingUrl() (+6 more)
...
Cohesion: 0.18
Nodes (10): requestOtp(), signInWithGoogle(), triggerSOS(), LoginScreen(), Props, Props, ResidentSOSScreen(), Props (+2 more)
...
Cohesion: 0.26
Nodes (10): NearbyStatus, Coordinates, hasLocationPermission(), hasPromptedForLocation(), LocationOutcome, readPosition(), rememberLocationPrompt(), requestDeviceLocation() (+2 more)
...
Cohesion: 0.2
Nodes (11): apiRequest(), confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), getResidentProfile(), listResidentComplaints(), login(), refreshSession() (+3 more)
...
Cohesion: 0.36
Nodes (8): GET(), getAgentSummary(), listAgentRegistrations(), listTeamInvites(), listTeamRegistrations(), listTeamRoster(), moneyBySubscription(), SubscriptionRow
...
Cohesion: 0.25
Nodes (9): 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, 3.3 Payment Proof Uploaded (to Admin), code:typescript ({), code:block14 (---), code:typescript ({) (+1 more)
...
Cohesion: 0.32
Nodes (8): 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, code:typescript ({), code:typescript ({), code:typescript ({)
...
Cohesion: 0.29
Nodes (7): continueLabel(), isBlank(), hasIdentityErrors(), identityStepComplete(), phoneError(), validateIdentity(), validateIdentityStep()
...
Cohesion: 0.29
Nodes (6): currentPeriod(), hostelId, mocks, principal, residentA, residentB

### Community 419 - "Community 419"
Cohesion: 0.43
Nodes (6): bsMajorityPeriod(), dirname, log(), main(), repoRoot, slot()
...
## Knowledge Gaps
- **5683 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+5678 more)
...
- **Why does `Button()` connect `Community 5` to `Community 1`, `Community 2`, `Community 4`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 15`, `Community 22`, `Community 25`, `Community 26`, `Community 28`, `Community 157`, `Community 32`, `Community 33`, `Community 35`, `Community 40`, `Community 168`, `Community 53`, `Community 54`, `Community 60`, `Community 189`, `Community 65`, `Community 83`, `Community 98`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 187` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 133`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 15`, `Community 149`, `Community 22`, `Community 21`, `Community 154`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 34`, `Community 419`, `Community 297`, `Community 172`, `Community 47`, `Community 177`, `Community 57`, `Community 186`, `Community 194`, `Community 67`, `Community 76`, `Community 78`, `Community 79`, `Community 339`, `Community 87`, `Community 89`, `Community 92`, `Community 230`, `Community 114`, `Community 121`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 25` to `Community 1`, `Community 4`, `Community 5`, `Community 135`, `Community 7`, `Community 11`, `Community 15`, `Community 20`, `Community 22`, `Community 24`, `Community 26`, `Community 154`, `Community 283`, `Community 29`, `Community 34`, `Community 297`, `Community 42`, `Community 45`, `Community 51`, `Community 53`, `Community 59`, `Community 189`, `Community 65`, `Community 70`, `Community 72`, `Community 73`, `Community 76`, `Community 79`, `Community 82`, `Community 107`, `Community 110`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Are the 436 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 436 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `iosUrlScheme`, `{ defineConfig }`, `expoConfig` to the rest of the system?**
  _5683 weakly-connected nodes found - possible documentation gaps or missing edges._
