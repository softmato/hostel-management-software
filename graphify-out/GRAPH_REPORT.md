...
## Corpus Check
- 2242 files · ~3,405,401 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17882 nodes · 50278 edges · 575 communities (545 shown, 30 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 840 edges (avg confidence: 0.8)
...
## Communities (575 total, 30 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (227): PATCH(), POST(), RouteContext, GET(), POST(), PATCH(), POST(), RouteContext (+219 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (194): ICONS, LABELS, Segment, TONES, FILTERS, Pending, Overview, MoneyData (+186 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (299): loadOverview(), loadMoney(), loadToday(), CalendarPreferenceCard(), NightStatusPromptCard(), loadFinance(), DeletionRequest, DeletionStatus (+291 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (207): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel() (+199 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (166): PlanPaymentClaim, ReviewPayoutAccount(), STATUS_LABEL, deferLoad(), DemoDataBadge(), Hostel, HostelTable(), Inquiry (+158 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (191): Scanner(), FaqRow(), MethodCard(), CookInviteScreen(), GuardianInviteScreen(), Choice, Compass(), MapButton() (+183 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (190): getOpenFeeSchedule(), listPublicFoodRoutine(), addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery, HostelAdminInquiryStatusInput, InquiryNoteCreateInput (+182 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (179): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, notifyHostelOfNewPost(), resolveHostelCommunityUserIds() (+171 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (164): ActivateScreen(), BootGate(), RootShell(), NightStatusHistoryScreen(), ApplyBlock(), ServiceProvidersScreen(), LoginScreen(), BrandSplash() (+156 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (157): HIDDEN, RoleLayout(), TABS, invalidateFeeds(), writeFeedRead(), TABS, CommunityScreen(), Composer() (+149 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (152): POST(), POST(), answerSchema, POST(), attacker, attempt(), headers, jsonRequest() (+144 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (164): POST(), RouteContext, DELETE(), GET(), hostelId(), GET(), POST(), DELETE() (+156 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (137): AdminCommunityScreen(), SosScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD (+129 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (168): AdminCommunityReportsScreen(), AdminMoreScreen(), AdminResidentsScreen(), AttendanceScreen(), NightStatusForm(), NightStatusScreen(), NotificationCard(), NotificationRow() (+160 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (130): CommunityReportDialog(), REASONS, ConfirmOptions, Notification, humanizeValue(), ImportedProfileSummary(), PrefillOccupancy, PrefillPhoto (+122 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (145): CommunityPageContent(), Badge(), grabDocument(), HostelAdminBillingPageContent(), InvoiceRow(), PaymentRow(), PlanCard(), rupees() (+137 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (109): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), dueWhen(), PlanDueInput (+101 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (142): BookingEndCause, HostelBookingClosedCause, hoursWord(), announceConfirmed(), announceEnding(), assertAwaitingAnswer(), cancelBookingByHostel(), cancelBookingByPlatform() (+134 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (128): PaymentMonthStrip(), ClearFilters(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard(), AmountCard() (+120 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (115): getHostelLedger(), collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES (+107 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (113): CentrePin(), describeAddress(), HostelPinField(), HostelPinPicker(), KATHMANDU, MapLinkField(), PickerBody(), PinAddress (+105 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (101): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, metadata, BrandWordmark(), WORDMARK, WORDMARK_SEGMENTS, LedgerMonth, LedgerPayment (+93 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (97): Choice, HOSTEL_TYPE_LABELS, HostelPanel(), MapButton(), MapCanvas, ModeTab(), NavigationPanel(), NOTHING_CHOSEN (+89 more)

### Community 23 - "Community 23"
Cohesion: 0.02
Nodes (84): POST(), GET(), assetId, hostelId, mocks, otherHostelId, principal, cookCreateSchema (+76 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (92): ConcessionBackfill, describeApplied(), FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, MonthDiscounts, monthStartPeriod(), Rate (+84 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (100): BookingQuote, GuestBookingDetail, GuestBookingSummary, HostelBookingView, metadata, PayoutAccountForReview, List(), ReasonAction() (+92 more)
...
Cohesion: 0.03
Nodes (103): ReviewForm(), ReviewScreen(), describeGrants(), GuardianRow(), PermissionSheet(), InviteGuardianScreen(), inviteGuardian(), listGuardians() (+95 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (93): GET(), POST(), GET(), POST(), GET(), readReturnState(), ownerIdentitiesFor(), resolveOwnedHostel() (+85 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (98): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput, ConsentInput (+90 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (80): HostelSuggestions(), GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS (+72 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (103): bsMonthStart(), formatBsDayRange(), fromBs(), gregorianOf(), bhadra(), aswin, bhadra, bs() (+95 more)

### Community 32 - "Community 32"
Cohesion: 0.02
Nodes (85): EMPTY_PAYOUT_DRAFT, METHODS, PayoutAccountDraft, PayoutAccountFields(), payoutAccountPayload(), DescriptionFacts, DescriptionSuggestions(), HostelType (+77 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (97): SORTS, StoreCategoryScreen(), AdminNightStatusRow, filterRollCall(), NightStatusValue, OVERRIDE_OPTIONS, ROLL_CALL_SEGMENTS, rollCallCounts() (+89 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (98): demoteToPublicAccount(), CardBooking, checkInBooking(), findCardBooking(), findHeldBooking(), returnHeldBed(), takeHeldBed(), LIVE_ACCESS (+90 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (85): listPlatformHostels(), ApiPrincipal, PaginationMeta, PaginationQuery, paginationRange(), querySchema, reviewModerationLogSchema, CampaignListQuery (+77 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (68): PATCH(), RouteContext, GET(), dayOfWeekSchema, foodFeedbackSchema, foodMenuCreateSchema, foodMenuListQuerySchema, foodMenuUpdateSchema (+60 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (62): PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), getPlatformSubscriptionLedger(), listPlanPaymentClaims(), GET(), communityHideSchema, RouteContext (+54 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (72): summarizeResidentComplaints(), listResidentInvoices(), renderStatementForResident(), getResidentLedger(), ResidentDoc, ResidentLedger, ResidentLedgerMonth, ResidentLedgerPayment (+64 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (65): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, ENDPOINTS, esewaProvider, SIGNED_FIELDS, attempt, fetchMock (+57 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (73): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), base, entityId, hostelId, mocks, principal (+65 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (73): cookLoginStem(), generateCookPassword(), mintCookLogin(), pick(), previousCookLabel(), cookPrincipal, mocks, acceptCookInvitation() (+65 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (59): POST(), POST(), POST(), POST(), POST(), POST(), RouteContext, POST() (+51 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (77): AttachmentGallery(), approveMatchedStatement(), assignOrphanPayment(), ReconciliationView, StatementProvider, ApiFailure, bootstrapSession(), assertMatchesExtension() (+69 more)

### Community 44 - "Community 44"
Cohesion: 0.03
Nodes (53): ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, RETAINED_BY_HOSTEL_ID, both, covered (+45 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (58): metadata, AccountDeletionPanel, BrandMark(), ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections() (+50 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (74): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt, deliver() (+66 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (60): MESSAGES, POST(), RouteContext, setHostelBookingPause(), mergeBookingConfig(), getPlatformBooking(), listPausedHostels(), listPlatformBookings() (+52 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (62): outstandingForResident(), depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, providedItemSchema, qrActivationSchema, residentSchema, auditMoveAction() (+54 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (66): authorUserId, mocks, postId, residentId, residentPrincipal, staffPrincipal, AnnouncementInput, CommentCreateInput (+58 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (64): openStore(), createNoticePush(), deleteNoticePush(), NoticePush, NoticePushInput, NoticePushRepeat, sendNoticePushNow(), updateNoticePush() (+56 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (64): classifyCredit(), CreditClassification, findOrphanClaims(), LadderClaim, LadderInvoice, loadMatchContext(), MatchContext, normalizeTxnId() (+56 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (60): approveClaim(), assertNotAlreadyRecordedFromStatement(), bulkApproveClaims(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck(), evidenceCheck() (+52 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (28): InlineText(), PlansEditor, PlatformConfigAnnouncementsPageContent, PlatformConfigContentPageContent, PlatformConfigFacilitiesPageContent, FLAGS, PlatformConfigFeaturesPageContent, PlatformConfigLegalPageContent (+20 more)
...
Cohesion: 0.04
Nodes (58): GET(), POST(), querySchema, RouteContext, getCommunitySettings(), communityAnnouncementSchema, communityCommentCreateSchema, communityFeedQuerySchema (+50 more)
...
Cohesion: 0.05
Nodes (66): BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodBounds(), bsPeriodOf() (+58 more)
...
Cohesion: 0.05
Nodes (52): PLATFORM_ROLES, escapeRegex(), objectIdSchema, paginationSchema, phoneSchema, SERVICE_PROVIDER_CATEGORIES, serviceProviderSchema, serviceProviderApplicationSchema (+44 more)

### Community 61 - "Community 61"
Cohesion: 0.05
Nodes (57): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), AdminTabs(), AdminMoneyScreen(), AdminTodayScreen(), AdminAlertsContext, AdminAlertsProvider() (+49 more)

### Community 62 - "Community 62"
Cohesion: 0.06
Nodes (57): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, GATEWAY_ORDER, getHostelPayMethods() (+49 more)

### Community 63 - "Community 63"
Cohesion: 0.07
Nodes (53): resolvePastedLink(), searchCandidates(), geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), lookupLocation(), resolvePastedLink() (+45 more)
...
Cohesion: 0.04
Nodes (48): financeIntegrityHash(), GatewayHealth, GatewayHealthSummary, getGatewayHealth(), IntentCounts, plural(), runGatewayHealthForHostel(), SEVERITY (+40 more)

### Community 67 - "Community 67"
Cohesion: 0.06
Nodes (50): CSV_COLUMNS, GET(), GET(), periodTotals(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS (+42 more)
...
Cohesion: 0.05
Nodes (59): buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, draftFromProfile(), emptyIdentityDraft(), firstIncompleteIdentityStep() (+51 more)
...
Cohesion: 0.04
Nodes (53): Faq, PlatformConfigSeoPageContent, Step, CONTENT_ICON_SLUGS, everything, IDENTITY, page, rendered (+45 more)

### Community 72 - "Community 72"
Cohesion: 0.04
Nodes (46): FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES, avatarTone(), CommunityComment (+38 more)
...
Cohesion: 0.05
Nodes (53): noticePushSchema, noticeReadStatusSchema, mocks, noticeInput, residentUserId, staffPrincipal, announceChange(), audit() (+45 more)

### Community 75 - "Community 75"
Cohesion: 0.06
Nodes (57): AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance(), deadline(), DIGIT_CONFUSABLES, EvidenceRead (+49 more)

### Community 76 - "Community 76"
Cohesion: 0.05
Nodes (53): CHANNELS, ClaimedStep, composeEmail(), composeNotice(), composePlanDueNotice(), deliverEmail(), deliverStep(), HostelRow (+45 more)

### Community 77 - "Community 77"
Cohesion: 0.06
Nodes (54): paymentProofSchema, arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal (+46 more)

### Community 78 - "Community 78"
Cohesion: 0.04
Nodes (46): HostelAdminCooksPanel, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine, formatWeekRange() (+38 more)

### Community 79 - "Community 79"
Cohesion: 0.04
Nodes (49): account, answerBy, before, book(), Booking, compact, confirmed(), Consent (+41 more)

### Community 80 - "Community 80"
Cohesion: 0.06
Nodes (47): addComplaintUpdate(), assertComplaintVoiceNote(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput (+39 more)

### Community 81 - "Community 81"
Cohesion: 0.07
Nodes (54): personalLookupHash(), getPresignedReadUrl(), userResidentProfileSchema, LEGACY_ROLE_MAP, Role, ROLE_VALUES, ageFromDateOfBirth(), ASSET_KINDS (+46 more)

### Community 82 - "Community 82"
Cohesion: 0.07
Nodes (51): fill(), money(), PlanCard(), PricingScreen(), pricePlan(), currentBsPeriod(), PlanPicker(), BillingToggle() (+43 more)

### Community 83 - "Community 83"
Cohesion: 0.06
Nodes (43): CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, isPlanDueNotification(), readId(), activeDevicesFor(), activeTokensFor(), androidChannel() (+35 more)

### Community 84 - "Community 84"
Cohesion: 0.1
Nodes (41): generateMetadata(), manifest(), robots(), JsonLd(), JsonLdData, ComparisonPage(), ContactPage(), generateMetadata() (+33 more)

### Community 85 - "Community 85"
Cohesion: 0.07
Nodes (42): Entry, hostelEntries(), locationEntries(), sitemap(), STATIC_ROUTES, listPublishedHostelSlugs(), generateMetadata(), buildCityIndex() (+34 more)

### Community 86 - "Community 86"
Cohesion: 0.07
Nodes (42): deleteHostelObjects(), ImageVariantRecord, optimizeImage(), streamToBuffer(), VARIANT_CONFIG, VariantName, r2Configured(), storePublicAsset() (+34 more)
...
Cohesion: 0.06
Nodes (42): AuthLayout(), metadata, PublicServiceDetailPage(), url, view, brandedTitle(), clamp(), ogImagePath() (+34 more)

### Community 90 - "Community 90"
Cohesion: 0.06
Nodes (40): appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind, creditOverpayment(), getCreditAmount(), getCreditBalance(), isDuplicateKey() (+32 more)

### Community 91 - "Community 91"
Cohesion: 0.06
Nodes (25): LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminNightStatusPage(), HostelAdminComplaintsPage(), redirectToWorkspaceScreen(), HostelAdminMaintenancePageContent() (+17 more)

### Community 92 - "Community 92"
Cohesion: 0.05
Nodes (43): BookingForm(), CheckoutScreen(), METHODS, PackageCard(), PayStep(), roomPhotoUris(), StatusCard(), answerHostelBooking() (+35 more)

### Community 93 - "Community 93"
Cohesion: 0.06
Nodes (31): generateMetadata(), generateMetadata(), metadata, ComparePage(), generateMetadata(), hostels, metadata, rows (+23 more)

### Community 94 - "Community 94"
Cohesion: 0.08
Nodes (45): candidateFontDirs(), ensureIdCardFonts(), FONT_DIR_SEGMENTS, FONT_FILES, CARD_NOUNS, CardVariant, drawBack(), drawBrandLockup() (+37 more)

### Community 95 - "Community 95"
Cohesion: 0.08
Nodes (42): BOOKING_DOCUMENT_KINDS, BookingDocumentKind, bookingDocumentLayout(), refundPolicyNotes(), allowed(), bookingDocumentAttachment(), bookingDocumentResponse(), BookingDocumentScope (+34 more)

### Community 96 - "Community 96"
Cohesion: 0.06
Nodes (43): formatPeriodKey(), DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), monthLabel(), parseAmount() (+35 more)

### Community 97 - "Community 97"
Cohesion: 0.05
Nodes (38): CookTodayScreen(), PortalDates, useHostelDayTurn(), useMinuteTick(), useSiteConfig(), PlanBillingInvoice, PlanBillingPayment, PlanBillingPlan (+30 more)
...
Cohesion: 0.07
Nodes (41): GuardianHomeScreen(), GuardianMetrics(), GuardianMoreScreen(), GuardianPaymentsScreen(), GuardianSafetyScreen(), LoginResult, acceptGuardianInvitation(), getGuardianFood() (+33 more)

### Community 104 - "Community 104"
Cohesion: 0.07
Nodes (38): addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange(), definedUpdate(), FoodFeedbackInput, FoodFeedbackRecord, FoodMenuCreateInput (+30 more)

### Community 105 - "Community 105"
Cohesion: 0.07
Nodes (30): applyWebhook(), WebhookResult, checkoutReturnUrl(), OpenCheckoutInput, openSoftmatoCheckout(), softmato(), SoftmatoNotConfiguredError, isSoftmatoConfigured() (+22 more)
...
Cohesion: 0.05
Nodes (24): field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminMoveChecklistPage(), HostelAdminSOSAlertsPage(), LoadState, NightStatusRow, Notification (+16 more)

### Community 108 - "Community 108"
Cohesion: 0.07
Nodes (40): BALANCE_ALIASES, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES, WITHDRAWAL_ALIASES (+32 more)
...
Cohesion: 0.09
Nodes (39): deliver(), Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity, EmailIdentityResolver, envEmailDomain() (+31 more)
...
Cohesion: 0.06
Nodes (28): ProviderDirectoryData, CATEGORIES, isApplicationOpen(), LandingStep(), MeResponse, OwnApplication, ProviderStats, ProviderStatus (+20 more)
...
Cohesion: 0.06
Nodes (27): currency(), LoadingRows(), StatusBadge(), TextArea(), ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent (+19 more)
...
Cohesion: 0.09
Nodes (31): ROUTINE_DAYS, ROUTINE_MEAL_TYPES, RoutineDay, RoutineMealType, Candidate, dueMeals(), MealCallReminderResult, mealLabel() (+23 more)

### Community 122 - "Community 122"
Cohesion: 0.07
Nodes (30): emailFacts(), getHostelPayoutAccount(), hostelOrThrow(), notifyPlatformOfPayoutReview(), PayoutAccountStatus, PayoutAccountView, PayoutActor, PayoutRecord (+22 more)
...
Cohesion: 0.1
Nodes (33): directionOf(), EMPTY_TALLY, floorToStep(), phaseOf(), shouldRepost(), tallyUploads(), active, done (+25 more)
...
Cohesion: 0.09
Nodes (26): TIER_TONE, PlanMark(), RAFTER, RIDGE, ROWS, EASE, listHeadingFor(), PlanCards() (+18 more)

### Community 129 - "Community 129"
Cohesion: 0.12
Nodes (28): applyBookingConfig(), BookingCancelStep, bookingCancelStepSchema, BookingConfig, DEFAULT_BOOKING_CONFIG, DEFAULT_CANCEL_STEPS, percent, bookingGuideIntro() (+20 more)

### Community 130 - "Community 130"
Cohesion: 0.1
Nodes (28): isAuthBypassEnabled(), original, dashboardHrefForRole(), destinationForRole(), isAllowedNextPath(), isHostelWorkspacePath(), isSafeLocalPath(), landingPathForRole() (+20 more)
...
Cohesion: 0.08
Nodes (22): AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex() (+14 more)
...
Cohesion: 0.07
Nodes (23): Complaint, ComplaintSummary, field(), FoodMenu, HostelAdminFoodPage(), HostelAdminNoticesPage(), HostelAdminPaymentsPage(), HostelAdminResidentsPage() (+15 more)
...
Cohesion: 0.12
Nodes (25): loadSiteConfig, loadSiteName(), getListingTier(), listingTiers(), DEFAULT_PLANS, DEFAULT_SITE_CONFIG, coerceSection(), getPublicSiteConfig() (+17 more)

### Community 141 - "Community 141"
Cohesion: 0.12
Nodes (28): cellAt(), focusCell(), Props, RowField, amountText(), blankSheetRow(), CellError, cleanCell() (+20 more)

### Community 142 - "Community 142"
Cohesion: 0.07
Nodes (22): EASE, FaqEntry, FaqRole, FaqRow(), FAQS, PlansFaq(), PREVIEW_ROWS, PREVIEWS (+14 more)
...
Cohesion: 0.09
Nodes (26): softmatoDocsUrl(), dueBhadra29, filed, throughAswin25, BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan (+18 more)
...
Cohesion: 0.08
Nodes (19): EmptyState(), Select(), field(), HostelAdminServiceProvidersPageContent(), ListingFlag, LoadState, MaintenanceRequest, optionalField() (+11 more)

### Community 148 - "Community 148"
Cohesion: 0.11
Nodes (21): notFound(), CityHostelsPage(), generateMetadata(), PageParams, PublicCitiesPage(), PublicLocationPage(), OwnerCallout(), SeoChip() (+13 more)
...
Cohesion: 0.11
Nodes (25): UploadCard(), useIsUploading(), getUploadRows(), isUploadActive(), listeners, pruneUploads(), resetUploadQueue(), rows (+17 more)
...
Cohesion: 0.14
Nodes (18): asRecord(), DrawnPush, readDrawnPush(), message, pushData, NativeNightPrompt, takeNativePendingAnswers(), NightStatusAnswer (+10 more)

### Community 156 - "Community 156"
Cohesion: 0.1
Nodes (20): claimNotificationSound(), claims, resetNotificationSoundClaims(), connectRealtime(), fetchConfig(), PusherModule, REALTIME_EVENT, RealtimeConfig (+12 more)
...
Cohesion: 0.13
Nodes (21): FILE_ASSET_KINDS, FileAssetKind, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), isPlatformOnlyAssetKind(), PLATFORM_ONLY_KINDS, DEFAULT_DOCUMENT_MIME_TYPES (+13 more)
...
Cohesion: 0.09
Nodes (23): BANK_CSV_PARSER, ESEWA_CSV_PARSER, both, corrupted, debit, [first], FIXTURE, headerOnly (+15 more)
...
Cohesion: 0.15
Nodes (21): dashboardUrl(), notifyWardenAdded(), notifyWardenUpdated(), auditWardenAction(), createHostelWarden(), deactivateHostelWarden(), findScopedWarden(), HostelMemberRecord (+13 more)
...
Cohesion: 0.12
Nodes (20): listTrendingTags(), sponsorSchema, GET(), loadPopularHostels(), PopularHostelRecord, assertWindow(), CreateInput, createSponsor() (+12 more)
...
Cohesion: 0.12
Nodes (12): Footer(), IdCardFace(), initialsOf(), Portrait(), SIGNATURE_BOX, CARD_COLORS, IdCard, drawSignature() (+4 more)
...
Cohesion: 0.16
Nodes (24): AccountDeletionRequest, code:typescript ({), code:typescript ({), code:typescript (interface IQuestionCallClick {), code:typescript ({), code:typescript ({), code:typescript (interface IAccountDeletionRequest {), code:block43 (packages/db/migrations/) (+16 more)
...
Cohesion: 0.14
Nodes (21): maneuverIcon(), NavCard(), NavigationFix, watchDeviceHeading(), watchNavigationPosition(), CARDINALS, directionWord(), distanceToPath() (+13 more)
...
Cohesion: 0.12
Nodes (15): BookButton(), SIZE, BookingAvailabilityView, BookingButton, CLOSED_REASONS, open, CATEGORY_LABELS, NEARBY_GROUPS (+7 more)
...
Cohesion: 0.15
Nodes (18): assertEnablable(), blockedReasonFor(), deleteGatewayConfig(), GATEWAY_REQUIREMENTS, GatewayConfigView, GatewaySecretView, listGatewayConfigs(), saveGatewayConfig() (+10 more)
...
Cohesion: 0.16
Nodes (18): resolveTiming(), asPushTiming(), laterFromDelay(), nextNoticePushRun(), noticePushExpiry(), NoticePushRepeat, NoticePushTiming, sentAt (+10 more)
...
Cohesion: 0.12
Nodes (17): activateResident(), getResidentProfile(), submitResidentReview(), triggerSOS(), RootStackParamList, Props, Props, ResidentActivationScreen() (+9 more)
...
Cohesion: 0.1
Nodes (20): AMOUNT_ALIASES, counterparty(), CREDIT_ALIASES, CREDIT_WORDS, DATE_ALIASES, DEBIT_ALIASES, DEBIT_WORDS, DESCRIPTION_ALIASES (+12 more)
...
Cohesion: 0.14
Nodes (17): isUsableCoordinate(), fetchRoadRoute(), isRecord(), parseRoadRoute(), parseSteps(), ROUTE_MODES, ROUTERS, RouteStep (+9 more)
...
Cohesion: 0.17
Nodes (17): findSuspendedHostelIds(), isOpenWhileSuspended(), liftHostelSuspension(), objectIds(), OPEN_WHILE_SUSPENDED, serializeSuspension(), hostelObjectId(), HostelSuspensionError (+9 more)
...
Cohesion: 0.13
Nodes (15): boundsCenter(), haversineMeters(), HostelWithDistance, KATHMANDU, distance, far, input, middle (+7 more)
...
Cohesion: 0.14
Nodes (8): ExistingResidentsPanel(), Props, ExistingResidentsSheet(), HostelAdminExistingResidentsPage(), TeamHostelResidentsPage(), useWorkspaceHref(), hostelAdminHref(), Props
...
Cohesion: 0.23
Nodes (17): AttendanceAlert, AttendanceLog, code:typescript ({), code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({) (+9 more)

### Community 250 - "Community 250"
Cohesion: 0.17
Nodes (17): Attendance / Night Safety, code:typescript (interface INightStatusLog {), code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface INotice {), code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {), Food (+9 more)
...
Cohesion: 0.18
Nodes (14): configureNativeNightPrompt(), registerNightStatusCategory(), drawPush(), createAndroidChannels(), easProjectId(), fetchExpoPushToken(), forgetPushToken(), PUSH_CHANNEL (+6 more)
...
Cohesion: 0.18
Nodes (13): buildHtml(), buildPage(), buildPinPage(), buildShell(), MapExplorer, MapExplorerProps, MapHandle, MapMarker (+5 more)
...
Cohesion: 0.16
Nodes (11): attendanceAlertResolveSchema, attendanceListQuerySchema, attendanceOverrideSchema, attendanceSettingsSchema, consentSchema, locationPingSchema, objectIdSchema, PATCH() (+3 more)
...
Cohesion: 0.15
Nodes (15): 3.1 Payment Due Reminder, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails, 4.2 Complaint Status Updated, 4.3 Complaint Resolved, 4. Resident Activity Emails (+7 more)

### Community 279 - "Community 279"
Cohesion: 0.18
Nodes (15): 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6. Service Provider Emails, 7.1 New Hostel Pending Approval (to Superadmin), 7.2 Subscription Expiring Soon, 7. Platform Admin Emails, 8.1 Community Post Engagement (Batched) (+7 more)
...
Cohesion: 0.24
Nodes (6): Claim, CouldNotCreateFileException, HostelHubDownloadsModule, UnreadableSourceException, UnsupportedOnThisAndroidException, file
...
Cohesion: 0.16
Nodes (10): AuthSession, getResidentReferral(), ResidentReferral, ResidentReferralCode, AppNavigator(), Stack, LoginScreen(), ResidentFoodScreen() (+2 more)
...
Cohesion: 0.23
Nodes (7): computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), systemDocumentKindFromText(), distance, base
...
Cohesion: 0.17
Nodes (12): 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 7.1 Attendance Alert (Resident Absent), 7. Attendance & Location Tracking Emails, 9.1 Account Deletion Requested, 9.1a Account Deletion Request Needs Review *(added 2026-08-02)*, 9.2 Account Deletion Cancelled, 9.3 Location History Deletion Approved, 9. Account & Privacy Emails (+4 more)

### Community 332 - "Community 332"
Cohesion: 0.17
Nodes (11): 12.1 Flaky Tests, 12.3 E2E Tests Timing Out, 12. Common Pitfalls & Debugging Tips, 13. Resources & Further Reading, 1. Goals & Philosophy, 2. Test Pyramid, 3. Tooling & Frameworks, 5. Coverage Expectations (+3 more)

### Community 333 - "Community 333"
Cohesion: 0.17
Nodes (12): 12.2 Tenant Isolation Bugs, 7.3 Privacy/Guardian Permissions Test Template, 9.1 Seed Scripts, 9.2 Test Database Isolation, 9.3 Test Helpers, 9. Test Data & Seeding, code:typescript (describe('GET /api/v1/guardian/linked-resident - privacy', (), code:typescript (describe('POST /api/v1/hostel/residents - account upgrade', ) (+4 more)
...
Cohesion: 0.29
Nodes (9): hasLocationPermission(), hasPromptedForLocation(), LocationOutcome, readPosition(), readPrecisePosition(), rememberLocationPrompt(), requestDeviceLocation(), toCoordinates() (+1 more)
...
Cohesion: 0.22
Nodes (8): DEFAULT_GUARDIAN_PERMISSIONS, guardianAccessCreateSchema, guardianInvitationAcceptSchema, guardianInviteSchema, guardianLoginSchema, guardianPermissionsSchema, guardianPermissionsUpdateSchema, objectIdSchema
...
Cohesion: 0.28
Nodes (7): noticePushCreateSchema, noticePushFields, noticePushListQuerySchema, noticePushScopeSchema, noticePushUpdateSchema, objectIdSchema, timeSchema
...
Cohesion: 0.29
Nodes (8): 7.1 Multi-Tenant Isolation Test Template, 7.2 Role Gate Test Template, 7.5 Payment Precision Test Template, 7. Mandatory Test Templates, code:typescript (describe('GET /api/v1/hostel/rooms/:id - tenant isolation', ), code:typescript (describe('GET /api/v1/hostel/rooms - role access', () => {), code:bash (npm --prefix apps/web run typecheck), code:bash (npm run web:lint)
...
Cohesion: 0.4
Nodes (6): 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, code:typescript ({), code:typescript ({)
...
Cohesion: 0.5
Nodes (3): moveInChecklistSchema, moveOutChecklistSchema, objectIdSchema
...
## Knowledge Gaps
- **6168 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+6163 more)
...
- **Why does `cn()` connect `Community 14` to `Community 128`, `Community 1`, `Community 3`, `Community 4`, `Community 260`, `Community 134`, `Community 139`, `Community 141`, `Community 142`, `Community 15`, `Community 148`, `Community 21`, `Community 22`, `Community 20`, `Community 24`, `Community 25`, `Community 30`, `Community 32`, `Community 45`, `Community 302`, `Community 177`, `Community 53`, `Community 59`, `Community 188`, `Community 64`, `Community 72`, `Community 78`, `Community 82`, `Community 88`, `Community 93`, `Community 98`, `Community 238`, `Community 115`, `Community 117`, `Community 125`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 1` to `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 8`, `Community 9`, `Community 12`, `Community 13`, `Community 14`, `Community 18`, `Community 20`, `Community 21`, `Community 24`, `Community 26`, `Community 27`, `Community 43`, `Community 45`, `Community 50`, `Community 61`, `Community 68`, `Community 72`, `Community 78`, `Community 92`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `Role` connect `Community 23` to `Community 0`, `Community 130`, `Community 3`, `Community 4`, `Community 390`, `Community 7`, `Community 262`, `Community 6`, `Community 10`, `Community 11`, `Community 17`, `Community 21`, `Community 25`, `Community 28`, `Community 29`, `Community 158`, `Community 31`, `Community 414`, `Community 34`, `Community 35`, `Community 37`, `Community 38`, `Community 167`, `Community 40`, `Community 41`, `Community 47`, `Community 48`, `Community 49`, `Community 178`, `Community 51`, `Community 52`, `Community 437`, `Community 55`, `Community 58`, `Community 64`, `Community 322`, `Community 194`, `Community 70`, `Community 202`, `Community 74`, `Community 76`, `Community 203`, `Community 77`, `Community 79`, `Community 80`, `Community 83`, `Community 343`, `Community 87`, `Community 223`, `Community 99`, `Community 104`, `Community 109`, `Community 246`, `Community 122`, `Community 251`, `Community 252`, `Community 125`?**
