...
## Corpus Check
- 2368 files · ~5,142,541 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21334 nodes · 60294 edges · 595 communities (563 shown, 32 thin omitted)
...
## Communities (595 total, 32 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.0
Nodes (482): 594(), 978(), [A,P], {actionStateRoute:v,navigationState:P}, activate(), activeAnimationId(), activeThemeId(), Ad() (+474 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (351): RouteContext, GET(), POST(), GET(), PATCH(), POST(), RouteContext, GET() (+343 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (184): FILTERS, Pending, Overview, MoneyData, MANAGE_ROWS, PORTAL_ROWS, TodayData, Person (+176 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (237): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel() (+229 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (207): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, metadata, LegacyHostelAdminAttendancePage(), HostelBookingView, LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage() (+199 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (279): loadOverview(), loadMoney(), loadToday(), loadFinance(), getAdminFoodRoutine(), getAdminHostel(), getAdminInvoices(), getAdminMaintenance() (+271 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (244): PATCH(), RouteContext, fileFieldCash(), getOrCreateSubscription(), selectPlan(), POST(), getOpenFeeSchedule(), GET() (+236 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (249): Scanner(), CookInviteScreen(), GuardianInviteScreen(), Assurance(), CallableRow(), IdentityCard(), PeopleSection(), SavedListRow() (+241 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (124): DeliveryWindowFields(), number(), text(), parseAmount(), clockTime(), draftFrom(), toNumber(), statusCodeOf() (+116 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (163): FieldCashRow, PlanPaymentClaim, formatBsAdDate(), Filter, ModeratedPost, ModerationPayload, HostelTable(), ReportGrid() (+155 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (186): POST(), POST(), POST(), answerSchema, POST(), POST(), attacker, attempt() (+178 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (201): AdminMoreScreen(), ActivateScreen(), APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard() (+193 more)

### Community 12 - "Community 12"
Cohesion: 0.01
Nodes (214): bsMonthStart(), bsPeriodBounds(), bsPeriodOf(), fromBs(), gregorianOf(), periodStartDate(), defaultDueDate(), openOrder() (+206 more)

### Community 13 - "Community 13"
Cohesion: 0.01
Nodes (75): add(), addChangeListener(), addEventListener(), addListenerForTag(), assert(), attachGestureHandler(), bubbles(), cancelable() (+67 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (209): deleteResidentLocationHistory(), getResidentAttendance(), listAttendanceAlerts(), authorUserId, mocks, postId, residentId, residentPrincipal (+201 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (214): AdminAlertsScreen(), ICONS, LABELS, Segment, TONES, AdminCommunityReportsScreen(), AdminHomeScreen(), AdminOverviewScreen() (+206 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (162): BubbleBackground(), BubbleBackgroundProps, BubbleColors, StarLayer(), StarLayerProps, StarsBackground(), StarsBackgroundProps, GuestBookingDetail (+154 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (183): MESSAGES, POST(), RouteContext, mergeBookingConfig(), listPausedHostels(), listPlatformBookings(), transfersByBooking(), listTransfersDue() (+175 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (193): DeletionPanel(), NotificationSettings(), BookingScreen(), whatNext(), SORTS, StoreCategoryScreen(), DeletionRequest, DeletionStatus (+185 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (177): AdminTabs(), HIDDEN, RoleLayout(), TABS, FILTERS, invalidateFeeds(), NIGHT_ANSWER_LABELS, nightAnswerText() (+169 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (189): BookingEndCause, HostelBookingClosedCause, announceConfirmed(), announceEnding(), assertAwaitingAnswer(), cancelBookingByHostel(), cancelBookingByPlatform(), cancelMyBooking() (+181 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (200): aa(), Ac(), af(), ai(), Al(), an(), as(), ba() (+192 more)
...
Cohesion: 0.02
Nodes (165): approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal, checker, eventId (+157 more)

### Community 24 - "Community 24"
Cohesion: 0.02
Nodes (138): AdminCommunityScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+130 more)

### Community 25 - "Community 25"
Cohesion: 0.02
Nodes (25): Render the pamphlet.  One master per side: A4 + 3 mm bleed at 600 dpi. The A4, shoot(), __addChild(), addPendingGesture(), cancelEvent(), composedPath(), __destroy_into_raw(), disconnect() (+17 more)

### Community 26 - "Community 26"
Cohesion: 0.06
Nodes (115): accountDeletionCancelledEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), ATTACHED, dueWhen(), payOnWebsite() (+107 more)

### Community 27 - "Community 27"
Cohesion: 0.02
Nodes (136): runPlanDueReminders(), auditFinanceAction(), FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), runPaymentReminders(), GATEWAY_ORDER, getHostelPayMethods() (+128 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (163): deliver(), abort(), _adopt(), _animationLoop(), ar(), assignAnimationToWorker(), at(), broadcastMessage() (+155 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (141): PaymentMonthStrip(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard(), AmountCard(), AdminLedger (+133 more)

### Community 30 - "Community 30"
Cohesion: 0.02
Nodes (152): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags() (+144 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (129): notifyHostelOfNewPost(), resolveHostelCommunityUserIds(), usersMutingNewPosts(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus(), OPEN_STATUSES, OverdueComplaint (+121 more)

### Community 32 - "Community 32"
Cohesion: 0.02
Nodes (127): POST(), PaginationMeta, PaginationQuery, querySchema, deviceTokenSchema, noticeSchema, noticePushSchema, noticeReadStatusSchema (+119 more)

### Community 33 - "Community 33"
Cohesion: 0.02
Nodes (104): adminPrincipal, mocks, PLATFORM_LIMITS, authorUserId, leanResult(), mocks, postId, reactorUserId (+96 more)

### Community 34 - "Community 34"
Cohesion: 0.02
Nodes (108): GetAppDialog(), Platform, GetPlanButton(), ConcessionBackfill, describeApplied(), FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent (+100 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (117): getHostelLedger(), collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES (+109 more)

### Community 36 - "Community 36"
Cohesion: 0.02
Nodes (121): NightStatusForm(), ReviewForm(), ReviewScreen(), AlertRow(), SosScreen(), SosInput, SosPhase, nepalDayKey() (+113 more)

### Community 37 - "Community 37"
Cohesion: 0.06
Nodes (84): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, budgetLabel(), LoadState (+76 more)

### Community 38 - "Community 38"
Cohesion: 0.02
Nodes (109): BrandMark(), BrandWordmark(), WORDMARK, WORDMARK_SEGMENTS, ActiveSuspension, HostelSuspendedScreen(), HostelSuspensionNotice(), isHostelPortal() (+101 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (95): metadata, AccountDeletionPanel, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails() (+87 more)

### Community 40 - "Community 40"
Cohesion: 0.02
Nodes (14): build(), componentWillUnmount(), createInteractionHandle(), duration(), __getAnimatedValue(), __getValue(), impactAsync(), __onAnimatedValueUpdateReceived() (+6 more)

### Community 41 - "Community 41"
Cohesion: 0.03
Nodes (104): cookPrincipal, mocks, resolveCookLabels(), CookServiceError, resolveAdminHostelId(), announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord (+96 more)

### Community 42 - "Community 42"
Cohesion: 0.03
Nodes (107): CommunityPageContent(), labelled(), VideoSlot(), CollectionQrField(), FileUploadArea(), TradeDetailsStep(), PhotoStrip(), downloadCaption() (+99 more)
...
Cohesion: 0.03
Nodes (94): POST(), GET(), POST(), cookCreateSchema, cookInvitationAcceptSchema, cookNameSchema, cookPortalUpdateSchema, cookRemoveSchema (+86 more)

### Community 46 - "Community 46"
Cohesion: 0.03
Nodes (91): Notification, HostelAdminExistingResidentsPage(), humanizeValue(), ImportedProfileSummary(), PrefillOccupancy, PrefillPhoto, ResidentPrefill, ResidentStatus (+83 more)

### Community 47 - "Community 47"
Cohesion: 0.02
Nodes (6): array(), l(), onStateChange(), returnValue(), so(), watchDeviceHeading()

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (91): GET(), BookableHostel, BookingUnavailableReason, findRoom(), hostelAddress(), HostelAvailability, hostelCoverPhoto(), hostelCoverPhotos() (+83 more)

### Community 49 - "Community 49"
Cohesion: 0.03
Nodes (89): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), methodProvider(), PROVIDER_LABEL, QrPanel() (+81 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (82): CommunityScreen(), Composer(), AttachmentGallery(), AnimatedBlurView, CommunityBoard(), CommunityBoardProps, Composer(), SORTS (+74 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (84): GET(), decodeKey(), decryptPersonalData(), encryptionKey(), encryptPersonalData(), isPersonalDataEncryptionConfigured(), personalLookupHash(), resetPersonalDataKeyCache() (+76 more)

### Community 53 - "Community 53"
Cohesion: 0.03
Nodes (32): bn(), c, Cl(), Ff(), fn(), getImageAsync(), getStringAsync(), gn() (+24 more)

### Community 54 - "Community 54"
Cohesion: 0.04
Nodes (85): demoteToPublicAccount(), CardBooking, checkInBooking(), findCardBooking(), findHeldBooking(), returnHeldBed(), takeHeldBed(), notifyPlatform() (+77 more)

### Community 55 - "Community 55"
Cohesion: 0.03
Nodes (80): listResidentClaims(), candidatesInRun(), canonicalize(), checkCharacter(), CONFUSABLES, decodeSequence(), deriveHostelPrefix(), encodeSequence() (+72 more)

### Community 56 - "Community 56"
Cohesion: 0.03
Nodes (78): Due, InvoiceRow, OPEN_STATUSES, findIndex(), index, indexesOf(), IndexSpec, promote (+70 more)

### Community 57 - "Community 57"
Cohesion: 0.04
Nodes (72): summarizeResidentComplaints(), listResidentInvoices(), renderStatementForResident(), acceptGuardianInvitation(), daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess(), GuardianAccessRecord (+64 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (63): ownerIdentitiesFor(), resolveOwnedHostel(), openSubscriptionCheckout(), getSubscriptionState(), invoiceIdFor(), RouteContext, GET(), querySchema (+55 more)

### Community 59 - "Community 59"
Cohesion: 0.03
Nodes (59): CancelDeletionPageContent(), AcceptResult, CookInvitePageContent, AcceptResult, GuardianInvitePageContent, HostelPhotoReminder(), AcceptResult, Invitation (+51 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (69): checkFieldCash(), submitFieldCash(), BOOKING_DOCUMENT_KINDS, BookingDocumentKind, bookingDocumentLayout(), refundPolicyNotes(), allowed(), bookingDocumentAttachment() (+61 more)

### Community 61 - "Community 61"
Cohesion: 0.04
Nodes (74): CHANNELS, ClaimedStep, composeEmail(), composeNotice(), composePlanDueNotice(), deliver(), deliverEmail(), deliverStep() (+66 more)

### Community 62 - "Community 62"
Cohesion: 0.04
Nodes (7): cancelAnimationFrame(), clear(), darken(), deactivate(), __debouncedOnEnd(), emit(), h()
...
Cohesion: 0.04
Nodes (64): openStore(), createResident(), getIntakeQuote(), IntakeQuote, lookupResidentProfile(), ManagedHostel, RESIDENT_TYPES, ResidentIntakeResult (+56 more)

### Community 65 - "Community 65"
Cohesion: 0.05
Nodes (60): BrowseProfileScreen(), JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, ProviderJobScreen() (+52 more)
...
Cohesion: 0.03
Nodes (55): paginationQuerySchema, DEPRECATED_ALIASES, grantingPermissionKeys(), mocks, listingFlagListQuerySchema, listingFlagResolveSchema, hostelAdminReferralListQuerySchema, objectIdSchema (+47 more)
...
Cohesion: 0.04
Nodes (58): currentBsPeriod(), OfferTab(), Faq, PlatformConfigSeoPageContent, Step, eventRuns(), sellingCatalog(), SEO_PAGE_ROUTES (+50 more)
...
Cohesion: 0.05
Nodes (53): hostelToday(), qrActivationSchema, teamWalletEntrySchema, getOperationsConfig(), saveOperationsConfig(), activateResident(), ActivationCodeGenerateInput, ActivationCodeInput (+45 more)
...
Cohesion: 0.05
Nodes (50): analyseLuminanceTable(), containerOf(), EDITOR_MARKERS, editorFrom(), EvidenceProvenance, ExifFacts, ijgEntry(), isScreenShape() (+42 more)
...
Cohesion: 0.05
Nodes (43): metadata, CheckoutHandoffButton(), Badge(), grabDocument(), InvoiceRow(), PaymentRow(), PlanCard(), rupees() (+35 more)
...
Cohesion: 0.07
Nodes (45): bodySchema, POST(), POST(), RouteContext, computePerceptualHash(), systemDocumentKind(), FILE_ASSET_KINDS, FileAssetKind (+37 more)
...
Cohesion: 0.08
Nodes (48): Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity() (+40 more)

### Community 88 - "Community 88"
Cohesion: 0.05
Nodes (38): PayoutAccountForReview, ReviewPayoutAccount(), STATUS_LABEL, FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar() (+30 more)
...
Cohesion: 0.07
Nodes (49): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodsBetween() (+41 more)

### Community 91 - "Community 91"
Cohesion: 0.06
Nodes (42): Offset, PhotoCropper(), buildIdCardData(), EMAIL_CHECK_HINTS, EmailCheck, Field(), FIELD_LABELS, formatCardDate() (+34 more)

### Community 92 - "Community 92"
Cohesion: 0.07
Nodes (42): assertPlanRoom(), countLive(), notifyLimitReached(), NOUN, PlanLimitError, PlanSeat, hostelId, mocks (+34 more)

### Community 93 - "Community 93"
Cohesion: 0.07
Nodes (36): List(), ReasonAction(), Row(), timeLeft(), Tone, useAction(), useNow(), useConfirm() (+28 more)
...
Cohesion: 0.05
Nodes (35): AuditLogRecord, PlatformAuditLogQuery, RefRecord, serializeAuditLog(), mocks, addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry() (+27 more)

### Community 96 - "Community 96"
Cohesion: 0.08
Nodes (42): nepalMinuteOfDay(), askingEndsAt(), askingEndsMinuteOfNight(), formatPromptTime(), isCurrentNight(), isSameNight(), minuteIsDue(), minuteOfNight() (+34 more)

### Community 97 - "Community 97"
Cohesion: 0.07
Nodes (42): notifyStaffOfJobProgress(), serviceProviderSchema, serviceProviderApplicationSchema, serviceProviderDocumentSchema, notifyPlatformOfServiceProviderApplication(), notifyServiceProviderDecision(), acceptServiceProviderJob(), ACTIVE_APPLICATION_STATUSES (+34 more)
...
Cohesion: 0.07
Nodes (38): Choice, maneuverIcon(), MapButton(), MapScreen(), ModeTab(), NavCard(), NOTHING_CHOSEN, RouteCard() (+30 more)
...
Cohesion: 0.08
Nodes (39): otpResendCooldownMs(), softmatoDocsUrl(), dueBhadra29, filed, throughAswin25, BillingHistory, BillingInvoiceRow, BillingPaymentRow (+31 more)
...
Cohesion: 0.08
Nodes (37): cellAt(), focusCell(), INPUT_MODES, Props, cellAt(), focusCell(), Props, SheetCell (+29 more)

### Community 109 - "Community 109"
Cohesion: 0.07
Nodes (34): ApiPrincipal, AccountRow, askingAccount(), declineResidencyInvite(), findResidencyInvite(), LIVE, OPEN_INVOICES, ResidencyInvite (+26 more)
...
Cohesion: 0.06
Nodes (30): referralSchema, referralCodeSchema, referralRewardSchema, activeCode, codeId, hostelId, joinedResidentId, mocks (+22 more)

### Community 114 - "Community 114"
Cohesion: 0.08
Nodes (30): campaignBaseSchema, deviceTokenRevokeSchema, deviceTokenSaveSchema, hostelNotificationCampaignSchema, nepalDateSchema, notificationCampaignListQuerySchema, notificationPreferenceUpdateSchema, notificationPrioritySchema (+22 more)
...
Cohesion: 0.1
Nodes (27): checkoutDocumentFor(), softmatoDocumentNumbers(), gateway, invoice, updateOne, IssuedInvoice, issueInvoiceDocument(), OpenedCheckout (+19 more)
...
Cohesion: 0.08
Nodes (30): accountDeletionRequestedEmail(), guardianAccessSchema, AccountDeletionError, applyImmediateEffects(), cancelAccountDeletionForUser(), cancelUrlFor(), DeletionPathway, DeletionRequestRecord (+22 more)
...
Cohesion: 0.09
Nodes (24): getCommunitySettings(), communityAnnouncementSchema, communityFeedQuerySchema, communityModerationQuerySchema, communityPostCreateSchema, communityReactionSchema, communityReportSchema, communityVoteSchema (+16 more)
...
Cohesion: 0.07
Nodes (24): PlanMark(), RAFTER, RIDGE, PortalDates, useHostelDayTurn(), useMinuteTick(), PlanBilling, PlanBillingInvoice (+16 more)

### Community 127 - "Community 127"
Cohesion: 0.09
Nodes (30): deliver(), emailFacts(), getHostelPayoutAccount(), hostelOrThrow(), notifyPlatformOfPayoutReview(), PayoutAccountStatus, PayoutAccountView, PayoutActor (+22 more)

### Community 128 - "Community 128"
Cohesion: 0.1
Nodes (28): PublicFooter(), buildCityIndex(), HostelTypeKey, hostelTypeLabel(), LocationCountRow, locationSlug(), configured, index (+20 more)
...
Cohesion: 0.09
Nodes (33): hostelForm(), buildHostelPayload(), capacitySummary(), emptyHostelForm(), emptyRoomRow(), FACILITY_OPTIONS, firstIncompleteHostelStep(), hasHostelErrors() (+25 more)
...
Cohesion: 0.08
Nodes (26): BrowseParams, BUDGET_BANDS, FilterSheet(), HostelBrowserProps, NearestToggle(), ViewSwitch(), ComparedHostel, comparePublicHostels() (+18 more)

### Community 134 - "Community 134"
Cohesion: 0.14
Nodes (32): allocateNumber(), changeOpenInvoiceMonths(), ensureInvoiceRaised(), findOpenInvoice(), graceDeadline(), invoiceDocumentInput(), issueSubscriptionInvoice(), PaymentRecord (+24 more)

### Community 135 - "Community 135"
Cohesion: 0.1
Nodes (30): AMOUNT_ALIASES, CREDIT_ALIASES, AMOUNT_ALIASES, CREDIT_ALIASES, DATE_ALIASES, DEBIT_ALIASES, NAME_ALIASES, readMoney() (+22 more)
...
Cohesion: 0.13
Nodes (25): GuardianHomeScreen(), GuardianMetrics(), GuardianMoreScreen(), GuardianPaymentsScreen(), GuardianSafetyScreen(), GuardianPayment, GuardianPermissions, canSee() (+17 more)
...
Cohesion: 0.1
Nodes (24): documents, many, parsed, result, buildProviderPayload(), EMPTY_PROVIDER_FORM, firstIncompleteProviderStep(), hasProviderErrors() (+16 more)
...
Cohesion: 0.1
Nodes (22): robots(), openCheckoutSession(), documentUrl(), InvoiceLean, PaymentLean, PlatformInvoiceRow, PlatformPaymentRow, PlatformSubscriptionLedger (+14 more)

### Community 158 - "Community 158"
Cohesion: 0.12
Nodes (20): geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), geocodeAddress(), HostelGeoLocation, resolveHostelGeo(), fetchNearbyPlaces() (+12 more)
...
Cohesion: 0.15
Nodes (23): documentDownloadUrl(), readSettledReceipt(), deliver(), loadInvoiceById(), loadProof(), PlanPaymentInstructions, ProofAsset, reviewPlanPaymentClaim() (+15 more)
...
Cohesion: 0.12
Nodes (22): useIsUploading(), dismissUpload(), emit(), isUploadActive(), listeners, pruneUploads(), resetUploadQueue(), rows (+14 more)

### Community 168 - "Community 168"
Cohesion: 0.18
Nodes (21): CsvTable, gridFromCsv(), peekHeaders(), readCsv(), stripBom(), stripPreamble(), buildTable(), tableFromGrid() (+13 more)
...
Cohesion: 0.13
Nodes (10): GoogleMap, HostelMap(), LeafletMap, TYPE_COLORS, AddressParts, Coordinates, GeocodePrecision, MapProvider (+2 more)
...
Cohesion: 0.17
Nodes (22): AccountDeletionRequest, code:typescript ({), code:typescript (interface IQuestionCallClick {), code:typescript ({), code:typescript ({), code:typescript (interface IAccountDeletionRequest {), code:block43 (packages/db/migrations/), code:typescript ({) (+14 more)
...
Cohesion: 0.15
Nodes (13): ENDPOINTS, getJson(), SIGNED_FIELDS, BASE_URLS, postJson(), GatewayCredentials, GatewayProvider, IntentHandoff (+5 more)
...
Cohesion: 0.2
Nodes (19): AttendanceAlert, AttendanceLog, code:typescript ({), code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({) (+11 more)

### Community 228 - "Community 228"
Cohesion: 0.12
Nodes (19): 2.3 Hostel Rejected, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails, 4.2 Complaint Status Updated (+11 more)
...
Cohesion: 0.16
Nodes (13): login(), requestOtp(), signInWithGoogle(), submitResidentReview(), RootStackParamList, LoginScreen(), Props, Props (+5 more)
...
Cohesion: 0.23
Nodes (6): Claim, CouldNotCreateFileException, HostelPalikaDownloadsModule, NoContextException, UnreadableSourceException, UnsupportedOnThisAndroidException
...
Cohesion: 0.14
Nodes (12): activateResident(), AuthSession, getResidentProfile(), AppNavigator(), Stack, Props, ResidentActivationScreen(), styles (+4 more)
...
Cohesion: 0.17
Nodes (13): isWithinQuietHours(), localMinutesNow(), PushGateInput, PushGateResult, shouldPush(), end, morning, night (+5 more)
...
Cohesion: 0.18
Nodes (11): notificationPreferenceSchema, DEFAULT_NOTIFICATION_PREFERENCE, filterPushRecipients(), getNotificationPreference(), NotificationPreference, PreferenceRecord, serialize(), updateNotificationPreference() (+3 more)
...
Cohesion: 0.24
Nodes (4): HostelHubDownloadsModule, NothingOpensThisException, file, intent
...
Cohesion: 0.21
Nodes (8): RouteContext, awardCreateSchema, awardUpdateSchema, imageUrl, perkCreateSchema, perkFields, perkUpdateSchema, RouteContext
...
Cohesion: 0.29
Nodes (10): notifyProviderOfAssignment(), notifyProviderOfMaintenanceNote(), notifyProviderOfStatusChange(), notifyProvidersOfOpenJob(), notifyStaffOfNewMaintenanceRequest(), providerUserId(), readableCategory(), RequestLike (+2 more)
...
Cohesion: 0.18
Nodes (9): BALANCE_ALIASES, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES, WITHDRAWAL_ALIASES (+1 more)
...
Cohesion: 0.18
Nodes (10): FeeScheduleCloseInput, feeScheduleCloseSchema, FeeScheduleCreateInput, feeScheduleCreateSchema, objectIdSchema, periodSchema, rateSchema, RentConcessionSaveInput (+2 more)
...
Cohesion: 0.25
Nodes (6): attempt, fetchMock, initiated, live, request, sandbox
...
Cohesion: 0.29
Nodes (4): esewaProvider, khaltiProvider, adapters, SHIPPED
...
## Knowledge Gaps
- **6920 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+6915 more)
...
- **Why does `string()` connect `Community 8` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 20`, `Community 21`, `Community 23`, `Community 24`, `Community 25`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 37`, `Community 40`, `Community 41`, `Community 43`, `Community 44`, `Community 45`, `Community 47`, `Community 48`, `Community 49`, `Community 50`, `Community 52`, `Community 53`, `Community 54`, `Community 55`, `Community 57`, `Community 58`, `Community 60`, `Community 61`, `Community 62`, `Community 64`, `Community 65`, `Community 66`, `Community 72`, `Community 74`, `Community 75`, `Community 76`, `Community 84`, `Community 85`, `Community 87`, `Community 88`, `Community 90`, `Community 91`, `Community 95`, `Community 96`, `Community 102`, `Community 104`, `Community 106`, `Community 108`, `Community 111`, `Community 112`, `Community 116`, `Community 117`, `Community 118`, `Community 127`, `Community 134`, `Community 141`, `Community 157`, `Community 158`, `Community 160`, `Community 161`, `Community 168`, `Community 171`, `Community 178`, `Community 179`, `Community 185`, `Community 191`, `Community 193`, `Community 198`, `Community 231`, `Community 247`, `Community 262`, `Community 265`, `Community 266`, `Community 295`, `Community 388`, `Community 392`, `Community 435`, `Community 437`?**
  _High betweenness centrality (0.160) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 8` to `Community 1`, `Community 131`, `Community 3`, `Community 7`, `Community 135`, `Community 10`, `Community 12`, `Community 13`, `Community 268`, `Community 141`, `Community 18`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 156`, `Community 29`, `Community 30`, `Community 34`, `Community 35`, `Community 37`, `Community 39`, `Community 41`, `Community 42`, `Community 43`, `Community 47`, `Community 178`, `Community 53`, `Community 185`, `Community 443`, `Community 193`, `Community 66`, `Community 72`, `Community 75`, `Community 205`, `Community 207`, `Community 80`, `Community 84`, `Community 342`, `Community 90`, `Community 96`, `Community 102`, `Community 231`, `Community 104`, `Community 111`, `Community 121`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 16` to `Community 2`, `Community 3`, `Community 4`, `Community 9`, `Community 140`, `Community 273`, `Community 22`, `Community 154`, `Community 156`, `Community 34`, `Community 37`, `Community 38`, `Community 39`, `Community 42`, `Community 43`, `Community 46`, `Community 59`, `Community 66`, `Community 69`, `Community 73`, `Community 80`, `Community 88`, `Community 217`, `Community 91`, `Community 93`, `Community 94`, `Community 103`, `Community 105`, `Community 108`, `Community 126`?**
