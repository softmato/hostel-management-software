...
## Corpus Check
- 2118 files · ~3,297,109 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17033 nodes · 47098 edges · 612 communities (565 shown, 47 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 773 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 665 edges
2. `successResponse()` - 645 edges
3. `connectToDatabase()` - 469 edges
4. `useAppTheme()` - 416 edges
5. `cn()` - 303 edges
6. `connectToDatabase()` - 257 edges
7. `unwrap()` - 211 edges
8. `useResource()` - 204 edges
9. `Text()` - 188 edges
10. `requireHostelCapability()` - 180 edges
...
## Communities (612 total, 47 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (325): GET(), POST(), GET(), PATCH(), POST(), GET(), POST(), GET() (+317 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (414): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput, ConsentInput (+406 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (260): Scanner(), CookInviteScreen(), GuardianInviteScreen(), Choice, MapButton(), MapScreen(), ModeTab(), NOTHING_CHOSEN (+252 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (292): NoticeArt(), loadFinance(), AdminInvoiceMatrix, AdminMaintenance, AdminModeration, AdminModerationFilter, AdminNotice, AdminPeriodSummary (+284 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (165): ICONS, LABELS, Segment, TONES, FILTERS, Pending, Overview, MoneyData (+157 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (234): getOrCreateSubscription(), POST(), GET(), getOpenFeeSchedule(), GET(), listPublicFoodRoutine(), recordListingAppearances(), addHostelAdminInquiryNote() (+226 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (198): POST(), POST(), POST(), RouteContext, answerSchema, POST(), POST(), attacker (+190 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (213): loadOverview(), loadMoney(), loadToday(), DeletionPanel(), NotificationSettings(), SETTINGS_TITLES, THEME_OPTIONS, AttachmentGallery() (+205 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (137): DeletionPathway, DeletionStatus, PATHWAY_COPY, csvField(), deferLoad(), DemoDataBadge(), field(), Hostel (+129 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (142): PlanPaymentClaim, GuardianDashboard, GuardianSafetyPageContent, FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, monthStartPeriod(), Rate (+134 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (187): AdminAlertsScreen(), AdminCommunityScreen(), AdminCommunityReportsScreen(), AdminHomeScreen(), AdminMoneyScreen(), AdminResidentsScreen(), AdminTodayScreen(), AttendanceScreen() (+179 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (166): AdminTabs(), HIDDEN, RoleLayout(), TABS, FILTERS, invalidateFeeds(), NotificationRow(), TILE_GLYPH (+158 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (133): AdminMoreScreen(), ActivateScreen(), BootGate(), RootShell(), NotificationsScreen(), ApplyBlock(), ServiceProvidersScreen(), SettingsScreen() (+125 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (143): collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor() (+135 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (110): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload (+102 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (143): PaymentMonthStrip(), ManageRatesScreen(), ClearFilters(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard() (+135 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (123): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, runPlanDueReminders(), formatBsPeriod() (+115 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (106): HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend(), HostelHero() (+98 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (111): authorUserId, mocks, postId, residentId, residentPrincipal, staffPrincipal, AnnouncementInput, CommentCreateInput (+103 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (100): HostelAdminCommunityPageContent, HostelAdminComplaintsPage, HostelAdminInquiriesPageContent, HostelAdminMaintenancePageContent, PRIORITIES, STATUS_ACTIONS, HostelAdminMoveChecklistPage, HostelAdminNightStatusPage (+92 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (118): storeCartSchema, storeCategorySchema, storeProductSchema, GET(), RouteContext, GET(), POST(), AddInput (+110 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (107): AdminOverviewScreen(), AlertActions, AssetViewer(), openIdFor(), openIds, StripThumb(), useViewerState(), ViewerBody() (+99 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (106): CommunityReportDialog(), REASONS, MonthOption(), ActiveSuspension, HostelSuspendedScreen(), HostelSuspensionNotice(), isHostelPortal(), PayPlanPanel (+98 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (81): GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, CITY_OPTIONS (+73 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (100): escapeRegex(), objectIdSchema, paginationSchema, phoneSchema, notifyStaffOfJobProgress(), addHistory(), addMaintenanceComment(), assertBedInHostel() (+92 more)

### Community 25 - "Community 25"
Cohesion: 0.08
Nodes (74): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), subscriptionClaimReceivedEmail(), subscriptionClaimRejectedEmail() (+66 more)

### Community 26 - "Community 26"
Cohesion: 0.02
Nodes (83): DescriptionFacts, DescriptionSuggestions(), HostelType, since(), starters, typeWords, cityOptions, createDocument() (+75 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (77): metadata, AccountDeletionPanel, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails() (+69 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (75): Notification, FILTERS, Notification, NotificationRow(), PushState, FILTERS, NotificationCard, NotificationsPageContent (+67 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (91): openStore(), StoreCategoryScreen(), appBlurTarget, closeConfirm(), ConfirmRequest, emit(), getConfirmRequest(), listeners (+83 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (78): CommunityScreen(), Composer(), CommunityPostScreen(), AnimatedBlurView, CommunityBoard(), CommunityBoardProps, Composer(), NotificationBell() (+70 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (85): Offset, PhotoCropper(), VideoSlot(), FileUploadArea(), FileUploadArea(), downloadCaption(), DownloadRow, DownloadStack() (+77 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (81): dueWhen(), PlanDueInput, planDueSoonEmail(), planOverdueEmail(), CHANNELS, ClaimedStep, composeEmail(), composeNotice() (+73 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (79): CookServiceError, resolveAdminHostelId(), announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError, decodePhotoCursor() (+71 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (70): HostelSuggestions(), PublicHomePage(), formatHostelAddress(), hostelTypeToUi(), mapPublicHostelToSummary(), PublicHostel, CATEGORY_LABELS, NEARBY_GROUPS (+62 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (75): POST(), PLATFORM_ROLES, platformPushScheduleSchema, dispatchDueNoticePushes(), POST(), CampaignListQuery, CampaignRecord, createCampaign() (+67 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (79): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodBounds() (+71 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (73): bsMonthStart(), fromBs(), gregorianOf(), hostelCalendarDay(), hostelToday(), BY_OCCUPANCY, EXACT, normalizeBedType() (+65 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (64): POST(), GET(), AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, GET() (+56 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (48): adminPrincipal, mocks, PLATFORM_LIMITS, assetId, hostelId, mocks, otherHostelId, principal (+40 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (60): JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, ProviderStatusCard(), TILE_INK (+52 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (49): HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminRoomsPageContent(), PlatformDashboardPageContent(), PlatformHostelReviewPageContent(), PlatformUsersPageContent(), DashboardCard(), DashboardCardProps (+41 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (49): generateMetadata(), generateMetadata(), manifest(), generateMetadata(), metadata, JsonLd(), JsonLdData, ComparisonPage() (+41 more)
...
Cohesion: 0.04
Nodes (57): approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal, checker, eventId (+49 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (52): buildIdCardData(), EMAIL_CHECK_HINTS, EmailCheck, Field(), FIELD_LABELS, formatCardDate(), IdCardPanel(), identityDraftKey() (+44 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (49): EMPTY_DRAFT, HostelAdminPaymentProfilePageContent, PaymentProfile, SECTION_FIELDS, SectionId, BankMark(), EsewaMark(), KhaltiMark() (+41 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (25): PlatformConfigAnnouncementsPageContent, PlatformConfigContentPageContent, PlatformConfigFacilitiesPageContent, FLAGS, PlatformConfigFeaturesPageContent, PlatformConfigLegalPageContent, PlatformConfigLocationsPageContent, PlatformConfigPlanServicePageContent (+17 more)

### Community 49 - "Community 49"
Cohesion: 0.06
Nodes (60): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt, getInvoiceDetailForHostel() (+52 more)
...
Cohesion: 0.04
Nodes (40): CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES, avatarTone() (+32 more)
...
Cohesion: 0.08
Nodes (54): bsFiscalYear(), amountInWords(), GROUPS, ONES, TENS, underHundred(), underThousand(), documentAdDate() (+46 more)

### Community 55 - "Community 55"
Cohesion: 0.04
Nodes (54): Plan, PlanId, Service, ServiceModule, ServiceModuleId, Faq, PlatformConfigSeoPageContent, Step (+46 more)

### Community 56 - "Community 56"
Cohesion: 0.05
Nodes (48): notifyHostelOfNewPost(), resolveHostelCommunityUserIds(), RealtimeConfig, RealtimeContext, RealtimeContextValue, RealtimeNotification, RealtimeProvider(), useRealtime() (+40 more)

### Community 57 - "Community 57"
Cohesion: 0.06
Nodes (56): formatPeriodKey(), cellAt(), focusCell(), Props, fullYear(), MONTH_SPELLINGS, monthFromWord(), readBsMonth() (+48 more)
...
Cohesion: 0.05
Nodes (46): DEPRECATED_ALIASES, mocks, ADMIN_ISSUABLE_ROLES, AdminIssuableRole, generateTemporaryPassword(), HIGH_PRIVILEGE_ROLES, issueTemporaryPasswordIfMissing(), loginUrl() (+38 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (43): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, AuthShell(), AuthShellProps, PANEL_COPY (+35 more)

### Community 61 - "Community 61"
Cohesion: 0.04
Nodes (45): FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind, creditOverpayment() (+37 more)

### Community 62 - "Community 62"
Cohesion: 0.05
Nodes (52): BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan, BillingSkip (+44 more)

### Community 63 - "Community 63"
Cohesion: 0.06
Nodes (45): POST(), RouteContext, listTrendingTags(), POST(), safeEqual(), sponsorSchema, ClickRecord, dayKey() (+37 more)

### Community 64 - "Community 64"
Cohesion: 0.05
Nodes (44): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), PortalDates, useHostelDayTurn() (+36 more)

### Community 65 - "Community 65"
Cohesion: 0.07
Nodes (44): POST(), RouteContext, computePerceptualHash(), systemDocumentKind(), hashUserAgent(), HostelRef, newVisitorKey(), recordHostelPageView() (+36 more)

### Community 66 - "Community 66"
Cohesion: 0.06
Nodes (31): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, metadata, LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminSOSAlertsPage(), HostelPhotoReminder() (+23 more)

### Community 67 - "Community 67"
Cohesion: 0.06
Nodes (44): AuthLayout(), metadata, CityHostelsPage(), generateMetadata(), PageParams, PublicLocationPage(), FilteredCityHostelsPage(), generateMetadata() (+36 more)

### Community 68 - "Community 68"
Cohesion: 0.07
Nodes (51): directionFlags(), evidenceFlags(), payeeFlags(), AMOUNT_LABELS, canonical(), canonicalDigits(), containsWithTolerance(), deadline() (+43 more)

### Community 69 - "Community 69"
Cohesion: 0.06
Nodes (44): DetailsCard(), InvoiceDetailScreen(), InvoiceHeaderBlock(), LedgerCard(), ResidentClaim, ResidentInvoice, chargeDescriptions(), filterInvoices() (+36 more)
...
Cohesion: 0.08
Nodes (43): noticePushSchema, announceChange(), audit(), CreateInput, createNoticePush(), DEFAULT_PUSHES, deleteNoticePush(), emitNoticePush() (+35 more)

### Community 72 - "Community 72"
Cohesion: 0.05
Nodes (38): ComparePage(), generateMetadata(), hostels, metadata, rows, AuthGuard(), CurrentUser, MeResponse (+30 more)

### Community 73 - "Community 73"
Cohesion: 0.06
Nodes (32): ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, attempt, fetchMock, forged, live (+24 more)
...
Cohesion: 0.08
Nodes (41): cookLoginStem(), generateCookPassword(), mintCookLogin(), pick(), previousCookLabel(), acceptCookInvitation(), addCookAccount(), assertRoomForAnotherCook() (+33 more)
...
Cohesion: 0.08
Nodes (45): work, joiningPayable(), raiseAdmissionInvoice(), addGuardian(), auditResidentAction(), BedRecord, createResident(), definedUpdate() (+37 more)

### Community 78 - "Community 78"
Cohesion: 0.06
Nodes (31): daysUntil(), HostelSubscriptionDueBanner(), rupees(), State, metadata, navItems, HOSTEL_ADMIN_NAV, HOSTEL_ADMIN_SEARCH_ENTRIES (+23 more)
...
Cohesion: 0.08
Nodes (38): Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity() (+30 more)

### Community 81 - "Community 81"
Cohesion: 0.07
Nodes (33): fill(), PricingScreen(), HostelRegistrationProgress(), Milestone, milestoneIndex(), MILESTONES, PaymentPanel(), PlanPicker() (+25 more)
...
Cohesion: 0.07
Nodes (38): BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan, PlanPaymentInstructions, Badge(), grabDocument(), HostelAdminBillingPageContent() (+30 more)

### Community 85 - "Community 85"
Cohesion: 0.08
Nodes (38): formatNPR(), drawCertificationStamp(), footerLine(), formatDate(), formatLongDate(), MONTHS, ReceiptPdfInput, renderReceiptPdf() (+30 more)

### Community 86 - "Community 86"
Cohesion: 0.06
Nodes (37): dispatchOtpChallenge(), generateOtpCode(), normalizeOtpIdentifier(), otpDeliveryProvider(), otpRateLimitMax(), otpRateLimitWindowMs(), otpResendCooldownMs(), otpTtlMs() (+29 more)
...
Cohesion: 0.08
Nodes (31): PublicServiceDetailPage(), loadSiteConfig, loadSiteName(), platformSettingSchema, getListingTier(), getPlan(), getServiceModule(), DEFAULT_PLANS (+23 more)
...
Cohesion: 0.08
Nodes (34): referralSchema, referralRewardSchema, assertActiveReferralCode(), auditReferralAction(), confirmReferralJoined(), createReferredInquiry(), findActiveReferralCode(), HostelAdminReferralListQuery (+26 more)
...
Cohesion: 0.06
Nodes (26): currency(), ResidentActivationPageContent, ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent, Complaint, field() (+18 more)

### Community 93 - "Community 93"
Cohesion: 0.08
Nodes (26): applyWebhook(), WebhookResult, softmato(), SoftmatoNotConfiguredError, SoftmatoConfig, softmatoWebhookSecret(), EnsureInvoiceInput, ensureSoftmatoInvoice() (+18 more)
...
Cohesion: 0.07
Nodes (37): bulkApproveSchema, POST(), GET(), POST(), auditFinanceAction(), voidInvoice(), closeFeeSchedule(), createFeeSchedule() (+29 more)
...
Cohesion: 0.1
Nodes (34): nightStatusPromptSchema, askingEndsAt(), askingEndsMinuteOfNight(), formatPromptTime(), isSameNight(), minuteIsDue(), minuteOfNight(), nightEndsAt() (+26 more)
...
Cohesion: 0.08
Nodes (31): cityCounts(), CitySummary, featuredCities(), inCity(), servingMeals(), showcaseHostels(), counts, hostel() (+23 more)

### Community 101 - "Community 101"
Cohesion: 0.1
Nodes (29): outstandingForResident(), moveOutChecklistSchema, roomSchema, auditMoveAction(), createMoveInChecklist(), createMoveOutChecklist(), findAdminResident(), getMoveInChecklist() (+21 more)

### Community 102 - "Community 102"
Cohesion: 0.09
Nodes (29): deleteHostelObjects(), DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList(), positiveInteger(), validateFileAssetMetadata(), ImageVariantRecord (+21 more)
...
Cohesion: 0.09
Nodes (33): Compass(), maneuverIcon(), NavCard(), cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath() (+25 more)

### Community 105 - "Community 105"
Cohesion: 0.11
Nodes (35): money(), PlanCard(), pricePlan(), listHeadingFor(), PlanCard(), CatalogueTab(), CycleDiscount(), PublicListingBadgePage() (+27 more)

### Community 106 - "Community 106"
Cohesion: 0.11
Nodes (31): resolvePastedLink(), searchCandidates(), resolvePastedLink(), searchCandidates(), AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim(), buildAddressQuery() (+23 more)

### Community 107 - "Community 107"
Cohesion: 0.08
Nodes (28): buildFormPostHandoff(), FormPostHandoff, HandoffError, IntentRecord, formPostIntent, hostelId, intentId, invoiceId (+20 more)
...
Cohesion: 0.07
Nodes (22): Input(), Select(), TextArea(), field(), HostelAdminReferralsPageContent(), HostelAdminReportsPageContent(), ListingFlag, LoadState (+14 more)

### Community 111 - "Community 111"
Cohesion: 0.06
Nodes (24): LegacyHostelAdminComplaintsPage(), Complaint, ComplaintSummary, EmptyState(), field(), FoodMenu, HostelAdminComplaintsPage(), HostelAdminFoodPage() (+16 more)
...
Cohesion: 0.08
Nodes (26): LIVE_ACCESS, releaseGuardianAccounts(), hostelId, mocks, userId, daysFromNow(), enabledPermissionLabels(), GuardianAccessRecord (+18 more)
...
Cohesion: 0.09
Nodes (30): buildHostelPayload(), capacitySummary(), FACILITY_OPTIONS, firstIncompleteHostelStep(), hasHostelErrors(), hasUsableRooms(), HOSTEL_PLANS, HOSTEL_STEPS (+22 more)

### Community 119 - "Community 119"
Cohesion: 0.11
Nodes (23): Entry, hostelEntries(), locationEntries(), sitemap(), STATIC_ROUTES, PublicFooter(), listPublishedHostelSlugs(), generateMetadata() (+15 more)

### Community 120 - "Community 120"
Cohesion: 0.11
Nodes (30): findLiveResidency(), LEGACY_ROLE_MAP, Role, ROLE_VALUES, ageFromDateOfBirth(), ASSET_KINDS, cardPhotoImageUrl(), checkResidentEmail() (+22 more)

### Community 121 - "Community 121"
Cohesion: 0.06
Nodes (17): ERASED_BY_HOSTEL_ID, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, attendanceAlertSchema, communityCommentVoteSchema, communityReactionSchema, communityReportSchema (+9 more)
...
Cohesion: 0.09
Nodes (26): findIndex(), index, indexesOf(), IndexSpec, promote, monthsBetween(), periodOf(), ResidentDoc (+18 more)
...
Cohesion: 0.15
Nodes (27): CARD_NOUNS, CardVariant, drawBack(), drawBrandLockup(), drawFooterSweep(), drawFront(), drawHeaderSweep(), drawIdCard() (+19 more)
...
Cohesion: 0.1
Nodes (23): softmatoDocsUrl(), dueBhadra29, filed, throughAswin25, CYCLE_LABELS, daysLeftThrough(), daysSpanned(), daysUntil() (+15 more)

### Community 137 - "Community 137"
Cohesion: 0.1
Nodes (27): Attendance / Night Safety, Build status (end of Phase 3), Build status (end of Phase 5 — verified 2026-08-02), code:typescript (export enum Role {), code:typescript (interface IQRActivation {), code:typescript (interface INightStatusLog {), code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {) (+19 more)
...
Cohesion: 0.11
Nodes (22): CreditClassification, BANK_CSV_PARSER, KHALTI_CSV_PARSER, bytes, [first], [, incoming], [outgoing, incoming], parse() (+14 more)
...
Cohesion: 0.15
Nodes (21): photoAssetId(), PublicAsset, resolveSearchImageUrls(), searchImageUrls(), resolveComparison(), HostelLayout(), LayoutProps, loadHostel (+13 more)
...
Cohesion: 0.09
Nodes (16): accountDeletionRequestSchema, attendanceLogSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, consentLogSchema, questionCallClickSchema, purgeAccount() (+8 more)

### Community 151 - "Community 151"
Cohesion: 0.11
Nodes (21): ApiFailure, ApiSuccess, AuthUser, getResidentNightStatus(), getResidentReferral(), listResidentPayments(), ResidentFoodRoutine, ResidentNightStatus (+13 more)
...
Cohesion: 0.15
Nodes (22): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), loadPayeeIdentity() (+14 more)
...
Cohesion: 0.21
Nodes (23): assertMatchesExtension(), beginDownload(), downloadAndShare(), downloadAndShareCsv(), downloadAndShareImage(), downloadToDevice(), forgetDownloadFolder(), LegacyFileSystem (+15 more)
...
Cohesion: 0.15
Nodes (17): readReturnState(), ownerIdentitiesFor(), resolveOwnedHostel(), deliver(), listPlanPaymentClaims(), loadInvoiceById(), loadProof(), ProofAsset (+9 more)
...
Cohesion: 0.13
Nodes (20): digitsOnly(), extractPayee(), HostelPayeeIdentity, matchesIdentity(), NAME_STOPWORDS, nameTokens(), PayeeRead, payeeRefusal() (+12 more)
...
Cohesion: 0.13
Nodes (19): EMPTY_PROVIDER_FORM, firstIncompleteProviderStep(), hasProviderErrors(), isProviderStepComplete(), PROVIDER_CATEGORIES, PROVIDER_STEPS, ProviderAttachment, ProviderCategory (+11 more)
...
Cohesion: 0.1
Nodes (15): addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine, formatWeekRange(), HostelAdminFoodPage (+7 more)
...
Cohesion: 0.13
Nodes (17): classifyCredit(), LadderClaim, LadderInvoice, MatchContext, normalizeTxnId(), ANITA_CODE, claims, context() (+9 more)
...
Cohesion: 0.12
Nodes (16): notificationSchema, userResidentProfileSchema, readProfile(), ResidentIdentityError, ResidentProfileData, findScannedAccount(), loadMembership(), PhotoAssetRecord (+8 more)
...
Cohesion: 0.12
Nodes (19): [0.6.0] - 2026-08-01 — Phases 1-3 closed out, [0.8.0] - 2026-08-01 — Phase 5: Growth, Maintenance & Polish, Changed, Changed, Changed, Changed, code:markdown (## [Phase X] - YYYY-MM-DD), Fixed (+11 more)
...
Cohesion: 0.19
Nodes (16): NearbyStatus, Coordinates, isUsableCoordinate(), hasLocationPermission(), hasPromptedForLocation(), LocationOutcome, NavigationFix, readPosition() (+8 more)

### Community 202 - "Community 202"
Cohesion: 0.13
Nodes (17): isRecord(), parseRoadRoute(), parseSteps(), RoadRoute, ROUTE_MODES, RouteMode, ROUTERS, RouteStep (+9 more)
...
Cohesion: 0.1
Nodes (19): BLOOD_GROUPS, BloodGroup, checkIdentityEmail(), DIETARY_PREFERENCES, DietaryPreference, EmailCheckStatus, Gender, GENDERS (+11 more)
...
Cohesion: 0.16
Nodes (15): configureNativeNightPrompt(), claimNotificationSound(), claims, resetNotificationSoundClaims(), createAndroidChannels(), easProjectId(), fetchExpoPushToken(), forgetPushToken() (+7 more)
...
Cohesion: 0.2
Nodes (14): CapacityError, claimBedForRoomType(), listAllRoomTypes(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary(), releaseBedForRoomType() (+6 more)

### Community 217 - "Community 217"
Cohesion: 0.13
Nodes (14): logger, pushTicketSchema, authHeaders(), chunk(), ExpoReceipt, fetchReceipts(), isConfigurationFailure(), ReceiptSweepResult (+6 more)
...
Cohesion: 0.24
Nodes (15): robots(), absoluteUrl(), formatNpr(), hostelJsonLd(), HostelJsonLdInput, JsonLd, LINE_SEPARATOR, organizationId() (+7 more)

### Community 224 - "Community 224"
Cohesion: 0.12
Nodes (12): PromotableUser, promoteAccountToResident(), PROTECTED_ROLES, ResidentPromotion, ResidentPromotionClearance, standDownMemberships(), hostelId, memberId (+4 more)
...
Cohesion: 0.16
Nodes (13): register(), submitResidentReview(), triggerSOS(), verifyOtp(), RootStackParamList, Props, OtpVerificationScreen(), Props (+5 more)
...
Cohesion: 0.18
Nodes (10): PublicCitiesPage(), OwnerCallout(), SeoChip(), SeoCrumbs(), SeoFaq(), SoftmatoCredit(), FeaturesHubPage(), SoftwarePage() (+2 more)
...
Cohesion: 0.14
Nodes (12): data, DeviceRow, endpoints, mocks, payload, urls, CATEGORY_PATHS, NOTIFICATION_LIST (+4 more)
...
Cohesion: 0.13
Nodes (16): 7.1 Attendance Alert (Resident Absent), 7.1 New Hostel Pending Approval (to Superadmin), 7. Attendance & Location Tracking Emails, 7. Platform Admin Emails, 8.1 Community Post Engagement (Batched), 8. Community & Notification Emails, code:typescript ({), code:typescript ({) (+8 more)
...
Cohesion: 0.14
Nodes (12): activateResident(), AuthSession, getResidentProfile(), AppNavigator(), Stack, LoginScreen(), Props, ResidentActivationScreen() (+4 more)
...
Cohesion: 0.17
Nodes (14): categoryLabel(), PROVIDER_CATEGORIES, ProviderCard(), ProviderDirectoryData, PublicProvider, PublicServiceProviderDirectoryPage(), DirectoryPageProps, EMPTY (+6 more)
...
Cohesion: 0.15
Nodes (12): candidateFontDirs(), ensureIdCardFonts(), FONT_DIR_SEGMENTS, FONT_FILES, PlatformIdCardType, band, BASE, canvas (+4 more)
...
Cohesion: 0.13
Nodes (11): addFieldsStage, filter, group, hostelId, invoiceId, lookups, mocks, residentId (+3 more)

### Community 266 - "Community 266"
Cohesion: 0.16
Nodes (11): CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, isPlanDueNotification(), readId(), body, [drawn, oldBuild, iphone], fetchMock (+3 more)
...
Cohesion: 0.15
Nodes (15): 2.2 Hostel Approved, 2.3 Hostel Rejected, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails (+7 more)

### Community 275 - "Community 275"
Cohesion: 0.18
Nodes (15): 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, 7.2 Subscription Expiring Soon, 9.1 Account Deletion Requested, code:typescript ({) (+7 more)
...
Cohesion: 0.33
Nodes (11): HostelScope, ResolvedDocument, resolveInvoiceDocument(), resolveReceiptDocument(), scopeFilter(), settledTotal(), trySoftmato(), GET() (+3 more)

### Community 286 - "Community 286"
Cohesion: 0.26
Nodes (13): getPresignedReadUrl(), CARD_LABELS, formatIssuedOn(), readPhotoBytes(), readQrBytes(), readSignatureBytes(), sendIdCardEmail(), getResidentIdentity() (+5 more)
...
Cohesion: 0.22
Nodes (10): StoreConfig, CartTotals, lineTotal(), PricedLine, qualifiesForFreeDelivery(), BASE, lines, total (+2 more)
...
Cohesion: 0.25
Nodes (5): hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKindFromText(), distance, base
...
Cohesion: 0.18
Nodes (11): 3.3 Payment Proof Uploaded (to Admin), 4.1 New Notice Posted, 4.2 Complaint Status Updated, 4.3 Complaint Resolved, 4. Resident Activity Emails, 5.1 SOS Triggered, 5. Safety & Emergency Emails, code:typescript ({) (+3 more)
...
Cohesion: 0.2
Nodes (9): resetResourceBus(), broken, food, healthy, listener, payments, second, unsubscribe (+1 more)
...
Cohesion: 0.29
Nodes (7): FALLBACK_ORDER, hasNoHostelPhotos(), HostelPhoto, HostelPhotoKind, photosOfKind(), resolveHostelPhotos(), resolveHostelPhotoUrls()
...
Cohesion: 0.27
Nodes (8): key(), ListingHostel, ListingProjection, projectSchedule(), projectScheduleOntoListing(), RoomConfiguration, hostel, result

### Community 377 - "Community 377"
Cohesion: 0.2
Nodes (9): calendarDateSchema, emergencyContactCreateSchema, guardianCreateSchema, objectIdSchema, optionalHostelScopeSchema, residentCreateSchema, residentStatusSchema, residentTypeSchema (+1 more)
...
Cohesion: 0.25
Nodes (5): hostelId, mocks, PHONE_ONLY, refused, userId
...
Cohesion: 0.25
Nodes (6): ERASED_MODEL_NAMES, RETAINED_BY_HOSTEL_ID, both, covered, missing, MODELS_DIR
...
Cohesion: 0.29
Nodes (8): 1.2 Hostel Admin Credentials (Post-Approval), 1.5 Guardian Invitation, 2.1 Hostel Submission Received, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, code:typescript ({), code:typescript ({), code:typescript ({)
...
Cohesion: 0.33
Nodes (6): 7.3 Privacy/Guardian Permissions Test Template, 9.1 Seed Scripts, 9.2 Test Database Isolation, 9. Test Data & Seeding, code:typescript (describe('GET /api/v1/guardian/linked-resident - privacy', (), code:bash (npm run web:build)
...
Cohesion: 0.6
Nodes (4): bodySchema, POST(), quotaMaxAge(), quotaRemaining()
...
Cohesion: 0.4
Nodes (4): LIVE_STATUSES, LiveResidency, liveResidencyMessage(), LiveRow
...
Cohesion: 0.4
Nodes (3): mocks, principal, userId
...
Cohesion: 0.5
Nodes (3): feeScheduleSchema, rateSchema, wholeRupees
...
## Knowledge Gaps
- **5957 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+5952 more)
...
- **Why does `cn()` connect `Community 22` to `Community 4`, `Community 8`, `Community 9`, `Community 14`, `Community 19`, `Community 23`, `Community 26`, `Community 27`, `Community 28`, `Community 31`, `Community 34`, `Community 41`, `Community 46`, `Community 48`, `Community 51`, `Community 52`, `Community 309`, `Community 182`, `Community 57`, `Community 60`, `Community 72`, `Community 81`, `Community 82`, `Community 84`, `Community 213`, `Community 105`, `Community 235`, `Community 111`, `Community 252`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 4` to `Community 2`, `Community 3`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 14`, `Community 15`, `Community 17`, `Community 19`, `Community 21`, `Community 22`, `Community 27`, `Community 28`, `Community 30`, `Community 40`, `Community 177`, `Community 182`, `Community 58`, `Community 124`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 86` to `Community 0`, `Community 2`, `Community 6`, `Community 7`, `Community 264`, `Community 8`, `Community 10`, `Community 9`, `Community 141`, `Community 14`, `Community 15`, `Community 13`, `Community 17`, `Community 19`, `Community 25`, `Community 26`, `Community 27`, `Community 31`, `Community 33`, `Community 34`, `Community 36`, `Community 37`, `Community 167`, `Community 168`, `Community 46`, `Community 181`, `Community 54`, `Community 53`, `Community 57`, `Community 192`, `Community 194`, `Community 72`, `Community 73`, `Community 84`, `Community 85`, `Community 214`, `Community 89`, `Community 91`, `Community 223`, `Community 98`, `Community 106`, `Community 239`, `Community 118`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Are the 464 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 464 INFERRED edges - model-reasoned connections that need verification._
