...
## Knowledge Gaps
- **2390 isolated node(s):** `AuthUser`, `ResidentSummary`, `ResidentFoodRoutine`, `ApiSuccess`, `ApiFailure` (+2385 more)
...
- **What connects `AuthUser`, `ResidentSummary`, `ResidentFoodRoutine` to the rest of the system?**
  _2390 weakly-connected nodes found - possible documentation gaps or missing edges._
