...
## Corpus Check
- 2117 files · ~3,295,082 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17013 nodes · 47057 edges · 549 communities (522 shown, 27 thin omitted)
...
## Communities (549 total, 27 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (325): POST(), PATCH(), RouteContext, POST(), getOrCreateSubscription(), bulkApproveSchema, POST(), POST() (+317 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (181): ICONS, LABELS, Segment, TONES, FILTERS, Pending, MoneyData, MANAGE_ROWS (+173 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (215): POST(), GET(), POST(), GET(), POST(), POST(), PATCH(), POST() (+207 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (237): Scanner(), CookInviteScreen(), GuardianInviteScreen(), MapScreen(), Assurance(), CallableRow(), IdentityCard(), PeopleSection() (+229 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (253): loadFinance(), AdminInvoiceMatrix, AdminModeration, AdminModerationFilter, AdminSubscription, getAdminLedger(), getAdminSubscription(), listAdminResidents() (+245 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (201): GET(), ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+193 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (166): summarizeResidentComplaints(), collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES (+158 more)
...
Cohesion: 0.02
Nodes (190): AttachmentGallery(), DeletionRequest, DeletionStatus, getDeletionStatus(), requestAccountDeletion(), api, ApiEnvelope, unwrap() (+182 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (128): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload (+120 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (146): HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend(), HostelHero() (+138 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (142): ConfirmOptions, Notification, BrowserPushRow(), FILTERS, Notification, NotificationRow(), PushState, FILTERS (+134 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (158): getPlanPaymentInstructions(), POST(), RouteContext, DELETE(), GET(), hostelId(), GET(), POST() (+150 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (143): AdminMoreScreen(), ActivateScreen(), BootGate(), RootShell(), NotificationsScreen(), ApplyBlock(), ServiceProvidersScreen(), SettingsScreen() (+135 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (128): PlanPaymentClaim, DemoDataBadge(), LoadState, DerivedPlan, HostelAdminFeePlansPageContent, Payment, CATEGORIES, Ledger (+120 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (150): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, notifyHostelOfNewPost(), resolveHostelCommunityUserIds() (+142 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (156): bsPeriodBounds(), formatBsPeriod(), formatBsPeriodMonth(), formatBsPeriodYear(), isBsPeriod(), periodParts(), periodStartDate(), PaymentMonthStrip() (+148 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (143): auditFinanceAction(), FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind (+135 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (133): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), manifest() (+125 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (147): bsMonthStart(), hostelToday(), BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped (+139 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (141): approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal, checker, eventId (+133 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (131): CommunityPageContent(), PayPlanPanel(), rupees(), Offset, PhotoCropper(), VideoSlot(), CollectionQrField(), OperationsConfig (+123 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (107): adminPrincipal, mocks, PLATFORM_LIMITS, AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, mocks (+99 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (119): listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), getPlatformSubscriptionLedger(), listPlanPaymentClaims(), GET(), GET() (+111 more)

### Community 24 - "Community 24"
Cohesion: 0.02
Nodes (115): HostelAdminAttendancePageContent, HostelAdminCommunityPageContent, HostelAdminComplaintsPage, HostelAdminInquiriesPageContent, HostelAdminMaintenancePageContent, PRIORITIES, STATUS_ACTIONS, HostelAdminMoveChecklistPage (+107 more)

### Community 25 - "Community 25"
Cohesion: 0.02
Nodes (133): AdminCommunityReportsScreen(), AdminResidentsScreen(), AttendanceScreen(), NightStatusHistoryScreen(), NightStatusForm(), NightStatusScreen(), ProfileScreen(), ReferralRow() (+125 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (99): GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, CITY_OPTIONS (+91 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (108): PaginationMeta, PaginationQuery, paginationQuerySchema, paginationRange(), querySchema, DEPRECATED_ALIASES, grantingPermissionKeys(), mocks (+100 more)
...
Cohesion: 0.03
Nodes (102): openStore(), HIDDEN, RoleLayout(), TABS, FILTERS, invalidateFeeds(), NotificationCard(), NotificationRow() (+94 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (102): AdminCommunityScreen(), CommunityScreen(), Composer(), ReportedPostCard(), useReportedCount(), AssetViewer(), useViewerState(), ViewerBody() (+94 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (113): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), loadOverview(), Overview, AdminTabs(), loadMoney(), AdminTodayScreen() (+105 more)
...
Cohesion: 0.02
Nodes (94): periodTotals(), CookServiceError, resolveAdminHostelId(), assertHostelAccess(), canAccessHostel(), hostelScopedFilter(), TenantAccessError, TenantPrincipal (+86 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (81): generateMetadata(), metadata, AccountDeletionPanel, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections() (+73 more)
...
Cohesion: 0.03
Nodes (90): BrandMark(), BrandWordmark(), WORDMARK, WORDMARK_SEGMENTS, LedgerMonth, LedgerPayment, ResidentLedger, ResidentPaymentTrackSheet (+82 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (60): DeletionPathway, DeletionStatus, PATHWAY_COPY, csvField(), deferLoad(), field(), Hostel, HostelTable() (+52 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (73): CSV_COLUMNS, GET(), POST(), RouteContext, POST(), safeEqual(), GET(), hostelSuspendSchema (+65 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (71): GET(), POST(), purgeArchivedHostel(), purgeHostel(), DELETE(), GET(), GET(), POST() (+63 more)

### Community 41 - "Community 41"
Cohesion: 0.03
Nodes (71): Faq, PlatformConfigSeoPageContent, Step, loadSiteName(), CONTENT_ICON_SLUGS, everything, IDENTITY, page (+63 more)

### Community 42 - "Community 42"
Cohesion: 0.03
Nodes (49): deleteHostelObjects(), ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, RETAINED_BY_HOSTEL_ID, both (+41 more)
...
Cohesion: 0.05
Nodes (56): GET(), GET(), escapeRegex(), objectIdSchema, paginationSchema, phoneSchema, notifyStaffOfJobProgress(), serviceProviderApplicationSchema (+48 more)

### Community 45 - "Community 45"
Cohesion: 0.08
Nodes (42): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), PLATFORM_NAME_PARTS, cookInvitationEmail() (+34 more)
...
Cohesion: 0.06
Nodes (61): SORTS, StoreCategoryScreen(), AdminNightStatusRow, filterRollCall(), NightStatusValue, OVERRIDE_OPTIONS, ROLL_CALL_SEGMENTS, rollCallCounts() (+53 more)
...
Cohesion: 0.05
Nodes (63): fill(), money(), PlanCard(), PricingScreen(), pricePlan(), PlanPicker(), TIER_TONE, BillingToggle() (+55 more)

### Community 50 - "Community 50"
Cohesion: 0.07
Nodes (61): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt, deliver() (+53 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (42): FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES, avatarTone(), CommunityComment (+34 more)
...
Cohesion: 0.05
Nodes (42): HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminRoomsPageContent(), PlatformDashboardPageContent(), PlatformUsersPageContent(), DashboardCard(), DashboardCardProps, PlatformServiceProvidersPageContent() (+34 more)
...
Cohesion: 0.05
Nodes (51): DELETE(), POST(), platformPushScheduleSchema, NotificationCampaignError, revokeDeviceToken(), saveDeviceToken(), campaignBaseSchema, deviceTokenRevokeSchema (+43 more)

### Community 57 - "Community 57"
Cohesion: 0.06
Nodes (49): POST(), cook, assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES, PermissionError, PLATFORM_ROLES (+41 more)

### Community 58 - "Community 58"
Cohesion: 0.05
Nodes (45): PATCH(), RouteContext, GET(), feeUpdateSchema, PATCH(), setResidentMonthlyFee(), dayOfWeekSchema, foodFeedbackSchema (+37 more)

### Community 59 - "Community 59"
Cohesion: 0.05
Nodes (53): BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodOf(), bsPeriodsBetween(), currentBsPeriod() (+45 more)
...
Cohesion: 0.07
Nodes (52): personalLookupHash(), PlatformIdCardType, userResidentProfileSchema, findLiveResidency(), LEGACY_ROLE_MAP, Role, ROLE_VALUES, CARD_LABELS (+44 more)
...
Cohesion: 0.08
Nodes (50): EvidenceEngineMode, AMOUNT_LABELS, canonical(), canonicalDigits(), containsWithTolerance(), deadline(), DIGIT_CONFUSABLES, EvidenceRead (+42 more)
...
Cohesion: 0.07
Nodes (45): documentUrl(), InvoiceLean, PaymentLean, PlatformInvoiceRow, PlatformPaymentRow, PlatformSubscriptionLedger, HostelScope, ResolvedDocument (+37 more)

### Community 70 - "Community 70"
Cohesion: 0.06
Nodes (42): ComplaintDetail(), ComplaintCard(), CategoryTile(), NewComplaintScreen(), PickedAttachment, SwapButton(), CapturedPhoto, PhotoCapture() (+34 more)

### Community 71 - "Community 71"
Cohesion: 0.06
Nodes (23): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminPaymentsPage(), redirectToWorkspaceScreen(), HostelAdminMaintenancePageContent() (+15 more)
...
Cohesion: 0.06
Nodes (45): BALANCE_ALIASES, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES, WITHDRAWAL_ALIASES (+37 more)
...
Cohesion: 0.06
Nodes (42): paymentProofSchema, arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal (+34 more)

### Community 77 - "Community 77"
Cohesion: 0.08
Nodes (39): hostelPeriodOf(), existingResidentListSchema, existingResidentRowSchema, BillPreview, CheckContext, CheckedRow, checkExistingResidents(), ListRow (+31 more)
...
Cohesion: 0.06
Nodes (28): currency(), Panel(), StatusBadge(), ResidentActivationPageContent, ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent (+20 more)

### Community 83 - "Community 83"
Cohesion: 0.07
Nodes (31): outstandingForResident(), depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, providedItemSchema, auditMoveAction(), createMoveInChecklist(), createMoveOutChecklist() (+23 more)
...
Cohesion: 0.06
Nodes (28): ComparePage(), generateMetadata(), hostels, metadata, rows, Choice, HOSTEL_TYPE_LABELS, HostelPanel() (+20 more)
...
Cohesion: 0.08
Nodes (32): buildHtml(), Marker, PlaceMarker, NearbyStatus, boundsCenter(), Coordinates, haversineMeters(), hostelCoordinates() (+24 more)
...
Cohesion: 0.09
Nodes (30): SosInput, SosPhase, isCurrentNight(), isSelfReportable(), NIGHT_STATUS_OPTIONS, nightKey(), nightNote(), NightStanding (+22 more)
...
Cohesion: 0.06
Nodes (26): ProviderDirectoryData, CATEGORIES, isApplicationOpen(), LandingStep(), MeResponse, OwnApplication, ProviderStats, ProviderStatus (+18 more)
...
Cohesion: 0.07
Nodes (18): useConfirm(), ExistingResidentsPanel(), Props, ExistingResidentsSheet(), HostelAdminExistingResidentsPage(), AUDIENCE_LABEL, PlatformPushPageContent, PushRecord (+10 more)

### Community 109 - "Community 109"
Cohesion: 0.11
Nodes (27): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, ImageVariantRecord (+19 more)
...
Cohesion: 0.13
Nodes (23): paymentClearedEmail(), paymentDueReminderEmail(), ReminderStage, wording(), paymentOverdueEmail(), paymentRejectedEmail(), paymentReversedEmail(), paymentProofReceivedEmail() (+15 more)
...
Cohesion: 0.1
Nodes (28): UploadCard(), UploadToaster(), useIsUploading(), useUploads(), ensureChannel(), startUploadNotifications(), dismissUpload(), listeners (+20 more)
...
Cohesion: 0.11
Nodes (29): BS_MONTHS, cellAt(), focusCell(), Props, CheckResult, RowField, amountText(), blankSheetRow() (+21 more)
...
Cohesion: 0.23
Nodes (22): dueWhen(), PlanDueInput, planDueSoonEmail(), planOverdueEmail(), planSuspensionNoticeEmail(), subscriptionClaimReceivedEmail(), subscriptionClaimRejectedEmail(), formatRupees() (+14 more)
...
Cohesion: 0.08
Nodes (19): EmptyState(), TextArea(), field(), HostelAdminReferralsPageContent(), ListingFlag, LoadState, MaintenanceRequest, optionalField() (+11 more)
...
Cohesion: 0.13
Nodes (22): isFileAssetKind(), isFinancialAssetKind(), DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList(), positiveInteger(), validateFileAssetMetadata() (+14 more)
...
Cohesion: 0.13
Nodes (24): dashboardHrefForRole(), destinationForRole(), isAllowedNextPath(), isHostelWorkspacePath(), isSafeLocalPath(), landingPathForRole(), ProtectedRouteRule, protectedRouteRuleForPath() (+16 more)
...
Cohesion: 0.17
Nodes (25): assertMatchesExtension(), beginDownload(), downloadAndShare(), downloadAndShareCsv(), downloadAndShareImage(), forgetDownloadFolder(), LegacyFileSystem, loadLegacyFileSystem() (+17 more)
...
Cohesion: 0.11
Nodes (12): DeviceLocationStatus, TYPE_COLORS, DraggablePinMap, FALLBACK_CENTER, LocationPicker(), LocationPickerValue, PART_LABELS, AddressParts (+4 more)
...
Cohesion: 0.09
Nodes (16): HostelAdminCooksPanel, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine, formatWeekRange() (+8 more)
...
Cohesion: 0.16
Nodes (15): getPresignedReadUrl(), claimSecret(), issueDocumentClaimToken(), isValidDocumentClaimToken(), RegistrationDocumentError, SubmittedDocument, asset, fileAssetSchema (+7 more)
...
Cohesion: 0.14
Nodes (14): RouteContext, findResidentOwnedAccess(), listResidentGuardians(), revokeGuardianAccess(), updateGuardianPermissions(), DEFAULT_GUARDIAN_PERMISSIONS, guardianAccessCreateSchema, guardianInvitationAcceptSchema (+6 more)
...
Cohesion: 0.2
Nodes (19): AttendanceLog, AuditLog, code:typescript ({), code:typescript ({), code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({), code:typescript ({) (+11 more)
...
Cohesion: 0.12
Nodes (8): AuthShell(), AuthShellProps, PANEL_COPY, SiteWordmark(), AuthExperiencePage(), generateMetadata(), metadata, generateMetadata()
...
Cohesion: 0.13
Nodes (13): activateResident(), AuthSession, getResidentProfile(), AppNavigator(), Stack, OtpVerificationScreen(), Props, ResidentActivationScreen() (+5 more)
...
Cohesion: 0.17
Nodes (12): login(), submitResidentReview(), triggerSOS(), RootStackParamList, LoginScreen(), Props, Props, Props (+4 more)
...
Cohesion: 0.16
Nodes (16): 5.1 SOS Triggered, 5. Safety & Emergency Emails, 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6. Service Provider Emails, 7.1 New Hostel Pending Approval (to Superadmin), 8.1 Community Post Engagement (Batched) (+8 more)
...
Cohesion: 0.2
Nodes (11): 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, 3.3 Payment Proof Uploaded (to Admin), 4.1 New Notice Posted, code:typescript ({), code:typescript ({) (+3 more)
...
- **Why does `cn()` connect `Community 11` to `Community 1`, `Community 9`, `Community 14`, `Community 144`, `Community 18`, `Community 21`, `Community 24`, `Community 26`, `Community 34`, `Community 35`, `Community 36`, `Community 292`, `Community 37`, `Community 38`, `Community 48`, `Community 177`, `Community 49`, `Community 51`, `Community 52`, `Community 53`, `Community 61`, `Community 75`, `Community 82`, `Community 95`, `Community 102`, `Community 108`, `Community 115`, `Community 374`, `Community 120`, `Community 123`, `Community 124`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 1` to `Community 3`, `Community 4`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 16`, `Community 24`, `Community 25`, `Community 30`, `Community 31`, `Community 160`, `Community 34`, `Community 35`, `Community 37`, `Community 38`, `Community 177`, `Community 185`, `Community 62`, `Community 70`, `Community 103`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `Role` connect `Community 22` to `Community 0`, `Community 2`, `Community 260`, `Community 5`, `Community 6`, `Community 7`, `Community 136`, `Community 9`, `Community 12`, `Community 140`, `Community 14`, `Community 15`, `Community 146`, `Community 19`, `Community 20`, `Community 276`, `Community 23`, `Community 26`, `Community 27`, `Community 28`, `Community 32`, `Community 33`, `Community 37`, `Community 40`, `Community 43`, `Community 176`, `Community 50`, `Community 178`, `Community 312`, `Community 57`, `Community 58`, `Community 187`, `Community 60`, `Community 56`, `Community 59`, `Community 74`, `Community 76`, `Community 81`, `Community 104`, `Community 106`, `Community 364`, `Community 242`, `Community 243`, `Community 375`?**
