# Graph Report - hostel-management-software  (2026-08-11)

## Corpus Check
- 1076 files · ~1,901,772 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8692 nodes · 21687 edges · 406 communities (380 shown, 26 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 375 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 490 edges
2. `successResponse()` - 479 edges
3. `connectToDatabase()` - 321 edges
4. `cn()` - 232 edges
5. `connectToDatabase()` - 212 edges
6. `requireHostelCapability()` - 158 edges
7. `requireHostelStaffPrincipal()` - 116 edges
8. `browserApi()` - 116 edges
9. `usePortalResource()` - 89 edges
10. `requireResidentPrincipal()` - 85 edges
...
## Communities (406 total, 26 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (112): Filter, ModeratedPost, ModerationPayload, DemoDataBadge(), HostelTable(), UserRecord, Ledger, OrphanAssignPicker (+104 more)
...
Cohesion: 0.04
Nodes (82): FeeSchedule, Rate, PRIORITIES, STATUS_ACTIONS, Campaign, Resident, AttendanceAnalytics, FoodAnalytics (+74 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (111): deleteResidentLocationHistory(), getResidentAttendance(), listAttendanceAlerts(), listResidentComplaints(), getFoodRoutine(), listFoodForResident(), listPublicFoodRoutine(), submitFoodFeedback() (+103 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (59): POST(), POST(), RouteContext, GET(), PATCH(), RouteContext, GET(), POST() (+51 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (75): GET(), POST(), POST(), POST(), POST(), GET(), POST(), bulkApproveSchema (+67 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (71): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CancelDeletionPageContent() (+63 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (77): Notification, EMPTY_SUMMARY, HostelAdminComplaintsPage, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS (+69 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (67): csvField(), deferLoad(), field(), Hostel, Inquiry, LoadState, Message(), numberField() (+59 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (68): GuardianDashboard, MatrixRow, MatrixTotals, PeriodSummary, ClaimFacts(), ProofReviewModal, HostelAdminReconcilePageContent, labelled() (+60 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (62): GET(), POST(), GET(), GET(), POST(), POST(), safeEqual(), GET() (+54 more)

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (50): POST(), POST(), DELETE(), GET(), POST(), checkoutSchema, POST(), POST() (+42 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (61): inferKind(), LightboxItem, MediaLightbox(), normalize(), PortalSearch(), PortalTone, scoreEntry(), toneStyles (+53 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (67): POST(), RealtimeConfig, RealtimeContext, RealtimeContextValue, RealtimeNotification, RealtimeProvider(), useRealtime(), GET() (+59 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (45): AuthShell(), AuthShellProps, SiteWordmark(), AccountDeletionPanel, AuthExperiencePage(), LegalBody(), buildValues(), PublicAboutPage() (+37 more)
...
Cohesion: 0.05
Nodes (58): CommunityReportDialog(), REASONS, ConfirmOptions, Resolver, ModerationButton(), PagerButton(), PublicHostelListingPage(), ReferenceCheck() (+50 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (37): PATCH(), RouteContext, PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), GET(), GET(), DELETE() (+29 more)
...
Cohesion: 0.05
Nodes (59): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), GATEWAY_ORDER, getPayInstructions(), InvoiceRecord, methodsFrom(), PayInstructions (+51 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (40): bedSchema, depositRefundSchema, emergencyContactSchema, foodMenuSchema, guardianSchema, moveInChecklistSchema, moveOutChecklistSchema, noticeSchema (+32 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (60): demoteToPublicAccount(), CapacityError, claimBedForRoomType(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary(), releaseBedForRoomType() (+52 more)
...
Cohesion: 0.05
Nodes (54): ProviderDirectoryData, escapeRegex(), objectIdSchema, paginationSchema, phoneSchema, serviceProviderApplicationSchema, serviceProviderDocumentSchema, DirectoryPageProps (+46 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (49): notifyResidentOfComplaintReply(), addComplaintUpdate(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput (+41 more)

### Community 28 - "Community 28"
Cohesion: 0.14
Nodes (35): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), verificationEmail(), guardianInvitationEmail(), cookPortalEnabledEmail(), hostelDocumentsRequestedEmail() (+27 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (51): POST(), acceptGuardianInvitation(), daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput (+43 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (45): CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing, CurrentUser (+37 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (45): getCreditAmount(), getInvoiceMatrix(), getResidentFinanceView(), InvoiceMatrix, InvoiceMatrixRow, listResidentClaims(), PortalInvoice, ResidentFinanceView (+37 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (47): PaginationMeta, PaginationQuery, paginationQuerySchema, querySchema, notificationCampaignSchema, reviewModerationLogSchema, CampaignListQuery, CampaignRecord (+39 more)

### Community 33 - "Community 33"
Cohesion: 0.08
Nodes (45): CommunityModerationPanel(), CommunityPageContent(), field(), LoadState, Message(), NightStatusRow, optionalNumber(), PageHeader() (+37 more)
...
Cohesion: 0.1
Nodes (43): notifyAdminsOfNewComplaint(), notifyResidentOfComplaintStatus(), OPEN_STATUSES, OverdueComplaint, runComplaintSlaCheck(), EmailAttachment, notifyAdminsOfClaim(), notifyAdminsOfClearedPayment() (+35 more)
...
Cohesion: 0.05
Nodes (48): announceFoodReady(), cookEmailForSlug(), CookPortalUpdateInput, CookServiceError, FoodReadyInput, generatePassword(), getCookPortalSettings(), HostelSettingsRecord (+40 more)
...
Cohesion: 0.05
Nodes (37): ComparePage(), hostels, metadata, rows, HostelAdminInquiriesPageContent(), HostelAdminRoomsPageContent(), PlatformHostelReviewPageContent(), PlatformUsersPageContent() (+29 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (35): AuthGuard(), fadeUp, Feature, features, heroSlides, PublicHostelRegistrationLandingPage(), stagger, stats (+27 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (47): addHostelAdminInquiryNote(), BedCreateInput, BedRecord, BedUpdateInput, DocumentRequestNotification, findScopedInquiry(), FloorCreateInput, FloorRecord (+39 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (30): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminMoveChecklistPage(), HostelAdminComplaintsPage(), HostelPhotoReminder() (+22 more)

### Community 43 - "Community 43"
Cohesion: 0.07
Nodes (45): communitySettingsSchema, PATCH(), resolveHostelId(), DELETE(), assertHostelScopedApiAccess(), requireHostelAdminPrincipal(), activeSuperadminCount(), createPlatformAdmin() (+37 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (37): accountDeletionRequestSchema, consentLogSchema, sessionSchema, CachedConnection, disconnectFromDatabase(), globalForMongoose, main(), main() (+29 more)

### Community 45 - "Community 45"
Cohesion: 0.06
Nodes (41): daysBetween(), deliver(), DunningAction, DunningStage, DunningState, escalateToHostel(), InvoiceRow, nextDunningAction() (+33 more)
...
Cohesion: 0.05
Nodes (26): field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), LoadState, NightStatusRow, Notification (+18 more)
...
Cohesion: 0.07
Nodes (39): classifyCredit(), CreditClassification, findOrphanClaims(), LadderClaim, LadderInvoice, loadMatchContext(), MatchContext, normalizeTxnId() (+31 more)
...
Cohesion: 0.06
Nodes (39): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertTransactionCodeNotReused(), describePriorClaim(), PriorClaim, similarEvidenceFlags(), submitClaim() (+31 more)

### Community 53 - "Community 53"
Cohesion: 0.06
Nodes (34): ApiPrincipal, questionCallClickSchema, sponsorSchema, ClickRecord, QuestionCallAnalyticsQuery, questionCallBaseUrl(), QuestionCallClickInput, QuestionCallConversionInput (+26 more)

### Community 54 - "Community 54"
Cohesion: 0.06
Nodes (27): csvField(), field(), Hostel, HostelAdminDashboardPageContent(), HostelAdminProfilePageContent(), Inquiry, LoadState, numberField() (+19 more)

### Community 55 - "Community 55"
Cohesion: 0.07
Nodes (27): PATCH(), POST(), RouteContext, GET(), POST(), dayOfWeekSchema, foodFeedbackSchema, foodMenuCreateSchema (+19 more)

### Community 56 - "Community 56"
Cohesion: 0.06
Nodes (30): financeIntegrityHash(), runGatewayHealthForHostel(), findingSchema, reconciliationRunSchema, checkAuditChain(), checkCreditBalances(), DRIFT_CODES, LedgerDriftSummary (+22 more)
...
Cohesion: 0.1
Nodes (32): CSV_COLUMNS, GET(), GET(), periodTotals(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS (+24 more)

### Community 59 - "Community 59"
Cohesion: 0.06
Nodes (25): currency(), Select(), StatusBadge(), ResidentActivationPageContent, ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent (+17 more)

### Community 60 - "Community 60"
Cohesion: 0.1
Nodes (33): userResidentProfileSchema, LEGACY_ROLE_MAP, Role, ROLE_VALUES, ageFromDateOfBirth(), cardPhotoImageUrl(), clearResidentIdentityPhoto(), evaluateProfilePrompt() (+25 more)

### Community 61 - "Community 61"
Cohesion: 0.07
Nodes (22): adminPrincipal, mocks, PLATFORM_LIMITS, authMocks, request, Role, ROLE_VALUES, sessionRole() (+14 more)

### Community 62 - "Community 62"
Cohesion: 0.08
Nodes (23): AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex() (+15 more)
...
Cohesion: 0.07
Nodes (22): EmptyState(), LoadingRows(), Panel(), field(), HostelAdminReferralsPageContent(), HostelAdminServiceProvidersPageContent(), ListingFlag, LoadState (+14 more)

### Community 65 - "Community 65"
Cohesion: 0.07
Nodes (28): AnnouncementInput, CommentCreateInput, CommentRecord, CommunityServiceError, FeedQuery, flagPost(), HideInput, hostelNamesByIds() (+20 more)
...
Cohesion: 0.09
Nodes (27): qrActivationSchema, ActivationCodeGenerateInput, ActivationCodeInput, activationSecret(), ActivationServiceError, ActivationStatus, ActivationStatusQuery, auditActivation() (+19 more)

### Community 71 - "Community 71"
Cohesion: 0.07
Nodes (21): incidentLogSchema, manualStatusOverrideSchema, nightStatusSchema, nightStatusLogSchema, sosAlertSchema, EmergencyContactRecord, findAdminResident(), NightStatusListQuery (+13 more)
...
Cohesion: 0.09
Nodes (27): platformSettingSchema, DEFAULT_SITE_CONFIG, coerceSection(), getPublicSiteConfig(), getSiteConfig(), getSiteConfigSection(), PlatformSettingRecord, SiteConfigServiceError (+19 more)

### Community 75 - "Community 75"
Cohesion: 0.1
Nodes (28): addHostelAdminProfilePhoto(), deleteHostelAdminProfilePhoto(), HostelAdminProfileQuery, HostelAdminProfileUpdateInput, HostelChangeRequestInput, HostelPhotoCreateInput, HostelPhotoDeleteQuery, LOCKED_NAME_STATUSES (+20 more)

### Community 76 - "Community 76"
Cohesion: 0.09
Nodes (19): GET(), POST(), PATCH(), RouteContext, nightStatusListQuerySchema, nightStatusOverrideSchema, nightStatusSchema, nightStatusUpdateSchema (+11 more)
...
Cohesion: 0.1
Nodes (27): BedCreateInput, BedRecord, BedUpdateInput, createHostelAdminBed(), createHostelAdminFloor(), createHostelAdminRoom(), findFloorInHostel(), findRoomInHostel() (+19 more)
...
Cohesion: 0.15
Nodes (19): ImageVariantRecord, optimizeImage(), streamToBuffer(), VARIANT_CONFIG, VariantName, r2Configured(), storePublicAsset(), deleteFromR2() (+11 more)

### Community 87 - "Community 87"
Cohesion: 0.13
Nodes (22): CheckoutStatus, closeIntent(), createPaymentIntent(), expireStaleIntents(), getCheckoutStatus(), handleProviderCallback(), IntentRecord, isUnconfirmable() (+14 more)
...
Cohesion: 0.12
Nodes (19): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), MediaViewerContext (+11 more)
...
Cohesion: 0.12
Nodes (21): noticeReadStatusSchema, auditNoticeAction(), broadcastNotice(), createNotice(), definedUpdate(), listNotices(), normalizeObjectIds(), NoticeCreateInput (+13 more)

### Community 97 - "Community 97"
Cohesion: 0.14
Nodes (25): fromAddress(), sendEmail(), SendEmailInput, SendEmailResult, appHostelStatusUrl(), appLoginUrl(), approvePlatformHostel(), createPlatformHostelApplication() (+17 more)
...
Cohesion: 0.11
Nodes (17): feeUpdateSchema, PATCH(), setResidentMonthlyFee(), POST(), GET(), monthlyPaymentGenerateSchema, monthSchema, objectIdSchema (+9 more)

### Community 104 - "Community 104"
Cohesion: 0.13
Nodes (20): progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster(), UploadRow, UploadStack(), useIsHydrated() (+12 more)
...
Cohesion: 0.13
Nodes (16): POST(), RouteContext, createPublicHostelInquiry(), publicInquiryCreateSchema, POST(), RouteContext, cookieAccessToken(), isRole() (+8 more)

### Community 110 - "Community 110"
Cohesion: 0.16
Nodes (18): createCommunityPost(), listCommunityFeed(), listCommunityModeration(), searchPattern(), getCommunitySettings(), communityAnnouncementSchema, communityCommentCreateSchema, communityFeedQuerySchema (+10 more)

### Community 111 - "Community 111"
Cohesion: 0.11
Nodes (14): metadata, FeedPayload, SidebarPayload, Space, SpacesPayload, CommunityPost, mediaUrl(), CommunitySponsor (+6 more)
...
Cohesion: 0.16
Nodes (16): computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, formatNPR(), formatDate(), ReceiptPdfInput (+8 more)
...
Cohesion: 0.17
Nodes (16): dashboardHrefForRole(), destinationForRole(), isAllowedNextPath(), isHostelWorkspacePath(), isSafeLocalPath(), landingPathForRole(), ProtectedRouteRule, protectedRouteRuleForPath() (+8 more)
...
Cohesion: 0.14
Nodes (15): addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery, HostelAdminInquiryStatusInput, InquiryNoteCreateInput, InquiryNoteRecord, InquiryRecord (+7 more)

### Community 127 - "Community 127"
Cohesion: 0.1
Nodes (20): hostelAdminInquiryListQuerySchema, hostelAdminInquiryStatusSchema, hostelRejectSchema, hostelRequestDocumentsSchema, hostelResubmitDocumentsSchema, hostelTypeSchema, hostelUnpublishSchema, inquiryNoteCreateSchema (+12 more)
...
Cohesion: 0.14
Nodes (14): AuthSession, getResidentProfile(), login(), AppNavigator(), RootStackParamList, Stack, LoginScreen(), Props (+6 more)
...
Cohesion: 0.35
Nodes (10): FLAGS, ConfigCard(), ConfigPage(), LoadState, parseListField(), Repeater(), TextAreaField(), TextField() (+2 more)
...
Cohesion: 0.15
Nodes (14): activateResident(), apiRequest(), confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listResidentComplaints(), refreshSession(), register() (+6 more)
...
Cohesion: 0.13
Nodes (12): amber, amount, assetId, checks, events, hostelId, invoice, invoiceId (+4 more)

### Community 161 - "Community 161"
Cohesion: 0.13
Nodes (11): assetId, call, hashCall, hostelId, input, invoiceId, mocks, principal (+3 more)
...
Cohesion: 0.2
Nodes (15): code:typescript (interface IMoveOutChecklistItem {), code:typescript (interface IServiceProvider {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IInquiry {), code:typescript (interface IHostelPageView {), Inquiry, MaintenanceRequest (+7 more)

### Community 165 - "Community 165"
Cohesion: 0.19
Nodes (15): code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {), code:typescript ({), code:typescript (interface IMoveInChecklistItem {), code:typescript (interface IServiceProvider {), Complaint, ComplaintUpdate, Food (+7 more)
...
Cohesion: 0.23
Nodes (8): createExpertConsultationRequest(), ExpertConsultationCreateInput, ExpertConsultationError, ExpertConsultationRequestRecord, getMyExpertConsultationRequest(), notifyTeamOfRequest(), expertConsultationCreateSchema, expertConsultationRequestSchema
...
Cohesion: 0.21
Nodes (12): commentOnPost(), findReadablePost(), findVisiblePostForResident(), getCommunityPost(), listCommunityForModeration(), listPostComments(), namesByUserId(), notifyPostReaction() (+4 more)
...
Cohesion: 0.24
Nodes (7): submitResidentReview(), triggerSOS(), Props, ResidentReviewsScreen(), Props, ResidentSOSScreen(), screenStyles
...
Cohesion: 0.36
Nodes (10): createCommunityAnnouncement(), decoratePosts(), deleteOwnPost(), findModeratablePost(), hideCommunityPost(), PostMedia, publishCommunityChange(), resolveAdminHostelId() (+2 more)
...
Cohesion: 0.31
Nodes (10): createHostelAdminBed(), createHostelAdminRoom(), findFloorInHostel(), findRoomInHostel(), refreshCapacitySummary(), refreshRoomVacancyStatus(), serializeBed(), serializeRoom() (+2 more)
...
Cohesion: 0.22
Nodes (5): createHostelAdminFloor(), serializeFloor(), inquiryId, serviceMocks, staffPrincipal
...
Cohesion: 0.22
Nodes (9): 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 7.1 New Hostel Pending Approval (to Superadmin), 7.2 Subscription Expiring Soon, 7. Platform Admin Emails, 8.1 Community Post Engagement (Batched), 8. Community & Notification Emails, code:typescript ({), code:typescript ({) (+1 more)
...
Cohesion: 0.29
Nodes (3): mocks, DEFAULT_WARDEN_PERMISSIONS, WARDEN_PERMISSION_KEYS
...
Cohesion: 0.6
Nodes (4): reportPost(), communityReportSchema, POST(), RouteContext
...
Cohesion: 0.6
Nodes (4): listTrendingTags(), GET(), loadPopularHostels(), PopularHostelRecord
...
Cohesion: 0.67
Nodes (3): 7.2 Role Gate Test Template, code:typescript (describe('GET /api/v1/hostel/rooms - role access', () => {), code:bash (npm run web:lint)
...
## Knowledge Gaps
- **3325 isolated node(s):** `AuthUser`, `ResidentSummary`, `ResidentFoodRoutine`, `ApiSuccess`, `ApiFailure` (+3320 more)
...
- **Why does `Role` connect `Community 61` to `Community 1`, `Community 2`, `Community 5`, `Community 6`, `Community 9`, `Community 11`, `Community 268`, `Community 269`, `Community 14`, `Community 15`, `Community 271`, `Community 270`, `Community 146`, `Community 147`, `Community 22`, `Community 151`, `Community 25`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 287`, `Community 288`, `Community 161`, `Community 34`, `Community 291`, `Community 160`, `Community 293`, `Community 37`, `Community 290`, `Community 289`, `Community 41`, `Community 35`, `Community 43`, `Community 44`, `Community 38`, `Community 173`, `Community 309`, `Community 55`, `Community 292`, `Community 192`, `Community 65`, `Community 193`, `Community 196`, `Community 70`, `Community 202`, `Community 75`, `Community 76`, `Community 91`, `Community 219`, `Community 221`, `Community 222`, `Community 220`, `Community 224`, `Community 223`, `Community 109`, `Community 242`, `Community 243`, `Community 124`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 4` to `Community 1`, `Community 6`, `Community 138`, `Community 267`, `Community 12`, `Community 14`, `Community 16`, `Community 273`, `Community 146`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 25`, `Community 26`, `Community 27`, `Community 29`, `Community 31`, `Community 32`, `Community 34`, `Community 35`, `Community 37`, `Community 38`, `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 45`, `Community 46`, `Community 48`, `Community 50`, `Community 52`, `Community 53`, `Community 183`, `Community 56`, `Community 58`, `Community 60`, `Community 62`, `Community 65`, `Community 70`, `Community 71`, `Community 74`, `Community 75`, `Community 333`, `Community 80`, `Community 85`, `Community 87`, `Community 96`, `Community 97`, `Community 228`, `Community 109`, `Community 243`, `Community 118`, `Community 126`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 17` to `Community 0`, `Community 2`, `Community 3`, `Community 7`, `Community 8`, `Community 137`, `Community 10`, `Community 9`, `Community 13`, `Community 142`, `Community 15`, `Community 148`, `Community 23`, `Community 30`, `Community 33`, `Community 39`, `Community 40`, `Community 181`, `Community 59`, `Community 64`, `Community 68`, `Community 69`, `Community 81`, `Community 91`, `Community 104`, `Community 111`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Are the 316 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 316 INFERRED edges - model-reasoned connections that need verification._
