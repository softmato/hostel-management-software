# Graph Report - hostel-management-software  (2026-09-15)

## Corpus Check
- 2096 files · ~3,279,992 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 16841 nodes · 46450 edges · 585 communities (559 shown, 26 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 755 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 656 edges
2. `successResponse()` - 636 edges
3. `connectToDatabase()` - 456 edges
4. `useAppTheme()` - 407 edges
5. `cn()` - 301 edges
6. `connectToDatabase()` - 254 edges
7. `unwrap()` - 210 edges
8. `useResource()` - 199 edges
9. `Text()` - 186 edges
10. `requireHostelCapability()` - 174 edges
...
## Communities (585 total, 26 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (247): POST(), GET(), POST(), GET(), POST(), PATCH(), POST(), RouteContext (+239 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (190): PlanPaymentClaim, DeletionPathway, DeletionStatus, PATHWAY_COPY, CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload (+182 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (171): ICONS, LABELS, Segment, TONES, FILTERS, Pending, Overview, MoneyData (+163 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (258): loadToday(), loadFinance(), getAdminFoodRoutine(), getAdminMaintenance(), getAdminNightStatus(), listAdminNotices(), ActivationIssue, addCook() (+250 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (230): PATCH(), RouteContext, GET(), getOpenFeeSchedule(), GET(), listPublicFoodRoutine(), recordListingAppearances(), addHostelAdminInquiryNote() (+222 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (202): Scanner(), CookInviteScreen(), GuardianInviteScreen(), Compass(), MapButton(), ModeTab(), RouteCard(), Assurance() (+194 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (151): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, metadata, LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), field(), GuardianDashboard (+143 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (175): SORTS, StoreCategoryScreen(), DeletionRequest, DeletionStatus, getDeletionStatus(), requestAccountDeletion(), api, ApiEnvelope (+167 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (118): Choice, MapScreen(), NOTHING_CHOSEN, PreviewCard(), ResultRow(), SavedHostelsScreen(), SavedListRow(), BrowseParams (+110 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (146): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, runPlanDueReminders(), notifyHostelOfNewPost() (+138 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (126): AdminCommunityScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+118 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (142): DELETE(), GET(), hostelId(), GET(), POST(), DELETE(), PATCH(), RouteContext (+134 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (125): answerSchema, POST(), summarizeResidentComplaints(), GET(), GET(), listResidentInvoices(), getResidentLedger(), getFoodRoutine() (+117 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (123): AdminTabs(), HIDDEN, RoleLayout(), TABS, AdminMoreScreen(), ActivateScreen(), BootGate(), RootShell() (+115 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (142): PaymentMonthStrip(), ManageRatesScreen(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard(), AmountCard() (+134 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (134): GET(), periodOf(), getHostelLedger(), getInvoiceMatrix(), getResidentFinanceView(), HostelLedger, HostelLedgerEntry, InvoiceMatrix (+126 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (102): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CancelDeletionPageContent(), useConfirm(), AcceptResult, CookInvitePageContent (+94 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (106): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), ApplyBlock(), ServiceProvidersScreen() (+98 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (96): GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, CITY_OPTIONS (+88 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (125): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES (+117 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (110): POST(), GET(), POST(), GET(), RouteContext, findResidentOwnedAccess(), revokeGuardianAccess(), updateGuardianPermissions() (+102 more)

### Community 21 - "Community 21"
Cohesion: 0.07
Nodes (86): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), dueWhen(), PlanDueInput (+78 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (125): AdminAlertsScreen(), AdminCommunityReportsScreen(), AdminHomeScreen(), AdminOverviewScreen(), AdminResidentsScreen(), AdminTodayScreen(), AttendanceScreen(), NightStatusHistoryScreen() (+117 more)

### Community 23 - "Community 23"
Cohesion: 0.02
Nodes (112): demoteToPublicAccount(), CapacityError, claimBedForRoomType(), listAllRoomTypes(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary() (+104 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (94): PRIORITIES, STATUS_ACTIONS, Campaign, Resident, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel (+86 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (90): generateMetadata(), metadata, generateMetadata(), metadata, ComparePage(), generateMetadata(), hostels, metadata (+82 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (103): GET(), POST(), querySchema, RouteContext, AnnouncementInput, CommentCreateInput, commentOnPost(), CommentRecord (+95 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (97): BrandMark(), BrandWordmark(), WORDMARK, WORDMARK_SEGMENTS, CommunityReportDialog(), REASONS, HostelPreviewLink(), ModerationButton() (+89 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (101): loadOverview(), loadMoney(), AdminAlertsContext, AdminAlertsValue, AlertActions, EMPTY_COUNTS, ICONS, LABELS (+93 more)

### Community 29 - "Community 29"
Cohesion: 0.02
Nodes (82): DescriptionFacts, DescriptionSuggestions(), HostelType, since(), starters, typeWords, cityOptions, createDocument() (+74 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (85): addComplaintUpdate(), assertComplaintVoiceNote(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput (+77 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (69): csvField(), field(), Hostel, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminProfilePageContent(), HostelAdminRoomsPageContent(), Inquiry (+61 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (83): CommunityScreen(), Composer(), AttachmentGallery(), AnimatedBlurView, CommunityBoard(), CommunityBoardProps, Composer(), SORTS (+75 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (89): BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan, Badge(), grabDocument(), HostelAdminBillingPageContent(), InvoiceRow() (+81 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (80): EMPTY_SUMMARY, HostelAdminCooksPanel, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine (+72 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (73): FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, monthStartPeriod(), Rate, RoomTypeOption, MonthField, MonthOption() (+65 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (76): RouteContext, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex(), HostelRecord, ListingFlagListQuery, ListingFlagRecord, ListingFlagResolveInput (+68 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (83): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), methodProvider(), PROVIDER_LABEL, QrPanel() (+75 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (62): outstandingForResident(), deleteHostelObjects(), ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, purgeArchivedHostel() (+54 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (76): cookPrincipal, mocks, resolveCookLabels(), announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError (+68 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (74): ReviewForm(), ReviewScreen(), NightStatusReasonCode, NightHistoryEntry, filterNotices(), groupNoticesByDay(), noticeCategories(), NoticeDay (+66 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (75): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodBounds() (+67 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (68): approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal, checker, eventId (+60 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (70): FILTERS, invalidateFeeds(), NotificationCard(), NotificationRow(), TILE_GLYPH, TILE_TONES, writeFeedRead(), RoleLayout() (+62 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (64): platformPushScheduleSchema, NotificationCampaignError, filterPushRecipients(), addDays(), nepalDateOf(), nepalWallClockToUtc(), nextOccurrence(), PushRepeat (+56 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (66): CHANNELS, ClaimedStep, composeEmail(), composeNotice(), composePlanDueNotice(), deliverEmail(), deliverStep(), HostelRow (+58 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (66): formatPeriodKey(), cellAt(), focusCell(), Props, defaultDueDate(), DeliveryWindowFields(), number(), text() (+58 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (55): appBaseUrl(), AuthServiceError, CLAIMABLE_STATUSES, dispatchOtpChallenge(), dispatchVerificationEmail(), findVerifiedRegistrationChallenge(), generateOtpCode(), GOOGLE_JWKS (+47 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (57): Notification, BrowserPushRow(), FILTERS, Notification, NotificationRow(), PushState, FILTERS, NotificationCard (+49 more)
...
Cohesion: 0.04
Nodes (61): bulkApproveSchema, POST(), feeUpdateSchema, PATCH(), setResidentMonthlyFee(), approveClaim(), assertNotAlreadyRecordedFromStatement(), bulkApproveClaims() (+53 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (58): GATEWAY_ORDER, getHostelPayMethods(), getPayInstructions(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod (+50 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (52): existingResidentListSchema, existingResidentRowSchema, BillPreview, CheckContext, CheckedRow, checkExistingResidents(), CheckResult, monthLabel() (+44 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (46): fill(), PricingScreen(), HostelRegistrationProgress(), Milestone, milestoneIndex(), MILESTONES, PaymentPanel(), PlanPicker() (+38 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (57): AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput, ConsentInput, dayKey() (+49 more)
...
Cohesion: 0.06
Nodes (55): auditFinanceAction(), BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan (+47 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (49): CSV_COLUMNS, GET(), POST(), RouteContext, listTrendingTags(), POST(), safeEqual(), sponsorSchema (+41 more)

### Community 61 - "Community 61"
Cohesion: 0.05
Nodes (51): ComplaintDetail(), ComplaintCard(), CategoryTile(), NewComplaintScreen(), PickedAttachment, SwapButton(), CapturedPhoto, PhotoCapture() (+43 more)

### Community 62 - "Community 62"
Cohesion: 0.05
Nodes (50): CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing, buildIdCardData() (+42 more)

### Community 63 - "Community 63"
Cohesion: 0.04
Nodes (42): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, AuthShell(), AuthShellProps, PANEL_COPY (+34 more)
...
Cohesion: 0.05
Nodes (43): FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind, creditOverpayment() (+35 more)

### Community 66 - "Community 66"
Cohesion: 0.06
Nodes (44): POST(), saveFoodRoutine(), addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange(), definedUpdate(), FoodFeedbackInput (+36 more)

### Community 67 - "Community 67"
Cohesion: 0.06
Nodes (49): deliver(), loadInvoiceById(), loadProof(), PlanPaymentInstructions, ProofAsset, reviewPlanPaymentClaim(), submitPlanPaymentClaim(), Resolver (+41 more)

### Community 68 - "Community 68"
Cohesion: 0.08
Nodes (39): generateMetadata(), manifest(), JsonLd(), JsonLdData, ComparisonPage(), FeatureModulePage(), FeaturesHubPage(), SoftwarePage() (+31 more)

### Community 69 - "Community 69"
Cohesion: 0.05
Nodes (48): platformSettingSchema, DEFAULT_SITE_CONFIG, coerceSection(), getPublicSiteConfig(), getSiteConfig(), getSiteConfigSection(), PlatformSettingRecord, PublicSiteConfig (+40 more)

### Community 70 - "Community 70"
Cohesion: 0.05
Nodes (46): classifyCredit(), CreditClassification, LadderClaim, LadderInvoice, MatchContext, normalizeTxnId(), ANITA_CODE, claims (+38 more)

### Community 71 - "Community 71"
Cohesion: 0.05
Nodes (36): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, attempt (+28 more)

### Community 72 - "Community 72"
Cohesion: 0.06
Nodes (42): SERVICE_PROVIDER_CATEGORIES, serviceProviderSchema, serviceProviderApplicationSchema, serviceProviderDocumentSchema, hostelId, mocks, providerId, notifyPlatformOfServiceProviderApplication() (+34 more)

### Community 73 - "Community 73"
Cohesion: 0.04
Nodes (37): EASE, FaqEntry, FaqRole, FaqRow(), FAQS, PREVIEW_ROWS, PREVIEWS, ROLES (+29 more)
...
Cohesion: 0.05
Nodes (36): daysUntil(), HostelSubscriptionDueBanner(), rupees(), State, PortalShell(), metadata, navItems, metadata (+28 more)

### Community 76 - "Community 76"
Cohesion: 0.06
Nodes (44): bsMonthStart(), hostelToday(), FeeScheduleRecord, rateForRoomType(), monthsBetween(), periodOf(), ResidentDoc, ResidentLedger (+36 more)

### Community 77 - "Community 77"
Cohesion: 0.05
Nodes (27): adminPrincipal, mocks, PLATFORM_LIMITS, mocks, readable, selectable, LIVE_ACCESS, releaseGuardianAccounts() (+19 more)

### Community 78 - "Community 78"
Cohesion: 0.05
Nodes (38): CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES, avatarTone() (+30 more)

### Community 79 - "Community 79"
Cohesion: 0.08
Nodes (42): signPurposeToken(), nightStatusPromptSchema, askingEndsAt(), askingEndsMinuteOfNight(), formatPromptTime(), isCurrentNight(), isSameNight(), minuteIsDue() (+34 more)

### Community 80 - "Community 80"
Cohesion: 0.08
Nodes (47): getPresignedReadUrl(), findLiveResidency(), LIVE_STATUSES, LiveResidency, LiveRow, LEGACY_ROLE_MAP, Role, ROLE_VALUES (+39 more)

### Community 81 - "Community 81"
Cohesion: 0.06
Nodes (34): AuthGuard(), HostelSuggestions(), checkOnly(), EMPTY_PREFILL, ENVIRONMENT_OPTIONS, IdentityResponse, Prefill, Step (+26 more)

### Community 82 - "Community 82"
Cohesion: 0.06
Nodes (40): AuthLayout(), metadata, PublicServiceDetailPage(), url, view, brandedTitle(), clamp(), ogImagePath() (+32 more)

### Community 83 - "Community 83"
Cohesion: 0.09
Nodes (44): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags() (+36 more)
...
Cohesion: 0.06
Nodes (44): buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, draftFromProfile(), emptyIdentityDraft(), firstIncompleteIdentityStep() (+36 more)

### Community 86 - "Community 86"
Cohesion: 0.05
Nodes (31): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, ExpertConsultationCreateInput, ExpertConsultationError, ExpertConsultationRequestRecord, expertConsultationCreateSchema (+23 more)

### Community 87 - "Community 87"
Cohesion: 0.07
Nodes (38): POST(), SetResidentFeeInput, ApiPrincipal, CampaignListQuery, CampaignRecord, createCampaign(), createHostelNotificationCampaign(), dispatchCampaign() (+30 more)
...
Cohesion: 0.06
Nodes (33): ConfirmOptions, csvField(), field(), numberField(), optionalField(), AddressFields, FORM_SECTIONS, HostelAdminProfilePageContent (+25 more)
...
Cohesion: 0.09
Nodes (39): mocks, allocateOrderNumber(), applyStatus(), CancelInput, cancelOrder(), CreateInput, hostelNames(), ListQuery (+31 more)

### Community 92 - "Community 92"
Cohesion: 0.07
Nodes (39): Offset, PhotoCropper(), VideoSlot(), FileUploadArea(), FileUploadArea(), EXTENSION_BY_MIME, FAMILY_BYTES, FAMILY_ORDER (+31 more)

### Community 93 - "Community 93"
Cohesion: 0.13
Nodes (35): bsFiscalYear(), amountInWords(), GROUPS, ONES, TENS, underHundred(), underThousand(), documentAdDate() (+27 more)

### Community 94 - "Community 94"
Cohesion: 0.08
Nodes (35): isAuthBypassEnabled(), original, cook, assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES, PermissionError (+27 more)
...
Cohesion: 0.1
Nodes (32): computePerceptualHash(), ImageVariantRecord, optimizeImage(), streamToBuffer(), VARIANT_CONFIG, VariantName, r2Configured(), storePublicAsset() (+24 more)
...
Cohesion: 0.1
Nodes (36): getInvoiceDetailForHostel(), HostelScope, ResolvedDocument, resolveInvoiceDocument(), resolveReceiptDocument(), scopeFilter(), settledTotal(), trySoftmato() (+28 more)
...
Cohesion: 0.09
Nodes (30): CityHostelsPage(), generateMetadata(), PageParams, PublicCitiesPage(), PublicLocationPage(), OwnerCallout(), SeoChip(), SeoCrumbs() (+22 more)

### Community 102 - "Community 102"
Cohesion: 0.08
Nodes (33): DELETE(), POST(), createPlatformNotificationCampaign(), listHostelNotificationCampaigns(), listPlatformNotificationCampaigns(), statsForCampaigns(), listNotifications(), revokeDeviceToken() (+25 more)
...
Cohesion: 0.08
Nodes (28): GET(), querySchema, applicantSchema, billingCycleSchema, HostelRegistrationInput, hostelRegistrationSchema, registrationFields, RegistrationPlanChoice (+20 more)

### Community 107 - "Community 107"
Cohesion: 0.09
Nodes (28): FILE_ASSET_KINDS, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList() (+20 more)

### Community 108 - "Community 108"
Cohesion: 0.07
Nodes (28): key(), ListingHostel, ListingProjection, projectSchedule(), RoomConfiguration, hostel, result, configuredLevel() (+20 more)
...
Cohesion: 0.1
Nodes (32): Guidance, GuidanceStatus, useGuidance(), cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath() (+24 more)

### Community 111 - "Community 111"
Cohesion: 0.2
Nodes (23): POST(), authenticateWithGoogle(), logout(), POST(), loginGuardian(), accessTokenTtlSeconds(), parseDurationSeconds(), refreshTokenTtlSeconds() (+15 more)

### Community 112 - "Community 112"
Cohesion: 0.07
Nodes (29): auditLogSchema, paymentProofSchema, computeMonthlyDue(), creditVerifiedAmount(), currentMonth(), definedUpdate(), findAdminPayment(), findAdminResident() (+21 more)
...
Cohesion: 0.1
Nodes (25): robots(), buildFormPostHandoff(), FormPostHandoff, HandoffError, IntentRecord, formPostIntent, hostelId, intentId (+17 more)

### Community 116 - "Community 116"
Cohesion: 0.09
Nodes (22): applyWebhook(), WebhookResult, checkoutReturnUrl(), OpenCheckoutInput, openSoftmatoCheckout(), softmato(), SoftmatoNotConfiguredError, SoftmatoConfig (+14 more)
...
Cohesion: 0.13
Nodes (28): issueInvoiceDocument(), ownerIdentitiesFor(), resolveOwnedHostel(), allocateNumber(), ensureInvoiceRaised(), findOpenInvoice(), getOrCreateSubscription(), getSubscriptionState() (+20 more)
...
Cohesion: 0.1
Nodes (25): isCurrentNight(), isSelfReportable(), NIGHT_STATUS_OPTIONS, nightKey(), nightNote(), NightStanding, SelfReportableStatus, NIGHT_OF_17TH (+17 more)
...
Cohesion: 0.13
Nodes (27): JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, ProviderJob, CATEGORY_ICONS (+19 more)

### Community 125 - "Community 125"
Cohesion: 0.12
Nodes (30): money(), PlanCard(), pricePlan(), listHeadingFor(), PlanCard(), CatalogueTab(), CycleDiscount(), BillingCycle (+22 more)
...
Cohesion: 0.14
Nodes (10): Claim, CouldNotCreateFileException, HostelHubDownloadsModule, HostelPalikaDownloadsModule, NoContextException, NothingOpensThisException, UnreadableSourceException, UnsupportedOnThisAndroidException (+2 more)

### Community 128 - "Community 128"
Cohesion: 0.14
Nodes (26): changePassword(), getCurrentUser(), isApprovedServiceProvider(), issueSessionForUser(), login(), publicUser(), refreshAccessToken(), sameIds() (+18 more)

### Community 129 - "Community 129"
Cohesion: 0.08
Nodes (24): attacker, attempt(), headers, jsonRequest(), routeMocks, verifyOtpChallenge(), GoogleAuthInput, googleAuthSchema (+16 more)

### Community 130 - "Community 130"
Cohesion: 0.09
Nodes (25): softmatoDocsUrl(), dueBhadra29, filed, throughAswin25, CYCLE_LABELS, daysLeftThrough(), daysSpanned(), daysUntil() (+17 more)
...
Cohesion: 0.12
Nodes (27): ApiFailure, apiRequest(), ApiSuccess, AuthUser, confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listNotifications() (+19 more)

### Community 134 - "Community 134"
Cohesion: 0.1
Nodes (15): GoogleMap, HostelMap(), LeafletMap, TYPE_COLORS, DraggablePinMap, FALLBACK_CENTER, LocationPicker(), LocationPickerValue (+7 more)
...
Cohesion: 0.11
Nodes (25): qrActivationSchema, activateResident(), ActivationCodeGenerateInput, ActivationCodeInput, activationSecret(), ActivationServiceError, ActivationStatus, ActivationStatusQuery (+17 more)

### Community 138 - "Community 138"
Cohesion: 0.09
Nodes (19): inferKind(), LightboxItem, MediaLightbox(), Choice, HOSTEL_TYPE_LABELS, HostelPanel(), MapButton(), MapCanvas (+11 more)

### Community 139 - "Community 139"
Cohesion: 0.1
Nodes (23): describeGrants(), GuardianRow(), PermissionSheet(), daysUntil(), describeGuardianOnRecord(), describeInvitation(), describeSharing(), EMPTY_INVITE_DRAFT (+15 more)

### Community 140 - "Community 140"
Cohesion: 0.12
Nodes (25): UploadCard(), useIsUploading(), dismissUpload(), emit(), listeners, pruneUploads(), resetUploadQueue(), rows (+17 more)

### Community 141 - "Community 141"
Cohesion: 0.11
Nodes (22): geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), placeOnMap(), geocodeAddress(), geocodeWithGoogle(), geocodeWithNominatim() (+14 more)
...
Cohesion: 0.1
Nodes (22): chelseaMarket, geistMono, geistSans, metadata, poppins, RootLayout(), MediaViewerProvider(), NotificationSoundListener() (+14 more)
...
Cohesion: 0.11
Nodes (28): code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {), code:typescript ({), code:typescript (interface IMoveInChecklistItem {), code:typescript (interface IMoveOutChecklistItem {), code:typescript (interface IServiceProvider {), code:typescript (interface IServiceProvider {), code:typescript (interface IMaintenanceRequest {) (+20 more)

### Community 149 - "Community 149"
Cohesion: 0.13
Nodes (20): hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), systemDocumentKindFromText(), distance, drawCertificationStamp(), footerLine(), formatDate() (+12 more)

### Community 150 - "Community 150"
Cohesion: 0.1
Nodes (20): notificationPreferenceSchema, DEFAULT_NOTIFICATION_PREFERENCE, NotificationPreference, PreferenceRecord, mocks, night, isWithinQuietHours(), localMinutesNow() (+12 more)

### Community 151 - "Community 151"
Cohesion: 0.09
Nodes (16): accountDeletionRequestSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, consentLogSchema, notificationSchema, questionCallClickSchema, purgeAccount() (+8 more)
...
Cohesion: 0.09
Nodes (10): PublicHostelListingPage(), ComparePageSkeleton(), HostelDetailPageSkeleton(), HostelListingPageSkeleton(), InquiryPageSkeleton(), emptyFilters, Filters, metadata (+2 more)
...
Cohesion: 0.16
Nodes (22): documentDownloadUrl(), IssuedInvoice, openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt, allocateReceiptNumber(), applySettlement() (+14 more)
...
Cohesion: 0.21
Nodes (19): GET(), resolvePastedLink(), searchCandidates(), lookupLocation(), resolvePastedLink(), searchCandidates(), hostelAdminGeocodeQuerySchema, queryVariants() (+11 more)
...
Cohesion: 0.11
Nodes (21): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, FeeScheduleCloseInput, feeScheduleCloseSchema (+13 more)
...
Cohesion: 0.12
Nodes (20): ContactPage(), generateMetadata(), faqJsonLd(), loadSiteConfig, loadSiteName(), resolveWebFaq(), getListingTier(), listingTiers() (+12 more)
...
Cohesion: 0.12
Nodes (17): connectRealtime(), fetchConfig(), PusherModule, REALTIME_EVENT, RealtimeConfig, RealtimeConnection, RealtimeHandlers, RealtimeNotification (+9 more)
...
Cohesion: 0.15
Nodes (20): AccountDeletionError, applyImmediateEffects(), cancelAccountDeletionForUser(), cancelUrlFor(), DeletionPathway, DeletionRequestRecord, getAccountDeletionStatus(), loadUser() (+12 more)
...
Cohesion: 0.18
Nodes (23): AttendanceAlert, AttendanceLog, code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({) (+15 more)
...
Cohesion: 0.16
Nodes (19): checkoutSchema, POST(), CheckoutStatus, closeIntent(), createPaymentIntent(), expireStaleIntents(), getCheckoutStatus(), handleProviderCallback() (+11 more)
...
Cohesion: 0.11
Nodes (20): FACILITY_OPTIONS, hasHostelErrors(), hasUsableRooms(), HOSTEL_PLANS, HOSTEL_STEPS, HOSTEL_TYPES, HostelAttachment, HostelErrors (+12 more)
...
Cohesion: 0.13
Nodes (19): Attendance / Night Safety, Build status (end of Phase 3), Build status (end of Phase 5 — verified 2026-08-02), code:typescript (export enum Role {), code:typescript (interface INightStatusLog {), code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface INotice {) (+11 more)

### Community 216 - "Community 216"
Cohesion: 0.14
Nodes (15): activateResident(), getResidentProfile(), login(), RootStackParamList, LoginScreen(), Props, Props, ResidentActivationScreen() (+7 more)
...
Cohesion: 0.19
Nodes (17): NavigationFix, watchDeviceHeading(), watchNavigationPosition(), cardinalFor(), CARDINALS, chooseHeading(), distanceToPath(), hasArrived() (+9 more)
...
Cohesion: 0.15
Nodes (15): auditNoticeAction(), createNotice(), listNotices(), markNoticeAsRead(), resolveAdminHostelId(), scopedHostelFilter(), serializeNotice(), updateNotice() (+7 more)
...
Cohesion: 0.13
Nodes (8): ExistingResidentsPanel(), Props, ExistingResidentsSheet(), HostelAdminExistingResidentsPage(), TeamHostelResidentsPage(), useWorkspaceHref(), ApiRequestError, Props
...
Cohesion: 0.22
Nodes (16): hostelTypeLabel(), locationSlug(), formatNpr(), hostelJsonLd(), generateMetadata(), HOSTEL_TYPE_LABEL, HostelDetailData, HostelDetailPage() (+8 more)

### Community 236 - "Community 236"
Cohesion: 0.22
Nodes (14): AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim(), buildAddressQuery(), definedParts(), GoogleAddressComponent, NominatimAddress, pick() (+6 more)
...
Cohesion: 0.15
Nodes (14): userResidentProfileSchema, ResidentIdentityError, ResidentProfileData, findScannedAccount(), loadMembership(), PhotoAssetRecord, ProfileRecord, readScannedResidentPhoto() (+6 more)

### Community 242 - "Community 242"
Cohesion: 0.18
Nodes (15): parseStatementDate(), PlansConfig, buildPresentation(), featuresFor(), fit(), FORBIDDEN_PATTERNS, isSafe(), LIMITS (+7 more)
...
Cohesion: 0.12
Nodes (17): 0.1 The shared Softmato domain, 0.2 Categories — which mailbox a message comes from, 0.2a Where replies go, 0.3 Where the sender is configured, 0.4 Template structure, 0.5 The look, 0. Sending Infrastructure, 1.2 Hostel Admin Credentials (Post-Approval) (+9 more)
...
Cohesion: 0.19
Nodes (12): native, NativeDownloads, openDownloaded(), openSavedFile(), SavedDownload, KNOWN_PATHS, marksRoleChange(), opensPlanBilling() (+4 more)
...
Cohesion: 0.13
Nodes (11): aad, candidates, dirname, ordered, repoRoot, secrets, target, unwrapper (+3 more)

### Community 264 - "Community 264"
Cohesion: 0.16
Nodes (11): POST(), verifyPurposeToken(), cancelAccountDeletionByToken(), hostelId, input, leanResult(), mocks, recipients (+3 more)
...
Cohesion: 0.13
Nodes (14): code:block1 (PASS  all three photos stored — 3), Emails, and how far they are verified, Phase 1 — Contract first, Phase 2 — The form, rebuilt as a flow, Phase 3 — The modules the form was missing, Phase 4 — Plan and money, Phase 5 — Publishing is a decision, Phase 6 — Emails (+6 more)
...
Cohesion: 0.14
Nodes (11): corner, dogleg, heading, KILOMETRE_EAST, located, result, START, steps (+3 more)
...
Cohesion: 0.2
Nodes (11): invoiceRow(), objectId(), overdue, paymentProofRecord(), paymentRecord(), receiptRecord(), residentPrincipal, residentRecord() (+3 more)
...
Cohesion: 0.27
Nodes (10): Entry, hostelEntries(), locationEntries(), sitemap(), STATIC_ROUTES, listPublishedHostelSlugs(), photoAssetId(), PublicAsset (+2 more)
...
Cohesion: 0.15
Nodes (11): toPortalInvoice(), bhadra(), first, goneId, hostelId, invoiceId, ledgerInvoice, mocks (+3 more)

### Community 299 - "Community 299"
Cohesion: 0.15
Nodes (9): ATTENDANCE_DEFAULTS, afterMidnight, evening, meters, mocks, once, residentId, residentPrincipal (+1 more)
...
Cohesion: 0.21
Nodes (13): 1.0 Signup One-Time Code, 1.1 Email Verification (PUBLIC Signup), 1.3 Warden Credentials, 1.4 Resident QR Activation, 1.6 Password Reset, 1.7 Account Upgraded, 1. Authentication & Account Emails, code:typescript ({) (+5 more)
...
Cohesion: 0.27
Nodes (10): isUsableCoordinate(), hasLocationPermission(), hasPromptedForLocation(), LocationOutcome, readPosition(), readPrecisePosition(), rememberLocationPrompt(), requestDeviceLocation() (+2 more)
...
Cohesion: 0.23
Nodes (10): publicHostelApplicationCreateSchema, documents, hostelForm(), many, parsed, result, emptyHostelForm(), emptyRoomRow() (+2 more)
...
Cohesion: 0.21
Nodes (9): buckets, clientKey(), positiveInteger(), publicFormLimit(), PublicFormRateLimitOptions, publicFormWindowMs(), RateLimitBucket, resetPublicFormRateLimitForTests() (+1 more)
...
Cohesion: 0.24
Nodes (9): MAP_LAYERS, mapLayer(), MapLayerId, KATHMANDU, MapCanvas, MapCanvasProps, MapHandle, MapMarker (+1 more)
...
Cohesion: 0.18
Nodes (10): advice, bare, creditReceipt, debitReceipt, eblQrReceipt, noisy, read, refund (+2 more)
...
Cohesion: 0.22
Nodes (11): 2.3 Hostel Rejected, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails, code:typescript ({) (+3 more)
...
Cohesion: 0.22
Nodes (7): AuthSession, triggerSOS(), AppNavigator(), Stack, ResidentComplaintsScreen(), Props, ResidentSOSScreen()
...
Cohesion: 0.2
Nodes (6): inviteId, mocks, principal, superadminId, user, userId
...
Cohesion: 0.2
Nodes (8): isMonthEnd(), friday, hostelId, mocks, nextFriday, principal, storedRoutine, thisFriday

### Community 367 - "Community 367"
Cohesion: 0.22
Nodes (7): assertTeamRegistrationIsNew(), hostelNameKey(), hostelId, mocks, PHONE_ONLY, refused, userId

### Community 368 - "Community 368"
Cohesion: 0.4
Nodes (6): ensureSoftmatoInvoice(), formatPaisa(), paisaToRupees(), rupeesToPaisa(), customerExternalRef(), invoiceExternalRef()
...
Cohesion: 0.27
Nodes (7): HostelPhotoReminder(), FALLBACK_ORDER, hasNoHostelPhotos(), HostelPhoto, HostelPhotoKind, photosOfKind(), resolveHostelPhotos()
...
Cohesion: 0.22
Nodes (9): [0.2.0] - 2026-07-14 (Late), Added, Added, Added, Added, Added, Added, Added (+1 more)
...
Cohesion: 0.25
Nodes (4): before, expiresAt, mocks, staffPrincipal
...
Cohesion: 0.25
Nodes (6): BED_TYPE_VALUES, currencyField, FinanceModelError, positiveWholeRupees, signedWholeRupees, wholeRupees
...
Cohesion: 0.29
Nodes (8): 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, code:typescript ({), code:typescript ({), code:block14 (---), code:typescript ({)
...
Cohesion: 0.29
Nodes (8): 7.1 Multi-Tenant Isolation Test Template, 7.3 Privacy/Guardian Permissions Test Template, 7.5 Payment Precision Test Template, 7. Mandatory Test Templates, code:typescript (describe('GET /api/v1/hostel/rooms/:id - tenant isolation', ), code:typescript (describe('GET /api/v1/guardian/linked-resident - privacy', (), code:bash (npm --prefix apps/web run typecheck), code:bash (npm run web:build)
...
Cohesion: 0.29
Nodes (7): maneuverIcon(), NavCard(), directionWord(), formatManeuverDistance(), instructionFor(), ordinal(), turnPhrase()
...
Cohesion: 0.33
Nodes (4): buildStatementNudge(), StatementNudge, NOW, nudge
...
Cohesion: 0.29
Nodes (4): mocks, noticeInput, residentUserId, staffPrincipal

### Community 446 - "Community 446"
Cohesion: 0.29
Nodes (5): assetId, hostelId, mocks, otherHostelId, principal
...
Cohesion: 0.29
Nodes (7): 4.2 Complaint Status Updated, 4.3 Complaint Resolved, 4. Resident Activity Emails, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({)
...
## Knowledge Gaps
- **5913 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+5908 more)
...
- **Why does `cn()` connect `Community 27` to `Community 1`, `Community 258`, `Community 2`, `Community 6`, `Community 138`, `Community 16`, `Community 18`, `Community 147`, `Community 24`, `Community 25`, `Community 155`, `Community 29`, `Community 31`, `Community 33`, `Community 34`, `Community 35`, `Community 46`, `Community 48`, `Community 53`, `Community 309`, `Community 55`, `Community 56`, `Community 62`, `Community 68`, `Community 73`, `Community 75`, `Community 78`, `Community 81`, `Community 89`, `Community 92`, `Community 225`, `Community 101`, `Community 125`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 2` to `Community 1`, `Community 3`, `Community 5`, `Community 134`, `Community 7`, `Community 8`, `Community 10`, `Community 13`, `Community 14`, `Community 16`, `Community 17`, `Community 22`, `Community 24`, `Community 25`, `Community 27`, `Community 28`, `Community 32`, `Community 34`, `Community 35`, `Community 37`, `Community 40`, `Community 48`, `Community 61`, `Community 78`, `Community 89`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 46` to `Community 0`, `Community 5`, `Community 7`, `Community 10`, `Community 12`, `Community 14`, `Community 15`, `Community 16`, `Community 147`, `Community 19`, `Community 21`, `Community 22`, `Community 150`, `Community 24`, `Community 25`, `Community 29`, `Community 415`, `Community 33`, `Community 162`, `Community 35`, `Community 165`, `Community 39`, `Community 41`, `Community 42`, `Community 47`, `Community 180`, `Community 182`, `Community 57`, `Community 444`, `Community 62`, `Community 64`, `Community 193`, `Community 322`, `Community 71`, `Community 203`, `Community 79`, `Community 81`, `Community 89`, `Community 92`, `Community 93`, `Community 222`, `Community 96`, `Community 98`, `Community 357`, `Community 235`, `Community 111`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Are the 451 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 451 INFERRED edges - model-reasoned connections that need verification._
