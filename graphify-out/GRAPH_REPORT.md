# Graph Report - hostel-management-software  (2026-09-09)

## Corpus Check
- 1881 files · ~3,250,971 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14939 nodes · 41079 edges · 520 communities (493 shown, 27 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 653 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 612 edges
2. `successResponse()` - 596 edges
3. `connectToDatabase()` - 412 edges
4. `useAppTheme()` - 362 edges
5. `cn()` - 276 edges
6. `connectToDatabase()` - 238 edges
7. `unwrap()` - 194 edges
...
## Communities (520 total, 27 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (251): PATCH(), POST(), RouteContext, GET(), POST(), PATCH(), POST(), RouteContext (+243 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (176): ICONS, LABELS, Segment, TONES, FILTERS, Pending, Overview, MoneyData (+168 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (226): POST(), POST(), GET(), GET(), GET(), searchCandidates(), addHostelAdminInquiryNote(), auditInquiryAction() (+218 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (199): Scanner(), FaqRow(), MethodCard(), CookInviteScreen(), GuardianInviteScreen(), Choice, Compass(), MapButton() (+191 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (242): VoiceNotePlayer(), RoundButton(), VOICE_NOTE_RECORDING, VoiceNote, VoiceNoteRecorder(), FinanceData, loadFinance(), ManageFinanceScreen() (+234 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (174): POST(), POST(), POST(), attacker, attempt(), headers, jsonRequest(), routeMocks (+166 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (193): listResidentComplaints(), summarizeResidentComplaints(), getOpenFeeSchedule(), getResidentFinanceView(), listResidentClaims(), listResidentInvoices(), outstandingForResident(), renderStatementForResident() (+185 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (200): loadOverview(), loadMoney(), loadToday(), TodayData, SORTS, AlertCard(), AdminRollCallCard(), AdminMaintenance (+192 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (127): DemoDataBadge(), Hostel, HostelTable(), UserRecord, GuardianDashboard, GuardianSafetyPageContent, HostelAdminTransactionsPageContent, Payment (+119 more)
...
Cohesion: 0.02
Nodes (132): AdminCommunityScreen(), SosScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD (+124 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (137): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply() (+129 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (137): FILTERS, NotificationCard(), NotificationRow(), NotificationsScreen(), TILE_GLYPH, TILE_TONES, CommunityScreen(), Composer() (+129 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (131): AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), BootGate(), RootShell(), ApplyBlock(), ServiceProvidersScreen(), DeletionPanel() (+123 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (137): POST(), RouteContext, DELETE(), GET(), hostelId(), GET(), POST(), DELETE() (+129 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (133): PaymentMonthStrip(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), PortalDates, InvoiceDetailScreen(), SummaryCard() (+125 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (117): GET(), POST(), querySchema, RouteContext, authorUserId, mocks, postId, residentId (+109 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (118): ProfileScreen(), ReferralRow(), ReviewForm(), ReviewScreen(), CheckoutStatusScreen(), AttachmentGallery(), DAY_LABELS, DayStrip() (+110 more)
...
Cohesion: 0.04
Nodes (90): GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, CITY_OPTIONS (+82 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (109): demoteToPublicAccount(), CapacityError, claimBedForRoomType(), listAllRoomTypes(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary() (+101 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (90): ATTENDANCE_DEFAULTS, adminPrincipal, mocks, PLATFORM_LIMITS, afterMidnight, evening, meters, mocks (+82 more)
...
Cohesion: 0.08
Nodes (74): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), formatRupees(), subscriptionInvoiceEmail() (+66 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (90): GET(), POST(), GET(), GET(), readReturnState(), ownerIdentitiesFor(), resolveOwnedHostel(), getSubscriptionState() (+82 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (89): CommunityReportDialog(), REASONS, MonthOption(), InlineText(), inferKind(), MediaLightbox(), ModerationButton(), PagerButton() (+81 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (97): cookPrincipal, mocks, resolveCookLabels(), announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError (+89 more)

### Community 27 - "Community 27"
Cohesion: 0.02
Nodes (83): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, daysFromNow(), enabledPermissionLabels(), GuardianAccessRecord, GuardianInvitationAcceptInput (+75 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (93): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), methodProvider(), PROVIDER_LABEL, QrPanel() (+85 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (84): PRIORITIES, STATUS_ACTIONS, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel, AdminReferral, FILTERS (+76 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (72): csvField(), deferLoad(), field(), Inquiry, LoadState, Message(), numberField(), optionalField() (+64 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (83): fromBs(), BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan (+75 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (77): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), base, entityId, hostelId, mocks, principal (+69 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (78): AdminCommunityReportsScreen(), AttendanceScreen(), NightStatusForm(), NightStatusScreen(), ReferralsScreen(), AlertRow(), StoreCategoryScreen(), CommunityPostScreen() (+70 more)
...
Cohesion: 0.04
Nodes (66): Notification, humanizeValue(), ImportedProfileSummary(), PrefillPhoto, ResidentPrefill, ResidentStatus, STATUS_ACTIONS, BrowserPushRow() (+58 more)
...
Cohesion: 0.04
Nodes (65): CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing, CurrentUser (+57 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (66): assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck(), evidenceCheck(), fileCheck(), InvoiceForCheck (+58 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (68): Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity() (+60 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (59): GATEWAY_ORDER, getHostelPayMethods(), getPayInstructions(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod (+51 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (66): publicHostelApplicationCreateSchema, documents, hostelForm(), many, parsed, result, buildHostelPayload(), capacitySummary() (+58 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (49): ComparePage(), hostels, metadata, rows, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminRoomsPageContent(), PlatformDashboardPageContent() (+41 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (58): PaginationMeta, PaginationQuery, querySchema, deviceTokenSchema, notificationCampaignSchema, describeDeposit(), notifyMoveOutCompleted(), hostelId (+50 more)
...
Cohesion: 0.05
Nodes (58): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), AdminTodayScreen(), AdminAlertsContext, AdminAlertsValue, AlertActions, EMPTY_COUNTS (+50 more)
...
Cohesion: 0.05
Nodes (36): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminFoodPage(), HostelAdminNoticesPage(), HostelAdminPaymentsPage(), HostelAdminResidentsPage() (+28 more)
...
Cohesion: 0.05
Nodes (61): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsPeriodBounds(), bsPeriodOf() (+53 more)
...
Cohesion: 0.06
Nodes (61): EvidenceEngineMode, AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance(), deadline(), DIGIT_CONFUSABLES (+53 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (51): EMPTY_SUMMARY, HostelAdminComplaintsPage, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine (+43 more)

### Community 56 - "Community 56"
Cohesion: 0.06
Nodes (50): AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput, ConsentInput, dayKey() (+42 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (45): escapeRegex(), objectIdSchema, paginationSchema, phoneSchema, SERVICE_PROVIDER_CATEGORIES, serviceProviderSchema, serviceProviderApplicationSchema, serviceProviderDocumentSchema (+37 more)
...
Cohesion: 0.05
Nodes (41): fill(), PricingScreen(), PlanPicker(), TIER_TONE, PlanMark(), ROWS, BillingToggle(), EASE (+33 more)

### Community 60 - "Community 60"
Cohesion: 0.06
Nodes (48): addHistory(), addMaintenanceComment(), assertBedInHostel(), assertProviderApproved(), assertRoomInHostel(), assertVoiceNoteUsable(), assignMaintenanceProvider(), auditMaintenanceAction() (+40 more)
...
Cohesion: 0.04
Nodes (37): AuthGuard(), HostelRegistrationProgress(), Milestone, milestoneIndex(), MILESTONES, PaymentPanel(), rupees(), SubscriptionState (+29 more)
...
Cohesion: 0.07
Nodes (42): collectionTotals(), countInvoicesByField(), invoicesByIds(), ledgerPipeline(), monthlySeries(), getHostelViewStats(), foodFeedbackSchema, listingFlagSchema (+34 more)
...
Cohesion: 0.05
Nodes (34): LegacyHostelAdminComplaintsPage(), Complaint, ComplaintSummary, EmptyState(), field(), FoodMenu, HostelAdminComplaintsPage(), LoadingRows() (+26 more)

### Community 73 - "Community 73"
Cohesion: 0.07
Nodes (28): AdminTabs(), HIDDEN, TABS, TABS, AdminAlertsProvider(), AvatarTabIcon(), RoleTabs(), TabDef (+20 more)
...
Cohesion: 0.06
Nodes (30): daysUntil(), HostelSubscriptionDueBanner(), rupees(), State, navItems, navItems, GUARDIAN_NAV, GUARDIAN_SEARCH_ENTRIES (+22 more)
...
Cohesion: 0.08
Nodes (39): storeOrderSchema, mocks, allocateOrderNumber(), applyStatus(), CancelInput, cancelOrder(), CreateInput, hostelNames() (+31 more)

### Community 79 - "Community 79"
Cohesion: 0.08
Nodes (34): DEPRECATED_ALIASES, grantingPermissionKeys(), mocks, dashboardUrl(), notifyWardenAdded(), notifyWardenUpdated(), auditWardenAction(), createHostelWarden() (+26 more)
...
Cohesion: 0.08
Nodes (37): bsMonthStart(), hostelCalendarDay(), hostelToday(), ResidentDoc, ResidentLedger, ResidentLedgerMonth, ResidentLedgerPayment, billed (+29 more)

### Community 82 - "Community 82"
Cohesion: 0.06
Nodes (27): currency(), Select(), ResidentActivationPageContent, ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent, Complaint (+19 more)

### Community 83 - "Community 83"
Cohesion: 0.07
Nodes (33): chargeDescriptions(), filterInvoices(), groupInvoicesByYear(), InvoiceRowCopy, InvoiceYear, isOpenInvoice(), LedgerLine, oneOffLabel() (+25 more)
...
Cohesion: 0.11
Nodes (32): BANK_CSV_PARSER, CsvTable, gridFromCsv(), peekHeaders(), readCsv(), stripBom(), stripPreamble(), buildTable() (+24 more)
...
Cohesion: 0.1
Nodes (30): nepalDayKey(), isCurrentNight(), isSelfReportable(), NIGHT_STATUS_OPTIONS, nightKey(), nightNote(), NightStanding, SelfReportableStatus (+22 more)
...
Cohesion: 0.07
Nodes (32): aswin, bhadra, bs(), card(), currentId, hostelId, inAswin, inOctober (+24 more)

### Community 91 - "Community 91"
Cohesion: 0.09
Nodes (27): ratingReviewSchema, reviewModerationLogSchema, notifyHostelOfReview(), auditReviewAction(), averageOf(), createResidentReview(), hideReview(), listPublicHostelReviews() (+19 more)

### Community 92 - "Community 92"
Cohesion: 0.09
Nodes (21): geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), GoogleMap, LeafletMap, TYPE_COLORS, fetchNearbyPlaces() (+13 more)

### Community 93 - "Community 93"
Cohesion: 0.08
Nodes (29): getR2Client(), classifyCredit(), CreditClassification, LadderClaim, LadderInvoice, MatchContext, normalizeTxnId(), ANITA_CODE (+21 more)

### Community 94 - "Community 94"
Cohesion: 0.07
Nodes (26): candidateRoots, fillMissing(), findRepoRoot(), { loadEnvConfig }, loadRootEnv(), parseEnvFile(), require, filled (+18 more)
...
Cohesion: 0.11
Nodes (26): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, ImageVariantRecord (+18 more)

### Community 98 - "Community 98"
Cohesion: 0.09
Nodes (30): FILE_ASSET_KINDS, FileAssetKind, FINANCIAL_KINDS, cancelUpload(), canRetryUpload(), handles, isActive(), retryUpload() (+22 more)
...
Cohesion: 0.12
Nodes (25): isFileAssetKind(), isFinancialAssetKind(), DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList(), positiveInteger(), validateFileAssetMetadata() (+17 more)

### Community 104 - "Community 104"
Cohesion: 0.09
Nodes (28): CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, readId(), activeDevicesFor(), activeTokensFor(), authHeaders(), chunk() (+20 more)
...
Cohesion: 0.1
Nodes (24): HostelSuggestions(), checkOnly(), EMPTY_PREFILL, ENVIRONMENT_OPTIONS, IdentityResponse, Prefill, Step, TalkToExpertButton() (+16 more)

### Community 107 - "Community 107"
Cohesion: 0.1
Nodes (29): proximityScore(), cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath(), formatManeuverDistance(), headingDifference() (+21 more)

### Community 108 - "Community 108"
Cohesion: 0.15
Nodes (26): GET(), periodTotals(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS, neutralize(), csv (+18 more)
...
Cohesion: 0.12
Nodes (22): native, NativeDownloads, openDownloaded(), SavedDownload, isNightStatusPrompt(), NIGHT_STATUS_ACTIONS, NIGHT_STATUS_BUTTONS, NIGHT_STATUS_REASONS (+14 more)
...
Cohesion: 0.1
Nodes (25): sessionSchema, AccountDeletionError, applyImmediateEffects(), cancelAccountDeletionForUser(), cancelUrlFor(), DeletionPathway, DeletionRequestRecord, getAccountDeletionStatus() (+17 more)
...
Cohesion: 0.09
Nodes (24): POST(), GET(), POST(), GET(), acceptGuardianInvitation(), GET(), GET(), POST() (+16 more)
...
Cohesion: 0.14
Nodes (28): CARD_NOUNS, CardVariant, drawBack(), drawBrandLockup(), drawFooterSweep(), drawFront(), drawHeaderSweep(), drawIdCard() (+20 more)
...
Cohesion: 0.1
Nodes (22): DownloadStack(), downloadFile(), DownloadOptions, DownloadOutcome, nextId(), readWithProgress(), saveBlob(), clicked (+14 more)

### Community 129 - "Community 129"
Cohesion: 0.11
Nodes (23): ComplaintDetail(), ComplaintCard(), ACTOR_LABELS, actorLabel(), Complaint, ComplaintUpdate, canConfirmResolution(), COMPLAINT_CATEGORY_OPTIONS (+15 more)
...
Cohesion: 0.09
Nodes (21): defaultDueDate(), DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), monthLabel(), describePreference() (+13 more)
...
Cohesion: 0.13
Nodes (25): LEGACY_ROLE_MAP, Role, ROLE_VALUES, cardPhotoImageUrl(), clearResidentIdentityPhoto(), generateResidentId(), isCardPhotoImage(), lookupResidentProfile() (+17 more)
...
Cohesion: 0.11
Nodes (20): downloadCaption(), DownloadRow, progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster(), UploadRow (+12 more)
...
Cohesion: 0.11
Nodes (18): softmatoDocsUrl(), BillingHistory, BillingInvoiceRow, BillingPaymentRow, CYCLE_LABELS, getInvoiceDetailForHostel(), Badge(), HostelAdminBillingPageContent() (+10 more)
...
Cohesion: 0.09
Nodes (22): Account deletion purge, Attendance maintenance (absence alerts + retention purge), Authentication, Check push delivery receipts, Complaint SLA breach check, cron-job.org setup (per job), CRON.md — Scheduled Jobs, Dispatch scheduled notifications (+14 more)
...
Cohesion: 0.16
Nodes (17): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), OpenedCheckout, readSettledReceipt(), SettledReceipt, GET(), RouteContext (+9 more)
...
Cohesion: 0.17
Nodes (18): FileUploadArea(), acceptAttribute(), EXTENSION_BY_MIME, FAMILY_BYTES, FAMILY_ORDER, familyOf(), formatBytes(), joinTypes() (+10 more)
...
Cohesion: 0.14
Nodes (14): AuthSession, requestOtp(), signInWithGoogle(), submitResidentReview(), triggerSOS(), AppNavigator(), RootStackParamList, Stack (+6 more)
...
Cohesion: 0.15
Nodes (16): hasLocationPermission(), hasPromptedForLocation(), LocationOutcome, NavigationFix, readPosition(), rememberLocationPrompt(), requestDeviceLocation(), toCoordinates() (+8 more)

### Community 191 - "Community 191"
Cohesion: 0.15
Nodes (16): getPresignedReadUrl(), userResidentProfileSchema, ageFromDateOfBirth(), readProfile(), ResidentIdentityError, findScannedAccount(), loadMembership(), PhotoAssetRecord (+8 more)
...
Cohesion: 0.14
Nodes (10): InviteResult, Member, PlatformTeamPage(), Registration, Registration, rupees(), Stat(), Summary (+2 more)
...
Cohesion: 0.24
Nodes (13): robots(), siteUrl(), CARD_LABELS, formatIssuedOn(), readPhotoBytes(), readQrBytes(), sendIdCardEmail(), getResidentIdentity() (+5 more)

### Community 220 - "Community 220"
Cohesion: 0.17
Nodes (13): Offset, PhotoCropper(), VideoSlot(), FileUploader(), FileUploaderPresentation, FileUploaderProps, FileUploaderView(), TONE_CLASSES (+5 more)
...
Cohesion: 0.15
Nodes (12): activateResident(), getResidentProfile(), login(), LoginScreen(), Props, Props, ResidentActivationScreen(), styles (+4 more)
...
Cohesion: 0.23
Nodes (14): allocateNumber(), ensureInvoiceRaised(), findOpenInvoice(), getOrCreateSubscription(), InvoiceRecord, issueSubscriptionInvoice(), PaymentRecord, resolveBillingContact() (+6 more)

### Community 233 - "Community 233"
Cohesion: 0.17
Nodes (13): arrangeSettlement(), catalog, hostelId, invoice(), invoiceId, mocks, otherHostelId, paymentId (+5 more)
...
Cohesion: 0.16
Nodes (15): 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, 4.2 Complaint Status Updated, 4.3 Complaint Resolved, 4. Resident Activity Emails (+7 more)
...
Cohesion: 0.16
Nodes (13): apiRequest(), confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listResidentComplaints(), refreshSession(), register(), ResidentComplaint (+5 more)
...
Cohesion: 0.27
Nodes (12): openCheckoutSession(), allocateReceiptNumber(), applySettlement(), InvoiceRecord, loadInvoice(), openSubscriptionCheckout(), publishForSubscription(), recordCashPayment() (+4 more)
...
Cohesion: 0.29
Nodes (9): resolvePastedLink(), ParsedMapLink, parseMapLink(), placeFromPath(), POINT_PARAMS, resolveShortLink(), SHORTENERS, parsed (+1 more)
...
Cohesion: 0.38
Nodes (7): GET(), getAgentSummary(), listAgentRegistrations(), listTeamRegistrations(), listTeamRoster(), moneyBySubscription(), SubscriptionRow
...
## Knowledge Gaps
- **5258 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+5253 more)
...
- **Why does `Button()` connect `Community 1` to `Community 3`, `Community 4`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 15`, `Community 17`, `Community 18`, `Community 25`, `Community 28`, `Community 30`, `Community 33`, `Community 35`, `Community 36`, `Community 41`, `Community 45`, `Community 47`, `Community 55`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 25` to `Community 1`, `Community 262`, `Community 8`, `Community 9`, `Community 142`, `Community 18`, `Community 19`, `Community 22`, `Community 29`, `Community 30`, `Community 159`, `Community 35`, `Community 36`, `Community 37`, `Community 42`, `Community 44`, `Community 175`, `Community 49`, `Community 55`, `Community 59`, `Community 62`, `Community 67`, `Community 72`, `Community 74`, `Community 203`, `Community 85`, `Community 220`, `Community 99`, `Community 100`, `Community 106`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 131` to `Community 0`, `Community 128`, `Community 5`, `Community 7`, `Community 9`, `Community 10`, `Community 15`, `Community 145`, `Community 18`, `Community 23`, `Community 26`, `Community 29`, `Community 30`, `Community 32`, `Community 33`, `Community 34`, `Community 37`, `Community 41`, `Community 297`, `Community 175`, `Community 51`, `Community 52`, `Community 53`, `Community 54`, `Community 56`, `Community 59`, `Community 62`, `Community 322`, `Community 68`, `Community 71`, `Community 80`, `Community 84`, `Community 106`, `Community 109`, `Community 116`, `Community 119`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Are the 407 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 407 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `{ defineConfig }`, `expoConfig`, `path` to the rest of the system?**
  _5258 weakly-connected nodes found - possible documentation gaps or missing edges._
