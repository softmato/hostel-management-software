# Graph Report - hostel-management-software  (2026-08-04)

## Corpus Check
- 881 files · ~1,689,128 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6730 nodes · 17089 edges · 334 communities (311 shown, 23 thin omitted)
...
2. `successResponse()` - 402 edges
3. `connectToDatabase()` - 254 edges
4. `cn()` - 212 edges
5. `connectToDatabase()` - 186 edges
6. `requireHostelStaffPrincipal()` - 116 edges
7. `requireHostelCapability()` - 109 edges
8. `browserApi()` - 103 edges
9. `usePortalResource()` - 78 edges
...
Cohesion: 0.03
Nodes (98): CommunityReportDialog(), REASONS, Notification, PagerButton(), normalize(), PortalSearch(), PortalTone, scoreEntry() (+90 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (85): CommunityPageContent(), HostelAdminCommunityPageContent, EMPTY_SUMMARY, HostelAdminComplaintsPage, HostelAdminDashboardPageContent, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings (+77 more)
...
Cohesion: 0.05
Nodes (62): ReportGrid(), GuardianDashboard, CATEGORIES, AUDIT_ACTIVITY, AuditLog, CHART_LABELS, MetricTrend, PLACEHOLDER_OWNERS (+54 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (60): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel(), ConfirmOptions, Resolver, useConfirm() (+52 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (66): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus(), OPEN_STATUSES (+58 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (59): PRIORITIES, STATUS_ACTIONS, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel, AdminReferral, FILTERS (+51 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (68): listResidentComplaints(), listPublicFoodRoutine(), listHostelAdminInquiries(), getHostelAdminProfile(), comparePublicHostels(), getPublicHostelBySlug(), listPlatformHostels(), listPublicHostels() (+60 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (48): PATCH(), POST(), RouteContext, POST(), RouteContext, PATCH(), RouteContext, GET() (+40 more)
...
Cohesion: 0.04
Nodes (45): POST(), GET(), GET(), searchCandidates(), createPublicHostelInquiry(), listHostelAdminInquiries(), hostelAdminGeocodeQuerySchema, hostelRejectSchema (+37 more)

### Community 13 - "Community 13"
Cohesion: 0.08
Nodes (41): GenericPortalScreen(), portalRows(), portalTitle(), hasFood(), LoadState, PublicHostelListingPage(), PublicHostelListingPageContent(), PublicInquiryPage() (+33 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (50): resolvePastedLink(), geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim() (+42 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (48): adminPrincipal, mocks, PLATFORM_LIMITS, POST(), cookPrincipal, cookUserId, DAY_NAMES, leanResult() (+40 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (50): dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, getFoodRoutine(), isMonthEnd(), mealsOn() (+42 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (48): ComparePage(), hostels, metadata, rows, AuthGuard(), Offset, PhotoCropper(), CurrentUser (+40 more)
...
Cohesion: 0.06
Nodes (34): DELETE(), GET(), POST(), RouteContext, deleteOwnPost(), GET(), GET(), GET() (+26 more)

### Community 21 - "Community 21"
Cohesion: 0.06
Nodes (44): HostelSuggestions(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, formatHostelAddress(), hostelTypeToUi(), mapPublicHostelToSummary() (+36 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (45): assertHostelAccess(), canAccessHostel(), hostelScopedFilter(), TenantAccessError, TenantPrincipal, attendanceLogSchema, foodReadyLogSchema, DAYS (+37 more)
...
Cohesion: 0.04
Nodes (51): cookEmailForSlug(), generatePassword(), provisionCookAccount(), addHostelAdminInquiryNote(), BedCreateInput, BedRecord, BedUpdateInput, DocumentRequestNotification (+43 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (31): Filter, ModeratedPost, ModerationPayload, ReportRecord, HostelAdminTransactionsPageContent, Payment, TABS, PlatformCommunityPageContent (+23 more)
...
Cohesion: 0.06
Nodes (26): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminMoveChecklistPage(), HostelAdminSOSAlertsPage(), HostelAdminComplaintsPage(), redirectToWorkspaceScreen(), HostelAdminMaintenancePageContent() (+18 more)

### Community 30 - "Community 30"
Cohesion: 0.08
Nodes (37): GET(), POST(), GET(), GET(), communityVoteSchema, GET(), PATCH(), POST() (+29 more)

### Community 31 - "Community 31"
Cohesion: 0.06
Nodes (37): AuditLogRecord, PlatformAuditLogQuery, RefRecord, PaginationMeta, PaginationQuery, paginationQuerySchema, querySchema, auditListingFlagAction() (+29 more)

### Community 32 - "Community 32"
Cohesion: 0.06
Nodes (34): listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), communityHideSchema, GET(), DELETE(), PATCH() (+26 more)

### Community 33 - "Community 33"
Cohesion: 0.08
Nodes (28): GET(), POST(), findResidentOwnedAccess(), revokeGuardianAccess(), updateGuardianPermissions(), DELETE(), GET(), PATCH() (+20 more)
...
Cohesion: 0.06
Nodes (31): complaintCategorySchema, complaintCreateSchema, complaintListQuerySchema, complaintReplySchema, complaintResolutionConfirmSchema, complaintStatusSchema, complaintStatusUpdateSchema, objectIdSchema (+23 more)
...
Cohesion: 0.09
Nodes (36): getHostelViewStats(), foodFeedbackSchema, listingFlagSchema, paymentProofSchema, averageResolutionDays(), bucketBoundaries(), collectionRate(), countByField() (+28 more)

### Community 40 - "Community 40"
Cohesion: 0.08
Nodes (32): depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, providedItemSchema, auditMoveAction(), createMoveInChecklist(), createMoveOutChecklist(), findAdminResident() (+24 more)
...
Cohesion: 0.07
Nodes (27): AccountDeletionPanel, DeletionPathway, DeletionStatus, PATHWAY_COPY, CancelDeletionPageContent(), OperationsConfig, PlatformOperationsPanel, AttendanceDay (+19 more)
...
Cohesion: 0.08
Nodes (23): GET(), RouteContext, POST(), RouteContext, RouteContext, addEmergencyContact(), addGuardian(), auditResidentAction() (+15 more)
...
Cohesion: 0.07
Nodes (31): inquiryId, serviceMocks, staffPrincipal, BedCreateInput, BedRecord, BedUpdateInput, createHostelAdminBed(), createHostelAdminFloor() (+23 more)
...
Cohesion: 0.08
Nodes (35): demoteToPublicAccount(), BedRecord, createResident(), definedUpdate(), EmergencyContactCreateInput, EmergencyContactRecord, GuardianCreateInput, GuardianRecord (+27 more)

### Community 52 - "Community 52"
Cohesion: 0.09
Nodes (27): GET(), getAttendanceConfig(), getAttendanceSettings(), listAttendanceAlerts(), listHostelAttendance(), overrideAttendance(), recordConsent(), resolveAdminHostelId() (+19 more)
...
Cohesion: 0.13
Nodes (24): AuthServiceError, resendVerificationEmail(), signupWithEmailVerification(), otpRequestSchema, POST(), errorResponse(), buckets, clientKey() (+16 more)

### Community 55 - "Community 55"
Cohesion: 0.08
Nodes (26): noticeSchema, noticeReadStatusSchema, mocks, noticeInput, residentUserId, staffPrincipal, auditNoticeAction(), broadcastNotice() (+18 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (23): HostelAdminFoodPage, Complaint, ComplaintSummary, field(), FoodMenu, HostelAdminFoodPage(), HostelAdminNoticesPage(), HostelAdminPaymentsPage() (+15 more)

### Community 57 - "Community 57"
Cohesion: 0.12
Nodes (19): POST(), POST(), POST(), POST(), GET(), successResponse(), CronAuthResult, normalizeSecret() (+11 more)
...
Cohesion: 0.07
Nodes (22): metadata, FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES, avatarTone() (+14 more)
...
Cohesion: 0.09
Nodes (26): listTrendingTags(), CachedConnection, globalForMongoose, sponsorSchema, GET(), loadPopularHostels(), PopularHostelRecord, assertWindow() (+18 more)
...
Cohesion: 0.07
Nodes (20): EmptyState(), StatusBadge(), TextArea(), field(), HostelAdminReferralsPageContent(), ListingFlag, LoadState, MaintenanceRequest (+12 more)

### Community 65 - "Community 65"
Cohesion: 0.12
Nodes (22): listCommunityModeration(), getCommunitySettings(), communityAnnouncementSchema, communityFeedQuerySchema, communityModerationQuerySchema, communityPostCreateSchema, communityReactionSchema, communityReportSchema (+14 more)
...
Cohesion: 0.08
Nodes (26): AnnouncementInput, CommentCreateInput, CommentRecord, CommunityServiceError, FeedQuery, findReadablePost(), findVisiblePostForResident(), flagPost() (+18 more)
...
Cohesion: 0.1
Nodes (25): issueSessionForUser(), login(), publicUser(), refreshAccessToken(), MockSessionModel, serviceMocks, session, user (+17 more)
...
Cohesion: 0.09
Nodes (19): PATCH(), RouteContext, PATCH(), POST(), GET(), monthlyPaymentGenerateSchema, monthSchema, objectIdSchema (+11 more)
...
Cohesion: 0.1
Nodes (25): notificationCampaignSchema, CampaignListQuery, CampaignRecord, createCampaign(), createHostelNotificationCampaign(), createPlatformNotificationCampaign(), dispatchCampaign(), dispatchDueCampaigns() (+17 more)
...
Cohesion: 0.18
Nodes (24): sendEmail(), appHostelStatusUrl(), appLoginUrl(), approvePlatformHostel(), createPlatformHostelApplication(), deleteHostelAdminProfilePhoto(), findHostelByIdOrThrow(), findOrCreatePublicHostelOwner() (+16 more)
...
Cohesion: 0.08
Nodes (15): hostelId, mocks, NOW, residentId, userId, guardianId, guardianUserId, hostelId (+7 more)
...
Cohesion: 0.1
Nodes (11): accountDeletionRequestSchema, consentLogSchema, deviceTokenSchema, notificationSchema, purgeAccount(), runAccountDeletionPurge(), mocks, now (+3 more)
...
Cohesion: 0.12
Nodes (15): GoogleAuthInput, googleAuthSchema, LoginInput, loginSchema, otpChannelSchema, otpPurposeSchema, OtpRequestInput, OtpVerifyInput (+7 more)
...
Cohesion: 0.17
Nodes (18): AccountDeletionRequest, code:typescript ({), code:typescript ({), code:typescript (interface IQuestionCallClick {), code:typescript ({), code:typescript ({), code:typescript (interface IAccountDeletionRequest {), code:block46 (packages/db/migrations/) (+10 more)
...
Cohesion: 0.15
Nodes (5): AuthShell(), AuthShellProps, AuthExperiencePage(), metadata, SignupForm()
...
Cohesion: 0.14
Nodes (11): GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse, GoogleAuthUser, GoogleCredentialResponse, Window, AuthResponse, OtpRequestData (+3 more)
...
Cohesion: 0.21
Nodes (15): createHostelAdminBed(), createHostelAdminFloor(), createHostelAdminRoom(), findFloorInHostel(), findRoomInHostel(), normalizeObjectIds(), refreshCapacitySummary(), refreshRoomVacancyStatus() (+7 more)
...
Cohesion: 0.2
Nodes (12): ServiceProviderRegistrationPageContent(), FileUploader(), FileUploaderPresentation, FileUploaderProps, FileUploaderView(), TONE_CLASSES, UploaderTone, UploadedAsset (+4 more)
...
Cohesion: 0.29
Nodes (10): GET(), POST(), querySchema, RouteContext, commentOnPost(), listCommunityForModeration(), listPostComments(), namesByUserId() (+2 more)
...
Cohesion: 0.27
Nodes (12): AttendanceAlert, AttendanceLog, code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({), Community Feature (+4 more)
...
Cohesion: 0.4
Nodes (7): changePassword(), getCurrentUser(), POST(), getBearerToken(), verifyAccessToken(), GET(), changePasswordSchema
...
Cohesion: 0.36
Nodes (10): createCommunityAnnouncement(), createCommunityPost(), decoratePosts(), findModeratablePost(), hideCommunityPost(), PostMedia, resolveAdminHostelId(), resolveAuthorSpace() (+2 more)
...
Cohesion: 0.32
Nodes (8): code:typescript (interface INotice {), code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {), code:typescript ({), Complaint, ComplaintUpdate, Notice, Notices, Complaints
...
## Knowledge Gaps
- **2388 isolated node(s):** `AuthUser`, `ResidentSummary`, `ResidentFoodRoutine`, `ApiSuccess`, `ApiFailure` (+2383 more)
...
- **Why does `Role` connect `Community 15` to `Community 132`, `Community 133`, `Community 6`, `Community 9`, `Community 11`, `Community 141`, `Community 16`, `Community 17`, `Community 20`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 30`, `Community 33`, `Community 35`, `Community 163`, `Community 37`, `Community 38`, `Community 46`, `Community 47`, `Community 49`, `Community 50`, `Community 51`, `Community 55`, `Community 60`, `Community 188`, `Community 67`, `Community 68`, `Community 69`, `Community 70`, `Community 72`, `Community 212`, `Community 215`, `Community 232`, `Community 112`, `Community 245`, `Community 117`, `Community 122`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 1` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 10`, `Community 13`, `Community 142`, `Community 17`, `Community 18`, `Community 21`, `Community 26`, `Community 28`, `Community 36`, `Community 37`, `Community 42`, `Community 45`, `Community 50`, `Community 56`, `Community 59`, `Community 64`, `Community 75`, `Community 79`, `Community 82`, `Community 120`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `browserApi()` connect `Community 42` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 10`, `Community 13`, `Community 17`, `Community 21`, `Community 26`, `Community 28`, `Community 36`, `Community 43`, `Community 45`, `Community 50`, `Community 178`, `Community 56`, `Community 59`, `Community 64`, `Community 73`, `Community 79`, `Community 81`, `Community 93`, `Community 231`?**
