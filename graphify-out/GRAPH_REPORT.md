# Graph Report - hostel-management-software  (2026-08-24)

## Corpus Check
- 1548 files · ~2,507,083 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12196 nodes · 32879 edges · 431 communities (412 shown, 19 thin omitted)
...
1. `handleRouteError()` - 551 edges
2. `successResponse()` - 537 edges
3. `connectToDatabase()` - 363 edges
4. `useAppTheme()` - 267 edges
5. `cn()` - 238 edges
6. `connectToDatabase()` - 222 edges
7. `unwrap()` - 167 edges
8. `requireHostelCapability()` - 162 edges
9. `useResource()` - 157 edges
10. `Text()` - 138 edges
...
Cohesion: 0.02
Nodes (211): POST(), GET(), POST(), POST(), POST(), POST(), deleteResidentLocationHistory(), listAttendanceAlerts() (+203 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (223): RouteContext, POST(), POST(), GET(), GET(), POST(), getFoodRoutinesByHostelId(), listPublicFoodRoutine() (+215 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (185): Scanner(), FaqRow(), MethodCard(), GuardianInviteScreen(), Choice, Compass(), MapButton(), MapScreen() (+177 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (225): AssetViewer(), useViewerState(), ViewerBody(), ViewerPage(), ActivationIssue, addEmergencyContact(), addHostelPhoto(), addResidentGuardian() (+217 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (163): PATCH(), POST(), RouteContext, GET(), getResidentAttendance(), addComplaintUpdate(), auditComplaintAction(), confirmComplaintResolution() (+155 more)
...
Cohesion: 0.02
Nodes (114): AccountDeletionPanel, DeletionPathway, DeletionStatus, PATHWAY_COPY, Filter, ModeratedPost, ModerationPayload, DemoDataBadge() (+106 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (153): POST(), RouteContext, GET(), POST(), DELETE(), PATCH(), RouteContext, GET() (+145 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (141): GET(), POST(), GET(), listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), GET() (+133 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (135): AdminAlertsScreen(), ICONS, LABELS, Segment, TONES, AdminCommunityReportsScreen(), FILTERS, Pending (+127 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (110): Overview, AdminMoreScreen(), MANAGE_ROWS, PORTAL_ROWS, ActivateScreen(), BootGate(), RootShell(), CallableRow() (+102 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (130): NightStatusForm(), NightStatusScreen(), DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS, MealCard(), MonthEndSpecial() (+122 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (114): HostelAdminCommunityPageContent, EMPTY_SUMMARY, HostelAdminComplaintsPage, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS (+106 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (93): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel(), ConfirmOptions, useConfirm(), field() (+85 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (110): ReferralRow(), CheckoutStatusScreen(), ComplaintDetail(), ComplaintCard(), needsResident(), OPEN_STATUSES, rank(), NewComplaintScreen() (+102 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (91): PATCH(), POST(), RouteContext, ProviderDirectoryData, PATCH(), RouteContext, GET(), rejectPlatformHostel() (+83 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (96): SubmitClaimScreen(), InvoiceDetailScreen(), LedgerCard(), SummaryCard(), AmountCard(), methodIcon(), methodLabel(), PayInvoiceScreen() (+88 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (90): CommunityReportDialog(), REASONS, ModerationButton(), PagerButton(), normalize(), PortalSearch(), PortalTone, scoreEntry() (+82 more)

### Community 18 - "Community 18"
Cohesion: 0.08
Nodes (67): LoadState, CATEGORIES, isApplicationOpen(), MeResponse, OwnApplication, ProviderStatus, ServiceProviderRegistrationPageContent(), ServiceProviderRegistrationPageProps (+59 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (83): mocks, readable, selectable, mocks, proofBody, readAs(), readRequest(), base (+75 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (80): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), ApplyBlock(), ServiceProvidersScreen(), SosScreen(), BottomChrome (+72 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (100): InvoiceMatrix, InvoiceMatrixRow, PortalInvoice, ResidentFinanceView, ResidentInvoiceLine, ResidentInvoiceReceipt, ResidentPortalInvoice, ResidentRow (+92 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (90): RealtimeTopic, FetchMode, Resource, readApiError(), cellWidth(), clampedFontScale(), columnsThatFit(), PhoneSize (+82 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (86): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, dayKey(), overrideAttendance(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply() (+78 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (82): PRIORITIES, STATUS_ACTIONS, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel, AdminReferral, FILTERS (+74 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (79): AdminCommunityScreen(), FILTERS, NotificationCard(), NotificationsScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES (+71 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (77): CommunityScreen(), Composer(), AttachmentGallery(), CommunityBoard(), CommunityBoardProps, Composer(), SORTS, CommentThread() (+69 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (87): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeNotReused() (+79 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (67): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), QueryProvider() (+59 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (55): csvField(), deferLoad(), field(), Hostel, HostelTable(), Inquiry, numberField(), optionalField() (+47 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (57): AuthShell(), AuthShellProps, SiteWordmark(), metadata, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon() (+49 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (55): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, accessId, adminPrincipal, codes, guardianId (+47 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (65): POST(), PaginationQuery, PLATFORM_ROLES, deviceTokenSchema, notificationSchema, notificationCampaignSchema, input, mocks (+57 more)
...
Cohesion: 0.04
Nodes (52): GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse, GoogleAuthUser, GoogleCredentialResponse, Window, AuthExperiencePage(), dashboardHrefForRole() (+44 more)
...
Cohesion: 0.04
Nodes (56): GenericPortalScreen(), portalRows(), portalTitle(), CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS, CITY_OPTIONS (+48 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (54): POST(), RouteContext, listTrendingTags(), PaginationMeta, paginationQuerySchema, querySchema, auditListingFlagAction(), DuplicateCheckResultRecord (+46 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (49): HostelSuggestions(), inferKind(), LightboxItem, MediaLightbox(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS (+41 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (55): CapacityError, claimBedForRoomType(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary(), releaseBedForRoomType(), RoomConfiguration (+47 more)
...
Cohesion: 0.04
Nodes (52): summarizeResidentComplaints(), dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, getFoodRoutine(), isMonthEnd() (+44 more)
...
Cohesion: 0.06
Nodes (50): DeletionPanel(), NotificationSettings(), SETTINGS_TITLES, THEME_OPTIONS, DeletionRequest, DeletionStatus, getDeletionStatus(), requestAccountDeletion() (+42 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (38): CheckoutStatus, ResidentCheckoutPageContent, APP_METHODS, METHODS, PayInstructions, Rejection, ResidentClaimForm, WHERE_TO_LOOK (+30 more)
...
Cohesion: 0.05
Nodes (40): accountDeletionRequestSchema, attendanceLogSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, consentLogSchema, sessionSchema, AccountDeletionError (+32 more)
...
Cohesion: 0.06
Nodes (26): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminComplaintsPage(), redirectToWorkspaceScreen(), HostelAdminMaintenancePageContent() (+18 more)
...
Cohesion: 0.13
Nodes (29): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), verificationEmail(), guardianInvitationEmail(), cookPortalEnabledEmail(), hostelDocumentsRequestedEmail() (+21 more)

### Community 52 - "Community 52"
Cohesion: 0.06
Nodes (48): BALANCE_ALIASES, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, TXN_ID_ALIASES, WITHDRAWAL_ALIASES, AMOUNT_ALIASES (+40 more)

### Community 53 - "Community 53"
Cohesion: 0.07
Nodes (43): robots(), sitemap(), STATIC_ROUTES, listPublishedHostelSlugs(), renderIdCardPng(), siteUrl(), hostelPageViewSchema, userResidentProfileSchema (+35 more)

### Community 54 - "Community 54"
Cohesion: 0.06
Nodes (33): ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, attempt, fetchMock, forged, live (+25 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (39): cookPrincipal, mocks, cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError, FoodPhotoUploadInput, FoodReadyInput (+31 more)
...
Cohesion: 0.06
Nodes (41): Offset, PhotoCropper(), progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster(), UploadRow (+33 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (39): POST(), acceptGuardianInvitation(), daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput (+31 more)
...
Cohesion: 0.07
Nodes (31): demoteToPublicAccount(), GET(), RouteContext, POST(), RouteContext, POST(), RouteContext, addEmergencyContact() (+23 more)
...
Cohesion: 0.06
Nodes (37): classifyCredit(), LadderClaim, LadderInvoice, normalizeTxnId(), ANITA_CODE, claims, context(), invoice() (+29 more)
...
Cohesion: 0.08
Nodes (38): GET(), resolvePastedLink(), searchCandidates(), hostelAdminGeocodeQuerySchema, AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim(), buildAddressQuery() (+30 more)

### Community 67 - "Community 67"
Cohesion: 0.06
Nodes (36): MonthPicker, PeriodRow, FILTERS, Notification, NotificationRow(), RealtimeConfig, RealtimeContext, RealtimeContextValue (+28 more)

### Community 68 - "Community 68"
Cohesion: 0.06
Nodes (33): ComparePage(), hostels, metadata, rows, AuthGuard(), CurrentUser, MeResponse, PortalAccount() (+25 more)

### Community 69 - "Community 69"
Cohesion: 0.07
Nodes (30): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, HostelPhotoReminder(), navItems, canAccessWorkspace(), workspaceHostelName(), GUARDIAN_NAV, GUARDIAN_SEARCH_ENTRIES (+22 more)

### Community 70 - "Community 70"
Cohesion: 0.08
Nodes (41): directionFlags(), evidenceFlags(), payeeFlags(), AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance() (+33 more)

### Community 71 - "Community 71"
Cohesion: 0.09
Nodes (32): CSV_COLUMNS, GET(), POST(), safeEqual(), GET(), csvCell(), csvFilename(), csvResponse() (+24 more)

### Community 72 - "Community 72"
Cohesion: 0.06
Nodes (32): attachFiles(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput, ComplaintListQuery, ComplaintRecord, ComplaintReplyInput (+24 more)
...
Cohesion: 0.08
Nodes (31): GET(), POST(), revokeGuardianAccess(), DELETE(), PATCH(), auditNoticeAction(), createNotice(), serializeNotice() (+23 more)

### Community 75 - "Community 75"
Cohesion: 0.1
Nodes (36): hostelForm(), buildHostelPayload(), capacitySummary(), CITY_OPTIONS, emptyHostelForm(), emptyRoomRow(), FACILITY_OPTIONS, firstIncompleteHostelStep() (+28 more)

### Community 76 - "Community 76"
Cohesion: 0.06
Nodes (35): BANK_CSV_PARSER, ESEWA_CSV_PARSER, both, corrupted, debit, [first], FIXTURE, headerOnly (+27 more)
...
Cohesion: 0.08
Nodes (26): outstandingForResident(), bedSchema, depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, providedItemSchema, auditMoveAction(), createMoveInChecklist() (+18 more)

### Community 80 - "Community 80"
Cohesion: 0.06
Nodes (26): cityOptions, createDocument(), createRoom(), DocumentConfig, DraftData, FACILITY_MINI, facilityOptions, FIELD_KEY_STEP (+18 more)

### Community 81 - "Community 81"
Cohesion: 0.07
Nodes (26): inquirySchema, referralSchema, referralCodeSchema, referralRewardSchema, HostelAdminReferralListQuery, normalizeObjectIds(), referralCodeCandidate(), ReferralCodeRecord (+18 more)
...
Cohesion: 0.08
Nodes (25): CancelDeletionPageContent(), NEXT_STATUSES, OrdersPayload, OrderStatus, PlatformStoreOrdersPageContent, STATUS_TONE, StoreOrder, ViewAllLink() (+17 more)
...
Cohesion: 0.09
Nodes (20): HostelGeoRecord, sleep(), GoogleMap, HostelMap(), LeafletMap, TYPE_COLORS, fetchNearbyPlaces(), fetchNearbyWithGoogle() (+12 more)
...
Cohesion: 0.09
Nodes (29): uploadPublicFile(), refreshSession(), resetRoleHealForTests(), fetchMock, forbidden(), jsonResponse(), ok(), refreshSessionMock (+21 more)

### Community 89 - "Community 89"
Cohesion: 0.12
Nodes (29): CsvTable, gridFromCsv(), peekHeaders(), readCsv(), stripBom(), stripPreamble(), [first], FIXTURES (+21 more)
...
Cohesion: 0.08
Nodes (25): qrActivationSchema, residentSchema, ActivationCodeGenerateInput, ActivationCodeInput, activationSecret(), ActivationServiceError, ActivationStatus, ActivationStatusQuery (+17 more)

### Community 95 - "Community 95"
Cohesion: 0.06
Nodes (27): defaultDueDate(), DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), monthLabel(), toNumber() (+19 more)
...
Cohesion: 0.08
Nodes (19): LoadingRows(), TextArea(), field(), HostelAdminReferralsPageContent(), ListingFlag, LoadState, MaintenanceRequest, optionalField() (+11 more)

### Community 99 - "Community 99"
Cohesion: 0.1
Nodes (25): periodTotals(), assertHostelAccess(), canAccessHostel(), hostelScopedFilter(), TenantAccessError, TenantPrincipal, foodReadyLogSchema, MEAL_TYPES (+17 more)

### Community 100 - "Community 100"
Cohesion: 0.09
Nodes (22): appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind, creditOverpayment(), getCreditAmount(), getCreditBalance(), isDuplicateKey() (+14 more)
...
Cohesion: 0.13
Nodes (25): HostelPayeeIdentity, assertQrAssetUsable(), EMPTY, PaymentProfileView, ProfileDocument, readQrPayeeFields(), TEXT_FIELDS, toView() (+17 more)
...
Cohesion: 0.11
Nodes (26): FileUploadArea(), acceptAttribute(), EXTENSION_BY_MIME, FAMILY_BYTES, FAMILY_ORDER, familyOf(), joinTypes(), KIND_RULES (+18 more)

### Community 105 - "Community 105"
Cohesion: 0.1
Nodes (23): GatewayConfig, GatewayHealthStatus, HEALTH_STYLE, HostelAdminPaymentGatewaysPageContent, PROVIDER_COPY, SecretView, AvailableRoomType, ResidentEmergencyContact (+15 more)

### Community 106 - "Community 106"
Cohesion: 0.13
Nodes (23): UploadCard(), UploadToaster(), useIsUploading(), useUploads(), dismissUpload(), emit(), finishUpload(), listeners (+15 more)

### Community 107 - "Community 107"
Cohesion: 0.1
Nodes (23): enabledAt, esewa, khalti, profile, assertEnablable(), blockedReasonFor(), GATEWAY_REQUIREMENTS, GatewayConfigView (+15 more)
...
Cohesion: 0.09
Nodes (10): ComparePageSkeleton(), HostelDetailPageSkeleton(), HostelListingPageSkeleton(), InquiryPageSkeleton(), emptyFilters, Filters, metadata, PublicHostel (+2 more)
...
Cohesion: 0.09
Nodes (21): CreditClassification, MatchContext, statementImportSchema, StatementRow, importStatement(), loadStatementAsset(), periodOf(), readStatementBytes() (+13 more)
...
Cohesion: 0.15
Nodes (21): ReviewForm(), ReviewScreen(), ResidentSummary, ResidentReview, submitResidentReview(), canReview(), emptyReviewDraft(), hasReviewErrors() (+13 more)
...
Cohesion: 0.12
Nodes (22): hashUserAgent(), HostelRef, newVisitorKey(), recordHostelPageView(), resolveVisitorKey(), getPresignedReadUrl(), DELETE(), GET() (+14 more)
...
Cohesion: 0.14
Nodes (19): ApiFailure, EXTENSION_MIME, PickedFile, resolveFileName(), resolveMimeType(), name, formatMegabytes(), PUBLIC_UPLOAD_TYPES (+11 more)

### Community 125 - "Community 125"
Cohesion: 0.14
Nodes (21): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, GATEWAY_ORDER, getPayInstructions() (+13 more)
...
Cohesion: 0.14
Nodes (18): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), prepare(), distance, ImageVariantRecord (+10 more)
...
Cohesion: 0.13
Nodes (19): digitsOnly(), extractPayee(), matchesIdentity(), NAME_STOPWORDS, nameTokens(), PayeeRead, payeeRefusal(), PayeeVerdict (+11 more)
...
Cohesion: 0.16
Nodes (17): systemDocumentKind(), systemDocumentKindFromText(), drawCertificationStamp(), footerLine(), formatDate(), formatLongDate(), MONTHS, ReceiptPdfInput (+9 more)

### Community 158 - "Community 158"
Cohesion: 0.2
Nodes (16): r2Configured(), storePublicAsset(), AccessLevel, bucketForAccessLevel(), deleteFromR2(), generateFileKey(), getPresignedUploadUrl(), getR2Client() (+8 more)
...
Cohesion: 0.1
Nodes (20): 0. Read before touching anything, A. Delivery promise — "order by 10 AM → today 4 PM, after 4 PM → tomorrow by 7 AM" (user item 6), B. Every product needs a photograph (user item 3), C1 — the button must stay "added", C2 — replace the toast with a server-sent push notification, C. Add to cart — persistent button state, and a notification carrying the image (user item 1), code:block1 (const reservedBottom = insideTabs), D0 — the checkout button is drawn *underneath the tab bar* — fix this first (+12 more)
...
Cohesion: 0.15
Nodes (14): activateResident(), getResidentProfile(), triggerSOS(), RootStackParamList, Props, ResidentActivationScreen(), styles, Profile (+6 more)
...
Cohesion: 0.14
Nodes (13): hasProvider(), IntentRow, recheckClosedAttempts(), SettlementReconSummary, findingSchema, reconciliationRunSchema, normalizeFindings(), RunFinding (+5 more)
...
Cohesion: 0.17
Nodes (14): DELETE(), POST(), createPlatformNotificationCampaign(), revokeDeviceToken(), saveDeviceToken(), campaignBaseSchema, deviceTokenRevokeSchema, deviceTokenSaveSchema (+6 more)
...
Cohesion: 0.14
Nodes (15): apiRequest(), getActivationStatus(), listNotifications(), listResidentNotices(), markNoticeAsRead(), markNotificationRead(), NotificationItem, refreshSession() (+7 more)
...
Cohesion: 0.14
Nodes (15): 0.1 The shared Softmato domain, 0.2 Categories — which mailbox a message comes from, 0.2a Where replies go, 0.3 Where the sender is configured, 0.4 Template structure, 0. Sending Infrastructure, 1.1 Email Verification (PUBLIC Signup), code:block1 (softmato.com) (+7 more)
...
Cohesion: 0.23
Nodes (7): paymentClearedEmail(), paymentDueReminderEmail(), paymentOverdueEmail(), paymentRejectedEmail(), paymentProofReceivedEmail(), paymentProofUploadedEmail(), monthName()
...
Cohesion: 0.17
Nodes (12): 1.4 Resident QR Activation, 1.7 Account Upgraded, 2.3 Hostel Rejected, 3.2 Payment Overdue, 3.5 Payment Rejected (to Resident), 4.3 Complaint Resolved, code:typescript ({), code:typescript ({) (+4 more)
...
Cohesion: 0.22
Nodes (7): AuthSession, login(), AppNavigator(), Stack, LoginScreen(), Props, ResidentReviewsScreen()
...
Cohesion: 0.22
Nodes (8): GatewayHealth, GatewayHealthSummary, getGatewayHealth(), IntentCounts, plural(), recordHealth(), SEVERITY, verdict()
...
Cohesion: 0.33
Nodes (7): 3.1 Payment Due Reminder, 3.4 Payment Verified (to Resident), 3. Payment Emails, 4.2 Complaint Status Updated, code:typescript ({), code:typescript ({), code:typescript ({)
...
Cohesion: 0.33
Nodes (6): 8. Monitoring & Logging, code:json ({ "level": "warn", "action": "public_asset_store_failed", "m), code:json ({ "level": "warn", "action": "public_asset_store_failed", "m), code:json ({), code:typescript (// app/api/cron/payment-reminders/route.ts), Deployment Steps
...
Cohesion: 0.5
Nodes (4): 4. Local Setup, 5. Commands, code:bash (node --experimental-transform-types packages/db/src/migrate-), First-time setup
...
## Knowledge Gaps
- **4369 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+4364 more)
...
- **Why does `Button()` connect `Community 20` to `Community 2`, `Community 3`, `Community 6`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 16`, `Community 17`, `Community 22`, `Community 29`, `Community 30`, `Community 33`, `Community 43`, `Community 44`, `Community 66`, `Community 67`, `Community 75`, `Community 120`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 95` to `Community 0`, `Community 3`, `Community 5`, `Community 267`, `Community 12`, `Community 13`, `Community 141`, `Community 16`, `Community 21`, `Community 150`, `Community 24`, `Community 25`, `Community 27`, `Community 29`, `Community 42`, `Community 43`, `Community 45`, `Community 52`, `Community 54`, `Community 57`, `Community 66`, `Community 68`, `Community 75`, `Community 80`, `Community 218`, `Community 104`, `Community 125`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 17` to `Community 3`, `Community 6`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 14`, `Community 18`, `Community 20`, `Community 24`, `Community 25`, `Community 28`, `Community 29`, `Community 30`, `Community 35`, `Community 36`, `Community 38`, `Community 44`, `Community 57`, `Community 63`, `Community 64`, `Community 65`, `Community 67`, `Community 68`, `Community 73`, `Community 80`, `Community 83`, `Community 91`, `Community 220`, `Community 104`, `Community 113`, `Community 121`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Are the 358 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 358 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `{ defineConfig }`, `expoConfig`, `path` to the rest of the system?**
  _4369 weakly-connected nodes found - possible documentation gaps or missing edges._
