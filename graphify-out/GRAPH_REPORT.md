...
## Corpus Check
- 1553 files · ~2,515,638 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12244 nodes · 33027 edges · 461 communities (438 shown, 23 thin omitted)
...
1. `handleRouteError()` - 553 edges
2. `successResponse()` - 539 edges
3. `connectToDatabase()` - 364 edges
4. `useAppTheme()` - 268 edges
5. `cn()` - 238 edges
6. `connectToDatabase()` - 222 edges
7. `unwrap()` - 168 edges
8. `requireHostelCapability()` - 162 edges
...
## Communities (461 total, 23 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (218): GuardianInviteScreen(), Choice, Compass(), MapButton(), MapScreen(), ModeTab(), NOTHING_CHOSEN, PreviewCard() (+210 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (231): POST(), POST(), GET(), sendEmail(), GET(), POST(), getFoodRoutinesByHostelId(), listPublicFoodRoutine() (+223 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (175): GET(), POST(), GET(), POST(), PATCH(), POST(), RouteContext, GET() (+167 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (213): useRealtime(), ActivationIssue, addEmergencyContact(), addHostelPhoto(), addInquiryNote(), addResidentGuardian(), approveMatchedStatement(), assignOrphanPayment() (+205 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (174): AdminAlertsScreen(), ICONS, LABELS, Segment, TONES, AdminCommunityScreen(), AdminCommunityReportsScreen(), FILTERS (+166 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (167): GET(), AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+159 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (114): CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload, DemoDataBadge(), UserRecord, GuardianDashboard, FeeSchedule (+106 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (158): DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS, MealCard(), MonthEndSpecial(), RoutineMeal, Footer() (+150 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (114): AdminMoreScreen(), ActivateScreen(), Scanner(), BootGate(), RootShell(), ApplyBlock(), ServiceProvidersScreen(), SettingsScreen() (+106 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (87): MANAGE_ROWS, PORTAL_ROWS, Person, needsResident(), OPEN_STATUSES, rank(), GuardianNotShared(), GuardianWardCard() (+79 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (119): NightStatusForm(), NotificationCard(), ProfileScreen(), CheckoutStatusScreen(), SubmitClaimScreen(), InvoiceDetailScreen(), LedgerCard(), SummaryCard() (+111 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (132): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES (+124 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (113): Notification, AttendanceCalendar(), HostelAdminAttendancePageContent, HostelAdminCommunityPageContent, HostelAdminComplaintsPage, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings (+105 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (89): AccountDeletionPanel, DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton() (+81 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (93): CommunityReportDialog(), REASONS, inferKind(), LightboxItem, MediaLightbox(), ModerationButton(), PagerButton(), normalize() (+85 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (85): GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, CITY_OPTIONS (+77 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (80): MonthPicker, PeriodRow, Ledger, OrphanAssignPicker, MatrixRow, MatrixTotals, PeriodSummary, ClaimFacts() (+72 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (81): GET(), GET(), GET(), POST(), RouteContext, accessId, adminPrincipal, codes (+73 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (71): csvField(), deferLoad(), field(), Hostel, HostelTable(), Inquiry, LoadState, Message() (+63 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (92): POST(), demoteToPublicAccount(), GET(), POST(), bulkApproveSchema, POST(), GET(), RouteContext (+84 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (85): GET(), POST(), querySchema, RouteContext, AnnouncementInput, CommentCreateInput, commentOnPost(), CommentRecord (+77 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (86): Offset, PhotoCropper(), FileUploadArea(), progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster() (+78 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (78): notifyPostReaction(), DELETE(), POST(), PaginationMeta, paginationQuerySchema, querySchema, auditListingFlagAction(), DuplicateCheckResultRecord (+70 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (78): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, BillableResidentRow, BilledInvoice (+70 more)

### Community 24 - "Community 24"
Cohesion: 0.06
Nodes (74): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus(), OPEN_STATUSES (+66 more)

### Community 25 - "Community 25"
Cohesion: 0.06
Nodes (66): CommunityScreen(), Composer(), CommunityBoard(), CommunityBoardProps, Composer(), SORTS, CommentThread(), CommunityPostCard() (+58 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (62): FINANCE_ERROR_STATUS, FinanceErrorCode, ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, attempt, fetchMock (+54 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (52): PATCH(), RouteContext, listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), POST(), RouteContext (+44 more)

### Community 28 - "Community 28"
Cohesion: 0.12
Nodes (49): accountDeletionCancelledEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), guardianInvitationEmail(), sosAlertEmail(), cookPortalEnabledEmail() (+41 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (59): AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel, HostelAdminReportsPageContent, Overview, Report, REPORT_EXPORTS (+51 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (68): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult (+60 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (68): HostelPayeeIdentity, FinanceServiceError, GATEWAY_ORDER, getPayInstructions(), InvoiceRecord, methodsFrom(), PayInstructions, PayMethod (+60 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (62): IdCardFace(), initialsOf(), Portrait(), BLOOD_OPTIONS, DIET_OPTIONS, EditIdentityScreen(), GENDER_OPTIONS, ID_TYPE_OPTIONS (+54 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (68): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), AssetViewer(), useViewerState() (+60 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (42): ComparePage(), hostels, metadata, rows, AuthExperiencePage(), CurrentUser, DASHBOARD_ROLES, dashboardHrefForRole() (+34 more)
...
Cohesion: 0.06
Nodes (61): AdminResidentsScreen(), NightStatusScreen(), ReferralsScreen(), SosScreen(), SORTS, StoreCategoryScreen(), CommunityPostScreen(), ComplaintsScreen() (+53 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (48): AuthShell(), AuthShellProps, SiteWordmark(), GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse, GoogleAuthUser, GoogleCredentialResponse (+40 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (53): financeIntegrityHash(), appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind, creditOverpayment(), getCreditAmount(), getCreditBalance() (+45 more)
...
Cohesion: 0.05
Nodes (53): POST(), GET(), POST(), checkoutSchema, POST(), createPaymentIntent(), acceptGuardianInvitation(), daysFromNow() (+45 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (44): AuthGuard(), fadeUp, Feature, featureChrome, features, heroSlides, PublicHostelRegistrationLandingPage(), stagger (+36 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (43): HostelSuggestions(), checkOnly(), EMPTY_PREFILL, ENVIRONMENT_OPTIONS, IdentityResponse, Prefill, Step, TalkToExpertButton() (+35 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (50): addComplaintUpdate(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput, ComplaintListQuery (+42 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (51): POST(), RouteContext, listTrendingTags(), POST(), safeEqual(), sponsorSchema, ClickRecord, dayKey() (+43 more)
...
Cohesion: 0.05
Nodes (48): addHistory(), addMaintenanceComment(), assertBedInHostel(), assertProviderApproved(), assertRoomInHostel(), auditMaintenanceAction(), BedRecord, createMaintenanceRequest() (+40 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (42): HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminRoomsPageContent(), PlatformDashboardPageContent(), PlatformHostelReviewPageContent(), PlatformUsersPageContent(), DashboardCard(), DashboardCardProps (+34 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (43): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, HostelPhotoReminder(), PortalShell(), navItems, navItems, FALLBACK_ORDER, hasNoHostelPhotos() (+35 more)

### Community 49 - "Community 49"
Cohesion: 0.06
Nodes (45): FILTERS, NotificationsScreen(), DeletionPanel(), NotificationSettings(), SETTINGS_TITLES, THEME_OPTIONS, palette, DeletionRequest (+37 more)

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (38): bedSchema, depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, providedItemSchema, roomSchema, auditMoveAction(), createMoveInChecklist() (+30 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (42): cookPrincipal, mocks, cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError, FoodPhotoUploadInput, FoodReadyInput (+34 more)

### Community 52 - "Community 52"
Cohesion: 0.06
Nodes (45): CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing, buildIdCardData() (+37 more)
...
Cohesion: 0.06
Nodes (41): serviceProviderApplicationSchema, serviceProviderDocumentSchema, REALTIME_TOPIC, hostelId, mocks, providerId, notifyPlatformOfServiceProviderApplication(), ACTIVE_APPLICATION_STATUSES (+33 more)

### Community 56 - "Community 56"
Cohesion: 0.06
Nodes (47): paymentSchema, arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal (+39 more)

### Community 57 - "Community 57"
Cohesion: 0.07
Nodes (41): POST(), addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange(), definedUpdate(), FoodFeedbackInput, FoodFeedbackRecord (+33 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (23): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminPaymentsPage(), redirectToWorkspaceScreen(), HostelAdminReferralsPageContent() (+15 more)

### Community 59 - "Community 59"
Cohesion: 0.07
Nodes (41): AttachmentGallery(), ComplaintDetail(), ComplaintDetailScreen(), ComplaintCard(), NewComplaintScreen(), PickedAttachment, ACTOR_LABELS, Complaint (+33 more)

### Community 60 - "Community 60"
Cohesion: 0.06
Nodes (44): GET(), POST(), mocks, allocateOrderNumber(), applyStatus(), CancelInput, CreateInput, hostelNames() (+36 more)
...
Cohesion: 0.07
Nodes (37): PATCH(), RouteContext, referralCodeSchema, GET(), auditReferralAction(), confirmReferralJoined(), createReferredInquiry(), getResidentReferral() (+29 more)
...
Cohesion: 0.08
Nodes (43): directionFlags(), evidenceFlags(), payeeFlags(), AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance() (+35 more)

### Community 65 - "Community 65"
Cohesion: 0.07
Nodes (37): LedgerScope, getHostelViewStats(), foodFeedbackSchema, listingFlagSchema, paymentProofSchema, referralRewardSchema, averageResolutionDays(), bucketBoundaries() (+29 more)

### Community 66 - "Community 66"
Cohesion: 0.08
Nodes (36): qrActivationSchema, activateResident(), ActivationCodeGenerateInput, ActivationCodeInput, activationSecret(), ActivationServiceError, ActivationStatus, ActivationStatusQuery (+28 more)
...
Cohesion: 0.12
Nodes (31): POST(), RouteContext, computePerceptualHash(), systemDocumentKind(), r2Configured(), storePublicAsset(), AccessLevel, bucketForAccessLevel() (+23 more)
...
Cohesion: 0.11
Nodes (18): PlatformConfigAnnouncementsPageContent, PlatformConfigFacilitiesPageContent, FLAGS, PlatformConfigFeaturesPageContent, PlatformConfigLegalPageContent, PlatformConfigLocationsPageContent, PlatformConfigPricingPageContent, ConfigCard() (+10 more)
...
Cohesion: 0.06
Nodes (24): adminPrincipal, mocks, PLATFORM_LIMITS, mocks, readable, selectable, profileMocks, staffPrincipal (+16 more)

### Community 74 - "Community 74"
Cohesion: 0.09
Nodes (25): ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails(), RenderedSection, LegalBody() (+17 more)
...
Cohesion: 0.09
Nodes (30): appBaseUrl(), CLAIMABLE_STATUSES, dispatchOtpChallenge(), dispatchVerificationEmail(), findVerifiedRegistrationChallenge(), generateOtpCode(), GOOGLE_JWKS, hashOtpCode() (+22 more)

### Community 77 - "Community 77"
Cohesion: 0.08
Nodes (34): collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor() (+26 more)
...
Cohesion: 0.1
Nodes (26): AuthServiceError, resendVerificationEmail(), resetPasswordWithToken(), revokeAllSessions(), signupWithEmailVerification(), verifyEmailWithToken(), POST(), POST() (+18 more)
...
Cohesion: 0.07
Nodes (24): currency(), Input(), StatusBadge(), TextArea(), ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent (+16 more)

### Community 86 - "Community 86"
Cohesion: 0.1
Nodes (30): CITY_OPTIONS, FACILITY_OPTIONS, hasHostelErrors(), hasUsableRooms(), HOSTEL_PLANS, HOSTEL_STEPS, HOSTEL_TYPES, HostelAttachment (+22 more)
...
Cohesion: 0.13
Nodes (26): CSV_COLUMNS, GET(), GET(), periodTotals(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS (+18 more)
...
Cohesion: 0.08
Nodes (19): Panel(), Select(), field(), HostelAdminMaintenancePageContent(), ListingFlag, LoadState, MaintenanceRequest, optionalField() (+11 more)

### Community 93 - "Community 93"
Cohesion: 0.09
Nodes (23): attacker, attempt(), headers, jsonRequest(), routeMocks, verifyOtpChallenge(), GoogleAuthInput, googleAuthSchema (+15 more)

### Community 94 - "Community 94"
Cohesion: 0.1
Nodes (22): feeUpdateSchema, PATCH(), SetResidentFeeInput, setResidentMonthlyFee(), POST(), GET(), generateMonthlyPayments(), getMonthlyPaymentMatrix() (+14 more)
...
Cohesion: 0.08
Nodes (26): dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, getFoodRoutine(), isMonthEnd(), mealsOn() (+18 more)
...
Cohesion: 0.08
Nodes (23): PlatformConfigContentPageContent, announcementSchema, contentHighlightSchema, ContentPage, contentPageSchema, ContentSection, contentSectionSchema, emailSchema (+15 more)

### Community 99 - "Community 99"
Cohesion: 0.13
Nodes (24): POST(), RealtimeConfig, RealtimeContext, RealtimeContextValue, RealtimeNotification, RealtimeProvider(), useRealtime(), canSubscribeToChannel() (+16 more)

### Community 100 - "Community 100"
Cohesion: 0.08
Nodes (17): accountDeletionRequestSchema, attendanceLogSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, consentLogSchema, deviceTokenSchema, questionCallClickSchema (+9 more)
...
Cohesion: 0.1
Nodes (17): EMPTY_DRAFT, HostelAdminPaymentProfilePageContent, PaymentProfile, SECTION_FIELDS, SectionId, BankMark(), EsewaMark(), KhaltiMark() (+9 more)
...
Cohesion: 0.13
Nodes (22): UploadCard(), dismissUpload(), emit(), finishUpload(), isUploadActive(), listeners, pruneUploads(), resetUploadQueue() (+14 more)

### Community 113 - "Community 113"
Cohesion: 0.13
Nodes (19): EMPTY_TALLY, floorToStep(), phaseOf(), shouldRepost(), tallyUploads(), active, done, next (+11 more)

### Community 114 - "Community 114"
Cohesion: 0.14
Nodes (18): isAuthBypassEnabled(), original, dashboardHrefForRole(), destinationForRole(), isAllowedNextPath(), isHostelWorkspacePath(), isSafeLocalPath(), landingPathForRole() (+10 more)
...
Cohesion: 0.33
Nodes (14): POST(), authenticateWithGoogle(), POST(), loginGuardian(), accessTokenTtlSeconds(), parseDurationSeconds(), refreshTokenTtlSeconds(), isMobileAuthClient() (+6 more)
...
Cohesion: 0.15
Nodes (17): FALLBACK, SiteConfigContext, SiteConfigProvider(), useFeatureFlag(), platformSettingSchema, DEFAULT_SITE_CONFIG, coerceSection(), getPublicSiteConfig() (+9 more)

### Community 119 - "Community 119"
Cohesion: 0.1
Nodes (15): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, ComplaintRecord, firstPerResident(), hostelNameMap(), listPlatformDirectory() (+7 more)
...
Cohesion: 0.14
Nodes (18): ApiFailure, EXTENSION_MIME, PickedFile, resolveFileName(), resolveMimeType(), name, formatMegabytes(), PUBLIC_UPLOAD_TYPES (+10 more)
...
Cohesion: 0.15
Nodes (19): readQrPayeeFields(), cleanAccountNumber(), cleanName(), hasQrPayee(), looksLikeName(), normalizeDigits(), QrPayeeRead, readQrPayee() (+11 more)
...
Cohesion: 0.17
Nodes (20): Guidance, GuidanceStatus, cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath(), hasArrived() (+12 more)

### Community 144 - "Community 144"
Cohesion: 0.13
Nodes (19): documents, hostelForm(), many, parsed, result, buildHostelPayload(), capacitySummary(), emptyHostelForm() (+11 more)
...
Cohesion: 0.1
Nodes (19): InvoiceMatrix, InvoiceMatrixRow, PortalInvoice, ResidentFinanceView, ResidentInvoiceLine, ResidentInvoiceReceipt, ResidentPortalInvoice, ResidentRow (+11 more)
...
Cohesion: 0.15
Nodes (19): LEGACY_ROLE_MAP, Role, ROLE_VALUES, cardPhotoImageUrl(), clearResidentIdentityPhoto(), generateResidentId(), isCardPhotoImage(), mintResidentId() (+11 more)
...
Cohesion: 0.18
Nodes (17): IdCardData, IdCardFace, PlatformIdCardType, CardImages, renderIdCardPng(), BASE, PNG_MAGIC, types (+9 more)
...
Cohesion: 0.14
Nodes (15): activateResident(), login(), ResidentReferral, ResidentReferralCode, triggerSOS(), RootStackParamList, LoginScreen(), Props (+7 more)
...
Cohesion: 0.11
Nodes (15): defaultDueDate(), DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), monthLabel(), PreviewColumn() (+7 more)

### Community 173 - "Community 173"
Cohesion: 0.18
Nodes (17): cancelOrder(), getOrder(), notifyHostelOfOrderStatus(), serializeOrder(), updateOrderStatus(), writeAudit(), canBuyerCancelStoreOrder(), canTransitionStoreOrder() (+9 more)
...
Cohesion: 0.13
Nodes (13): getResidentLedger(), monthsBetween(), periodOf(), ResidentDoc, ResidentLedger, ResidentLedgerMonth, ResidentLedgerPayment, billed (+5 more)
...
Cohesion: 0.18
Nodes (15): ReferralBody(), ReferralRow(), ReferralStatus, ReferralSummary, buildReferralShare(), describeRewards(), referralAppLink(), referralShareUrl() (+7 more)
...
Cohesion: 0.12
Nodes (11): ADMIN_ISSUABLE_ROLES, AdminIssuableRole, generateTemporaryPassword(), HIGH_PRIVILEGE_ROLES, loginUrl(), RegisterOrUpgradeInput, ROLE_LABELS, existing (+3 more)
...
Cohesion: 0.17
Nodes (12): CONTENT_ICON_SLUGS, CONTENT_ICONS, contentIcon(), fillPlaceholders(), IoniconName, ResolvedContentPage, SiteIdentity, everything (+4 more)
...
Cohesion: 0.15
Nodes (15): 2.2 Hostel Approved, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, 4.3 Complaint Resolved, code:typescript ({) (+7 more)
...
Cohesion: 0.15
Nodes (13): apiRequest(), getActivationStatus(), getResidentReferral(), listResidentNotices(), markNoticeAsRead(), refreshSession(), register(), ResidentNotice (+5 more)
...
Cohesion: 0.18
Nodes (10): POST(), verifyPurposeToken(), cancelAccountDeletionByToken(), hostelId, input, leanResult(), mocks, recipients (+2 more)
...
Cohesion: 0.19
Nodes (11): hasLocationPermission(), hasPromptedForLocation(), LocationOutcome, NavigationFix, readPosition(), rememberLocationPrompt(), requestDeviceLocation(), toCoordinates() (+3 more)
...
Cohesion: 0.24
Nodes (10): buildShell(), MapExplorer, MapExplorerProps, MapHandle, MapMarker, Coordinates, inlineJson(), MAP_LAYERS (+2 more)
...
Cohesion: 0.23
Nodes (6): hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKindFromText(), distance, SystemDocumentKind, base
...
Cohesion: 0.31
Nodes (9): cellWidth(), clampedFontScale(), columnsThatFit(), PhoneSize, phoneSizeFor(), scaledHeight(), cell, HANDSET_WIDTHS (+1 more)
...
Cohesion: 0.36
Nodes (7): count(), describeFanout(), SosFanoutTone, sosMessagePayload(), fanout(), outcome, validateSosMessage()
...
Cohesion: 0.33
Nodes (7): 2.1 Hostel Submission Received, 2.3 Hostel Rejected, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, 3.3 Payment Proof Uploaded (to Admin), code:typescript ({), code:typescript ({)

### Community 345 - "Community 345"
Cohesion: 0.29
Nodes (7): 4. Local Setup, 5. Commands, 8. Monitoring & Logging, code:json ({ "level": "warn", "action": "public_asset_store_failed", "m), code:bash (node --experimental-transform-types packages/db/src/migrate-), code:json ({ "level": "warn", "action": "public_asset_store_failed", "m), First-time setup
...
## Knowledge Gaps
- **4377 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+4372 more)
...
- **Why does `Button()` connect `Community 8` to `Community 0`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 141`, `Community 13`, `Community 14`, `Community 16`, `Community 18`, `Community 32`, `Community 36`, `Community 49`, `Community 59`, `Community 74`, `Community 86`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 14` to `Community 0`, `Community 4`, `Community 261`, `Community 6`, `Community 8`, `Community 9`, `Community 12`, `Community 13`, `Community 15`, `Community 16`, `Community 18`, `Community 21`, `Community 25`, `Community 29`, `Community 34`, `Community 37`, `Community 39`, `Community 41`, `Community 42`, `Community 47`, `Community 48`, `Community 52`, `Community 71`, `Community 72`, `Community 85`, `Community 88`, `Community 92`, `Community 228`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 172` to `Community 3`, `Community 4`, `Community 133`, `Community 10`, `Community 11`, `Community 13`, `Community 144`, `Community 17`, `Community 18`, `Community 16`, `Community 148`, `Community 21`, `Community 23`, `Community 281`, `Community 26`, `Community 28`, `Community 33`, `Community 41`, `Community 42`, `Community 45`, `Community 49`, `Community 52`, `Community 65`, `Community 68`, `Community 76`, `Community 82`, `Community 91`, `Community 240`, `Community 116`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Are the 359 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 359 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `{ defineConfig }`, `expoConfig`, `path` to the rest of the system?**
  _4377 weakly-connected nodes found - possible documentation gaps or missing edges._
