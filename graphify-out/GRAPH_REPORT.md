...
## Corpus Check
- 2370 files · ~5,146,154 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21370 nodes · 60392 edges · 590 communities (557 shown, 33 thin omitted)
...
## Communities (590 total, 33 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.0
Nodes (485): 978(), [A,P], abort(), {actionStateRoute:v,navigationState:P}, activate(), activeThemeId(), Ad(), {addKeyedListener:i} (+477 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (332): loadOverview(), loadMoney(), loadToday(), AdminRollCallCard(), NightStatusPromptCard(), FinanceData, loadFinance(), AdminInvoiceMatrix (+324 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (219): PATCH(), POST(), RouteContext, GET(), POST(), POST(), POST(), POST() (+211 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (274): runPlanDueReminders(), auditFinanceAction(), FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), BY_OCCUPANCY, EXACT, normalizeBedType() (+266 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (267): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, assertPlanRoom(), countLive(), notifyLimitReached(), NOUN (+259 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (250): PATCH(), RouteContext, POST(), fileFieldCash(), getOrCreateSubscription(), selectPlan(), startPlanPeriod(), POST() (+242 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (198): FILTERS, Pending, MoneyData, BootGate(), PickedAttachment, AdminHomeHeader(), FLAGGED, ReportedPostCard() (+190 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (184): MANAGE_ROWS, PORTAL_ROWS, AdminResidentsScreen(), TodayData, Person, ProfileScreen(), ReferralRow(), SETTINGS_TITLES (+176 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (170): FieldCashRow, PlanPaymentClaim, formatBsAdDate(), deferLoad(), DemoDataBadge(), Hostel, HostelTable(), LoadState (+162 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (229): deleteResidentLocationHistory(), getResidentAttendance(), listAttendanceAlerts(), authorUserId, mocks, postId, residentId, residentPrincipal (+221 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (189): Choice, Compass(), MapButton(), ModeTab(), NOTHING_CHOSEN, PreviewCard(), ResultRow(), RouteCard() (+181 more)

### Community 11 - "Community 11"
Cohesion: 0.01
Nodes (81): add(), addChangeListener(), addEventListener(), addListenerForTag(), assert(), bubbles(), cancelable(), cancelBubble() (+73 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (212): AdminCommunityReportsScreen(), AdminMoreScreen(), ActivateScreen(), Scanner(), CookInviteScreen(), GuardianInviteScreen(), MapScreen(), NightStatusHistoryScreen() (+204 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (184): generateMetadata(), chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout() (+176 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (202): MESSAGES, POST(), RouteContext, serializeAuditLog(), announceConfirmed(), announceEnding(), assertAwaitingAnswer(), cancelBookingByHostel() (+194 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (176): AdminTabs(), HIDDEN, RoleLayout(), TABS, FILTERS, invalidateFeeds(), NIGHT_ANSWER_LABELS, nightAnswerText() (+168 more)

### Community 16 - "Community 16"
Cohesion: 0.01
Nodes (140): LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminMoveChecklistPage() (+132 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (118): number(), toNumber(), statusCodeOf(), toNumber(), _(), 276(), 601(), a() (+110 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (174): AttendanceScreen(), DayRow(), ReviewForm(), ReviewScreen(), NotificationSettings(), DAY_LABELS, DayStrip(), FoodRoutineWeek() (+166 more)
...
Cohesion: 0.02
Nodes (150): AuthShellProps, PANEL_COPY, SiteWordmark(), BubbleBackground(), BubbleBackgroundProps, BubbleColors, BrandMark(), BrandWordmark() (+142 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (124): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, CITY_OPTIONS, FACILITY_STATS (+116 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (14): cancelEvent(), __destroy_into_raw(), forceInvalidate(), free(), __getChildren(), maybeCompleteAuthSession(), notifyPendingGestures(), onStateChange() (+6 more)

### Community 23 - "Community 23"
Cohesion: 0.02
Nodes (144): Platform, EMPTY_SUMMARY, ConcessionBackfill, describeApplied(), FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, MonthDiscounts (+136 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (129): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), ATTACHED, dueWhen() (+121 more)

### Community 25 - "Community 25"
Cohesion: 0.02
Nodes (149): EMPTY_PAYOUT_DRAFT, METHODS, PayoutAccountDraft, PayoutAccountFields(), payoutAccountPayload(), DescriptionFacts, DescriptionSuggestions(), HostelType (+141 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (139): aa(), af(), ai(), Al(), array(), ba(), bc(), bi() (+131 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (144): checkoutDocumentFor(), softmatoDocumentNumbers(), gateway, invoice, updateOne, documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument() (+136 more)

### Community 28 - "Community 28"
Cohesion: 0.02
Nodes (150): demoteToPublicAccount(), LIVE_ACCESS, releaseGuardianAccounts(), daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess(), GuardianAccessRecord, GuardianInvitationAcceptInput (+142 more)

### Community 29 - "Community 29"
Cohesion: 0.02
Nodes (30): Render the pamphlet.  One master per side: A4 + 3 mm bleed at 600 dpi. The A4, shoot(), 594(), build(), componentWillUnmount(), createInteractionHandle(), defineProperty(), duration() (+22 more)

### Community 30 - "Community 30"
Cohesion: 0.02
Nodes (125): AdminCommunityScreen(), openStore(), Overview, HOSTEL, MONTHS, UiPreview(), ACTION_TONES, CARD_PAD (+117 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (107): RouteContext, GET(), POST(), GET(), GET(), POST(), DELETE(), RouteContext (+99 more)

### Community 32 - "Community 32"
Cohesion: 0.02
Nodes (129): bsPeriodsBetween(), getHostelLedger(), collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident() (+121 more)

### Community 33 - "Community 33"
Cohesion: 0.02
Nodes (106): StarLayer(), StarLayerProps, StarsBackground(), StarsBackgroundProps, metadata, AccountDeletionPanel, ContentHeader(), ContentIntro() (+98 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (133): BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan, BillingSkip (+125 more)

### Community 35 - "Community 35"
Cohesion: 0.02
Nodes (105): POST(), authorUserId, leanResult(), mocks, postId, reactorUserId, residentIn(), mocks (+97 more)
...
Cohesion: 0.02
Nodes (11): 42(), computeBlankness(), Eo(), __getNativeAnimationConfig(), hex(), hexa(), n, percentString() (+3 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (115): GET(), hashUserAgent(), HostelRef, newVisitorKey(), recordHostelPageView(), resolveVisitorKey(), decodeKey(), decryptPersonalData() (+107 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (118): PaginationMeta, PaginationQuery, querySchema, platformSettingSchema, storeCartSchema, storeCategorySchema, storeProductSchema, AddInput (+110 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (98): PRIORITIES, STATUS_ACTIONS, Campaign, Resident, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel (+90 more)

### Community 41 - "Community 41"
Cohesion: 0.02
Nodes (81): ComparePage(), generateMetadata(), hostels, metadata, rows, AuthExperiencePage(), csvField(), field() (+73 more)

### Community 42 - "Community 42"
Cohesion: 0.03
Nodes (77): PATCH(), RouteContext, POST(), RouteContext, PATCH(), RouteContext, GET(), RouteContext (+69 more)

### Community 43 - "Community 43"
Cohesion: 0.02
Nodes (36): activeAnimationId(), __addChild(), addListener(), addPendingGesture(), animation_id(), ensureConfig(), f(), get_slot_str() (+28 more)

### Community 44 - "Community 44"
Cohesion: 0.03
Nodes (81): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CancelDeletionPageContent(), CommunityModerationPanel(), Filter, ModeratedPost (+73 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (99): SORTS, StoreCategoryScreen(), cellWidth(), clampedFontScale(), columnsThatFit(), PhoneSize, phoneSizeFor(), scaledHeight() (+91 more)

### Community 46 - "Community 46"
Cohesion: 0.03
Nodes (103): _animationLoop(), cancelAnimationFrame(), _cleanupCanvas(), _cleanupStateMachineListeners(), clear_marker(), clear_segment(), clear_slots(), clearSlot() (+95 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (73): CATEGORIES, field(), optionalField(), CreateWardenResult, PERMISSION_LABELS, EmptyInline(), SectionCard(), ActivationStatusResponse (+65 more)

### Community 48 - "Community 48"
Cohesion: 0.03
Nodes (87): grabDocument(), HostelAdminBillingPageContent(), InvoiceRow(), PaymentRow(), PlanCard(), rupees(), shortDate(), STATUS_TONE (+79 more)

### Community 49 - "Community 49"
Cohesion: 0.03
Nodes (88): RootShell(), BottomChrome, BottomChromeContext, BottomChromeProvider(), CHROME_TIMING, acknowledged, HostelSuspensionHost(), remainingLabel() (+80 more)

### Community 50 - "Community 50"
Cohesion: 0.03
Nodes (82): POST(), PATCH(), RouteContext, POST(), listTransfersDue(), listPayoutAccounts(), DELETE(), PATCH() (+74 more)
...
Cohesion: 0.05
Nodes (88): CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), AdminLedger, AdminLedgerEntry, readApiErrorDetails(), CalendarSystem (+80 more)

### Community 53 - "Community 53"
Cohesion: 0.02
Nodes (71): ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, RETAINED_BY_HOSTEL_ID, both, covered (+63 more)

### Community 54 - "Community 54"
Cohesion: 0.03
Nodes (69): Notification, FILTERS, Notification, NotificationRow(), PushState, FILTERS, NotificationCard, NotificationsPageContent (+61 more)

### Community 55 - "Community 55"
Cohesion: 0.03
Nodes (77): summarizeResidentComplaints(), listResidentInvoices(), dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, getFoodRoutine() (+69 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (84): AdminAlertsScreen(), ICONS, LABELS, Segment, TONES, AdminHomeScreen(), AdminOverviewScreen(), AdminMoneyScreen() (+76 more)

### Community 57 - "Community 57"
Cohesion: 0.03
Nodes (72): BookButton(), SIZE, BookingAvailabilityView, BookingButton, CLOSED_REASONS, open, HostelSuggestions(), inferKind() (+64 more)

### Community 58 - "Community 58"
Cohesion: 0.03
Nodes (71): AuthGuard(), CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing (+63 more)

### Community 59 - "Community 59"
Cohesion: 0.03
Nodes (61): listPausedHostels(), GET(), POST(), RouteContext, DELETE(), GET(), hostelId(), GET() (+53 more)

### Community 60 - "Community 60"
Cohesion: 0.04
Nodes (79): fill(), money(), PlanCard(), PricingScreen(), softmatoDocsUrl(), dueBhadra29, filed, throughAswin25 (+71 more)

### Community 61 - "Community 61"
Cohesion: 0.05
Nodes (69): BookableHostel, BookingUnavailableReason, findRoom(), hostelAddress(), HostelAvailability, hostelCoverPhoto(), hostelCoverPhotos(), hostelUnavailableReason() (+61 more)

### Community 62 - "Community 62"
Cohesion: 0.04
Nodes (76): bsPeriodBounds(), periodStartDate(), gregorianSpan(), defaultDueDate(), issueReceiptForEvent(), IssueReceiptInput, nextReceiptNumber(), periodCoverage() (+68 more)

### Community 63 - "Community 63"
Cohesion: 0.04
Nodes (66): notifyProviderOfAssignment(), notifyProviderOfMaintenanceNote(), notifyProviderOfStatusChange(), notifyProvidersOfOpenJob(), notifyStaffOfNewMaintenanceRequest(), providerUserId(), readableCategory(), RequestLike (+58 more)

### Community 64 - "Community 64"
Cohesion: 0.04
Nodes (59): BookingPaymentToCheck, TransferView, PlatformBookingView, PayoutAccountForReview, ReviewPayoutAccount(), STATUS_LABEL, List(), ReasonAction() (+51 more)
...
Cohesion: 0.05
Nodes (60): POST(), GET(), POST(), GET(), GET(), POST(), acceptPlatformAdminInvitation(), AcceptPlatformAdminInvitationInput (+52 more)

### Community 67 - "Community 67"
Cohesion: 0.05
Nodes (65): paymentProofSchema, arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal (+57 more)
...
Cohesion: 0.04
Nodes (55): emergencyContactSchema, incidentLogSchema, manualStatusOverrideSchema, nightStatusLogSchema, sosAlertSchema, nightKey(), answer, mocks (+47 more)
...
Cohesion: 0.05
Nodes (65): CHANNELS, ClaimedStep, composeEmail(), composeNotice(), composePlanDueNotice(), deliver(), deliverEmail(), deliverStep() (+57 more)

### Community 72 - "Community 72"
Cohesion: 0.05
Nodes (52): existingResidentListSchema, existingResidentRowSchema, defaultJoinedDate(), BillPreview, CheckContext, CheckedRow, checkExistingResidents(), CheckResult (+44 more)

### Community 73 - "Community 73"
Cohesion: 0.05
Nodes (57): ProviderDirectoryData, notifyStaffOfJobProgress(), serviceProviderSchema, serviceProviderApplicationSchema, serviceProviderDocumentSchema, DirectoryPageProps, EMPTY, generateMetadata() (+49 more)

### Community 74 - "Community 74"
Cohesion: 0.05
Nodes (61): BookingEnding, bookingFee(), BookingSettlement, cancellationSchedule(), cancelRefundPercent(), FULL_REFUND_ENDINGS, holdDayAt(), holdEndsAt() (+53 more)

### Community 75 - "Community 75"
Cohesion: 0.04
Nodes (50): AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry() (+42 more)

### Community 76 - "Community 76"
Cohesion: 0.05
Nodes (55): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, metadata, HostelBookingView, HostelBookingRequestsReminder(), HostelPhotoReminder(), isAuthBypassEnabled(), original (+47 more)

### Community 77 - "Community 77"
Cohesion: 0.04
Nodes (44): DeletionPathway, DeletionStatus, PATHWAY_COPY, ConfirmOptions, useConfirm(), ExistingResidentsPanel(), Props, ExistingResidentsSheet() (+36 more)

### Community 78 - "Community 78"
Cohesion: 0.06
Nodes (54): BOOKING_DOCUMENT_KINDS, BookingDocumentKind, bookingDocumentLayout(), refundPolicyNotes(), allowed(), bookingDocumentResponse(), BookingDocumentScope, resolveBookingDocument() (+46 more)

### Community 79 - "Community 79"
Cohesion: 0.04
Nodes (57): currentBsPeriod(), OfferTab(), Faq, PlatformConfigSeoPageContent, Step, eventRuns(), sellingCatalog(), coerceSection() (+49 more)

### Community 80 - "Community 80"
Cohesion: 0.04
Nodes (48): CommunityPageContent(), FeedPayload, NewPostAlertsToggle(), SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+40 more)
...
Cohesion: 0.05
Nodes (55): BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsMonthStart(), formatBsDayMonth() (+47 more)
...
Cohesion: 0.09
Nodes (35): POST(), POST(), POST(), POST(), POST(), POST(), safeEqual(), POST() (+27 more)

### Community 86 - "Community 86"
Cohesion: 0.05
Nodes (51): COLUMNS, Member, MemberData, RegistrationTrackSheet(), TrackSheetLoader(), metadata, HOSTEL_AGREEMENT_STATUSES, hostelAgreementSchema (+43 more)

### Community 87 - "Community 87"
Cohesion: 0.07
Nodes (43): CheckoutInvoice, checkoutView(), currentPlanId(), fail(), findHostelForCheckout(), HostelMatch, paymentState(), PlanCheckoutInput (+35 more)

### Community 88 - "Community 88"
Cohesion: 0.05
Nodes (55): BALANCE_ALIASES, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES, WITHDRAWAL_ALIASES (+47 more)

### Community 89 - "Community 89"
Cohesion: 0.05
Nodes (48): periodTotals(), assertHostelAccess(), hostelScopedFilter(), TenantAccessError, TenantPrincipal, foodReadyLogSchema, notificationCampaignSchema, CampaignListQuery (+40 more)
...
Cohesion: 0.05
Nodes (43): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), CookTodayScreen(), PortalDates (+35 more)
...
Cohesion: 0.06
Nodes (43): NightStatusForm(), AlertRow(), SosScreen(), nepalDayKey(), isCurrentNight(), isSelfReportable(), NIGHT_STATUS_OPTIONS, nightKey() (+35 more)

### Community 94 - "Community 94"
Cohesion: 0.08
Nodes (51): _adopt(), ar(), assignAnimationToWorker(), at(), br(), broadcastMessage(), Bt(), composedPath() (+43 more)

### Community 95 - "Community 95"
Cohesion: 0.06
Nodes (35): PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), listFieldCashToConfirm(), getPlatformSubscriptionLedger(), listPlanPaymentClaims(), GET(), POST() (+27 more)
...
Cohesion: 0.06
Nodes (46): methodProvider(), ReferenceStrip(), IntakeQuote, RESIDENT_TYPES, ResidentIntakeResult, ResidentOccupancy, ResidentPrefill, ResidentPrefillPhoto (+38 more)
...
Cohesion: 0.06
Nodes (44): deliver(), Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity() (+36 more)

### Community 100 - "Community 100"
Cohesion: 0.07
Nodes (41): JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, ProviderJobScreen(), acceptProviderJob() (+33 more)
...
Cohesion: 0.06
Nodes (41): DetailsCard(), InvoiceHeaderBlock(), LedgerCard(), ResidentInvoice, chargeDescriptions(), filterInvoices(), groupInvoicesByYear(), invoiceLedger() (+33 more)
...
Cohesion: 0.07
Nodes (40): noticeReadStatusSchema, mocks, noticeInput, residentUserId, staffPrincipal, announceChange(), audit(), CreateInput (+32 more)
...
Cohesion: 0.08
Nodes (45): as(), attachGestureHandler(), bd(), bp(), Cd(), cn(), cp(), cs() (+37 more)
...
Cohesion: 0.08
Nodes (36): composeFeeDueNotice(), sendFeeDueReminders(), platformPushScheduleSchema, resolveTiming(), asPushTiming(), laterFromDelay(), nextNoticePushRun(), noticePushExpiry() (+28 more)
...
Cohesion: 0.09
Nodes (26): COMMUNITY_DEFAULTS, CommunitySettings, getCommunitySettings(), communityAnnouncementSchema, communityFeedQuerySchema, communityModerationQuerySchema, communityPostCreateSchema, communityReactionSchema (+18 more)
...
Cohesion: 0.1
Nodes (33): Guidance, GuidanceStatus, cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath(), formatManeuverDistance() (+25 more)
...
Cohesion: 0.12
Nodes (31): bootstrapSession(), assertMatchesExtension(), beginDownload(), downloadAndShare(), downloadAndShareCsv(), downloadAndShareImage(), forgetDownloadFolder(), LegacyFileSystem (+23 more)

### Community 133 - "Community 133"
Cohesion: 0.13
Nodes (28): bodySchema, POST(), deleteHostelObjects(), FILE_ASSET_KINDS, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), isPlatformOnlyAssetKind() (+20 more)

### Community 134 - "Community 134"
Cohesion: 0.09
Nodes (33): announcedCount(), announcementSummary(), MealButton, mealButtonLabel(), mealButtons(), MealButtonsInput, mealLockNote(), mealsToCall() (+25 more)
...
Cohesion: 0.08
Nodes (32): continueLabel(), isBlank(), buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, hasIdentityErrors() (+24 more)
...
Cohesion: 0.12
Nodes (29): ROUTINE_DAYS, ROUTINE_MEAL_TYPES, RoutineDay, RoutineMealType, Candidate, dueMeals(), MealCallReminderResult, mealLabel() (+21 more)
...
Cohesion: 0.08
Nodes (27): ACTOR_LABELS, actorLabel(), Complaint, COMPLAINT_CATEGORIES, COMPLAINT_STATUSES, ComplaintAttachment, ComplaintCategory, ComplaintStatus (+19 more)
...
Cohesion: 0.11
Nodes (28): ApiFailure, apiRequest(), ApiSuccess, AuthUser, getActivationStatus(), getResidentNightStatus(), listResidentFood(), listResidentNotices() (+20 more)
...
Cohesion: 0.09
Nodes (27): directionFlags(), evidenceFlags(), payeeFlags(), CREDIT_MARKERS, DEBIT_MARKERS, DirectionRead, directionRefusal(), EvidenceDirection (+19 more)
...
Cohesion: 0.19
Nodes (18): CSV_COLUMNS, GET(), GET(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS, neutralize() (+10 more)
...
Cohesion: 0.2
Nodes (17): CARDINALS, chooseHeading(), directionWord(), distanceToPath(), hasArrived(), headingDifference(), instructionFor(), isOffRoute() (+9 more)
...
Cohesion: 0.16
Nodes (14): hostelToday(), teamWalletEntrySchema, fit_width(), Builds the launch-screen art: the logo lockup and the "Powered by" strip.  Run f, commissionFor(), creditTeamCommission(), getAgentWallet(), listTeamWallets() (+6 more)
...
Cohesion: 0.17
Nodes (13): native, NativeDownloads, openDownloaded(), openSavedFile(), SavedDownload, saveSilently(), KNOWN_PATHS, marksRoleChange() (+5 more)
...
Cohesion: 0.19
Nodes (15): NearbyStatus, Coordinates, isUsableCoordinate(), hasLocationPermission(), hasPromptedForLocation(), LocationOutcome, NavigationFix, readPosition() (+7 more)
...
Cohesion: 0.22
Nodes (8): POST(), RouteContext, DEFAULT_GUARDIAN_PERMISSIONS, guardianAccessCreateSchema, guardianInvitationAcceptSchema, guardianLoginSchema, guardianPermissionsSchema, objectIdSchema
...
## Knowledge Gaps
- **6936 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+6931 more)
...
- **Why does `string()` connect `Community 14` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 11`, `Community 12`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 22`, `Community 23`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 32`, `Community 34`, `Community 35`, `Community 37`, `Community 38`, `Community 39`, `Community 43`, `Community 45`, `Community 46`, `Community 49`, `Community 50`, `Community 51`, `Community 52`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 64`, `Community 66`, `Community 70`, `Community 71`, `Community 72`, `Community 74`, `Community 77`, `Community 78`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 85`, `Community 86`, `Community 87`, `Community 96`, `Community 97`, `Community 99`, `Community 100`, `Community 101`, `Community 102`, `Community 106`, `Community 109`, `Community 113`, `Community 114`, `Community 117`, `Community 118`, `Community 120`, `Community 139`, `Community 142`, `Community 154`, `Community 155`, `Community 156`, `Community 163`, `Community 169`, `Community 171`, `Community 172`, `Community 178`, `Community 179`, `Community 191`, `Community 192`, `Community 200`, `Community 210`, `Community 231`, `Community 261`, `Community 295`, `Community 310`, `Community 390`, `Community 436`?**
  _High betweenness centrality (0.151) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 17` to `Community 2`, `Community 3`, `Community 6`, `Community 7`, `Community 265`, `Community 11`, `Community 139`, `Community 13`, `Community 14`, `Community 142`, `Community 144`, `Community 18`, `Community 19`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 30`, `Community 32`, `Community 36`, `Community 40`, `Community 43`, `Community 44`, `Community 48`, `Community 49`, `Community 178`, `Community 51`, `Community 52`, `Community 57`, `Community 58`, `Community 443`, `Community 189`, `Community 62`, `Community 191`, `Community 192`, `Community 65`, `Community 200`, `Community 202`, `Community 331`, `Community 77`, `Community 80`, `Community 81`, `Community 82`, `Community 210`, `Community 88`, `Community 345`, `Community 223`, `Community 95`, `Community 106`, `Community 113`, `Community 114`, `Community 118`, `Community 125`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 6` to `Community 1`, `Community 7`, `Community 8`, `Community 10`, `Community 12`, `Community 15`, `Community 18`, `Community 20`, `Community 150`, `Community 23`, `Community 30`, `Community 33`, `Community 36`, `Community 168`, `Community 44`, `Community 45`, `Community 47`, `Community 52`, `Community 54`, `Community 56`, `Community 77`, `Community 80`, `Community 97`?**
...
- **What connects `iosUrlScheme`, `{ defineConfig }`, `expoConfig` to the rest of the system?**
  _6936 weakly-connected nodes found - possible documentation gaps or missing edges._