...
## Corpus Check
- 1956 files · ~3,340,751 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15528 nodes · 42792 edges · 530 communities (502 shown, 28 thin omitted)
...
## Communities (530 total, 28 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (267): POST(), POST(), GET(), GET(), POST(), GET(), POST(), PATCH() (+259 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (308): loadOverview(), loadMoney(), loadToday(), VoiceNotePlayer(), RoundButton(), VOICE_NOTE_RECORDING, VoiceNote, VoiceNoteRecorder() (+300 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (253): getOrCreateSubscription(), POST(), GET(), getOpenFeeSchedule(), GET(), POST(), getFoodRoutinesByHostelId(), serializeRoutine() (+245 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (229): Scanner(), CookInviteScreen(), GuardianInviteScreen(), MapScreen(), PreviewCard(), ResultRow(), Assurance(), CallableRow() (+221 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (219): deleteResidentLocationHistory(), getResidentAttendance(), verifyOtpChallenge(), deleteOwnPost(), confirmComplaintResolution(), listResidentComplaints(), summarizeResidentComplaints(), GET() (+211 more)
...
Cohesion: 0.05
Nodes (146): ICONS, LABELS, Segment, TONES, FILTERS, Pending, MoneyData, Person (+138 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (199): POST(), RealtimeConfig, RealtimeContext, RealtimeContextValue, RealtimeNotification, useRealtime(), DELETE(), POST() (+191 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (180): AdminMoreScreen(), MANAGE_ROWS, PORTAL_ROWS, ActivateScreen(), BootGate(), RootShell(), NotificationsScreen(), ApplyBlock() (+172 more)

### Community 9 - "Community 9"
Cohesion: 0.01
Nodes (145): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage() (+137 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (168): PATCH(), POST(), RouteContext, PATCH(), RouteContext, demoteToPublicAccount(), POST(), GET() (+160 more)
...
Cohesion: 0.03
Nodes (131): AdminTabs(), HIDDEN, TABS, TABS, CommunityScreen(), Composer(), AdminAlertsProvider(), CommunityBoard() (+123 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (117): Overview, HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+109 more)
...
Cohesion: 0.02
Nodes (112): GET(), POST(), GET(), POST(), assetId, hostelId, mocks, otherHostelId (+104 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (121): GET(), cookLoginStem(), generateCookPassword(), mintCookLogin(), pick(), previousCookLabel(), cookPrincipal, mocks (+113 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (126): AdminCommunityReportsScreen(), AdminResidentsScreen(), AttendanceScreen(), NightStatusForm(), NightStatusScreen(), ProfileScreen(), ReferralsScreen(), DeletionPanel() (+118 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (112): AssetViewer(), useViewerState(), ViewerPage(), CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel() (+104 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (95): FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, monthStartPeriod(), Rate, RoomTypeOption, gregorianSpan(), MonthField (+87 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (83): AuthExperiencePage(), csvField(), field(), Hostel, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminProfilePageContent(), HostelAdminRoomsPageContent() (+75 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (103): querySchema, RouteContext, authorUserId, mocks, postId, residentId, residentPrincipal, staffPrincipal (+95 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (117): storeCartSchema, storeCategorySchema, storeOrderSchema, storeProductSchema, GET(), RouteContext, AddInput, addToCart() (+109 more)

### Community 24 - "Community 24"
Cohesion: 0.02
Nodes (92): InlineText(), TIER_TONE, PlanMark(), RAFTER, RIDGE, ROWS, BillingToggle(), EASE (+84 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (95): collectionTotals(), countInvoicesByField(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor(), LedgerInvoiceRow (+87 more)

### Community 26 - "Community 26"
Cohesion: 0.08
Nodes (69): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), verificationEmail(), subscriptionClaimReceivedEmail(), subscriptionClaimRejectedEmail(), formatRupees() (+61 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (90): CommunityReportDialog(), REASONS, MonthOption(), BrowserPushRow(), ModerationButton(), PagerButton(), normalize(), PortalSearch() (+82 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (98): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply() (+90 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (85): AttendanceCalendar(), EMPTY_SUMMARY, CookAccount, Credentials, HostelAdminCooksPanel, Issued, addDays(), COOK_PORTAL_DEFAULTS (+77 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (90): ReviewForm(), ReviewScreen(), AttachmentGallery(), DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS, MealCard() (+82 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (77): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), DocumentScreen(), MobileLegal (+69 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (76): Notification, grabDocument(), PayPlanPanel(), rupees(), FILTERS, Notification, NotificationRow(), PushState (+68 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (78): PRIORITIES, STATUS_ACTIONS, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel, AdminReferral, FILTERS (+70 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (87): AdminAlertsScreen(), AdminCommunityScreen(), AdminHomeScreen(), AdminOverviewScreen(), AdminMoneyScreen(), AdminTodayScreen(), TodayData, AdminAlertsContext (+79 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (78): fill(), PricingScreen(), HostelRegistrationProgress(), Milestone, milestoneIndex(), MILESTONES, PaymentPanel(), PlanPicker() (+70 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (88): Offset, PhotoCropper(), VideoSlot(), CollectionQrField(), FileUploadArea(), FileUploadArea(), PhotoStrip(), downloadCaption() (+80 more)
...
Cohesion: 0.04
Nodes (81): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure (+73 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (84): FILTERS, NotificationCard(), NotificationRow(), TILE_GLYPH, TILE_TONES, ReferralRow(), CheckoutStatusScreen(), ComplaintDetail() (+76 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (64): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, attempt (+56 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (76): hashUserAgent(), HostelRef, newVisitorKey(), recordHostelPageView(), resolveVisitorKey(), getPresignedReadUrl(), auditLogSchema, hostelPageViewSchema (+68 more)

### Community 42 - "Community 42"
Cohesion: 0.03
Nodes (63): AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET() (+55 more)
...
Cohesion: 0.04
Nodes (74): graceDeadline(), addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd() (+66 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (70): CsvTable, gridFromCsv(), peekHeaders(), readCsv(), stripBom(), stripPreamble(), ESEWA_CSV_PARSER, both (+62 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (56): ComparePage(), hostels, metadata, rows, AuthGuard(), CurrentUser, MeResponse, PortalAccount() (+48 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (62): getHostelPayMethods(), assertQrAssetUsable(), EMPTY, PaymentProfileView, ProfileDocument, readQrPayeeFields(), TEXT_FIELDS, toView() (+54 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (64): feeUpdateSchema, PATCH(), POST(), GET(), paymentProofSchema, arrangeProof(), leanResult(), mocks (+56 more)
...
Cohesion: 0.05
Nodes (45): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, HostelPhotoReminder(), PortalShell(), navItems, navItems, FALLBACK_ORDER, hasNoHostelPhotos() (+37 more)
...
Cohesion: 0.06
Nodes (47): GET(), ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+39 more)

### Community 58 - "Community 58"
Cohesion: 0.05
Nodes (47): REALTIME_TOPIC_VALUES, useRealtime(), claimNotificationSound(), claims, resetNotificationSoundClaims(), invalidateQuery(), resetQueryCache(), again (+39 more)
...
Cohesion: 0.06
Nodes (40): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), robots() (+32 more)
...
Cohesion: 0.08
Nodes (40): POST(), RouteContext, computePerceptualHash(), ImageVariantRecord, optimizeImage(), streamToBuffer(), VARIANT_CONFIG, VariantName (+32 more)

### Community 65 - "Community 65"
Cohesion: 0.06
Nodes (43): bsMonthStart(), hostelCalendarDay(), hostelToday(), rateForRoomType(), monthsBetween(), periodOf(), ResidentDoc, ResidentLedger (+35 more)

### Community 66 - "Community 66"
Cohesion: 0.06
Nodes (40): PATCH(), RouteContext, referralSchema, referralCodeSchema, referralRewardSchema, assertActiveReferralCode(), auditReferralAction(), confirmReferralJoined() (+32 more)

### Community 67 - "Community 67"
Cohesion: 0.07
Nodes (41): DeviceLocationStatus, hasGeolocation(), LocationOutcome, NavigationFix, OrientationPermission, requestDeviceLocation(), requestHeadingPermission(), Unsubscribe (+33 more)

### Community 68 - "Community 68"
Cohesion: 0.05
Nodes (34): financeIntegrityHash(), hasProvider(), IntentRow, recheckClosedAttempts(), SettlementReconSummary, findingSchema, reconciliationRunSchema, checkAuditChain() (+26 more)
...
Cohesion: 0.05
Nodes (39): defaultDueDate(), DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), axisMonth(), monthLabel() (+31 more)
...
Cohesion: 0.08
Nodes (40): announceFoodReady(), dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, ROUTINE_DAYS, ROUTINE_MEAL_TYPES (+32 more)

### Community 77 - "Community 77"
Cohesion: 0.07
Nodes (38): afterResponse(), mocks, work, filterPushRecipients(), CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, readId() (+30 more)
...
Cohesion: 0.08
Nodes (31): POST(), bulkApproveSchema, POST(), GET(), listResidentClaims(), approveClaim(), assertNotAlreadyRecordedFromStatement(), bulkApproveClaims() (+23 more)

### Community 86 - "Community 86"
Cohesion: 0.12
Nodes (33): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt, allocateReceiptNumber() (+25 more)
...
Cohesion: 0.08
Nodes (35): canonical(), canonicalDigits(), containsWithTolerance(), evidenceTextFlags(), extractClaimFields(), isDefinitelyNotPaymentEvidence(), looksLikePaymentReceipt(), matchClaimFacts() (+27 more)
...
Cohesion: 0.1
Nodes (31): appBaseUrl(), authenticateWithGoogle(), CLAIMABLE_STATUSES, dispatchOtpChallenge(), dispatchVerificationEmail(), findVerifiedRegistrationChallenge(), generateOtpCode(), GOOGLE_JWKS (+23 more)
...
Cohesion: 0.08
Nodes (29): qrActivationSchema, before, expiresAt, mocks, staffPrincipal, activateResident(), ActivationCodeGenerateInput, ActivationCodeInput (+21 more)
...
Cohesion: 0.08
Nodes (24): inferKind(), MediaLightbox(), Choice, HOSTEL_TYPE_LABELS, HostelPanel(), MapButton(), MapCanvas, ModeTab() (+16 more)

### Community 96 - "Community 96"
Cohesion: 0.09
Nodes (30): acceptPlatformAdminInvitation(), AcceptPlatformAdminInvitationInput, appUrl(), checkPlatformAdminEmail(), daysFromNow(), EmailAvailability, EmailAvailabilityResult, findLiveInvite() (+22 more)
...
Cohesion: 0.09
Nodes (30): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, FeeScheduleCloseInput, feeScheduleCloseSchema (+22 more)
...
Cohesion: 0.07
Nodes (22): ProviderDirectoryData, CATEGORIES, isApplicationOpen(), LandingStep(), MeResponse, OwnApplication, ProviderStats, ProviderStatus (+14 more)

### Community 101 - "Community 101"
Cohesion: 0.09
Nodes (32): announcementSummary(), CookFoodPhoto, MealButton, mealButtonLabel(), mealButtons(), MealButtonsInput, mealLockNote(), mealsToCall() (+24 more)
...
Cohesion: 0.1
Nodes (26): listTrendingTags(), sponsorSchema, GET(), loadPopularHostels(), PopularHostelRecord, GET(), assertWindow(), CreateInput (+18 more)
...
Cohesion: 0.11
Nodes (25): CARDINALS, chooseHeading(), directionWord(), distanceToPath(), headingDifference(), instructionFor(), nextStep(), normaliseHeading() (+17 more)
...
Cohesion: 0.14
Nodes (25): AMOUNT_LABELS, ClaimFacts, deadline(), DIGIT_CONFUSABLES, EvidenceRead, EvidenceTextMatch, ExtractedClaimFields, getWorker() (+17 more)
...
Cohesion: 0.33
Nodes (12): POST(), AuthServiceError, POST(), loginGuardian(), accessTokenTtlSeconds(), parseDurationSeconds(), refreshTokenTtlSeconds(), isMobileAuthClient() (+4 more)
...
Cohesion: 0.14
Nodes (18): CSV_COLUMNS, POST(), safeEqual(), ClickRecord, dayKey(), getQuestionCallAnalytics(), QuestionCallAnalyticsQuery, questionCallBaseUrl() (+10 more)
...
Cohesion: 0.15
Nodes (17): approvalPeriod(), getPeriodSummary(), monthsBetween(), periodOf(), PeriodRow, PeriodSummary, august, bhadra (+9 more)
...
Cohesion: 0.15
Nodes (14): login(), submitResidentReview(), triggerSOS(), RootStackParamList, LoginScreen(), Props, Profile, Props (+6 more)
...
Cohesion: 0.16
Nodes (14): appBlurTarget, closeConfirm(), ConfirmRequest, emit(), getConfirmRequest(), listeners, openConfirm(), subscribeToConfirm() (+6 more)
...
Cohesion: 0.14
Nodes (16): apiRequest(), confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), getResidentProfile(), listNotifications(), listResidentComplaints(), markNotificationRead() (+8 more)
...
Cohesion: 0.11
Nodes (12): isMonthEnd(), friday, hostelId, mocks, nextFriday, principal, storedRoutine, thisFriday (+4 more)
...
Cohesion: 0.18
Nodes (14): activeSuperadminCount(), createPlatformAdmin(), CreatePlatformAdminInput, generateTemporaryPassword(), listPlatformAdmins(), loginUrl(), PLATFORM_ADMIN_ROLES, PlatformAdminRole (+6 more)
...
Cohesion: 0.14
Nodes (12): activateResident(), AuthSession, getResidentNightStatus(), ResidentNightStatus, updateResidentNightStatus(), AppNavigator(), Stack, Props (+4 more)
...
Cohesion: 0.12
Nodes (12): countInvoicesByStatus(), addFieldsStage, filter, group, hostelId, invoiceId, lookups, mocks (+4 more)
...
Cohesion: 0.17
Nodes (13): deliver(), loadInvoiceById(), loadProof(), PlanPaymentInstructions, ProofAsset, reviewPlanPaymentClaim(), submitPlanPaymentClaim(), formatEmailDate() (+5 more)
...
Cohesion: 0.17
Nodes (15): 1.0 Signup One-Time Code, 1.1 Email Verification (PUBLIC Signup), 1.3 Warden Credentials, 1.4 Resident QR Activation, 1.6 Password Reset, 1.7 Account Upgraded, 1. Authentication & Account Emails, 2.3 Hostel Rejected (+7 more)
...
Cohesion: 0.17
Nodes (10): resetPasswordWithToken(), revokeAllSessions(), verifyPurposeToken(), hostelId, input, leanResult(), mocks, recipients (+2 more)
...
Cohesion: 0.35
Nodes (7): changePassword(), getCurrentUser(), sameIds(), POST(), getBearerToken(), verifyAccessToken(), changePasswordSchema
...
Cohesion: 0.33
Nodes (10): code:typescript (interface IFoodReadyLog {), code:typescript ({), FoodReadyLog, Notification, Notification, Notification, Notification (as built), NotificationCampaign (+2 more)
...
## Knowledge Gaps
- **5471 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+5466 more)
...
- **Why does `Button()` connect `Community 6` to `Community 32`, `Community 1`, `Community 34`, `Community 3`, `Community 69`, `Community 134`, `Community 5`, `Community 8`, `Community 37`, `Community 11`, `Community 13`, `Community 15`, `Community 19`, `Community 20`, `Community 27`, `Community 29`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 27` to `Community 3`, `Community 5`, `Community 262`, `Community 6`, `Community 8`, `Community 9`, `Community 11`, `Community 12`, `Community 20`, `Community 21`, `Community 24`, `Community 29`, `Community 32`, `Community 35`, `Community 36`, `Community 37`, `Community 47`, `Community 50`, `Community 51`, `Community 60`, `Community 63`, `Community 83`, `Community 95`, `Community 97`, `Community 100`, `Community 106`, `Community 122`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 70` to `Community 0`, `Community 1`, `Community 130`, `Community 5`, `Community 11`, `Community 12`, `Community 141`, `Community 14`, `Community 15`, `Community 17`, `Community 18`, `Community 20`, `Community 152`, `Community 25`, `Community 26`, `Community 155`, `Community 160`, `Community 33`, `Community 32`, `Community 35`, `Community 161`, `Community 36`, `Community 40`, `Community 170`, `Community 43`, `Community 45`, `Community 47`, `Community 53`, `Community 55`, `Community 63`, `Community 69`, `Community 76`, `Community 77`, `Community 79`, `Community 88`, `Community 90`, `Community 98`, `Community 103`, `Community 113`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
...
- **What connects `iosUrlScheme`, `{ defineConfig }`, `expoConfig` to the rest of the system?**
  _5471 weakly-connected nodes found - possible documentation gaps or missing edges._
