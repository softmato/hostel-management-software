...
## Corpus Check
- 1990 files · ~3,202,995 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 16039 nodes · 43948 edges · 545 communities (522 shown, 23 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 706 edges (avg confidence: 0.8)
...
3. `connectToDatabase()` - 442 edges
4. `useAppTheme()` - 394 edges
5. `cn()` - 294 edges
6. `connectToDatabase()` - 248 edges
7. `unwrap()` - 198 edges
...
## Communities (545 total, 23 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (238): PATCH(), RouteContext, POST(), getOrCreateSubscription(), POST(), GET(), getOpenFeeSchedule(), GET() (+230 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (152): Overview, MoneyData, MANAGE_ROWS, PORTAL_ROWS, TodayData, Person, SORTS, needsResident() (+144 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (246): loadOverview(), loadMoney(), loadToday(), getAdminFoodRoutine(), getAdminHostel(), getAdminInvoices(), getAdminMaintenance(), getAdminNightStatus() (+238 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (156): PlanPaymentClaim, csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, HostelTable(), Inquiry (+148 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (217): AdminOverviewScreen(), AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), Scanner(), AttendanceScreen(), FaqRow(), MethodCard() (+209 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (205): auditFinanceAction(), FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult (+197 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (195): deleteResidentLocationHistory(), getResidentAttendance(), addComplaintUpdate(), assertComplaintVoiceNote(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory (+187 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (186): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, dayKey(), overrideAttendance(), POST(), notifyAdminsOfNewComplaint() (+178 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (135): PATCH(), RouteContext, listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), getPlatformSubscriptionLedger(), listPlanPaymentClaims() (+127 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (182): BootGate(), RootShell(), DeletionPanel(), NotificationSettings(), SETTINGS_TITLES, THEME_OPTIONS, BrandSplash(), AuthDivider() (+174 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (154): AuditLogRecord, PlatformAuditLogQuery, RefRecord, ownerIdentitiesFor(), summarizeResidentComplaints(), getHostelLedger(), collectionTotals(), countInvoicesByField() (+146 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (120): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload (+112 more)
...
Cohesion: 0.03
Nodes (121): HostelSuggestions(), GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS (+113 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (157): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags() (+149 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (126): BrandMark(), BrandWordmark(), WORDMARK, WORDMARK_SEGMENTS, CommunityReportDialog(), REASONS, MonthOption(), BrowserPushRow() (+118 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (117): HostelAdminCommunityPageContent, HostelAdminFeePlansPageContent, HostelAdminInquiriesPageContent, HostelAdminMaintenancePageContent, PRIORITIES, STATUS_ACTIONS, HostelAdminMoveChecklistPage, HostelAdminNightStatusPage (+109 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (112): POST(), GET(), POST(), POST(), POST(), POST(), listAttendanceAlerts(), GET() (+104 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (128): cookLoginStem(), generateCookPassword(), mintCookLogin(), pick(), previousCookLabel(), cookPrincipal, mocks, acceptCookInvitation() (+120 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (104): POST(), POST(), POST(), getPlanPaymentInstructions(), POST(), RouteContext, DELETE(), GET() (+96 more)
...
Cohesion: 0.02
Nodes (123): grabDocument(), PayPlanPanel(), rupees(), HostelAdminReconcilePageContent, labelled(), PROVIDERS, Reconciliation, StatementImportRow (+115 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (99): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), SosScreen(), BottomChrome, BottomChromeContext, BottomChromeProvider() (+91 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (115): DELETE(), checkoutSchema, POST(), GET(), POST(), querySchema, RouteContext, AnnouncementInput (+107 more)

### Community 24 - "Community 24"
Cohesion: 0.02
Nodes (116): cropToGuide(), FILL, GuidedCapture(), GUIDES, GuideShape, loadManipulator(), Manipulator, Point() (+108 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (120): AdminAlertsScreen(), ICONS, LABELS, Segment, TONES, AdminCommunityReportsScreen(), FILTERS, Pending (+112 more)

### Community 26 - "Community 26"
Cohesion: 0.02
Nodes (92): metadata, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails(), RenderedSection (+84 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (100): AdminCommunityScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+92 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (91): Notification, FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, monthStartPeriod(), Rate, RoomTypeOption, gregorianSpan() (+83 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (91): GET(), POST(), GET(), GET(), GET(), resolveOwnedHostel(), getSubscriptionState(), selectPlan() (+83 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (89): CommunityScreen(), Composer(), CommunityPostScreen(), AdminSearchBar(), CommunityBoard(), CommunityBoardProps, Composer(), SORTS (+81 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (99): ReviewForm(), ReviewScreen(), AttachmentGallery(), DAY_LABELS, DayStrip(), MEAL_ICONS, MealCard(), MonthEndSpecial() (+91 more)

### Community 32 - "Community 32"
Cohesion: 0.02
Nodes (87): DescriptionFacts, DescriptionSuggestions(), HostelType, since(), starters, typeWords, VideoSlot(), cityOptions (+79 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (87): HIDDEN, RoleLayout(), TABS, FILTERS, invalidateFeeds(), NotificationRow(), TILE_GLYPH, TILE_TONES (+79 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (89): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), sitemap() (+81 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (82): notifyProviderOfAssignment(), notifyProviderOfMaintenanceNote(), notifyProviderOfStatusChange(), notifyStaffOfJobProgress(), notifyStaffOfNewMaintenanceRequest(), providerUserId(), readableCategory(), RequestLike (+74 more)

### Community 36 - "Community 36"
Cohesion: 0.02
Nodes (58): deleteHostelObjects(), ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, RETAINED_BY_HOSTEL_ID, both (+50 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (81): mapped, GATEWAY_ORDER, getHostelPayMethods(), getPayInstructions(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions (+73 more)

### Community 38 - "Community 38"
Cohesion: 0.09
Nodes (53): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), PLATFORM_NAME_PARTS, cookInvitationEmail() (+45 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (69): AccountDeletionPanel, DeletionPathway, DeletionStatus, PATHWAY_COPY, EMPTY_SUMMARY, HostelAdminComplaintsPage, CookAccount, Credentials (+61 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (76): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), methodProvider(), PROVIDER_LABEL, QrPanel() (+68 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (68): PaginationMeta, PaginationQuery, querySchema, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex(), HostelRecord, ListingFlagListQuery (+60 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (65): FILTERS, Notification, NotificationRow(), PushState, blankRow(), Row, TeamInviteBox(), MemberActions() (+57 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (74): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodBounds() (+66 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (56): fill(), money(), PlanCard(), PricingScreen(), pricePlan(), PlanPicker(), InlineText(), BillingToggle() (+48 more)

### Community 45 - "Community 45"
Cohesion: 0.03
Nodes (47): adminPrincipal, mocks, PLATFORM_LIMITS, mocks, readable, selectable, base, entityId (+39 more)
...
Cohesion: 0.06
Nodes (56): robots(), documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt (+48 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (49): GET(), POST(), POST(), RouteContext, DEFAULT_GUARDIAN_PERMISSIONS, guardianAccessCreateSchema, guardianInvitationAcceptSchema, guardianInviteSchema (+41 more)
...
Cohesion: 0.04
Nodes (57): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), aswin, bhadra, bs() (+49 more)
...
Cohesion: 0.04
Nodes (46): PATCH(), POST(), RouteContext, GET(), POST(), saveFoodRoutine(), dayOfWeekSchema, foodFeedbackSchema (+38 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (45): metadata, CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+37 more)
...
Cohesion: 0.06
Nodes (58): getPresignedReadUrl(), userResidentProfileSchema, findLiveResidency(), LIVE_STATUSES, LiveResidency, LiveRow, auditProviderAction(), updateProviderStatus() (+50 more)

### Community 57 - "Community 57"
Cohesion: 0.06
Nodes (40): ComparePage(), hostels, metadata, rows, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), PlatformDashboardPageContent(), PlatformHostelReviewPageContent() (+32 more)

### Community 58 - "Community 58"
Cohesion: 0.07
Nodes (48): JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, ProviderStatusCard(), TILE_INK (+40 more)

### Community 59 - "Community 59"
Cohesion: 0.07
Nodes (57): demoteToPublicAccount(), afterResponse(), mocks, work, assertActiveReferralCode(), findActiveReferralCode(), linkReferralOnRegistration(), liveResidencyMessage() (+49 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (42): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, daysUntil(), HostelSubscriptionDueBanner(), rupees(), State, PortalShell(), navItems (+34 more)

### Community 61 - "Community 61"
Cohesion: 0.06
Nodes (51): HostelScope, ResolvedDocument, resolveInvoiceDocument(), resolveReceiptDocument(), scopeFilter(), settledTotal(), trySoftmato(), InvoiceDocumentInput (+43 more)
...
Cohesion: 0.05
Nodes (50): buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, draftFromProfile(), emptyIdentityDraft(), firstIncompleteIdentityStep() (+42 more)

### Community 66 - "Community 66"
Cohesion: 0.06
Nodes (23): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminNoticesPage(), HostelAdminResidentsPage(), redirectToWorkspaceScreen() (+15 more)

### Community 67 - "Community 67"
Cohesion: 0.06
Nodes (42): DetailsCard(), LedgerCard(), ResidentClaim, ResidentInvoice, chargeDescriptions(), filterInvoices(), groupInvoicesByYear(), invoiceLedger() (+34 more)
...
Cohesion: 0.07
Nodes (40): BALANCE_ALIASES, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, TXN_ID_ALIASES, WITHDRAWAL_ALIASES, AMOUNT_ALIASES (+32 more)

### Community 74 - "Community 74"
Cohesion: 0.08
Nodes (40): paymentProofSchema, alreadyReviewedError(), approvePaymentProof(), assertProofIsPending(), auditPaymentAction(), computeMonthlyDue(), creditVerifiedAmount(), currentMonth() (+32 more)
...
Cohesion: 0.08
Nodes (31): DEPRECATED_ALIASES, mocks, auditWardenAction(), createHostelWarden(), deactivateHostelWarden(), findScopedWarden(), HostelMemberRecord, hydrateUser() (+23 more)

### Community 79 - "Community 79"
Cohesion: 0.06
Nodes (31): inquirySchema, referralSchema, referralCodeSchema, referralRewardSchema, auditReferralAction(), HostelAdminReferralListQuery, normalizeObjectIds(), referralCodeCandidate() (+23 more)
...
Cohesion: 0.05
Nodes (34): DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), monthLabel(), PreviewColumn(), toNumber() (+26 more)
...
Cohesion: 0.07
Nodes (36): CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, readId(), activeDevicesFor(), activeTokensFor(), androidChannel(), authHeaders() (+28 more)
...
Cohesion: 0.08
Nodes (33): POST(), platformAdminInvitationEmail(), acceptPlatformAdminInvitation(), AcceptPlatformAdminInvitationInput, appUrl(), checkPlatformAdminEmail(), daysFromNow(), EmailAvailability (+25 more)
...
Cohesion: 0.07
Nodes (30): cityCounts(), CitySummary, featuredCities(), inCity(), servingMeals(), showcaseHostels(), counts, hostel() (+22 more)

### Community 92 - "Community 92"
Cohesion: 0.08
Nodes (31): buildHtml(), Marker, PlaceMarker, NearbyStatus, boundsCenter(), Coordinates, haversineMeters(), hostelCoordinates() (+23 more)

### Community 93 - "Community 93"
Cohesion: 0.09
Nodes (34): NavigationFix, watchDeviceHeading(), cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath(), formatManeuverDistance() (+26 more)

### Community 94 - "Community 94"
Cohesion: 0.13
Nodes (32): GET(), resolvePastedLink(), searchCandidates(), lookupLocation(), resolvePastedLink(), searchCandidates(), AddressParts, addressPartsFromGoogle() (+24 more)
...
Cohesion: 0.09
Nodes (33): Compass(), NavigationFix, watchDeviceHeading(), watchNavigationPosition(), cardinalFor(), CARDINALS, chooseHeading(), directionWord() (+25 more)

### Community 97 - "Community 97"
Cohesion: 0.09
Nodes (26): GET(), GET(), querySchema, assertTeamRegistrationIsNew(), checkTeamOwnerEmail(), findHostelUsingEmail(), hostelNameKey(), hostelAdminGeocodeQuerySchema (+18 more)
...
Cohesion: 0.07
Nodes (26): inferKind(), MediaLightbox(), Choice, HOSTEL_TYPE_LABELS, HostelPanel(), MapButton(), MapCanvas, ModeTab() (+18 more)
...
Cohesion: 0.11
Nodes (31): storeCategorySchema, storeOrderSchema, storeProductSchema, categoriesFor(), escapeRegex(), getStoreProduct(), getStoreShelves(), ListQuery (+23 more)
...
Cohesion: 0.1
Nodes (34): StoreCategoryScreen(), StoreCategory, discountPercent(), freeDeliveryNote(), freeDeliveryProgress(), limitNote(), orderTone(), rupees() (+26 more)
...
Cohesion: 0.07
Nodes (21): EmptyState(), Select(), field(), HostelAdminReportsPageContent(), HostelAdminServiceProvidersPageContent(), ListingFlag, LoadState, MaintenanceRequest (+13 more)

### Community 110 - "Community 110"
Cohesion: 0.07
Nodes (24): PromotableUser, promoteAccountToResident(), PROTECTED_ROLES, ResidentPromotion, ResidentPromotionClearance, standDownMemberships(), hostelId, memberId (+16 more)
...
Cohesion: 0.11
Nodes (28): bsMonthStart(), hostelToday(), rateForRoomType(), hostelCalendarDay(), hostelMonthStart(), hostelPeriodOf(), hostelToday(), once (+20 more)

### Community 113 - "Community 113"
Cohesion: 0.09
Nodes (18): POST(), RouteContext, RouteContext, calendarDateSchema, emergencyContactCreateSchema, guardianCreateSchema, objectIdSchema, optionalHostelScopeSchema (+10 more)
...
Cohesion: 0.08
Nodes (26): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+18 more)
...
Cohesion: 0.1
Nodes (22): getAttendanceConfig(), getAttendanceSettings(), listHostelAttendance(), recordConsent(), resolveAdminHostelId(), resolveAttendanceAlert(), updateAttendanceSettings(), attendanceAlertResolveSchema (+14 more)
...
Cohesion: 0.11
Nodes (16): ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, BASE_URLS, khaltiProvider, GatewayProvider, IntentHandoff (+8 more)
...
Cohesion: 0.09
Nodes (21): qrActivationSchema, residentSchema, userSchema, ActivationCodeGenerateInput, ActivationCodeInput, activationSecret(), ActivationServiceError, ActivationStatus (+13 more)
...
Cohesion: 0.13
Nodes (22): GuardianMetrics(), GuardianPaymentsScreen(), GuardianSafetyScreen(), GuardianPayment, GuardianPermissionKey, GuardianPermissions, GuardianReceipt, canSee() (+14 more)
...
Cohesion: 0.15
Nodes (19): FILE_ASSET_KINDS, FileAssetKind, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), r2Configured(), storePublicAsset(), AccessLevel (+11 more)

### Community 148 - "Community 148"
Cohesion: 0.14
Nodes (22): softmatoDocsUrl(), dueBhadra29, filed, throughAswin25, BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan (+14 more)
...
Cohesion: 0.11
Nodes (14): AuthGuard(), EMPTY_PREFILL, ENVIRONMENT_OPTIONS, IdentityResponse, Prefill, Step, checkAuthWithRefresh(), isStaleSession() (+6 more)
...
Cohesion: 0.15
Nodes (18): Choice, maneuverIcon(), MapButton(), ModeTab(), NavCard(), NOTHING_CHOSEN, RouteCard(), buildShell() (+10 more)
...
Cohesion: 0.14
Nodes (16): duesLine(), StayPill, now, count(), describeFanout(), SETTLED_SOS, SosFanoutTone, sosIsFlagged() (+8 more)
...
Cohesion: 0.16
Nodes (14): oauthAccountSchema, deleteTeamMember(), endSessions(), findMember(), MemberRecord, reinstateTeamMember(), removeTeamMember(), suspendTeamMember() (+6 more)

### Community 195 - "Community 195"
Cohesion: 0.13
Nodes (13): DeviceLocation, DeviceLocationStatus, formatDistance(), hostelCoordinates(), isUsableCoordinate(), KATHMANDU, hasGeolocation(), LocationOutcome (+5 more)
...
Cohesion: 0.14
Nodes (15): activateResident(), getResidentProfile(), submitResidentReview(), RootStackParamList, LoginScreen(), Props, Props, ResidentActivationScreen() (+7 more)

### Community 201 - "Community 201"
Cohesion: 0.12
Nodes (19): Attendance / Night Safety, Build status (end of Phase 3), Build status (end of Phase 5 — verified 2026-08-02), code:typescript (export enum Role {), code:typescript (interface IQRActivation {), code:typescript (interface INightStatusLog {), code:typescript (interface IResident {), code:typescript (interface IGuardianAccessPermissions {) (+11 more)
...
Cohesion: 0.18
Nodes (15): systemDocumentKind(), drawCertificationStamp(), footerLine(), formatDate(), formatLongDate(), MONTHS, ReceiptPdfInput, renderReceiptPdf() (+7 more)
...
Cohesion: 0.16
Nodes (15): cook, assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES, PermissionError, PLATFORM_ROLES, Principal (+7 more)
...
Cohesion: 0.18
Nodes (12): computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), distance, SystemDocumentKind, ImageVariantRecord, optimizeImage(), streamToBuffer() (+4 more)
...
Cohesion: 0.13
Nodes (17): 6.2 Service Provider Approved, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 7.1 Attendance Alert (Resident Absent), 7.2 Subscription Expiring Soon, 7. Attendance & Location Tracking Emails, 9.1 Account Deletion Requested, 9.1a Account Deletion Request Needs Review *(added 2026-08-02)*, 9.2 Account Deletion Cancelled (+9 more)
...
Cohesion: 0.15
Nodes (17): Bed, code:typescript (interface IUser {), code:typescript (interface IUserResidentProfile {), code:typescript (interface INearbyPlace {), code:typescript (interface IHostelDocument {), code:typescript (type HostelCapability =), code:typescript (interface IRoomConfiguration {), Core Identity (+9 more)

### Community 235 - "Community 235"
Cohesion: 0.24
Nodes (17): code:typescript (interface IMaintenanceRequest {), code:typescript (interface IInquiry {), code:typescript (interface IHostelPageView {), code:typescript (// One per resident, per hostel. Minted lazily on first dash), code:typescript (interface ISubscription {), code:typescript (interface IPlatformSetting {), HostelPageView, Inquiries, Referral, Notifications, Subscriptions (+9 more)
...
Cohesion: 0.18
Nodes (11): groupNearbyPlaces(), humanizeNearbyType(), NEARBY_GLYPHS, NEARBY_GROUPS, NEARBY_ICONS, nearbyGlyph(), NearbyGroup, nearbyIcon() (+3 more)
...
Cohesion: 0.29
Nodes (9): residentAccessClearedEmail(), roleLabel(), formatNpr(), itemsTable(), StoreEmailItem, storeOrderPlacedBuyerEmail(), storeOrderReceivedPlatformEmail(), storeOrderStatusBuyerEmail() (+1 more)
...
Cohesion: 0.14
Nodes (12): isCurrentNight(), isSameNight(), { body, title }, chase, due, first, HOSTEL, late (+4 more)
...
Cohesion: 0.16
Nodes (14): 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.3 Payment Proof Uploaded (to Admin), 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, 4.3 Complaint Resolved, code:typescript ({) (+6 more)
...
Cohesion: 0.22
Nodes (10): nepalDayKey(), filterNotices(), groupNoticesByDay(), noticeCategories(), NoticeDay, NoticeStatus, days, read (+2 more)
...
Cohesion: 0.22
Nodes (6): PlatformHostelsPageContent(), PortalPlaceholderAction, PortalPlaceholderPage(), PortalPlaceholderPageProps, GuardianScreenPageProps, PlatformScreenPageProps
...
Cohesion: 0.24
Nodes (8): HostelPhotoReminder(), FALLBACK_ORDER, hasNoHostelPhotos(), HostelPhoto, HostelPhotoKind, resolveHostelPhotos(), resolveHostelPhotoUrls(), describeActivationTarget()

### Community 325 - "Community 325"
Cohesion: 0.2
Nodes (7): NEXT_STATUSES, OrdersPayload, OrderStatus, PlatformStoreOrdersPageContent, STATUS_TONE, StoreOrder, ViewAllLink()
...
Cohesion: 0.22
Nodes (10): 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.3 Hostel Rejected, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, code:typescript ({), code:typescript ({), code:typescript ({) (+2 more)
...
Cohesion: 0.22
Nodes (10): 7.1 Multi-Tenant Isolation Test Template, 7.3 Privacy/Guardian Permissions Test Template, 7.4 Account-Upgrade Test Template, 7.5 Payment Precision Test Template, 7. Mandatory Test Templates, code:typescript (describe('GET /api/v1/hostel/rooms/:id - tenant isolation', ), code:typescript (describe('GET /api/v1/guardian/linked-resident - privacy', (), code:typescript (describe('Payment calculations - decimal precision', () => {) (+2 more)

### Community 360 - "Community 360"
Cohesion: 0.2
Nodes (10): 10.1 GitHub Actions Workflow, 10.2 Merge Rules, 10. CI/CD Integration, 7.2 Role Gate Test Template, 9.2 Test Database Isolation, code:typescript (describe('GET /api/v1/hostel/rooms - role access', () => {), code:typescript (// In test setup (e.g., jest.setup.ts)), code:yaml (# .github/workflows/test.yml) (+2 more)
...
Cohesion: 0.24
Nodes (6): AuthSession, triggerSOS(), AppNavigator(), Stack, Props, ResidentSOSScreen()
...
Cohesion: 0.22
Nodes (7): attempt, fetchMock, initiated, live, request, sandbox, GatewayCredentials
...
Cohesion: 0.38
Nodes (7): code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface INotice {), Payment, PaymentProof, Payments, Receipt
...
Cohesion: 0.33
Nodes (4): PlatformHostelsPageContent, pendingHostels, PlatformHostel, PlatformHostelsData
...
## Knowledge Gaps
- **5697 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+5692 more)
...
- **Why does `Button()` connect `Community 1` to `Community 2`, `Community 3`, `Community 4`, `Community 9`, `Community 11`, `Community 15`, `Community 20`, `Community 277`, `Community 22`, `Community 21`, `Community 24`, `Community 25`, `Community 26`, `Community 28`, `Community 30`, `Community 31`, `Community 39`, `Community 40`, `Community 42`, `Community 173`, `Community 53`, `Community 58`, `Community 62`, `Community 118`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 15` to `Community 1`, `Community 3`, `Community 4`, `Community 138`, `Community 11`, `Community 13`, `Community 16`, `Community 148`, `Community 21`, `Community 151`, `Community 26`, `Community 283`, `Community 28`, `Community 30`, `Community 32`, `Community 34`, `Community 39`, `Community 42`, `Community 44`, `Community 51`, `Community 53`, `Community 57`, `Community 60`, `Community 63`, `Community 64`, `Community 69`, `Community 325`, `Community 86`, `Community 99`, `Community 377`, `Community 126`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 82` to `Community 2`, `Community 3`, `Community 131`, `Community 5`, `Community 8`, `Community 9`, `Community 138`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 10`, `Community 18`, `Community 20`, `Community 21`, `Community 24`, `Community 26`, `Community 155`, `Community 28`, `Community 27`, `Community 32`, `Community 38`, `Community 169`, `Community 43`, `Community 177`, `Community 50`, `Community 54`, `Community 55`, `Community 187`, `Community 73`, `Community 76`, `Community 81`, `Community 84`, `Community 217`, `Community 94`, `Community 351`, `Community 121`, `Community 124`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Are the 437 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 437 INFERRED edges - model-reasoned connections that need verification._
