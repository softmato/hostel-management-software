...
## Corpus Check
- 1957 files · ~3,343,669 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15560 nodes · 42839 edges · 522 communities (498 shown, 24 thin omitted)
...
Cohesion: 0.02
Nodes (239): PATCH(), POST(), RouteContext, GET(), POST(), POST(), PATCH(), POST() (+231 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (171): FILTERS, Pending, MoneyData, MANAGE_ROWS, PORTAL_ROWS, TodayData, APP_ANSWERS, buildContactMethods() (+163 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (241): RouteContext, GET(), POST(), GET(), querySchema, getBillingPeriodSummary(), BillingRunInput, BillingRunQuery (+233 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (242): loadOverview(), loadMoney(), loadToday(), loadFinance(), getAdminFoodRoutine(), getAdminHostel(), getAdminInvoices(), getAdminMaintenance() (+234 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (184): BootGate(), ReviewForm(), ReviewScreen(), BrandSplash(), AuthDivider(), GoogleSignInButton(), RoleGate(), accentForAccount() (+176 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (135): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage() (+127 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (118): PlanPaymentClaim, UserRecord, GuardianDashboard, Payment, TABS, CreateWardenResult, PERMISSION_LABELS, PlatformCommunityPageContent (+110 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (165): AdminTabs(), HIDDEN, TABS, AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), Scanner(), FaqRow() (+157 more)
...
Cohesion: 0.03
Nodes (119): AccountDeletionPanel, DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton() (+111 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (117): Choice, MapScreen(), NOTHING_CHOSEN, PreviewCard(), ResultRow(), SavedHostelsScreen(), SavedListRow(), BrowseParams (+109 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (142): PaymentMonthStrip(), ManageRatesScreen(), ClearFilters(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard() (+134 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (146): listAttendanceAlerts(), listResidentGuardians(), listHostelAdminInquiries(), listPlatformHostels(), PaginationMeta, PaginationQuery, paginationRange(), querySchema (+138 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (136): FinanceAuditInput, approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal, checker (+128 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (115): AdminCommunityScreen(), AdminHomeScreen(), AdminOverviewScreen(), Overview, HOSTEL, MONTHS, UiPreview(), ACTION_TONES (+107 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (126): CommunityScreen(), Composer(), CommunityBoard(), CommunityBoardProps, Composer(), SORTS, CommentThread(), CommunityPostCard() (+118 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (107): FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, monthStartPeriod(), Rate, RoomTypeOption, gregorianSpan(), MonthField (+99 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (135): AdminCommunityReportsScreen(), AttendanceScreen(), NightStatusForm(), NightStatusScreen(), FILTERS, NotificationCard(), NotificationRow(), NotificationsScreen() (+127 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (114): listResidentComplaints(), outstandingForResident(), listFoodForResident(), submitFoodFeedback(), uploadFoodPhoto(), connectToDatabase(), auditLogSchema, depositRefundSchema (+106 more)

### Community 19 - "Community 19"
Cohesion: 0.06
Nodes (79): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, LoadState, CATEGORIES (+71 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (104): summarizeResidentComplaints(), getResidentFinanceView(), HostelLedger, HostelLedgerEntry, InvoiceMatrix, InvoiceMatrixRow, listResidentClaims(), NotBilled (+96 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (82): ComparePage(), hostels, metadata, rows, AuthExperiencePage(), csvField(), field(), Hostel (+74 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (97): GET(), POST(), querySchema, RouteContext, authorUserId, mocks, postId, residentId (+89 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (101): AdminAlertsScreen(), ICONS, LABELS, Segment, TONES, AdminMoneyScreen(), AdminTodayScreen(), AdminAlertsContext (+93 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (85): PRIORITIES, STATUS_ACTIONS, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel, GatewayConfig, GatewayHealthStatus (+77 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (94): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), sitemap() (+86 more)

### Community 26 - "Community 26"
Cohesion: 0.09
Nodes (63): accountDeletionCancelledEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), subscriptionClaimReceivedEmail(), subscriptionClaimRejectedEmail(), formatRupees(), subscriptionInvoiceEmail() (+55 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (91): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply() (+83 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (85): ownerIdentitiesFor(), cookLoginStem(), generateCookPassword(), mintCookLogin(), pick(), previousCookLabel(), cookPrincipal, mocks (+77 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (78): HostelSuggestions(), inferKind(), MediaLightbox(), PublicComparePage(), formatHostelAddress(), hostelTypeToUi(), mapPublicHostelToSummary(), PublicHostel (+70 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (90): Offset, PhotoCropper(), VideoSlot(), CollectionQrField(), FileUploadArea(), FileUploadArea(), isApplicationOpen(), ServiceProviderRegistrationPageContent() (+82 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (89): demoteToPublicAccount(), CapacityError, claimBedForRoomType(), listAllRoomTypes(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary() (+81 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (74): AuthGuard(), HostelRegistrationProgress(), Milestone, milestoneIndex(), MILESTONES, PaymentPanel(), rupees(), SubscriptionState (+66 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (65): csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, HostelTable(), Inquiry, LoadState (+57 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (82): GET(), HostelServiceError, hashUserAgent(), HostelRef, newVisitorKey(), recordHostelPageView(), resolveVisitorKey(), getPresignedReadUrl() (+74 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (80): POST(), GET(), POST(), GET(), purgeArchivedHostel(), purgeHostel(), DELETE(), GET() (+72 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (67): NotificationsPageContent(), Notification, FILTERS, Notification, NotificationRow(), PushState, FILTERS, NotificationCard (+59 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (58): AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow (+50 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (65): ApplyBlock(), ServiceProvidersScreen(), DocumentScreen(), MobileLegal, InfoActions(), InfoHeader(), InfoHighlights(), InfoIcon (+57 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (63): metadata, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails(), RenderedSection (+55 more)
...
Cohesion: 0.04
Nodes (76): mapped, GATEWAY_ORDER, getHostelPayMethods(), getPayInstructions(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions (+68 more)

### Community 42 - "Community 42"
Cohesion: 0.03
Nodes (57): GET(), authorUserId, leanResult(), mocks, postId, reactorUserId, residentIn(), assetId (+49 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (70): POST(), PLATFORM_ROLES, deviceTokenSchema, notificationSchema, notificationCampaignSchema, input, mocks, userId (+62 more)

### Community 44 - "Community 44"
Cohesion: 0.03
Nodes (64): CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing, CurrentUser (+56 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (58): PATCH(), RouteContext, PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), getPlatformSubscriptionLedger(), listPlanPaymentClaims(), GET() (+50 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (60): BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan, metadata, CommunityPageContent(), FeedPayload, SidebarPayload (+52 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (62): CommunityReportDialog(), REASONS, MonthOption(), BrowserPushRow(), ModerationButton(), PagerButton(), ReferenceCheck(), CodeChip() (+54 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (69): collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor(), LedgerInvoice (+61 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (57): GET(), POST(), GET(), resolveOwnedHostel(), getPlanPaymentInstructions(), getSubscriptionState(), DELETE(), POST() (+49 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (57): AttendanceCalendar(), EMPTY_SUMMARY, HostelAdminCooksPanel, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS (+49 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (63): auditFinanceAction(), previousEntryHash(), write(), BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure (+55 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (59): methodProvider(), createResident(), getIntakeQuote(), IntakeQuote, lookupResidentProfile(), RESIDENT_TYPES, ResidentIntakeResult, ResidentOccupancy (+51 more)
...
Cohesion: 0.06
Nodes (54): JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, ProviderStatusCard(), TILE_INK (+46 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (61): arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal, alreadyReviewedError() (+53 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (53): addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery, HostelAdminInquiryStatusInput, InquiryNoteCreateInput, InquiryNoteRecord, InquiryRecord (+45 more)
...
Cohesion: 0.05
Nodes (52): dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, getFoodRoutinesByHostelId(), isMonthEnd(), mealsOn() (+44 more)

### Community 63 - "Community 63"
Cohesion: 0.06
Nodes (59): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags(), documentFlags() (+51 more)

### Community 64 - "Community 64"
Cohesion: 0.05
Nodes (49): serviceProviderSchema, serviceProviderApplicationSchema, serviceProviderDocumentSchema, DirectoryPageProps, EMPTY, metadata, ServiceProviderDirectoryPage(), ServiceProvidersPage() (+41 more)
...
Cohesion: 0.08
Nodes (35): POST(), POST(), POST(), POST(), POST(), safeEqual(), periodOf(), runBillingCycleForAllHostels() (+27 more)

### Community 69 - "Community 69"
Cohesion: 0.05
Nodes (39): EMPTY_DRAFT, HostelAdminPaymentProfilePageContent, PaymentProfile, SECTION_FIELDS, SectionId, BankMark(), EsewaMark(), KhaltiMark() (+31 more)
...
Cohesion: 0.07
Nodes (42): DeviceLocationStatus, hasGeolocation(), LocationOutcome, NavigationFix, OrientationPermission, requestDeviceLocation(), requestHeadingPermission(), Unsubscribe (+34 more)
...
Cohesion: 0.09
Nodes (38): CSV_COLUMNS, GET(), GET(), periodTotals(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS (+30 more)

### Community 77 - "Community 77"
Cohesion: 0.06
Nodes (36): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, AuthShell(), AuthShellProps, PANEL_COPY (+28 more)
...
Cohesion: 0.06
Nodes (36): LIVE_ACCESS, releaseGuardianAccounts(), hostelId, mocks, userId, daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess() (+28 more)
...
Cohesion: 0.1
Nodes (42): AssetViewer(), useViewerState(), ViewerPage(), ManageFinanceScreen(), ManagePaymentSetupScreen(), clampIndex(), closeAssetViewer(), emit() (+34 more)

### Community 83 - "Community 83"
Cohesion: 0.07
Nodes (38): afterResponse(), mocks, CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, readId(), activeDevicesFor(), activeTokensFor() (+30 more)

### Community 84 - "Community 84"
Cohesion: 0.07
Nodes (42): AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance(), deadline(), DIGIT_CONFUSABLES, EvidenceRead (+34 more)

### Community 85 - "Community 85"
Cohesion: 0.07
Nodes (38): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput, ConsentInput (+30 more)
...
Cohesion: 0.06
Nodes (33): platformSettingSchema, qrActivationSchema, DEFAULT_OPERATIONS_CONFIG, OperationsConfig, operationsConfigSchema, PlatformSettingRecord, saveOperationsConfig(), before (+25 more)
...
Cohesion: 0.09
Nodes (32): deleteHostelObjects(), FILE_ASSET_KINDS, FileAssetKind, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES (+24 more)

### Community 93 - "Community 93"
Cohesion: 0.05
Nodes (38): complaintCategorySchema, complaintCreateSchema, complaintListQuerySchema, complaintReplySchema, complaintResolutionConfirmSchema, complaintStatusSchema, complaintStatusUpdateSchema, objectIdSchema (+30 more)

### Community 94 - "Community 94"
Cohesion: 0.07
Nodes (33): dayOfWeekSchema, foodFeedbackSchema, foodMenuCreateSchema, foodMenuListQuerySchema, foodMenuUpdateSchema, foodRoutineSaveSchema, mealTypeSchema, objectIdSchema (+25 more)

### Community 95 - "Community 95"
Cohesion: 0.11
Nodes (35): idCardIssuedEmail(), robots(), CARD_NOUNS, CardVariant, drawBack(), drawBrandLockup(), drawFooterSweep(), drawFront() (+27 more)

### Community 96 - "Community 96"
Cohesion: 0.1
Nodes (33): announceFoodReady(), ROUTINE_DAYS, ROUTINE_MEAL_TYPES, RoutineDay, RoutineMealType, Candidate, dueMeals(), MealCallReminderResult (+25 more)

### Community 97 - "Community 97"
Cohesion: 0.11
Nodes (34): HostelScope, ResolvedDocument, resolveInvoiceDocument(), resolveReceiptDocument(), scopeFilter(), settledTotal(), trySoftmato(), InvoiceDocumentInput (+26 more)

### Community 98 - "Community 98"
Cohesion: 0.05
Nodes (32): DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), axisMonth(), monthLabel(), toNumber() (+24 more)
...
Cohesion: 0.07
Nodes (17): hasFood(), PublicHostelListingPage(), PublicInquiryPage(), PublicInquiryPageContent(), ComparePageSkeleton(), HostelDetailPageSkeleton(), HostelListingPageSkeleton(), InquiryPageSkeleton() (+9 more)

### Community 101 - "Community 101"
Cohesion: 0.08
Nodes (35): added, arrangeSettlement(), catalog, dueAt, filed, hostelId, invoice(), invoiceId (+27 more)
...
Cohesion: 0.07
Nodes (29): FeeScheduleRecord, key(), ListingHostel, ListingProjection, projectSchedule(), projectScheduleOntoListing(), RoomConfiguration, hostel (+21 more)
...
Cohesion: 0.11
Nodes (34): money(), PlanCard(), pricePlan(), listHeadingFor(), PlanCard(), CatalogueTab(), CycleDiscount(), PublicServiceDetailPage() (+26 more)

### Community 110 - "Community 110"
Cohesion: 0.06
Nodes (29): fromBs(), gregorianOf(), BillableResident, { amount }, asar(), bhadra(), byRoomType, charge (+21 more)
...
Cohesion: 0.11
Nodes (30): UploadCard(), UploadToaster(), useIsUploading(), useUploads(), dismissUpload(), emit(), listeners, pruneUploads() (+22 more)
...
Cohesion: 0.1
Nodes (31): activateResident(), ApiFailure, apiRequest(), ApiSuccess, AuthUser, confirmComplaintResolution(), createResidentComplaint(), getActivationStatus() (+23 more)

### Community 116 - "Community 116"
Cohesion: 0.12
Nodes (24): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, ImageVariantRecord (+16 more)
...
Cohesion: 0.1
Nodes (29): maneuverIcon(), NavCard(), cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath(), formatManeuverDistance() (+21 more)
...
Cohesion: 0.12
Nodes (23): native, NativeDownloads, openDownloaded(), SavedDownload, isNightStatusPrompt(), NIGHT_STATUS_ACTIONS, NIGHT_STATUS_BUTTONS, NIGHT_STATUS_REASONS (+15 more)
...
Cohesion: 0.09
Nodes (29): daysBetween(), deliver(), DunningAction, DunningStage, DunningState, escalateToHostel(), InvoiceRow, nextDunningAction() (+21 more)
...
Cohesion: 0.09
Nodes (21): PortalShell(), hostelAdminHref(), PLATFORM_MODERATOR_NAV, PLATFORM_MODERATOR_SEARCH_ENTRIES, PLATFORM_NAV, PLATFORM_SEARCH_ENTRIES, PortalIconName, PortalNavGroup (+13 more)
...
Cohesion: 0.15
Nodes (26): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt, readReturnState() (+18 more)
...
Cohesion: 0.1
Nodes (25): approveClaim(), assertNotAlreadyRecordedFromStatement(), bulkApproveClaims(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck(), evidenceCheck() (+17 more)
...
Cohesion: 0.1
Nodes (24): softmatoDocsUrl(), dueBhadra29, filed, throughAswin25, CYCLE_LABELS, daysLeftThrough(), daysSpanned(), daysUntil() (+16 more)
...
Cohesion: 0.11
Nodes (15): secretsMatch(), ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, BASE_URLS, GatewayProvider, IntentHandoff (+7 more)
...
Cohesion: 0.14
Nodes (23): ReferralBody(), ReferralRow(), ReferralsScreen(), getResidentReferral(), Referral, ReferralCode, ReferralReward, ReferralStatus (+15 more)
...
Cohesion: 0.13
Nodes (21): AttachedFile(), ApiFailure, EXTENSION_MIME, isAudio(), PickedFile, resolveFileName(), resolveMimeType(), name (+13 more)

### Community 144 - "Community 144"
Cohesion: 0.11
Nodes (21): normalize(), PortalSearch(), PortalTone, scoreEntry(), toneStyles, iconMap, IconName, NavItem (+13 more)

### Community 145 - "Community 145"
Cohesion: 0.15
Nodes (23): bsMonthStart(), hostelToday(), rateForRoomType(), hostelCalendarDay(), hostelMonthStart(), hostelPeriodOf(), hostelToday(), once (+15 more)
...
Cohesion: 0.11
Nodes (21): sponsorSchema, assertWindow(), CreateInput, createSponsor(), deleteSponsor(), listLiveSponsors(), ListQuery, listSponsors() (+13 more)
...
Cohesion: 0.14
Nodes (19): Guidance, GuidanceStatus, useGuidance(), NearbyStatus, Coordinates, hasLocationPermission(), hasPromptedForLocation(), LocationOutcome (+11 more)
...
Cohesion: 0.12
Nodes (22): 5.1 SOS Triggered, 5. Safety & Emergency Emails, 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, 7.1 New Hostel Pending Approval (to Superadmin) (+14 more)
...
Cohesion: 0.13
Nodes (16): getResidentProfile(), login(), ResidentNightStatus, submitResidentReview(), RootStackParamList, LoginScreen(), Props, Props (+8 more)
...
Cohesion: 0.17
Nodes (18): AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim(), buildAddressQuery(), definedParts(), geocodeWithGoogle(), geocodeWithNominatim(), GoogleAddressComponent (+10 more)
...
Cohesion: 0.11
Nodes (18): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), FeeScheduleCloseInput, feeScheduleCloseSchema, FeeScheduleCreateInput (+10 more)

### Community 187 - "Community 187"
Cohesion: 0.1
Nodes (17): aswin, bhadra, bs(), card(), currentId, hostelId, inAswin, inOctober (+9 more)
...
Cohesion: 0.15
Nodes (16): registerNightStatusCategory(), claimNotificationSound(), claims, resetNotificationSoundClaims(), createAndroidChannels(), easProjectId(), fetchExpoPushToken(), forgetPushToken() (+8 more)
...
Cohesion: 0.22
Nodes (18): deliver(), loadInvoiceById(), loadProof(), PlanPaymentInstructions, ProofAsset, reviewPlanPaymentClaim(), submitPlanPaymentClaim(), appBase() (+10 more)
...
Cohesion: 0.12
Nodes (20): 5.1 Service Provider Registration, 5.2 Hostel Maintenance Module, 5.3 Hostel Comparison, 5.4 Referral System, 5.5 Duplicate / Ghost Listing Detection, 5.7 Production Hardening, 5.8 QA Tasks, 5.9 Phase 5 Done Means (+12 more)
...
Cohesion: 0.13
Nodes (15): questionCallClickSchema, ClickRecord, getQuestionCallStatus(), QuestionCallAnalyticsQuery, questionCallBaseUrl(), QuestionCallClickInput, QuestionCallConversionInput, QuestionCallServiceError (+7 more)
...
Cohesion: 0.25
Nodes (18): AuditLog, code:typescript (interface IHostelPageView {), code:typescript (// One per resident, per hostel. Minted lazily on first dash), code:typescript (interface ISubscription {), code:typescript (interface IPlatformSetting {), code:typescript (interface IAuditLog {), code:typescript ({), code:typescript ({) (+10 more)
...
Cohesion: 0.16
Nodes (16): 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.3 Payment Proof Uploaded (to Admin), 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, 4.1 New Notice Posted, 4.2 Complaint Status Updated (+8 more)
...
Cohesion: 0.15
Nodes (11): AuthSession, register(), verifyOtp(), AppNavigator(), Stack, OtpVerificationScreen(), Props, ResidentActivationScreen() (+3 more)

### Community 231 - "Community 231"
Cohesion: 0.23
Nodes (16): AttendanceAlert, AttendanceLog, code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({), FoodReadyLog (+8 more)
...
Cohesion: 0.27
Nodes (9): buildShell(), MapExplorer, MapExplorerProps, MapHandle, MapMarker, inlineJson(), MAP_LAYERS, mapLayer() (+1 more)
...
Cohesion: 0.18
Nodes (11): 10.1 GitHub Actions Workflow, 10.2 Merge Rules, 10. CI/CD Integration, 7.2 Role Gate Test Template, 9.2 Test Database Isolation, code:typescript (describe('GET /api/v1/hostel/rooms - role access', () => {), code:typescript (describe('GET /api/v1/guardian/linked-resident - privacy', (), code:typescript (// In test setup (e.g., jest.setup.ts)) (+3 more)
...
Cohesion: 0.35
Nodes (11): code:typescript ({), code:typescript ({), code:typescript (interface IQuestionCallClick {), code:typescript ({), Community Feature, CommunityComment, CommunityPost, CommunityReaction (+3 more)
...
Cohesion: 0.2
Nodes (8): khaltiProvider, attempt, fetchMock, initiated, live, request, sandbox, GatewayCredentials
...
Cohesion: 0.5
Nodes (6): InquiryLinkScreen(), isValidReferralCode(), normalizeReferralCode(), parseReferralLink(), safeDecode(), valid()
...
Cohesion: 0.29
Nodes (5): ThemeToggle(), ThemeToggleProps, navItems, GUARDIAN_NAV, GUARDIAN_SEARCH_ENTRIES
...
Cohesion: 0.38
Nodes (6): categoryLabel(), PROVIDER_CATEGORIES, ProviderCard(), ProviderDirectoryData, PublicProvider, PublicServiceProviderDirectoryPage()

### Community 394 - "Community 394"
Cohesion: 0.29
Nodes (5): base, entityId, hostelId, mocks, principal
...
## Knowledge Gaps
- **5497 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+5492 more)
...
- **Why does `Button()` connect `Community 1` to `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 144`, `Community 23`, `Community 33`, `Community 36`, `Community 38`, `Community 39`, `Community 40`, `Community 47`, `Community 50`, `Community 52`, `Community 54`, `Community 70`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 47` to `Community 1`, `Community 5`, `Community 6`, `Community 264`, `Community 9`, `Community 16`, `Community 144`, `Community 19`, `Community 21`, `Community 24`, `Community 25`, `Community 29`, `Community 30`, `Community 32`, `Community 33`, `Community 36`, `Community 39`, `Community 44`, `Community 46`, `Community 50`, `Community 66`, `Community 72`, `Community 100`, `Community 105`, `Community 109`, `Community 369`, `Community 124`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 18` to `Community 0`, `Community 130`, `Community 2`, `Community 131`, `Community 133`, `Community 263`, `Community 8`, `Community 12`, `Community 13`, `Community 145`, `Community 20`, `Community 22`, `Community 151`, `Community 150`, `Community 153`, `Community 25`, `Community 27`, `Community 28`, `Community 31`, `Community 34`, `Community 35`, `Community 37`, `Community 41`, `Community 43`, `Community 301`, `Community 45`, `Community 48`, `Community 49`, `Community 51`, `Community 55`, `Community 56`, `Community 57`, `Community 60`, `Community 62`, `Community 63`, `Community 64`, `Community 67`, `Community 68`, `Community 197`, `Community 196`, `Community 203`, `Community 76`, `Community 79`, `Community 81`, `Community 83`, `Community 85`, `Community 86`, `Community 89`, `Community 92`, `Community 94`, `Community 96`, `Community 97`, `Community 101`, `Community 106`, `Community 370`, `Community 119`, `Community 121`, `Community 122`, `Community 126`, `Community 127`?**
...
- **What connects `iosUrlScheme`, `{ defineConfig }`, `expoConfig` to the rest of the system?**
  _5497 weakly-connected nodes found - possible documentation gaps or missing edges._
