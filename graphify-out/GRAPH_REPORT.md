...
## Corpus Check
- 2323 files · ~4,847,105 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18634 nodes · 52381 edges · 608 communities (574 shown, 34 thin omitted)
...
## Communities (608 total, 34 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (327): GET(), PATCH(), POST(), RouteContext, GET(), GET(), POST(), PATCH() (+319 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (214): FILTERS, Pending, MoneyData, MANAGE_ROWS, PORTAL_ROWS, TodayData, FILTERS, NIGHT_ANSWER_LABELS (+206 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (304): answerSchema, ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+296 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (283): MESSAGES, POST(), RouteContext, GET(), announceConfirmed(), announceEnding(), assertAwaitingAnswer(), cancelBookingByHostel() (+275 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (225): Scanner(), CookInviteScreen(), GuardianInviteScreen(), Choice, Compass(), MapButton(), MapScreen(), ModeTab() (+217 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (180): FieldCashRow, PlanPaymentClaim, formatBsAdDate(), DeletionPathway, DeletionStatus, PATHWAY_COPY, Filter, ModeratedPost (+172 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (260): loadOverview(), loadMoney(), loadToday(), loadFinance(), getAdminCommunityModeration(), getAdminFoodRoutine(), getAdminHostel(), getAdminInvoices() (+252 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (209): AdminMoreScreen(), ActivateScreen(), APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard() (+201 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (171): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CancelDeletionPageContent(), CommunityModerationPanel(), AcceptResult, CookInvitePageContent (+163 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (174): POST(), POST(), POST(), POST(), POST(), attacker, attempt(), headers (+166 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (187): PATCH(), RouteContext, GET(), querySchema, GET(), recordListingAppearances(), addHostelAdminInquiryNote(), auditInquiryAction() (+179 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (165): AdminCommunityScreen(), AdminCommunityReportsScreen(), AdminResidentsScreen(), AttendanceScreen(), NightStatusHistoryScreen(), NightStatusForm(), NightStatusScreen(), nightAnswerText() (+157 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (118): GET(), POST(), adminPrincipal, mocks, PLATFORM_LIMITS, POST(), POST(), assetId (+110 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (134): POST(), cookLoginStem(), generateCookPassword(), mintCookLogin(), pick(), previousCookLabel(), cookPrincipal, mocks (+126 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (123): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), manifest() (+115 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (112): Platform, ConcessionBackfill, describeApplied(), FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, MonthDiscounts, monthStartPeriod() (+104 more)

### Community 16 - "Community 16"
Cohesion: 0.07
Nodes (105): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), submitFieldCash(), dueWhen(), PlanDueInput (+97 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (129): CentrePin(), describeAddress(), HostelPinField(), HostelPinPicker(), KATHMANDU, MapLinkField(), PickerBody(), PinAddress (+121 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (132): ReviewForm(), ReviewScreen(), ResidentHomeActions(), ResidentHomeHeader(), ResidentQuickActions(), ResidentRecordRows(), ResidentServiceGrid(), ResidentWaitingActions() (+124 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (124): Offset, PhotoCropper(), VideoSlot(), CollectionQrField(), OperationsConfig, PendingSettingChange, PlanDueReminderSchedule, PlanReminderStep (+116 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (109): BubbleBackground(), BubbleBackgroundProps, BubbleColors, StarLayer(), StarLayerProps, StarsBackground(), StarsBackgroundProps, CommunityReportDialog() (+101 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (115): DELETE(), RouteContext, GET(), POST(), querySchema, RouteContext, authorUserId, mocks (+107 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (128): bsMonthStart(), formatBsDayRange(), fromBs(), gregorianOf(), BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult (+120 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (129): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES (+121 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (120): PaymentMonthStrip(), ClearFilters(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard(), AmountCard() (+112 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (113): invalidateFeeds(), CommunityScreen(), Composer(), AnimatedBlurView, CommunityBoard(), CommunityBoardProps, Composer(), NotificationBell() (+105 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (115): GET(), POST(), DELETE(), PATCH(), RouteContext, GET(), PATCH(), requireSuperadminPrincipal() (+107 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (98): Overview, HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+90 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (110): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, notifyHostelOfNewPost(), resolveHostelCommunityUserIds() (+102 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (110): AdminAlertsScreen(), ICONS, LABELS, Segment, TONES, AdminHomeScreen(), AdminOverviewScreen(), AdminMoneyScreen() (+102 more)

### Community 30 - "Community 30"
Cohesion: 0.02
Nodes (93): EMPTY_PAYOUT_DRAFT, METHODS, PayoutAccountDraft, PayoutAccountFields(), payoutAccountPayload(), DescriptionFacts, DescriptionSuggestions(), HostelType (+85 more)

### Community 31 - "Community 31"
Cohesion: 0.02
Nodes (96): GetPlanButton(), TIER_TONE, EASE, listHeadingFor(), PlanCards(), PlanLine(), PlansClosingCta(), PlansEditor (+88 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (88): POST(), GET(), POST(), findResidentOwnedAccess(), revokeGuardianAccess(), updateGuardianPermissions(), purgeArchivedHostel(), purgeHostel() (+80 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (83): HostelAdminMaintenancePageContent, PRIORITIES, STATUS_ACTIONS, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel, GatewayConfig (+75 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (85): BookingQuote, GuestBookingDetail, GuestBookingSummary, metadata, BookingCheckoutPage(), Method, METHODS, nextStep() (+77 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (67): GenericPortalScreen(), portalRows(), portalTitle(), hasFood(), LoadState, PublicHostelListingPageContent(), PublicInquiryPage(), PublicInquiryPageContent() (+59 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (82): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), methodProvider(), PROVIDER_LABEL, QrPanel() (+74 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (69): BookButton(), SIZE, BookingAvailabilityView, BookingButton, CLOSED_REASONS, open, HostelPhotoReminder(), HostelSuggestions() (+61 more)

### Community 38 - "Community 38"
Cohesion: 0.02
Nodes (45): deleteHostelObjects(), ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, RETAINED_BY_HOSTEL_ID, both (+37 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (81): openStore(), NoticeArt(), ManageRatesScreen(), createManagedNotice(), createNoticePush(), deleteNoticePush(), NOTICE_CATEGORIES, NoticeAudience (+73 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (71): POST(), AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, hostelToday(), findSuspendedHostelIds() (+63 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (77): approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal, checker, eventId (+69 more)

### Community 42 - "Community 42"
Cohesion: 0.03
Nodes (64): secretsMatch(), ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, attempt, fetchMock, forged (+56 more)

### Community 43 - "Community 43"
Cohesion: 0.03
Nodes (74): deviceTokenSchema, noticeReadStatusSchema, mocks, noticeInput, residentUserId, staffPrincipal, broadcastNotice(), BroadcastOptions (+66 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (59): AuthShell(), AuthShellProps, PANEL_COPY, SiteWordmark(), metadata, AccountDeletionPanel, ContentHeader(), ContentIntro() (+51 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (55): ComparePage(), generateMetadata(), hostels, metadata, rows, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminRoomsPageContent() (+47 more)

### Community 46 - "Community 46"
Cohesion: 0.03
Nodes (65): normalize(), PortalSearch(), PortalTone, scoreEntry(), toneStyles, iconMap, IconName, NavItem (+57 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (73): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register() (+65 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (62): bsPeriodBounds(), periodStartDate(), defaultDueDate(), periodCoverage(), hostelPeriodOf(), BillPreview, CheckContext, CheckedRow (+54 more)
...
Cohesion: 0.05
Nodes (60): notifyProviderOfAssignment(), notifyProviderOfStatusChange(), notifyStaffOfJobProgress(), notifyStaffOfNewMaintenanceRequest(), providerUserId(), readableCategory(), RequestLike, STATUS_WORDS (+52 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (28): InlineText(), PlatformConfigAnnouncementsPageContent, PlatformConfigContentPageContent, PlatformConfigFacilitiesPageContent, FLAGS, PlatformConfigFeaturesPageContent, PlatformConfigLegalPageContent, PlatformConfigLocationsPageContent (+20 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (59): AttachmentGallery(), ComplaintDetail(), ComplaintDetailScreen(), ComplaintCard(), ComplaintsScreen(), needsResident(), OPEN_STATUSES, rank() (+51 more)
...
Cohesion: 0.05
Nodes (59): DELETE(), POST(), PaginationQuery, platformPushScheduleSchema, CampaignListQuery, CampaignRecord, createCampaign(), createHostelNotificationCampaign() (+51 more)
...
Cohesion: 0.06
Nodes (54): collectionTotals(), countInvoicesByField(), monthlySeries(), countListingAppearances(), getHostelViewStats(), complaintSchema, foodFeedbackSchema, listingFlagSchema (+46 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (49): asRecord(), DrawnPush, readDrawnPush(), message, pushData, configureNativeNightPrompt(), NativeNightPrompt, takeNativePendingAnswers() (+41 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (56): BookingForm(), CheckoutScreen(), METHODS, PackageCard(), PayStep(), roomPhotoUris(), StatusCard(), answerHostelBooking() (+48 more)

### Community 59 - "Community 59"
Cohesion: 0.06
Nodes (60): personalLookupHash(), getPresignedReadUrl(), notificationSchema, userResidentProfileSchema, findLiveResidency(), LIVE_STATUSES, LiveResidency, LiveRow (+52 more)

### Community 60 - "Community 60"
Cohesion: 0.06
Nodes (63): directionFlags(), evidenceFlags(), payeeFlags(), AMOUNT_LABELS, canonical(), canonicalDigits(), containsWithTolerance(), deadline() (+55 more)
...
Cohesion: 0.06
Nodes (42): SosScreen(), AdminSearchBar(), BottomChrome, BottomChromeContext, BottomChromeProvider(), CHROME_TIMING, useBottomChrome(), cropToGuide() (+34 more)
...
Cohesion: 0.06
Nodes (59): arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal, alreadyReviewedError() (+51 more)

### Community 65 - "Community 65"
Cohesion: 0.07
Nodes (49): bodySchema, POST(), POST(), RouteContext, computePerceptualHash(), systemDocumentKind(), hashUserAgent(), HostelRef (+41 more)
...
Cohesion: 0.06
Nodes (54): formatPeriodKey(), cellAt(), focusCell(), INPUT_MODES, Props, fullYear(), MONTH_SPELLINGS, monthFromWord() (+46 more)

### Community 68 - "Community 68"
Cohesion: 0.05
Nodes (49): filterPushRecipients(), CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, isPlanDueNotification(), readId(), activeDevicesFor(), activeTokensFor() (+41 more)

### Community 69 - "Community 69"
Cohesion: 0.05
Nodes (51): otpResendCooldownMs(), softmatoDocsUrl(), dueBhadra29, filed, throughAswin25, BillingHistory, BillingInvoiceRow, BillingPaymentRow (+43 more)

### Community 70 - "Community 70"
Cohesion: 0.06
Nodes (50): BookingPaymentToCheck, TransferView, HostelBookingView, PlatformBookingView, PayoutAccountForReview, PayoutAccountView, ReviewPayoutAccount(), STATUS_LABEL (+42 more)

### Community 71 - "Community 71"
Cohesion: 0.05
Nodes (42): metadata, CheckoutHandoffButton(), Handoff, ORDER, ProgressStep, TransitionScreen(), useCheckoutHandoff(), Badge() (+34 more)

### Community 72 - "Community 72"
Cohesion: 0.07
Nodes (56): fill(), money(), PlanCard(), PricingScreen(), changeOpenInvoiceMonths(), invoiceMonthsLocked(), PaymentRecord, pricePlan() (+48 more)

### Community 73 - "Community 73"
Cohesion: 0.04
Nodes (44): financeIntegrityHash(), getCreditBalance(), Entry, eventId, hostelId, invoiceId, mocks, residentId (+36 more)

### Community 74 - "Community 74"
Cohesion: 0.05
Nodes (48): qrActivationSchema, before, expiresAt, mocks, staffPrincipal, activateResident(), ActivationCodeGenerateInput, ActivationCodeInput (+40 more)

### Community 75 - "Community 75"
Cohesion: 0.07
Nodes (49): ApiFailure, assertMatchesExtension(), beginDownload(), downloadAndShare(), downloadAndShareCsv(), downloadAndShareImage(), downloadToDevice(), forgetDownloadFolder() (+41 more)

### Community 76 - "Community 76"
Cohesion: 0.04
Nodes (27): generateMetadata(), PublicBookingGuidePage(), PublicHostelListingPage(), ComparePageSkeleton(), HostelDetailPageSkeleton(), HostelListingPageSkeleton(), InquiryPageSkeleton(), PublicRefundPolicyPage() (+19 more)

### Community 77 - "Community 77"
Cohesion: 0.06
Nodes (32): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, metadata, LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminMoveChecklistPage() (+24 more)

### Community 78 - "Community 78"
Cohesion: 0.05
Nodes (47): getR2Client(), classifyCredit(), CreditClassification, LadderClaim, LadderInvoice, MatchContext, normalizeTxnId(), ANITA_CODE (+39 more)

### Community 79 - "Community 79"
Cohesion: 0.04
Nodes (31): useConfirm(), ExistingResidentsPanel(), Props, ExistingResidentsSheet(), HostelAdminExistingResidentsPage(), AUDIENCE_LABEL, PlatformPushPageContent, PushRecord (+23 more)

### Community 80 - "Community 80"
Cohesion: 0.07
Nodes (51): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodOf() (+43 more)

### Community 81 - "Community 81"
Cohesion: 0.08
Nodes (46): storeOrderSchema, formatNpr(), itemsTable(), StoreEmailItem, mocks, allocateOrderNumber(), applyStatus(), CancelInput (+38 more)

### Community 82 - "Community 82"
Cohesion: 0.06
Nodes (49): maneuverIcon(), NavCard(), CARDINALS, chooseHeading(), directionWord(), distanceToPath(), formatManeuverDistance(), hasArrived() (+41 more)

### Community 83 - "Community 83"
Cohesion: 0.06
Nodes (42): idCardIssuedEmail(), serviceProviderApplicationSchema, serviceProviderDocumentSchema, hostelId, mocks, providerId, notifyServiceProviderDecision(), ACTIVE_APPLICATION_STATUSES (+34 more)

### Community 84 - "Community 84"
Cohesion: 0.05
Nodes (49): buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, draftFromProfile(), emptyIdentityDraft(), firstIncompleteIdentityStep() (+41 more)
...
Cohesion: 0.07
Nodes (45): noticePushSchema, announceChange(), audit(), CreateInput, createNoticePush(), DEFAULT_PUSHES, deleteNoticePush(), emitNoticePush() (+37 more)

### Community 87 - "Community 87"
Cohesion: 0.05
Nodes (43): approveClaim(), assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck(), evidenceCheck(), fileCheck() (+35 more)

### Community 88 - "Community 88"
Cohesion: 0.07
Nodes (44): Guidance, GuidanceStatus, proximityScore(), hasGeolocation(), LocationOutcome, NavigationFix, OrientationPermission, requestDeviceLocation() (+36 more)

### Community 89 - "Community 89"
Cohesion: 0.07
Nodes (40): isAuthBypassEnabled(), original, CookieReader, hasSessionCookie(), LEGACY_ACCESS_TOKEN_COOKIES, LEGACY_REFRESH_TOKEN_COOKIES, readAccessTokenCookie(), readRefreshTokenCookieValue() (+32 more)

### Community 90 - "Community 90"
Cohesion: 0.05
Nodes (27): field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), LoadState, NightStatusRow, Notification (+19 more)

### Community 91 - "Community 91"
Cohesion: 0.05
Nodes (44): hostelDayParts(), HOSTEL_AGREEMENT_STATUSES, hostelAgreementSchema, PLATFORM_DOCUMENT_KINDS, platformDocumentSequenceSchema, TRACK_SHEET_EVENT, joinedDateText(), AGREEMENT_STATUSES (+36 more)

### Community 92 - "Community 92"
Cohesion: 0.08
Nodes (42): nepalMinuteOfDay(), nightStatusPromptSchema, askingEndsAt(), askingEndsMinuteOfNight(), formatPromptTime(), isCurrentNight(), isSameNight(), minuteIsDue() (+34 more)
...
Cohesion: 0.08
Nodes (48): demoteToPublicAccount(), findHeldBooking(), liveResidencyMessage(), addEmergencyContact(), addGuardian(), auditResidentAction(), BedRecord, createResident() (+40 more)
...
Cohesion: 0.07
Nodes (35): PATCH(), ratingReviewSchema, auditReviewAction(), averageOf(), createResidentReview(), hideReview(), listPlatformReviews(), listPublicHostelReviews() (+27 more)

### Community 97 - "Community 97"
Cohesion: 0.13
Nodes (39): BOOKING_DOCUMENT_KINDS, BookingDocumentInput, BookingDocumentKind, renderBookingDocument(), bsFiscalYear(), amountInWords(), GROUPS, ONES (+31 more)
...
Cohesion: 0.05
Nodes (34): PortalDates, useHostelDayTurn(), AdminNightStatusRow, PlanBillingInvoice, PlanBillingPayment, PlanBillingPlan, filterRollCall(), NightStatusValue (+26 more)
...
Cohesion: 0.07
Nodes (40): GuardianHomeScreen(), GuardianMetrics(), GuardianMoreScreen(), GuardianPaymentsScreen(), GuardianSafetyScreen(), acceptGuardianInvitation(), getGuardianFood(), getGuardianNotices() (+32 more)
...
Cohesion: 0.07
Nodes (33): PLATFORM_SETTING_CHANGE_STATUSES, platformSettingChangeSchema, bookings, CollectionQr, isSettingChangeKey(), SETTING_CHANGES, SettingChangeDefinition, SettingChangeKey (+25 more)

### Community 105 - "Community 105"
Cohesion: 0.07
Nodes (37): announceFoodReady(), ROUTINE_DAYS, ROUTINE_MEAL_TYPES, RoutineDay, RoutineMealType, Candidate, dueMeals(), MealCallReminderResult (+29 more)

### Community 106 - "Community 106"
Cohesion: 0.07
Nodes (40): HostelScope, ResolvedDocument, resolveInvoiceDocument(), resolveReceiptDocument(), scopeFilter(), settledTotal(), softmatoDocument(), mocks (+32 more)

### Community 107 - "Community 107"
Cohesion: 0.06
Nodes (35): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse (+27 more)

### Community 108 - "Community 108"
Cohesion: 0.07
Nodes (32): generateMetadata(), metadata, CommunityPageContent(), FeedPayload, NewPostAlertsToggle(), SidebarPayload, Space, SpacesPayload (+24 more)

### Community 109 - "Community 109"
Cohesion: 0.09
Nodes (39): renderOtpEmail(), sendResendOtp(), deliver(), Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity (+31 more)
...
Cohesion: 0.09
Nodes (23): AdminTabs(), HIDDEN, RoleLayout(), TABS, TABS, DISSOLVE, RoleTabs(), TabBarProps (+15 more)

### Community 115 - "Community 115"
Cohesion: 0.06
Nodes (27): currency(), EmptyState(), Input(), ResidentActivationPageContent, ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent (+19 more)
...
Cohesion: 0.07
Nodes (35): HostelAdminResidentsPage, humanizeValue(), ImportedProfileSummary(), PrefillOccupancy, PrefillPhoto, ResidentPrefill, ResidentStatus, STATUS_ACTIONS (+27 more)

### Community 118 - "Community 118"
Cohesion: 0.11
Nodes (41): documentDownloadUrl(), issueInvoiceDocument(), fileFieldCash(), allocateNumber(), ensureInvoiceRaised(), findOpenInvoice(), getOrCreateSubscription(), graceDeadline() (+33 more)
...
Cohesion: 0.09
Nodes (38): addToCart(), cancelStoreOrder(), Cart, CartLine, CartResult, CartTotals, clearCart(), getCart() (+30 more)
...
Cohesion: 0.06
Nodes (25): csvField(), field(), Hostel, HostelAdminProfilePageContent(), Inquiry, LoadState, numberField(), optionalField() (+17 more)

### Community 124 - "Community 124"
Cohesion: 0.07
Nodes (33): REALTIME_TOPIC_VALUES, resetQueryCache(), again, first, june, listener, load, may (+25 more)
...
Cohesion: 0.06
Nodes (25): EASE, FaqEntry, FaqRole, FaqRow(), FAQS, PlansFaq(), PREVIEW_ROWS, PREVIEWS (+17 more)

### Community 128 - "Community 128"
Cohesion: 0.09
Nodes (24): METHODS, PayDialog(), rupees(), TeamCommissionPanel(), TeamWallet, blankRow(), Row, TeamInviteBox() (+16 more)

### Community 129 - "Community 129"
Cohesion: 0.09
Nodes (35): CookTodayScreen(), announcedCount(), announcementSummary(), CookPhotoDay, MealButton, mealButtonLabel(), mealButtons(), MealButtonsInput (+27 more)
...
Cohesion: 0.07
Nodes (30): aswin, bhadra, bs(), card(), currentId, hostelId, inAswin, inOctober (+22 more)

### Community 133 - "Community 133"
Cohesion: 0.08
Nodes (24): Choice, HOSTEL_TYPE_LABELS, MapButton(), MapCanvas, ModeTab(), NavigationPanel(), NOTHING_CHOSEN, PublicMapPage() (+16 more)

### Community 134 - "Community 134"
Cohesion: 0.07
Nodes (21): Panel(), TextArea(), field(), HostelAdminReferralsPageContent(), HostelAdminServiceProvidersPageContent(), ListingFlag, LoadState, MaintenanceRequest (+13 more)

### Community 135 - "Community 135"
Cohesion: 0.1
Nodes (26): isCurrentNight(), isSelfReportable(), NIGHT_STATUS_OPTIONS, nightNote(), NightStanding, SelfReportableStatus, NIGHT_OF_17TH, standing (+18 more)
...
Cohesion: 0.09
Nodes (30): assertActiveReferralCode(), auditReferralAction(), confirmReferralJoined(), findActiveReferralCode(), HostelAdminReferralListQuery, linkReferralOnRegistration(), normalizeObjectIds(), referralCodeCandidate() (+22 more)

### Community 139 - "Community 139"
Cohesion: 0.12
Nodes (22): checkoutDocumentFor(), softmatoDocumentNumbers(), gateway, invoice, updateOne, checkFieldCash(), readReturnState(), ReturnStep (+14 more)
...
Cohesion: 0.11
Nodes (30): ApiFailure, apiRequest(), ApiSuccess, AuthUser, confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listNotifications() (+22 more)
...
Cohesion: 0.13
Nodes (24): InvoiceRecord, fileBookingRefund(), refileBookingRefund(), submitBookingRefund(), loadOwnBooking(), BookingSettlement, ensureBookingInvoice(), openBookingCheckout() (+16 more)
...
Cohesion: 0.15
Nodes (23): BookingConfig, DEFAULT_BOOKING_CONFIG, bookingGuideIntro(), bookingGuideSections(), GuideTerms, moveInReminder(), BookingGuide, getBookingGuide() (+15 more)
...
Cohesion: 0.11
Nodes (22): geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), geocodeAddress(), geocodeWithGoogle(), geocodeWithNominatim(), HostelGeoLocation (+14 more)
...
Cohesion: 0.08
Nodes (24): dispatchOtpChallenge(), generateOtpCode(), normalizeOtpIdentifier(), otpDeliveryProvider(), otpRateLimitMax(), otpRateLimitWindowMs(), otpTtlMs(), requestOtpChallenge() (+16 more)

### Community 160 - "Community 160"
Cohesion: 0.1
Nodes (23): daysFromNow(), enabledPermissionLabels(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags, GuardianPermissionsUpdateInput, GuardianRecord (+15 more)
...
Cohesion: 0.13
Nodes (21): readQrPayeeFields(), cleanAccountNumber(), cleanName(), hasQrPayee(), looksLikeName(), normalizeDigits(), QrPayeeRead, readQrPayee() (+13 more)

### Community 169 - "Community 169"
Cohesion: 0.14
Nodes (23): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), loadPayeeIdentity() (+15 more)

### Community 170 - "Community 170"
Cohesion: 0.14
Nodes (19): hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKindFromText(), distance, drawCertificationStamp(), footerLine(), formatDate(), formatLongDate() (+11 more)

### Community 171 - "Community 171"
Cohesion: 0.08
Nodes (16): accountId, adminId, booking, calls, compact, guardian, intake, linkAt (+8 more)
...
Cohesion: 0.1
Nodes (15): accountDeletionRequestSchema, attendanceLogSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, questionCallClickSchema, purgeAccount(), runAccountDeletionPurge() (+7 more)
...
Cohesion: 0.13
Nodes (14): AuthGuard(), metadata, checkAuthWithRefresh(), isStaleSession(), fetchMock, payload, refreshSessionMock, refreshSession() (+6 more)
...
Cohesion: 0.13
Nodes (17): nepalDayKey(), nightKey(), filterNotices(), groupNoticesByDay(), noticeCategories(), NoticeDay, NoticeStatus, days (+9 more)
...
Cohesion: 0.19
Nodes (16): returnHeldBed(), takeHeldBed(), CapacityError, claimBedForRoomType(), listAllRoomTypes(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes() (+8 more)
...
Cohesion: 0.12
Nodes (16): asar, coverage, eventId, hostelId, invoiceId, mocks, principal, receiptId (+8 more)

### Community 218 - "Community 218"
Cohesion: 0.18
Nodes (15): IssuedInvoice, OpenedCheckout, readSettledReceipt(), SettledReceipt, documentFilename(), downloadInvoiceFile(), downloadReceiptFile(), fetchInvoiceDetail() (+7 more)

### Community 219 - "Community 219"
Cohesion: 0.16
Nodes (15): robots(), documentUrl(), InvoiceLean, PaymentLean, PlatformInvoiceRow, PlatformPaymentRow, PlatformSubscriptionLedger, bookingTask() (+7 more)
...
Cohesion: 0.16
Nodes (12): AuthSession, login(), submitResidentReview(), AppNavigator(), RootStackParamList, Stack, LoginScreen(), Props (+4 more)
...
Cohesion: 0.24
Nodes (15): openCheckoutSession(), allocateReceiptNumber(), applySettlement(), InvoiceRecord, loadInvoice(), logAccessFailure(), openHostelAfterPayment(), openSubscriptionCheckout() (+7 more)
...
Cohesion: 0.21
Nodes (13): useIsUploading(), dismissUpload(), emit(), isUploadActive(), listeners, pruneUploads(), rows, startRead() (+5 more)
...
Cohesion: 0.18
Nodes (12): DeletionPanel(), DeletionRequest, DeletionStatus, getDeletionStatus(), requestAccountDeletion(), canRequestDeletion(), DeletionPathway, deletionReasonError() (+4 more)
...
Cohesion: 0.15
Nodes (14): UploadCard(), resetUploadQueue(), afterSuccessLinger, before, down(), failed, id, [only] (+6 more)
...
Cohesion: 0.16
Nodes (11): getResidentProfile(), requestOtp(), signInWithGoogle(), Profile, Props, ResidentProfileScreen(), Props, ResidentSOSScreen() (+3 more)
...
Cohesion: 0.24
Nodes (10): getHostelLedger(), listRecentInvoices(), approvalPeriod(), getPeriodSummary(), monthsBetween(), periodOf(), PeriodRow, PeriodSummary (+2 more)
...
Cohesion: 0.18
Nodes (14): 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, 3.1 Payment Due Reminder, 3.3 Payment Proof Uploaded (to Admin), 3.4 Payment Verified (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)* (+6 more)
...
Cohesion: 0.2
Nodes (6): LIVE_ACCESS, releaseGuardianAccounts(), hostelId, mocks, userId, guardianAccessSchema

### Community 353 - "Community 353"
Cohesion: 0.18
Nodes (7): promoteAccountToResident(), standDownMemberships(), hostelId, memberId, mocks, otherHostelId, userId
...
Cohesion: 0.27
Nodes (9): directionOf(), EMPTY_TALLY, floorToStep(), phaseOf(), tallyUploads(), UploadPhase, UploadTally, VERBS (+1 more)
...
Cohesion: 0.22
Nodes (9): 2.3 Hostel Rejected, 3.2 Payment Overdue, 3.5 Payment Rejected (to Resident), 4.3 Complaint Resolved, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({) (+1 more)
...
Cohesion: 0.29
Nodes (6): hostelRegistrationSchema, teamHostelRegistrationSchema, base, parsed, result, team
...
Cohesion: 0.33
Nodes (4): escapeRegex(), objectIdSchema, paginationSchema, phoneSchema
...
- **Why does `cn()` connect `Community 20` to `Community 128`, `Community 1`, `Community 5`, `Community 133`, `Community 134`, `Community 8`, `Community 137`, `Community 14`, `Community 15`, `Community 19`, `Community 156`, `Community 30`, `Community 31`, `Community 34`, `Community 35`, `Community 37`, `Community 44`, `Community 45`, `Community 46`, `Community 51`, `Community 308`, `Community 55`, `Community 67`, `Community 71`, `Community 72`, `Community 76`, `Community 79`, `Community 93`, `Community 102`, `Community 103`, `Community 107`, `Community 108`, `Community 117`, `Community 127`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 1` to `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 11`, `Community 15`, `Community 17`, `Community 18`, `Community 20`, `Community 24`, `Community 25`, `Community 29`, `Community 36`, `Community 39`, `Community 44`, `Community 46`, `Community 52`, `Community 58`, `Community 62`, `Community 117`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 2` to `Community 0`, `Community 3`, `Community 9`, `Community 10`, `Community 139`, `Community 12`, `Community 13`, `Community 138`, `Community 144`, `Community 21`, `Community 22`, `Community 154`, `Community 26`, `Community 28`, `Community 157`, `Community 159`, `Community 160`, `Community 161`, `Community 162`, `Community 32`, `Community 292`, `Community 38`, `Community 40`, `Community 41`, `Community 169`, `Community 42`, `Community 43`, `Community 430`, `Community 47`, `Community 48`, `Community 49`, `Community 50`, `Community 178`, `Community 54`, `Community 56`, `Community 187`, `Community 59`, `Community 61`, `Community 64`, `Community 65`, `Community 66`, `Community 68`, `Community 69`, `Community 72`, `Community 73`, `Community 74`, `Community 77`, `Community 333`, `Community 78`, `Community 81`, `Community 83`, `Community 86`, `Community 87`, `Community 218`, `Community 219`, `Community 92`, `Community 91`, `Community 94`, `Community 95`, `Community 96`, `Community 104`, `Community 233`, `Community 106`, `Community 105`, `Community 234`, `Community 110`, `Community 246`, `Community 118`, `Community 122`?**
