...
## Summary
- 6546 nodes · 16513 edges · 305 communities (288 shown, 17 thin omitted)
...
Cohesion: 0.04
Nodes (97): GET(), POST(), POST(), GET(), GET(), consentSchema, POST(), DELETE() (+89 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (73): PATCH(), POST(), RouteContext, POST(), GET(), RouteContext, POST(), RouteContext (+65 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (72): DemoDataBadge(), Hostel, ReportGrid(), UserRecord, HostelAdminDashboardPageContent, HostelAdminTransactionsPageContent, Payment, TABS (+64 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (61): PATCH(), RouteContext, listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), POST(), RouteContext (+53 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (66): AccountDeletionPanel, DeletionPathway, DeletionStatus, PATHWAY_COPY, ConfirmOptions, Resolver, csvField(), deferLoad() (+58 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (66): Notification, PagerButton(), PublicHostelListingPage(), PublicHostelListingPage(), InquiryPage(), cn(), Alert(), AlertAction() (+58 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (51): GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, hasFood() (+43 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (67): HostelAdminCommunityPageContent, EMPTY_SUMMARY, HostelAdminComplaintsPage, HostelAdminFeePlansPageContent, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek (+59 more)
...
Cohesion: 0.04
Nodes (58): HostelPhotoReminder(), HostelSuggestions(), inferKind(), LightboxItem, MediaLightbox(), formatHostelAddress(), hostelTypeToUi(), mapPublicHostelToSummary() (+50 more)

### Community 11 - "Community 11"
Cohesion: 0.07
Nodes (49): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CancelDeletionPageContent(), field(), GuardianDashboard, LoadState (+41 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (71): deleteResidentLocationHistory(), getResidentAttendance(), commentOnPost(), deleteOwnPost(), findVisiblePostForResident(), listPostComments(), reactToPost(), reportPost() (+63 more)
...
Cohesion: 0.03
Nodes (44): adminPrincipal, mocks, PLATFORM_LIMITS, MockSessionModel, serviceMocks, session, user, authorUserId (+36 more)
...
Cohesion: 0.05
Nodes (53): RouteContext, authorUserId, mocks, postId, residentId, residentPrincipal, staffPrincipal, AnnouncementInput (+45 more)
...
Cohesion: 0.08
Nodes (43): CATEGORIES, EmptyInline(), PortalPageHeader(), RoleButton(), SectionCard(), SoftBadge(), statusToneFromLabel(), CommunityComment (+35 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (43): ComparePage(), hostels, metadata, rows, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminRoomsPageContent(), PlatformDashboardPageContent() (+35 more)
...
Cohesion: 0.07
Nodes (52): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply() (+44 more)
...
Cohesion: 0.05
Nodes (43): PaginationMeta, paginationQuerySchema, querySchema, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex(), HostelRecord, ListingFlagListQuery (+35 more)
...
Cohesion: 0.05
Nodes (47): notifyPostReaction(), PaginationQuery, notificationSchema, notificationCampaignSchema, input, mocks, userId, CampaignListQuery (+39 more)
...
Cohesion: 0.06
Nodes (28): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminPaymentsPage(), redirectToWorkspaceScreen(), HostelAdminMaintenancePageContent() (+20 more)
...
Cohesion: 0.05
Nodes (43): referralSchema, referralCodeSchema, referralRewardSchema, activeCode, codeId, hostelId, joinedResidentId, mocks (+35 more)
...
Cohesion: 0.08
Nodes (35): publicInquiryCreateSchema, POST(), RouteContext, ApiAuthError, cookieAccessToken(), isRole(), loadApiPrincipal(), ImageVariantRecord (+27 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (35): emergencyContactSchema, incidentLogSchema, manualStatusOverrideSchema, nightStatusLogSchema, sosAlertSchema, normalizeObjectId(), ResidentAccessError, ResidentRecord (+27 more)

### Community 39 - "Community 39"
Cohesion: 0.06
Nodes (42): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput, ConsentInput (+34 more)
...
Cohesion: 0.07
Nodes (33): LoadState, ReportRecord, DerivedPlan, Payment, HostelPreviewLink(), NotificationBell(), Campaign, Hostel (+25 more)
...
Cohesion: 0.05
Nodes (25): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, CachedConnection, globalForMongoose, candidateRoots, { loadEnvConfig } (+17 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (28): currency(), Input(), Select(), ResidentActivationPageContent, ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent (+20 more)
...
Cohesion: 0.07
Nodes (30): bedSchema, depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, paymentSchema, providedItemSchema, auditMoveAction(), createMoveInChecklist() (+22 more)

### Community 48 - "Community 48"
Cohesion: 0.09
Nodes (36): getHostelViewStats(), nightStatusSchema, paymentProofSchema, averageResolutionDays(), bucketBoundaries(), collectionRate(), countByField(), CountingModel (+28 more)

### Community 49 - "Community 49"
Cohesion: 0.07
Nodes (28): noticeSchema, noticeReadStatusSchema, adminOfA, cases, mocks, pipeline, residentInB, wardenOfA (+20 more)
...
Cohesion: 0.1
Nodes (29): addHostelAdminProfilePhoto(), deleteHostelAdminProfilePhoto(), HostelAdminProfileQuery, HostelAdminProfileUpdateInput, HostelChangeRequestInput, HostelPhotoCreateInput, HostelPhotoDeleteQuery, LOCKED_NAME_STATUSES (+21 more)
...
Cohesion: 0.08
Nodes (19): LoadingRows(), Panel(), field(), HostelAdminServiceProvidersPageContent(), ListingFlag, LoadState, MaintenanceRequest, optionalField() (+11 more)
...
Cohesion: 0.13
Nodes (28): ageFromDateOfBirth(), cardPhotoImageUrl(), clearResidentIdentityPhoto(), generateResidentId(), getResidentIdentity(), getResidentIdentityQr(), isCardPhotoImage(), lookupResidentProfile() (+20 more)
...
Cohesion: 0.12
Nodes (16): attendanceAlertResolveSchema, attendanceListQuerySchema, attendanceOverrideSchema, attendanceSettingsSchema, locationPingSchema, objectIdSchema, DELETE(), requireHostelAdminPrincipal() (+8 more)
...
Cohesion: 0.14
Nodes (22): AttendanceAlert, AttendanceLog, AuditLog, code:typescript ({), code:typescript ({), code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({) (+14 more)
...
Cohesion: 0.15
Nodes (17): FileUploadArea(), acceptAttribute(), EXTENSION_BY_MIME, joinTypes(), KIND_RULES, KindRule, labelsFor(), uploadHint() (+9 more)
...
Cohesion: 0.11
Nodes (18): bedCreateSchema, hostelRejectSchema, hostelRequestDocumentsSchema, hostelResubmitDocumentsSchema, hostelTypeSchema, hostelUnpublishSchema, inquiryStatusSchema, objectIdSchema (+10 more)
...
Cohesion: 0.16
Nodes (15): ServiceProviderRegistrationPageContent(), isActive(), formatBytes(), AttachedFile(), FileUploader(), FileUploaderPresentation, FileUploaderProps, FileUploaderView() (+7 more)
...
Cohesion: 0.15
Nodes (11): activateResident(), AuthSession, signInWithGoogle(), AppNavigator(), Stack, Props, ResidentActivationScreen(), styles (+3 more)

### Community 114 - "Community 114"
Cohesion: 0.19
Nodes (11): GET(), POST(), ALLOWED_ROLES, GET(), POST(), assertApiRoles(), requireHostelScopedPrincipal(), POST() (+3 more)

### Community 115 - "Community 115"
Cohesion: 0.17
Nodes (11): PATCH(), POST(), GET(), monthlyPaymentGenerateSchema, monthSchema, objectIdSchema, paymentCreateSchema, paymentListQuerySchema (+3 more)
...
Cohesion: 0.18
Nodes (13): code:typescript (interface IMoveInChecklistItem {), code:typescript (interface IMoveOutChecklistItem {), code:typescript (interface IServiceProvider {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IInquiry {), MaintenanceRequest, Move-in / Move-out, MoveInChecklist (+5 more)
...
Cohesion: 0.26
Nodes (13): code:typescript ({), code:typescript ({), code:typescript ({), code:typescript (interface IQuestionCallClick {), code:typescript ({), code:typescript ({), Community Feature, CommunityComment (+5 more)
...
Cohesion: 0.25
Nodes (6): useConfirm(), AttendanceDay, ResidentAttendancePageContent, Zone, ZONE_LABELS, ZONE_STYLES
...
Cohesion: 0.17
Nodes (3): maintenanceCommentSchema, maintenanceHistorySchema, serviceProviderSchema
...
Cohesion: 0.31
Nodes (9): AccountDeletionRequest, code:typescript (interface IAccountDeletionRequest {), code:block44 (packages/db/migrations/), code:block45 (packages/db/migrations/), code:block46 (packages/db/migrations/), Consent & Privacy, ConsentLog, Migrations (Mongoose) (+1 more)
...
- **Why does `Role` connect `Community 15` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 13`, `Community 16`, `Community 17`, `Community 18`, `Community 22`, `Community 25`, `Community 27`, `Community 29`, `Community 31`, `Community 33`, `Community 37`, `Community 39`, `Community 41`, `Community 42`, `Community 49`, `Community 51`, `Community 52`, `Community 53`, `Community 61`, `Community 64`, `Community 65`, `Community 67`, `Community 79`, `Community 92`, `Community 103`, `Community 114`, `Community 119`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 6` to `Community 3`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 19`, `Community 20`, `Community 21`, `Community 25`, `Community 34`, `Community 36`, `Community 165`, `Community 41`, `Community 45`, `Community 46`, `Community 52`, `Community 58`, `Community 63`, `Community 77`, `Community 94`, `Community 108`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `browserApi()` connect `Community 11` to `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 19`, `Community 20`, `Community 25`, `Community 156`, `Community 34`, `Community 165`, `Community 41`, `Community 44`, `Community 45`, `Community 46`, `Community 52`, `Community 55`, `Community 58`, `Community 63`, `Community 72`, `Community 204`, `Community 76`, `Community 93`?**
