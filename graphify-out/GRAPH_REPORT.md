...
## Corpus Check
- 1051 files · ~1,871,555 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8452 nodes · 21039 edges · 375 communities (356 shown, 19 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 372 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 486 edges
2. `successResponse()` - 475 edges
3. `connectToDatabase()` - 318 edges
4. `cn()` - 223 edges
5. `connectToDatabase()` - 209 edges
6. `requireHostelCapability()` - 154 edges
7. `requireHostelStaffPrincipal()` - 116 edges
8. `browserApi()` - 115 edges
9. `usePortalResource()` - 86 edges
...
## Communities (375 total, 19 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (165): EmailAttachment, fromAddress(), sendEmail(), SendEmailInput, SendEmailResult, listPublicFoodRoutine(), listHostelAdminInquiries(), addHostelAdminProfilePhoto() (+157 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (122): POST(), attacker, attempt(), headers, jsonRequest(), routeMocks, appBaseUrl(), authenticateWithGoogle() (+114 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (104): HostelAdminCommunityPageContent, HostelAdminComplaintsPage, HostelAdminFeePlansPageContent, HostelAdminInquiriesPageContent, HostelAdminMaintenancePageContent, PRIORITIES, STATUS_ACTIONS, HostelAdminMoveChecklistPage (+96 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (79): Filter, ModeratedPost, ModerationPayload, HostelTable(), FeeSchedule, HostelAdminFeeSchedulePageContent, Rate, PlatformCommunityPageContent (+71 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (82): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), verificationEmail(), ProviderDirectoryData, guardianInvitationEmail(), sosAlertEmail() (+74 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (91): CommunityReportDialog(), REASONS, ConfirmOptions, Resolver, ModerationButton(), PagerButton(), normalize(), PortalSearch() (+83 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (85): GET(), POST(), POST(), POST(), POST(), GET(), POST(), bulkApproveSchema (+77 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (96): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, dayKey(), POST(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintStatus() (+88 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (72): POST(), RouteContext, complaintCategorySchema, complaintCreateSchema, complaintListQuerySchema, complaintReplySchema, complaintResolutionConfirmSchema, complaintStatusSchema (+64 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (66): csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, Inquiry, LoadState, Message() (+58 more)

### Community 10 - "Community 10"
Cohesion: 0.05
Nodes (50): DELETE(), GET(), checkoutSchema, POST(), POST(), RouteContext, GET(), GET() (+42 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (71): AuditLogRecord, PlatformAuditLogQuery, RefRecord, listTrendingTags(), listPlatformHostels(), CachedConnection, globalForMongoose, PaginationMeta (+63 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (68): HostelPhotoReminder(), HostelSuggestions(), inferKind(), LightboxItem, MediaLightbox(), PublicComparePage(), PublicHostel, ROUTINE_DAYS (+60 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (62): getResidentFinanceView(), InvoiceMatrix, InvoiceMatrixRow, listResidentClaims(), PortalInvoice, ResidentFinanceView, ResidentRow, LedgerInvoice (+54 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (60): GET(), POST(), GET(), recordConsent(), attendanceAlertResolveSchema, attendanceListQuerySchema, attendanceOverrideSchema, attendanceSettingsSchema (+52 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (65): EMPTY_SUMMARY, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine, formatWeekRange() (+57 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (69): getResidentAttendance(), listResidentComplaints(), listFoodForResident(), connectToDatabase(), incidentLogSchema, manualStatusOverrideSchema, nightStatusLogSchema, qrActivationSchema (+61 more)
...
Cohesion: 0.04
Nodes (44): AuthShell(), AuthShellProps, SiteWordmark(), AccountDeletionPanel, AuthExperiencePage(), LegalBody(), buildValues(), PublicAboutPage() (+36 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (50): POST(), GET(), GET(), POST(), listHostelAdminFloors(), listHostelAdminRooms(), hostelRequestDocumentsSchema, hostelScopedListQuerySchema (+42 more)

### Community 20 - "Community 20"
Cohesion: 0.07
Nodes (48): GuardianDashboard, EmptyInline(), InitialsAvatar(), MetricCard(), PortalPageHeader(), RoleButton(), SectionCard(), SoftBadge() (+40 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (66): announceFoodReady(), cookEmailForSlug(), CookPortalUpdateInput, CookServiceError, FoodReadyInput, generatePassword(), getCookPortalSettings(), HostelSettingsRecord (+58 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (52): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, secretsMatch(), ENDPOINTS, esewaProvider, SIGNED_FIELDS, attempt (+44 more)
...
Cohesion: 0.06
Nodes (49): GET(), resolvePastedLink(), searchCandidates(), geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), hostelAdminGeocodeQuerySchema (+41 more)
...
Cohesion: 0.05
Nodes (41): PATCH(), RouteContext, listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), PATCH(), hostelRejectSchema (+33 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (51): GATEWAY_ORDER, getPayInstructions(), InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice(), assertQrAssetUsable() (+43 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (46): CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing, CurrentUser (+38 more)

### Community 30 - "Community 30"
Cohesion: 0.09
Nodes (37): POST(), POST(), POST(), POST(), POST(), RouteContext, POST(), POST() (+29 more)

### Community 31 - "Community 31"
Cohesion: 0.09
Nodes (40): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel(), useConfirm(), field(), LoadState (+32 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (42): daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags, GuardianPermissionsUpdateInput (+34 more)
...
Cohesion: 0.05
Nodes (47): GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse, GoogleAuthUser, GoogleCredentialResponse, Window, cook, assertAllowedRole() (+39 more)

### Community 37 - "Community 37"
Cohesion: 0.06
Nodes (38): Notification, FILTERS, Notification, NotificationBell(), NotificationRow(), FILTERS, NotificationCard, NotificationsPageContent (+30 more)
...
Cohesion: 0.06
Nodes (28): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminResidentsPage(), redirectToWorkspaceScreen(), HostelAdminReferralsPageContent() (+20 more)
...
Cohesion: 0.05
Nodes (38): DeletionPathway, DeletionStatus, PATHWAY_COPY, CancelDeletionPageContent(), AcceptResult, GuardianInvitePageContent, HostelAdminRoomsPageContent, AttendanceDay (+30 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (41): FinanceAuditInput, assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), similarEvidenceFlags(), submitClaim(), SubmitClaimResult, UsableAsset (+33 more)
...
Cohesion: 0.06
Nodes (43): addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery, HostelAdminInquiryStatusInput, InquiryNoteCreateInput, InquiryNoteRecord, InquiryRecord (+35 more)

### Community 45 - "Community 45"
Cohesion: 0.07
Nodes (40): notifyResidentOfComplaintReply(), addComplaintUpdate(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput (+32 more)
...
Cohesion: 0.07
Nodes (37): auditFinanceAction(), previousEntryHash(), base, entityId, hostelId, mocks, principal, write() (+29 more)
...
Cohesion: 0.1
Nodes (20): PlatformConfigAnnouncementsPageContent, PlatformConfigFacilitiesPageContent, FLAGS, PlatformConfigFeaturesPageContent, PlatformConfigLegalPageContent, PlatformConfigLocationsPageContent, PlatformConfigPricingPageContent, ConfigCard() (+12 more)

### Community 55 - "Community 55"
Cohesion: 0.07
Nodes (35): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+27 more)
...
Cohesion: 0.07
Nodes (32): createExpertConsultationRequest(), ExpertConsultationCreateInput, ExpertConsultationError, ExpertConsultationRequestRecord, getMyExpertConsultationRequest(), notifyTeamOfRequest(), expertConsultationCreateSchema, expertConsultationRequestSchema (+24 more)

### Community 62 - "Community 62"
Cohesion: 0.07
Nodes (32): AnnouncementInput, CommentCreateInput, CommentRecord, CommunityServiceError, deleteOwnPost(), FeedQuery, flagPost(), HideInput (+24 more)
...
Cohesion: 0.08
Nodes (32): BALANCE_ALIASES, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, TXN_ID_ALIASES, WITHDRAWAL_ALIASES, CsvTable (+24 more)

### Community 65 - "Community 65"
Cohesion: 0.07
Nodes (21): GET(), RouteContext, POST(), RouteContext, POST(), RouteContext, emergencyContactCreateSchema, guardianCreateSchema (+13 more)
...
Cohesion: 0.08
Nodes (25): GatewayHealth, GatewayHealthSummary, getGatewayHealth(), IntentCounts, plural(), recordHealth(), runGatewayHealth(), runGatewayHealthForHostel() (+17 more)
...
Cohesion: 0.08
Nodes (28): BANK_CSV_PARSER, peekHeaders(), ESEWA_CSV_PARSER, both, corrupted, debit, [first], FIXTURE (+20 more)

### Community 77 - "Community 77"
Cohesion: 0.07
Nodes (20): LoadingRows(), StatusBadge(), TextArea(), field(), HostelAdminMaintenancePageContent(), ListingFlag, LoadState, MaintenanceRequest (+12 more)

### Community 78 - "Community 78"
Cohesion: 0.07
Nodes (20): Complaint, ComplaintSummary, field(), FoodMenu, HostelAdminComplaintsPage(), HostelAdminFoodPage(), HostelAdminNoticesPage(), HostelAdminPaymentsPage() (+12 more)
...
Cohesion: 0.11
Nodes (25): uploadPublicFile(), FILE_ASSET_KINDS, FileAssetKind, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), ApiEnvelope, parseEnvelope() (+17 more)
...
Cohesion: 0.11
Nodes (22): GET(), POST(), requireSuperadminPrincipal(), GET(), PUT(), PUT(), RouteContext, DELETE() (+14 more)

### Community 83 - "Community 83"
Cohesion: 0.08
Nodes (20): financeIntegrityHash(), checkAuditChain(), DRIFT_CODES, LedgerDriftSummary, runLedgerDrift(), runLedgerDriftForHostel(), after, broken (+12 more)
...
Cohesion: 0.1
Nodes (23): findOrphanClaims(), loadMatchContext(), approveMatchedRows(), askResidentAboutClaim(), assignOrphanCredit(), ClaimedNoTransactionRow, getReconciliation(), MatchedRow (+15 more)
...
Cohesion: 0.14
Nodes (17): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), QueryProvider() (+9 more)
...
Cohesion: 0.1
Nodes (18): BedRecord, EmergencyContactCreateInput, EmergencyContactRecord, GuardianCreateInput, GuardianRecord, listResidents(), normalizeObjectIds(), ResidentAccountLink (+10 more)
...
Cohesion: 0.16
Nodes (16): issueSessionForUser(), login(), logout(), publicUser(), refreshAccessToken(), MockSessionModel, serviceMocks, session (+8 more)
...
Cohesion: 0.17
Nodes (13): listCommunityForModeration(), reportPost(), communityAnnouncementSchema, communityFeedQuerySchema, communityModerationQuerySchema, communityPostCreateSchema, communityReportSchema, communityVoteSchema (+5 more)
...
Cohesion: 0.13
Nodes (16): apiRequest(), getActivationStatus(), listNotifications(), listResidentNotices(), markNoticeAsRead(), markNotificationRead(), NotificationItem, refreshSession() (+8 more)
...
Cohesion: 0.17
Nodes (11): statementImportSchema, StatementParseError, StatementParseResult, StatementProvider, StatementRow, importStatement(), loadStatementAsset(), periodOf() (+3 more)
...
Cohesion: 0.16
Nodes (11): activateResident(), getResidentProfile(), OtpVerificationScreen(), Props, Props, ResidentActivationScreen(), styles, Profile (+3 more)
...
Cohesion: 0.18
Nodes (7): PlatformBroadcastPanel, OperationsConfig, PlatformOperationsPanel, PlatformAdmin, PlatformOwner, PlatformSettingsPageContent, ROLE_COPY
...
Cohesion: 0.33
Nodes (8): COMMUNITY_DEFAULTS, CommunitySettings, getCommunitySettings(), communitySettingsSchema, GET(), PATCH(), resolveHostelId(), assertHostelScopedApiAccess()
...
Cohesion: 0.2
Nodes (8): getInvoiceMatrix(), toPortalInvoice(), hostelId, invoiceId, ledgerInvoice, mocks, residentId, listRecentInvoices()

### Community 207 - "Community 207"
Cohesion: 0.27
Nodes (10): assertActiveReferralCode(), findActiveReferralCode(), linkReferralOnRegistration(), createResident(), isDuplicateKeyError(), linkResidentAccount(), normalizeObjectId(), residentDashboardUrl() (+2 more)
...
Cohesion: 0.22
Nodes (10): 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6. Service Provider Emails, 7.1 New Hostel Pending Approval (to Superadmin), code:typescript ({), code:typescript ({), code:typescript ({) (+2 more)
...
Cohesion: 0.48
Nodes (5): notifyPostReaction(), reactToPost(), communityReactionSchema, POST(), RouteContext
...
## Knowledge Gaps
- **3230 isolated node(s):** `AuthUser`, `ResidentSummary`, `ResidentFoodRoutine`, `ApiSuccess`, `ApiFailure` (+3225 more)
...
- **Why does `Role` connect `Community 21` to `Community 0`, `Community 1`, `Community 134`, `Community 7`, `Community 8`, `Community 265`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 16`, `Community 18`, `Community 150`, `Community 152`, `Community 282`, `Community 27`, `Community 29`, `Community 30`, `Community 32`, `Community 162`, `Community 35`, `Community 36`, `Community 167`, `Community 168`, `Community 42`, `Community 43`, `Community 45`, `Community 50`, `Community 51`, `Community 182`, `Community 55`, `Community 59`, `Community 60`, `Community 189`, `Community 62`, `Community 65`, `Community 68`, `Community 204`, `Community 205`, `Community 79`, `Community 208`, `Community 82`, `Community 91`, `Community 222`, `Community 115`, `Community 248`, `Community 122`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 16` to `Community 0`, `Community 1`, `Community 4`, `Community 6`, `Community 7`, `Community 10`, `Community 11`, `Community 13`, `Community 146`, `Community 19`, `Community 21`, `Community 22`, `Community 150`, `Community 25`, `Community 153`, `Community 28`, `Community 30`, `Community 32`, `Community 33`, `Community 35`, `Community 38`, `Community 39`, `Community 42`, `Community 43`, `Community 44`, `Community 45`, `Community 46`, `Community 50`, `Community 52`, `Community 55`, `Community 56`, `Community 57`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 63`, `Community 69`, `Community 73`, `Community 203`, `Community 79`, `Community 207`, `Community 83`, `Community 91`, `Community 98`, `Community 109`, `Community 239`, `Community 114`, `Community 115`, `Community 247`, `Community 122`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `browserApi()` connect `Community 41` to `Community 2`, `Community 3`, `Community 9`, `Community 12`, `Community 15`, `Community 17`, `Community 20`, `Community 23`, `Community 29`, `Community 31`, `Community 34`, `Community 37`, `Community 167`, `Community 40`, `Community 175`, `Community 49`, `Community 53`, `Community 54`, `Community 58`, `Community 68`, `Community 77`, `Community 78`, `Community 80`, `Community 219`, `Community 95`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Are the 313 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 313 INFERRED edges - model-reasoned connections that need verification._
