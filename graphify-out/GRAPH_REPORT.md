...
## Corpus Check
- 2063 files · ~3,251,492 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 16532 nodes · 45445 edges · 546 communities (519 shown, 27 thin omitted)
...
## Communities (546 total, 27 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (269): AttendanceScreen(), BootGate(), RootShell(), DeletionPanel(), NotificationSettings(), SETTINGS_TITLES, THEME_OPTIONS, BrandSplash() (+261 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (285): loadToday(), AdminSearchBar(), NightStatusPromptCard(), loadFinance(), ManageRatesScreen(), useSystemInsets(), getAdminFoodRoutine(), getAdminMaintenance() (+277 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (179): ICONS, LABELS, Segment, TONES, FILTERS, Pending, Overview, MANAGE_ROWS (+171 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (252): AdminCommunityReportsScreen(), AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), Scanner(), CookInviteScreen(), GuardianInviteScreen(), NightStatusHistoryScreen() (+244 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (224): getOrCreateSubscription(), selectPlan(), getOpenFeeSchedule(), getFoodRoutinesByHostelId(), listPublicFoodRoutine(), recordListingAppearances(), addHostelAdminInquiryNote(), auditInquiryAction() (+216 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (222): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, notifyHostelOfNewPost(), resolveHostelCommunityUserIds(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply() (+214 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (168): PATCH(), POST(), RouteContext, GET(), POST(), PATCH(), POST(), RouteContext (+160 more)
...
Cohesion: 0.03
Nodes (127): GuardianDashboard, formatDate(), Ledger, OrphanAssignPicker, MatrixRow, MatrixTotals, PeriodSummary, ClaimFacts() (+119 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (110): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel() (+102 more)
...
Cohesion: 0.03
Nodes (119): AdminCommunityScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+111 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (115): CommunityReportDialog(), REASONS, MonthOption(), HostelPreviewLink(), BrowserPushRow(), ModerationButton(), PagerButton(), normalize() (+107 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (122): getHostelLedger(), collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES (+114 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (108): GET(), POST(), GET(), GET(), POST(), GET(), readReturnState(), ownerIdentitiesFor() (+100 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (92): complaintCategorySchema, complaintCreateSchema, complaintListQuerySchema, complaintReplySchema, complaintResolutionConfirmSchema, complaintStatusSchema, complaintStatusUpdateSchema, objectIdSchema (+84 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (87): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, DASHBOARD_ROLES, FACILITY_ICONS (+79 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (110): AuditLogRecord, PlatformAuditLogQuery, RefRecord, summarizeResidentComplaints(), listResidentInvoices(), dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine (+102 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (107): adminPrincipal, mocks, PLATFORM_LIMITS, assetId, hostelId, mocks, otherHostelId, principal (+99 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (90): metadata, AccountDeletionPanel, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails() (+82 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (124): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES (+116 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (117): PaymentMonthStrip(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard(), AmountCard(), AdminLedger (+109 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (110): demoteToPublicAccount(), CapacityError, claimBedForRoomType(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary(), releaseBedForRoomType() (+102 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (84): ComparePage(), hostels, metadata, rows, csvField(), field(), Hostel, HostelAdminDashboardPageContent() (+76 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (108): AssetViewer(), useViewerState(), ViewerBody(), ViewerPage(), CopyButton(), ManualMethodPanel(), methodCaption(), methodKey() (+100 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (95): CookServiceError, resolveAdminHostelId(), assertHostelAccess(), canAccessHostel(), hostelScopedFilter(), TenantAccessError, TenantPrincipal, foodReadyLogSchema (+87 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (91): GET(), POST(), querySchema, RouteContext, authorUserId, mocks, postId, residentId (+83 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (82): HostelPhotoReminder(), inferKind(), LightboxItem, MediaLightbox(), PublicComparePage(), CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS (+74 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (89): PaginationMeta, PaginationQuery, paginationRange(), querySchema, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex(), HostelRecord (+81 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (94): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), loadOverview(), AdminTabs(), AdminMoneyScreen(), loadMoney(), MoneyData (+86 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (84): HIDDEN, RoleLayout(), TABS, FILTERS, invalidateFeeds(), NotificationCard(), NotificationRow(), TILE_GLYPH (+76 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (76): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), ApplyBlock(), ServiceProvidersScreen() (+68 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (68): outstandingForResident(), deleteHostelObjects(), ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, purgeArchivedHostel() (+60 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (86): sendEmail(), createExpertConsultationRequest(), ExpertConsultationCreateInput, ExpertConsultationError, ExpertConsultationRequestRecord, notifyTeamOfRequest(), expertConsultationCreateSchema, appLoginUrl() (+78 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (74): FILTERS, Notification, NotificationRow(), PushState, blankRow(), Row, TeamInviteBox(), MemberActions() (+66 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (82): ReviewForm(), ReviewScreen(), describeGrants(), GuardianRow(), PermissionSheet(), InviteGuardianScreen(), daysUntil(), describeGuardianOnRecord() (+74 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (72): CommunityScreen(), Composer(), CommunityPostScreen(), AnimatedBlurView, CommunityBoard(), CommunityBoardProps, Composer(), SORTS (+64 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (74): SetResidentFeeInput, approveClaim(), assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck(), evidenceCheck() (+66 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (64): AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel, HostelAdminReportsPageContent, Overview, Report, REPORT_EXPORTS (+56 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (60): GET(), POST(), PATCH(), RouteContext, getPlanPaymentInstructions(), POST(), RouteContext, DELETE() (+52 more)

### Community 41 - "Community 41"
Cohesion: 0.03
Nodes (61): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, AuthShell(), AuthShellProps, PANEL_COPY (+53 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (73): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+65 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (50): listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), getPlatformSubscriptionLedger(), listPlanPaymentClaims(), GET(), findModeratablePost() (+42 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (68): CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing, buildIdCardData() (+60 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (66): BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan, BillingSkip (+58 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (49): fill(), PricingScreen(), HostelRegistrationProgress(), Milestone, milestoneIndex(), MILESTONES, PaymentPanel(), PlanPicker() (+41 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (62): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), FinanceServiceError, GATEWAY_ORDER, getHostelPayMethods(), getPayInstructions(), HostelPayMethods (+54 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (60): POST(), cookCreateSchema, cookInvitationAcceptSchema, cookNameSchema, cookPortalUpdateSchema, cookRemoveSchema, cookUpdateSchema, foodReadySchema (+52 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (69): BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodBounds(), bsPeriodOf() (+61 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (58): HostelAdminCooksPanel, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine, formatWeekRange() (+50 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (67): formatPeriodKey(), cellAt(), focusCell(), Props, DeliveryWindowFields(), number(), text(), budgetLabel() (+59 more)
...
Cohesion: 0.04
Nodes (47): ReturnState, CancelDeletionPageContent(), CheckoutReturnPage(), AcceptResult, CookInvitePageContent, AcceptResult, GuardianInvitePageContent, AcceptResult (+39 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (58): ProviderDirectoryData, escapeRegex(), serviceProviderApplicationSchema, serviceProviderDocumentSchema, DirectoryPageProps, EMPTY, metadata, ServiceProviderDirectoryPage() (+50 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (51): existingResidentListSchema, existingResidentRowSchema, BillPreview, CheckContext, CheckedRow, checkExistingResidents(), CheckResult, moveInDateFor() (+43 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (53): PortalDates, useMinuteTick(), AdminNightStatusRow, PlanBilling, PlanBillingInvoice, PlanBillingPayment, PlanBillingPlan, bootstrapSession() (+45 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (54): addHistory(), addMaintenanceComment(), assertBedInHostel(), assertProviderApproved(), assertRoomInHostel(), assertVoiceNoteUsable(), assignMaintenanceProvider(), auditMaintenanceAction() (+46 more)
...
Cohesion: 0.09
Nodes (35): POST(), POST(), POST(), POST(), POST(), periodOf(), runBillingCycleForAllHostels(), POST() (+27 more)
...
Cohesion: 0.05
Nodes (49): aswin, bhadra, bs(), card(), currentId, hostelId, inAswin, inOctober (+41 more)
...
Cohesion: 0.06
Nodes (46): buildHostelPayload(), capacitySummary(), CITY_OPTIONS, FACILITY_OPTIONS, firstIncompleteHostelStep(), hasHostelErrors(), hasUsableRooms(), HOSTEL_PLANS (+38 more)

### Community 68 - "Community 68"
Cohesion: 0.05
Nodes (38): financeIntegrityHash(), IntentRow, recheckClosedAttempts(), runSettlementRecon(), runSettlementReconForHostel(), SettlementReconSummary, paymentIntentSchema, findingSchema (+30 more)
...
Cohesion: 0.05
Nodes (42): Accordion(), BLOOD_OPTIONS, BUDGET_CHIPS, ContactStep(), continueLabel(), DatePickerField(), DIET_CHIPS, DIET_LABELS (+34 more)
...
Cohesion: 0.06
Nodes (35): FINANCE_ERROR_STATUS, FinanceErrorCode, ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, attempt, fetchMock (+27 more)

### Community 73 - "Community 73"
Cohesion: 0.06
Nodes (41): ComplaintDetail(), CategoryTile(), NewComplaintScreen(), PickedAttachment, SwapButton(), CapturedPhoto, PhotoCapture(), VoiceNotePlayer() (+33 more)

### Community 74 - "Community 74"
Cohesion: 0.06
Nodes (45): createResident(), getIntakeQuote(), IntakeQuote, lookupResidentProfile(), RESIDENT_TYPES, ResidentIntakeResult, ResidentOccupancy, ResidentPrefill (+37 more)

### Community 75 - "Community 75"
Cohesion: 0.07
Nodes (38): asRecord(), DrawnPush, readDrawnPush(), message, pushData, configureNativeNightPrompt(), NativeNightPrompt, takeNativePendingAnswers() (+30 more)

### Community 76 - "Community 76"
Cohesion: 0.06
Nodes (43): downloadCaption(), DownloadRow, DownloadStack(), progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster() (+35 more)

### Community 77 - "Community 77"
Cohesion: 0.08
Nodes (48): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags(), evidenceFlags() (+40 more)

### Community 78 - "Community 78"
Cohesion: 0.13
Nodes (28): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), verificationEmail(), PLATFORM_NAME_PARTS, cookInvitationEmail(), guardianInvitationEmail() (+20 more)
...
Cohesion: 0.08
Nodes (37): FILE_ASSET_KINDS, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList() (+29 more)

### Community 81 - "Community 81"
Cohesion: 0.07
Nodes (37): DELETE(), POST(), NotificationFilter, revokeDeviceToken(), campaignBaseSchema, deviceTokenRevokeSchema, deviceTokenSaveSchema, hostelNotificationCampaignSchema (+29 more)
...
Cohesion: 0.07
Nodes (25): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminSOSAlertsPage(), redirectToWorkspaceScreen(), HostelAdminReportsPageContent(), HostelAdminServiceProvidersPageContent(), LegacyHostelAdminDashboardPage() (+17 more)

### Community 84 - "Community 84"
Cohesion: 0.07
Nodes (32): AuthGuard(), HostelSuggestions(), checkOnly(), EMPTY_PREFILL, ENVIRONMENT_OPTIONS, IdentityResponse, Prefill, Step (+24 more)

### Community 85 - "Community 85"
Cohesion: 0.05
Nodes (44): CONTENT_ICON_SLUGS, everything, IDENTITY, page, rendered, PLAN_MODULES, PLAN_SERVICES, PLAN_TIERS (+36 more)
...
Cohesion: 0.07
Nodes (38): drawCertificationStamp(), footerLine(), formatDate(), formatLongDate(), MONTHS, ReceiptPdfInput, renderReceiptPdf(), renderStatementPdf() (+30 more)

### Community 88 - "Community 88"
Cohesion: 0.07
Nodes (28): BrowseParams, BUDGET_BANDS, FilterSheet(), HostelBrowser(), HostelBrowserProps, NearestToggle(), ViewSwitch(), useSavedHostels() (+20 more)
...
Cohesion: 0.1
Nodes (38): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt, allocateReceiptNumber() (+30 more)
...
Cohesion: 0.09
Nodes (38): useIsUploading(), directionOf(), EMPTY_TALLY, floorToStep(), phaseOf(), shouldRepost(), tallyUploads(), active (+30 more)
...
Cohesion: 0.06
Nodes (37): buildHtml(), boundsCenter(), haversineMeters(), hostelCoordinates(), HostelWithDistance, isUsableCoordinate(), KATHMANDU, sortByDistance() (+29 more)

### Community 99 - "Community 99"
Cohesion: 0.07
Nodes (36): documents, hostelForm(), many, parsed, result, emptyHostelForm(), emptyRoomRow(), HostelForm (+28 more)
...
Cohesion: 0.1
Nodes (34): cookLoginStem(), generateCookPassword(), mintCookLogin(), pick(), previousCookLabel(), acceptCookInvitation(), addCookAccount(), assertRoomForAnotherCook() (+26 more)
...
Cohesion: 0.07
Nodes (26): metadata, CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+18 more)

### Community 106 - "Community 106"
Cohesion: 0.07
Nodes (27): robots(), documentUrl(), InvoiceLean, PaymentLean, PlatformInvoiceRow, PlatformPaymentRow, PlatformSubscriptionLedger, buildFormPostHandoff() (+19 more)

### Community 107 - "Community 107"
Cohesion: 0.06
Nodes (26): currency(), Input(), Panel(), TextArea(), ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent (+18 more)

### Community 108 - "Community 108"
Cohesion: 0.07
Nodes (36): buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, hasIdentityErrors(), IdentityErrors, IdentityStep (+28 more)
...
Cohesion: 0.09
Nodes (30): listTrendingTags(), paginationQuerySchema, sponsorSchema, GET(), loadPopularHostels(), PopularHostelRecord, DELETE(), PATCH() (+22 more)
...
Cohesion: 0.06
Nodes (24): LegacyHostelAdminComplaintsPage(), Complaint, ComplaintSummary, field(), FoodMenu, HostelAdminComplaintsPage(), HostelAdminFoodPage(), HostelAdminNoticesPage() (+16 more)

### Community 113 - "Community 113"
Cohesion: 0.1
Nodes (27): generateMetadata(), RootLayout(), sitemap(), STATIC_ROUTES, listPublishedHostelSlugs(), loadSiteConfig, loadSiteName(), getListingTier() (+19 more)

### Community 114 - "Community 114"
Cohesion: 0.09
Nodes (23): applyWebhook(), WebhookResult, softmato(), SoftmatoNotConfiguredError, isSoftmatoConfigured(), SoftmatoConfig, softmatoWebhookSecret(), formatPaisa() (+15 more)
...
Cohesion: 0.14
Nodes (28): subscriptionClaimReceivedEmail(), subscriptionClaimRejectedEmail(), deliver(), loadInvoiceById(), loadProof(), PlanPaymentInstructions, ProofAsset, reviewPlanPaymentClaim() (+20 more)

### Community 117 - "Community 117"
Cohesion: 0.1
Nodes (33): mocks, allocateOrderNumber(), applyStatus(), CancelInput, cancelOrder(), CreateInput, getOrder(), hostelNames() (+25 more)
...
Cohesion: 0.1
Nodes (27): GuardianHomeScreen(), GuardianMetrics(), GuardianPaymentsScreen(), GuardianSafetyScreen(), GuardianPayment, GuardianPermissions, canSee(), GUARDIAN_PERMISSION_LABELS (+19 more)

### Community 122 - "Community 122"
Cohesion: 0.1
Nodes (31): Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity() (+23 more)

### Community 123 - "Community 123"
Cohesion: 0.07
Nodes (22): EmptyState(), LoadingRows(), field(), HostelAdminMaintenancePageContent(), HostelAdminReferralsPageContent(), ListingFlag, LoadState, MaintenanceRequest (+14 more)
...
Cohesion: 0.08
Nodes (29): CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, readId(), activeDevicesFor(), activeTokensFor(), androidChannel(), authHeaders() (+21 more)
...
Cohesion: 0.09
Nodes (30): bsMonthStart(), formatBsDayRange(), computeInvoiceAmount(), countDaysInclusive(), FeeScheduleRecord, rateForRoomType(), hostelCalendarDay(), hostelMonthStart() (+22 more)
...
Cohesion: 0.1
Nodes (28): softmatoDocsUrl(), dueBhadra29, filed, throughAswin25, BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan (+20 more)
...
Cohesion: 0.09
Nodes (24): GET(), GET(), querySchema, foodRoutineSaveSchema, applicantSchema, billingCycleSchema, HostelRegistrationInput, hostelRegistrationSchema (+16 more)
...
Cohesion: 0.11
Nodes (19): EmailAttachment, receiptAttachment(), hostelId, mocks, receiptId, residentId, verified, gatewayUnhealthyEmail() (+11 more)
...
Cohesion: 0.1
Nodes (16): ExistingResidentsPanel(), Props, ExistingResidentsSheet(), HostelAdminExistingResidentsPage(), PayPlanPanel(), rupees(), TeamHostelResidentsPage(), downloadFile() (+8 more)
...
Cohesion: 0.11
Nodes (21): chelseaMarket, geistMono, geistSans, metadata, poppins, MediaViewerProvider(), NotificationSoundListener(), QueryProvider() (+13 more)
...
Cohesion: 0.11
Nodes (26): 5.1 SOS Triggered, 5. Safety & Emergency Emails, 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, 7.1 Attendance Alert (Resident Absent) (+18 more)
...
Cohesion: 0.13
Nodes (17): cropToGuide(), FILL, GuidedCapture(), GUIDES, GuideShape, loadManipulator(), Manipulator, InquiryFields() (+9 more)
...
Cohesion: 0.08
Nodes (23): draftFromProfile(), emptyIdentityDraft(), firstIncompleteIdentityStep(), IDENTITY_STEP_FIELDS, IDENTITY_STEPS, blank, BOTH_ASSETS, card (+15 more)
...
Cohesion: 0.15
Nodes (21): checkoutSchema, POST(), CheckoutStatus, closeIntent(), createPaymentIntent(), expireStaleIntents(), getCheckoutStatus(), handleProviderCallback() (+13 more)

### Community 168 - "Community 168"
Cohesion: 0.1
Nodes (21): addBsMonths(), august, bhadra, dateAgo(), hostelId, invoice(), mocks, NOW (+13 more)

### Community 169 - "Community 169"
Cohesion: 0.16
Nodes (16): otpCodeEmail(), sosAlertEmail(), wardRegisteredEmail(), hostelRejectedEmail(), paymentVerifiedEmail(), complaintResolvedEmail(), residentNewNoticeEmail(), residentAccessClearedEmail() (+8 more)
...
Cohesion: 0.11
Nodes (12): TYPE_COLORS, DraggablePinMap, FALLBACK_CENTER, LocationPicker(), LocationPickerValue, PART_LABELS, AddressParts, Coordinates (+4 more)
...
Cohesion: 0.22
Nodes (18): GET(), resolvePastedLink(), searchCandidates(), lookupLocation(), resolvePastedLink(), searchCandidates(), hostelAdminGeocodeQuerySchema, queryVariants() (+10 more)
...
Cohesion: 0.13
Nodes (14): recordConsent(), attendanceAlertResolveSchema, attendanceListQuerySchema, attendanceOverrideSchema, attendanceSettingsSchema, consentSchema, locationPingSchema, objectIdSchema (+6 more)
...
Cohesion: 0.12
Nodes (14): FeeSchedule, HostelAdminFeeSchedulePageContent, monthStartPeriod(), Rate, RoomTypeOption, gregorianSpan(), MonthField, MonthPicker (+6 more)
...
Cohesion: 0.14
Nodes (13): HostelMap(), Marker, PlaceMarker, humanizeNearbyType(), NEARBY_GLYPHS, NEARBY_GROUPS, NEARBY_ICONS, nearbyGlyph() (+5 more)
...
Cohesion: 0.13
Nodes (13): activateResident(), AuthSession, getResidentProfile(), AppNavigator(), Stack, LoginScreen(), Props, ResidentActivationScreen() (+5 more)
...
Cohesion: 0.12
Nodes (10): PlatformBroadcastPanel, PlatformOperationsPanel, CHECK_TONES, EmailCheck, GrantMode, PlatformAdmin, PlatformAdminInvite, PlatformOwner (+2 more)
...
Cohesion: 0.24
Nodes (6): Claim, CouldNotCreateFileException, HostelPalikaDownloadsModule, UnreadableSourceException, UnsupportedOnThisAndroidException, file
...
Cohesion: 0.16
Nodes (15): 3.2 Payment Overdue, 3.3 Payment Proof Uploaded (to Admin), 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, 4.1 New Notice Posted, 4.2 Complaint Status Updated, 4.3 Complaint Resolved (+7 more)
...
Cohesion: 0.24
Nodes (9): InquiryStatus, ManagedInquiry, BUCKETS, inquiriesIn(), InquiryAction, inquiryActions(), InquiryBucket, inquiryCounts() (+1 more)
...
Cohesion: 0.18
Nodes (8): ActivationStatusResponse, ActivationTarget, CodeState, DOT_COLOR, MeResponse, STATE_COPY, SessionStore, SessionUser
...
Cohesion: 0.18
Nodes (12): 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.3 Hostel Rejected, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, 3.1 Payment Due Reminder, code:typescript ({), code:typescript ({) (+4 more)
...
Cohesion: 0.29
Nodes (8): 7.2 Role Gate Test Template, 7.3 Privacy/Guardian Permissions Test Template, 7. Mandatory Test Templates, 9.2 Test Database Isolation, code:typescript (describe('GET /api/v1/hostel/rooms - role access', () => {), code:typescript (describe('GET /api/v1/guardian/linked-resident - privacy', (), code:bash (npm run web:lint), code:bash (npm run web:build)
...
Cohesion: 0.48
Nodes (6): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, canAccessWorkspace(), workspaceHostelName(), hostelAdminNavForSlug(), searchEntriesFromNav()
...
## Knowledge Gaps
- **5818 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+5813 more)
...
- **Why does `Button()` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 20`, `Community 22`, `Community 25`, `Community 30`, `Community 159`, `Community 32`, `Community 35`, `Community 164`, `Community 36`, `Community 37`, `Community 175`, `Community 50`, `Community 66`, `Community 67`, `Community 70`, `Community 73`, `Community 74`, `Community 88`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 13` to `Community 129`, `Community 2`, `Community 1`, `Community 133`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 142`, `Community 145`, `Community 17`, `Community 20`, `Community 151`, `Community 24`, `Community 28`, `Community 35`, `Community 39`, `Community 41`, `Community 44`, `Community 301`, `Community 46`, `Community 50`, `Community 51`, `Community 69`, `Community 76`, `Community 206`, `Community 84`, `Community 89`, `Community 105`, `Community 107`, `Community 112`, `Community 251`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 51` to `Community 0`, `Community 1`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 262`, `Community 138`, `Community 14`, `Community 139`, `Community 16`, `Community 145`, `Community 12`, `Community 20`, `Community 21`, `Community 22`, `Community 151`, `Community 414`, `Community 43`, `Community 44`, `Community 49`, `Community 185`, `Community 186`, `Community 59`, `Community 190`, `Community 64`, `Community 67`, `Community 70`, `Community 198`, `Community 72`, `Community 207`, `Community 209`, `Community 93`, `Community 96`, `Community 97`, `Community 100`, `Community 109`?**
...
- **What connects `iosUrlScheme`, `{ defineConfig }`, `expoConfig` to the rest of the system?**
  _5818 weakly-connected nodes found - possible documentation gaps or missing edges._
