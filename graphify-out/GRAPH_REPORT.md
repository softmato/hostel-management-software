...
## Corpus Check
- 1374 files · ~2,198,494 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10831 nodes · 28132 edges · 435 communities (413 shown, 22 thin omitted)
...
Cohesion: 0.02
Nodes (125): GET(), POST(), POST(), POST(), POST(), bulkApproveSchema, POST(), POST() (+117 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (150): Scanner(), GuardianInviteScreen(), CallableRow(), IdentityCard(), PeopleSection(), ContactRow(), GuardianLoginScreen(), IconButton() (+142 more)
...
Cohesion: 0.03
Nodes (107): GET(), POST(), POST(), GET(), recordConsent(), POST(), DELETE(), GET() (+99 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (84): ICONS, LABELS, TONES, Overview, PORTAL_ROWS, NotificationCard(), Person, ProfileScreen() (+76 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (144): sendEmail(), addHostelAdminProfilePhoto(), deleteHostelAdminProfilePhoto(), getHostelAdminProfile(), HostelAdminProfileQuery, HostelAdminProfileUpdateInput, HostelChangeRequestInput, HostelPhotoCreateInput (+136 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (129): BootGate(), RootShell(), BrandSplash(), AuthDivider(), GoogleSignInButton(), UploadToaster(), APP_NAME_PARTS, logo (+121 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (90): CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload, HostelTable(), UserRecord, DeletionQueue, DeletionRequest (+82 more)
...
Cohesion: 0.04
Nodes (116): deleteResidentLocationHistory(), addComplaintUpdate(), auditComplaintAction(), confirmComplaintResolution(), createComplaint(), findAdminComplaint(), listResidentComplaints(), replyToComplaint() (+108 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (88): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), AuthShell() (+80 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (76): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), field(), GuardianDashboard, GuardianPermissions, LoadState (+68 more)
...
Cohesion: 0.03
Nodes (71): csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, Inquiry, LoadState, Message() (+63 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (75): Ledger, OrphanAssignPicker, MatrixRow, MatrixTotals, PeriodSummary, ClaimFacts(), FLAG_LABELS, POSITIVE_FLAGS (+67 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (87): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, auditFinanceAction(), FinanceAuditInput, previousEntryHash(), voidInvoice() (+79 more)

### Community 16 - "Community 16"
Cohesion: 0.1
Nodes (58): LoadState, AnimatedPage(), AuthMode, Breadcrumbs(), formatMoney(), FormField(), HostelCard(), HostelListCard() (+50 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (73): PRIORITIES, STATUS_ACTIONS, Campaign, Resident, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel (+65 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (78): SubmitClaimScreen(), InvoiceDetailScreen(), LedgerCard(), SummaryCard(), AmountCard(), methodIcon(), methodLabel(), PayInvoiceScreen() (+70 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (82): NightStatusForm(), ReviewForm(), ReviewScreen(), CookTodayScreen(), CookMenuScreen(), CookPhotosScreen(), announcedCount(), FoodReadyAnnouncement (+74 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (73): ApiPrincipal, assertHostelAccess(), canAccessHostel(), hostelScopedFilter(), TenantAccessError, TenantPrincipal, noticeSchema, noticeReadStatusSchema (+65 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (64): HostelPhotoReminder(), HostelSuggestions(), inferKind(), LightboxItem, MediaLightbox(), PublicComparePage(), PublicHostel, ROUTINE_DAYS (+56 more)

### Community 22 - "Community 22"
Cohesion: 0.12
Nodes (49): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), guardianInvitationEmail(), sosAlertEmail() (+41 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (61): CommunityReportDialog(), REASONS, ConfirmOptions, ModerationButton(), PagerButton(), PublicHostelListingPage(), ReferenceCheck(), CopyButton() (+53 more)
...
Cohesion: 0.05
Nodes (62): DiscoveryHeader(), DiscoveryHeaderProps, IdCardFace(), IdCardPrompt(), BLOOD_OPTIONS, DIET_OPTIONS, GENDER_OPTIONS, ID_TYPE_OPTIONS (+54 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (58): POST(), RouteContext, computePerceptualHash(), systemDocumentKind(), cookieAccessToken(), isRole(), loadApiPrincipal(), DEFAULT_DOCUMENT_MIME_TYPES (+50 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (56): addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery, HostelAdminInquiryStatusInput, InquiryNoteCreateInput, InquiryNoteRecord, InquiryRecord (+48 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (59): AttendanceAlert, AttendanceCalendar(), AttendanceRow, HostelAdminAttendancePageContent, Zone, ZONE_ORDER, ZONE_STYLES, EMPTY_SUMMARY (+51 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (45): PATCH(), POST(), RouteContext, POST(), RouteContext, PATCH(), RouteContext, requireHostelStaffPrincipal() (+37 more)

### Community 32 - "Community 32"
Cohesion: 0.07
Nodes (57): CommunityScreen(), Composer(), CommunityBoard(), CommunityBoardProps, Composer(), CommentThread(), CommunityPostCard(), MediaGrid() (+49 more)
...
Cohesion: 0.05
Nodes (57): AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), NightStatusScreen(), FILTERS, NotificationsScreen(), ReferralsScreen(), SettingsScreen() (+49 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (60): paymentProofSchema, arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal (+52 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (54): serviceProviderApplicationSchema, serviceProviderDocumentSchema, DirectoryPageProps, EMPTY, metadata, ServiceProviderDirectoryPage(), ServiceProvidersPage(), hostelId (+46 more)
...
Cohesion: 0.04
Nodes (38): summarizeResidentComplaints(), bedSchema, depositRefundSchema, emergencyContactSchema, foodMenuSchema, guardianSchema, moveInChecklistSchema, moveOutChecklistSchema (+30 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (51): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery (+43 more)

### Community 44 - "Community 44"
Cohesion: 0.09
Nodes (56): notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus(), OPEN_STATUSES, OverdueComplaint, runComplaintSlaCheck(), EmailAttachment, daysBetween() (+48 more)

### Community 45 - "Community 45"
Cohesion: 0.06
Nodes (55): demoteToPublicAccount(), CapacityError, claimBedForRoomType(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary(), releaseBedForRoomType() (+47 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (54): getInvoiceMatrix(), InvoiceMatrix, InvoiceMatrixRow, listResidentClaims(), PortalInvoice, ResidentFinanceView, ResidentInvoiceLine, ResidentInvoiceReceipt (+46 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (38): GET(), PATCH(), RouteContext, listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), POST() (+30 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (47): accountDeletionRequestSchema, deviceTokenSchema, notificationSchema, sessionSchema, asRecord(), DeviceTokenRevokeInput, DeviceTokenSaveInput, markAllNotificationsRead() (+39 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (47): dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, isMonthEnd(), mealsOn(), ROUTINE_DAYS (+39 more)

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (49): AttachmentGallery(), ComplaintDetail(), ComplaintCard(), NewComplaintScreen(), PickedAttachment, ACTOR_LABELS, actorLabel(), Complaint (+41 more)
...
Cohesion: 0.05
Nodes (35): ENDPOINTS, esewaProvider, SIGNED_FIELDS, attempt, fetchMock, forged, live, payload (+27 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (29): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminSOSAlertsPage(), HostelAdminFoodPage(), redirectToWorkspaceScreen() (+21 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (44): GATEWAY_ORDER, getPayInstructions(), InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice(), assertQrAssetUsable() (+36 more)

### Community 57 - "Community 57"
Cohesion: 0.06
Nodes (40): PaginationMeta, paginationQuerySchema, querySchema, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex(), HostelRecord, ListingFlagListQuery (+32 more)
...
Cohesion: 0.06
Nodes (41): cookPrincipal, mocks, cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError, FoodPhotoUploadInput, FoodReadyInput (+33 more)

### Community 60 - "Community 60"
Cohesion: 0.04
Nodes (33): fadeUp, Feature, features, heroSlides, PublicHostelRegistrationLandingPage(), stagger, stats, cityOptions (+25 more)

### Community 61 - "Community 61"
Cohesion: 0.07
Nodes (39): DeletionPanel(), NotificationSettings(), THEME_OPTIONS, palette, DeletionRequest, DeletionStatus, getDeletionStatus(), requestAccountDeletion() (+31 more)
...
Cohesion: 0.06
Nodes (30): DeletionPathway, DeletionStatus, PATHWAY_COPY, CancelDeletionPageContent(), useConfirm(), AcceptResult, GuardianInvitePageContent, AttendanceDay (+22 more)
...
Cohesion: 0.08
Nodes (34): InquiryFields(), REALTIME_TOPIC_VALUES, useRealtime(), hasInquiryErrors(), InquiryDraft, InquiryErrors, normalizePhone(), validateInquiry() (+26 more)

### Community 67 - "Community 67"
Cohesion: 0.06
Nodes (29): GET(), POST(), PATCH(), RouteContext, objectIdSchema, platformReviewListQuerySchema, REVIEW_CATEGORY_KEYS, ReviewCategoryKey (+21 more)
...
Cohesion: 0.07
Nodes (31): AdminAlertsScreen(), AdminOverviewScreen(), loadOverview(), alertCounts(), AlertKind, AlertRow, buildAlertFeed(), occupancyRate() (+23 more)

### Community 74 - "Community 74"
Cohesion: 0.06
Nodes (23): LoadingRows(), TextArea(), field(), HostelAdminMaintenancePageContent(), HostelAdminReferralsPageContent(), HostelAdminReportsPageContent(), ListingFlag, LoadState (+15 more)
...
Cohesion: 0.11
Nodes (29): RealtimeConfig, RealtimeContext, RealtimeContextValue, RealtimeNotification, RealtimeProvider(), useRealtime(), GET(), HostelRef (+21 more)
...
Cohesion: 0.09
Nodes (30): hostelPageViewSchema, userResidentProfileSchema, LEGACY_ROLE_MAP, Role, ROLE_VALUES, ageFromDateOfBirth(), cardPhotoImageUrl(), clearResidentIdentityPhoto() (+22 more)
...
Cohesion: 0.07
Nodes (23): financeIntegrityHash(), checkAuditChain(), DRIFT_CODES, LedgerDriftSummary, runLedgerDriftForHostel(), after, broken, claimId (+15 more)

### Community 87 - "Community 87"
Cohesion: 0.09
Nodes (27): ADMIN_ISSUABLE_ROLES, AdminIssuableRole, generateTemporaryPassword(), HIGH_PRIVILEGE_ROLES, loginUrl(), RegisterOrUpgradeInput, registerOrUpgradeUserByEmail(), ROLE_LABELS (+19 more)
...
Cohesion: 0.08
Nodes (23): communitySettingsSchema, PATCH(), resolveHostelId(), assertHostelScopedApiAccess(), requireHostelAdminPrincipal(), requireHostelScopedPrincipal(), authMocks, request (+15 more)
...
Cohesion: 0.08
Nodes (24): GatewayHealth, GatewayHealthSummary, getGatewayHealth(), IntentCounts, plural(), recordHealth(), runGatewayHealthForHostel(), SEVERITY (+16 more)
...
Cohesion: 0.09
Nodes (27): notificationCampaignSchema, CampaignListQuery, CampaignRecord, createCampaign(), createHostelNotificationCampaign(), createPlatformNotificationCampaign(), dispatchCampaign(), dispatchDueCampaigns() (+19 more)

### Community 94 - "Community 94"
Cohesion: 0.12
Nodes (27): ApiFailure, apiRequest(), ApiSuccess, AuthUser, confirmComplaintResolution(), getActivationStatus(), listNotifications(), listResidentComplaints() (+19 more)

### Community 95 - "Community 95"
Cohesion: 0.08
Nodes (21): currency(), EmptyState(), Panel(), ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, Complaint, field() (+13 more)
...
Cohesion: 0.08
Nodes (21): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, statementImportSchema, importStatement(), loadStatementAsset(), periodOf(), readStatementBytes() (+13 more)
...
Cohesion: 0.09
Nodes (18): GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse, GoogleAuthUser, GoogleCredentialResponse, Window, CATEGORIES, isApplicationOpen() (+10 more)
...
Cohesion: 0.16
Nodes (20): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags(), evidenceFlags() (+12 more)
...
Cohesion: 0.12
Nodes (18): createResidentComplaint(), getResidentProfile(), login(), requestOtp(), ResidentComplaint, signInWithGoogle(), triggerSOS(), RootStackParamList (+10 more)
...
Cohesion: 0.12
Nodes (21): loadPayeeIdentity(), digitsOnly(), extractPayee(), HostelPayeeIdentity, matchesIdentity(), NAME_STOPWORDS, nameTokens(), PayeeRead (+13 more)
...
Cohesion: 0.19
Nodes (19): AssetViewer(), useViewerState(), ViewerPage(), clampIndex(), closeAssetViewer(), emit(), getAssetViewerState(), isPreviewable() (+11 more)
...
Cohesion: 0.11
Nodes (11): ROLE_VALUES, hostelMemberSchema, rolePermissionSchema, userSchema, hostelId, mocks, principal, residentA (+3 more)

### Community 143 - "Community 143"
Cohesion: 0.13
Nodes (17): findIndex(), index, indexesOf(), IndexSpec, promote, INVOICE_STATUSES, invoiceBalanceSchema, event (+9 more)
...
Cohesion: 0.15
Nodes (17): GET(), POST(), activeSuperadminCount(), createPlatformAdmin(), CreatePlatformAdminInput, generateTemporaryPassword(), listPlatformAdmins(), loginUrl() (+9 more)
...
Cohesion: 0.12
Nodes (19): 3.1 Payment Due Reminder, 3.3 Payment Proof Uploaded (to Admin), 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, 4.1 New Notice Posted, 4.2 Complaint Status Updated, 4.3 Complaint Resolved (+11 more)
...
Cohesion: 0.15
Nodes (15): daysFromNow(), enabledPermissionLabels(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags, GuardianPermissionsUpdateInput, GuardianRecord (+7 more)
...
Cohesion: 0.16
Nodes (16): 0.4 Template structure, 1.0 Signup One-Time Code, 1.1 Email Verification (PUBLIC Signup), 1.2 Hostel Admin Credentials (Post-Approval), 1.3 Warden Credentials, 1.5 Guardian Invitation, 1.6 Password Reset, 1. Authentication & Account Emails (+8 more)
...
Cohesion: 0.29
Nodes (7): hasFood(), PublicInquiryPage(), PublicInquiryPageContent(), InquiryPage(), isValidReferralCode(), normalizeReferralCode(), readReferralCode()

### Community 250 - "Community 250"
Cohesion: 0.24
Nodes (10): GenericPortalScreen(), portalRows(), portalTitle(), categoryLabel(), PROVIDER_CATEGORIES, ProviderCard(), ProviderDirectoryData, PublicProvider (+2 more)
...
Cohesion: 0.25
Nodes (8): 1.4 Resident QR Activation, 1.7 Account Upgraded, 2.3 Hostel Rejected, 3.2 Payment Overdue, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({)
...
Cohesion: 0.5
Nodes (4): ALIASES, CITY_IMAGES, cityImageUrl(), normalizeCity()
...
## Knowledge Gaps
- **3975 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+3970 more)
...
- **Why does `Button()` connect `Community 4` to `Community 1`, `Community 6`, `Community 7`, `Community 11`, `Community 13`, `Community 14`, `Community 18`, `Community 19`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 30`, `Community 34`, `Community 35`, `Community 50`, `Community 61`, `Community 66`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 23` to `Community 4`, `Community 6`, `Community 7`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 16`, `Community 17`, `Community 144`, `Community 21`, `Community 26`, `Community 30`, `Community 32`, `Community 288`, `Community 34`, `Community 35`, `Community 40`, `Community 60`, `Community 63`, `Community 71`, `Community 72`, `Community 80`, `Community 84`, `Community 214`, `Community 95`, `Community 97`, `Community 105`, `Community 113`, `Community 249`, `Community 250`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `Role` connect `Community 47` to `Community 0`, `Community 256`, `Community 2`, `Community 5`, `Community 8`, `Community 10`, `Community 138`, `Community 13`, `Community 142`, `Community 15`, `Community 272`, `Community 20`, `Community 26`, `Community 28`, `Community 156`, `Community 31`, `Community 35`, `Community 164`, `Community 163`, `Community 294`, `Community 295`, `Community 293`, `Community 38`, `Community 170`, `Community 43`, `Community 171`, `Community 44`, `Community 46`, `Community 45`, `Community 48`, `Community 49`, `Community 178`, `Community 312`, `Community 313`, `Community 314`, `Community 59`, `Community 67`, `Community 76`, `Community 205`, `Community 80`, `Community 85`, `Community 87`, `Community 89`, `Community 220`, `Community 99`, `Community 100`, `Community 360`, `Community 233`, `Community 234`, `Community 110`, `Community 113`, `Community 255`?**
