...
## Corpus Check
- 1942 files · ~3,329,762 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15381 nodes · 42531 edges · 512 communities (488 shown, 24 thin omitted)
...
## Communities (512 total, 24 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (310): AdminOverviewScreen(), loadOverview(), loadMoney(), loadToday(), AdminAlertsContext, AdminAlertsValue, AlertActions, EMPTY_COUNTS (+302 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (266): PATCH(), RouteContext, POST(), resolveOwnedHostel(), findOpenInvoice(), getOrCreateSubscription(), getSubscriptionState(), issueSubscriptionInvoice() (+258 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (198): PlanPaymentClaim, deferLoad(), DemoDataBadge(), Hostel, HostelTable(), Inquiry, LoadState, Message() (+190 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (203): POST(), GET(), POST(), POST(), PATCH(), POST(), RouteContext, GET() (+195 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (163): ICONS, LABELS, Segment, TONES, FILTERS, Pending, Overview, MoneyData (+155 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (194): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel() (+186 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (183): Scanner(), CookInviteScreen(), GuardianInviteScreen(), MapScreen(), Assurance(), CallableRow(), IdentityCard(), PeopleSection() (+175 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (158): GET(), PATCH(), RouteContext, getPlatformSubscriptionLedger(), GET(), listPlanPaymentClaims(), GET(), POST() (+150 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (170): POST(), RouteContext, DELETE(), GET(), hostelId(), GET(), POST(), DELETE() (+162 more)
...
Cohesion: 0.02
Nodes (163): CommunityScreen(), Composer(), CommunityBoard(), CommunityBoardProps, Composer(), SORTS, CommentThread(), CommunityPostCard() (+155 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (143): metadata, CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+135 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (145): AdminAlertsScreen(), AdminCommunityReportsScreen(), AdminHomeScreen(), AdminTabs(), HIDDEN, TABS, AdminMoreScreen(), AdminResidentsScreen() (+137 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (148): notifyAdminsOfNewComplaint(), notifyResidentOfComplaintStatus(), OPEN_STATUSES, OverdueComplaint, runComplaintSlaCheck(), hostelId, mocks, now (+140 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (137): getResidentAttendance(), listResidentComplaints(), summarizeResidentComplaints(), LedgerInvoice, listResidentInvoices(), outstandingForResident(), getResidentLedger(), monthsBetween() (+129 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (158): ProfileScreen(), ReferralRow(), CheckoutStatusScreen(), PaymentMonthStrip(), ManageRatesScreen(), CreditRow(), ManageStatementScreen(), METHOD_ICONS (+150 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (131): GET(), POST(), GET(), readReturnState(), invoiceIdFor(), GET(), DELETE(), POST() (+123 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (117): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), methodProvider(), PROVIDER_LABEL, QrPanel() (+109 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (115): HostelAdminReconcilePageContent, labelled(), PROVIDERS, Reconciliation, StatementImportRow, Suggestion, VideoSlot(), CollectionQrField() (+107 more)
...
Cohesion: 0.04
Nodes (104): deleteResidentLocationHistory(), DELETE(), GET(), POST(), querySchema, RouteContext, authorUserId, mocks (+96 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (83): GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, CITY_OPTIONS (+75 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (96): AdminCommunityScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+88 more)

### Community 23 - "Community 23"
Cohesion: 0.02
Nodes (73): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, ownerIdentitiesFor(), ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow (+65 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (91): BootGate(), RootShell(), SosScreen(), BottomChrome, BottomChromeContext, BottomChromeProvider(), CHROME_TIMING, useBottomChrome() (+83 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (79): FinanceAuditInput, financeIntegrityHash(), SetResidentFeeInput, approveClaim(), assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck, claimChecks() (+71 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (73): formatDate(), monthStartPeriod(), gregorianSpan(), MonthField, MonthOption(), MonthPicker, PeriodRow, defaultMonth() (+65 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (79): PaginationMeta, PaginationQuery, deviceTokenSchema, notificationSchema, ratingReviewSchema, reviewModerationLogSchema, sponsorSchema, input (+71 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (88): CapacityError, claimBedForRoomType(), listAllRoomTypes(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary(), releaseBedForRoomType() (+80 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (82): ComplaintDetail(), ComplaintCard(), ComplaintsScreen(), needsResident(), OPEN_STATUSES, rank(), CategoryTile(), NewComplaintScreen() (+74 more)

### Community 30 - "Community 30"
Cohesion: 0.02
Nodes (60): adminPrincipal, mocks, PLATFORM_LIMITS, mocks, readable, selectable, mocks, proofBody (+52 more)
...
Cohesion: 0.04
Nodes (78): ReviewForm(), ReviewScreen(), DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS, MealCard(), RoutineMeal (+70 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (75): auditFinanceAction(), previousEntryHash(), base, entityId, hostelId, mocks, principal, write() (+67 more)
...
Cohesion: 0.04
Nodes (73): BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan, BillingSkip (+65 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (58): csvField(), field(), numberField(), optionalField(), AddressFields, FORM_SECTIONS, HostelAdminProfilePageContent, PendingPhoto (+50 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (70): documents, hostelForm(), many, parsed, result, buildHostelPayload(), capacitySummary(), CITY_OPTIONS (+62 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (64): nepalMinuteOfDay(), formatPromptTime(), isCurrentNight(), isSameNight(), minuteIsDue(), parsePromptTime(), promptIsDue(), reminderIsDue() (+56 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (65): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, GATEWAY_ORDER, getHostelPayMethods() (+57 more)
...
Cohesion: 0.05
Nodes (59): GET(), POST(), GET(), GET(), GET(), POST(), acceptPlatformAdminInvitation(), AcceptPlatformAdminInvitationInput (+51 more)
...
Cohesion: 0.06
Nodes (53): JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, ProviderStatusCard(), TILE_INK (+45 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (44): ComparePage(), hostels, metadata, rows, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), PlatformDashboardPageContent(), PlatformHostelReviewPageContent() (+36 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (50): BrowserPushRow(), FILTERS, Notification, NotificationRow(), PushState, FILTERS, NotificationCard, NotificationsPageContent (+42 more)
...
Cohesion: 0.05
Nodes (51): CurrentUser, DASHBOARD_ROLES, dashboardHrefForRole(), hasDashboard(), MeResponse, moreItems, navItems, providerNavItems (+43 more)

### Community 53 - "Community 53"
Cohesion: 0.06
Nodes (58): FROZEN_RECEIPT_FIELDS, guardUpdate(), immutabilityError(), receipt, receiptSchema, receiptUpdateViolatesImmutability(), touched, arrangeProof() (+50 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (50): Footer(), IdCardFace(), initialsOf(), Portrait(), buildIdCard(), CARD_COLORS, CARD_NOUNS, CARD_VARIANTS (+42 more)

### Community 55 - "Community 55"
Cohesion: 0.09
Nodes (35): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), verificationEmail(), subscriptionClaimReceivedEmail(), subscriptionClaimRejectedEmail(), formatRupees() (+27 more)

### Community 56 - "Community 56"
Cohesion: 0.05
Nodes (46): BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan, Badge(), grabDocument(), HostelAdminBillingPageContent(), InvoiceRow() (+38 more)
...
Cohesion: 0.04
Nodes (44): HostelRegistrationProgress(), Milestone, milestoneIndex(), MILESTONES, PaymentPanel(), rupees(), SubscriptionState, cityOptions (+36 more)
...
Cohesion: 0.06
Nodes (45): nepalDayKey(), isCurrentNight(), isSelfReportable(), NIGHT_STATUS_OPTIONS, nightKey(), nightNote(), NightStanding, SelfReportableStatus (+37 more)

### Community 61 - "Community 61"
Cohesion: 0.05
Nodes (42): fill(), PricingScreen(), PlanPicker(), TIER_TONE, PlanMark(), RAFTER, RIDGE, ROWS (+34 more)

### Community 62 - "Community 62"
Cohesion: 0.05
Nodes (44): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), PortalDates, useSiteConfig() (+36 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (47): SiteAnnouncementBanner(), toneClasses, FALLBACK, SiteConfigContext, SiteConfigProvider(), platformSettingSchema, DEFAULT_SITE_CONFIG, coerceSection() (+39 more)

### Community 64 - "Community 64"
Cohesion: 0.07
Nodes (44): cookLoginStem(), generateCookPassword(), mintCookLogin(), pick(), previousCookLabel(), acceptCookInvitation(), addCookAccount(), assertRoomForAnotherCook() (+36 more)
...
Cohesion: 0.07
Nodes (40): listTrendingTags(), POST(), RouteContext, computePerceptualHash(), systemDocumentKind(), hashUserAgent(), HostelRef, newVisitorKey() (+32 more)
...
Cohesion: 0.07
Nodes (24): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), redirectToWorkspaceScreen(), HostelAdminReportsPageContent(), HostelAdminServiceProvidersPageContent() (+16 more)
...
Cohesion: 0.08
Nodes (38): deleteHostelObjects(), FILE_ASSET_KINDS, FileAssetKind, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES (+30 more)
...
Cohesion: 0.06
Nodes (35): accessId, adminPrincipal, codes, guardianId, guardianPrincipal, issue(), leanResult(), mocks (+27 more)
...
Cohesion: 0.1
Nodes (36): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt, allocateReceiptNumber() (+28 more)
...
Cohesion: 0.1
Nodes (41): collectionTotals(), countInvoicesByField(), invoicesByIds(), ledgerPipeline(), listRecentInvoices(), monthlySeries(), getHostelViewStats(), paymentProofSchema (+33 more)

### Community 82 - "Community 82"
Cohesion: 0.07
Nodes (35): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery (+27 more)

### Community 83 - "Community 83"
Cohesion: 0.06
Nodes (37): AttachmentGallery(), approveMatchedStatement(), assignOrphanPayment(), ReconciliationView, StatementProvider, EXTENSION_MIME, isAudio(), PickedFile (+29 more)
...
Cohesion: 0.08
Nodes (28): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, HostelPhotoReminder(), PortalShell(), navItems, canAccessWorkspace(), workspaceHostelName(), GUARDIAN_NAV (+20 more)

### Community 87 - "Community 87"
Cohesion: 0.09
Nodes (40): money(), PlanCard(), softmatoDocsUrl(), CYCLE_LABELS, daysUntil(), getBillingHistory(), getInvoiceDetailForHostel(), pricePlan() (+32 more)
...
Cohesion: 0.09
Nodes (36): Compass(), Guidance, GuidanceStatus, useGuidance(), cardinalFor(), CARDINALS, chooseHeading(), directionWord() (+28 more)

### Community 93 - "Community 93"
Cohesion: 0.06
Nodes (27): demoteToPublicAccount(), POST(), RouteContext, listResidentGuardians(), DEFAULT_GUARDIAN_PERMISSIONS, guardianInviteSchema, guardianLoginSchema, guardianPermissionsSchema (+19 more)
...
Cohesion: 0.06
Nodes (30): Offset, PhotoCropper(), CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg (+22 more)
...
Cohesion: 0.1
Nodes (32): deliver(), loadInvoiceById(), loadProof(), PlanPaymentInstructions, ProofAsset, reviewPlanPaymentClaim(), submitPlanPaymentClaim(), EmailAttachment (+24 more)

### Community 99 - "Community 99"
Cohesion: 0.12
Nodes (33): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags(), evidenceFlags() (+25 more)

### Community 100 - "Community 100"
Cohesion: 0.08
Nodes (27): GET(), querySchema, applicantSchema, billingCycleSchema, HostelRegistrationInput, hostelRegistrationSchema, registrationFields, RegistrationPlanChoice (+19 more)
...
Cohesion: 0.07
Nodes (34): CREDIT_MARKERS, DEBIT_MARKERS, DirectionRead, EvidenceDirection, EvidenceOutcome, matched(), OUTCOME_MARKERS, readEvidenceDirection() (+26 more)

### Community 105 - "Community 105"
Cohesion: 0.08
Nodes (29): qrActivationSchema, before, expiresAt, mocks, staffPrincipal, ActivationCodeGenerateInput, ActivationCodeInput, activationSecret() (+21 more)
...
Cohesion: 0.06
Nodes (20): AccountDeletionPanel, ResidentIdSharePage(), CATEGORIES, isApplicationOpen(), LandingStep(), MeResponse, OwnApplication, ProviderStats (+12 more)

### Community 110 - "Community 110"
Cohesion: 0.07
Nodes (22): EmptyState(), Panel(), TextArea(), field(), HostelAdminMaintenancePageContent(), HostelAdminReferralsPageContent(), ListingFlag, LoadState (+14 more)
...
Cohesion: 0.11
Nodes (27): bsMonthStart(), rateForRoomType(), hostelCalendarDay(), hostelMonthStart(), hostelPeriodOf(), hostelToday(), once, isActiveReferralCode() (+19 more)

### Community 117 - "Community 117"
Cohesion: 0.09
Nodes (23): getAttendanceSettings(), listHostelAttendance(), recordConsent(), resolveAdminHostelId(), resolveAttendanceAlert(), updateAttendanceSettings(), attendanceAlertResolveSchema, attendanceListQuerySchema (+15 more)
...
Cohesion: 0.15
Nodes (20): paymentClearedEmail(), paymentDueReminderEmail(), ReminderStage, wording(), paymentOverdueEmail(), paymentRejectedEmail(), paymentReversedEmail(), paymentProofReceivedEmail() (+12 more)
...
Cohesion: 0.14
Nodes (21): GET(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS, neutralize(), csv, toCsv() (+13 more)
...
Cohesion: 0.09
Nodes (24): normalize(), PortalSearch(), PortalTone, scoreEntry(), toneStyles, iconMap, IconName, NavItem (+16 more)
...
Cohesion: 0.11
Nodes (21): averageRating(), cityCount(), group(), HomeStat, homeStats(), rated, stats, vacantBeds() (+13 more)
...
Cohesion: 0.11
Nodes (23): Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity() (+15 more)
...
Cohesion: 0.14
Nodes (21): HostelServiceError, dashboardUrl(), notifyWardenAdded(), notifyWardenUpdated(), auditWardenAction(), createHostelWarden(), deactivateHostelWarden(), findScopedWarden() (+13 more)
...
Cohesion: 0.12
Nodes (21): analyseLuminanceTable(), containerOf(), EDITOR_MARKERS, editorFrom(), ExifFacts, ijgEntry(), isScreenShape(), JpegScan (+13 more)
...
Cohesion: 0.13
Nodes (21): AMOUNT_ALIASES, CREDIT_ALIASES, readMoney(), DATE_ALIASES, DEBIT_ALIASES, NAME_ALIASES, nonZero(), readMoney() (+13 more)
...
Cohesion: 0.19
Nodes (17): otpCodeEmail(), fromHeaderFor(), replyToFor(), setEmailIdentityResolver(), sosAlertEmail(), paymentVerifiedEmail(), complaintResolvedEmail(), residentNewNoticeEmail() (+9 more)
...
Cohesion: 0.1
Nodes (22): generateOtpCode(), normalizeOtpIdentifier(), otpRateLimitMax(), otpRateLimitWindowMs(), otpResendCooldownMs(), otpTtlMs(), requestOtpChallenge(), defaultDueDate() (+14 more)
...
Cohesion: 0.12
Nodes (16): AuthSession, getResidentProfile(), submitResidentReview(), triggerSOS(), AppNavigator(), RootStackParamList, Stack, LoginScreen() (+8 more)
...
Cohesion: 0.18
Nodes (13): ApiFailure, formatMegabytes(), PUBLIC_UPLOAD_TYPES, publicUploadError(), parseEnvelope(), PickedAsset, PublicFile, PublicUploadError (+5 more)
...
Cohesion: 0.24
Nodes (17): AttendanceAlert, AttendanceLog, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({), code:typescript (interface IQuestionCallClick {) (+9 more)
...
Cohesion: 0.27
Nodes (16): code:typescript (interface IHostelPageView {), code:typescript (// One per resident, per hostel. Minted lazily on first dash), code:typescript (interface ISubscription {), code:typescript (interface IPlatformSetting {), code:typescript (interface IAuditLog {), code:typescript ({), HostelPageView, Inquiries, Referral, Notifications, Subscriptions (+8 more)
...
Cohesion: 0.15
Nodes (12): activateResident(), listResidentNotices(), login(), markNoticeAsRead(), ResidentNotice, Props, Props, ResidentActivationScreen() (+4 more)
...
Cohesion: 0.18
Nodes (14): 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, 4.2 Complaint Status Updated, 4.3 Complaint Resolved, 4. Resident Activity Emails (+6 more)
...
Cohesion: 0.31
Nodes (11): AuditLog, code:typescript ({), code:typescript (interface IFoodReadyLog {), code:typescript ({), Notification, Notification, Notification, Notification (as built) (+3 more)
...
Cohesion: 0.22
Nodes (10): 1.7 Account Upgraded, 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.3 Hostel Rejected, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, code:typescript ({), code:typescript ({) (+2 more)
...
Cohesion: 0.24
Nodes (6): PortalPlaceholderAction, PortalPlaceholderPage(), PortalPlaceholderPageProps, GuardianScreenPageProps, HostelAdminScreenPage(), HostelAdminScreenPageProps
...
## Knowledge Gaps
- **5401 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+5396 more)
...
- **Why does `Button()` connect `Community 4` to `Community 0`, `Community 2`, `Community 5`, `Community 6`, `Community 10`, `Community 11`, `Community 12`, `Community 15`, `Community 17`, `Community 18`, `Community 24`, `Community 26`, `Community 156`, `Community 29`, `Community 31`, `Community 32`, `Community 35`, `Community 37`, `Community 38`, `Community 167`, `Community 47`, `Community 177`, `Community 49`, `Community 73`, `Community 83`, `Community 126`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 11` to `Community 129`, `Community 2`, `Community 4`, `Community 5`, `Community 18`, `Community 275`, `Community 21`, `Community 26`, `Community 35`, `Community 37`, `Community 42`, `Community 44`, `Community 46`, `Community 48`, `Community 177`, `Community 49`, `Community 52`, `Community 56`, `Community 58`, `Community 61`, `Community 63`, `Community 68`, `Community 86`, `Community 87`, `Community 95`, `Community 101`, `Community 109`, `Community 110`, `Community 111`, `Community 126`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 180` to `Community 0`, `Community 385`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 15`, `Community 18`, `Community 19`, `Community 21`, `Community 22`, `Community 151`, `Community 26`, `Community 160`, `Community 34`, `Community 37`, `Community 38`, `Community 39`, `Community 40`, `Community 169`, `Community 171`, `Community 50`, `Community 51`, `Community 181`, `Community 56`, `Community 58`, `Community 191`, `Community 192`, `Community 81`, `Community 84`, `Community 88`, `Community 97`, `Community 104`, `Community 365`, `Community 117`, `Community 119`, `Community 121`, `Community 123`?**
...
- **What connects `{ defineConfig }`, `expoConfig`, `path` to the rest of the system?**
  _5401 weakly-connected nodes found - possible documentation gaps or missing edges._
