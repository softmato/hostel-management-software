# Graph Report - hostel-management-software  (2026-09-11)

## Corpus Check
- 1957 files · ~3,343,818 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15561 nodes · 42842 edges · 529 communities (504 shown, 25 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 688 edges (avg confidence: 0.8)
...
3. `connectToDatabase()` - 435 edges
4. `useAppTheme()` - 373 edges
5. `cn()` - 283 edges
6. `connectToDatabase()` - 246 edges
7. `unwrap()` - 197 edges
...
## Communities (529 total, 25 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (284): POST(), GET(), POST(), POST(), PATCH(), POST(), RouteContext, GET() (+276 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (259): PATCH(), RouteContext, GET(), getOpenFeeSchedule(), GET(), listPublicFoodRoutine(), uploadFoodPhoto(), foodPhotoUploadSchema (+251 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (209): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), CookInviteScreen(), GuardianInviteScreen() (+201 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (249): FinanceData, loadFinance(), ManageFinanceScreen(), ManageRatesScreen(), ActivationIssue, addEmergencyContact(), addHostelPhoto(), addResidentGuardian() (+241 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (171): MANAGE_ROWS, PORTAL_ROWS, TodayData, AttendanceScreen(), NightStatusForm(), FILTERS, NotificationCard(), NotificationRow() (+163 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (146): PlanPaymentClaim, deferLoad(), DemoDataBadge(), Hostel, HostelTable(), Inquiry, LoadState, Message() (+138 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (166): CommunityReportDialog(), REASONS, ConfirmOptions, Notification, MonthOption(), BrowserPushRow(), FILTERS, Notification (+158 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (182): AdminMoreScreen(), ActivateScreen(), Scanner(), BootGate(), RootShell(), NotificationsScreen(), ApplyBlock(), ServiceProvidersScreen() (+174 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (180): summarizeResidentComplaints(), GET(), GET(), collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds() (+172 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (142): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel() (+134 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (155): AdminAlertsScreen(), ICONS, LABELS, Segment, TONES, AdminCommunityReportsScreen(), FILTERS, Pending (+147 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (143): verifyOtpChallenge(), GET(), GET(), POST(), DELETE(), PATCH(), RouteContext, getBillingPeriodSummary() (+135 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (130): AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput, ConsentInput, dayKey() (+122 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (108): HostelSuggestions(), GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS (+100 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (124): PaymentMonthStrip(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), AdminLedger, AdminLedgerEntry, AdminPeriodRow (+116 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (118): ReviewForm(), ReviewScreen(), DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS, MealCard(), MonthEndSpecial() (+110 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (106): CookShiftCard(), CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), methodProvider(), PROVIDER_LABEL (+98 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (105): AdminCommunityScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, CARD_PAD, EarningsTrend(), HostelHero() (+97 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (89): ATTENDANCE_DEFAULTS, adminPrincipal, mocks, PLATFORM_LIMITS, afterMidnight, evening, meters, mocks (+81 more)
...
Cohesion: 0.03
Nodes (97): GET(), POST(), demoteToPublicAccount(), GET(), querySchema, POST(), RouteContext, purgeArchivedHostel() (+89 more)
...
Cohesion: 0.03
Nodes (91): GET(), PaginationMeta, PaginationQuery, paginationQuerySchema, paginationRange(), querySchema, DEPRECATED_ALIASES, grantingPermissionKeys() (+83 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (99): Badge(), grabDocument(), HostelAdminBillingPageContent(), InvoiceRow(), PaymentRow(), PlanCard(), rupees(), shortDate() (+91 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (96): NightStatusScreen(), ReferralsScreen(), SORTS, StoreCategoryScreen(), ComplaintDetailScreen(), ComplaintsScreen(), HostelCompare(), GuardiansScreen() (+88 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (97): fromBs(), gregorianOf(), BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary (+89 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (91): sitemap(), STATIC_ROUTES, TIER_TONE, ListingTierTone, Plan, PlanId, portalAccessLines(), Service (+83 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (91): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintStatus() (+83 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (84): Offset, PhotoCropper(), VideoSlot(), CollectionQrField(), CurrentUser, MeResponse, PortalAccount(), PortalTone (+76 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (79): HostelAdminAttendancePageContent, HostelAdminCommunityPageContent, HostelAdminComplaintsPage, HostelAdminCooksPanel, HostelAdminDashboardPageContent, HostelAdminFeePlansPageContent, addDays(), COOK_PORTAL_DEFAULTS (+71 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (84): cookLoginStem(), generateCookPassword(), mintCookLogin(), pick(), previousCookLabel(), acceptCookInvitation(), addCookAccount(), assertRoomForAnotherCook() (+76 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (86): CapacityError, claimBedForRoomType(), listAllRoomTypes(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary(), releaseBedForRoomType() (+78 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (74): PRIORITIES, STATUS_ACTIONS, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel, GatewayConfig, GatewayHealthStatus (+66 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (61): metadata, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails(), RenderedSection (+53 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (66): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, secretsMatch(), ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS (+58 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (74): createResident(), getIntakeQuote(), IntakeQuote, lookupResidentProfile(), RESIDENT_TYPES, ResidentIntakeResult, ResidentOccupancy, ResidentPrefill (+66 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (68): cityOptions, createDocument(), createRoom(), DocumentConfig, DraftData, FACILITY_MINI, facilityOptions, FIELD_KEY_STEP (+60 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (41): InlineText(), PlanMark(), RAFTER, RIDGE, ROWS, EASE, listHeadingFor(), PlanCards() (+33 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (77): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, HostelPayeeIdentity, GATEWAY_ORDER (+69 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (78): createExpertConsultationRequest(), hashUserAgent(), HostelRef, newVisitorKey(), recordHostelPageView(), resolveVisitorKey(), getPresignedReadUrl(), hostelPageViewSchema (+70 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (73): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult (+65 more)

### Community 41 - "Community 41"
Cohesion: 0.02
Nodes (37): ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, RETAINED_BY_HOSTEL_ID, both, covered (+29 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (64): DiscoveryHeader(), IdCardFace(), initialsOf(), Portrait(), BLOOD_OPTIONS, DIET_OPTIONS, EditIdentityScreen(), GENDER_OPTIONS (+56 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (55): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, HostelPhotoReminder(), normalize(), PortalSearch(), PortalTone, scoreEntry(), toneStyles (+47 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (57): FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, monthStartPeriod(), Rate, RoomTypeOption, gregorianSpan(), MonthField (+49 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (68): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodBounds() (+60 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (54): financeIntegrityHash(), appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind, creditOverpayment(), getCreditAmount(), getCreditBalance() (+46 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (62): Choice, Compass(), maneuverIcon(), MapButton(), ModeTab(), NavCard(), NOTHING_CHOSEN, RouteCard() (+54 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (60): CommunityPostScreen(), CommentThread(), CommunityPostCard(), relativeTime(), ReportSheet(), ReactionBar(), ReactionChip(), SWING (+52 more)
...
Cohesion: 0.04
Nodes (46): ComparePage(), hostels, metadata, rows, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminRoomsPageContent(), PlatformDashboardPageContent() (+38 more)

### Community 52 - "Community 52"
Cohesion: 0.06
Nodes (54): GET(), escapeRegex(), serviceProviderApplicationSchema, serviceProviderDocumentSchema, PATCH(), ServiceProvidersPage(), GET(), ACTIVE_APPLICATION_STATUSES (+46 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (59): documents, hostelForm(), many, parsed, result, buildHostelPayload(), capacitySummary(), CITY_OPTIONS (+51 more)

### Community 54 - "Community 54"
Cohesion: 0.04
Nodes (43): AuthGuard(), CurrentUser, DASHBOARD_ROLES, dashboardHrefForRole(), hasDashboard(), MeResponse, moreItems, navItems (+35 more)
...
Cohesion: 0.06
Nodes (51): HostelRef, notifyHostelOfInquiry(), notifyPlatformOfPendingHostel(), cook, assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES (+43 more)

### Community 57 - "Community 57"
Cohesion: 0.06
Nodes (52): POST(), getCookToday(), dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, getFoodRoutine() (+44 more)

### Community 58 - "Community 58"
Cohesion: 0.05
Nodes (48): classifyCredit(), CreditClassification, LadderClaim, LadderInvoice, MatchContext, normalizeTxnId(), ANITA_CODE, claims (+40 more)
...
Cohesion: 0.08
Nodes (45): CSV_COLUMNS, GET(), POST(), safeEqual(), GET(), periodTotals(), csvCell(), csvFilename() (+37 more)

### Community 61 - "Community 61"
Cohesion: 0.06
Nodes (28): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminPaymentsPage(), redirectToWorkspaceScreen(), HostelAdminReferralsPageContent() (+20 more)

### Community 62 - "Community 62"
Cohesion: 0.08
Nodes (40): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, base (+32 more)
...
Cohesion: 0.07
Nodes (47): RoleLayout(), TABS, useQueryValue(), define(), announceFoodReady(), CookPhotoFeed, CookResident, CookToday (+39 more)

### Community 65 - "Community 65"
Cohesion: 0.09
Nodes (49): documentDownloadUrl(), issueInvoiceDocument(), openCheckoutSession(), readSettledReceipt(), deliver(), getPlanPaymentInstructions(), loadInvoiceById(), loadProof() (+41 more)
...
Cohesion: 0.06
Nodes (45): CategoryTile(), NewComplaintScreen(), PickedAttachment, SwapButton(), PhotoCapture(), VoiceNotePlayer(), RoundButton(), VOICE_NOTE_RECORDING (+37 more)
...
Cohesion: 0.07
Nodes (34): CommunityScreen(), Composer(), AttachmentGallery(), CommunityBoard(), CommunityBoardProps, Composer(), NotificationBell(), SORTS (+26 more)

### Community 71 - "Community 71"
Cohesion: 0.06
Nodes (45): paymentProofSchema, arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal (+37 more)

### Community 72 - "Community 72"
Cohesion: 0.07
Nodes (42): DELETE(), POST(), ApiPrincipal, CampaignListQuery, CampaignRecord, createCampaign(), createHostelNotificationCampaign(), createPlatformNotificationCampaign() (+34 more)

### Community 73 - "Community 73"
Cohesion: 0.07
Nodes (44): notifyResidentOfComplaintReply(), addComplaintUpdate(), assertComplaintVoiceNote(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren() (+36 more)

### Community 74 - "Community 74"
Cohesion: 0.07
Nodes (43): appBaseUrl(), CLAIMABLE_STATUSES, dispatchOtpChallenge(), dispatchVerificationEmail(), findVerifiedRegistrationChallenge(), generateOtpCode(), GOOGLE_JWKS, hashOtpCode() (+35 more)

### Community 75 - "Community 75"
Cohesion: 0.05
Nodes (42): approveClaim(), assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck(), evidenceCheck(), fileCheck() (+34 more)

### Community 76 - "Community 76"
Cohesion: 0.07
Nodes (41): bsMonthStart(), hostelToday(), FeeScheduleRecord, rateForRoomType(), monthsBetween(), periodOf(), ResidentDoc, ResidentLedger (+33 more)
...
Cohesion: 0.07
Nodes (36): RouteContext, referralSchema, referralRewardSchema, GET(), auditReferralAction(), confirmReferralJoined(), createReferredInquiry(), getResidentReferral() (+28 more)

### Community 82 - "Community 82"
Cohesion: 0.08
Nodes (40): mocks, allocateOrderNumber(), applyStatus(), CancelInput, cancelOrder(), CreateInput, hostelNames(), listAllOrders() (+32 more)

### Community 83 - "Community 83"
Cohesion: 0.07
Nodes (29): AdminTabs(), HIDDEN, TABS, AdminResidentsScreen(), SavedListRow(), TABS, AdminAlertsProvider(), HeadCell() (+21 more)

### Community 84 - "Community 84"
Cohesion: 0.09
Nodes (38): HostelScope, ResolvedDocument, resolveInvoiceDocument(), resolveReceiptDocument(), scopeFilter(), settledTotal(), trySoftmato(), InvoiceDocumentInput (+30 more)

### Community 85 - "Community 85"
Cohesion: 0.07
Nodes (32): averageRating(), cityCount(), group(), HomeStat, homeStats(), rated, stats, vacantBeds() (+24 more)
...
Cohesion: 0.1
Nodes (41): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags(), documentFlags() (+33 more)
...
Cohesion: 0.05
Nodes (42): 10. Account purge, 11. Hostel purge, 12. Ledger drift, 13. Complaint SLA, 14. Attendance maintenance, 15. Gateway health, 16. Gateway settlement recon, 1. Gateway expiry sweep (+34 more)
...
Cohesion: 0.08
Nodes (34): filterPushRecipients(), CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, readId(), activeDevicesFor(), activeTokensFor(), androidChannel() (+26 more)

### Community 95 - "Community 95"
Cohesion: 0.06
Nodes (26): accountId, adminId, calls, compact, guardian, linkAt, NO_CLEARANCE, publicId (+18 more)

### Community 96 - "Community 96"
Cohesion: 0.11
Nodes (34): CARD_NOUNS, CardVariant, drawBack(), drawBrandLockup(), drawFooterSweep(), drawFront(), drawHeaderSweep(), drawIdCard() (+26 more)

### Community 97 - "Community 97"
Cohesion: 0.06
Nodes (27): candidateRoots, fillMissing(), findRepoRoot(), { loadEnvConfig }, loadRootEnv(), parseEnvFile(), require, filled (+19 more)

### Community 98 - "Community 98"
Cohesion: 0.1
Nodes (33): Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity() (+25 more)
...
Cohesion: 0.09
Nodes (34): announcedCount(), announcementSummary(), CookFoodPhoto, CookPhotoDay, MealButton, mealButtonLabel(), mealButtons(), MealButtonsInput (+26 more)

### Community 105 - "Community 105"
Cohesion: 0.1
Nodes (27): POST(), RouteContext, sponsorSchema, DELETE(), PATCH(), RouteContext, GET(), POST() (+19 more)
...
Cohesion: 0.07
Nodes (23): currency(), LoadingRows(), Panel(), ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent, Complaint (+15 more)

### Community 110 - "Community 110"
Cohesion: 0.11
Nodes (32): money(), PlanCard(), pricePlan(), PlanCard(), CatalogueTab(), CycleDiscount(), PublicServiceDetailPage(), BillingCycle (+24 more)

### Community 111 - "Community 111"
Cohesion: 0.09
Nodes (25): liveUserIds(), notifyRateCardChanged(), ratesByRoomType(), ashaId, binodId, hostelId, mocks, notify() (+17 more)
...
Cohesion: 0.09
Nodes (25): buildHtml(), Marker, PlaceMarker, buildShell(), MapExplorer, MapExplorerProps, MapHandle, MapMarker (+17 more)

### Community 114 - "Community 114"
Cohesion: 0.09
Nodes (27): NearbyStatus, Coordinates, haversineMeters(), HostelWithDistance, isUsableCoordinate(), KATHMANDU, sortByDistance(), distance (+19 more)
...
Cohesion: 0.07
Nodes (24): fill(), PricingScreen(), HostelRegistrationProgress(), Milestone, milestoneIndex(), MILESTONES, PaymentPanel(), PlanPicker() (+16 more)
...
Cohesion: 0.13
Nodes (27): announceFoodReady(), startOfToday(), Candidate, dueMeals(), MealCallReminderResult, mealLabel(), RoutineRecord, runMealCallReminders() (+19 more)

### Community 119 - "Community 119"
Cohesion: 0.07
Nodes (20): EmptyState(), Input(), TextArea(), field(), HostelAdminMaintenancePageContent(), ListingFlag, LoadState, MaintenanceRequest (+12 more)

### Community 120 - "Community 120"
Cohesion: 0.11
Nodes (26): nightStatusPromptSchema, formatPromptTime(), isSameNight(), minuteIsDue(), parsePromptTime(), promptIsDue(), reminderIsDue(), duePrompts() (+18 more)

### Community 121 - "Community 121"
Cohesion: 0.25
Nodes (17): POST(), authenticateWithGoogle(), AuthServiceError, changePassword(), POST(), POST(), loginGuardian(), accessTokenTtlSeconds() (+9 more)

### Community 122 - "Community 122"
Cohesion: 0.09
Nodes (24): LIVE_ACCESS, releaseGuardianAccounts(), hostelId, mocks, userId, daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess() (+16 more)
...
Cohesion: 0.11
Nodes (25): AccountDeletionError, applyImmediateEffects(), cancelAccountDeletionByToken(), cancelAccountDeletionForUser(), cancelUrlFor(), DeletionPathway, DeletionRequestRecord, getAccountDeletionStatus() (+17 more)

### Community 129 - "Community 129"
Cohesion: 0.12
Nodes (26): ApiFailure, apiRequest(), ApiSuccess, AuthUser, confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listNotifications() (+18 more)

### Community 130 - "Community 130"
Cohesion: 0.08
Nodes (11): PublicHostelListingPage(), ComparePageSkeleton(), HostelDetailPageSkeleton(), HostelListingPageSkeleton(), InquiryPageSkeleton(), emptyFilters, Filters, metadata (+3 more)
...
Cohesion: 0.08
Nodes (20): BedRecord, listMaintenanceRequests(), MaintenanceCommentCreateInput, MaintenanceCommentRecord, MaintenanceHistoryRecord, MaintenanceProviderAssignInput, MaintenanceRequestCreateInput, MaintenanceRequestListQuery (+12 more)

### Community 137 - "Community 137"
Cohesion: 0.1
Nodes (22): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), MediaViewerProvider() (+14 more)

### Community 138 - "Community 138"
Cohesion: 0.09
Nodes (20): csvField(), field(), numberField(), optionalField(), AddressFields, FORM_SECTIONS, HostelAdminProfilePageContent, PendingPhoto (+12 more)

### Community 139 - "Community 139"
Cohesion: 0.1
Nodes (16): PlatformHostelsPageContent(), PlatformHostelsPageContent, PortalExperiencePage(), PortalPlaceholderAction, PortalPlaceholderPage(), PortalPlaceholderPageProps, ResidentProfilePageContent(), ResidentProfilePageContent (+8 more)
...
Cohesion: 0.11
Nodes (20): noticeReadStatusSchema, mocks, noticeInput, residentUserId, staffPrincipal, auditNoticeAction(), broadcastNotice(), createNotice() (+12 more)
...
Cohesion: 0.12
Nodes (17): geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), HostelGeoLocation, resolveHostelGeo(), fetchNearbyPlaces(), fetchNearbyWithGoogle() (+9 more)
...
Cohesion: 0.14
Nodes (18): FILE_ASSET_KINDS, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList() (+10 more)
...
Cohesion: 0.15
Nodes (19): softmatoDocsUrl(), dueBhadra29, filed, throughAswin25, BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan (+11 more)
...
Cohesion: 0.19
Nodes (19): AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim(), buildAddressQuery(), definedParts(), geocodeAddress(), geocodeWithGoogle(), geocodeWithNominatim() (+11 more)

### Community 188 - "Community 188"
Cohesion: 0.18
Nodes (20): getCurrentUser(), isApprovedServiceProvider(), issueSessionForUser(), login(), publicUser(), refreshAccessToken(), sameIds(), AuthTokenPayload (+12 more)
...
Cohesion: 0.13
Nodes (15): approvalPeriod(), getPeriodSummary(), monthsBetween(), periodOf(), PeriodRow, PeriodSummary, august, bhadra (+7 more)
...
Cohesion: 0.12
Nodes (21): 4.3 Complaint Resolved, 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, 7.1 New Hostel Pending Approval (to Superadmin), 7.2 Subscription Expiring Soon (+13 more)

### Community 194 - "Community 194"
Cohesion: 0.13
Nodes (15): activateResident(), AuthSession, submitResidentReview(), triggerSOS(), AppNavigator(), RootStackParamList, Stack, Props (+7 more)

### Community 195 - "Community 195"
Cohesion: 0.14
Nodes (21): code:typescript ({), code:typescript (interface IMoveInChecklistItem {), code:typescript (interface IMoveOutChecklistItem {), code:typescript (interface IServiceProvider {), code:typescript (interface IServiceProvider {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IMaintenanceRequest {), Complaint (+13 more)
...
Cohesion: 0.25
Nodes (16): GET(), resolvePastedLink(), searchCandidates(), lookupLocation(), resolvePastedLink(), searchCandidates(), queryVariants(), reverseGeocode() (+8 more)
...
Cohesion: 0.12
Nodes (17): ESEWA_CSV_PARSER, both, corrupted, debit, [first], FIXTURE, headerOnly, noDate (+9 more)
...
Cohesion: 0.13
Nodes (18): Bed, Build status (end of Phase 3), Build status (end of Phase 5 — verified 2026-08-02), code:typescript (export enum Role {), code:typescript (interface IRoomConfiguration {), code:typescript (interface IResident {), code:typescript (interface IGuardianAccessPermissions {), Conventions (+10 more)
...
Cohesion: 0.11
Nodes (14): DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), monthLabel(), PreviewColumn(), toNumber() (+6 more)
...
Cohesion: 0.24
Nodes (18): AuditLog, code:typescript (interface IInquiry {), code:typescript (interface IHostelPageView {), code:typescript (// One per resident, per hostel. Minted lazily on first dash), code:typescript (interface ISubscription {), code:typescript (interface IPlatformSetting {), code:typescript (interface IAuditLog {), code:typescript ({) (+10 more)
...
Cohesion: 0.17
Nodes (14): active, done, down(), failed, finished, first, next, notice (+6 more)
...
Cohesion: 0.19
Nodes (14): PlansConfig, buildPresentation(), featuresFor(), fit(), FORBIDDEN_PATTERNS, isSafe(), LIMITS, plain() (+6 more)
...
Cohesion: 0.15
Nodes (12): getResidentProfile(), login(), register(), verifyOtp(), LoginScreen(), Props, OtpVerificationScreen(), Props (+4 more)
...
Cohesion: 0.17
Nodes (8): AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET()

### Community 248 - "Community 248"
Cohesion: 0.3
Nodes (13): activeRegistration(), disableBrowserPush(), enableBrowserPush(), EnableResult, matchesKey(), publicKey(), PushStatus, PushSupport (+5 more)
...
Cohesion: 0.19
Nodes (5): ReturnState, ownerIdentitiesFor(), CheckoutReturnPage(), CachedConnection, globalForMongoose
...
Cohesion: 0.23
Nodes (10): categoryLabel(), PROVIDER_CATEGORIES, ProviderCard(), ProviderDirectoryData, PublicProvider, PublicServiceProviderDirectoryPage(), DirectoryPageProps, EMPTY (+2 more)
...
Cohesion: 0.29
Nodes (11): notifyStaffOfJobProgress(), addHistory(), addMaintenanceComment(), assignMaintenanceProvider(), auditMaintenanceAction(), findScopedMaintenanceRequest(), normalizeObjectIds(), scopedHostelFilter() (+3 more)

### Community 308 - "Community 308"
Cohesion: 0.31
Nodes (9): notifyProviderOfAssignment(), notifyProviderOfMaintenanceNote(), notifyProviderOfStatusChange(), notifyStaffOfNewMaintenanceRequest(), providerUserId(), readableCategory(), RequestLike, STATUS_WORDS (+1 more)
...
Cohesion: 0.2
Nodes (11): 0.1 The shared Softmato domain, 0.2 Categories — which mailbox a message comes from, 0.2a Where replies go, 0.3 Where the sender is configured, 0.4 Template structure, 0. Sending Infrastructure, code:block1 (softmato.com), code:block2 (packages/shared/src/email/) (+3 more)
...
Cohesion: 0.2
Nodes (9): CANVAS_NATIVE, dirname, { loadEnvConfig }, nextConfig, repoRoot, require, SECURITY_HEADERS, SHARP_NATIVE (+1 more)
...
Cohesion: 0.33
Nodes (7): logout(), readBodyRefreshToken(), blankRequest, missingRequest, request, clearSessionCookies(), POST()
...
Cohesion: 0.2
Nodes (10): 3.3 Payment Proof Uploaded (to Admin), 4.1 New Notice Posted, 4.2 Complaint Status Updated, 4. Resident Activity Emails, 5.1 SOS Triggered, 5. Safety & Emergency Emails, code:typescript ({), code:typescript ({) (+2 more)
...
Cohesion: 0.33
Nodes (9): assertBedInHostel(), assertProviderApproved(), assertRoomInHostel(), assertVoiceNoteUsable(), createMaintenanceRequest(), getMaintenanceSettings(), normalizeObjectId(), resolveAdminHostelId() (+1 more)
...
Cohesion: 0.28
Nodes (9): 2.2 Hostel Approved, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, code:block14 (---), code:typescript ({) (+1 more)
...
Cohesion: 0.29
Nodes (8): 2.1 Hostel Submission Received, 2.3 Hostel Rejected, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({)
...
Cohesion: 0.4
Nodes (4): native, NativeDownloads, openDownloaded(), SavedDownload
...
## Knowledge Gaps
- **5498 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+5493 more)
...
- **Why does `Button()` connect `Community 2` to `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 138`, `Community 14`, `Community 15`, `Community 16`, `Community 24`, `Community 29`, `Community 33`, `Community 35`, `Community 42`, `Community 43`, `Community 44`, `Community 47`, `Community 48`, `Community 63`, `Community 68`, `Community 125`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 6` to `Community 2`, `Community 130`, `Community 4`, `Community 5`, `Community 7`, `Community 9`, `Community 13`, `Community 278`, `Community 23`, `Community 26`, `Community 28`, `Community 29`, `Community 33`, `Community 36`, `Community 37`, `Community 43`, `Community 44`, `Community 49`, `Community 50`, `Community 51`, `Community 54`, `Community 86`, `Community 89`, `Community 106`, `Community 108`, `Community 109`, `Community 110`, `Community 116`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 1` to `Community 0`, `Community 128`, `Community 8`, `Community 136`, `Community 11`, `Community 12`, `Community 140`, `Community 396`, `Community 145`, `Community 20`, `Community 21`, `Community 22`, `Community 279`, `Community 152`, `Community 25`, `Community 26`, `Community 154`, `Community 27`, `Community 151`, `Community 30`, `Community 31`, `Community 34`, `Community 162`, `Community 38`, `Community 39`, `Community 40`, `Community 41`, `Community 46`, `Community 179`, `Community 52`, `Community 307`, `Community 56`, `Community 57`, `Community 58`, `Community 60`, `Community 61`, `Community 190`, `Community 188`, `Community 65`, `Community 66`, `Community 71`, `Community 72`, `Community 73`, `Community 74`, `Community 203`, `Community 76`, `Community 75`, `Community 332`, `Community 81`, `Community 82`, `Community 84`, `Community 88`, `Community 218`, `Community 93`, `Community 94`, `Community 95`, `Community 349`, `Community 105`, `Community 118`, `Community 247`, `Community 120`, `Community 121`, `Community 122`, `Community 127`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Are the 430 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 430 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `iosUrlScheme`, `{ defineConfig }`, `expoConfig` to the rest of the system?**
  _5498 weakly-connected nodes found - possible documentation gaps or missing edges._
