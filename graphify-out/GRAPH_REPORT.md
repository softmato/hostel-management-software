...
## Corpus Check
- 2340 files · ~5,129,116 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21149 nodes · 59724 edges · 595 communities (554 shown, 41 thin omitted)
...
## Communities (595 total, 41 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.0
Nodes (593): 594(), 978(), [A,P], abort(), {actionStateRoute:v,navigationState:P}, activate(), activeAnimationId(), activeThemeId() (+585 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (290): PATCH(), POST(), RouteContext, GET(), POST(), PATCH(), POST(), RouteContext (+282 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (275): FieldCashRow, PlanPaymentClaim, PayoutAccountForReview, ReviewPayoutAccount(), STATUS_LABEL, DeletionPathway, DeletionStatus, PATHWAY_COPY (+267 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (223): ICONS, LABELS, Segment, TONES, FILTERS, Pending, MoneyData, MANAGE_ROWS (+215 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (321): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), loadOverview(), Overview, loadMoney(), AdminTodayScreen(), loadToday() (+313 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (216): LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), csvField(), field(), Hostel, HostelAdminDashboardPageContent() (+208 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (266): Scanner(), CookInviteScreen(), GuardianInviteScreen(), Assurance(), CallableRow(), IdentityCard(), PeopleSection(), ContactRow() (+258 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (240): POST(), GET(), getOpenFeeSchedule(), GET(), listPublicFoodRoutine(), recordListingAppearances(), addHostelAdminInquiryNote(), auditInquiryAction() (+232 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (202): Choice, MapButton(), MapScreen(), ModeTab(), NOTHING_CHOSEN, PreviewCard(), ResultRow(), RouteCard() (+194 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (213): answerSchema, POST(), ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput (+205 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (204): AdminCommunityReportsScreen(), AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), BootGate(), RootShell(), NightStatusHistoryScreen(), NightStatusForm() (+196 more)

### Community 11 - "Community 11"
Cohesion: 0.01
Nodes (188): auditFinanceAction(), FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment() (+180 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (161): AdminCommunityScreen(), SosScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD (+153 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (86): number(), toNumber(), statusCodeOf(), toNumber(), Render the pamphlet.  One master per side: A4 + 3 mm bleed at 600 dpi. The A4, shoot(), _(), 276() (+78 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (193): MESSAGES, POST(), RouteContext, BookingEndCause, HostelBookingClosedCause, hoursWord(), announceConfirmed(), announceEnding() (+185 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (209): aa(), Ac(), Ad(), af(), ai(), Al(), ba(), bc() (+201 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (154): POST(), POST(), attacker, attempt(), headers, jsonRequest(), routeMocks, appBaseUrl() (+146 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (177): robots(), otpResendCooldownMs(), checkoutDocumentFor(), softmatoDocumentNumbers(), gateway, invoice, updateOne, documentDownloadUrl() (+169 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (152): BubbleBackground(), BubbleBackgroundProps, BubbleColors, StarLayer(), StarLayerProps, StarsBackground(), StarsBackgroundProps, AVATAR_MOTION_TRANSITION (+144 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (157): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, notifyHostelOfNewPost(), resolveHostelCommunityUserIds(), usersMutingNewPosts(), notifyAdminsOfNewComplaint() (+149 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (158): getHostelPayoutAccount(), POST(), RouteContext, DELETE(), GET(), hostelId(), GET(), GET() (+150 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (166): ProfileScreen(), ReferralRow(), CheckoutStatusScreen(), PaymentMonthStrip(), ManageRatesScreen(), ClearFilters(), CreditRow(), ManageStatementScreen() (+158 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (141): GetAppDialog(), Platform, GetPlanButton(), ConcessionBackfill, describeApplied(), FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent (+133 more)

### Community 23 - "Community 23"
Cohesion: 0.02
Nodes (154): AdminTabs(), HIDDEN, RoleLayout(), TABS, FILTERS, invalidateFeeds(), NIGHT_ANSWER_LABELS, nightAnswerText() (+146 more)
...
Cohesion: 0.02
Nodes (22): __addChild(), addPendingGesture(), build(), cancelEvent(), disconnect(), forceInvalidate(), __getChildren(), __getNativeConfig() (+14 more)

### Community 26 - "Community 26"
Cohesion: 0.02
Nodes (138): AttendanceScreen(), DayRow(), ReviewForm(), ReviewScreen(), describeGrants(), GuardianRow(), PermissionSheet(), InviteGuardianScreen() (+130 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (120): generateMetadata(), manifest(), notFound(), CityHostelsPage(), generateMetadata(), PageParams, generateMetadata(), metadata (+112 more)

### Community 28 - "Community 28"
Cohesion: 0.02
Nodes (131): PayPlanPanel(), rupees(), Offset, PhotoCropper(), VideoSlot(), CollectionQrField(), OperationsConfig, PendingSettingChange (+123 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (111): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), ApplyBlock(), ServiceProvidersScreen() (+103 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (15): c, ga(), getImageAsync(), ls(), notificationAsync(), object(), openBrowserAsync(), requestMicrophonePermissionsAsync() (+7 more)

### Community 31 - "Community 31"
Cohesion: 0.02
Nodes (36): add(), addChangeListener(), addEventListener(), addListenerForTag(), attachGestureHandler(), clearInteractionHandle(), configureNextLayoutAnimation(), createGestureHandler() (+28 more)

### Community 32 - "Community 32"
Cohesion: 0.02
Nodes (102): adminPrincipal, mocks, PLATFORM_LIMITS, authorUserId, leanResult(), mocks, postId, reactorUserId (+94 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (102): generateMetadata(), metadata, RefundPolicy, currentBsPeriod(), AccountDeletionPanel, ContentHeader(), ContentIntro(), ContentNote() (+94 more)

### Community 34 - "Community 34"
Cohesion: 0.02
Nodes (121): BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan, BillingSkip (+113 more)

### Community 35 - "Community 35"
Cohesion: 0.02
Nodes (95): GET(), listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), checkFieldCash(), listFieldCashToConfirm(), getPlatformSubscriptionLedger() (+87 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (114): cookPrincipal, mocks, resolveCookLabels(), announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError (+106 more)

### Community 37 - "Community 37"
Cohesion: 0.07
Nodes (79): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, hasFood(), budgetLabel() (+71 more)

### Community 38 - "Community 38"
Cohesion: 0.02
Nodes (105): BrandMark(), BrandWordmark(), WORDMARK, WORDMARK_SEGMENTS, SignedOutGate(), CurrentUser, MeResponse, PortalAccount() (+97 more)

### Community 39 - "Community 39"
Cohesion: 0.02
Nodes (86): authorUserId, mocks, postId, residentId, residentPrincipal, staffPrincipal, AnnouncementInput, CommentCreateInput (+78 more)

### Community 40 - "Community 40"
Cohesion: 0.02
Nodes (40): assert(), bubbles(), cancelable(), cancelBubble(), composed(), computeBlankness(), current(), currentTarget() (+32 more)
...
Cohesion: 0.03
Nodes (85): BookingQuote, GuestBookingDetail, GuestBookingSummary, HostelBookingView, metadata, List(), ReasonAction(), Row() (+77 more)
...
Cohesion: 0.03
Nodes (100): demoteToPublicAccount(), LIVE_ACCESS, releaseGuardianAccounts(), mocks, work, assertActiveReferralCode(), LIVE_STATUSES, LiveResidency (+92 more)

### Community 47 - "Community 47"
Cohesion: 0.03
Nodes (98): openStore(), answerHostelBooking(), CardBooking, findCardBooking(), getPayoutAccount(), HostelBooking, HostelBookings, HostelBookingsTab (+90 more)

### Community 48 - "Community 48"
Cohesion: 0.03
Nodes (87): PRIORITIES, STATUS_ACTIONS, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel, GatewayConfig, GatewayHealthStatus, HEALTH_STYLE, HostelAdminPaymentGatewaysPageContent (+79 more)

### Community 49 - "Community 49"
Cohesion: 0.03
Nodes (84): GET(), POST(), GET(), ownerIdentitiesFor(), resolveOwnedHostel(), POST(), GET(), querySchema (+76 more)

### Community 50 - "Community 50"
Cohesion: 0.03
Nodes (73): summarizeResidentComplaints(), accessId, accessQuery, adminPrincipal, codes, guardianId, guardianPrincipal, issue() (+65 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (80): CommunityScreen(), Composer(), CommunityPostScreen(), FLAGGED, ReportedPostCard(), AnimatedBlurView, CommunityBoard(), CommunityBoardProps (+72 more)

### Community 52 - "Community 52"
Cohesion: 0.02
Nodes (10): createInteractionHandle(), __getAnimatedValue(), getStringAsync(), __getValue(), impactAsync(), __onAnimatedValueUpdateReceived(), replace(), s (+2 more)

### Community 53 - "Community 53"
Cohesion: 0.02
Nodes (5): array(), deactivate(), l(), returnValue(), watchDeviceHeading()

### Community 54 - "Community 54"
Cohesion: 0.04
Nodes (50): InlineText(), TIER_TONE, PlanMark(), RAFTER, RIDGE, ROWS, EASE, PlanCards() (+42 more)

### Community 55 - "Community 55"
Cohesion: 0.03
Nodes (72): NotificationsPageContent(), Notification, BrowserPushRow(), FILTERS, Notification, NotificationRow(), PushState, FILTERS (+64 more)

### Community 56 - "Community 56"
Cohesion: 0.03
Nodes (69): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, ENDPOINTS, esewaProvider, getJson(), parseAmount(), SIGNED_FIELDS (+61 more)

### Community 57 - "Community 57"
Cohesion: 0.04
Nodes (80): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, HostelPayeeIdentity, GATEWAY_ORDER (+72 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (78): DELETE(), POST(), platformPushScheduleSchema, GET(), PATCH(), CampaignListQuery, CampaignRecord, createCampaign() (+70 more)

### Community 59 - "Community 59"
Cohesion: 0.05
Nodes (68): fileFieldCash(), submitFieldCash(), InvoiceRecord, applyWebhook(), recordSoftmatoPayment(), WebhookResult, EndBookingInput, ENDING_FOR_STATUS (+60 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (61): POST(), POST(), POST(), runPlanDueReminders(), POST(), POST(), RouteContext, periodOf() (+53 more)

### Community 61 - "Community 61"
Cohesion: 0.04
Nodes (70): POST(), GET(), POST(), listResidentGuardians(), DEFAULT_GUARDIAN_PERMISSIONS, guardianAccessCreateSchema, guardianInvitationAcceptSchema, guardianInviteSchema (+62 more)

### Community 62 - "Community 62"
Cohesion: 0.04
Nodes (64): monthsBetween(), periodOf(), hostelPeriodOf(), existingResidentListSchema, existingResidentRowSchema, BillPreview, CheckContext, CheckedRow (+56 more)

### Community 63 - "Community 63"
Cohesion: 0.04
Nodes (63): applyBookingConfig(), BookingCancelStep, bookingCancelStepSchema, BookingConfig, bookingConfigSchema, DEFAULT_BOOKING_CONFIG, DEFAULT_CANCEL_STEPS, mergeBookingConfig() (+55 more)

### Community 64 - "Community 64"
Cohesion: 0.03
Nodes (67): approveClaim(), assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck(), evidenceCheck(), fileCheck() (+59 more)

### Community 65 - "Community 65"
Cohesion: 0.05
Nodes (81): _adopt(), an(), ar(), as(), assignAnimationToWorker(), at(), bn(), broadcastMessage() (+73 more)

### Community 66 - "Community 66"
Cohesion: 0.04
Nodes (10): cancelAnimationFrame(), clear(), darken(), __debouncedOnEnd(), emit(), h(), pause(), pausePreview() (+2 more)

### Community 67 - "Community 67"
Cohesion: 0.05
Nodes (75): addBsMonths(), BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsMonthStart(), bsPeriodBounds() (+67 more)

### Community 68 - "Community 68"
Cohesion: 0.06
Nodes (60): DELETE(), RouteContext, GET(), POST(), querySchema, RouteContext, commentOnPost(), createCommunityAnnouncement() (+52 more)
...
Cohesion: 0.05
Nodes (59): CardBooking, checkInBooking(), findCardBooking(), findHeldBooking(), returnHeldBed(), takeHeldBed(), account, answerBy (+51 more)

### Community 73 - "Community 73"
Cohesion: 0.03
Nodes (60): PlanId, Service, ServiceModule, ServiceModuleId, Faq, PlatformConfigSeoPageContent, Step, CONTENT_ICON_SLUGS (+52 more)

### Community 74 - "Community 74"
Cohesion: 0.03
Nodes (10): ensureConfig(), f(), get_slot_str(), getSlot(), notify(), run(), scanFromURLAsync(), setState() (+2 more)
...
Cohesion: 0.04
Nodes (49): BillingInvoiceRow, BillingPaymentRow, BillingPlan, formatBsAdDate(), metadata, CheckoutHandoffButton(), Handoff, ORDER (+41 more)
...
Cohesion: 0.04
Nodes (41): AuditLogRecord, PlatformAuditLogQuery, RefRecord, serializeAuditLog(), mocks, PaginationMeta, PaginationQuery, querySchema (+33 more)
...
Cohesion: 0.05
Nodes (48): BookButton(), SIZE, BookingAvailabilityView, BookingButton, CLOSED_REASONS, open, HostelSuggestions(), PublicComparePage() (+40 more)

### Community 84 - "Community 84"
Cohesion: 0.04
Nodes (43): EASE, FaqEntry, FaqRole, FaqRow(), FAQS, PREVIEW_ROWS, PREVIEWS, ROLES (+35 more)

### Community 85 - "Community 85"
Cohesion: 0.05
Nodes (45): POST(), hostelToday(), dayOfWeekSchema, foodFeedbackSchema, foodMenuCreateSchema, foodMenuListQuerySchema, foodMenuUpdateSchema, foodRoutineSaveSchema (+37 more)
...
Cohesion: 0.07
Nodes (53): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags() (+45 more)

### Community 88 - "Community 88"
Cohesion: 0.06
Nodes (46): assertPlanRoom(), countLive(), notifyLimitReached(), NOUN, PlanLimitError, PlanSeat, hostelId, mocks (+38 more)

### Community 89 - "Community 89"
Cohesion: 0.05
Nodes (43): escapeRegex(), objectIdSchema, paginationSchema, phoneSchema, serviceProviderSchema, serviceProviderApplicationSchema, serviceProviderDocumentSchema, hostelId (+35 more)
...
Cohesion: 0.07
Nodes (45): deliver(), Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity, EmailIdentityResolver, envEmailDomain() (+37 more)

### Community 92 - "Community 92"
Cohesion: 0.08
Nodes (46): fill(), money(), PlanCard(), PricingScreen(), BillingToggle(), listHeadingFor(), PlanCard(), CatalogueTab() (+38 more)
...
Cohesion: 0.08
Nodes (37): Entry, hostelEntries(), locationEntries(), sitemap(), STATIC_ROUTES, PublicFooter(), listPublishedHostelSlugs(), buildCityIndex() (+29 more)

### Community 101 - "Community 101"
Cohesion: 0.1
Nodes (34): bodySchema, POST(), deleteHostelObjects(), r2Configured(), storePublicAsset(), AccessLevel, bucketForAccessLevel(), deleteFromR2() (+26 more)
...
Cohesion: 0.07
Nodes (32): CommunityPageContent(), FeedPayload, NewPostAlertsToggle(), SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+24 more)
...
Cohesion: 0.07
Nodes (33): FeeScheduleRecord, hostelCalendarDay(), hostelMonthStart(), hostelToday(), once, isActiveReferralCode(), aswinLastDay, email (+25 more)
...
Cohesion: 0.11
Nodes (30): getInvoiceDetailForHostel(), bookingDocumentLayout(), refundPolicyNotes(), allowed(), bookingDocumentResponse(), BookingDocumentScope, resolveBookingDocument(), HostelScope (+22 more)
...
Cohesion: 0.1
Nodes (36): getPresignedReadUrl(), hostelPageViewSchema, LEGACY_ROLE_MAP, Role, ROLE_VALUES, CARD_LABELS, formatIssuedOn(), readPhotoBytes() (+28 more)
...
Cohesion: 0.08
Nodes (33): deliver(), emailFacts(), hostelOrThrow(), notifyPlatformOfPayoutReview(), PayoutAccountStatus, PayoutAccountView, PayoutActor, PayoutRecord (+25 more)
...
Cohesion: 0.09
Nodes (32): POST(), cook, assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES, PermissionError, PLATFORM_ROLES (+24 more)
...
Cohesion: 0.09
Nodes (35): cancelStoreOrder(), Cart, CartLine, CartResult, CartTotals, clearCart(), getCart(), getCartCount() (+27 more)
...
Cohesion: 0.1
Nodes (27): computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, drawCertificationStamp(), footerLine(), formatDate() (+19 more)
...
Cohesion: 0.08
Nodes (19): PortalDates, useHostelDayTurn(), PlanBillingInvoice, PlanBillingPayment, PlanBillingPlan, SitePlans, FADED, LIFT (+11 more)
...
Cohesion: 0.11
Nodes (23): userResidentProfileSchema, findLiveResidency(), ageFromDateOfBirth(), lookupResidentProfile(), normalizeResidentId(), readProfile(), ResidentIdentityError, resolvePlatformIdCard() (+15 more)
...
Cohesion: 0.17
Nodes (20): Compass(), cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath(), hasArrived(), headingDifference() (+12 more)
...
Cohesion: 0.15
Nodes (13): AuthSession, getResidentProfile(), submitResidentReview(), AppNavigator(), RootStackParamList, Stack, Profile, Props (+5 more)
...
Cohesion: 0.13
Nodes (16): apiRequest(), confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), getResidentNightStatus(), listResidentComplaints(), login(), refreshSession() (+8 more)
...
Cohesion: 0.12
Nodes (14): maneuverIcon(), NavCard(), formatManeuverDistance(), corner, dogleg, heading, KILOMETRE_EAST, located (+6 more)
...
Cohesion: 0.15
Nodes (15): 2.3 Hostel Rejected, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails, code:typescript ({) (+7 more)
...
Cohesion: 0.18
Nodes (12): 10.1 GitHub Actions Workflow, 10.2 Merge Rules, 10. CI/CD Integration, 7.1 Multi-Tenant Isolation Test Template, 7.4 Account-Upgrade Test Template, 7.5 Payment Precision Test Template, 7. Mandatory Test Templates, code:typescript (describe('GET /api/v1/hostel/rooms/:id - tenant isolation', ) (+4 more)
...
Cohesion: 0.18
Nodes (11): 12.2 Tenant Isolation Bugs, 7.2 Role Gate Test Template, 7.3 Privacy/Guardian Permissions Test Template, 9.2 Test Database Isolation, code:typescript (describe('GET /api/v1/hostel/rooms - role access', () => {), code:typescript (describe('GET /api/v1/guardian/linked-resident - privacy', (), code:typescript (// In test setup (e.g., jest.setup.ts)), code:bash (TEST_MONGODB_URI=mongodb://localhost:27017/multi-hostel-test) (+3 more)
...
Cohesion: 0.29
Nodes (7): classifyRow(), normalizeHeader(), SETTLED_STATUSES, StatementParseResult, StatementProvider, SUMMARY_LABELS, UNSETTLED_STATUSES
...
Cohesion: 0.4
Nodes (5): 4.2 Complaint Status Updated, 4.3 Complaint Resolved, 4. Resident Activity Emails, code:typescript ({), code:typescript ({)
...
- **Why does `string()` connect `Community 14` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 25`, `Community 26`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 34`, `Community 36`, `Community 38`, `Community 40`, `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 46`, `Community 47`, `Community 49`, `Community 51`, `Community 52`, `Community 53`, `Community 56`, `Community 57`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 63`, `Community 64`, `Community 66`, `Community 67`, `Community 72`, `Community 74`, `Community 75`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 85`, `Community 86`, `Community 91`, `Community 93`, `Community 98`, `Community 102`, `Community 106`, `Community 109`, `Community 110`, `Community 111`, `Community 112`, `Community 116`, `Community 118`, `Community 122`, `Community 127`, `Community 132`, `Community 140`, `Community 156`, `Community 162`, `Community 168`, `Community 170`, `Community 176`, `Community 177`, `Community 186`, `Community 193`, `Community 204`, `Community 222`, `Community 260`, `Community 275`, `Community 309`, `Community 431`, `Community 435`?**
  _High betweenness centrality (0.154) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 13` to `Community 1`, `Community 2`, `Community 6`, `Community 10`, `Community 11`, `Community 140`, `Community 12`, `Community 14`, `Community 16`, `Community 17`, `Community 21`, `Community 22`, `Community 24`, `Community 153`, `Community 25`, `Community 155`, `Community 28`, `Community 30`, `Community 31`, `Community 33`, `Community 35`, `Community 164`, `Community 37`, `Community 36`, `Community 40`, `Community 41`, `Community 45`, `Community 176`, `Community 48`, `Community 53`, `Community 56`, `Community 185`, `Community 186`, `Community 57`, `Community 312`, `Community 440`, `Community 193`, `Community 67`, `Community 195`, `Community 74`, `Community 204`, `Community 78`, `Community 81`, `Community 82`, `Community 83`, `Community 86`, `Community 218`, `Community 222`, `Community 100`, `Community 361`, `Community 106`, `Community 110`, `Community 114`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 18` to `Community 2`, `Community 3`, `Community 130`, `Community 5`, `Community 263`, `Community 135`, `Community 22`, `Community 153`, `Community 27`, `Community 28`, `Community 33`, `Community 37`, `Community 38`, `Community 41`, `Community 43`, `Community 48`, `Community 307`, `Community 54`, `Community 55`, `Community 194`, `Community 69`, `Community 76`, `Community 81`, `Community 83`, `Community 84`, `Community 92`, `Community 99`, `Community 105`, `Community 108`?**
