# Graph Report - hostel-management-software  (2026-09-07)

## Corpus Check
- 1772 files · ~3,152,377 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14298 nodes · 39334 edges · 522 communities (501 shown, 21 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 614 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 577 edges
2. `successResponse()` - 565 edges
3. `connectToDatabase()` - 384 edges
4. `useAppTheme()` - 356 edges
5. `cn()` - 262 edges
6. `connectToDatabase()` - 227 edges
7. `unwrap()` - 192 edges
8. `useResource()` - 191 edges
9. `Text()` - 172 edges
...
## Communities (522 total, 21 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (271): POST(), GET(), POST(), GET(), PATCH(), POST(), RouteContext, GET() (+263 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (180): ICONS, LABELS, Segment, TONES, FILTERS, Pending, Overview, MoneyData (+172 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (281): loadOverview(), loadMoney(), loadToday(), loadFinance(), DeletionRequest, DeletionStatus, getDeletionStatus(), requestAccountDeletion() (+273 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (240): POST(), POST(), GET(), getOpenFeeSchedule(), GET(), POST(), getFoodRoutinesByHostelId(), listPublicFoodRoutine() (+232 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (218): Scanner(), FaqRow(), MethodCard(), CookInviteScreen(), GuardianInviteScreen(), Assurance(), CallableRow(), IdentityCard() (+210 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (151): CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload, csvField(), deferLoad(), DemoDataBadge(), field() (+143 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (112): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), ConfirmOptions (+104 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (139): AdminTabs(), HIDDEN, TABS, FILTERS, NotificationRow(), NotificationsScreen(), TILE_GLYPH, TILE_TONES (+131 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (141): deleteResidentLocationHistory(), getResidentAttendance(), DELETE(), checkoutSchema, POST(), POST(), GET(), POST() (+133 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (118): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, CommunityReportDialog(), REASONS, ModerationButton(), PagerButton(), normalize(), PortalSearch() (+110 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (135): PaymentMonthStrip(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), InvoiceDetailScreen(), SummaryCard(), AmountCard() (+127 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (108): AdminMoreScreen(), ActivateScreen(), BootGate(), RootShell(), ApplyBlock(), ServiceProvidersScreen(), SettingsScreen(), GuardianLoginScreen() (+100 more)
...
Cohesion: 0.03
Nodes (90): FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, monthStartPeriod(), Rate, RoomTypeOption, MonthField, MonthOption() (+82 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (110): AdminAlertsScreen(), AdminCommunityScreen(), AdminCommunityReportsScreen(), AdminHomeScreen(), AdminOverviewScreen(), AdminMoneyScreen(), AdminResidentsScreen(), AdminTodayScreen() (+102 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (99): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, POST(), notifyAdminsOfNewComplaint() (+91 more)
...
Cohesion: 0.03
Nodes (80): resolveAdminHostelId(), PaginationMeta, PaginationQuery, paginationQuerySchema, querySchema, assertHostelAccess(), canAccessHostel(), hostelScopedFilter() (+72 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (88): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), sitemap() (+80 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (83): CommunityScreen(), Composer(), AttachmentGallery(), CommunityBoard(), CommunityBoardProps, Composer(), SORTS, CommentThread() (+75 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (91): bsMonthStart(), hostelCalendarDay(), hostelToday(), BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register() (+83 more)

### Community 21 - "Community 21"
Cohesion: 0.09
Nodes (61): accountDeletionCancelledEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), cookInvitationEmail(), guardianInvitationEmail(), sosAlertEmail() (+53 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (78): HostelAdminCommunityPageContent, EMPTY_SUMMARY, HostelAdminComplaintsPage, CookAccount, Credentials, HostelAdminCooksPanel, Issued, addDays() (+70 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (81): demoteToPublicAccount(), GET(), RouteContext, POST(), RouteContext, POST(), RouteContext, CapacityError (+73 more)
...
Cohesion: 0.04
Nodes (77): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult (+69 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (76): collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor() (+68 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (61): DocumentScreen(), MobileLegal, InfoActions(), InfoHeader(), InfoHighlights(), InfoIcon, InfoIntro(), InfoNote() (+53 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (61): ENDPOINTS, esewaProvider, SIGNED_FIELDS, attempt, fetchMock, forged, live, payload (+53 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (72): cookLoginStem(), generateCookPassword(), mintCookLogin(), pick(), previousCookLabel(), cookPrincipal, mocks, acceptCookInvitation() (+64 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (57): ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails(), RenderedSection, LegalBody() (+49 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (66): InvoiceHeaderBlock(), LedgerCard(), CopyButton(), methodIcon(), methodLabel(), methodProvider(), PayInvoiceScreen(), PROVIDER_LABEL (+58 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (64): Notification, BrowserPushRow(), FILTERS, Notification, NotificationRow(), PushState, FILTERS, NotificationCard (+56 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (77): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsPeriodBounds(), bsPeriodOf() (+69 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (70): CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing, CurrentUser (+62 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (50): summarizeResidentComplaints(), issue(), auditGuardianAction(), createGuardianAccess(), expiresInDays(), findAdminResident(), GuardianAccessCreateInput, GuardianAccessRecord (+42 more)

### Community 36 - "Community 36"
Cohesion: 0.05
Nodes (64): POST(), getFoodRoutine(), saveFoodRoutine(), serializeRoutine(), addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange() (+56 more)
...
Cohesion: 0.05
Nodes (69): documents, hostelForm(), many, parsed, result, buildHostelPayload(), capacitySummary(), CITY_OPTIONS (+61 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (59): addComplaintUpdate(), assertComplaintVoiceNote(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput (+51 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (59): AdminAlertsContext, AdminAlertsValue, AlertActions, EMPTY_COUNTS, ICONS, LABELS, TONES, AssetViewer() (+51 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (42): metadata, CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+34 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (58): ProviderDirectoryData, notifyStaffOfJobProgress(), serviceProviderApplicationSchema, serviceProviderDocumentSchema, REALTIME_TOPIC, DirectoryPageProps, EMPTY, metadata (+50 more)

### Community 43 - "Community 43"
Cohesion: 0.06
Nodes (62): feeUpdateSchema, PATCH(), setResidentMonthlyFee(), POST(), GET(), alreadyReviewedError(), approvePaymentProof(), assertProofIsPending() (+54 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (44): fill(), PricingScreen(), InlineText(), TIER_TONE, PlanMark(), ROWS, BillingToggle(), EASE (+36 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (62): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES (+54 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (50): financeIntegrityHash(), getCreditBalance(), Entry, eventId, hostelId, invoiceId, mocks, residentId (+42 more)
...
Cohesion: 0.05
Nodes (54): GATEWAY_ORDER, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice(), assertQrAssetUsable(), EMPTY (+46 more)
...
Cohesion: 0.06
Nodes (60): EvidenceEngineMode, AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance(), deadline(), DIGIT_CONFUSABLES (+52 more)
...
Cohesion: 0.05
Nodes (39): ComparePage(), hostels, metadata, rows, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminRoomsPageContent(), PlatformDashboardPageContent() (+31 more)

### Community 56 - "Community 56"
Cohesion: 0.08
Nodes (43): appBaseUrl(), AuthServiceError, CLAIMABLE_STATUSES, dispatchOtpChallenge(), dispatchVerificationEmail(), findVerifiedRegistrationChallenge(), getCurrentUser(), GOOGLE_JWKS (+35 more)

### Community 57 - "Community 57"
Cohesion: 0.07
Nodes (52): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags() (+44 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (43): PATCH(), RouteContext, referralSchema, referralCodeSchema, referralRewardSchema, GET(), assertActiveReferralCode(), auditReferralAction() (+35 more)

### Community 59 - "Community 59"
Cohesion: 0.06
Nodes (49): Compass(), isUsableCoordinate(), cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath(), hasArrived() (+41 more)

### Community 60 - "Community 60"
Cohesion: 0.07
Nodes (43): GET(), AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput, ConsentInput (+35 more)
...
Cohesion: 0.08
Nodes (38): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, SystemDocumentKind (+30 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (30): adminPrincipal, mocks, PLATFORM_LIMITS, mocks, readable, selectable, base, entityId (+22 more)

### Community 64 - "Community 64"
Cohesion: 0.06
Nodes (40): GET(), POST(), findResidentOwnedAccess(), listResidentGuardians(), revokeGuardianAccess(), updateGuardianPermissions(), DEFAULT_GUARDIAN_PERMISSIONS, guardianInvitationAcceptSchema (+32 more)

### Community 65 - "Community 65"
Cohesion: 0.07
Nodes (35): depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, providedItemSchema, roomSchema, auditMoveAction(), createMoveInChecklist(), createMoveOutChecklist() (+27 more)

### Community 66 - "Community 66"
Cohesion: 0.06
Nodes (37): EvidenceEngine, EvidenceReadFailure, OcrResult, OcrWord, Attempt, billingPeriod(), DEFAULT_MODELS, GeminiRead (+29 more)

### Community 67 - "Community 67"
Cohesion: 0.07
Nodes (24): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), redirectToWorkspaceScreen(), HostelAdminMaintenancePageContent(), HostelAdminReportsPageContent() (+16 more)

### Community 68 - "Community 68"
Cohesion: 0.06
Nodes (31): MapScreen(), SavedHostelsScreen(), BrowseParams, BUDGET_BANDS, FilterSheet(), HostelBrowser(), HostelBrowserProps, NearestToggle() (+23 more)
...
Cohesion: 0.05
Nodes (30): BROWSE_FACILITIES, BrowseByFacility(), BrowseByType(), CitiesRow(), Hero(), HERO_CHIPS, PublicHomeProps, RowCard (+22 more)

### Community 71 - "Community 71"
Cohesion: 0.07
Nodes (37): DELETE(), POST(), createHostelNotificationCampaign(), createPlatformNotificationCampaign(), resolveHostelId(), revokeDeviceToken(), saveDeviceToken(), campaignBaseSchema (+29 more)
...
Cohesion: 0.07
Nodes (39): RealtimeConfig, RealtimeContext, RealtimeContextValue, RealtimeNotification, useRealtime(), deviceTokenSchema, input, mocks (+31 more)
...
Cohesion: 0.05
Nodes (16): AuthExperiencePage(), PublicHostelListingPage(), ComparePageSkeleton(), HostelDetailPageSkeleton(), HostelListingPageSkeleton(), InquiryPageSkeleton(), PublicPricingPage(), ResidentActivationPageContent (+8 more)
...
Cohesion: 0.1
Nodes (36): PreviewCard(), ResultRow(), FACILITY_ICONS, facilityIcon(), facilityKey(), HostelCard(), SaveButton(), HeadCell() (+28 more)
...
Cohesion: 0.08
Nodes (37): IntakeQuote, RESIDENT_TYPES, ResidentIntakeResult, ResidentPrefill, ResidentType, backgroundFacts(), careFacts(), CollectableBill (+29 more)

### Community 81 - "Community 81"
Cohesion: 0.06
Nodes (34): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, AuthShell(), AuthShellProps, PANEL_COPY (+26 more)
...
Cohesion: 0.07
Nodes (37): findIndex(), index, indexesOf(), IndexSpec, promote, assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck (+29 more)
...
Cohesion: 0.09
Nodes (34): useIsUploading(), directionOf(), EMPTY_TALLY, floorToStep(), phaseOf(), shouldRepost(), tallyUploads(), active (+26 more)
...
Cohesion: 0.06
Nodes (25): AuthGuard(), cityOptions, createDocument(), createRoom(), DocumentConfig, DraftData, FACILITY_MINI, facilityOptions (+17 more)

### Community 90 - "Community 90"
Cohesion: 0.08
Nodes (22): geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), GoogleMap, HostelMap(), LeafletMap, TYPE_COLORS (+14 more)

### Community 91 - "Community 91"
Cohesion: 0.07
Nodes (28): qrActivationSchema, userSchema, ActivationCodeGenerateInput, ActivationCodeInput, activationSecret(), ActivationServiceError, ActivationStatus, ActivationStatusQuery (+20 more)

### Community 92 - "Community 92"
Cohesion: 0.09
Nodes (31): accountDeletionRequestedEmail(), POST(), AccountDeletionError, applyImmediateEffects(), cancelAccountDeletionByToken(), cancelAccountDeletionForUser(), cancelUrlFor(), DeletionPathway (+23 more)
...
Cohesion: 0.08
Nodes (23): Claim, CouldNotCreateFileException, HostelHubDownloadsModule, NoContextException, NothingOpensThisException, UnreadableSourceException, UnsupportedOnThisAndroidException, amber (+15 more)
...
Cohesion: 0.11
Nodes (31): GET(), resolvePastedLink(), searchCandidates(), hostelAdminGeocodeQuerySchema, AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim(), definedParts() (+23 more)

### Community 101 - "Community 101"
Cohesion: 0.1
Nodes (34): CookTodayScreen(), announcedCount(), announcementSummary(), CookFoodPhoto, CookPhotoDay, FoodReadySent, MealButton, mealButtonLabel() (+26 more)

### Community 102 - "Community 102"
Cohesion: 0.07
Nodes (22): EmptyState(), Panel(), TextArea(), field(), HostelAdminReferralsPageContent(), HostelAdminServiceProvidersPageContent(), ListingFlag, LoadState (+14 more)

### Community 103 - "Community 103"
Cohesion: 0.09
Nodes (25): attacker, attempt(), headers, jsonRequest(), routeMocks, resetPasswordWithToken(), revokeAllSessions(), verifyEmailWithToken() (+17 more)
...
Cohesion: 0.07
Nodes (28): dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, isMonthEnd(), mealsOn(), ROUTINE_DAYS (+20 more)
...
Cohesion: 0.21
Nodes (20): POST(), authenticateWithGoogle(), logout(), POST(), loginGuardian(), accessTokenTtlSeconds(), parseDurationSeconds(), refreshTokenTtlSeconds() (+12 more)
...
Cohesion: 0.07
Nodes (20): CATEGORIES, isApplicationOpen(), LandingStep(), MeResponse, OwnApplication, ProviderStats, ProviderStatus, renderEmphasis() (+12 more)

### Community 111 - "Community 111"
Cohesion: 0.11
Nodes (32): money(), PlanCard(), listHeadingFor(), PlanCard(), CatalogueTab(), CycleDiscount(), PublicServiceDetailPage(), BillingCycle (+24 more)

### Community 112 - "Community 112"
Cohesion: 0.09
Nodes (25): averageRating(), cityCount(), group(), HomeStat, homeStats(), rated, stats, vacantBeds() (+17 more)
...
Cohesion: 0.1
Nodes (24): HostelSuggestions(), EMPTY_PREFILL, ENVIRONMENT_OPTIONS, IdentityResponse, Prefill, Step, TalkToExpertButton(), MyExpertConsultationRequest (+16 more)
...
Cohesion: 0.16
Nodes (18): POST(), POST(), runBillingCycleForAllHostels(), POST(), POST(), POST(), POST(), errorResponse() (+10 more)

### Community 117 - "Community 117"
Cohesion: 0.11
Nodes (29): userResidentProfileSchema, ageFromDateOfBirth(), cardPhotoImageUrl(), clearResidentIdentityPhoto(), generateResidentId(), getResidentIdentity(), isCardPhotoImage(), lookupResidentProfile() (+21 more)

### Community 118 - "Community 118"
Cohesion: 0.1
Nodes (28): cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath(), formatManeuverDistance(), headingDifference(), instructionFor() (+20 more)
...
Cohesion: 0.12
Nodes (28): UploadCard(), saveDataUrlToDevice(), saveToDevice(), dismissUpload(), emit(), finishUpload(), listeners, pruneUploads() (+20 more)

### Community 121 - "Community 121"
Cohesion: 0.08
Nodes (18): POST(), accountDeletionRequestSchema, attendanceLogSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, consentLogSchema, questionCallClickSchema (+10 more)

### Community 122 - "Community 122"
Cohesion: 0.1
Nodes (26): downloadCaption(), DownloadRow, progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster(), UploadRow (+18 more)
...
Cohesion: 0.12
Nodes (23): FILE_ASSET_KINDS, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList() (+15 more)
...
Cohesion: 0.09
Nodes (27): acceptGuardianInvitation(), daysFromNow(), enabledPermissionLabels(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags, GuardianPermissionsUpdateInput (+19 more)
...
Cohesion: 0.09
Nodes (23): registerEmailIdentity(), PRODUCTION_RECOMMENDED, PRODUCTION_REQUIRED, ServerEnv, serverEnvSchema, serverEnvWarnings(), PRODUCTION_MINIMUM, pusher (+15 more)
...
Cohesion: 0.09
Nodes (22): getR2Client(), statementImportSchema, StatementBytes, StatementProvider, importStatement(), loadStatementAsset(), periodOf(), readStatementBytes() (+14 more)
...
Cohesion: 0.12
Nodes (23): FileUploadArea(), EXTENSION_BY_MIME, FAMILY_BYTES, FAMILY_ORDER, familyOf(), joinTypes(), KIND_RULES, KindRule (+15 more)
...
Cohesion: 0.12
Nodes (21): cook, assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES, PermissionError, Principal, destinationForRole() (+13 more)
...
Cohesion: 0.09
Nodes (21): releaseWaiters(), rotateAccessToken(), body, decoder, EvidenceFields, EvidenceReference, EvidenceStage, FetchLike (+13 more)

### Community 147 - "Community 147"
Cohesion: 0.17
Nodes (22): changePassword(), issueSessionForUser(), login(), publicUser(), refreshAccessToken(), POST(), AuthTokenPayload, getBearerToken() (+14 more)
...
Cohesion: 0.14
Nodes (18): auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex(), HostelRecord, ListingFlagListQuery, ListingFlagRecord, ListingFlagResolveInput, ListingFlagServiceError (+10 more)
...
Cohesion: 0.15
Nodes (19): Choice, maneuverIcon(), MapButton(), ModeTab(), NavCard(), NOTHING_CHOSEN, RouteCard(), buildShell() (+11 more)

### Community 164 - "Community 164"
Cohesion: 0.1
Nodes (21): ContentPage, ContentSection, EMPTY_PAGE, FALLBACK_SITE_CONFIG, getSiteConfig(), MobileSiteConfig, SiteConfigResponse, SiteContent (+13 more)

### Community 165 - "Community 165"
Cohesion: 0.17
Nodes (21): assertMatchesExtension(), downloadAndShare(), downloadAndShareCsv(), downloadAndShareImage(), downloadToDevice(), forgetDownloadFolder(), LegacyFileSystem, loadLegacyFileSystem() (+13 more)
...
Cohesion: 0.09
Nodes (19): generateOtpCode(), normalizeOtpIdentifier(), otpRateLimitMax(), otpRateLimitWindowMs(), otpResendCooldownMs(), requestOtpChallenge(), DeliveryWindowFields(), number() (+11 more)
...
Cohesion: 0.11
Nodes (18): hashOtpCode(), verifyOtpChallenge(), GoogleAuthInput, googleAuthSchema, LoginInput, loginSchema, otpChannelSchema, otpPurposeSchema (+10 more)
...
Cohesion: 0.15
Nodes (18): uploadPublicFile(), FileAssetKind, ApiEnvelope, parseEnvelope(), sendUpload(), sendWithProgress(), UploadCanceledError, UploadError (+10 more)

### Community 177 - "Community 177"
Cohesion: 0.13
Nodes (19): Offset, PhotoCropper(), VideoSlot(), isActive(), formatBytes(), UploadKind, AttachedFile(), FileUploader() (+11 more)
...
Cohesion: 0.12
Nodes (16): AuthSession, getResidentProfile(), login(), submitResidentReview(), AppNavigator(), RootStackParamList, Stack, LoginScreen() (+8 more)
...
Cohesion: 0.11
Nodes (16): DownloadStack(), clicked, link, seen, cancelDownload(), canRetryDownload(), DownloadHandle, DownloadItem (+8 more)
...
Cohesion: 0.1
Nodes (20): Account deletion purge, Attendance maintenance (absence alerts + retention purge), Authentication, Complaint SLA breach check, cron-job.org setup (per job), CRON.md — Scheduled Jobs, Dispatch scheduled notifications, Endpoints (+12 more)

### Community 189 - "Community 189"
Cohesion: 0.13
Nodes (13): PlatformHostelsPageContent(), PlatformHostelsPageContent, PortalExperiencePage(), PortalPlaceholderAction, PortalPlaceholderPage(), PortalPlaceholderPageProps, pendingHostels, PlatformHostel (+5 more)
...
Cohesion: 0.13
Nodes (17): listResidentInvoices(), getResidentLedger(), monthsBetween(), periodOf(), ResidentDoc, ResidentLedger, ResidentLedgerMonth, ResidentLedgerPayment (+9 more)
...
Cohesion: 0.12
Nodes (13): hasClearance(), PromotableUser, promoteAccountToResident(), PROTECTED_ROLES, ResidentPromotion, ResidentPromotionClearance, standDownMemberships(), hostelId (+5 more)

### Community 205 - "Community 205"
Cohesion: 0.15
Nodes (14): Guidance, GuidanceStatus, useGuidance(), hasGeolocation(), LocationOutcome, NavigationFix, OrientationPermission, requestDeviceLocation() (+6 more)
...
Cohesion: 0.21
Nodes (17): announceFoodReady(), dueMeals(), mealLabel(), runMealCallReminders(), canAnnounceMeal(), formatMinuteOfDay(), mealOpensAtMinute(), MealWindow (+9 more)
...
Cohesion: 0.14
Nodes (12): notificationSchema, notificationCampaignSchema, CampaignListQuery, CampaignRecord, createCampaign(), dispatchCampaign(), HostelCampaignInput, normalizeObjectId() (+4 more)
...
Cohesion: 0.13
Nodes (14): cookPrincipal, cookUserId, DAY_NAMES, leanResult(), mocks, ownerUserId, residentRows, residentUserId (+6 more)
...
Cohesion: 0.14
Nodes (16): 2.3 Hostel Rejected, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, 4.2 Complaint Status Updated, 4.3 Complaint Resolved (+8 more)
...
Cohesion: 0.16
Nodes (11): register(), requestOtp(), signInWithGoogle(), triggerSOS(), verifyOtp(), Props, Props, ResidentSOSScreen() (+3 more)

### Community 250 - "Community 250"
Cohesion: 0.16
Nodes (13): apiRequest(), getActivationStatus(), listNotifications(), listResidentNotices(), markNoticeAsRead(), markNotificationRead(), NotificationItem, refreshSession() (+5 more)
...
Cohesion: 0.15
Nodes (13): 4.1 New Notice Posted, 4. Resident Activity Emails, 5.1 SOS Triggered, 5. Safety & Emergency Emails, code:typescript ({), code:typescript ({), code:typescript ({), Email Opt-In/Opt-Out Matrix (+5 more)
...
Cohesion: 0.2
Nodes (8): ExpertConsultationCreateInput, ExpertConsultationError, ExpertConsultationRequestRecord, notifyTeamOfRequest(), expertConsultationCreateSchema, expertConsultationRequestSchema, coerceSection(), getSiteConfigSection()
...
Cohesion: 0.23
Nodes (9): HostelPhotoReminder(), FALLBACK_ORDER, hasNoHostelPhotos(), HostelPhoto, HostelPhotoKind, photosOfKind(), resolveHostelPhotos(), resolveHostelPhotoUrls() (+1 more)
...
Cohesion: 0.18
Nodes (8): hostelId, invoice, invoiceId, mocks, principal, qr, qrAssetId, residentId
...
Cohesion: 0.22
Nodes (8): calendarRoot, config, foodRoot, { getDefaultConfig }, netinfoShim, path, plansRoot, { withNativeWind }
...
Cohesion: 0.29
Nodes (8): 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, 3.3 Payment Proof Uploaded (to Admin), code:typescript ({), code:block14 (---), code:typescript ({)
...
Cohesion: 0.29
Nodes (5): getImageUrl(), optimizeImage(), OptimizeResponse, PresignResponse, ReadUrlResponse
...
Cohesion: 0.4
Nodes (4): formatDistance(), hostelCoordinates(), isUsableCoordinate(), KATHMANDU
...
Cohesion: 0.4
Nodes (4): afterResponse(), mocks, work, nonFatal()
...
Cohesion: 0.6
Nodes (3): avatarInitial(), avatarToneIndex(), index
...
Cohesion: 0.6
Nodes (3): robots(), siteUrl(), residentIdShareUrl()
...
## Knowledge Gaps
- **5058 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+5053 more)
...
- **Why does `Button()` connect `Community 1` to `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 19`, `Community 22`, `Community 24`, `Community 27`, `Community 30`, `Community 31`, `Community 32`, `Community 163`, `Community 38`, `Community 40`, `Community 51`, `Community 68`, `Community 70`, `Community 80`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 9` to `Community 1`, `Community 5`, `Community 6`, `Community 136`, `Community 12`, `Community 13`, `Community 16`, `Community 18`, `Community 22`, `Community 279`, `Community 30`, `Community 32`, `Community 34`, `Community 41`, `Community 44`, `Community 47`, `Community 177`, `Community 55`, `Community 61`, `Community 75`, `Community 84`, `Community 89`, `Community 94`, `Community 102`, `Community 104`, `Community 110`, `Community 111`, `Community 114`, `Community 122`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 167` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 136`, `Community 10`, `Community 13`, `Community 145`, `Community 20`, `Community 21`, `Community 26`, `Community 157`, `Community 32`, `Community 33`, `Community 34`, `Community 38`, `Community 166`, `Community 172`, `Community 45`, `Community 49`, `Community 177`, `Community 52`, `Community 56`, `Community 66`, `Community 71`, `Community 207`, `Community 82`, `Community 89`, `Community 220`, `Community 100`, `Community 103`, `Community 107`, `Community 365`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Are the 379 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 379 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `{ defineConfig }`, `expoConfig`, `path` to the rest of the system?**
  _5058 weakly-connected nodes found - possible documentation gaps or missing edges._
