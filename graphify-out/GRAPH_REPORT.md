...
## Corpus Check
- 1944 files · ~3,332,951 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15419 nodes · 42567 edges · 524 communities (502 shown, 22 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 687 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 632 edges
2. `successResponse()` - 615 edges
3. `connectToDatabase()` - 434 edges
4. `useAppTheme()` - 373 edges
5. `cn()` - 283 edges
6. `connectToDatabase()` - 245 edges
7. `unwrap()` - 197 edges
8. `useResource()` - 195 edges
9. `Text()` - 177 edges
...
## Communities (524 total, 22 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (178): ICONS, LABELS, Segment, TONES, FILTERS, Pending, Overview, MoneyData (+170 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (278): loadOverview(), loadMoney(), loadToday(), loadFinance(), DeletionRequest, DeletionStatus, getDeletionStatus(), requestAccountDeletion() (+270 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (224): PATCH(), RouteContext, POST(), getOrCreateSubscription(), POST(), GET(), getOpenFeeSchedule(), GET() (+216 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (229): auditFinanceAction(), FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), voidInvoice(), approveCashPayment(), cashThresholdFor(), RecordCashInput (+221 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (152): PlanPaymentClaim, Filter, ModeratedPost, ModerationPayload, csvField(), deferLoad(), DemoDataBadge(), field() (+144 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (195): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintStatus() (+187 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (135): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), field(), GuardianDashboard, HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage() (+127 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (178): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput, ConsentInput (+170 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (146): AdminCommunityScreen(), HIDDEN, TABS, SavedListRow(), SosScreen(), HOSTEL, MONTHS, UiPreview() (+138 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (168): AdminAlertsScreen(), AdminCommunityReportsScreen(), AdminHomeScreen(), AdminOverviewScreen(), AdminTabs(), AdminMoneyScreen(), AdminMoreScreen(), AdminResidentsScreen() (+160 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (148): POST(), attacker, attempt(), headers, jsonRequest(), routeMocks, appBaseUrl(), authenticateWithGoogle() (+140 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (120): DELETE(), GET(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), getPlatformSubscriptionLedger(), listPlanPaymentClaims(), checkoutSchema (+112 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (151): Scanner(), CookInviteScreen(), GuardianInviteScreen(), Assurance(), CallableRow(), IdentityCard(), PeopleSection(), ContactRow() (+143 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (133): AuthShell(), AuthShellProps, PANEL_COPY, SiteWordmark(), metadata, AccountDeletionPanel, ContentHeader(), ContentIntro() (+125 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (154): PaymentMonthStrip(), ManageRatesScreen(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard(), AmountCard() (+146 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (124): PATCH(), POST(), RouteContext, GET(), POST(), POST(), POST(), POST() (+116 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (93): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CancelDeletionPageContent(), AcceptResult, CookInvitePageContent, GuardianDashboardPageContent() (+85 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (103): CookAccount, Credentials, HostelAdminCooksPanel, Issued, PRIORITIES, STATUS_ACTIONS, CATEGORIES, Campaign (+95 more)

### Community 18 - "Community 18"
Cohesion: 0.07
Nodes (82): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, DASHBOARD_ROLES, FACILITY_ICONS (+74 more)
...
Cohesion: 0.02
Nodes (83): ComparePage(), hostels, metadata, rows, AuthExperiencePage(), csvField(), field(), Hostel (+75 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (97): useConfirm(), Notification, grabDocument(), PayPlanPanel(), rupees(), humanizeValue(), ImportedProfileSummary(), PrefillPhoto (+89 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (103): addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery, HostelAdminInquiryStatusInput, InquiryNoteCreateInput, InquiryNoteRecord, InquiryRecord (+95 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (102): FILTERS, NotificationRow(), NotificationsScreen(), TILE_GLYPH, TILE_TONES, CommunityScreen(), Composer(), AttachmentGallery() (+94 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (84): GET(), POST(), GET(), GET(), POST(), readReturnState(), GET(), ownerIdentitiesFor() (+76 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (102): demoteToPublicAccount(), CapacityError, claimBedForRoomType(), listAllRoomTypes(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary() (+94 more)
...
Cohesion: 0.03
Nodes (103): Offset, PhotoCropper(), VideoSlot(), CollectionQrField(), FileUploadArea(), FileUploadArea(), PhotoStrip(), downloadCaption() (+95 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (84): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), DocumentScreen(), MobileLegal (+76 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (98): getHostelLedger(), HostelLedger, HostelLedgerEntry, InvoiceMatrix, InvoiceMatrixRow, NotBilled, PortalInvoice, ResidentFinanceView (+90 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (83): CommunityReportDialog(), REASONS, MonthOption(), BrowserPushRow(), PlanMark(), RAFTER, RIDGE, ROWS (+75 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (80): HostelPhotoReminder(), inferKind(), MediaLightbox(), PublicComparePage(), CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS (+72 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (72): AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, base, entityId, hostelId (+64 more)
...
Cohesion: 0.03
Nodes (71): POST(), GET(), POST(), GET(), POST(), DELETE(), PATCH(), RouteContext (+63 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (67): PATCH(), RouteContext, POST(), RouteContext, PATCH(), RouteContext, requireHostelStaffPrincipal(), result (+59 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (74): HostelRegistrationProgress(), Milestone, milestoneIndex(), MILESTONES, PaymentPanel(), rupees(), SubscriptionState, cityOptions (+66 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (68): summarizeResidentComplaints(), accessId, adminPrincipal, codes, guardianId, guardianPrincipal, issue(), leanResult() (+60 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (78): ComplaintDetail(), ComplaintCard(), CategoryTile(), NewComplaintScreen(), PickedAttachment, SwapButton(), CapturedPhoto, PhotoCapture() (+70 more)
...
Cohesion: 0.04
Nodes (70): authorUserId, mocks, postId, residentId, residentPrincipal, staffPrincipal, authorUserId, leanResult() (+62 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (71): EvidenceEngine, EvidenceEngineMode, EvidenceReadFailure, OcrResult, OcrWord, KEYS, saved, IMAGE (+63 more)

### Community 42 - "Community 42"
Cohesion: 0.1
Nodes (47): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), cookInvitationEmail(), guardianInvitationEmail() (+39 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (64): BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan, BillingSkip (+56 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (59): listTrendingTags(), cookLoginStem(), generateCookPassword(), mintCookLogin(), pick(), previousCookLabel(), acceptCookInvitation(), addCookAccount() (+51 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (55): AuthGuard(), CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing (+47 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (57): hostelSettingsSchema, nightStatusPromptSchema, formatPromptTime(), isSameNight(), minuteIsDue(), parsePromptTime(), promptIsDue(), reminderIsDue() (+49 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (54): CommunityModerationPanel(), AttendanceAlert, AttendanceCalendar(), AttendanceRow, Zone, ZONE_ORDER, ZONE_STYLES, EMPTY_SUMMARY (+46 more)
...
Cohesion: 0.05
Nodes (60): documents, hostelForm(), many, parsed, result, buildHostelPayload(), capacitySummary(), CITY_OPTIONS (+52 more)

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (60): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsPeriodBounds(), bsPeriodOf() (+52 more)
...
Cohesion: 0.08
Nodes (38): POST(), POST(), POST(), POST(), POST(), POST(), safeEqual(), runBillingCycleForAllHostels() (+30 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (49): Footer(), IdCardFace(), initialsOf(), Portrait(), buildIdCard(), CARD_COLORS, CARD_NOUNS, CARD_VARIANTS (+41 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (50): AdminAlertsContext, AdminAlertsProvider(), AdminAlertsValue, AlertActions, EMPTY_COUNTS, ICONS, LABELS, TONES (+42 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (41): BROWSE_FACILITIES, BrowseByFacility(), BrowseByType(), CitiesRow(), CityCard(), Hero(), HERO_CHIPS, NearbyHostels() (+33 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (55): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags() (+47 more)

### Community 58 - "Community 58"
Cohesion: 0.07
Nodes (47): BootGate(), BrandSplash(), AuthDivider(), GoogleSignInButton(), RoleGate(), accentForAccount(), AccountShape, HomeRoute (+39 more)

### Community 59 - "Community 59"
Cohesion: 0.05
Nodes (36): getPlanPaymentInstructions(), POST(), RouteContext, DELETE(), GET(), hostelId(), GET(), GET() (+28 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (32): fill(), PricingScreen(), PlanPicker(), InlineText(), BillingToggle(), EASE, PlanCards(), PlanLine() (+24 more)
...
Cohesion: 0.06
Nodes (42): addHistory(), addMaintenanceComment(), assertBedInHostel(), assertProviderApproved(), assertRoomInHostel(), assertVoiceNoteUsable(), assignMaintenanceProvider(), auditMaintenanceAction() (+34 more)

### Community 63 - "Community 63"
Cohesion: 0.06
Nodes (37): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, daysUntil(), HostelSubscriptionDueBanner(), rupees(), State, PortalShell(), navItems (+29 more)

### Community 64 - "Community 64"
Cohesion: 0.05
Nodes (36): metadata, CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+28 more)
...
Cohesion: 0.06
Nodes (43): InvoiceDetailScreen(), InvoiceHeaderBlock(), LedgerCard(), ResidentClaim, ResidentInvoice, chargeDescriptions(), filterInvoices(), groupInvoicesByYear() (+35 more)

### Community 68 - "Community 68"
Cohesion: 0.06
Nodes (42): notifyResidentOfComplaintReply(), addComplaintUpdate(), assertComplaintVoiceNote(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren() (+34 more)

### Community 69 - "Community 69"
Cohesion: 0.05
Nodes (44): listResidentClaims(), approveClaim(), assertNotAlreadyRecordedFromStatement(), bulkApproveClaims(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck() (+36 more)

### Community 70 - "Community 70"
Cohesion: 0.09
Nodes (42): PreviewCard(), ResultRow(), FACILITY_ICONS, facilityIcon(), facilityKey(), HostelCard(), SaveButton(), HostelShowcase() (+34 more)

### Community 71 - "Community 71"
Cohesion: 0.08
Nodes (37): CSV_COLUMNS, GET(), GET(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS, neutralize() (+29 more)
...
Cohesion: 0.06
Nodes (38): qrActivationSchema, before, expiresAt, mocks, staffPrincipal, ActivationCodeGenerateInput, ActivationCodeInput, activationSecret() (+30 more)
...
Cohesion: 0.09
Nodes (35): FILE_ASSET_KINDS, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList() (+27 more)

### Community 80 - "Community 80"
Cohesion: 0.07
Nodes (38): SERVICE_PROVIDER_CATEGORIES, serviceProviderSchema, serviceProviderApplicationSchema, serviceProviderDocumentSchema, ACTIVE_APPLICATION_STATUSES, approveServiceProvider(), auditProviderAction(), findOwnProvider() (+30 more)

### Community 81 - "Community 81"
Cohesion: 0.08
Nodes (38): IntakeQuote, RESIDENT_TYPES, ResidentIntakeResult, ResidentPrefill, ResidentPrefillPhoto, ResidentType, backgroundFacts(), careFacts() (+30 more)

### Community 82 - "Community 82"
Cohesion: 0.09
Nodes (34): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, loadSharp() (+26 more)
...
Cohesion: 0.08
Nodes (36): bsMonthStart(), hostelCalendarDay(), hostelToday(), rateForRoomType(), approvalPeriod(), getPeriodSummary(), monthsBetween(), periodOf() (+28 more)

### Community 86 - "Community 86"
Cohesion: 0.07
Nodes (27): formatPaisa(), PlatformStorePageContent, StoreCategory, StoreProduct, StoreSettings, Tab, toRupees(), discountPercent() (+19 more)
...
Cohesion: 0.06
Nodes (30): GET(), GET(), querySchema, foodRoutineSaveSchema, applicantSchema, billingCycleSchema, HostelRegistrationInput, hostelRegistrationSchema (+22 more)

### Community 89 - "Community 89"
Cohesion: 0.09
Nodes (30): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), robots() (+22 more)
...
Cohesion: 0.1
Nodes (30): describeGrants(), GuardianRow(), PermissionSheet(), InviteGuardianScreen(), inviteGuardian(), listGuardians(), revokeGuardian(), updateGuardianPermissions() (+22 more)
...
Cohesion: 0.08
Nodes (31): platformAdminInvitationEmail(), acceptPlatformAdminInvitation(), AcceptPlatformAdminInvitationInput, appUrl(), checkPlatformAdminEmail(), daysFromNow(), EmailAvailability, EmailAvailabilityResult (+23 more)
...
Cohesion: 0.09
Nodes (30): NearbyStatus, Coordinates, isUsableCoordinate(), hasLocationPermission(), hasPromptedForLocation(), LocationOutcome, NavigationFix, readPosition() (+22 more)
...
Cohesion: 0.09
Nodes (32): Compass(), cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath(), hasArrived(), headingDifference() (+24 more)

### Community 101 - "Community 101"
Cohesion: 0.14
Nodes (27): subscriptionClaimReceivedEmail(), subscriptionClaimRejectedEmail(), deliver(), loadInvoiceById(), loadProof(), PlanPaymentInstructions, ProofAsset, reviewPlanPaymentClaim() (+19 more)

### Community 102 - "Community 102"
Cohesion: 0.09
Nodes (33): CookTodayScreen(), announcedCount(), announcementSummary(), MealButton, mealButtonLabel(), mealButtons(), MealButtonsInput, mealLockNote() (+25 more)

### Community 103 - "Community 103"
Cohesion: 0.07
Nodes (29): RootShell(), AssetViewer(), useViewerState(), BottomChrome, BottomChromeContext, BottomChromeProvider(), CHROME_TIMING, usePush() (+21 more)

### Community 104 - "Community 104"
Cohesion: 0.1
Nodes (27): addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange(), definedUpdate(), FoodFeedbackInput, FoodFeedbackRecord, FoodMenuCreateInput (+19 more)
...
Cohesion: 0.12
Nodes (23): isNightStatusPrompt(), NIGHT_STATUS_ACTIONS, NIGHT_STATUS_BUTTONS, NIGHT_STATUS_REASONS, NightStatusActionId, NightStatusAnswer, parseNightStatusAction(), reasonLabel() (+15 more)

### Community 108 - "Community 108"
Cohesion: 0.11
Nodes (29): UploadCard(), UploadToaster(), useIsUploading(), useUploads(), dismissUpload(), emit(), listeners, pruneUploads() (+21 more)

### Community 109 - "Community 109"
Cohesion: 0.09
Nodes (21): applyWebhook(), WebhookResult, OpenCheckoutInput, softmato(), SoftmatoNotConfiguredError, isSoftmatoConfigured(), SoftmatoConfig, softmatoWebhookSecret() (+13 more)
...
Cohesion: 0.09
Nodes (30): containsWithTolerance(), evidenceTextFlags(), isDefinitelyNotPaymentEvidence(), looksLikePaymentReceipt(), matchClaimFacts(), receiptSignals(), referenceOnEvidence(), canvas (+22 more)

### Community 112 - "Community 112"
Cohesion: 0.13
Nodes (28): documentDownloadUrl(), issueInvoiceDocument(), readSettledReceipt(), allocateReceiptNumber(), applySettlement(), InvoiceRecord, loadInvoice(), openSubscriptionCheckout() (+20 more)
...
Cohesion: 0.12
Nodes (30): money(), PlanCard(), pricePlan(), listHeadingFor(), PlanCard(), CatalogueTab(), CycleDiscount(), PublicServiceDetailPage() (+22 more)

### Community 115 - "Community 115"
Cohesion: 0.08
Nodes (27): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES (+19 more)

### Community 116 - "Community 116"
Cohesion: 0.06
Nodes (31): 1.1 Confirm EAS is signing with the keystore we already committed to, 1.2 Push notifications need the FCM key on EAS, 1. Before the first build, 2.1 Android APK — install and test, 2.2 iOS — install and test, 2.3 Store artefacts — only when the tested build is good, 2. The builds, 3.1 What it is (+23 more)

### Community 117 - "Community 117"
Cohesion: 0.1
Nodes (23): Choice, maneuverIcon(), MapButton(), ModeTab(), NavCard(), NOTHING_CHOSEN, RouteCard(), buildShell() (+15 more)

### Community 118 - "Community 118"
Cohesion: 0.07
Nodes (26): fromBs(), gregorianOf(), bhadra(), BillableResident, { amount }, asar(), bhadra(), byRoomType (+18 more)

### Community 119 - "Community 119"
Cohesion: 0.08
Nodes (12): PublicHostelListingPage(), PublicInquiryPage(), ComparePageSkeleton(), HostelDetailPageSkeleton(), HostelListingPageSkeleton(), InquiryPageSkeleton(), emptyFilters, Filters (+4 more)
...
Cohesion: 0.14
Nodes (28): ageFromDateOfBirth(), cardPhotoImageUrl(), clearResidentIdentityPhoto(), generateResidentId(), getResidentIdentity(), isCardPhotoImage(), lookupResidentProfile(), mintResidentId() (+20 more)
...
Cohesion: 0.09
Nodes (18): PortalDates, PlanBillingInvoice, PlanBillingPayment, PlanBillingPlan, SitePlans, FADED, LIFT, ManageBillingScreen() (+10 more)
...
Cohesion: 0.11
Nodes (19): DeletionPathway, DeletionStatus, PATHWAY_COPY, ConfirmOptions, AttendanceDay, ResidentAttendancePageContent, Zone, ZONE_LABELS (+11 more)

### Community 136 - "Community 136"
Cohesion: 0.16
Nodes (24): RouteContext, AddInput, addToCart(), CartItemRecord, CartRecord, clearCart(), emptyCart(), getCart() (+16 more)
...
Cohesion: 0.09
Nodes (21): aswin, bhadra, bs(), card(), currentId, hostelId, inAswin, inOctober (+13 more)
...
Cohesion: 0.15
Nodes (18): webPushSubscribeSchema, webPushUnsubscribeSchema, EMPTY, ensureConfigured(), isWebPushConfigured(), VapidConfig, WebPushPayload, webPushPublicKey() (+10 more)
...
Cohesion: 0.13
Nodes (19): AdminRollCallCard(), AdminNightStatus, AdminNightStatusRow, overrideNightStatus(), AdminRollCallData, filterRollCall(), NightStatusValue, OVERRIDE_OPTIONS (+11 more)
...
Cohesion: 0.11
Nodes (20): CachedQuery, clearQueryCache(), defined, entries, Entry, inflight, invalidateQuery(), Listener (+12 more)
...
Cohesion: 0.12
Nodes (16): BASE_URLS, khaltiProvider, attempt, fetchMock, initiated, live, request, sandbox (+8 more)
...
Cohesion: 0.16
Nodes (17): announceFoodReady(), CookFoodPhoto, CookPhotoDay, CookPhotoFeed, CookResident, FoodReadyAnnouncement, FoodReadyResult, FoodReadySent (+9 more)

### Community 171 - "Community 171"
Cohesion: 0.1
Nodes (20): ContentPage, ContentSection, EMPTY_PAGE, FALLBACK_SITE_CONFIG, getSiteConfig(), MobileSiteConfig, SiteConfigResponse, SiteContent (+12 more)
...
Cohesion: 0.2
Nodes (19): storeCartSchema, storeOrderSchema, serializeStoreCategory(), serializeStoreProduct(), storeObjectId(), assertSlugFree(), CategoryCreateInput, CategoryUpdateInput (+11 more)
...
Cohesion: 0.15
Nodes (19): softmatoDocsUrl(), BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan, CYCLE_LABELS, daysUntil(), getBillingHistory() (+11 more)
...
Cohesion: 0.13
Nodes (22): Attendance / Night Safety, code:typescript (interface INightStatusLog {), code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface INotice {), code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {), code:typescript ({) (+14 more)
...
Cohesion: 0.24
Nodes (17): HostelScope, ResolvedDocument, resolveInvoiceDocument(), resolveReceiptDocument(), scopeFilter(), settledTotal(), trySoftmato(), attach() (+9 more)
...
Cohesion: 0.13
Nodes (21): 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, 7.1 New Hostel Pending Approval (to Superadmin), 7.2 Subscription Expiring Soon, 7. Platform Admin Emails (+13 more)

### Community 191 - "Community 191"
Cohesion: 0.14
Nodes (18): ApiFailure, ApiSuccess, AuthUser, listNotifications(), listResidentFood(), markNotificationRead(), NotificationItem, ResidentFoodMenu (+10 more)
...
Cohesion: 0.13
Nodes (16): storeCategorySchema, storeProductSchema, categoriesFor(), escapeRegex(), getStoreHome(), getStoreProduct(), getStoreShelves(), ListQuery (+8 more)
...
Cohesion: 0.14
Nodes (15): getResidentProfile(), login(), submitResidentReview(), triggerSOS(), RootStackParamList, LoginScreen(), Props, Profile (+7 more)
...
Cohesion: 0.18
Nodes (14): IssuedInvoice, openCheckoutSession(), OpenedCheckout, SettledReceipt, checkoutReturnUrl(), openSoftmatoCheckout(), EnsureInvoiceInput, ensureSoftmatoInvoice() (+6 more)
...
Cohesion: 0.14
Nodes (15): getPresignedReadUrl(), userResidentProfileSchema, ResidentIdentityError, ResidentProfileData, findScannedAccount(), loadMembership(), PhotoAssetRecord, ProfileRecord (+7 more)
...
Cohesion: 0.16
Nodes (11): paymentClearedEmail(), paymentDueReminderEmail(), ReminderStage, wording(), paymentOverdueEmail(), paymentRejectedEmail(), paymentReversedEmail(), paymentProofReceivedEmail() (+3 more)
...
Cohesion: 0.18
Nodes (17): code:typescript (interface IMoveOutChecklistItem {), code:typescript (interface IServiceProvider {), code:typescript (interface IServiceProvider {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IInquiry {), ComplaintUpdate, MaintenanceRequest (+9 more)
...
Cohesion: 0.12
Nodes (15): deliverySchema, linkUrl, paisa, platformStoreOrderListQuerySchema, productImage, slug, storeCartAddSchema, storeCategoryCreateSchema (+7 more)
...
Cohesion: 0.16
Nodes (16): 2.1 Platform Owner Hostel Approval, 2.2 Public Hostel Listing, 2.3 Inquiry Flow, 2.4 Hostel Profile Management, 2.5 Room + Bed Management, 2.6 QA Tasks, 2.7 Phase 2 Done Means, code:txt (/login) (+8 more)
...
Cohesion: 0.24
Nodes (12): dashboardHrefForRole(), destinationForRole(), isAllowedNextPath(), isHostelWorkspacePath(), isSafeLocalPath(), landingPathForRole(), ProtectedRouteRule, protectedRouteRuleForPath() (+4 more)

### Community 245 - "Community 245"
Cohesion: 0.17
Nodes (11): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, AuthResponse, OtpRequestData, RegisterData (+3 more)

### Community 246 - "Community 246"
Cohesion: 0.15
Nodes (7): ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, GatewayProvider, adapters, SHIPPED
...
Cohesion: 0.16
Nodes (13): apiRequest(), confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listResidentComplaints(), listResidentNotices(), markNoticeAsRead(), refreshSession() (+5 more)
...
Cohesion: 0.19
Nodes (10): useRealtime(), connectRealtime(), fetchConfig(), PusherModule, REALTIME_EVENT, RealtimeConfig, RealtimeConnection, RealtimeHandlers (+2 more)
...
Cohesion: 0.18
Nodes (9): CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, readId(), body, fetchMock, [message], mocks (+1 more)
...
Cohesion: 0.2
Nodes (12): 2.2 Hostel Approved, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, code:typescript ({), code:block14 (---) (+4 more)
...
Cohesion: 0.2
Nodes (8): activateResident(), AuthSession, AppNavigator(), Stack, Props, ResidentActivationScreen(), styles, ResidentNoticesScreen()
...
Cohesion: 0.24
Nodes (9): FeeScheduleRecord, key(), ListingHostel, ListingProjection, projectSchedule(), projectScheduleOntoListing(), RoomConfiguration, hostel (+1 more)
...
Cohesion: 0.31
Nodes (7): RoleLayout(), TABS, useMinuteTick(), useQueryValue(), CookToday, readQuery(), subscribeQuery()
...
Cohesion: 0.2
Nodes (5): resetVisionClient(), body, mocks, { privateKey }, [url, init]
...
Cohesion: 0.22
Nodes (10): 1.5 Guardian Invitation, 2.1 Hostel Submission Received, 2.3 Hostel Rejected, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, 3.3 Payment Proof Uploaded (to Admin), code:typescript ({), code:typescript ({) (+2 more)
...
Cohesion: 0.2
Nodes (10): 4.1 New Notice Posted, 4.2 Complaint Status Updated, 4.3 Complaint Resolved, 4. Resident Activity Emails, 5.1 SOS Triggered, 5. Safety & Emergency Emails, code:typescript ({), code:typescript ({) (+2 more)
...
Cohesion: 0.25
Nodes (7): KHALTI_CSV_PARSER, bytes, [first], [, incoming], [outgoing, incoming], parse(), rows
...
Cohesion: 0.53
Nodes (5): defaultWorkspaceSlug(), isAuthBypassed(), listWorkspaceHostels(), previewHostels(), WorkspaceHostel
...
Cohesion: 0.5
Nodes (4): 8.1 Community Post Engagement (Batched), 8. Community & Notification Emails, code:typescript ({), code:typescript ({)
...
## Knowledge Gaps
- **5422 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+5417 more)
...
- **Why does `Button()` connect `Community 0` to `Community 1`, `Community 4`, `Community 261`, `Community 6`, `Community 135`, `Community 8`, `Community 9`, `Community 12`, `Community 13`, `Community 14`, `Community 16`, `Community 17`, `Community 19`, `Community 21`, `Community 150`, `Community 23`, `Community 28`, `Community 30`, `Community 38`, `Community 169`, `Community 47`, `Community 55`, `Community 56`, `Community 58`, `Community 64`, `Community 81`, `Community 91`, `Community 117`, `Community 121`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 30` to `Community 0`, `Community 4`, `Community 6`, `Community 135`, `Community 13`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 281`, `Community 27`, `Community 31`, `Community 36`, `Community 45`, `Community 47`, `Community 177`, `Community 60`, `Community 63`, `Community 64`, `Community 66`, `Community 74`, `Community 89`, `Community 105`, `Community 114`, `Community 119`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 7` to `Community 130`, `Community 3`, `Community 2`, `Community 5`, `Community 136`, `Community 10`, `Community 11`, `Community 138`, `Community 13`, `Community 15`, `Community 146`, `Community 22`, `Community 24`, `Community 25`, `Community 26`, `Community 29`, `Community 415`, `Community 32`, `Community 33`, `Community 163`, `Community 37`, `Community 40`, `Community 43`, `Community 44`, `Community 46`, `Community 174`, `Community 48`, `Community 177`, `Community 175`, `Community 52`, `Community 53`, `Community 57`, `Community 186`, `Community 187`, `Community 61`, `Community 62`, `Community 195`, `Community 68`, `Community 69`, `Community 198`, `Community 71`, `Community 73`, `Community 78`, `Community 80`, `Community 212`, `Community 85`, `Community 213`, `Community 93`, `Community 354`, `Community 101`, `Community 104`, `Community 234`, `Community 109`, `Community 112`, `Community 373`, `Community 247`, `Community 123`, `Community 124`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Are the 429 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 429 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `iosUrlScheme`, `{ defineConfig }`, `expoConfig` to the rest of the system?**
  _5422 weakly-connected nodes found - possible documentation gaps or missing edges._
