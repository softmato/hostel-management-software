...
## Corpus Check
- 2315 files · ~4,837,970 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18568 nodes · 52090 edges · 606 communities (575 shown, 31 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 863 edges (avg confidence: 0.8)
...
3. `connectToDatabase()` - 521 edges
4. `useAppTheme()` - 422 edges
5. `cn()` - 342 edges
6. `connectToDatabase()` - 280 edges
7. `unwrap()` - 232 edges
...
## Communities (606 total, 31 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (228): GET(), POST(), GET(), POST(), GET(), POST(), POST(), POST() (+220 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (182): ICONS, LABELS, Segment, TONES, FILTERS, Pending, Overview, MoneyData (+174 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (278): RouteContext, PATCH(), RouteContext, POST(), fileFieldCash(), getOrCreateSubscription(), getSubscriptionState(), selectPlan() (+270 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (277): loadToday(), NoticeArt(), loadFinance(), getAdminFoodRoutine(), getAdminMaintenance(), getAdminNightStatus(), listAdminNotices(), ActivationIssue (+269 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (185): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload (+177 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (146): PlanPaymentClaim, UserRecord, GuardianDashboard, Platform, ConcessionBackfill, describeApplied(), FeeSchedule, formatDate() (+138 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (185): Scanner(), FaqRow(), MethodCard(), CookInviteScreen(), GuardianInviteScreen(), PreviewCard(), ResultRow(), Assurance() (+177 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (181): HIDDEN, RoleLayout(), TABS, FILTERS, invalidateFeeds(), NIGHT_ANSWER_LABELS, nightAnswerText(), NightPromptAnswer() (+173 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (204): BookingForm(), METHODS, PackageCard(), roomPhotoUris(), StatusCard(), AttachmentGallery(), DeletionRequest, DeletionStatus (+196 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (155): ServiceProvidersScreen(), DocumentScreen(), MobileLegal, cropToGuide(), FILL, GuidedCapture(), GUIDES, GuideShape (+147 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (166): AdminAlertsScreen(), AdminCommunityReportsScreen(), AdminHomeScreen(), AdminTabs(), AdminMoreScreen(), AdminResidentsScreen(), AdminTodayScreen(), ActivateScreen() (+158 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (151): listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), getPlatformSubscriptionLedger(), getPlanPaymentInstructions(), listPlanPaymentClaims(), GET() (+143 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (142): BubbleBackground(), BubbleBackgroundProps, BubbleColors, StarLayer(), StarLayerProps, StarsBackground(), StarsBackgroundProps, CommunityReportDialog() (+134 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (134): generateMetadata(), generateMetadata(), manifest(), robots(), Entry, hostelEntries(), locationEntries(), sitemap() (+126 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (149): PaymentMonthStrip(), ManageRatesScreen(), ClearFilters(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard() (+141 more)

### Community 15 - "Community 15"
Cohesion: 0.01
Nodes (118): ATTENDANCE_DEFAULTS, adminPrincipal, mocks, PLATFORM_LIMITS, afterMidnight, evening, meters, mocks (+110 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (97): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, COMPARISON_AMENITIES, comparisonAmenities() (+89 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (132): MESSAGES, POST(), RouteContext, RouteContext, DELETE(), GET(), hostelId(), GET() (+124 more)

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (106): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), submitFieldCash(), dueWhen() (+98 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (130): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply() (+122 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (136): announceConfirmed(), announceEnding(), assertAwaitingAnswer(), cancelBookingByHostel(), cancelBookingByPlatform(), cancelMyBooking(), confirmBooking(), declineBooking() (+128 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (126): OrphanAssignPicker, HostelAdminReconcilePageContent, labelled(), PROVIDERS, Reconciliation, StatementImportRow, Suggestion, VideoSlot() (+118 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (106): AdminCommunityScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+98 more)

### Community 23 - "Community 23"
Cohesion: 0.02
Nodes (120): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, BillableResidentRow, BilledInvoice (+112 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (105): checkoutDocumentFor(), softmatoDocumentNumbers(), gateway, invoice, updateOne, documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument() (+97 more)

### Community 25 - "Community 25"
Cohesion: 0.02
Nodes (110): notifyHostelOfNewPost(), resolveHostelCommunityUserIds(), usersMutingNewPosts(), cookPrincipal, mocks, resolveCookLabels(), announceFoodReady(), cookEmailForSlug() (+102 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (95): AuthShell(), AuthShellProps, PANEL_COPY, SiteWordmark(), metadata, ContentHeader(), ContentIntro(), ContentNote() (+87 more)

### Community 27 - "Community 27"
Cohesion: 0.02
Nodes (114): BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsMonthStart(), bsPeriodBounds(), bsPeriodOf() (+106 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (89): POST(), summarizeResidentComplaints(), GET(), listResidentInvoices(), GET(), POST(), RouteContext, acceptGuardianInvitation() (+81 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (114): AdminOverviewScreen(), loadOverview(), AdminMoneyScreen(), loadMoney(), AdminAlertsContext, AdminAlertsProvider(), AdminAlertsValue, AlertActions (+106 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (102): ProfileScreen(), ReferralRow(), CheckoutStatusScreen(), AdminSearchBar(), DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS (+94 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (82): AccountDeletionPanel, DeletionPathway, DeletionStatus, PATHWAY_COPY, csvField(), deferLoad(), DemoDataBadge(), field() (+74 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (93): PATCH(), POST(), RouteContext, demoteToPublicAccount(), POST(), RouteContext, PATCH(), RouteContext (+85 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (98): POST(), POST(), GET(), POST(), bulkApproveSchema, POST(), GET(), POST() (+90 more)

### Community 34 - "Community 34"
Cohesion: 0.02
Nodes (92): EMPTY_PAYOUT_DRAFT, METHODS, PayoutAccountDraft, PayoutAccountFields(), payoutAccountPayload(), DescriptionFacts, DescriptionSuggestions(), HostelType (+84 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (95): addComplaintUpdate(), assertComplaintVoiceNote(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput (+87 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (96): openStore(), SORTS, StoreCategoryScreen(), appBlurTarget, closeConfirm(), ConfirmRequest, emit(), getConfirmRequest() (+88 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (84): PaginationMeta, paginationQuerySchema, paginationRange(), querySchema, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex(), HostelRecord (+76 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (85): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), methodProvider(), PROVIDER_LABEL, QrPanel() (+77 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (90): CardBooking, checkInBooking(), findCardBooking(), findHeldBooking(), returnHeldBed(), takeHeldBed(), CapacityError, claimBedForRoomType() (+82 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (92): fill(), money(), PlanCard(), PricingScreen(), softmatoDocsUrl(), dueBhadra29, filed, throughAswin25 (+84 more)

### Community 41 - "Community 41"
Cohesion: 0.03
Nodes (85): BS_MONTHS, cellAt(), focusCell(), INPUT_MODES, Props, COLUMNS, Member, MemberData (+77 more)

### Community 42 - "Community 42"
Cohesion: 0.03
Nodes (72): BookingQuote, GuestBookingDetail, GuestBookingSummary, metadata, BookingCheckoutPage(), Method, METHODS, nextStep() (+64 more)

### Community 43 - "Community 43"
Cohesion: 0.03
Nodes (78): BookingPaymentToCheck, TransferView, HostelBookingView, PlatformBookingView, PayoutAccountForReview, ReviewPayoutAccount(), STATUS_LABEL, List() (+70 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (71): PATCH(), getPlatformBooking(), transfersByBooking(), releaseGuardianAccounts(), findResidentOwnedAccess(), revokeGuardianAccess(), updateGuardianPermissions(), guardianPermissionsUpdateSchema (+63 more)

### Community 45 - "Community 45"
Cohesion: 0.02
Nodes (45): deleteHostelObjects(), ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, purgeHostel(), RETAINED_BY_HOSTEL_ID (+37 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (64): BookingDocumentInput, renderBookingDocument(), bsFiscalYear(), amountInWords(), GROUPS, ONES, TENS, underHundred() (+56 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (72): CookTodayScreen(), PortalDates, useHostelDayTurn(), useMinuteTick(), AdminNightStatusRow, PlanBilling, PlanBillingInvoice, PlanBillingPayment (+64 more)

### Community 48 - "Community 48"
Cohesion: 0.03
Nodes (68): FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind, creditOverpayment() (+60 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (62): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, attempt (+54 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (68): ComparePage(), generateMetadata(), hostels, metadata, rows, BrandMark(), BrandWordmark(), WORDMARK (+60 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (65): answerSchema, POST(), GET(), ApiAuthError, nightKey(), GET(), POST(), settleNightStatusNotifications() (+57 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (60): hostelPeriodOf(), existingResidentListSchema, existingResidentRowSchema, BillPreview, CheckContext, CheckedRow, checkExistingResidents(), CheckResult (+52 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (69): feeUpdateSchema, PATCH(), SetResidentFeeInput, setResidentMonthlyFee(), approveClaim(), findClaim(), POST(), GET() (+61 more)

### Community 54 - "Community 54"
Cohesion: 0.04
Nodes (60): applyBookingConfig(), BookingCancelStep, bookingCancelStepSchema, BookingConfig, bookingConfigSchema, DEFAULT_BOOKING_CONFIG, DEFAULT_CANCEL_STEPS, mergeBookingConfig() (+52 more)

### Community 55 - "Community 55"
Cohesion: 0.04
Nodes (66): approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal, checker, eventId (+58 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (56): ExistingResidentsPanel(), Props, ExistingResidentsSheet(), HostelAdminCommunityPageContent, EMPTY_SUMMARY, HostelAdminComplaintsPage, HostelAdminExistingResidentsPage(), HostelAdminFeePlansPageContent (+48 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (52): BookButton(), SIZE, BookingAvailabilityView, BookingButton, CLOSED_REASONS, open, HostelSuggestions(), formatHostelAddress() (+44 more)
...
Cohesion: 0.04
Nodes (50): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse (+42 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (26): PlatformConfigAnnouncementsPageContent, PlatformConfigContentPageContent, PlatformConfigFacilitiesPageContent, FLAGS, PlatformConfigFeaturesPageContent, PlatformConfigLegalPageContent, PlatformConfigLocationsPageContent, PlatformConfigPlanServicePageContent (+18 more)

### Community 61 - "Community 61"
Cohesion: 0.06
Nodes (61): Choice, Compass(), maneuverIcon(), MapButton(), ModeTab(), NavCard(), NOTHING_CHOSEN, RouteCard() (+53 more)

### Community 62 - "Community 62"
Cohesion: 0.05
Nodes (64): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES (+56 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (55): POST(), HostelRef, notifyHostelOfInquiry(), notifyPlatformOfPendingHostel(), PaginationQuery, deviceTokenSchema, noticeReadStatusSchema, broadcastNotice() (+47 more)

### Community 64 - "Community 64"
Cohesion: 0.03
Nodes (58): PlanId, portalAccessLines(), Service, ServiceModule, ServiceModuleId, Faq, PlatformConfigSeoPageContent, Step (+50 more)

### Community 65 - "Community 65"
Cohesion: 0.05
Nodes (60): CHANNELS, ClaimedStep, composeEmail(), composeNotice(), composePlanDueNotice(), deliverEmail(), deliverStep(), HostelRow (+52 more)

### Community 66 - "Community 66"
Cohesion: 0.04
Nodes (63): continueLabel(), isBlank(), buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, draftFromProfile() (+55 more)
...
Cohesion: 0.04
Nodes (53): account, answerBy, before, book(), Booking, compact, confirmed(), Consent (+45 more)

### Community 70 - "Community 70"
Cohesion: 0.05
Nodes (46): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, metadata, metadata, navItems, metadata, navItems, verifyAccessToken() (+38 more)

### Community 71 - "Community 71"
Cohesion: 0.05
Nodes (41): HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminRoomsPageContent(), PlatformDashboardPageContent(), PlatformUsersPageContent(), DashboardCard(), DashboardCardProps, PlatformServiceProvidersPageContent() (+33 more)

### Community 72 - "Community 72"
Cohesion: 0.06
Nodes (50): GATEWAY_ORDER, getHostelPayMethods(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice() (+42 more)

### Community 73 - "Community 73"
Cohesion: 0.05
Nodes (50): addHistory(), addMaintenanceComment(), assertBedInHostel(), assertProviderApproved(), assertRoomInHostel(), assertVoiceNoteUsable(), assignMaintenanceProvider(), auditMaintenanceAction() (+42 more)

### Community 74 - "Community 74"
Cohesion: 0.06
Nodes (49): GET(), AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput, ConsentInput (+41 more)

### Community 75 - "Community 75"
Cohesion: 0.06
Nodes (52): GET(), POST(), GET(), GET(), POST(), acceptPlatformAdminInvitation(), AcceptPlatformAdminInvitationInput, appUrl() (+44 more)

### Community 76 - "Community 76"
Cohesion: 0.07
Nodes (50): POST(), getFoodRoutine(), getFoodRoutinesByHostelId(), saveFoodRoutine(), serializeRoutine(), addUtcDay(), auditFoodAction(), createFoodMenu() (+42 more)

### Community 77 - "Community 77"
Cohesion: 0.05
Nodes (48): Resident, MoveEvent, LedgerMonth, LedgerPayment, ResidentLedger, ResidentPaymentTrackSheet, HostelPreviewLink(), normalize() (+40 more)

### Community 78 - "Community 78"
Cohesion: 0.05
Nodes (42): CopyButton(), GatewayProviderName, ManualMethodPanel(), MethodIcon(), methodKey(), methodLabel(), PayMethod, PROVIDER_LABEL (+34 more)

### Community 79 - "Community 79"
Cohesion: 0.06
Nodes (49): appBaseUrl(), CLAIMABLE_STATUSES, dispatchOtpChallenge(), dispatchVerificationEmail(), findVerifiedRegistrationChallenge(), generateOtpCode(), GOOGLE_JWKS, hashOtpCode() (+41 more)

### Community 80 - "Community 80"
Cohesion: 0.07
Nodes (56): decodeKey(), decryptPersonalData(), encryptionKey(), encryptPersonalData(), isPersonalDataEncryptionConfigured(), personalLookupHash(), resetPersonalDataKeyCache(), envelope (+48 more)
...
Cohesion: 0.07
Nodes (46): collectionTotals(), getHostelViewStats(), foodFeedbackSchema, listingFlagSchema, paymentProofSchema, averageResolutionDays(), bucketBoundaries(), buildHostelAdminDashboardReport() (+38 more)

### Community 83 - "Community 83"
Cohesion: 0.06
Nodes (43): ComplaintDetail(), ComplaintCard(), CategoryTile(), NewComplaintScreen(), PickedAttachment, SwapButton(), CapturedPhoto, PhotoCapture() (+35 more)

### Community 84 - "Community 84"
Cohesion: 0.08
Nodes (44): BOOKING_DOCUMENT_KINDS, BookingDocumentKind, bookingDocumentLayout(), refundPolicyNotes(), allowed(), bookingDocumentAttachment(), bookingDocumentResponse(), BookingDocumentScope (+36 more)

### Community 85 - "Community 85"
Cohesion: 0.08
Nodes (45): formatNpr(), itemsTable(), StoreEmailItem, mocks, allocateOrderNumber(), applyStatus(), CancelInput, cancelOrder() (+37 more)

### Community 86 - "Community 86"
Cohesion: 0.06
Nodes (43): CheckoutHandoffButton(), Handoff, ORDER, ProgressStep, ProgressSteps(), TransitionScreen(), useCheckoutHandoff(), Badge() (+35 more)

### Community 87 - "Community 87"
Cohesion: 0.07
Nodes (51): directionFlags(), evidenceFlags(), payeeFlags(), AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance() (+43 more)

### Community 88 - "Community 88"
Cohesion: 0.07
Nodes (45): GET(), POST(), announceChange(), audit(), CreateInput, createNoticePush(), DEFAULT_PUSHES, deleteNoticePush() (+37 more)

### Community 89 - "Community 89"
Cohesion: 0.13
Nodes (33): POST(), POST(), authenticateWithGoogle(), AuthServiceError, changePassword(), logout(), POST(), POST() (+25 more)
...
Cohesion: 0.05
Nodes (44): addBsMonths(), bsPeriodsBetween(), august, bhadra, hostelId, invoice(), mocks, NOW (+36 more)

### Community 92 - "Community 92"
Cohesion: 0.06
Nodes (22): LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminMoveChecklistPage(), HostelAdminSOSAlertsPage(), HostelAdminComplaintsPage(), HostelAdminResidentsPage() (+14 more)

### Community 93 - "Community 93"
Cohesion: 0.07
Nodes (44): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), loadPayeeIdentity() (+36 more)

### Community 94 - "Community 94"
Cohesion: 0.1
Nodes (42): GET(), BookableHostel, BookingUnavailableReason, findRoom(), hostelAddress(), HostelAvailability, hostelCoverPhoto(), hostelCoverPhotos() (+34 more)

### Community 95 - "Community 95"
Cohesion: 0.06
Nodes (41): formatPeriodKey(), DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), axisMonth(), monthLabel() (+33 more)

### Community 96 - "Community 96"
Cohesion: 0.07
Nodes (41): qrActivationSchema, activateResident(), ActivationCodeGenerateInput, ActivationCodeInput, activationSecret(), ActivationServiceError, ActivationStatus, ActivationStatusQuery (+33 more)
...
Cohesion: 0.06
Nodes (24): field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminNightStatusPage(), LoadState, NightStatusRow, Notification, NotificationsPageContent() (+16 more)

### Community 100 - "Community 100"
Cohesion: 0.08
Nodes (34): DEPRECATED_ALIASES, grantingPermissionKeys(), mocks, GET(), POST(), auditWardenAction(), createHostelWarden(), deactivateHostelWarden() (+26 more)
...
Cohesion: 0.06
Nodes (26): currency(), Input(), TextArea(), ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent, Complaint (+18 more)
...
Cohesion: 0.1
Nodes (34): nepalMinuteOfDay(), nightStatusPromptSchema, askingEndsMinuteOfNight(), formatPromptTime(), isSameNight(), minuteIsDue(), minuteOfNight(), nightEndsAt() (+26 more)
...
Cohesion: 0.08
Nodes (35): documentFlags(), detectProvider(), headlineAmount(), labelledValue(), looksLikeStatement(), methodForProvider(), ParsedReceipt, parseReceipt() (+27 more)
...
Cohesion: 0.1
Nodes (32): cookLoginStem(), generateCookPassword(), mintCookLogin(), pick(), previousCookLabel(), acceptCookInvitation(), addCookAccount(), assertRoomForAnotherCook() (+24 more)

### Community 116 - "Community 116"
Cohesion: 0.09
Nodes (19): DeviceLocationStatus, hasGeolocation(), LocationOutcome, NavigationFix, OrientationPermission, requestDeviceLocation(), requestHeadingPermission(), Unsubscribe (+11 more)

### Community 117 - "Community 117"
Cohesion: 0.13
Nodes (31): resolvePastedLink(), searchCandidates(), lookupLocation(), resolvePastedLink(), searchCandidates(), AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim() (+23 more)
...
Cohesion: 0.13
Nodes (28): bodySchema, POST(), r2Configured(), storePublicAsset(), AccessLevel, bucketForAccessLevel(), generateFileKey(), getPresignedUploadUrl() (+20 more)
...
Cohesion: 0.08
Nodes (25): Choice, HOSTEL_TYPE_LABELS, HostelPanel(), MapButton(), MapCanvas, ModeTab(), NavigationPanel(), NOTHING_CHOSEN (+17 more)

### Community 126 - "Community 126"
Cohesion: 0.07
Nodes (22): Panel(), Select(), StatusBadge(), field(), HostelAdminMaintenancePageContent(), HostelAdminReportsPageContent(), ListingFlag, LoadState (+14 more)

### Community 127 - "Community 127"
Cohesion: 0.08
Nodes (30): BANK, both, empty, ESEWA, [first], ids, KHALTI, odd (+22 more)

### Community 128 - "Community 128"
Cohesion: 0.11
Nodes (30): CsvTable, gridFromCsv(), peekHeaders(), readCsv(), stripBom(), stripPreamble(), ESEWA_PARSER, [first] (+22 more)
...
Cohesion: 0.09
Nodes (22): METHODS, PayDialog(), rupees(), TeamCommissionPanel(), TeamWallet, blankRow(), Row, TeamInviteBox() (+14 more)
...
Cohesion: 0.06
Nodes (23): accountId, adminId, booking, calls, compact, guardian, intake, linkAt (+15 more)
...
Cohesion: 0.13
Nodes (28): JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, ProviderJobScreen(), ProviderJob (+20 more)

### Community 136 - "Community 136"
Cohesion: 0.11
Nodes (26): describeGrants(), GuardianRow(), PermissionSheet(), InviteGuardianScreen(), daysUntil(), describeGuardianOnRecord(), describeInvitation(), describeSharing() (+18 more)

### Community 137 - "Community 137"
Cohesion: 0.1
Nodes (25): SosScreen(), BottomChrome, BottomChromeContext, BottomChromeProvider(), CHROME_TIMING, useBottomChrome(), SosFab(), SosHeaderButton() (+17 more)

### Community 138 - "Community 138"
Cohesion: 0.1
Nodes (26): guardianAccessSchema, AccountDeletionError, applyImmediateEffects(), cancelAccountDeletionByToken(), cancelAccountDeletionForUser(), cancelUrlFor(), DeletionPathway, DeletionRequestRecord (+18 more)
...
Cohesion: 0.1
Nodes (28): UploadCard(), useIsUploading(), dismissUpload(), emit(), getUploadRows(), listeners, pruneUploads(), resetUploadQueue() (+20 more)
...
Cohesion: 0.12
Nodes (26): GuardianHomeScreen(), GuardianMetrics(), GuardianPaymentsScreen(), GuardianSafetyScreen(), GuardianPayment, GuardianPermissionKey, GuardianPermissions, GuardianReceipt (+18 more)

### Community 144 - "Community 144"
Cohesion: 0.09
Nodes (27): findOrphanClaims(), loadMatchContext(), statementImportSchema, StatementRow, ApprovedNotInStatementRow, approveMatchedRows(), approverNamesFor(), ClaimedNoTransactionRow (+19 more)

### Community 145 - "Community 145"
Cohesion: 0.09
Nodes (22): applicantSchema, billingCycleSchema, HostelRegistrationInput, hostelRegistrationSchema, registrationFields, RegistrationPlanChoice, registrationPlanChoiceSchema, TeamHostelRegistrationInput (+14 more)
...
Cohesion: 0.11
Nodes (25): cook, assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES, PermissionError, Principal, TEAM_ROLES (+17 more)
...
Cohesion: 0.08
Nodes (20): Complaint, ComplaintSummary, EmptyState(), field(), FoodMenu, HostelAdminFoodPage(), HostelAdminNoticesPage(), HostelAdminPaymentsPage() (+12 more)
...
Cohesion: 0.11
Nodes (19): HostelGeoRecord, sleep(), geocodeAddress(), geocodeWithGoogle(), geocodeWithNominatim(), HostelGeoLocation, resolveHostelGeo(), fetchNearbyPlaces() (+11 more)
...
Cohesion: 0.1
Nodes (15): monthlySeries(), countListingAppearances(), complaintSchema, hostelPageViewSchema, moveOutChecklistSchema, nightStatusSchema, ratingReviewSchema, compare() (+7 more)
...
Cohesion: 0.15
Nodes (19): otpResendCooldownMs(), fail(), findHostelForCheckout(), HostelMatch, paymentState(), PlanCheckoutInput, planCheckoutSchema, readCheckoutToken() (+11 more)

### Community 174 - "Community 174"
Cohesion: 0.12
Nodes (15): AuthGuard(), checkOnly(), metadata, checkAuthWithRefresh(), isStaleSession(), fetchMock, payload, refreshSessionMock (+7 more)
...
Cohesion: 0.14
Nodes (19): assertQrAssetUsable(), EMPTY, PaymentProfileView, ProfileDocument, readQrPayeeFields(), TEXT_FIELDS, PaymentProfileUpdateInput, paymentProfileUpdateSchema (+11 more)
...
Cohesion: 0.12
Nodes (17): averageRating(), cityCount(), group(), HomeStat, homeStats(), rated, stats, vacantBeds() (+9 more)
...
Cohesion: 0.13
Nodes (17): classifyCredit(), CreditClassification, LadderClaim, LadderInvoice, MatchContext, normalizeTxnId(), ANITA_CODE, claims (+9 more)

### Community 195 - "Community 195"
Cohesion: 0.14
Nodes (20): activeDevicesFor(), activeTokensFor(), androidChannel(), authHeaders(), chunk(), DeviceRow, dispatchPush(), EMPTY (+12 more)
...
Cohesion: 0.16
Nodes (16): isNightStatusPrompt(), NIGHT_STATUS_ACTIONS, NIGHT_STATUS_BUTTONS, NIGHT_STATUS_REASONS, NightStatusActionId, parseNightStatusAction(), reasonLabel(), SelfReportedStatus (+8 more)
...
Cohesion: 0.16
Nodes (17): ApiFailure, EXTENSION_MIME, isAudio(), PickedFile, resolveFileName(), resolveMimeType(), name, parseEnvelope() (+9 more)

### Community 206 - "Community 206"
Cohesion: 0.15
Nodes (17): isApprovedServiceProvider(), issueSessionForUser(), login(), publicUser(), refreshAccessToken(), cook, createUser(), createUserDoc() (+9 more)
...
Cohesion: 0.12
Nodes (15): notificationSchema, userResidentProfileSchema, ResidentIdentityError, ResidentProfileData, findScannedAccount(), loadMembership(), PhotoAssetRecord, ProfileRecord (+7 more)
...
Cohesion: 0.16
Nodes (15): asPushTiming(), laterFromDelay(), NoticePushRepeat, NoticePushTiming, sentAt, TUESDAY_NOON, WASHING, addDays() (+7 more)
...
Cohesion: 0.14
Nodes (14): AuthSession, getResidentProfile(), triggerSOS(), AppNavigator(), RootStackParamList, Stack, Props, ResidentActivationScreen() (+6 more)

### Community 222 - "Community 222"
Cohesion: 0.15
Nodes (20): code:typescript (interface IMoveInChecklistItem {), code:typescript (interface IMoveOutChecklistItem {), code:typescript (interface IServiceProvider {), code:typescript (interface IServiceProvider {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IInquiry {), Complaint (+12 more)
...
Cohesion: 0.15
Nodes (19): Attendance / Night Safety, code:typescript (interface INightStatusLog {), code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface INotice {), code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {), code:typescript ({) (+11 more)

### Community 231 - "Community 231"
Cohesion: 0.2
Nodes (19): AttendanceAlert, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({), code:typescript (interface IQuestionCallClick {), code:typescript ({), code:typescript ({) (+11 more)
...
Cohesion: 0.12
Nodes (15): AuthState, initialState, notificationsSlice, NotificationsState, migrated, state, AppDispatch, AppState (+7 more)

### Community 235 - "Community 235"
Cohesion: 0.17
Nodes (16): ReviewForm(), ReviewScreen(), canReview(), emptyReviewDraft(), hasReviewErrors(), REVIEW_CATEGORIES, REVIEWABLE_STATUSES, ReviewCategoryKey (+8 more)
...
Cohesion: 0.12
Nodes (15): GoogleAuthInput, googleAuthSchema, LoginInput, loginSchema, otpChannelSchema, otpPurposeSchema, OtpRequestInput, otpRequestSchema (+7 more)

### Community 242 - "Community 242"
Cohesion: 0.17
Nodes (13): computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKindFromText(), distance, SystemDocumentKind, ImageVariantRecord, optimizeImage() (+5 more)

### Community 243 - "Community 243"
Cohesion: 0.14
Nodes (15): platformPushScheduleSchema, NotificationCampaignError, PLATFORM_PUSH_AUDIENCES, platformPushSchema, AUDIENCE_ROLES, deliverPush(), PlatformPushAudience, PlatformPushInput (+7 more)
...
Cohesion: 0.12
Nodes (15): buildHtml(), boundsCenter(), KATHMANDU, sortByDistance(), distance, far, input, middle (+7 more)
...
Cohesion: 0.13
Nodes (13): CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS, CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, MOCK_HOSTELS (+5 more)
...
Cohesion: 0.21
Nodes (14): liftHostelSuspension(), objectIds(), OPEN_WHILE_SUSPENDED, serializeSuspension(), hostelObjectId(), HostelSuspensionError, liftPlatformHostelSuspension(), startHostelSuspension() (+6 more)
...
Cohesion: 0.15
Nodes (14): isWithinQuietHours(), localMinutesNow(), PushGateInput, PushGateResult, PushPreference, shouldPush(), end, morning (+6 more)
...
Cohesion: 0.14
Nodes (17): 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails, 4.2 Complaint Status Updated, 4.3 Complaint Resolved (+9 more)
...
Cohesion: 0.2
Nodes (12): deleteTeamMember(), endSessions(), findMember(), MemberRecord, removeTeamMember(), suspendTeamMember(), TeamMemberError, teamMemberFootprint() (+4 more)
...
Cohesion: 0.13
Nodes (14): 0. Reading order, 12. Notifications, 2. The tier model, 7. The matching ladder, 8.1 Evidence hashing, 8.2 What to tell the resident on rejection, 8.3 Honesty about Tier 0's limit, 8. Fraud controls (+6 more)
...
Cohesion: 0.15
Nodes (15): 7.2 Role Gate Test Template, 7.3 Privacy/Guardian Permissions Test Template, 7.4 Account-Upgrade Test Template, 7. Mandatory Test Templates, 9.1 Seed Scripts, 9.2 Test Database Isolation, 9.3 Test Helpers, 9. Test Data & Seeding (+7 more)
...
Cohesion: 0.19
Nodes (10): groupNearbyPlaces(), humanizeNearbyType(), NEARBY_GLYPHS, NEARBY_GROUPS, NEARBY_ICONS, nearbyGlyph(), NearbyGroup, nearbyIcon() (+2 more)
...
Cohesion: 0.2
Nodes (10): notificationPreferenceSchema, DEFAULT_NOTIFICATION_PREFERENCE, filterPushRecipients(), getNotificationPreference(), NotificationPreference, PreferenceRecord, serialize(), updateNotificationPreference() (+2 more)

### Community 307 - "Community 307"
Cohesion: 0.24
Nodes (11): CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, isPlanDueNotification(), readId(), CATEGORY_PATHS, NOTIFICATION_LIST, readId() (+3 more)
...
Cohesion: 0.18
Nodes (10): requestOtp(), signInWithGoogle(), submitResidentReview(), LoginScreen(), Props, Props, ResidentReviewsScreen(), Props (+2 more)
...
Cohesion: 0.21
Nodes (11): categoryLabel(), PROVIDER_CATEGORIES, ProviderCard(), ProviderDirectoryData, PublicProvider, PublicServiceProviderDirectoryPage(), DirectoryPageProps, EMPTY (+3 more)
...
Cohesion: 0.29
Nodes (13): AttendanceLog, code:typescript ({), code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({), FoodReadyLog, Notification, Notification (+5 more)
...
Cohesion: 0.2
Nodes (8): PlatformHostelsPageContent(), PlatformHostelsPageContent, PortalPlaceholderAction, PortalPlaceholderPage(), PortalPlaceholderPageProps, HostelAdminScreenPage(), HostelAdminScreenPageProps, PlatformScreenPageProps
...
Cohesion: 0.27
Nodes (8): approvalPeriod(), getPeriodSummary(), monthsBetween(), periodOf(), PeriodRow, PeriodSummary, countableResidentIds(), hostelVerificationSchema
...
Cohesion: 0.2
Nodes (11): activateResident(), apiRequest(), confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listResidentComplaints(), login(), refreshSession() (+3 more)
...
Cohesion: 0.18
Nodes (8): bank, hostelA, hostelB, owner, row, store, superadmin, payoutAccountInputSchema
...
Cohesion: 0.29
Nodes (8): documents, hostelForm(), many, parsed, result, emptyHostelForm(), emptyRoomRow(), form()
...
Cohesion: 0.24
Nodes (9): featuresFor(), fit(), FORBIDDEN_PATTERNS, isSafe(), LIMITS, plain(), PlanTier, PresentationInput (+1 more)
...
Cohesion: 0.2
Nodes (10): 10.1 GitHub Actions Workflow, 10.2 Merge Rules, 10. CI/CD Integration, 7.1 Multi-Tenant Isolation Test Template, 7.5 Payment Precision Test Template, code:typescript (describe('GET /api/v1/hostel/rooms/:id - tenant isolation', ), code:typescript (describe('Payment calculations - decimal precision', () => {), code:yaml (# .github/workflows/test.yml) (+2 more)
...
Cohesion: 0.22
Nodes (4): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks

### Community 410 - "Community 410"
Cohesion: 0.25
Nodes (7): arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal

### Community 411 - "Community 411"
Cohesion: 0.28
Nodes (8): EMPTY, ensureConfigured(), statusCodeOf(), VapidConfig, WebPushPayload, webPushPublicKey(), WebPushResult, WebPushTarget
...
Cohesion: 0.33
Nodes (9): AccountDeletionRequest, code:block43 (packages/db/migrations/), code:typescript ({), code:typescript (interface IAccountDeletionRequest {), code:block46 (packages/db/migrations/), Consent & Privacy, ConsentLog, Migrations (Mongoose) (+1 more)
...
Cohesion: 0.36
Nodes (7): HostelForm, ProviderForm, clearRegistrationDraft(), DraftKind, keyFor(), readRegistrationDraft(), saveRegistrationDraft()
...
Cohesion: 0.46
Nodes (6): describePreference(), formatMinutes(), MUTABLE_CATEGORIES, NotificationPreference, parseMinutes(), base
...
Cohesion: 0.33
Nodes (5): attacker, attempt(), headers, jsonRequest(), routeMocks
...
Cohesion: 0.33
Nodes (7): 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, code:typescript ({), code:typescript ({), code:typescript ({)
...
- **Why does `cn()` connect `Community 12` to `Community 1`, `Community 130`, `Community 4`, `Community 5`, `Community 13`, `Community 142`, `Community 16`, `Community 21`, `Community 149`, `Community 279`, `Community 26`, `Community 156`, `Community 31`, `Community 34`, `Community 40`, `Community 41`, `Community 42`, `Community 50`, `Community 56`, `Community 57`, `Community 59`, `Community 60`, `Community 324`, `Community 71`, `Community 77`, `Community 78`, `Community 213`, `Community 86`, `Community 90`, `Community 101`, `Community 125`, `Community 126`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 1` to `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 136`, `Community 10`, `Community 9`, `Community 137`, `Community 12`, `Community 14`, `Community 21`, `Community 26`, `Community 29`, `Community 30`, `Community 31`, `Community 38`, `Community 56`, `Community 61`, `Community 77`, `Community 78`, `Community 83`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 2` to `Community 0`, `Community 11`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 23`, `Community 24`, `Community 25`, `Community 27`, `Community 28`, `Community 32`, `Community 33`, `Community 35`, `Community 37`, `Community 39`, `Community 40`, `Community 41`, `Community 44`, `Community 45`, `Community 48`, `Community 49`, `Community 50`, `Community 51`, `Community 52`, `Community 53`, `Community 54`, `Community 55`, `Community 63`, `Community 65`, `Community 67`, `Community 70`, `Community 72`, `Community 73`, `Community 74`, `Community 75`, `Community 76`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 84`, `Community 85`, `Community 88`, `Community 89`, `Community 91`, `Community 93`, `Community 94`, `Community 96`, `Community 100`, `Community 102`, `Community 111`, `Community 114`, `Community 115`, `Community 120`, `Community 127`, `Community 133`, `Community 138`, `Community 144`, `Community 145`, `Community 161`, `Community 162`, `Community 168`, `Community 173`, `Community 176`, `Community 185`, `Community 194`, `Community 195`, `Community 196`, `Community 206`, `Community 214`, `Community 243`, `Community 244`, `Community 255`, `Community 258`, `Community 260`, `Community 278`, `Community 306`, `Community 343`, `Community 389`, `Community 409`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Are the 516 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 516 INFERRED edges - model-reasoned connections that need verification._
