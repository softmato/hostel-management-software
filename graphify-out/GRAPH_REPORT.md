# Graph Report - hostel-management-software  (2026-09-21)

## Corpus Check
- 2276 files · ~4,072,538 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18359 nodes · 51294 edges · 611 communities (577 shown, 34 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 850 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 728 edges
2. `successResponse()` - 705 edges
3. `connectToDatabase()` - 511 edges
4. `useAppTheme()` - 422 edges
5. `cn()` - 333 edges
6. `connectToDatabase()` - 272 edges
7. `unwrap()` - 230 edges
...
## Communities (611 total, 34 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (308): GET(), POST(), MESSAGES, POST(), RouteContext, PATCH(), POST(), RouteContext (+300 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (350): loadOverview(), loadMoney(), loadToday(), AdminRollCallCard(), NightStatusPromptCard(), FinanceData, loadFinance(), DeletionRequest (+342 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (281): getOrCreateSubscription(), POST(), GET(), GET(), querySchema, GET(), foodRoutineSaveSchema, GET() (+273 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (212): ICONS, LABELS, Segment, TONES, FILTERS, Pending, openStore(), Overview (+204 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (274): answerSchema, POST(), ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError (+266 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (216): Scanner(), CookInviteScreen(), GuardianInviteScreen(), MapScreen(), CallableRow(), IdentityCard(), PeopleSection(), SavedHostelsScreen() (+208 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (226): BubbleBackground(), BubbleBackgroundProps, BubbleColors, StarLayer(), StarLayerProps, StarsBackground(), StarsBackgroundProps, BrandMark() (+218 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (159): PlanPaymentClaim, deferLoad(), DemoDataBadge(), Hostel, HostelTable(), Inquiry, LoadState, Message() (+151 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (224): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, notifyHostelOfNewPost(), resolveHostelCommunityUserIds() (+216 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (186): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel() (+178 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (223): GET(), BookingEndCause, HostelBookingClosedCause, announceConfirmed(), announceEnding(), assertAwaitingAnswer(), cancelBookingByHostel(), cancelBookingByPlatform() (+215 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (180): AdminCommunityReportsScreen(), AdminMoreScreen(), MANAGE_ROWS, PORTAL_ROWS, AdminResidentsScreen(), ActivateScreen(), AttendanceScreen(), BootGate() (+172 more)
...
Cohesion: 0.05
Nodes (133): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), dueWhen(), PlanDueInput (+125 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (142): invalidateFeeds(), writeFeedRead(), CommunityScreen(), Composer(), AnimatedBlurView, CommunityBoard(), CommunityBoardProps, Composer() (+134 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (144): ReviewForm(), ReviewScreen(), AttachmentGallery(), DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS, MealCard() (+136 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (126): adminPrincipal, mocks, PLATFORM_LIMITS, mocks, readable, selectable, mocks, proofBody (+118 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (131): GET(), readReturnState(), ownerIdentitiesFor(), resolveOwnedHostel(), getPlanPaymentInstructions(), findOpenInvoice(), getSubscriptionState(), invoiceIdFor() (+123 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (121): AdminCommunityScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+113 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (121): GET(), listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), listPlanPaymentClaims(), bookingDocumentResponse(), GET() (+113 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (97): HostelSuggestions(), GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS (+89 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (121): PaymentMonthStrip(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard(), AmountCard(), AdminLedger (+113 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (98): generateMetadata(), chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout() (+90 more)

### Community 23 - "Community 23"
Cohesion: 0.02
Nodes (84): EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, isMonthEnd(), ROUTINE_DAYS, ROUTINE_MEAL_TYPES, RoutineDay (+76 more)

### Community 24 - "Community 24"
Cohesion: 0.02
Nodes (95): EMPTY_PAYOUT_DRAFT, METHODS, PayoutAccountDraft, PayoutAccountFields(), payoutAccountPayload(), AuthGuard(), DescriptionFacts, DescriptionSuggestions() (+87 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (105): demoteToPublicAccount(), CardBooking, checkInBooking(), findCardBooking(), findHeldBooking(), returnHeldBed(), takeHeldBed(), CapacityError (+97 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (89): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), DocumentScreen(), MobileLegal (+81 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (98): DELETE(), GET(), hostelId(), GET(), PATCH(), storeCategorySchema, storeProductSchema, GET() (+90 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (89): cookLoginStem(), generateCookPassword(), mintCookLogin(), pick(), previousCookLabel(), cookPrincipal, mocks, acceptCookInvitation() (+81 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (92): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, BillableResidentRow, BilledInvoice (+84 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (49): InlineText(), TIER_TONE, PlanMark(), RAFTER, RIDGE, ROWS, EASE, PlanCards() (+41 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (79): AuthLayout(), metadata, notFound(), CityHostelsPage(), generateMetadata(), PageParams, PublicFooter(), CITY_VISUALS (+71 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (68): HIDDEN, RoleLayout(), TABS, NightStatusForm(), AlertRow(), SosScreen(), TABS, BottomChrome (+60 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (79): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), AdminTabs(), AdminMoneyScreen(), AdminTodayScreen(), AdminAlertsContext, AdminAlertsProvider() (+71 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (67): metadata, AccountDeletionPanel, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails() (+59 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (69): BookingQuote, GuestBookingDetail, GuestBookingSummary, HostelBookingView, metadata, PayoutAccountForReview, ReviewPayoutAccount(), STATUS_LABEL (+61 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (75): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), methodProvider(), PROVIDER_LABEL, QrPanel() (+67 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (75): HostelAdminCooksPanel, ConcessionBackfill, describeApplied(), FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, MonthDiscounts, monthStartPeriod() (+67 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (79): NoticeArt(), ManageRatesScreen(), createManagedNotice(), createNoticePush(), deleteNoticePush(), listManagedNotices(), ManagedNotice, NOTICE_CATEGORIES (+71 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (74): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult (+66 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (64): ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, attempt, fetchMock, forged, live (+56 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (67): bsPeriodBounds(), periodStartDate(), defaultDueDate(), periodCoverage(), hostelPeriodOf(), existingResidentListSchema, existingResidentRowSchema, monthWindow() (+59 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (65): applyBookingConfig(), BookingCancelStep, bookingCancelStepSchema, BookingConfig, bookingConfigSchema, DEFAULT_BOOKING_CONFIG, DEFAULT_CANCEL_STEPS, mergeBookingConfig() (+57 more)
...
Cohesion: 0.06
Nodes (64): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt, allocateReceiptNumber() (+56 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (62): nightAnswerText(), NightPromptAnswer(), NotificationCard(), ProfileScreen(), ReferralRow(), CheckoutStatusScreen(), ResidentLedger, ResidentPrefill (+54 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (52): PATCH(), RouteContext, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex(), HostelRecord, ListingFlagListQuery, ListingFlagRecord (+44 more)
...
Cohesion: 0.05
Nodes (64): documents, hostelForm(), many, parsed, result, buildHostelPayload(), capacitySummary(), CITY_OPTIONS (+56 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (47): GetAppDialog(), Platform, CopyButton(), GatewayProviderName, ManualMethodPanel(), MethodIcon(), methodKey(), methodLabel() (+39 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (50): AcceptResult, CookInvitePageContent, AcceptResult, GuardianInvitePageContent, ActivationStatusResponse, ActivationTarget, CodeState, DOT_COLOR (+42 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (66): BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsMonthStart(), formatBsDayMonth(), formatBsDayRange() (+58 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (66): BS_MONTHS, formatPeriodKey(), cellAt(), focusCell(), Props, DeliveryWindowFields(), number(), text() (+58 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (56): PreviewCard(), ResultRow(), FACILITY_ICONS, facilityIcon(), facilityKey(), HostelCard(), SaveButton(), HostelShowcase() (+48 more)
...
Cohesion: 0.06
Nodes (55): JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, ProviderStatusCard(), TILE_INK (+47 more)
...
Cohesion: 0.04
Nodes (52): financeIntegrityHash(), appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind, creditOverpayment(), getCreditAmount(), getCreditBalance() (+44 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (49): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, auditLogSchema, qrActivationSchema, reviewModerationLogSchema, before (+41 more)

### Community 59 - "Community 59"
Cohesion: 0.05
Nodes (50): discountRent(), applyConcessionToIssuedInvoices(), ConcessionBackfill, EMPTY, InvoiceLine, settledAmountOf(), bill, hostelId (+42 more)
...
Cohesion: 0.05
Nodes (53): GATEWAY_ORDER, getHostelPayMethods(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice() (+45 more)

### Community 64 - "Community 64"
Cohesion: 0.06
Nodes (49): POST(), RouteContext, listTrendingTags(), POST(), safeEqual(), sponsorSchema, ClickRecord, dayKey() (+41 more)

### Community 65 - "Community 65"
Cohesion: 0.04
Nodes (40): accessId, accessQuery, adminPrincipal, codes, guardianId, guardianPrincipal, issue(), leanResult() (+32 more)

### Community 66 - "Community 66"
Cohesion: 0.06
Nodes (51): documentUrl(), InvoiceLean, PaymentLean, PlatformInvoiceRow, PlatformPaymentRow, PlatformSubscriptionLedger, BOOKING_DOCUMENT_KINDS, BookingDocumentKind (+43 more)

### Community 67 - "Community 67"
Cohesion: 0.05
Nodes (41): requestResidentProfileForm(), checkOnly(), EMPTY_PREFILL, ENVIRONMENT_OPTIONS, IdentityResponse, Prefill, Step, checkAuthWithRefresh() (+33 more)

### Community 68 - "Community 68"
Cohesion: 0.07
Nodes (47): notifyProviderOfAssignment(), notifyProviderOfMaintenanceNote(), notifyProviderOfStatusChange(), notifyStaffOfNewMaintenanceRequest(), providerUserId(), readableCategory(), RequestLike, STATUS_WORDS (+39 more)

### Community 69 - "Community 69"
Cohesion: 0.07
Nodes (37): POST(), POST(), POST(), runPlanDueReminders(), sweepBookings(), POST(), periodOf(), runBillingCycleForAllHostels() (+29 more)
...
Cohesion: 0.08
Nodes (51): Assurance(), fill(), money(), PlanCard(), PricingScreen(), BillingToggle(), listHeadingFor(), PlanCard() (+43 more)

### Community 72 - "Community 72"
Cohesion: 0.05
Nodes (51): continueLabel(), isBlank(), buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, draftFromProfile() (+43 more)

### Community 73 - "Community 73"
Cohesion: 0.08
Nodes (43): GuardianNotShared(), GuardianWardCard(), GuardianHomeScreen(), GuardianMetrics(), GuardianPaymentsScreen(), GuardianSafetyScreen(), LoginResult, acceptGuardianInvitation() (+35 more)

### Community 74 - "Community 74"
Cohesion: 0.06
Nodes (46): candidatesInRun(), canonicalize(), checkCharacter(), CONFUSABLES, decodeSequence(), deriveHostelPrefix(), encodeSequence(), extractReferenceCodes() (+38 more)
...
Cohesion: 0.07
Nodes (46): deliver(), loadInvoiceById(), loadProof(), PlanPaymentInstructions, ProofAsset, reviewPlanPaymentClaim(), submitPlanPaymentClaim(), Resolver (+38 more)

### Community 77 - "Community 77"
Cohesion: 0.05
Nodes (45): CHANNELS, ClaimedStep, composeNotice(), composePlanDueNotice(), deliverEmail(), deliverStep(), HostelRow, InvoiceRow (+37 more)

### Community 78 - "Community 78"
Cohesion: 0.07
Nodes (39): POST(), RouteContext, computePerceptualHash(), systemDocumentKind(), hashUserAgent(), HostelRef, newVisitorKey(), recordHostelPageView() (+31 more)
...
Cohesion: 0.06
Nodes (38): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, AuthShell(), AuthShellProps, PANEL_COPY (+30 more)

### Community 81 - "Community 81"
Cohesion: 0.08
Nodes (48): AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance(), deadline(), DIGIT_CONFUSABLES, EvidenceRead (+40 more)

### Community 82 - "Community 82"
Cohesion: 0.05
Nodes (39): referralSchema, referralCodeSchema, referralRewardSchema, activeCode, codeId, hostelId, joinedResidentId, mocks (+31 more)

### Community 83 - "Community 83"
Cohesion: 0.08
Nodes (44): Choice, Compass(), maneuverIcon(), MapButton(), ModeTab(), NavCard(), NOTHING_CHOSEN, RouteCard() (+36 more)

### Community 84 - "Community 84"
Cohesion: 0.06
Nodes (33): HostelAdminInquiriesPageContent(), HostelAdminRoomsPageContent(), PlatformHostelReviewPageContent(), PlatformUsersPageContent(), DashboardCard(), DashboardCardProps, PlatformServiceProvidersPageContent(), PlatformHostelReviewPageContent (+25 more)

### Community 85 - "Community 85"
Cohesion: 0.06
Nodes (22): LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminNoticesPage(), redirectToWorkspaceScreen(), HostelAdminMaintenancePageContent() (+14 more)

### Community 86 - "Community 86"
Cohesion: 0.06
Nodes (41): downloadCaption(), DownloadRow, DownloadStack(), progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster() (+33 more)
...
Cohesion: 0.06
Nodes (39): classifyCredit(), CreditClassification, LadderClaim, LadderInvoice, MatchContext, normalizeTxnId(), ANITA_CODE, claims (+31 more)

### Community 89 - "Community 89"
Cohesion: 0.07
Nodes (42): CollectionQrField(), FileUploadArea(), PhotoStrip(), isActive(), acceptAttribute(), EXTENSION_BY_MIME, FAMILY_BYTES, FAMILY_ORDER (+34 more)
...
Cohesion: 0.05
Nodes (40): bsPeriodOf(), openOrder(), aswin, bhadra, bs(), card(), currentId, hostelId (+32 more)

### Community 92 - "Community 92"
Cohesion: 0.08
Nodes (41): mocks, allocateOrderNumber(), applyStatus(), CancelInput, cancelOrder(), CreateInput, hostelNames(), listAllOrders() (+33 more)
...
Cohesion: 0.09
Nodes (37): collectionTotals(), getHostelViewStats(), foodFeedbackSchema, listingFlagSchema, paymentProofSchema, averageResolutionDays(), bucketBoundaries(), buildHostelAdminDashboardReport() (+29 more)
...
Cohesion: 0.07
Nodes (27): ExistingResidentsPanel(), Props, ExistingResidentsSheet(), Badge(), grabDocument(), HostelAdminBillingPageContent(), InvoiceRow(), PaymentRow() (+19 more)

### Community 101 - "Community 101"
Cohesion: 0.07
Nodes (31): CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES, avatarTone() (+23 more)
...
Cohesion: 0.08
Nodes (34): DELETE(), POST(), revokeDeviceToken(), saveDeviceToken(), campaignBaseSchema, deviceTokenRevokeSchema, deviceTokenSaveSchema, hostelNotificationCampaignSchema (+26 more)
...
Cohesion: 0.06
Nodes (26): currency(), Input(), LoadingRows(), ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent, Complaint (+18 more)

### Community 108 - "Community 108"
Cohesion: 0.07
Nodes (34): buildPage(), buildPinPage(), CentrePin(), describeAddress(), HostelPinField(), HostelPinPicker(), KATHMANDU, MapLinkField() (+26 more)
...
Cohesion: 0.06
Nodes (32): bsPeriodsBetween(), asar, coverage, eventId, hostelId, invoiceId, mocks, principal (+24 more)

### Community 113 - "Community 113"
Cohesion: 0.08
Nodes (32): GET(), acceptPlatformAdminInvitation(), AcceptPlatformAdminInvitationInput, appUrl(), checkPlatformAdminEmail(), daysFromNow(), EmailAvailability, EmailAvailabilityResult (+24 more)
...
Cohesion: 0.1
Nodes (32): cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath(), formatManeuverDistance(), hasArrived(), headingDifference() (+24 more)
...
Cohesion: 0.14
Nodes (28): CSV_COLUMNS, GET(), GET(), periodTotals(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS (+20 more)

### Community 121 - "Community 121"
Cohesion: 0.07
Nodes (25): csvField(), field(), numberField(), optionalField(), AddressFields, FORM_SECTIONS, HostelAdminProfilePageContent, PendingPhoto (+17 more)

### Community 122 - "Community 122"
Cohesion: 0.08
Nodes (30): countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor(), LedgerInvoice (+22 more)

### Community 123 - "Community 123"
Cohesion: 0.09
Nodes (28): deliver(), emailFacts(), hostelOrThrow(), notifyPlatformOfPayoutReview(), PayoutAccountStatus, PayoutAccountView, PayoutActor, PayoutRecord (+20 more)
...
Cohesion: 0.09
Nodes (32): readMoney(), AMOUNT_ALIASES, counterparty(), CREDIT_ALIASES, CREDIT_WORDS, DATE_ALIASES, DEBIT_ALIASES, DEBIT_WORDS (+24 more)

### Community 126 - "Community 126"
Cohesion: 0.09
Nodes (32): announcedCount(), announcementSummary(), CookFoodPhoto, MealButton, mealButtonLabel(), mealButtons(), MealButtonsInput, mealLockNote() (+24 more)

### Community 127 - "Community 127"
Cohesion: 0.07
Nodes (27): POST(), cookCreateSchema, cookInvitationAcceptSchema, cookNameSchema, cookPortalUpdateSchema, cookRemoveSchema, cookUpdateSchema, foodReadySchema (+19 more)
...
Cohesion: 0.07
Nodes (22): LegacyHostelAdminComplaintsPage(), Complaint, ComplaintSummary, field(), FoodMenu, HostelAdminComplaintsPage(), HostelAdminFoodPage(), HostelAdminPaymentsPage() (+14 more)

### Community 130 - "Community 130"
Cohesion: 0.08
Nodes (28): BookingForm(), CheckoutScreen(), METHODS, PackageCard(), roomPhotoUris(), StatusCard(), BookingScreen(), whatNext() (+20 more)
...
Cohesion: 0.1
Nodes (25): hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKindFromText(), distance, readQrPayeeFields(), cleanAccountNumber(), cleanName(), hasQrPayee() (+17 more)
...
Cohesion: 0.13
Nodes (27): resolvePastedLink(), resolvePastedLink(), searchCandidates(), AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim(), definedParts(), GoogleAddressComponent (+19 more)
...
Cohesion: 0.07
Nodes (20): Panel(), Select(), TextArea(), field(), HostelAdminServiceProvidersPageContent(), ListingFlag, LoadState, MaintenanceRequest (+12 more)

### Community 139 - "Community 139"
Cohesion: 0.08
Nodes (21): csvField(), field(), Hostel, HostelAdminDashboardPageContent(), Inquiry, LoadState, numberField(), optionalField() (+13 more)

### Community 140 - "Community 140"
Cohesion: 0.14
Nodes (24): bodySchema, POST(), FILE_ASSET_KINDS, FileAssetKind, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), isPlatformOnlyAssetKind() (+16 more)
...
Cohesion: 0.08
Nodes (25): describePreference(), formatMinutes(), MUTABLE_CATEGORIES, NotificationPreference, parseMinutes(), base, claimAmount, dirname (+17 more)

### Community 143 - "Community 143"
Cohesion: 0.11
Nodes (26): UploadCard(), useIsUploading(), dismissUpload(), emit(), isUploadActive(), listeners, pruneUploads(), resetUploadQueue() (+18 more)

### Community 144 - "Community 144"
Cohesion: 0.09
Nodes (21): Choice, HOSTEL_TYPE_LABELS, HostelPanel(), MapButton(), MapCanvas, ModeTab(), NavigationPanel(), NOTHING_CHOSEN (+13 more)
...
Cohesion: 0.1
Nodes (22): platformPushScheduleSchema, NotificationCampaignError, PLATFORM_PUSH_AUDIENCES, platformPushSchema, addDays(), nepalWallClockToUtc(), nextOccurrence(), PushRepeat (+14 more)
...
Cohesion: 0.1
Nodes (24): directionFlags(), evidenceFlags(), payeeFlags(), CREDIT_MARKERS, DEBIT_MARKERS, DirectionRead, directionRefusal(), EvidenceDirection (+16 more)
...
Cohesion: 0.11
Nodes (20): listRecentInvoices(), approvalPeriod(), getPeriodSummary(), monthsBetween(), periodOf(), PeriodRow, PeriodSummary, august (+12 more)

### Community 168 - "Community 168"
Cohesion: 0.09
Nodes (22): ESEWA_CSV_PARSER, both, corrupted, debit, [first], FIXTURE, headerOnly, noDate (+14 more)
...
Cohesion: 0.11
Nodes (20): buildHtml(), Marker, PlaceMarker, boundsCenter(), haversineMeters(), hostelCoordinates(), HostelWithDistance, KATHMANDU (+12 more)
...
Cohesion: 0.1
Nodes (19): AvailableRoomType, RoomMapFloor, DeletionQueue, DeletionRequest, PlatformAccountDeletionsPageContent, ResidentEmergencyContact, ResidentGuardian, useAvailableRoomTypes() (+11 more)
...
Cohesion: 0.09
Nodes (20): releaseWaiters(), rotateAccessToken(), body, decoder, EvidenceFields, EvidenceReference, EvidenceStage, FetchLike (+12 more)
...
Cohesion: 0.13
Nodes (10): DeviceLocationStatus, GoogleMap, HostelMap(), LeafletMap, TYPE_COLORS, Coordinates, GeocodePrecision, MapProvider (+2 more)
...
Cohesion: 0.13
Nodes (17): BookingAvailability, BookState, CLOSED_REASONS, open, native, NativeDownloads, openDownloaded(), openSavedFile() (+9 more)
...
Cohesion: 0.15
Nodes (16): platformAdminInviteSchema, deleteTeamMember(), endSessions(), findMember(), MemberRecord, reinstateTeamMember(), removeTeamMember(), suspendTeamMember() (+8 more)

### Community 191 - "Community 191"
Cohesion: 0.12
Nodes (19): feeUpdateSchema, PATCH(), setResidentMonthlyFee(), POST(), GET(), generateMonthlyPayments(), getMonthlyPaymentMatrix(), resolveAdminHostelId() (+11 more)
...
Cohesion: 0.09
Nodes (10): AuthExperiencePage(), HostelAdminProfilePageContent(), ResidentActivationPageContent, ResidentActivationPageContent(), emptyForm, HostelProfile, LegacyHostelAdminProfilePage(), ProfileData (+2 more)
...
Cohesion: 0.1
Nodes (19): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES (+11 more)

### Community 201 - "Community 201"
Cohesion: 0.1
Nodes (19): AMOUNT_ALIASES, CREDIT_ALIASES, DATE_ALIASES, DEBIT_ALIASES, ESEWA_PARSER, NAME_ALIASES, nonZero(), readMoney() (+11 more)
...
Cohesion: 0.16
Nodes (22): code:typescript ({), code:typescript (interface IServiceProvider {), code:typescript (interface IServiceProvider {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IInquiry {), code:typescript (interface IHostelPageView {), code:typescript (// One per resident, per hostel. Minted lazily on first dash), code:typescript (interface ISubscription {) (+14 more)
...
Cohesion: 0.12
Nodes (13): DEPRECATED_ALIASES, mocks, DEFAULT_WARDEN_PERMISSIONS, DEPRECATED_WARDEN_PERMISSION_KEYS, DeprecatedWardenPermissionKey, objectIdSchema, optionalHostelScopeSchema, permissionsSchema (+5 more)

### Community 221 - "Community 221"
Cohesion: 0.18
Nodes (16): formatNPR(), drawCertificationStamp(), footerLine(), formatDate(), formatLongDate(), MONTHS, ReceiptPdfInput, renderReceiptPdf() (+8 more)

### Community 222 - "Community 222"
Cohesion: 0.2
Nodes (18): dueMeals(), canAnnounceMeal(), MEAL_TIMING_DEFAULTS, MealAnnounceState, mealClosesAtMinute(), mealOpensAtMinute(), MealWindow, nepalDayKey() (+10 more)

### Community 223 - "Community 223"
Cohesion: 0.13
Nodes (20): 0.4 Template structure, 1.0 Signup One-Time Code, 1.1 Email Verification (PUBLIC Signup), 1.2 Hostel Admin Credentials (Post-Approval), 1.3 Warden Credentials, 1.4 Resident QR Activation, 1.5 Guardian Invitation, 1.6 Password Reset (+12 more)

### Community 224 - "Community 224"
Cohesion: 0.18
Nodes (17): addBsMonths(), ExistingCheck, ExistingRow, blankRow(), inputFromRow(), ListSection, listTotals(), monthName() (+9 more)

### Community 225 - "Community 225"
Cohesion: 0.14
Nodes (15): activateResident(), getResidentProfile(), submitResidentReview(), RootStackParamList, Props, ResidentActivationScreen(), styles, Profile (+7 more)
...
Cohesion: 0.15
Nodes (16): isUsableCoordinate(), fetchRoadRoute(), isRecord(), parseRoadRoute(), parseSteps(), ROUTE_MODES, ROUTERS, routeUrl() (+8 more)
...
Cohesion: 0.14
Nodes (14): monthlySeries(), countListingAppearances(), moveOutChecklistSchema, ratingReviewSchema, compare(), countMoveOuts(), getHostelPerformanceReport(), LIVE_STATUSES (+6 more)
...
Cohesion: 0.21
Nodes (19): AuditLog, code:typescript (interface IAuditLog {), code:typescript ({), code:typescript ({), code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({), FoodReadyLog (+11 more)

### Community 237 - "Community 237"
Cohesion: 0.15
Nodes (16): ApiFailure, ApiSuccess, AuthUser, getResidentReferral(), listResidentFood(), ResidentFoodMenu, ResidentFoodPhoto, ResidentFoodRoutine (+8 more)
...
Cohesion: 0.14
Nodes (16): apiRequest(), confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listNotifications(), listResidentComplaints(), markNotificationRead(), NotificationItem (+8 more)
...
Cohesion: 0.2
Nodes (14): NearbyStatus, Coordinates, hasLocationPermission(), hasPromptedForLocation(), LocationOutcome, NavigationFix, readPosition(), readPrecisePosition() (+6 more)
...
Cohesion: 0.16
Nodes (17): Attendance / Night Safety, code:typescript (interface IQRActivation {), code:typescript (interface INightStatusLog {), code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {), Food (+9 more)
...
Cohesion: 0.25
Nodes (16): AttendanceAlert, AttendanceLog, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({), code:typescript (interface IQuestionCallClick {), code:typescript ({) (+8 more)

### Community 275 - "Community 275"
Cohesion: 0.13
Nodes (15): 0.1 The shared Softmato domain, 0.2 Categories — which mailbox a message comes from, 0.2a Where replies go, 0.3 Where the sender is configured, 0.5 The look, 0. Sending Infrastructure, code:block1 (softmato.com), Email Infrastructure (+7 more)
...
Cohesion: 0.22
Nodes (13): Engine, fieldsFrom(), FileScore, GOLDEN_DIR, isNear(), main(), ManifestEntry, paceMs() (+5 more)

### Community 297 - "Community 297"
Cohesion: 0.26
Nodes (12): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, metadata, canAccessWorkspace(), defaultWorkspaceSlug(), isAuthBypassed(), listWorkspaceHostels, previewHostels() (+4 more)
...
Cohesion: 0.26
Nodes (5): Claim, CouldNotCreateFileException, HostelPalikaDownloadsModule, UnreadableSourceException, UnsupportedOnThisAndroidException

### Community 306 - "Community 306"
Cohesion: 0.14
Nodes (11): bhadra(), filter, hostelId, invoiceId, mocks, otherHostelId, principal, residentA (+3 more)
...
Cohesion: 0.18
Nodes (11): CATEGORY_VISUALS, EVENT_VARIANTS, EventVariant, FALLBACK_VISUAL, NOTIFICATION_CATEGORIES, NotificationTone, NotificationVisual, comment (+3 more)
...
Cohesion: 0.19
Nodes (8): ReportExport, columnPositions(), PAGE, renderReportPdf(), ReportPdfInput, sanitize(), columns, many
...
Cohesion: 0.24
Nodes (13): AccountDeletionRequest, code:typescript (interface IAccountDeletionRequest {), code:block43 (packages/db/migrations/), code:typescript ({), code:typescript (interface IAccountDeletionRequest {), code:block46 (packages/db/migrations/), Consent & Privacy, ConsentLog (+5 more)
...
Cohesion: 0.17
Nodes (13): 1.7 Account Upgraded, 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.3 Hostel Rejected, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, 3.3 Payment Proof Uploaded (to Admin), code:typescript ({) (+5 more)

### Community 324 - "Community 324"
Cohesion: 0.18
Nodes (13): 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails, 4.3 Complaint Resolved, code:typescript ({) (+5 more)
...
Cohesion: 0.23
Nodes (10): resetEmailIdentityCache(), coerceSection(), getPublicSiteConfig(), getSiteConfig(), updateSiteConfigSection(), isSiteConfigSection(), getPublicPlatformStats(), PUT() (+2 more)
...
Cohesion: 0.2
Nodes (12): 4.1 New Notice Posted, 4.2 Complaint Status Updated, 4. Resident Activity Emails, 5.1 SOS Triggered, 5. Safety & Emergency Emails, 6.1 Service Provider Registration Received, 6.3 Service Provider Rejected, 6. Service Provider Emails (+4 more)
...
Cohesion: 0.25
Nodes (11): code:typescript (interface INotice {), code:typescript (interface IMoveInChecklistItem {), code:typescript (interface IMoveOutChecklistItem {), code:typescript (interface IMaintenanceRequest {), Complaint, ComplaintUpdate, Move-in / Move-out, MoveInChecklist (+3 more)
...
Cohesion: 0.22
Nodes (7): AuthSession, login(), AppNavigator(), Stack, LoginScreen(), Props, ResidentReferralScreen()
...
Cohesion: 0.27
Nodes (8): HostelRegistrationProgress(), Milestone, milestoneIndex(), MILESTONES, PaymentPanel(), PlanPicker(), rupees(), SubscriptionState

### Community 377 - "Community 377"
Cohesion: 0.27
Nodes (8): listStatementImports(), GET(), assignOrphanSchema, bulkApproveStatementSchema, STATEMENT_PROVIDERS, StatementImportInput, statementImportSchema, statementListQuerySchema
...
Cohesion: 0.39
Nodes (8): deleteGatewayConfig(), listGatewayConfigs(), saveGatewayConfig(), DELETE(), deleteSchema, GET(), PUT(), saveSchema

### Community 402 - "Community 402"
Cohesion: 0.31
Nodes (7): getAttendanceAnalytics(), getFoodAnalytics(), MEAL_TYPES, MealType, normalizeObjectId(), OperationsAnalyticsError, resolveHostelId()
...
Cohesion: 0.29
Nodes (8): 6.2 Service Provider Approved, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 7.1 Attendance Alert (Resident Absent), 7. Attendance & Location Tracking Emails, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({)

### Community 442 - "Community 442"
Cohesion: 0.29
Nodes (8): 7.1 New Hostel Pending Approval (to Superadmin), 7.2 Subscription Expiring Soon, 7. Platform Admin Emails, 8.1 Community Post Engagement (Batched), 8. Community & Notification Emails, code:typescript ({), code:typescript ({), code:typescript ({)
...
Cohesion: 0.29
Nodes (7): 9.1 Account Deletion Requested, 9.1a Account Deletion Request Needs Review *(added 2026-08-02)*, 9.2 Account Deletion Cancelled, 9.3 Location History Deletion Approved, 9. Account & Privacy Emails, code:typescript ({), code:typescript ({)
...
Cohesion: 0.6
Nodes (4): daysUntil(), HostelSubscriptionDueBanner(), rupees(), State
...
Cohesion: 0.5
Nodes (3): HOSTEL_ADMIN_SCREENS, HostelAdminWorkspacePage(), HostelAdminWorkspacePageProps
...
## Knowledge Gaps
- **6434 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+6429 more)
...
- **Why does `cn()` connect `Community 6` to `Community 129`, `Community 3`, `Community 7`, `Community 136`, `Community 9`, `Community 138`, `Community 11`, `Community 398`, `Community 271`, `Community 144`, `Community 20`, `Community 22`, `Community 24`, `Community 156`, `Community 30`, `Community 31`, `Community 34`, `Community 35`, `Community 37`, `Community 49`, `Community 50`, `Community 52`, `Community 56`, `Community 313`, `Community 67`, `Community 71`, `Community 79`, `Community 84`, `Community 86`, `Community 89`, `Community 94`, `Community 95`, `Community 100`, `Community 101`, `Community 118`, `Community 376`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 4` to `Community 0`, `Community 2`, `Community 8`, `Community 265`, `Community 10`, `Community 140`, `Community 12`, `Community 16`, `Community 17`, `Community 145`, `Community 19`, `Community 147`, `Community 402`, `Community 149`, `Community 23`, `Community 152`, `Community 25`, `Community 154`, `Community 155`, `Community 28`, `Community 29`, `Community 27`, `Community 31`, `Community 159`, `Community 34`, `Community 39`, `Community 167`, `Community 297`, `Community 42`, `Community 40`, `Community 44`, `Community 41`, `Community 46`, `Community 438`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 190`, `Community 63`, `Community 64`, `Community 65`, `Community 66`, `Community 192`, `Community 68`, `Community 69`, `Community 70`, `Community 75`, `Community 76`, `Community 77`, `Community 78`, `Community 82`, `Community 88`, `Community 92`, `Community 96`, `Community 97`, `Community 104`, `Community 233`, `Community 106`, `Community 111`, `Community 112`, `Community 113`, `Community 245`, `Community 119`, `Community 120`, `Community 249`, `Community 123`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 3` to `Community 1`, `Community 130`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 11`, `Community 14`, `Community 15`, `Community 18`, `Community 21`, `Community 26`, `Community 32`, `Community 33`, `Community 34`, `Community 36`, `Community 37`, `Community 38`, `Community 48`, `Community 49`, `Community 50`, `Community 55`, `Community 61`, `Community 71`, `Community 73`, `Community 83`, `Community 108`, `Community 121`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Are the 506 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 506 INFERRED edges - model-reasoned connections that need verification._
