...
## Corpus Check
- 1981 files · ~3,617,691 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15995 nodes · 43818 edges · 541 communities (517 shown, 24 thin omitted)
...
## Communities (541 total, 24 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (203): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel() (+195 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (173): ICONS, LABELS, Segment, TONES, FILTERS, Pending, Overview, MoneyData (+165 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (279): deleteResidentLocationHistory(), listResidentComplaints(), sendEmail(), getOpenFeeSchedule(), getResidentFinanceView(), listFoodForResident(), listPublicFoodRoutine(), createPaymentIntent() (+271 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (245): loadOverview(), loadMoney(), loadToday(), loadFinance(), getAdminFoodRoutine(), getAdminHostel(), getAdminInvoices(), getAdminMaintenance() (+237 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (193): Scanner(), CookInviteScreen(), GuardianInviteScreen(), MapScreen(), PreviewCard(), ResultRow(), Assurance(), CallableRow() (+185 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (143): PATCH(), POST(), RouteContext, POST(), POST(), DELETE(), GET(), POST() (+135 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (179): notifyAdminsOfNewComplaint(), notifyResidentOfComplaintStatus(), OPEN_STATUSES, OverdueComplaint, runComplaintSlaCheck(), hostelId, mocks, now (+171 more)
...
Cohesion: 0.02
Nodes (160): adminPrincipal, mocks, PLATFORM_LIMITS, assetId, hostelId, mocks, otherHostelId, principal (+152 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (152): POST(), attacker, attempt(), headers, jsonRequest(), routeMocks, appBaseUrl(), authenticateWithGoogle() (+144 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (121): PlanPaymentClaim, deferLoad(), DemoDataBadge(), Hostel, HostelTable(), Inquiry, LoadState, Message() (+113 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (145): GuardianDashboard, monthStartPeriod(), CATEGORIES, Ledger, OrphanAssignPicker, defaultMonth(), MatrixRow, MatrixTotals (+137 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (131): BrandMark(), BrandWordmark(), WORDMARK, WORDMARK_SEGMENTS, ConfirmOptions, ROWS, PlatformCommunityPageContent, CurrentUser (+123 more)
...
Cohesion: 0.02
Nodes (124): FinanceAuditInput, assetId, body, call, hashCall, hostelId, input, invoiceId (+116 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (134): BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan, Badge(), grabDocument(), HostelAdminBillingPageContent(), InvoiceRow() (+126 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (124): CommunityScreen(), Composer(), CommunityBoard(), CommunityBoardProps, Composer(), SORTS, CommentThread(), CommunityPostCard() (+116 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (95): GET(), POST(), POST(), GET(), POST(), POST(), GET(), POST() (+87 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (111): demoteToPublicAccount(), CapacityError, claimBedForRoomType(), listAllRoomTypes(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary() (+103 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (110): getHostelLedger(), collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES (+102 more)
...
Cohesion: 0.02
Nodes (85): GET(), PATCH(), RouteContext, listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), getPlatformSubscriptionLedger() (+77 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (122): AdminCommunityReportsScreen(), AdminOverviewScreen(), AdminResidentsScreen(), AttendanceScreen(), NightStatusForm(), NightStatusScreen(), FILTERS, NotificationCard() (+114 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (90): POST(), GET(), POST(), getAttendanceConfig(), getAttendanceSettings(), listAttendanceAlerts(), listHostelAttendance(), recordConsent() (+82 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (94): AdminCommunityScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+86 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (107): AdminAlertsScreen(), AdminHomeScreen(), AdminMoneyScreen(), AdminTodayScreen(), AdminAlertsContext, AdminAlertsValue, AlertActions, EMPTY_COUNTS (+99 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (98): ReferralBody(), ReferralRow(), ReviewForm(), ReviewScreen(), DeletionPanel(), NotificationSettings(), SETTINGS_TITLES, THEME_OPTIONS (+90 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (83): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, openCheckoutSession(), readReturnState(), ownerIdentitiesFor(), deliver() (+75 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (86): IdCardPrompt(), Point(), AttachmentRow(), ChipGroup(), FormSection(), PhotoStrip(), RemoveButton(), ReviewRow() (+78 more)
...
Cohesion: 0.03
Nodes (75): summarizeResidentComplaints(), listResidentInvoices(), renderStatementForResident(), releaseGuardianAccounts(), daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess(), GuardianAccessRecord (+67 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (71): cityOptions, createDocument(), createRoom(), DocumentConfig, DraftData, FACILITY_MINI, facilityOptions, FIELD_KEY_STEP (+63 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (70): gregorianSpan(), MonthField, MonthOption(), MonthPicker, PeriodRow, BrowserPushRow(), FILTERS, Notification (+62 more)

### Community 33 - "Community 33"
Cohesion: 0.02
Nodes (50): ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, RETAINED_BY_HOSTEL_ID, both, covered (+42 more)
...
Cohesion: 0.04
Nodes (56): AdminTabs(), HIDDEN, TABS, SosScreen(), TABS, AdminAlertsProvider(), AdminSearchBar(), BottomChrome (+48 more)
...
Cohesion: 0.03
Nodes (57): PATCH(), RouteContext, POST(), applicantSchema, billingCycleSchema, HostelRegistrationInput, hostelRegistrationSchema, registrationFields (+49 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (59): metadata, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails(), RenderedSection (+51 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (74): decodeKey(), decryptPersonalData(), encryptionKey(), encryptPersonalData(), isPersonalDataEncryptionConfigured(), personalLookupHash(), resetPersonalDataKeyCache(), envelope (+66 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (68): money(), PlanCard(), sitemap(), STATIC_ROUTES, pricePlan(), TIER_TONE, listHeadingFor(), PlanCard() (+60 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (71): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), BillableResidentRow, BilledInvoice, BillingCycleInput (+63 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (51): Choice, HOSTEL_TYPE_LABELS, HostelPanel(), MapButton(), MapCanvas, ModeTab(), NavigationPanel(), NOTHING_CHOSEN (+43 more)
...
Cohesion: 0.11
Nodes (44): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), PLATFORM_NAME_PARTS, cookInvitationEmail() (+36 more)

### Community 45 - "Community 45"
Cohesion: 0.03
Nodes (53): HostelAdminAttendancePageContent, HostelAdminCommunityPageContent, HostelAdminComplaintsPage, HostelAdminCooksPanel, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek (+45 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (61): AccountDeletionPanel, ResidentIdSharePage(), SiteAnnouncementBanner(), toneClasses, FALLBACK, SiteConfigContext, SiteConfigProvider(), SiteName() (+53 more)
...
Cohesion: 0.05
Nodes (62): mapped, GATEWAY_ORDER, getHostelPayMethods(), getPayInstructions(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions (+54 more)
...
Cohesion: 0.05
Nodes (58): auditFinanceAction(), previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal (+50 more)
...
Cohesion: 0.05
Nodes (57): DELETE(), POST(), platformPushScheduleSchema, revokeDeviceToken(), campaignBaseSchema, deviceTokenRevokeSchema, deviceTokenSaveSchema, hostelNotificationCampaignSchema (+49 more)
...
Cohesion: 0.04
Nodes (48): attendanceOverrideSchema, complaintCategorySchema, complaintCreateSchema, complaintListQuerySchema, complaintReplySchema, complaintResolutionConfirmSchema, complaintStatusSchema, complaintStatusUpdateSchema (+40 more)

### Community 58 - "Community 58"
Cohesion: 0.05
Nodes (53): PaginationMeta, PaginationQuery, querySchema, notificationCampaignSchema, CampaignListQuery, CampaignRecord, createCampaign(), createHostelNotificationCampaign() (+45 more)
...
Cohesion: 0.06
Nodes (57): BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodOf(), currentBsPeriod() (+49 more)

### Community 62 - "Community 62"
Cohesion: 0.04
Nodes (47): addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery, HostelAdminInquiryStatusInput, InquiryNoteCreateInput, InquiryNoteRecord, InquiryRecord (+39 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (30): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminComplaintsPage(), HostelAdminFoodPage() (+22 more)

### Community 64 - "Community 64"
Cohesion: 0.06
Nodes (51): notifyStaffOfJobProgress(), addHistory(), addMaintenanceComment(), assertBedInHostel(), assertProviderApproved(), assertRoomInHostel(), assertVoiceNoteUsable(), assignMaintenanceProvider() (+43 more)
...
Cohesion: 0.06
Nodes (50): hostelForm(), buildHostelPayload(), capacitySummary(), CITY_OPTIONS, emptyHostelForm(), emptyRoomRow(), FACILITY_OPTIONS, firstIncompleteHostelStep() (+42 more)
...
Cohesion: 0.05
Nodes (47): ProviderDirectoryData, serviceProviderSchema, serviceProviderApplicationSchema, serviceProviderDocumentSchema, DirectoryPageProps, EMPTY, metadata, ServiceProviderDirectoryPage() (+39 more)

### Community 71 - "Community 71"
Cohesion: 0.05
Nodes (40): PlanMark(), RAFTER, RIDGE, PortalDates, useHostelDayTurn(), useMinuteTick(), AdminNightStatusRow, PlanBilling (+32 more)
...
Cohesion: 0.07
Nodes (41): hasGeolocation(), LocationOutcome, NavigationFix, OrientationPermission, requestDeviceLocation(), requestHeadingPermission(), Unsubscribe, watchDeviceHeading() (+33 more)
...
Cohesion: 0.08
Nodes (42): POST(), DELETE(), PATCH(), RouteContext, DELETE(), PATCH(), RouteContext, POST() (+34 more)
...
Cohesion: 0.08
Nodes (39): JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, ProviderJobScreen(), getOwnProvider() (+31 more)
...
Cohesion: 0.07
Nodes (45): AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance(), deadline(), DIGIT_CONFUSABLES, EvidenceRead (+37 more)

### Community 83 - "Community 83"
Cohesion: 0.06
Nodes (36): HostelPhotoReminder(), formatHostelAddress(), hasFood(), hostelTypeToUi(), mapPublicHostelToSummary(), roomTypeLabel(), CATEGORY_LABELS, NEARBY_GROUPS (+28 more)
...
Cohesion: 0.08
Nodes (40): storeOrderSchema, mocks, allocateOrderNumber(), applyStatus(), CancelInput, cancelOrder(), CreateInput, getOrder() (+32 more)
...
Cohesion: 0.06
Nodes (28): currency(), LoadingRows(), StatusBadge(), ResidentActivationPageContent, ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent (+20 more)

### Community 90 - "Community 90"
Cohesion: 0.06
Nodes (38): documents, many, parsed, result, HostelForm, HostelRegisterPayload, buildProviderPayload(), EMPTY_PROVIDER_FORM (+30 more)
...
Cohesion: 0.09
Nodes (38): useIsUploading(), useUploads(), directionOf(), EMPTY_TALLY, floorToStep(), phaseOf(), shouldRepost(), tallyUploads() (+30 more)
...
Cohesion: 0.08
Nodes (37): drawCertificationStamp(), footerLine(), formatDate(), formatLongDate(), MONTHS, ReceiptPdfInput, renderReceiptPdf(), renderStatementPdf() (+29 more)
...
Cohesion: 0.09
Nodes (36): Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity() (+28 more)
...
Cohesion: 0.16
Nodes (29): bsFiscalYear(), documentAdDate(), documentAmount(), documentBsDate(), documentInstant(), drawFooter(), drawIssuer(), drawTaxNote() (+21 more)
...
Cohesion: 0.07
Nodes (32): addBsMonths(), bsPeriodBounds(), bsPeriodsBetween(), periodStartDate(), defaultDueDate(), august, bhadra, dateAgo() (+24 more)
...
Cohesion: 0.1
Nodes (26): robots(), documentUrl(), InvoiceLean, PaymentLean, PlatformInvoiceRow, PlatformPaymentRow, PlatformSubscriptionLedger, FILE_ASSET_KINDS (+18 more)
...
Cohesion: 0.09
Nodes (30): filterPushRecipients(), CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, readId(), activeDevicesFor(), activeTokensFor(), androidChannel() (+22 more)
...
Cohesion: 0.1
Nodes (26): POST(), RouteContext, sponsorSchema, DELETE(), PATCH(), RouteContext, GET(), POST() (+18 more)
...
Cohesion: 0.09
Nodes (27): deleteHostelObjects(), ImageVariantRecord, optimizeImage(), streamToBuffer(), VARIANT_CONFIG, VariantName, deleteFromR2(), getR2Client() (+19 more)
...
Cohesion: 0.07
Nodes (20): EmptyState(), Select(), field(), HostelAdminReferralsPageContent(), ListingFlag, LoadState, MaintenanceRequest, optionalField() (+12 more)
...
Cohesion: 0.15
Nodes (28): assertMatchesExtension(), downloadAndShare(), downloadAndShareCsv(), downloadAndShareImage(), downloadToDevice(), forgetDownloadFolder(), LegacyFileSystem, loadLegacyFileSystem() (+20 more)

### Community 133 - "Community 133"
Cohesion: 0.08
Nodes (20): Complaint, ComplaintSummary, field(), FoodMenu, HostelAdminNoticesPage(), HostelAdminPaymentsPage(), HostelAdminResidentsPage(), LoadState (+12 more)
...
Cohesion: 0.1
Nodes (21): noticeSchema, noticeReadStatusSchema, mocks, noticeInput, residentUserId, staffPrincipal, auditNoticeAction(), broadcastNotice() (+13 more)
...
Cohesion: 0.17
Nodes (21): subscriptionClaimReceivedEmail(), subscriptionClaimRejectedEmail(), formatRupees(), subscriptionInvoiceEmail(), METHOD_LABELS, subscriptionReceiptEmail(), EmailAttachment, hostelRegisteredByTeamEmail() (+13 more)

### Community 139 - "Community 139"
Cohesion: 0.12
Nodes (19): hammingDistance(), isPerceptualNearDuplicate(), distance, readQrPayeeFields(), cleanAccountNumber(), cleanName(), hasQrPayee(), looksLikeName() (+11 more)
...
Cohesion: 0.11
Nodes (21): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), MediaViewerProvider() (+13 more)
...
Cohesion: 0.12
Nodes (27): code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {), code:typescript ({), code:typescript (interface IMoveInChecklistItem {), code:typescript (interface IMoveOutChecklistItem {), code:typescript (interface IServiceProvider {), code:typescript (interface IServiceProvider {), code:typescript (interface IMaintenanceRequest {) (+19 more)
...
Cohesion: 0.09
Nodes (22): aswin, bhadra, bs(), card(), currentId, hostelId, inAswin, inOctober (+14 more)
...
Cohesion: 0.1
Nodes (18): csvField(), field(), numberField(), optionalField(), AddressFields, FORM_SECTIONS, HostelAdminProfilePageContent, PendingPhoto (+10 more)
...
Cohesion: 0.15
Nodes (13): paymentClearedEmail(), paymentDueReminderEmail(), ReminderStage, wording(), paymentOverdueEmail(), paymentRejectedEmail(), paymentReversedEmail(), paymentProofReceivedEmail() (+5 more)
...
Cohesion: 0.14
Nodes (13): AuthGuard(), checkAuthWithRefresh(), isStaleSession(), fetchMock, payload, refreshSessionMock, refreshSession(), resetRoleHealForTests() (+5 more)
...
Cohesion: 0.12
Nodes (14): buildFormPostHandoff(), FormPostHandoff, HandoffError, IntentRecord, formPostIntent, hostelId, intentId, invoiceId (+6 more)
...
Cohesion: 0.16
Nodes (18): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), OpenedCheckout, readSettledReceipt(), SettledReceipt, softmatoDocsUrl(), dueBhadra29 (+10 more)
...
Cohesion: 0.14
Nodes (17): ApiFailure, ApiSuccess, AuthUser, listResidentFood(), listResidentPayments(), ResidentFoodMenu, ResidentFoodPhoto, ResidentFoodRoutine (+9 more)
...
Cohesion: 0.15
Nodes (16): CSV_COLUMNS, GET(), ClickRecord, dayKey(), getQuestionCallAnalytics(), QuestionCallAnalyticsQuery, questionCallBaseUrl(), QuestionCallClickInput (+8 more)
...
Cohesion: 0.15
Nodes (15): registerNightStatusCategory(), claimNotificationSound(), claims, resetNotificationSoundClaims(), createAndroidChannels(), easProjectId(), fetchExpoPushToken(), forgetPushToken() (+7 more)
...
Cohesion: 0.15
Nodes (14): activateResident(), login(), triggerSOS(), RootStackParamList, LoginScreen(), Props, Props, ResidentActivationScreen() (+6 more)
...
Cohesion: 0.14
Nodes (16): InvoiceDocumentInput, InvoicePresentation, documentFileName(), DocumentKind, InvoiceRow, invoiceStatus(), loadIssuer(), methodLabel() (+8 more)

### Community 222 - "Community 222"
Cohesion: 0.15
Nodes (14): GET(), POST(), GET(), POST(), listPlatformAdminInvites(), listPlatformAdmins(), invitableRoleSchema, platformAdminBulkInviteSchema (+6 more)
...
Cohesion: 0.18
Nodes (10): checkoutReturnUrl(), OpenCheckoutInput, openSoftmatoCheckout(), softmato(), SoftmatoNotConfiguredError, isSoftmatoConfigured(), SoftmatoConfig, classify() (+2 more)
...
Cohesion: 0.12
Nodes (14): buildHtml(), boundsCenter(), KATHMANDU, distance, far, input, middle, near (+6 more)
...
Cohesion: 0.24
Nodes (11): nepalDayKey(), isCurrentNight(), isSelfReportable(), NIGHT_STATUS_OPTIONS, nightKey(), nightNote(), NightStanding, SelfReportableStatus (+3 more)
...
Cohesion: 0.2
Nodes (12): 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, 4.3 Complaint Resolved, code:block14 (---), code:typescript ({) (+4 more)
...
Cohesion: 0.2
Nodes (8): AuthSession, getResidentProfile(), AppNavigator(), Stack, ResidentPaymentsScreen(), Profile, Props, ResidentProfileScreen()
...
Cohesion: 0.24
Nodes (11): Attendance / Night Safety, code:typescript (interface INightStatusLog {), code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface INotice {), FoodRoutine, NightStatusLog, Payment (+3 more)

### Community 332 - "Community 332"
Cohesion: 0.2
Nodes (10): 4.1 New Notice Posted, 4.2 Complaint Status Updated, 4. Resident Activity Emails, 5.1 SOS Triggered, 5. Safety & Emergency Emails, code:typescript ({), code:typescript ({), code:typescript ({) (+2 more)
...
Cohesion: 0.31
Nodes (8): GET(), POST(), hostelNames(), listAllOrders(), listOrders(), statusFilter(), storeOrderCreateSchema, storeOrderListQuerySchema
...
Cohesion: 0.43
Nodes (6): amountInWords(), GROUPS, ONES, TENS, underHundred(), underThousand()
...
## Knowledge Gaps
- **5681 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+5676 more)
...
- **Why does `Button()` connect `Community 1` to `Community 0`, `Community 3`, `Community 4`, `Community 7`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 16`, `Community 25`, `Community 26`, `Community 28`, `Community 29`, `Community 32`, `Community 34`, `Community 35`, `Community 166`, `Community 38`, `Community 43`, `Community 45`, `Community 55`, `Community 68`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 100` to `Community 0`, `Community 130`, `Community 5`, `Community 7`, `Community 136`, `Community 9`, `Community 8`, `Community 11`, `Community 13`, `Community 15`, `Community 144`, `Community 19`, `Community 21`, `Community 22`, `Community 24`, `Community 26`, `Community 28`, `Community 286`, `Community 31`, `Community 166`, `Community 41`, `Community 174`, `Community 176`, `Community 177`, `Community 53`, `Community 183`, `Community 59`, `Community 61`, `Community 194`, `Community 67`, `Community 68`, `Community 83`, `Community 217`, `Community 96`, `Community 97`, `Community 103`, `Community 108`, `Community 110`, `Community 254`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 12` to `Community 0`, `Community 1`, `Community 133`, `Community 10`, `Community 11`, `Community 140`, `Community 15`, `Community 144`, `Community 31`, `Community 32`, `Community 36`, `Community 38`, `Community 40`, `Community 297`, `Community 42`, `Community 45`, `Community 46`, `Community 47`, `Community 50`, `Community 51`, `Community 56`, `Community 67`, `Community 71`, `Community 72`, `Community 74`, `Community 83`, `Community 84`, `Community 89`, `Community 246`, `Community 127`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
...
- **What connects `iosUrlScheme`, `{ defineConfig }`, `expoConfig` to the rest of the system?**
  _5681 weakly-connected nodes found - possible documentation gaps or missing edges._
