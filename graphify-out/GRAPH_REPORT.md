...
## Corpus Check
- 2264 files · ~4,065,676 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18297 nodes · 51061 edges · 575 communities (545 shown, 30 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 845 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 720 edges
2. `successResponse()` - 697 edges
...
Cohesion: 0.01
Nodes (302): PATCH(), POST(), RouteContext, PATCH(), RouteContext, POST(), getOrCreateSubscription(), bulkApproveSchema (+294 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (234): PlanPaymentClaim, PayoutAccountForReview, ReviewPayoutAccount(), STATUS_LABEL, DeletionPathway, DeletionStatus, PATHWAY_COPY, CommunityModerationPanel() (+226 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (329): AdminResidentsScreen(), NightStatusHistoryScreen(), NightStatusForm(), StatusCard(), MyBookingsScreen(), NightStatusPromptCard(), NoticeArt(), PlanMark() (+321 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (239): POST(), GET(), POST(), GET(), MESSAGES, POST(), RouteContext, GET() (+231 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (212): LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), csvField(), field(), Hostel, HostelAdminDashboardPageContent() (+204 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (198): AdminCommunityReportsScreen(), FILTERS, Pending, MoneyData, MANAGE_ROWS, PORTAL_ROWS, TodayData, APP_ANSWERS (+190 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (244): GET(), AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput, ConsentInput (+236 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (205): BubbleBackground(), BubbleBackgroundProps, BubbleColors, StarLayer(), StarLayerProps, StarsBackground(), StarsBackgroundProps, BrandWordmark() (+197 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (194): Scanner(), FaqRow(), MethodCard(), CookInviteScreen(), GuardianInviteScreen(), Assurance(), CallableRow(), IdentityCard() (+186 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (187): FILTERS, invalidateFeeds(), NotificationRow(), TILE_GLYPH, TILE_TONES, writeFeedRead(), CommunityScreen(), Composer() (+179 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (162): AdminTabs(), HIDDEN, RoleLayout(), TABS, AdminMoreScreen(), ActivateScreen(), BootGate(), RootShell() (+154 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (159): POST(), POST(), answerSchema, POST(), attacker, attempt(), headers, jsonRequest() (+151 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (159): ReviewForm(), ReviewScreen(), describeGrants(), GuardianRow(), GuardiansScreen(), PermissionSheet(), InviteGuardianScreen(), getAdminLedger() (+151 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (153): PaymentMonthStrip(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard(), AmountCard(), AdminLedger (+145 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (133): listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), getPlatformSubscriptionLedger(), listPlanPaymentClaims(), GET(), DELETE() (+125 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (139): AdminAlertsScreen(), ICONS, LABELS, Segment, TONES, AdminHomeScreen(), AdminOverviewScreen(), loadOverview() (+131 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (107): ATTENDANCE_DEFAULTS, adminPrincipal, mocks, PLATFORM_LIMITS, afterMidnight, evening, meters, mocks (+99 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (115): AdminCommunityScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+107 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (109): CookServiceError, resolveAdminHostelId(), FoodFeedbackInput, FoodFeedbackRecord, FoodMenuCreateInput, FoodMenuListQuery, FoodMenuRecord, FoodMenuUpdateInput (+101 more)

### Community 19 - "Community 19"
Cohesion: 0.07
Nodes (96): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), verificationEmail(), dueWhen(), PlanDueInput, planDueSoonEmail() (+88 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (118): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, notifyHostelOfNewPost(), resolveHostelCommunityUserIds() (+110 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (98): PATCH(), RouteContext, GET(), PATCH(), RouteContext, GET(), paginationQuerySchema, escapeRegex() (+90 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (96): BookingQuote, GuestBookingDetail, GuestBookingSummary, metadata, List(), ReasonAction(), Row(), timeLeft() (+88 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (86): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CancelDeletionPageContent(), AcceptResult, CookInvitePageContent, AcceptResult (+78 more)

### Community 24 - "Community 24"
Cohesion: 0.02
Nodes (98): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, summarizeResidentComplaints(), LedgerInvoice, releaseGuardianAccounts(), daysFromNow() (+90 more)

### Community 25 - "Community 25"
Cohesion: 0.02
Nodes (108): demoteToPublicAccount(), LIVE_STATUSES, LiveResidency, liveResidencyMessage(), LiveRow, notifyResidentRoomChanged(), notifyResidentStatusChanged(), readable() (+100 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (86): ConcessionBackfill, describeApplied(), FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, MonthDiscounts, monthStartPeriod(), Rate (+78 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (101): NightStatusScreen(), ReferralsScreen(), SavedHostelsScreen(), CheckoutScreen(), SORTS, StoreCategoryScreen(), CommunityPostScreen(), NotificationBell() (+93 more)
...
Cohesion: 0.03
Nodes (101): cookPrincipal, mocks, resolveCookLabels(), announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError (+93 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (91): approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal, checker, eventId (+83 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (81): PRIORITIES, STATUS_ACTIONS, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel, GatewayConfig, GatewayHealthStatus, HEALTH_STYLE, HostelAdminPaymentGatewaysPageContent (+73 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (98): BookingEndCause, HostelBookingClosedCause, announceConfirmed(), announceEnding(), assertAwaitingAnswer(), cancelBookingByHostel(), cancelBookingByPlatform(), cancelMyBooking() (+90 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (88): collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor() (+80 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (87): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), methodProvider(), PROVIDER_LABEL, QrPanel() (+79 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (77): auditFinanceAction(), FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), base, entityId, hostelId, mocks (+69 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (86): Offset, PhotoCropper(), CollectionQrField(), FileUploadArea(), PhotoStrip(), downloadCaption(), DownloadRow, DownloadStack() (+78 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (61): GenericPortalScreen(), portalRows(), portalTitle(), hasFood(), LoadState, PublicHostelListingPageContent(), PublicInquiryPage(), PublicInquiryPageContent() (+53 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (90): BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodBounds(), bsPeriodOf() (+82 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (82): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, aswin, bhadra (+74 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (82): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt, documentUrl() (+74 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (76): HostelRef, notifyHostelOfInquiry(), notifyPlatformOfPendingHostel(), PLATFORM_ROLES, deviceTokenSchema, notificationSchema, input, mocks (+68 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (63): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, secretsMatch(), ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS (+55 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (62): BookButton(), SIZE, BookingAvailabilityView, BookingButton, CLOSED_REASONS, open, HostelSuggestions(), PublicComparePage() (+54 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (70): GATEWAY_ORDER, getHostelPayMethods(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice() (+62 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (62): hostelPeriodOf(), existingResidentListSchema, existingResidentRowSchema, BillPreview, CheckContext, CheckedRow, checkExistingResidents(), CheckResult (+54 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (65): InquiryFields(), IdCardScreen(), InquiryStatus, listManagedInquiries(), ManagedInquiry, setInquiryStatus(), assertMatchesExtension(), beginDownload() (+57 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (70): formatPeriodKey(), cellAt(), focusCell(), Props, defaultDueDate(), DeliveryWindowFields(), number(), text() (+62 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (66): NotificationCard(), ProfileScreen(), ReferralRow(), CheckoutStatusScreen(), AttachmentGallery(), DAY_LABELS, DayStrip(), MEAL_ICONS (+58 more)

### Community 49 - "Community 49"
Cohesion: 0.06
Nodes (52): POST(), POST(), POST(), runPlanDueReminders(), sweepBookings(), POST(), POST(), POST() (+44 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (62): isCurrentNight(), isSelfReportable(), NIGHT_STATUS_OPTIONS, nightKey(), nightNote(), NightStanding, SelfReportableStatus, NIGHT_OF_17TH (+54 more)
...
Cohesion: 0.06
Nodes (53): metadata, AccountDeletionPanel, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails() (+45 more)

### Community 53 - "Community 53"
Cohesion: 0.03
Nodes (42): ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, RETAINED_BY_HOSTEL_ID, both, covered (+34 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (27): PlatformConfigAnnouncementsPageContent, PlatformConfigContentPageContent, PlatformConfigFacilitiesPageContent, FLAGS, PlatformConfigFeaturesPageContent, PlatformConfigLegalPageContent, PlatformConfigLocationsPageContent, PlatformConfigPlanServicePageContent (+19 more)

### Community 55 - "Community 55"
Cohesion: 0.08
Nodes (60): BOOKING_DOCUMENT_KINDS, BookingDocumentInput, BookingDocumentKind, bookingDocumentLayout(), refundPolicyNotes(), renderBookingDocument(), bookingDocumentAttachment(), BookingDocumentScope (+52 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (47): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, AuthShell(), AuthShellProps, PANEL_COPY (+39 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (54): RouteContext, addHistory(), addMaintenanceComment(), assertBedInHostel(), assertProviderApproved(), assertRoomInHostel(), assertVoiceNoteUsable(), assignMaintenanceProvider() (+46 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (55): inquirySchema, referralSchema, referralCodeSchema, referralRewardSchema, activeCode, codeId, hostelId, joinedResidentId (+47 more)

### Community 59 - "Community 59"
Cohesion: 0.05
Nodes (57): CardBooking, checkInBooking(), findCardBooking(), findHeldBooking(), returnHeldBed(), takeHeldBed(), account, answerBy (+49 more)

### Community 60 - "Community 60"
Cohesion: 0.04
Nodes (50): POST(), feeUpdateSchema, PATCH(), setResidentMonthlyFee(), dayOfWeekSchema, foodFeedbackSchema, foodMenuCreateSchema, foodMenuListQuerySchema (+42 more)

### Community 61 - "Community 61"
Cohesion: 0.05
Nodes (63): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES (+55 more)
...
Cohesion: 0.05
Nodes (55): ComplaintDetail(), ComplaintDetailScreen(), ComplaintCard(), ComplaintsScreen(), needsResident(), OPEN_STATUSES, rank(), CategoryTile() (+47 more)
...
Cohesion: 0.05
Nodes (55): DocumentCard(), isPdfReceipt(), PdfPreview(), ReceiptPreview(), AttachedFile(), AttachFailure, DocumentPickerModule, Dropzone() (+47 more)
...
Cohesion: 0.06
Nodes (54): otpCodeEmail(), deliver(), Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity, EmailIdentityResolver (+46 more)

### Community 69 - "Community 69"
Cohesion: 0.05
Nodes (55): bookingFacts(), hostelBookingsPath(), assertSuperadmin(), Destination, loadTransfer(), loadTransferProof(), markTransferSent(), PayoutAccountRow (+47 more)

### Community 70 - "Community 70"
Cohesion: 0.05
Nodes (55): BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan, BillingSkip (+47 more)

### Community 71 - "Community 71"
Cohesion: 0.05
Nodes (43): EMPTY_DRAFT, HostelAdminPaymentProfilePageContent, PaymentProfile, SECTION_FIELDS, SectionId, BankMark(), EsewaMark(), KhaltiMark() (+35 more)

### Community 72 - "Community 72"
Cohesion: 0.04
Nodes (44): CookAccount, Credentials, HostelAdminCooksPanel, Issued, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek (+36 more)
...
Cohesion: 0.06
Nodes (51): platformPushScheduleSchema, announceChange(), audit(), CreateInput, createNoticePush(), DEFAULT_PUSHES, deleteNoticePush(), emitNoticePush() (+43 more)

### Community 75 - "Community 75"
Cohesion: 0.08
Nodes (46): generateMetadata(), manifest(), notFound(), CityHostelsPage(), generateMetadata(), PageParams, JsonLd(), JsonLdData (+38 more)

### Community 76 - "Community 76"
Cohesion: 0.04
Nodes (48): Faq, PlatformConfigSeoPageContent, Step, CONTENT_ICON_SLUGS, everything, IDENTITY, page, rendered (+40 more)

### Community 77 - "Community 77"
Cohesion: 0.08
Nodes (42): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), systemDocumentKindFromText(), distance (+34 more)

### Community 78 - "Community 78"
Cohesion: 0.06
Nodes (45): filterPushRecipients(), CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, isPlanDueNotification(), readId(), activeDevicesFor(), activeTokensFor() (+37 more)

### Community 79 - "Community 79"
Cohesion: 0.08
Nodes (51): getPresignedReadUrl(), userResidentProfileSchema, findLiveResidency(), LEGACY_ROLE_MAP, Role, ROLE_VALUES, CARD_LABELS, formatIssuedOn() (+43 more)
...
Cohesion: 0.07
Nodes (47): cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath(), hasArrived(), headingDifference(), instructionFor() (+39 more)

### Community 82 - "Community 82"
Cohesion: 0.07
Nodes (52): directionFlags(), evidenceFlags(), payeeFlags(), AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance() (+44 more)

### Community 83 - "Community 83"
Cohesion: 0.07
Nodes (50): fill(), money(), PlanCard(), PricingScreen(), pricePlan(), PlanPicker(), BillingToggle(), listHeadingFor() (+42 more)
...
Cohesion: 0.06
Nodes (42): DetailsCard(), InvoiceDetailScreen(), InvoiceHeaderBlock(), LedgerCard(), chargeDescriptions(), filterInvoices(), groupInvoicesByYear(), invoiceLedger() (+34 more)

### Community 86 - "Community 86"
Cohesion: 0.07
Nodes (40): Entry, hostelEntries(), locationEntries(), sitemap(), STATIC_ROUTES, listPublishedHostelSlugs(), buildCityIndex(), CityIndexEntry (+32 more)
...
Cohesion: 0.06
Nodes (38): GET(), POST(), GET(), querySchema, assertTeamRegistrationIsNew(), checkTeamOwnerEmail(), findHostelUsingEmail(), hostelNameKey() (+30 more)

### Community 89 - "Community 89"
Cohesion: 0.06
Nodes (38): buildIdCardData(), EMAIL_CHECK_HINTS, EmailCheck, Field(), FIELD_LABELS, formatCardDate(), IdCardPanel(), identityDraftKey() (+30 more)
...
Cohesion: 0.06
Nodes (37): CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS, CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, MOCK_HOSTELS (+29 more)
...
Cohesion: 0.07
Nodes (36): DELETE(), POST(), createPlatformNotificationCampaign(), revokeDeviceToken(), saveDeviceToken(), campaignBaseSchema, deviceTokenRevokeSchema, deviceTokenSaveSchema (+28 more)
...
Cohesion: 0.08
Nodes (36): PublicServiceDetailPage(), loadSiteConfig, loadSiteName(), getListingTier(), getPlan(), getService(), getServiceModule(), listingTiers() (+28 more)
...
Cohesion: 0.06
Nodes (36): qrActivationSchema, before, expiresAt, mocks, staffPrincipal, activateResident(), ActivationCodeGenerateInput, ActivationCodeInput (+28 more)
...
Cohesion: 0.06
Nodes (39): addBsMonths(), august, bhadra, dateAgo(), hostelId, invoice(), mocks, NOW (+31 more)

### Community 101 - "Community 101"
Cohesion: 0.07
Nodes (36): bsMonthStart(), hostelCalendarDay(), hostelToday(), discountRent(), hostelCalendarDay(), hostelMonthStart(), hostelToday(), once (+28 more)
...
Cohesion: 0.07
Nodes (27): BrowseParams, BUDGET_BANDS, FilterSheet(), HostelBrowser(), HostelBrowserProps, NearestToggle(), ViewSwitch(), ComparedHostel (+19 more)
...
Cohesion: 0.07
Nodes (28): geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), geocodeAddress(), geocodeWithGoogle(), geocodeWithNominatim(), HostelGeoLocation (+20 more)

### Community 106 - "Community 106"
Cohesion: 0.08
Nodes (34): mergeBookingConfig(), GET(), POST(), PLATFORM_SETTING_CHANGE_STATUSES, platformSettingChangeSchema, GET(), PUT(), saveOperationsConfig() (+26 more)
...
Cohesion: 0.07
Nodes (34): AuthLayout(), metadata, url, view, brandedTitle(), clamp(), ogImagePath(), ogSignature() (+26 more)
...
Cohesion: 0.08
Nodes (25): applyWebhook(), WebhookResult, softmato(), SoftmatoNotConfiguredError, SoftmatoConfig, softmatoWebhookSecret(), ensureSoftmatoInvoice(), formatPaisa() (+17 more)

### Community 113 - "Community 113"
Cohesion: 0.06
Nodes (33): approveClaim(), assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck(), evidenceCheck(), fileCheck() (+25 more)

### Community 114 - "Community 114"
Cohesion: 0.08
Nodes (30): DEPRECATED_ALIASES, mocks, auditWardenAction(), createHostelWarden(), deactivateHostelWarden(), findScopedWarden(), HostelMemberRecord, hydrateUser() (+22 more)
...
Cohesion: 0.08
Nodes (29): CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES, avatarTone() (+21 more)

### Community 118 - "Community 118"
Cohesion: 0.1
Nodes (32): CsvTable, gridFromCsv(), peekHeaders(), readCsv(), stripBom(), stripPreamble(), ESEWA_CSV_PARSER, both (+24 more)
...
Cohesion: 0.08
Nodes (32): NearbyStatus, boundsCenter(), Coordinates, haversineMeters(), hostelCoordinates(), HostelWithDistance, isUsableCoordinate(), KATHMANDU (+24 more)

### Community 121 - "Community 121"
Cohesion: 0.09
Nodes (25): TIER_TONE, EASE, PlanCards(), PlanLine(), PlansClosingCta(), PlansEditor, PlansFootnote(), PlansHeading() (+17 more)

### Community 122 - "Community 122"
Cohesion: 0.11
Nodes (34): CHANNELS, ClaimedStep, composeEmail(), composeNotice(), composePlanDueNotice(), deliverEmail(), deliverStep(), HostelRow (+26 more)
...
Cohesion: 0.08
Nodes (31): cookAccountSchema, acceptPlatformAdminInvitation(), AcceptPlatformAdminInvitationInput, appUrl(), checkPlatformAdminEmail(), daysFromNow(), EmailAvailability, EmailAvailabilityResult (+23 more)

### Community 125 - "Community 125"
Cohesion: 0.11
Nodes (33): storeCategorySchema, storeProductSchema, categoriesFor(), escapeRegex(), getStoreHome(), getStoreProduct(), getStoreShelves(), ListQuery (+25 more)

### Community 126 - "Community 126"
Cohesion: 0.1
Nodes (33): storeOrderSchema, mocks, allocateOrderNumber(), applyStatus(), CancelInput, cancelOrder(), CreateInput, getOrder() (+25 more)
...
Cohesion: 0.12
Nodes (30): PreviewCard(), ResultRow(), FACILITY_ICONS, facilityIcon(), facilityKey(), HostelCard(), SaveButton(), HostelShowcase() (+22 more)
...
Cohesion: 0.12
Nodes (28): native, NativeDownloads, openDownloaded(), openSavedFile(), SavedDownload, NativeNightPrompt, takeNativePendingAnswers(), isNightStatusPrompt() (+20 more)

### Community 133 - "Community 133"
Cohesion: 0.06
Nodes (30): nextPlanDueStep(), PlanReminderSent, ALL, base, decide(), early, edited, hostelId (+22 more)
...
Cohesion: 0.08
Nodes (23): PortalShell(), metadata, navItems, metadata, navItems, GUARDIAN_NAV, GUARDIAN_SEARCH_ENTRIES, HOSTEL_ADMIN_NAV (+15 more)
...
Cohesion: 0.1
Nodes (27): Choice, Compass(), maneuverIcon(), MapButton(), MapScreen(), ModeTab(), NavCard(), NOTHING_CHOSEN (+19 more)

### Community 141 - "Community 141"
Cohesion: 0.07
Nodes (30): ESEWA_PARSER, [first], FIXTURES, fromCsv, fromWorkbook, parse(), parseText(), read() (+22 more)
...
Cohesion: 0.12
Nodes (27): UploadCard(), UploadToaster(), useIsUploading(), useUploads(), dismissUpload(), emit(), listeners, pruneUploads() (+19 more)
...
Cohesion: 0.11
Nodes (25): InquiryLinkScreen(), ReferralBody(), Referral, ReferralCode, ReferralReward, ReferralStatus, ReferralSummary, RewardStatus (+17 more)
...
Cohesion: 0.11
Nodes (18): blankRow(), Row, TeamInviteBox(), MemberActions(), Props, TeamMembersTable(), InviteResult, Member (+10 more)
...
Cohesion: 0.09
Nodes (26): findOrphanClaims(), loadMatchContext(), StatementRow, ApprovedNotInStatementRow, approveMatchedRows(), approverNamesFor(), ClaimedNoTransactionRow, getReconciliation() (+18 more)
...
Cohesion: 0.12
Nodes (23): softmatoDocsUrl(), dueBhadra29, filed, throughAswin25, BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan (+15 more)
...
Cohesion: 0.09
Nodes (21): statementImportSchema, StatementBytes, StatementProvider, importStatement(), loadStatementAsset(), periodOf(), readStatementBytes(), readStatementText() (+13 more)
...
Cohesion: 0.19
Nodes (19): allowed(), bookingDocumentResponse(), resolveBookingDocument(), HostelScope, ResolvedDocument, resolveInvoiceDocument(), resolveReceiptDocument(), scopeFilter() (+11 more)
...
Cohesion: 0.11
Nodes (22): ApiFailure, ApiSuccess, AuthUser, getResidentNightStatus(), getResidentReferral(), listResidentFood(), ResidentFoodMenu, ResidentFoodPhoto (+14 more)
...
Cohesion: 0.09
Nodes (19): BOOKING_STATUSES, bookingSchema, cancelStepSchema, isOpenBookingStatus(), OPEN_BOOKING_STATUSES, reminderSentSchema, sealedSchema, settledRupees (+11 more)
...
Cohesion: 0.12
Nodes (18): classifyCredit(), CreditClassification, LadderClaim, LadderInvoice, MatchContext, normalizeTxnId(), ANITA_CODE, claims (+10 more)

### Community 196 - "Community 196"
Cohesion: 0.14
Nodes (16): DeliveryPromise, formatHour(), DEFAULT_STORE_CONFIG, PlatformSettingRecord, StoreConfig, storeConfigSchema, CartTotals, clampQuantity() (+8 more)
...
Cohesion: 0.14
Nodes (15): platformAdminInviteSchema, sessionSchema, deleteTeamMember(), endSessions(), findMember(), MemberRecord, reinstateTeamMember(), removeTeamMember() (+7 more)
...
Cohesion: 0.13
Nodes (16): AdminNightStatusRow, filterRollCall(), NightStatusValue, OVERRIDE_OPTIONS, ROLL_CALL_SEGMENTS, rollCallCounts(), RollCallSegment, rollCallTone() (+8 more)
...
Cohesion: 0.13
Nodes (15): HostelMap(), Marker, PlaceMarker, groupNearbyPlaces(), humanizeNearbyType(), NEARBY_GLYPHS, NEARBY_GROUPS, NEARBY_ICONS (+7 more)
...
Cohesion: 0.15
Nodes (16): fetchRoadRoute(), isRecord(), parseRoadRoute(), parseSteps(), RoadRoute, ROUTE_MODES, ROUTERS, routeUrl() (+8 more)
...
Cohesion: 0.15
Nodes (13): activateResident(), AuthSession, triggerSOS(), AppNavigator(), RootStackParamList, Stack, LoginScreen(), Props (+5 more)
...
Cohesion: 0.25
Nodes (14): robots(), absoluteUrl(), HostelJsonLdInput, JsonLd, LINE_SEPARATOR, organizationId(), organizationJsonLd(), PARAGRAPH_SEPARATOR (+6 more)

### Community 246 - "Community 246"
Cohesion: 0.18
Nodes (10): CITY_VISUALS, DEFAULT_CITY_VISUAL, OwnerCallout(), SeoChip(), SeoCrumbs(), SeoFaq(), SoftmatoCredit(), SoftwarePage() (+2 more)
...
Cohesion: 0.12
Nodes (15): deliverySchema, linkUrl, paisa, platformStoreOrderListQuerySchema, productImage, slug, storeCartItemUpdateSchema, storeCategoryCreateSchema (+7 more)
...
Cohesion: 0.18
Nodes (11): GET(), POST(), listFeeSchedules(), feeScheduleListQuerySchema, deleteRentConcession(), listRentConcessions(), RentConcessionRecord, RentConcessionRow (+3 more)

### Community 275 - "Community 275"
Cohesion: 0.18
Nodes (11): GET(), POST(), noticePushCreateSchema, noticePushFields, noticePushListQuerySchema, noticePushScopeSchema, noticePushUpdateSchema, objectIdSchema (+3 more)
...
Cohesion: 0.14
Nodes (15): 1.2 Hostel Admin Credentials (Post-Approval), 1.5 Guardian Invitation, 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.3 Hostel Rejected, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, 3.3 Payment Proof Uploaded (to Admin) (+7 more)
...
Cohesion: 0.15
Nodes (13): ContentSection, EMPTY_PAGE, FALLBACK_SITE_CONFIG, getSiteConfig(), SiteConfigResponse, SiteContent, SiteFeatures, SiteLegal (+5 more)
...
Cohesion: 0.18
Nodes (10): getResidentProfile(), submitResidentReview(), OtpVerificationScreen(), Props, Profile, Props, ResidentProfileScreen(), Props (+2 more)
...
Cohesion: 0.23
Nodes (10): claimSecret(), issueDocumentClaimToken(), isValidDocumentClaimToken(), RegistrationDocumentError, SubmittedDocument, GET(), isAssignedProvider(), resolveVariantKey() (+2 more)
...
Cohesion: 0.29
Nodes (13): AttendanceAlert, AttendanceLog, code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({), code:typescript ({), FoodReadyLog, Location Tracking & Auto-Attendance (+5 more)
...
Cohesion: 0.18
Nodes (12): apiRequest(), confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listResidentComplaints(), login(), refreshSession(), register() (+4 more)
...
Cohesion: 0.27
Nodes (10): canTransitionStoreOrder(), isTerminalStoreOrderStatus(), nextStoreOrderStatuses(), OPEN_STORE_ORDER_STATUSES, STORE_ORDER_STATUS_LABEL, STORE_ORDER_STATUSES, StoreOrderStatus, nonTerminal (+2 more)
...
Cohesion: 0.47
Nodes (6): formatNpr(), itemsTable(), StoreEmailItem, storeOrderPlacedBuyerEmail(), storeOrderReceivedPlatformEmail(), storeOrderStatusBuyerEmail()
...
Cohesion: 0.4
Nodes (10): code:typescript ({), code:typescript ({), code:typescript ({), code:typescript (interface IQuestionCallClick {), code:typescript ({), Community Feature, CommunityComment, CommunityPost (+2 more)
...
## Knowledge Gaps
- **6416 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+6411 more)
...
- **Why does `cn()` connect `Community 7` to `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 136`, `Community 265`, `Community 138`, `Community 145`, `Community 146`, `Community 22`, `Community 23`, `Community 154`, `Community 26`, `Community 28`, `Community 162`, `Community 36`, `Community 165`, `Community 37`, `Community 43`, `Community 47`, `Community 306`, `Community 52`, `Community 54`, `Community 56`, `Community 62`, `Community 72`, `Community 83`, `Community 84`, `Community 89`, `Community 92`, `Community 99`, `Community 117`, `Community 246`, `Community 121`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 5` to `Community 1`, `Community 2`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 140`, `Community 12`, `Community 13`, `Community 15`, `Community 23`, `Community 26`, `Community 27`, `Community 34`, `Community 46`, `Community 48`, `Community 52`, `Community 308`, `Community 63`, `Community 65`, `Community 72`, `Community 80`, `Community 103`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 6` to `Community 0`, `Community 3`, `Community 134`, `Community 391`, `Community 11`, `Community 14`, `Community 16`, `Community 274`, `Community 18`, `Community 20`, `Community 21`, `Community 24`, `Community 153`, `Community 25`, `Community 157`, `Community 30`, `Community 29`, `Community 32`, `Community 33`, `Community 158`, `Community 35`, `Community 165`, `Community 166`, `Community 39`, `Community 40`, `Community 38`, `Community 42`, `Community 171`, `Community 44`, `Community 167`, `Community 41`, `Community 173`, `Community 45`, `Community 49`, `Community 50`, `Community 53`, `Community 181`, `Community 55`, `Community 57`, `Community 58`, `Community 59`, `Community 64`, `Community 195`, `Community 67`, `Community 69`, `Community 70`, `Community 196`, `Community 74`, `Community 203`, `Community 204`, `Community 78`, `Community 79`, `Community 86`, `Community 88`, `Community 345`, `Community 90`, `Community 93`, `Community 94`, `Community 96`, `Community 97`, `Community 98`, `Community 101`, `Community 105`, `Community 106`, `Community 112`, `Community 113`, `Community 114`, `Community 247`, `Community 122`, `Community 124`, `Community 125`, `Community 126`?**
...
- **What connects `iosUrlScheme`, `{ defineConfig }`, `expoConfig` to the rest of the system?**
  _6416 weakly-connected nodes found - possible documentation gaps or missing edges._