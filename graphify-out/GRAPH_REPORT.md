...
## Corpus Check
- 1976 files · ~3,612,582 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15943 nodes · 43692 edges · 544 communities (517 shown, 27 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 699 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 638 edges
2. `successResponse()` - 619 edges
3. `connectToDatabase()` - 439 edges
...
## Communities (544 total, 27 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (315): loadOverview(), loadMoney(), loadToday(), loadFinance(), DeletionRequest, DeletionStatus, getDeletionStatus(), requestAccountDeletion() (+307 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (211): MANAGE_ROWS, PORTAL_ROWS, TodayData, Person, ProfileScreen(), AdminRollCallCard(), DAY_LABELS, DayStrip() (+203 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (235): PATCH(), PATCH(), RouteContext, POST(), getOrCreateSubscription(), selectPlan(), POST(), getOpenFeeSchedule() (+227 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (208): Scanner(), FaqRow(), MethodCard(), CookInviteScreen(), GuardianInviteScreen(), Choice, Compass(), MapButton() (+200 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (158): PlanPaymentClaim, csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, HostelTable(), Inquiry (+150 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (214): auditFinanceAction(), FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), voidInvoice(), approveCashPayment(), cashThresholdFor(), RecordCashInput (+206 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (150): FILTERS, Pending, APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), SETTINGS_TITLES, THEME_OPTIONS (+142 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (135): GET(), POST(), GET(), attendanceAlertResolveSchema, attendanceListQuerySchema, attendanceOverrideSchema, consentSchema, locationPingSchema (+127 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (142): Overview, SosScreen(), HOSTEL, MONTHS, UiPreview(), TABS, ACTION_TONES, AdminHomeHeader() (+134 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (160): demoteToPublicAccount(), base, entityId, hostelId, mocks, principal, write(), assetId (+152 more)
...
Cohesion: 0.03
Nodes (149): POST(), attacker, attempt(), headers, jsonRequest(), routeMocks, appBaseUrl(), authenticateWithGoogle() (+141 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (165): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, dayKey(), overrideAttendance(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintStatus() (+157 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (142): BrandMark(), CommunityReportDialog(), REASONS, ConfirmOptions, Resolver, Notification, LedgerMonth, LedgerPayment (+134 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (131): PATCH(), POST(), RouteContext, GET(), GET(), POST(), POST(), POST() (+123 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (132): summarizeResidentComplaints(), listResidentInvoices(), outstandingForResident(), accessId, accessQuery, adminPrincipal, codes, guardianId (+124 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (151): BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan, Badge(), grabDocument(), HostelAdminBillingPageContent(), InvoiceRow() (+143 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (126): FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, monthStartPeriod(), Rate, RoomTypeOption, gregorianSpan(), MonthField (+118 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (116): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), subscriptionClaimReceivedEmail(), subscriptionClaimRejectedEmail() (+108 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (133): cookPrincipal, mocks, resolveCookLabels(), CookServiceError, resolveAdminHostelId(), announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord (+125 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (131): PaymentMonthStrip(), ManageRatesScreen(), ClearFilters(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard() (+123 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (119): addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery, HostelAdminInquiryStatusInput, InquiryNoteCreateInput, InquiryNoteRecord, InquiryRecord (+111 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (116): FILTERS, NotificationCard(), NotificationRow(), NotificationsScreen(), TILE_GLYPH, TILE_TONES, CommunityScreen(), Composer() (+108 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (119): platformSettingSchema, storeCartSchema, storeCategorySchema, storeOrderSchema, storeProductSchema, revokeDeviceToken(), connectToDatabase(), AddInput (+111 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (104): AdminMoreScreen(), ActivateScreen(), BootGate(), RootShell(), ApplyBlock(), ServiceProvidersScreen(), SettingsScreen(), LoginScreen() (+96 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (106): HostelAdminAttendancePageContent, HostelAdminCommunityPageContent, HostelAdminComplaintsPage, HostelAdminFeePlansPageContent, HostelAdminInquiriesPageContent, HostelAdminMaintenancePageContent, PRIORITIES, STATUS_ACTIONS (+98 more)

### Community 26 - "Community 26"
Cohesion: 0.02
Nodes (88): AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, ownerIdentitiesFor(), getResidentLedger(), monthsBetween() (+80 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (96): Choice, HOSTEL_TYPE_LABELS, MapButton(), MapCanvas, ModeTab(), NavigationPanel(), NOTHING_CHOSEN, PublicMapPage() (+88 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (100): SORTS, StoreCategoryScreen(), AdminNightStatusRow, filterRollCall(), NightStatusValue, OVERRIDE_OPTIONS, ROLL_CALL_SEGMENTS, rollCallCounts() (+92 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (102): getHostelLedger(), HostelLedger, HostelLedgerEntry, InvoiceMatrix, InvoiceMatrixRow, NotBilled, PortalInvoice, ResidentFinanceView (+94 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (95): escapeRegex(), notifyProviderOfAssignment(), notifyProviderOfMaintenanceNote(), notifyProviderOfStatusChange(), notifyStaffOfJobProgress(), notifyStaffOfNewMaintenanceRequest(), providerUserId(), readableCategory() (+87 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (95): AdminAlertsScreen(), ICONS, LABELS, Segment, TONES, AdminHomeScreen(), AdminOverviewScreen(), AdminTabs() (+87 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (79): POST(), GET(), POST(), attendanceSettingsSchema, POST(), RouteContext, DELETE(), GET() (+71 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (87): authorUserId, mocks, postId, residentId, residentPrincipal, staffPrincipal, authorUserId, leanResult() (+79 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (88): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), methodProvider(), PROVIDER_LABEL, QrPanel() (+80 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (83): AdminCommunityScreen(), AdminCommunityReportsScreen(), AdminResidentsScreen(), AttendanceScreen(), NightStatusForm(), NightStatusScreen(), ReferralsScreen(), DeletionPanel() (+75 more)
...
Cohesion: 0.05
Nodes (59): GenericPortalScreen(), portalRows(), portalTitle(), CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS, CITY_OPTIONS (+51 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (60): PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), getPlatformSubscriptionLedger(), listPlanPaymentClaims(), GET(), communityHideSchema, complaintCategorySchema (+52 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (78): logger, CampaignListQuery, CampaignRecord, createCampaign(), createHostelNotificationCampaign(), createPlatformNotificationCampaign(), dispatchCampaign(), dispatchDueCampaigns() (+70 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (56): RouteContext, POST(), RouteContext, GET(), PATCH(), RouteContext, publicHostelCompareQuerySchema, GET() (+48 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (75): ReviewForm(), ReviewScreen(), describeGrants(), GuardianRow(), PermissionSheet(), InviteGuardianScreen(), inviteGuardian(), listGuardians() (+67 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (73): Accordion(), BLOOD_OPTIONS, BUDGET_CHIPS, ContactStep(), continueLabel(), DatePickerField(), DIET_CHIPS, DIET_LABELS (+65 more)

### Community 43 - "Community 43"
Cohesion: 0.03
Nodes (57): Complaint, ComplaintSummary, currency(), EmptyState(), field(), FoodMenu, Input(), LoadingRows() (+49 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (47): POST(), POST(), POST(), POST(), POST(), periodOf(), runBillingCycleForAllHostels(), POST() (+39 more)

### Community 45 - "Community 45"
Cohesion: 0.06
Nodes (60): GET(), resolvePastedLink(), searchCandidates(), geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), lookupLocation() (+52 more)
...
Cohesion: 0.05
Nodes (31): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminComplaintsPage(), HostelAdminFoodPage(), HostelAdminNoticesPage() (+23 more)
...
Cohesion: 0.06
Nodes (39): ComparePage(), hostels, metadata, rows, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), PlatformDashboardPageContent(), PlatformHostelReviewPageContent() (+31 more)

### Community 54 - "Community 54"
Cohesion: 0.07
Nodes (58): documentFlags(), evidenceFlags(), directionRefusal(), outcomeRefusal(), AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts (+50 more)
...
Cohesion: 0.05
Nodes (36): POST(), RouteContext, DEFAULT_GUARDIAN_PERMISSIONS, guardianAccessCreateSchema, guardianInvitationAcceptSchema, guardianInviteSchema, guardianLoginSchema, guardianPermissionsSchema (+28 more)
...
Cohesion: 0.06
Nodes (44): CSV_COLUMNS, GET(), POST(), RouteContext, POST(), safeEqual(), sponsorSchema, ClickRecord (+36 more)

### Community 59 - "Community 59"
Cohesion: 0.07
Nodes (39): ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails(), RenderedSection, LegalBody() (+31 more)

### Community 60 - "Community 60"
Cohesion: 0.08
Nodes (43): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), distance, SystemDocumentKind, deleteHostelObjects() (+35 more)

### Community 61 - "Community 61"
Cohesion: 0.06
Nodes (37): HostelSuggestions(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, PublicHostel, checkOnly(), EMPTY_PREFILL (+29 more)

### Community 62 - "Community 62"
Cohesion: 0.05
Nodes (31): fill(), PricingScreen(), PlanPicker(), BillingToggle(), EASE, PlanCards(), PlanLine(), PlansClosingCta() (+23 more)
...
Cohesion: 0.07
Nodes (48): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodBounds() (+40 more)
...
Cohesion: 0.09
Nodes (39): JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, ProviderJobScreen(), listProviderJobs() (+31 more)

### Community 68 - "Community 68"
Cohesion: 0.09
Nodes (44): documentDownloadUrl(), issueInvoiceDocument(), openCheckoutSession(), readSettledReceipt(), deliver(), loadInvoiceById(), loadProof(), PlanPaymentInstructions (+36 more)

### Community 69 - "Community 69"
Cohesion: 0.06
Nodes (39): qrActivationSchema, residentSchema, before, expiresAt, mocks, staffPrincipal, activateResident(), ActivationCodeGenerateInput (+31 more)
...
Cohesion: 0.05
Nodes (31): ProviderDirectoryData, ResidentIdSharePage(), CATEGORIES, isApplicationOpen(), LandingStep(), MeResponse, OwnApplication, ProviderStats (+23 more)

### Community 72 - "Community 72"
Cohesion: 0.05
Nodes (42): TIER_TONE, PlanMark(), RAFTER, RIDGE, ROWS, ListingTierTone, Plan, PlanId (+34 more)

### Community 73 - "Community 73"
Cohesion: 0.06
Nodes (34): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), sitemap() (+26 more)

### Community 74 - "Community 74"
Cohesion: 0.06
Nodes (44): AMOUNT_ALIASES, CREDIT_ALIASES, AMOUNT_ALIASES, CREDIT_ALIASES, DATE_ALIASES, DEBIT_ALIASES, NAME_ALIASES, readMoney() (+36 more)
...
Cohesion: 0.07
Nodes (38): HostelPayeeIdentity, assertQrAssetUsable(), EMPTY, getPaymentProfile(), PaymentProfileView, ProfileDocument, TEXT_FIELDS, toView() (+30 more)

### Community 77 - "Community 77"
Cohesion: 0.06
Nodes (40): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+32 more)

### Community 78 - "Community 78"
Cohesion: 0.06
Nodes (23): field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminSOSAlertsPage(), LoadState, NightStatusRow, Notification, NotificationsPageContent() (+15 more)
...
Cohesion: 0.07
Nodes (30): metadata, CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+22 more)

### Community 81 - "Community 81"
Cohesion: 0.07
Nodes (37): ComplaintDetail(), ComplaintCard(), ComplaintsScreen(), needsResident(), OPEN_STATUSES, rank(), ACTOR_LABELS, actorLabel() (+29 more)
...
Cohesion: 0.07
Nodes (33): buildIdCardData(), EMAIL_CHECK_HINTS, EmailCheck, Field(), FIELD_LABELS, formatCardDate(), IdCardPanel(), identityPhotoUrl() (+25 more)
...
Cohesion: 0.08
Nodes (35): ChargeBasis, closeFeeSchedule(), computeInvoiceAmount(), countDaysInclusive(), createFeeSchedule(), dayBefore(), FeeScheduleRate, FeeScheduleRecord (+27 more)
...
Cohesion: 0.06
Nodes (31): PortalDates, useHostelDayTurn(), PlanBilling, PlanBillingInvoice, PlanBillingPayment, PlanBillingPlan, ContentSection, EMPTY_PAGE (+23 more)

### Community 94 - "Community 94"
Cohesion: 0.07
Nodes (31): HostelPhotoReminder(), PublicHomePage(), formatHostelAddress(), hostelTypeToUi(), mapPublicHostelToSummary(), roomTypeLabel(), CATEGORY_LABELS, NEARBY_GROUPS (+23 more)
...
Cohesion: 0.08
Nodes (24): blankRow(), Row, TeamInviteBox(), MemberActions(), Props, TeamMembersTable(), InviteResult, Member (+16 more)
...
Cohesion: 0.09
Nodes (32): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags() (+24 more)
...
Cohesion: 0.09
Nodes (26): native, NativeDownloads, openDownloaded(), openSavedFile(), SavedDownload, registerNightStatusCategory(), claimNotificationSound(), claims (+18 more)
...
Cohesion: 0.11
Nodes (28): bsMonthStart(), hostelCalendarDay(), hostelToday(), rateForRoomType(), hostelCalendarDay(), hostelMonthStart(), hostelPeriodOf(), hostelToday() (+20 more)
...
Cohesion: 0.1
Nodes (29): ApiFailure, apiRequest(), ApiSuccess, AuthUser, confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), getResidentProfile() (+21 more)

### Community 113 - "Community 113"
Cohesion: 0.09
Nodes (31): announcedCount(), announcementSummary(), CookFoodPhoto, MealButton, mealButtonLabel(), MealButtonsInput, mealLockNote(), mealsToCall() (+23 more)

### Community 114 - "Community 114"
Cohesion: 0.09
Nodes (29): BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan, BillingSkip (+21 more)

### Community 115 - "Community 115"
Cohesion: 0.11
Nodes (23): activateResident(), AuthSession, login(), submitResidentReview(), triggerSOS(), AppNavigator(), RootStackParamList, Stack (+15 more)
...
Cohesion: 0.1
Nodes (14): PlatformHostelsPageContent(), PlatformHostelsPageContent, PortalPlaceholderAction, PortalPlaceholderPage(), PortalPlaceholderPageProps, ResidentPaymentsPageContent, ResidentPaymentsPageContent(), ResidentProfilePageContent() (+6 more)
...
Cohesion: 0.08
Nodes (23): buildIdCard(), cardDate(), draftFromProfile(), emptyIdentityDraft(), firstIncompleteIdentityStep(), IDENTITY_STEPS, blank, BOTH_ASSETS (+15 more)
...
Cohesion: 0.12
Nodes (22): ReferralBody(), ReferralRow(), getResidentReferral(), Referral, ReferralCode, ReferralReward, ReferralStatus, ReferralSummary (+14 more)
...
Cohesion: 0.21
Nodes (23): assertMatchesExtension(), downloadAndShare(), downloadAndShareCsv(), downloadAndShareImage(), downloadToDevice(), forgetDownloadFolder(), LegacyFileSystem, loadLegacyFileSystem() (+15 more)
...
Cohesion: 0.17
Nodes (17): FALLBACK, SiteConfigContext, SiteConfigProvider(), useFeatureFlag(), DEFAULT_SITE_CONFIG, coerceSection(), getPublicSiteConfig(), getSiteConfig() (+9 more)
...
Cohesion: 0.11
Nodes (20): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, FeeScheduleCloseInput, feeScheduleCloseSchema (+12 more)

### Community 152 - "Community 152"
Cohesion: 0.12
Nodes (19): classifyCredit(), CreditClassification, findOrphanClaims(), LadderClaim, LadderInvoice, MatchContext, normalizeTxnId(), ANITA_CODE (+11 more)
...
Cohesion: 0.11
Nodes (21): CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing, CurrentUser (+13 more)
...
Cohesion: 0.09
Nodes (17): DRIFT_CODES, after, broken, claimId, db, eventId, filter, finding (+9 more)
...
Cohesion: 0.13
Nodes (13): ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, BASE_URLS, GatewayProvider, IntentHandoff, PaymentIntent (+5 more)
...
Cohesion: 0.14
Nodes (18): appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind, creditOverpayment(), getCreditBalance(), isDuplicateKey(), recomputeCreditBalance() (+10 more)
...
Cohesion: 0.16
Nodes (18): auditWardenAction(), createHostelWarden(), deactivateHostelWarden(), findScopedWarden(), HostelMemberRecord, hydrateUser(), listHostelWardens(), MemberStatus (+10 more)
...
Cohesion: 0.12
Nodes (14): fadeUp, Feature, featureChrome, features, heroSlides, PublicHostelRegistrationLandingPage(), stagger, stats (+6 more)
...
Cohesion: 0.12
Nodes (20): 10.1 GitHub Actions Workflow, 10.2 Merge Rules, 10. CI/CD Integration, 7.1 Multi-Tenant Isolation Test Template, 7.2 Role Gate Test Template, 7.3 Privacy/Guardian Permissions Test Template, 7.4 Account-Upgrade Test Template, 7.5 Payment Precision Test Template (+12 more)
...
Cohesion: 0.21
Nodes (16): nightStatusPromptSchema, formatPromptTime(), minuteIsDue(), nightKey(), parsePromptTime(), promptIsDue(), reminderIsDue(), duePrompts() (+8 more)
...
Cohesion: 0.12
Nodes (18): 0.1 The shared Softmato domain, 0.2 Categories — which mailbox a message comes from, 0.2a Where replies go, 0.3 Where the sender is configured, 0.4 Template structure, 0. Sending Infrastructure, code:block1 (softmato.com), code:block2 (packages/shared/src/email/) (+10 more)
...
Cohesion: 0.25
Nodes (17): drawBack(), drawBrandLockup(), drawFooterSweep(), drawFront(), drawHeaderSweep(), drawIdCard(), drawLogoMark(), drawPortrait() (+9 more)
...
Cohesion: 0.15
Nodes (15): bsPeriodOf(), currentBsPeriod(), openOrder(), currentPeriod(), hostelId, mocks, principal, residentA (+7 more)
...
Cohesion: 0.16
Nodes (9): buildFormPostHandoff(), FormPostHandoff, HandoffError, IntentRecord, GatewayProviderName, adapters, SHIPPED, GatewayRelayPage() (+1 more)
...
Cohesion: 0.15
Nodes (16): 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, 4.1 New Notice Posted, 4.2 Complaint Status Updated, 4.3 Complaint Resolved (+8 more)
...
Cohesion: 0.21
Nodes (13): hostelForm(), buildHostelPayload(), capacitySummary(), emptyHostelForm(), emptyRoomRow(), firstIncompleteHostelStep(), numberValue(), RULES_TEMPLATES (+5 more)
...
Cohesion: 0.18
Nodes (10): Build status (end of Phase 3), Build status (end of Phase 5 — verified 2026-08-02), code:typescript (export enum Role {), Conventions, Cook Portal, DATABASE.md — Schema & Relationships, Enums, Indexing Strategy Summary (+2 more)
...
Cohesion: 0.29
Nodes (8): pushTicketSchema, authHeaders(), chunk(), ExpoReceipt, fetchReceipts(), isConfigurationFailure(), ReceiptSweepResult, sweepPushReceipts()
...
Cohesion: 0.4
Nodes (10): AttendanceAlert, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript (interface IQuestionCallClick {), Community Feature, CommunityComment, CommunityPost (+2 more)
...
Cohesion: 0.25
Nodes (6): documents, many, parsed, result, EMPTY_PROVIDER_FORM, serviceProviderRegisterSchema
...
Cohesion: 0.25
Nodes (5): errors, fetchMock, mocks, permissionDenied, report
...
Cohesion: 0.38
Nodes (4): metadata, buildPosts(), posts, PublicBlogPage()
...
## Knowledge Gaps
- **5665 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+5660 more)
...
- **Why does `Button()` connect `Community 6` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 8`, `Community 10`, `Community 13`, `Community 17`, `Community 20`, `Community 22`, `Community 24`, `Community 25`, `Community 28`, `Community 158`, `Community 31`, `Community 34`, `Community 35`, `Community 41`, `Community 42`, `Community 172`, `Community 45`, `Community 59`, `Community 67`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 13` to `Community 1`, `Community 4`, `Community 6`, `Community 134`, `Community 10`, `Community 16`, `Community 17`, `Community 273`, `Community 25`, `Community 27`, `Community 160`, `Community 36`, `Community 37`, `Community 43`, `Community 172`, `Community 47`, `Community 53`, `Community 57`, `Community 59`, `Community 61`, `Community 62`, `Community 191`, `Community 63`, `Community 71`, `Community 72`, `Community 73`, `Community 458`, `Community 80`, `Community 87`, `Community 88`, `Community 94`, `Community 101`, `Community 102`, `Community 364`, `Community 126`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 139` to `Community 0`, `Community 258`, `Community 4`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 151`, `Community 25`, `Community 29`, `Community 35`, `Community 164`, `Community 36`, `Community 38`, `Community 166`, `Community 42`, `Community 45`, `Community 174`, `Community 50`, `Community 184`, `Community 63`, `Community 65`, `Community 198`, `Community 74`, `Community 84`, `Community 85`, `Community 218`, `Community 94`, `Community 95`, `Community 109`, `Community 122`, `Community 126`, `Community 127`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Are the 434 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 434 INFERRED edges - model-reasoned connections that need verification._
