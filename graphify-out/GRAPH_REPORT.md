...
## Corpus Check
- 1970 files · ~2,885,346 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15691 nodes · 43141 edges · 524 communities (500 shown, 24 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 692 edges (avg confidence: 0.8)
...
## Communities (524 total, 24 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (208): PATCH(), POST(), RouteContext, GET(), POST(), PATCH(), POST(), RouteContext (+200 more)
...
Cohesion: 0.01
Nodes (286): methodProvider(), RoundButton(), VOICE_NOTE_RECORDING, VoiceNote, VoiceNoteRecorder(), loadFinance(), ManageRatesScreen(), AdminInvoiceMatrix (+278 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (193): Scanner(), CookInviteScreen(), GuardianInviteScreen(), PreviewCard(), ResultRow(), Assurance(), CallableRow(), IdentityCard() (+185 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (227): loadOverview(), loadMoney(), loadToday(), ReviewForm(), ReviewScreen(), DeletionPanel(), load, describeGrants() (+219 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (164): POST(), attacker, attempt(), headers, jsonRequest(), routeMocks, appBaseUrl(), authenticateWithGoogle() (+156 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (134): PlanPaymentClaim, DemoDataBadge(), Hostel, HostelTable(), Inquiry, LoadState, ReportGrid(), ReportRecord (+126 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (141): CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload, AttendanceAlert, AttendanceCalendar(), AttendanceRow, Zone (+133 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (180): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput, ConsentInput (+172 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (160): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply() (+152 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (116): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminAttendancePageContent, HostelAdminCommunityPageContent, HostelAdminComplaintsPage (+108 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (144): auditFinanceAction(), FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), voidInvoice(), appendEntry(), applyCreditToInvoice(), CreditBalanceView (+136 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (151): addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery, HostelAdminInquiryStatusInput, InquiryNoteCreateInput, InquiryNoteRecord, InquiryRecord (+143 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (145): approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal, checker, eventId (+137 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (129): PATCH(), RouteContext, getPlanPaymentInstructions(), POST(), RouteContext, DELETE(), GET(), hostelId() (+121 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (135): PaymentMonthStrip(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard(), AmountCard(), AdminLedger (+127 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (85): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, DASHBOARD_ROLES, FACILITY_ICONS (+77 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (114): GET(), POST(), querySchema, RouteContext, authorUserId, mocks, postId, residentId (+106 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (92): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CancelDeletionPageContent() (+84 more)
...
Cohesion: 0.03
Nodes (113): ownerIdentitiesFor(), periodOf(), getHostelLedger(), HostelLedger, HostelLedgerEntry, InvoiceMatrix, InvoiceMatrixRow, NotBilled (+105 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (108): grabDocument(), PayPlanPanel(), rupees(), HostelAdminReconcilePageContent, labelled(), PROVIDERS, Reconciliation, StatementImportRow (+100 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (78): AuthExperiencePage(), csvField(), field(), Hostel, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminProfilePageContent(), HostelAdminRoomsPageContent() (+70 more)
...
Cohesion: 0.03
Nodes (102): AdminResidentsScreen(), NightStatusForm(), NotificationCard(), NotificationRow(), ProfileScreen(), ReferralRow(), CheckoutStatusScreen(), ComplaintDetail() (+94 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (97): CommunityReportDialog(), REASONS, MonthOption(), Offset, PhotoCropper(), VideoSlot(), ModerationButton(), PagerButton() (+89 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (78): AuthShell(), AuthShellProps, PANEL_COPY, SiteWordmark(), metadata, AccountDeletionPanel, ContentHeader(), ContentIntro() (+70 more)
...
Cohesion: 0.03
Nodes (95): notifyProviderOfAssignment(), notifyProviderOfMaintenanceNote(), notifyProviderOfStatusChange(), notifyStaffOfJobProgress(), notifyStaffOfNewMaintenanceRequest(), providerUserId(), readableCategory(), RequestLike (+87 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (93): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), sitemap() (+85 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (99): AdminCommunityReportsScreen(), NightStatusScreen(), NotificationsScreen(), ReferralsScreen(), NotificationSettings(), SORTS, StoreCategoryScreen(), CommunityPostScreen() (+91 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (96): RealtimeTopic, CookTodayScreen(), RoleLayout(), TABS, useMinuteTick(), useQueryValue(), define(), seedCommunityPost() (+88 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (81): GET(), POST(), GET(), GET(), GET(), readReturnState(), resolveOwnedHostel(), DELETE() (+73 more)

### Community 33 - "Community 33"
Cohesion: 0.02
Nodes (82): HostelRegistrationProgress(), Milestone, milestoneIndex(), MILESTONES, PaymentPanel(), rupees(), SubscriptionState, cityOptions (+74 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (75): bsPeriodsBetween(), summarizeResidentComplaints(), listResidentInvoices(), getResidentLedger(), monthsBetween(), periodOf(), ResidentDoc, ResidentLedger (+67 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (81): CommunityScreen(), Composer(), AttachmentGallery(), CommunityBoard(), CommunityBoardProps, Composer(), SORTS, CommentThread() (+73 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (79): POST(), PaginationMeta, PaginationQuery, querySchema, PLATFORM_ROLES, noticeSchema, noticeReadStatusSchema, notificationCampaignSchema (+71 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (87): BLOOD_OPTIONS, continueLabel(), DIET_LABELS, DIET_OPTIONS, EmailCheck, FormControl, GENDER_LABELS, GENDER_OPTIONS (+79 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (71): BrowserPushRow(), FILTERS, Notification, NotificationRow(), PushState, blankRow(), Row, TeamInviteBox() (+63 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (84): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, TXN_ID_ALIASES, WITHDRAWAL_ALIASES (+76 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (61): GET(), querySchema, findHostelUsingEmail(), listHostelAdminInquiries(), bedCreateSchema, bedUpdateSchema, floorCreateSchema, hostelAdminGeocodeQuerySchema (+53 more)

### Community 41 - "Community 41"
Cohesion: 0.03
Nodes (64): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), ServiceProvidersScreen(), DocumentScreen() (+56 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (54): attendanceAlertResolveSchema, PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), getPlatformSubscriptionLedger(), listPlanPaymentClaims(), GET(), GET() (+46 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (76): demoteToPublicAccount(), LIVE_ACCESS, releaseGuardianAccounts(), hostelId, mocks, userId, escapeRegex(), objectIdSchema (+68 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (67): POST(), GET(), POST(), cookCreateSchema, cookInvitationAcceptSchema, cookNameSchema, cookPortalUpdateSchema, cookRemoveSchema (+59 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (45): field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminMoveChecklistPage(), LoadState, NightStatusRow, Notification, NotificationsPageContent() (+37 more)
...
Cohesion: 0.04
Nodes (67): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), AdminTodayScreen(), AdminAlertsContext, AdminAlertsValue, AlertActions, EMPTY_COUNTS (+59 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (72): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags(), documentFlags() (+64 more)

### Community 49 - "Community 49"
Cohesion: 0.06
Nodes (70): decodeKey(), decryptPersonalData(), encryptionKey(), encryptPersonalData(), isPersonalDataEncryptionConfigured(), personalLookupHash(), resetPersonalDataKeyCache(), envelope (+62 more)

### Community 50 - "Community 50"
Cohesion: 0.07
Nodes (43): POST(), POST(), getCurrentUser(), POST(), POST(), POST(), POST(), safeEqual() (+35 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (57): JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, ProviderJobScreen(), AdminNightStatusRow (+49 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (59): aswin, bhadra, bs(), card(), currentId, hostelId, inAswin, inOctober (+51 more)
...
Cohesion: 0.05
Nodes (55): cookLoginStem(), generateCookPassword(), mintCookLogin(), pick(), previousCookLabel(), acceptCookInvitation(), addCookAccount(), assertRoomForAnotherCook() (+47 more)
...
Cohesion: 0.06
Nodes (60): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodBounds() (+52 more)
...
Cohesion: 0.07
Nodes (49): storeOrderSchema, formatNpr(), itemsTable(), StoreEmailItem, mocks, allocateOrderNumber(), applyStatus(), CancelInput (+41 more)

### Community 62 - "Community 62"
Cohesion: 0.06
Nodes (41): AdminTabs(), HIDDEN, TABS, AlertRow(), ContactRow(), SosScreen(), TABS, AdminAlertsProvider() (+33 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (45): ComparePage(), hostels, metadata, rows, AuthGuard(), CurrentUser, MeResponse, PortalAccount() (+37 more)
...
Cohesion: 0.05
Nodes (43): HostelSuggestions(), PublicComparePage(), PublicHostel, PublicHostelListingPageContent(), checkOnly(), EMPTY_PREFILL, ENVIRONMENT_OPTIONS, IdentityResponse (+35 more)
...
Cohesion: 0.06
Nodes (43): afterResponse(), mocks, work, CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, readId(), activeDevicesFor() (+35 more)
...
Cohesion: 0.09
Nodes (46): openCheckoutSession(), deliver(), loadInvoiceById(), loadProof(), PlanPaymentInstructions, ProofAsset, reviewPlanPaymentClaim(), submitPlanPaymentClaim() (+38 more)

### Community 71 - "Community 71"
Cohesion: 0.08
Nodes (40): CSV_COLUMNS, GET(), GET(), periodTotals(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS (+32 more)
...
Cohesion: 0.07
Nodes (40): BootGate(), RootShell(), AssetViewer(), useViewerState(), BottomChrome, BottomChromeContext, BottomChromeProvider(), CHROME_TIMING (+32 more)
...
Cohesion: 0.06
Nodes (33): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, PortalShell(), navItems, navItems, canAccessWorkspace(), workspaceHostelName(), GUARDIAN_NAV (+25 more)
...
Cohesion: 0.07
Nodes (37): addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange(), definedUpdate(), FoodFeedbackInput, FoodFeedbackRecord, FoodMenuCreateInput (+29 more)
...
Cohesion: 0.07
Nodes (36): referralSchema, referralCodeSchema, referralRewardSchema, describeReward(), notifyReferralJoined(), notifyReferralReward(), referrerUserId(), rewardNotice() (+28 more)
...
Cohesion: 0.07
Nodes (33): userSchema, ADMIN_ISSUABLE_ROLES, AdminIssuableRole, generateTemporaryPassword(), HIGH_PRIVILEGE_ROLES, loginUrl(), RegisterOrUpgradeInput, registerOrUpgradeUserByEmail() (+25 more)

### Community 85 - "Community 85"
Cohesion: 0.06
Nodes (32): configuredLevel(), levelPriority, logger, LogLevel, normalizeMeta(), shouldLog(), write(), pushTicketSchema (+24 more)
...
Cohesion: 0.08
Nodes (26): geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), placeOnMap(), geocodeAddress(), HostelGeoLocation, resolveHostelGeo() (+18 more)
...
Cohesion: 0.12
Nodes (34): GET(), resolvePastedLink(), searchCandidates(), lookupLocation(), resolvePastedLink(), searchCandidates(), AddressParts, addressPartsFromGoogle() (+26 more)
...
Cohesion: 0.06
Nodes (28): complaintCategorySchema, complaintCreateSchema, complaintListQuerySchema, complaintReplySchema, complaintResolutionConfirmSchema, complaintStatusSchema, complaintStatusUpdateSchema, objectIdSchema (+20 more)
...
Cohesion: 0.1
Nodes (32): Guidance, GuidanceStatus, CARDINALS, chooseHeading(), directionWord(), distanceToPath(), hasArrived(), headingDifference() (+24 more)
...
Cohesion: 0.09
Nodes (31): DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS, MealCard(), MonthEndSpecial(), RoutineMeal, CookMenuScreen() (+23 more)
...
Cohesion: 0.08
Nodes (31): detectProvider(), headlineAmount(), labelledValue(), ParsedReceipt, parseReceipt(), ReceiptProvider, ReceiptShape, STATEMENT_COLUMN_PAIRS (+23 more)
...
Cohesion: 0.08
Nodes (21): AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex() (+13 more)
...
Cohesion: 0.11
Nodes (27): bsMonthStart(), hostelCalendarDay(), hostelToday(), rateForRoomType(), hostelCalendarDay(), hostelMonthStart(), hostelToday(), once (+19 more)

### Community 116 - "Community 116"
Cohesion: 0.09
Nodes (28): methodLabel(), SubmitClaimScreen(), canonicalize(), CLAIM_METHODS, ClaimDraft, ClaimErrors, ClaimRejection, ClaimRejectionDetails (+20 more)
...
Cohesion: 0.08
Nodes (24): POST(), dayOfWeekSchema, foodFeedbackSchema, foodMenuCreateSchema, foodMenuListQuerySchema, foodMenuUpdateSchema, foodRoutineSaveSchema, mealTypeSchema (+16 more)
...
Cohesion: 0.12
Nodes (22): robots(), documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), OpenedCheckout, readSettledReceipt(), SettledReceipt, documentUrl() (+14 more)

### Community 130 - "Community 130"
Cohesion: 0.17
Nodes (21): subscriptionClaimReceivedEmail(), subscriptionClaimRejectedEmail(), formatRupees(), subscriptionInvoiceEmail(), METHOD_LABELS, subscriptionReceiptEmail(), hostelRegisteredByTeamEmail(), hostelVerifiedEmail() (+13 more)
...
Cohesion: 0.13
Nodes (16): EmailAttachment, hostelId, mocks, receiptId, residentId, verified, gatewayUnhealthyEmail(), paymentClearedEmail() (+8 more)
...
Cohesion: 0.1
Nodes (20): DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), describePreference(), formatMinutes(), MUTABLE_CATEGORIES (+12 more)
...
Cohesion: 0.13
Nodes (21): Choice, Compass(), maneuverIcon(), MapButton(), MapScreen(), ModeTab(), NavCard(), NOTHING_CHOSEN (+13 more)

### Community 146 - "Community 146"
Cohesion: 0.16
Nodes (18): FILE_ASSET_KINDS, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), r2Configured(), storePublicAsset(), AccessLevel, bucketForAccessLevel() (+10 more)
...
Cohesion: 0.21
Nodes (23): bootstrapSession(), assertMatchesExtension(), downloadAndShare(), downloadAndShareCsv(), downloadAndShareImage(), downloadToDevice(), forgetDownloadFolder(), LegacyFileSystem (+15 more)
...
Cohesion: 0.18
Nodes (17): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, SystemDocumentKind (+9 more)
...
Cohesion: 0.08
Nodes (12): base, enabledAt, esewa, fonepay, hostelId, mocks, noSecret, principal (+4 more)
...
Cohesion: 0.11
Nodes (20): buildHtml(), buildShell(), boundsCenter(), haversineMeters(), hostelCoordinates(), HostelWithDistance, isUsableCoordinate(), KATHMANDU (+12 more)
...
Cohesion: 0.13
Nodes (13): ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, BASE_URLS, GatewayCredentials, GatewayProvider, IntentHandoff (+5 more)
...
Cohesion: 0.2
Nodes (17): nightStatusPromptSchema, formatPromptTime(), isSameNight(), minuteIsDue(), nightKey(), parsePromptTime(), promptIsDue(), reminderIsDue() (+9 more)

### Community 196 - "Community 196"
Cohesion: 0.13
Nodes (20): 1.7 Account Upgraded, 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.3 Hostel Rejected, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, 3.1 Payment Due Reminder, 3.2 Payment Overdue (+12 more)
...
Cohesion: 0.15
Nodes (17): 1.0 Signup One-Time Code, 1.1 Email Verification (PUBLIC Signup), 1.2 Hostel Admin Credentials (Post-Approval), 1.3 Warden Credentials, 1.4 Resident QR Activation, 1.5 Guardian Invitation, 1.6 Password Reset, 1. Authentication & Account Emails (+9 more)
...
Cohesion: 0.19
Nodes (10): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, AuthResponse, OtpRequestData, RegisterData (+2 more)
...
Cohesion: 0.22
Nodes (11): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, BED_TYPE_LABELS, BED_TYPE_OCCUPANCY (+3 more)
...
Cohesion: 0.5
Nodes (3): initialState, savedSlice, SavedState
...
## Knowledge Gaps
- **5540 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+5535 more)
...
- **Why does `Button()` connect `Community 1` to `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 15`, `Community 145`, `Community 18`, `Community 19`, `Community 21`, `Community 24`, `Community 25`, `Community 26`, `Community 30`, `Community 31`, `Community 35`, `Community 37`, `Community 38`, `Community 41`, `Community 45`, `Community 47`, `Community 53`, `Community 54`, `Community 55`, `Community 184`, `Community 62`, `Community 106`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 141` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 136`, `Community 264`, `Community 135`, `Community 13`, `Community 15`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 27`, `Community 33`, `Community 166`, `Community 39`, `Community 168`, `Community 42`, `Community 45`, `Community 174`, `Community 53`, `Community 181`, `Community 58`, `Community 59`, `Community 63`, `Community 195`, `Community 83`, `Community 87`, `Community 90`, `Community 95`, `Community 110`, `Community 116`, `Community 121`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 25` to `Community 1`, `Community 6`, `Community 7`, `Community 136`, `Community 10`, `Community 16`, `Community 18`, `Community 19`, `Community 276`, `Community 21`, `Community 22`, `Community 26`, `Community 29`, `Community 33`, `Community 38`, `Community 45`, `Community 54`, `Community 55`, `Community 60`, `Community 63`, `Community 65`, `Community 69`, `Community 76`, `Community 82`, `Community 94`, `Community 107`, `Community 108`, `Community 119`, `Community 124`?**
