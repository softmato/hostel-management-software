...
## Corpus Check
- 2299 files · ~4,832,258 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18493 nodes · 51687 edges · 610 communities (578 shown, 32 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 855 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 737 edges
2. `successResponse()` - 714 edges
3. `connectToDatabase()` - 516 edges
4. `useAppTheme()` - 422 edges
5. `cn()` - 339 edges
6. `connectToDatabase()` - 275 edges
7. `unwrap()` - 230 edges
...
## Communities (610 total, 32 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (204): ICONS, LABELS, Segment, TONES, FILTERS, Pending, openStore(), Overview (+196 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (323): loadOverview(), loadMoney(), loadToday(), NightStatusPromptCard(), RoundButton(), VOICE_NOTE_RECORDING, VoiceNote, VoiceNoteRecorder() (+315 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (222): POST(), GET(), POST(), GET(), MESSAGES, POST(), RouteContext, GET() (+214 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (259): PATCH(), RouteContext, POST(), POST(), GET(), getOpenFeeSchedule(), GET(), POST() (+251 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (203): getResidentAttendance(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), addComplaintUpdate(), assertComplaintVoiceNote(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord (+195 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (154): PlanPaymentClaim, csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, HostelTable(), Inquiry (+146 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (196): auditFinanceAction(), FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment() (+188 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (181): generateMetadata(), chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout() (+173 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (155): CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload, CommunityPageContent(), NewPostAlertsToggle(), field(), GuardianPermissions (+147 more)

### Community 9 - "Community 9"
Cohesion: 0.01
Nodes (167): Scanner(), APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), CookInviteScreen() (+159 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (171): AdminMoreScreen(), ActivateScreen(), BootGate(), RootShell(), NotificationsScreen(), ApplyBlock(), SavedHostelsScreen(), ServiceProvidersScreen() (+163 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (151): AdminCommunityScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+143 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (152): BubbleBackground(), BubbleBackgroundProps, BubbleColors, StarLayer(), StarLayerProps, StarsBackground(), StarsBackgroundProps, BrandMark() (+144 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (167): AdminAlertsScreen(), AdminCommunityReportsScreen(), AdminHomeScreen(), AdminTabs(), HIDDEN, RoleLayout(), TABS, AdminMoneyScreen() (+159 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (118): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, CITY_OPTIONS, FACILITY_STATS (+110 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (156): POST(), RouteContext, GET(), POST(), DELETE(), PATCH(), RouteContext, GET() (+148 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (145): notifyHostelOfNewPost(), resolveHostelCommunityUserIds(), usersMutingNewPosts(), notifyResidentOfComplaintStatus(), OPEN_STATUSES, OverdueComplaint, hostelId, mocks (+137 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (124): PATCH(), POST(), RouteContext, PATCH(), RouteContext, listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema (+116 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (121): Platform, ConcessionBackfill, describeApplied(), FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, MonthDiscounts, monthStartPeriod() (+113 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (135): FILTERS, invalidateFeeds(), NIGHT_ANSWER_LABELS, nightAnswerText(), NightPromptAnswer(), NotificationRow(), TILE_GLYPH, TILE_TONES (+127 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (138): NightStatusForm(), ReviewForm(), ReviewScreen(), AlertRow(), SosScreen(), AttachmentGallery(), DAY_LABELS, DayStrip() (+130 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (142): PaymentMonthStrip(), ClearFilters(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard(), AmountCard() (+134 more)

### Community 22 - "Community 22"
Cohesion: 0.07
Nodes (103): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), dueWhen(), PlanDueInput (+95 more)

### Community 23 - "Community 23"
Cohesion: 0.02
Nodes (117): GET(), POST(), POST(), POST(), POST(), listAttendanceAlerts(), GET(), POST() (+109 more)

### Community 24 - "Community 24"
Cohesion: 0.02
Nodes (117): HostelAdminCooksPanel, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine, formatWeekRange() (+109 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (139): BookingEndCause, bookingMoveInReminderEmail(), HostelBookingClosedCause, hoursWord(), announceConfirmed(), announceEnding(), assertAwaitingAnswer(), cancelBookingByHostel() (+131 more)

### Community 26 - "Community 26"
Cohesion: 0.02
Nodes (88): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CancelDeletionPageContent() (+80 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (100): POST(), POST(), POST(), resetPasswordWithToken(), verifyEmailWithToken(), POST(), runPlanDueReminders(), sweepBookings() (+92 more)

### Community 28 - "Community 28"
Cohesion: 0.02
Nodes (104): EMPTY_PAYOUT_DRAFT, METHODS, PayoutAccountDraft, PayoutAccountFields(), payoutAccountPayload(), DescriptionFacts, DescriptionSuggestions(), HostelType (+96 more)

### Community 29 - "Community 29"
Cohesion: 0.02
Nodes (106): SavedListRow(), BookingForm(), CheckoutScreen(), METHODS, PackageCard(), PayStep(), roomPhotoUris(), StatusCard() (+98 more)

### Community 30 - "Community 30"
Cohesion: 0.02
Nodes (102): findHeldBooking(), LIVE_ACCESS, hostelId, mocks, userId, work, ROLE_VALUES, hostelMemberSchema (+94 more)

### Community 31 - "Community 31"
Cohesion: 0.02
Nodes (77): field(), GuardianDashboard, GuardianDashboardPageContent(), LoadState, NightStatusRow, Notification, NotificationsPageContent(), optionalNumber() (+69 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (100): bsPeriodsBetween(), collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES (+92 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (70): LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminAttendancePageContent (+62 more)

### Community 34 - "Community 34"
Cohesion: 0.02
Nodes (72): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery (+64 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (90): cookPrincipal, mocks, resolveCookLabels(), announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError (+82 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (78): BookButton(), SIZE, BookingAvailabilityView, BookingButton, CLOSED_REASONS, open, HostelSuggestions(), inferKind() (+70 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (79): POST(), GET(), POST(), getPlatformBooking(), transfersByBooking(), acceptGuardianInvitation(), purgeArchivedHostel(), purgeHostel() (+71 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (74): GetPlanButton(), InlineText(), TIER_TONE, PlanMark(), RAFTER, RIDGE, ROWS, EASE (+66 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (87): Offset, PhotoCropper(), VideoSlot(), FileUploadArea(), FileUploadArea(), isApplicationOpen(), ServiceProviderRegistrationPageContent(), downloadCaption() (+79 more)
...
Cohesion: 0.04
Nodes (80): GATEWAY_ORDER, getHostelPayMethods(), getPayInstructions(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod (+72 more)
...
Cohesion: 0.04
Nodes (79): noticeSchema, noticeReadStatusSchema, platformPushScheduleSchema, mocks, noticeInput, residentUserId, staffPrincipal, announceChange() (+71 more)
...
Cohesion: 0.05
Nodes (77): authorUserId, mocks, postId, residentId, residentPrincipal, staffPrincipal, AnnouncementInput, CommentCreateInput (+69 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (79): notifyClaimReviewed(), receiptAttachment(), approveClaim(), assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck() (+71 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (68): BrowseProfileScreen(), JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, ProviderStatusCard() (+60 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (62): appBaseUrl(), dispatchVerificationEmail(), normalizeEmail(), requestPasswordReset(), resendVerificationEmail(), signupWithEmailVerification(), POST(), POST() (+54 more)

### Community 49 - "Community 49"
Cohesion: 0.03
Nodes (63): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, PaginationMeta, PaginationQuery, paginationQuerySchema, paginationRange() (+55 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (78): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags(), documentFlags() (+70 more)

### Community 51 - "Community 51"
Cohesion: 0.03
Nodes (64): AnyProps, DOMMotionProps, mergeProps(), mergeRefs(), Slot(), SlotProps, WithAsChild, Align (+56 more)

### Community 52 - "Community 52"
Cohesion: 0.03
Nodes (51): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, AuthShell(), AuthShellProps, PANEL_COPY (+43 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (58): AuthGuard(), CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing (+50 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (63): documents, hostelForm(), many, parsed, result, buildHostelPayload(), capacitySummary(), CITY_OPTIONS (+55 more)

### Community 55 - "Community 55"
Cohesion: 0.04
Nodes (58): inquirySchema, referralSchema, referralCodeSchema, referralRewardSchema, activeCode, codeId, hostelId, joinedResidentId (+50 more)
...
Cohesion: 0.04
Nodes (48): answerSchema, complaintCategorySchema, complaintCreateSchema, complaintListQuerySchema, complaintReplySchema, complaintResolutionConfirmSchema, complaintStatusSchema, complaintStatusUpdateSchema (+40 more)

### Community 59 - "Community 59"
Cohesion: 0.04
Nodes (53): releaseGuardianAccounts(), daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags (+45 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (55): notifyStaffOfJobProgress(), addHistory(), addMaintenanceComment(), assertBedInHostel(), assertProviderApproved(), assertRoomInHostel(), assertVoiceNoteUsable(), assignMaintenanceProvider() (+47 more)

### Community 61 - "Community 61"
Cohesion: 0.07
Nodes (57): BookableHostel, BookingUnavailableReason, findRoom(), hostelAddress(), HostelAvailability, hostelCoverPhoto(), hostelCoverPhotos(), hostelUnavailableReason() (+49 more)

### Community 62 - "Community 62"
Cohesion: 0.05
Nodes (46): BookingQuote, GuestBookingDetail, GuestBookingSummary, metadata, BookingCheckoutPage(), Method, METHODS, nextStep() (+38 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (55): DetailsCard(), InvoiceDetailScreen(), LedgerCard(), CheckoutStatus, getCheckoutStatus(), getFinanceView(), getPayInstructions(), InvoiceLine (+47 more)

### Community 64 - "Community 64"
Cohesion: 0.05
Nodes (56): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), methodProvider(), PROVIDER_LABEL, QrPanel() (+48 more)
...
Cohesion: 0.04
Nodes (52): account, answerBy, before, book(), Booking, compact, confirmed(), Consent (+44 more)

### Community 69 - "Community 69"
Cohesion: 0.05
Nodes (50): hostelDayParts(), COLUMNS, Member, MemberData, RegistrationTrackSheet(), TrackSheetLoader(), metadata, HOSTEL_AGREEMENT_STATUSES (+42 more)

### Community 70 - "Community 70"
Cohesion: 0.06
Nodes (55): fill(), money(), PlanCard(), PricingScreen(), metadata, checkout(), day(), Invoice (+47 more)

### Community 71 - "Community 71"
Cohesion: 0.05
Nodes (43): POST(), getFoodRoutine(), getFoodRoutinesByHostelId(), saveFoodRoutine(), serializeRoutine(), dayOfWeekSchema, foodFeedbackSchema, foodMenuCreateSchema (+35 more)
...
Cohesion: 0.06
Nodes (51): Choice, Compass(), maneuverIcon(), MapButton(), ModeTab(), NavCard(), NOTHING_CHOSEN, RouteCard() (+43 more)

### Community 74 - "Community 74"
Cohesion: 0.06
Nodes (46): POST(), PLATFORM_ROLES, deviceTokenSchema, notificationSchema, answer, mocks, userId, input (+38 more)

### Community 75 - "Community 75"
Cohesion: 0.06
Nodes (49): fromBs(), gregorianOf(), bhadra(), BillableResident, ChargeBasis, computeInvoiceAmount(), countDaysInclusive(), dayBefore() (+41 more)

### Community 76 - "Community 76"
Cohesion: 0.08
Nodes (47): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt, ownerIdentitiesFor() (+39 more)

### Community 77 - "Community 77"
Cohesion: 0.05
Nodes (45): qrActivationSchema, before, expiresAt, mocks, staffPrincipal, activateResident(), ActivationCodeGenerateInput, ActivationCodeInput (+37 more)
...
Cohesion: 0.06
Nodes (50): BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodOf(), formatBsDate() (+42 more)

### Community 80 - "Community 80"
Cohesion: 0.06
Nodes (43): AdminOverviewScreen(), AlertActions, AssetViewer(), openIdFor(), openIds, StripThumb(), useViewerState(), ViewerBody() (+35 more)

### Community 81 - "Community 81"
Cohesion: 0.12
Nodes (36): POST(), authenticateWithGoogle(), AuthServiceError, changePassword(), logout(), revokeAllSessions(), POST(), POST() (+28 more)

### Community 82 - "Community 82"
Cohesion: 0.07
Nodes (46): CLAIMABLE_STATUSES, dispatchOtpChallenge(), findVerifiedRegistrationChallenge(), generateOtpCode(), getCurrentUser(), GOOGLE_JWKS, hashOtpCode(), isApprovedServiceProvider() (+38 more)

### Community 83 - "Community 83"
Cohesion: 0.07
Nodes (41): BookingPaymentToCheck, TransferView, HostelBookingView, PlatformBookingView, PayoutAccountForReview, ReviewPayoutAccount(), STATUS_LABEL, List() (+33 more)

### Community 84 - "Community 84"
Cohesion: 0.06
Nodes (42): formatPeriodKey(), DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), axisMonth(), monthLabel() (+34 more)
...
Cohesion: 0.07
Nodes (32): demoteToPublicAccount(), GET(), RouteContext, POST(), RouteContext, RouteContext, addEmergencyContact(), addGuardian() (+24 more)
...
Cohesion: 0.09
Nodes (45): getPresignedReadUrl(), LEGACY_ROLE_MAP, Role, ROLE_VALUES, CARD_LABELS, formatIssuedOn(), readPhotoBytes(), readQrBytes() (+37 more)
...
Cohesion: 0.07
Nodes (43): AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance(), deadline(), DIGIT_CONFUSABLES, EvidenceRead (+35 more)

### Community 93 - "Community 93"
Cohesion: 0.09
Nodes (40): deliver(), deliver(), Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity, EmailIdentityResolver (+32 more)
...
Cohesion: 0.07
Nodes (32): applyBookingConfig(), bookingConfigSchema, PLATFORM_SETTING_CHANGE_STATUSES, platformSettingChangeSchema, bookings, CollectionQr, isSettingChangeKey(), SETTING_CHANGES (+24 more)

### Community 96 - "Community 96"
Cohesion: 0.1
Nodes (35): PreviewCard(), FACILITY_ICONS, facilityIcon(), facilityKey(), HostelCard(), SaveButton(), HeadCell(), HostelShowcase() (+27 more)

### Community 97 - "Community 97"
Cohesion: 0.07
Nodes (36): notifyHostelBookingPause(), emailFacts(), hostelOrThrow(), notifyPlatformOfPayoutReview(), PayoutAccountStatus, PayoutAccountView, PayoutActor, PayoutRecord (+28 more)
...
Cohesion: 0.07
Nodes (27): applyWebhook(), checkoutReturnUrl(), OpenCheckoutInput, openSoftmatoCheckout(), softmato(), SoftmatoNotConfiguredError, SoftmatoConfig, softmatoWebhookSecret() (+19 more)
...
Cohesion: 0.1
Nodes (36): signPurposeToken(), nightStatusPromptSchema, askingEndsAt(), askingEndsMinuteOfNight(), formatPromptTime(), isCurrentNight(), isSameNight(), minuteIsDue() (+28 more)
...
Cohesion: 0.07
Nodes (35): softmatoDocsUrl(), dueBhadra29, filed, throughAswin25, CYCLE_LABELS, daysLeftThrough(), daysSpanned(), daysUntil() (+27 more)

### Community 105 - "Community 105"
Cohesion: 0.07
Nodes (31): ResultRow(), buildHtml(), Marker, PlaceMarker, boundsCenter(), haversineMeters(), hostelCoordinates(), HostelWithDistance (+23 more)
...
Cohesion: 0.06
Nodes (27): attacker, attempt(), headers, jsonRequest(), routeMocks, base, entityId, hostelId (+19 more)
...
Cohesion: 0.1
Nodes (32): otpResendCooldownMs(), verifyOtpChallenge(), fail(), findHostelForCheckout(), HostelMatch, paymentState(), PlanCheckoutInput, planCheckoutSchema (+24 more)

### Community 112 - "Community 112"
Cohesion: 0.1
Nodes (32): cookLoginStem(), generateCookPassword(), mintCookLogin(), pick(), previousCookLabel(), addCookAccount(), assertRoomForAnotherCook(), backfillLegacyCook() (+24 more)

### Community 113 - "Community 113"
Cohesion: 0.08
Nodes (33): ComplaintDetail(), ComplaintCard(), ACTOR_LABELS, actorLabel(), Complaint, COMPLAINT_CATEGORIES, COMPLAINT_STATUSES, ComplaintAttachment (+25 more)
...
Cohesion: 0.06
Nodes (30): nextPlanDueStep(), ALL, base, decide(), early, edited, hostelId, html (+22 more)
...
Cohesion: 0.09
Nodes (28): DELETE(), POST(), createPlatformNotificationCampaign(), listHostelNotificationCampaigns(), listPlatformNotificationCampaigns(), statsForCampaigns(), revokeDeviceToken(), saveDeviceToken() (+20 more)

### Community 122 - "Community 122"
Cohesion: 0.09
Nodes (25): getAttendanceConfig(), getAttendanceSettings(), listHostelAttendance(), overrideAttendance(), recordConsent(), resolveAdminHostelId(), resolveAttendanceAlert(), updateAttendanceSettings() (+17 more)
...
Cohesion: 0.1
Nodes (32): getInvoiceDetailForHostel(), HostelScope, ResolvedDocument, resolveInvoiceDocument(), resolveReceiptDocument(), scopeFilter(), settledTotal(), trySoftmato() (+24 more)
...
Cohesion: 0.1
Nodes (29): cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath(), formatManeuverDistance(), hasArrived(), instructionFor() (+21 more)
...
Cohesion: 0.12
Nodes (27): bodySchema, POST(), deleteHostelObjects(), ImageVariantRecord, optimizeImage(), streamToBuffer(), VARIANT_CONFIG, VariantName (+19 more)
...
Cohesion: 0.14
Nodes (21): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, loadSharp() (+13 more)

### Community 138 - "Community 138"
Cohesion: 0.08
Nodes (26): addBsMonths(), bsPeriodBounds(), periodStartDate(), defaultDueDate(), august, bhadra, dateAgo(), hostelId (+18 more)
...
Cohesion: 0.11
Nodes (23): BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan, Badge(), grabDocument(), HostelAdminBillingPageContent(), InvoiceRow() (+15 more)

### Community 147 - "Community 147"
Cohesion: 0.09
Nodes (23): createNoticePush(), deleteNoticePush(), NoticePushInput, NoticePushRepeat, sendNoticePushNow(), updateNoticePush(), dayInputFromNow(), clockLabel() (+15 more)
...
Cohesion: 0.11
Nodes (24): AMOUNT_ALIASES, CREDIT_ALIASES, readMoney(), DATE_ALIASES, DEBIT_ALIASES, NAME_ALIASES, nonZero(), readMoney() (+16 more)
...
Cohesion: 0.14
Nodes (22): bsMonthStart(), discountRent(), hostelCalendarDay(), hostelMonthStart(), hostelToday(), once, isActiveReferralCode(), AdmissionInvoiceResult (+14 more)
...
Cohesion: 0.12
Nodes (25): Attendance / Night Safety, code:typescript (interface IQRActivation {), code:typescript (interface INightStatusLog {), code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface INotice {), code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {) (+17 more)
...
Cohesion: 0.12
Nodes (17): CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, isPlanDueNotification(), readId(), data, DeviceRow, endpoints (+9 more)
...
Cohesion: 0.13
Nodes (15): HostelGeoRecord, sleep(), HostelGeoLocation, resolveHostelGeo(), fetchNearbyPlaces(), fetchNearbyWithGoogle(), GOOGLE_PLACE_TYPES, GooglePlacesResponse (+7 more)
...
Cohesion: 0.13
Nodes (14): BASE_URLS, attempt, fetchMock, initiated, live, request, sandbox, GatewayCredentials (+6 more)

### Community 205 - "Community 205"
Cohesion: 0.12
Nodes (21): 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, 7.1 Attendance Alert (Resident Absent), 7.1 New Hostel Pending Approval (to Superadmin), 7.2 Subscription Expiring Soon, 7. Attendance & Location Tracking Emails (+13 more)
...
Cohesion: 0.1
Nodes (18): BALANCE_ALIASES, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES, WITHDRAWAL_ALIASES (+10 more)
...
Cohesion: 0.15
Nodes (18): activeDevicesFor(), activeTokensFor(), androidChannel(), authHeaders(), chunk(), DeviceRow, EMPTY, ExpoDevice (+10 more)
...
Cohesion: 0.17
Nodes (14): hostelToday(), teamWalletEntrySchema, getOperationsConfig(), fit_width(), Builds the launch-screen art: the logo lockup and the "Powered by" strip.  Run f, commissionFor(), creditTeamCommission(), getAgentWallet() (+6 more)
...
Cohesion: 0.15
Nodes (14): activateResident(), login(), submitResidentReview(), triggerSOS(), RootStackParamList, LoginScreen(), Props, Props (+6 more)
...
Cohesion: 0.18
Nodes (16): currentBsPeriod(), OfferTab(), eventRuns(), sellingCatalog(), coerceSection(), getPublicSiteConfig(), getSiteConfig(), getSiteConfigSection() (+8 more)
...
Cohesion: 0.18
Nodes (11): DeviceLocation, DeviceLocationStatus, hasGeolocation(), LocationOutcome, NavigationFix, OrientationPermission, requestDeviceLocation(), requestHeadingPermission() (+3 more)
...
Cohesion: 0.13
Nodes (9): secretsMatch(), ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, khaltiProvider, GatewayProvider, adapters (+1 more)
...
Cohesion: 0.15
Nodes (15): apiRequest(), confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listResidentComplaints(), listResidentFood(), refreshSession(), ResidentComplaint (+7 more)
...
Cohesion: 0.33
Nodes (15): composeEmail(), hostelSubmissionReceivedEmail(), appBase(), attach(), deliver(), formatEmailDate(), hostelBillingUrl(), hostelListingUrl() (+7 more)
...
Cohesion: 0.16
Nodes (14): 2.2 Hostel Approved, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails, code:typescript ({) (+6 more)
...
Cohesion: 0.18
Nodes (9): AuthSession, register(), verifyOtp(), AppNavigator(), Stack, OtpVerificationScreen(), Props, ResidentFoodScreen() (+1 more)
...
Cohesion: 0.44
Nodes (5): bookingDocumentResponse(), resolveBookingDocument(), GET(), RouteContext, documentFilename()
...
Cohesion: 0.28
Nodes (7): key(), ListingHostel, ListingProjection, projectSchedule(), RoomConfiguration, hostel, result
...
Cohesion: 0.22
Nodes (6): purgeAccount(), mocks, now, otherUserId, residentId, userId
...
Cohesion: 0.29
Nodes (7): 4.2 Complaint Status Updated, 4.3 Complaint Resolved, 4. Resident Activity Emails, 6.1 Service Provider Registration Received, code:typescript ({), code:typescript ({), code:typescript ({)
...
Cohesion: 0.4
Nodes (6): 2.1 Hostel Submission Received, 2.3 Hostel Rejected, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, code:typescript ({), code:typescript ({)
...
Cohesion: 0.83
Nodes (4): formatBsPeriod(), formatBsPeriodYear(), isBsPeriod(), periodParts()
...
## Knowledge Gaps
- **6480 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+6475 more)
...
- **Why does `cn()` connect `Community 12` to `Community 0`, `Community 5`, `Community 7`, `Community 8`, `Community 14`, `Community 18`, `Community 146`, `Community 148`, `Community 24`, `Community 26`, `Community 28`, `Community 31`, `Community 36`, `Community 38`, `Community 39`, `Community 40`, `Community 42`, `Community 51`, `Community 53`, `Community 62`, `Community 70`, `Community 332`, `Community 78`, `Community 83`, `Community 108`, `Community 119`, `Community 120`, `Community 123`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 0` to `Community 1`, `Community 5`, `Community 135`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 140`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 147`, `Community 24`, `Community 26`, `Community 29`, `Community 31`, `Community 42`, `Community 47`, `Community 54`, `Community 64`, `Community 73`, `Community 80`, `Community 114`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `Role` connect `Community 107` to `Community 385`, `Community 2`, `Community 386`, `Community 4`, `Community 5`, `Community 134`, `Community 6`, `Community 3`, `Community 12`, `Community 14`, `Community 270`, `Community 16`, `Community 17`, `Community 15`, `Community 408`, `Community 25`, `Community 26`, `Community 281`, `Community 158`, `Community 159`, `Community 30`, `Community 34`, `Community 35`, `Community 37`, `Community 43`, `Community 45`, `Community 46`, `Community 175`, `Community 174`, `Community 301`, `Community 50`, `Community 52`, `Community 440`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 191`, `Community 68`, `Community 69`, `Community 71`, `Community 77`, `Community 79`, `Community 464`, `Community 81`, `Community 82`, `Community 340`, `Community 341`, `Community 86`, `Community 90`, `Community 95`, `Community 223`, `Community 97`, `Community 104`, `Community 112`, `Community 244`, `Community 245`, `Community 250`, `Community 383`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Are the 511 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 511 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `iosUrlScheme`, `{ defineConfig }`, `expoConfig` to the rest of the system?**
  _6480 weakly-connected nodes found - possible documentation gaps or missing edges._