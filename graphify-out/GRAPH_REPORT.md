...
## Corpus Check
- 1225 files · ~2,035,353 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9804 nodes · 24524 edges · 423 communities (404 shown, 19 thin omitted)
...
1. `handleRouteError()` - 496 edges
2. `successResponse()` - 483 edges
...
## Communities (423 total, 19 thin omitted)
...
Cohesion: 0.03
Nodes (130): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload (+122 more)
...
Cohesion: 0.03
Nodes (95): PATCH(), POST(), RouteContext, GET(), POST(), POST(), POST(), POST() (+87 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (77): attendanceListQuerySchema, attendanceOverrideSchema, consentSchema, locationPingSchema, objectIdSchema, POST(), DELETE(), GET() (+69 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (94): CommunityReportDialog(), REASONS, ConfirmOptions, Notification, MonthPicker, PeriodRow, FILTERS, Notification (+86 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (115): sendEmail(), addHostelAdminProfilePhoto(), deleteHostelAdminProfilePhoto(), HostelAdminProfileQuery, HostelAdminProfileUpdateInput, HostelChangeRequestInput, HostelPhotoCreateInput, HostelPhotoDeleteQuery (+107 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (86): CheckoutStatusScreen(), Resource, InvoiceDetailScreen(), LedgerCard(), SummaryCard(), AmountCard(), methodIcon(), methodLabel() (+78 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (75): DeletionPathway, DeletionStatus, PATHWAY_COPY, CancelDeletionPageContent(), useConfirm(), AcceptResult, GuardianInvitePageContent, EmptyInline() (+67 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (75): POST(), GET(), POST(), createHostelAdminFloor(), listHostelAdminFloors(), listHostelAdminInquiries(), listHostelAdminRooms(), scopedHostelFilter() (+67 more)

### Community 10 - "Community 10"
Cohesion: 0.08
Nodes (68): accountDeletionCancelledEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), Resolver, DEFAULT_MAILBOXES, EmailCategory (+60 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (79): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply() (+71 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (61): Ledger, OrphanAssignPicker, HostelAdminPaymentsPage, MatrixRow, MatrixTotals, PeriodSummary, ClaimFacts(), FLAG_LABELS (+53 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (75): HostelAdminCommunityPageContent, EMPTY_SUMMARY, HostelAdminComplaintsPage, HostelAdminDashboardPageContent, HostelAdminFeePlansPageContent, HostelAdminFeeSchedulePageContent, addDays(), COOK_PORTAL_DEFAULTS (+67 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (42): PATCH(), RouteContext, POST(), RouteContext, GET(), GET(), PATCH(), RouteContext (+34 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (70): BottomChrome, BottomChromeContext, BottomChromeProvider(), CHROME_TIMING, api, API_BASE_URL, bindSessionHandlers(), unwrap() (+62 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (59): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, base (+51 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (79): deleteResidentLocationHistory(), getResidentAttendance(), listAttendanceAlerts(), listResidentComplaints(), getFoodRoutine(), listFoodForResident(), listPublicFoodRoutine(), submitFoodFeedback() (+71 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (48): HostelSuggestions(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, PublicHostel, LoadState, PublicHostelListingPageContent() (+40 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (48): GET(), POST(), GET(), attendanceAlertResolveSchema, attendanceSettingsSchema, communitySettingsSchema, PATCH(), resolveHostelId() (+40 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (59): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, HostelPayeeIdentity, GATEWAY_ORDER (+51 more)
...
Cohesion: 0.04
Nodes (44): AuthGuard(), fadeUp, Feature, features, heroSlides, PublicHostelRegistrationLandingPage(), stagger, stats (+36 more)

### Community 24 - "Community 24"
Cohesion: 0.07
Nodes (41): GenericPortalScreen(), portalRows(), portalTitle(), hasFood(), PublicInquiryPage(), PublicInquiryPageContent(), PublicPricingPage(), categoryLabel() (+33 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (60): BALANCE_ALIASES, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, TXN_ID_ALIASES, WITHDRAWAL_ALIASES, AMOUNT_ALIASES (+52 more)
...
Cohesion: 0.04
Nodes (51): dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, isMonthEnd(), mealsOn(), ROUTINE_DAYS (+43 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (45): ActivateScreen(), RootShell(), LoginScreen(), BrowseProfileScreen(), BROWSE_FACILITIES, BrowseByFacility(), BrowseByType(), Hero() (+37 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (47): POST(), acceptGuardianInvitation(), daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput (+39 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (38): HostelPhotoReminder(), formatHostelAddress(), hostelTypeToUi(), mapPublicHostelToSummary(), roomTypeLabel(), CATEGORY_LABELS, NEARBY_GROUPS, PublicHostelDetailPage() (+30 more)
...
Cohesion: 0.06
Nodes (36): ComparePage(), hostels, metadata, rows, HostelAdminDashboardPageContent(), PlatformDashboardPageContent(), DashboardCard(), DashboardCardProps (+28 more)

### Community 33 - "Community 33"
Cohesion: 0.09
Nodes (36): Scanner(), InquiryFields(), readApiError(), CLAIM_METHODS, ClaimDraft, ClaimErrors, hasErrors(), parseClaimAmount() (+28 more)

### Community 34 - "Community 34"
Cohesion: 0.06
Nodes (43): GET(), POST(), CSV_COLUMNS, GET(), POST(), RouteContext, POST(), safeEqual() (+35 more)

### Community 35 - "Community 35"
Cohesion: 0.06
Nodes (50): robots(), sitemap(), STATIC_ROUTES, listPublishedHostelSlugs(), decodeKey(), decryptPersonalData(), encryptionKey(), encryptPersonalData() (+42 more)

### Community 36 - "Community 36"
Cohesion: 0.07
Nodes (46): appBaseUrl(), dispatchOtpChallenge(), dispatchVerificationEmail(), findVerifiedRegistrationChallenge(), generateOtpCode(), GOOGLE_JWKS, hashOtpCode(), normalizeEmail() (+38 more)
...
Cohesion: 0.05
Nodes (45): addComplaintUpdate(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput, ComplaintListQuery (+37 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (45): referralSchema, referralCodeSchema, referralRewardSchema, activeCode, codeId, hostelId, joinedResidentId, mocks (+37 more)
...
Cohesion: 0.07
Nodes (44): POST(), RealtimeConfig, RealtimeContext, RealtimeContextValue, RealtimeNotification, RealtimeProvider(), useRealtime(), GET() (+36 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (35): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, ENDPOINTS, esewaProvider, SIGNED_FIELDS, attempt, fetchMock (+27 more)

### Community 43 - "Community 43"
Cohesion: 0.06
Nodes (43): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput, ConsentInput (+35 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (24): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminResidentsPage(), redirectToWorkspaceScreen(), HostelAdminReferralsPageContent() (+16 more)

### Community 45 - "Community 45"
Cohesion: 0.07
Nodes (44): GET(), resolvePastedLink(), searchCandidates(), geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), hostelAdminGeocodeQuerySchema (+36 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (40): DEPRECATED_ALIASES, mocks, ADMIN_ISSUABLE_ROLES, AdminIssuableRole, generateTemporaryPassword(), HIGH_PRIVILEGE_ROLES, loginUrl(), RegisterOrUpgradeInput (+32 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (36): GET(), listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), POST(), hostelRequestDocumentsSchema, assertApiRoles() (+28 more)
...
Cohesion: 0.06
Nodes (37): normalize(), PortalSearch(), PortalTone, scoreEntry(), toneStyles, iconMap, IconName, NavItem (+29 more)

### Community 50 - "Community 50"
Cohesion: 0.08
Nodes (35): FACILITY_ICONS, facilityIcon(), HostelCard(), HeadCell(), HostelCompare(), HostelCompareProps, campusDistanceLabel(), coverPhoto() (+27 more)

### Community 51 - "Community 51"
Cohesion: 0.07
Nodes (43): Offset, PhotoCropper(), FileUploadArea(), TradeDetailsStep(), isActive(), acceptAttribute(), EXTENSION_BY_MIME, FAMILY_BYTES (+35 more)
...
Cohesion: 0.07
Nodes (39): dateForDay(), MEAL_TYPES, MealType, mealTypeNow(), nepalClock(), ROUTINE_DAYS, RoutineDay, tuesday (+31 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (11): BootGate(), BrandSplash(), RoleTabScreen(), logo, accentForAccount(), AccountShape, HomeRoute, readableRole() (+3 more)
...
Cohesion: 0.06
Nodes (27): metadata, LegalBody(), buildValues(), PublicAboutPage(), values, buildPosts(), posts, PublicBlogPage() (+19 more)

### Community 58 - "Community 58"
Cohesion: 0.09
Nodes (40): collectionTotals(), listRecentInvoices(), platformRollup(), getHostelViewStats(), foodFeedbackSchema, paymentProofSchema, averageResolutionDays(), bucketBoundaries() (+32 more)

### Community 59 - "Community 59"
Cohesion: 0.05
Nodes (24): adminPrincipal, mocks, PLATFORM_LIMITS, Role, ROLE_VALUES, hostelMemberSchema, rolePermissionSchema, userSchema (+16 more)

### Community 60 - "Community 60"
Cohesion: 0.06
Nodes (28): currency(), EmptyState(), StatusBadge(), ResidentActivationPageContent, ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent (+20 more)
...
Cohesion: 0.08
Nodes (36): serviceProviderApplicationSchema, serviceProviderDocumentSchema, notifyPlatformOfServiceProviderApplication(), ACTIVE_APPLICATION_STATUSES, approveServiceProvider(), auditProviderAction(), findOwnProvider(), findProviderOrThrow() (+28 more)

### Community 63 - "Community 63"
Cohesion: 0.07
Nodes (29): GatewayHealth, GatewayHealthSummary, getGatewayHealth(), IntentCounts, plural(), recordHealth(), runGatewayHealthForHostel(), SEVERITY (+21 more)
...
Cohesion: 0.08
Nodes (37): AMOUNT_LABELS, canonical(), canonicalDigits(), containsWithTolerance(), DIGIT_CONFUSABLES, evidenceTextFlags(), EvidenceTextMatch, extractClaimFields() (+29 more)
...
Cohesion: 0.1
Nodes (30): changePassword(), getCurrentUser(), issueSessionForUser(), login(), publicUser(), refreshAccessToken(), MockSessionModel, owner (+22 more)

### Community 68 - "Community 68"
Cohesion: 0.08
Nodes (28): attacker, attempt(), headers, jsonRequest(), routeMocks, resetPasswordWithToken(), revokeAllSessions(), verifyEmailWithToken() (+20 more)

### Community 69 - "Community 69"
Cohesion: 0.08
Nodes (28): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, qrActivationSchema, activateResident(), ActivationCodeGenerateInput, ActivationCodeInput (+20 more)

### Community 70 - "Community 70"
Cohesion: 0.07
Nodes (24): incidentLogSchema, manualStatusOverrideSchema, nightStatusLogSchema, sosAlertSchema, normalizeObjectId(), ResidentAccessError, ResidentRecord, ResidentStatus (+16 more)

### Community 71 - "Community 71"
Cohesion: 0.1
Nodes (16): PlatformConfigAnnouncementsPageContent, PlatformConfigFacilitiesPageContent, FLAGS, PlatformConfigFeaturesPageContent, PlatformConfigLegalPageContent, PlatformConfigLocationsPageContent, PlatformConfigPricingPageContent, ConfigCard() (+8 more)

### Community 72 - "Community 72"
Cohesion: 0.07
Nodes (32): BANK_CSV_PARSER, BANK, both, empty, ESEWA, [first], ids, KHALTI (+24 more)

### Community 73 - "Community 73"
Cohesion: 0.21
Nodes (22): POST(), authenticateWithGoogle(), AuthServiceError, logout(), POST(), errorResponse(), accessTokenTtlSeconds(), parseDurationSeconds() (+14 more)
...
Cohesion: 0.1
Nodes (22): useBottomChrome(), BUDGET_BANDS, FilterSheet(), HostelBrowser(), HostelBrowserProps, NearestToggle(), AnimatedTabBar(), NearbyStatus (+14 more)
...
Cohesion: 0.08
Nodes (20): GET(), RouteContext, POST(), RouteContext, RouteContext, emergencyContactCreateSchema, guardianCreateSchema, objectIdSchema (+12 more)

### Community 79 - "Community 79"
Cohesion: 0.07
Nodes (27): CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing, buildIdCardData() (+19 more)
...
Cohesion: 0.09
Nodes (28): buildHtml(), HostelMap(), Marker, boundsCenter(), Coordinates, haversineMeters(), hostelCoordinates(), HostelWithDistance (+20 more)

### Community 83 - "Community 83"
Cohesion: 0.07
Nodes (24): csvField(), field(), Hostel, HostelAdminInquiriesPageContent(), HostelAdminRoomsPageContent(), Inquiry, LoadState, numberField() (+16 more)
...
Cohesion: 0.1
Nodes (17): TABS, TABS, RoleTabs(), TabDef, TabBarRenderProps, ColorScheme, palette, radius (+9 more)

### Community 87 - "Community 87"
Cohesion: 0.08
Nodes (19): outstandingForResident(), bedSchema, depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, providedItemSchema, roomSchema, listMoveEvents() (+11 more)

### Community 88 - "Community 88"
Cohesion: 0.07
Nodes (23): BedRecord, MaintenanceCommentCreateInput, MaintenanceCommentRecord, MaintenanceHistoryRecord, MaintenanceRequestCreateInput, MaintenanceRequestListQuery, MaintenanceRequestRecord, MaintenanceServiceError (+15 more)
...
Cohesion: 0.07
Nodes (20): Input(), Select(), field(), HostelAdminMaintenancePageContent(), ListingFlag, LoadState, MaintenanceRequest, optionalField() (+12 more)

### Community 91 - "Community 91"
Cohesion: 0.1
Nodes (27): announceFoodReady(), cookEmailForSlug(), CookPortalUpdateInput, CookServiceError, FoodReadyInput, generatePassword(), getCookPortalSettings(), HostelSettingsRecord (+19 more)
...
Cohesion: 0.1
Nodes (24): listTrendingTags(), sponsorSchema, GET(), loadPopularHostels(), PopularHostelRecord, assertWindow(), CreateInput, createSponsor() (+16 more)

### Community 96 - "Community 96"
Cohesion: 0.11
Nodes (23): issueReceiptForEvent(), IssueReceiptInput, nextReceiptNumber(), periodCoverage(), periodOfDate(), renderReceiptById(), renderStatementForResident(), voidReceipt() (+15 more)
...
Cohesion: 0.08
Nodes (17): POST(), accountDeletionRequestSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, consentLogSchema, questionCallClickSchema, sessionSchema (+9 more)

### Community 99 - "Community 99"
Cohesion: 0.08
Nodes (22): auditFinanceAction(), FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), checkAuditChain(), after, broken, claimId (+14 more)
...
Cohesion: 0.11
Nodes (23): progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster(), UploadRow, UploadStack(), useIsHydrated() (+15 more)
...
Cohesion: 0.12
Nodes (24): addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange(), definedUpdate(), FoodFeedbackInput, FoodFeedbackRecord, FoodMenuCreateInput (+16 more)
...
Cohesion: 0.09
Nodes (24): platformSettingSchema, coerceSection(), getSiteConfig(), PlatformSettingRecord, SiteConfigServiceError, announcementSchema, emailSchema, facilitiesSchema (+16 more)

### Community 108 - "Community 108"
Cohesion: 0.1
Nodes (20): CurrentUser, DASHBOARD_ROLES, dashboardHrefForRole(), hasDashboard(), MeResponse, moreItems, navItems, providerNavItems (+12 more)
...
Cohesion: 0.11
Nodes (16): POST(), dayOfWeekSchema, foodFeedbackSchema, foodMenuCreateSchema, foodMenuListQuerySchema, foodMenuUpdateSchema, foodPhotoUploadSchema, mealTypeSchema (+8 more)

### Community 111 - "Community 111"
Cohesion: 0.1
Nodes (19): feeUpdateSchema, PATCH(), SetResidentFeeInput, setResidentMonthlyFee(), POST(), GET(), setResidentMonthlyFee(), monthlyPaymentGenerateSchema (+11 more)
...
Cohesion: 0.13
Nodes (20): noticeReadStatusSchema, auditNoticeAction(), broadcastNotice(), createNotice(), definedUpdate(), normalizeObjectIds(), NoticeCreateInput, NoticeListQuery (+12 more)
...
Cohesion: 0.1
Nodes (21): getResidentFinanceView(), InvoiceMatrix, InvoiceMatrixRow, listResidentClaims(), PortalInvoice, ResidentFinanceView, ResidentInvoiceReceipt, ResidentPortalInvoice (+13 more)
...
Cohesion: 0.12
Nodes (16): PaginationQuery, ratingReviewSchema, reviewModerationLogSchema, auditReviewAction(), averageOf(), hideReview(), listPublicHostelReviews(), moderateReview() (+8 more)
...
Cohesion: 0.09
Nodes (21): 0. Decisions taken (do not re-litigate), 1. Server-side gaps this app depends on, Boot contract (agreed), Definition of Done (mirrors PHASES.md §6.3), M0 — Scaffold & toolchain ✅ *(2026-08-16, bar the device run)*, M10 — Release, M1 — Design system & app shell ◐ *(core landed 2026-08-16)*, M2 — Auth, session & the no-flash boot ◐ *(mechanism landed 2026-08-16)* (+13 more)
...
Cohesion: 0.12
Nodes (11): AuthShell(), AuthShellProps, SiteWordmark(), ThemeToggle(), ThemeToggleProps, AuthResponse, OtpRequestData, RegisterData (+3 more)
...
Cohesion: 0.15
Nodes (14): approvalPeriod(), getPeriodSummary(), monthsBetween(), periodOf(), PeriodRow, PeriodSummary, august, hostelId (+6 more)
...
Cohesion: 0.15
Nodes (18): countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor(), LedgerInvoiceRow, ledgerPipeline() (+10 more)
...
Cohesion: 0.2
Nodes (16): CheckoutStatus, closeIntent(), expireStaleIntents(), handleProviderCallback(), IntentRecord, isUnconfirmable(), markSucceeded(), PaymentIntentView (+8 more)

### Community 161 - "Community 161"
Cohesion: 0.14
Nodes (11): latestInvoicePerResident(), complaintSchema, nightStatusSchema, paymentSchema, ComplaintRecord, firstPerResident(), hostelNameMap(), listPlatformComplaints() (+3 more)

### Community 162 - "Community 162"
Cohesion: 0.18
Nodes (16): periodTotals(), buildHostelAdminReportExport(), buildPlatformReportExport(), complaintVolume(), HostelAdminReportExportInput, hostelNamesByIdFor(), hostelsByStatus(), normalizeObjectId() (+8 more)

### Community 163 - "Community 163"
Cohesion: 0.15
Nodes (12): AccountDeletionPanel, SiteAnnouncementBanner(), toneClasses, FALLBACK, SiteConfigContext, SiteConfigProvider(), useFeatureFlag(), getPublicSiteConfig() (+4 more)
...
Cohesion: 0.18
Nodes (16): evidenceFlags(), CREDIT_MARKERS, DEBIT_MARKERS, DirectionRead, directionRefusal(), EvidenceDirection, EvidenceOutcome, matched() (+8 more)

### Community 167 - "Community 167"
Cohesion: 0.18
Nodes (16): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags(), loadPayeeIdentity() (+8 more)

### Community 168 - "Community 168"
Cohesion: 0.16
Nodes (16): approveClaim(), assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck(), evidenceCheck(), findClaim() (+8 more)
...
Cohesion: 0.13
Nodes (14): GoogleAuthInput, googleAuthSchema, LoginInput, loginSchema, otpChannelSchema, otpPurposeSchema, OtpRequestInput, OtpVerifyInput (+6 more)
...
Cohesion: 0.2
Nodes (17): addHistory(), addMaintenanceComment(), assertBedInHostel(), assertProviderApproved(), assertRoomInHostel(), auditMaintenanceAction(), createMaintenanceRequest(), findScopedMaintenanceRequest() (+9 more)
...
Cohesion: 0.15
Nodes (14): ProviderDirectoryData, DirectoryPageProps, EMPTY, metadata, ServiceProviderDirectoryPage(), ServiceProvidersPage(), listPublicServiceProviders(), hostelAdminServiceProviderListQuerySchema (+6 more)
...
Cohesion: 0.17
Nodes (11): EMAIL_CATEGORIES, BASE, blank, derived, EMAIL_SECTION, getSiteConfigSection, IDENTITY_SECTION, injected (+3 more)
...
Cohesion: 0.2
Nodes (8): activateResident(), AuthSession, AppNavigator(), Stack, Props, ResidentActivationScreen(), styles, ResidentSOSScreen()
...
Cohesion: 0.67
Nodes (5): isValidReferralCode(), normalizeReferralCode(), parseReferralLink(), safeDecode(), valid()
...
Cohesion: 0.33
Nodes (3): DeletionQueue, DeletionRequest, PlatformAccountDeletionsPageContent
...
Cohesion: 0.6
Nodes (3): LoadState, DEFAULT_SITE_CONFIG, SiteConfig
...
## Knowledge Gaps
- **3688 isolated node(s):** `{ defineConfig }`, `expoConfig`, `{ getDefaultConfig }`, `{ withNativeWind }`, `config` (+3683 more)
...
- **Why does `Role` connect `Community 59` to `Community 0`, `Community 2`, `Community 4`, `Community 6`, `Community 11`, `Community 268`, `Community 269`, `Community 14`, `Community 16`, `Community 144`, `Community 19`, `Community 148`, `Community 283`, `Community 27`, `Community 29`, `Community 31`, `Community 34`, `Community 36`, `Community 37`, `Community 38`, `Community 295`, `Community 296`, `Community 40`, `Community 43`, `Community 46`, `Community 47`, `Community 174`, `Community 48`, `Community 186`, `Community 318`, `Community 319`, `Community 67`, `Community 68`, `Community 69`, `Community 196`, `Community 76`, `Community 78`, `Community 210`, `Community 212`, `Community 91`, `Community 93`, `Community 94`, `Community 249`, `Community 108`, `Community 110`, `Community 238`, `Community 247`, `Community 248`, `Community 121`, `Community 126`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 33` to `Community 0`, `Community 1`, `Community 5`, `Community 7`, `Community 8`, `Community 75`, `Community 12`, `Community 13`, `Community 108`, `Community 45`, `Community 49`, `Community 50`, `Community 54`, `Community 55`, `Community 28`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 17` to `Community 2`, `Community 4`, `Community 132`, `Community 6`, `Community 9`, `Community 11`, `Community 139`, `Community 143`, `Community 19`, `Community 20`, `Community 21`, `Community 152`, `Community 27`, `Community 29`, `Community 31`, `Community 160`, `Community 289`, `Community 34`, `Community 161`, `Community 36`, `Community 162`, `Community 166`, `Community 38`, `Community 40`, `Community 167`, `Community 168`, `Community 43`, `Community 41`, `Community 45`, `Community 39`, `Community 46`, `Community 48`, `Community 35`, `Community 178`, `Community 179`, `Community 58`, `Community 37`, `Community 62`, `Community 63`, `Community 64`, `Community 67`, `Community 196`, `Community 69`, `Community 70`, `Community 68`, `Community 72`, `Community 73`, `Community 87`, `Community 88`, `Community 91`, `Community 221`, `Community 94`, `Community 95`, `Community 96`, `Community 225`, `Community 93`, `Community 98`, `Community 105`, `Community 106`, `Community 107`, `Community 111`, `Community 119`, `Community 124`?**
