...
## Corpus Check
- 2315 files · ~4,838,943 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18574 nodes · 52111 edges · 593 communities (559 shown, 34 thin omitted)
...
## Communities (593 total, 34 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (310): POST(), GET(), PATCH(), POST(), RouteContext, GET(), POST(), GET() (+302 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (320): openStore(), NightStatusPromptCard(), loadFinance(), ActivationIssue, addCook(), addEmergencyContact(), addHostelPhoto(), addResidentGuardian() (+312 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (304): DeletionPanel(), NotificationSettings(), SETTINGS_TITLES, THEME_OPTIONS, LoginScreen(), METHODS, PackageCard(), PayStep() (+296 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (244): Scanner(), CookInviteScreen(), GuardianInviteScreen(), MapScreen(), CallableRow(), IdentityCard(), PeopleSection(), SavedHostelsScreen() (+236 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (174): ICONS, LABELS, Segment, TONES, FILTERS, Pending, Overview, MoneyData (+166 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (261): RouteContext, fileFieldCash(), getOrCreateSubscription(), POST(), GET(), GET(), foodRoutineSaveSchema, GET() (+253 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (150): PlanPaymentClaim, DeletionPathway, DeletionStatus, PATHWAY_COPY, csvField(), deferLoad(), DemoDataBadge(), field() (+142 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (203): answerSchema, POST(), hostelCoverPhotos(), listMyBookings(), confirmComplaintResolution(), listResidentComplaints(), getOpenFeeSchedule(), getResidentFinanceView() (+195 more)
...
Cohesion: 0.02
Nodes (158): BubbleBackground(), BubbleBackgroundProps, BubbleColors, StarLayer(), StarLayerProps, StarsBackground(), StarsBackgroundProps, BrandWordmark() (+150 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (155): listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), getPlatformSubscriptionLedger(), listPlanPaymentClaims(), GET(), DELETE() (+147 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (160): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, runPlanDueReminders(), notifyHostelOfNewPost() (+152 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (157): getHostelPayoutAccount(), POST(), RouteContext, DELETE(), GET(), hostelId(), GET(), PATCH() (+149 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (152): FILTERS, invalidateFeeds(), NIGHT_ANSWER_LABELS, nightAnswerText(), NightPromptAnswer(), NotificationCard(), NotificationRow(), NotificationsScreen() (+144 more)

### Community 14 - "Community 14"
Cohesion: 0.01
Nodes (129): ATTENDANCE_DEFAULTS, adminPrincipal, mocks, PLATFORM_LIMITS, afterMidnight, evening, meters, mocks (+121 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (129): AdminTabs(), HIDDEN, RoleLayout(), TABS, AdminMoreScreen(), MANAGE_ROWS, PORTAL_ROWS, ActivateScreen() (+121 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (133): HostelAdminAttendancePageContent, HostelAdminCommunityPageContent, HostelAdminComplaintsPage, HostelAdminInquiriesPageContent, HostelAdminMaintenancePageContent, PRIORITIES, STATUS_ACTIONS, HostelAdminMoveChecklistPage (+125 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (118): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), dueWhen(), PlanDueInput (+110 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (155): MESSAGES, POST(), RouteContext, BookingEndCause, bookingPaymentVerifiedEmail(), HostelBookingClosedCause, announceConfirmed(), announceEnding() (+147 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (147): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), loadOverview(), AdminMoneyScreen(), loadMoney(), AdminTodayScreen(), loadToday() (+139 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (136): CommunityPageContent(), grabDocument(), HostelAdminBillingPageContent(), InvoiceRow(), PaymentRow(), PlanCard(), rupees(), shortDate() (+128 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (139): BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan, BillingSkip (+131 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (113): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), DocumentScreen(), MobileLegal (+105 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (131): PaymentMonthStrip(), ClearFilters(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard(), AmountCard() (+123 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (111): GetAppDialog(), Platform, GetPlanButton(), ConcessionBackfill, describeApplied(), FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent (+103 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (120): checkoutDocumentFor(), softmatoDocumentNumbers(), gateway, invoice, updateOne, documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument() (+112 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (110): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), manifest() (+102 more)
...
Cohesion: 0.03
Nodes (111): cookPrincipal, mocks, resolveCookLabels(), CookServiceError, resolveAdminHostelId(), announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord (+103 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (123): AdminCommunityReportsScreen(), AdminResidentsScreen(), AttendanceScreen(), NightStatusHistoryScreen(), NightStatusForm(), NightStatusScreen(), ProfileScreen(), ReferralRow() (+115 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (98): PATCH(), GET(), escapeRegex(), auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex(), HostelRecord, ListingFlagListQuery (+90 more)

### Community 31 - "Community 31"
Cohesion: 0.08
Nodes (68): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, LoadState, AnimatedPage() (+60 more)

### Community 32 - "Community 32"
Cohesion: 0.02
Nodes (89): summarizeResidentComplaints(), daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags (+81 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (89): GET(), POST(), POST(), ownerIdentitiesFor(), resolveOwnedHostel(), openSubscriptionCheckout(), getSubscriptionState(), invoiceIdFor() (+81 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (85): EMPTY_PAYOUT_DRAFT, METHODS, PayoutAccountDraft, PayoutAccountFields(), payoutAccountPayload(), cityOptions, createDocument(), createRoom() (+77 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (90): collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor() (+82 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (85): Entry, hostelEntries(), locationEntries(), sitemap(), STATIC_ROUTES, AuthLayout(), metadata, CityHostelsPage() (+77 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (81): BookingQuote, GuestBookingDetail, GuestBookingSummary, metadata, BookingCheckoutPage(), Method, METHODS, nextStep() (+73 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (88): demoteToPublicAccount(), returnHeldBed(), takeHeldBed(), LIVE_ACCESS, releaseGuardianAccounts(), CapacityError, claimBedForRoomType(), listAllRoomTypes() (+80 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (78): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), methodProvider(), PROVIDER_LABEL, QrPanel() (+70 more)
...
Cohesion: 0.03
Nodes (67): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, financeIntegrityHash(), GatewayHealth, GatewayHealthSummary, IntentCounts (+59 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (60): generateMetadata(), AuthShell(), AuthShellProps, PANEL_COPY, SiteWordmark(), metadata, AccountDeletionPanel, BrandMark() (+52 more)

### Community 43 - "Community 43"
Cohesion: 0.03
Nodes (77): qrActivationSchema, residentSchema, computeMonthlyDue(), creditVerifiedAmount(), currentMonth(), definedUpdate(), findAdminPayment(), findAdminResident() (+69 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (71): POST(), POST(), POST(), POST(), auditFinanceAction(), previousEntryHash(), periodOf(), runBillingCycleForAllHostels() (+63 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (39): InlineText(), EASE, PlanCards(), PlanLine(), PlansClosingCta(), PlansEditor, PlansFootnote(), PlansHeading() (+31 more)

### Community 46 - "Community 46"
Cohesion: 0.03
Nodes (67): normalize(), PortalSearch(), PortalTone, scoreEntry(), toneStyles, iconMap, IconName, NavItem (+59 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (79): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags() (+71 more)

### Community 48 - "Community 48"
Cohesion: 0.03
Nodes (72): ListingTierTone, PlanId, portalAccessLines(), Service, ServiceModule, ServiceModuleId, Faq, PlatformConfigSeoPageContent (+64 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (57): HostelBookingView, PayoutAccountForReview, ReviewPayoutAccount(), STATUS_LABEL, List(), ReasonAction(), Row(), timeLeft() (+49 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (67): BookableHostel, BookingUnavailableReason, findRoom(), hostelAddress(), HostelAvailability, hostelCoverPhoto(), hostelUnavailableReason(), loadBookableHostel() (+59 more)

### Community 51 - "Community 51"
Cohesion: 0.03
Nodes (47): ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, RETAINED_BY_HOSTEL_ID, both, covered (+39 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (67): noticeSchema, noticeReadStatusSchema, notificationSchema, platformPushScheduleSchema, announceChange(), audit(), CreateInput, createNoticePush() (+59 more)
...
Cohesion: 0.03
Nodes (65): FinanceAuditInput, assetId, body, call, hashCall, hostelId, input, invoiceId (+57 more)

### Community 55 - "Community 55"
Cohesion: 0.03
Nodes (61): approveClaim(), assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck(), evidenceCheck(), fileCheck() (+53 more)

### Community 56 - "Community 56"
Cohesion: 0.05
Nodes (61): notifyProviderOfAssignment(), notifyProviderOfMaintenanceNote(), notifyProviderOfStatusChange(), notifyStaffOfNewMaintenanceRequest(), providerUserId(), readableCategory(), RequestLike, STATUS_WORDS (+53 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (69): addBsMonths(), BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsMonthStart(), bsPeriodBounds() (+61 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (56): deviceTokenSchema, pushTicketSchema, authHeaders(), chunk(), ExpoReceipt, fetchReceipts(), isConfigurationFailure(), ReceiptSweepResult (+48 more)
...
Cohesion: 0.05
Nodes (59): GET(), POST(), GET(), GET(), POST(), acceptPlatformAdminInvitation(), AcceptPlatformAdminInvitationInput, appUrl() (+51 more)

### Community 61 - "Community 61"
Cohesion: 0.04
Nodes (48): HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminRoomsPageContent(), PlatformDashboardPageContent(), PlatformHostelReviewPageContent(), PlatformUsersPageContent(), DashboardCard(), DashboardCardProps (+40 more)

### Community 62 - "Community 62"
Cohesion: 0.05
Nodes (54): COLUMNS, Member, MemberData, RegistrationTrackSheet(), TrackSheetLoader(), cellAt(), focusCell(), Props (+46 more)

### Community 63 - "Community 63"
Cohesion: 0.07
Nodes (49): bodySchema, POST(), POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind() (+41 more)
...
Cohesion: 0.06
Nodes (57): Assurance(), fill(), money(), PlanCard(), PricingScreen(), UpgradeDialog(), BillingToggle(), listHeadingFor() (+49 more)

### Community 66 - "Community 66"
Cohesion: 0.06
Nodes (57): BS_MONTHS, formatPeriodKey(), cellAt(), focusCell(), INPUT_MODES, Props, fullYear(), MONTH_SPELLINGS (+49 more)

### Community 67 - "Community 67"
Cohesion: 0.05
Nodes (50): addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine, formatWeekRange(), HostelAdminFoodPage (+42 more)

### Community 68 - "Community 68"
Cohesion: 0.06
Nodes (59): AMOUNT_LABELS, canonical(), canonicalDigits(), containsWithTolerance(), deadline(), DIGIT_CONFUSABLES, EvidenceRead, evidenceTextFlags() (+51 more)

### Community 69 - "Community 69"
Cohesion: 0.07
Nodes (48): appBaseUrl(), authenticateWithGoogle(), CLAIMABLE_STATUSES, dispatchOtpChallenge(), dispatchVerificationEmail(), findVerifiedRegistrationChallenge(), GOOGLE_JWKS, normalizeEmail() (+40 more)

### Community 70 - "Community 70"
Cohesion: 0.05
Nodes (39): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse (+31 more)

### Community 71 - "Community 71"
Cohesion: 0.06
Nodes (46): POST(), RouteContext, listTrendingTags(), POST(), safeEqual(), sponsorSchema, ClickRecord, dayKey() (+38 more)

### Community 72 - "Community 72"
Cohesion: 0.05
Nodes (55): continueLabel(), isBlank(), buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, draftFromProfile() (+47 more)

### Community 73 - "Community 73"
Cohesion: 0.05
Nodes (40): BookButton(), SIZE, BookingAvailabilityView, BookingButton, CLOSED_REASONS, open, formatHostelAddress(), hasFood() (+32 more)

### Community 74 - "Community 74"
Cohesion: 0.04
Nodes (48): account, answerBy, before, book(), Booking, compact, confirmed(), Consent (+40 more)

### Community 75 - "Community 75"
Cohesion: 0.06
Nodes (46): notifyResidentOfComplaintReply(), addComplaintUpdate(), assertComplaintVoiceNote(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren() (+38 more)

### Community 76 - "Community 76"
Cohesion: 0.08
Nodes (46): BOOKING_DOCUMENT_KINDS, BookingDocumentKind, bookingDocumentLayout(), refundPolicyNotes(), allowed(), bookingDocumentResponse(), BookingDocumentScope, resolveBookingDocument() (+38 more)

### Community 77 - "Community 77"
Cohesion: 0.07
Nodes (52): personalLookupHash(), getPresignedReadUrl(), userResidentProfileSchema, findLiveResidency(), LEGACY_ROLE_MAP, Role, ROLE_VALUES, CARD_LABELS (+44 more)

### Community 78 - "Community 78"
Cohesion: 0.06
Nodes (31): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, metadata, LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage() (+23 more)
...
Cohesion: 0.06
Nodes (49): AMOUNT_ALIASES, CREDIT_ALIASES, readMoney(), DATE_ALIASES, DEBIT_ALIASES, NAME_ALIASES, nonZero(), readMoney() (+41 more)
...
Cohesion: 0.06
Nodes (35): AuthGuard(), HostelSuggestions(), PublicHostel, checkOnly(), EMPTY_PREFILL, ENVIRONMENT_OPTIONS, IdentityResponse, Prefill (+27 more)

### Community 84 - "Community 84"
Cohesion: 0.08
Nodes (36): asRecord(), DrawnPush, readDrawnPush(), message, pushData, NativeNightPrompt, takeNativePendingAnswers(), isNightStatusPrompt() (+28 more)

### Community 85 - "Community 85"
Cohesion: 0.04
Nodes (41): since(), defaultDueDate(), DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), axisMonth() (+33 more)

### Community 86 - "Community 86"
Cohesion: 0.08
Nodes (41): AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput, ConsentInput, dayKey() (+33 more)

### Community 87 - "Community 87"
Cohesion: 0.07
Nodes (41): useGuidance(), hasGeolocation(), LocationOutcome, NavigationFix, OrientationPermission, requestDeviceLocation(), requestHeadingPermission(), Unsubscribe (+33 more)
...
Cohesion: 0.1
Nodes (37): PreviewCard(), ResultRow(), FACILITY_ICONS, facilityIcon(), facilityKey(), HostelCard(), SaveButton(), HeadCell() (+29 more)
...
Cohesion: 0.16
Nodes (28): POST(), POST(), AuthServiceError, changePassword(), logout(), POST(), POST(), loginGuardian() (+20 more)

### Community 97 - "Community 97"
Cohesion: 0.05
Nodes (30): categoryLabel(), PROVIDER_CATEGORIES, ProviderCard(), ProviderDirectoryData, PublicProvider, PublicServiceProviderDirectoryPage(), CATEGORIES, isApplicationOpen() (+22 more)

### Community 98 - "Community 98"
Cohesion: 0.05
Nodes (40): assets, bucket, commentedEnv(), copyObject(), dirname, existsAtSource(), existsAtTarget(), failures (+32 more)
...
Cohesion: 0.07
Nodes (34): discountRent(), getRentConcession(), hostelCalendarDay(), hostelMonthStart(), hostelToday(), once, isActiveReferralCode(), aswinLastDay (+26 more)
...
Cohesion: 0.08
Nodes (37): GATEWAY_ORDER, getHostelPayMethods(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice() (+29 more)

### Community 103 - "Community 103"
Cohesion: 0.06
Nodes (33): metadata, CheckoutHandoffButton(), Handoff, ORDER, ProgressStep, ProgressSteps(), TransitionScreen(), useCheckoutHandoff() (+25 more)

### Community 104 - "Community 104"
Cohesion: 0.08
Nodes (36): CampaignListQuery, CampaignRecord, createCampaign(), createHostelNotificationCampaign(), dispatchCampaign(), HostelCampaignInput, listHostelNotificationCampaigns(), normalizeObjectId() (+28 more)
...
Cohesion: 0.09
Nodes (36): Compass(), Guidance, GuidanceStatus, NavigationFix, watchDeviceHeading(), watchNavigationPosition(), cardinalFor(), CARDINALS (+28 more)

### Community 109 - "Community 109"
Cohesion: 0.06
Nodes (35): findIndex(), index, indexesOf(), IndexSpec, promote, monthsBetween(), periodOf(), ResidentDoc (+27 more)

### Community 110 - "Community 110"
Cohesion: 0.1
Nodes (35): nepalMinuteOfDay(), nightStatusPromptSchema, askingEndsMinuteOfNight(), formatPromptTime(), isCurrentNight(), isSameNight(), minuteIsDue(), minuteOfNight() (+27 more)

### Community 111 - "Community 111"
Cohesion: 0.08
Nodes (30): GET(), querySchema, focusSchema, POST(), assertTeamRegistrationIsNew(), checkTeamOwnerEmail(), findHostelUsingEmail(), hostelNameKey() (+22 more)

### Community 112 - "Community 112"
Cohesion: 0.06
Nodes (26): currency(), Input(), Select(), ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent, Complaint (+18 more)
...
Cohesion: 0.08
Nodes (29): FeedPayload, NewPostAlertsToggle(), SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES, avatarTone() (+21 more)
...
Cohesion: 0.06
Nodes (33): aswin, bhadra, bs(), card(), currentId, hostelId, inAswin, inOctober (+25 more)

### Community 117 - "Community 117"
Cohesion: 0.06
Nodes (23): Panel(), TextArea(), field(), HostelAdminMaintenancePageContent(), HostelAdminReferralsPageContent(), HostelAdminReportsPageContent(), ListingFlag, LoadState (+15 more)
...
Cohesion: 0.07
Nodes (27): EvidenceEngine, EvidenceEngineMode, EvidenceReadFailure, OcrResult, OcrWord, KEYS, saved, IMAGE (+19 more)

### Community 121 - "Community 121"
Cohesion: 0.07
Nodes (30): attacker, attempt(), headers, jsonRequest(), routeMocks, generateOtpCode(), hashOtpCode(), normalizeOtpIdentifier() (+22 more)

### Community 122 - "Community 122"
Cohesion: 0.09
Nodes (32): Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity() (+24 more)
...
Cohesion: 0.08
Nodes (24): Choice, HOSTEL_TYPE_LABELS, HostelPanel(), MapButton(), MapCanvas, ModeTab(), NavigationPanel(), NOTHING_CHOSEN (+16 more)
...
Cohesion: 0.1
Nodes (28): NearbyStatus, Coordinates, haversineMeters(), hostelCoordinates(), HostelWithDistance, isUsableCoordinate(), KATHMANDU, sortByDistance() (+20 more)

### Community 130 - "Community 130"
Cohesion: 0.12
Nodes (28): CsvTable, gridFromCsv(), readCsv(), stripBom(), stripPreamble(), ESEWA_PARSER, [first], FIXTURES (+20 more)
...
Cohesion: 0.07
Nodes (22): LegacyHostelAdminComplaintsPage(), Complaint, ComplaintSummary, EmptyState(), field(), FoodMenu, HostelAdminComplaintsPage(), HostelAdminFoodPage() (+14 more)
...
Cohesion: 0.09
Nodes (23): dayLabel(), foodFacts(), leadDay(), ROUTINE_DAYS, ROUTINE_MEALS, RoutineDay, routineDays(), days (+15 more)
...
Cohesion: 0.07
Nodes (22): EASE, FaqEntry, FaqRole, FaqRow(), FAQS, PREVIEW_ROWS, PREVIEWS, ROLES (+14 more)
...
Cohesion: 0.13
Nodes (29): softmatoDocsUrl(), dueBhadra29, filed, throughAswin25, BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan (+21 more)
...
Cohesion: 0.1
Nodes (25): CreditClassification, peekHeaders(), ESEWA_CSV_PARSER, both, corrupted, debit, [first], FIXTURE (+17 more)
...
Cohesion: 0.12
Nodes (21): otpResendCooldownMs(), fail(), findHostelForCheckout(), HostelMatch, paymentState(), PlanCheckoutInput, planCheckoutSchema, readCheckoutToken() (+13 more)
...
Cohesion: 0.12
Nodes (23): directionOf(), EMPTY_TALLY, floorToStep(), phaseOf(), tallyUploads(), active, done, down() (+15 more)

### Community 161 - "Community 161"
Cohesion: 0.1
Nodes (21): formatDistance(), hostelCoordinates(), isUsableCoordinate(), KATHMANDU, fetchRoadRoute(), isRecord(), parseRoadRoute(), parseSteps() (+13 more)
...
Cohesion: 0.09
Nodes (22): BALANCE_ALIASES, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES, WITHDRAWAL_ALIASES (+14 more)
...
Cohesion: 0.15
Nodes (22): getCurrentUser(), isApprovedServiceProvider(), issueSessionForUser(), login(), publicUser(), refreshAccessToken(), sameIds(), AuthTokenPayload (+14 more)

### Community 170 - "Community 170"
Cohesion: 0.12
Nodes (19): approvalPeriod(), getPeriodSummary(), monthsBetween(), periodOf(), PeriodRow, PeriodSummary, august, bhadra (+11 more)

### Community 171 - "Community 171"
Cohesion: 0.11
Nodes (17): DEPRECATED_ALIASES, grantingPermissionKeys(), mocks, GET(), POST(), listHostelWardens(), DEFAULT_WARDEN_PERMISSIONS, DEPRECATED_WARDEN_PERMISSION_KEYS (+9 more)
...
Cohesion: 0.14
Nodes (20): assertQrAssetUsable(), EMPTY, PaymentProfileView, ProfileDocument, readQrPayeeFields(), TEXT_FIELDS, updatePaymentProfile(), PaymentProfileUpdateInput (+12 more)
...
Cohesion: 0.13
Nodes (19): hostelOrThrow(), notifyPlatformOfPayoutReview(), PayoutAccountStatus, PayoutAccountView, PayoutActor, PayoutRecord, revealHostelPayoutAccount(), reviewHostelPayoutAccount() (+11 more)
...
Cohesion: 0.11
Nodes (11): TYPE_COLORS, DraggablePinMap, FALLBACK_CENTER, LocationPicker(), LocationPickerValue, PART_LABELS, AddressParts, Coordinates (+3 more)

### Community 186 - "Community 186"
Cohesion: 0.13
Nodes (13): secretsMatch(), ENDPOINTS, parseAmount(), SIGNED_FIELDS, BASE_URLS, GatewayCredentials, GatewayProvider, IntentHandoff (+5 more)
...
Cohesion: 0.13
Nodes (20): detectProvider(), headlineAmount(), labelledValue(), looksLikeStatement(), ParsedReceipt, parseReceipt(), ReceiptProvider, ReceiptShape (+12 more)
...
Cohesion: 0.13
Nodes (16): buildHtml(), Marker, PlaceMarker, boundsCenter(), groupNearbyPlaces(), humanizeNearbyType(), NEARBY_GLYPHS, NEARBY_GROUPS (+8 more)

### Community 192 - "Community 192"
Cohesion: 0.12
Nodes (19): buildPage(), buildPinPage(), CentrePin(), describeAddress(), HostelPinField(), HostelPinPicker(), KATHMANDU, MapLinkField() (+11 more)
...
Cohesion: 0.12
Nodes (17): AccountRow, askingAccount(), declineResidencyInvite(), findResidencyInvite(), LIVE, OPEN_INVOICES, ResidencyInvite, ResidencyInviteError (+9 more)
...
Cohesion: 0.17
Nodes (17): systemDocumentKindFromText(), formatNPR(), drawCertificationStamp(), footerLine(), formatDate(), formatLongDate(), MONTHS, ReceiptPdfInput (+9 more)
...
Cohesion: 0.14
Nodes (14): applyConcessionToIssuedInvoices(), ConcessionBackfill, EMPTY, InvoiceLine, settledAmountOf(), bill, hostelId, lean() (+6 more)
...
Cohesion: 0.15
Nodes (14): activateResident(), requestOtp(), signInWithGoogle(), submitResidentReview(), RootStackParamList, Props, Props, ResidentActivationScreen() (+6 more)
...
Cohesion: 0.18
Nodes (15): Choice, maneuverIcon(), MapButton(), ModeTab(), NavCard(), NOTHING_CHOSEN, RouteCard(), MapExplorer (+7 more)
...
Cohesion: 0.11
Nodes (17): FACILITY_OPTIONS, HOSTEL_PLANS, HOSTEL_STEPS, HOSTEL_TYPES, HostelAttachment, HostelErrors, HostelRegisterPayload, HostelStepKey (+9 more)
...
Cohesion: 0.18
Nodes (16): Attendance / Night Safety, code:typescript (interface INightStatusLog {), code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface INotice {), code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {), Food (+8 more)
...
Cohesion: 0.15
Nodes (11): AuthSession, getResidentProfile(), triggerSOS(), AppNavigator(), Stack, LoginScreen(), Profile, Props (+3 more)
...
Cohesion: 0.18
Nodes (14): 6.1 Service Provider Registration Received, 6.3 Service Provider Rejected, 6. Service Provider Emails, 7.1 New Hostel Pending Approval (to Superadmin), 7.2 Subscription Expiring Soon, 7. Platform Admin Emails, 8.1 Community Post Engagement (Batched), 8. Community & Notification Emails (+6 more)
...
Cohesion: 0.18
Nodes (13): buildHostelPayload(), capacitySummary(), firstIncompleteHostelStep(), hasHostelErrors(), hasUsableRooms(), hostelStepErrors(), isHostelStepComplete(), numberValue() (+5 more)
...
Cohesion: 0.27
Nodes (12): shouldRepost(), UploadNotice, apply(), drain(), ensureChannel(), onQueueChanged(), pending, readPermission() (+4 more)
...
Cohesion: 0.17
Nodes (13): 4.3 Complaint Resolved, 5.1 SOS Triggered, 5. Safety & Emergency Emails, 6.2 Service Provider Approved, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 7.1 Attendance Alert (Resident Absent), 7. Attendance & Location Tracking Emails, code:typescript ({) (+5 more)
...
Cohesion: 0.23
Nodes (10): documents, hostelForm(), many, parsed, result, emptyHostelForm(), emptyRoomRow(), HostelForm (+2 more)
...
Cohesion: 0.23
Nodes (10): PUBLIC_CACHE, resetEmailIdentityCache(), getPublicSiteConfig(), getSiteConfig(), updateSiteConfigSection(), isSiteConfigSection(), getPublicPlatformStats(), PUT() (+2 more)
...
Cohesion: 0.27
Nodes (9): hashUserAgent(), HostelRef, newVisitorKey(), recordHostelPageView(), resolveVisitorKey(), hostelPageViewSchema, evaluateProfilePrompt(), POST() (+1 more)
...
Cohesion: 0.18
Nodes (11): 6.1 Multi-Tenant Isolation ⭐ HIGHEST PRIORITY, 6.2 Auth & Account-Upgrade Logic ⭐ CRITICAL, 6.3 Role-Based Access Control (Every Endpoint), 6.4 Payments, 6.5 Privacy-Sensitive Views, 6.6 Business-Rule Constraints, 6.7 Audit Logging, 6. What Must Be Tested (Non-Negotiable) (+3 more)
...
Cohesion: 0.24
Nodes (10): 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails, code:typescript ({), code:typescript ({) (+2 more)

### Community 377 - "Community 377"
Cohesion: 0.22
Nodes (10): 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.3 Hostel Rejected, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, code:typescript ({), code:typescript ({), code:block14 (---) (+2 more)
...
Cohesion: 0.27
Nodes (10): 4. Commands, Backend Tests, code:bash (npm run web:test), code:bash (npm --prefix apps/web run test:watch), code:bash (npm --prefix apps/web run test -- attendance-zone), code:bash (npm --prefix apps/web run typecheck), Frontend/Web Tests, Not yet wired up (+2 more)
...
Cohesion: 0.25
Nodes (8): 3.3 Payment Proof Uploaded (to Admin), 4.1 New Notice Posted, 4.2 Complaint Status Updated, 4. Resident Activity Emails, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({)
...
Cohesion: 0.33
Nodes (7): 7.1 Multi-Tenant Isolation Test Template, 7.2 Role Gate Test Template, 7.5 Payment Precision Test Template, 7. Mandatory Test Templates, code:typescript (describe('GET /api/v1/hostel/rooms/:id - tenant isolation', ), code:typescript (describe('GET /api/v1/hostel/rooms - role access', () => {), code:bash (npm run web:lint)
...
Cohesion: 0.33
Nodes (3): esewaProvider, adapters, SHIPPED
...
## Knowledge Gaps
- **6498 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+6493 more)
...
- **Why does `Button()` connect `Community 4` to `Community 1`, `Community 2`, `Community 3`, `Community 133`, `Community 6`, `Community 8`, `Community 9`, `Community 13`, `Community 15`, `Community 16`, `Community 19`, `Community 22`, `Community 23`, `Community 24`, `Community 39`, `Community 40`, `Community 42`, `Community 46`, `Community 185`, `Community 192`, `Community 65`, `Community 67`, `Community 79`, `Community 229`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 9` to `Community 4`, `Community 132`, `Community 6`, `Community 8`, `Community 137`, `Community 136`, `Community 15`, `Community 16`, `Community 20`, `Community 24`, `Community 26`, `Community 154`, `Community 31`, `Community 34`, `Community 36`, `Community 37`, `Community 42`, `Community 45`, `Community 46`, `Community 49`, `Community 305`, `Community 61`, `Community 62`, `Community 65`, `Community 66`, `Community 67`, `Community 73`, `Community 82`, `Community 83`, `Community 213`, `Community 94`, `Community 95`, `Community 97`, `Community 99`, `Community 103`, `Community 114`, `Community 117`, `Community 126`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 7` to `Community 0`, `Community 5`, `Community 10`, `Community 11`, `Community 139`, `Community 12`, `Community 14`, `Community 145`, `Community 18`, `Community 149`, `Community 21`, `Community 25`, `Community 28`, `Community 30`, `Community 32`, `Community 33`, `Community 162`, `Community 35`, `Community 36`, `Community 292`, `Community 166`, `Community 38`, `Community 41`, `Community 170`, `Community 43`, `Community 44`, `Community 169`, `Community 174`, `Community 47`, `Community 48`, `Community 50`, `Community 178`, `Community 51`, `Community 52`, `Community 54`, `Community 55`, `Community 56`, `Community 53`, `Community 58`, `Community 60`, `Community 62`, `Community 63`, `Community 195`, `Community 196`, `Community 69`, `Community 71`, `Community 75`, `Community 76`, `Community 77`, `Community 78`, `Community 335`, `Community 80`, `Community 86`, `Community 216`, `Community 217`, `Community 88`, `Community 92`, `Community 96`, `Community 100`, `Community 102`, `Community 104`, `Community 105`, `Community 235`, `Community 109`, `Community 110`, `Community 111`, `Community 121`, `Community 123`?**
...
- **What connects `iosUrlScheme`, `{ defineConfig }`, `expoConfig` to the rest of the system?**
  _6498 weakly-connected nodes found - possible documentation gaps or missing edges._