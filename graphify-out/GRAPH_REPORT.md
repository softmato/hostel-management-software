# Graph Report - hostel-management-software  (2026-09-13)

## Corpus Check
- 1966 files · ~3,601,904 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15738 nodes · 43294 edges · 524 communities (499 shown, 25 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 695 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 635 edges
2. `successResponse()` - 616 edges
3. `connectToDatabase()` - 437 edges
4. `useAppTheme()` - 382 edges
5. `cn()` - 288 edges
...
## Communities (524 total, 25 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (265): RouteContext, POST(), getOrCreateSubscription(), getSubscriptionState(), selectPlan(), POST(), GET(), getOpenFeeSchedule() (+257 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (183): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel() (+175 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (166): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), SETTINGS_TITLES, THEME_OPTIONS, AlertRow(), needsResident() (+158 more)
...
Cohesion: 0.02
Nodes (237): AdminCommunityReportsScreen(), FILTERS, Pending, loadOverview(), loadMoney(), loadToday(), ReportedPostCard(), loadFinance() (+229 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (178): Scanner(), FaqRow(), MethodCard(), CookInviteScreen(), GuardianInviteScreen(), PreviewCard(), Assurance(), SavedListRow() (+170 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (146): LegacyHostelAdminAttendancePage(), BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan, LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), field() (+138 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (179): POST(), GET(), POST(), PATCH(), getAttendanceConfig(), getAttendanceSettings(), resolveAdminHostelId(), updateAttendanceSettings() (+171 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (169): GET(), POST(), GET(), listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), readReturnState() (+161 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (116): Overview, MANAGE_ROWS, PORTAL_ROWS, AdminResidentsScreen(), TodayData, DeniedNotice(), AdminRollCallCard(), GuardianNotShared() (+108 more)
...
Cohesion: 0.02
Nodes (139): AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput, ConsentInput, dayKey() (+131 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (131): POST(), GET(), POST(), POST(), POST(), POST(), listAttendanceAlerts(), POST() (+123 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (152): formatBsPeriod(), formatBsPeriodMonth(), formatBsPeriodYear(), isBsPeriod(), periodParts(), PaymentMonthStrip(), ManageRatesScreen(), ClearFilters() (+144 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (127): PATCH(), RouteContext, GET(), POST(), RouteContext, PATCH(), RouteContext, GET() (+119 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (131): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply() (+123 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (135): AttendanceScreen(), CallableRow(), IdentityCard(), PeopleSection(), Person, ProfileScreen(), ReviewForm(), ReviewScreen() (+127 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (126): BootGate(), NotificationSettings(), BrandSplash(), RoleGate(), accentForAccount(), AccountShape, HomeRoute, resolveHome() (+118 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (113): BrandMark(), CommunityReportDialog(), REASONS, MonthOption(), BrowserPushRow(), ModerationButton(), CurrentUser, MeResponse (+105 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (91): ComparePage(), hostels, metadata, rows, AuthExperiencePage(), csvField(), field(), Hostel (+83 more)
...
Cohesion: 0.07
Nodes (91): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), subscriptionClaimReceivedEmail(), subscriptionClaimRejectedEmail() (+83 more)
...
Cohesion: 0.03
Nodes (122): AdminMoreScreen(), ActivateScreen(), MapScreen(), NightStatusForm(), NightStatusScreen(), FILTERS, NotificationCard(), NotificationRow() (+114 more)

### Community 24 - "Community 24"
Cohesion: 0.02
Nodes (94): ATTENDANCE_DEFAULTS, adminPrincipal, mocks, PLATFORM_LIMITS, afterMidnight, evening, meters, mocks (+86 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (99): AdminCommunityScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+91 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (102): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, cookLoginStem(), generateCookPassword(), mintCookLogin(), pick() (+94 more)
...
Cohesion: 0.04
Nodes (98): CommunityScreen(), Composer(), CommunityBoard(), CommunityBoardProps, Composer(), SORTS, CommentThread(), CommunityPostCard() (+90 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (94): POST(), RouteContext, DELETE(), POST(), PaginationMeta, paginationQuerySchema, paginationRange(), querySchema (+86 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (102): GET(), getHostelViewStats(), hashUserAgent(), HostelRef, newVisitorKey(), recordHostelPageView(), resolveVisitorKey(), personalLookupHash() (+94 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (74): metadata, AccountDeletionPanel, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails() (+66 more)

### Community 32 - "Community 32"
Cohesion: 0.02
Nodes (83): HostelRegistrationProgress(), Milestone, milestoneIndex(), MILESTONES, PaymentPanel(), rupees(), SubscriptionState, cityOptions (+75 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (79): summarizeResidentComplaints(), daysFromNow(), enabledPermissionLabels(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags, GuardianPermissionsUpdateInput (+71 more)
...
Cohesion: 0.05
Nodes (85): SORTS, StoreCategoryScreen(), addToCart(), cancelStoreOrder(), Cart, CartLine, CartResult, CartTotals (+77 more)
...
Cohesion: 0.04
Nodes (82): AdminAlertsScreen(), ICONS, LABELS, Segment, TONES, AdminHomeScreen(), AdminOverviewScreen(), AdminMoneyScreen() (+74 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (80): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult (+72 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (78): robots(), documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt (+70 more)
...
Cohesion: 0.04
Nodes (65): POST(), dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, isMonthEnd(), mealsOn() (+57 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (52): demoteToPublicAccount(), GET(), RouteContext, POST(), RouteContext, findResidentOwnedAccess(), revokeGuardianAccess(), updateGuardianPermissions() (+44 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (66): Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity(), fromHeaderFor() (+58 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (51): AdminTabs(), HIDDEN, TABS, TABS, AdminAlertsProvider(), AvatarTabIcon(), RoleTabs(), TabDef (+43 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (69): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodBounds() (+61 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (59): notifyProviderOfAssignment(), notifyProviderOfStatusChange(), notifyStaffOfJobProgress(), notifyStaffOfNewMaintenanceRequest(), providerUserId(), readableCategory(), RequestLike, STATUS_WORDS (+51 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (58): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, AuthShell(), AuthShellProps, PANEL_COPY (+50 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (54): inferKind(), MediaLightbox(), PublicComparePage(), formatHostelAddress(), hasFood(), hostelTypeToUi(), mapPublicHostelToSummary(), PublicHostel (+46 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (55): EMPTY_SUMMARY, HostelAdminCooksPanel, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine (+47 more)
...
Cohesion: 0.04
Nodes (60): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, aswin, bhadra (+52 more)

### Community 56 - "Community 56"
Cohesion: 0.05
Nodes (53): PATCH(), POST(), RouteContext, GET(), outstandingForResident(), depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema (+45 more)
...
Cohesion: 0.06
Nodes (49): addComplaintUpdate(), assertComplaintVoiceNote(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput (+41 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (58): buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, draftFromProfile(), emptyIdentityDraft(), firstIncompleteIdentityStep() (+50 more)
...
Cohesion: 0.07
Nodes (46): POST(), getFoodRoutine(), addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange(), definedUpdate(), FoodFeedbackInput (+38 more)

### Community 67 - "Community 67"
Cohesion: 0.05
Nodes (44): Accordion(), BLOOD_OPTIONS, BUDGET_CHIPS, ContactStep(), continueLabel(), DatePickerField(), DIET_CHIPS, DIET_LABELS (+36 more)
...
Cohesion: 0.05
Nodes (38): EMPTY_DRAFT, HostelAdminPaymentProfilePageContent, PaymentProfile, SECTION_FIELDS, SectionId, BankMark(), EsewaMark(), KhaltiMark() (+30 more)

### Community 70 - "Community 70"
Cohesion: 0.06
Nodes (37): defaultDueDate(), DeliveryWindowFields(), formatPaisa(), number(), PlatformStorePageContent, StoreCategory, StoreProduct, StoreSettings (+29 more)

### Community 71 - "Community 71"
Cohesion: 0.07
Nodes (48): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags() (+40 more)

### Community 72 - "Community 72"
Cohesion: 0.06
Nodes (43): bsMonthStart(), FeeScheduleRecord, rateForRoomType(), monthsBetween(), periodOf(), ResidentDoc, ResidentLedger, ResidentLedgerMonth (+35 more)
...
Cohesion: 0.06
Nodes (43): paymentProofSchema, arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal (+35 more)
...
Cohesion: 0.06
Nodes (37): InvoiceHeaderBlock(), LedgerCard(), chargeDescriptions(), filterInvoices(), groupInvoicesByYear(), invoiceLedger(), InvoiceRowCopy, InvoiceYear (+29 more)

### Community 79 - "Community 79"
Cohesion: 0.09
Nodes (35): deleteHostelObjects(), r2Configured(), storePublicAsset(), AccessLevel, bucketForAccessLevel(), deleteFromR2(), generateFileKey(), getR2Client() (+27 more)

### Community 80 - "Community 80"
Cohesion: 0.07
Nodes (34): CachedConnection, globalForMongoose, ADMIN_ISSUABLE_ROLES, AdminIssuableRole, generateTemporaryPassword(), HIGH_PRIVILEGE_ROLES, loginUrl(), RegisterOrUpgradeInput (+26 more)
...
Cohesion: 0.07
Nodes (34): buildIdCardData(), EMAIL_CHECK_HINTS, EmailCheck, Field(), FIELD_LABELS, formatCardDate(), IdCardPanel(), identityPhotoUrl() (+26 more)
...
Cohesion: 0.08
Nodes (29): ratingReviewSchema, reviewModerationLogSchema, auditReviewAction(), averageOf(), createResidentReview(), hideReview(), listPlatformReviews(), listPublicHostelReviews() (+21 more)

### Community 89 - "Community 89"
Cohesion: 0.07
Nodes (33): RootShell(), AssetViewer(), useViewerState(), BottomChrome, BottomChromeContext, BottomChromeProvider(), CHROME_TIMING, usePush() (+25 more)
...
Cohesion: 0.06
Nodes (34): BANK_CSV_PARSER, ESEWA_CSV_PARSER, both, corrupted, debit, [first], FIXTURE, headerOnly (+26 more)
...
Cohesion: 0.08
Nodes (28): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, AddressFields, FORM_SECTIONS, HostelAdminProfilePageContent, PendingPhoto, PHOTO_LIMITS, SectionDef (+20 more)
...
Cohesion: 0.08
Nodes (32): ComplaintDetail(), ComplaintCard(), ACTOR_LABELS, actorLabel(), Complaint, COMPLAINT_CATEGORIES, COMPLAINT_STATUSES, ComplaintAttachment (+24 more)
...
Cohesion: 0.1
Nodes (31): NavigationFix, cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath(), formatManeuverDistance(), hasArrived() (+23 more)
...
Cohesion: 0.09
Nodes (25): GET(), querySchema, applicantSchema, billingCycleSchema, HostelRegistrationInput, hostelRegistrationSchema, registrationFields, RegistrationPlanChoice (+17 more)
...
Cohesion: 0.1
Nodes (31): ApiFailure, apiRequest(), ApiSuccess, AuthUser, getActivationStatus(), getResidentNightStatus(), listNotifications(), listResidentFood() (+23 more)
...
Cohesion: 0.12
Nodes (30): announceFoodReady(), startOfToday(), ROUTINE_DAYS, ROUTINE_MEAL_TYPES, RoutineDay, RoutineMealType, Candidate, dueMeals() (+22 more)
...
Cohesion: 0.09
Nodes (25): PaginationQuery, noticeReadStatusSchema, mocks, noticeInput, residentUserId, staffPrincipal, auditNoticeAction(), broadcastNotice() (+17 more)
...
Cohesion: 0.08
Nodes (27): countInvoicesByStatus(), fromLedgerRow(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor(), LedgerInvoice, LedgerInvoiceRow, LedgerScope (+19 more)

### Community 115 - "Community 115"
Cohesion: 0.11
Nodes (27): Compass(), cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath(), headingDifference(), instructionFor() (+19 more)
...
Cohesion: 0.06
Nodes (23): claimAmount, dirname, dueAmount, eventId, fractional, hostels, invoiceBalances, invoiceId (+15 more)
...
Cohesion: 0.1
Nodes (26): DownloadRow, DownloadStack(), progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster(), UploadRow (+18 more)
...
Cohesion: 0.12
Nodes (21): activateResident(), AuthSession, getResidentProfile(), AppNavigator(), RootStackParamList, Stack, LoginScreen(), Props (+13 more)
...
Cohesion: 0.11
Nodes (24): candidateFontDirs(), ensureIdCardFonts(), FONT_DIR_SEGMENTS, FONT_FILES, IdCardData, PlatformIdCardType, CardImages, renderIdCardPng() (+16 more)

### Community 127 - "Community 127"
Cohesion: 0.07
Nodes (28): announcementSchema, cap, contentHighlightSchema, ContentPage, contentPageSchema, ContentSection, contentSectionSchema, emailSchema (+20 more)
...
Cohesion: 0.11
Nodes (21): native, NativeDownloads, openDownloaded(), SavedDownload, registerNightStatusCategory(), KNOWN_PATHS, marksRoleChange(), resolvePushPath() (+13 more)

### Community 136 - "Community 136"
Cohesion: 0.13
Nodes (19): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, ImageVariantRecord (+11 more)
...
Cohesion: 0.17
Nodes (21): ProviderJobRow(), CATEGORY_ICONS, completedJobCount(), isOpenJob(), isOverdueJob(), jobActions(), jobAddress(), jobCategoryIcon() (+13 more)
...
Cohesion: 0.09
Nodes (21): approveMatchedStatement(), assignOrphanPayment(), ReconciliationView, StatementProvider, Bucket, BUCKET_ORDER, Buckets, DocumentPickerModule (+13 more)
...
Cohesion: 0.18
Nodes (23): CARD_NOUNS, CardVariant, drawBack(), drawBrandLockup(), drawFooterSweep(), drawFront(), drawHeaderSweep(), drawIdCard() (+15 more)
...
Cohesion: 0.12
Nodes (19): ResultRow(), buildHtml(), boundsCenter(), haversineMeters(), hostelCoordinates(), HostelWithDistance, isUsableCoordinate(), KATHMANDU (+11 more)
...
Cohesion: 0.16
Nodes (15): platformSettingSchema, DEFAULT_SITE_CONFIG, coerceSection(), getPublicSiteConfig(), getSiteConfig(), getSiteConfigSection(), PlatformSettingRecord, PublicSiteConfig (+7 more)
...
Cohesion: 0.16
Nodes (18): FileUploadArea(), FileUploadArea(), EXTENSION_BY_MIME, FAMILY_BYTES, FAMILY_ORDER, familyOf(), formatBytes(), joinTypes() (+10 more)
...
Cohesion: 0.16
Nodes (16): sitemap(), STATIC_ROUTES, listPublishedHostelSlugs(), loadSiteConfig, loadSiteName(), getListingTier(), getService(), listingTiers() (+8 more)
...
Cohesion: 0.13
Nodes (13): DeviceLocationStatus, formatDistance(), hostelCoordinates(), isUsableCoordinate(), KATHMANDU, hasGeolocation(), LocationOutcome, OrientationPermission (+5 more)
...
Cohesion: 0.12
Nodes (16): Plan, PlanId, Service, ServiceModule, ServiceModuleId, PLAN_MODULES, PLAN_SERVICES, PLAN_TIERS (+8 more)
...
Cohesion: 0.14
Nodes (16): Offset, PhotoCropper(), VideoSlot(), isActive(), UploadKind, FileUploader(), FileUploaderPresentation, FileUploaderProps (+8 more)
...
Cohesion: 0.2
Nodes (15): softmatoDocsUrl(), dueBhadra29, filed, throughAswin25, CYCLE_LABELS, daysLeftThrough(), daysSpanned(), daysUntil() (+7 more)
...
Cohesion: 0.14
Nodes (18): 2.3 Hostel Rejected, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.3 Payment Proof Uploaded (to Admin), 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, 4.1 New Notice Posted (+10 more)
...
Cohesion: 0.15
Nodes (12): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), MediaViewerProvider() (+4 more)
...
Cohesion: 0.23
Nodes (12): RoundButton(), VOICE_NOTE_RECORDING, VoiceNote, VoiceNoteRecorder(), formatDuration(), IDLE_HINTS, isUsableRecording(), READY_HINTS (+4 more)
...
Cohesion: 0.14
Nodes (14): Build status (end of Phase 3), Build status (end of Phase 5 — verified 2026-08-02), code:typescript (export enum Role {), Conventions, Cook Portal, DATABASE.md — Schema & Relationships, Enums, Hostel Configuration & Settings (+6 more)

### Community 248 - "Community 248"
Cohesion: 0.26
Nodes (15): AttendanceLog, AuditLog, code:typescript ({), code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({), code:typescript ({), FoodReadyLog (+7 more)
...
Cohesion: 0.29
Nodes (14): AttendanceAlert, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript (interface IQuestionCallClick {), code:typescript ({), code:typescript ({), Community Feature (+6 more)
...
Cohesion: 0.18
Nodes (13): 7.1 Multi-Tenant Isolation Test Template, 7.2 Role Gate Test Template, 7.3 Privacy/Guardian Permissions Test Template, 7.5 Payment Precision Test Template, 7. Mandatory Test Templates, 9.1 Seed Scripts, 9.2 Test Database Isolation, 9. Test Data & Seeding (+5 more)
...
Cohesion: 0.15
Nodes (8): breakfast, hostelId, other, routines, DAYS, foodRoutineSchema, MEALS, routineMealSchema
...
Cohesion: 0.17
Nodes (9): PublicHostelListingPageContent(), ComparisonStore, useComparisonStore, HostelFiltersState, HostelFiltersStore, initialHostelFilters, useHostelFiltersStore, UiStore (+1 more)
...
Cohesion: 0.25
Nodes (9): RosterSegment, rosterSegmentRows(), RosterSummary, searchResidents(), named(), resident(), rows, source (+1 more)
...
Cohesion: 0.18
Nodes (10): 5.1 SOS Triggered, 5. Safety & Emergency Emails, code:typescript ({), code:typescript ({), Email Opt-In/Opt-Out Matrix, EMAIL_SYSTEM.md — Email Triggers & Templates, Guardian Control, Implementation Checklist (+2 more)
...
Cohesion: 0.27
Nodes (9): DEFAULT_AUDIO_MIME_TYPES, DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, DEFAULT_VIDEO_MIME_TYPES, fileAssetLimits(), mimeList(), PLATFORM_ACCEPTED_MIME_TYPES, positiveInteger() (+1 more)
...
Cohesion: 0.31
Nodes (10): AccountDeletionRequest, code:typescript (interface IAccountDeletionRequest {), code:block43 (packages/db/migrations/), code:typescript ({), code:typescript (interface IAccountDeletionRequest {), code:block46 (packages/db/migrations/), Consent & Privacy, ConsentLog (+2 more)
...
Cohesion: 0.29
Nodes (6): CONTENT_ICON_SLUGS, everything, IDENTITY, page, rendered, contentSchema
...
Cohesion: 0.4
Nodes (4): Meter(), Reading, toneFor(), TONES
...
## Knowledge Gaps
- **5550 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+5545 more)
...
- **Why does `number()` connect `Community 70` to `Community 1`, `Community 3`, `Community 134`, `Community 8`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 17`, `Community 18`, `Community 20`, `Community 21`, `Community 23`, `Community 25`, `Community 27`, `Community 160`, `Community 32`, `Community 163`, `Community 42`, `Community 173`, `Community 47`, `Community 175`, `Community 52`, `Community 55`, `Community 58`, `Community 59`, `Community 188`, `Community 61`, `Community 189`, `Community 64`, `Community 67`, `Community 331`, `Community 82`, `Community 85`, `Community 109`, `Community 112`, `Community 117`, `Community 123`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 2` to `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 9`, `Community 13`, `Community 16`, `Community 18`, `Community 20`, `Community 150`, `Community 27`, `Community 28`, `Community 31`, `Community 32`, `Community 35`, `Community 36`, `Community 37`, `Community 171`, `Community 51`, `Community 52`, `Community 186`, `Community 67`, `Community 93`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 18` to `Community 1`, `Community 2`, `Community 3`, `Community 6`, `Community 134`, `Community 9`, `Community 19`, `Community 20`, `Community 22`, `Community 281`, `Community 27`, `Community 31`, `Community 32`, `Community 301`, `Community 50`, `Community 51`, `Community 54`, `Community 189`, `Community 73`, `Community 76`, `Community 204`, `Community 83`, `Community 84`, `Community 87`, `Community 101`, `Community 102`, `Community 119`, `Community 124`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Are the 432 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 432 INFERRED edges - model-reasoned connections that need verification._
- **Are the 6 inferred relationships involving `useAppTheme()` (e.g. with `CommunityPostCard()` and `MediaGrid()`) actually correct?**
  _`useAppTheme()` has 6 INFERRED edges - model-reasoned connections that need verification._
- **What connects `iosUrlScheme`, `{ defineConfig }`, `expoConfig` to the rest of the system?**
  _5550 weakly-connected nodes found - possible documentation gaps or missing edges._
