...
## Corpus Check
- 2230 files · ~3,386,158 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17794 nodes · 49952 edges · 564 communities (534 shown, 30 thin omitted)
...
## Communities (564 total, 30 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (198): ICONS, LABELS, Segment, TONES, FILTERS, Pending, Overview, MoneyData (+190 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (284): RouteContext, PATCH(), RouteContext, POST(), POST(), GET(), GET(), GET() (+276 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (289): AdminOverviewScreen(), loadOverview(), loadMoney(), loadToday(), AdminAlertsContext, AdminAlertsValue, AlertActions, EMPTY_COUNTS (+281 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (236): AdminMoreScreen(), ActivateScreen(), Scanner(), CookInviteScreen(), GuardianInviteScreen(), Choice, Compass(), MapButton() (+228 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (194): POST(), POST(), MESSAGES, POST(), RouteContext, GET(), POST(), POST() (+186 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (198): GET(), POST(), GET(), bookingDocumentResponse(), resolveBookingDocument(), checkoutSchema, POST(), DELETE() (+190 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (204): AdminCommunityScreen(), AdminTabs(), HIDDEN, RoleLayout(), TABS, AdminResidentsScreen(), FILTERS, invalidateFeeds() (+196 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (209): ReviewForm(), ReviewScreen(), BookingForm(), CheckoutScreen(), METHODS, PayStep(), StatusCard(), BookingScreen() (+201 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (137): PlanPaymentClaim, DemoDataBadge(), HostelTable(), Message(), GuardianDashboard, GuardianSafetyPageContent, MonthRow(), Payment (+129 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (171): POST(), POST(), answerSchema, POST(), attacker, attempt(), headers, jsonRequest() (+163 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (144): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CancelDeletionPageContent(), CommunityModerationPanel(), Filter, ModeratedPost (+136 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (193): GET(), announceConfirmed(), announceEnding(), assertAwaitingAnswer(), cancelBookingByHostel(), cancelBookingByPlatform(), cancelMyBooking(), confirmBooking() (+185 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (183): AdminAlertsScreen(), AdminCommunityReportsScreen(), AdminHomeScreen(), AdminTodayScreen(), AttendanceScreen(), NightStatusHistoryScreen(), NightStatusForm(), NightStatusScreen() (+175 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (165): setHostelBookingPause(), listPayoutAccounts(), GET(), POST(), DELETE(), PATCH(), RouteContext, GET() (+157 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (145): SosScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+137 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (160): PATCH(), POST(), RouteContext, GET(), POST(), POST(), GET(), POST() (+152 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (134): CommunityReportDialog(), REASONS, ConfirmOptions, MonthOption(), HostelPreviewLink(), BrowserPushRow(), FILTERS, Notification (+126 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (125): Notification, FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, monthStartPeriod(), Rate, RoomTypeOption, gregorianSpan() (+117 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (123): generateMetadata(), chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout() (+115 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (147): BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan, CommunityPageContent(), Badge(), grabDocument(), HostelAdminBillingPageContent() (+139 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (136): IdCardPrompt(), Point(), MockupCarousel(), MockupImage(), AttachmentRow(), ChipGroup(), FormSection(), PhotoStrip() (+128 more)
...
Cohesion: 0.03
Nodes (110): collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor() (+102 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (107): HostelAdminCommunityPageContent, HostelAdminComplaintsPage, HostelAdminFeePlansPageContent, HostelAdminInquiriesPageContent, HostelAdminMaintenancePageContent, PRIORITIES, STATUS_ACTIONS, HostelAdminNightStatusPage (+99 more)

### Community 25 - "Community 25"
Cohesion: 0.02
Nodes (115): AssetViewer(), openIdFor(), openIds, StripThumb(), useViewerState(), ViewerBody(), ViewerPage(), ClaimCard() (+107 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (107): openStore(), BootGate(), RootShell(), BrandSplash(), acknowledged, HostelSuspensionHost(), remainingLabel(), STAFF_ROLES (+99 more)

### Community 27 - "Community 27"
Cohesion: 0.02
Nodes (93): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, FinanceAuditInput, financeIntegrityHash(), FinanceServiceError, findIndex() (+85 more)

### Community 28 - "Community 28"
Cohesion: 0.07
Nodes (78): GenericPortalScreen(), portalRows(), portalTitle(), DASHBOARD_ROLES, FACILITY_ICONS, HOSTEL_TYPE_ICONS, TRUST_ICON_FALLBACKS, TRUST_ICONS (+70 more)

### Community 29 - "Community 29"
Cohesion: 0.02
Nodes (78): adminPrincipal, mocks, PLATFORM_LIMITS, authorUserId, leanResult(), mocks, postId, reactorUserId (+70 more)

### Community 30 - "Community 30"
Cohesion: 0.02
Nodes (72): absenceStreak(), ABSENT_ZONES, SettingsRecord, ATTENDANCE_DEFAULTS, AttendanceConfig, AttendanceZone, afterMidnight, evening (+64 more)
...
Cohesion: 0.03
Nodes (94): demoteToPublicAccount(), returnHeldBed(), takeHeldBed(), CapacityError, claimBedForRoomType(), listAllRoomTypes(), listAvailableRoomTypes(), loadConfigurations() (+86 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (74): AuthShell(), AuthShellProps, PANEL_COPY, SiteWordmark(), metadata, AccountDeletionPanel, ContentHeader(), ContentIntro() (+66 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (66): POST(), RouteContext, GET(), PATCH(), RouteContext, GET(), RouteContext, GET() (+58 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (78): addComplaintUpdate(), auditComplaintAction(), confirmComplaintResolution(), createComplaint(), findAdminComplaint(), replyToComplaint(), serializeComplaint(), updateComplaintStatus() (+70 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (72): BookButton(), SIZE, BookingAvailabilityView, BookingButton, CLOSED_REASONS, open, ComparePage(), generateMetadata() (+64 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (78): GuestBookingDetail, metadata, BookingCheckoutPage(), Method, METHODS, nextStep(), PayStep(), StatusCard() (+70 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (75): summarizeResidentComplaints(), listResidentInvoices(), daysFromNow(), enabledPermissionLabels(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags (+67 more)
...
Cohesion: 0.05
Nodes (84): notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus(), notifyTeamOfRequest(), daysBetween(), deliver(), DunningAction, DunningState (+76 more)

### Community 41 - "Community 41"
Cohesion: 0.03
Nodes (78): Faq, PlatformConfigSeoPageContent, Step, app, base, cleared, fill, html (+70 more)

### Community 42 - "Community 42"
Cohesion: 0.03
Nodes (66): PaginationMeta, PaginationQuery, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex(), HostelRecord, ListingFlagListQuery, ListingFlagRecord (+58 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (68): PATCH(), ProviderDirectoryData, GET(), escapeRegex(), objectIdSchema, paginationSchema, phoneSchema, notifyStaffOfJobProgress() (+60 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (63): HostelPhotoReminder(), cookLoginStem(), generateCookPassword(), mintCookLogin(), pick(), previousCookLabel(), acceptCookInvitation(), addCookAccount() (+55 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (64): ExpertConsultationCreateInput, ExpertConsultationError, ExpertConsultationRequestRecord, expertConsultationCreateSchema, HostelServiceError, hashUserAgent(), HostelRef, newVisitorKey() (+56 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (63): noticePushSchema, noticeReadStatusSchema, mocks, noticeInput, residentUserId, staffPrincipal, announceChange(), audit() (+55 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (56): EMPTY_SUMMARY, HostelAdminExistingResidentsPage(), addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine (+48 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (69): SORTS, addToCart(), cancelStoreOrder(), Cart, CartLine, CartResult, CartTotals, clearCart() (+61 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (67): fill(), money(), PlanCard(), PricingScreen(), PlanPicker(), TIER_TONE, BillingToggle(), EASE (+59 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (49): csvField(), deferLoad(), field(), Hostel, Inquiry, LoadState, numberField(), optionalField() (+41 more)
...
Cohesion: 0.05
Nodes (54): hostelPeriodOf(), existingResidentListSchema, existingResidentRowSchema, BillPreview, CheckContext, CheckedRow, checkExistingResidents(), CheckResult (+46 more)
...
Cohesion: 0.05
Nodes (63): BANK_CSV_PARSER, CsvTable, gridFromCsv(), peekHeaders(), readCsv(), stripBom(), stripPreamble(), ESEWA_CSV_PARSER (+55 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (67): BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodBounds(), bsPeriodOf() (+59 more)
...
Cohesion: 0.05
Nodes (58): notifyProviderOfAssignment(), notifyProviderOfMaintenanceNote(), notifyProviderOfStatusChange(), notifyStaffOfNewMaintenanceRequest(), providerUserId(), readableCategory(), RequestLike, STATUS_WORDS (+50 more)
...
Cohesion: 0.05
Nodes (62): BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan, BillingSkip (+54 more)
...
Cohesion: 0.05
Nodes (61): BALANCE_ALIASES, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES, WITHDRAWAL_ALIASES (+53 more)

### Community 62 - "Community 62"
Cohesion: 0.08
Nodes (57): documentDownloadUrl(), issueInvoiceDocument(), openCheckoutSession(), readSettledReceipt(), ownerIdentitiesFor(), resolveOwnedHostel(), deliver(), loadInvoiceById() (+49 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (48): HostelBookingView, PayoutAccountForReview, ReviewPayoutAccount(), STATUS_LABEL, DeletionPathway, DeletionStatus, PATHWAY_COPY, List() (+40 more)
...
Cohesion: 0.06
Nodes (55): auditFinanceAction(), previousEntryHash(), GATEWAY_ORDER, getHostelPayMethods(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions (+47 more)

### Community 66 - "Community 66"
Cohesion: 0.06
Nodes (54): DELETE(), POST(), CampaignListQuery, CampaignRecord, createCampaign(), createHostelNotificationCampaign(), createPlatformNotificationCampaign(), dispatchCampaign() (+46 more)
...
Cohesion: 0.05
Nodes (57): documents, hostelForm(), many, parsed, result, buildHostelPayload(), capacitySummary(), emptyHostelForm() (+49 more)

### Community 69 - "Community 69"
Cohesion: 0.07
Nodes (46): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, deleteHostelObjects() (+38 more)
...
Cohesion: 0.07
Nodes (48): POST(), getFoodRoutine(), getFoodRoutinesByHostelId(), saveFoodRoutine(), serializeRoutine(), addUtcDay(), auditFoodAction(), createFoodMenu() (+40 more)

### Community 74 - "Community 74"
Cohesion: 0.04
Nodes (44): assertComplaintVoiceNote(), attachFiles(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput, ComplaintListQuery, ComplaintRecord (+36 more)
...
Cohesion: 0.05
Nodes (39): HostelAdminInquiriesPageContent(), HostelAdminRoomsPageContent(), PlatformHostelReviewPageContent(), PlatformUsersPageContent(), DashboardCard(), DashboardCardProps, PlatformServiceProvidersPageContent(), PlatformHostelReviewPageContent (+31 more)
...
Cohesion: 0.05
Nodes (42): DEPRECATED_ALIASES, mocks, ADMIN_ISSUABLE_ROLES, AdminIssuableRole, generateTemporaryPassword(), HIGH_PRIVILEGE_ROLES, loginUrl(), RegisterOrUpgradeInput (+34 more)

### Community 79 - "Community 79"
Cohesion: 0.05
Nodes (38): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse (+30 more)
...
Cohesion: 0.06
Nodes (34): FINANCE_ERROR_STATUS, FinanceErrorCode, ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, attempt, fetchMock (+26 more)
...
Cohesion: 0.06
Nodes (23): LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminResidentsPage(), redirectToWorkspaceScreen() (+15 more)
...
Cohesion: 0.07
Nodes (32): IssuedInvoice, OpenedCheckout, SettledReceipt, applyWebhook(), WebhookResult, checkoutReturnUrl(), OpenCheckoutInput, openSoftmatoCheckout() (+24 more)
...
Cohesion: 0.05
Nodes (28): EASE, FaqEntry, FaqRole, FaqRow(), FAQS, PREVIEW_ROWS, PREVIEWS, ROLES (+20 more)

### Community 94 - "Community 94"
Cohesion: 0.06
Nodes (34): notifyHostelOfNewPost(), resolveHostelCommunityUserIds(), usersMutingNewPosts(), notifyKitchenOfFoodFeedback(), notifyKitchenOfRoutineChange(), resolveHostelCookUserIds(), cookAccountSchema, AddedResident (+26 more)

### Community 95 - "Community 95"
Cohesion: 0.08
Nodes (38): POST(), deviceTokenSchema, notificationSchema, input, mocks, userId, asRecord(), createOrUpdateBatchedNotification() (+30 more)

### Community 96 - "Community 96"
Cohesion: 0.07
Nodes (35): cookPrincipal, mocks, resolveCookLabels(), cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError, decodePhotoCursor() (+27 more)

### Community 97 - "Community 97"
Cohesion: 0.07
Nodes (30): getPlatformBooking(), findResidentOwnedAccess(), revokeGuardianAccess(), updateGuardianPermissions(), purgeArchivedHostel(), purgeHostel(), DELETE(), GET() (+22 more)

### Community 98 - "Community 98"
Cohesion: 0.08
Nodes (35): mergeBookingConfig(), GET(), POST(), PLATFORM_SETTING_CHANGE_STATUSES, platformSettingChangeSchema, GET(), PUT(), nextReceiptNumber() (+27 more)
...
Cohesion: 0.08
Nodes (37): HostelScope, ResolvedDocument, resolveInvoiceDocument(), resolveReceiptDocument(), scopeFilter(), settledTotal(), trySoftmato(), InvoiceDocumentInput (+29 more)
...
Cohesion: 0.07
Nodes (33): NoticeArt(), createNoticePush(), deleteNoticePush(), NoticePush, NoticePushInput, NoticePushRepeat, sendNoticePushNow(), updateNoticePush() (+25 more)

### Community 107 - "Community 107"
Cohesion: 0.06
Nodes (27): currency(), EmptyState(), StatusBadge(), TextArea(), ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent (+19 more)
...
Cohesion: 0.09
Nodes (36): useIsUploading(), directionOf(), EMPTY_TALLY, floorToStep(), phaseOf(), shouldRepost(), tallyUploads(), active (+28 more)
...
Cohesion: 0.08
Nodes (36): maneuverIcon(), NavCard(), Guidance, GuidanceStatus, NavigationFix, watchDeviceHeading(), watchNavigationPosition(), CARDINALS (+28 more)

### Community 112 - "Community 112"
Cohesion: 0.06
Nodes (33): AcceptPlatformAdminInvitationInput, appUrl(), daysFromNow(), EmailAvailability, EmailAvailabilityResult, hashToken(), INVITABLE_ROLES, invitePlatformAdmin() (+25 more)
...
Cohesion: 0.09
Nodes (33): buildCityIndex(), CityIndexEntry, HOSTEL_TYPE_PAGES, HostelTypeKey, hostelTypeLabel(), HostelTypePage, LocationCountRow, locationSlug() (+25 more)
...
Cohesion: 0.05
Nodes (32): DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), monthLabel(), toNumber(), scheduledMinutes() (+24 more)

### Community 117 - "Community 117"
Cohesion: 0.08
Nodes (23): HostelGeoRecord, sleep(), HostelGeoLocation, resolveHostelGeo(), GoogleMap, LeafletMap, TYPE_COLORS, fetchNearbyPlaces() (+15 more)
...
Cohesion: 0.12
Nodes (24): CSV_COLUMNS, GET(), GET(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS, neutralize() (+16 more)
...
Cohesion: 0.09
Nodes (32): announcementSummary(), CookFoodPhoto, CookPhotoDay, MealButton, mealButtonLabel(), mealButtons(), MealButtonsInput, mealLockNote() (+24 more)
...
Cohesion: 0.07
Nodes (21): Complaint, ComplaintSummary, field(), FoodMenu, HostelAdminComplaintsPage(), HostelAdminFoodPage(), HostelAdminNoticesPage(), HostelAdminPaymentsPage() (+13 more)
...
Cohesion: 0.07
Nodes (20): Input(), LoadingRows(), Select(), field(), HostelAdminReportsPageContent(), ListingFlag, LoadState, MaintenanceRequest (+12 more)
...
Cohesion: 0.11
Nodes (26): bsMonthStart(), rateForRoomType(), hostelCalendarDay(), hostelMonthStart(), hostelToday(), once, isActiveReferralCode(), AdmissionInvoiceResult (+18 more)
...
Cohesion: 0.1
Nodes (27): addBsMonths(), august, bhadra, hostelId, invoice(), mocks, NOW, periodAgo() (+19 more)
...
Cohesion: 0.09
Nodes (20): isHostelPortal(), useHostelSuspension(), PortalShell(), metadata, navItems, GUARDIAN_NAV, GUARDIAN_SEARCH_ENTRIES, hostelAdminHref() (+12 more)
...
Cohesion: 0.11
Nodes (24): candidateFontDirs(), ensureIdCardFonts(), FONT_DIR_SEGMENTS, FONT_FILES, IdCardData, IdCardFace, CardImages, renderIdCardPng() (+16 more)
...
Cohesion: 0.11
Nodes (23): AccountDeletionError, applyImmediateEffects(), cancelUrlFor(), DeletionPathway, DeletionRequestRecord, getAccountDeletionStatus(), loadUser(), notifyPlatformOfDeletionRequest() (+15 more)

### Community 152 - "Community 152"
Cohesion: 0.12
Nodes (17): listBookingPaymentsToCheck(), GET(), getGuardianDashboard(), getGuardianSafetySummary(), listGuardianFood(), listGuardianNotices(), listGuardianPayments(), requireGuardianPrincipal() (+9 more)
...
Cohesion: 0.08
Nodes (24): aswin, bhadra, bs(), card(), currentId, hostelId, inAswin, inOctober (+16 more)
...
Cohesion: 0.11
Nodes (22): softmatoDocsUrl(), dueBhadra29, filed, throughAswin25, CYCLE_LABELS, daysLeftThrough(), daysSpanned(), daysUntil() (+14 more)
...
Cohesion: 0.1
Nodes (19): dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, isMonthEnd(), mealsOn(), RoutineMeal (+11 more)
...
Cohesion: 0.15
Nodes (18): cook, dashboardHrefForRole(), destinationForRole(), isAllowedNextPath(), isHostelWorkspacePath(), isSafeLocalPath(), landingPathForRole(), ProtectedRouteRule (+10 more)
...
Cohesion: 0.15
Nodes (17): base, entityId, hostelId, mocks, principal, write(), readQrPayeeFields(), cleanAccountNumber() (+9 more)
...
Cohesion: 0.17
Nodes (16): GET(), DELETE(), GET(), PUT(), GET(), checkResidentEmail(), clearResidentIdentityPhoto(), evaluateProfilePrompt() (+8 more)
...
Cohesion: 0.13
Nodes (18): 2.3 Hostel Rejected, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails, 4.2 Complaint Status Updated (+10 more)
...
Cohesion: 0.14
Nodes (12): AuthSession, getResidentProfile(), register(), verifyOtp(), AppNavigator(), Stack, OtpVerificationScreen(), Props (+4 more)
...
Cohesion: 0.22
Nodes (13): findSuspendedHostelIds(), liftHostelSuspension(), objectIds(), OPEN_WHILE_SUSPENDED, serializeSuspension(), hostelObjectId(), HostelSuspensionError, liftPlatformHostelSuspension() (+5 more)

### Community 250 - "Community 250"
Cohesion: 0.16
Nodes (13): platformPushScheduleSchema, NotificationCampaignError, AUDIENCE_ROLES, deliverPush(), PlatformPushAudience, PlatformPushInput, PushLogRecord, PushMessage (+5 more)
...
Cohesion: 0.2
Nodes (13): assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck(), evidenceCheck(), fileCheck(), InvoiceForCheck (+5 more)
...
Cohesion: 0.2
Nodes (6): getInvoiceDetailForHostel(), readReturnState(), ReturnState, CheckoutReturnPage(), metadata, fetchInvoiceDetail()
...
Cohesion: 0.29
Nodes (7): assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES, PermissionError, PLATFORM_ROLES, Principal
...
Cohesion: 0.33
Nodes (6): 3.3 Payment Proof Uploaded (to Admin), 4.1 New Notice Posted, 5.1 SOS Triggered, 5. Safety & Emergency Emails, code:typescript ({), code:typescript ({)
...
## Knowledge Gaps
- **6143 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+6138 more)
...
- **Why does `cn()` connect `Community 16` to `Community 256`, `Community 0`, `Community 128`, `Community 133`, `Community 8`, `Community 10`, `Community 139`, `Community 140`, `Community 17`, `Community 18`, `Community 19`, `Community 150`, `Community 28`, `Community 31`, `Community 33`, `Community 36`, `Community 37`, `Community 47`, `Community 49`, `Community 50`, `Community 311`, `Community 56`, `Community 63`, `Community 71`, `Community 76`, `Community 83`, `Community 93`, `Community 107`, `Community 118`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 0` to `Community 2`, `Community 3`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 12`, `Community 14`, `Community 16`, `Community 17`, `Community 20`, `Community 22`, `Community 25`, `Community 26`, `Community 33`, `Community 39`, `Community 47`, `Community 50`, `Community 67`, `Community 106`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `Role` connect `Community 29` to `Community 1`, `Community 4`, `Community 261`, `Community 5`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 15`, `Community 404`, `Community 151`, `Community 154`, `Community 28`, `Community 285`, `Community 30`, `Community 288`, `Community 32`, `Community 34`, `Community 35`, `Community 37`, `Community 38`, `Community 40`, `Community 44`, `Community 46`, `Community 183`, `Community 55`, `Community 57`, `Community 58`, `Community 60`, `Community 188`, `Community 189`, `Community 200`, `Community 73`, `Community 74`, `Community 72`, `Community 78`, `Community 79`, `Community 81`, `Community 341`, `Community 94`, `Community 96`, `Community 98`, `Community 99`, `Community 105`, `Community 234`, `Community 235`, `Community 112`, `Community 241`, `Community 242`, `Community 249`, `Community 250`?**
