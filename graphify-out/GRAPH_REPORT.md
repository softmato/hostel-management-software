# Graph Report - hostel-management-software  (2026-09-24)

## Corpus Check
- 2368 files · ~5,142,546 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21334 nodes · 60293 edges · 594 communities (559 shown, 35 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 1183 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 763 edges
2. `successResponse()` - 735 edges
3. `connectToDatabase()` - 542 edges
4. `useAppTheme()` - 424 edges
5. `cn()` - 345 edges
6. `connectToDatabase()` - 283 edges
7. `o()` - 258 edges
8. `string()` - 258 edges
9. `u()` - 242 edges
10. `unwrap()` - 237 edges
...
## Communities (594 total, 35 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.0
Nodes (590): [A,P], abort(), {actionStateRoute:v,navigationState:P}, activate(), activeAnimationId(), activeThemeId(), {addKeyedListener:i}, {addKeyedListener:o} (+582 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (350): loadOverview(), loadMoney(), loadToday(), CalendarPreferenceCard(), NightStatusPromptCard(), NoticeArt(), loadFinance(), DeletionRequest (+342 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (183): ICONS, LABELS, Segment, TONES, FILTERS, Pending, Overview, MANAGE_ROWS (+175 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (227): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload (+219 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (196): LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), csvField(), field(), Hostel, HostelAdminDashboardPageContent() (+188 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (262): bsDaysInMonth(), bsMonthStart(), bsPeriodBounds(), bsPeriodOf(), fromBs(), gregorianOf(), hostelToday(), periodStartDate() (+254 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (97): DeliveryWindowFields(), number(), text(), parseAmount(), clockTime(), draftFrom(), toNumber(), statusCodeOf() (+89 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (240): PATCH(), RouteContext, POST(), fileFieldCash(), getOrCreateSubscription(), getSubscriptionState(), selectPlan(), POST() (+232 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (245): Scanner(), FaqRow(), MethodCard(), CookInviteScreen(), GuardianInviteScreen(), Assurance(), CallableRow(), IdentityCard() (+237 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (165): RouteContext, GET(), PATCH(), RouteContext, attendanceAlertResolveSchema, attendanceListQuerySchema, attendanceOverrideSchema, consentSchema (+157 more)

### Community 10 - "Community 10"
Cohesion: 0.01
Nodes (169): FieldCashRow, PlanPaymentClaim, formatBsAdDate(), DeletionPathway, DeletionStatus, PATHWAY_COPY, deferLoad(), DemoDataBadge() (+161 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (233): GET(), BookingEndCause, HostelBookingClosedCause, announceConfirmed(), announceEnding(), assertAwaitingAnswer(), cancelBookingByHostel(), cancelBookingByPlatform() (+225 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (180): POST(), POST(), POST(), answerSchema, POST(), POST(), attacker, attempt() (+172 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (171): PATCH(), POST(), RouteContext, GET(), GET(), POST(), POST(), POST() (+163 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (248): aa(), Ac(), Ad(), ae(), af(), ai(), Al(), an() (+240 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (176): BubbleBackground(), BubbleBackgroundProps, BubbleColors, ConfirmOptions, Notification, HostelAdminCooksPanel, monthStartPeriod(), addDays() (+168 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (173): attendanceSettingsSchema, listPausedHostels(), listPlatformBookings(), transfersByBooking(), GET(), POST(), RouteContext, DELETE() (+165 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (173): AdminCommunityReportsScreen(), AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), NightStatusHistoryScreen(), NightStatusScreen(), NotificationCard(), NotificationsScreen() (+165 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (153): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, metadata, HostelBookingView, BrandMark(), BrandWordmark(), WORDMARK, WORDMARK_SEGMENTS (+145 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (158): HIDDEN, RoleLayout(), TABS, FILTERS, invalidateFeeds(), NIGHT_ANSWER_LABELS, nightAnswerText(), NightPromptAnswer() (+150 more)
...
Cohesion: 0.02
Nodes (136): AdminCommunityScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+128 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (148): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery (+140 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (128): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), ATTACHED, dueWhen() (+120 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (156): GuardianCallRegister(), GuardianWardHero(), PaymentMonthStrip(), ResidentStayHero(), ManageRatesScreen(), ClearFilters(), CreditRow(), ManageStatementScreen() (+148 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (124): GET(), POST(), ownerIdentitiesFor(), resolveOwnedHostel(), openSubscriptionCheckout(), invoiceIdFor(), checkoutSchema, POST() (+116 more)
...
Cohesion: 0.02
Nodes (20): __addChild(), addListener(), cancelEvent(), disconnect(), forceInvalidate(), __getChildren(), __getNativeConfig(), __getNativeTag() (+12 more)

### Community 28 - "Community 28"
Cohesion: 0.02
Nodes (129): AuditLogRecord, PlatformAuditLogQuery, RefRecord, serializeAuditLog(), mocks, listTrendingTags(), addHostelAdminInquiryNote(), auditInquiryAction() (+121 more)

### Community 29 - "Community 29"
Cohesion: 0.02
Nodes (136): cookPrincipal, mocks, resolveCookLabels(), CookServiceError, resolveAdminHostelId(), announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord (+128 more)
...
Cohesion: 0.03
Nodes (104): GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, CITY_OPTIONS (+96 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (122): BootGate(), RootShell(), BrandSplash(), AuthDivider(), GoogleSignInButton(), acknowledged, HostelSuspensionHost(), remainingLabel() (+114 more)

### Community 33 - "Community 33"
Cohesion: 0.02
Nodes (115): POST(), MESSAGES, POST(), RouteContext, GET(), POST(), POST(), PATCH() (+107 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (12): c, ga(), getImageAsync(), init(), object(), openBrowserAsync(), requestMicrophonePermissionsAsync(), rs() (+4 more)

### Community 35 - "Community 35"
Cohesion: 0.02
Nodes (119): CommunityPageContent(), labelled(), VideoSlot(), CollectionQrField(), OperationsConfig, PendingSettingChange, PlanDueReminderSchedule, PlanReminderStep (+111 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (115): NightStatusForm(), ReviewForm(), ReviewScreen(), AlertRow(), SosScreen(), api, NightStatusReasonCode, reasonLabel() (+107 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (111): getHostelLedger(), collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES (+103 more)

### Community 38 - "Community 38"
Cohesion: 0.02
Nodes (113): demoteToPublicAccount(), returnHeldBed(), takeHeldBed(), LIVE_ACCESS, releaseGuardianAccounts(), hostelId, mocks, userId (+105 more)
...
Cohesion: 0.03
Nodes (98): recordConsent(), runPlanDueReminders(), runPaymentReminders(), settleEvent(), runGatewayHealth(), runGatewayHealthForHostel(), buildFormPostHandoff(), FormPostHandoff (+90 more)
...
Cohesion: 0.02
Nodes (15): build(), createInteractionHandle(), focus(), focusTextInput(), __getAnimatedValue(), getStringAsync(), __getValue(), impactAsync() (+7 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (95): checkFieldCash(), submitFieldCash(), BOOKING_DOCUMENT_KINDS, BookingDocumentKind, bookingDocumentLayout(), refundPolicyNotes(), allowed(), bookingDocumentAttachment() (+87 more)

### Community 44 - "Community 44"
Cohesion: 0.03
Nodes (56): StarLayer(), StarLayerProps, StarsBackground(), StarsBackgroundProps, GetPlanButton(), InlineText(), TIER_TONE, ROWS (+48 more)

### Community 45 - "Community 45"
Cohesion: 0.02
Nodes (6): array(), deactivate(), l(), removeListeners(), returnValue(), watchDeviceHeading()

### Community 46 - "Community 46"
Cohesion: 0.02
Nodes (41): assert(), bubbles(), cancelable(), cancelBubble(), clear_slot(), composed(), computeBlankness(), currentTarget() (+33 more)

### Community 47 - "Community 47"
Cohesion: 0.03
Nodes (96): GET(), hashUserAgent(), HostelRef, newVisitorKey(), recordHostelPageView(), resolveVisitorKey(), decodeKey(), decryptPersonalData() (+88 more)

### Community 48 - "Community 48"
Cohesion: 0.03
Nodes (22): addEventListener(), addListenerForTag(), cancelAnimationFrame(), clear(), clearInteractionHandle(), darken(), __debouncedOnEnd(), delete() (+14 more)

### Community 49 - "Community 49"
Cohesion: 0.03
Nodes (90): POST(), deviceTokenSchema, notificationSchema, notificationCampaignSchema, answer, mocks, userId, input (+82 more)

### Community 50 - "Community 50"
Cohesion: 0.03
Nodes (74): GuestBookingDetail, metadata, PayoutAccountForReview, ReviewPayoutAccount(), STATUS_LABEL, List(), ReasonAction(), Row() (+66 more)

### Community 51 - "Community 51"
Cohesion: 0.03
Nodes (89): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), AdminTabs(), AdminMoneyScreen(), MoneyData, AdminTodayScreen(), AdminAlertsContext (+81 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (81): MockupCarousel(), MockupImage(), JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT (+73 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (77): CommunityScreen(), Composer(), CommunityPostScreen(), AnimatedBlurView, CommunityBoard(), CommunityBoardProps, Composer(), NotificationBell() (+69 more)

### Community 54 - "Community 54"
Cohesion: 0.03
Nodes (67): generateMetadata(), metadata, AccountDeletionPanel, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections() (+59 more)

### Community 55 - "Community 55"
Cohesion: 0.03
Nodes (66): GetAppDialog(), Platform, gregorianSpan(), CopyButton(), GatewayProviderName, ManualMethodPanel(), MethodIcon(), methodKey() (+58 more)

### Community 56 - "Community 56"
Cohesion: 0.05
Nodes (85): SORTS, StoreCategoryScreen(), define(), defineQuery(), addToCart(), cancelStoreOrder(), Cart, CartLine (+77 more)

### Community 57 - "Community 57"
Cohesion: 0.04
Nodes (79): incidentLogSchema, manualStatusOverrideSchema, nightStatusLogSchema, nightStatusPromptSchema, sosAlertSchema, askingEndsAt(), askingEndsMinuteOfNight(), formatPromptTime() (+71 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (76): assertPlanRoom(), countLive(), notifyLimitReached(), NOUN, PlanLimitError, PlanSeat, hostelId, mocks (+68 more)

### Community 59 - "Community 59"
Cohesion: 0.02
Nodes (61): adminPrincipal, mocks, PLATFORM_LIMITS, authorUserId, leanResult(), mocks, postId, reactorUserId (+53 more)

### Community 60 - "Community 60"
Cohesion: 0.04
Nodes (69): bodySchema, POST(), POST(), RouteContext, computePerceptualHash(), systemDocumentKind(), createPublicHostelInquiry(), publicInquiryCreateSchema (+61 more)

### Community 61 - "Community 61"
Cohesion: 0.03
Nodes (66): metadata, CheckoutHandoffButton(), Handoff, ORDER, ProgressStep, TransitionScreen(), useCheckoutHandoff(), Badge() (+58 more)

### Community 62 - "Community 62"
Cohesion: 0.04
Nodes (75): openStore(), methodProvider(), createResident(), getIntakeQuote(), IntakeQuote, lookupResidentProfile(), ManagedHostel, RESIDENT_TYPES (+67 more)

### Community 63 - "Community 63"
Cohesion: 0.04
Nodes (73): candidatesInRun(), canonicalize(), checkCharacter(), CONFUSABLES, decodeSequence(), deriveHostelPrefix(), encodeSequence(), extractReferenceCodes() (+65 more)

### Community 64 - "Community 64"
Cohesion: 0.03
Nodes (74): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), PROVIDER_LABEL, QrPanel(), DetailsCard() (+66 more)

### Community 65 - "Community 65"
Cohesion: 0.03
Nodes (72): currentBsPeriod(), OfferTab(), Faq, PlatformConfigSeoPageContent, Step, everything, IDENTITY, page (+64 more)
...
Cohesion: 0.04
Nodes (73): issueReceiptForEvent(), IssueReceiptInput, nextReceiptNumber(), periodCoverage(), periodOfDate(), ReceiptVerification, renderReceiptById(), verifyReceiptByCode() (+65 more)
...
Cohesion: 0.05
Nodes (57): applyBookingConfig(), BookingCancelStep, bookingCancelStepSchema, BookingConfig, bookingConfigSchema, DEFAULT_BOOKING_CONFIG, DEFAULT_CANCEL_STEPS, percent (+49 more)

### Community 70 - "Community 70"
Cohesion: 0.03
Nodes (47): deleteHostelObjects(), ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, purgeArchivedHostel(), purgeHostel() (+39 more)

### Community 71 - "Community 71"
Cohesion: 0.04
Nodes (66): CHANNELS, ClaimedStep, composeEmail(), composeNotice(), composePlanDueNotice(), deliver(), deliverEmail(), deliverStep() (+58 more)
...
Cohesion: 0.06
Nodes (62): 978(), _adopt(), ar(), assignAnimationToWorker(), at(), bn(), broadcastMessage(), Bt() (+54 more)

### Community 74 - "Community 74"
Cohesion: 0.05
Nodes (51): hostelPeriodOf(), BillPreview, CheckContext, CheckedRow, checkExistingResidents(), CheckResult, monthLabel(), moveInDateFor() (+43 more)

### Community 75 - "Community 75"
Cohesion: 0.03
Nodes (13): deliver(), addPendingGesture(), ensureConfig(), f(), get_slot_str(), getSlot(), notify(), run() (+5 more)
...
Cohesion: 0.04
Nodes (50): FeedPayload, NewPostAlertsToggle(), SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES, avatarTone() (+42 more)

### Community 78 - "Community 78"
Cohesion: 0.05
Nodes (52): AttachmentGallery(), DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS, MealCard(), MonthEndSpecial(), RoutineMeal (+44 more)
...
Cohesion: 0.05
Nodes (48): EvidenceEngine, EvidenceEngineMode, EvidenceReadFailure, OcrResult, OcrWord, KEYS, saved, IMAGE (+40 more)
...
Cohesion: 0.04
Nodes (52): Due, InvoiceRow, OPEN_STATUSES, findIndex(), index, indexesOf(), IndexSpec, promote (+44 more)

### Community 84 - "Community 84"
Cohesion: 0.06
Nodes (55): paymentProofSchema, arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal (+47 more)
...
Cohesion: 0.05
Nodes (47): COLUMNS, Member, MemberData, RegistrationTrackSheet(), TrackSheetLoader(), metadata, HOSTEL_AGREEMENT_STATUSES, hostelAgreementSchema (+39 more)

### Community 87 - "Community 87"
Cohesion: 0.06
Nodes (46): PLATFORM_NAME_PARTS, hammingDistance(), isPerceptualNearDuplicate(), distance, formatNPR(), cleanAccountNumber(), cleanName(), hasQrPayee() (+38 more)
...
Cohesion: 0.06
Nodes (39): AuthGuard(), HostelSuggestions(), PublicHostel, checkOnly(), EMPTY_PREFILL, ENVIRONMENT_OPTIONS, IdentityResponse, Prefill (+31 more)

### Community 90 - "Community 90"
Cohesion: 0.04
Nodes (41): financeIntegrityHash(), getCreditBalance(), Entry, eventId, hostelId, invoiceId, mocks, residentId (+33 more)

### Community 91 - "Community 91"
Cohesion: 0.06
Nodes (44): notifyStaffOfJobProgress(), serviceProviderApplicationSchema, serviceProviderDocumentSchema, hostelId, mocks, providerId, notifyPlatformOfServiceProviderApplication(), notifyServiceProviderDecision() (+36 more)
...
Cohesion: 0.07
Nodes (48): fill(), money(), PlanCard(), PricingScreen(), pricePlan(), BillingToggle(), listHeadingFor(), PlanCard() (+40 more)

### Community 94 - "Community 94"
Cohesion: 0.06
Nodes (40): referralSchema, referralCodeSchema, referralRewardSchema, activeCode, codeId, hostelId, joinedResidentId, mocks (+32 more)

### Community 95 - "Community 95"
Cohesion: 0.05
Nodes (37): PlanMark(), RAFTER, RIDGE, PortalDates, useHostelDayTurn(), PlanBilling, PlanBillingInvoice, PlanBillingPayment (+29 more)
...
Cohesion: 0.06
Nodes (45): continueLabel(), isBlank(), buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, draftFromProfile() (+37 more)
...
Cohesion: 0.08
Nodes (40): addHistory(), addMaintenanceComment(), assertBedInHostel(), assertProviderApproved(), assertRoomInHostel(), assertVoiceNoteUsable(), assignMaintenanceProvider(), auditMaintenanceAction() (+32 more)
...
Cohesion: 0.1
Nodes (35): GET(), periodTotals(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS, neutralize(), csv (+27 more)
...
Cohesion: 0.07
Nodes (37): qrActivationSchema, activateResident(), ActivationCodeGenerateInput, ActivationCodeInput, activationSecret(), ActivationServiceError, ActivationStatus, ActivationStatusQuery (+29 more)

### Community 106 - "Community 106"
Cohesion: 0.06
Nodes (33): paginationQuerySchema, DEPRECATED_ALIASES, grantingPermissionKeys(), mocks, DELETE(), PATCH(), RouteContext, GET() (+25 more)
...
Cohesion: 0.08
Nodes (38): Compass(), maneuverIcon(), NavCard(), Guidance, GuidanceStatus, cardinalFor(), CARDINALS, chooseHeading() (+30 more)
...
Cohesion: 0.09
Nodes (39): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsMonthName(), bsPeriodsBetween(), formatBsDayMonth(), formatBsDayRange() (+31 more)

### Community 111 - "Community 111"
Cohesion: 0.09
Nodes (36): cellAt(), focusCell(), INPUT_MODES, Props, cellAt(), focusCell(), Props, SheetCell (+28 more)

### Community 112 - "Community 112"
Cohesion: 0.06
Nodes (20): ComparePage(), generateMetadata(), hostels, metadata, rows, dashboardHrefForRole(), hasDashboard(), PublicHeader() (+12 more)

### Community 113 - "Community 113"
Cohesion: 0.07
Nodes (35): analyseLuminanceTable(), containerOf(), EDITOR_MARKERS, editorFrom(), EvidenceProvenance, ExifFacts, ijgEntry(), isScreenShape() (+27 more)

### Community 114 - "Community 114"
Cohesion: 0.08
Nodes (29): GET(), POST(), querySchema, RouteContext, getCommunitySettings(), communityAnnouncementSchema, communityCommentCreateSchema, communityFeedQuerySchema (+21 more)
...
Cohesion: 0.07
Nodes (28): BrowseParams, BUDGET_BANDS, FilterSheet(), HostelBrowser(), HostelBrowserProps, NearestToggle(), ViewSwitch(), useNearby() (+20 more)

### Community 117 - "Community 117"
Cohesion: 0.08
Nodes (37): documents, hostelForm(), many, parsed, result, buildHostelPayload(), capacitySummary(), emptyHostelForm() (+29 more)
...
Cohesion: 0.08
Nodes (34): Choice, MapButton(), MapScreen(), ModeTab(), NOTHING_CHOSEN, RouteCard(), buildPage(), buildPinPage() (+26 more)
...
Cohesion: 0.08
Nodes (32): deliver(), emailFacts(), getHostelPayoutAccount(), hostelOrThrow(), notifyPlatformOfPayoutReview(), PayoutAccountStatus, PayoutAccountView, PayoutActor (+24 more)
...
Cohesion: 0.07
Nodes (18): open, KNOWN_PATHS, marksRoleChange(), opensPlanBilling(), resolvePushPath(), REWRITES, ROLE_CHANGE_TYPES, blobNames (+10 more)
...
Cohesion: 0.15
Nodes (31): documentDownloadUrl(), issueInvoiceDocument(), allocateNumber(), ensureInvoiceRaised(), findOpenInvoice(), graceDeadline(), invoiceDocumentInput(), issueSubscriptionInvoice() (+23 more)

### Community 138 - "Community 138"
Cohesion: 0.09
Nodes (31): readMoney(), AMOUNT_ALIASES, counterparty(), CREDIT_ALIASES, CREDIT_WORDS, DATE_ALIASES, DEBIT_ALIASES, DEBIT_WORDS (+23 more)

### Community 139 - "Community 139"
Cohesion: 0.07
Nodes (27): getResidentLedger(), monthsBetween(), periodOf(), ResidentDoc, ResidentLedger, ResidentLedgerMonth, ResidentLedgerPayment, billed (+19 more)

### Community 140 - "Community 140"
Cohesion: 0.09
Nodes (27): AccountDeletionError, applyImmediateEffects(), cancelUrlFor(), DeletionPathway, DeletionRequestRecord, getAccountDeletionStatus(), loadUser(), notifyPlatformOfDeletionRequest() (+19 more)
...
Cohesion: 0.11
Nodes (28): formatPeriodKey(), fullYear(), MONTH_SPELLINGS, monthFromWord(), readBsMonth(), readJoinedDate(), readMonthsDue(), readPhone() (+20 more)

### Community 143 - "Community 143"
Cohesion: 0.12
Nodes (22): checkoutDocumentFor(), softmatoDocumentNumbers(), gateway, invoice, updateOne, getInvoiceDetailForHostel(), readReturnState(), ReturnStep (+14 more)

### Community 144 - "Community 144"
Cohesion: 0.11
Nodes (28): ApiFailure, apiRequest(), ApiSuccess, AuthUser, confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listPublicHostels() (+20 more)

### Community 145 - "Community 145"
Cohesion: 0.11
Nodes (27): useIsUploading(), ensureChannel(), startUploadNotifications(), dismissUpload(), emit(), getUploadRows(), listeners, pruneUploads() (+19 more)
...
Cohesion: 0.07
Nodes (18): CATEGORIES, HeroStats(), isApplicationOpen(), LandingStep(), MeResponse, OwnApplication, ProviderStats, ProviderStatus (+10 more)

### Community 150 - "Community 150"
Cohesion: 0.12
Nodes (24): otpResendCooldownMs(), CheckoutInvoice, checkoutView(), currentPlanId(), fail(), findHostelForCheckout(), HostelMatch, paymentState() (+16 more)
...
Cohesion: 0.12
Nodes (21): CSV_COLUMNS, GET(), POST(), RouteContext, POST(), safeEqual(), ClickRecord, dayKey() (+13 more)
...
Cohesion: 0.14
Nodes (22): hostelTypeLabel(), photoAssetId(), PublicAsset, resolveSearchImageUrls(), searchImageUrls(), HostelLayout(), LayoutProps, loadHostel (+14 more)
...
Cohesion: 0.18
Nodes (19): NativeNightPrompt, takeNativePendingAnswers(), isNightStatusPrompt(), NIGHT_STATUS_ACTIONS, NIGHT_STATUS_BUTTONS, NIGHT_STATUS_REASONS, NightStatusActionId, NightStatusAnswer (+11 more)
...
Cohesion: 0.16
Nodes (21): readSettledReceipt(), deliver(), loadInvoiceById(), loadProof(), PlanPaymentInstructions, ProofAsset, reviewPlanPaymentClaim(), submitPlanPaymentClaim() (+13 more)
...
Cohesion: 0.11
Nodes (23): Attendance / Night Safety, Bed, Build status (end of Phase 3), Build status (end of Phase 5 — verified 2026-08-02), code:typescript (export enum Role {), code:typescript (interface IQRActivation {), code:typescript (interface INightStatusLog {), code:typescript (interface INotice {) (+15 more)
...
Cohesion: 0.12
Nodes (17): BASE_URLS, khaltiProvider, postJson(), attempt, fetchMock, initiated, live, request (+9 more)
...
Cohesion: 0.14
Nodes (20): activeDevicesFor(), activeTokensFor(), androidChannel(), authHeaders(), chunk(), DeviceRow, EMPTY, ExpoDevice (+12 more)

### Community 201 - "Community 201"
Cohesion: 0.11
Nodes (19): composeFeeDueNotice(), sendFeeDueReminders(), platformPushScheduleSchema, NotificationCampaignError, PLATFORM_PUSH_AUDIENCES, PushRepeat, AUDIENCE_ROLES, AutomaticPushKey (+11 more)

### Community 202 - "Community 202"
Cohesion: 0.17
Nodes (17): resolveTiming(), asPushTiming(), laterFromDelay(), nextNoticePushRun(), noticePushExpiry(), NoticePushRepeat, NoticePushTiming, sentAt (+9 more)
...
Cohesion: 0.17
Nodes (15): robots(), IssuedInvoice, openCheckoutSession(), OpenedCheckout, SettledReceipt, bookingTask(), outboundUrl(), siteUrl() (+7 more)
...
Cohesion: 0.12
Nodes (20): 3.1 Payment Due Reminder, 3.3 Payment Proof Uploaded (to Admin), 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails, 4.1 New Notice Posted, 4.2 Complaint Status Updated (+12 more)
...
Cohesion: 0.16
Nodes (17): categoryForRole(), countHits(), HIGH_KEYWORDS, MaintenanceCategory, normalize(), ProviderRole, providerRoleLabel(), ROLE_LABELS (+9 more)

### Community 227 - "Community 227"
Cohesion: 0.13
Nodes (17): ProviderDirectoryData, DirectoryPageProps, EMPTY, generateMetadata(), metadata, ServiceProviderDirectoryPage(), ServiceProvidersPage(), getPublicServiceProviderStats() (+9 more)

### Community 228 - "Community 228"
Cohesion: 0.16
Nodes (19): code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {), code:typescript ({), code:typescript (interface IMoveInChecklistItem {), code:typescript (interface IMoveOutChecklistItem {), Complaint (+11 more)
...
Cohesion: 0.15
Nodes (14): register(), submitResidentReview(), triggerSOS(), verifyOtp(), RootStackParamList, LoginScreen(), Props, OtpVerificationScreen() (+6 more)
...
Cohesion: 0.12
Nodes (16): InvoiceDocumentInput, InvoicePresentation, documentFileName(), DocumentKind, InvoiceRow, invoiceStatus(), methodLabel(), PAYMENT_METHODS (+8 more)
...
Cohesion: 0.22
Nodes (13): logAccessFailure(), openHostelAfterPayment(), liftHostelSuspension(), OPEN_WHILE_SUSPENDED, serializeSuspension(), hostelObjectId(), HostelSuspensionError, liftPlatformHostelSuspension() (+5 more)
...
Cohesion: 0.13
Nodes (10): Award, awardState(), Claim, FinanceView, Invoice, OPEN_STATUSES, Perk, Programme (+2 more)
...
Cohesion: 0.17
Nodes (15): 5.1 SOS Triggered, 5. Safety & Emergency Emails, 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, 7.1 Attendance Alert (Resident Absent) (+7 more)
...
Cohesion: 0.16
Nodes (9): activateResident(), AuthSession, AppNavigator(), Stack, Props, PublicHomeScreen(), Props, ResidentActivationScreen() (+1 more)
...
Cohesion: 0.16
Nodes (11): softmatoWebhookSecret(), RawDelivery, body, now(), reserialised, result, signature, stale (+3 more)
...
Cohesion: 0.16
Nodes (5): PlatformCommunityPageContent, ProviderCardPage(), ProviderRecord, titleCase(), ResidentSettingsPageContent
...
Cohesion: 0.26
Nodes (11): PROVIDER_ROLES, notifyProviderOfAssignment(), notifyProviderOfMaintenanceNote(), notifyProviderOfStatusChange(), notifyProvidersOfOpenJob(), notifyStaffOfNewMaintenanceRequest(), providerUserId(), readableCategory() (+3 more)

### Community 317 - "Community 317"
Cohesion: 0.18
Nodes (10): POST(), RouteContext, DEFAULT_GUARDIAN_PERMISSIONS, guardianAccessCreateSchema, guardianInvitationAcceptSchema, guardianInviteSchema, guardianLoginSchema, guardianPermissionsSchema (+2 more)
...
Cohesion: 0.17
Nodes (12): 10.1 GitHub Actions Workflow, 10.2 Merge Rules, 10. CI/CD Integration, 9.1 Seed Scripts, 9.2 Test Database Isolation, 9.3 Test Helpers, 9. Test Data & Seeding, code:typescript (describe('POST /api/v1/hostel/residents - account upgrade', ) (+4 more)
...
Cohesion: 0.2
Nodes (11): 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.3 Hostel Rejected, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, 3.2 Payment Overdue, code:typescript ({), code:typescript ({) (+3 more)
...
Cohesion: 0.2
Nodes (11): 7.1 Multi-Tenant Isolation Test Template, 7.2 Role Gate Test Template, 7.3 Privacy/Guardian Permissions Test Template, 7.5 Payment Precision Test Template, 7. Mandatory Test Templates, code:typescript (describe('GET /api/v1/hostel/rooms/:id - tenant isolation', ), code:typescript (describe('GET /api/v1/hostel/rooms - role access', () => {), code:typescript (describe('GET /api/v1/guardian/linked-resident - privacy', () (+3 more)
...
Cohesion: 0.22
Nodes (5): secretsMatch(), ENDPOINTS, esewaProvider, getJson(), SIGNED_FIELDS
...
Cohesion: 0.25
Nodes (6): api(), collected, expiresAt, now, photoKinds, plan
...
Cohesion: 0.29
Nodes (5): api(), objectId, plan, sessionFor(), stamp
...
Cohesion: 0.4
Nodes (5): parseStatementDate(), PlansConfig, build(), plan(), result
...
## Knowledge Gaps
- **6921 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+6916 more)
...
- **Why does `string()` connect `Community 6` to `Community 0`, `Community 1`, `Community 3`, `Community 5`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 16`, `Community 17`, `Community 19`, `Community 21`, `Community 22`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 33`, `Community 34`, `Community 38`, `Community 39`, `Community 40`, `Community 41`, `Community 42`, `Community 43`, `Community 45`, `Community 46`, `Community 47`, `Community 48`, `Community 49`, `Community 50`, `Community 51`, `Community 52`, `Community 53`, `Community 55`, `Community 56`, `Community 57`, `Community 58`, `Community 61`, `Community 62`, `Community 64`, `Community 66`, `Community 67`, `Community 69`, `Community 71`, `Community 74`, `Community 75`, `Community 80`, `Community 81`, `Community 83`, `Community 86`, `Community 87`, `Community 90`, `Community 92`, `Community 101`, `Community 103`, `Community 109`, `Community 110`, `Community 111`, `Community 115`, `Community 118`, `Community 120`, `Community 121`, `Community 135`, `Community 137`, `Community 142`, `Community 143`, `Community 149`, `Community 150`, `Community 161`, `Community 162`, `Community 169`, `Community 173`, `Community 174`, `Community 179`, `Community 180`, `Community 187`, `Community 195`, `Community 197`, `Community 200`, `Community 210`, `Community 231`, `Community 245`, `Community 260`, `Community 264`, `Community 297`, `Community 298`, `Community 308`, `Community 388`, `Community 391`, `Community 394`, `Community 397`, `Community 438`, `Community 443`?**
  _High betweenness centrality (0.160) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 6` to `Community 128`, `Community 3`, `Community 388`, `Community 5`, `Community 8`, `Community 9`, `Community 138`, `Community 12`, `Community 14`, `Community 142`, `Community 20`, `Community 21`, `Community 150`, `Community 23`, `Community 24`, `Community 26`, `Community 27`, `Community 29`, `Community 159`, `Community 31`, `Community 32`, `Community 34`, `Community 35`, `Community 37`, `Community 41`, `Community 45`, `Community 46`, `Community 179`, `Community 55`, `Community 57`, `Community 187`, `Community 61`, `Community 445`, `Community 66`, `Community 67`, `Community 197`, `Community 198`, `Community 75`, `Community 77`, `Community 80`, `Community 209`, `Community 81`, `Community 211`, `Community 89`, `Community 101`, `Community 231`, `Community 109`, `Community 110`, `Community 117`, `Community 248`, `Community 126`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 15` to `Community 2`, `Community 3`, `Community 4`, `Community 393`, `Community 10`, `Community 268`, `Community 269`, `Community 18`, `Community 20`, `Community 149`, `Community 156`, `Community 31`, `Community 159`, `Community 35`, `Community 41`, `Community 44`, `Community 50`, `Community 308`, `Community 54`, `Community 55`, `Community 61`, `Community 76`, `Community 77`, `Community 89`, `Community 92`, `Community 93`, `Community 95`, `Community 102`, `Community 111`, `Community 112`, `Community 124`, `Community 126`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Are the 536 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 536 INFERRED edges - model-reasoned connections that need verification._
