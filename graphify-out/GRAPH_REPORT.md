...
## Corpus Check
- 1748 files · ~3,129,427 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14151 nodes · 38890 edges · 481 communities (461 shown, 20 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 605 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 568 edges
2. `successResponse()` - 556 edges
3. `connectToDatabase()` - 379 edges
4. `useAppTheme()` - 356 edges
5. `cn()` - 261 edges
6. `connectToDatabase()` - 225 edges
7. `unwrap()` - 192 edges
...
Cohesion: 0.04
Nodes (156): ICONS, LABELS, Segment, TONES, FILTERS, Pending, TodayData, Person (+148 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (196): AdminMoreScreen(), MANAGE_ROWS, PORTAL_ROWS, ActivateScreen(), APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen() (+188 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (228): loadToday(), VoiceNotePlayer(), RoundButton(), VOICE_NOTE_RECORDING, VoiceNote, VoiceNoteRecorder(), loadFinance(), getAdminFoodRoutine() (+220 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (185): POST(), bulkApproveSchema, POST(), POST(), POST(), GET(), periodOf(), getOpenFeeSchedule() (+177 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (148): GET(), POST(), GET(), PATCH(), RouteContext, attendanceAlertResolveSchema, attendanceListQuerySchema, attendanceOverrideSchema (+140 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (185): AdminCommunityReportsScreen(), AdminResidentsScreen(), Scanner(), AttendanceScreen(), CookInviteScreen(), GuardianInviteScreen(), MapScreen(), NightStatusScreen() (+177 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (189): auditFinanceAction(), FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), voidInvoice(), approveCashPayment(), cashThresholdFor(), RecordCashInput (+181 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (191): deleteResidentLocationHistory(), getResidentAttendance(), listAttendanceAlerts(), listResidentComplaints(), getResidentFinanceView(), getFoodRoutinesByHostelId(), listFoodForResident(), listPublicFoodRoutine() (+183 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (168): MEAL_ICONS, mealIcon(), MealRow(), DeletionRequest, DeletionStatus, getDeletionStatus(), requestAccountDeletion(), api (+160 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (171): NotificationCard(), ProfileScreen(), ReferralRow(), CheckoutStatusScreen(), PaymentMonthStrip(), ManageRatesScreen(), CreditRow(), ManageStatementScreen() (+163 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (140): POST(), attacker, attempt(), headers, jsonRequest(), routeMocks, appBaseUrl(), authenticateWithGoogle() (+132 more)
...
Cohesion: 0.03
Nodes (101): POST(), GET(), POST(), POST(), getCurrentUser(), POST(), POST(), RouteContext (+93 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (132): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, dayKey(), overrideAttendance(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply() (+124 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (96): csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, HostelTable(), Inquiry, LoadState (+88 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (118): AdminCommunityScreen(), FILTERS, NotificationRow(), TILE_GLYPH, TILE_TONES, HOSTEL, MONTHS, UiPreview() (+110 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (114): NightStatusForm(), DeletionPanel(), AlertRow(), ReportedPostCard(), FLOAT_SHADOW, PaintedAmount(), copyReference(), DuesLine (+106 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (102): AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry() (+94 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (92): PATCH(), POST(), RouteContext, GET(), POST(), RouteContext, PATCH(), RouteContext (+84 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (95): base, entityId, hostelId, mocks, principal, write(), base, enabledAt (+87 more)
...
Cohesion: 0.07
Nodes (73): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, DASHBOARD_ROLES, FACILITY_ICONS (+65 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (82): field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminMoveChecklistPage(), LoadState, NightStatusRow, Notification, optionalNumber() (+74 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (77): ReportGrid(), ReportRecord, GuardianDashboard, HostelAdminDashboardPageContent, hostelTypeLabels, StatementNudge, CreateWardenResult, PERMISSION_LABELS (+69 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (107): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), loadOverview(), Overview, AdminTabs(), HIDDEN, TABS (+99 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (93): NotificationsPageContent(), Notification, AttendanceCalendar(), HostelAdminCooksPanel, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek (+85 more)
...
Cohesion: 0.03
Nodes (84): FeeSchedule, formatDate(), monthStartPeriod(), Rate, RoomTypeOption, MonthField, MonthOption(), MonthPicker (+76 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (82): summarizeResidentComplaints(), LedgerInvoice, listResidentInvoices(), renderStatementForResident(), getResidentLedger(), ResidentDoc, ResidentLedger, ResidentLedgerMonth (+74 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (91): cookPrincipal, mocks, resolveCookLabels(), CookServiceError, resolveAdminHostelId(), announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord (+83 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (77): POST(), GET(), POST(), POST(), POST(), POST(), GET(), POST() (+69 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (67): AuthShell(), AuthShellProps, PANEL_COPY, SiteWordmark(), metadata, AccountDeletionPanel, ContentHeader(), ContentIntro() (+59 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (87): demoteToPublicAccount(), CapacityError, claimBedForRoomType(), listAllRoomTypes(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary() (+79 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (67): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminAttendancePageContent (+59 more)

### Community 34 - "Community 34"
Cohesion: 0.05
Nodes (79): CommunityScreen(), Composer(), CommunityBoard(), CommunityBoardProps, Composer(), SORTS, CommentThread(), CommunityPostCard() (+71 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (66): AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel, Overview, Report, REPORT_EXPORTS, field() (+58 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (73): CommunityReportDialog(), REASONS, inferKind(), MediaLightbox(), PlanMark(), ROWS, EASE, FaqEntry (+65 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (71): Offset, PhotoCropper(), VideoSlot(), CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole() (+63 more)

### Community 38 - "Community 38"
Cohesion: 0.1
Nodes (49): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), verificationEmail(), cookInvitationEmail(), guardianInvitationEmail(), cookPortalEnabledEmail() (+41 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (63): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse (+55 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (53): SavedListRow(), TABS, AssetViewer(), useViewerState(), ViewerBody(), ViewerPage(), SavedCard(), AttachmentRow() (+45 more)

### Community 41 - "Community 41"
Cohesion: 0.03
Nodes (44): AuthGuard(), cityOptions, createDocument(), createRoom(), DocumentConfig, DraftData, FACILITY_MINI, facilityOptions (+36 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (48): normalize(), PortalSearch(), PortalTone, scoreEntry(), toneStyles, iconMap, IconName, NavItem (+40 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (62): arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal, alreadyReviewedError() (+54 more)
...
Cohesion: 0.05
Nodes (49): HostelSuggestions(), formatHostelAddress(), hasFood(), hostelTypeToUi(), mapPublicHostelToSummary(), PublicHostel, roomTypeLabel(), CATEGORY_LABELS (+41 more)
...
Cohesion: 0.06
Nodes (54): GATEWAY_ORDER, getPayInstructions(), InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice(), assertQrAssetUsable() (+46 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (47): metadata, CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+39 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (46): EMPTY_DRAFT, HostelAdminPaymentProfilePageContent, PaymentProfile, SECTION_FIELDS, SectionId, BankMark(), EsewaMark(), KhaltiMark() (+38 more)
...
Cohesion: 0.07
Nodes (53): Choice, Compass(), maneuverIcon(), MapButton(), ModeTab(), NavCard(), NOTHING_CHOSEN, RouteCard() (+45 more)
...
Cohesion: 0.08
Nodes (47): GuardianWardCard(), NotificationBell(), RoleTabScreen(), GuardianHomeScreen(), GuardianMetrics(), GuardianMoreScreen(), GuardianPaymentsScreen(), acceptGuardianInvitation() (+39 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (55): EvidenceEngineMode, AMOUNT_LABELS, canonical(), canonicalDigits(), containsWithTolerance(), deadline(), DIGIT_CONFUSABLES, EvidenceRead (+47 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (46): otpCodeEmail(), Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity, EmailIdentityResolver, envEmailDomain() (+38 more)

### Community 57 - "Community 57"
Cohesion: 0.06
Nodes (42): escapeRegex(), SERVICE_PROVIDER_CATEGORIES, serviceProviderSchema, serviceProviderApplicationSchema, serviceProviderDocumentSchema, hostelId, mocks, providerId (+34 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (44): AttachmentGallery(), DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS, MealCard(), RoutineMeal, CookMenuScreen() (+36 more)
...
Cohesion: 0.07
Nodes (50): BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsPeriodBounds(), bsPeriodOf(), bsPeriodsBetween() (+42 more)
...
Cohesion: 0.06
Nodes (39): EvidenceEngine, EvidenceReadFailure, OcrResult, OcrWord, Attempt, billingPeriod(), DEFAULT_MODELS, GeminiRead (+31 more)

### Community 65 - "Community 65"
Cohesion: 0.08
Nodes (23): PlatformConfigAnnouncementsPageContent, PlatformConfigFacilitiesPageContent, FLAGS, PlatformConfigFeaturesPageContent, PlatformConfigLegalPageContent, PlatformConfigLocationsPageContent, PlatformConfigPlanServicePageContent, PlatformConfigPricingPageContent (+15 more)

### Community 66 - "Community 66"
Cohesion: 0.07
Nodes (41): monthlySeries(), getHostelViewStats(), foodFeedbackSchema, listingFlagSchema, paymentProofSchema, ratingReviewSchema, averageResolutionDays(), bucketBoundaries() (+33 more)

### Community 67 - "Community 67"
Cohesion: 0.06
Nodes (41): aswin, bhadra, bs(), card(), currentId, hostelId, inAswin, inOctober (+33 more)
...
Cohesion: 0.07
Nodes (45): BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan, BillingSkip (+37 more)
...
Cohesion: 0.05
Nodes (43): TIER_TONE, ListingTierTone, PlanId, portalAccessLines(), Service, ServiceModule, ServiceModuleId, PLAN_MODULES (+35 more)

### Community 73 - "Community 73"
Cohesion: 0.08
Nodes (38): platformSettingSchema, storeCartSchema, AddInput, addToCart(), CartItemRecord, CartRecord, clearCart(), emptyCart() (+30 more)
...
Cohesion: 0.06
Nodes (36): ComparePage(), hostels, metadata, rows, CurrentUser, DASHBOARD_ROLES, hasDashboard(), MeResponse (+28 more)
...
Cohesion: 0.07
Nodes (22): fill(), PricingScreen(), InlineText(), BillingToggle(), EASE, PlanCards(), PlanLine(), PlansClosingCta() (+14 more)
...
Cohesion: 0.07
Nodes (33): ResultRow(), buildHtml(), Marker, PlaceMarker, boundsCenter(), haversineMeters(), hostelCoordinates(), HostelWithDistance (+25 more)

### Community 84 - "Community 84"
Cohesion: 0.1
Nodes (38): hostelForm(), buildHostelPayload(), capacitySummary(), CITY_OPTIONS, emptyHostelForm(), emptyRoomRow(), FACILITY_OPTIONS, firstIncompleteHostelStep() (+30 more)
...
Cohesion: 0.06
Nodes (25): accountDeletionRequestSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, consentLogSchema, notificationSchema, questionCallClickSchema, sessionSchema (+17 more)

### Community 87 - "Community 87"
Cohesion: 0.09
Nodes (27): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), systemDocumentKindFromText(), distance (+19 more)
...
Cohesion: 0.08
Nodes (33): collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor() (+25 more)

### Community 91 - "Community 91"
Cohesion: 0.12
Nodes (30): PreviewCard(), FACILITY_ICONS, facilityIcon(), facilityKey(), HostelCard(), SaveButton(), HeadCell(), HostelShowcase() (+22 more)
...
Cohesion: 0.1
Nodes (33): userResidentProfileSchema, LEGACY_ROLE_MAP, Role, ROLE_VALUES, ageFromDateOfBirth(), cardPhotoImageUrl(), clearResidentIdentityPhoto(), generateResidentId() (+25 more)
...
Cohesion: 0.09
Nodes (29): AccountDeletionError, applyImmediateEffects(), cancelAccountDeletionByToken(), cancelAccountDeletionForUser(), cancelUrlFor(), DeletionPathway, DeletionRequestRecord, getAccountDeletionStatus() (+21 more)
...
Cohesion: 0.09
Nodes (26): publicHostelApplicationCreateSchema, documents, many, parsed, result, buildProviderPayload(), EMPTY_PROVIDER_FORM, firstIncompleteProviderStep() (+18 more)
...
Cohesion: 0.1
Nodes (26): RoleLayout(), useQueryValue(), recordCookAnnouncement(), CachedQuery, clearQueryCache(), defined, entries, Entry (+18 more)
...
Cohesion: 0.11
Nodes (24): ComplaintDetail(), ComplaintCard(), ACTOR_LABELS, actorLabel(), Complaint, ComplaintCategory, ComplaintUpdate, canConfirmResolution() (+16 more)

### Community 121 - "Community 121"
Cohesion: 0.11
Nodes (25): CookTodayScreen(), announcedCount(), announcementSummary(), MealButton, mealButtonLabel(), mealButtons(), mealsToCall(), mealSubtitle() (+17 more)
...
Cohesion: 0.18
Nodes (19): CSV_COLUMNS, GET(), GET(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS, neutralize() (+11 more)

### Community 129 - "Community 129"
Cohesion: 0.1
Nodes (20): DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), monthLabel(), parseAmount(), describePreference() (+12 more)
...
Cohesion: 0.15
Nodes (19): TABS, announceFoodReady(), CookFoodPhoto, CookPhotoDay, CookPhotoFeed, CookResident, CookToday, FoodReadyAnnouncement (+11 more)
...
Cohesion: 0.13
Nodes (18): everything, IDENTITY, page, rendered, DEFAULT_SITE_CONFIG, coerceSection(), getPublicSiteConfig(), getSiteConfig() (+10 more)
...
Cohesion: 0.1
Nodes (20): ESEWA_CSV_PARSER, both, corrupted, debit, [first], FIXTURE, headerOnly, noDate (+12 more)
...
Cohesion: 0.11
Nodes (15): DeviceLocation, DeviceLocationStatus, formatDistance(), hostelCoordinates(), isUsableCoordinate(), KATHMANDU, hasGeolocation(), LocationOutcome (+7 more)
...
Cohesion: 0.09
Nodes (16): after, broken, claimId, db, eventId, filter, finding, first (+8 more)
...
Cohesion: 0.14
Nodes (14): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), robots() (+6 more)
...
Cohesion: 0.17
Nodes (17): periodTotals(), buildHostelAdminReportExport(), buildPlatformReportExport(), complaintVolume(), HostelAdminReportExportInput, hostelNamesByIdFor(), hostelsByStatus(), normalizeObjectId() (+9 more)
...
Cohesion: 0.22
Nodes (17): AttendanceLog, AuditLog, code:typescript ({), code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({), code:typescript ({), FoodReadyLog (+9 more)
...
Cohesion: 0.15
Nodes (13): apiRequest(), getActivationStatus(), getResidentNightStatus(), refreshSession(), register(), ResidentNightStatus, triggerSOS(), updateResidentNightStatus() (+5 more)
...
Cohesion: 0.26
Nodes (14): AttendanceAlert, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript (interface IQuestionCallClick {), code:typescript ({), Community Feature, CommunityComment (+6 more)
...
Cohesion: 0.19
Nodes (9): createExpertConsultationRequest(), ExpertConsultationCreateInput, ExpertConsultationError, ExpertConsultationRequestRecord, getMyExpertConsultationRequest(), notifyTeamOfRequest(), expertConsultationCreateSchema, expertConsultationRequestSchema (+1 more)
...
Cohesion: 0.2
Nodes (9): POST(), RouteContext, DEFAULT_GUARDIAN_PERMISSIONS, guardianAccessCreateSchema, guardianInvitationAcceptSchema, guardianLoginSchema, guardianPermissionsSchema, guardianPermissionsUpdateSchema (+1 more)
...
Cohesion: 0.2
Nodes (8): activateResident(), AuthSession, AppNavigator(), Stack, Props, ResidentActivationScreen(), styles, ResidentFoodScreen()
...
Cohesion: 0.25
Nodes (4): PlatformConfigContentPageContent, CONTENT_ICON_SLUGS, ContentPage, ContentSection
...
Cohesion: 0.25
Nodes (7): calendarRoot, config, { getDefaultConfig }, netinfoShim, path, plansRoot, { withNativeWind }
...
## Knowledge Gaps
- **5024 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+5019 more)
...
- **Why does `Button()` connect `Community 0` to `Community 1`, `Community 2`, `Community 5`, `Community 8`, `Community 9`, `Community 11`, `Community 14`, `Community 143`, `Community 16`, `Community 23`, `Community 24`, `Community 25`, `Community 27`, `Community 158`, `Community 31`, `Community 34`, `Community 36`, `Community 40`, `Community 42`, `Community 52`, `Community 58`, `Community 71`, `Community 84`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 129` to `Community 130`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 14`, `Community 15`, `Community 152`, `Community 154`, `Community 27`, `Community 284`, `Community 164`, `Community 37`, `Community 38`, `Community 41`, `Community 44`, `Community 45`, `Community 47`, `Community 49`, `Community 55`, `Community 62`, `Community 64`, `Community 66`, `Community 82`, `Community 84`, `Community 116`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 36` to `Community 0`, `Community 11`, `Community 14`, `Community 21`, `Community 22`, `Community 23`, `Community 25`, `Community 26`, `Community 27`, `Community 31`, `Community 160`, `Community 35`, `Community 37`, `Community 40`, `Community 41`, `Community 42`, `Community 45`, `Community 49`, `Community 54`, `Community 65`, `Community 76`, `Community 79`, `Community 81`, `Community 101`, `Community 109`, `Community 111`, `Community 253`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Are the 374 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 374 INFERRED edges - model-reasoned connections that need verification._
