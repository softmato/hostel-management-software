# Graph Report - hostel-management-software  (2026-08-06)

## Corpus Check
- 897 files · ~1,708,286 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6919 nodes · 17576 edges · 311 communities (294 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 305 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 411 edges
2. `successResponse()` - 406 edges
3. `connectToDatabase()` - 257 edges
4. `cn()` - 215 edges
5. `connectToDatabase()` - 186 edges
6. `requireHostelStaffPrincipal()` - 116 edges
7. `requireHostelCapability()` - 109 edges
8. `browserApi()` - 106 edges
9. `usePortalResource()` - 79 edges
10. `requireResidentPrincipal()` - 72 edges
...
## Communities (311 total, 17 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (122): GET(), GET(), GET(), POST(), GET(), PATCH(), RouteContext, recordConsent() (+114 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (174): sendEmail(), listHostelAdminInquiries(), addHostelAdminProfilePhoto(), deleteHostelAdminProfilePhoto(), getHostelAdminProfile(), HostelAdminProfileQuery, HostelAdminProfileUpdateInput, HostelChangeRequestInput (+166 more)
...
Cohesion: 0.03
Nodes (101): CommunityReportDialog(), REASONS, Notification, ModerationButton(), PagerButton(), normalize(), PortalSearch(), PortalTone (+93 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (73): PATCH(), POST(), RouteContext, POST(), POST(), RouteContext, GET(), PATCH() (+65 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (74): Filter, ModeratedPost, ModerationPayload, GuardianDashboard, MatrixRow, MatrixTotals, humanizeValue(), ImportedProfileSummary() (+66 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (71): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel(), ConfirmOptions, Resolver, useConfirm() (+63 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (89): GET(), querySchema, RouteContext, AnnouncementInput, CommentCreateInput, commentOnPost(), CommentRecord, CommunityServiceError (+81 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (64): PRIORITIES, STATUS_ACTIONS, Campaign, Resident, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel (+56 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (79): getResidentAttendance(), listAttendanceAlerts(), listResidentComplaints(), getFoodRoutine(), listFoodForResident(), listPublicFoodRoutine(), submitFoodFeedback(), uploadFoodPhoto() (+71 more)
...
Cohesion: 0.03
Nodes (55): Complaint, ComplaintSummary, currency(), EmptyState(), field(), FoodMenu, Input(), LoadingRows() (+47 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (49): CommunityPageContent(), csvField(), deferLoad(), DemoDataBadge(), field(), Inquiry, LoadState, Message() (+41 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (43): auditGuardianAction(), createGuardianAccess(), expiresInDays(), findAdminResident(), GuardianAccessCreateInput, GuardianAccessRecord, GuardianLoginInput, GuardianPermissionRecord (+35 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (34): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminFoodPage, HostelAdminComplaintsPage() (+26 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (58): demoteToPublicAccount(), CapacityError, claimBedForRoomType(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary(), releaseBedForRoomType() (+50 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (62): paymentProofSchema, receiptSchema, arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId (+54 more)
...
Cohesion: 0.04
Nodes (53): HostelAdminCommunityPageContent, EMPTY_SUMMARY, HostelAdminComplaintsPage, HostelAdminFeePlansPageContent, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek (+45 more)
...
Cohesion: 0.14
Nodes (36): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), verificationEmail(), guardianInvitationEmail(), sosAlertEmail(), cookPortalEnabledEmail() (+28 more)
...
Cohesion: 0.05
Nodes (47): PaginationMeta, PaginationQuery, paginationQuerySchema, querySchema, deviceTokenSchema, noticeReadStatusSchema, notificationSchema, mocks (+39 more)
...
Cohesion: 0.05
Nodes (34): AccountDeletionPanel, LegalBody(), PortalShell(), buildValues(), PublicAboutPage(), values, buildPosts(), posts (+26 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (28): MockSessionModel, serviceMocks, session, user, authorUserId, leanResult(), mocks, postId (+20 more)

### Community 28 - "Community 28"
Cohesion: 0.07
Nodes (43): CSV_COLUMNS, GET(), POST(), safeEqual(), GET(), csvCell(), csvFilename(), csvResponse() (+35 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (36): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, HostelPhotoReminder(), navItems, navItems, canAccessWorkspace(), defaultWorkspaceSlug(), isAuthBypassed() (+28 more)

### Community 30 - "Community 30"
Cohesion: 0.06
Nodes (43): CachedConnection, globalForMongoose, candidateRoots, { loadEnvConfig }, require, ADMIN_ISSUABLE_ROLES, AdminIssuableRole, generateTemporaryPassword() (+35 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (28): HostelTable(), Contact, PlatformApplication, PlatformHostelDetail, PlatformHostelDocument, TABS, ACTION_CONFIG, ActionKey (+20 more)

### Community 32 - "Community 32"
Cohesion: 0.08
Nodes (36): publicInquiryCreateSchema, POST(), RouteContext, cookieAccessToken(), isRole(), loadApiPrincipal(), authMocks, request (+28 more)

### Community 33 - "Community 33"
Cohesion: 0.07
Nodes (41): serviceProviderApplicationSchema, serviceProviderDocumentSchema, ACTIVE_APPLICATION_STATUSES, approveServiceProvider(), auditProviderAction(), findOwnProvider(), findProviderOrThrow(), getApprovedServiceProviderForHostel() (+33 more)

### Community 34 - "Community 34"
Cohesion: 0.11
Nodes (38): notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus(), OPEN_STATUSES, OverdueComplaint, runComplaintSlaCheck(), HostelRef, notifyHostelOfInquiry() (+30 more)

### Community 35 - "Community 35"
Cohesion: 0.07
Nodes (39): qrActivationSchema, activateResident(), ActivationCodeGenerateInput, ActivationCodeInput, activationSecret(), ActivationServiceError, ActivationStatus, ActivationStatusQuery (+31 more)
...
Cohesion: 0.07
Nodes (37): referralSchema, referralCodeSchema, referralRewardSchema, assertActiveReferralCode(), auditReferralAction(), confirmReferralJoined(), createReferredInquiry(), findActiveReferralCode() (+29 more)

### Community 38 - "Community 38"
Cohesion: 0.06
Nodes (38): assertHostelAccess(), canAccessHostel(), hostelScopedFilter(), TenantAccessError, TenantPrincipal, notificationCampaignSchema, CampaignListQuery, CampaignRecord (+30 more)
...
Cohesion: 0.09
Nodes (41): HostelServiceError, getHostelViewStats(), hashUserAgent(), HostelRef, newVisitorKey(), recordHostelPageView(), resolveVisitorKey(), averageResolutionDays() (+33 more)
...
Cohesion: 0.09
Nodes (32): GET(), POST(), POST(), AccountDeletionError, applyImmediateEffects(), cancelAccountDeletionByToken(), cancelAccountDeletionForUser(), cancelUrlFor() (+24 more)
...
Cohesion: 0.06
Nodes (23): ReportGrid(), ReportRecord, HostelAdminDashboardPageContent, AUDIT_ACTIVITY, AuditLog, CHART_LABELS, MetricTrend, PLACEHOLDER_OWNERS (+15 more)

### Community 49 - "Community 49"
Cohesion: 0.07
Nodes (28): AuthExperiencePage(), CurrentUser, DASHBOARD_ROLES, dashboardHrefForRole(), hasDashboard(), MeResponse, moreItems, navItems (+20 more)

### Community 50 - "Community 50"
Cohesion: 0.07
Nodes (25): BedRecord, MaintenanceCommentCreateInput, MaintenanceCommentRecord, MaintenanceHistoryRecord, MaintenanceRequestCreateInput, MaintenanceRequestListQuery, MaintenanceRequestRecord, MaintenanceServiceError (+17 more)
...
Cohesion: 0.09
Nodes (22): DeletionPathway, DeletionStatus, PATHWAY_COPY, CancelDeletionPageContent(), DeletionQueue, DeletionRequest, PlatformAccountDeletionsPageContent, ResidentQuestionCallCard() (+14 more)

### Community 56 - "Community 56"
Cohesion: 0.08
Nodes (23): AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry() (+15 more)

### Community 57 - "Community 57"
Cohesion: 0.09
Nodes (25): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), robots() (+17 more)
...
Cohesion: 0.1
Nodes (28): Hostel, AttendanceAlert, AttendanceCalendar(), AttendanceRow, HostelAdminAttendancePageContent, Zone, ZONE_ORDER, ZONE_STYLES (+20 more)

### Community 62 - "Community 62"
Cohesion: 0.09
Nodes (29): POST(), acceptGuardianInvitation(), daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput (+21 more)
...
Cohesion: 0.09
Nodes (22): geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex(), HostelRecord (+14 more)
...
Cohesion: 0.11
Nodes (24): uploadPublicFile(), cancelUpload(), handles, UploadHandle, UploadStatus, UploadStore, ApiEnvelope, parseEnvelope() (+16 more)
...
Cohesion: 0.11
Nodes (23): listTrendingTags(), sponsorSchema, GET(), loadPopularHostels(), PopularHostelRecord, assertWindow(), CreateInput, createSponsor() (+15 more)
...
Cohesion: 0.09
Nodes (20): ratingReviewSchema, reviewModerationLogSchema, auditReviewAction(), averageOf(), listPlatformReviews(), listPublicHostelReviews(), moderateReview(), PlatformReviewListQuery (+12 more)
...
Cohesion: 0.09
Nodes (23): platformSettingSchema, coerceSection(), getSiteConfig(), PlatformSettingRecord, SiteConfigServiceError, updateSiteConfigSection(), announcementSchema, facilitiesSchema (+15 more)
...
Cohesion: 0.14
Nodes (12): POST(), POST(), POST(), CronAuthResult, normalizeSecret(), safeEqual(), validateCronRequest(), otpChallengeSchema (+4 more)
...
Cohesion: 0.15
Nodes (15): GET(), getGuardianDashboard(), getGuardianSafetySummary(), listGuardianFood(), listGuardianNotices(), listGuardianPayments(), requireGuardianPrincipal(), GET() (+7 more)

### Community 92 - "Community 92"
Cohesion: 0.1
Nodes (12): accountDeletionRequestSchema, communityCommentSchema, consentLogSchema, questionCallClickSchema, sessionSchema, purgeAccount(), runAccountDeletionPurge(), mocks (+4 more)
...
Cohesion: 0.12
Nodes (18): EmailAttachment, fromAddress(), SendEmailInput, SendEmailResult, ApiPrincipal, activeSuperadminCount(), createPlatformAdmin(), CreatePlatformAdminInput (+10 more)
...
Cohesion: 0.12
Nodes (18): apiRequest(), confirmComplaintResolution(), createPublicInquiry(), createResidentComplaint(), getActivationStatus(), getPublicHostel(), listNotifications(), listResidentComplaints() (+10 more)
...
Cohesion: 0.14
Nodes (16): AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput, ConsentInput, deleteResidentLocationHistory() (+8 more)
...
Cohesion: 0.18
Nodes (12): login(), submitResidentReview(), RootStackParamList, LoginScreen(), Props, Props, PublicHostelDetailScreen(), rentRange() (+4 more)
...
Cohesion: 0.21
Nodes (17): AuditLog, code:typescript (interface ISubscription {), code:typescript (interface IPlatformSetting {), code:typescript (interface IAuditLog {), code:typescript ({), code:typescript ({), FoodReadyLog, Notification (+9 more)
...
Cohesion: 0.14
Nodes (9): Campaign, Hostel, PlatformBroadcastPanel, PlatformOperationsPanel, PlatformAdmin, PlatformOwner, PlatformSettingsPageContent, ROLE_COPY (+1 more)

### Community 122 - "Community 122"
Cohesion: 0.2
Nodes (11): createExpertConsultationRequest(), ExpertConsultationCreateInput, ExpertConsultationError, ExpertConsultationRequestRecord, getMyExpertConsultationRequest(), notifyTeamOfRequest(), expertConsultationCreateSchema, GET() (+3 more)
...
Cohesion: 0.15
Nodes (11): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, ATTENDANCE_DEFAULTS, AttendanceConfig, AttendanceZone, dayKey() (+3 more)
...
Cohesion: 0.16
Nodes (15): code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {), code:typescript ({), code:typescript (interface IMoveInChecklistItem {), code:typescript (interface IMoveOutChecklistItem {), code:typescript (interface IServiceProvider {), Complaint, ComplaintUpdate (+7 more)

### Community 127 - "Community 127"
Cohesion: 0.23
Nodes (15): AttendanceAlert, AttendanceLog, code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({) (+7 more)
...
Cohesion: 0.21
Nodes (14): AccountDeletionRequest, code:typescript ({), code:typescript (interface IQuestionCallClick {), code:typescript ({), code:typescript ({), code:typescript (interface IAccountDeletionRequest {), code:block46 (packages/db/migrations/), Consent & Privacy (+6 more)
...
Cohesion: 0.18
Nodes (9): Avatar(), AVATAR_TONES, avatarTone(), CommunityComment, CommunityMedia, CommunityPostCard(), MediaGrid(), REACTIONS (+1 more)

### Community 142 - "Community 142"
Cohesion: 0.18
Nodes (9): distanceMeters(), hasLocationConsent(), recordLocationPing(), zoneForDistance(), meters, mocks, residentId, residentPrincipal (+1 more)
...
Cohesion: 0.18
Nodes (11): getAttendanceConfig(), getAttendanceSettings(), listHostelAttendance(), overrideAttendance(), resolveAdminHostelId(), resolveAttendanceAlert(), serializeLog(), updateAttendanceSettings() (+3 more)
...
Cohesion: 0.33
Nodes (12): code:typescript (interface IMaintenanceRequest {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IInquiry {), code:typescript (interface IHostelPageView {), code:typescript (// One per resident, per hostel. Minted lazily on first dash), HostelPageView, Inquiries, Referral, Notifications, Subscriptions, Inquiry (+4 more)
...
Cohesion: 0.33
Nodes (8): destinationForRole(), isAllowedNextPath(), isHostelWorkspacePath(), isSafeLocalPath(), ProtectedRouteRule, protectedRouteRuleForPath(), protectedRouteRules, roleAllowedNextPrefixes

### Community 157 - "Community 157"
Cohesion: 0.25
Nodes (9): cook, assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES, PermissionError, PLATFORM_ROLES, Principal (+1 more)
...
Cohesion: 0.27
Nodes (9): dashboardHrefForRole(), landingPathForRole(), accessSecret(), config, proxy(), redirectToLogin(), roleLandingPath, routeAliases (+1 more)
...
Cohesion: 0.24
Nodes (9): ProviderDirectoryData, ServiceProviderRegistrationPage(), DirectoryPageProps, EMPTY, metadata, ServiceProviderDirectoryPage(), ServiceProvidersPage(), listPublicServiceProviders() (+1 more)
...
Cohesion: 0.24
Nodes (10): Attendance / Night Safety, code:typescript (interface INightStatusLog {), code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface INotice {), Food, FoodMenu, FoodPhoto (+2 more)
...
Cohesion: 0.39
Nodes (9): addComplaintUpdate(), attachFiles(), auditComplaintAction(), confirmComplaintResolution(), createComplaint(), replyToComplaint(), serializeComplaint(), slaDueDate() (+1 more)
...
Cohesion: 0.32
Nodes (8): code:typescript (interface IPayment {), code:typescript (interface IPaymentProof {), code:typescript (interface IReceipt {), Payment, PaymentProof, Payments, QR Activation, Receipt
...
Cohesion: 0.47
Nodes (6): code:typescript (interface IServiceProvider {), MaintenanceRequest, Planned for Phase 6 — app account + job marketplace (PRD.md §8.6/§9.6, not yet built), Planned for Phase 6 — job broadcast + claim (PRD.md §8.6/§9.6, not yet built), Service Providers & Maintenance, ServiceProvider
...
## Knowledge Gaps
- **2464 isolated node(s):** `AuthUser`, `ResidentSummary`, `ResidentFoodRoutine`, `ApiSuccess`, `ApiFailure` (+2459 more)
...
- **Why does `Role` connect `Community 27` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 134`, `Community 7`, `Community 142`, `Community 15`, `Community 17`, `Community 18`, `Community 151`, `Community 24`, `Community 156`, `Community 157`, `Community 29`, `Community 158`, `Community 32`, `Community 30`, `Community 34`, `Community 35`, `Community 38`, `Community 170`, `Community 171`, `Community 172`, `Community 44`, `Community 49`, `Community 52`, `Community 53`, `Community 58`, `Community 62`, `Community 67`, `Community 215`, `Community 91`, `Community 98`, `Community 114`, `Community 120`, `Community 121`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 3` to `Community 5`, `Community 6`, `Community 8`, `Community 10`, `Community 11`, `Community 140`, `Community 141`, `Community 14`, `Community 12`, `Community 13`, `Community 20`, `Community 21`, `Community 25`, `Community 26`, `Community 31`, `Community 41`, `Community 45`, `Community 48`, `Community 49`, `Community 53`, `Community 61`, `Community 71`, `Community 76`, `Community 86`, `Community 97`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `browserApi()` connect `Community 55` to `Community 3`, `Community 5`, `Community 6`, `Community 8`, `Community 10`, `Community 11`, `Community 140`, `Community 141`, `Community 14`, `Community 12`, `Community 13`, `Community 20`, `Community 25`, `Community 31`, `Community 41`, `Community 42`, `Community 45`, `Community 48`, `Community 49`, `Community 53`, `Community 61`, `Community 65`, `Community 66`, `Community 75`, `Community 86`, `Community 217`, `Community 121`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Are the 252 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 252 INFERRED edges - model-reasoned connections that need verification._
