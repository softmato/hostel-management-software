...
## Corpus Check
- 2285 files · ~4,077,953 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18404 nodes · 51482 edges · 591 communities (559 shown, 32 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 852 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 732 edges
2. `successResponse()` - 709 edges
3. `connectToDatabase()` - 513 edges
4. `useAppTheme()` - 422 edges
5. `cn()` - 337 edges
6. `connectToDatabase()` - 273 edges
7. `unwrap()` - 230 edges
...
## Communities (591 total, 32 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (337): loadOverview(), openStore(), loadMoney(), loadToday(), methodProvider(), loadFinance(), AdminInvoiceMatrix, AdminMaintenance (+329 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (199): ICONS, LABELS, Segment, TONES, FILTERS, Pending, Overview, MoneyData (+191 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (269): AdminCommunityReportsScreen(), AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), Scanner(), AttendanceScreen(), CookInviteScreen(), GuardianInviteScreen() (+261 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (183): PlanPaymentClaim, csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, HostelTable(), Inquiry (+175 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (174): BubbleBackground(), BubbleBackgroundProps, BubbleColors, StarLayer(), StarLayerProps, StarsBackground(), StarsBackgroundProps, AVATAR_MOTION_TRANSITION (+166 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (182): dayKey(), deleteResidentLocationHistory(), getResidentAttendance(), listAttendanceAlerts(), listHostelAttendance(), overrideAttendance(), addComplaintUpdate(), assertComplaintVoiceNote() (+174 more)
...
Cohesion: 0.02
Nodes (165): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult (+157 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (161): HIDDEN, RoleLayout(), TABS, FILTERS, invalidateFeeds(), NIGHT_ANSWER_LABELS, nightAnswerText(), NightPromptAnswer() (+153 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (137): POST(), GET(), POST(), POST(), POST(), POST(), GET(), POST() (+129 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (137): AdminCommunityScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+129 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (158): PaymentMonthStrip(), ManageRatesScreen(), ClearFilters(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard() (+150 more)
...
Cohesion: 0.03
Nodes (112): GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, CITY_OPTIONS (+104 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (107): PreviewCard(), ResultRow(), SavedListRow(), BrowseParams, BUDGET_BANDS, FilterSheet(), HostelBrowserProps, NearestToggle() (+99 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (141): CommunityPageContent(), Badge(), grabDocument(), HostelAdminBillingPageContent(), InvoiceRow(), PaymentRow(), PlanCard(), rupees() (+133 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (136): notifyHostelOfNewPost(), resolveHostelCommunityUserIds(), usersMutingNewPosts(), cookPrincipal, mocks, resolveCookLabels(), CookServiceError, resolveAdminHostelId() (+128 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (104): recordConsent(), attendanceAlertResolveSchema, attendanceListQuerySchema, attendanceOverrideSchema, attendanceSettingsSchema, consentSchema, locationPingSchema, objectIdSchema (+96 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (142): DeletionPanel(), BookingForm(), METHODS, PackageCard(), PayStep(), roomPhotoUris(), StatusCard(), describeGrants() (+134 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (129): OPEN_STATUSES, OverdueComplaint, approveClaim(), assertNotAlreadyRecordedFromStatement(), bulkApproveClaims(), BulkApproveResult, ClaimCheck, claimChecks() (+121 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (122): EMPTY_SUMMARY, CookAccount, Credentials, HostelAdminCooksPanel, Issued, HostelAdminExistingResidentsPage(), ConcessionBackfill, describeApplied() (+114 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (113): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), ApplyBlock(), ServiceProvidersScreen() (+105 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (98): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CancelDeletionPageContent(), CommunityModerationPanel(), Filter, ModeratedPost (+90 more)

### Community 23 - "Community 23"
Cohesion: 0.07
Nodes (97): accountDeletionCancelledEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), dueWhen(), PlanDueInput, planDueSoonEmail() (+89 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (130): bsPeriodBounds(), bsPeriodOf(), periodStartDate(), openOrder(), BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey() (+122 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (111): PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), getPlatformSubscriptionLedger(), listPlanPaymentClaims(), GET(), DELETE(), RouteContext (+103 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (109): HostelAdminCommunityPageContent, HostelAdminComplaintsPage, HostelAdminDashboardPageContent, HostelAdminFeePlansPageContent, HostelAdminInquiriesPageContent, HostelAdminMaintenancePageContent, PRIORITIES, STATUS_ACTIONS (+101 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (114): getHostelLedger(), collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES (+106 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (128): BookingEndCause, bookingProofReceivedEmail(), ENDED_COPY, GuestBase, HostelBookingClosedCause, BookingFacts, bookingFactsTable(), hoursWord() (+120 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (100): BootGate(), RootShell(), BrandSplash(), AuthDivider(), GoogleSignInButton(), acknowledged, HostelSuspensionHost(), remainingLabel() (+92 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (88): AuthShell(), AuthShellProps, PANEL_COPY, SiteWordmark(), metadata, AccountDeletionPanel, ContentHeader(), ContentIntro() (+80 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (89): MESSAGES, POST(), RouteContext, GET(), POST(), PATCH(), RouteContext, setHostelBookingPause() (+81 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (77): PATCH(), POST(), RouteContext, GET(), PATCH(), RouteContext, POST(), RouteContext (+69 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (89): POST(), readReturnState(), GET(), ownerIdentitiesFor(), resolveOwnedHostel(), getSubscriptionState(), POST(), DELETE() (+81 more)

### Community 34 - "Community 34"
Cohesion: 0.02
Nodes (82): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery (+74 more)

### Community 35 - "Community 35"
Cohesion: 0.02
Nodes (91): EMPTY_PAYOUT_DRAFT, METHODS, PayoutAccountDraft, PayoutAccountFields(), payoutAccountPayload(), DescriptionFacts, DescriptionSuggestions(), HostelType (+83 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (79): POST(), GET(), GET(), POST(), recordListingAppearances(), addHostelAdminProfilePhoto(), deleteHostelAdminProfilePhoto(), addHostelAdminProfilePhoto() (+71 more)

### Community 37 - "Community 37"
Cohesion: 0.02
Nodes (87): AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, LIVE_ACCESS, releaseGuardianAccounts(), hostelId (+79 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (100): CardBooking, checkInBooking(), findCardBooking(), findHeldBooking(), returnHeldBed(), takeHeldBed(), account, answerBy (+92 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (100): notifyAdminsOfNewComplaint(), notifyResidentOfComplaintStatus(), runComplaintSlaCheck(), EmailAttachment, ExpertConsultationCreateInput, ExpertConsultationError, ExpertConsultationRequestRecord, notifyTeamOfRequest() (+92 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (90): runPlanDueReminders(), financeIntegrityHash(), GATEWAY_ORDER, getHostelPayMethods(), getPayInstructions(), HostelPayMethods, InvoiceRecord, methodsFrom() (+82 more)

### Community 41 - "Community 41"
Cohesion: 0.03
Nodes (82): Notification, BrowserPushRow(), FILTERS, Notification, NotificationRow(), PushState, FILTERS, NotificationCard (+74 more)

### Community 42 - "Community 42"
Cohesion: 0.03
Nodes (78): BookingQuote, GuestBookingDetail, GuestBookingSummary, HostelBookingView, metadata, PayoutAccountForReview, ReviewPayoutAccount(), STATUS_LABEL (+70 more)

### Community 43 - "Community 43"
Cohesion: 0.03
Nodes (100): demoteToPublicAccount(), activeCode, codeId, hostelId, joinedResidentId, mocks, otherHostelId, paymentId (+92 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (81): CommunityScreen(), Composer(), CommunityPostScreen(), AnimatedBlurView, CommunityBoard(), CommunityBoardProps, Composer(), SORTS (+73 more)

### Community 45 - "Community 45"
Cohesion: 0.03
Nodes (84): summarizeResidentComplaints(), LedgerInvoice, emergencyContactSchema, noticeSchema, noticeReadStatusSchema, qrActivationSchema, residentSchema, roomSchema (+76 more)

### Community 46 - "Community 46"
Cohesion: 0.03
Nodes (86): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), PROVIDER_LABEL, QrPanel(), DetailsCard() (+78 more)

### Community 47 - "Community 47"
Cohesion: 0.03
Nodes (90): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), AdminTabs(), AdminMoneyScreen(), AdminTodayScreen(), AdminAlertsContext, AdminAlertsValue (+82 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (88): GET(), decodeKey(), decryptPersonalData(), encryptionKey(), encryptPersonalData(), isPersonalDataEncryptionConfigured(), personalLookupHash(), resetPersonalDataKeyCache() (+80 more)

### Community 49 - "Community 49"
Cohesion: 0.03
Nodes (63): GET(), POST(), GET(), bookingDocumentResponse(), resolveBookingDocument(), POST(), authorUserId, leanResult() (+55 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (96): EMPTY_ROUTINE, addHostelAdminInquiryNote(), appHostelStatusUrl(), archivePlatformHostel(), auditHostelAction(), BedCreateInput, BedRecord, BedUpdateInput (+88 more)
...
Cohesion: 0.04
Nodes (71): listPausedHostels(), GET(), POST(), RouteContext, DELETE(), GET(), hostelId(), GET() (+63 more)

### Community 53 - "Community 53"
Cohesion: 0.06
Nodes (81): SORTS, StoreCategoryScreen(), addToCart(), Cart, CartLine, CartResult, CartTotals, clearCart() (+73 more)
...
Cohesion: 0.04
Nodes (82): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags(), documentFlags() (+74 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (56): Platform, GetPlanButton(), CopyButton(), GatewayProviderName, ManualMethodPanel(), MethodIcon(), methodKey(), methodLabel() (+48 more)

### Community 57 - "Community 57"
Cohesion: 0.03
Nodes (51): generateMetadata(), generateMetadata(), metadata, ComparePage(), generateMetadata(), hostels, metadata, rows (+43 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (69): notifyResidentOfComplaintReply(), notifyProviderOfAssignment(), notifyProviderOfMaintenanceNote(), notifyProviderOfStatusChange(), notifyStaffOfNewMaintenanceRequest(), providerUserId(), readableCategory(), RequestLike (+61 more)

### Community 59 - "Community 59"
Cohesion: 0.06
Nodes (51): POST(), POST(), POST(), POST(), POST(), POST(), RouteContext, POST() (+43 more)

### Community 60 - "Community 60"
Cohesion: 0.03
Nodes (67): TIER_TONE, ListingTierTone, Plan, PlanId, portalAccessLines(), Service, ServiceModule, ServiceModuleId (+59 more)

### Community 61 - "Community 61"
Cohesion: 0.04
Nodes (69): BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsMonthStart(), bsPeriodsBetween() (+61 more)

### Community 62 - "Community 62"
Cohesion: 0.08
Nodes (66): BookingDocumentInput, bookingDocumentLayout(), refundPolicyNotes(), renderBookingDocument(), bsFiscalYear(), amountInWords(), GROUPS, ONES (+58 more)
...
Cohesion: 0.05
Nodes (67): Choice, Compass(), maneuverIcon(), MapButton(), ModeTab(), NavCard(), NOTHING_CHOSEN, RouteCard() (+59 more)

### Community 65 - "Community 65"
Cohesion: 0.05
Nodes (59): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, metadata, isAuthBypassEnabled(), original, CookieReader, hasSessionCookie(), LEGACY_ACCESS_TOKEN_COOKIES (+51 more)
...
Cohesion: 0.04
Nodes (47): ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, attempt, fetchMock, forged, live (+39 more)

### Community 69 - "Community 69"
Cohesion: 0.07
Nodes (60): BookableHostel, BookingUnavailableReason, findRoom(), hostelAddress(), HostelAvailability, hostelCoverPhoto(), hostelCoverPhotos(), hostelUnavailableReason() (+52 more)

### Community 70 - "Community 70"
Cohesion: 0.05
Nodes (60): hostelForm(), buildHostelPayload(), capacitySummary(), CITY_OPTIONS, emptyHostelForm(), emptyRoomRow(), FACILITY_OPTIONS, firstIncompleteHostelStep() (+52 more)
...
Cohesion: 0.04
Nodes (57): findIndex(), index, indexesOf(), IndexSpec, promote, listResidentInvoices(), issueReceiptForEvent(), IssueReceiptInput (+49 more)
...
Cohesion: 0.05
Nodes (50): CSV_COLUMNS, GET(), POST(), RouteContext, listTrendingTags(), POST(), safeEqual(), sponsorSchema (+42 more)

### Community 75 - "Community 75"
Cohesion: 0.06
Nodes (59): formatBsPeriod(), formatBsPeriodMonth(), formatBsPeriodYear(), formatPeriodKey(), isBsPeriod(), periodParts(), cellAt(), focusCell() (+51 more)

### Community 76 - "Community 76"
Cohesion: 0.04
Nodes (44): FeedPayload, NewPostAlertsToggle(), SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES, avatarTone() (+36 more)

### Community 77 - "Community 77"
Cohesion: 0.06
Nodes (44): POST(), hostelToday(), GET(), GET(), querySchema, applicantSchema, billingCycleSchema, HostelRegistrationInput (+36 more)
...
Cohesion: 0.06
Nodes (52): fill(), money(), PlanCard(), PricingScreen(), metadata, UpgradeDialog(), checkout(), day() (+44 more)
...
Cohesion: 0.05
Nodes (44): Choice, HOSTEL_TYPE_LABELS, HostelPanel(), MapButton(), MapCanvas, ModeTab(), NavigationPanel(), NOTHING_CHOSEN (+36 more)

### Community 82 - "Community 82"
Cohesion: 0.06
Nodes (41): AuthGuard(), HostelSuggestions(), PublicHostel, checkOnly(), EMPTY_PREFILL, ENVIRONMENT_OPTIONS, IdentityResponse, Prefill (+33 more)

### Community 83 - "Community 83"
Cohesion: 0.06
Nodes (51): paymentProofSchema, arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal (+43 more)
...
Cohesion: 0.08
Nodes (47): documentDownloadUrl(), IssuedInvoice, openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt, allocateReceiptNumber(), applySettlement() (+39 more)
...
Cohesion: 0.06
Nodes (45): triageReportedPost(), TriageVerdict, extractJsonPayload(), parseModelJson(), sanitizeJsonPayload(), VALID_JSON_ESCAPES, buildMessages(), CHAT_ENDPOINTS (+37 more)

### Community 90 - "Community 90"
Cohesion: 0.08
Nodes (44): storeOrderSchema, storeObjectId(), mocks, allocateOrderNumber(), applyStatus(), CancelInput, cancelOrder(), CreateInput (+36 more)

### Community 91 - "Community 91"
Cohesion: 0.07
Nodes (41): GuidanceStatus, useGuidance(), hasGeolocation(), LocationOutcome, NavigationFix, OrientationPermission, requestDeviceLocation(), requestHeadingPermission() (+33 more)

### Community 92 - "Community 92"
Cohesion: 0.06
Nodes (22): LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminSOSAlertsPage(), HostelAdminFoodPage(), HostelAdminNoticesPage(), redirectToWorkspaceScreen() (+14 more)
...
Cohesion: 0.09
Nodes (39): noticePushSchema, announceChange(), audit(), CreateInput, createNoticePush(), DEFAULT_PUSHES, deleteNoticePush(), dispatchDueNoticePushes() (+31 more)
...
Cohesion: 0.07
Nodes (33): applyBookingConfig(), BookingCancelStep, PLATFORM_SETTING_CHANGE_STATUSES, platformSettingChangeSchema, bookings, CollectionQr, isSettingChangeKey(), SETTING_CHANGES (+25 more)
...
Cohesion: 0.09
Nodes (40): otpResendCooldownMs(), issueInvoiceDocument(), fail(), findHostelForCheckout(), HostelMatch, paymentState(), PlanCheckoutInput, planCheckoutSchema (+32 more)
...
Cohesion: 0.07
Nodes (33): referralSchema, referralCodeSchema, referralRewardSchema, describeReward(), notifyReferralJoined(), notifyReferralReward(), referrerUserId(), rewardNotice() (+25 more)
...
Cohesion: 0.07
Nodes (34): deliver(), emailFacts(), getHostelPayoutAccount(), hostelOrThrow(), notifyPlatformOfPayoutReview(), PayoutAccountStatus, PayoutAccountView, PayoutActor (+26 more)

### Community 107 - "Community 107"
Cohesion: 0.09
Nodes (32): NightStatusForm(), AlertRow(), SosScreen(), isCurrentNight(), isSelfReportable(), NIGHT_STATUS_OPTIONS, nightKey(), nightNote() (+24 more)
...
Cohesion: 0.09
Nodes (34): candidatesInRun(), canonicalize(), checkCharacter(), CONFUSABLES, decodeSequence(), deriveHostelPrefix(), encodeSequence(), extractReferenceCodes() (+26 more)
...
Cohesion: 0.09
Nodes (30): addBsMonths(), august, bhadra, dateAgo(), hostelId, invoice(), mocks, NOW (+22 more)

### Community 125 - "Community 125"
Cohesion: 0.09
Nodes (27): EvidenceEngine, EvidenceEngineMode, EvidenceReadFailure, OcrResult, OcrWord, KEYS, saved, accessToken() (+19 more)
...
Cohesion: 0.14
Nodes (31): assertMatchesExtension(), beginDownload(), downloadAndShare(), downloadAndShareCsv(), downloadAndShareImage(), downloadToDevice(), forgetDownloadFolder(), LegacyFileSystem (+23 more)

### Community 129 - "Community 129"
Cohesion: 0.09
Nodes (25): inquiryId, serviceMocks, staffPrincipal, BedCreateInput, BedRecord, BedUpdateInput, createHostelAdminBed(), createHostelAdminFloor() (+17 more)
...
Cohesion: 0.06
Nodes (22): claimAmount, dirname, dueAmount, eventId, fractional, hostels, invoiceBalances, invoiceId (+14 more)

### Community 138 - "Community 138"
Cohesion: 0.14
Nodes (24): CsvTable, gridFromCsv(), readCsv(), stripBom(), stripPreamble(), buildTable(), tableFromGrid(), decodeText() (+16 more)
...
Cohesion: 0.08
Nodes (20): LegacyHostelAdminComplaintsPage(), Complaint, ComplaintSummary, field(), FoodMenu, HostelAdminComplaintsPage(), HostelAdminPaymentsPage(), HostelAdminResidentsPage() (+12 more)

### Community 142 - "Community 142"
Cohesion: 0.09
Nodes (25): buildPage(), buildPinPage(), CentrePin(), describeAddress(), HostelPinField(), HostelPinPicker(), KATHMANDU, MapLinkField() (+17 more)
...
Cohesion: 0.11
Nodes (28): AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance(), deadline(), DIGIT_CONFUSABLES, EvidenceRead (+20 more)
...
Cohesion: 0.11
Nodes (24): useIsUploading(), ensureChannel(), startUploadNotifications(), dismissUpload(), getUploadRows(), listeners, pruneUploads(), resetUploadQueue() (+16 more)
...
Cohesion: 0.1
Nodes (24): peekHeaders(), ESEWA_CSV_PARSER, both, corrupted, debit, [first], FIXTURE, headerOnly (+16 more)

### Community 153 - "Community 153"
Cohesion: 0.1
Nodes (19): auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex(), HostelRecord, ListingFlagListQuery, ListingFlagRecord, ListingFlagResolveInput, ListingFlagServiceError (+11 more)
...
Cohesion: 0.09
Nodes (20): challengeId, mocks, other, owned, ownerId, typed, HostelAdminProfileQuery, HostelAdminProfileUpdateInput (+12 more)
...
Cohesion: 0.12
Nodes (25): code:typescript (interface IFoodPhoto {), code:typescript (interface IComplaintUpdate {), code:typescript ({), code:typescript (interface IMoveInChecklistItem {), code:typescript (interface IMoveOutChecklistItem {), code:typescript (interface IServiceProvider {), code:typescript (interface IServiceProvider {), code:typescript (interface IMaintenanceRequest {) (+17 more)
...
Cohesion: 0.18
Nodes (19): bodySchema, POST(), deleteHostelObjects(), r2Configured(), storePublicAsset(), AccessLevel, bucketForAccessLevel(), deleteFromR2() (+11 more)
...
Cohesion: 0.11
Nodes (23): Attendance / Night Safety, Build status (end of Phase 3), Build status (end of Phase 5 — verified 2026-08-02), code:typescript (export enum Role {), code:typescript (interface INightStatusLog {), code:typescript (interface IFoodRoutine {), code:typescript (interface INotice {), code:typescript (interface IComplaint {) (+15 more)
...
Cohesion: 0.1
Nodes (20): AMOUNT_ALIASES, CREDIT_ALIASES, AMOUNT_ALIASES, CREDIT_ALIASES, DATE_ALIASES, DEBIT_ALIASES, NAME_ALIASES, REMARKS_ALIASES (+12 more)
...
Cohesion: 0.12
Nodes (19): readPhone(), columnFor(), ColumnKey, EXISTING_RESIDENT_COLUMNS, ExistingResidentFileError, ExistingResidentFileResult, ExistingResidentFileRow, EXTRA_COLUMNS (+11 more)
...
Cohesion: 0.13
Nodes (17): addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery, HostelAdminInquiryStatusInput, InquiryNoteCreateInput, InquiryNoteRecord, InquiryRecord (+9 more)
...
Cohesion: 0.2
Nodes (13): computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), distance, SystemDocumentKind, loadSharp(), SharpFactory, POST() (+5 more)
...
Cohesion: 0.16
Nodes (15): liftHostelSuspension(), OPEN_WHILE_SUSPENDED, serializeSuspension(), hostelObjectId(), HostelSuspensionError, liftPlatformHostelSuspension(), startHostelSuspension(), SUSPENSION_REASONS (+7 more)
...
Cohesion: 0.15
Nodes (13): AuthSession, login(), submitResidentReview(), AppNavigator(), RootStackParamList, Stack, LoginScreen(), Props (+5 more)
...
Cohesion: 0.14
Nodes (16): InvoiceDocumentInput, InvoicePresentation, DocumentKind, InvoiceRow, invoiceStatus(), loadIssuer(), methodLabel(), PAYMENT_METHODS (+8 more)
...
Cohesion: 0.18
Nodes (18): AccountDeletionRequest, code:typescript ({), code:typescript ({), code:typescript (interface IAccountDeletionRequest {), code:block43 (packages/db/migrations/), code:typescript ({), code:typescript (interface IAccountDeletionRequest {), code:block46 (packages/db/migrations/) (+10 more)
...
Cohesion: 0.15
Nodes (13): evidenceTextFlags(), looksLikePaymentReceipt(), receiptSignals(), canvas, ctx, esewa, ESEWA_PDF_LINES, extracted (+5 more)
...
Cohesion: 0.26
Nodes (5): CouldNotCreateFileException, HostelPalikaDownloadsModule, NoContextException, UnreadableSourceException, UnsupportedOnThisAndroidException

### Community 285 - "Community 285"
Cohesion: 0.24
Nodes (13): cookEmailForSlug(), generatePassword(), provisionCookAccount(), appLoginUrl(), approvePlatformHostel(), grantHostelOwnerAccess(), provisionApprovalCookAccount(), CARD_LABELS (+5 more)
...
Cohesion: 0.27
Nodes (14): AuditLog, code:typescript ({), code:typescript ({), code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({), FoodReadyLog, Notification (+6 more)

### Community 294 - "Community 294"
Cohesion: 0.16
Nodes (14): 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails, 4.2 Complaint Status Updated, 4.3 Complaint Resolved (+6 more)
...
Cohesion: 0.2
Nodes (11): activateResident(), apiRequest(), confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listResidentComplaints(), refreshSession(), ResidentComplaint (+3 more)
...
Cohesion: 0.31
Nodes (3): Claim, HostelHubDownloadsModule, file
...
Cohesion: 0.18
Nodes (9): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES (+1 more)
...
Cohesion: 0.22
Nodes (8): getResidentProfile(), Props, ResidentActivationScreen(), styles, Profile, Props, ResidentProfileScreen(), screenStyles
...
Cohesion: 0.38
Nodes (8): cleanAccountNumber(), cleanName(), looksLikeName(), normalizeDigits(), QrPayeeRead, readQrPayee(), readUnlabelledPoster(), read
...
Cohesion: 0.25
Nodes (5): IMAGE, lines, logged, mocks, saved
...
Cohesion: 0.4
Nodes (5): ImageVariantRecord, optimizeImage(), streamToBuffer(), VARIANT_CONFIG, VariantName
...
## Knowledge Gaps
- **6447 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+6442 more)
...
- **Why does `cn()` connect `Community 4` to `Community 1`, `Community 3`, `Community 132`, `Community 12`, `Community 13`, `Community 141`, `Community 15`, `Community 20`, `Community 22`, `Community 151`, `Community 413`, `Community 30`, `Community 35`, `Community 41`, `Community 42`, `Community 304`, `Community 51`, `Community 56`, `Community 60`, `Community 71`, `Community 75`, `Community 76`, `Community 79`, `Community 81`, `Community 82`, `Community 84`, `Community 88`, `Community 95`, `Community 110`, `Community 255`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 8`, `Community 10`, `Community 11`, `Community 14`, `Community 142`, `Community 18`, `Community 20`, `Community 21`, `Community 22`, `Community 29`, `Community 30`, `Community 41`, `Community 44`, `Community 46`, `Community 47`, `Community 53`, `Community 54`, `Community 56`, `Community 64`, `Community 70`, `Community 73`, `Community 76`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 5` to `Community 129`, `Community 259`, `Community 133`, `Community 6`, `Community 7`, `Community 12`, `Community 140`, `Community 16`, `Community 19`, `Community 24`, `Community 25`, `Community 153`, `Community 27`, `Community 28`, `Community 285`, `Community 31`, `Community 33`, `Community 34`, `Community 163`, `Community 36`, `Community 37`, `Community 38`, `Community 39`, `Community 40`, `Community 165`, `Community 166`, `Community 43`, `Community 45`, `Community 48`, `Community 50`, `Community 52`, `Community 54`, `Community 55`, `Community 58`, `Community 59`, `Community 60`, `Community 63`, `Community 65`, `Community 67`, `Community 68`, `Community 69`, `Community 195`, `Community 72`, `Community 201`, `Community 74`, `Community 77`, `Community 78`, `Community 83`, `Community 85`, `Community 86`, `Community 87`, `Community 217`, `Community 90`, `Community 96`, `Community 97`, `Community 98`, `Community 100`, `Community 101`, `Community 230`, `Community 231`, `Community 102`, `Community 106`, `Community 109`, `Community 111`, `Community 113`, `Community 242`, `Community 116`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Are the 508 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 508 INFERRED edges - model-reasoned connections that need verification._
