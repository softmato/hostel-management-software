...
## Corpus Check
- 1882 files · ~3,251,964 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14942 nodes · 41097 edges · 495 communities (471 shown, 24 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 655 edges (avg confidence: 0.8)
...
3. `connectToDatabase()` - 413 edges
4. `useAppTheme()` - 362 edges
5. `cn()` - 276 edges
6. `connectToDatabase()` - 239 edges
7. `unwrap()` - 194 edges
...
## Communities (495 total, 24 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (238): POST(), PATCH(), POST(), RouteContext, GET(), POST(), GET(), POST() (+230 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (276): POST(), GET(), getOpenFeeSchedule(), GET(), getFoodRoutinesByHostelId(), addUtcDay(), auditFoodAction(), createFoodMenu() (+268 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (265): methodProvider(), loadFinance(), ManageRatesScreen(), getAdminFoodRoutine(), ActivationIssue, addEmergencyContact(), addHostelPhoto(), addInquiryNote() (+257 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (160): MoneyData, MANAGE_ROWS, PORTAL_ROWS, Person, SETTINGS_TITLES, THEME_OPTIONS, needsResident(), OPEN_STATUSES (+152 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (168): Filter, ModeratedPost, ModerationPayload, csvField(), deferLoad(), DemoDataBadge(), field(), Hostel (+160 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (139): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage() (+131 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (196): ReviewForm(), ReviewScreen(), SORTS, DeletionRequest, DeletionStatus, getDeletionStatus(), requestAccountDeletion(), addCook() (+188 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (161): metadata, CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+153 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (137): Choice, MapScreen(), NOTHING_CHOSEN, PreviewCard(), ResultRow(), SavedListRow(), BrowseParams, BUDGET_BANDS (+129 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (142): HOSTEL, MONTHS, UiPreview(), TABS, ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+134 more)
...
Cohesion: 0.02
Nodes (140): deleteResidentLocationHistory(), getResidentAttendance(), DELETE(), checkoutSchema, POST(), confirmComplaintResolution(), listResidentComplaints(), complaintCategorySchema (+132 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (133): listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), GET(), POST(), querySchema, RouteContext (+125 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (114): FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, monthStartPeriod(), Rate, RoomTypeOption, gregorianSpan(), MonthField (+106 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (138): Scanner(), CookInviteScreen(), GuardianInviteScreen(), Compass(), MapButton(), ModeTab(), RouteCard(), Assurance() (+130 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (132): PaymentMonthStrip(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), PortalDates, ClaimsCard(), InvoiceDetailScreen() (+124 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (142): AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), AttendanceScreen(), NightStatusForm(), NightStatusScreen(), ProfileScreen(), ReferralRow() (+134 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (101): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CancelDeletionPageContent(), CommunityModerationPanel(), useConfirm(), AcceptResult (+93 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (119): AdminAlertsScreen(), ICONS, LABELS, Segment, TONES, AdminCommunityReportsScreen(), FILTERS, Pending (+111 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (106): GET(), POST(), GET(), readReturnState(), ownerIdentitiesFor(), resolveOwnedHostel(), allocateNumber(), findOpenInvoice() (+98 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (105): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), BootGate(), RootShell() (+97 more)
...
Cohesion: 0.03
Nodes (99): Choice, HOSTEL_TYPE_LABELS, MapButton(), MapCanvas, ModeTab(), NavigationPanel(), NOTHING_CHOSEN, PublicMapPage() (+91 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (93): PRIORITIES, STATUS_ACTIONS, Campaign, Resident, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel (+85 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (103): notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus(), OPEN_STATUSES, OverdueComplaint, runComplaintSlaCheck(), hostelId, mocks (+95 more)
...
Cohesion: 0.04
Nodes (100): AdminCommunityScreen(), FILTERS, NotificationCard(), NotificationRow(), NotificationsScreen(), TILE_GLYPH, TILE_TONES, CommunityScreen() (+92 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (110): fromBs(), gregorianOf(), BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary (+102 more)

### Community 28 - "Community 28"
Cohesion: 0.02
Nodes (86): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, summarizeResidentComplaints(), latestInvoicePerResident(), LedgerInvoice, daysFromNow() (+78 more)

### Community 29 - "Community 29"
Cohesion: 0.02
Nodes (81): adminPrincipal, mocks, PLATFORM_LIMITS, authorUserId, leanResult(), mocks, postId, reactorUserId (+73 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (78): ComparePage(), hostels, metadata, rows, csvField(), field(), Hostel, HostelAdminDashboardPageContent() (+70 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (98): POST(), HostelRef, notifyHostelOfInquiry(), notifyPlatformOfPendingHostel(), assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES (+90 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (98): resolveCookLabels(), announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError, decodePhotoCursor(), encodePhotoCursor() (+90 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (90): GET(), getResidentLedger(), getHostelViewStats(), hashUserAgent(), HostelRef, newVisitorKey(), recordHostelPageView(), resolveVisitorKey() (+82 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (78): PATCH(), RouteContext, PATCH(), RouteContext, GET(), escapeRegex(), objectIdSchema, paginationSchema (+70 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (74): collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor(), LedgerInvoiceRow (+66 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (74): auditFinanceAction(), previousEntryHash(), base, entityId, hostelId, mocks, principal, write() (+66 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (65): FinanceAuditInput, SetResidentFeeInput, ApiPrincipal, PaginationMeta, PaginationQuery, querySchema, DEPRECATED_ALIASES, grantingPermissionKeys() (+57 more)
...
Cohesion: 0.04
Nodes (61): secretsMatch(), ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, attempt, fetchMock, forged (+53 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (52): AuthGuard(), cityOptions, createDocument(), createRoom(), DocumentConfig, DraftData, FACILITY_MINI, facilityOptions (+44 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (65): JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, ProviderStatusCard(), TILE_INK (+57 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (51): metadata, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails(), RenderedSection (+43 more)

### Community 43 - "Community 43"
Cohesion: 0.03
Nodes (64): CookServiceError, resolveAdminHostelId(), assertHostelAccess(), canAccessHostel(), hostelScopedFilter(), TenantAccessError, TenantPrincipal, qrActivationSchema (+56 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (61): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, GATEWAY_ORDER, getHostelPayMethods(), HostelPayMethods, InvoiceRecord, methodsFrom() (+53 more)
...
Cohesion: 0.05
Nodes (68): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthStart(), bsPeriodBounds() (+60 more)
...
Cohesion: 0.05
Nodes (52): HostelPhotoReminder(), HostelSuggestions(), formatHostelAddress(), hostelTypeToUi(), mapPublicHostelToSummary(), PublicHostel, roomTypeLabel(), CATEGORY_LABELS (+44 more)
...
Cohesion: 0.05
Nodes (54): GET(), GET(), GET(), GET(), POST(), platformAdminInviteSchema, acceptPlatformAdminInvitation(), AcceptPlatformAdminInvitationInput (+46 more)
...
Cohesion: 0.04
Nodes (40): CurrentUser, DASHBOARD_ROLES, dashboardHrefForRole(), hasDashboard(), MeResponse, moreItems, navItems, providerNavItems (+32 more)

### Community 58 - "Community 58"
Cohesion: 0.05
Nodes (46): referralSchema, referralCodeSchema, referralRewardSchema, activeCode, codeId, hostelId, joinedResidentId, mocks (+38 more)
...
Cohesion: 0.05
Nodes (42): financeIntegrityHash(), appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind, creditOverpayment(), getCreditAmount(), getCreditBalance() (+34 more)

### Community 61 - "Community 61"
Cohesion: 0.11
Nodes (31): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), verificationEmail(), cookInvitationEmail(), guardianInvitationEmail(), wardRegisteredEmail() (+23 more)

### Community 62 - "Community 62"
Cohesion: 0.07
Nodes (42): isFileAssetKind(), isFinancialAssetKind(), DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList(), positiveInteger(), validateFileAssetMetadata() (+34 more)

### Community 63 - "Community 63"
Cohesion: 0.08
Nodes (35): POST(), POST(), POST(), POST(), POST(), safeEqual(), runBillingCycleForAllHostels(), POST() (+27 more)
...
Cohesion: 0.07
Nodes (41): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), systemDocumentKindFromText(), distance (+33 more)
...
Cohesion: 0.05
Nodes (39): accountDeletionRequestSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, consentLogSchema, sessionSchema, AccountDeletionError, applyImmediateEffects() (+31 more)
...
Cohesion: 0.07
Nodes (45): storeCategorySchema, storeProductSchema, categoriesFor(), getStoreProduct(), ListQuery, serializeStoreCategory(), serializeStoreProduct(), SORTS (+37 more)
...
Cohesion: 0.05
Nodes (34): candidateRoots, fillMissing(), findRepoRoot(), { loadEnvConfig }, loadRootEnv(), parseEnvFile(), require, filled (+26 more)
...
Cohesion: 0.07
Nodes (42): Offset, PhotoCropper(), FileUploadArea(), isActive(), acceptAttribute(), EXTENSION_BY_MIME, FAMILY_BYTES, FAMILY_ORDER (+34 more)
...
Cohesion: 0.08
Nodes (39): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt, allocateReceiptNumber() (+31 more)

### Community 78 - "Community 78"
Cohesion: 0.06
Nodes (37): CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, readId(), activeDevicesFor(), activeTokensFor(), authHeaders(), chunk() (+29 more)
...
Cohesion: 0.05
Nodes (43): CONTENT_ICON_SLUGS, everything, IDENTITY, page, rendered, PLAN_MODULES, PLAN_SERVICES, PLAN_TIERS (+35 more)
...
Cohesion: 0.07
Nodes (37): downloadCaption(), DownloadRow, DownloadStack(), progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster() (+29 more)

### Community 84 - "Community 84"
Cohesion: 0.07
Nodes (34): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery (+26 more)
...
Cohesion: 0.08
Nodes (27): applyWebhook(), WebhookResult, softmato(), SoftmatoNotConfiguredError, isSoftmatoConfigured(), SoftmatoConfig, softmatoWebhookSecret(), ensureSoftmatoInvoice() (+19 more)

### Community 88 - "Community 88"
Cohesion: 0.08
Nodes (32): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), robots() (+24 more)
...
Cohesion: 0.1
Nodes (35): GET(), resolvePastedLink(), searchCandidates(), geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), hostelAdminGeocodeQuerySchema (+27 more)
...
Cohesion: 0.06
Nodes (29): CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing, buildIdCardData() (+21 more)
...
Cohesion: 0.1
Nodes (27): POST(), RouteContext, listTrendingTags(), sponsorSchema, GET(), loadPopularHostels(), PopularHostelRecord, assertWindow() (+19 more)
...
Cohesion: 0.09
Nodes (23): outstandingForResident(), depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, providedItemSchema, auditMoveAction(), createMoveOutChecklist(), findAdminResident() (+15 more)

### Community 104 - "Community 104"
Cohesion: 0.07
Nodes (25): FoodFeedbackInput, FoodFeedbackRecord, FoodMenuCreateInput, FoodMenuListQuery, FoodMenuRecord, FoodMenuUpdateInput, FoodPhotoRecord, FoodPhotoUploadInput (+17 more)
...
Cohesion: 0.12
Nodes (25): RoleLayout(), TABS, useMinuteTick(), useQueryValue(), announceFoodReady(), CookFoodPhoto, CookPhotoDay, CookPhotoFeed (+17 more)
...
Cohesion: 0.09
Nodes (24): TIER_TONE, PlanMark(), ROWS, EASE, listHeadingFor(), PlanCards(), PlanLine(), PlansClosingCta() (+16 more)

### Community 110 - "Community 110"
Cohesion: 0.09
Nodes (24): noticeReadStatusSchema, mocks, noticeInput, residentUserId, staffPrincipal, auditNoticeAction(), broadcastNotice(), createNotice() (+16 more)
...
Cohesion: 0.11
Nodes (18): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, PortalShell(), navItems, canAccessWorkspace(), workspaceHostelName(), HOSTEL_ADMIN_NAV, HOSTEL_ADMIN_SEARCH_ENTRIES (+10 more)
...
Cohesion: 0.14
Nodes (18): SiteAnnouncementBanner(), toneClasses, FALLBACK, SiteConfigContext, SiteConfigProvider(), useFeatureFlag(), platformSettingSchema, DEFAULT_SITE_CONFIG (+10 more)
...
Cohesion: 0.09
Nodes (17): CookAccount, Credentials, HostelAdminCooksPanel, Issued, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek (+9 more)
...
Cohesion: 0.21
Nodes (18): formatRupees(), subscriptionInvoiceEmail(), METHOD_LABELS, subscriptionReceiptEmail(), hostelRegisteredByTeamEmail(), hostelVerifiedEmail(), hostelSubmissionReceivedEmail(), appBase() (+10 more)
...
Cohesion: 0.14
Nodes (18): applicantSchema, billingCycleSchema, HostelRegistrationInput, hostelRegistrationSchema, RegistrationPlanChoice, registrationPlanChoiceSchema, TeamHostelRegistrationInput, teamHostelRegistrationSchema (+10 more)
...
Cohesion: 0.1
Nodes (15): AddressFields, FORM_SECTIONS, HostelAdminProfilePageContent, PendingPhoto, PHOTO_LIMITS, SectionDef, SectionId, SECTIONS (+7 more)
...
Cohesion: 0.15
Nodes (12): paymentClearedEmail(), paymentDueReminderEmail(), ReminderStage, wording(), paymentOverdueEmail(), paymentRejectedEmail(), paymentReversedEmail(), paymentProofReceivedEmail() (+4 more)
...
Cohesion: 0.18
Nodes (15): cook, dashboardHrefForRole(), destinationForRole(), isAllowedNextPath(), isHostelWorkspacePath(), isSafeLocalPath(), landingPathForRole(), ProtectedRouteRule (+7 more)
...
Cohesion: 0.15
Nodes (13): AuthSession, register(), submitResidentReview(), verifyOtp(), AppNavigator(), RootStackParamList, Stack, OtpVerificationScreen() (+5 more)
...
Cohesion: 0.12
Nodes (11): EASE, FaqEntry, FaqRole, FaqRow(), FAQS, PlansFaq(), PREVIEW_ROWS, ROLES (+3 more)
...
Cohesion: 0.21
Nodes (15): Guidance, useGuidance(), CARDINALS, directionWord(), distanceToPath(), hasArrived(), instructionFor(), isOffRoute() (+7 more)
...
Cohesion: 0.18
Nodes (16): code:typescript (interface IMoveOutChecklistItem {), code:typescript (interface IServiceProvider {), code:typescript (interface IServiceProvider {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IInquiry {), MaintenanceRequest, Move-in / Move-out (+8 more)
...
Cohesion: 0.17
Nodes (13): fill(), PricingScreen(), HostelRegistrationProgress(), Milestone, milestoneIndex(), MILESTONES, PaymentPanel(), PlanPicker() (+5 more)
...
Cohesion: 0.19
Nodes (9): DOC_TYPES, DocRow, FACILITIES, newRoom(), num(), ROOM_TYPES, RoomRow, rupees() (+1 more)
...
Cohesion: 0.19
Nodes (13): 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, 3.1 Payment Due Reminder, 3.3 Payment Proof Uploaded (to Admin), 3.4 Payment Verified (to Resident), 3. Payment Emails (+5 more)
...
Cohesion: 0.29
Nodes (5): AccountDeletionPanel, DeletionPathway, DeletionStatus, PATHWAY_COPY, metadata
...
Cohesion: 0.33
Nodes (7): getAttendanceConfig(), getAttendanceSettings(), listAttendanceAlerts(), listHostelAttendance(), resolveAdminHostelId(), resolveAttendanceAlert(), updateAttendanceSettings()
...
Cohesion: 0.67
Nodes (3): maneuverIcon(), NavCard(), formatManeuverDistance()
...
## Knowledge Gaps
- **5259 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+5254 more)
...
- **Why does `Button()` connect `Community 3` to `Community 2`, `Community 4`, `Community 6`, `Community 134`, `Community 8`, `Community 9`, `Community 7`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 20`, `Community 26`, `Community 163`, `Community 41`, `Community 42`, `Community 52`, `Community 71`, `Community 94`, `Community 114`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 7` to `Community 3`, `Community 4`, `Community 5`, `Community 134`, `Community 13`, `Community 17`, `Community 22`, `Community 23`, `Community 30`, `Community 38`, `Community 40`, `Community 42`, `Community 48`, `Community 49`, `Community 306`, `Community 50`, `Community 57`, `Community 194`, `Community 201`, `Community 74`, `Community 83`, `Community 213`, `Community 92`, `Community 95`, `Community 226`, `Community 99`, `Community 109`, `Community 240`, `Community 114`, `Community 117`, `Community 124`, `Community 253`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 46` to `Community 0`, `Community 2`, `Community 4`, `Community 6`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 17`, `Community 273`, `Community 19`, `Community 21`, `Community 23`, `Community 154`, `Community 32`, `Community 162`, `Community 35`, `Community 39`, `Community 40`, `Community 43`, `Community 49`, `Community 53`, `Community 181`, `Community 56`, `Community 64`, `Community 69`, `Community 71`, `Community 74`, `Community 86`, `Community 343`, `Community 90`, `Community 102`, `Community 111`, `Community 240`, `Community 112`, `Community 115`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Are the 408 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 408 INFERRED edges - model-reasoned connections that need verification._
