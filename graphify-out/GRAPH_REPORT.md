# Graph Report - hostel-management-software  (2026-08-25)

## Corpus Check
- 1559 files · ~2,526,007 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12307 nodes · 33204 edges · 459 communities (439 shown, 20 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 507 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 555 edges
2. `successResponse()` - 541 edges
3. `connectToDatabase()` - 366 edges
4. `useAppTheme()` - 272 edges
5. `cn()` - 238 edges
6. `connectToDatabase()` - 223 edges
7. `unwrap()` - 170 edges
8. `requireHostelCapability()` - 164 edges
9. `useResource()` - 160 edges
10. `Text()` - 139 edges

## Surprising Connections (you probably didn't know these)
- `getOpenFeeSchedule()` --calls--> `connectToDatabase()`  [INFERRED]
  apps/web/src/modules/finance/fee-schedule.service.ts → packages/db/src/connection.ts
...
## Communities (459 total, 20 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (233): POST(), POST(), GET(), GET(), POST(), listPublicFoodRoutine(), addHostelAdminInquiryNote(), auditInquiryAction() (+225 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (222): ActivationIssue, addEmergencyContact(), addHostelPhoto(), addResidentGuardian(), approveMatchedStatement(), assignOrphanPayment(), AttendanceAnalytics, AttendanceSettings (+214 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (178): AdminMoreScreen(), ActivateScreen(), Scanner(), GuardianInviteScreen(), RootShell(), MapScreen(), PreviewCard(), ResultRow() (+170 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (117): ICONS, LABELS, Segment, TONES, MANAGE_ROWS, PORTAL_ROWS, FILTERS, NotificationCard() (+109 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (143): PATCH(), POST(), RouteContext, GET(), POST(), POST(), POST(), POST() (+135 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (141): POST(), attacker, attempt(), headers, jsonRequest(), routeMocks, appBaseUrl(), authenticateWithGoogle() (+133 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (104): csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, HostelTable(), Inquiry, LoadState (+96 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (141): AdminAlertsScreen(), AdminCommunityScreen(), AdminCommunityReportsScreen(), FILTERS, Pending, AdminHomeScreen(), AdminOverviewScreen(), loadOverview() (+133 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (114): adminPrincipal, mocks, PLATFORM_LIMITS, mocks, readable, selectable, mocks, proofBody (+106 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (109): Notification, MonthPicker, PeriodRow, Ledger, OrphanAssignPicker, MatrixRow, MatrixTotals, PeriodSummary (+101 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (93): MoneyData, AdminResidentsScreen(), PickedAttachment, AdminRollCallCard(), AdminSearchBar(), DocumentScreen(), MobileLegal, AuthDivider() (+85 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (97): POST(), GET(), POST(), POST(), POST(), POST(), RouteContext, DELETE() (+89 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (104): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), metadata (+96 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (100): FeeSchedule, HostelAdminFeeSchedulePageContent, Rate, HostelAdminMaintenancePageContent, PRIORITIES, STATUS_ACTIONS, Campaign, HostelAdminNotificationsPageContent (+92 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (123): NightStatusScreen(), ReferralsScreen(), SORTS, StoreCategoryScreen(), CommunityPostScreen(), ComplaintDetailScreen(), ComplaintsScreen(), useResource() (+115 more)
...
Cohesion: 0.03
Nodes (81): GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, hasFood() (+73 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (107): BootGate(), DeletionPanel(), NotificationSettings(), SETTINGS_TITLES, THEME_OPTIONS, BrandSplash(), palette, useRealtime() (+99 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (80): PATCH(), RouteContext, listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), POST(), RouteContext (+72 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (94): CommunityReportDialog(), REASONS, inferKind(), MediaLightbox(), ModerationButton(), PagerButton(), normalize(), PortalSearch() (+86 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (105): NightStatusForm(), ReviewForm(), ReviewScreen(), AttachmentGallery(), DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS (+97 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (77): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CancelDeletionPageContent() (+69 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (79): deleteResidentLocationHistory(), getResidentAttendance(), DELETE(), GET(), checkoutSchema, POST(), complaintCategorySchema, complaintCreateSchema (+71 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (86): GET(), POST(), GET(), GET(), POST(), POST(), DELETE(), POST() (+78 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (65): GuardianDashboard, GuardianSafetyPageContent, CATEGORIES, CreateWardenResult, PERMISSION_LABELS, EmptyInline(), InitialsAvatar(), PortalPageHeader() (+57 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (80): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintStatus(), OPEN_STATUSES, OverdueComplaint (+72 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (72): CommunityScreen(), Composer(), CommunityBoard(), CommunityBoardProps, Composer(), SORTS, CommentThread(), CommunityPostCard() (+64 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (76): cook, PaginationMeta, PaginationQuery, querySchema, assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES (+68 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (74): cookPrincipal, mocks, cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError, FoodPhotoUploadInput, FoodReadyInput (+66 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (60): ComparePage(), hostels, metadata, rows, AuthGuard(), CurrentUser, MeResponse, PortalAccount() (+52 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (54): summarizeResidentComplaints(), latestInvoicePerResident(), accessId, adminPrincipal, codes, guardianId, guardianPrincipal, issue() (+46 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (46): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminAttendancePageContent, HostelAdminCommunityPageContent, HostelAdminComplaintsPage (+38 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (56): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, CachedConnection, globalForMongoose, accountDeletionRequestSchema, communityCommentSchema (+48 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (63): IdCardFace(), initialsOf(), Portrait(), BLOOD_OPTIONS, DIET_OPTIONS, EditIdentityScreen(), GENDER_OPTIONS, ID_TYPE_OPTIONS (+55 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (58): outstandingForResident(), depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, providedItemSchema, qrActivationSchema, residentSchema, auditMoveAction() (+50 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (52): field(), GuardianDashboard, LoadState, NightStatusRow, Notification, NotificationsPageContent(), optionalNumber(), PlatformReviewsPageContent() (+44 more)
...
Cohesion: 0.04
Nodes (59): HostelPhotoReminder(), HostelSuggestions(), CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS, CITY_OPTIONS, FACILITY_STATS (+51 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (39): PlatformCommunityPageContent, PlatformConfigAnnouncementsPageContent, PlatformConfigContentPageContent, PlatformConfigFacilitiesPageContent, FLAGS, PlatformConfigFeaturesPageContent, PlatformConfigLegalPageContent, PlatformConfigLocationsPageContent (+31 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (63): GATEWAY_ORDER, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice(), assertQrAssetUsable(), EMPTY (+55 more)

### Community 40 - "Community 40"
Cohesion: 0.14
Nodes (38): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), verificationEmail(), guardianInvitationEmail(), cookPortalEnabledEmail(), hostelDocumentsRequestedEmail() (+30 more)
...
Cohesion: 0.05
Nodes (48): resolvePastedLink(), geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim() (+40 more)
...
Cohesion: 0.06
Nodes (53): demoteToPublicAccount(), CapacityError, claimBedForRoomType(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary(), releaseBedForRoomType() (+45 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (45): SosScreen(), TABS, BottomChrome, BottomChromeContext, BottomChromeProvider(), CHROME_TIMING, useBottomChrome(), AvatarTabIcon() (+37 more)
...
Cohesion: 0.05
Nodes (47): EMPTY_SUMMARY, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine, formatWeekRange() (+39 more)
...
Cohesion: 0.05
Nodes (44): escapeRegex(), objectIdSchema, paginationSchema, phoneSchema, serviceProviderApplicationSchema, serviceProviderDocumentSchema, hostelId, mocks (+36 more)
...
Cohesion: 0.05
Nodes (45): approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal, checker, eventId (+37 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (42): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+34 more)

### Community 53 - "Community 53"
Cohesion: 0.06
Nodes (42): addHistory(), addMaintenanceComment(), assertBedInHostel(), assertProviderApproved(), assertRoomInHostel(), auditMaintenanceAction(), BedRecord, createMaintenanceRequest() (+34 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (47): ProfileScreen(), CheckoutStatusScreen(), ComplaintDetail(), ComplaintCard(), MealCard(), Footer(), scannedPhotoSource(), ACTOR_LABELS (+39 more)
...
Cohesion: 0.06
Nodes (41): notifyResidentOfComplaintReply(), addComplaintUpdate(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput (+33 more)

### Community 57 - "Community 57"
Cohesion: 0.07
Nodes (42): listResidentComplaints(), connectToDatabase(), paginationRange(), auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex(), HostelRecord, ListingFlagListQuery (+34 more)

### Community 58 - "Community 58"
Cohesion: 0.05
Nodes (33): financeIntegrityHash(), IntentRow, SettlementReconSummary, findingSchema, reconciliationRunSchema, checkAuditChain(), checkCreditBalances(), DRIFT_CODES (+25 more)

### Community 59 - "Community 59"
Cohesion: 0.06
Nodes (38): referralSchema, referralCodeSchema, referralRewardSchema, activeCode, codeId, hostelId, joinedResidentId, mocks (+30 more)
...
Cohesion: 0.09
Nodes (38): collectionTotals(), countInvoicesByField(), getHostelViewStats(), foodFeedbackSchema, listingFlagSchema, paymentProofSchema, ratingReviewSchema, bucketBoundaries() (+30 more)
...
Cohesion: 0.05
Nodes (39): InvoiceMatrix, InvoiceMatrixRow, PortalInvoice, ResidentFinanceView, ResidentInvoiceLine, ResidentInvoiceReceipt, ResidentPortalInvoice, ResidentRow (+31 more)

### Community 64 - "Community 64"
Cohesion: 0.07
Nodes (35): noticeReadStatusSchema, mocks, noticeInput, residentUserId, staffPrincipal, auditNoticeAction(), broadcastNotice(), createNotice() (+27 more)

### Community 65 - "Community 65"
Cohesion: 0.06
Nodes (31): metadata, CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+23 more)

### Community 66 - "Community 66"
Cohesion: 0.08
Nodes (39): buildHostelPayload(), capacitySummary(), CITY_OPTIONS, FACILITY_OPTIONS, firstIncompleteHostelStep(), hasHostelErrors(), hasUsableRooms(), HOSTEL_PLANS (+31 more)

### Community 67 - "Community 67"
Cohesion: 0.06
Nodes (27): currency(), Input(), ResidentActivationPageContent, ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent, Complaint (+19 more)

### Community 68 - "Community 68"
Cohesion: 0.06
Nodes (36): InvoiceDetailScreen(), LedgerCard(), HandoffPlan, isCheckoutFinished(), planHandoff(), relayUrl(), now, plan (+28 more)

### Community 69 - "Community 69"
Cohesion: 0.07
Nodes (33): isAuthBypassEnabled(), original, dashboardHrefForRole(), destinationForRole(), isAllowedNextPath(), isHostelWorkspacePath(), isSafeLocalPath(), landingPathForRole() (+25 more)
...
Cohesion: 0.06
Nodes (29): incidentLogSchema, manualStatusOverrideSchema, nightStatusSchema, nightStatusLogSchema, sosAlertSchema, EmergencyContactRecord, findAdminResident(), NightStatusListQuery (+21 more)

### Community 72 - "Community 72"
Cohesion: 0.09
Nodes (38): AMOUNT_LABELS, canonical(), canonicalDigits(), containsWithTolerance(), DIGIT_CONFUSABLES, evidenceTextFlags(), EvidenceTextMatch, extractClaimFields() (+30 more)

### Community 73 - "Community 73"
Cohesion: 0.1
Nodes (34): CsvTable, gridFromCsv(), readCsv(), stripBom(), stripPreamble(), ESEWA_PARSER, [first], FIXTURES (+26 more)

### Community 74 - "Community 74"
Cohesion: 0.07
Nodes (36): BALANCE_ALIASES, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES, WITHDRAWAL_ALIASES (+28 more)
...
Cohesion: 0.08
Nodes (25): PortalShell(), navItems, navItems, GUARDIAN_NAV, GUARDIAN_SEARCH_ENTRIES, HOSTEL_ADMIN_NAV, HOSTEL_ADMIN_SEARCH_ENTRIES, hostelAdminHref() (+17 more)

### Community 77 - "Community 77"
Cohesion: 0.08
Nodes (29): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), base, entityId, hostelId, mocks, principal (+21 more)
...
Cohesion: 0.09
Nodes (27): buildFormPostHandoff(), FormPostHandoff, HandoffError, IntentRecord, formPostIntent, hostelId, intentId, invoiceId (+19 more)

### Community 80 - "Community 80"
Cohesion: 0.1
Nodes (32): mocks, allocateOrderNumber(), applyStatus(), CancelInput, cancelOrder(), CreateInput, hostelNames(), listAllOrders() (+24 more)
...
Cohesion: 0.07
Nodes (29): countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor(), LedgerInvoiceRow, ledgerPipeline(), LedgerScope (+21 more)
...
Cohesion: 0.09
Nodes (24): getAttendanceConfig(), getAttendanceSettings(), listHostelAttendance(), overrideAttendance(), recordConsent(), resolveAdminHostelId(), resolveAttendanceAlert(), updateAttendanceSettings() (+16 more)

### Community 85 - "Community 85"
Cohesion: 0.09
Nodes (27): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, FeeScheduleRecord, isActiveReferralCode() (+19 more)
...
Cohesion: 0.11
Nodes (24): CSV_COLUMNS, GET(), POST(), RouteContext, POST(), safeEqual(), ClickRecord, dayKey() (+16 more)

### Community 89 - "Community 89"
Cohesion: 0.14
Nodes (25): GET(), periodTotals(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS, neutralize(), csv (+17 more)

### Community 90 - "Community 90"
Cohesion: 0.09
Nodes (27): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), useSiteConfig(), ContentPage (+19 more)

### Community 91 - "Community 91"
Cohesion: 0.11
Nodes (23): useIsUploading(), EMPTY_TALLY, floorToStep(), phaseOf(), shouldRepost(), tallyUploads(), active, done (+15 more)
...
Cohesion: 0.08
Nodes (17): AuthShell(), AuthShellProps, SiteWordmark(), GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse, GoogleAuthUser, GoogleCredentialResponse (+9 more)

### Community 96 - "Community 96"
Cohesion: 0.13
Nodes (27): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags() (+19 more)
...
Cohesion: 0.1
Nodes (24): progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster(), UploadRow, UploadStack(), useIsHydrated() (+16 more)

### Community 99 - "Community 99"
Cohesion: 0.16
Nodes (21): r2Configured(), storePublicAsset(), AccessLevel, bucketForAccessLevel(), deleteFromR2(), generateFileKey(), getR2Client(), keyPrefix() (+13 more)
...
Cohesion: 0.11
Nodes (24): uploadPublicFile(), FILE_ASSET_KINDS, FileAssetKind, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), ApiEnvelope, parseEnvelope() (+16 more)
...
Cohesion: 0.13
Nodes (23): GuardianHomeScreen(), GuardianMetrics(), GuardianMoreScreen(), GuardianPaymentsScreen(), GuardianSafetyScreen(), GuardianPayment, GuardianPermissionKey, GuardianPermissions (+15 more)
...
Cohesion: 0.14
Nodes (26): DELETE(), PATCH(), RouteContext, AddInput, addToCart(), CartItemRecord, CartRecord, clearCart() (+18 more)
...
Cohesion: 0.11
Nodes (18): computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), prepare(), systemDocumentKind(), systemDocumentKindFromText(), distance, base (+10 more)

### Community 109 - "Community 109"
Cohesion: 0.1
Nodes (22): findIndex(), index, indexesOf(), IndexSpec, promote, invoice, INVOICE_STATUSES, invoiceLineSchema (+14 more)

### Community 110 - "Community 110"
Cohesion: 0.15
Nodes (24): assertWholeRupees(), formatNPR(), isWholeRupees(), prorate(), roundToRupee(), splitAmount(), sumAmounts(), credit (+16 more)

### Community 111 - "Community 111"
Cohesion: 0.08
Nodes (25): AMOUNT_ALIASES, CREDIT_ALIASES, CREDIT_WORDS, DATE_ALIASES, DEBIT_ALIASES, DEBIT_WORDS, DESCRIPTION_ALIASES, FROM_ALIASES (+17 more)

### Community 112 - "Community 112"
Cohesion: 0.11
Nodes (21): CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, readId(), activeTokensFor(), authHeaders(), chunk(), EMPTY (+13 more)
...
Cohesion: 0.11
Nodes (21): CityCard(), ALIASES, CITY_IMAGES, cityImageUrl(), normalizeCity(), kathmandu, cityCounts(), CitySummary (+13 more)
...
Cohesion: 0.13
Nodes (22): FileUploadArea(), EXTENSION_BY_MIME, FAMILY_BYTES, FAMILY_ORDER, familyOf(), joinTypes(), KIND_RULES, KindRule (+14 more)
...
Cohesion: 0.17
Nodes (21): AssetViewer(), useViewerState(), ViewerBody(), ViewerPage(), clampIndex(), closeAssetViewer(), emit(), getAssetViewerState() (+13 more)

### Community 123 - "Community 123"
Cohesion: 0.14
Nodes (19): ProviderJobScreen(), listProviderJobs(), ProviderJob, ProviderJobStatus, updateProviderJobStatus(), CATEGORY_ICONS, completedJobCount(), isOpenJob() (+11 more)
...
Cohesion: 0.18
Nodes (20): storeCartSchema, storeOrderSchema, serializeStoreCategory(), serializeStoreProduct(), storeObjectId(), assertSlugFree(), CategoryCreateInput, CategoryUpdateInput (+12 more)
...
Cohesion: 0.08
Nodes (23): 10. Admin tabs — the five main services (owner decision 2026-08-19), 11. Critique pass on the admin screens *(2026-08-20)*, 12. "Manage on the web" becomes eight native screens *(2026-08-21)*, 1. Blockers — the app is broken in production until these are done, 2. M6 — finish public discovery, 3. M1–M5 — the open items that are code, not a device pass, 4. UI defects from the audit, 5. Screen-by-screen UI pass (+15 more)
...
Cohesion: 0.14
Nodes (19): UploadCard(), dismissUpload(), emit(), finishUpload(), listeners, pruneUploads(), resetUploadQueue(), rows (+11 more)

### Community 136 - "Community 136"
Cohesion: 0.11
Nodes (18): PRODUCTION_RECOMMENDED, PRODUCTION_REQUIRED, ServerEnv, serverEnvSchema, serverEnvWarnings(), PRODUCTION_MINIMUM, pusher, snapshot (+10 more)
...
Cohesion: 0.12
Nodes (16): listRecentInvoices(), approvalPeriod(), getPeriodSummary(), monthsBetween(), periodOf(), PeriodRow, PeriodSummary, august (+8 more)

### Community 140 - "Community 140"
Cohesion: 0.09
Nodes (18): claimAmount, dirname, dueAmount, eventId, fractional, hostels, invoiceBalances, invoiceId (+10 more)
...
Cohesion: 0.12
Nodes (17): POST(), POST(), RouteContext, acceptGuardianInvitation(), findResidentOwnedAccess(), listResidentGuardians(), revokeGuardianAccess(), updateGuardianPermissions() (+9 more)

### Community 150 - "Community 150"
Cohesion: 0.12
Nodes (18): hostelPageViewSchema, userResidentProfileSchema, LEGACY_ROLE_MAP, Role, ROLE_VALUES, ageFromDateOfBirth(), cardPhotoImageUrl(), generateResidentId() (+10 more)
...
Cohesion: 0.15
Nodes (19): Guidance, GuidanceStatus, useGuidance(), NavigationFix, watchDeviceHeading(), watchNavigationPosition(), CARDINALS, directionWord() (+11 more)
...
Cohesion: 0.14
Nodes (19): getPresignedReadUrl(), lookupResidentProfile(), normalizeResidentId(), readProfile(), ResidentIdentityError, resolvePlatformIdCard(), titleCaseCategory(), ResidentProfileData (+11 more)
...
Cohesion: 0.1
Nodes (17): defaultDueDate(), DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), monthLabel(), toNumber() (+9 more)
...
Cohesion: 0.19
Nodes (21): AuditLog, code:typescript (interface IPlatformSetting {), code:typescript (interface IAuditLog {), code:typescript ({), code:typescript ({), code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({) (+13 more)
...
Cohesion: 0.17
Nodes (16): ApiFailure, EXTENSION_MIME, PickedFile, resolveFileName(), resolveMimeType(), name, parseEnvelope(), PickedAsset (+8 more)
...
Cohesion: 0.13
Nodes (17): Offset, PhotoCropper(), isActive(), formatBytes(), UploadKind, AttachedFile(), FileUploader(), FileUploaderPresentation (+9 more)
...
Cohesion: 0.15
Nodes (14): getResidentProfile(), login(), submitResidentReview(), triggerSOS(), RootStackParamList, Props, Profile, Props (+6 more)
...
Cohesion: 0.18
Nodes (15): IdCardData, IdCardFace, PlatformIdCardType, CardImages, renderIdCardPng(), BASE, PNG_MAGIC, types (+7 more)

### Community 184 - "Community 184"
Cohesion: 0.2
Nodes (13): DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList(), positiveInteger(), validateFileAssetMetadata(), getPresignedUploadUrl(), asset (+5 more)

### Community 185 - "Community 185"
Cohesion: 0.14
Nodes (14): storeCategorySchema, storeProductSchema, categoriesFor(), escapeRegex(), getStoreHome(), getStoreShelves(), ListQuery, listStoreProducts() (+6 more)

### Community 186 - "Community 186"
Cohesion: 0.11
Nodes (17): Account deletion purge, Attendance maintenance (absence alerts + retention purge), Authentication, Complaint SLA breach check, cron-job.org setup (per job), CRON.md — Scheduled Jobs, Dispatch scheduled notifications, Endpoints (+9 more)
...
Cohesion: 0.12
Nodes (12): monthsBetween(), periodOf(), ResidentDoc, ResidentLedger, ResidentLedgerMonth, ResidentLedgerPayment, billed, eventId (+4 more)
...
Cohesion: 0.17
Nodes (5): ComparePageSkeleton(), HostelDetailPageSkeleton(), HostelListingPageSkeleton(), InquiryPageSkeleton(), Skeleton()
...
Cohesion: 0.14
Nodes (14): 0.1 The shared Softmato domain, 0.2 Categories — which mailbox a message comes from, 0.2a Where replies go, 0.3 Where the sender is configured, 0. Sending Infrastructure, code:block1 (softmato.com), Email Infrastructure, Email Opt-In/Opt-Out Matrix (+6 more)
...
Cohesion: 0.13
Nodes (14): 10. A centre FAB in the tab bar, 1. Accent header with a rounded bottom, and something straddling it, 2. The hero is an account card, not a banner, 3. Services are icon tiles in grouped cards — never a list of rows, 4. Money is signed by colour, and the currency is smaller than the number, 5. Lists are grouped by date, headings outside the cards, 6. The overflow menu is a bottom sheet, not a popover, 7. Filters are chip groups in a sheet, with Reset and Apply (+6 more)
...
Cohesion: 0.21
Nodes (11): documents, hostelForm(), many, parsed, result, emptyHostelForm(), emptyRoomRow(), HostelForm (+3 more)
...
Cohesion: 0.18
Nodes (9): AuthSession, register(), verifyOtp(), AppNavigator(), Stack, LoginScreen(), OtpVerificationScreen(), Props (+1 more)
...
Cohesion: 0.21
Nodes (12): 6.1 Service Provider Registration Received, 6.3 Service Provider Rejected, 6. Service Provider Emails, 7.1 New Hostel Pending Approval (to Superadmin), 7.2 Subscription Expiring Soon, 7. Platform Admin Emails, 8.1 Community Post Engagement (Batched), 8. Community & Notification Emails (+4 more)
...
Cohesion: 0.18
Nodes (5): emptyFilters, Filters, metadata, PublicHostel, PublicHostelsData
...
Cohesion: 0.2
Nodes (11): 4.3 Complaint Resolved, 6.2 Service Provider Approved, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 7.1 Attendance Alert (Resident Absent), 7. Attendance & Location Tracking Emails, code:typescript ({), code:typescript ({), code:typescript ({) (+3 more)
...
Cohesion: 0.27
Nodes (7): buildContactMethods(), buildFaqs(), contactMethods, faqs, PublicContactPage(), SiteIdentity, WEB_ANSWERS
...
Cohesion: 0.29
Nodes (7): CLAIM_METHODS, ClaimDraft, ClaimErrors, hasErrors(), parseClaimAmount(), errors, validateClaim()

### Community 283 - "Community 283"
Cohesion: 0.27
Nodes (9): graphify - READ THIS FIRST, graphify - READ THIS FIRST then docs folder PHASES.md, Keeping the graph fresh, Mobile app work — READ THE DESIGN REFERENCES FIRST, Reuse before inventing, The palette is not negotiable, The rules those references encode, What you MUST do at the start of every session (+1 more)
...
Cohesion: 0.33
Nodes (7): count(), describeFanout(), SosFanoutTone, sosMessagePayload(), SosOutcome, fanout(), outcome
...
Cohesion: 0.22
Nodes (7): DraggablePinMap, FALLBACK_CENTER, LocationPicker(), LocationPickerValue, PART_LABELS, AddressParts, GeocodeResult
...
Cohesion: 0.36
Nodes (6): robots(), sitemap(), STATIC_ROUTES, listPublishedHostelSlugs(), siteUrl(), residentIdShareUrl()
...
Cohesion: 0.22
Nodes (9): 0.4 Template structure, 1.2 Hostel Admin Credentials (Post-Approval), 1.5 Guardian Invitation, code:typescript ({), code:block2 (packages/shared/src/email/), code:typescript (// packages/shared/src/email/templates/payment/payment-overd), code:typescript (// the call site — spreading the template carries the catego), code:typescript ({) (+1 more)

### Community 307 - "Community 307"
Cohesion: 0.25
Nodes (9): 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.3 Hostel Rejected, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, code:typescript ({), code:typescript ({), code:typescript ({) (+1 more)
...
Cohesion: 0.25
Nodes (7): dirname, { loadEnvConfig }, nextConfig, repoRoot, require, SECURITY_HEADERS, SHARP_NATIVE
...
Cohesion: 0.5
Nodes (8): code:typescript (interface IHostelPageView {), code:typescript (// One per resident, per hostel. Minted lazily on first dash), code:typescript (interface ISubscription {), HostelPageView, Inquiries, Referral, Notifications, Subscriptions, Inquiry, Referral, Referral / ReferralCode / ReferralReward
...
Cohesion: 0.33
Nodes (7): 7.1 Multi-Tenant Isolation Test Template, 7.3 Privacy/Guardian Permissions Test Template, 7.5 Payment Precision Test Template, 7. Mandatory Test Templates, code:typescript (describe('GET /api/v1/hostel/rooms/:id - tenant isolation', ), code:typescript (describe('GET /api/v1/guardian/linked-resident - privacy', (), code:bash (npm run web:build)
...
Cohesion: 0.33
Nodes (5): config, { getDefaultConfig }, netinfoShim, path, { withNativeWind }
...
Cohesion: 0.5
Nodes (3): KNOWN_PATHS, resolvePushPath(), REWRITES
...
Cohesion: 0.4
Nodes (3): HostelAdminNoticesPage, HostelAdminNoticesPage(), LegacyHostelAdminNoticesPage()

### Community 379 - "Community 379"
Cohesion: 0.4
Nodes (3): HostelAdminSOSAlertsPage(), HostelAdminSOSAlertsPage, LegacyHostelAdminSosAlertsPage()
...
Cohesion: 0.4
Nodes (5): 8. Monitoring & Logging, code:json ({ "level": "warn", "action": "public_asset_store_failed", "m), code:json ({), code:typescript (// app/api/cron/payment-reminders/route.ts), Deployment Steps

### Community 391 - "Community 391"
Cohesion: 0.4
Nodes (5): 4. Local Setup, 5. Commands, code:json ({ "level": "warn", "action": "public_asset_store_failed", "m), code:bash (node --experimental-transform-types packages/db/src/migrate-), First-time setup
...
## Knowledge Gaps
- **4396 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+4391 more)
...
- **Why does `Button()` connect `Community 10` to `Community 1`, `Community 2`, `Community 3`, `Community 6`, `Community 7`, `Community 9`, `Community 12`, `Community 14`, `Community 17`, `Community 146`, `Community 19`, `Community 20`, `Community 21`, `Community 24`, `Community 33`, `Community 38`, `Community 297`, `Community 45`, `Community 47`, `Community 66`, `Community 199`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 19` to `Community 2`, `Community 3`, `Community 6`, `Community 263`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `Community 21`, `Community 24`, `Community 29`, `Community 35`, `Community 36`, `Community 37`, `Community 38`, `Community 41`, `Community 47`, `Community 177`, `Community 65`, `Community 201`, `Community 76`, `Community 98`, `Community 232`, `Community 119`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 165` to `Community 1`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 141`, `Community 13`, `Community 16`, `Community 17`, `Community 21`, `Community 22`, `Community 153`, `Community 282`, `Community 29`, `Community 37`, `Community 40`, `Community 42`, `Community 46`, `Community 177`, `Community 50`, `Community 61`, `Community 66`, `Community 70`, `Community 74`, `Community 77`, `Community 85`, `Community 94`, `Community 111`, `Community 119`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Are the 361 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 361 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `{ defineConfig }`, `expoConfig`, `path` to the rest of the system?**
  _4396 weakly-connected nodes found - possible documentation gaps or missing edges._
