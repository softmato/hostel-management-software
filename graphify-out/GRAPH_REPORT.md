...
## Summary
- 6730 nodes · 17089 edges · 337 communities (314 shown, 23 thin omitted)
...
## Communities (337 total, 23 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (104): Filter, ModeratedPost, ModerationPayload, UserRecord, GuardianDashboard, EMPTY_SUMMARY, HostelAdminComplaintsPage, CATEGORIES (+96 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (81): csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, Inquiry, LoadState, Message() (+73 more)
...
Cohesion: 0.03
Nodes (78): CommunityReportDialog(), REASONS, Notification, PagerButton(), PublicHostelListingPage(), PublicHostelListingPage(), InquiryPage(), cn() (+70 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (84): deleteResidentLocationHistory(), getResidentAttendance(), listResidentComplaints(), listFoodForResident(), listPublicFoodRoutine(), submitFoodFeedback(), uploadFoodPhoto(), listResidentGuardians() (+76 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (61): POST(), POST(), GET(), GET(), POST(), GET(), searchCandidates(), createPublicHostelInquiry() (+53 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (52): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), ConfirmOptions, Resolver, useConfirm(), AcceptResult (+44 more)
...
Cohesion: 0.03
Nodes (54): adminPrincipal, mocks, PLATFORM_LIMITS, Role, ROLE_VALUES, mocks, hostelMemberSchema, qrActivationSchema (+46 more)
...
Cohesion: 0.06
Nodes (57): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, dayKey(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus() (+49 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (62): announceFoodReady(), CookPortalUpdateInput, CookServiceError, FoodReadyInput, getCookPortalSettings(), HostelSettingsRecord, listFoodReadyLogs(), loadCookAccount() (+54 more)
...
Cohesion: 0.05
Nodes (42): DELETE(), POST(), RouteContext, complaintCategorySchema, complaintCreateSchema, complaintListQuerySchema, complaintReplySchema, complaintResolutionConfirmSchema (+34 more)
...
Cohesion: 0.06
Nodes (46): HostelSuggestions(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, formatHostelAddress(), hostelTypeToUi(), mapPublicHostelToSummary() (+38 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (38): PATCH(), POST(), RouteContext, POST(), RouteContext, PATCH(), RouteContext, POST() (+30 more)
...
Cohesion: 0.04
Nodes (47): ComparePage(), hostels, metadata, rows, Offset, PhotoCropper(), CurrentUser, MeResponse (+39 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (38): PATCH(), RouteContext, listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), communityHideSchema, DELETE() (+30 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (45): listTrendingTags(), PaginationMeta, paginationQuerySchema, querySchema, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex(), HostelRecord (+37 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (38): AuditLogRecord, PlatformAuditLogQuery, RefRecord, CachedConnection, globalForMongoose, emergencyContactSchema, guardianSchema, paymentSchema (+30 more)
...
Cohesion: 0.06
Nodes (26): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminResidentsPage(), redirectToWorkspaceScreen(), HostelAdminReferralsPageContent() (+18 more)

### Community 29 - "Community 29"
Cohesion: 0.08
Nodes (38): GET(), POST(), GET(), GET(), deleteOwnPost(), communityVoteSchema, GET(), PATCH() (+30 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (38): inferKind(), LightboxItem, MediaLightbox(), normalize(), PortalSearch(), PortalTone, scoreEntry(), toneStyles (+30 more)

### Community 31 - "Community 31"
Cohesion: 0.06
Nodes (31): GET(), RouteContext, POST(), RouteContext, findResidentOwnedAccess(), revokeGuardianAccess(), updateGuardianPermissions(), POST() (+23 more)
...
Cohesion: 0.11
Nodes (30): CommunityModerationPanel(), field(), LoadState, Message(), NightStatusRow, Notification, optionalNumber(), PageHeader() (+22 more)
...
Cohesion: 0.06
Nodes (35): PaginationQuery, deviceTokenSchema, notificationSchema, notificationCampaignSchema, CampaignListQuery, CampaignRecord, createCampaign(), createHostelNotificationCampaign() (+27 more)
...
Cohesion: 0.08
Nodes (29): GET(), getAttendanceConfig(), getAttendanceSettings(), listAttendanceAlerts(), listHostelAttendance(), overrideAttendance(), recordConsent(), resolveAdminHostelId() (+21 more)
...
Cohesion: 0.1
Nodes (28): appBaseUrl(), AuthServiceError, dispatchVerificationEmail(), requestPasswordReset(), resendVerificationEmail(), signupWithEmailVerification(), verifyEmailWithToken(), POST() (+20 more)
...
Cohesion: 0.08
Nodes (23): CancelDeletionPageContent(), Campaign, Hostel, PlatformBroadcastPanel, OperationsConfig, PlatformOperationsPanel, PlatformAdmin, PlatformOwner (+15 more)

### Community 49 - "Community 49"
Cohesion: 0.09
Nodes (18): GET(), GET(), ApiAuthError, cookieAccessToken(), isRole(), loadApiPrincipal(), requireGuardianPrincipal(), authMocks (+10 more)
...
Cohesion: 0.07
Nodes (23): LegacyHostelAdminComplaintsPage(), HostelAdminFoodPage, Complaint, ComplaintSummary, field(), FoodMenu, HostelAdminComplaintsPage(), HostelAdminFoodPage() (+15 more)
...
Cohesion: 0.1
Nodes (26): AccountDeletionPanel, DeletionPathway, DeletionStatus, PATHWAY_COPY, CommunityPageContent(), AvailableRoomType, NotificationBell(), ResidentEmergencyContact (+18 more)
...
Cohesion: 0.14
Nodes (20): GET(), POST(), requireSuperadminPrincipal(), handleRouteError(), GET(), POST(), GET(), PUT() (+12 more)
...
Cohesion: 0.08
Nodes (21): currency(), EmptyState(), LoadingRows(), ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, Complaint, field() (+13 more)

### Community 71 - "Community 71"
Cohesion: 0.09
Nodes (18): foodFeedbackSchema, listingFlagSchema, maintenanceRequestSchema, paymentProofSchema, ratingReviewSchema, bucketBoundaries(), CountingModel, getPlatformDashboardReport() (+10 more)
...
Cohesion: 0.14
Nodes (15): POST(), POST(), POST(), ApiError, ApiSuccess, CronAuthResult, normalizeSecret(), safeEqual() (+7 more)
...
Cohesion: 0.08
Nodes (18): HostelTable(), DeletionQueue, DeletionRequest, PlatformAccountDeletionsPageContent, ACTION_CONFIG, ActionKey, ACTIONS, HostelDetail (+10 more)
...
Cohesion: 0.14
Nodes (22): issueSessionForUser(), login(), publicUser(), refreshAccessToken(), loginGuardian(), AuthTokenPayload, hashToken(), jwtSecret() (+14 more)
...
Cohesion: 0.12
Nodes (12): metadata, FeedPayload, SidebarPayload, Space, SpacesPayload, CommunitySponsor, CommunitySponsorRail(), PopularHostel (+4 more)

### Community 105 - "Community 105"
Cohesion: 0.15
Nodes (21): getHostelViewStats(), averageResolutionDays(), collectionRate(), countByField(), countVacantBeds(), endOfMonth(), foodRatingSummary(), getHostelAdminComplaintsReport() (+13 more)
...
Cohesion: 0.12
Nodes (15): activateResident(), AuthSession, register(), verifyOtp(), AppNavigator(), Stack, LoginScreen(), OtpVerificationScreen() (+7 more)
...
Cohesion: 0.16
Nodes (13): ResidentNightStatus, submitResidentReview(), triggerSOS(), RootStackParamList, Props, Props, Profile, Props (+5 more)
...
Cohesion: 0.22
Nodes (13): ImageVariantRecord, optimizeImage(), streamToBuffer(), VARIANT_CONFIG, VariantName, r2Configured(), storePublicAsset(), deleteFromR2() (+5 more)
...
Cohesion: 0.13
Nodes (10): accountDeletionRequestSchema, attendanceLogSchema, consentLogSchema, purgeAccount(), runAccountDeletionPurge(), mocks, now, otherUserId (+2 more)
...
Cohesion: 0.18
Nodes (18): AttendanceAlert, AttendanceLog, code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({) (+10 more)
...
Cohesion: 0.14
Nodes (16): Attendance / Night Safety, Build status (end of Phase 3), Build status (end of Phase 5 — verified 2026-08-02), code:typescript (export enum Role {), code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), Conventions, Cook Portal (+8 more)
...
Cohesion: 0.15
Nodes (16): code:typescript (interface INotice {), code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {), code:typescript ({), code:typescript (interface IMoveInChecklistItem {), code:typescript (interface IMoveOutChecklistItem {), code:typescript (interface IServiceProvider {), Complaint (+8 more)
...
Cohesion: 0.15
Nodes (11): Avatar(), AVATAR_TONES, avatarTone(), CommunityComment, CommunityMedia, CommunityPost, CommunityPostCard(), MediaGrid() (+3 more)
...
Cohesion: 0.24
Nodes (14): AuditLog, code:typescript (interface IPlatformSetting {), code:typescript (interface IAuditLog {), code:typescript ({), code:typescript ({), FoodReadyLog, Notification, Notification (+6 more)
...
Cohesion: 0.31
Nodes (13): code:typescript (interface IMaintenanceRequest {), code:typescript (interface IInquiry {), code:typescript (interface IHostelPageView {), code:typescript (// One per resident, per hostel. Minted lazily on first dash), code:typescript (interface ISubscription {), HostelPageView, Inquiries, Referral, Notifications, Subscriptions, Inquiry (+5 more)

### Community 157 - "Community 157"
Cohesion: 0.22
Nodes (13): AccountDeletionRequest, code:typescript (interface IQuestionCallClick {), code:typescript ({), code:typescript ({), code:typescript (interface IAccountDeletionRequest {), code:block46 (packages/db/migrations/), Consent & Privacy, ConsentLog (+5 more)
...
Cohesion: 0.38
Nodes (7): code:typescript (interface IServiceProvider {), code:typescript (interface IMaintenanceRequest {), MaintenanceRequest, Planned for Phase 6 — app account + job marketplace (PRD.md §8.6/§9.6, not yet built), Planned for Phase 6 — job broadcast + claim (PRD.md §8.6/§9.6, not yet built), Service Providers & Maintenance, ServiceProvider
...
Cohesion: 0.5
Nodes (4): cookEmailForSlug(), generatePassword(), provisionCookAccount(), provisionApprovalCookAccount()
...
- **Why does `Role` connect `Community 8` to `Community 136`, `Community 10`, `Community 11`, `Community 13`, `Community 15`, `Community 18`, `Community 20`, `Community 149`, `Community 24`, `Community 26`, `Community 29`, `Community 31`, `Community 32`, `Community 161`, `Community 162`, `Community 35`, `Community 42`, `Community 44`, `Community 46`, `Community 47`, `Community 48`, `Community 49`, `Community 50`, `Community 61`, `Community 62`, `Community 192`, `Community 65`, `Community 193`, `Community 64`, `Community 68`, `Community 72`, `Community 85`, `Community 214`, `Community 247`, `Community 230`, `Community 117`, `Community 119`, `Community 122`, `Community 125`, `Community 126`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 3` to `Community 0`, `Community 1`, `Community 6`, `Community 135`, `Community 7`, `Community 9`, `Community 14`, `Community 16`, `Community 17`, `Community 20`, `Community 148`, `Community 25`, `Community 30`, `Community 34`, `Community 35`, `Community 40`, `Community 44`, `Community 53`, `Community 54`, `Community 59`, `Community 66`, `Community 76`, `Community 77`, `Community 103`, `Community 104`, `Community 124`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `browserApi()` connect `Community 48` to `Community 0`, `Community 1`, `Community 3`, `Community 6`, `Community 135`, `Community 7`, `Community 9`, `Community 16`, `Community 17`, `Community 20`, `Community 25`, `Community 30`, `Community 34`, `Community 37`, `Community 40`, `Community 44`, `Community 53`, `Community 182`, `Community 54`, `Community 59`, `Community 69`, `Community 70`, `Community 77`, `Community 79`, `Community 81`, `Community 103`, `Community 104`, `Community 232`?**
