...
## Corpus Check
- 1909 files · ~3,286,635 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15138 nodes · 41712 edges · 530 communities (511 shown, 19 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 671 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 622 edges
2. `successResponse()` - 606 edges
3. `connectToDatabase()` - 423 edges
4. `useAppTheme()` - 363 edges
5. `cn()` - 282 edges
6. `connectToDatabase()` - 241 edges
7. `unwrap()` - 194 edges
...
## Communities (530 total, 19 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (280): POST(), GET(), POST(), POST(), PATCH(), POST(), RouteContext, GET() (+272 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (313): AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), Scanner(), APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen() (+305 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (220): PATCH(), RouteContext, getOrCreateSubscription(), POST(), GET(), GET(), addHostelAdminInquiryNote(), auditInquiryAction() (+212 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (243): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+235 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (221): useSystemInsets(), ActivationIssue, addCook(), addEmergencyContact(), addHostelPhoto(), addInquiryNote(), addResidentGuardian(), approveMatchedStatement() (+213 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (182): FILTERS, NotificationCard(), NotificationRow(), NotificationsScreen(), TILE_GLYPH, TILE_TONES, DAY_LABELS, DayStrip() (+174 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (166): AdminCommunityReportsScreen(), FILTERS, Pending, AttendanceScreen(), NightStatusScreen(), Person, ProfileScreen(), ReferralsScreen() (+158 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (136): GuardianDashboard, GuardianSafetyPageContent, FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, Rate, RoomTypeOption, gregorianSpan() (+128 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (146): POST(), attacker, attempt(), headers, jsonRequest(), routeMocks, appBaseUrl(), authenticateWithGoogle() (+138 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (153): POST(), RouteContext, DELETE(), GET(), hostelId(), GET(), POST(), DELETE() (+145 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (108): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload (+100 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (143): PaymentMonthStrip(), ClearFilters(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), PortalDates, SummaryCard() (+135 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (119): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, CommunityReportDialog(), REASONS, ConfirmOptions, Resolver, HostelPhotoReminder(), daysUntil() (+111 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (131): AdminAlertsScreen(), ICONS, LABELS, Segment, TONES, AdminHomeScreen(), AdminOverviewScreen(), loadOverview() (+123 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (97): AuthExperiencePage(), HostelSuggestions(), inferKind(), LightboxItem, MediaLightbox(), GenericPortalScreen(), portalRows(), portalTitle() (+89 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (123): GET(), POST(), querySchema, RouteContext, authorUserId, mocks, postId, residentId (+115 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (134): BootGate(), BrandSplash(), AuthDivider(), GoogleSignInButton(), RoleGate(), accentForAccount(), AccountShape, HomeRoute (+126 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (92): csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, HostelTable(), Inquiry, LoadState (+84 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (112): HostelAdminCommunityPageContent, HostelAdminComplaintsPage, HostelAdminInquiriesPageContent, HostelAdminMaintenancePageContent, PRIORITIES, STATUS_ACTIONS, HostelAdminMoveChecklistPage, HostelAdminNightStatusPage (+104 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (113): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintStatus(), OPEN_STATUSES, OverdueComplaint (+105 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (103): AdminCommunityScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+95 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (94): GET(), communityHideSchema, RouteContext, DELETE(), PATCH(), RouteContext, requirePlatformPrincipal(), resetEmailIdentityCache() (+86 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (99): CommunityScreen(), Composer(), CommunityPostScreen(), AttachmentGallery(), ReportedPostCard(), CommunityBoard(), CommunityBoardProps, Composer() (+91 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (97): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), sitemap() (+89 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (88): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), PROVIDER_LABEL, QrPanel(), InvoiceDetailScreen() (+80 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (93): approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal, checker, eventId (+85 more)

### Community 26 - "Community 26"
Cohesion: 0.09
Nodes (63): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), formatRupees(), subscriptionInvoiceEmail() (+55 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (80): fill(), money(), PlanCard(), PricingScreen(), pricePlan(), PlanPicker(), InlineText(), TIER_TONE (+72 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (87): ReviewForm(), ReviewScreen(), describeGrants(), GuardianRow(), PermissionSheet(), InviteGuardianScreen(), daysUntil(), describeGuardianOnRecord() (+79 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (87): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure (+79 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (74): Notification, BrowserPushRow(), FILTERS, Notification, NotificationRow(), PushState, FILTERS, NotificationCard (+66 more)

### Community 31 - "Community 31"
Cohesion: 0.02
Nodes (50): deleteHostelObjects(), ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, RETAINED_BY_HOSTEL_ID, both (+42 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (79): collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor() (+71 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (70): HostelRegistrationProgress(), Milestone, milestoneIndex(), MILESTONES, PaymentPanel(), rupees(), SubscriptionState, cityOptions (+62 more)
...
Cohesion: 0.04
Nodes (60): metadata, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails(), RenderedSection (+52 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (65): ComparePage(), hostels, metadata, rows, AuthGuard(), CurrentUser, MeResponse, PortalAccount() (+57 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (60): summarizeResidentComplaints(), listResidentInvoices(), accessId, adminPrincipal, codes, guardianId, guardianPrincipal, issue() (+52 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (84): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthStart(), bsPeriodBounds() (+76 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (71): NightStatusForm(), ReferralRow(), DeletionPanel(), methodProvider(), PhotoDayCard(), useDates(), ClaimsCard(), ReceiptsCard() (+63 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (58): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt, ReturnState (+50 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (65): GET(), POST(), adminPrincipal, mocks, PLATFORM_LIMITS, GET(), profileMocks, staffPrincipal (+57 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (66): GATEWAY_ORDER, getHostelPayMethods(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice() (+58 more)
...
Cohesion: 0.05
Nodes (63): POST(), GET(), DELETE(), POST(), CampaignListQuery, CampaignRecord, createCampaign(), createHostelNotificationCampaign() (+55 more)
...
Cohesion: 0.03
Nodes (43): ROLE_VALUES, hostelMemberSchema, rolePermissionSchema, accountId, compact, guardian, NO_CLEARANCE, publicId (+35 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (45): CopyButton(), GatewayProviderName, ManualMethodPanel(), MethodIcon(), methodKey(), methodLabel(), PayMethod, PROVIDER_LABEL (+37 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (54): GET(), periodTotals(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS, neutralize(), csv (+46 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (44): HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminRoomsPageContent(), PlatformDashboardPageContent(), PlatformUsersPageContent(), DashboardCard(), DashboardCardProps, HostelAdminDashboardPageContent (+36 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (54): notifyResidentOfComplaintReply(), addComplaintUpdate(), assertComplaintVoiceNote(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren() (+46 more)
...
Cohesion: 0.05
Nodes (51): cookPrincipal, mocks, resolveCookLabels(), cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError, decodePhotoCursor() (+43 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (49): readReturnState(), resolveOwnedHostel(), findOpenInvoice(), getSubscriptionState(), invoiceIdFor(), issueSubscriptionInvoice(), selectPlan(), dayOfWeekSchema (+41 more)

### Community 54 - "Community 54"
Cohesion: 0.06
Nodes (52): announceFoodReady(), dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, isMonthEnd(), mealsOn() (+44 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (53): CapacityError, claimBedForRoomType(), listAllRoomTypes(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary(), releaseBedForRoomType() (+45 more)

### Community 56 - "Community 56"
Cohesion: 0.05
Nodes (38): DeletionPathway, DeletionStatus, PATHWAY_COPY, CancelDeletionPageContent(), AcceptResult, CookInvitePageContent, AcceptResult, GuardianInvitePageContent (+30 more)
...
Cohesion: 0.05
Nodes (44): Footer(), IdCardFace(), initialsOf(), Portrait(), buildIdCard(), CARD_COLORS, CARD_NOUNS, CARD_VARIANTS (+36 more)

### Community 59 - "Community 59"
Cohesion: 0.06
Nodes (29): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminMoveChecklistPage(), HostelAdminSOSAlertsPage(), HostelAdminFeePlansPageContent, HostelAdminComplaintsPage(), HostelAdminNoticesPage() (+21 more)

### Community 60 - "Community 60"
Cohesion: 0.06
Nodes (44): CategoryTile(), NewComplaintScreen(), PickedAttachment, SwapButton(), CapturedPhoto, PhotoCapture(), RoundButton(), VOICE_NOTE_RECORDING (+36 more)

### Community 61 - "Community 61"
Cohesion: 0.05
Nodes (41): financeIntegrityHash(), appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind, creditOverpayment(), getCreditAmount(), getCreditBalance() (+33 more)

### Community 62 - "Community 62"
Cohesion: 0.06
Nodes (50): BALANCE_ALIASES, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, TXN_ID_ALIASES, WITHDRAWAL_ALIASES, AMOUNT_ALIASES (+42 more)
...
Cohesion: 0.06
Nodes (33): NEXT_STATUSES, OrdersPayload, OrderStatus, PlatformStoreOrdersPageContent, STATUS_TONE, StoreOrder, formatPaisa(), PlatformStorePageContent (+25 more)

### Community 66 - "Community 66"
Cohesion: 0.06
Nodes (41): notifyStaffOfJobProgress(), serviceProviderApplicationSchema, serviceProviderDocumentSchema, hostelId, mocks, providerId, notifyPlatformOfServiceProviderApplication(), notifyServiceProviderDecision() (+33 more)
...
Cohesion: 0.06
Nodes (42): before, expiresAt, mocks, staffPrincipal, activateResident(), ActivationCodeGenerateInput, ActivationCodeInput, activationSecret() (+34 more)

### Community 69 - "Community 69"
Cohesion: 0.06
Nodes (42): FeeScheduleRecord, rateForRoomType(), getResidentLedger(), monthsBetween(), periodOf(), ResidentDoc, ResidentLedger, ResidentLedgerMonth (+34 more)

### Community 70 - "Community 70"
Cohesion: 0.07
Nodes (43): DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity(), fromHeaderFor() (+35 more)

### Community 71 - "Community 71"
Cohesion: 0.05
Nodes (41): approveClaim(), assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck(), evidenceCheck(), fileCheck() (+33 more)
...
Cohesion: 0.06
Nodes (28): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, resolveBillingContact(), auditLogSchema, oauthAccountSchema, platformAdminInviteSchema (+20 more)

### Community 76 - "Community 76"
Cohesion: 0.07
Nodes (42): arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal, alreadyReviewedError() (+34 more)
...
Cohesion: 0.09
Nodes (37): BANK_CSV_PARSER, CsvTable, gridFromCsv(), peekHeaders(), readCsv(), stripBom(), stripPreamble(), parseText() (+29 more)

### Community 79 - "Community 79"
Cohesion: 0.05
Nodes (31): hostelId, invoice, invoiceId, mocks, principal, qr, qrAssetId, residentId (+23 more)
...
Cohesion: 0.06
Nodes (26): currency(), EmptyState(), TextArea(), ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent, Complaint (+18 more)
...
Cohesion: 0.11
Nodes (36): directionFlags(), evidenceFlags(), payeeFlags(), AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance() (+28 more)
...
Cohesion: 0.08
Nodes (27): CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS, CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, MOCK_HOSTELS (+19 more)

### Community 91 - "Community 91"
Cohesion: 0.09
Nodes (27): getR2Client(), classifyCredit(), CreditClassification, LadderClaim, LadderInvoice, MatchContext, normalizeTxnId(), ANITA_CODE (+19 more)
...
Cohesion: 0.07
Nodes (21): Input(), StatusBadge(), field(), HostelAdminReferralsPageContent(), HostelAdminServiceProvidersPageContent(), ListingFlag, LoadState, MaintenanceRequest (+13 more)
...
Cohesion: 0.09
Nodes (22): applyWebhook(), checkoutReturnUrl(), OpenCheckoutInput, openSoftmatoCheckout(), softmato(), SoftmatoNotConfiguredError, isSoftmatoConfigured(), SoftmatoConfig (+14 more)

### Community 96 - "Community 96"
Cohesion: 0.11
Nodes (28): nightStatusPromptSchema, formatPromptTime(), isCurrentNight(), isSameNight(), minuteIsDue(), nightKey(), parsePromptTime(), promptIsDue() (+20 more)
...
Cohesion: 0.07
Nodes (23): HostelAdminFoodPage, Complaint, ComplaintSummary, field(), FoodMenu, HostelAdminFoodPage(), HostelAdminPaymentsPage(), HostelAdminResidentsPage() (+15 more)
...
Cohesion: 0.1
Nodes (27): uploadPublicFile(), FILE_ASSET_KINDS, FileAssetKind, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), UploadItem, UploadKind (+19 more)
...
Cohesion: 0.09
Nodes (25): EvidenceEngine, EvidenceEngineMode, EvidenceReadFailure, OcrResult, OcrWord, accessToken(), annotateUrl(), assertion() (+17 more)

### Community 105 - "Community 105"
Cohesion: 0.1
Nodes (27): methodLabel(), SubmitClaimScreen(), canonicalize(), CLAIM_METHODS, ClaimDraft, ClaimErrors, ClaimRejection, ClaimRejectionDetails (+19 more)

### Community 106 - "Community 106"
Cohesion: 0.11
Nodes (25): InquiryLinkScreen(), ReferralBody(), Referral, ReferralCode, ReferralReward, ReferralStatus, ReferralSummary, ResidentReferral (+17 more)
...
Cohesion: 0.11
Nodes (22): Choice, Compass(), maneuverIcon(), MapButton(), ModeTab(), NavCard(), NOTHING_CHOSEN, RouteCard() (+14 more)

### Community 111 - "Community 111"
Cohesion: 0.07
Nodes (17): GET(), RouteContext, listResidentContacts(), calendarDateSchema, emergencyContactCreateSchema, guardianCreateSchema, objectIdSchema, optionalHostelScopeSchema (+9 more)
...
Cohesion: 0.09
Nodes (26): acceptGuardianInvitation(), daysFromNow(), enabledPermissionLabels(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags, GuardianPermissionsUpdateInput (+18 more)

### Community 115 - "Community 115"
Cohesion: 0.1
Nodes (25): afterResponse(), mocks, activeDevicesFor(), activeTokensFor(), authHeaders(), chunk(), DeviceRow, dispatchPush() (+17 more)
...
Cohesion: 0.08
Nodes (19): VideoSlot(), CATEGORIES, isApplicationOpen(), LandingStep(), MeResponse, OwnApplication, ProviderStats, ProviderStatus (+11 more)

### Community 118 - "Community 118"
Cohesion: 0.09
Nodes (21): configuredLevel(), levelPriority, logger, LogLevel, normalizeMeta(), shouldLog(), write(), deviceTokenSchema (+13 more)
...
Cohesion: 0.12
Nodes (20): AccountDeletionError, applyImmediateEffects(), DeletionPathway, DeletionRequestRecord, getAccountDeletionStatus(), loadUser(), releaseGuardianRole(), requestAccountDeletion() (+12 more)

### Community 142 - "Community 142"
Cohesion: 0.11
Nodes (22): userResidentProfileSchema, ageFromDateOfBirth(), lookupResidentProfile(), normalizeResidentId(), readProfile(), ResidentIdentityError, resolvePlatformIdCard(), splitName() (+14 more)
...
Cohesion: 0.09
Nodes (20): authSlice, AuthState, initialState, SessionEndReason, initialState, savedSlice, SavedState, migrated (+12 more)

### Community 148 - "Community 148"
Cohesion: 0.1
Nodes (16): AuthShell(), AuthShellProps, PANEL_COPY, SiteWordmark(), GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse, GoogleAuthUser (+8 more)
...
Cohesion: 0.16
Nodes (17): geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), geocodeAddress(), HostelGeoLocation, resolveHostelGeo(), TYPE_COLORS (+9 more)

### Community 151 - "Community 151"
Cohesion: 0.16
Nodes (21): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), loadPayeeIdentity() (+13 more)
...
Cohesion: 0.14
Nodes (20): dismissUpload(), emit(), listeners, pruneUploads(), resetUploadQueue(), rows, startRead(), startTransfer() (+12 more)

### Community 162 - "Community 162"
Cohesion: 0.11
Nodes (20): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, DEMO_ACCOUNTS, DemoRole, destinationAfterLogin() (+12 more)

### Community 163 - "Community 163"
Cohesion: 0.17
Nodes (17): bucketForAccessLevel(), generateFileKey(), getPresignedUploadUrl(), asset, fileAssetSchema, variantSchema, violation, POST() (+9 more)
...
Cohesion: 0.15
Nodes (21): getPresignedReadUrl(), LEGACY_ROLE_MAP, Role, ROLE_VALUES, cardPhotoImageUrl(), clearResidentIdentityPhoto(), generateResidentId(), isCardPhotoImage() (+13 more)
...
Cohesion: 0.11
Nodes (10): TABS, RoleTabs(), TabDef, TABS, runWhenIdle(), TABS, HIDDEN, TABS (+2 more)
...
Cohesion: 0.16
Nodes (17): RootShell(), AssetViewer(), useViewerState(), BottomChrome, BottomChromeContext, BottomChromeProvider(), CHROME_TIMING, UploadCard() (+9 more)
...
Cohesion: 0.13
Nodes (19): 0.4 Template structure, 1.0 Signup One-Time Code, 1.1 Email Verification (PUBLIC Signup), 1.2 Hostel Admin Credentials (Post-Approval), 1.3 Warden Credentials, 1.4 Resident QR Activation, 1.6 Password Reset, 1.7 Account Upgraded (+11 more)
...
Cohesion: 0.19
Nodes (16): Guidance, GuidanceStatus, useGuidance(), CARDINALS, directionWord(), distanceToPath(), hasArrived(), instructionFor() (+8 more)
...
Cohesion: 0.19
Nodes (11): robots(), r2Configured(), storePublicAsset(), AccessLevel, keyPrefix(), privateBucket(), publicBucket(), requireEnv() (+3 more)
...
Cohesion: 0.14
Nodes (12): AuthSession, getResidentProfile(), requestOtp(), signInWithGoogle(), AppNavigator(), Stack, OtpVerificationScreen(), Profile (+4 more)
...
Cohesion: 0.18
Nodes (13): softmatoDocsUrl(), BillingHistory, BillingInvoiceRow, BillingPaymentRow, CYCLE_LABELS, getInvoiceDetailForHostel(), Badge(), HostelAdminBillingPageContent() (+5 more)
...
Cohesion: 0.15
Nodes (16): 2.2 Hostel Approved, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, 4.2 Complaint Status Updated, 4.3 Complaint Resolved (+8 more)
...
Cohesion: 0.14
Nodes (7): ACTION_PROGRESS, PlatformServiceProviderReviewPageContent, ProviderApplication, ProviderDetail, ProviderDocument, TABS, DetailSection()

### Community 239 - "Community 239"
Cohesion: 0.18
Nodes (12): Offset, PhotoCropper(), AttachedFile(), FileUploaderPresentation, FileUploaderProps, FileUploaderView(), previewSrc(), TONE_CLASSES (+4 more)
...
Cohesion: 0.2
Nodes (11): DownloadStack(), downloadFile(), DownloadOptions, DownloadOutcome, nextId(), readWithProgress(), saveBlob(), clicked (+3 more)
...
Cohesion: 0.15
Nodes (13): 7.2 Subscription Expiring Soon, 7. Platform Admin Emails, 8.1 Community Post Engagement (Batched), 8. Community & Notification Emails, code:typescript ({), code:typescript ({), code:typescript ({), Email Opt-In/Opt-Out Matrix (+5 more)
...
Cohesion: 0.21
Nodes (12): arrangeSettlement(), catalog, hostelId, invoice(), invoiceId, mocks, otherHostelId, paymentId (+4 more)
...
Cohesion: 0.19
Nodes (9): createExpertConsultationRequest(), ExpertConsultationCreateInput, ExpertConsultationError, ExpertConsultationRequestRecord, notifyTeamOfRequest(), expertConsultationCreateSchema, expertConsultationRequestSchema, coerceSection() (+1 more)
...
Cohesion: 0.22
Nodes (5): GoogleMap, HostelMap(), LeafletMap, MapProvider, useMapProvider()
...
Cohesion: 0.35
Nodes (10): renderIdCardPng(), CARD_LABELS, formatIssuedOn(), readPhotoBytes(), readQrBytes(), sendIdCardEmail(), getResidentIdentity(), getResidentIdentityQr() (+2 more)

### Community 314 - "Community 314"
Cohesion: 0.42
Nodes (10): appBase(), deliver(), formatEmailDate(), hostelListingUrl(), onHostelVerified(), onInvoiceIssued(), onPaymentSettled(), onRegisteredByTeam() (+2 more)
...
Cohesion: 0.25
Nodes (11): 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, 7.1 New Hostel Pending Approval (to Superadmin), code:typescript ({), code:typescript ({) (+3 more)
...
Cohesion: 0.36
Nodes (8): buildTable(), tableFromGrid(), StatementTable, assertWithinLimits(), gridFromWorkbook(), normalize(), readWorkbook(), sheetHasAnchor()
...
Cohesion: 0.2
Nodes (10): 0.1 The shared Softmato domain, 0.2 Categories — which mailbox a message comes from, 0.2a Where replies go, 0.3 Where the sender is configured, 0. Sending Infrastructure, code:block1 (softmato.com), code:block2 (packages/shared/src/email/), Email Infrastructure (+2 more)
...
Cohesion: 0.25
Nodes (9): 7.1 Multi-Tenant Isolation Test Template, 7.4 Account-Upgrade Test Template, 7.5 Payment Precision Test Template, 7. Mandatory Test Templates, 9.3 Test Helpers, code:typescript (describe('GET /api/v1/hostel/rooms/:id - tenant isolation', ), code:typescript (describe('POST /api/v1/hostel/residents - account upgrade', ), code:typescript (// tests/helpers/auth.ts) (+1 more)
...
Cohesion: 0.22
Nodes (9): 7.2 Role Gate Test Template, 7.3 Privacy/Guardian Permissions Test Template, 9.1 Seed Scripts, 9.2 Test Database Isolation, 9. Test Data & Seeding, code:typescript (describe('GET /api/v1/hostel/rooms - role access', () => {), code:typescript (describe('GET /api/v1/guardian/linked-resident - privacy', (), code:bash (npm run web:lint) (+1 more)
...
Cohesion: 0.33
Nodes (7): 1.5 Guardian Invitation, 2.1 Hostel Submission Received, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, code:typescript ({), code:typescript ({), code:typescript ({)
...
## Knowledge Gaps
- **5330 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+5325 more)
...
- **Why does `cn()` connect `Community 12` to `Community 1`, `Community 389`, `Community 5`, `Community 7`, `Community 6`, `Community 10`, `Community 14`, `Community 17`, `Community 18`, `Community 23`, `Community 27`, `Community 30`, `Community 286`, `Community 33`, `Community 35`, `Community 36`, `Community 47`, `Community 49`, `Community 51`, `Community 185`, `Community 64`, `Community 65`, `Community 77`, `Community 80`, `Community 90`, `Community 93`, `Community 98`, `Community 227`, `Community 99`, `Community 239`, `Community 117`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 38` to `Community 0`, `Community 1`, `Community 4`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 140`, `Community 270`, `Community 17`, `Community 18`, `Community 401`, `Community 20`, `Community 149`, `Community 24`, `Community 26`, `Community 32`, `Community 33`, `Community 34`, `Community 36`, `Community 164`, `Community 165`, `Community 45`, `Community 48`, `Community 176`, `Community 54`, `Community 187`, `Community 62`, `Community 65`, `Community 67`, `Community 96`, `Community 104`, `Community 105`, `Community 108`, `Community 112`, `Community 115`, `Community 380`, `Community 253`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 6` to `Community 1`, `Community 4`, `Community 5`, `Community 7`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 17`, `Community 18`, `Community 22`, `Community 24`, `Community 28`, `Community 30`, `Community 35`, `Community 39`, `Community 45`, `Community 47`, `Community 56`, `Community 185`, `Community 60`, `Community 110`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Are the 418 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 418 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `{ defineConfig }`, `expoConfig`, `path` to the rest of the system?**
  _5330 weakly-connected nodes found - possible documentation gaps or missing edges._
