# Graph Report - hostel-management-software  (2026-09-20)

## Corpus Check
- 2260 files · ~4,059,731 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18047 nodes · 50621 edges · 554 communities (526 shown, 28 thin omitted)
...
## Communities (554 total, 28 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (294): PATCH(), POST(), RouteContext, PATCH(), RouteContext, POST(), getOrCreateSubscription(), GET() (+286 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (190): ICONS, LABELS, Segment, TONES, FILTERS, Pending, openStore(), Overview (+182 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (210): POST(), GET(), POST(), POST(), POST(), GET(), POST(), POST() (+202 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (277): loadOverview(), loadMoney(), loadToday(), loadFinance(), PortalDates, getAdminFoodRoutine(), getAdminHostel(), getAdminInvoices() (+269 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (213): Scanner(), CookInviteScreen(), GuardianInviteScreen(), Choice, Compass(), MapButton(), ModeTab(), NOTHING_CHOSEN (+205 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (246): BootGate(), ReviewForm(), ReviewScreen(), BookingForm(), METHODS, PackageCard(), PayStep(), roomPhotoUris() (+238 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (192): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CancelDeletionPageContent(), CommunityModerationPanel(), Filter, ModeratedPost (+184 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (146): PlanPaymentClaim, DemoDataBadge(), HostelTable(), LoadState, Message(), ReportGrid(), ReportRecord, GuardianDashboard (+138 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (158): POST(), POST(), answerSchema, POST(), attacker, attempt(), headers, jsonRequest() (+150 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (153): BubbleBackground(), BubbleBackgroundProps, BubbleColors, CommunityReportDialog(), REASONS, ConfirmOptions, Hostel, Notification (+145 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (157): BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan, CommunityPageContent(), Badge(), grabDocument(), HostelAdminBillingPageContent() (+149 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (143): SosScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+135 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (154): POST(), RouteContext, DELETE(), GET(), hostelId(), GET(), GET(), GET() (+146 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (162): PaymentMonthStrip(), ManageRatesScreen(), ClearFilters(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard() (+154 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (148): notifyHostelOfNewPost(), resolveHostelCommunityUserIds(), usersMutingNewPosts(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus(), OPEN_STATUSES, OverdueComplaint (+140 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (152): HIDDEN, RoleLayout(), TABS, FILTERS, invalidateFeeds(), NotificationCard(), NotificationRow(), TILE_GLYPH (+144 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (164): AdminAlertsScreen(), AdminCommunityReportsScreen(), AdminHomeScreen(), AdminTabs(), AdminMoneyScreen(), AdminMoreScreen(), AdminResidentsScreen(), AdminTodayScreen() (+156 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (132): listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), DELETE(), RouteContext, GET(), POST() (+124 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (145): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, TXN_ID_ALIASES, WITHDRAWAL_ALIASES (+137 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (127): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), methodProvider(), PROVIDER_LABEL, QrPanel() (+119 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (130): fromBs(), gregorianOf(), BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped (+122 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (107): GET(), POST(), GET(), readReturnState(), listBookingPaymentsToCheck(), GET(), DELETE(), POST() (+99 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (119): cropToGuide(), FILL, GuidedCapture(), GUIDES, GuideShape, loadManipulator(), Manipulator, AttachmentRow() (+111 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (102): deleteResidentLocationHistory(), getResidentAttendance(), DELETE(), GET(), confirmComplaintResolution(), listResidentComplaints(), complaintCategorySchema, complaintCreateSchema (+94 more)

### Community 24 - "Community 24"
Cohesion: 0.02
Nodes (100): BookingQuote, GuestBookingDetail, GuestBookingSummary, HostelBookingView, metadata, PayoutAccountForReview, ReviewPayoutAccount(), STATUS_LABEL (+92 more)
...
Cohesion: 0.03
Nodes (111): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult (+103 more)

### Community 27 - "Community 27"
Cohesion: 0.02
Nodes (93): authorUserId, leanResult(), mocks, postId, reactorUserId, residentIn(), mocks, readable (+85 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (107): cookPrincipal, mocks, resolveCookLabels(), announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError (+99 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (103): AdminCommunityScreen(), AdminOverviewScreen(), AdminAlertsContext, AdminAlertsProvider(), AdminAlertsValue, AlertActions, EMPTY_COUNTS, ICONS (+95 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (100): demoteToPublicAccount(), findLiveResidency(), LIVE_STATUSES, LiveResidency, liveResidencyMessage(), LiveRow, notifyResidentRoomChanged(), notifyResidentStatusChanged() (+92 more)
...
Cohesion: 0.03
Nodes (82): RouteContext, PATCH(), RouteContext, paginationQuerySchema, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex(), HostelRecord (+74 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (100): BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsMonthStart(), bsPeriodBounds() (+92 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (91): collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor() (+83 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (89): formatHostelAddress(), hostelTypeToUi(), mapPublicHostelToSummary(), PublicHostel, PublicHostelDetailPage(), Choice, HOSTEL_TYPE_LABELS, HostelPanel() (+81 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (85): CommunityScreen(), Composer(), AttachmentGallery(), AnimatedBlurView, CommunityBoard(), CommunityBoardProps, Composer(), SORTS (+77 more)

### Community 37 - "Community 37"
Cohesion: 0.08
Nodes (59): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), verificationEmail(), bookingProofToCheckEmail(), hostelBookingsPausedEmail(), PLATFORM_NAME_PARTS (+51 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (69): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), ApplyBlock(), ServiceProvidersScreen() (+61 more)
...
Cohesion: 0.04
Nodes (67): resolvePastedLink(), searchCandidates(), geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), lookupLocation(), resolvePastedLink() (+59 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (64): generateMetadata(), generateMetadata(), manifest(), generateMetadata(), metadata, ComparePage(), generateMetadata(), hostels (+56 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (55): GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, hasFood() (+47 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (56): AcceptResult, CookInvitePageContent, AttendanceDay, ResidentAttendancePageContent, Zone, ZONE_LABELS, ZONE_STYLES, APP_METHODS (+48 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (61): hostelPeriodOf(), existingResidentListSchema, existingResidentRowSchema, BillPreview, CheckContext, CheckedRow, checkExistingResidents(), CheckResult (+53 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (55): summarizeResidentComplaints(), listResidentInvoices(), outstandingForResident(), bedSchema, depositRefundSchema, emergencyContactSchema, guardianSchema, moveInChecklistSchema (+47 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (70): formatPeriodKey(), cellAt(), focusCell(), Props, DeliveryWindowFields(), number(), text(), budgetLabel() (+62 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (62): ownerIdentitiesFor(), resolveOwnedHostel(), getPlanPaymentInstructions(), reviewPlanPaymentClaim(), findOpenInvoice(), getSubscriptionState(), invoiceIdFor(), selectPlan() (+54 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (66): classifyCredit(), CreditClassification, findOrphanClaims(), LadderClaim, LadderInvoice, loadMatchContext(), MatchContext, normalizeTxnId() (+58 more)
...
Cohesion: 0.04
Nodes (52): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, AuthShell(), AuthShellProps, PANEL_COPY (+44 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (50): HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminRoomsPageContent(), PlatformDashboardPageContent(), PlatformHostelReviewPageContent(), PlatformUsersPageContent(), DashboardCard(), DashboardCardProps (+42 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (60): HostelPayeeIdentity, GATEWAY_ORDER, getHostelPayMethods(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod (+52 more)

### Community 53 - "Community 53"
Cohesion: 0.03
Nodes (41): ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, RETAINED_BY_HOSTEL_ID, both, covered (+33 more)
...
Cohesion: 0.04
Nodes (52): GET(), PATCH(), RouteContext, POST(), feeUpdateSchema, PATCH(), setResidentMonthlyFee(), getFoodRoutine() (+44 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (56): PaginationMeta, PaginationQuery, querySchema, noticeSchema, noticeReadStatusSchema, mocks, noticeInput, residentUserId (+48 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (60): BrandWordmark(), WORDMARK, WORDMARK_SEGMENTS, ActiveSuspension, HostelSuspendedScreen(), HostelSuspensionNotice(), isHostelPortal(), PayPlanPanel (+52 more)
...
Cohesion: 0.04
Nodes (46): ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, attempt, fetchMock, forged, live (+38 more)

### Community 60 - "Community 60"
Cohesion: 0.06
Nodes (62): UploadCard(), useIsUploading(), useUploads(), directionOf(), EMPTY_TALLY, floorToStep(), phaseOf(), shouldRepost() (+54 more)

### Community 61 - "Community 61"
Cohesion: 0.05
Nodes (56): GET(), GET(), GET(), acceptPlatformAdminInvitation(), AcceptPlatformAdminInvitationInput, appUrl(), checkPlatformAdminEmail(), daysFromNow() (+48 more)
...
Cohesion: 0.04
Nodes (44): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, hostelOrThrow(), notifyPlatformOfPayoutReview(), PayoutAccountStatus, PayoutAccountView (+36 more)

### Community 65 - "Community 65"
Cohesion: 0.07
Nodes (60): PlatformIdCardType, getPresignedReadUrl(), userResidentProfileSchema, LEGACY_ROLE_MAP, Role, ROLE_VALUES, CARD_LABELS, formatIssuedOn() (+52 more)

### Community 66 - "Community 66"
Cohesion: 0.06
Nodes (51): notifyProviderOfAssignment(), notifyProviderOfMaintenanceNote(), notifyProviderOfStatusChange(), notifyStaffOfJobProgress(), notifyStaffOfNewMaintenanceRequest(), providerUserId(), readableCategory(), RequestLike (+43 more)
...
Cohesion: 0.05
Nodes (48): chelseaMarket, geistMono, geistSans, metadata, poppins, RootLayout(), MediaViewerProvider(), SiteAnnouncementBanner() (+40 more)

### Community 70 - "Community 70"
Cohesion: 0.05
Nodes (45): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, metadata, HostelPhotoReminder(), daysUntil(), HostelSubscriptionDueBanner(), rupees(), State (+37 more)
...
Cohesion: 0.05
Nodes (50): releaseGuardianAccounts(), daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags (+42 more)

### Community 73 - "Community 73"
Cohesion: 0.07
Nodes (47): JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, ProviderJobScreen(), listProviderJobs() (+39 more)

### Community 74 - "Community 74"
Cohesion: 0.05
Nodes (29): LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminComplaintsPage(), HostelAdminResidentsPage() (+21 more)

### Community 75 - "Community 75"
Cohesion: 0.06
Nodes (56): fill(), money(), PlanCard(), PricingScreen(), pricePlan(), PlanPicker(), BillingToggle(), listHeadingFor() (+48 more)
...
Cohesion: 0.06
Nodes (40): AuthGuard(), HostelSuggestions(), checkOnly(), EMPTY_PREFILL, ENVIRONMENT_OPTIONS, IdentityResponse, Prefill, Step (+32 more)

### Community 78 - "Community 78"
Cohesion: 0.08
Nodes (49): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt, allocateReceiptNumber() (+41 more)

### Community 79 - "Community 79"
Cohesion: 0.08
Nodes (41): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, SystemDocumentKind (+33 more)
...
Cohesion: 0.06
Nodes (44): POST(), RouteContext, listTrendingTags(), POST(), safeEqual(), sponsorSchema, ClickRecord, dayKey() (+36 more)

### Community 82 - "Community 82"
Cohesion: 0.05
Nodes (42): escapeRegex(), objectIdSchema, paginationSchema, phoneSchema, serviceProviderApplicationSchema, serviceProviderDocumentSchema, hostelId, mocks (+34 more)

### Community 83 - "Community 83"
Cohesion: 0.06
Nodes (44): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery (+36 more)
...
Cohesion: 0.08
Nodes (49): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags() (+41 more)
...
Cohesion: 0.05
Nodes (34): PlatformHostelsPageContent(), currency(), Panel(), Select(), PlatformHostelsPageContent, PortalPlaceholderAction, PortalPlaceholderPage(), PortalPlaceholderPageProps (+26 more)

### Community 88 - "Community 88"
Cohesion: 0.08
Nodes (43): otpCodeEmail(), deliver(), Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity, EmailIdentityResolver (+35 more)

### Community 89 - "Community 89"
Cohesion: 0.13
Nodes (40): BookingDocumentInput, renderBookingDocument(), bsFiscalYear(), amountInWords(), GROUPS, ONES, TENS, underHundred() (+32 more)
...
Cohesion: 0.05
Nodes (43): findCardBooking(), findHeldBooking(), account, answerBy, before, book(), Booking, compact (+35 more)

### Community 95 - "Community 95"
Cohesion: 0.07
Nodes (36): RefundPolicy, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails(), RenderedSection (+28 more)
...
Cohesion: 0.08
Nodes (38): isAuthBypassEnabled(), original, CookieReader, hasSessionCookie(), LEGACY_ACCESS_TOKEN_COOKIES, LEGACY_REFRESH_TOKEN_COOKIES, readAccessTokenCookie(), readRefreshTokenCookieValue() (+30 more)

### Community 98 - "Community 98"
Cohesion: 0.15
Nodes (41): dueWhen(), PlanDueInput, planDueSoonEmail(), planOverdueEmail(), planSuspensionNoticeEmail(), formatRupees(), subscriptionInvoiceEmail(), bookingConfirmedEmail() (+33 more)
...
Cohesion: 0.06
Nodes (35): PLATFORM_SETTING_CHANGE_STATUSES, platformSettingChangeSchema, bookings, CollectionQr, isSettingChangeKey(), SETTING_CHANGES, SettingChangeDefinition, SettingChangeKey (+27 more)
...
Cohesion: 0.06
Nodes (34): GET(), GET(), querySchema, applicantSchema, billingCycleSchema, HostelRegistrationInput, hostelRegistrationSchema, registrationFields (+26 more)
...
Cohesion: 0.06
Nodes (36): qrActivationSchema, before, expiresAt, mocks, staffPrincipal, ActivationCodeGenerateInput, ActivationCodeInput, activationSecret() (+28 more)

### Community 107 - "Community 107"
Cohesion: 0.05
Nodes (39): Faq, PlatformConfigSeoPageContent, Step, announcementSchema, cap, contentHighlightSchema, ContentPage, contentPageSchema (+31 more)
...
Cohesion: 0.1
Nodes (42): announceConfirmed(), directionsUrl(), bell(), BookingAudience, bookingFacts(), deliver(), guestBookingPath(), hostelBookingsPath() (+34 more)

### Community 110 - "Community 110"
Cohesion: 0.08
Nodes (37): cookLoginStem(), generateCookPassword(), mintCookLogin(), pick(), previousCookLabel(), acceptCookInvitation(), addCookAccount(), assertRoomForAnotherCook() (+29 more)

### Community 111 - "Community 111"
Cohesion: 0.06
Nodes (35): findIndex(), index, indexesOf(), IndexSpec, promote, applyConcessionToIssuedInvoices(), ConcessionBackfill, EMPTY (+27 more)
...
Cohesion: 0.08
Nodes (37): CampaignListQuery, CampaignRecord, createCampaign(), createHostelNotificationCampaign(), dispatchCampaign(), HostelCampaignInput, listHostelNotificationCampaigns(), normalizeObjectId() (+29 more)
...
Cohesion: 0.07
Nodes (29): StarLayer(), StarLayerProps, StarsBackground(), StarsBackgroundProps, TIER_TONE, EASE, PlanCards(), PlanLine() (+21 more)
...
Cohesion: 0.08
Nodes (27): applyWebhook(), WebhookResult, softmato(), SoftmatoNotConfiguredError, isSoftmatoConfigured(), SoftmatoConfig, softmatoWebhookSecret(), EnsureInvoiceInput (+19 more)

### Community 120 - "Community 120"
Cohesion: 0.1
Nodes (40): MESSAGES, POST(), RouteContext, BookingEndCause, HostelBookingClosedCause, announceEnding(), assertAwaitingAnswer(), cancelBookingByHostel() (+32 more)

### Community 121 - "Community 121"
Cohesion: 0.1
Nodes (35): CardBooking, checkInBooking(), returnHeldBed(), takeHeldBed(), applyStrikeRule(), endBooking(), EndBookingInput, ENDING_FOR_STATUS (+27 more)

### Community 122 - "Community 122"
Cohesion: 0.07
Nodes (36): addBsMonths(), august, bhadra, hostelId, invoice(), mocks, NOW, periodAgo() (+28 more)
...
Cohesion: 0.09
Nodes (37): BookingEnding, bookingFee(), BookingSettlement, cancellationSchedule(), cancelRefundPercent(), FULL_REFUND_ENDINGS, holdDayAt(), holdEndsAt() (+29 more)
...
Cohesion: 0.1
Nodes (30): applyBookingConfig(), BookingCancelStep, bookingCancelStepSchema, BookingConfig, bookingConfigSchema, DEFAULT_BOOKING_CONFIG, DEFAULT_CANCEL_STEPS, percent (+22 more)
...
Cohesion: 0.11
Nodes (34): askingEndsAt(), askingEndsMinuteOfNight(), formatPromptTime(), isCurrentNight(), isSameNight(), minuteIsDue(), minuteOfNight(), nightEndsAt() (+26 more)
...
Cohesion: 0.08
Nodes (21): GET(), RouteContext, RouteContext, RouteContext, listResidentContacts(), listResidents(), calendarDateSchema, emergencyContactCreateSchema (+13 more)
...
Cohesion: 0.09
Nodes (23): blankRow(), Row, TeamInviteBox(), Props, TeamMembersTable(), InviteResult, Member, PlatformTeamPage() (+15 more)
...
Cohesion: 0.08
Nodes (25): EvidenceEngine, EvidenceEngineMode, EvidenceReadFailure, OcrResult, KEYS, saved, IMAGE, lines (+17 more)
...
Cohesion: 0.1
Nodes (26): addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange(), definedUpdate(), FoodFeedbackInput, FoodFeedbackRecord, FoodMenuCreateInput (+18 more)
...
Cohesion: 0.15
Nodes (30): bootstrapSession(), assertMatchesExtension(), beginDownload(), downloadAndShare(), downloadAndShareCsv(), downloadAndShareImage(), downloadToDevice(), forgetDownloadFolder() (+22 more)
...
Cohesion: 0.07
Nodes (20): EmptyState(), LoadingRows(), StatusBadge(), field(), HostelAdminReportsPageContent(), ListingFlag, LoadState, MaintenanceRequest (+12 more)

### Community 150 - "Community 150"
Cohesion: 0.09
Nodes (26): softmatoDocsUrl(), dueBhadra29, filed, throughAswin25, CYCLE_LABELS, daysLeftThrough(), daysSpanned(), daysUntil() (+18 more)
...
Cohesion: 0.07
Nodes (21): Complaint, ComplaintSummary, field(), FoodMenu, HostelAdminFoodPage(), HostelAdminNoticesPage(), HostelAdminPaymentsPage(), Input() (+13 more)
...
Cohesion: 0.1
Nodes (22): OcrWord, accessToken(), annotateUrl(), assertion(), base64url(), billingPeriod(), boxOf(), isVisionConfigured() (+14 more)

### Community 159 - "Community 159"
Cohesion: 0.07
Nodes (24): nextPlanDueStep(), ALL, base, decide(), early, edited, hostelId, html (+16 more)
...
Cohesion: 0.1
Nodes (26): Attendance / Night Safety, Build status (end of Phase 3), Build status (end of Phase 5 — verified 2026-08-02), code:typescript (export enum Role {), code:typescript (interface IQRActivation {), code:typescript (interface INightStatusLog {), code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {) (+18 more)
...
Cohesion: 0.14
Nodes (23): changeLabel(), count(), figureRow(), fittedSize(), hairline(), masthead(), moneyPage(), monthOnly() (+15 more)
...
Cohesion: 0.13
Nodes (18): buildProviderPayload(), firstIncompleteProviderStep(), hasProviderErrors(), isProviderStepComplete(), PROVIDER_CATEGORIES, PROVIDER_STEPS, ProviderAttachment, ProviderCategory (+10 more)
...
Cohesion: 0.15
Nodes (17): Guidance, GuidanceStatus, hasLocationPermission(), hasPromptedForLocation(), LocationOutcome, NavigationFix, readPosition(), readPrecisePosition() (+9 more)
...
Cohesion: 0.15
Nodes (17): ApiFailure, ApiSuccess, AuthUser, confirmComplaintResolution(), createResidentComplaint(), listResidentComplaints(), listResidentFood(), ResidentComplaint (+9 more)
...
Cohesion: 0.12
Nodes (15): distanceToPath(), nextStep(), progressAlong(), projectOntoSegment(), corner, dogleg, heading, KILOMETRE_EAST (+7 more)
...
Cohesion: 0.16
Nodes (13): getResidentProfile(), login(), triggerSOS(), RootStackParamList, LoginScreen(), Props, Profile, Props (+5 more)
...
Cohesion: 0.21
Nodes (14): AdminInvoiceRow, InvoiceSegment, isFirstMonth(), isProRated(), outstandingRows(), searchInvoiceRows(), first, moved() (+6 more)
...
Cohesion: 0.14
Nodes (16): 2.3 Hostel Rejected, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails, 4.3 Complaint Resolved (+8 more)
...
Cohesion: 0.15
Nodes (14): apiRequest(), getActivationStatus(), listNotifications(), markNotificationRead(), NotificationItem, refreshSession(), requestOtp(), saveDeviceToken() (+6 more)
...
Cohesion: 0.21
Nodes (14): maneuverIcon(), NavCard(), cardinalFor(), CARDINALS, chooseHeading(), directionWord(), formatManeuverDistance(), headingDifference() (+6 more)
...
Cohesion: 0.17
Nodes (11): RouteContext, listResidentGuardians(), DEFAULT_GUARDIAN_PERMISSIONS, guardianAccessCreateSchema, guardianInvitationAcceptSchema, guardianInviteSchema, guardianLoginSchema, guardianPermissionsSchema (+3 more)

### Community 269 - "Community 269"
Cohesion: 0.2
Nodes (11): claimSecret(), issueDocumentClaimToken(), isValidDocumentClaimToken(), RegistrationDocumentError, SubmittedDocument, PUBLIC_TYPES, GET(), isAssignedProvider() (+3 more)
...
Cohesion: 0.15
Nodes (13): 4.1 New Notice Posted, 4.2 Complaint Status Updated, 4. Resident Activity Emails, 5.1 SOS Triggered, 5. Safety & Emergency Emails, code:typescript ({), code:typescript ({), Email Opt-In/Opt-Out Matrix (+5 more)
...
Cohesion: 0.24
Nodes (11): buildContactMethods(), buildFaqs(), contactMethods, faqs, PublicContactPage(), SiteIdentity, WEB_ANSWERS, ContactPage() (+3 more)

### Community 312 - "Community 312"
Cohesion: 0.18
Nodes (9): activateResident(), AuthSession, AppNavigator(), Stack, Props, ResidentActivationScreen(), styles, ResidentComplaintsScreen() (+1 more)
...
Cohesion: 0.29
Nodes (8): subscriptionClaimReceivedEmail(), subscriptionClaimRejectedEmail(), deliver(), loadInvoiceById(), loadProof(), PlanPaymentInstructions, ProofAsset, submitPlanPaymentClaim()
...
Cohesion: 0.28
Nodes (7): mocks, notifyOrderPlaced(), notifyOrderStatusEmail(), orderEmailItems(), orderItemCount(), resolveOrderRecipients(), StoreOrderNotificationRecord
...
## Knowledge Gaps
- **6247 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+6242 more)
...
- **Why does `cn()` connect `Community 9` to `Community 256`, `Community 129`, `Community 1`, `Community 6`, `Community 7`, `Community 10`, `Community 138`, `Community 148`, `Community 149`, `Community 151`, `Community 24`, `Community 25`, `Community 152`, `Community 31`, `Community 35`, `Community 163`, `Community 41`, `Community 42`, `Community 299`, `Community 43`, `Community 46`, `Community 50`, `Community 51`, `Community 57`, `Community 58`, `Community 189`, `Community 62`, `Community 69`, `Community 70`, `Community 75`, `Community 77`, `Community 87`, `Community 96`, `Community 102`, `Community 123`, `Community 108`, `Community 116`, `Community 379`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 1` to `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 11`, `Community 13`, `Community 15`, `Community 145`, `Community 19`, `Community 22`, `Community 25`, `Community 284`, `Community 29`, `Community 36`, `Community 38`, `Community 39`, `Community 40`, `Community 43`, `Community 67`, `Community 95`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `Role` connect `Community 27` to `Community 0`, `Community 2`, `Community 130`, `Community 133`, `Community 6`, `Community 7`, `Community 8`, `Community 12`, `Community 14`, `Community 17`, `Community 21`, `Community 23`, `Community 26`, `Community 28`, `Community 30`, `Community 32`, `Community 33`, `Community 164`, `Community 165`, `Community 47`, `Community 48`, `Community 49`, `Community 50`, `Community 182`, `Community 55`, `Community 56`, `Community 57`, `Community 61`, `Community 64`, `Community 66`, `Community 197`, `Community 70`, `Community 72`, `Community 78`, `Community 80`, `Community 83`, `Community 86`, `Community 93`, `Community 94`, `Community 97`, `Community 100`, `Community 102`, `Community 103`, `Community 104`, `Community 234`, `Community 235`, `Community 106`, `Community 109`, `Community 110`, `Community 113`, `Community 241`, `Community 120`?**
...
- **What connects `iosUrlScheme`, `{ defineConfig }`, `expoConfig` to the rest of the system?**
  _6247 weakly-connected nodes found - possible documentation gaps or missing edges._