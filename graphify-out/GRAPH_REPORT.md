...
## Summary
- 12344 nodes · 33468 edges · 448 communities (429 shown, 19 thin omitted)
...
## Communities (448 total, 19 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (213): PATCH(), POST(), RouteContext, GET(), GET(), POST(), POST(), POST() (+205 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (180): Scanner(), FaqRow(), MethodCard(), GuardianInviteScreen(), Choice, MapButton(), MapScreen(), ModeTab() (+172 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (183): POST(), GET(), HostelAdminProfileQuery, HostelAdminProfileUpdateInput, HostelChangeRequestInput, HostelPhotoCreateInput, HostelPhotoDeleteQuery, LOCKED_NAME_STATUSES (+175 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (201): ActivationIssue, addEmergencyContact(), addHostelPhoto(), addResidentGuardian(), approveMatchedStatement(), assignOrphanPayment(), AttendanceAnalytics, AttendanceSettings (+193 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (158): AdminAlertsScreen(), ICONS, LABELS, Segment, TONES, AdminHomeScreen(), AdminOverviewScreen(), loadOverview() (+150 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (161): auditFinanceAction(), FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment() (+153 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (110): FILTERS, Pending, CallableRow(), IdentityCard(), PeopleSection(), Person, ProfileScreen(), PickedAttachment (+102 more)
...
Cohesion: 0.02
Nodes (105): Filter, ModeratedPost, ModerationPayload, deferLoad(), DemoDataBadge(), Hostel, HostelTable(), Inquiry (+97 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (135): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply() (+127 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (151): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput, ConsentInput (+143 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (127): GET(), POST(), querySchema, RouteContext, authorUserId, mocks, postId, residentId (+119 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (138): CookTodayScreen(), SosInput, SosPhase, DeletionRequest, DeletionStatus, getDeletionStatus(), requestAccountDeletion(), listReferrals() (+130 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (108): CommunityReportDialog(), REASONS, ConfirmOptions, MonthPicker, PeriodRow, HostelPreviewLink(), FILTERS, Notification (+100 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (90): adminPrincipal, mocks, PLATFORM_LIMITS, base, entityId, hostelId, mocks, principal (+82 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (119): getHostelLedger(), getInvoiceMatrix(), HostelLedger, HostelLedgerEntry, InvoiceMatrix, InvoiceMatrixRow, PortalInvoice, ResidentFinanceView (+111 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (109): NightStatusForm(), NotificationCard(), ReferralRow(), CheckoutStatusScreen(), ComplaintDetail(), ComplaintCard(), ComplaintsScreen(), needsResident() (+101 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (92): AdminCommunityScreen(), AdminMoreScreen(), MANAGE_ROWS, PORTAL_ROWS, ActivateScreen(), BootGate(), FILTERS, NotificationsScreen() (+84 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (87): GuardianDashboard, MatrixRow, MatrixTotals, PeriodSummary, ClaimFacts(), FLAG_LABELS, POSITIVE_FLAGS, ProofReviewModal (+79 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (88): FeeSchedule, Rate, PRIORITIES, STATUS_ACTIONS, Campaign, Resident, AttendanceAnalytics, FoodAnalytics (+80 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (89): ViewerPage(), ManageFinanceScreen(), ManagePaymentSetupScreen(), SubmitClaimScreen(), InvoiceDetailScreen(), LedgerCard(), methodIcon(), methodLabel() (+81 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (82): DeletionPathway, DeletionStatus, PATHWAY_COPY, CancelDeletionPageContent(), CommunityModerationPanel(), field(), GuardianPermissions, LoadState (+74 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (69): PATCH(), RouteContext, GET(), escapeRegex(), objectIdSchema, paginationSchema, phoneSchema, serviceProviderApplicationSchema (+61 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (64): metadata, AccountDeletionPanel, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails() (+56 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (71): AttendanceCalendar(), EMPTY_SUMMARY, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine (+63 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (73): PaginationMeta, PaginationQuery, paginationQuerySchema, querySchema, notificationCampaignSchema, input, mocks, userId (+65 more)

### Community 26 - "Community 26"
Cohesion: 0.06
Nodes (50): GenericPortalScreen(), portalRows(), portalTitle(), hasFood(), LoadState, PublicHostelListingPageContent(), PublicInquiryPage(), PublicInquiryPageContent() (+42 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (50): summarizeResidentComplaints(), bedSchema, depositRefundSchema, emergencyContactSchema, guardianSchema, moveInChecklistSchema, moveOutChecklistSchema, noticeSchema (+42 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (60): CommunityScreen(), Composer(), CommunityBoard(), Composer(), CommentThread(), CommunityPostCard(), ReportSheet(), ReactionBar() (+52 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (52): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery (+44 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (55): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), ApplyBlock(), ServiceProvidersScreen(), AdminMoneyCard(), CHIP_TONES (+47 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (65): AdminCommunityReportsScreen(), AdminResidentsScreen(), NightStatusScreen(), ReferralsScreen(), SORTS, StoreCategoryScreen(), CommunityPostScreen(), ComplaintDetailScreen() (+57 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (48): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), useConfirm(), PageHeader(), AcceptResult, GuardianInvitePageContent (+40 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (67): demoteToPublicAccount(), CapacityError, claimBedForRoomType(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary(), releaseBedForRoomType() (+59 more)

### Community 34 - "Community 34"
Cohesion: 0.05
Nodes (55): GET(), POST(), CSV_COLUMNS, GET(), GET(), POST(), DELETE(), PATCH() (+47 more)
...
Cohesion: 0.05
Nodes (57): IdCardFace(), initialsOf(), Portrait(), IdCardPrompt(), Point(), IdCardDetail(), IdCardScreen(), buildIdCard() (+49 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (65): feeUpdateSchema, PATCH(), SetResidentFeeInput, setResidentMonthlyFee(), arrangeProof(), leanResult(), mocks, paymentId (+57 more)
...
Cohesion: 0.04
Nodes (59): dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, isMonthEnd(), mealsOn(), ROUTINE_DAYS (+51 more)
...
Cohesion: 0.05
Nodes (46): AuthGuard(), HostelSuggestions(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, PublicHostel, checkOnly() (+38 more)
...
Cohesion: 0.05
Nodes (60): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, TXN_ID_ALIASES, WITHDRAWAL_ALIASES (+52 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (53): daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags, GuardianPermissionsUpdateInput (+45 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (50): qrActivationSchema, referralSchema, referralCodeSchema, referralRewardSchema, residentSchema, auditReferralAction(), confirmReferralJoined(), HostelAdminReferralListQuery (+42 more)
...
Cohesion: 0.05
Nodes (58): storeOrderSchema, mocks, allocateOrderNumber(), applyStatus(), CancelInput, cancelOrder(), CreateInput, getOrder() (+50 more)

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (36): SosScreen(), TABS, AdminSearchBar(), ViewerBody(), useBottomChrome(), AvatarTabIcon(), RoleTabs(), TabDef (+28 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (44): GET(), POST(), GET(), POST(), POST(), DELETE(), POST(), getMyExpertConsultationRequest() (+36 more)

### Community 52 - "Community 52"
Cohesion: 0.12
Nodes (33): idCardIssuedEmail(), accountUpgradedEmail(), verificationEmail(), guardianInvitationEmail(), cookPortalEnabledEmail(), hostelDocumentsRequestedEmail(), hostelApprovedEmail(), hostelPublishedEmail() (+25 more)

### Community 53 - "Community 53"
Cohesion: 0.06
Nodes (46): AttachmentGallery(), DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS, MealCard(), MonthEndSpecial(), RoutineMeal (+38 more)

### Community 54 - "Community 54"
Cohesion: 0.06
Nodes (35): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, attempt (+27 more)

### Community 55 - "Community 55"
Cohesion: 0.07
Nodes (45): GATEWAY_ORDER, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice(), assertQrAssetUsable(), EMPTY (+37 more)

### Community 56 - "Community 56"
Cohesion: 0.05
Nodes (30): AuthShell(), AuthShellProps, SiteWordmark(), GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse, GoogleAuthUser, GoogleCredentialResponse (+22 more)
...
Cohesion: 0.07
Nodes (44): notificationSchema, userResidentProfileSchema, LEGACY_ROLE_MAP, Role, ROLE_VALUES, ageFromDateOfBirth(), cardPhotoImageUrl(), clearResidentIdentityPhoto() (+36 more)
...
Cohesion: 0.09
Nodes (19): PlatformConfigAnnouncementsPageContent, PlatformConfigContentPageContent, PlatformConfigFacilitiesPageContent, FLAGS, PlatformConfigFeaturesPageContent, PlatformConfigLegalPageContent, PlatformConfigLocationsPageContent, PlatformConfigPricingPageContent (+11 more)
...
Cohesion: 0.07
Nodes (21): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminNoticesPage(), redirectToWorkspaceScreen(), HostelAdminMaintenancePageContent() (+13 more)
...
Cohesion: 0.06
Nodes (37): ComparePage(), hostels, metadata, rows, CurrentUser, DASHBOARD_ROLES, dashboardHrefForRole(), hasDashboard() (+29 more)
...
Cohesion: 0.08
Nodes (40): AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance(), DIGIT_CONFUSABLES, evidenceTextFlags(), EvidenceTextMatch (+32 more)

### Community 69 - "Community 69"
Cohesion: 0.08
Nodes (38): Offset, PhotoCropper(), FileUploadArea(), acceptAttribute(), EXTENSION_BY_MIME, FAMILY_BYTES, FAMILY_ORDER, familyOf() (+30 more)

### Community 70 - "Community 70"
Cohesion: 0.09
Nodes (38): storeCategorySchema, storeProductSchema, DELETE(), PATCH(), RouteContext, categoriesFor(), escapeRegex(), getStoreHome() (+30 more)
...
Cohesion: 0.07
Nodes (35): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, FeeScheduleRecord, FeeScheduleCloseInput (+27 more)

### Community 73 - "Community 73"
Cohesion: 0.06
Nodes (27): cityOptions, createDocument(), createRoom(), DocumentConfig, DraftData, FACILITY_MINI, facilityOptions, FIELD_KEY_STEP (+19 more)
...
Cohesion: 0.06
Nodes (35): ESEWA_CSV_PARSER, both, corrupted, debit, [first], FIXTURE, headerOnly, noDate (+27 more)
...
Cohesion: 0.12
Nodes (29): computePerceptualHash(), ImageVariantRecord, optimizeImage(), streamToBuffer(), VARIANT_CONFIG, VariantName, r2Configured(), storePublicAsset() (+21 more)
...
Cohesion: 0.08
Nodes (31): periodTotals(), assertHostelAccess(), canAccessHostel(), hostelScopedFilter(), TenantAccessError, TenantPrincipal, attendanceLogSchema, foodReadyLogSchema (+23 more)
...
Cohesion: 0.09
Nodes (28): progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster(), UploadRow, UploadStack(), useIsHydrated() (+20 more)
...
Cohesion: 0.07
Nodes (20): Panel(), field(), HostelAdminReferralsPageContent(), HostelAdminReportsPageContent(), ListingFlag, LoadState, MaintenanceRequest, optionalField() (+12 more)
...
Cohesion: 0.11
Nodes (18): POST(), POST(), POST(), POST(), periodOf(), runBillingCycleForAllHostels(), POST(), POST() (+10 more)
...
Cohesion: 0.12
Nodes (26): UploadCard(), UploadToaster(), useIsUploading(), useUploads(), uploadPublicFile(), uploadPublicText(), dismissUpload(), emit() (+18 more)

### Community 97 - "Community 97"
Cohesion: 0.08
Nodes (22): currency(), EmptyState(), Input(), StatusBadge(), ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, Complaint (+14 more)
...
Cohesion: 0.09
Nodes (22): deviceTokenSchema, CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, readId(), activeTokensFor(), authHeaders(), chunk() (+14 more)

### Community 101 - "Community 101"
Cohesion: 0.14
Nodes (22): ProviderJobScreen(), getOwnProvider(), listProviderJobs(), ProviderApplication, ProviderJob, ProviderJobStatus, updateProviderJobStatus(), CATEGORY_ICONS (+14 more)

### Community 102 - "Community 102"
Cohesion: 0.11
Nodes (20): HostelPhotoReminder(), formatHostelAddress(), hostelTypeToUi(), mapPublicHostelToSummary(), roomTypeLabel(), CATEGORY_LABELS, NEARBY_GROUPS, PublicHostelDetailPage() (+12 more)
...
Cohesion: 0.09
Nodes (24): RootShell(), AssetViewer(), useViewerState(), BottomChrome, BottomChromeContext, BottomChromeProvider(), CHROME_TIMING, usePush() (+16 more)
...
Cohesion: 0.1
Nodes (22): sponsorSchema, loadPopularHostels(), PopularHostelRecord, assertWindow(), CreateInput, createSponsor(), deleteSponsor(), listLiveSponsors() (+14 more)

### Community 111 - "Community 111"
Cohesion: 0.16
Nodes (21): otpCodeEmail(), EmailCategory, fromHeaderFor(), replyToFor(), fromAddress(), sendEmail(), SendEmailInput, SendEmailResult (+13 more)
...
Cohesion: 0.12
Nodes (23): Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity(), NAME_SUFFIX (+15 more)
...
Cohesion: 0.13
Nodes (20): GuardianHomeScreen(), GuardianMetrics(), GuardianPaymentsScreen(), GuardianSafetyScreen(), GuardianPayment, GuardianPermissionKey, GuardianPermissions, GuardianReceipt (+12 more)

### Community 125 - "Community 125"
Cohesion: 0.08
Nodes (13): RouteContext, emergencyContactCreateSchema, guardianCreateSchema, objectIdSchema, optionalHostelScopeSchema, residentCreateSchema, residentStatusSchema, residentTypeSchema (+5 more)
...
Cohesion: 0.15
Nodes (16): ApiFailure, EXTENSION_MIME, PickedFile, resolveFileName(), resolveMimeType(), name, formatMegabytes(), PUBLIC_UPLOAD_TYPES (+8 more)
...
Cohesion: 0.15
Nodes (14): requestOtp(), signInWithGoogle(), submitResidentReview(), triggerSOS(), RootStackParamList, LoginScreen(), Props, Props (+6 more)
...
Cohesion: 0.15
Nodes (14): apiRequest(), getActivationStatus(), listNotifications(), login(), markNotificationRead(), NotificationItem, refreshSession(), register() (+6 more)
...
Cohesion: 0.2
Nodes (11): DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList(), positiveInteger(), validateFileAssetMetadata(), hashBytes(), normalizeMime() (+3 more)
...
Cohesion: 0.24
Nodes (10): buildHtml(), buildShell(), MapExplorer, MapExplorerProps, MapHandle, MapMarker, inlineJson(), MAP_LAYERS (+2 more)
...
Cohesion: 0.2
Nodes (10): POST(), acceptGuardianInvitation(), DEFAULT_GUARDIAN_PERMISSIONS, guardianAccessCreateSchema, guardianInvitationAcceptSchema, guardianInviteSchema, guardianLoginSchema, guardianPermissionsSchema (+2 more)

### Community 242 - "Community 242"
Cohesion: 0.26
Nodes (9): getPresignedReadUrl(), asset, fileAssetSchema, variantSchema, violation, GET(), resolveVariantKey(), RouteContext (+1 more)
...
Cohesion: 0.2
Nodes (11): 1.2 Hostel Admin Credentials (Post-Approval), 1.5 Guardian Invitation, 2.1 Hostel Submission Received, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, 3.3 Payment Proof Uploaded (to Admin), code:typescript ({), code:typescript ({) (+3 more)
...
Cohesion: 0.36
Nodes (5): hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKindFromText(), distance, SystemDocumentKind
...
Cohesion: 0.48
Nodes (6): deleteGatewayConfig(), listGatewayConfigs(), DELETE(), deleteSchema, GET(), saveSchema
...
- **Why does `Button()` connect `Community 6` to `Community 1`, `Community 3`, `Community 4`, `Community 8`, `Community 13`, `Community 16`, `Community 17`, `Community 18`, `Community 20`, `Community 21`, `Community 23`, `Community 24`, `Community 30`, `Community 32`, `Community 36`, `Community 40`, `Community 50`, `Community 53`, `Community 126`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 13` to `Community 257`, `Community 6`, `Community 8`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 23`, `Community 24`, `Community 26`, `Community 32`, `Community 38`, `Community 41`, `Community 42`, `Community 56`, `Community 60`, `Community 65`, `Community 66`, `Community 69`, `Community 73`, `Community 82`, `Community 86`, `Community 91`, `Community 92`, `Community 97`, `Community 228`, `Community 102`, `Community 109`, `Community 119`, `Community 122`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 168` to `Community 0`, `Community 3`, `Community 4`, `Community 7`, `Community 141`, `Community 15`, `Community 17`, `Community 274`, `Community 19`, `Community 20`, `Community 21`, `Community 150`, `Community 18`, `Community 35`, `Community 40`, `Community 45`, `Community 48`, `Community 52`, `Community 54`, `Community 69`, `Community 71`, `Community 72`, `Community 73`, `Community 81`, `Community 82`, `Community 98`, `Community 126`?**
