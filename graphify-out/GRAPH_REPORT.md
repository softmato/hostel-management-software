...
## Corpus Check
- 2094 files · ~3,281,506 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 16832 nodes · 46426 edges · 541 communities (506 shown, 35 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 754 edges (avg confidence: 0.8)
...
3. `connectToDatabase()` - 455 edges
4. `useAppTheme()` - 406 edges
5. `cn()` - 301 edges
6. `connectToDatabase()` - 253 edges
7. `unwrap()` - 210 edges
...
## Communities (541 total, 35 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (298): loadOverview(), loadMoney(), loadToday(), AdminRollCallCard(), NightStatusPromptCard(), load, FinanceData, loadFinance() (+290 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (197): PlanPaymentClaim, DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton() (+189 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (215): MoneyData, AdminMoreScreen(), MANAGE_ROWS, PORTAL_ROWS, AdminResidentsScreen(), TodayData, ActivateScreen(), AttendanceScreen() (+207 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (221): PATCH(), RouteContext, POST(), getOrCreateSubscription(), POST(), GET(), getOpenFeeSchedule(), GET() (+213 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (204): AdminCommunityReportsScreen(), FILTERS, Pending, ReviewForm(), ReviewScreen(), CommunityScreen(), Composer(), CommunityPostScreen() (+196 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (206): dayKey(), deleteResidentLocationHistory(), getResidentAttendance(), listAttendanceAlerts(), listHostelAttendance(), overrideAttendance(), demoteToPublicAccount(), confirmComplaintResolution() (+198 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (171): Scanner(), FaqRow(), MethodCard(), CookInviteScreen(), GuardianInviteScreen(), Choice, Compass(), MapButton() (+163 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (147): GET(), POST(), GET(), POST(), attendanceSettingsSchema, POST(), POST(), GET() (+139 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (187): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, notifyHostelOfNewPost(), resolveHostelCommunityUserIds(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply() (+179 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (150): AdminCommunityScreen(), APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), ApplyBlock(), ServiceProvidersScreen(), SosScreen() (+142 more)

### Community 10 - "Community 10"
Cohesion: 0.01
Nodes (132): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage() (+124 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (132): PATCH(), RouteContext, getPlatformSubscriptionLedger(), listPlanPaymentClaims(), GET(), POST(), RouteContext, complaintCategorySchema (+124 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (152): POST(), POST(), POST(), attacker, attempt(), headers, jsonRequest(), routeMocks (+144 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (150): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), manifest() (+142 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (161): ClearFilters(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard(), AmountCard(), AdminLedger (+153 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (107): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, CITY_OPTIONS, FACILITY_STATS (+99 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (135): AdminHomeScreen(), AdminOverviewScreen(), Overview, HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader() (+127 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (135): getResidentFinanceView(), HostelLedger, HostelLedgerEntry, InvoiceMatrix, InvoiceMatrixRow, listResidentClaims(), NotBilled, PortalInvoice (+127 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (112): FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, monthStartPeriod(), Rate, RoomTypeOption, MonthField, MonthOption() (+104 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (122): base, entityId, hostelId, mocks, principal, write(), hostelId, invoice (+114 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (125): DescriptionFacts, DescriptionSuggestions(), HostelType, since(), starters, typeWords, Offset, PhotoCropper() (+117 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (109): AccountDeletionPanel, InlineText(), TIER_TONE, PlanMark(), RAFTER, RIDGE, ROWS, BillingToggle() (+101 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (109): POST(), GET(), POST(), POST(), POST(), POST(), GET(), POST() (+101 more)

### Community 23 - "Community 23"
Cohesion: 0.02
Nodes (121): CentrePin(), describeAddress(), HostelPinField(), HostelPinPicker(), KATHMANDU, MapLinkField(), PickerBody(), PinAddress (+113 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (104): PRIORITIES, STATUS_ACTIONS, Campaign, Resident, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel (+96 more)

### Community 25 - "Community 25"
Cohesion: 0.02
Nodes (113): cookPrincipal, mocks, CookServiceError, resolveAdminHostelId(), announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput (+105 more)

### Community 26 - "Community 26"
Cohesion: 0.02
Nodes (108): CapacityError, claimBedForRoomType(), listAllRoomTypes(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary(), releaseBedForRoomType() (+100 more)

### Community 27 - "Community 27"
Cohesion: 0.02
Nodes (92): generateMetadata(), metadata, generateMetadata(), metadata, ComparePage(), generateMetadata(), hostels, metadata (+84 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (85): answerSchema, recordConsent(), attendanceAlertResolveSchema, attendanceListQuerySchema, attendanceOverrideSchema, consentSchema, locationPingSchema, objectIdSchema (+77 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (98): BootGate(), RootShell(), BrandSplash(), AuthDivider(), GoogleSignInButton(), ResidencyInviteHost(), RoleGate(), accentForAccount() (+90 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (98): BrandMark(), BrandWordmark(), WORDMARK, WORDMARK_SEGMENTS, CommunityReportDialog(), REASONS, BrowserPushRow(), ModerationButton() (+90 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (78): csvField(), field(), Hostel, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminProfilePageContent(), HostelAdminRoomsPageContent(), Inquiry (+70 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (99): BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan, Badge(), grabDocument(), HostelAdminBillingPageContent(), InvoiceRow() (+91 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (89): HostelSuggestions(), inferKind(), MediaLightbox(), PublicComparePage(), PublicHomePage(), formatHostelAddress(), hasFood(), hostelTypeToUi() (+81 more)

### Community 34 - "Community 34"
Cohesion: 0.08
Nodes (71): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), verificationEmail(), dueWhen(), PlanDueInput, planDueSoonEmail() (+63 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (61): PlatformCommunityPageContent, PlatformConfigAnnouncementsPageContent, PlatformConfigContentPageContent, PlatformConfigFacilitiesPageContent, FLAGS, PlatformConfigFeaturesPageContent, PlatformConfigLegalPageContent, PlatformConfigLocationsPageContent (+53 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (91): HIDDEN, RoleLayout(), TABS, FILTERS, invalidateFeeds(), NotificationCard(), NotificationRow(), TILE_GLYPH (+83 more)
...
Cohesion: 0.03
Nodes (93): AssetViewer(), useViewerState(), ViewerPage(), CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel() (+85 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (94): approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal, checker, eventId (+86 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (91): authorUserId, mocks, postId, residentId, residentPrincipal, staffPrincipal, authorUserId, leanResult() (+83 more)

### Community 41 - "Community 41"
Cohesion: 0.03
Nodes (80): GET(), POST(), DELETE(), PATCH(), RouteContext, PATCH(), purgeArchivedHostel(), purgeHostel() (+72 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (92): addBsMonths(), BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsMonthStart(), bsPeriodBounds() (+84 more)

### Community 43 - "Community 43"
Cohesion: 0.03
Nodes (72): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery (+64 more)
...
Cohesion: 0.06
Nodes (77): SORTS, StoreCategoryScreen(), addToCart(), cancelStoreOrder(), Cart, CartLine, CartResult, CartTotals (+69 more)
...
Cohesion: 0.04
Nodes (69): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+61 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (70): BS_MONTHS, formatPeriodKey(), cellAt(), focusCell(), Props, defaultDueDate(), DeliveryWindowFields(), number() (+62 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (62): DELETE(), POST(), platformPushScheduleSchema, NotificationCampaignError, revokeDeviceToken(), campaignBaseSchema, deviceTokenRevokeSchema, deviceTokenSaveSchema (+54 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (63): configuredLevel(), levelPriority, logger, LogLevel, normalizeMeta(), shouldLog(), write(), pushTicketSchema (+55 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (64): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), SetResidentFeeInput, setResidentMonthlyFee(), approveClaim(), assertNotAlreadyRecordedFromStatement(), BulkApproveResult (+56 more)
...
Cohesion: 0.06
Nodes (58): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt, subscriptionClaimReceivedEmail() (+50 more)

### Community 56 - "Community 56"
Cohesion: 0.03
Nodes (42): deleteHostelObjects(), ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, RETAINED_BY_HOSTEL_ID, both (+34 more)
...
Cohesion: 0.04
Nodes (55): LIVE_ACCESS, releaseGuardianAccounts(), hostelId, mocks, userId, daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess() (+47 more)
...
Cohesion: 0.05
Nodes (49): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, metadata, HostelPhotoReminder(), daysUntil(), HostelSubscriptionDueBanner(), rupees(), State (+41 more)

### Community 62 - "Community 62"
Cohesion: 0.04
Nodes (52): HostelAdminCooksPanel, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine, formatWeekRange() (+44 more)
...
Cohesion: 0.05
Nodes (55): GATEWAY_ORDER, getHostelPayMethods(), getPayInstructions(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod (+47 more)
...
Cohesion: 0.05
Nodes (56): BALANCE_ALIASES, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES, WITHDRAWAL_ALIASES (+48 more)

### Community 70 - "Community 70"
Cohesion: 0.05
Nodes (47): AdminAlertsScreen(), ICONS, LABELS, Segment, TONES, AdminTabs(), AdminTodayScreen(), AdminAlertsContext (+39 more)
...
Cohesion: 0.05
Nodes (41): CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES, avatarTone() (+33 more)
...
Cohesion: 0.06
Nodes (49): IntakeQuote, RESIDENT_TYPES, ResidentIntakeResult, ResidentOccupancy, ResidentPrefill, ResidentPrefillPhoto, ResidentType, residentCardPhotoSource() (+41 more)

### Community 75 - "Community 75"
Cohesion: 0.07
Nodes (53): getPresignedReadUrl(), userResidentProfileSchema, findLiveResidency(), LEGACY_ROLE_MAP, Role, ROLE_VALUES, CARD_LABELS, formatIssuedOn() (+45 more)
...
Cohesion: 0.07
Nodes (49): getInvoiceDetailForHostel(), HostelScope, ResolvedDocument, resolveInvoiceDocument(), resolveReceiptDocument(), scopeFilter(), settledTotal(), trySoftmato() (+41 more)

### Community 80 - "Community 80"
Cohesion: 0.06
Nodes (52): fill(), money(), PlanCard(), PricingScreen(), pricePlan(), HostelRegistrationProgress(), Milestone, milestoneIndex() (+44 more)

### Community 81 - "Community 81"
Cohesion: 0.06
Nodes (41): SERVICE_PROVIDER_CATEGORIES, serviceProviderSchema, serviceProviderApplicationSchema, serviceProviderDocumentSchema, hostelId, mocks, providerId, ACTIVE_APPLICATION_STATUSES (+33 more)
...
Cohesion: 0.07
Nodes (41): addHistory(), addMaintenanceComment(), assertBedInHostel(), assertProviderApproved(), assertRoomInHostel(), assertVoiceNoteUsable(), assignMaintenanceProvider(), auditMaintenanceAction() (+33 more)
...
Cohesion: 0.06
Nodes (32): PATCH(), POST(), RouteContext, GET(), POST(), dayOfWeekSchema, foodFeedbackSchema, foodMenuCreateSchema (+24 more)
...
Cohesion: 0.08
Nodes (36): dashboardHrefForRole(), isAuthBypassEnabled(), original, cook, assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES (+28 more)
...
Cohesion: 0.09
Nodes (31): FILE_ASSET_KINDS, FileAssetKind, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits() (+23 more)
...
Cohesion: 0.07
Nodes (35): BANK_CSV_PARSER, peekHeaders(), ESEWA_CSV_PARSER, both, corrupted, debit, [first], FIXTURE (+27 more)

### Community 102 - "Community 102"
Cohesion: 0.08
Nodes (27): outstandingForResident(), depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, providedItemSchema, roomSchema, auditMoveAction(), createMoveInChecklist() (+19 more)
...
Cohesion: 0.1
Nodes (33): Guidance, cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath(), formatManeuverDistance(), hasArrived() (+25 more)
...
Cohesion: 0.08
Nodes (30): GuardianPaymentsScreen(), acceptGuardianInvitation(), getGuardianFood(), getGuardianNotices(), getGuardianPayments(), getGuardianSafetySummary(), GuardianAccess, GuardianComplaint (+22 more)
...
Cohesion: 0.07
Nodes (23): AcceptResult, CookInvitePageContent, ActivationStatusResponse, ActivationTarget, CodeState, DOT_COLOR, MeResponse, ResidentActivationPageContent (+15 more)

### Community 113 - "Community 113"
Cohesion: 0.12
Nodes (30): storeCategorySchema, storeProductSchema, categoriesFor(), escapeRegex(), getStoreProduct(), getStoreShelves(), ListQuery, serializeStoreCategory() (+22 more)
...
Cohesion: 0.07
Nodes (14): PublicHostelListingPage(), PublicInquiryPage(), ComparePageSkeleton(), HostelDetailPageSkeleton(), HostelListingPageSkeleton(), InquiryPageSkeleton(), emptyFilters, Filters (+6 more)
...
Cohesion: 0.12
Nodes (26): GuidanceStatus, cardinalFor(), CARDINALS, chooseHeading(), distanceToPath(), hasArrived(), headingDifference(), isOffRoute() (+18 more)
...
Cohesion: 0.11
Nodes (25): signPurposeToken(), AccountDeletionError, applyImmediateEffects(), cancelAccountDeletionForUser(), cancelUrlFor(), DeletionPathway, DeletionRequestRecord, getAccountDeletionStatus() (+17 more)
...
Cohesion: 0.09
Nodes (18): PortalDates, useHostelDayTurn(), PlanBillingInvoice, PlanBillingPayment, PlanBillingPlan, FADED, LIFT, ManageBillingScreen() (+10 more)
...
Cohesion: 0.1
Nodes (23): confirmSettlementByStatement(), getR2Client(), StatementBytes, StatementProvider, importStatement(), ingest(), loadStatementAsset(), periodOf() (+15 more)
...
Cohesion: 0.22
Nodes (22): assertMatchesExtension(), beginDownload(), downloadAndShareCsv(), downloadAndShareImage(), downloadToDevice(), forgetDownloadFolder(), LegacyFileSystem, loadLegacyFileSystem() (+14 more)
...
Cohesion: 0.13
Nodes (15): activateResident(), AuthSession, login(), triggerSOS(), AppNavigator(), RootStackParamList, Stack, LoginScreen() (+7 more)
...
Cohesion: 0.13
Nodes (17): boundsCenter(), haversineMeters(), HostelWithDistance, isUsableCoordinate(), KATHMANDU, sortByDistance(), distance, far (+9 more)
...
Cohesion: 0.24
Nodes (16): AttendanceAlert, AttendanceLog, code:typescript ({), code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({), code:typescript ({), FoodReadyLog (+8 more)
...
Cohesion: 0.2
Nodes (12): buildHtml(), buildPinPage(), buildShell(), MapExplorer, MapExplorerProps, MapHandle, MapMarker, Coordinates (+4 more)
...
Cohesion: 0.22
Nodes (11): claimRegistrationDocuments(), claimSecret(), issueDocumentClaimToken(), isValidDocumentClaimToken(), RegistrationDocumentError, SubmittedDocument, GET(), isAssignedProvider() (+3 more)
...
Cohesion: 0.18
Nodes (12): apiRequest(), confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listResidentComplaints(), refreshSession(), register(), ResidentComplaint (+4 more)
...
Cohesion: 0.22
Nodes (8): getResidentProfile(), submitResidentReview(), Profile, Props, ResidentProfileScreen(), Props, ResidentReviewsScreen(), screenStyles
...
Cohesion: 0.22
Nodes (10): 3.1 Payment Due Reminder, 3.4 Payment Verified (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails, 4.2 Complaint Status Updated, code:block14 (---), code:typescript ({), code:typescript ({) (+2 more)
...
Cohesion: 0.25
Nodes (8): 2.3 Hostel Rejected, 3.2 Payment Overdue, 3.5 Payment Rejected (to Resident), 4.3 Complaint Resolved, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({)
...
Cohesion: 0.29
Nodes (6): documentUrl(), InvoiceLean, PaymentLean, PlatformInvoiceRow, PlatformPaymentRow, PlatformSubscriptionLedger
...
## Knowledge Gaps
- **5912 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+5907 more)
...
- **Why does `Button()` connect `Community 9` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 6`, `Community 14`, `Community 18`, `Community 149`, `Community 23`, `Community 27`, `Community 29`, `Community 30`, `Community 35`, `Community 163`, `Community 37`, `Community 38`, `Community 46`, `Community 62`, `Community 67`, `Community 70`, `Community 72`, `Community 74`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 30` to `Community 1`, `Community 2`, `Community 132`, `Community 4`, `Community 9`, `Community 10`, `Community 13`, `Community 15`, `Community 18`, `Community 20`, `Community 21`, `Community 24`, `Community 283`, `Community 27`, `Community 31`, `Community 32`, `Community 33`, `Community 35`, `Community 37`, `Community 45`, `Community 49`, `Community 61`, `Community 62`, `Community 72`, `Community 200`, `Community 80`, `Community 92`, `Community 229`, `Community 118`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 5` to `Community 3`, `Community 133`, `Community 134`, `Community 7`, `Community 8`, `Community 12`, `Community 17`, `Community 145`, `Community 19`, `Community 404`, `Community 21`, `Community 22`, `Community 152`, `Community 153`, `Community 25`, `Community 26`, `Community 28`, `Community 154`, `Community 293`, `Community 295`, `Community 40`, `Community 39`, `Community 42`, `Community 43`, `Community 44`, `Community 41`, `Community 47`, `Community 48`, `Community 50`, `Community 51`, `Community 52`, `Community 53`, `Community 55`, `Community 56`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 63`, `Community 64`, `Community 65`, `Community 68`, `Community 71`, `Community 75`, `Community 76`, `Community 79`, `Community 81`, `Community 82`, `Community 83`, `Community 88`, `Community 95`, `Community 353`, `Community 102`, `Community 103`, `Community 110`, `Community 113`, `Community 121`, `Community 124`, `Community 125`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Are the 450 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 450 INFERRED edges - model-reasoned connections that need verification._
