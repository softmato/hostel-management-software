...
## Corpus Check
- 2241 files · ~3,401,647 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17864 nodes · 50218 edges · 558 communities (525 shown, 33 thin omitted)
...
## Communities (558 total, 33 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (272): GET(), POST(), MESSAGES, POST(), RouteContext, PATCH(), POST(), RouteContext (+264 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (188): ICONS, LABELS, Segment, TONES, FILTERS, Pending, MoneyData, MANAGE_ROWS (+180 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (272): PATCH(), RouteContext, getOrCreateSubscription(), POST(), GET(), GET(), querySchema, getOpenFeeSchedule() (+264 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (267): BookingEndCause, HostelBookingClosedCause, announceConfirmed(), announceEnding(), assertAwaitingAnswer(), cancelBookingByHostel(), cancelBookingByPlatform(), cancelMyBooking() (+259 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (269): loadToday(), RoundButton(), VOICE_NOTE_RECORDING, VoiceNote, VoiceNoteRecorder(), loadFinance(), getAdminFoodRoutine(), getAdminMaintenance() (+261 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (174): PlanPaymentClaim, csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, HostelTable(), Inquiry (+166 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (229): BookingForm(), CheckoutScreen(), METHODS, PackageCard(), PayStep(), roomPhotoUris(), StatusCard(), AttachmentGallery() (+221 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (208): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, loadContext(), notifyHostelOfNewPost(), resolveHostelCommunityUserIds(), usersMutingNewPosts() (+200 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (181): Scanner(), CookInviteScreen(), GuardianInviteScreen(), Choice, Compass(), MapButton(), ModeTab(), NOTHING_CHOSEN (+173 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (179): POST(), POST(), GET(), answerSchema, POST(), attacker, attempt(), headers (+171 more)

### Community 10 - "Community 10"
Cohesion: 0.01
Nodes (148): LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminMoveChecklistPage() (+140 more)

### Community 11 - "Community 11"
Cohesion: 0.01
Nodes (201): AdminCommunityReportsScreen(), AdminResidentsScreen(), AttendanceScreen(), NightStatusHistoryScreen(), NightStatusForm(), NightStatusScreen(), NotificationCard(), ProfileScreen() (+193 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (154): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), dueWhen(), PlanDueInput (+146 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (128): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CancelDeletionPageContent() (+120 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (149): AdminMoreScreen(), ActivateScreen(), APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard() (+141 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (143): generateMetadata(), generateMetadata(), manifest(), robots(), Entry, hostelEntries(), locationEntries(), sitemap() (+135 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (139): AdminCommunityScreen(), MapScreen(), SosScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader() (+131 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (149): demoteToPublicAccount(), findHeldBooking(), listResidentComplaints(), LIVE_ACCESS, releaseGuardianAccounts(), connectToDatabase(), PaginationMeta, PaginationQuery (+141 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (135): listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), getPlatformSubscriptionLedger(), listPlanPaymentClaims(), GET(), DELETE() (+127 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (120): HostelSuggestions(), GenericPortalScreen(), portalRows(), portalTitle(), formatDate(), JobCard(), OPEN_STATUSES, PRIORITY_TONES (+112 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (132): BrandMark(), BrandWordmark(), WORDMARK, WORDMARK_SEGMENTS, CommunityReportDialog(), REASONS, MonthOption(), ActiveSuspension (+124 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (135): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), loadOverview(), Overview, AdminMoneyScreen(), loadMoney(), AdminTodayScreen() (+127 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (129): getPlanPaymentInstructions(), setHostelBookingPause(), mergeBookingConfig(), listTransfersDue(), getHostelPayoutAccount(), listPayoutAccounts(), DELETE(), GET() (+121 more)

### Community 23 - "Community 23"
Cohesion: 0.02
Nodes (109): approveClaim(), assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck(), evidenceCheck(), fileCheck() (+101 more)

### Community 24 - "Community 24"
Cohesion: 0.02
Nodes (103): summarizeResidentComplaints(), LedgerInvoice, outstandingForResident(), issue(), auditGuardianAction(), createGuardianAccess(), expiresInDays(), findAdminResident() (+95 more)

### Community 25 - "Community 25"
Cohesion: 0.02
Nodes (128): chelseaMarket, geistMono, geistSans, metadata, poppins, RootLayout(), money(), PlanCard() (+120 more)

### Community 26 - "Community 26"
Cohesion: 0.02
Nodes (125): AuditLogRecord, PlatformAuditLogQuery, RefRecord, SetResidentFeeInput, cookPrincipal, mocks, resolveCookLabels(), announceFoodReady() (+117 more)
...
Cohesion: 0.03
Nodes (107): ConcessionBackfill, describeApplied(), FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, MonthDiscounts, monthStartPeriod(), Rate (+99 more)

### Community 29 - "Community 29"
Cohesion: 0.02
Nodes (110): adminPrincipal, mocks, PLATFORM_LIMITS, assetId, hostelId, mocks, otherHostelId, principal (+102 more)

### Community 30 - "Community 30"
Cohesion: 0.02
Nodes (103): BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan, PlanPaymentInstructions, BookingPaymentToCheck, BookingQuote, GuestBookingDetail (+95 more)

### Community 31 - "Community 31"
Cohesion: 0.02
Nodes (108): cropToGuide(), FILL, GuidedCapture(), GUIDES, GuideShape, loadManipulator(), Manipulator, IdCardPrompt() (+100 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (94): openStore(), AdminTabs(), HIDDEN, RoleLayout(), TABS, FILTERS, NotificationRow(), TILE_GLYPH (+86 more)

### Community 33 - "Community 33"
Cohesion: 0.02
Nodes (90): EMPTY_PAYOUT_DRAFT, METHODS, PayoutAccountDraft, PayoutAccountFields(), payoutAccountPayload(), AuthGuard(), DescriptionFacts, DescriptionSuggestions() (+82 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (84): PRIORITIES, STATUS_ACTIONS, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel, GatewayConfig, GatewayHealthStatus (+76 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (87): Notification, FILTERS, Notification, NotificationRow(), PushState, NotificationSoundListener(), FILTERS, NotificationCard (+79 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (93): bsMonthStart(), formatBsDayRange(), BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped (+85 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (99): deleteResidentLocationHistory(), GET(), findCardBooking(), getPlatformBooking(), listPausedHostels(), listPlatformBookings(), transfersByBooking(), GET() (+91 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (76): metadata, RefundPolicy, AccountDeletionPanel, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections() (+68 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (77): resolveAttendanceAlert(), attendanceAlertResolveSchema, complaintCategorySchema, complaintCreateSchema, complaintListQuerySchema, complaintReplySchema, complaintResolutionConfirmSchema, complaintStatusSchema (+69 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (83): approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal, checker, eventId (+75 more)

### Community 41 - "Community 41"
Cohesion: 0.03
Nodes (81): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+73 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (76): CommunityScreen(), Composer(), CommunityPostScreen(), AnimatedBlurView, CommunityBoard(), CommunityBoardProps, Composer(), NotificationBell() (+68 more)

### Community 43 - "Community 43"
Cohesion: 0.03
Nodes (59): csvField(), field(), Hostel, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminProfilePageContent(), HostelAdminRoomsPageContent(), Inquiry (+51 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (81): deliver(), DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity(), fromHeaderFor() (+73 more)
...
Cohesion: 0.04
Nodes (62): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, ENDPOINTS, esewaProvider, SIGNED_FIELDS, attempt, fetchMock (+54 more)

### Community 47 - "Community 47"
Cohesion: 0.03
Nodes (78): BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsPeriodBounds(), bsPeriodOf(), bsPeriodsBetween(), currentBsPeriod() (+70 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (78): SORTS, StoreCategoryScreen(), addToCart(), cancelStoreOrder(), Cart, CartLine, CartResult, CartTotals (+70 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (60): AuthLayout(), metadata, daysUntil(), HostelSubscriptionDueBanner(), rupees(), State, isHostelPortal(), useHostelSuspension() (+52 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (67): GATEWAY_ORDER, getHostelPayMethods(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice() (+59 more)

### Community 51 - "Community 51"
Cohesion: 0.08
Nodes (67): BookingDocumentInput, renderBookingDocument(), bsFiscalYear(), bsMonthName(), formatBsDayMonth(), toBs(), amountInWords(), GROUPS (+59 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (64): addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange(), definedUpdate(), FoodFeedbackInput, FoodFeedbackRecord, FoodMenuCreateInput (+56 more)
...
Cohesion: 0.05
Nodes (51): asRecord(), DrawnPush, readDrawnPush(), message, pushData, configureNativeNightPrompt(), NativeNightPrompt, takeNativePendingAnswers() (+43 more)

### Community 55 - "Community 55"
Cohesion: 0.07
Nodes (43): POST(), POST(), getCurrentUser(), POST(), runPlanDueReminders(), sweepBookings(), POST(), POST() (+35 more)

### Community 56 - "Community 56"
Cohesion: 0.05
Nodes (62): collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor() (+54 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (55): POST(), GET(), POST(), DEFAULT_GUARDIAN_PERMISSIONS, guardianAccessCreateSchema, guardianInvitationAcceptSchema, guardianInviteSchema, guardianLoginSchema (+47 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (28): AuthShell(), AuthShellProps, PANEL_COPY, SiteWordmark(), AuthExperiencePage(), PublicHostelListingPage(), ComparePageSkeleton(), HostelDetailPageSkeleton() (+20 more)

### Community 59 - "Community 59"
Cohesion: 0.04
Nodes (62): buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, draftFromProfile(), emptyIdentityDraft(), firstIncompleteIdentityStep() (+54 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (60): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES (+52 more)
...
Cohesion: 0.06
Nodes (59): hashUserAgent(), HostelRef, newVisitorKey(), recordHostelPageView(), resolveVisitorKey(), personalLookupHash(), getPresignedReadUrl(), hostelPageViewSchema (+51 more)

### Community 63 - "Community 63"
Cohesion: 0.06
Nodes (60): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags(), documentFlags() (+52 more)
...
Cohesion: 0.06
Nodes (46): hostelPeriodOf(), existingResidentListSchema, existingResidentRowSchema, splitFullName(), buildExistingResidentsTemplate(), fieldTeam(), fieldTeamExistingResidents, hostelStaffExistingResidents (+38 more)
...
Cohesion: 0.05
Nodes (37): fill(), PricingScreen(), HostelRegistrationProgress(), Milestone, milestoneIndex(), MILESTONES, PaymentPanel(), PlanPicker() (+29 more)

### Community 69 - "Community 69"
Cohesion: 0.06
Nodes (52): hostelForm(), buildHostelPayload(), capacitySummary(), CITY_OPTIONS, emptyHostelForm(), emptyRoomRow(), FACILITY_OPTIONS, firstIncompleteHostelStep() (+44 more)

### Community 70 - "Community 70"
Cohesion: 0.05
Nodes (51): invalidateFeeds(), REALTIME_TOPIC_VALUES, CachedQuery, clearQueryCache(), defined, entries, Entry, inflight (+43 more)

### Community 71 - "Community 71"
Cohesion: 0.05
Nodes (43): OperationsConfig, PendingSettingChange, PlanDueReminderSchedule, PlanReminderStep, PlatformOperationsPanel, REMINDER_CHANNELS, checkAuthWithRefresh(), isStaleSession() (+35 more)
...
Cohesion: 0.08
Nodes (50): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt, allocateReceiptNumber() (+42 more)
...
Cohesion: 0.06
Nodes (43): SERVICE_PROVIDER_CATEGORIES, serviceProviderSchema, serviceProviderApplicationSchema, serviceProviderDocumentSchema, hostelId, mocks, providerId, notifyPlatformOfServiceProviderApplication() (+35 more)

### Community 76 - "Community 76"
Cohesion: 0.06
Nodes (44): DELETE(), POST(), createPlatformNotificationCampaign(), revokeDeviceToken(), saveDeviceToken(), campaignBaseSchema, deviceTokenRevokeSchema, deviceTokenSaveSchema (+36 more)
...
Cohesion: 0.08
Nodes (43): BOOKING_DOCUMENT_KINDS, BookingDocumentKind, bookingDocumentLayout(), refundPolicyNotes(), allowed(), bookingDocumentResponse(), BookingDocumentScope, resolveBookingDocument() (+35 more)

### Community 81 - "Community 81"
Cohesion: 0.07
Nodes (43): addBsMonths(), cellAt(), focusCell(), Props, BillPreview, CheckContext, CheckedRow, checkExistingResidents() (+35 more)

### Community 82 - "Community 82"
Cohesion: 0.06
Nodes (41): InvoiceDetailScreen(), InvoiceHeaderBlock(), ResidentClaim, ResidentInvoice, chargeDescriptions(), filterInvoices(), groupInvoicesByYear(), InvoiceRowCopy (+33 more)

### Community 83 - "Community 83"
Cohesion: 0.05
Nodes (32): BookButton(), SIZE, BookingAvailabilityView, BookingButton, CLOSED_REASONS, open, inferKind(), MediaLightbox() (+24 more)

### Community 84 - "Community 84"
Cohesion: 0.05
Nodes (39): GET(), POST(), GET(), listCookAccounts(), cookCreateSchema, cookInvitationAcceptSchema, cookNameSchema, cookPortalUpdateSchema (+31 more)
...
Cohesion: 0.06
Nodes (42): formatPeriodKey(), DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), monthLabel(), parseAmount() (+34 more)

### Community 89 - "Community 89"
Cohesion: 0.06
Nodes (42): findIndex(), index, indexesOf(), IndexSpec, promote, issueReceiptForEvent(), IssueReceiptInput, nextReceiptNumber() (+34 more)

### Community 90 - "Community 90"
Cohesion: 0.09
Nodes (21): PlatformConfigAnnouncementsPageContent, PlatformConfigFacilitiesPageContent, FLAGS, PlatformConfigFeaturesPageContent, PlatformConfigLegalPageContent, PlatformConfigLocationsPageContent, PlatformConfigPlanServicePageContent, PlatformConfigPricingPageContent (+13 more)

### Community 91 - "Community 91"
Cohesion: 0.09
Nodes (36): GET(), periodTotals(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS, neutralize(), csv (+28 more)
...
Cohesion: 0.09
Nodes (34): deleteHostelObjects(), FILE_ASSET_KINDS, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), isPlatformOnlyAssetKind(), PLATFORM_ONLY_KINDS, ImageVariantRecord (+26 more)
...
Cohesion: 0.09
Nodes (30): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, DEFAULT_DOCUMENT_MIME_TYPES (+22 more)
...
Cohesion: 0.09
Nodes (35): maneuverIcon(), NavCard(), NavigationFix, watchDeviceHeading(), watchNavigationPosition(), cardinalFor(), CARDINALS, chooseHeading() (+27 more)
...
Cohesion: 0.07
Nodes (34): confirmSettlementByStatement(), BANK, both, empty, ESEWA, [first], ids, KHALTI (+26 more)
...
Cohesion: 0.06
Nodes (31): nextPlanDueStep(), ALL, base, decide(), early, edited, hostelId, html (+23 more)
...
Cohesion: 0.08
Nodes (31): documents, many, parsed, result, HostelForm, buildProviderPayload(), EMPTY_PROVIDER_FORM, firstIncompleteProviderStep() (+23 more)

### Community 112 - "Community 112"
Cohesion: 0.08
Nodes (27): CommunityPageContent(), FeedPayload, NewPostAlertsToggle(), SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+19 more)
...
Cohesion: 0.06
Nodes (25): FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), computeCreditAmount(), checkAuditChain(), checkCreditBalances(), DRIFT_CODES, LedgerDriftSummary (+17 more)
...
Cohesion: 0.1
Nodes (21): CentrePin(), describeAddress(), HostelPinField(), HostelPinPicker(), KATHMANDU, MapLinkField(), PickerBody(), PinAddress (+13 more)
...
Cohesion: 0.16
Nodes (17): readReturnState(), ownerIdentitiesFor(), resolveOwnedHostel(), findOpenInvoice(), getSubscriptionState(), invoiceIdFor(), selectPlan(), registrationPlanChoiceSchema (+9 more)
...
Cohesion: 0.15
Nodes (18): DELETE(), PATCH(), RouteContext, GET(), POST(), assertWindow(), createSponsor(), deleteSponsor() (+10 more)
...
Cohesion: 0.15
Nodes (13): activateResident(), AuthSession, triggerSOS(), AppNavigator(), RootStackParamList, Stack, Props, ResidentActivationScreen() (+5 more)
...
Cohesion: 0.16
Nodes (14): applyBookingConfig(), BookingCancelStep, bookingCancelStepSchema, BookingConfig, DEFAULT_BOOKING_CONFIG, DEFAULT_CANCEL_STEPS, percent, bookingGuideSections() (+6 more)
...
Cohesion: 0.21
Nodes (15): isSettingChangeKey(), ChangeRecord, CLOSED_MESSAGES, confirmSettingChange(), definitionFor(), hashToken(), loadByToken(), maskEmail() (+7 more)
...
Cohesion: 0.14
Nodes (7): bookingConfigSchema, bookings, CollectionQr, SETTING_CHANGES, SettingChangeDefinition, SettingChangeKey, ComparisonRow
...
Cohesion: 0.16
Nodes (14): 2.3 Hostel Rejected, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.3 Payment Proof Uploaded (to Admin), 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails (+6 more)
...
Cohesion: 0.18
Nodes (10): register(), submitResidentReview(), verifyOtp(), LoginScreen(), Props, OtpVerificationScreen(), Props, Props (+2 more)
...
Cohesion: 0.33
Nodes (10): fillPolicyText(), hoursText(), PolicySection, PolicyTerms, policyValues(), refundPolicyIntro(), refundPolicySections(), getRefundPolicy() (+2 more)
...
Cohesion: 0.18
Nodes (12): apiRequest(), getActivationStatus(), listNotifications(), login(), markNotificationRead(), NotificationItem, refreshSession(), requestOtp() (+4 more)
...
Cohesion: 0.18
Nodes (11): 4.1 New Notice Posted, 4.2 Complaint Status Updated, 4.3 Complaint Resolved, 4. Resident Activity Emails, 5.1 SOS Triggered, 5. Safety & Emergency Emails, code:typescript ({), code:typescript ({) (+3 more)
...
Cohesion: 0.22
Nodes (7): at, bs(), dirname, dueAt, invoiceSet, settings, subscriptionSet

### Community 367 - "Community 367"
Cohesion: 0.36
Nodes (5): bookingGuideIntro(), BookingGuide, getBookingGuide(), PublicBookingGuidePage(), generateMetadata()
...
Cohesion: 0.25
Nodes (9): 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, code:typescript ({), code:typescript ({), code:typescript ({), code:block14 (---) (+1 more)
...
- **Why does `cn()` connect `Community 20` to `Community 1`, `Community 5`, `Community 10`, `Community 13`, `Community 142`, `Community 15`, `Community 19`, `Community 25`, `Community 28`, `Community 30`, `Community 33`, `Community 35`, `Community 38`, `Community 43`, `Community 45`, `Community 49`, `Community 58`, `Community 61`, `Community 68`, `Community 79`, `Community 81`, `Community 83`, `Community 86`, `Community 87`, `Community 90`, `Community 238`, `Community 112`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 1` to `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 16`, `Community 20`, `Community 21`, `Community 152`, `Community 27`, `Community 28`, `Community 31`, `Community 35`, `Community 38`, `Community 42`, `Community 173`, `Community 61`, `Community 69`, `Community 126`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `Role` connect `Community 29` to `Community 0`, `Community 2`, `Community 3`, `Community 260`, `Community 5`, `Community 132`, `Community 262`, `Community 7`, `Community 9`, `Community 136`, `Community 12`, `Community 13`, `Community 396`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 23`, `Community 24`, `Community 26`, `Community 419`, `Community 420`, `Community 422`, `Community 39`, `Community 423`, `Community 41`, `Community 40`, `Community 300`, `Community 44`, `Community 47`, `Community 49`, `Community 177`, `Community 52`, `Community 57`, `Community 316`, `Community 318`, `Community 67`, `Community 72`, `Community 73`, `Community 74`, `Community 77`, `Community 80`, `Community 84`, `Community 212`, `Community 220`, `Community 221`, `Community 97`, `Community 226`, `Community 232`, `Community 233`, `Community 368`, `Community 245`, `Community 120`?**
