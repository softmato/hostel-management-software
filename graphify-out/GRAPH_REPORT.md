...
## Corpus Check
- 711 files · ~1,588,242 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5628 nodes · 13681 edges · 288 communities (269 shown, 19 thin omitted)
...
1. `handleRouteError()` - 303 edges
2. `successResponse()` - 302 edges
3. `cn()` - 187 edges
4. `connectToDatabase()` - 181 edges
5. `connectToDatabase()` - 171 edges
6. `requireHostelStaffPrincipal()` - 103 edges
7. `requireHostelCapability()` - 100 edges
8. `browserApi()` - 83 edges
...
Cohesion: 0.04
Nodes (128): POST(), appBaseUrl(), authenticateWithGoogle(), AuthServiceError, changePassword(), dispatchOtpChallenge(), dispatchVerificationEmail(), findVerifiedRegistrationChallenge() (+120 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (85): HostelTable(), LoadState, UserRecord, GuardianDashboard, Payment, TABS, ComplaintsResponse, PlatformComplaint (+77 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (118): addHostelAdminProfilePhoto(), deleteHostelAdminProfilePhoto(), getHostelAdminProfile(), HostelAdminProfileQuery, HostelAdminProfileUpdateInput, HostelChangeRequestInput, HostelPhotoCreateInput, HostelPhotoDeleteQuery (+110 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (67): GET(), GET(), POST(), POST(), PATCH(), RouteContext, GET(), POST() (+59 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (70): PATCH(), POST(), RouteContext, POST(), POST(), POST(), RouteContext, GET() (+62 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (55): ApiPrincipal, assertHostelAccess(), canAccessHostel(), hostelScopedFilter(), TenantAccessError, TenantPrincipal, deviceTokenSchema, emergencyContactSchema (+47 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (63): PagerButton(), PublicHostelListingPage(), InquiryPage(), cn(), Alert(), AlertAction(), AlertDescription(), AlertTitle() (+55 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (65): EMPTY_SUMMARY, HostelAdminComplaintsPage, HostelAdminDashboardPageContent, HostelAdminFeePlansPageContent, HostelAdminInquiriesPageContent, HostelAdminMaintenancePageContent, HostelAdminMoveChecklistPage, HostelAdminNightStatusPage (+57 more)
...
Cohesion: 0.07
Nodes (48): GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, formatHostelAddress(), hasFood(), hostelTypeToUi() (+40 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (52): ComparePage(), hostels, metadata, rows, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminRoomsPageContent(), PlatformDashboardPageContent() (+44 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (53): BusyContext, BusyFormProps, csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, Inquiry (+45 more)

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (63): demoteToPublicAccount(), CapacityError, claimBedForRoomType(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary(), releaseBedForRoomType() (+55 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (72): addComplaintUpdate(), auditComplaintAction(), confirmComplaintResolution(), createComplaint(), findAdminComplaint(), listResidentComplaints(), replyToComplaint(), serializeComplaint() (+64 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (52): inquiryId, serviceMocks, staffPrincipal, BedCreateInput, BedRecord, BedUpdateInput, createHostelAdminBed(), createHostelAdminFloor() (+44 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (45): PATCH(), RouteContext, listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), PATCH(), RouteContext (+37 more)
...
Cohesion: 0.04
Nodes (40): GET(), hostelRejectSchema, hostelRequestDocumentsSchema, hostelResubmitDocumentsSchema, hostelTypeSchema, hostelUnpublishSchema, inquiryStatusSchema, objectIdSchema (+32 more)

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (57): paymentSchema, receiptSchema, alreadyReviewedError(), approvePaymentProof(), assertProofIsPending(), auditPaymentAction(), computeMonthlyDue(), createPaymentRecord() (+49 more)

### Community 19 - "Community 19"
Cohesion: 0.06
Nodes (55): extractJsonPayload(), parseModelJson(), sanitizeJsonPayload(), VALID_JSON_ESCAPES, buildMessages(), CHAT_ENDPOINTS, ChatCompletionResponse, ChatMessage (+47 more)

### Community 20 - "Community 20"
Cohesion: 0.09
Nodes (38): BusyForm(), SubmitButton(), field(), LoadState, Message(), NightStatusRow, Notification, optionalNumber() (+30 more)

### Community 21 - "Community 21"
Cohesion: 0.06
Nodes (40): normalize(), PortalSearch(), PortalTone, scoreEntry(), toneStyles, iconMap, IconName, NavItem (+32 more)

### Community 22 - "Community 22"
Cohesion: 0.1
Nodes (41): PRIORITIES, STATUS_ACTIONS, AdminReferral, FILTERS, ReferralsResponse, Overview, Report, field() (+33 more)
...
Cohesion: 0.05
Nodes (35): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, fromAddress(), sendEmail(), SendEmailInput, SendEmailResult (+27 more)

### Community 26 - "Community 26"
Cohesion: 0.06
Nodes (23): HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminNoticesPage(), HostelAdminResidentsPage(), redirectToWorkspaceScreen(), HostelAdminMaintenancePageContent(), HostelAdminReferralsPageContent() (+15 more)

### Community 27 - "Community 27"
Cohesion: 0.06
Nodes (33): LegalBody(), CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS, CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS (+25 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (37): dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, mealsOn(), ROUTINE_DAYS, ROUTINE_MEAL_TYPES (+29 more)
...
Cohesion: 0.07
Nodes (36): SiteAnnouncementBanner(), toneClasses, FALLBACK, SiteConfigContext, SiteConfigProvider(), useFeatureFlag(), platformSettingSchema, DEFAULT_SITE_CONFIG (+28 more)
...
Cohesion: 0.08
Nodes (31): announceFoodReady(), cookEmailForSlug(), CookPortalUpdateInput, CookServiceError, FoodReadyInput, generatePassword(), getCookPortalSettings(), HostelSettingsRecord (+23 more)
...
Cohesion: 0.14
Nodes (25): EmptyInline(), SectionCard(), quickActionTones, DAY_ORDER, MEAL_META, MEAL_ORDER, Profile, Complaint (+17 more)

### Community 37 - "Community 37"
Cohesion: 0.1
Nodes (35): getHostelViewStats(), paymentProofSchema, averageResolutionDays(), bucketBoundaries(), collectionRate(), countByField(), CountingModel, countVacantBeds() (+27 more)

### Community 38 - "Community 38"
Cohesion: 0.07
Nodes (30): attachFiles(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput, ComplaintListQuery, ComplaintRecord, ComplaintReplyInput (+22 more)

### Community 39 - "Community 39"
Cohesion: 0.07
Nodes (25): POST(), RouteContext, guardianAccessCreateSchema, guardianLoginSchema, objectIdSchema, GET(), POST(), PATCH() (+17 more)
...
Cohesion: 0.1
Nodes (33): activateResident(), ApiFailure, apiRequest(), ApiSuccess, AuthUser, confirmComplaintResolution(), createResidentComplaint(), getActivationStatus() (+25 more)

### Community 42 - "Community 42"
Cohesion: 0.08
Nodes (29): serviceProviderApplicationSchema, serviceProviderDocumentSchema, approveServiceProvider(), auditProviderAction(), findProviderOrThrow(), getApprovedServiceProviderForHostel(), hideServiceProvider(), HostelAdminServiceProviderListQuery (+21 more)
...
Cohesion: 0.1
Nodes (24): AuthSession, requestOtp(), signInWithGoogle(), submitResidentReview(), AppNavigator(), RootStackParamList, Stack, LoginScreen() (+16 more)

### Community 45 - "Community 45"
Cohesion: 0.12
Nodes (24): ImageVariantRecord, optimizeImage(), streamToBuffer(), VARIANT_CONFIG, VariantName, deleteFromR2(), generateFileKey(), getPresignedReadUrl() (+16 more)
...
Cohesion: 0.11
Nodes (27): auditWardenAction(), createHostelWarden(), deactivateHostelWarden(), findScopedWarden(), HostelMemberRecord, hydrateUser(), listHostelWardens(), MemberStatus (+19 more)

### Community 48 - "Community 48"
Cohesion: 0.07
Nodes (16): authMocks, request, Role, ROLE_VALUES, mocks, hostelMemberSchema, rolePermissionSchema, mocks (+8 more)
...
Cohesion: 0.1
Nodes (21): depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, providedItemSchema, auditMoveAction(), createMoveOutChecklist(), findAdminResident(), getMoveOutChecklist() (+13 more)
...
Cohesion: 0.14
Nodes (27): deliverNoticeBroadcast(), createInAppNotification(), daysBetween(), OPEN_STATUSES, PaymentRecord, PaymentReminderRun, ResidentRecord, runPaymentReminders() (+19 more)
...
Cohesion: 0.08
Nodes (18): EmptyState(), Panel(), StatusBadge(), field(), ListingFlag, LoadState, MaintenanceRequest, optionalField() (+10 more)
...
Cohesion: 0.13
Nodes (22): decryptPersonalData(), userResidentProfileSchema, ageFromDateOfBirth(), generateResidentId(), getResidentIdentity(), getResidentIdentityQr(), lookupResidentProfile(), mintResidentId() (+14 more)
...
Cohesion: 0.11
Nodes (10): AuthShell(), AuthShellProps, AuthExperiencePage(), metadata, AuthResponse, OtpRequestData, RegisterData, SignupForm() (+2 more)
...
Cohesion: 0.11
Nodes (13): roomTypeLabel(), NEARBY_GROUPS, RoomCard, ROUTINE_DAYS, ROUTINE_MEALS, NearbyPlaceType, Sheet(), SheetContent() (+5 more)
...
Cohesion: 0.13
Nodes (14): auditLogSchema, ratingReviewSchema, reviewModerationLogSchema, auditReviewAction(), createResidentReview(), hideReview(), moderateReview(), PlatformReviewListQuery (+6 more)
...
Cohesion: 0.18
Nodes (16): AuditLog, code:typescript (interface IPlatformSetting {), code:typescript (interface IAuditLog {), code:typescript (interface INotification {), code:typescript (interface INotificationReceipt {), code:typescript (interface IFoodReadyLog {), code:typescript (interface IAttendanceLog {), FoodReadyLog (+8 more)
...
Cohesion: 0.21
Nodes (12): FileUploadArea(), acceptAttribute(), EXTENSION_BY_MIME, formatBytes(), joinTypes(), KIND_RULES, KindRule, labelsFor() (+4 more)
...
Cohesion: 0.2
Nodes (12): ServiceProviderRegistrationPageContent(), FileUploader(), FileUploaderPresentation, FileUploaderProps, FileUploaderView(), TONE_CLASSES, UploaderTone, UploadOptions (+4 more)
...
Cohesion: 0.18
Nodes (14): AccountDeletionRequest, code:typescript (interface IQuestionCallClick {), code:typescript (interface IHostelSettings {), code:typescript (interface IConsentLog {), code:typescript (interface IAccountDeletionRequest {), code:typescript (interface IAccountDeletionRequest {), Consent & Privacy, ConsentLog (+6 more)
...
Cohesion: 0.19
Nodes (8): chelseaMarket, geistMono, geistSans, metadata, poppins, QueryProvider(), SmoothScrollProvider(), ThemeProvider()
...
Cohesion: 0.18
Nodes (13): [0.4.0] - 2026-07-22 — Phase 2: Public discovery + hostel core (gap completion), [0.5.2] - 2026-07-23 — Cook credential hand-off + dashboard visibility, [0.6.0] - 2026-08-01 — Phases 1-3 closed out, Added, Added, Added, Changed, Changed (+5 more)
...
Cohesion: 0.24
Nodes (10): decodeKey(), encryptionKey(), encryptPersonalData(), isPersonalDataEncryptionConfigured(), resetPersonalDataKeyCache(), envelope, flipped, profile (+2 more)
...
Cohesion: 0.17
Nodes (10): [0.5.1] - 2026-07-23 — Cook credentials at approval + shared-credential hardening, Added, Added, Changed, Changed, code:markdown (## [Phase X] - YYYY-MM-DD), Known gap, Planned (+2 more)
...
Cohesion: 0.17
Nodes (6): PublicHostelListingPage(), emptyFilters, Filters, metadata, PublicHostel, PublicHostelsData
...
Cohesion: 0.18
Nodes (10): Build status (end of Phase 3), code:typescript (export enum Role {), code:block44 (packages/db/migrations/), code:block46 (packages/db/migrations/), Conventions, Cook Portal, DATABASE.md — Schema & Relationships, Enums (+2 more)

### Community 135 - "Community 135"
Cohesion: 0.29
Nodes (11): AttendanceAlert, AttendanceLog, code:typescript (interface IAttendanceAlert {), code:typescript (interface ICommunityPost {), code:typescript (interface ICommunityComment {), code:typescript (interface ICommunityReaction {), Community Feature, CommunityComment (+3 more)
...
Cohesion: 0.36
Nodes (10): code:typescript (interface IHostelPageView {), code:typescript (interface IReferral {), code:typescript (interface INotification {), code:typescript (interface ISubscription {), HostelPageView, Inquiries, Referral, Notifications, Subscriptions, Inquiry, Notification (+2 more)
...
Cohesion: 0.28
Nodes (9): code:typescript (interface IQRActivation {), code:typescript (interface IPayment {), code:typescript (interface IPaymentProof {), code:typescript (interface IReceipt {), Payment, PaymentProof, Payments, QR Activation (+1 more)
...
Cohesion: 0.36
Nodes (7): DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList(), PLATFORM_ACCEPTED_MIME_TYPES, positiveInteger(), validateFileAssetMetadata()
...
Cohesion: 0.36
Nodes (6): inferKind(), LightboxItem, MediaLightbox(), MediaViewerContext, MediaViewerContextValue, MediaViewerProvider()
...
Cohesion: 0.4
Nodes (4): attacker, attempt(), jsonRequest(), routeMocks
...
## Knowledge Gaps
- **2018 isolated node(s):** `AuthUser`, `ResidentSummary`, `ResidentFoodRoutine`, `ApiSuccess`, `ApiFailure` (+2013 more)
...
- **Why does `Role` connect `Community 48` to `Community 0`, `Community 1`, `Community 130`, `Community 3`, `Community 2`, `Community 5`, `Community 12`, `Community 14`, `Community 15`, `Community 144`, `Community 24`, `Community 152`, `Community 25`, `Community 27`, `Community 28`, `Community 30`, `Community 33`, `Community 39`, `Community 169`, `Community 170`, `Community 47`, `Community 55`, `Community 186`, `Community 187`, `Community 68`, `Community 69`, `Community 79`, `Community 207`, `Community 122`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 13` to `Community 0`, `Community 2`, `Community 3`, `Community 5`, `Community 8`, `Community 12`, `Community 14`, `Community 18`, `Community 25`, `Community 28`, `Community 30`, `Community 31`, `Community 33`, `Community 37`, `Community 38`, `Community 42`, `Community 47`, `Community 49`, `Community 50`, `Community 53`, `Community 55`, `Community 58`, `Community 63`, `Community 70`, `Community 71`, `Community 81`, `Community 91`, `Community 96`, `Community 118`, `Community 124`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 6` to `Community 128`, `Community 1`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 16`, `Community 20`, `Community 21`, `Community 23`, `Community 24`, `Community 27`, `Community 31`, `Community 34`, `Community 36`, `Community 172`, `Community 56`, `Community 59`, `Community 62`, `Community 78`, `Community 80`, `Community 95`, `Community 99`, `Community 107`?**
