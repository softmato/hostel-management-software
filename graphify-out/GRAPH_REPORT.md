# Graph Report - hostel-management-software  (2026-08-26)

## Corpus Check
- 1585 files · ~2,576,661 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12521 nodes · 33970 edges · 472 communities (450 shown, 22 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 515 edges (avg confidence: 0.8)
...
4. `useAppTheme()` - 282 edges
5. `cn()` - 239 edges
6. `connectToDatabase()` - 223 edges
7. `useResource()` - 172 edges
8. `unwrap()` - 171 edges
...
## Communities (472 total, 22 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (216): POST(), GET(), GET(), listPublicFoodRoutine(), addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery (+208 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (189): AdminMoreScreen(), ActivateScreen(), GuardianInviteScreen(), MapScreen(), PreviewCard(), ResultRow(), ApplyBlock(), Assurance() (+181 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (157): PATCH(), POST(), RouteContext, POST(), POST(), POST(), resolveAttendanceAlert(), GET() (+149 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (115): ICONS, LABELS, Segment, TONES, Overview, MANAGE_ROWS, PORTAL_ROWS, Person (+107 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (130): GET(), POST(), GET(), POST(), POST(), AuthServiceError, getCurrentUser(), verifyEmailWithToken() (+122 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (164): GET(), getResidentAttendance(), verifyOtpChallenge(), listCommunityForModeration(), confirmComplaintResolution(), createComplaint(), listResidentComplaints(), summarizeResidentComplaints() (+156 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (183): ProfileScreen(), CheckoutStatusScreen(), CookPhotosScreen(), isProvider(), ManageGatewayScreen(), ActivationIssue, addEmergencyContact(), addHostelPhoto() (+175 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (142): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), loadOverview(), AdminMoneyScreen(), loadMoney(), MoneyData, AdminTodayScreen() (+134 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (142): Scanner(), BootGate(), NotificationSettings(), GuardianLoginScreen(), BrandSplash(), AuthDivider(), GoogleSignInButton(), APP_NAME_PARTS (+134 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (106): Filter, ModeratedPost, ModerationPayload, GuardianDashboard, GuardianSafetyPageContent, Ledger, OrphanAssignPicker, MatrixRow (+98 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (107): HostelAdminCommunityPageContent, FeeSchedule, HostelAdminFeeSchedulePageContent, Rate, HostelAdminInquiriesPageContent, HostelAdminMaintenancePageContent, PRIORITIES, STATUS_ACTIONS (+99 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (93): DeletionPathway, DeletionStatus, PATHWAY_COPY, csvField(), deferLoad(), DemoDataBadge(), field(), Hostel (+85 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (117): GET(), POST(), POST(), RouteContext, DELETE(), GET(), hostelId(), GET() (+109 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (117): CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), InvoiceDetailScreen(), LedgerCard(), SummaryCard(), AmountCard() (+109 more)
...
Cohesion: 0.03
Nodes (99): AuthShell(), AuthShellProps, SiteWordmark(), metadata, AccountDeletionPanel, ContentHeader(), ContentIntro(), ContentNote() (+91 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (83): AuthExperiencePage(), GenericPortalScreen(), portalRows(), portalTitle(), CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS (+75 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (100): checkoutSchema, POST(), GET(), POST(), querySchema, RouteContext, AnnouncementInput, CommentCreateInput (+92 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (100): AdminCommunityScreen(), AdminCommunityReportsScreen(), FILTERS, Pending, AdminResidentsScreen(), NightStatusScreen(), ReferralsScreen(), SORTS (+92 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (77): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel(), CommunityPageContent(), ConfirmOptions, useConfirm() (+69 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (90): NightStatusForm(), DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS, MealCard(), MonthEndSpecial(), RoutineMeal (+82 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (82): HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend(), HostelHero() (+74 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (82): CommunityReportDialog(), REASONS, ModerationButton(), PagerButton(), normalize(), PortalSearch(), PortalTone, scoreEntry() (+74 more)
...
Cohesion: 0.1
Nodes (56): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), EmailCategory, guardianInvitationEmail() (+48 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (76): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, GATEWAY_ORDER, getPayInstructions() (+68 more)

### Community 26 - "Community 26"
Cohesion: 0.06
Nodes (67): CommunityScreen(), Composer(), CommunityBoard(), CommunityBoardProps, Composer(), SORTS, CommentThread(), CommunityPostCard() (+59 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (69): BAND_WIDTH, DiscoveryHeaderProps, IconButton(), MapButton(), IdCardFace(), initialsOf(), Portrait(), IdCardPrompt() (+61 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (63): Notification, MonthPicker, PeriodRow, humanizeValue(), ImportedProfileSummary(), ResidentPrefill, ResidentStatus, STATUS_ACTIONS (+55 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (70): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply() (+62 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (62): POST(), acceptGuardianInvitation(), daysFromNow(), enabledPermissionLabels(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags (+54 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (60): GET(), resolvePastedLink(), searchCandidates(), geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), hostelAdminGeocodeQuerySchema (+52 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (53): PATCH(), RouteContext, listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), PATCH(), RouteContext (+45 more)
...
Cohesion: 0.03
Nodes (47): metadata, FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES, avatarTone() (+39 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (49): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, CachedConnection, globalForMongoose, PaginationMeta, PaginationQuery (+41 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (48): ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, attempt, fetchMock, forged, live (+40 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (51): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), DocumentScreen(), MobileLegal (+43 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (54): AuthGuard(), CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing (+46 more)
...
Cohesion: 0.05
Nodes (40): AdminTabs(), HIDDEN, TABS, SosScreen(), TABS, AdminAlertsProvider(), AdminSearchBar(), useBottomChrome() (+32 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (59): BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan, BillingSkip (+51 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (55): cookPrincipal, mocks, cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError, FoodPhotoUploadInput, FoodReadyInput (+47 more)
...
Cohesion: 0.05
Nodes (42): HostelSuggestions(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, PublicHostel, PublicHostelListingPageContent(), EMPTY_PREFILL (+34 more)
...
Cohesion: 0.06
Nodes (47): AttachmentGallery(), ComplaintDetail(), ComplaintDetailScreen(), ComplaintCard(), ComplaintsScreen(), needsResident(), OPEN_STATUSES, rank() (+39 more)

### Community 49 - "Community 49"
Cohesion: 0.07
Nodes (45): POST(), HostelRef, notifyHostelOfInquiry(), notifyPlatformOfPendingHostel(), PLATFORM_ROLES, deviceTokenSchema, notificationSchema, input (+37 more)
...
Cohesion: 0.04
Nodes (33): adminPrincipal, mocks, PLATFORM_LIMITS, mocks, readable, selectable, profileMocks, staffPrincipal (+25 more)
...
Cohesion: 0.04
Nodes (36): fadeUp, Feature, featureChrome, features, heroSlides, PublicHostelRegistrationLandingPage(), stagger, stats (+28 more)

### Community 55 - "Community 55"
Cohesion: 0.07
Nodes (46): collectionTotals(), monthlySeries(), platformRollup(), getHostelViewStats(), hashUserAgent(), HostelRef, newVisitorKey(), resolveVisitorKey() (+38 more)

### Community 56 - "Community 56"
Cohesion: 0.06
Nodes (26): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminComplaintsPage(), HostelAdminPaymentsPage(), redirectToWorkspaceScreen() (+18 more)
...
Cohesion: 0.07
Nodes (43): Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity(), fromHeaderFor() (+35 more)
...
Cohesion: 0.06
Nodes (40): classifyCredit(), CreditClassification, LadderClaim, LadderInvoice, MatchContext, normalizeTxnId(), ANITA_CODE, claims (+32 more)
...
Cohesion: 0.08
Nodes (44): demoteToPublicAccount(), emergencyContactSchema, assertActiveReferralCode(), findActiveReferralCode(), linkReferralOnRegistration(), raiseAdmissionInvoice(), addEmergencyContact(), addGuardian() (+36 more)
...
Cohesion: 0.07
Nodes (32): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, HostelPhotoReminder(), PortalShell(), navItems, navItems, canAccessWorkspace(), workspaceHostelName() (+24 more)
...
Cohesion: 0.06
Nodes (29): useMediaViewer(), APP_METHODS, EvidencePreview(), METHODS, PayInstructions, Rejection, rejectionFrom(), ResidentClaimForm (+21 more)

### Community 71 - "Community 71"
Cohesion: 0.07
Nodes (36): notificationCampaignSchema, CampaignListQuery, CampaignRecord, createCampaign(), createHostelNotificationCampaign(), createPlatformNotificationCampaign(), dispatchCampaign(), dispatchDueCampaigns() (+28 more)

### Community 72 - "Community 72"
Cohesion: 0.07
Nodes (32): isAuthBypassEnabled(), original, dashboardHrefForRole(), destinationForRole(), isAllowedNextPath(), isHostelWorkspacePath(), isSafeLocalPath(), landingPathForRole() (+24 more)

### Community 73 - "Community 73"
Cohesion: 0.08
Nodes (36): POST(), saveFoodRoutine(), addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange(), definedUpdate(), FoodFeedbackInput (+28 more)
...
Cohesion: 0.07
Nodes (31): RouteContext, referralSchema, referralCodeSchema, referralRewardSchema, auditReferralAction(), confirmReferralJoined(), HostelAdminReferralListQuery, normalizeObjectIds() (+23 more)
...
Cohesion: 0.07
Nodes (32): approveClaim(), assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck(), evidenceCheck(), findClaim() (+24 more)

### Community 79 - "Community 79"
Cohesion: 0.09
Nodes (33): appBaseUrl(), changePassword(), CLAIMABLE_STATUSES, dispatchOtpChallenge(), dispatchVerificationEmail(), findVerifiedRegistrationChallenge(), generateOtpCode(), GOOGLE_JWKS (+25 more)

### Community 80 - "Community 80"
Cohesion: 0.09
Nodes (30): DEPRECATED_ALIASES, mocks, GET(), POST(), auditWardenAction(), createHostelWarden(), deactivateHostelWarden(), findScopedWarden() (+22 more)
...
Cohesion: 0.08
Nodes (32): FILTERS, NotificationCard(), NotificationsScreen(), ReferralRow(), AlertCard(), ProviderJobScreen(), formatRelativeDay(), AppNotification (+24 more)

### Community 83 - "Community 83"
Cohesion: 0.08
Nodes (24): CancelDeletionPageContent(), NEXT_STATUSES, OrdersPayload, OrderStatus, PlatformStoreOrdersPageContent, STATUS_TONE, StoreOrder, ViewAllLink() (+16 more)

### Community 84 - "Community 84"
Cohesion: 0.08
Nodes (35): alreadyReviewedError(), approvePaymentProof(), assertProofIsPending(), computeMonthlyDue(), creditVerifiedAmount(), currentMonth(), definedUpdate(), findAdminPayment() (+27 more)
...
Cohesion: 0.07
Nodes (30): registerEmailIdentity(), PRODUCTION_RECOMMENDED, PRODUCTION_REQUIRED, ServerEnv, serverEnvSchema, serverEnvWarnings(), PRODUCTION_MINIMUM, pusher (+22 more)
...
Cohesion: 0.07
Nodes (27): EMPTY_SUMMARY, HostelAdminComplaintsPage, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine (+19 more)

### Community 89 - "Community 89"
Cohesion: 0.07
Nodes (21): Input(), LoadingRows(), field(), HostelAdminReferralsPageContent(), HostelAdminServiceProvidersPageContent(), ListingFlag, LoadState, MaintenanceRequest (+13 more)

### Community 90 - "Community 90"
Cohesion: 0.13
Nodes (31): CARD_NOUNS, CardVariant, drawBack(), drawBrandLockup(), drawFooterSweep(), drawFront(), drawHeaderSweep(), drawIdCard() (+23 more)

### Community 91 - "Community 91"
Cohesion: 0.11
Nodes (27): POST(), RouteContext, computePerceptualHash(), systemDocumentKind(), cookieAccessToken(), isRole(), loadApiPrincipal(), authMocks (+19 more)
...
Cohesion: 0.09
Nodes (27): downloadCaption(), DownloadRow, progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster(), UploadRow (+19 more)
...
Cohesion: 0.07
Nodes (27): GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse, GoogleAuthUser, GoogleCredentialResponse, Window, DEMO_ACCOUNTS, DemoRole (+19 more)
...
Cohesion: 0.22
Nodes (18): POST(), POST(), POST(), loginGuardian(), accessTokenTtlSeconds(), getBearerToken(), parseDurationSeconds(), refreshTokenTtlSeconds() (+10 more)

### Community 99 - "Community 99"
Cohesion: 0.09
Nodes (24): qrActivationSchema, residentSchema, ActivationCodeGenerateInput, ActivationCodeInput, ActivationServiceError, ActivationStatus, ActivationStatusQuery, activationUrl() (+16 more)

### Community 100 - "Community 100"
Cohesion: 0.11
Nodes (28): hostelPageViewSchema, LEGACY_ROLE_MAP, Role, ROLE_VALUES, readQrBytes(), ageFromDateOfBirth(), cardPhotoImageUrl(), generateResidentId() (+20 more)
...
Cohesion: 0.08
Nodes (20): Complaint, ComplaintSummary, field(), FoodMenu, HostelAdminFoodPage(), HostelAdminNoticesPage(), HostelAdminResidentsPage(), LoadState (+12 more)
...
Cohesion: 0.11
Nodes (21): noticeSchema, noticeReadStatusSchema, auditNoticeAction(), broadcastNotice(), createNotice(), definedUpdate(), normalizeObjectIds(), NoticeCreateInput (+13 more)

### Community 111 - "Community 111"
Cohesion: 0.12
Nodes (20): periodOf(), getHostelLedger(), getInvoiceMatrix(), getResidentFinanceView(), listResidentInvoices(), issueReceiptForEvent(), IssueReceiptInput, nextReceiptNumber() (+12 more)
...
Cohesion: 0.11
Nodes (23): ApiFailure, ApiSuccess, AuthUser, confirmComplaintResolution(), createResidentComplaint(), getResidentReferral(), listResidentComplaints(), listResidentFood() (+15 more)

### Community 117 - "Community 117"
Cohesion: 0.14
Nodes (21): GuardianHomeScreen(), GuardianMetrics(), GuardianMoreScreen(), GuardianPaymentsScreen(), GuardianSafetyScreen(), GuardianPayment, GuardianPermissions, canSee() (+13 more)
...
Cohesion: 0.12
Nodes (19): native, NativeDownloads, openDownloaded(), SavedDownload, KNOWN_PATHS, resolvePushPath(), REWRITES, createAndroidChannels() (+11 more)
...
Cohesion: 0.12
Nodes (20): ALLOWED_FAMILIES, ascii(), contentTypeMismatch(), Family, looksTextual(), sniffFamily(), startsWith(), CSV (+12 more)
...
Cohesion: 0.09
Nodes (21): HostelLedger, HostelLedgerEntry, InvoiceMatrix, InvoiceMatrixRow, PortalInvoice, ResidentFinanceView, ResidentInvoiceLine, ResidentInvoiceReceipt (+13 more)
...
Cohesion: 0.15
Nodes (19): ApiFailure, EXTENSION_MIME, PickedFile, resolveFileName(), resolveMimeType(), name, parseEnvelope(), PickedAsset (+11 more)

### Community 143 - "Community 143"
Cohesion: 0.12
Nodes (20): UploadCard(), dismissUpload(), listeners, pruneUploads(), resetUploadQueue(), rows, sweepUploads(), afterSuccessLinger (+12 more)

### Community 144 - "Community 144"
Cohesion: 0.12
Nodes (20): Offset, PhotoCropper(), UploadStack(), useUploadStore, acceptAttribute(), UploadKind, AttachedFile(), FileUploader() (+12 more)
...
Cohesion: 0.16
Nodes (21): issueSessionForUser(), login(), publicUser(), refreshAccessToken(), AuthTokenPayload, hashToken(), jwtSecret(), PurposeTokenPayload (+13 more)
...
Cohesion: 0.12
Nodes (18): buildHtml(), boundsCenter(), haversineMeters(), hostelCoordinates(), HostelWithDistance, isUsableCoordinate(), KATHMANDU, distance (+10 more)
...
Cohesion: 0.16
Nodes (14): robots(), sitemap(), STATIC_ROUTES, listPublishedHostelSlugs(), r2Configured(), storePublicAsset(), AccessLevel, deleteFromR2() (+6 more)
...
Cohesion: 0.2
Nodes (18): bootstrapSession(), assertMatchesExtension(), downloadAndShare(), downloadAndShareCsv(), downloadAndShareImage(), downloadToDevice(), forgetDownloadFolder(), LegacyFileSystem (+10 more)

### Community 175 - "Community 175"
Cohesion: 0.12
Nodes (16): GoogleAuthInput, googleAuthSchema, LoginInput, loginSchema, otpChannelSchema, otpPurposeSchema, OtpRequestInput, otpRequestSchema (+8 more)

### Community 176 - "Community 176"
Cohesion: 0.11
Nodes (15): defaultDueDate(), DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), monthLabel(), toNumber() (+7 more)
...
Cohesion: 0.13
Nodes (14): eventId, hostelId, invoiceId, mocks, principal, receiptId, residentId, FROZEN_RECEIPT_FIELDS (+6 more)
...
Cohesion: 0.16
Nodes (13): requestOtp(), signInWithGoogle(), submitResidentReview(), triggerSOS(), RootStackParamList, Props, Props, ResidentReviewsScreen() (+5 more)

### Community 186 - "Community 186"
Cohesion: 0.13
Nodes (13): AuthSession, getResidentProfile(), listResidentNotices(), markNoticeAsRead(), ResidentNotice, AppNavigator(), Stack, LoginScreen() (+5 more)
...
Cohesion: 0.15
Nodes (13): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), MediaViewerProvider() (+5 more)
...
Cohesion: 0.14
Nodes (15): apiRequest(), getActivationStatus(), getResidentNightStatus(), listNotifications(), login(), markNotificationRead(), NotificationItem, refreshSession() (+7 more)
...
Cohesion: 0.21
Nodes (12): RootShell(), AssetViewer(), useViewerState(), BottomChrome, BottomChromeContext, BottomChromeProvider(), CHROME_TIMING, UploadToaster() (+4 more)
...
Cohesion: 0.16
Nodes (14): 7.1 Attendance Alert (Resident Absent), 7.1 New Hostel Pending Approval (to Superadmin), 7.2 Subscription Expiring Soon, 7. Attendance & Location Tracking Emails, 7. Platform Admin Emails, 8.1 Community Post Engagement (Batched), 8. Community & Notification Emails, code:typescript ({) (+6 more)
...
Cohesion: 0.17
Nodes (10): authenticateWithGoogle(), cook, createUser(), createUserDoc(), MockSessionModel, owner, serviceMocks, session (+2 more)

### Community 232 - "Community 232"
Cohesion: 0.15
Nodes (12): ChangePasswordInput, emailSchema, ForgotPasswordInput, GoogleAuthInput, googleAuthSchema, LoginInput, loginSchema, passwordSchema (+4 more)
...
Cohesion: 0.21
Nodes (10): prepare(), ImageVariantRecord, optimizeImage(), streamToBuffer(), VARIANT_CONFIG, VariantName, loadSharp(), SharpFactory (+2 more)
...
Cohesion: 0.26
Nodes (9): AdminInvoiceRow, amountOwed(), InvoiceSegment, outstandingRows(), searchInvoiceRows(), owing, rows, settled (+1 more)
...
Cohesion: 0.24
Nodes (9): invoiceRow(), objectId(), paymentProofRecord(), paymentRecord(), receiptRecord(), residentPrincipal, residentRecord(), serviceMocks (+1 more)
...
Cohesion: 0.33
Nodes (7): CouldNotCreateFileException, HostelHubDownloadsModule, NoContextException, NothingOpensThisException, UnreadableSourceException, UnsupportedOnThisAndroidException, intent
...
Cohesion: 0.31
Nodes (8): count(), describeFanout(), SosFanoutTone, sosMessagePayload(), SosOutcome, fanout(), outcome, validateSosMessage()
...
Cohesion: 0.27
Nodes (8): findBillableResidents(), getBillingPeriodSummary(), runBillingCycle(), BillingRunInput, BillingRunQuery, billingRunQuerySchema, billingRunSchema, periodSchema
...
Cohesion: 0.2
Nodes (6): ATTENDANCE_DEFAULTS, meters, mocks, residentId, residentPrincipal, written
...
Cohesion: 0.31
Nodes (9): 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, code:typescript ({), code:typescript ({), code:typescript ({) (+1 more)
...
Cohesion: 0.33
Nodes (7): 7.1 Multi-Tenant Isolation Test Template, 7.2 Role Gate Test Template, 7.5 Payment Precision Test Template, 7. Mandatory Test Templates, code:typescript (describe('GET /api/v1/hostel/rooms/:id - tenant isolation', ), code:bash (npm --prefix apps/web run typecheck), code:bash (npm run web:lint)
...
Cohesion: 0.73
Nodes (4): logout(), readBodyRefreshToken(), clearSessionCookies(), POST()
...
## Knowledge Gaps
- **4457 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+4452 more)
...
- **Why does `Button()` connect `Community 3` to `Community 1`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 15`, `Community 18`, `Community 19`, `Community 20`, `Community 150`, `Community 22`, `Community 27`, `Community 28`, `Community 31`, `Community 33`, `Community 37`, `Community 40`, `Community 48`, `Community 70`, `Community 204`, `Community 88`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 176` to `Community 2`, `Community 4`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 146`, `Community 19`, `Community 21`, `Community 24`, `Community 153`, `Community 25`, `Community 283`, `Community 31`, `Community 33`, `Community 36`, `Community 38`, `Community 45`, `Community 46`, `Community 50`, `Community 54`, `Community 55`, `Community 74`, `Community 79`, `Community 93`, `Community 98`, `Community 109`, `Community 111`, `Community 119`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 22` to `Community 1`, `Community 3`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 15`, `Community 16`, `Community 144`, `Community 18`, `Community 19`, `Community 28`, `Community 34`, `Community 38`, `Community 39`, `Community 43`, `Community 46`, `Community 54`, `Community 66`, `Community 67`, `Community 68`, `Community 69`, `Community 70`, `Community 83`, `Community 88`, `Community 93`, `Community 102`, `Community 233`, `Community 119`?**
