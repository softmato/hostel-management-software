# Graph Report - hostel-management-software  (2026-08-02)

## Corpus Check
- 824 files · ~1,645,238 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6314 nodes · 15827 edges · 315 communities (297 shown, 18 thin omitted)
...
1. `handleRouteError()` - 368 edges
2. `successResponse()` - 364 edges
3. `connectToDatabase()` - 229 edges
4. `cn()` - 191 edges
5. `connectToDatabase()` - 181 edges
6. `requireHostelStaffPrincipal()` - 116 edges
7. `requireHostelCapability()` - 109 edges
8. `browserApi()` - 95 edges
9. `requireResidentPrincipal()` - 72 edges
10. `usePortalResource()` - 70 edges
...
- `GET()` --calls--> `connectToDatabase()`  [INFERRED]
  apps/web/src/app/api/v1/resident/community/route.ts → packages/db/src/connection.ts
...
## Communities (315 total, 18 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (90): DemoDataBadge(), HostelTable(), LoadState, Message(), UserRecord, GuardianDashboard, DerivedPlan, Payment (+82 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (119): deleteResidentLocationHistory(), getResidentAttendance(), listAttendanceAlerts(), demoteToPublicAccount(), deleteOwnPost(), listCommunityFeed(), listCommunityForModeration(), listPostComments() (+111 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (66): accountUpgradedEmail(), verificationEmail(), ProviderDirectoryData, guardianInvitationEmail(), sosAlertEmail(), cookPortalEnabledEmail(), hostelDocumentsRequestedEmail(), hostelApprovedEmail() (+58 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (75): HostelAdminCommunityPageContent, EMPTY_SUMMARY, HostelAdminComplaintsPage, HostelAdminFeePlansPageContent, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek (+67 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (54): PATCH(), POST(), RouteContext, GET(), POST(), POST(), GET(), PATCH() (+46 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (62): PRIORITIES, STATUS_ACTIONS, Campaign, Resident, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel (+54 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (58): csvField(), deferLoad(), field(), Hostel, Inquiry, numberField(), optionalField(), PageHeader() (+50 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (67): Notification, PagerButton(), SiteAnnouncementBanner(), toneClasses, PublicHostelListingPage(), cn(), Alert(), AlertAction() (+59 more)
...
Cohesion: 0.06
Nodes (62): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, dayKey(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus() (+54 more)

### Community 12 - "Community 12"
Cohesion: 0.08
Nodes (45): GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, PublicHostel, LoadState, PublicHostelListingPage() (+37 more)
...
Cohesion: 0.07
Nodes (41): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), AcceptResult, GuardianInvitePageContent, EmptyInline(), SectionCard() (+33 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (43): listHostelAttendance(), attendanceListQuerySchema, consentSchema, locationPingSchema, objectIdSchema, DELETE(), GET(), POST() (+35 more)
...
Cohesion: 0.05
Nodes (42): PATCH(), RouteContext, resolveAttendanceAlert(), attendanceAlertResolveSchema, listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET() (+34 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (37): bedSchema, depositRefundSchema, emergencyContactSchema, foodMenuSchema, guardianSchema, moveInChecklistSchema, moveOutChecklistSchema, paymentSchema (+29 more)

### Community 20 - "Community 20"
Cohesion: 0.06
Nodes (35): GET(), PATCH(), POST(), requireGuardianPrincipal(), ApiError, ApiSuccess, GET(), noticeCreateSchema (+27 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (43): AuditLogRecord, PlatformAuditLogQuery, RefRecord, CachedConnection, globalForMongoose, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex() (+35 more)
...
Cohesion: 0.06
Nodes (52): receiptSchema, arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal (+44 more)

### Community 24 - "Community 24"
Cohesion: 0.09
Nodes (43): field(), LoadState, Message(), NightStatusRow, Notification, optionalNumber(), PageHeader(), Resident (+35 more)

### Community 25 - "Community 25"
Cohesion: 0.06
Nodes (44): addComplaintUpdate(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput, ComplaintListQuery (+36 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (49): cookEmailForSlug(), generatePassword(), provisionCookAccount(), addHostelAdminInquiryNote(), BedCreateInput, BedRecord, BedUpdateInput, DocumentRequestNotification (+41 more)

### Community 27 - "Community 27"
Cohesion: 0.07
Nodes (33): POST(), RouteContext, GET(), PATCH(), RouteContext, requireHostelStaffPrincipal(), paginationQuerySchema, GET() (+25 more)

### Community 28 - "Community 28"
Cohesion: 0.07
Nodes (44): appBaseUrl(), dispatchOtpChallenge(), dispatchVerificationEmail(), findVerifiedRegistrationChallenge(), generateOtpCode(), GOOGLE_JWKS, hashOtpCode(), normalizeEmail() (+36 more)
...
Cohesion: 0.07
Nodes (36): GET(), POST(), ALLOWED_ROLES, GET(), POST(), listOwnerHostelApplications(), resubmitOwnerHostelDocuments(), publicInquiryCreateSchema (+28 more)

### Community 31 - "Community 31"
Cohesion: 0.06
Nodes (26): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminFoodPage(), redirectToWorkspaceScreen(), HostelAdminMaintenancePageContent() (+18 more)
...
Cohesion: 0.06
Nodes (41): addHistory(), addMaintenanceComment(), assertBedInHostel(), assertProviderApproved(), assertRoomInHostel(), auditMaintenanceAction(), BedRecord, createMaintenanceRequest() (+33 more)

### Community 34 - "Community 34"
Cohesion: 0.06
Nodes (41): daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags, GuardianPermissionsUpdateInput (+33 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (27): adminPrincipal, mocks, PLATFORM_LIMITS, Role, ROLE_VALUES, mocks, hostelMemberSchema, rolePermissionSchema (+19 more)

### Community 36 - "Community 36"
Cohesion: 0.06
Nodes (42): addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange(), definedUpdate(), FoodFeedbackInput, FoodFeedbackRecord, FoodMenuCreateInput (+34 more)
...
Cohesion: 0.05
Nodes (37): inquirySchema, referralSchema, referralCodeSchema, referralRewardSchema, activeCode, codeId, hostelId, joinedResidentId (+29 more)
...
Cohesion: 0.06
Nodes (35): authorUserId, mocks, postId, residentId, residentPrincipal, staffPrincipal, AnnouncementInput, CommentCreateInput (+27 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (31): PaginationMeta, PaginationQuery, querySchema, deviceTokenSchema, noticeSchema, noticeReadStatusSchema, mocks, noticeInput (+23 more)
...
Cohesion: 0.07
Nodes (34): notificationSchema, notificationCampaignSchema, CampaignListQuery, CampaignRecord, createCampaign(), createHostelNotificationCampaign(), createPlatformNotificationCampaign(), dispatchCampaign() (+26 more)
...
Cohesion: 0.07
Nodes (27): inferKind(), LightboxItem, MediaLightbox(), formatHostelAddress(), hasFood(), hostelTypeToUi(), mapPublicHostelToSummary(), roomTypeLabel() (+19 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (29): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+21 more)

### Community 48 - "Community 48"
Cohesion: 0.07
Nodes (24): incidentLogSchema, manualStatusOverrideSchema, nightStatusLogSchema, residentSchema, sosAlertSchema, ResidentAccessError, ResidentRecord, ResidentStatus (+16 more)

### Community 49 - "Community 49"
Cohesion: 0.1
Nodes (32): getHostelViewStats(), listingFlagSchema, paymentProofSchema, averageResolutionDays(), bucketBoundaries(), collectionRate(), CountingModel, countVacantBeds() (+24 more)
...
Cohesion: 0.07
Nodes (21): Select(), field(), HostelAdminReferralsPageContent(), HostelAdminServiceProvidersPageContent(), ListingFlag, LoadState, MaintenanceRequest, optionalField() (+13 more)

### Community 54 - "Community 54"
Cohesion: 0.06
Nodes (33): 10. What Not To Do, 1. Principles, 2. Foundation, 3. Layout Per Portal, 4. Key Screens & Components (Build These as Shared Components), 5. States Every List/Detail View Must Handle, 6. Accessibility, 7. Responsive Breakpoints (+25 more)
...
Cohesion: 0.13
Nodes (27): changePassword(), getCurrentUser(), issueSessionForUser(), login(), publicUser(), refreshAccessToken(), POST(), AuthTokenPayload (+19 more)

### Community 57 - "Community 57"
Cohesion: 0.07
Nodes (31): HostelAdminProfileQuery, HostelAdminProfileUpdateInput, HostelChangeRequestInput, HostelPhotoCreateInput, HostelPhotoDeleteQuery, LOCKED_NAME_STATUSES, PHOTO_LIMITS, HostelRecord (+23 more)
...
Cohesion: 0.09
Nodes (21): overrideAttendance(), attendanceOverrideSchema, GET(), POST(), PATCH(), RouteContext, nightStatusListQuerySchema, nightStatusOverrideSchema (+13 more)
...
Cohesion: 0.12
Nodes (20): attacker, attempt(), headers, jsonRequest(), routeMocks, AuthServiceError, resetPasswordWithToken(), revokeAllSessions() (+12 more)

### Community 63 - "Community 63"
Cohesion: 0.26
Nodes (17): POST(), authenticateWithGoogle(), logout(), POST(), accessTokenTtlSeconds(), parseDurationSeconds(), refreshTokenTtlSeconds(), isMobileAuthClient() (+9 more)
...
Cohesion: 0.13
Nodes (23): userResidentProfileSchema, ageFromDateOfBirth(), evaluateProfilePrompt(), generateResidentId(), getResidentIdentity(), getResidentIdentityQr(), lookupResidentProfile(), mintResidentId() (+15 more)

### Community 69 - "Community 69"
Cohesion: 0.11
Nodes (16): POST(), POST(), RouteContext, acceptGuardianInvitation(), revokeGuardianAccess(), DEFAULT_GUARDIAN_PERMISSIONS, guardianAccessCreateSchema, guardianInvitationAcceptSchema (+8 more)
...
Cohesion: 0.15
Nodes (24): fromAddress(), sendEmail(), SendEmailInput, SendEmailResult, appHostelStatusUrl(), appLoginUrl(), approvePlatformHostel(), createPlatformHostelApplication() (+16 more)
...
Cohesion: 0.13
Nodes (20): uploadPublicFile(), ApiEnvelope, parseEnvelope(), sendUpload(), sendWithProgress(), UploadCanceledError, UploadError, UploadProgress (+12 more)
...
Cohesion: 0.13
Nodes (18): NotificationBell(), AttendanceDay, ResidentAttendancePageContent, Zone, ZONE_LABELS, ZONE_STYLES, useHostelWardens(), useResidents() (+10 more)
...
Cohesion: 0.14
Nodes (15): getResidentProfile(), NotificationItem, submitResidentReview(), triggerSOS(), RootStackParamList, Props, Props, Profile (+7 more)

### Community 89 - "Community 89"
Cohesion: 0.2
Nodes (15): ImageVariantRecord, optimizeImage(), streamToBuffer(), VARIANT_CONFIG, VariantName, r2Configured(), storePublicAsset(), deleteFromR2() (+7 more)
...
Cohesion: 0.1
Nodes (20): A. Do now (agent-completable, in Phase 1 scope) — ✅ DONE, B0. Auth screens — remove the demo shortcuts *(explicitly requested)* ✅, B1. Pagination — specified everywhere, implemented nowhere, B2. Three "nobody gets notified" gaps ✅, B3. Community engagement notifications, B4. Multi-tenancy, B5. Account deletion & data retention — entire feature absent, B6. Privacy commitments the site makes but the code does not keep (+12 more)
...
Cohesion: 0.16
Nodes (12): GET(), POST(), requireSuperadminPrincipal(), GET(), PUT(), PUT(), RouteContext, GET() (+4 more)

### Community 100 - "Community 100"
Cohesion: 0.24
Nodes (11): POST(), POST(), errorResponse(), CronAuthResult, normalizeSecret(), safeEqual(), validateCronRequest(), POST() (+3 more)
...
Cohesion: 0.15
Nodes (18): AccountDeletionRequest, code:typescript (interface IQuestionCallClick {), code:typescript ({), code:typescript ({), code:typescript (interface IAccountDeletionRequest {), code:block44 (packages/db/migrations/), code:block45 (packages/db/migrations/), code:block46 (packages/db/migrations/) (+10 more)
...
Cohesion: 0.21
Nodes (14): getAttendanceSettings(), resolveAdminHostelId(), attendanceSettingsSchema, getCommunitySettings(), communitySettingsSchema, GET(), PATCH(), resolveHostelId() (+6 more)
...
Cohesion: 0.18
Nodes (17): comparePublicHostels(), createHostelAdminBed(), createHostelAdminFloor(), createHostelAdminRoom(), definedUpdate(), findFloorInHostel(), findRoomInHostel(), normalizeObjectIds() (+9 more)
...
Cohesion: 0.14
Nodes (15): Build status (end of Phase 3), Build status (end of Phase 5 — verified 2026-08-02), code:typescript (export enum Role {), code:typescript (interface IMoveInChecklistItem {), code:typescript (interface IMoveOutChecklistItem {), Conventions, Cook Portal, DATABASE.md — Schema & Relationships (+7 more)
...
Cohesion: 0.2
Nodes (8): LegalBody(), PublicHomePageContent(), PublicPricingPageContent(), PublicPrivacyPage(), sections, PublicTermsPage(), sections, useSiteConfig()
...
Cohesion: 0.22
Nodes (12): requestHostelProfileChange(), profileMocks, staffPrincipal, updateHostelAdminProfile(), addHostelAdminProfilePhoto(), auditHostelAction(), deleteHostelAdminProfilePhoto(), findScopedHostel() (+4 more)

### Community 121 - "Community 121"
Cohesion: 0.18
Nodes (13): ServiceProviderRegistrationPageContent(), UploadKind, AttachedFile(), FileUploader(), FileUploaderPresentation, FileUploaderProps, FileUploaderView(), TONE_CLASSES (+5 more)
...
Cohesion: 0.16
Nodes (10): AuthSession, register(), verifyOtp(), AppNavigator(), Stack, LoginScreen(), OtpVerificationScreen(), Props (+2 more)

### Community 129 - "Community 129"
Cohesion: 0.16
Nodes (13): apiRequest(), confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listNotifications(), listResidentComplaints(), login(), markNotificationRead() (+5 more)
...
Cohesion: 0.27
Nodes (11): FileUploadArea(), acceptAttribute(), EXTENSION_BY_MIME, formatBytes(), joinTypes(), KIND_RULES, KindRule, labelsFor() (+3 more)
...
Cohesion: 0.22
Nodes (14): AuditLog, code:typescript ({), code:typescript ({), code:typescript (interface IFoodReadyLog {), code:typescript ({), FoodReadyLog, Notification, Notification (+6 more)
...
Cohesion: 0.15
Nodes (12): 5.1 SOS Triggered, 5. Safety & Emergency Emails, 8.1 Community Post Engagement (Batched), 8. Community & Notification Emails, code:typescript ({), code:typescript ({), Email Opt-In/Opt-Out Matrix, EMAIL_SYSTEM.md — Email Triggers & Templates (+4 more)
...
Cohesion: 0.17
Nodes (11): Attendance maintenance (absence alerts + retention purge), Authentication, Complaint SLA breach check, cron-job.org setup (per job), CRON.md — Scheduled Jobs, Dispatch scheduled notifications, Endpoints, Payment reminders and overdue chases (+3 more)
...
Cohesion: 0.2
Nodes (6): createPublicHostelInquiry(), serializePublicHostel(), serializeRoomConfigurations(), inquiryId, serviceMocks, staffPrincipal

### Community 167 - "Community 167"
Cohesion: 0.2
Nodes (9): 1. State right now, 2. What this session did, 3. Decisions locked this session — do not re-open, 4. The rule that keeps producing bugs, 5. Gotchas that will cost you time, 6. Resume here — `TODO.md` Track B3 onward, 7. Deliberately deferred (TODO.md B8), code:bash (npm --prefix apps/web run typecheck && npm run web:lint && n) (+1 more)
...
Cohesion: 0.4
Nodes (6): code:typescript (interface IServiceProvider {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IInquiry {), MaintenanceRequest, Service Providers & Maintenance, ServiceProvider
...
Cohesion: 0.67
Nodes (3): 7.1 Attendance Alert (Resident Absent), 7. Attendance & Location Tracking Emails, code:typescript ({)
...
## Knowledge Gaps
- **2274 isolated node(s):** `AuthUser`, `ResidentSummary`, `ResidentFoodRoutine`, `ApiSuccess`, `ApiFailure` (+2269 more)
...
- **Why does `Role` connect `Community 35` to `Community 0`, `Community 1`, `Community 9`, `Community 11`, `Community 14`, `Community 146`, `Community 147`, `Community 20`, `Community 23`, `Community 152`, `Community 26`, `Community 27`, `Community 28`, `Community 30`, `Community 34`, `Community 164`, `Community 37`, `Community 166`, `Community 36`, `Community 41`, `Community 42`, `Community 45`, `Community 47`, `Community 176`, `Community 50`, `Community 56`, `Community 59`, `Community 61`, `Community 62`, `Community 192`, `Community 206`, `Community 99`, `Community 104`, `Community 116`, `Community 119`, `Community 120`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `browserApi()` connect `Community 24` to `Community 0`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 12`, `Community 13`, `Community 15`, `Community 32`, `Community 163`, `Community 37`, `Community 40`, `Community 43`, `Community 45`, `Community 46`, `Community 52`, `Community 53`, `Community 60`, `Community 70`, `Community 76`, `Community 82`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 1` to `Community 2`, `Community 4`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 19`, `Community 21`, `Community 23`, `Community 25`, `Community 26`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 38`, `Community 166`, `Community 41`, `Community 42`, `Community 44`, `Community 47`, `Community 48`, `Community 49`, `Community 56`, `Community 57`, `Community 189`, `Community 61`, `Community 62`, `Community 63`, `Community 64`, `Community 68`, `Community 72`, `Community 90`, `Community 100`, `Community 105`, `Community 109`, `Community 119`, `Community 120`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Are the 224 inferred relationships involving `connectToDatabase()` (e.g. with `POST()` and `GET()`) actually correct?**
  _`connectToDatabase()` has 224 INFERRED edges - model-reasoned connections that need verification._
