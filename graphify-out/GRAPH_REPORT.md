...
## Corpus Check
- 1393 files · ~2,251,581 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11025 nodes · 28583 edges · 435 communities (415 shown, 20 thin omitted)
...
Cohesion: 0.02
Nodes (221): POST(), POST(), GET(), GET(), POST(), getFoodRoutinesByHostelId(), serializeRoutine(), listPublicFoodRoutine() (+213 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (161): POST(), GET(), POST(), GET(), PATCH(), POST(), RouteContext, GET() (+153 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (160): Scanner(), GuardianInviteScreen(), Choice, Compass(), maneuverIcon(), MapButton(), MapScreen(), ModeTab() (+152 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (155): getResidentAttendance(), confirmComplaintResolution(), listResidentComplaints(), getResidentFinanceView(), listResidentInvoices(), renderReceiptById(), renderStatementForResident(), getFoodRoutine() (+147 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (111): DemoDataBadge(), HostelTable(), UserRecord, GuardianDashboard, FeeSchedule, HostelAdminFeeSchedulePageContent, Rate, CreateWardenResult (+103 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (140): AuthDivider(), GoogleSignInButton(), accentForAccount(), AccountShape, HomeRoute, resolveHome(), ROLE, signedIn (+132 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (86): ICONS, LABELS, TONES, Overview, PORTAL_ROWS, Person, ProfileScreen(), CheckoutStatusScreen() (+78 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (95): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload (+87 more)
...
Cohesion: 0.03
Nodes (104): TABS, AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), BootGate(), RootShell(), NightStatusScreen(), FILTERS (+96 more)
...
Cohesion: 0.03
Nodes (77): Ledger, OrphanAssignPicker, HostelAdminPaymentsPage, MatrixRow, MatrixTotals, PeriodSummary, ClaimFacts(), FLAG_LABELS (+69 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (82): SubmitClaimScreen(), InvoiceDetailScreen(), LedgerCard(), SummaryCard(), AmountCard(), methodIcon(), methodLabel(), PayInvoiceScreen() (+74 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (74): adminPrincipal, mocks, PLATFORM_LIMITS, mocks, readable, selectable, mocks, proofBody (+66 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (57): GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, hasFood() (+49 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (61): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, summarizeResidentComplaints(), SetResidentFeeInput, accessId, adminPrincipal (+53 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (65): csvField(), deferLoad(), field(), Hostel, Inquiry, LoadState, Message(), numberField() (+57 more)

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (73): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus(), OPEN_STATUSES (+65 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (51): AuthShell(), AuthShellProps, SiteWordmark(), GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse, GoogleAuthUser, GoogleCredentialResponse (+43 more)
...
Cohesion: 0.04
Nodes (49): PATCH(), POST(), RouteContext, GET(), RouteContext, POST(), RouteContext, POST() (+41 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (63): IdCardFace(), initialsOf(), Portrait(), IdCardPrompt(), Point(), BLOOD_OPTIONS, DIET_OPTIONS, GENDER_OPTIONS (+55 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (63): POST(), POST(), POST(), GET(), POST(), bulkApproveSchema, POST(), POST() (+55 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (59): CommunityReportDialog(), REASONS, ModerationButton(), PagerButton(), PublicHostelListingPage(), ReferenceCheck(), CopyButton(), PublicHostelListingPage() (+51 more)
...
Cohesion: 0.04
Nodes (60): POST(), InvoiceMatrix, InvoiceMatrixRow, PortalInvoice, ResidentFinanceView, ResidentInvoiceLine, ResidentInvoiceReceipt, ResidentPortalInvoice (+52 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (63): RouteContext, feeUpdateSchema, PATCH(), setResidentMonthlyFee(), POST(), GET(), alreadyReviewedError(), approvePaymentProof() (+55 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (50): Notification, MonthPicker, PeriodRow, HostelAdminResidentsPage, humanizeValue(), ImportedProfileSummary(), ResidentPrefill, ResidentStatus (+42 more)
...
Cohesion: 0.04
Nodes (52): ComparePage(), hostels, metadata, rows, CurrentUser, MeResponse, PortalAccount(), PortalTone (+44 more)
...
Cohesion: 0.05
Nodes (51): cookPrincipal, mocks, cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError, FoodPhotoUploadInput, FoodReadyInput (+43 more)

### Community 36 - "Community 36"
Cohesion: 0.05
Nodes (47): HostelPhotoReminder(), CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS, CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS (+39 more)
...
Cohesion: 0.06
Nodes (45): GET(), RouteContext, serviceProviderApplicationSchema, serviceProviderDocumentSchema, PATCH(), GET(), ACTIVE_APPLICATION_STATUSES, auditProviderAction() (+37 more)
...
Cohesion: 0.05
Nodes (48): AttachmentGallery(), CookTodayScreen(), CookMenuScreen(), CookPhotosScreen(), announcedCount(), FoodReadyAnnouncement, MealButton, mealButtonLabel() (+40 more)
...
Cohesion: 0.08
Nodes (42): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, ImageVariantRecord (+34 more)

### Community 45 - "Community 45"
Cohesion: 0.06
Nodes (43): POST(), saveFoodRoutine(), addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange(), definedUpdate(), FoodFeedbackInput (+35 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (44): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), QueryProvider() (+36 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (44): CLAIMABLE_STATUSES, dispatchOtpChallenge(), findVerifiedRegistrationChallenge(), generateOtpCode(), GOOGLE_JWKS, hashOtpCode(), normalizeEmail(), normalizeOtpIdentifier() (+36 more)
...
Cohesion: 0.06
Nodes (27): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminFoodPage(), redirectToWorkspaceScreen(), HostelAdminMaintenancePageContent(), HostelAdminReportsPageContent() (+19 more)

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (40): DeletionPanel(), NotificationSettings(), THEME_OPTIONS, DeletionRequest, DeletionStatus, getDeletionStatus(), requestAccountDeletion(), canRequestDeletion() (+32 more)
...
Cohesion: 0.05
Nodes (38): CancelDeletionPageContent(), RealtimeConfig, RealtimeContext, RealtimeContextValue, RealtimeNotification, RealtimeProvider(), CheckoutStatus, ResidentCheckoutPageContent (+30 more)

### Community 54 - "Community 54"
Cohesion: 0.07
Nodes (40): collectionTotals(), countInvoicesByField(), foodFeedbackSchema, listingFlagSchema, paymentProofSchema, ratingReviewSchema, SERVICE_PROVIDER_CATEGORIES, serviceProviderSchema (+32 more)

### Community 55 - "Community 55"
Cohesion: 0.07
Nodes (38): PATCH(), RouteContext, referralSchema, referralCodeSchema, referralRewardSchema, auditReferralAction(), confirmReferralJoined(), createReferredInquiry() (+30 more)

### Community 56 - "Community 56"
Cohesion: 0.06
Nodes (43): HostelServiceError, getHostelViewStats(), hashUserAgent(), HostelRef, newVisitorKey(), recordHostelPageView(), resolveVisitorKey(), hostelPageViewSchema (+35 more)

### Community 57 - "Community 57"
Cohesion: 0.07
Nodes (42): Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity(), fromHeaderFor() (+34 more)
...
Cohesion: 0.08
Nodes (44): directionFlags(), evidenceFlags(), payeeFlags(), AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance() (+36 more)
...
Cohesion: 0.08
Nodes (42): demoteToPublicAccount(), roomSchema, assertActiveReferralCode(), findActiveReferralCode(), linkReferralOnRegistration(), addEmergencyContact(), addGuardian(), auditResidentAction() (+34 more)
...
Cohesion: 0.08
Nodes (30): AuthGuard(), HostelSuggestions(), PublicHostel, checkOnly(), EMPTY_PREFILL, ENVIRONMENT_OPTIONS, IdentityResponse, Prefill (+22 more)

### Community 66 - "Community 66"
Cohesion: 0.06
Nodes (33): issueReceiptForEvent(), IssueReceiptInput, nextReceiptNumber(), periodCoverage(), periodOfDate(), voidReceipt(), eventId, hostelId (+25 more)

### Community 67 - "Community 67"
Cohesion: 0.06
Nodes (28): outstandingForResident(), bedSchema, depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, providedItemSchema, listMoveEvents(), MoveChecklistServiceError (+20 more)

### Community 68 - "Community 68"
Cohesion: 0.06
Nodes (35): acceptGuardianInvitation(), daysFromNow(), enabledPermissionLabels(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags, GuardianPermissionsUpdateInput (+27 more)
...
Cohesion: 0.18
Nodes (25): POST(), authenticateWithGoogle(), AuthServiceError, changePassword(), logout(), POST(), POST(), loginGuardian() (+17 more)

### Community 71 - "Community 71"
Cohesion: 0.09
Nodes (36): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, GATEWAY_ORDER, getPayInstructions() (+28 more)

### Community 72 - "Community 72"
Cohesion: 0.1
Nodes (29): InquiryLinkScreen(), ReferralBody(), ReferralRow(), InquiryFields(), hasInquiryErrors(), InquiryDraft, InquiryErrors, normalizePhone() (+21 more)
...
Cohesion: 0.08
Nodes (31): addHistory(), addMaintenanceComment(), assertBedInHostel(), assertProviderApproved(), assertRoomInHostel(), auditMaintenanceAction(), BedRecord, createMaintenanceRequest() (+23 more)
...
Cohesion: 0.07
Nodes (25): metadata, CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+17 more)
...
Cohesion: 0.09
Nodes (33): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), loadPayeeIdentity() (+25 more)

### Community 83 - "Community 83"
Cohesion: 0.06
Nodes (25): currency(), Select(), TextArea(), ResidentActivationPageContent, ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent (+17 more)
...
Cohesion: 0.1
Nodes (31): getCurrentUser(), issueSessionForUser(), login(), publicUser(), refreshAccessToken(), cook, createUser(), createUserDoc() (+23 more)
...
Cohesion: 0.08
Nodes (27): attacker, attempt(), headers, jsonRequest(), routeMocks, resendVerificationEmail(), resetPasswordWithToken(), revokeAllSessions() (+19 more)

### Community 89 - "Community 89"
Cohesion: 0.07
Nodes (31): countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor(), LedgerInvoiceRow, ledgerPipeline() (+23 more)

### Community 90 - "Community 90"
Cohesion: 0.09
Nodes (20): ENDPOINTS, esewaProvider, SIGNED_FIELDS, BASE_URLS, khaltiProvider, attempt, fetchMock, initiated (+12 more)
...
Cohesion: 0.14
Nodes (20): POST(), POST(), POST(), runBillingCycleForAllHostels(), POST(), runGatewayHealth(), POST(), POST() (+12 more)

### Community 93 - "Community 93"
Cohesion: 0.08
Nodes (23): PaginationQuery, auditLogSchema, noticeSchema, noticeReadStatusSchema, mocks, noticeInput, residentUserId, staffPrincipal (+15 more)
...
Cohesion: 0.08
Nodes (25): GatewayHealth, GatewayHealthSummary, getGatewayHealth(), IntentCounts, plural(), recordHealth(), runGatewayHealthForHostel(), SEVERITY (+17 more)
...
Cohesion: 0.07
Nodes (20): EmptyState(), Input(), Panel(), field(), HostelAdminReferralsPageContent(), ListingFlag, LoadState, MaintenanceRequest (+12 more)
...
Cohesion: 0.09
Nodes (20): complaintCategorySchema, complaintCreateSchema, complaintListQuerySchema, complaintReplySchema, complaintResolutionConfirmSchema, complaintStatusSchema, complaintStatusUpdateSchema, objectIdSchema (+12 more)
...
Cohesion: 0.1
Nodes (15): PlatformHostelsPageContent(), PlatformHostelsPageContent, PortalExperiencePage(), PortalPlaceholderAction, PortalPlaceholderPage(), PortalPlaceholderPageProps, ResidentProfilePageContent(), ResidentProfilePageContent (+7 more)

### Community 104 - "Community 104"
Cohesion: 0.11
Nodes (24): DeletionPathway, DeletionStatus, PATHWAY_COPY, AvailableRoomType, RoomMapFloor, HostelPreviewLink(), ResidentEmergencyContact, ResidentGuardian (+16 more)
...
Cohesion: 0.11
Nodes (24): uploadPublicFile(), FILE_ASSET_KINDS, FileAssetKind, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), UploadKind, ApiEnvelope (+16 more)
...
Cohesion: 0.13
Nodes (24): FileUploadArea(), acceptAttribute(), EXTENSION_BY_MIME, FAMILY_BYTES, FAMILY_ORDER, familyOf(), formatBytes(), joinTypes() (+16 more)
...
Cohesion: 0.11
Nodes (19): appBaseUrl(), dispatchVerificationEmail(), requestPasswordReset(), signupWithEmailVerification(), POST(), POST(), buckets, clientKey() (+11 more)
...
Cohesion: 0.11
Nodes (15): POST(), accountDeletionRequestSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, consentLogSchema, purgeAccount(), runAccountDeletionPurge() (+7 more)
...
Cohesion: 0.12
Nodes (16): AuthSession, login(), submitResidentReview(), triggerSOS(), AppNavigator(), RootStackParamList, Stack, LoginScreen() (+8 more)
...
Cohesion: 0.14
Nodes (16): POST(), safeEqual(), questionCallClickSchema, ClickRecord, QuestionCallAnalyticsQuery, questionCallBaseUrl(), QuestionCallClickInput, QuestionCallConversionInput (+8 more)
...
Cohesion: 0.16
Nodes (18): Guidance, GuidanceStatus, NavigationFix, watchDeviceHeading(), watchNavigationPosition(), CARDINALS, directionWord(), distanceToPath() (+10 more)
...
Cohesion: 0.23
Nodes (14): CSV_COLUMNS, GET(), GET(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS, neutralize() (+6 more)

### Community 169 - "Community 169"
Cohesion: 0.15
Nodes (16): Offset, PhotoCropper(), isActive(), AttachedFile(), FileUploader(), FileUploaderPresentation, FileUploaderProps, FileUploaderView() (+8 more)
...
Cohesion: 0.22
Nodes (12): robots(), sitemap(), STATIC_ROUTES, listPublishedHostelSlugs(), siteUrl(), CARD_LABELS, formatIssuedOn(), readPhotoBytes() (+4 more)

### Community 189 - "Community 189"
Cohesion: 0.23
Nodes (15): CheckoutStatus, closeIntent(), createPaymentIntent(), expireStaleIntents(), handleProviderCallback(), IntentRecord, isUnconfirmable(), markSucceeded() (+7 more)
...
Cohesion: 0.15
Nodes (14): apiRequest(), confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), getResidentProfile(), listResidentComplaints(), refreshSession(), register() (+6 more)
...
Cohesion: 0.21
Nodes (13): buildPlatformReportExport(), complaintVolume(), HostelAdminReportExportInput, hostelNamesByIdFor(), hostelsByStatus(), normalizeObjectId(), paymentVolume(), PlatformReportExportInput (+5 more)
...
Cohesion: 0.18
Nodes (10): activateResident(), getResidentNightStatus(), ResidentNightStatus, updateResidentNightStatus(), Props, ResidentActivationScreen(), styles, Props (+2 more)
...
Cohesion: 0.2
Nodes (12): 2.2 Hostel Approved, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.3 Payment Proof Uploaded (to Admin), 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, code:typescript ({) (+4 more)
...
Cohesion: 0.21
Nodes (12): 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, 7.1 Attendance Alert (Resident Absent), 7. Attendance & Location Tracking Emails, code:typescript ({) (+4 more)
...
Cohesion: 0.25
Nodes (9): 1.7 Account Upgraded, 2.1 Hostel Submission Received, 2.3 Hostel Rejected, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, code:typescript ({), code:typescript ({), code:typescript ({) (+1 more)
...
Cohesion: 0.29
Nodes (5): toast, ToastInput, ToastItem, ToastStore, ToastTone
...
## Knowledge Gaps
- **4045 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+4040 more)
...
- **Why does `Button()` connect `Community 6` to `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 9`, `Community 140`, `Community 13`, `Community 12`, `Community 17`, `Community 23`, `Community 25`, `Community 26`, `Community 29`, `Community 32`, `Community 40`, `Community 50`, `Community 53`, `Community 72`, `Community 80`, `Community 81`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 25` to `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 11`, `Community 12`, `Community 15`, `Community 19`, `Community 26`, `Community 29`, `Community 32`, `Community 33`, `Community 36`, `Community 169`, `Community 51`, `Community 52`, `Community 65`, `Community 74`, `Community 78`, `Community 81`, `Community 218`, `Community 95`, `Community 98`, `Community 104`, `Community 110`, `Community 120`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `Role` connect `Community 14` to `Community 0`, `Community 1`, `Community 10`, `Community 144`, `Community 17`, `Community 16`, `Community 19`, `Community 276`, `Community 18`, `Community 22`, `Community 26`, `Community 31`, `Community 32`, `Community 289`, `Community 35`, `Community 36`, `Community 39`, `Community 41`, `Community 298`, `Community 44`, `Community 45`, `Community 174`, `Community 47`, `Community 57`, `Community 60`, `Community 62`, `Community 68`, `Community 69`, `Community 77`, `Community 79`, `Community 209`, `Community 210`, `Community 85`, `Community 88`, `Community 93`, `Community 101`, `Community 105`, `Community 113`, `Community 250`?**
