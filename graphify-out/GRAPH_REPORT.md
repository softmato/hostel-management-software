...
## Corpus Check
- 2315 files · ~4,837,869 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18568 nodes · 52084 edges · 603 communities (573 shown, 30 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 861 edges (avg confidence: 0.8)
...
- `chipOf()` --calls--> `bsMonthName()`  [EXTRACTED]
  apps/mobile/src/lib/payment-months.ts → packages/shared/src/calendar/bs.ts
...
## Communities (603 total, 30 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (257): GET(), POST(), GET(), POST(), MESSAGES, POST(), RouteContext, GET() (+249 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (198): ICONS, LABELS, Segment, TONES, FILTERS, Pending, MoneyData, MANAGE_ROWS (+190 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (267): PATCH(), RouteContext, POST(), fileFieldCash(), getOrCreateSubscription(), selectPlan(), POST(), GET() (+259 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (253): loadFinance(), ActivationIssue, addEmergencyContact(), addHostelPhoto(), addResidentGuardian(), approveMatchedStatement(), assignMaintenanceProvider(), assignOrphanPayment() (+245 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (162): PlanPaymentClaim, AccountDeletionPanel, DeletionPathway, DeletionStatus, PATHWAY_COPY, csvField(), deferLoad(), DemoDataBadge() (+154 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (206): POST(), GET(), answerSchema, POST(), AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput (+198 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (194): HIDDEN, RoleLayout(), TABS, FILTERS, invalidateFeeds(), NIGHT_ANSWER_LABELS, nightAnswerText(), NightPromptAnswer() (+186 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (148): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload (+140 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (197): Scanner(), CookInviteScreen(), GuardianInviteScreen(), Assurance(), CallableRow(), IdentityCard(), PeopleSection(), ContactRow() (+189 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (189): loadToday(), DeletionPanel(), BookingForm(), CheckoutScreen(), METHODS, PackageCard(), roomPhotoUris(), StatusCard() (+181 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (155): POST(), POST(), attacker, attempt(), headers, jsonRequest(), routeMocks, appBaseUrl() (+147 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (160): generateMetadata(), manifest(), robots(), Entry, hostelEntries(), locationEntries(), sitemap(), STATIC_ROUTES (+152 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (143): POST(), POST(), POST(), GET(), POST(), bulkApproveSchema, POST(), GET() (+135 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (129): AdminCommunityScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+121 more)

### Community 14 - "Community 14"
Cohesion: 0.06
Nodes (113): accountDeletionCancelledEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), submitFieldCash(), dueWhen(), PlanDueInput (+105 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (96): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, COMPARISON_AMENITIES, comparisonAmenities() (+88 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (125): BookingQuote, GuestBookingDetail, GuestBookingSummary, metadata, BookingCheckoutPage(), Method, METHODS, nextStep() (+117 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (138): ProfileScreen(), ReferralRow(), ReviewForm(), ReviewScreen(), CheckoutStatusScreen(), AttachmentGallery(), ComplaintDetail(), ComplaintCard() (+130 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (140): PaymentMonthStrip(), ManageRatesScreen(), ClearFilters(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), InvoiceDetailScreen() (+132 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (118): HostelAdminAttendancePageContent, HostelAdminBillingPageContent(), HostelAdminCommunityPageContent, HostelAdminComplaintsPage, HostelAdminInquiriesPageContent, HostelAdminMaintenancePageContent, PRIORITIES, STATUS_ACTIONS (+110 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (137): AdminCommunityReportsScreen(), AdminResidentsScreen(), AttendanceScreen(), NightStatusHistoryScreen(), NightStatusForm(), NightStatusScreen(), ReferralsScreen(), SavedListRow() (+129 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (102): PATCH(), POST(), RouteContext, demoteToPublicAccount(), POST(), RouteContext, GET(), PATCH() (+94 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (99): Platform, InvoiceRow(), PaymentRow(), PlanCard(), rupees(), shortDate(), STATUS_TONE, ConcessionBackfill (+91 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (135): announceConfirmed(), announceEnding(), assertAwaitingAnswer(), cancelBookingByHostel(), cancelBookingByPlatform(), cancelMyBooking(), confirmBooking(), declineBooking() (+127 more)

### Community 24 - "Community 24"
Cohesion: 0.02
Nodes (125): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), loadOverview(), Overview, AdminTabs(), AdminMoneyScreen(), loadMoney() (+117 more)

### Community 25 - "Community 25"
Cohesion: 0.02
Nodes (119): VideoSlot(), CollectionQrField(), OperationsConfig, PendingSettingChange, PlanDueReminderSchedule, PlanReminderStep, PlatformOperationsPanel, REMINDER_CHANNELS (+111 more)

### Community 26 - "Community 26"
Cohesion: 0.02
Nodes (95): ATTENDANCE_DEFAULTS, adminPrincipal, mocks, PLATFORM_LIMITS, afterMidnight, evening, meters, mocks (+87 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (115): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, notifyHostelOfNewPost(), resolveHostelCommunityUserIds() (+107 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (127): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES (+119 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (119): AdminMoreScreen(), ActivateScreen(), BootGate(), RootShell(), NotificationsScreen(), SavedHostelsScreen(), SettingsScreen(), LoginScreen() (+111 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (112): listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), getPlatformSubscriptionLedger(), listPlanPaymentClaims(), GET(), DELETE() (+104 more)

### Community 31 - "Community 31"
Cohesion: 0.02
Nodes (104): BubbleBackground(), BubbleBackgroundProps, BubbleColors, StarLayer(), StarLayerProps, StarsBackground(), StarsBackgroundProps, ConfirmOptions (+96 more)

### Community 32 - "Community 32"
Cohesion: 0.02
Nodes (108): CardBooking, checkInBooking(), findCardBooking(), findHeldBooking(), returnHeldBed(), takeHeldBed(), notifyPlatform(), CapacityError (+100 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (107): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, checkoutDocumentFor(), softmatoDocumentNumbers(), gateway, invoice (+99 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (92): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), ApplyBlock(), ServiceProvidersScreen() (+84 more)

### Community 35 - "Community 35"
Cohesion: 0.02
Nodes (94): EMPTY_PAYOUT_DRAFT, METHODS, PayoutAccountDraft, PayoutAccountFields(), payoutAccountPayload(), AuthGuard(), DescriptionFacts, DescriptionSuggestions() (+86 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (104): cookPrincipal, mocks, resolveCookLabels(), CookServiceError, announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput (+96 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (108): BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan, BillingSkip (+100 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (98): BookingPaymentToCheck, TransferView, HostelBookingView, PlatformBookingView, PayoutAccountForReview, ReviewPayoutAccount(), STATUS_LABEL, List() (+90 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (74): MapScreen(), BrowseParams, BUDGET_BANDS, FilterSheet(), HostelBrowser(), HostelBrowserProps, NearestToggle(), ViewSwitch() (+66 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (81): getPlatformBooking(), releaseGuardianAccounts(), findResidentOwnedAccess(), revokeGuardianAccess(), updateGuardianPermissions(), guardianPermissionsUpdateSchema, DELETE(), GET() (+73 more)

### Community 41 - "Community 41"
Cohesion: 0.02
Nodes (51): deleteHostelObjects(), ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, purgeHostel(), RETAINED_BY_HOSTEL_ID (+43 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (48): GetPlanButton(), InlineText(), TIER_TONE, PlanMark(), RAFTER, RIDGE, ROWS, EASE (+40 more)

### Community 43 - "Community 43"
Cohesion: 0.03
Nodes (81): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), PROVIDER_LABEL, QrPanel(), ManageFinanceScreen() (+73 more)

### Community 44 - "Community 44"
Cohesion: 0.03
Nodes (60): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, AuthShell(), AuthShellProps, PANEL_COPY (+52 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (63): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, attempt (+55 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (73): classifyCredit(), CreditClassification, findOrphanClaims(), LadderClaim, LadderInvoice, loadMatchContext(), MatchContext, normalizeTxnId() (+65 more)

### Community 47 - "Community 47"
Cohesion: 0.03
Nodes (72): PlanId, portalAccessLines(), Service, ServiceModule, ServiceModuleId, Faq, PlatformConfigSeoPageContent, Step (+64 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (67): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, GATEWAY_ORDER, getHostelPayMethods() (+59 more)

### Community 49 - "Community 49"
Cohesion: 0.06
Nodes (67): GET(), BookableHostel, BookingUnavailableReason, findRoom(), hostelAddress(), HostelAvailability, hostelCoverPhoto(), hostelCoverPhotos() (+59 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (61): collectionTotals(), monthlySeries(), countListingAppearances(), getHostelViewStats(), foodFeedbackSchema, inquirySchema, listingFlagSchema, maintenanceRequestSchema (+53 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (64): openStore(), methodProvider(), createResident(), getIntakeQuote(), IntakeQuote, lookupResidentProfile(), RESIDENT_TYPES, ResidentIntakeResult (+56 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (63): GET(), POST(), GET(), querySchema, assertTeamRegistrationIsNew(), checkTeamOwnerEmail(), findHostelUsingEmail(), hostelNameKey() (+55 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (53): generateMetadata(), ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails(), RenderedSection (+45 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (56): PaginationMeta, paginationQuerySchema, querySchema, DEPRECATED_ALIASES, grantingPermissionKeys(), mocks, auditListingFlagAction(), DuplicateCheckResultRecord (+48 more)

### Community 55 - "Community 55"
Cohesion: 0.04
Nodes (59): approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal, checker, eventId (+51 more)

### Community 56 - "Community 56"
Cohesion: 0.03
Nodes (59): assetId, body, call, hashCall, hostelId, input, invoiceId, mocks (+51 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (53): BookButton(), SIZE, BookingAvailabilityView, BookingButton, CLOSED_REASONS, open, HostelSuggestions(), formatHostelAddress() (+45 more)

### Community 58 - "Community 58"
Cohesion: 0.05
Nodes (59): POST(), getFoodRoutine(), saveFoodRoutine(), serializeRoutine(), addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange() (+51 more)

### Community 59 - "Community 59"
Cohesion: 0.06
Nodes (61): PATCH(), RouteContext, POST(), GET(), alreadyReviewedError(), approvePaymentProof(), assertProofIsPending(), auditPaymentAction() (+53 more)

### Community 60 - "Community 60"
Cohesion: 0.03
Nodes (64): ACTOR_FIELDS, ACTOR_OVERRIDES, actorRefs, args, atKept, backupDir, brief, bucket (+56 more)

### Community 61 - "Community 61"
Cohesion: 0.05
Nodes (65): fill(), money(), PlanCard(), PricingScreen(), pricePlan(), currentBsPeriod(), metadata, UpgradeDialog() (+57 more)

### Community 62 - "Community 62"
Cohesion: 0.05
Nodes (61): CHANNELS, ClaimedStep, composeEmail(), composeNotice(), composePlanDueNotice(), deliverEmail(), deliverStep(), HostelRow (+53 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (54): addComplaintUpdate(), assertComplaintVoiceNote(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput (+46 more)

### Community 64 - "Community 64"
Cohesion: 0.04
Nodes (55): COLUMNS, Member, MemberData, RegistrationTrackSheet(), TrackSheetLoader(), cellAt(), focusCell(), Props (+47 more)

### Community 65 - "Community 65"
Cohesion: 0.06
Nodes (49): openCheckoutSession(), applyWebhook(), WebhookResult, fileBookingRefund(), refileBookingRefund(), submitBookingRefund(), expireUnpaidBooking(), getMyBooking() (+41 more)

### Community 66 - "Community 66"
Cohesion: 0.06
Nodes (61): personalLookupHash(), getPresignedReadUrl(), notificationSchema, userResidentProfileSchema, LEGACY_ROLE_MAP, Role, ROLE_VALUES, CARD_LABELS (+53 more)

### Community 67 - "Community 67"
Cohesion: 0.06
Nodes (49): hostelPeriodOf(), BillPreview, CheckContext, CheckedRow, checkExistingResidents(), CheckResult, monthLabel(), moveInDateFor() (+41 more)

### Community 68 - "Community 68"
Cohesion: 0.04
Nodes (50): FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind, creditOverpayment() (+42 more)

### Community 69 - "Community 69"
Cohesion: 0.05
Nodes (52): addHistory(), addMaintenanceComment(), assertBedInHostel(), assertProviderApproved(), assertRoomInHostel(), assertVoiceNoteUsable(), assignMaintenanceProvider(), auditMaintenanceAction() (+44 more)

### Community 70 - "Community 70"
Cohesion: 0.04
Nodes (54): account, answerBy, before, book(), Booking, compact, confirmed(), Consent (+46 more)

### Community 71 - "Community 71"
Cohesion: 0.05
Nodes (51): CSV_COLUMNS, GET(), POST(), RouteContext, listTrendingTags(), POST(), safeEqual(), sponsorSchema (+43 more)

### Community 72 - "Community 72"
Cohesion: 0.05
Nodes (60): BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodBounds(), bsPeriodOf() (+52 more)

### Community 73 - "Community 73"
Cohesion: 0.05
Nodes (51): POST(), PaginationQuery, deviceTokenSchema, noticeReadStatusSchema, broadcastNotice(), BroadcastOptions, definedUpdate(), normalizeObjectIds() (+43 more)

### Community 74 - "Community 74"
Cohesion: 0.06
Nodes (54): DELETE(), POST(), platformPushScheduleSchema, CampaignListQuery, CampaignRecord, createCampaign(), createHostelNotificationCampaign(), createPlatformNotificationCampaign() (+46 more)
...
Cohesion: 0.06
Nodes (57): formatPeriodKey(), cellAt(), focusCell(), INPUT_MODES, Props, fullYear(), MONTH_SPELLINGS, monthFromWord() (+49 more)

### Community 77 - "Community 77"
Cohesion: 0.05
Nodes (44): CommunityPageContent(), FeedPayload, NewPostAlertsToggle(), SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+36 more)

### Community 78 - "Community 78"
Cohesion: 0.06
Nodes (45): Notification, BrowserPushRow(), FILTERS, Notification, NotificationRow(), PushState, FILTERS, NotificationCard (+37 more)

### Community 79 - "Community 79"
Cohesion: 0.06
Nodes (51): deliver(), loadInvoiceById(), loadProof(), PlanPaymentInstructions, ProofAsset, reviewPlanPaymentClaim(), submitPlanPaymentClaim(), InvoiceRecord (+43 more)

### Community 80 - "Community 80"
Cohesion: 0.08
Nodes (51): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags() (+43 more)

### Community 81 - "Community 81"
Cohesion: 0.07
Nodes (49): storeCategorySchema, storeProductSchema, categoriesFor(), escapeRegex(), getStoreHome(), getStoreProduct(), getStoreShelves(), ListQuery (+41 more)

### Community 82 - "Community 82"
Cohesion: 0.06
Nodes (35): HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminRoomsPageContent(), PlatformDashboardPageContent(), PlatformUsersPageContent(), DashboardCard(), DashboardCardProps, PlatformServiceProvidersPageContent() (+27 more)

### Community 83 - "Community 83"
Cohesion: 0.05
Nodes (49): continueLabel(), isBlank(), buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, draftFromProfile() (+41 more)

### Community 84 - "Community 84"
Cohesion: 0.06
Nodes (42): CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, isPlanDueNotification(), readId(), activeDevicesFor(), activeTokensFor(), androidChannel() (+34 more)

### Community 85 - "Community 85"
Cohesion: 0.06
Nodes (40): Offset, PhotoCropper(), buildIdCardData(), EMAIL_CHECK_HINTS, EmailCheck, Field(), FIELD_LABELS, formatCardDate() (+32 more)

### Community 86 - "Community 86"
Cohesion: 0.09
Nodes (37): bodySchema, POST(), computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, SystemDocumentKind (+29 more)

### Community 87 - "Community 87"
Cohesion: 0.09
Nodes (41): BOOKING_DOCUMENT_KINDS, BookingDocumentKind, bookingDocumentLayout(), refundPolicyNotes(), allowed(), bookingDocumentResponse(), BookingDocumentScope, resolveBookingDocument() (+33 more)

### Community 88 - "Community 88"
Cohesion: 0.05
Nodes (35): PortalDates, useHostelDayTurn(), AdminNightStatusRow, PlanBilling, PlanBillingInvoice, PlanBillingPayment, PlanBillingPlan, filterRollCall() (+27 more)

### Community 89 - "Community 89"
Cohesion: 0.06
Nodes (22): LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminNoticesPage(), HostelAdminPaymentsPage(), redirectToWorkspaceScreen() (+14 more)
...
Cohesion: 0.08
Nodes (40): cookLoginStem(), generateCookPassword(), mintCookLogin(), pick(), previousCookLabel(), acceptCookInvitation(), addCookAccount(), assertRoomForAnotherCook() (+32 more)
...
Cohesion: 0.06
Nodes (24): field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminMoveChecklistPage(), LoadState, NightStatusRow, Notification, NotificationsPageContent() (+16 more)

### Community 94 - "Community 94"
Cohesion: 0.14
Nodes (37): BookingDocumentInput, renderBookingDocument(), bsFiscalYear(), amountInWords(), GROUPS, ONES, TENS, underHundred() (+29 more)

### Community 95 - "Community 95"
Cohesion: 0.08
Nodes (40): storeOrderSchema, mocks, allocateOrderNumber(), applyStatus(), CancelInput, cancelOrder(), CreateInput, hostelNames() (+32 more)
...
Cohesion: 0.06
Nodes (28): summarizeResidentComplaints(), listResidentInvoices(), bedSchema, emergencyContactSchema, foodMenuSchema, guardianSchema, noticeSchema, paymentSchema (+20 more)
...
Cohesion: 0.06
Nodes (31): applyBookingConfig(), bookingConfigSchema, PLATFORM_SETTING_CHANGE_STATUSES, platformSettingChangeSchema, bookings, CollectionQr, isSettingChangeKey(), SETTING_CHANGES (+23 more)
...
Cohesion: 0.08
Nodes (37): formatNPR(), drawCertificationStamp(), footerLine(), formatDate(), formatLongDate(), MONTHS, ReceiptPdfInput, renderReceiptPdf() (+29 more)

### Community 104 - "Community 104"
Cohesion: 0.11
Nodes (34): PreviewCard(), ResultRow(), FACILITY_ICONS, facilityIcon(), facilityKey(), HostelCard(), SaveButton(), HeadCell() (+26 more)

### Community 105 - "Community 105"
Cohesion: 0.09
Nodes (33): roomSchema, auditMoveAction(), createMoveInChecklist(), createMoveOutChecklist(), findAdminResident(), getMoveInChecklist(), getMoveOutChecklist(), getResidentMoveChecklists() (+25 more)

### Community 106 - "Community 106"
Cohesion: 0.07
Nodes (39): AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance(), deadline(), DIGIT_CONFUSABLES, EvidenceRead (+31 more)

### Community 107 - "Community 107"
Cohesion: 0.1
Nodes (11): Claim, CouldNotCreateFileException, HostelHubDownloadsModule, HostelPalikaDownloadsModule, NoContextException, NothingOpensThisException, UnreadableSourceException, UnsupportedOnThisAndroidException (+3 more)
...
Cohesion: 0.06
Nodes (26): currency(), Select(), TextArea(), ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent, Complaint (+18 more)

### Community 110 - "Community 110"
Cohesion: 0.09
Nodes (31): fail(), findHostelForCheckout(), HostelMatch, paymentState(), PlanCheckoutInput, planCheckoutSchema, readCheckoutToken(), runPlanCheckout() (+23 more)

### Community 111 - "Community 111"
Cohesion: 0.07
Nodes (31): buildHtml(), Marker, PlaceMarker, boundsCenter(), haversineMeters(), hostelCoordinates(), HostelWithDistance, KATHMANDU (+23 more)
...
Cohesion: 0.13
Nodes (32): resolvePastedLink(), searchCandidates(), lookupLocation(), resolvePastedLink(), searchCandidates(), AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim() (+24 more)

### Community 116 - "Community 116"
Cohesion: 0.08
Nodes (29): loadContext(), formatBsPeriod(), formatBsPeriodYear(), isBsPeriod(), periodParts(), liveUserIds(), notifyRateCardChanged(), ratesByRoomType() (+21 more)
...
Cohesion: 0.1
Nodes (31): GuidanceStatus, cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath(), hasArrived(), headingDifference() (+23 more)
...
Cohesion: 0.07
Nodes (22): EmptyState(), LoadingRows(), StatusBadge(), field(), HostelAdminReferralsPageContent(), HostelAdminReportsPageContent(), ListingFlag, LoadState (+14 more)

### Community 123 - "Community 123"
Cohesion: 0.09
Nodes (32): proximityScore(), cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath(), formatManeuverDistance(), hasArrived() (+24 more)

### Community 124 - "Community 124"
Cohesion: 0.1
Nodes (31): qrActivationSchema, activateResident(), ActivationCodeGenerateInput, ActivationCodeInput, activationSecret(), ActivationServiceError, ActivationStatus, ActivationStatusQuery (+23 more)
...
Cohesion: 0.08
Nodes (30): countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor(), LedgerInvoiceRow (+22 more)
...
Cohesion: 0.08
Nodes (21): metadata, navItems, metadata, navItems, GUARDIAN_NAV, GUARDIAN_SEARCH_ENTRIES, HOSTEL_ADMIN_NAV, HOSTEL_ADMIN_SEARCH_ENTRIES (+13 more)

### Community 130 - "Community 130"
Cohesion: 0.11
Nodes (27): bsMonthStart(), hostelCalendarDay(), hostelToday(), hostelCalendarDay(), hostelMonthStart(), hostelToday(), once, isActiveReferralCode() (+19 more)

### Community 131 - "Community 131"
Cohesion: 0.09
Nodes (28): addBsMonths(), august, bhadra, hostelId, invoice(), mocks, NOW, periodAgo() (+20 more)
...
Cohesion: 0.09
Nodes (22): Choice, HOSTEL_TYPE_LABELS, HostelPanel(), MapButton(), MapCanvas, ModeTab(), NavigationPanel(), NOTHING_CHOSEN (+14 more)
...
Cohesion: 0.11
Nodes (27): UploadCard(), useIsUploading(), dismissUpload(), emit(), isUploadActive(), listeners, pruneUploads(), resetUploadQueue() (+19 more)
...
Cohesion: 0.09
Nodes (19): discountPercent(), formatPaisa(), slugify(), StoreCategory, StoreProduct, toPaisa(), toRupees(), Row (+11 more)
...
Cohesion: 0.11
Nodes (26): accountDeletionRequestedEmail(), AccountDeletionError, applyImmediateEffects(), cancelAccountDeletionByToken(), cancelAccountDeletionForUser(), cancelUrlFor(), DeletionPathway, DeletionRequestRecord (+18 more)
...
Cohesion: 0.08
Nodes (20): LegacyHostelAdminComplaintsPage(), Complaint, ComplaintSummary, field(), FoodMenu, HostelAdminComplaintsPage(), HostelAdminFoodPage(), HostelAdminResidentsPage() (+12 more)
...
Cohesion: 0.16
Nodes (26): changeLabel(), Column, count(), Figure, figureRow(), fittedSize(), hairline(), Ink (+18 more)

### Community 146 - "Community 146"
Cohesion: 0.13
Nodes (24): GuardianHomeScreen(), GuardianMetrics(), GuardianPaymentsScreen(), GuardianSafetyScreen(), GuardianPayment, GuardianPermissions, canSee(), GUARDIAN_PERMISSION_LABELS (+16 more)
...
Cohesion: 0.07
Nodes (23): allBlank, blankable, parsed, paths, result, validProfile, without, assetId (+15 more)
...
Cohesion: 0.08
Nodes (21): ComparePage(), generateMetadata(), hostels, metadata, rows, PublicComparePage(), PublicHostelListingPageContent(), PublicHostelQueryParams (+13 more)
...
Cohesion: 0.13
Nodes (20): ApiFailure, EXTENSION_MIME, isAudio(), PickedFile, resolveFileName(), resolveMimeType(), name, formatMegabytes() (+12 more)

### Community 160 - "Community 160"
Cohesion: 0.12
Nodes (20): CheckoutHandoffButton(), Handoff, ORDER, ProgressStep, ProgressSteps(), TransitionScreen(), useCheckoutHandoff(), PayPlanPanel() (+12 more)
...
Cohesion: 0.14
Nodes (19): FILE_ASSET_KINDS, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), isPlatformOnlyAssetKind(), PLATFORM_ONLY_KINDS, DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES (+11 more)

### Community 163 - "Community 163"
Cohesion: 0.12
Nodes (20): chelseaMarket, geistMono, geistSans, metadata, poppins, RootLayout(), MediaViewerProvider(), NotificationSoundListener() (+12 more)
...
Cohesion: 0.12
Nodes (18): HostelGeoRecord, sleep(), geocodeAddress(), geocodeWithGoogle(), geocodeWithNominatim(), HostelGeoLocation, resolveHostelGeo(), fetchNearbyPlaces() (+10 more)

### Community 167 - "Community 167"
Cohesion: 0.09
Nodes (15): accountDeletionRequestSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, questionCallClickSchema, sessionSchema, purgeAccount(), runAccountDeletionPurge() (+7 more)

### Community 168 - "Community 168"
Cohesion: 0.1
Nodes (19): DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), axisMonth(), monthLabel(), describePreference() (+11 more)

### Community 169 - "Community 169"
Cohesion: 0.16
Nodes (23): storeCartSchema, AddInput, addToCart(), CartItemRecord, CartRecord, clearCart(), emptyCart(), getCart() (+15 more)
...
Cohesion: 0.17
Nodes (21): nepalMinuteOfDay(), nightStatusPromptSchema, askingEndsMinuteOfNight(), formatPromptTime(), minuteIsDue(), minuteOfNight(), parsePromptTime(), promptIsDue() (+13 more)
...
Cohesion: 0.09
Nodes (20): aswin, bhadra, bs(), card(), currentId, hostelId, inAswin, inOctober (+12 more)
...
Cohesion: 0.16
Nodes (21): directionOf(), EMPTY_TALLY, floorToStep(), phaseOf(), shouldRepost(), tallyUploads(), UploadNotice, UploadPhase (+13 more)
...
Cohesion: 0.14
Nodes (19): Choice, Compass(), maneuverIcon(), MapButton(), ModeTab(), NavCard(), NOTHING_CHOSEN, RouteCard() (+11 more)
...
Cohesion: 0.14
Nodes (9): GoogleMap, HostelMap(), LeafletMap, TYPE_COLORS, Coordinates, GeocodePrecision, MapProvider, NearbyPlace (+1 more)
...
Cohesion: 0.13
Nodes (18): isUsableCoordinate(), fetchRoadRoute(), isRecord(), parseRoadRoute(), parseSteps(), RoadRoute, ROUTE_MODES, ROUTERS (+10 more)

### Community 204 - "Community 204"
Cohesion: 0.12
Nodes (18): buildPage(), buildPinPage(), CentrePin(), describeAddress(), HostelPinPicker(), KATHMANDU, MapLinkField(), PickerBody() (+10 more)

### Community 205 - "Community 205"
Cohesion: 0.13
Nodes (14): PlatformHostelsPageContent(), PlatformHostelsPageContent, PortalExperiencePage(), PortalPlaceholderAction, PortalPlaceholderPage(), PortalPlaceholderPageProps, pendingHostels, PlatformHostel (+6 more)

### Community 206 - "Community 206"
Cohesion: 0.2
Nodes (17): CookieReader, hasSessionCookie(), LEGACY_ACCESS_TOKEN_COOKIES, LEGACY_REFRESH_TOKEN_COOKIES, readAccessTokenCookie(), readRefreshTokenCookieValue(), accessSecret(), isSoftSessionPath() (+9 more)
...
Cohesion: 0.15
Nodes (13): formatDistance(), hostelCoordinates(), isUsableCoordinate(), KATHMANDU, hasGeolocation(), LocationOutcome, NavigationFix, OrientationPermission (+5 more)

### Community 217 - "Community 217"
Cohesion: 0.12
Nodes (17): bsPeriodsBetween(), getResidentLedger(), monthsBetween(), periodOf(), ResidentDoc, ResidentLedger, ResidentLedgerMonth, ResidentLedgerPayment (+9 more)

### Community 218 - "Community 218"
Cohesion: 0.13
Nodes (16): daysFromNow(), enabledPermissionLabels(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags, GuardianPermissionsUpdateInput, GuardianRecord (+8 more)

### Community 219 - "Community 219"
Cohesion: 0.14
Nodes (15): getResidentReferral(), login(), ResidentReferral, ResidentReferralCode, submitResidentReview(), triggerSOS(), RootStackParamList, LoginScreen() (+7 more)

### Community 220 - "Community 220"
Cohesion: 0.14
Nodes (17): ApiFailure, ApiSuccess, AuthUser, getResidentNightStatus(), listResidentFood(), ResidentFoodMenu, ResidentFoodPhoto, ResidentFoodRoutine (+9 more)

### Community 221 - "Community 221"
Cohesion: 0.15
Nodes (20): code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface INotice {), code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {), code:typescript ({), code:typescript (interface IMoveInChecklistItem {), code:typescript (interface IMoveOutChecklistItem {) (+12 more)
...
Cohesion: 0.18
Nodes (12): averageRating(), cityCount(), group(), HomeStat, homeStats(), rated, stats, vacantBeds() (+4 more)

### Community 225 - "Community 225"
Cohesion: 0.18
Nodes (14): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, metadata, isAuthBypassEnabled(), original, canAccessWorkspace(), defaultWorkspaceSlug(), isAuthBypassed() (+6 more)
...
Cohesion: 0.16
Nodes (13): oauthAccountSchema, deleteTeamMember(), endSessions(), findMember(), MemberRecord, removeTeamMember(), suspendTeamMember(), TeamMemberError (+5 more)
...
Cohesion: 0.13
Nodes (19): 1.0 Signup One-Time Code, 1.2 Hostel Admin Credentials (Post-Approval), 1.3 Warden Credentials, 1.4 Resident QR Activation, 1.5 Guardian Invitation, 1.6 Password Reset, 1.7 Account Upgraded, 1. Authentication & Account Emails (+11 more)
...
Cohesion: 0.13
Nodes (16): digitsOnly(), extractPayee(), matchesIdentity(), NAME_STOPWORDS, nameTokens(), PayeeRead, PayeeVerdict, ProfileLike (+8 more)
...
Cohesion: 0.13
Nodes (14): isCurrentNight(), isSameNight(), nightEndsAt(), nightAnswerData(), { body, title }, chase, due, first (+6 more)
...
Cohesion: 0.15
Nodes (7): ExistingResidentsPanel(), Props, ExistingResidentsSheet(), HostelAdminExistingResidentsPage(), TeamHostelResidentsPage(), useWorkspaceHref(), Props

### Community 250 - "Community 250"
Cohesion: 0.19
Nodes (15): softmatoDocsUrl(), dueBhadra29, filed, throughAswin25, BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan (+7 more)

### Community 251 - "Community 251"
Cohesion: 0.18
Nodes (12): teamWalletEntrySchema, fit_width(), Builds the launch-screen art: the logo lockup and the "Powered by" strip.  Run f, commissionFor(), creditTeamCommission(), getAgentWallet(), payoutSchema, recordTeamPayout() (+4 more)
...
Cohesion: 0.18
Nodes (15): deliver(), emailFacts(), hostelOrThrow(), notifyPlatformOfPayoutReview(), PayoutAccountStatus, PayoutAccountView, PayoutActor, PayoutRecord (+7 more)
...
Cohesion: 0.23
Nodes (17): AuditLog, code:typescript ({), code:typescript ({), code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({), FoodReadyLog, Notification (+9 more)
...
Cohesion: 0.17
Nodes (13): invoiceRow(), notice, objectId(), opened, overdue, paymentProofRecord(), paymentRecord(), receiptRecord() (+5 more)
...
Cohesion: 0.18
Nodes (13): active, done, down(), failed, finished, first, next, notice (+5 more)
...
Cohesion: 0.14
Nodes (12): accessId, accessQuery, adminPrincipal, codes, guardianId, guardianPrincipal, leanResult(), liveAccessId (+4 more)
...
Cohesion: 0.2
Nodes (15): code:typescript (interface IServiceProvider {), code:typescript (interface IServiceProvider {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IInquiry {), MaintenanceRequest, Move-in / Move-out, MoveInChecklist (+7 more)
...
Cohesion: 0.19
Nodes (12): categoryLabel(), PROVIDER_CATEGORIES, ProviderCard(), ProviderDirectoryData, PublicProvider, PublicServiceProviderDirectoryPage(), ServiceProviderRegistrationPage(), DirectoryPageProps (+4 more)

### Community 298 - "Community 298"
Cohesion: 0.19
Nodes (10): PLATFORM_MODERATOR_NAV, PLATFORM_MODERATOR_SEARCH_ENTRIES, PLATFORM_NAV, PLATFORM_SEARCH_ENTRIES, moderatorHrefs, websiteConfig, sessionRole(), metadata (+2 more)
...
Cohesion: 0.14
Nodes (8): authorUserId, mocks, postId, residentId, residentPrincipal, staffPrincipal, BLOCKED, PATTERN
...
Cohesion: 0.15
Nodes (14): 0.1 The shared Softmato domain, 0.2 Categories — which mailbox a message comes from, 0.2a Where replies go, 0.3 Where the sender is configured, 0.4 Template structure, 0.5 The look, 0. Sending Infrastructure, 1.1 Email Verification (PUBLIC Signup) (+6 more)

### Community 305 - "Community 305"
Cohesion: 0.2
Nodes (14): 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, 7.2 Subscription Expiring Soon, 9.1 Account Deletion Requested, code:typescript ({) (+6 more)

### Community 306 - "Community 306"
Cohesion: 0.16
Nodes (14): 2.2 Hostel Approved, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails, 4.3 Complaint Resolved (+6 more)
...
Cohesion: 0.26
Nodes (9): listRecentInvoices(), approvalPeriod(), getPeriodSummary(), monthsBetween(), periodOf(), PeriodRow, PeriodSummary, countableResidentIds() (+1 more)
...
Cohesion: 0.18
Nodes (12): 7.1 Attendance Alert (Resident Absent), 7.1 New Hostel Pending Approval (to Superadmin), 7. Attendance & Location Tracking Emails, 7. Platform Admin Emails, 8.1 Community Post Engagement (Batched), 8. Community & Notification Emails, code:typescript ({), code:typescript ({) (+4 more)
...
Cohesion: 0.18
Nodes (9): AuthSession, register(), verifyOtp(), AppNavigator(), Stack, OtpVerificationScreen(), Props, ResidentComplaintsScreen() (+1 more)
...
Cohesion: 0.18
Nodes (8): cook, createUser(), createUserDoc(), MockSessionModel, owner, serviceMocks, session, user
...
Cohesion: 0.38
Nodes (12): code:typescript (interface IHostelPageView {), code:typescript (// One per resident, per hostel. Minted lazily on first dash), code:typescript (interface ISubscription {), code:typescript (interface IPlatformSetting {), code:typescript (interface IAuditLog {), HostelPageView, Inquiries, Referral, Notifications, Subscriptions, Inquiry (+4 more)
...
Cohesion: 0.18
Nodes (8): refreshedSnapshots(), fresh, gone, items, next, present, snapshot, stale
...
Cohesion: 0.24
Nodes (9): buildHostelPayload(), capacitySummary(), firstIncompleteHostelStep(), numberValue(), RULES_TEMPLATES, complete, long, many (+1 more)
...
Cohesion: 0.36
Nodes (8): hashUserAgent(), HostelRef, newVisitorKey(), recordHostelPageView(), resolveVisitorKey(), evaluateProfilePrompt(), POST(), RouteContext
...
Cohesion: 0.27
Nodes (9): EMPTY, ensureConfigured(), sendWebPush(), statusCodeOf(), VapidConfig, WebPushPayload, webPushPublicKey(), WebPushResult (+1 more)
...
Cohesion: 0.2
Nodes (10): 10.1 GitHub Actions Workflow, 10.2 Merge Rules, 10. CI/CD Integration, 7.3 Privacy/Guardian Permissions Test Template, 9.2 Test Database Isolation, code:typescript (describe('GET /api/v1/guardian/linked-resident - privacy', (), code:typescript (// In test setup (e.g., jest.setup.ts)), code:yaml (# .github/workflows/test.yml) (+2 more)
...
Cohesion: 0.22
Nodes (9): 6.3 Role-Based Access Control (Every Endpoint), 7.4 Account-Upgrade Test Template, 9.1 Seed Scripts, 9.3 Test Helpers, 9. Test Data & Seeding, code:typescript (describe('POST /api/v1/hostel/residents - account upgrade', ), code:typescript (// tests/helpers/auth.ts), code:bash (npm run test) (+1 more)
...
Cohesion: 0.36
Nodes (6): CityCard(), ALIASES, CITY_IMAGES, cityImageUrl(), normalizeCity(), kathmandu
...
Cohesion: 0.25
Nodes (3): hostelId, mocks, providerId
...
Cohesion: 0.25
Nodes (8): 4.1 New Notice Posted, 4.2 Complaint Status Updated, 4. Resident Activity Emails, 5.1 SOS Triggered, 5. Safety & Emergency Emails, code:typescript ({), code:typescript ({), code:typescript ({)
...
Cohesion: 0.43
Nodes (6): HostelForm, clearRegistrationDraft(), DraftKind, keyFor(), readRegistrationDraft(), saveRegistrationDraft()
...
Cohesion: 0.29
Nodes (5): hostelId, mocks, receiptId, residentId, verified
...
Cohesion: 0.33
Nodes (7): 2.1 Hostel Submission Received, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, 3.3 Payment Proof Uploaded (to Admin), code:typescript ({), code:typescript ({), code:typescript ({)
...
Cohesion: 0.4
Nodes (4): SavedHostel, initialState, savedSlice, SavedState
...
Cohesion: 0.4
Nodes (4): activateResident(), Props, ResidentActivationScreen(), styles
...
Cohesion: 0.5
Nodes (4): 9.1a Account Deletion Request Needs Review *(added 2026-08-02)*, 9.2 Account Deletion Cancelled, 9.3 Location History Deletion Approved, 9. Account & Privacy Emails
...
## Knowledge Gaps
- **6495 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+6490 more)
...
- **Why does `cn()` connect `Community 31` to `Community 1`, `Community 4`, `Community 133`, `Community 134`, `Community 7`, `Community 11`, `Community 142`, `Community 15`, `Community 16`, `Community 19`, `Community 22`, `Community 152`, `Community 25`, `Community 154`, `Community 160`, `Community 35`, `Community 38`, `Community 42`, `Community 44`, `Community 57`, `Community 61`, `Community 319`, `Community 64`, `Community 76`, `Community 77`, `Community 78`, `Community 82`, `Community 85`, `Community 96`, `Community 249`, `Community 121`, `Community 122`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 1` to `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 13`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 22`, `Community 24`, `Community 29`, `Community 31`, `Community 34`, `Community 38`, `Community 39`, `Community 43`, `Community 51`, `Community 53`, `Community 191`, `Community 204`, `Community 77`, `Community 78`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 5` to `Community 0`, `Community 2`, `Community 386`, `Community 130`, `Community 10`, `Community 11`, `Community 12`, `Community 139`, `Community 14`, `Community 140`, `Community 21`, `Community 23`, `Community 26`, `Community 27`, `Community 30`, `Community 32`, `Community 33`, `Community 162`, `Community 36`, `Community 37`, `Community 166`, `Community 167`, `Community 40`, `Community 41`, `Community 169`, `Community 45`, `Community 46`, `Community 47`, `Community 48`, `Community 49`, `Community 50`, `Community 174`, `Community 52`, `Community 54`, `Community 55`, `Community 58`, `Community 59`, `Community 188`, `Community 62`, `Community 63`, `Community 64`, `Community 65`, `Community 322`, `Community 67`, `Community 68`, `Community 69`, `Community 197`, `Community 71`, `Community 66`, `Community 73`, `Community 74`, `Community 79`, `Community 80`, `Community 81`, `Community 84`, `Community 87`, `Community 217`, `Community 218`, `Community 91`, `Community 95`, `Community 225`, `Community 98`, `Community 97`, `Community 100`, `Community 228`, `Community 103`, `Community 105`, `Community 110`, `Community 240`, `Community 114`, `Community 250`, `Community 251`, `Community 124`, `Community 254`?**
