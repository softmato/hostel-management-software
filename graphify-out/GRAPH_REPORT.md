...
## Corpus Check
- 2327 files · ~4,846,977 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18669 nodes · 52510 edges · 580 communities (548 shown, 32 thin omitted)
...
- `generateMetadata()` --calls--> `getListingTier()`  [INFERRED]
  apps/web/src/app/(public)/plans-pricing/badge/[tier]/page.tsx → packages/shared/src/plans/catalog.ts
- `ListingBadgePage()` --calls--> `getListingTier()`  [INFERRED]
  apps/web/src/app/(public)/plans-pricing/badge/[tier]/page.tsx → packages/shared/src/plans/catalog.ts
...
## Communities (580 total, 32 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (293): Scanner(), FaqRow(), MethodCard(), CookInviteScreen(), GuardianInviteScreen(), Choice, MapButton(), MapScreen() (+285 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (207): ICONS, LABELS, Segment, TONES, FILTERS, Pending, Overview, MoneyData (+199 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (326): loadOverview(), loadMoney(), loadToday(), METHODS, PackageCard(), PayStep(), roomPhotoUris(), StatusCard() (+318 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (191): FieldCashRow, PlanPaymentClaim, AccountDeletionPanel, DeletionPathway, DeletionStatus, PATHWAY_COPY, Filter, ModeratedPost (+183 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (241): robots(), otpResendCooldownMs(), requestOtpChallenge(), verifyOtpChallenge(), checkoutDocumentFor(), softmatoDocumentNumbers(), gateway, invoice (+233 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (174): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, notifyHostelOfNewPost(), resolveHostelCommunityUserIds() (+166 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (158): BubbleBackground(), BubbleBackgroundProps, BubbleColors, StarLayer(), StarLayerProps, StarsBackground(), StarsBackgroundProps, AVATAR_MOTION_TRANSITION (+150 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (170): listResidentComplaints(), getOpenFeeSchedule(), outstandingForResident(), listFoodForResident(), submitFoodFeedback(), uploadFoodPhoto(), listHostelAdminInquiries(), getHostelAdminProfile() (+162 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (130): PATCH(), POST(), RouteContext, GET(), PATCH(), RouteContext, GET(), POST() (+122 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (151): POST(), POST(), answerSchema, POST(), attacker, attempt(), headers, jsonRequest() (+143 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (168): listPublicFoodRoutine(), addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery, HostelAdminInquiryStatusInput, InquiryNoteCreateInput, InquiryNoteRecord (+160 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (138): Platform, EMPTY_SUMMARY, ConcessionBackfill, describeApplied(), FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, MonthDiscounts (+130 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (113): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, CITY_OPTIONS, FACILITY_STATS (+105 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (140): adminPrincipal, mocks, PLATFORM_LIMITS, assertPlanRoom(), countLive(), notifyLimitReached(), NOUN, PlanLimitError (+132 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (148): FILTERS, invalidateFeeds(), NIGHT_ANSWER_LABELS, nightAnswerText(), NightPromptAnswer(), NotificationRow(), TILE_GLYPH, TILE_TONES (+140 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (143): GET(), POST(), GET(), GET(), POST(), createExpertConsultationRequest(), ExpertConsultationCreateInput, ExpertConsultationError (+135 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (138): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), manifest() (+130 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (125): POST(), POST(), POST(), POST(), GET(), POST(), bookingDocumentResponse(), bulkApproveSchema (+117 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (149): formatBsPeriod(), formatBsPeriodYear(), isBsPeriod(), periodParts(), PaymentMonthStrip(), CreditRow(), ManageStatementScreen(), METHOD_ICONS (+141 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (128): PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), GET(), POST(), RouteContext, GET(), DELETE() (+120 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (113): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CancelDeletionPageContent(), AcceptResult, CookInvitePageContent, field() (+105 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (114): ApplyBlock(), ServiceProvidersScreen(), DocumentScreen(), MobileLegal, InfoActions(), InfoHeader(), InfoHighlights(), InfoIcon (+106 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (121): HostelAdminCommunityPageContent, HostelAdminComplaintsPage, HostelAdminDashboardPageContent, HostelAdminFeePlansPageContent, HostelAdminInquiriesPageContent, HostelAdminMaintenancePageContent, PRIORITIES, STATUS_ACTIONS (+113 more)

### Community 23 - "Community 23"
Cohesion: 0.02
Nodes (129): CommunityPageContent(), grabDocument(), AddressFields, FORM_SECTIONS, HostelAdminProfilePageContent, PendingPhoto, PHOTO_LIMITS, SectionDef (+121 more)

### Community 24 - "Community 24"
Cohesion: 0.02
Nodes (154): AdminAlertsScreen(), AdminCommunityReportsScreen(), AdminHomeScreen(), AdminOverviewScreen(), AdminMoneyScreen(), AdminMoreScreen(), AdminResidentsScreen(), AdminTodayScreen() (+146 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (94): GET(), POST(), POST(), PATCH(), RouteContext, GET(), listPayoutAccounts(), reviewHostelPayoutAccount() (+86 more)

### Community 26 - "Community 26"
Cohesion: 0.02
Nodes (121): cookPrincipal, mocks, resolveCookLabels(), CookServiceError, resolveAdminHostelId(), announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord (+113 more)
...
Cohesion: 0.03
Nodes (104): AdminCommunityScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+96 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (103): getHostelPayoutAccount(), POST(), RouteContext, DELETE(), GET(), hostelId(), GET(), POST() (+95 more)

### Community 30 - "Community 30"
Cohesion: 0.02
Nodes (89): generateMetadata(), metadata, RefundPolicy, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections() (+81 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (114): ReviewForm(), ReviewScreen(), DeletionPanel(), AttachmentGallery(), DeletionRequest, DeletionStatus, getDeletionStatus(), requestAccountDeletion() (+106 more)

### Community 32 - "Community 32"
Cohesion: 0.07
Nodes (82): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), subscriptionClaimReceivedEmail(), subscriptionClaimRejectedEmail() (+74 more)

### Community 33 - "Community 33"
Cohesion: 0.02
Nodes (106): demoteToPublicAccount(), LIVE_ACCESS, releaseGuardianAccounts(), hostelId, mocks, userId, guardianAccessSchema, activeCode (+98 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (94): Choice, HOSTEL_TYPE_LABELS, MapButton(), MapCanvas, ModeTab(), NavigationPanel(), NOTHING_CHOSEN, PublicMapPage() (+86 more)

### Community 35 - "Community 35"
Cohesion: 0.02
Nodes (94): EMPTY_PAYOUT_DRAFT, METHODS, PayoutAccountDraft, PayoutAccountFields(), payoutAccountPayload(), DescriptionFacts, DescriptionSuggestions(), HostelType (+86 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (99): collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor() (+91 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (98): bsMonthStart(), BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, aswin (+90 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (73): AdminTabs(), HIDDEN, RoleLayout(), TABS, SosScreen(), TABS, AdminAlertsProvider(), AdminSearchBar() (+65 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (87): openStore(), BootGate(), RootShell(), BootSplashCover(), BrandSplash(), LOGO_HEIGHT, styles, AuthDivider() (+79 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (67): POST(), GET(), GET(), POST(), recordListingAppearances(), bedCreateSchema, floorCreateSchema, hostelAdminGeocodeQuerySchema (+59 more)
...
Cohesion: 0.04
Nodes (85): isLive(), loadContext(), sendPlanDueReminders(), formatBsPeriodMonth(), axisMonth(), composeFeeDueNotice(), Due, InvoiceRow (+77 more)

### Community 43 - "Community 43"
Cohesion: 0.03
Nodes (81): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult (+73 more)

### Community 44 - "Community 44"
Cohesion: 0.03
Nodes (81): currentBsPeriod(), OfferTab(), Faq, PlatformConfigSeoPageContent, Step, CONTENT_ICON_SLUGS, everything, IDENTITY (+73 more)
...
Cohesion: 0.06
Nodes (80): BOOKING_DOCUMENT_KINDS, BookingDocumentInput, BookingDocumentKind, renderBookingDocument(), bsFiscalYear(), amountInWords(), GROUPS, ONES (+72 more)
...
Cohesion: 0.03
Nodes (51): deleteHostelObjects(), ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, purgeArchivedHostel(), purgeHostel() (+43 more)
...
Cohesion: 0.04
Nodes (60): AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, onPlanSuspensionStarted(), findSuspendedHostelIds(), liftHostelSuspension() (+52 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (59): BookButton(), SIZE, BookingAvailabilityView, BookingButton, CLOSED_REASONS, open, HostelSuggestions(), formatHostelAddress() (+51 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (64): AdminAlertsContext, AdminAlertsValue, AlertActions, EMPTY_COUNTS, ICONS, LABELS, QUICK_REJECT_REASONS, TONES (+56 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (57): BookingQuote, GuestBookingDetail, GuestBookingSummary, metadata, BookingCheckoutPage(), Method, METHODS, nextStep() (+49 more)

### Community 54 - "Community 54"
Cohesion: 0.06
Nodes (69): MESSAGES, POST(), BookingEndCause, HostelBookingClosedCause, announceEnding(), assertAwaitingAnswer(), cancelBookingByHostel(), cancelBookingByPlatform() (+61 more)

### Community 55 - "Community 55"
Cohesion: 0.04
Nodes (59): summarizeResidentComplaints(), addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange(), definedUpdate(), FoodFeedbackInput, FoodFeedbackRecord (+51 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (68): mergeBookingConfig(), bookingDocumentLayout(), refundPolicyNotes(), allowed(), BookingDocumentScope, resolveBookingDocument(), ENDED, getPlatformBooking() (+60 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (62): notifyProviderOfAssignment(), notifyProviderOfMaintenanceNote(), notifyProviderOfStatusChange(), notifyStaffOfJobProgress(), notifyStaffOfNewMaintenanceRequest(), providerUserId(), readableCategory(), RequestLike (+54 more)
...
Cohesion: 0.05
Nodes (62): GATEWAY_ORDER, getHostelPayMethods(), getPayInstructions(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod (+54 more)

### Community 61 - "Community 61"
Cohesion: 0.06
Nodes (59): resolvePastedLink(), searchCandidates(), geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), lookupLocation(), resolvePastedLink() (+51 more)

### Community 62 - "Community 62"
Cohesion: 0.05
Nodes (64): Assurance(), fill(), money(), PlanCard(), PricingScreen(), metadata, UpgradeDialog(), PlanPicker() (+56 more)
...
Cohesion: 0.05
Nodes (50): BookingPaymentToCheck, TransferView, HostelBookingView, PlatformBookingView, ReviewPayoutAccount(), STATUS_LABEL, List(), ReasonAction() (+42 more)

### Community 67 - "Community 67"
Cohesion: 0.05
Nodes (50): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, attempt (+42 more)

### Community 68 - "Community 68"
Cohesion: 0.05
Nodes (54): GET(), ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+46 more)

### Community 69 - "Community 69"
Cohesion: 0.05
Nodes (51): GET(), escapeRegex(), objectIdSchema, paginationSchema, phoneSchema, SERVICE_PROVIDER_CATEGORIES, serviceProviderSchema, serviceProviderApplicationSchema (+43 more)

### Community 70 - "Community 70"
Cohesion: 0.05
Nodes (61): Resolver, fromHeaderFor(), replyToFor(), resolveEmailIdentity(), fromAddress(), sendEmail(), SendEmailInput, SendEmailResult (+53 more)

### Community 71 - "Community 71"
Cohesion: 0.06
Nodes (40): POST(), POST(), POST(), runPlanDueReminders(), checkoutSchema, POST(), POST(), runBillingCycleForAllHostels() (+32 more)

### Community 72 - "Community 72"
Cohesion: 0.06
Nodes (64): EvidenceEngineMode, AMOUNT_LABELS, canonical(), canonicalDigits(), containsWithTolerance(), deadline(), DIGIT_CONFUSABLES, EvidenceRead (+56 more)

### Community 73 - "Community 73"
Cohesion: 0.04
Nodes (58): BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan, BillingSkip (+50 more)
...
Cohesion: 0.05
Nodes (54): POST(), RealtimeConfig, RealtimeContext, RealtimeContextValue, RealtimeNotification, useRealtime(), notificationCampaignSchema, answer (+46 more)
...
Cohesion: 0.06
Nodes (57): addBsMonths(), formatPeriodKey(), cellAt(), focusCell(), INPUT_MODES, Props, fullYear(), MONTH_SPELLINGS (+49 more)

### Community 79 - "Community 79"
Cohesion: 0.05
Nodes (48): BillingInvoiceRow, BillingPaymentRow, BillingPlan, formatBsAdDate(), CheckoutHandoffButton(), Handoff, ORDER, ProgressStep (+40 more)

### Community 80 - "Community 80"
Cohesion: 0.05
Nodes (51): classifyCredit(), CreditClassification, findOrphanClaims(), LadderClaim, LadderInvoice, loadMatchContext(), MatchContext, normalizeTxnId() (+43 more)

### Community 81 - "Community 81"
Cohesion: 0.05
Nodes (47): POST(), RouteContext, listTrendingTags(), POST(), RouteContext, cookieAccessToken(), isRole(), loadApiPrincipal() (+39 more)
...
Cohesion: 0.06
Nodes (43): Notification, BrowserPushRow(), FILTERS, Notification, NotificationRow(), PushState, FILTERS, NotificationCard (+35 more)

### Community 84 - "Community 84"
Cohesion: 0.05
Nodes (53): buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, draftFromProfile(), emptyIdentityDraft(), firstIncompleteIdentityStep() (+45 more)

### Community 85 - "Community 85"
Cohesion: 0.05
Nodes (46): RouteContext, BookingError, assertSuperadmin(), Destination, listTransfersDue(), loadTransfer(), loadTransferProof(), PayoutAccountRow (+38 more)
...
Cohesion: 0.05
Nodes (46): REALTIME_TOPIC_VALUES, useRealtime(), claimNotificationSound(), claims, resetNotificationSoundClaims(), resetQueryCache(), again, first (+38 more)

### Community 88 - "Community 88"
Cohesion: 0.06
Nodes (47): createResident(), getIntakeQuote(), IntakeQuote, lookupResidentProfile(), RESIDENT_TYPES, ResidentIntakeResult, ResidentOccupancy, ResidentPrefill (+39 more)

### Community 89 - "Community 89"
Cohesion: 0.05
Nodes (39): financeIntegrityHash(), hasProvider(), IntentRow, recheckClosedAttempts(), runSettlementReconForHostel(), SettlementReconSummary, work, computeCreditAmount() (+31 more)
...
Cohesion: 0.07
Nodes (32): HostelAdminInquiriesPageContent(), PlatformHostelReviewPageContent(), DashboardCard(), DashboardCardProps, PlatformDashboardPageContent, PlatformHostelReviewPageContent, PlatformServiceProvidersPageContent, PlatformUsersPageContent (+24 more)
...
Cohesion: 0.07
Nodes (39): DELETE(), POST(), GET(), PATCH(), revokeDeviceToken(), campaignBaseSchema, deviceTokenRevokeSchema, deviceTokenSaveSchema (+31 more)

### Community 94 - "Community 94"
Cohesion: 0.06
Nodes (42): POST(), GET(), GET(), POST(), acceptPlatformAdminInvitation(), AcceptPlatformAdminInvitationInput, appUrl(), checkPlatformAdminEmail() (+34 more)

### Community 95 - "Community 95"
Cohesion: 0.09
Nodes (47): bookingEndedEmail(), bookingInvoiceEmail(), bookingPaymentRejectedEmail(), bookingPaymentVerifiedEmail(), bookingRefundSentEmail(), ENDED_COPY, GuestBase, BookingFacts (+39 more)
...
Cohesion: 0.06
Nodes (23): LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminSOSAlertsPage(), HostelAdminNoticesPage(), HostelAdminResidentsPage(), redirectToWorkspaceScreen() (+15 more)

### Community 98 - "Community 98"
Cohesion: 0.07
Nodes (36): GET(), POST(), RouteContext, listResidentGuardians(), issue(), auditGuardianAction(), createGuardianAccess(), expiresInDays() (+28 more)

### Community 99 - "Community 99"
Cohesion: 0.04
Nodes (40): otpRateLimitMax(), otpRateLimitWindowMs(), DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), monthLabel() (+32 more)

### Community 100 - "Community 100"
Cohesion: 0.05
Nodes (41): findCardBooking(), findHeldBooking(), account, answerBy, before, book(), Booking, compact (+33 more)
...
Cohesion: 0.08
Nodes (33): applyBookingConfig(), BookingCancelStep, bookingCancelStepSchema, BookingConfig, bookingConfigSchema, DEFAULT_BOOKING_CONFIG, DEFAULT_CANCEL_STEPS, percent (+25 more)
...
Cohesion: 0.1
Nodes (37): bodySchema, POST(), ImageVariantRecord, optimizeImage(), streamToBuffer(), VARIANT_CONFIG, VariantName, r2Configured() (+29 more)

### Community 106 - "Community 106"
Cohesion: 0.07
Nodes (40): GuardianMetrics(), GuardianMoreScreen(), GuardianPaymentsScreen(), GuardianSafetyScreen(), LoginResult, acceptGuardianInvitation(), getGuardianFood(), getGuardianNotices() (+32 more)

### Community 107 - "Community 107"
Cohesion: 0.1
Nodes (40): bookingProofReceivedEmail(), BookableHostel, BookingUnavailableReason, findRoom(), hostelAddress(), HostelAvailability, hostelCoverPhoto(), hostelCoverPhotos() (+32 more)

### Community 108 - "Community 108"
Cohesion: 0.06
Nodes (28): currency(), Input(), Panel(), ResidentActivationPageContent, ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent (+20 more)

### Community 109 - "Community 109"
Cohesion: 0.09
Nodes (37): AddInput, addToCart(), CartItemRecord, CartRecord, clearCart(), emptyCart(), getCart(), getCartCount() (+29 more)
...
Cohesion: 0.08
Nodes (39): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags() (+31 more)
...
Cohesion: 0.09
Nodes (36): Compass(), maneuverIcon(), NavCard(), NavigationFix, watchDeviceHeading(), watchNavigationPosition(), cardinalFor(), CARDINALS (+28 more)

### Community 115 - "Community 115"
Cohesion: 0.06
Nodes (30): EvidenceEngine, EvidenceReadFailure, OcrResult, OcrWord, KEYS, saved, IMAGE, lines (+22 more)

### Community 116 - "Community 116"
Cohesion: 0.07
Nodes (35): AnyProps, DOMMotionProps, mergeProps(), mergeRefs(), Slot(), SlotProps, WithAsChild, Align (+27 more)

### Community 117 - "Community 117"
Cohesion: 0.07
Nodes (33): DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity(), NAME_SUFFIX, setEmailIdentityResolver() (+25 more)
...
Cohesion: 0.1
Nodes (29): PublicFooter(), buildCityIndex(), HostelTypeKey, hostelTypeLabel(), LocationCountRow, locationSlug(), configured, index (+21 more)

### Community 128 - "Community 128"
Cohesion: 0.08
Nodes (30): publicHostelApplicationCreateSchema, documents, many, parsed, result, buildProviderPayload(), EMPTY_PROVIDER_FORM, firstIncompleteProviderStep() (+22 more)

### Community 129 - "Community 129"
Cohesion: 0.09
Nodes (34): hostelForm(), buildHostelPayload(), capacitySummary(), emptyHostelForm(), emptyRoomRow(), FACILITY_OPTIONS, firstIncompleteHostelStep(), hasHostelErrors() (+26 more)

### Community 130 - "Community 130"
Cohesion: 0.07
Nodes (22): EmptyState(), Select(), field(), HostelAdminReportsPageContent(), HostelAdminServiceProvidersPageContent(), ListingFlag, LoadState, MaintenanceRequest (+14 more)

### Community 131 - "Community 131"
Cohesion: 0.08
Nodes (28): qrActivationSchema, before, expiresAt, mocks, staffPrincipal, ActivationCodeGenerateInput, ActivationCodeInput, activationSecret() (+20 more)

### Community 132 - "Community 132"
Cohesion: 0.11
Nodes (30): UploadCard(), UploadToaster(), useIsUploading(), useUploads(), dismissUpload(), emit(), getUploadRows(), isUploadActive() (+22 more)
...
Cohesion: 0.19
Nodes (26): ATTACHED, dueWhen(), payOnWebsite(), PlanDueInput, planDueSoonEmail(), planOverdueEmail(), planSuspensionNoticeEmail(), formatRupees() (+18 more)
...
Cohesion: 0.07
Nodes (21): csvField(), field(), Hostel, HostelAdminDashboardPageContent(), HostelAdminProfilePageContent(), Inquiry, LoadState, numberField() (+13 more)
...
Cohesion: 0.07
Nodes (26): nextPlanDueStep(), planRemindsToday(), ALL, base, days, decide(), early, edited (+18 more)

### Community 141 - "Community 141"
Cohesion: 0.11
Nodes (25): PLATFORM_SETTING_CHANGE_STATUSES, platformSettingChangeSchema, isSettingChangeKey(), cancelSettingChange(), ChangeRecord, CLOSED_MESSAGES, confirmSettingChange(), definitionFor() (+17 more)

### Community 142 - "Community 142"
Cohesion: 0.09
Nodes (22): discountRent(), applyConcessionToIssuedInvoices(), ConcessionBackfill, EMPTY, InvoiceLine, settledAmountOf(), bill, hostelId (+14 more)
...
Cohesion: 0.1
Nodes (22): palette, asRecord(), DrawnPush, readDrawnPush(), message, pushData, configureNativeNightPrompt(), registerNightStatusCategory() (+14 more)

### Community 146 - "Community 146"
Cohesion: 0.08
Nodes (20): LegacyHostelAdminComplaintsPage(), Complaint, ComplaintSummary, field(), FoodMenu, HostelAdminComplaintsPage(), HostelAdminFoodPage(), HostelAdminPaymentsPage() (+12 more)
...
Cohesion: 0.11
Nodes (22): TIER_TONE, EASE, PlanCards(), PlanLine(), PlansClosingCta(), PlansEditor, PlansFootnote(), PlansHeading() (+14 more)
...
Cohesion: 0.12
Nodes (21): hostelToday(), teamWalletEntrySchema, fit_width(), Builds the launch-screen art: the logo lockup and the "Powered by" strip.  Run f, commissionFor(), creditTeamCommission(), getAgentWallet(), listTeamWallets() (+13 more)
...
Cohesion: 0.13
Nodes (19): appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind, creditOverpayment(), getCreditAmount(), getCreditBalance(), isDuplicateKey() (+11 more)
...
Cohesion: 0.13
Nodes (23): code:typescript (interface IComplaint {), code:typescript ({), code:typescript (interface IMoveInChecklistItem {), code:typescript (interface IMoveOutChecklistItem {), code:typescript (interface IServiceProvider {), code:typescript (interface IServiceProvider {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IMaintenanceRequest {) (+15 more)
...
Cohesion: 0.1
Nodes (18): body, decoder, EvidenceFields, EvidenceReference, EvidenceStage, FetchLike, lines, message (+10 more)
...
Cohesion: 0.1
Nodes (20): CREDIT_MARKERS, DEBIT_MARKERS, DirectionRead, EvidenceDirection, EvidenceOutcome, matched(), OUTCOME_MARKERS, outcomeRefusal() (+12 more)
...
Cohesion: 0.16
Nodes (15): CityCard(), ALIASES, CITY_IMAGES, cityImageUrl(), normalizeCity(), kathmandu, averageRating(), cityCount() (+7 more)
...
Cohesion: 0.12
Nodes (20): 2.2 Hostel Approved, 2.3 Hostel Rejected, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails (+12 more)
...
Cohesion: 0.13
Nodes (16): categoryLabel(), PROVIDER_CATEGORIES, ProviderCard(), ProviderDirectoryData, PublicProvider, PublicServiceProviderDirectoryPage(), ServiceProviderRegistrationPage(), categories (+8 more)
...
Cohesion: 0.14
Nodes (10): buildFormPostHandoff(), HandoffError, formPostIntent, hostelId, intentId, invoiceId, mocks, residentId (+2 more)
...
Cohesion: 0.18
Nodes (12): AdminNightStatusRow, filterRollCall(), NightStatusValue, OVERRIDE_OPTIONS, ROLL_CALL_SEGMENTS, rollCallCounts(), RollCallSegment, rollCallTone() (+4 more)
...
Cohesion: 0.26
Nodes (14): formatNPR(), drawCertificationStamp(), footerLine(), formatDate(), formatLongDate(), MONTHS, ReceiptPdfInput, renderReceiptPdf() (+6 more)
...
Cohesion: 0.14
Nodes (15): 6.2 Service Provider Approved, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 7.1 Attendance Alert (Resident Absent), 7. Attendance & Location Tracking Emails, 9.1 Account Deletion Requested, 9.1a Account Deletion Request Needs Review *(added 2026-08-02)*, 9.2 Account Deletion Cancelled, 9.3 Location History Deletion Approved (+7 more)
...
Cohesion: 0.21
Nodes (8): computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), systemDocumentKindFromText(), distance, SystemDocumentKind, base
...
Cohesion: 0.18
Nodes (14): 10.1 GitHub Actions Workflow, 7.1 Multi-Tenant Isolation Test Template, 7.2 Role Gate Test Template, 7.3 Privacy/Guardian Permissions Test Template, 7.5 Payment Precision Test Template, 7. Mandatory Test Templates, 9.2 Test Database Isolation, code:typescript (describe('GET /api/v1/hostel/rooms/:id - tenant isolation', ) (+6 more)
...
Cohesion: 0.21
Nodes (10): cook, assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES, PermissionError, Principal, TEAM_ROLES (+2 more)
...
Cohesion: 0.23
Nodes (12): code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface INotice {), code:typescript (interface IComplaintUpdate {), Food, FoodMenu, FoodPhoto, FoodRoutine (+4 more)

### Community 341 - "Community 341"
Cohesion: 0.23
Nodes (12): 1.0 Signup One-Time Code, 1.1 Email Verification (PUBLIC Signup), 1.3 Warden Credentials, 1.4 Resident QR Activation, 1.6 Password Reset, 1.7 Account Upgraded, 1. Authentication & Account Emails, code:typescript (// packages/shared/src/email/templates/payment/payment-overd) (+4 more)
...
Cohesion: 0.22
Nodes (10): apiRequest(), getActivationStatus(), listNotifications(), markNotificationRead(), NotificationItem, refreshSession(), saveDeviceToken(), triggerSOS() (+2 more)
...
Cohesion: 0.25
Nodes (7): HostelRegisterPayload, ProviderRegisterPayload, HostelApplicationStatus, listOwnHostelApplications(), LocationMatch, lookupRegistrationLocation(), OwnHostelApplication
...
Cohesion: 0.25
Nodes (8): 3.3 Payment Proof Uploaded (to Admin), 4.1 New Notice Posted, 5.1 SOS Triggered, 5. Safety & Emergency Emails, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({)
...
## Knowledge Gaps
- **6527 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+6522 more)
...
- **Why does `cn()` connect `Community 6` to `Community 1`, `Community 3`, `Community 260`, `Community 11`, `Community 12`, `Community 16`, `Community 146`, `Community 20`, `Community 23`, `Community 152`, `Community 155`, `Community 156`, `Community 30`, `Community 34`, `Community 35`, `Community 163`, `Community 51`, `Community 53`, `Community 312`, `Community 59`, `Community 62`, `Community 65`, `Community 66`, `Community 78`, `Community 79`, `Community 83`, `Community 91`, `Community 92`, `Community 102`, `Community 108`, `Community 116`, `Community 120`, `Community 126`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 6`, `Community 11`, `Community 14`, `Community 18`, `Community 148`, `Community 21`, `Community 20`, `Community 23`, `Community 155`, `Community 28`, `Community 30`, `Community 31`, `Community 38`, `Community 39`, `Community 41`, `Community 45`, `Community 52`, `Community 61`, `Community 62`, `Community 77`, `Community 83`, `Community 88`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 7` to `Community 131`, `Community 4`, `Community 5`, `Community 8`, `Community 9`, `Community 10`, `Community 13`, `Community 142`, `Community 15`, `Community 143`, `Community 141`, `Community 19`, `Community 26`, `Community 29`, `Community 159`, `Community 33`, `Community 36`, `Community 293`, `Community 166`, `Community 37`, `Community 42`, `Community 43`, `Community 44`, `Community 46`, `Community 47`, `Community 48`, `Community 49`, `Community 50`, `Community 54`, `Community 182`, `Community 56`, `Community 55`, `Community 57`, `Community 60`, `Community 61`, `Community 64`, `Community 65`, `Community 67`, `Community 68`, `Community 196`, `Community 69`, `Community 71`, `Community 199`, `Community 73`, `Community 74`, `Community 70`, `Community 76`, `Community 80`, `Community 81`, `Community 82`, `Community 85`, `Community 89`, `Community 219`, `Community 93`, `Community 94`, `Community 95`, `Community 98`, `Community 103`, `Community 105`, `Community 107`, `Community 237`, `Community 109`, `Community 111`, `Community 118`, `Community 127`?**
