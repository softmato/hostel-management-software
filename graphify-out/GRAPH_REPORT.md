...
## Corpus Check
- 1582 files · ~2,577,200 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12502 nodes · 33927 edges · 458 communities (438 shown, 20 thin omitted)
...
## Communities (458 total, 20 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (185): PATCH(), POST(), RouteContext, POST(), POST(), POST(), recordConsent(), consentSchema (+177 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (238): RouteContext, POST(), POST(), GET(), GET(), POST(), geocodeAndCacheHostel(), HostelGeoRecord (+230 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (234): InquiryFields(), loadFinance(), ActivationIssue, addEmergencyContact(), addHostelPhoto(), addResidentGuardian(), approveMatchedStatement(), assignOrphanPayment() (+226 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (195): AdminMoreScreen(), ActivateScreen(), Scanner(), GuardianInviteScreen(), Choice, Compass(), MapButton(), MapScreen() (+187 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (125): Overview, MANAGE_ROWS, PORTAL_ROWS, Person, needsResident(), OPEN_STATUSES, rank(), GuardianNotShared() (+117 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (134): deferLoad(), DemoDataBadge(), Hostel, HostelTable(), Inquiry, LoadState, Message(), PageHeader() (+126 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (174): DeletionPanel(), NotificationSettings(), SETTINGS_TITLES, THEME_OPTIONS, CookTodayScreen(), DeletionRequest, DeletionStatus, getDeletionStatus() (+166 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (158): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult (+150 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (118): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel() (+110 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (145): AdminAlertsScreen(), ICONS, LABELS, Segment, TONES, AdminHomeScreen(), AdminOverviewScreen(), loadOverview() (+137 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (139): deleteResidentLocationHistory(), getResidentAttendance(), confirmComplaintResolution(), listResidentComplaints(), outstandingForResident(), getFoodRoutine(), getFoodRoutinesByHostelId(), saveFoodRoutine() (+131 more)
...
Cohesion: 0.02
Nodes (107): addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine, formatWeekRange(), HostelAdminFoodPage (+99 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (99): CommunityReportDialog(), REASONS, ConfirmOptions, Notification, humanizeValue(), ImportedProfileSummary(), ResidentPrefill, ResidentStatus (+91 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (88): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), PickedAttachment, DocumentScreen() (+80 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (101): HostelAdminAttendancePageContent, HostelAdminCommunityPageContent, HostelAdminComplaintsPage, HostelAdminInquiriesPageContent, HostelAdminMaintenancePageContent, PRIORITIES, STATUS_ACTIONS, HostelAdminMoveChecklistPage (+93 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (86): GET(), POST(), GET(), POST(), GET(), POST(), POST(), POST() (+78 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (89): BootGate(), FILTERS, NotificationsScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader() (+81 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (78): adminPrincipal, mocks, PLATFORM_LIMITS, base, entityId, hostelId, mocks, principal (+70 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (90): POST(), RouteContext, DELETE(), GET(), hostelId(), GET(), POST(), DELETE() (+82 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (96): AdminResidentsScreen(), NightStatusScreen(), ReferralsScreen(), SORTS, StoreCategoryScreen(), CommunityPostScreen(), ComplaintDetailScreen(), ComplaintsScreen() (+88 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (93): demoteToPublicAccount(), CapacityError, claimBedForRoomType(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary(), releaseBedForRoomType() (+85 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (80): AdminCommunityScreen(), AdminCommunityReportsScreen(), FILTERS, Pending, CommunityScreen(), Composer(), ReportedPostCard(), useReportedCount() (+72 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (72): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+64 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (85): collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor() (+77 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (80): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, dayKey(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus() (+72 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (86): NotificationCard(), ProfileScreen(), ReferralRow(), CheckoutStatusScreen(), AttachmentGallery(), ComplaintDetail(), ComplaintCard(), AlertCard() (+78 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (74): POST(), summarizeResidentComplaints(), acceptGuardianInvitation(), daysFromNow(), enabledPermissionLabels(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput (+66 more)
...
Cohesion: 0.03
Nodes (76): cookPrincipal, mocks, announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError, FoodPhotoUploadInput (+68 more)
...
Cohesion: 0.03
Nodes (59): metadata, CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+51 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (64): POST(), PLATFORM_ROLES, deviceTokenSchema, notificationSchema, notificationCampaignSchema, input, mocks, userId (+56 more)

### Community 33 - "Community 33"
Cohesion: 0.13
Nodes (44): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), guardianInvitationEmail(), sosAlertEmail() (+36 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (50): PATCH(), PATCH(), RouteContext, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex(), HostelRecord, ListingFlagListQuery (+42 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (49): AuthGuard(), cityOptions, createDocument(), createRoom(), DocumentConfig, DraftData, FACILITY_MINI, facilityOptions (+41 more)
...
Cohesion: 0.04
Nodes (50): financeIntegrityHash(), GatewayHealth, GatewayHealthSummary, IntentCounts, plural(), recordHealth(), runGatewayHealth(), runGatewayHealthForHostel() (+42 more)
...
Cohesion: 0.06
Nodes (51): NightStatusForm(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), AdminLedger, AdminLedgerEntry, formatWeekday() (+43 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (52): appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind, creditOverpayment(), getCreditAmount(), getCreditBalance(), isDuplicateKey() (+44 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (37): HostelPhotoReminder(), formatHostelAddress(), hostelTypeToUi(), mapPublicHostelToSummary(), roomTypeLabel(), CATEGORY_LABELS, NEARBY_GROUPS, PublicHostelDetailPage() (+29 more)
...
Cohesion: 0.04
Nodes (35): CheckoutStatus, ResidentCheckoutPageContent, APP_METHODS, METHODS, PayInstructions, ReferenceCheck(), Rejection, ResidentClaimForm (+27 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (37): ComparePage(), hostels, metadata, rows, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), PlatformDashboardPageContent(), PlatformHostelReviewPageContent() (+29 more)
...
Cohesion: 0.06
Nodes (38): accountDeletionRequestSchema, attendanceLogSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, consentLogSchema, userSchema, CachedConnection (+30 more)
...
Cohesion: 0.06
Nodes (23): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminComplaintsPage(), redirectToWorkspaceScreen() (+15 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (41): CLAIMABLE_STATUSES, dispatchOtpChallenge(), findVerifiedRegistrationChallenge(), generateOtpCode(), GOOGLE_JWKS, hashOtpCode(), normalizeEmail(), normalizeOtpIdentifier() (+33 more)

### Community 57 - "Community 57"
Cohesion: 0.08
Nodes (40): storeCartSchema, storeProductSchema, AddInput, addToCart(), CartItemRecord, CartRecord, clearCart(), emptyCart() (+32 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (37): serviceProviderApplicationSchema, serviceProviderDocumentSchema, REALTIME_TOPIC, hostelId, mocks, providerId, notifyPlatformOfServiceProviderApplication(), ACTIVE_APPLICATION_STATUSES (+29 more)

### Community 59 - "Community 59"
Cohesion: 0.06
Nodes (39): addComplaintUpdate(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput, ComplaintListQuery (+31 more)

### Community 60 - "Community 60"
Cohesion: 0.07
Nodes (30): AdminTabs(), HIDDEN, TABS, SosScreen(), TABS, AdminAlertsProvider(), AdminSearchBar(), ViewerBody() (+22 more)
...
Cohesion: 0.06
Nodes (40): loadSiteConfig, loadSiteName(), CONTENT_ICON_SLUGS, everything, IDENTITY, page, rendered, platformSettingSchema (+32 more)
...
Cohesion: 0.08
Nodes (40): GATEWAY_ORDER, getPayInstructions(), InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice(), toView() (+32 more)

### Community 66 - "Community 66"
Cohesion: 0.07
Nodes (41): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES (+33 more)
...
Cohesion: 0.1
Nodes (33): DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList(), positiveInteger(), validateFileAssetMetadata(), r2Configured(), storePublicAsset() (+25 more)

### Community 69 - "Community 69"
Cohesion: 0.09
Nodes (34): appBaseUrl(), dispatchVerificationEmail(), requestPasswordReset(), resendVerificationEmail(), signupWithEmailVerification(), POST(), errorResponse(), buckets (+26 more)
...
Cohesion: 0.08
Nodes (36): userResidentProfileSchema, LEGACY_ROLE_MAP, Role, ROLE_VALUES, ageFromDateOfBirth(), cardPhotoImageUrl(), generateResidentId(), isCardPhotoImage() (+28 more)
...
Cohesion: 0.07
Nodes (27): paginationQuerySchema, DEPRECATED_ALIASES, grantingPermissionKeys(), mocks, objectIdSchema, platformReviewListQuerySchema, REVIEW_CATEGORY_KEYS, ReviewCategoryKey (+19 more)

### Community 78 - "Community 78"
Cohesion: 0.07
Nodes (30): approveClaim(), assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck(), evidenceCheck(), findClaim() (+22 more)

### Community 79 - "Community 79"
Cohesion: 0.08
Nodes (22): ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, BASE_URLS, khaltiProvider, attempt, fetchMock (+14 more)
...
Cohesion: 0.07
Nodes (30): BillableResident, ChargeBasis, countDaysInclusive(), createFeeSchedule(), dayBefore(), FeeScheduleRate, getOpenFeeSchedule(), InvoiceAmount (+22 more)

### Community 84 - "Community 84"
Cohesion: 0.08
Nodes (31): POST(), BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan (+23 more)
...
Cohesion: 0.09
Nodes (33): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags(), documentFlags() (+25 more)
...
Cohesion: 0.14
Nodes (26): AuthServiceError, changePassword(), getCurrentUser(), issueSessionForUser(), login(), publicUser(), refreshAccessToken(), POST() (+18 more)

### Community 97 - "Community 97"
Cohesion: 0.07
Nodes (20): EmptyState(), Panel(), StatusBadge(), field(), HostelAdminMaintenancePageContent(), ListingFlag, LoadState, MaintenanceRequest (+12 more)
...
Cohesion: 0.1
Nodes (24): DownloadRow, progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster(), UploadRow, UploadStack() (+16 more)
...
Cohesion: 0.09
Nodes (23): peekHeaders(), ESEWA_CSV_PARSER, both, corrupted, debit, [first], FIXTURE, headerOnly (+15 more)
...
Cohesion: 0.09
Nodes (19): defaultDueDate(), DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), monthLabel(), CLAIM_METHODS (+11 more)

### Community 121 - "Community 121"
Cohesion: 0.12
Nodes (19): GET(), getAttendanceConfig(), getAttendanceSettings(), listAttendanceAlerts(), listHostelAttendance(), resolveAdminHostelId(), resolveAttendanceAlert(), updateAttendanceSettings() (+11 more)
...
Cohesion: 0.14
Nodes (16): attacker, attempt(), headers, jsonRequest(), routeMocks, resetPasswordWithToken(), revokeAllSessions(), verifyEmailWithToken() (+8 more)
...
Cohesion: 0.13
Nodes (18): GET(), POST(), activeSuperadminCount(), createPlatformAdmin(), CreatePlatformAdminInput, generateTemporaryPassword(), listPlatformAdmins(), loginUrl() (+10 more)
...
Cohesion: 0.1
Nodes (18): authSlice, AuthState, initialState, SessionEndReason, initialState, savedSlice, SavedState, AppDispatch (+10 more)
...
Cohesion: 0.18
Nodes (17): generateMetadata(), robots(), sitemap(), STATIC_ROUTES, listPublishedHostelSlugs(), renderIdCardPng(), siteUrl(), CARD_LABELS (+9 more)
...
Cohesion: 0.17
Nodes (18): bootstrapSession(), downloadAndShare(), downloadAndShareCsv(), downloadAndShareImage(), downloadToDevice(), forgetDownloadFolder(), LegacyFileSystem, loadLegacyFileSystem() (+10 more)
...
Cohesion: 0.13
Nodes (19): 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.3 Payment Proof Uploaded (to Admin), 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, 4.1 New Notice Posted, 4.2 Complaint Status Updated (+11 more)

### Community 180 - "Community 180"
Cohesion: 0.15
Nodes (13): activateResident(), login(), ResidentPayment, ResidentPaymentProof, RootStackParamList, LoginScreen(), Props, Props (+5 more)
...
Cohesion: 0.16
Nodes (13): LedgerCard(), filterInvoices(), invoiceLedger(), LedgerLine, OPEN_STATUSES, PaymentFilter, PaymentStats, ledger (+5 more)
...
Cohesion: 0.25
Nodes (17): AuditLog, code:typescript (// One per resident, per hostel. Minted lazily on first dash), code:typescript (interface ISubscription {), code:typescript (interface IPlatformSetting {), code:typescript (interface IAuditLog {), code:typescript ({), code:typescript ({), HostelPageView (+9 more)
...
Cohesion: 0.14
Nodes (12): AuthSession, getResidentProfile(), triggerSOS(), AppNavigator(), Stack, ResidentPaymentsScreen(), Profile, Props (+4 more)
...
Cohesion: 0.18
Nodes (12): apiRequest(), getActivationStatus(), listNotifications(), listResidentPayments(), markNotificationRead(), NotificationItem, refreshSession(), saveDeviceToken() (+4 more)
...
Cohesion: 0.17
Nodes (11): Listener, publishTopics(), resetResourceBus(), broken, food, healthy, listener, payments (+3 more)
...
Cohesion: 0.35
Nodes (10): assertWholeRupees(), formatNPR(), isWholeRupees(), prorate(), roundToRupee(), splitAmount(), sumAmounts(), credit (+2 more)
...
Cohesion: 0.2
Nodes (8): purgeAccount(), runAccountDeletionPurge(), sweepAbandonedUploads(), mocks, now, otherUserId, residentId, userId
...
Cohesion: 0.28
Nodes (8): ProviderDirectoryData, DirectoryPageProps, EMPTY, metadata, ServiceProviderDirectoryPage(), ServiceProvidersPage(), listPublicServiceProviders(), publicServiceProviderListQuerySchema
...
## Knowledge Gaps
- **4452 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+4447 more)
...
- **Why does `Button()` connect `Community 14` to `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 12`, `Community 13`, `Community 17`, `Community 146`, `Community 20`, `Community 22`, `Community 26`, `Community 28`, `Community 31`, `Community 36`, `Community 40`, `Community 170`, `Community 47`, `Community 60`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 120` to `Community 0`, `Community 2`, `Community 130`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 12`, `Community 141`, `Community 15`, `Community 17`, `Community 148`, `Community 24`, `Community 29`, `Community 31`, `Community 159`, `Community 33`, `Community 35`, `Community 36`, `Community 39`, `Community 40`, `Community 171`, `Community 45`, `Community 51`, `Community 56`, `Community 66`, `Community 69`, `Community 79`, `Community 82`, `Community 88`, `Community 218`, `Community 94`, `Community 98`, `Community 99`, `Community 119`, `Community 121`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 13` to `Community 4`, `Community 5`, `Community 8`, `Community 9`, `Community 12`, `Community 14`, `Community 15`, `Community 17`, `Community 28`, `Community 30`, `Community 31`, `Community 35`, `Community 38`, `Community 42`, `Community 170`, `Community 171`, `Community 45`, `Community 47`, `Community 48`, `Community 49`, `Community 51`, `Community 54`, `Community 67`, `Community 330`, `Community 92`, `Community 97`, `Community 103`, `Community 232`, `Community 117`, `Community 119`?**
...
- **What connects `{ defineConfig }`, `expoConfig`, `path` to the rest of the system?**
  _4452 weakly-connected nodes found - possible documentation gaps or missing edges._
