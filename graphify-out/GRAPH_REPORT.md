...
## Corpus Check
- 1044 files · ~1,863,281 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8390 nodes · 20891 edges · 394 communities (370 shown, 24 thin omitted)
...
## Communities (394 total, 24 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (122): DeletionPathway, DeletionStatus, PATHWAY_COPY, Filter, ModeratedPost, ModerationPayload, deferLoad(), DemoDataBadge() (+114 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (136): sendEmail(), addHostelAdminProfilePhoto(), deleteHostelAdminProfilePhoto(), HostelAdminProfileQuery, HostelAdminProfileUpdateInput, HostelChangeRequestInput, HostelPhotoCreateInput, HostelPhotoDeleteQuery (+128 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (95): PATCH(), POST(), RouteContext, GET(), POST(), POST(), POST(), listAttendanceAlerts() (+87 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (87): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), verificationEmail(), ProviderDirectoryData, guardianInvitationEmail(), sosAlertEmail() (+79 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (88): Notification, CATEGORIES, HostelAdminNoticesPage, HostelAdminPaymentsPage, MatrixRow, MatrixTotals, humanizeValue(), ImportedProfileSummary() (+80 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (74): FeeSchedule, Rate, PRIORITIES, STATUS_ACTIONS, Campaign, Resident, AttendanceAnalytics, FoodAnalytics (+66 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (92): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult (+84 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (69): GenericPortalScreen(), portalRows(), portalTitle(), CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS, CITY_OPTIONS (+61 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (58): DELETE(), checkoutSchema, POST(), POST(), RouteContext, COMMUNITY_DEFAULTS, CommunitySettings, communitySettingsSchema (+50 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (84): GET(), POST(), querySchema, RouteContext, AnnouncementInput, CommentCreateInput, commentOnPost(), CommentRecord (+76 more)

### Community 10 - "Community 10"
Cohesion: 0.05
Nodes (86): POST(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus(), OPEN_STATUSES, OverdueComplaint, runComplaintSlaCheck(), daysBetween() (+78 more)
...
Cohesion: 0.04
Nodes (63): CommunityReportDialog(), REASONS, ConfirmOptions, Resolver, ModerationButton(), PagerButton(), PublicHostelListingPage(), PublicHostelListingPage() (+55 more)

### Community 13 - "Community 13"
Cohesion: 0.06
Nodes (50): GuardianDashboard, CreateWardenResult, PERMISSION_LABELS, EmptyInline(), InitialsAvatar(), PortalPageHeader(), RoleButton(), SectionCard() (+42 more)
...
Cohesion: 0.07
Nodes (76): deleteResidentLocationHistory(), getResidentAttendance(), listResidentComplaints(), getFoodRoutine(), listFoodForResident(), listPublicFoodRoutine(), submitFoodFeedback(), uploadFoodPhoto() (+68 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (54): HostelSuggestions(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, formatHostelAddress(), hostelTypeToUi(), mapPublicHostelToSummary() (+46 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (40): GET(), POST(), GET(), PATCH(), RouteContext, listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema (+32 more)
...
Cohesion: 0.06
Nodes (49): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), distance, cookieAccessToken(), isRole() (+41 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (47): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, PaginationMeta, PaginationQuery, auditListingFlagAction(), DuplicateCheckResultRecord (+39 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (48): GET(), resolvePastedLink(), searchCandidates(), hostelAdminGeocodeQuerySchema, AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim(), buildAddressQuery() (+40 more)
...
Cohesion: 0.04
Nodes (43): complaintCategorySchema, complaintCreateSchema, complaintListQuerySchema, complaintReplySchema, complaintResolutionConfirmSchema, complaintStatusSchema, objectIdSchema, POST() (+35 more)
...
Cohesion: 0.07
Nodes (37): GET(), POST(), GET(), POST(), getMyExpertConsultationRequest(), GET(), POST(), voidInvoice() (+29 more)

### Community 27 - "Community 27"
Cohesion: 0.06
Nodes (35): POST(), RouteContext, GET(), PATCH(), RouteContext, PATCH(), RouteContext, ApiError (+27 more)
...
Cohesion: 0.05
Nodes (45): findIndex(), index, indexesOf(), IndexSpec, classifyCredit(), CreditClassification, LadderClaim, LadderInvoice (+37 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (44): POST(), acceptGuardianInvitation(), daysFromNow(), enabledPermissionLabels(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags (+36 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (46): deviceTokenSchema, notificationSchema, notificationCampaignSchema, input, mocks, userId, CampaignListQuery, CampaignRecord (+38 more)

### Community 34 - "Community 34"
Cohesion: 0.06
Nodes (41): GET(), POST(), listTrendingTags(), requireSuperadminPrincipal(), sponsorSchema, GET(), PUT(), PUT() (+33 more)

### Community 35 - "Community 35"
Cohesion: 0.06
Nodes (29): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelPhotoReminder(), redirectToWorkspaceScreen() (+21 more)
...
Cohesion: 0.05
Nodes (40): CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing, CurrentUser (+32 more)

### Community 38 - "Community 38"
Cohesion: 0.07
Nodes (44): demoteToPublicAccount(), CapacityError, claimBedForRoomType(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary(), releaseBedForRoomType() (+36 more)
...
Cohesion: 0.07
Nodes (40): assertHostelAccess(), canAccessHostel(), hostelScopedFilter(), TenantAccessError, TenantPrincipal, foodReadyLogSchema, qrActivationSchema, getAttendanceAnalytics() (+32 more)
...
Cohesion: 0.06
Nodes (28): LegalBody(), buildValues(), PublicAboutPage(), values, buildPosts(), posts, PublicBlogPage(), buildContactMethods() (+20 more)

### Community 45 - "Community 45"
Cohesion: 0.06
Nodes (36): referralSchema, referralCodeSchema, referralRewardSchema, activeCode, codeId, hostelId, joinedResidentId, mocks (+28 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (34): financeIntegrityHash(), CachedConnection, globalForMongoose, computeCreditAmount(), creditBalanceSchema, creditEntrySchema, findingSchema, reconciliationRunSchema (+26 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (36): HostelAdminCommunityPageContent, HostelAdminComplaintsPage, HostelAdminDashboardPageContent, HostelAdminFeeSchedulePageContent, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek (+28 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (28): currency(), Input(), StatusBadge(), ResidentActivationPageContent, ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent (+20 more)

### Community 49 - "Community 49"
Cohesion: 0.08
Nodes (35): dispatchOtpChallenge(), generateOtpCode(), GOOGLE_JWKS, normalizeOtpIdentifier(), otpDeliveryProvider(), otpRateLimitMax(), otpRateLimitWindowMs(), otpResendCooldownMs() (+27 more)

### Community 50 - "Community 50"
Cohesion: 0.1
Nodes (39): collectionTotals(), countInvoicesByField(), listRecentInvoices(), getHostelViewStats(), foodFeedbackSchema, ratingReviewSchema, averageResolutionDays(), bucketBoundaries() (+31 more)
...
Cohesion: 0.07
Nodes (29): metadata, FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES, avatarTone() (+21 more)

### Community 53 - "Community 53"
Cohesion: 0.08
Nodes (35): BALANCE_ALIASES, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, TXN_ID_ALIASES, WITHDRAWAL_ALIASES, CsvTable (+27 more)

### Community 54 - "Community 54"
Cohesion: 0.07
Nodes (32): CommunityPageContent(), csvField(), field(), numberField(), optionalField(), RoomConfiguration, RoomMapFloor, AddressFields (+24 more)

### Community 55 - "Community 55"
Cohesion: 0.07
Nodes (28): bedSchema, guardianSchema, roomSchema, invoiceRow(), objectId(), paymentProofRecord(), paymentRecord(), receiptRecord() (+20 more)

### Community 56 - "Community 56"
Cohesion: 0.08
Nodes (34): FALLBACK, SiteConfigContext, SiteConfigProvider(), useFeatureFlag(), platformSettingSchema, DEFAULT_SITE_CONFIG, coerceSection(), getPublicSiteConfig() (+26 more)

### Community 57 - "Community 57"
Cohesion: 0.07
Nodes (32): EmailAttachment, fromAddress(), SendEmailInput, SendEmailResult, HostelServiceError, ADMIN_ISSUABLE_ROLES, AdminIssuableRole, generateTemporaryPassword() (+24 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (33): getResidentFinanceView(), InvoiceMatrix, InvoiceMatrixRow, listResidentClaims(), PortalInvoice, ResidentFinanceView, ResidentRow, toPortalInvoice() (+25 more)

### Community 59 - "Community 59"
Cohesion: 0.07
Nodes (32): attacker, attempt(), headers, jsonRequest(), routeMocks, findVerifiedRegistrationChallenge(), hashOtpCode(), normalizeEmail() (+24 more)
...
Cohesion: 0.07
Nodes (22): EmptyState(), Panel(), field(), HostelAdminMaintenancePageContent(), HostelAdminServiceProvidersPageContent(), ListingFlag, LoadState, MaintenanceRequest (+14 more)

### Community 66 - "Community 66"
Cohesion: 0.07
Nodes (22): emergencyContactSchema, incidentLogSchema, manualStatusOverrideSchema, nightStatusLogSchema, residentSchema, sosAlertSchema, EmergencyContactRecord, findAdminResident() (+14 more)

### Community 67 - "Community 67"
Cohesion: 0.19
Nodes (21): POST(), authenticateWithGoogle(), changePassword(), logout(), POST(), POST(), accessTokenTtlSeconds(), parseDurationSeconds() (+13 more)
...
Cohesion: 0.09
Nodes (27): inquiryId, serviceMocks, staffPrincipal, BedCreateInput, BedRecord, BedUpdateInput, createHostelAdminBed(), createHostelAdminFloor() (+19 more)
...
Cohesion: 0.13
Nodes (22): appBaseUrl(), AuthServiceError, dispatchVerificationEmail(), requestPasswordReset(), resendVerificationEmail(), signupWithEmailVerification(), POST(), buckets (+14 more)

### Community 75 - "Community 75"
Cohesion: 0.09
Nodes (23): getAttendanceConfig(), getAttendanceSettings(), listHostelAttendance(), recordConsent(), resolveAdminHostelId(), resolveAttendanceAlert(), updateAttendanceSettings(), attendanceAlertResolveSchema (+15 more)
...
Cohesion: 0.12
Nodes (27): getCurrentUser(), issueSessionForUser(), login(), publicUser(), refreshAccessToken(), loginGuardian(), AuthTokenPayload, getBearerToken() (+19 more)
...
Cohesion: 0.16
Nodes (18): POST(), POST(), POST(), geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), POST() (+10 more)
...
Cohesion: 0.07
Nodes (17): ACTION_PROGRESS, PlatformServiceProviderReviewPageContent, ProviderApplication, ProviderDetail, ProviderDocument, TABS, ACTION_PROGRESS, AVAILABILITY (+9 more)

### Community 87 - "Community 87"
Cohesion: 0.1
Nodes (23): BillableResident, ChargeBasis, computeInvoiceAmount(), countDaysInclusive(), createFeeSchedule(), dayBefore(), FeeScheduleRate, FeeScheduleRecord (+15 more)
...
Cohesion: 0.1
Nodes (15): CATEGORY_LABELS, NEARBY_GROUPS, PublicReview, PublicReviewData, RoomCard, ROUTINE_DAYS, ROUTINE_MEALS, HostelMap() (+7 more)
...
Cohesion: 0.15
Nodes (20): FileUploadArea(), IdCardPanel(), identityPhotoUrl(), acceptAttribute(), EXTENSION_BY_MIME, FAMILY_BYTES, FAMILY_ORDER, familyOf() (+12 more)
...
Cohesion: 0.11
Nodes (15): AuthShell(), AuthShellProps, SiteWordmark(), GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse, GoogleAuthUser, GoogleCredentialResponse (+7 more)
...
Cohesion: 0.14
Nodes (20): POST(), BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan (+12 more)

### Community 110 - "Community 110"
Cohesion: 0.14
Nodes (11): ENDPOINTS, SIGNED_FIELDS, BASE_URLS, GatewayCredentials, GatewayProvider, PaymentIntent, PaymentIntentRequest, SettlementRecord (+3 more)

### Community 111 - "Community 111"
Cohesion: 0.12
Nodes (16): feeUpdateSchema, PATCH(), POST(), GET(), monthlyPaymentGenerateSchema, monthSchema, objectIdSchema, paymentCreateSchema (+8 more)
...
Cohesion: 0.16
Nodes (17): dashboardHrefForRole(), dashboardHrefForRole(), destinationForRole(), isAllowedNextPath(), isHostelWorkspacePath(), isSafeLocalPath(), landingPathForRole(), ProtectedRouteRule (+9 more)

### Community 118 - "Community 118"
Cohesion: 0.12
Nodes (18): BANK_CSV_PARSER, peekHeaders(), ESEWA_CSV_PARSER, both, corrupted, debit, [first], FIXTURE (+10 more)
...
Cohesion: 0.13
Nodes (17): Offset, PhotoCropper(), TradeDetailsStep(), isActive(), UploadKind, FileUploader(), FileUploaderPresentation, FileUploaderProps (+9 more)

### Community 127 - "Community 127"
Cohesion: 0.17
Nodes (17): POST(), CheckoutStatus, closeIntent(), createPaymentIntent(), expireStaleIntents(), getCheckoutStatus(), handleProviderCallback(), IntentRecord (+9 more)
...
Cohesion: 0.12
Nodes (17): dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, mealsOn(), ROUTINE_DAYS, ROUTINE_MEAL_TYPES (+9 more)
...
Cohesion: 0.12
Nodes (9): ROLE_VALUES, hostelMemberSchema, rolePermissionSchema, userSchema, mocks, principal, userId, existing (+1 more)
...
Cohesion: 0.11
Nodes (11): adminPrincipal, mocks, PLATFORM_LIMITS, mocks, readable, selectable, Role, mocks (+3 more)
...
Cohesion: 0.14
Nodes (13): POST(), GET(), CLAIM_REJECTION_REASONS, claimApproveSchema, ClaimRejectInput, ClaimRejectionReasonCode, claimRejectSchema, ClaimSubmitInput (+5 more)
...
Cohesion: 0.18
Nodes (13): 7.1 Multi-Tenant Isolation Test Template, 7.2 Role Gate Test Template, 7.3 Privacy/Guardian Permissions Test Template, 7.4 Account-Upgrade Test Template, 7.5 Payment Precision Test Template, 7. Mandatory Test Templates, 9.2 Test Database Isolation, code:typescript (describe('GET /api/v1/hostel/rooms/:id - tenant isolation', ) (+5 more)
...
Cohesion: 0.33
Nodes (8): formatNPR(), formatDate(), ReceiptPdfInput, renderReceiptPdf(), renderStatementPdf(), sanitize(), StatementPdfInput, StatementRow

### Community 198 - "Community 198"
Cohesion: 0.36
Nodes (9): assertWholeRupees(), isWholeRupees(), prorate(), roundToRupee(), splitAmount(), sumAmounts(), credit, log (+1 more)

### Community 199 - "Community 199"
Cohesion: 0.18
Nodes (10): BANK, both, empty, ESEWA, [first], ids, KHALTI, odd (+2 more)
...
Cohesion: 0.22
Nodes (10): 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, code:typescript ({), code:typescript ({), code:typescript ({) (+2 more)
...
Cohesion: 0.29
Nodes (4): esewaProvider, GatewayProviderName, adapters, SHIPPED
...
## Knowledge Gaps
- **3201 isolated node(s):** `AuthUser`, `ResidentSummary`, `ResidentFoodRoutine`, `ApiSuccess`, `ApiFailure` (+3196 more)
...
- **Why does `Role` connect `Community 142` to `Community 0`, `Community 256`, `Community 1`, `Community 259`, `Community 6`, `Community 7`, `Community 8`, `Community 137`, `Community 9`, `Community 10`, `Community 138`, `Community 17`, `Community 18`, `Community 19`, `Community 274`, `Community 275`, `Community 276`, `Community 151`, `Community 24`, `Community 26`, `Community 27`, `Community 28`, `Community 155`, `Community 30`, `Community 32`, `Community 160`, `Community 34`, `Community 37`, `Community 38`, `Community 295`, `Community 296`, `Community 297`, `Community 40`, `Community 298`, `Community 173`, `Community 174`, `Community 49`, `Community 51`, `Community 55`, `Community 184`, `Community 57`, `Community 58`, `Community 59`, `Community 190`, `Community 195`, `Community 69`, `Community 77`, `Community 80`, `Community 213`, `Community 214`, `Community 218`, `Community 230`, `Community 231`, `Community 232`, `Community 105`, `Community 117`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 15` to `Community 1`, `Community 3`, `Community 261`, `Community 6`, `Community 134`, `Community 8`, `Community 9`, `Community 10`, `Community 135`, `Community 20`, `Community 25`, `Community 28`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 159`, `Community 38`, `Community 39`, `Community 40`, `Community 160`, `Community 45`, `Community 46`, `Community 49`, `Community 50`, `Community 51`, `Community 55`, `Community 56`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 66`, `Community 67`, `Community 69`, `Community 70`, `Community 200`, `Community 77`, `Community 78`, `Community 80`, `Community 81`, `Community 87`, `Community 88`, `Community 109`, `Community 237`, `Community 112`, `Community 127`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `browserApi()` connect `Community 11` to `Community 0`, `Community 4`, `Community 5`, `Community 7`, `Community 13`, `Community 14`, `Community 16`, `Community 29`, `Community 291`, `Community 37`, `Community 42`, `Community 47`, `Community 48`, `Community 52`, `Community 54`, `Community 183`, `Community 61`, `Community 62`, `Community 65`, `Community 76`, `Community 82`, `Community 86`, `Community 215`, `Community 92`, `Community 100`?**
