# Graph Report - hostel-management-software  (2026-09-10)

## Corpus Check
- 1931 files · ~3,315,347 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15321 nodes · 42231 edges · 542 communities (521 shown, 21 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 682 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 626 edges
2. `successResponse()` - 609 edges
3. `connectToDatabase()` - 430 edges
4. `useAppTheme()` - 365 edges
5. `cn()` - 283 edges
6. `connectToDatabase()` - 244 edges
7. `unwrap()` - 195 edges
8. `useResource()` - 193 edges
9. `Text()` - 176 edges
10. `requireHostelCapability()` - 172 edges
...
## Communities (542 total, 21 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (216): POST(), GET(), POST(), POST(), PATCH(), POST(), RouteContext, GET() (+208 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (166): ICONS, LABELS, Segment, TONES, FILTERS, Pending, Overview, MoneyData (+158 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (267): loadOverview(), loadMoney(), AttachmentGallery(), loadFinance(), getAdminHostel(), getAdminInvoices(), getAdminPeriodSummary(), getAdminReport() (+259 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (219): PATCH(), RouteContext, POST(), POST(), GET(), POST(), addHostelAdminProfilePhoto(), deleteHostelAdminProfilePhoto() (+211 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (154): HostelTable(), UserRecord, GuardianDashboard, CATEGORIES, Ledger, MatrixRow, MatrixTotals, PeriodSummary (+146 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (203): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult (+195 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (174): AdminMoreScreen(), MANAGE_ROWS, PORTAL_ROWS, ActivateScreen(), APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen() (+166 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (137): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage() (+129 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (161): POST(), RouteContext, DELETE(), GET(), hostelId(), GET(), POST(), DELETE() (+153 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (122): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CancelDeletionPageContent() (+114 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (147): notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus(), OPEN_STATUSES, OverdueComplaint, runComplaintSlaCheck(), hostelId, mocks (+139 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (148): NotificationCard(), AlertCard(), PaymentMonthStrip(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), InvoiceDetailScreen() (+140 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (130): CommunityScreen(), Composer(), CommunityPostScreen(), CommunityBoard(), CommunityBoardProps, Composer(), NotificationBell(), SORTS (+122 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (123): getResidentAttendance(), summarizeResidentComplaints(), listResidentInvoices(), renderStatementForResident(), listFoodForResident(), serializeFoodFeedback(), submitFoodFeedback(), daysFromNow() (+115 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (116): Scanner(), CookInviteScreen(), GuardianInviteScreen(), MapScreen(), CallableRow(), IdentityCard(), PeopleSection(), SavedHostelsScreen() (+108 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (93): GET(), POST(), PATCH(), RouteContext, complaintCategorySchema, complaintCreateSchema, complaintListQuerySchema, complaintReplySchema (+85 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (113): CommunityReportDialog(), REASONS, MonthOption(), daysUntil(), HostelSubscriptionDueBanner(), rupees(), State, BrowserPushRow() (+105 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (125): listAttendanceAlerts(), listResidentComplaints(), getOpenFeeSchedule(), outstandingForResident(), addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery (+117 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (119): AdminAlertsScreen(), AdminCommunityReportsScreen(), AdminHomeScreen(), AdminTabs(), HIDDEN, TABS, AdminMoneyScreen(), AdminResidentsScreen() (+111 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (92): ComparePage(), hostels, metadata, rows, csvField(), field(), Hostel, HostelAdminDashboardPageContent() (+84 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (117): ReviewForm(), ReviewScreen(), DeletionPanel(), NotificationSettings(), SETTINGS_TITLES, SettingsScreen(), THEME_OPTIONS, describeGrants() (+109 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (102): AdminCommunityScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+94 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (88): FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, monthStartPeriod(), Rate, RoomTypeOption, gregorianSpan(), MonthField (+80 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (95): grabDocument(), PRIORITIES, STATUS_ACTIONS, Campaign, Resident, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel (+87 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (83): csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, Inquiry, LoadState, Message() (+75 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (105): Offset, PhotoCropper(), VideoSlot(), CollectionQrField(), FileUploadArea(), uploadPublicFile(), FileUploadArea(), PhotoStrip() (+97 more)

### Community 26 - "Community 26"
Cohesion: 0.08
Nodes (71): GenericPortalScreen(), portalRows(), portalTitle(), DASHBOARD_ROLES, FACILITY_ICONS, HOSTEL_TYPE_ICONS, PublicHomePage(), PublicHomePageContent() (+63 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (100): querySchema, RouteContext, AnnouncementInput, CommentCreateInput, commentOnPost(), CommentRecord, CommunityServiceError, createCommunityAnnouncement() (+92 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (96): cookPrincipal, mocks, resolveCookLabels(), CookServiceError, resolveAdminHostelId(), announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord (+88 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (83): NotificationsPageContent(), Notification, FILTERS, Notification, NotificationRow(), PushState, FILTERS, NotificationCard (+75 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (91): demoteToPublicAccount(), CapacityError, claimBedForRoomType(), listAllRoomTypes(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary() (+83 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (68): AuthShell(), AuthShellProps, PANEL_COPY, SiteWordmark(), metadata, AccountDeletionPanel, ContentHeader(), ContentIntro() (+60 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (91): periodOf(), getHostelLedger(), collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident() (+83 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (90): AdminOverviewScreen(), loadToday(), TodayData, AdminAlertsContext, AdminAlertsValue, AlertActions, EMPTY_COUNTS, ICONS (+82 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (73): HostelRegistrationProgress(), Milestone, milestoneIndex(), MILESTONES, PaymentPanel(), rupees(), SubscriptionState, cityOptions (+65 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (80): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), methodProvider(), PROVIDER_LABEL, QrPanel() (+72 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (66): HostelSuggestions(), inferKind(), MediaLightbox(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, formatHostelAddress() (+58 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (82): BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan, BillingSkip (+74 more)
...
Cohesion: 0.04
Nodes (78): createExpertConsultationRequest(), ExpertConsultationCreateInput, ExpertConsultationError, ExpertConsultationRequestRecord, notifyTeamOfRequest(), expertConsultationCreateSchema, HostelServiceError, hashUserAgent() (+70 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (56): deleteHostelObjects(), ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, purgeArchivedHostel(), purgeHostel() (+48 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (70): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt, readReturnState() (+62 more)

### Community 42 - "Community 42"
Cohesion: 0.1
Nodes (50): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), verificationEmail(), cookInvitationEmail(), guardianInvitationEmail(), wardRegisteredEmail() (+42 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (66): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, cookLoginStem(), generateCookPassword(), mintCookLogin(), pick() (+58 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (63): notifyProviderOfAssignment(), notifyProviderOfMaintenanceNote(), notifyProviderOfStatusChange(), notifyStaffOfNewMaintenanceRequest(), providerUserId(), readableCategory(), RequestLike, STATUS_WORDS (+55 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (65): paymentProofSchema, receiptSchema, arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId (+57 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (58): DELETE(), POST(), listOwnerHostelApplications(), GET(), assertPrimaryCredentialPrincipal(), requireApiPrincipal(), GET(), CampaignListQuery (+50 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (39): InlineText(), TIER_TONE, PlanMark(), ROWS, EASE, PlanCards(), PlanLine(), PlansClosingCta() (+31 more)
...
Cohesion: 0.05
Nodes (51): POST(), PaginationMeta, PaginationQuery, querySchema, noticeSchema, noticeReadStatusSchema, auditNoticeAction(), broadcastNotice() (+43 more)
...
Cohesion: 0.05
Nodes (38): PATCH(), RouteContext, listingFlagListQuerySchema, listingFlagResolveSchema, GET(), GET(), GET(), paymentProofReviewSchema (+30 more)

### Community 52 - "Community 52"
Cohesion: 0.07
Nodes (46): appBaseUrl(), CLAIMABLE_STATUSES, dispatchOtpChallenge(), dispatchVerificationEmail(), findVerifiedRegistrationChallenge(), generateOtpCode(), GOOGLE_JWKS, normalizeEmail() (+38 more)

### Community 53 - "Community 53"
Cohesion: 0.08
Nodes (23): PlatformConfigAnnouncementsPageContent, PlatformConfigContentPageContent, PlatformConfigFacilitiesPageContent, FLAGS, PlatformConfigFeaturesPageContent, PlatformConfigLegalPageContent, PlatformConfigLocationsPageContent, PlatformConfigPlanServicePageContent (+15 more)

### Community 54 - "Community 54"
Cohesion: 0.07
Nodes (51): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsPeriodBounds(), bsPeriodOf() (+43 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (39): GET(), CSV_COLUMNS, GET(), listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), getPlatformSubscriptionLedger() (+31 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (43): otpCodeEmail(), Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity, EmailIdentityResolver, envEmailDomain() (+35 more)

### Community 57 - "Community 57"
Cohesion: 0.04
Nodes (30): adminPrincipal, mocks, PLATFORM_LIMITS, mocks, readable, selectable, assetId, hostelId (+22 more)
...
Cohesion: 0.07
Nodes (43): saveFoodRoutine(), addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange(), definedUpdate(), FoodFeedbackInput, FoodFeedbackRecord (+35 more)

### Community 60 - "Community 60"
Cohesion: 0.06
Nodes (39): ProviderStatusCard(), TILE_INK, TILE_TINT, AdminNightStatusRow, getOwnProvider(), listProviderJobs(), ProviderApplication, ProviderJobStatus (+31 more)
...
Cohesion: 0.05
Nodes (35): AuthGuard(), CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing (+27 more)

### Community 63 - "Community 63"
Cohesion: 0.08
Nodes (40): HostelScope, ResolvedDocument, resolveInvoiceDocument(), resolveReceiptDocument(), scopeFilter(), settledTotal(), trySoftmato(), InvoiceDocumentInput (+32 more)
...
Cohesion: 0.05
Nodes (35): candidateRoots, fillMissing(), findRepoRoot(), { loadEnvConfig }, loadRootEnv(), parseEnvFile(), require, filled (+27 more)

### Community 66 - "Community 66"
Cohesion: 0.08
Nodes (45): hostelForm(), buildHostelPayload(), capacitySummary(), CITY_OPTIONS, emptyHostelForm(), emptyRoomRow(), FACILITY_OPTIONS, firstIncompleteHostelStep() (+37 more)
...
Cohesion: 0.05
Nodes (31): BROWSE_FACILITIES, BrowseByFacility(), BrowseByType(), CitiesRow(), Hero(), HERO_CHIPS, NearbyHostels(), PublicHomeProps (+23 more)

### Community 69 - "Community 69"
Cohesion: 0.05
Nodes (33): categoryLabel(), PROVIDER_CATEGORIES, ProviderCard(), ProviderDirectoryData, PublicProvider, PublicServiceProviderDirectoryPage(), CATEGORIES, isApplicationOpen() (+25 more)
...
Cohesion: 0.07
Nodes (38): addComplaintUpdate(), assertComplaintVoiceNote(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput (+30 more)
...
Cohesion: 0.07
Nodes (39): notifyStaffOfJobProgress(), serviceProviderApplicationSchema, serviceProviderDocumentSchema, notifyPlatformOfServiceProviderApplication(), notifyServiceProviderDecision(), ACTIVE_APPLICATION_STATUSES, approveServiceProvider(), auditProviderAction() (+31 more)
...
Cohesion: 0.06
Nodes (32): Footer(), IdCardFace(), initialsOf(), Portrait(), buildIdCard(), CARD_COLORS, CARD_NOUNS, CARD_VARIANTS (+24 more)
...
Cohesion: 0.1
Nodes (41): Assurance(), fill(), money(), PlanCard(), PricingScreen(), pricePlan(), PlanPicker(), BillingToggle() (+33 more)
...
Cohesion: 0.07
Nodes (37): GuardianMetrics(), GuardianPaymentsScreen(), GuardianSafetyScreen(), LoginResult, acceptGuardianInvitation(), getGuardianFood(), getGuardianNotices(), getGuardianPayments() (+29 more)
...
Cohesion: 0.07
Nodes (27): metadata, CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+19 more)

### Community 83 - "Community 83"
Cohesion: 0.09
Nodes (36): Guidance, GuidanceStatus, useGuidance(), cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath() (+28 more)

### Community 84 - "Community 84"
Cohesion: 0.06
Nodes (34): approveClaim(), assertNotAlreadyRecordedFromStatement(), bulkApproveClaims(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck(), evidenceCheck() (+26 more)
...
Cohesion: 0.07
Nodes (33): Coordinates, haversineMeters(), hostelCoordinates(), HostelWithDistance, isUsableCoordinate(), KATHMANDU, sortByDistance(), distance (+25 more)

### Community 87 - "Community 87"
Cohesion: 0.05
Nodes (37): CONTENT_ICON_SLUGS, everything, IDENTITY, page, rendered, announcementSchema, cap, contentHighlightSchema (+29 more)

### Community 88 - "Community 88"
Cohesion: 0.07
Nodes (32): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse (+24 more)

### Community 89 - "Community 89"
Cohesion: 0.08
Nodes (32): IdCardPrompt(), Point(), BLOOD_OPTIONS, DIET_OPTIONS, GENDER_OPTIONS, ID_TYPE_OPTIONS, IdentityForm(), OCCUPATION_OPTIONS (+24 more)

### Community 90 - "Community 90"
Cohesion: 0.1
Nodes (33): watchDeviceHeading(), cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath(), hasArrived(), headingDifference() (+25 more)

### Community 91 - "Community 91"
Cohesion: 0.1
Nodes (28): isCurrentNight(), isSelfReportable(), NIGHT_STATUS_OPTIONS, nightKey(), nightNote(), NightStanding, SelfReportableStatus, NIGHT_OF_17TH (+20 more)
...
Cohesion: 0.09
Nodes (34): CookTodayScreen(), announcedCount(), announcementSummary(), MealButton, mealButtonLabel(), mealButtons(), MealButtonsInput, mealLockNote() (+26 more)

### Community 95 - "Community 95"
Cohesion: 0.13
Nodes (28): PreviewCard(), ResultRow(), FACILITY_ICONS, facilityIcon(), facilityKey(), HostelCard(), SaveButton(), HostelShowcase() (+20 more)

### Community 96 - "Community 96"
Cohesion: 0.07
Nodes (33): CREDIT_MARKERS, DEBIT_MARKERS, DirectionRead, directionRefusal(), EvidenceDirection, EvidenceOutcome, matched(), OUTCOME_MARKERS (+25 more)

### Community 97 - "Community 97"
Cohesion: 0.08
Nodes (23): Choice, HOSTEL_TYPE_LABELS, HostelPanel(), MapButton(), MapCanvas, ModeTab(), NavigationPanel(), NOTHING_CHOSEN (+15 more)

### Community 98 - "Community 98"
Cohesion: 0.09
Nodes (23): applyWebhook(), WebhookResult, softmatoWebhookSecret(), EnsureInvoiceInput, ensureSoftmatoInvoice(), formatPaisa(), paisaToRupees(), rupeesToPaisa() (+15 more)

### Community 99 - "Community 99"
Cohesion: 0.08
Nodes (28): platformAdminInvitationEmail(), AcceptPlatformAdminInvitationInput, appUrl(), checkPlatformAdminEmail(), daysFromNow(), EmailAvailability, EmailAvailabilityResult, hashToken() (+20 more)
...
Cohesion: 0.11
Nodes (27): nightStatusPromptSchema, formatPromptTime(), isSameNight(), minuteIsDue(), nightKey(), parsePromptTime(), promptIsDue(), reminderIsDue() (+19 more)
...
Cohesion: 0.08
Nodes (23): searchHostels(), rows, ComparedHostel, comparePublicHostels(), definedParams(), Facility, getPublicHostel(), InquiryInput (+15 more)

### Community 105 - "Community 105"
Cohesion: 0.11
Nodes (26): bsMonthStart(), FeeScheduleRecord, rateForRoomType(), hostelCalendarDay(), hostelMonthStart(), hostelToday(), once, AdmissionInvoiceResult (+18 more)
...
Cohesion: 0.14
Nodes (26): JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, ProviderJob, CATEGORY_ICONS (+18 more)

### Community 108 - "Community 108"
Cohesion: 0.1
Nodes (25): CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, readId(), activeDevicesFor(), activeTokensFor(), authHeaders(), chunk() (+17 more)

### Community 109 - "Community 109"
Cohesion: 0.11
Nodes (24): paginationQuerySchema, sponsorSchema, DELETE(), PATCH(), RouteContext, GET(), POST(), assertWindow() (+16 more)
...
Cohesion: 0.1
Nodes (25): documents, many, parsed, result, buildProviderPayload(), EMPTY_PROVIDER_FORM, firstIncompleteProviderStep(), hasProviderErrors() (+17 more)

### Community 112 - "Community 112"
Cohesion: 0.12
Nodes (21): GET(), querySchema, assertTeamRegistrationIsNew(), findHostelUsingEmail(), hostelNameKey(), GET(), POST(), mocks (+13 more)

### Community 113 - "Community 113"
Cohesion: 0.1
Nodes (26): associatedData(), decryptSecret(), encryptSecret(), fingerprintSecret(), MasterKey, parseMasterKey(), rewrapSecret(), SecretCryptoError (+18 more)

### Community 114 - "Community 114"
Cohesion: 0.09
Nodes (25): BANK, both, empty, ESEWA, [first], ids, KHALTI, odd (+17 more)

### Community 115 - "Community 115"
Cohesion: 0.11
Nodes (25): qrActivationSchema, ActivationCodeGenerateInput, ActivationCodeInput, activationSecret(), ActivationServiceError, ActivationStatus, ActivationStatusQuery, ActivationTarget (+17 more)
...
Cohesion: 0.11
Nodes (22): native, NativeDownloads, openDownloaded(), SavedDownload, registerNightStatusCategory(), KNOWN_PATHS, marksRoleChange(), resolvePushPath() (+14 more)
...
Cohesion: 0.08
Nodes (19): CookAccount, Credentials, HostelAdminCooksPanel, Issued, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek (+11 more)

### Community 121 - "Community 121"
Cohesion: 0.12
Nodes (21): isAuthBypassEnabled(), original, dashboardHrefForRole(), destinationForRole(), isAllowedNextPath(), isHostelWorkspacePath(), isSafeLocalPath(), landingPathForRole() (+13 more)

### Community 122 - "Community 122"
Cohesion: 0.12
Nodes (24): methodLabel(), SubmitClaimScreen(), canonicalize(), CLAIM_METHODS, ClaimDraft, ClaimErrors, ClaimRejection, ClaimRejectionDetails (+16 more)

### Community 123 - "Community 123"
Cohesion: 0.15
Nodes (19): isNightStatusPrompt(), NIGHT_STATUS_ACTIONS, NIGHT_STATUS_BUTTONS, NIGHT_STATUS_REASONS, NightStatusActionId, NightStatusAnswer, NightStatusReasonCode, parseNightStatusAction() (+11 more)

### Community 124 - "Community 124"
Cohesion: 0.11
Nodes (22): PublicListingBadgePage(), loadSiteConfig, loadSiteName(), getListingTier(), getService(), listingTiers(), serviceHref(), DEFAULT_PLANS (+14 more)

### Community 125 - "Community 125"
Cohesion: 0.11
Nodes (26): readMoney(), AMOUNT_ALIASES, counterparty(), CREDIT_ALIASES, CREDIT_WORDS, DATE_ALIASES, DEBIT_ALIASES, DEBIT_WORDS (+18 more)
...
Cohesion: 0.14
Nodes (27): AccountDeletionRequest, AttendanceAlert, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript (interface IQuestionCallClick {), code:typescript ({), code:typescript ({) (+19 more)
...
Cohesion: 0.13
Nodes (23): UploadCard(), dismissUpload(), emit(), listeners, pruneUploads(), resetUploadQueue(), rows, startRead() (+15 more)

### Community 131 - "Community 131"
Cohesion: 0.1
Nodes (22): REALTIME_TOPIC_VALUES, connectRealtime(), fetchConfig(), PusherModule, REALTIME_EVENT, RealtimeConfig, RealtimeHandlers, RealtimeNotification (+14 more)
...
Cohesion: 0.34
Nodes (15): POST(), authenticateWithGoogle(), POST(), loginGuardian(), errorResponse(), accessTokenTtlSeconds(), parseDurationSeconds(), refreshTokenTtlSeconds() (+7 more)

### Community 135 - "Community 135"
Cohesion: 0.1
Nodes (21): hashOtpCode(), verifyOtpChallenge(), GoogleAuthInput, googleAuthSchema, LoginInput, loginSchema, otpChannelSchema, otpPurposeSchema (+13 more)

### Community 136 - "Community 136"
Cohesion: 0.08
Nodes (20): financeIntegrityHash(), checkAuditChain(), DRIFT_CODES, after, broken, claimId, db, entry() (+12 more)
...
Cohesion: 0.09
Nodes (20): CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS, CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, MOCK_HOSTELS (+12 more)

### Community 143 - "Community 143"
Cohesion: 0.11
Nodes (20): formatDistance(), hostelCoordinates(), isUsableCoordinate(), KATHMANDU, fetchRoadRoute(), isRecord(), parseRoadRoute(), parseSteps() (+12 more)
...
Cohesion: 0.2
Nodes (19): formatRupees(), subscriptionInvoiceEmail(), METHOD_LABELS, subscriptionReceiptEmail(), hostelRegisteredByTeamEmail(), hostelVerifiedEmail(), hostelSubmissionReceivedEmail(), appBase() (+11 more)
...
Cohesion: 0.15
Nodes (18): FILE_ASSET_KINDS, FileAssetKind, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits() (+10 more)
...
Cohesion: 0.09
Nodes (18): allBlank, blankable, parsed, paths, result, validProfile, BLOOD_GROUP_VALUES, DIETARY_PREFERENCE_VALUES (+10 more)
...
Cohesion: 0.08
Nodes (23): Account deletion purge, Attendance maintenance (absence alerts + retention purge), Authentication, Check push delivery receipts, Complaint SLA breach check, cron-job.org setup (per job), CRON.md — Scheduled Jobs, Dispatch scheduled notifications (+15 more)
...
Cohesion: 0.22
Nodes (22): assertMatchesExtension(), downloadAndShare(), downloadAndShareCsv(), downloadAndShareImage(), downloadToDevice(), forgetDownloadFolder(), LegacyFileSystem, loadLegacyFileSystem() (+14 more)
...
Cohesion: 0.1
Nodes (11): TYPE_COLORS, DraggablePinMap, FALLBACK_CENTER, LocationPicker(), LocationPickerValue, PART_LABELS, AddressParts, GeocodePrecision (+3 more)
...
Cohesion: 0.13
Nodes (15): BASE_URLS, khaltiProvider, attempt, fetchMock, initiated, live, request, sandbox (+7 more)
...
Cohesion: 0.13
Nodes (15): logout(), cook, createUser(), createUserDoc(), MockSessionModel, owner, serviceMocks, session (+7 more)

### Community 180 - "Community 180"
Cohesion: 0.24
Nodes (17): GET(), resolvePastedLink(), searchCandidates(), lookupLocation(), resolvePastedLink(), searchCandidates(), queryVariants(), reverseGeocode() (+9 more)
...
Cohesion: 0.14
Nodes (15): auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex(), HostelRecord, ListingFlagListQuery, ListingFlagRecord, ListingFlagResolveInput, ListingFlagServiceError (+7 more)
...
Cohesion: 0.13
Nodes (17): ApiFailure, ApiSuccess, AuthUser, confirmComplaintResolution(), createResidentComplaint(), listResidentComplaints(), listResidentPayments(), ResidentComplaint (+9 more)
...
Cohesion: 0.14
Nodes (14): buildHtml(), Marker, PlaceMarker, boundsCenter(), humanizeNearbyType(), NEARBY_GLYPHS, NEARBY_GROUPS, NEARBY_ICONS (+6 more)
...
Cohesion: 0.15
Nodes (15): generateMetadata(), robots(), sitemap(), STATIC_ROUTES, documentUrl(), InvoiceLean, PaymentLean, PlatformInvoiceRow (+7 more)
...
Cohesion: 0.17
Nodes (16): systemDocumentKindFromText(), drawCertificationStamp(), footerLine(), formatDate(), formatLongDate(), MONTHS, ReceiptPdfInput, renderReceiptPdf() (+8 more)

### Community 194 - "Community 194"
Cohesion: 0.24
Nodes (19): CARD_NOUNS, CardVariant, drawBack(), drawBrandLockup(), drawFooterSweep(), drawFront(), drawHeaderSweep(), drawIdCard() (+11 more)

### Community 195 - "Community 195"
Cohesion: 0.19
Nodes (19): issueSessionForUser(), login(), publicUser(), refreshAccessToken(), AuthTokenPayload, hashToken(), jwtSecret(), PurposeTokenPayload (+11 more)

### Community 196 - "Community 196"
Cohesion: 0.16
Nodes (17): softmatoDocsUrl(), BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan, CYCLE_LABELS, daysUntil(), getBillingHistory() (+9 more)
...
Cohesion: 0.18
Nodes (9): Claim, CouldNotCreateFileException, HostelHubDownloadsModule, NoContextException, NothingOpensThisException, UnreadableSourceException, UnsupportedOnThisAndroidException, file (+1 more)

### Community 199 - "Community 199"
Cohesion: 0.2
Nodes (20): AttendanceLog, AuditLog, code:typescript (interface IAuditLog {), code:typescript ({), code:typescript ({), code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({) (+12 more)

### Community 200 - "Community 200"
Cohesion: 0.12
Nodes (20): 2.2 Hostel Approved, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.3 Payment Proof Uploaded (to Admin), 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, 4.1 New Notice Posted (+12 more)
...
Cohesion: 0.15
Nodes (16): DayRow(), AttendanceDay, AttendanceMonth, AttendanceSource, AttendanceSummary, AttendanceTone, AttendanceZone, ResidentAttendance (+8 more)

### Community 205 - "Community 205"
Cohesion: 0.2
Nodes (12): platformSettingSchema, DEFAULT_SITE_CONFIG, coerceSection(), getPublicSiteConfig(), getSiteConfig(), PlatformSettingRecord, PublicSiteConfig, SiteConfigServiceError (+4 more)

### Community 206 - "Community 206"
Cohesion: 0.13
Nodes (6): PublicInquiryPage(), ComparePageSkeleton(), HostelDetailPageSkeleton(), HostelListingPageSkeleton(), InquiryPageSkeleton(), InquiryPage()

### Community 207 - "Community 207"
Cohesion: 0.17
Nodes (14): platformAdminInviteSchema, deleteTeamMember(), endSessions(), findMember(), MemberRecord, reinstateTeamMember(), removeTeamMember(), suspendTeamMember() (+6 more)

### Community 208 - "Community 208"
Cohesion: 0.15
Nodes (14): getResidentProfile(), login(), requestOtp(), signInWithGoogle(), triggerSOS(), RootStackParamList, LoginScreen(), Props (+6 more)
...
Cohesion: 0.13
Nodes (16): after, ambiguous, before, candidates, dirname, EXACT, keyed, normalizeBedType() (+8 more)

### Community 214 - "Community 214"
Cohesion: 0.11
Nodes (13): claim, eventId, existing, future, hostelId, invoiceId, mocks, originalUpdate (+5 more)
...
Cohesion: 0.16
Nodes (18): Attendance / Night Safety, code:typescript (interface IQRActivation {), code:typescript (interface INightStatusLog {), code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface INotice {), code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {) (+10 more)

### Community 218 - "Community 218"
Cohesion: 0.13
Nodes (13): activateResident(), AuthSession, submitResidentReview(), AppNavigator(), Stack, Props, ResidentActivationScreen(), styles (+5 more)

### Community 219 - "Community 219"
Cohesion: 0.11
Nodes (18): 2. Environment Variables, App, Auth / JWT, Cloudflare R2, Cookies, limits, logging, Cron, Database, Email (Resend) (+10 more)
...
Cohesion: 0.15
Nodes (15): ContentSection, EMPTY_PAGE, FALLBACK_SITE_CONFIG, getSiteConfig(), MobileSiteConfig, SiteConfigResponse, SiteContent, SiteFeatures (+7 more)
...
Cohesion: 0.12
Nodes (16): 10. File Uploads, 11. QR Activation (Public/Resident), 12. Platform Config (Public - Limited Fields), 13. Cron Jobs (Internal, Auth-Protected by Shared Secret), 14. Duplicate/Ghost Listing Detection (Internal Logic), 16. Cook Account Setup (Internal), 17. Notifications (all authenticated roles), 2.1 Temporary access logins (all authenticated roles) (+8 more)

### Community 232 - "Community 232"
Cohesion: 0.15
Nodes (15): apiRequest(), getActivationStatus(), listNotifications(), listResidentFood(), markNotificationRead(), NotificationItem, refreshSession(), ResidentFoodMenu (+7 more)
...
Cohesion: 0.18
Nodes (12): appBlurTarget, closeConfirm(), ConfirmRequest, emit(), getConfirmRequest(), listeners, openConfirm(), subscribeToConfirm() (+4 more)
...
Cohesion: 0.12
Nodes (12): DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), monthLabel(), toNumber(), toNumber() (+4 more)

### Community 239 - "Community 239"
Cohesion: 0.14
Nodes (8): secretsMatch(), ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, GatewayProvider, adapters, SHIPPED
...
Cohesion: 0.22
Nodes (12): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, HostelPhotoReminder(), canAccessWorkspace(), defaultWorkspaceSlug(), isAuthBypassed(), listWorkspaceHostels(), previewHostels() (+4 more)

### Community 242 - "Community 242"
Cohesion: 0.12
Nodes (8): accountId, compact, guardian, NO_CLEARANCE, publicId, serviceMocks, staffPrincipal, wardenId

### Community 243 - "Community 243"
Cohesion: 0.17
Nodes (14): CurrentUser, DASHBOARD_ROLES, dashboardHrefForRole(), hasDashboard(), MeResponse, moreItems, navItems, providerNavItems (+6 more)
...
Cohesion: 0.19
Nodes (12): ClaimDraft, clearClaimDraft(), keyFor(), readClaimDraft(), saveClaimDraft(), isResizableImage(), loadManipulator(), Manipulator (+4 more)
...
Cohesion: 0.16
Nodes (11): chelseaMarket, geistMono, geistSans, metadata, poppins, RootLayout(), MediaViewerProvider(), QueryProvider() (+3 more)
...
Cohesion: 0.13
Nodes (11): afterReversal, checker, eventId, hostelId, invoiceId, ledger, maker, mocks (+3 more)
...
Cohesion: 0.19
Nodes (15): code:typescript ({), code:typescript (interface IMoveInChecklistItem {), code:typescript (interface IMoveOutChecklistItem {), code:typescript (interface IServiceProvider {), code:typescript (interface IServiceProvider {), code:typescript (interface IMaintenanceRequest {), Complaint, ComplaintUpdate (+7 more)
...
Cohesion: 0.22
Nodes (10): InquiryStatus, ManagedInquiry, BUCKETS, inquiriesIn(), InquiryAction, inquiryActions(), InquiryBucket, inquiryCounts() (+2 more)

### Community 267 - "Community 267"
Cohesion: 0.22
Nodes (11): NearbyStatus, hasLocationPermission(), hasPromptedForLocation(), LocationOutcome, NavigationFix, readPosition(), rememberLocationPrompt(), requestDeviceLocation() (+3 more)

### Community 268 - "Community 268"
Cohesion: 0.21
Nodes (12): PlansConfig, buildPresentation(), featuresFor(), fit(), FORBIDDEN_PATTERNS, isSafe(), LIMITS, plain() (+4 more)
...
Cohesion: 0.31
Nodes (9): AuthServiceError, changePassword(), getCurrentUser(), sameIds(), POST(), getBearerToken(), verifyAccessToken(), GET() (+1 more)
...
Cohesion: 0.2
Nodes (12): activeSuperadminCount(), createPlatformAdmin(), CreatePlatformAdminInput, generateTemporaryPassword(), loginUrl(), PLATFORM_ADMIN_ROLES, PlatformAdminRole, PlatformAdminServiceError (+4 more)
...
Cohesion: 0.15
Nodes (14): 0.1 The shared Softmato domain, 0.2 Categories — which mailbox a message comes from, 0.2a Where replies go, 0.3 Where the sender is configured, 0.4 Template structure, 0. Sending Infrastructure, 1.1 Email Verification (PUBLIC Signup), code:block1 (softmato.com) (+6 more)
...
Cohesion: 0.21
Nodes (9): attacker, attempt(), headers, jsonRequest(), routeMocks, resetPasswordWithToken(), revokeAllSessions(), POST() (+1 more)

### Community 287 - "Community 287"
Cohesion: 0.18
Nodes (9): hasGeolocation(), LocationOutcome, NavigationFix, OrientationPermission, requestDeviceLocation(), requestHeadingPermission(), Unsubscribe, watchDeviceHeading() (+1 more)
...
Cohesion: 0.17
Nodes (11): accessId, adminPrincipal, codes, guardianId, guardianPrincipal, issue(), leanResult(), mocks (+3 more)
...
Cohesion: 0.18
Nodes (12): 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 7.2 Subscription Expiring Soon, 9.1 Account Deletion Requested, 9.1a Account Deletion Request Needs Review *(added 2026-08-02)*, 9.2 Account Deletion Cancelled, 9.3 Location History Deletion Approved, 9. Account & Privacy Emails, code:typescript ({) (+4 more)
...
Cohesion: 0.24
Nodes (9): listStatementImports(), GET(), POST(), assignOrphanSchema, bulkApproveStatementSchema, STATEMENT_PROVIDERS, StatementImportInput, statementImportSchema (+1 more)
...
Cohesion: 0.24
Nodes (11): 1.0 Signup One-Time Code, 1.2 Hostel Admin Credentials (Post-Approval), 1.3 Warden Credentials, 1.5 Guardian Invitation, 1.6 Password Reset, 1. Authentication & Account Emails, code:typescript ({), code:typescript ({) (+3 more)

### Community 330 - "Community 330"
Cohesion: 0.2
Nodes (11): 1.4 Resident QR Activation, 1.7 Account Upgraded, 2.1 Hostel Submission Received, 2.3 Hostel Rejected, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, code:typescript ({), code:typescript ({) (+3 more)
...
Cohesion: 0.2
Nodes (9): calendarRoot, config, foodRoot, { getDefaultConfig }, netinfoShim, nightRoot, path, plansRoot (+1 more)
...
Cohesion: 0.22
Nodes (8): OrphanAssignPicker, HostelAdminReconcilePageContent, labelled(), PROVIDERS, Reconciliation, StatementImportRow, Suggestion, mimeTypeForStatement()

### Community 346 - "Community 346"
Cohesion: 0.22
Nodes (6): NEXT_STATUSES, OrdersPayload, OrderStatus, PlatformStoreOrdersPageContent, STATUS_TONE, StoreOrder
...
Cohesion: 0.22
Nodes (8): dirname, { loadEnvConfig }, nextConfig, repoRoot, require, SECURITY_HEADERS, SHARP_NATIVE, TESSERACT_RUNTIME
...
Cohesion: 0.48
Nodes (6): openTarget(), readPayload(), resubscribe(), safePath(), showNotification(), urlBase64ToUint8Array()
...
Cohesion: 0.5
Nodes (3): ensurePlayer(), playReactionPop(), REACTION_POP
...
Cohesion: 0.4
Nodes (4): activationCodeGenerateSchema, activationCodeSchema, activationStatusQuerySchema, objectIdSchema

### Community 460 - "Community 460"
Cohesion: 0.7
Nodes (3): verifyEmailWithToken(), verifyEmailSchema, POST()
...
## Knowledge Gaps
- **5391 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+5386 more)
...
- **Why does `cn()` connect `Community 16` to `Community 1`, `Community 4`, `Community 6`, `Community 7`, `Community 392`, `Community 9`, `Community 12`, `Community 19`, `Community 22`, `Community 24`, `Community 25`, `Community 26`, `Community 285`, `Community 29`, `Community 31`, `Community 34`, `Community 36`, `Community 47`, `Community 53`, `Community 62`, `Community 196`, `Community 69`, `Community 77`, `Community 206`, `Community 82`, `Community 345`, `Community 97`, `Community 243`, `Community 120`, `Community 124`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 1` to `Community 2`, `Community 4`, `Community 6`, `Community 9`, `Community 11`, `Community 12`, `Community 14`, `Community 16`, `Community 18`, `Community 20`, `Community 22`, `Community 24`, `Community 29`, `Community 31`, `Community 160`, `Community 33`, `Community 35`, `Community 165`, `Community 38`, `Community 50`, `Community 60`, `Community 66`, `Community 68`, `Community 77`, `Community 89`, `Community 345`, `Community 120`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 237` to `Community 0`, `Community 134`, `Community 6`, `Community 9`, `Community 11`, `Community 145`, `Community 18`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 28`, `Community 32`, `Community 34`, `Community 163`, `Community 170`, `Community 42`, `Community 172`, `Community 48`, `Community 178`, `Community 308`, `Community 180`, `Community 54`, `Community 55`, `Community 52`, `Community 62`, `Community 66`, `Community 78`, `Community 81`, `Community 348`, `Community 96`, `Community 225`, `Community 102`, `Community 106`, `Community 239`, `Community 122`, `Community 125`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Are the 425 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 425 INFERRED edges - model-reasoned connections that need verification._
- **Are the 5 inferred relationships involving `useAppTheme()` (e.g. with `CommunityPostCard()` and `MediaGrid()`) actually correct?**
  _`useAppTheme()` has 5 INFERRED edges - model-reasoned connections that need verification._
- **What connects `{ defineConfig }`, `expoConfig`, `path` to the rest of the system?**
