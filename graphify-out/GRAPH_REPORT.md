...
## Corpus Check
- 2340 files · ~5,129,099 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21149 nodes · 59724 edges · 602 communities (566 shown, 36 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 1167 edges (avg confidence: 0.8)
...
## Communities (602 total, 36 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.0
Nodes (496): 594(), 978(), [A,P], {actionStateRoute:v,navigationState:P}, activate(), activeAnimationId(), activeThemeId(), {addKeyedListener:i} (+488 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (290): GET(), POST(), PATCH(), POST(), RouteContext, POST(), GET(), POST() (+282 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (211): ICONS, LABELS, Segment, TONES, FILTERS, Pending, Overview, MoneyData (+203 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (219): LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), csvField(), field(), Hostel, HostelAdminDashboardPageContent() (+211 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (316): loadOverview(), loadMoney(), loadToday(), AttachmentGallery(), FLAGGED, ReportedPostCard(), loadFinance(), DeletionRequest (+308 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (204): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel() (+196 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (191): FieldCashRow, PlanPaymentClaim, formatBsAdDate(), deferLoad(), DemoDataBadge(), Hostel, HostelTable(), Inquiry (+183 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (241): POST(), GET(), getOpenFeeSchedule(), GET(), listPublicFoodRoutine(), recordListingAppearances(), addHostelAdminInquiryNote(), auditInquiryAction() (+233 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (208): Scanner(), CookInviteScreen(), GuardianInviteScreen(), Choice, MapButton(), MapScreen(), ModeTab(), NOTHING_CHOSEN (+200 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (148): number(), toNumber(), statusCodeOf(), toNumber(), _(), 276(), 601(), a() (+140 more)
...
Cohesion: 0.02
Nodes (220): answerSchema, POST(), ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput (+212 more)

### Community 12 - "Community 12"
Cohesion: 0.01
Nodes (191): auditFinanceAction(), FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment() (+183 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (196): BAND_WIDTH, DiscoveryHeader(), DiscoveryHeaderProps, IconButton(), MapButton(), cropToGuide(), FILL, GuidedCapture() (+188 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (17): Render the pamphlet.  One master per side: A4 + 3 mm bleed at 600 dpi. The A4, shoot(), addPendingGesture(), cancelEvent(), composedPath(), __destroy_into_raw(), forceInvalidate(), free() (+9 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (201): MESSAGES, POST(), RouteContext, BookingEndCause, HostelBookingClosedCause, announceConfirmed(), announceEnding(), assertAwaitingAnswer() (+193 more)
...
Cohesion: 0.01
Nodes (165): adminPrincipal, mocks, PLATFORM_LIMITS, mocks, readable, selectable, mocks, proofBody (+157 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (171): robots(), otpResendCooldownMs(), checkoutDocumentFor(), softmatoDocumentNumbers(), gateway, invoice, updateOne, documentDownloadUrl() (+163 more)
...
Cohesion: 0.03
Nodes (151): POST(), RouteContext, DELETE(), GET(), hostelId(), GET(), GET(), GET() (+143 more)

### Community 21 - "Community 21"
Cohesion: 0.06
Nodes (124): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), ATTACHED, dueWhen() (+116 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (141): openStore(), AdminMoreScreen(), ActivateScreen(), BootGate(), RootShell(), NightStatusHistoryScreen(), NotificationsScreen(), SettingsScreen() (+133 more)

### Community 23 - "Community 23"
Cohesion: 0.02
Nodes (156): AdminAlertsScreen(), AdminCommunityReportsScreen(), AdminHomeScreen(), AdminOverviewScreen(), AdminTabs(), AdminMoneyScreen(), AdminResidentsScreen(), AdminTodayScreen() (+148 more)

### Community 24 - "Community 24"
Cohesion: 0.02
Nodes (131): AdminCommunityScreen(), SosScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD (+123 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (142): CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard(), AmountCard(), AdminLedger, AdminLedgerEntry (+134 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (134): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, notifyHostelOfNewPost(), resolveHostelCommunityUserIds(), usersMutingNewPosts(), notifyAdminsOfNewComplaint() (+126 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (162): aa(), Ad(), af(), ai(), Al(), as(), bc(), bo() (+154 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (118): generateMetadata(), generateMetadata(), manifest(), notFound(), CityHostelsPage(), generateMetadata(), PageParams, generateMetadata() (+110 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (89): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, budgetLabel(), LoadState (+81 more)

### Community 30 - "Community 30"
Cohesion: 0.02
Nodes (105): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), ApplyBlock(), ServiceProvidersScreen() (+97 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (141): _adopt(), _animationLoop(), ar(), assignAnimationToWorker(), at(), broadcastMessage(), Bt(), _cleanupCanvas() (+133 more)

### Community 32 - "Community 32"
Cohesion: 0.02
Nodes (122): BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan, BillingSkip (+114 more)
...
Cohesion: 0.03
Nodes (115): CommunityPageContent(), labelled(), VideoSlot(), CollectionQrField(), FileUploadArea(), TradeDetailsStep(), PhotoStrip(), downloadCaption() (+107 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (111): ReviewForm(), ReviewScreen(), describeGrants(), GuardianRow(), PermissionSheet(), InviteGuardianScreen(), inviteGuardian(), listGuardians() (+103 more)

### Community 36 - "Community 36"
Cohesion: 0.02
Nodes (90): GET(), listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), checkFieldCash(), listFieldCashToConfirm(), getPlatformSubscriptionLedger() (+82 more)

### Community 37 - "Community 37"
Cohesion: 0.02
Nodes (96): EMPTY_PAYOUT_DRAFT, METHODS, PayoutAccountDraft, PayoutAccountFields(), payoutAccountPayload(), AuthGuard(), DescriptionFacts, DescriptionSuggestions() (+88 more)

### Community 38 - "Community 38"
Cohesion: 0.02
Nodes (9): 42(), Eo(), hex(), hexa(), n, percentString(), round(), sm_start() (+1 more)

### Community 39 - "Community 39"
Cohesion: 0.02
Nodes (30): abort(), addChangeListener(), addEventListener(), addListenerForTag(), cancel(), clearInteractionHandle(), configureNextLayoutAnimation(), createGestureHandler() (+22 more)

### Community 40 - "Community 40"
Cohesion: 0.02
Nodes (82): authorUserId, mocks, postId, residentId, residentPrincipal, staffPrincipal, AnnouncementInput, CommentCreateInput (+74 more)

### Community 41 - "Community 41"
Cohesion: 0.03
Nodes (92): GET(), ownerIdentitiesFor(), resolveOwnedHostel(), checkoutSchema, POST(), DELETE(), RouteContext, deleteOwnComment() (+84 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (95): SORTS, StoreCategoryScreen(), AdminSearchBar(), FilterSheet(), useSystemInsets(), formatResidentIdInput(), normalizeResidentId(), residentIdError() (+87 more)

### Community 43 - "Community 43"
Cohesion: 0.03
Nodes (97): BrandMark(), BrandWordmark(), WORDMARK, WORDMARK_SEGMENTS, LedgerMonth, LedgerPayment, ResidentLedger, ResidentPaymentTrackSheet (+89 more)

### Community 44 - "Community 44"
Cohesion: 0.03
Nodes (94): collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor() (+86 more)

### Community 45 - "Community 45"
Cohesion: 0.03
Nodes (97): demoteToPublicAccount(), mocks, work, LIVE_STATUSES, LiveResidency, liveResidencyMessage(), LiveRow, acceptResidencyInvite() (+89 more)

### Community 46 - "Community 46"
Cohesion: 0.02
Nodes (11): createInteractionHandle(), duration(), __getAnimatedValue(), __getValue(), impactAsync(), __onAnimatedValueUpdateReceived(), replace(), s (+3 more)

### Community 47 - "Community 47"
Cohesion: 0.03
Nodes (75): BookingQuote, GuestBookingDetail, GuestBookingSummary, HostelBookingView, metadata, PayoutAccountForReview, ReviewPayoutAccount(), STATUS_LABEL (+67 more)

### Community 48 - "Community 48"
Cohesion: 0.03
Nodes (86): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, HostelPayeeIdentity, GATEWAY_ORDER (+78 more)

### Community 49 - "Community 49"
Cohesion: 0.02
Nodes (7): array(), deactivate(), disconnect(), l(), returnValue(), so(), watchDeviceHeading()

### Community 50 - "Community 50"
Cohesion: 0.03
Nodes (22): __addChild(), f(), get_slot_str(), __getNativeConfig(), __getNativeTag(), __getPlatformConfig(), getSlot(), hasListeners() (+14 more)

### Community 51 - "Community 51"
Cohesion: 0.03
Nodes (75): summarizeResidentComplaints(), LedgerInvoice, releaseGuardianAccounts(), daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess(), GuardianAccessRecord, GuardianInvitationAcceptInput (+67 more)

### Community 52 - "Community 52"
Cohesion: 0.03
Nodes (73): ConcessionBackfill, describeApplied(), FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, MonthDiscounts, monthStartPeriod(), Rate (+65 more)

### Community 53 - "Community 53"
Cohesion: 0.03
Nodes (76): bookingPolicyVersion(), newBookingCode(), applyBookingConfig(), BookingCancelStep, bookingCancelStepSchema, BookingConfig, bookingConfigSchema, DEFAULT_BOOKING_CONFIG (+68 more)
...
Cohesion: 0.04
Nodes (73): POST(), cook, assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES, PermissionError, PLATFORM_ROLES (+65 more)
...
Cohesion: 0.04
Nodes (85): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodBounds() (+77 more)

### Community 58 - "Community 58"
Cohesion: 0.03
Nodes (68): Offset, PhotoCropper(), buildIdCardData(), EMAIL_CHECK_HINTS, EmailCheck, Field(), FIELD_LABELS, formatCardDate() (+60 more)

### Community 59 - "Community 59"
Cohesion: 0.04
Nodes (63): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, ENDPOINTS, esewaProvider, getJson(), parseAmount(), SIGNED_FIELDS (+55 more)

### Community 60 - "Community 60"
Cohesion: 0.03
Nodes (27): an(), bn(), build(), c, Ff(), getImageAsync(), hn(), ln() (+19 more)

### Community 61 - "Community 61"
Cohesion: 0.03
Nodes (64): BillingInvoiceRow, BillingPaymentRow, BillingPlan, metadata, CheckoutHandoffButton(), Handoff, ORDER, ProgressStep (+56 more)

### Community 62 - "Community 62"
Cohesion: 0.04
Nodes (71): DELETE(), POST(), platformPushScheduleSchema, CampaignListQuery, CampaignRecord, createCampaign(), createHostelNotificationCampaign(), createPlatformNotificationCampaign() (+63 more)

### Community 63 - "Community 63"
Cohesion: 0.04
Nodes (69): POST(), GET(), listResidentGuardians(), DEFAULT_GUARDIAN_PERMISSIONS, guardianAccessCreateSchema, guardianInvitationAcceptSchema, guardianInviteSchema, guardianLoginSchema (+61 more)

### Community 64 - "Community 64"
Cohesion: 0.04
Nodes (61): AuthShell(), AuthShellProps, PANEL_COPY, SiteWordmark(), metadata, RefundPolicy, ContentHeader(), ContentIntro() (+53 more)

### Community 65 - "Community 65"
Cohesion: 0.04
Nodes (8): cancelAnimationFrame(), clear(), darken(), __debouncedOnEnd(), emit(), h(), pause(), pausePreview()

### Community 66 - "Community 66"
Cohesion: 0.04
Nodes (56): outstandingForResident(), CookServiceError, resolveAdminHostelId(), assertHostelAccess(), hostelScopedFilter(), TenantAccessError, TenantPrincipal, bedSchema (+48 more)

### Community 67 - "Community 67"
Cohesion: 0.04
Nodes (65): AdminAlertsContext, AdminAlertsProvider(), AdminAlertsValue, AlertActions, EMPTY_COUNTS, ICONS, LABELS, QUICK_REJECT_REASONS (+57 more)

### Community 68 - "Community 68"
Cohesion: 0.05
Nodes (54): POST(), POST(), POST(), runPlanDueReminders(), POST(), POST(), POST(), RouteContext (+46 more)

### Community 69 - "Community 69"
Cohesion: 0.04
Nodes (65): logAccessFailure(), openHostelAfterPayment(), BookableHostel, BookingUnavailableReason, hostelCoverPhoto(), hostelCoverPhotos(), hostelUnavailableReason(), RoomAvailability (+57 more)

### Community 70 - "Community 70"
Cohesion: 0.04
Nodes (56): BookButton(), SIZE, BookingAvailabilityView, BookingButton, CLOSED_REASONS, open, HostelSuggestions(), PublicComparePage() (+48 more)

### Community 71 - "Community 71"
Cohesion: 0.03
Nodes (49): AuditLogRecord, PlatformAuditLogQuery, RefRecord, serializeAuditLog(), mocks, PaginationMeta, PaginationQuery, querySchema (+41 more)

### Community 72 - "Community 72"
Cohesion: 0.05
Nodes (67): dueBhadra29, filed, throughAswin25, daysSpanned(), daysUntil(), CHANNELS, ClaimedStep, composeEmail() (+59 more)
...
Cohesion: 0.05
Nodes (50): chelseaMarket, geistMono, geistSans, metadata, poppins, RootLayout(), currentBsPeriod(), AccountDeletionPanel (+42 more)
...
Cohesion: 0.04
Nodes (57): PlanId, Service, ServiceModule, ServiceModuleId, Faq, PlatformConfigSeoPageContent, Step, PLAN_MODULES (+49 more)

### Community 80 - "Community 80"
Cohesion: 0.06
Nodes (51): GET(), POST(), querySchema, RouteContext, commentOnPost(), createCommunityAnnouncement(), createCommunityPost(), decoratePosts() (+43 more)
...
Cohesion: 0.06
Nodes (57): UploadCard(), useIsUploading(), directionOf(), EMPTY_TALLY, floorToStep(), phaseOf(), shouldRepost(), tallyUploads() (+49 more)

### Community 85 - "Community 85"
Cohesion: 0.06
Nodes (56): formatPeriodKey(), cellAt(), focusCell(), INPUT_MODES, Props, fullYear(), MONTH_SPELLINGS, monthFromWord() (+48 more)
...
Cohesion: 0.05
Nodes (45): DEPRECATED_ALIASES, mocks, ADMIN_ISSUABLE_ROLES, AdminIssuableRole, generateTemporaryPassword(), HIGH_PRIVILEGE_ROLES, loginUrl(), RegisterOrUpgradeInput (+37 more)

### Community 88 - "Community 88"
Cohesion: 0.05
Nodes (51): BookingForm(), CheckoutScreen(), METHODS, PackageCard(), PayStep(), roomPhotoUris(), StatusCard(), BookingScreen() (+43 more)
...
Cohesion: 0.05
Nodes (45): POST(), hostelToday(), dayOfWeekSchema, foodFeedbackSchema, foodMenuCreateSchema, foodMenuListQuerySchema, foodMenuUpdateSchema, foodPhotoUploadSchema (+37 more)

### Community 91 - "Community 91"
Cohesion: 0.04
Nodes (44): HostelAdminCooksPanel, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine, formatWeekRange() (+36 more)
...
Cohesion: 0.05
Nodes (40): FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES, avatarTone(), CommunityComment (+32 more)

### Community 94 - "Community 94"
Cohesion: 0.07
Nodes (43): Guidance, GuidanceStatus, proximityScore(), hasGeolocation(), LocationOutcome, NavigationFix, OrientationPermission, requestDeviceLocation() (+35 more)

### Community 95 - "Community 95"
Cohesion: 0.05
Nodes (39): CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS, CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, MOCK_HOSTELS (+31 more)

### Community 96 - "Community 96"
Cohesion: 0.07
Nodes (38): Entry, hostelEntries(), locationEntries(), sitemap(), STATIC_ROUTES, PublicFooter(), listPublishedHostelSlugs(), buildCityIndex() (+30 more)
...
Cohesion: 0.08
Nodes (40): assertPlanRoom(), countLive(), notifyLimitReached(), NOUN, PlanLimitError, PlanSeat, hostelId, mocks (+32 more)

### Community 99 - "Community 99"
Cohesion: 0.05
Nodes (44): hostelDayParts(), HOSTEL_AGREEMENT_STATUSES, hostelAgreementSchema, PLATFORM_DOCUMENT_KINDS, platformDocumentSequenceSchema, TRACK_SHEET_EVENT, AGREEMENT_STATUSES, agreementRef() (+36 more)
...
Cohesion: 0.08
Nodes (39): Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity() (+31 more)

### Community 105 - "Community 105"
Cohesion: 0.07
Nodes (36): addUtcDay(), auditFoodAction(), dayRange(), FoodFeedbackInput, FoodFeedbackRecord, FoodMenuCreateInput, FoodMenuListQuery, FoodMenuRecord (+28 more)

### Community 106 - "Community 106"
Cohesion: 0.1
Nodes (34): bodySchema, POST(), deleteHostelObjects(), ImageVariantRecord, optimizeImage(), streamToBuffer(), VARIANT_CONFIG, VariantName (+26 more)
...
Cohesion: 0.07
Nodes (31): EvidenceEngine, EvidenceReadFailure, OcrResult, OcrWord, KEYS, saved, IMAGE, lines (+23 more)
...
Cohesion: 0.1
Nodes (36): personalLookupHash(), hostelPageViewSchema, findLiveResidency(), LEGACY_ROLE_MAP, Role, ROLE_VALUES, ageFromDateOfBirth(), ASSET_KINDS (+28 more)

### Community 118 - "Community 118"
Cohesion: 0.13
Nodes (34): assertMatchesExtension(), beginDownload(), downloadAndShare(), downloadAndShareCsv(), downloadAndShareImage(), downloadToDevice(), forgetDownloadFolder(), LegacyFileSystem (+26 more)
...
Cohesion: 0.07
Nodes (33): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse (+25 more)
...
Cohesion: 0.13
Nodes (26): bookingDocumentLayout(), refundPolicyNotes(), allowed(), bookingDocumentResponse(), BookingDocumentScope, resolveBookingDocument(), HostelScope, ResolvedDocument (+18 more)
...
Cohesion: 0.1
Nodes (28): bsMonthStart(), hostelCalendarDay(), discountRent(), FeeScheduleRecord, hostelCalendarDay(), hostelMonthStart(), hostelToday(), once (+20 more)
...
Cohesion: 0.13
Nodes (26): native, NativeDownloads, openDownloaded(), openSavedFile(), SavedDownload, NativeNightPrompt, takeNativePendingAnswers(), isNightStatusPrompt() (+18 more)
...
Cohesion: 0.07
Nodes (19): AuthExperiencePage(), PublicPricingPage(), ProviderDirectoryData, ResidentActivationPageContent, ResidentActivationPageContent(), ServiceProviderRegistrationPage(), categories, fields (+11 more)

### Community 134 - "Community 134"
Cohesion: 0.1
Nodes (28): DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS, MealCard(), RoutineMeal, CookMenuScreen(), CookPortalSettings (+20 more)
...
Cohesion: 0.11
Nodes (29): ApiFailure, apiRequest(), ApiSuccess, AuthUser, confirmComplaintResolution(), createPublicInquiry(), createResidentComplaint(), getActivationStatus() (+21 more)
...
Cohesion: 0.1
Nodes (21): configureNativeNightPrompt(), claimNotificationSound(), claims, resetNotificationSoundClaims(), createAndroidChannels(), easProjectId(), fetchExpoPushToken(), forgetPushToken() (+13 more)
...
Cohesion: 0.1
Nodes (13): GoogleMap, LeafletMap, TYPE_COLORS, DraggablePinMap, FALLBACK_CENTER, LocationPicker(), PART_LABELS, AddressParts (+5 more)

### Community 155 - "Community 155"
Cohesion: 0.13
Nodes (21): computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), systemDocumentKindFromText(), distance, drawCertificationStamp(), footerLine() (+13 more)
...
Cohesion: 0.1
Nodes (21): CITY_OPTIONS, FACILITY_OPTIONS, hasHostelErrors(), hasUsableRooms(), HOSTEL_PLANS, HOSTEL_STEPS, HOSTEL_TYPES, HostelAttachment (+13 more)
...
Cohesion: 0.12
Nodes (13): COLUMNS, Member, MemberData, RegistrationTrackSheet(), TrackSheetLoader(), cellAt(), focusCell(), Props (+5 more)
...
Cohesion: 0.14
Nodes (16): getPresignedReadUrl(), userResidentProfileSchema, readProfile(), ResidentIdentityError, ResidentProfileData, findScannedAccount(), loadMembership(), PhotoAssetRecord (+8 more)
...
Cohesion: 0.16
Nodes (13): login(), register(), verifyOtp(), RootStackParamList, LoginScreen(), Props, OtpVerificationScreen(), Props (+5 more)
...
Cohesion: 0.14
Nodes (10): BankMark(), EsewaMark(), KhaltiMark(), MarkProps, NotesMark(), QrMark(), PaymentProfileResidentPreview, ProfileDraft (+2 more)
...
Cohesion: 0.15
Nodes (10): PromotableUser, promoteAccountToResident(), PROTECTED_ROLES, ResidentPromotion, standDownMemberships(), hostelId, memberId, mocks (+2 more)
...
Cohesion: 0.2
Nodes (8): open, KNOWN_PATHS, marksRoleChange(), opensPlanBilling(), resolvePushPath(), REWRITES, ROLE_CHANGE_TYPES, push
...
Cohesion: 0.15
Nodes (9): deliver(), hostelId, localInvoiceId, now, payload, presentation, softmato, stamp (+1 more)
...
Cohesion: 0.26
Nodes (10): url, view, Face, GET(), loadFaces(), loadLogos(), readAppFile(), readFont() (+2 more)
...
Cohesion: 0.27
Nodes (11): PlatformIdCardType, CARD_LABELS, formatIssuedOn(), readPhotoBytes(), readQrBytes(), readSignatureBytes(), sendIdCardEmail(), getResidentIdentityQr() (+3 more)
...
Cohesion: 0.2
Nodes (12): 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails, 4.3 Complaint Resolved, code:typescript ({) (+4 more)
...
Cohesion: 0.24
Nodes (10): ESEWA_PARSER, [first], FIXTURES, fromCsv, fromWorkbook, parse(), parseText(), read() (+2 more)
...
Cohesion: 0.24
Nodes (11): 4.2 Complaint Status Updated, 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, code:typescript ({), code:typescript ({) (+3 more)
...
Cohesion: 0.33
Nodes (8): DELETE(), RouteContext, assertWindow(), createSponsor(), deleteSponsor(), serializeSponsor(), updateSponsor(), writeAudit()
...
Cohesion: 0.25
Nodes (9): 7.1 New Hostel Pending Approval (to Superadmin), 7.2 Subscription Expiring Soon, 7. Platform Admin Emails, 8.1 Community Post Engagement (Batched), 8. Community & Notification Emails, code:typescript ({), code:typescript ({), code:typescript ({) (+1 more)
...
## Knowledge Gaps
- **6866 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+6861 more)
...
- **Why does `string()` connect `Community 15` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 14`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 37`, `Community 38`, `Community 39`, `Community 41`, `Community 42`, `Community 45`, `Community 46`, `Community 47`, `Community 48`, `Community 49`, `Community 50`, `Community 51`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 63`, `Community 65`, `Community 68`, `Community 69`, `Community 70`, `Community 71`, `Community 72`, `Community 75`, `Community 77`, `Community 81`, `Community 82`, `Community 83`, `Community 85`, `Community 87`, `Community 90`, `Community 99`, `Community 103`, `Community 108`, `Community 110`, `Community 111`, `Community 112`, `Community 113`, `Community 116`, `Community 120`, `Community 124`, `Community 135`, `Community 153`, `Community 155`, `Community 159`, `Community 174`, `Community 175`, `Community 177`, `Community 187`, `Community 190`, `Community 196`, `Community 205`, `Community 209`, `Community 230`, `Community 231`, `Community 248`, `Community 261`, `Community 277`, `Community 297`, `Community 314`, `Community 394`, `Community 404`, `Community 405`, `Community 445`, `Community 449`?**
  _High betweenness centrality (0.154) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 9` to `Community 128`, `Community 1`, `Community 5`, `Community 6`, `Community 394`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 22`, `Community 23`, `Community 152`, `Community 25`, `Community 24`, `Community 28`, `Community 29`, `Community 156`, `Community 157`, `Community 158`, `Community 33`, `Community 34`, `Community 36`, `Community 37`, `Community 39`, `Community 44`, `Community 174`, `Community 48`, `Community 49`, `Community 50`, `Community 52`, `Community 56`, `Community 57`, `Community 186`, `Community 187`, `Community 60`, `Community 61`, `Community 59`, `Community 317`, `Community 196`, `Community 70`, `Community 455`, `Community 77`, `Community 81`, `Community 209`, `Community 85`, `Community 93`, `Community 224`, `Community 230`, `Community 108`, `Community 110`, `Community 112`, `Community 374`, `Community 123`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 16` to `Community 128`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 264`, `Community 139`, `Community 140`, `Community 152`, `Community 28`, `Community 29`, `Community 34`, `Community 37`, `Community 423`, `Community 43`, `Community 47`, `Community 52`, `Community 312`, `Community 58`, `Community 61`, `Community 64`, `Community 70`, `Community 74`, `Community 76`, `Community 208`, `Community 85`, `Community 91`, `Community 93`, `Community 95`, `Community 97`, `Community 109`?**
...
- **What connects `iosUrlScheme`, `{ defineConfig }`, `expoConfig` to the rest of the system?**
  _6866 weakly-connected nodes found - possible documentation gaps or missing edges._