...
## Corpus Check
- 2121 files · ~3,311,521 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17058 nodes · 47157 edges · 565 communities (537 shown, 28 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 774 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 667 edges
2. `successResponse()` - 647 edges
3. `connectToDatabase()` - 470 edges
...
## Communities (565 total, 28 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (254): POST(), PATCH(), POST(), RouteContext, GET(), POST(), POST(), POST() (+246 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (185): ICONS, LABELS, Segment, TONES, FILTERS, Pending, Overview, MoneyData (+177 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (254): PATCH(), RouteContext, POST(), POST(), GET(), getOpenFeeSchedule(), GET(), POST() (+246 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (271): FinanceData, loadFinance(), PortalDates, useHostelDayTurn(), AdminInvoiceMatrix, AdminMaintenance, AdminModeration, AdminModerationFilter (+263 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (225): Scanner(), CookInviteScreen(), GuardianInviteScreen(), MapScreen(), Assurance(), CallableRow(), IdentityCard(), PeopleSection() (+217 more)
...
Cohesion: 0.02
Nodes (190): summarizeResidentComplaints(), GET(), POST(), outstandingForResident(), getFoodRoutine(), addUtcDay(), auditFoodAction(), createFoodMenu() (+182 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (143): PlanPaymentClaim, HostelTable(), Message(), UserRecord, GuardianDashboard, MatrixRow, MatrixTotals, PeriodSummary (+135 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (138): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage() (+130 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (156): GET(), POST(), GET(), GET(), answerSchema, POST(), readReturnState(), GET() (+148 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (155): POST(), POST(), POST(), attacker, attempt(), headers, jsonRequest(), routeMocks (+147 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (132): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel() (+124 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (158): FILTERS, invalidateFeeds(), NotificationRow(), TILE_GLYPH, TILE_TONES, writeFeedRead(), CommunityScreen(), Composer() (+150 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (173): loadOverview(), loadMoney(), loadToday(), AttachmentGallery(), SubscriptionDueCard(), DeletionRequest, DeletionStatus, getDeletionStatus() (+165 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (114): inferKind(), LightboxItem, MediaLightbox(), GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel (+106 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (145): PaymentMonthStrip(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard(), AmountCard(), AdminLedger (+137 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (128): deleteResidentLocationHistory(), DELETE(), checkoutSchema, POST(), DELETE(), RouteContext, GET(), POST() (+120 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (126): BrandMark(), BrandWordmark(), WORDMARK, WORDMARK_SEGMENTS, CommunityReportDialog(), REASONS, MonthOption(), HostelPreviewLink() (+118 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (128): DescriptionFacts, DescriptionSuggestions(), HostelType, since(), starters, typeWords, Offset, PhotoCropper() (+120 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (133): AdminCommunityReportsScreen(), AdminResidentsScreen(), AttendanceScreen(), NightStatusHistoryScreen(), NightStatusForm(), NightStatusScreen(), NotificationCard(), ProfileScreen() (+125 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (105): AdminCommunityScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+97 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (107): POST(), GET(), POST(), demoteToPublicAccount(), PATCH(), releaseGuardianAccounts(), acceptGuardianInvitation(), findResidentOwnedAccess() (+99 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (88): generateMetadata(), metadata, generateMetadata(), metadata, AccountDeletionPanel, ContentHeader(), ContentIntro(), ContentNote() (+80 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (104): notifyHostelOfNewPost(), resolveHostelCommunityUserIds(), usersMutingNewPosts(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus(), OPEN_STATUSES, OverdueComplaint (+96 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (90): PATCH(), RouteContext, listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), getPlatformSubscriptionLedger(), listPlanPaymentClaims() (+82 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (104): GET(), hashUserAgent(), HostelRef, newVisitorKey(), recordHostelPageView(), resolveVisitorKey(), personalLookupHash(), getPresignedReadUrl() (+96 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (90): resolveAttendanceAlert(), attendanceAlertResolveSchema, POST(), RouteContext, listTrendingTags(), PaginationMeta, paginationQuerySchema, paginationRange() (+82 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (90): ReviewForm(), ReviewScreen(), describeGrants(), GuardianRow(), PermissionSheet(), InviteGuardianScreen(), inviteGuardian(), listGuardians() (+82 more)

### Community 28 - "Community 28"
Cohesion: 0.09
Nodes (65): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), PLATFORM_NAME_PARTS, hostelDayParts() (+57 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (91): announceFoodReady(), startOfToday(), dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, isMonthEnd() (+83 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (73): bsPeriodOf(), FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, monthStartPeriod(), Rate, RoomTypeOption, gregorianSpan() (+65 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (66): csvField(), field(), Hostel, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminProfilePageContent(), HostelAdminRoomsPageContent(), Inquiry (+58 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (87): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt, subscriptionClaimReceivedEmail() (+79 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (84): findIndex(), index, indexesOf(), IndexSpec, promote, assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck (+76 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (78): collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor() (+70 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (64): CancelDeletionPageContent(), AcceptResult, CookInvitePageContent, AcceptResult, GuardianInvitePageContent, PlatformBroadcastPanel, OperationsConfig, PlanDueReminderSchedule (+56 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (70): NotificationsPageContent(), HostelAdminCooksPanel, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine (+62 more)
...
Cohesion: 0.04
Nodes (82): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), AdminTabs(), AdminMoneyScreen(), AdminTodayScreen(), AdminAlertsContext, AdminAlertsProvider() (+74 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (87): evidenceFlags(), CREDIT_MARKERS, DEBIT_MARKERS, DirectionRead, directionRefusal(), EvidenceDirection, EvidenceOutcome, matched() (+79 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (56): GET(), listResidentComplaints(), complaintCategorySchema, complaintCreateSchema, complaintListQuerySchema, complaintReplySchema, complaintResolutionConfirmSchema, complaintStatusSchema (+48 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (65): GET(), GET(), incidentLogSchema, manualStatusOverrideSchema, nightStatusLogSchema, sosAlertSchema, nightKey(), GET() (+57 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (71): cookLoginStem(), generateCookPassword(), mintCookLogin(), pick(), previousCookLabel(), acceptCookInvitation(), addCookAccount(), assertRoomForAnotherCook() (+63 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (68): RealtimeConfig, RealtimeContext, RealtimeContextValue, RealtimeNotification, RealtimeProvider(), HostelRef, notifyHostelOfInquiry(), notifyPlatformOfPendingHostel() (+60 more)

### Community 44 - "Community 44"
Cohesion: 0.03
Nodes (57): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), GatewayHealth (+49 more)

### Community 45 - "Community 45"
Cohesion: 0.03
Nodes (58): BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan, FeedPayload, SidebarPayload, Space, SpacesPayload (+50 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (71): fromBs(), gregorianOf(), BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary (+63 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (67): formatBsDayRange(), hostelToday(), BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped (+59 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (62): PRIORITIES, STATUS_ACTIONS, GatewayConfig, GatewayHealthStatus, HEALTH_STYLE, HostelAdminPaymentGatewaysPageContent, PROVIDER_COPY, SecretView (+54 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (50): csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, Inquiry, LoadState, numberField() (+42 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (57): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, metadata, HostelPhotoReminder(), daysUntil(), HostelSubscriptionDueBanner(), rupees(), State (+49 more)

### Community 51 - "Community 51"
Cohesion: 0.03
Nodes (61): cashThresholdFor(), RecordCashInput, RecordCashResult, afterReversal, checker, eventId, hostelId, invoiceId (+53 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (66): formatPeriodKey(), cellAt(), focusCell(), Props, DeliveryWindowFields(), number(), text(), budgetLabel() (+58 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (51): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, buildFormPostHandoff() (+43 more)

### Community 54 - "Community 54"
Cohesion: 0.08
Nodes (63): bsFiscalYear(), bsMonthName(), amountInWords(), GROUPS, ONES, TENS, underHundred(), underThousand() (+55 more)

### Community 55 - "Community 55"
Cohesion: 0.04
Nodes (57): AuthGuard(), CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing (+49 more)
...
Cohesion: 0.04
Nodes (45): fill(), PricingScreen(), HostelRegistrationProgress(), Milestone, milestoneIndex(), MILESTONES, PaymentPanel(), PlanPicker() (+37 more)

### Community 59 - "Community 59"
Cohesion: 0.05
Nodes (52): BrowserPushRow(), FILTERS, Notification, NotificationRow(), PushState, blankRow(), Row, TeamInviteBox() (+44 more)
...
Cohesion: 0.05
Nodes (58): openStore(), createResident(), getIntakeQuote(), IntakeQuote, lookupResidentProfile(), ManagedHostel, RESIDENT_TYPES, ResidentIntakeResult (+50 more)
...
Cohesion: 0.03
Nodes (38): ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, RETAINED_BY_HOSTEL_ID, both, covered (+30 more)
...
Cohesion: 0.05
Nodes (51): addHistory(), addMaintenanceComment(), assertBedInHostel(), assertProviderApproved(), assertRoomInHostel(), assertVoiceNoteUsable(), assignMaintenanceProvider(), auditMaintenanceAction() (+43 more)

### Community 69 - "Community 69"
Cohesion: 0.06
Nodes (39): HIDDEN, RoleLayout(), TABS, SosScreen(), TABS, BottomChrome, BottomChromeContext, BottomChromeProvider() (+31 more)

### Community 70 - "Community 70"
Cohesion: 0.06
Nodes (54): platformPushScheduleSchema, announceChange(), audit(), CreateInput, createNoticePush(), DEFAULT_PUSHES, deleteNoticePush(), emitNoticePush() (+46 more)

### Community 71 - "Community 71"
Cohesion: 0.04
Nodes (53): CONTENT_ICON_SLUGS, everything, IDENTITY, page, rendered, platformSettingSchema, DEFAULT_SITE_CONFIG, coerceSection() (+45 more)

### Community 72 - "Community 72"
Cohesion: 0.06
Nodes (50): documentUrl(), InvoiceLean, PaymentLean, PlatformInvoiceRow, PlatformPaymentRow, PlatformSubscriptionLedger, HostelScope, ResolvedDocument (+42 more)

### Community 73 - "Community 73"
Cohesion: 0.05
Nodes (46): EvidenceEngine, EvidenceReadFailure, OcrResult, OcrWord, KEYS, saved, IMAGE, lines (+38 more)
...
Cohesion: 0.05
Nodes (56): BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthStart(), bsPeriodBounds(), bsPeriodsBetween(), currentBsPeriod() (+48 more)

### Community 76 - "Community 76"
Cohesion: 0.06
Nodes (53): Compass(), Guidance, GuidanceStatus, useGuidance(), watchDeviceHeading(), watchNavigationPosition(), cardinalFor(), CARDINALS (+45 more)

### Community 77 - "Community 77"
Cohesion: 0.09
Nodes (45): generateMetadata(), manifest(), JsonLd(), JsonLdData, ComparisonPage(), ContactPage(), generateMetadata(), FeaturesPage() (+37 more)

### Community 78 - "Community 78"
Cohesion: 0.07
Nodes (44): deleteHostelObjects(), DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList(), positiveInteger(), validateFileAssetMetadata(), ImageVariantRecord (+36 more)
...
Cohesion: 0.05
Nodes (48): softmatoDocsUrl(), dueBhadra29, filed, throughAswin25, CYCLE_LABELS, daysLeftThrough(), daysSpanned(), daysUntil() (+40 more)

### Community 81 - "Community 81"
Cohesion: 0.06
Nodes (46): storeCartSchema, storeOrderSchema, storeProductSchema, StoreServiceError, mocks, allocateOrderNumber(), applyStatus(), CancelInput (+38 more)

### Community 82 - "Community 82"
Cohesion: 0.06
Nodes (40): PATCH(), RouteContext, referralSchema, referralCodeSchema, referralRewardSchema, GET(), auditReferralAction(), confirmReferralJoined() (+32 more)

### Community 83 - "Community 83"
Cohesion: 0.06
Nodes (45): GATEWAY_ORDER, getHostelPayMethods(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice() (+37 more)
...
Cohesion: 0.06
Nodes (38): GET(), GET(), querySchema, applicantSchema, billingCycleSchema, HostelRegistrationInput, hostelRegistrationSchema, registrationFields (+30 more)
...
Cohesion: 0.07
Nodes (37): POST(), RouteContext, listResidentGuardians(), issue(), auditGuardianAction(), createGuardianAccess(), expiresInDays(), findAdminResident() (+29 more)
...
Cohesion: 0.09
Nodes (44): addEmergencyContact(), addGuardian(), auditResidentAction(), BedRecord, createResident(), definedUpdate(), duplicateKeyField(), EmergencyContactCreateInput (+36 more)

### Community 94 - "Community 94"
Cohesion: 0.07
Nodes (34): auditLogSchema, ADMIN_ISSUABLE_ROLES, AdminIssuableRole, generateTemporaryPassword(), HIGH_PRIVILEGE_ROLES, issueTemporaryPasswordIfMissing(), loginUrl(), RegisterOrUpgradeInput (+26 more)
...
Cohesion: 0.07
Nodes (35): AuthLayout(), metadata, url, view, brandedTitle(), clamp(), ogImagePath(), ogSignature() (+27 more)

### Community 97 - "Community 97"
Cohesion: 0.06
Nodes (31): ROLE_VALUES, hostelMemberSchema, qrActivationSchema, rolePermissionSchema, userSchema, before, expiresAt, mocks (+23 more)
...
Cohesion: 0.06
Nodes (32): PaginationQuery, noticeSchema, noticeReadStatusSchema, mocks, noticeInput, residentUserId, staffPrincipal, auditNoticeAction() (+24 more)
...
Cohesion: 0.08
Nodes (35): Choice, maneuverIcon(), MapButton(), ModeTab(), NavCard(), NOTHING_CHOSEN, RouteCard(), buildPage() (+27 more)

### Community 104 - "Community 104"
Cohesion: 0.11
Nodes (33): PreviewCard(), ResultRow(), FACILITY_ICONS, facilityIcon(), facilityKey(), HostelCard(), SaveButton(), HostelShowcase() (+25 more)

### Community 105 - "Community 105"
Cohesion: 0.09
Nodes (36): palette, directionOf(), EMPTY_TALLY, floorToStep(), phaseOf(), shouldRepost(), tallyUploads(), active (+28 more)
...
Cohesion: 0.1
Nodes (37): money(), PlanCard(), pricePlan(), listHeadingFor(), PlanCard(), CatalogueTab(), CycleDiscount(), PublicListingBadgePage() (+29 more)

### Community 108 - "Community 108"
Cohesion: 0.17
Nodes (31): dueWhen(), PlanDueInput, planDueSoonEmail(), planOverdueEmail(), composeEmail(), planSuspensionNoticeEmail(), subscriptionClaimRejectedEmail(), formatRupees() (+23 more)
...
Cohesion: 0.1
Nodes (31): dashboardHrefForRole(), isAuthBypassEnabled(), original, dashboardHrefForRole(), destinationForRole(), isAllowedNextPath(), isHostelWorkspacePath(), isSafeLocalPath() (+23 more)
...
Cohesion: 0.1
Nodes (30): appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind, creditOverpayment(), getCreditAmount(), getCreditBalance(), isDuplicateKey() (+22 more)
...
Cohesion: 0.07
Nodes (28): listResidentInvoices(), addFieldsStage, filter, group, hostelId, invoiceId, lookups, mocks (+20 more)

### Community 116 - "Community 116"
Cohesion: 0.09
Nodes (26): HostelSuggestions(), checkOnly(), EMPTY_PREFILL, ENVIRONMENT_OPTIONS, IdentityResponse, Prefill, Step, TalkToExpertButton() (+18 more)

### Community 117 - "Community 117"
Cohesion: 0.08
Nodes (32): buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, firstIncompleteIdentityStep(), IDENTITY_STEP_FIELDS, IDENTITY_STEPS (+24 more)

### Community 118 - "Community 118"
Cohesion: 0.12
Nodes (29): UploadCard(), UploadToaster(), useIsUploading(), useUploads(), dismissUpload(), emit(), getUploadRows(), listeners (+21 more)
...
Cohesion: 0.09
Nodes (27): BANK_CSV_PARSER, peekHeaders(), BANK, both, empty, ESEWA, [first], ids (+19 more)
...
Cohesion: 0.08
Nodes (24): ComparePage(), generateMetadata(), hostels, metadata, rows, hasDashboard(), PublicHeader(), categoryLabel() (+16 more)

### Community 131 - "Community 131"
Cohesion: 0.14
Nodes (24): hostelTypeLabel(), locationSlug(), formatNpr(), hostelJsonLd(), photoAssetId(), PublicAsset, resolveSearchImageUrls(), searchImageUrls() (+16 more)
...
Cohesion: 0.1
Nodes (29): Attendance / Night Safety, code:typescript (interface IQRActivation {), code:typescript (interface INightStatusLog {), code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface INotice {), code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {) (+21 more)
...
Cohesion: 0.12
Nodes (20): averageRating(), cityCount(), group(), HomeStat, homeStats(), rated, stats, vacantBeds() (+12 more)
...
Cohesion: 0.11
Nodes (25): activeDevicesFor(), activeTokensFor(), androidChannel(), authHeaders(), chunk(), DeviceRow, dispatchPush(), EMPTY (+17 more)

### Community 141 - "Community 141"
Cohesion: 0.09
Nodes (19): LIVE_ACCESS, daysFromNow(), enabledPermissionLabels(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags, GuardianPermissionsUpdateInput (+11 more)

### Community 142 - "Community 142"
Cohesion: 0.09
Nodes (24): draftFromProfile(), emptyIdentityDraft(), hasIdentityErrors(), identityStepComplete(), phoneError(), blank, BOTH_ASSETS, card (+16 more)
...
Cohesion: 0.13
Nodes (20): computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, drawCertificationStamp(), footerLine(), formatDate() (+12 more)
...
Cohesion: 0.11
Nodes (21): buildHtml(), Marker, PlaceMarker, boundsCenter(), haversineMeters(), hostelCoordinates(), HostelWithDistance, isUsableCoordinate() (+13 more)

### Community 150 - "Community 150"
Cohesion: 0.11
Nodes (22): Entry, hostelEntries(), locationEntries(), sitemap(), STATIC_ROUTES, listPublishedHostelSlugs(), loadSiteConfig, loadSiteName() (+14 more)

### Community 151 - "Community 151"
Cohesion: 0.13
Nodes (19): geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), geocodeAddress(), HostelGeoLocation, resolveHostelGeo(), fetchNearbyPlaces() (+11 more)

### Community 152 - "Community 152"
Cohesion: 0.11
Nodes (25): readMoney(), AMOUNT_ALIASES, counterparty(), CREDIT_ALIASES, CREDIT_WORDS, DATE_ALIASES, DEBIT_ALIASES, DEBIT_WORDS (+17 more)
...
Cohesion: 0.11
Nodes (20): addBsMonths(), approvalPeriod(), getPeriodSummary(), monthsBetween(), periodOf(), PeriodRow, PeriodSummary, august (+12 more)
...
Cohesion: 0.1
Nodes (19): configuredLevel(), levelPriority, logger, LogLevel, normalizeMeta(), shouldLog(), write(), hasClearance() (+11 more)

### Community 161 - "Community 161"
Cohesion: 0.18
Nodes (24): AddInput, addToCart(), CartItemRecord, CartRecord, clearCart(), emptyCart(), getCart(), getCartCount() (+16 more)
...
Cohesion: 0.16
Nodes (21): searchCandidates(), AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim(), buildAddressQuery(), definedParts(), geocodeWithGoogle(), geocodeWithNominatim() (+13 more)
...
Cohesion: 0.17
Nodes (21): nightStatusPromptSchema, askingEndsAt(), askingEndsMinuteOfNight(), formatPromptTime(), minuteIsDue(), minuteOfNight(), parsePromptTime(), promptIsDue() (+13 more)

### Community 170 - "Community 170"
Cohesion: 0.14
Nodes (18): NightStanding, duesLine(), StayPill, now, count(), describeFanout(), SETTLED_SOS, SosFanoutTone (+10 more)
...
Cohesion: 0.09
Nodes (14): accountId, adminId, calls, compact, guardian, linkAt, NO_CLEARANCE, publicId (+6 more)
...
Cohesion: 0.12
Nodes (17): CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, isPlanDueNotification(), readId(), body, [drawn, oldBuild, iphone], fetchMock (+9 more)
...
Cohesion: 0.13
Nodes (8): GoogleMap, HostelMap(), LeafletMap, TYPE_COLORS, GeocodePrecision, MapProvider, NearbyPlace, useMapProvider()
...
Cohesion: 0.15
Nodes (16): configureNativeNightPrompt(), claimNotificationSound(), claims, resetNotificationSoundClaims(), createAndroidChannels(), easProjectId(), fetchExpoPushToken(), forgetPushToken() (+8 more)
...
Cohesion: 0.11
Nodes (19): 0.1 The shared Softmato domain, 0.2 Categories — which mailbox a message comes from, 0.2a Where replies go, 0.3 Where the sender is configured, 0.4 Template structure, 0.5 The look, 0. Sending Infrastructure, code:block1 (softmato.com) (+11 more)
...
Cohesion: 0.14
Nodes (17): Bed, Build status (end of Phase 3), Build status (end of Phase 5 — verified 2026-08-02), code:typescript (export enum Role {), code:typescript (interface IRoomConfiguration {), code:typescript (interface IResident {), code:typescript (interface IGuardianAccessPermissions {), Conventions (+9 more)

### Community 223 - "Community 223"
Cohesion: 0.16
Nodes (13): activateResident(), login(), triggerSOS(), RootStackParamList, LoginScreen(), Props, Props, ResidentActivationScreen() (+5 more)

### Community 224 - "Community 224"
Cohesion: 0.12
Nodes (12): refreshedSnapshots(), SavedHostel, fresh, gone, items, next, present, snapshot (+4 more)
...
Cohesion: 0.13
Nodes (7): Footer(), IdCardFace(), initialsOf(), Portrait(), SIGNATURE_BOX, CARD_COLORS, IdCard
...
Cohesion: 0.13
Nodes (16): 3.3 Payment Proof Uploaded (to Admin), 4.1 New Notice Posted, 4.2 Complaint Status Updated, 4.3 Complaint Resolved, 4. Resident Activity Emails, 5.1 SOS Triggered, 5. Safety & Emergency Emails, 6.2 Service Provider Approved (+8 more)

### Community 245 - "Community 245"
Cohesion: 0.15
Nodes (16): 6.1 Service Provider Registration Received, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, 7.1 Attendance Alert (Resident Absent), 7.1 New Hostel Pending Approval (to Superadmin), 7. Attendance & Location Tracking Emails, 8.1 Community Post Engagement (Batched) (+8 more)
...
Cohesion: 0.21
Nodes (11): native, NativeDownloads, openDownloaded(), openSavedFile(), SavedDownload, KNOWN_PATHS, marksRoleChange(), opensPlanBilling() (+3 more)
...
Cohesion: 0.14
Nodes (13): activeCode, codeId, hostelId, joinedResidentId, mocks, otherHostelId, paymentId, principal (+5 more)
...
Cohesion: 0.25
Nodes (11): NearbyStatus, hasLocationPermission(), hasPromptedForLocation(), LocationOutcome, NavigationFix, readPosition(), readPrecisePosition(), rememberLocationPrompt() (+3 more)
...
Cohesion: 0.27
Nodes (14): AttendanceAlert, AttendanceLog, code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({), FoodReadyLog (+6 more)
...
Cohesion: 0.16
Nodes (12): apiRequest(), getActivationStatus(), refreshSession(), register(), requestOtp(), signInWithGoogle(), submitResidentReview(), verifyOtp() (+4 more)
...
Cohesion: 0.29
Nodes (10): resolvePastedLink(), resolvePastedLink(), ParsedMapLink, parseMapLink(), placeFromPath(), POINT_PARAMS, resolveShortLink(), SHORTENERS (+2 more)
...
Cohesion: 0.18
Nodes (9): AuthSession, getResidentNightStatus(), ResidentNightStatus, updateResidentNightStatus(), AppNavigator(), Stack, Props, ResidentNightStatusScreen() (+1 more)
...
Cohesion: 0.36
Nodes (7): SignatureInk(), SignaturePad(), drawSignature(), isSignatureComplete(), serializeSignature(), SignatureStroke, signatureStrokes()
...
Cohesion: 0.23
Nodes (9): nepalDayKey(), filterNotices(), groupNoticesByDay(), noticeCategories(), NoticeDay, NoticeStatus, days, read (+1 more)

### Community 316 - "Community 316"
Cohesion: 0.24
Nodes (9): isCurrentNight(), isSelfReportable(), NIGHT_STATUS_OPTIONS, nightKey(), nightNote(), SelfReportableStatus, NIGHT_OF_17TH, standing (+1 more)
...
Cohesion: 0.27
Nodes (11): code:typescript (interface IMaintenanceRequest {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IInquiry {), MaintenanceRequest, Move-in / Move-out, MoveInChecklist, MoveOutChecklist, Planned for Phase 6 — app account + job marketplace (PRD.md §8.6/§9.6, not yet built) (+3 more)
...
Cohesion: 0.36
Nodes (8): robots(), absoluteUrl(), organizationId(), organizationJsonLd(), vendorJsonLd(), websiteId(), websiteJsonLd(), siteUrl()
...
Cohesion: 0.44
Nodes (9): code:typescript ({), code:typescript ({), code:typescript (interface IQuestionCallClick {), code:typescript ({), Community Feature, CommunityComment, CommunityPost, CommunityReaction (+1 more)

### Community 388 - "Community 388"
Cohesion: 0.22
Nodes (9): 7.2 Subscription Expiring Soon, 7. Platform Admin Emails, 9.1 Account Deletion Requested, 9.1a Account Deletion Request Needs Review *(added 2026-08-02)*, 9.2 Account Deletion Cancelled, 9.3 Location History Deletion Approved, 9. Account & Privacy Emails, code:typescript ({) (+1 more)

### Community 389 - "Community 389"
Cohesion: 0.25
Nodes (9): 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.3 Hostel Rejected, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, code:typescript ({), code:typescript ({), code:block14 (---) (+1 more)
...
Cohesion: 0.33
Nodes (5): findLiveResidency(), LIVE_STATUSES, LiveResidency, liveResidencyMessage(), LiveRow
...
## Knowledge Gaps
- **5969 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+5964 more)
...
- **Why does `Button()` connect `Community 1` to `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 11`, `Community 12`, `Community 13`, `Community 15`, `Community 17`, `Community 19`, `Community 22`, `Community 27`, `Community 30`, `Community 36`, `Community 37`, `Community 38`, `Community 49`, `Community 59`, `Community 61`, `Community 66`, `Community 69`, `Community 79`, `Community 103`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 17` to `Community 1`, `Community 130`, `Community 7`, `Community 8`, `Community 11`, `Community 14`, `Community 18`, `Community 22`, `Community 30`, `Community 31`, `Community 36`, `Community 45`, `Community 302`, `Community 303`, `Community 50`, `Community 52`, `Community 55`, `Community 58`, `Community 59`, `Community 62`, `Community 63`, `Community 87`, `Community 92`, `Community 107`, `Community 116`, `Community 248`, `Community 122`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `Role` connect `Community 9` to `Community 2`, `Community 133`, `Community 6`, `Community 10`, `Community 11`, `Community 141`, `Community 14`, `Community 16`, `Community 17`, `Community 21`, `Community 406`, `Community 23`, `Community 24`, `Community 409`, `Community 29`, `Community 160`, `Community 33`, `Community 35`, `Community 40`, `Community 41`, `Community 42`, `Community 43`, `Community 172`, `Community 429`, `Community 430`, `Community 50`, `Community 51`, `Community 180`, `Community 312`, `Community 187`, `Community 189`, `Community 190`, `Community 65`, `Community 68`, `Community 70`, `Community 74`, `Community 75`, `Community 80`, `Community 81`, `Community 84`, `Community 85`, `Community 86`, `Community 88`, `Community 91`, `Community 93`, `Community 94`, `Community 353`, `Community 354`, `Community 97`, `Community 100`, `Community 231`, `Community 235`, `Community 236`, `Community 110`, `Community 378`, `Community 254`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Are the 465 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 465 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `iosUrlScheme`, `{ defineConfig }`, `expoConfig` to the rest of the system?**
  _5969 weakly-connected nodes found - possible documentation gaps or missing edges._
