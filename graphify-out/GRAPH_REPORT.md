...
## Corpus Check
- 1184 files · ~1,999,237 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9550 nodes · 23613 edges · 422 communities (402 shown, 20 thin omitted)
...
Cohesion: 0.02
Nodes (128): POST(), POST(), GET(), GET(), POST(), addHostelAdminInquiryNote(), BedCreateInput, BedRecord (+120 more)
...
Cohesion: 0.03
Nodes (85): GET(), POST(), POST(), POST(), bulkApproveSchema, POST(), POST(), POST() (+77 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (77): recordConsent(), attendanceListQuerySchema, attendanceOverrideSchema, consentSchema, locationPingSchema, objectIdSchema, DELETE(), GET() (+69 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (86): FeeSchedule, Rate, PRIORITIES, STATUS_ACTIONS, Campaign, Resident, AttendanceAnalytics, FoodAnalytics (+78 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (71): CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload, DemoDataBadge(), HostelTable(), UserRecord, HostelAdminTransactionsPageContent (+63 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (81): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CancelDeletionPageContent(), field(), LoadState, Message() (+73 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (89): GET(), POST(), querySchema, RouteContext, AnnouncementInput, CommentCreateInput, commentOnPost(), CommentRecord (+81 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (75): CommunityReportDialog(), REASONS, ConfirmOptions, ModerationButton(), PagerButton(), CATEGORY_LABELS, NEARBY_GROUPS, PublicReview (+67 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (72): GuardianDashboard, CATEGORIES, Ledger, OrphanAssignPicker, MatrixRow, MatrixTotals, PeriodSummary, ClaimFacts() (+64 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (62): csvField(), deferLoad(), field(), Hostel, Inquiry, LoadState, Message(), numberField() (+54 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (60): AuthExperiencePage(), HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminRoomsPageContent(), PlatformDashboardPageContent(), PlatformHostelReviewPageContent(), PlatformHostelsPageContent(), PlatformUsersPageContent() (+52 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (63): useConfirm(), AttendanceDay, ResidentAttendancePageContent, Zone, ZONE_LABELS, ZONE_STYLES, APP_METHODS, METHODS (+55 more)
...
Cohesion: 0.04
Nodes (84): geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), listHostelAdminInquiries(), addHostelAdminProfilePhoto(), deleteHostelAdminProfilePhoto(), getHostelAdminProfile() (+76 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (59): auditGuardianAction(), createGuardianAccess(), expiresInDays(), findAdminResident(), getGuardianDashboard(), getGuardianSafetySummary(), GuardianAccessCreateInput, GuardianAccessRecord (+51 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (48): PATCH(), POST(), RouteContext, PATCH(), RouteContext, POST(), RouteContext, PATCH() (+40 more)

### Community 17 - "Community 17"
Cohesion: 0.07
Nodes (66): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, POST(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus() (+58 more)

### Community 18 - "Community 18"
Cohesion: 0.13
Nodes (43): accountDeletionCancelledEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), guardianInvitationEmail(), sosAlertEmail(), cookPortalEnabledEmail() (+35 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (65): POST(), auditFinanceAction(), BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary (+57 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (54): GET(), resolvePastedLink(), searchCandidates(), hostelAdminGeocodeQuerySchema, AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim(), definedParts() (+46 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (63): api, API_BASE_URL, bindSessionHandlers(), ApiEnvelope, ApiFailure, unwrap(), expoHostUri(), forEmulator() (+55 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (52): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, HostelPhotoReminder(), normalize(), PortalSearch(), PortalTone, scoreEntry(), toneStyles (+44 more)
...
Cohesion: 0.05
Nodes (48): Notification, MonthPicker, PeriodRow, humanizeValue(), ImportedProfileSummary(), ResidentPrefill, ResidentStatus, STATUS_ACTIONS (+40 more)

### Community 25 - "Community 25"
Cohesion: 0.06
Nodes (48): GET(), POST(), GET(), GET(), attendanceSettingsSchema, GET(), PATCH(), POST() (+40 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (57): announceFoodReady(), cookEmailForSlug(), CookPortalUpdateInput, CookServiceError, FoodReadyInput, generatePassword(), getCookPortalSettings(), HostelSettingsRecord (+49 more)

### Community 27 - "Community 27"
Cohesion: 0.06
Nodes (57): deleteResidentLocationHistory(), getResidentAttendance(), listResidentComplaints(), getCreditAmount(), getResidentFinanceView(), getPayInstructions(), getFoodRoutine(), listFoodForResident() (+49 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (41): AuthShell(), AuthShellProps, SiteWordmark(), GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse, GoogleAuthUser, GoogleCredentialResponse (+33 more)
...
Cohesion: 0.05
Nodes (59): BALANCE_ALIASES, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, TXN_ID_ALIASES, WITHDRAWAL_ALIASES, AMOUNT_ALIASES (+51 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (52): BootGate(), RootShell(), LoginScreen(), BottomChrome, BottomChromeContext, BottomChromeProvider(), CHROME_TIMING, BrandSplash() (+44 more)
...
Cohesion: 0.05
Nodes (52): listPlatformHostels(), PaginationMeta, PaginationQuery, paginationRange(), querySchema, notificationCampaignSchema, reviewModerationLogSchema, CampaignListQuery (+44 more)

### Community 34 - "Community 34"
Cohesion: 0.06
Nodes (49): GET(), POST(), listTrendingTags(), requireSuperadminPrincipal(), resetEmailIdentityCache(), paginationQuerySchema, sponsorSchema, campaignBaseSchema (+41 more)

### Community 35 - "Community 35"
Cohesion: 0.06
Nodes (41): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, ENDPOINTS, esewaProvider, SIGNED_FIELDS, CheckoutStatus, closeIntent() (+33 more)
...
Cohesion: 0.07
Nodes (52): demoteToPublicAccount(), CapacityError, claimBedForRoomType(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary(), releaseBedForRoomType() (+44 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (37): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery (+29 more)

### Community 39 - "Community 39"
Cohesion: 0.06
Nodes (47): HostelPayeeIdentity, GATEWAY_ORDER, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice(), assertQrAssetUsable() (+39 more)
...
Cohesion: 0.06
Nodes (35): attendanceAlertResolveSchema, listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), communityHideSchema, GET(), DELETE() (+27 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (44): ComparePage(), hostels, metadata, rows, CurrentUser, MeResponse, PortalAccount(), PortalTone (+36 more)

### Community 43 - "Community 43"
Cohesion: 0.07
Nodes (43): CSV_COLUMNS, GET(), POST(), safeEqual(), GET(), periodTotals(), csvCell(), csvFilename() (+35 more)
...
Cohesion: 0.05
Nodes (44): getInvoiceMatrix(), InvoiceMatrix, InvoiceMatrixRow, listResidentClaims(), PortalInvoice, ResidentFinanceView, ResidentInvoiceReceipt, ResidentPortalInvoice (+36 more)

### Community 46 - "Community 46"
Cohesion: 0.07
Nodes (33): Resource, useResource(), SubmitClaimScreen(), methodIcon(), methodLabel(), PayInvoiceScreen(), PROVIDER_LABEL, QrPanel() (+25 more)
...
Cohesion: 0.06
Nodes (37): DeletionPathway, DeletionStatus, PATHWAY_COPY, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS (+29 more)

### Community 50 - "Community 50"
Cohesion: 0.07
Nodes (33): POST(), GatewayHealth, GatewayHealthSummary, IntentCounts, plural(), recordHealth(), runGatewayHealth(), runGatewayHealthForHostel() (+25 more)
...
Cohesion: 0.07
Nodes (22): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminNoticesPage(), redirectToWorkspaceScreen(), HostelAdminMaintenancePageContent(), LegacyHostelAdminFeePlansPage() (+14 more)

### Community 55 - "Community 55"
Cohesion: 0.09
Nodes (39): renderIdCardPng(), userResidentProfileSchema, GET(), LEGACY_ROLE_MAP, Role, ROLE_VALUES, CARD_LABELS, formatIssuedOn() (+31 more)

### Community 56 - "Community 56"
Cohesion: 0.11
Nodes (23): useBottomChrome(), AnimatedTabBar(), TabBarRenderProps, ColorScheme, palette, radius, roleAccent, spacing (+15 more)

### Community 57 - "Community 57"
Cohesion: 0.08
Nodes (32): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), MediaViewerProvider() (+24 more)

### Community 58 - "Community 58"
Cohesion: 0.09
Nodes (39): AMOUNT_LABELS, canonical(), canonicalDigits(), containsWithTolerance(), DIGIT_CONFUSABLES, evidenceTextFlags(), EvidenceTextMatch, extractClaimFields() (+31 more)
...
Cohesion: 0.1
Nodes (34): useAppSelector, InvoiceDetailScreen(), AmountCard(), daysUntil(), formatAmount(), formatDate(), formatDateTime(), formatDueLabel() (+26 more)
...
Cohesion: 0.08
Nodes (28): AuthGuard(), HostelSuggestions(), checkOnly(), EMPTY_PREFILL, ENVIRONMENT_OPTIONS, IdentityResponse, Prefill, Step (+20 more)
...
Cohesion: 0.07
Nodes (27): LedgerCard(), SummaryCard(), HandoffPlan, isCheckoutFinished(), planHandoff(), now, plan, CheckoutStatus (+19 more)
...
Cohesion: 0.06
Nodes (25): currency(), TextArea(), ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent, Complaint, field() (+17 more)

### Community 69 - "Community 69"
Cohesion: 0.06
Nodes (26): FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), POST(), checkAuditChain(), DRIFT_CODES, LedgerDriftSummary, runLedgerDrift() (+18 more)
...
Cohesion: 0.09
Nodes (31): addComplaintUpdate(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput, ComplaintListQuery (+23 more)

### Community 72 - "Community 72"
Cohesion: 0.08
Nodes (29): SetResidentFeeInput, setResidentMonthlyFee(), ApiPrincipal, qrActivationSchema, residentSchema, ActivationCodeGenerateInput, ActivationCodeInput, activationSecret() (+21 more)

### Community 73 - "Community 73"
Cohesion: 0.06
Nodes (23): Select(), StatusBadge(), field(), HostelAdminReferralsPageContent(), HostelAdminReportsPageContent(), HostelAdminServiceProvidersPageContent(), ListingFlag, LoadState (+15 more)

### Community 75 - "Community 75"
Cohesion: 0.07
Nodes (19): adminPrincipal, mocks, PLATFORM_LIMITS, Role, ROLE_VALUES, sessionRole(), hostelMemberSchema, rolePermissionSchema (+11 more)

### Community 76 - "Community 76"
Cohesion: 0.09
Nodes (34): serviceProviderDocumentSchema, notifyPlatformOfServiceProviderApplication(), ACTIVE_APPLICATION_STATUSES, approveServiceProvider(), auditProviderAction(), findOwnProvider(), findProviderOrThrow(), getApprovedServiceProviderForHostel() (+26 more)
...
Cohesion: 0.06
Nodes (25): LegacyHostelAdminComplaintsPage(), HostelAdminFoodPage, Complaint, ComplaintSummary, EmptyState(), field(), FoodMenu, HostelAdminComplaintsPage() (+17 more)
...
Cohesion: 0.22
Nodes (19): POST(), authenticateWithGoogle(), logout(), POST(), accessTokenTtlSeconds(), parseDurationSeconds(), refreshTokenTtlSeconds(), isMobileAuthClient() (+11 more)
...
Cohesion: 0.07
Nodes (20): csvField(), field(), Hostel, HostelAdminProfilePageContent(), Inquiry, LoadState, numberField(), optionalField() (+12 more)
...
Cohesion: 0.1
Nodes (23): deviceTokenSchema, notificationSchema, input, mocks, userId, asRecord(), createOrUpdateBatchedNotification(), DeviceTokenSaveInput (+15 more)
...
Cohesion: 0.1
Nodes (16): POST(), accountDeletionRequestSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, consentLogSchema, questionCallClickSchema, purgeAccount() (+8 more)

### Community 109 - "Community 109"
Cohesion: 0.13
Nodes (21): issueSessionForUser(), login(), publicUser(), refreshAccessToken(), MockSessionModel, serviceMocks, session, user (+13 more)
...
Cohesion: 0.13
Nodes (18): noticeSchema, noticeReadStatusSchema, auditNoticeAction(), broadcastNotice(), createNotice(), definedUpdate(), listNotices(), normalizeObjectIds() (+10 more)
...
Cohesion: 0.13
Nodes (19): appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind, creditOverpayment(), getCreditBalance(), isDuplicateKey(), recomputeCreditBalance() (+11 more)
...
Cohesion: 0.13
Nodes (16): attacker, attempt(), headers, jsonRequest(), routeMocks, resetPasswordWithToken(), revokeAllSessions(), verifyOtpChallenge() (+8 more)
...
Cohesion: 0.14
Nodes (16): ImageVariantRecord, optimizeImage(), streamToBuffer(), VARIANT_CONFIG, VariantName, getR2Client(), statementImportSchema, StatementBytes (+8 more)

### Community 147 - "Community 147"
Cohesion: 0.2
Nodes (15): POST(), RouteContext, computePerceptualHash(), systemDocumentKind(), cookieAccessToken(), isRole(), loadApiPrincipal(), POST() (+7 more)
...
Cohesion: 0.1
Nodes (19): 0. Decisions taken (do not re-litigate), 1. Server-side gaps this app depends on, Boot contract (agreed), Definition of Done (mirrors PHASES.md §6.3), M0 — Scaffold & toolchain ✅ *(2026-08-16, bar the device run)*, M10 — Release, M1 — Design system & app shell ◐ *(core landed 2026-08-16)*, M2 — Auth, session & the no-flash boot ◐ *(mechanism landed 2026-08-16)* (+11 more)
...
Cohesion: 0.19
Nodes (18): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags(), evidenceFlags() (+10 more)

### Community 152 - "Community 152"
Cohesion: 0.21
Nodes (14): r2Configured(), storePublicAsset(), AccessLevel, bucketForAccessLevel(), deleteFromR2(), generateFileKey(), getPresignedUploadUrl(), keyPrefix() (+6 more)

### Community 153 - "Community 153"
Cohesion: 0.15
Nodes (14): login(), register(), submitResidentReview(), verifyOtp(), RootStackParamList, LoginScreen(), Props, OtpVerificationScreen() (+6 more)
...
Cohesion: 0.15
Nodes (15): Offset, PhotoCropper(), isActive(), UploadKind, FileUploader(), FileUploaderPresentation, FileUploaderProps, FileUploaderView() (+7 more)
...
Cohesion: 0.26
Nodes (13): POST(), GET(), canSubscribeToChannel(), realtimeChannelsFor(), hostelChannel(), userChannel(), authorizeRealtimeChannel(), BatchEvent (+5 more)
...
Cohesion: 0.12
Nodes (16): announcementSchema, emailSchema, facilitiesSchema, featuresSchema, heroSchema, identitySchema, legalSchema, locationsSchema (+8 more)
...
Cohesion: 0.14
Nodes (15): apiRequest(), confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listResidentComplaints(), listResidentNotices(), markNoticeAsRead(), refreshSession() (+7 more)
...
Cohesion: 0.16
Nodes (13): DirectoryPageProps, EMPTY, metadata, ServiceProviderDirectoryPage(), ServiceProvidersPage(), listPublicServiceProviders(), hostelAdminServiceProviderListQuerySchema, objectIdSchema (+5 more)
...
Cohesion: 0.18
Nodes (12): RealtimeConfig, RealtimeContext, RealtimeContextValue, RealtimeNotification, RealtimeProvider(), useRealtime(), CATEGORY_TOPICS, endpointsForTopics() (+4 more)
...
Cohesion: 0.18
Nodes (14): 4.2 Complaint Status Updated, 6.1 Service Provider Registration Received, 6.3 Service Provider Rejected, 6. Service Provider Emails, 7.1 New Hostel Pending Approval (to Superadmin), 7.2 Subscription Expiring Soon, 7. Platform Admin Emails, 8.1 Community Post Engagement (Batched) (+6 more)
...
Cohesion: 0.25
Nodes (7): BADGE_TONES, BadgeTone, STATUS_TONES, statusTone(), Badge(), badgeVariants, TONES
...
Cohesion: 0.24
Nodes (10): 2.2 Hostel Approved, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, code:block14 (---), code:typescript ({) (+2 more)
...
## Knowledge Gaps
- **3630 isolated node(s):** `{ defineConfig }`, `expoConfig`, `{ getDefaultConfig }`, `{ withNativeWind }`, `config` (+3625 more)
...
- **Why does `Role` connect `Community 75` to `Community 256`, `Community 1`, `Community 2`, `Community 3`, `Community 257`, `Community 258`, `Community 134`, `Community 7`, `Community 135`, `Community 0`, `Community 10`, `Community 14`, `Community 271`, `Community 16`, `Community 15`, `Community 17`, `Community 152`, `Community 25`, `Community 26`, `Community 28`, `Community 159`, `Community 160`, `Community 289`, `Community 290`, `Community 34`, `Community 36`, `Community 37`, `Community 40`, `Community 169`, `Community 170`, `Community 42`, `Community 45`, `Community 302`, `Community 303`, `Community 304`, `Community 52`, `Community 188`, `Community 67`, `Community 323`, `Community 199`, `Community 72`, `Community 200`, `Community 77`, `Community 78`, `Community 81`, `Community 209`, `Community 92`, `Community 97`, `Community 101`, `Community 109`, `Community 238`, `Community 111`, `Community 240`, `Community 239`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 8` to `Community 1`, `Community 4`, `Community 5`, `Community 6`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 22`, `Community 23`, `Community 24`, `Community 29`, `Community 158`, `Community 42`, `Community 44`, `Community 46`, `Community 49`, `Community 62`, `Community 65`, `Community 73`, `Community 80`, `Community 89`, `Community 90`, `Community 218`, `Community 95`, `Community 100`, `Community 234`, `Community 112`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 14` to `Community 128`, `Community 0`, `Community 2`, `Community 134`, `Community 7`, `Community 13`, `Community 15`, `Community 17`, `Community 146`, `Community 19`, `Community 151`, `Community 26`, `Community 27`, `Community 160`, `Community 33`, `Community 34`, `Community 163`, `Community 35`, `Community 37`, `Community 38`, `Community 39`, `Community 40`, `Community 36`, `Community 43`, `Community 45`, `Community 47`, `Community 50`, `Community 52`, `Community 54`, `Community 55`, `Community 57`, `Community 58`, `Community 188`, `Community 61`, `Community 63`, `Community 67`, `Community 69`, `Community 71`, `Community 72`, `Community 76`, `Community 77`, `Community 78`, `Community 82`, `Community 210`, `Community 87`, `Community 91`, `Community 92`, `Community 224`, `Community 225`, `Community 97`, `Community 101`, `Community 102`, `Community 108`, `Community 109`, `Community 120`, `Community 126`?**
