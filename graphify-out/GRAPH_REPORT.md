...
## Corpus Check
- 1390 files · ~2,244,100 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10997 nodes · 28496 edges · 458 communities (436 shown, 22 thin omitted)
...
## Communities (458 total, 22 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (205): PATCH(), POST(), RouteContext, GET(), POST(), GET(), POST(), PATCH() (+197 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (210): POST(), GET(), GET(), listPublicFoodRoutine(), addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery (+202 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (175): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, POST(), AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery (+167 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (150): Scanner(), GuardianInviteScreen(), Choice, Compass(), MapButton(), MapScreen(), ModeTab(), NOTHING_CHOSEN (+142 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (167): deleteResidentLocationHistory(), getResidentAttendance(), listAttendanceAlerts(), addComplaintUpdate(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory (+159 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (109): Filter, ModeratedPost, ModerationPayload, GuardianDashboard, FeeSchedule, HostelAdminFeeSchedulePageContent, Rate, HostelAdminTransactionsPageContent (+101 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (130): ConfirmOptions, Notification, MonthPicker, PeriodRow, humanizeValue(), ImportedProfileSummary(), ResidentPrefill, ResidentStatus (+122 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (102): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel(), useConfirm(), field(), GuardianPermissions (+94 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (108): HostelAdminCommunityPageContent, EMPTY_SUMMARY, HostelAdminComplaintsPage, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS (+100 more)

### Community 9 - "Community 9"
Cohesion: 0.08
Nodes (69): ICONS, LABELS, TONES, Overview, PORTAL_ROWS, Person, GuardianNotShared(), GuardianWardCard() (+61 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (125): AuthDivider(), GoogleSignInButton(), accentForAccount(), AccountShape, HomeRoute, resolveHome(), ROLE, signedIn (+117 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (104): GET(), POST(), querySchema, RouteContext, AnnouncementInput, CommentCreateInput, commentOnPost(), CommentRecord (+96 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (85): adminPrincipal, mocks, PLATFORM_LIMITS, listFoodReadyLogs(), cookPortalUpdateSchema, foodReadySchema, objectIdSchema, ALLOWED_ROLES (+77 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (85): POST(), summarizeResidentComplaints(), acceptGuardianInvitation(), daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess(), GuardianAccessRecord, GuardianInvitationAcceptInput (+77 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (81): AdminMoreScreen(), ActivateScreen(), BootGate(), RootShell(), FILTERS, NotificationsScreen(), DeletionPanel(), NotificationSettings() (+73 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (74): DELETE(), POST(), PaginationMeta, PaginationQuery, paginationQuerySchema, querySchema, auditListingFlagAction(), DuplicateCheckResultRecord (+66 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (59): DeletionPathway, DeletionStatus, PATHWAY_COPY, csvField(), deferLoad(), DemoDataBadge(), field(), Hostel (+51 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (70): BAND_WIDTH, DiscoveryHeader(), DiscoveryHeaderProps, IconButton(), MapButton(), IdCardFace(), IdCardPrompt(), Point() (+62 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (56): TABS, TABS, ViewerBody(), BottomChrome, BottomChromeContext, BottomChromeProvider(), CHROME_TIMING, useBottomChrome() (+48 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (63): NotificationCard(), ProfileScreen(), ReferralRow(), CheckoutStatusScreen(), SubmitClaimScreen(), InvoiceDetailScreen(), SummaryCard(), AmountCard() (+55 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (67): POST(), GET(), BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary (+59 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (57): GET(), resolvePastedLink(), searchCandidates(), geocodeAndCacheHostel(), HostelGeoRecord, hostelAdminGeocodeQuerySchema, AddressParts, addressPartsFromGoogle() (+49 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (53): AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel, AdminReferral, FILTERS, ReferralsResponse, Overview (+45 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (64): NightStatusForm(), CookTodayScreen(), CookMenuScreen(), CookPhotosScreen(), announcedCount(), FoodReadyAnnouncement, MealButton, mealButtonLabel() (+56 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (65): feeUpdateSchema, PATCH(), SetResidentFeeInput, setResidentMonthlyFee(), POST(), GET(), arrangeProof(), leanResult() (+57 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (43): AuthShell(), AuthShellProps, SiteWordmark(), metadata, AccountDeletionPanel, LegalBody(), buildValues(), PublicAboutPage() (+35 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (51): HostelSuggestions(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, PublicHostel, roomTypeLabel(), PublicHostelListingPageContent() (+43 more)

### Community 27 - "Community 27"
Cohesion: 0.07
Nodes (55): POST(), RouteContext, computePerceptualHash(), cookieAccessToken(), isRole(), loadApiPrincipal(), DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES (+47 more)

### Community 28 - "Community 28"
Cohesion: 0.07
Nodes (41): GenericPortalScreen(), portalRows(), portalTitle(), hasFood(), LoadState, PublicInquiryPage(), PublicInquiryPageContent(), CATEGORIES (+33 more)

### Community 29 - "Community 29"
Cohesion: 0.07
Nodes (57): CommunityScreen(), Composer(), CommunityBoard(), CommunityBoardProps, Composer(), CommentThread(), CommunityPostCard(), ReportSheet() (+49 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (60): collectionTotals(), countInvoicesByField(), getHostelViewStats(), assertHostelAccess(), canAccessHostel(), hostelScopedFilter(), TenantAccessError, TenantPrincipal (+52 more)

### Community 31 - "Community 31"
Cohesion: 0.13
Nodes (40): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), guardianInvitationEmail(), sosAlertEmail() (+32 more)
...
Cohesion: 0.11
Nodes (45): POST(), authenticateWithGoogle(), AuthServiceError, changePassword(), getCurrentUser(), issueSessionForUser(), login(), logout() (+37 more)
...
Cohesion: 0.06
Nodes (50): AttachmentGallery(), ComplaintDetail(), ComplaintCard(), needsResident(), OPEN_STATUSES, rank(), NewComplaintScreen(), PickedAttachment (+42 more)
...
Cohesion: 0.06
Nodes (48): robots(), sitemap(), STATIC_ROUTES, listPublishedHostelSlugs(), IdCardData, IdCardFace, PlatformIdCardType, CardImages (+40 more)
...
Cohesion: 0.06
Nodes (47): GET(), serviceProviderApplicationSchema, serviceProviderDocumentSchema, notifyPlatformOfServiceProviderApplication(), ACTIVE_APPLICATION_STATUSES, approveServiceProvider(), auditProviderAction(), findOwnProvider() (+39 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (37): AuthGuard(), fadeUp, Feature, features, heroSlides, PublicHostelRegistrationLandingPage(), stagger, stats (+29 more)
...
Cohesion: 0.05
Nodes (49): getInvoiceMatrix(), InvoiceMatrix, InvoiceMatrixRow, listResidentClaims(), PortalInvoice, ResidentFinanceView, ResidentInvoiceLine, ResidentInvoiceReceipt (+41 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (44): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), MediaViewerProvider() (+36 more)
...
Cohesion: 0.05
Nodes (30): CheckoutStatus, ResidentCheckoutPageContent, APP_METHODS, METHODS, PayInstructions, ReferenceCheck(), Rejection, ResidentClaimForm (+22 more)
...
Cohesion: 0.06
Nodes (22): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), redirectToWorkspaceScreen(), HostelAdminMaintenancePageContent() (+14 more)
...
Cohesion: 0.07
Nodes (40): BANK_CSV_PARSER, peekHeaders(), [first], FIXTURES, fromCsv, fromWorkbook, parse(), parseText() (+32 more)

### Community 56 - "Community 56"
Cohesion: 0.08
Nodes (28): HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), PlatformDashboardPageContent(), DashboardCard(), DashboardCardProps, PlatformDashboardPageContent, PlatformServiceProvidersPageContent, PlatformUsersPageContent (+20 more)
...
Cohesion: 0.09
Nodes (31): appBaseUrl(), dispatchVerificationEmail(), requestPasswordReset(), resendVerificationEmail(), signupWithEmailVerification(), POST(), hashUserAgent(), HostelRef (+23 more)

### Community 60 - "Community 60"
Cohesion: 0.07
Nodes (32): referralSchema, referralCodeSchema, referralRewardSchema, auditReferralAction(), confirmReferralJoined(), createReferredInquiry(), HostelAdminReferralListQuery, normalizeObjectIds() (+24 more)

### Community 61 - "Community 61"
Cohesion: 0.08
Nodes (34): GET(), qrActivationSchema, activateResident(), ActivationCodeGenerateInput, ActivationCodeInput, activationSecret(), ActivationServiceError, ActivationStatus (+26 more)

### Community 62 - "Community 62"
Cohesion: 0.09
Nodes (36): FileUploadArea(), acceptAttribute(), EXTENSION_BY_MIME, FAMILY_BYTES, FAMILY_ORDER, familyOf(), formatBytes(), joinTypes() (+28 more)

### Community 63 - "Community 63"
Cohesion: 0.06
Nodes (27): currency(), LoadingRows(), Select(), StatusBadge(), ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent (+19 more)

### Community 64 - "Community 64"
Cohesion: 0.08
Nodes (32): AdminResidentsScreen(), NightStatusScreen(), ReferralsScreen(), CommunityPostScreen(), ComplaintDetailScreen(), ComplaintsScreen(), HostelCompare(), GuardianHomeScreen() (+24 more)
...
Cohesion: 0.08
Nodes (34): addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange(), definedUpdate(), FoodFeedbackInput, FoodFeedbackRecord, FoodMenuCreateInput (+26 more)

### Community 67 - "Community 67"
Cohesion: 0.07
Nodes (32): AdminAlertsScreen(), AdminOverviewScreen(), loadOverview(), load, alertCounts(), AlertKind, AlertRow, buildAlertFeed() (+24 more)
...
Cohesion: 0.06
Nodes (29): Offset, PhotoCropper(), CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg (+21 more)
...
Cohesion: 0.07
Nodes (30): CurrentUser, DASHBOARD_ROLES, dashboardHrefForRole(), hasDashboard(), MeResponse, moreItems, navItems, providerNavItems (+22 more)

### Community 73 - "Community 73"
Cohesion: 0.07
Nodes (30): HostelPhotoReminder(), formatHostelAddress(), hostelTypeToUi(), mapPublicHostelToSummary(), CATEGORY_LABELS, NEARBY_GROUPS, PublicHostelDetailPage(), PublicReview (+22 more)
...
Cohesion: 0.09
Nodes (27): daysBetween(), deliver(), DunningAction, DunningState, escalateToHostel(), InvoiceRow, OPEN_STATUSES, PaymentReminderRun (+19 more)
...
Cohesion: 0.08
Nodes (26): appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind, creditOverpayment(), getCreditAmount(), getCreditBalance(), isDuplicateKey() (+18 more)

### Community 78 - "Community 78"
Cohesion: 0.06
Nodes (27): auditFinanceAction(), FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), base, entityId, hostelId, mocks (+19 more)

### Community 79 - "Community 79"
Cohesion: 0.08
Nodes (28): classifyCredit(), CreditClassification, LadderClaim, LadderInvoice, MatchContext, normalizeTxnId(), ANITA_CODE, claims (+20 more)

### Community 80 - "Community 80"
Cohesion: 0.09
Nodes (28): RouteContext, listTrendingTags(), sponsorSchema, GET(), loadPopularHostels(), PopularHostelRecord, DELETE(), PATCH() (+20 more)

### Community 81 - "Community 81"
Cohesion: 0.07
Nodes (22): Complaint, ComplaintSummary, field(), FoodMenu, HostelAdminComplaintsPage(), HostelAdminFoodPage(), HostelAdminNoticesPage(), HostelAdminPaymentsPage() (+14 more)
...
Cohesion: 0.12
Nodes (27): GET(), POST(), GET(), POST(), AccountDeletionError, applyImmediateEffects(), cancelAccountDeletionByToken(), cancelAccountDeletionForUser() (+19 more)
...
Cohesion: 0.08
Nodes (24): notifyGatewayUnhealthy(), GatewayHealth, GatewayHealthSummary, getGatewayHealth(), IntentCounts, plural(), recordHealth(), SEVERITY (+16 more)

### Community 88 - "Community 88"
Cohesion: 0.07
Nodes (20): EmptyState(), TextArea(), field(), HostelAdminReferralsPageContent(), ListingFlag, LoadState, MaintenanceRequest, optionalField() (+12 more)

### Community 89 - "Community 89"
Cohesion: 0.1
Nodes (25): progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster(), UploadRow, UploadStack(), useIsHydrated() (+17 more)

### Community 90 - "Community 90"
Cohesion: 0.1
Nodes (26): uploadPublicFile(), FILE_ASSET_KINDS, FileAssetKind, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), UploadKind, ApiEnvelope (+18 more)
...
Cohesion: 0.11
Nodes (27): POST(), assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim() (+19 more)
...
Cohesion: 0.15
Nodes (19): POST(), POST(), runGatewayHealth(), runGatewayHealthForHostel(), POST(), POST(), runSettlementRecon(), runSettlementReconForHostel() (+11 more)
...
Cohesion: 0.08
Nodes (25): addEmergencyContact(), BedRecord, EmergencyContactCreateInput, EmergencyContactRecord, GuardianCreateInput, GuardianRecord, ResidentAccountLink, ResidentCreateInput (+17 more)

### Community 98 - "Community 98"
Cohesion: 0.08
Nodes (20): csvField(), field(), Hostel, Inquiry, LoadState, numberField(), optionalField(), PlatformHostelReviewPageContent() (+12 more)
...
Cohesion: 0.13
Nodes (21): ReferralBody(), getResidentReferral(), Referral, ReferralCode, ReferralReward, ReferralStatus, ReferralSummary, ResidentReferral (+13 more)
...
Cohesion: 0.11
Nodes (17): CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS, CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, MOCK_HOSTELS (+9 more)
...
Cohesion: 0.15
Nodes (18): Guidance, GuidanceStatus, NearbyStatus, Coordinates, hasLocationPermission(), hasPromptedForLocation(), LocationOutcome, NavigationFix (+10 more)
...
Cohesion: 0.12
Nodes (18): issueReceiptForEvent(), nextReceiptNumber(), periodOfDate(), voidReceipt(), eventId, hostelId, invoiceId, mocks (+10 more)

### Community 135 - "Community 135"
Cohesion: 0.13
Nodes (21): countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor(), LedgerInvoiceRow, ledgerPipeline() (+13 more)

### Community 136 - "Community 136"
Cohesion: 0.12
Nodes (17): PRODUCTION_RECOMMENDED, PRODUCTION_REQUIRED, ServerEnv, serverEnvSchema, serverEnvWarnings(), PRODUCTION_MINIMUM, pusher, snapshot (+9 more)
...
Cohesion: 0.17
Nodes (13): EmailAttachment, notifyAdminsOfClearedPayment(), hostelId, mocks, receiptId, residentId, verified, paymentClearedEmail() (+5 more)
...
Cohesion: 0.13
Nodes (21): 5.1 SOS Triggered, 5. Safety & Emergency Emails, 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, 7.1 New Hostel Pending Approval (to Superadmin) (+13 more)
...
Cohesion: 0.13
Nodes (20): 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.3 Hostel Rejected, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.3 Payment Proof Uploaded (to Admin) (+12 more)

### Community 158 - "Community 158"
Cohesion: 0.14
Nodes (16): ApiFailure, ApiSuccess, AuthUser, confirmComplaintResolution(), createResidentComplaint(), listResidentComplaints(), listResidentPayments(), ResidentComplaint (+8 more)
...
Cohesion: 0.16
Nodes (17): ResidentEmergencyContact, ResidentGuardian, useAvailableRoomTypes(), useHostelWardens(), useResidentContacts(), useResidents(), useRoomMap(), Warden (+9 more)
...
Cohesion: 0.16
Nodes (14): LedgerCard(), ResidentInvoice, filterInvoices(), invoiceLedger(), LedgerLine, OPEN_STATUSES, PaymentFilter, PaymentStats (+6 more)
...
Cohesion: 0.21
Nodes (14): CsvTable, gridFromCsv(), readCsv(), stripBom(), stripPreamble(), buildTable(), tableFromGrid(), StatementParseError (+6 more)
...
Cohesion: 0.3
Nodes (11): CSV_COLUMNS, GET(), GET(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS, neutralize() (+3 more)
...
Cohesion: 0.14
Nodes (9): authorUserId, mocks, postId, residentId, residentPrincipal, staffPrincipal, BLOCKED, maskProfanity() (+1 more)
...
Cohesion: 0.18
Nodes (9): AuthSession, getResidentProfile(), AppNavigator(), Stack, ResidentFoodScreen(), ResidentPaymentsScreen(), Profile, Props (+1 more)
...
Cohesion: 0.23
Nodes (13): demoteToPublicAccount(), addGuardian(), auditResidentAction(), definedUpdate(), deleteResident(), findResidentForPrincipal(), getResidentById(), listResidentContacts() (+5 more)
...
Cohesion: 0.21
Nodes (12): assertActiveReferralCode(), findActiveReferralCode(), linkReferralOnRegistration(), createResident(), isDuplicateKeyError(), linkResidentAccount(), normalizeObjectId(), normalizeObjectIds() (+4 more)
...
Cohesion: 0.27
Nodes (9): SosScreen(), count(), describeFanout(), SosFanoutTone, sosMessagePayload(), SosOutcome, fanout(), outcome (+1 more)
...
Cohesion: 0.2
Nodes (8): verifyPurposeToken(), hostelId, input, leanResult(), mocks, recipients, userId, userOf()
...
Cohesion: 0.44
Nodes (9): code:typescript ({), code:typescript ({), code:typescript ({), code:typescript (interface IQuestionCallClick {), Community Feature, CommunityComment, CommunityPost, CommunityReaction (+1 more)
...
Cohesion: 0.43
Nodes (5): keys, url, WEB_PORTAL_PATHS, WebPortalKey, webPortalUrl()
...
Cohesion: 0.47
Nodes (6): buildPlatformReportExport(), complaintVolume(), hostelNamesByIdFor(), hostelsByStatus(), paymentVolume(), residentsByStatus()
...
## Knowledge Gaps
- **4040 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+4035 more)
...
- **Why does `Button()` connect `Community 9` to `Community 129`, `Community 3`, `Community 35`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 72`, `Community 10`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 50`, `Community 21`, `Community 23`?**
  _High betweenness centrality (0.107) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 6` to `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 16`, `Community 18`, `Community 25`, `Community 26`, `Community 28`, `Community 29`, `Community 32`, `Community 36`, `Community 40`, `Community 50`, `Community 56`, `Community 57`, `Community 58`, `Community 62`, `Community 63`, `Community 69`, `Community 70`, `Community 72`, `Community 73`, `Community 81`, `Community 89`, `Community 223`, `Community 107`, `Community 121`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `Role` connect `Community 12` to `Community 0`, `Community 1`, `Community 2`, `Community 133`, `Community 11`, `Community 13`, `Community 270`, `Community 271`, `Community 16`, `Community 24`, `Community 25`, `Community 27`, `Community 285`, `Community 30`, `Community 33`, `Community 169`, `Community 42`, `Community 43`, `Community 46`, `Community 49`, `Community 178`, `Community 305`, `Community 312`, `Community 61`, `Community 191`, `Community 323`, `Community 325`, `Community 326`, `Community 327`, `Community 72`, `Community 204`, `Community 205`, `Community 78`, `Community 207`, `Community 84`, `Community 214`, `Community 86`, `Community 216`, `Community 97`, `Community 99`, `Community 115`, `Community 375`, `Community 248`, `Community 121`, `Community 250`, `Community 252`, `Community 253`, `Community 254`?**
...
- **What connects `{ defineConfig }`, `expoConfig`, `path` to the rest of the system?**
  _4040 weakly-connected nodes found - possible documentation gaps or missing edges._
