# Graph Report - hostel-management-software  (2026-09-16)

## Corpus Check
- 2232 files · ~3,389,093 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17807 nodes · 49996 edges · 584 communities (554 shown, 30 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 828 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 714 edges
2. `successResponse()` - 691 edges
3. `connectToDatabase()` - 502 edges
4. `useAppTheme()` - 418 edges
5. `cn()` - 316 edges
6. `connectToDatabase()` - 269 edges
7. `unwrap()` - 227 edges
8. `useResource()` - 218 edges
9. `Text()` - 195 edges
10. `requireHostelCapability()` - 182 edges
...
## Communities (584 total, 30 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (343): POST(), GET(), POST(), GET(), MESSAGES, POST(), RouteContext, GET() (+335 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (193): ICONS, LABELS, Segment, TONES, FILTERS, Pending, MANAGE_ROWS, PORTAL_ROWS (+185 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (314): loadToday(), AdminRollCallCard(), CalendarPreferenceCard(), NightStatusPromptCard(), methodProvider(), loadFinance(), AdminNightStatus, AdminNightStatusRow (+306 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (268): POST(), getOrCreateSubscription(), selectPlan(), POST(), GET(), GET(), querySchema, getOpenFeeSchedule() (+260 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (230): BookingQuote, GuestBookingDetail, GuestBookingSummary, metadata, BookingCheckoutPage(), Method, METHODS, nextStep() (+222 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (155): PlanPaymentClaim, DeletionPathway, DeletionStatus, PATHWAY_COPY, csvField(), deferLoad(), DemoDataBadge(), field() (+147 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (183): Scanner(), FaqRow(), MethodCard(), CookInviteScreen(), GuardianInviteScreen(), Choice, Compass(), MapButton() (+175 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (194): AdminCommunityReportsScreen(), AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), AttendanceScreen(), NightStatusHistoryScreen(), NightStatusScreen(), NotificationCard() (+186 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (170): generateMetadata(), chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout() (+162 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (168): AdminTabs(), HIDDEN, RoleLayout(), TABS, FILTERS, invalidateFeeds(), NotificationRow(), TILE_GLYPH (+160 more)
...
Cohesion: 0.03
Nodes (126): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CancelDeletionPageContent(), CommunityModerationPanel(), Filter, ModeratedPost (+118 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (159): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, bell(), BookingAudience (+151 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (132): AdminCommunityScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+124 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (159): JobRowDivider(), ProviderHero(), ProviderHeroRegister(), TILE_INK, TILE_TINT, ResidencyInviteHost(), DeletionRequest, DeletionStatus (+151 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (121): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, cookLoginStem(), generateCookPassword(), mintCookLogin(), pick() (+113 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (144): BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan, CommunityPageContent(), Badge(), grabDocument(), HostelAdminBillingPageContent() (+136 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (111): accountDeletionCancelledEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), dueWhen(), PlanDueInput, planDueSoonEmail() (+103 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (130): PackageCard(), roomPhotoUris(), BAND_WIDTH, DiscoveryHeader(), DiscoveryHeaderProps, IconButton(), MapButton(), cropToGuide() (+122 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (131): POST(), RouteContext, listTrendingTags(), DELETE(), POST(), PaginationMeta, PaginationQuery, paginationQuerySchema (+123 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (121): HostelAdminCommunityPageContent, HostelAdminDashboardPageContent, HostelAdminFeePlansPageContent, HostelAdminInquiriesPageContent, HostelAdminMaintenancePageContent, PRIORITIES, STATUS_ACTIONS, HostelAdminMoveChecklistPage (+113 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (136): PaymentMonthStrip(), ManageRatesScreen(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), InvoiceDetailScreen(), SummaryCard() (+128 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (90): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, DASHBOARD_ROLES, FACILITY_ICONS (+82 more)

### Community 23 - "Community 23"
Cohesion: 0.02
Nodes (104): ATTENDANCE_DEFAULTS, adminPrincipal, mocks, PLATFORM_LIMITS, afterMidnight, evening, meters, mocks (+96 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (119): AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput, ConsentInput, dayKey() (+111 more)

### Community 25 - "Community 25"
Cohesion: 0.02
Nodes (119): RouteContext, GET(), PATCH(), RouteContext, requireHostelStaffPrincipal(), notifyStaffOfJobProgress(), addHistory(), addMaintenanceComment() (+111 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (121): POST(), POST(), POST(), runPlanDueReminders(), findCardBooking(), checkoutSchema, POST(), POST() (+113 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (122): openStore(), BootGate(), RootShell(), AttachmentGallery(), BrandSplash(), acknowledged, HostelSuspensionHost(), remainingLabel() (+114 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (105): PATCH(), POST(), RouteContext, GET(), summarizeResidentComplaints(), GET(), listResidentInvoices(), outstandingForResident() (+97 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (110): GET(), getHostelViewStats(), hashUserAgent(), HostelRef, newVisitorKey(), recordHostelPageView(), resolveVisitorKey(), getPresignedReadUrl() (+102 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (107): NightStatusForm(), ReviewForm(), ReviewScreen(), AlertRow(), SosScreen(), DAY_LABELS, DayStrip(), FoodRoutineWeek() (+99 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (86): AuthShell(), AuthShellProps, PANEL_COPY, SiteWordmark(), metadata, RefundPolicy, AccountDeletionPanel, ContentHeader() (+78 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (102): DELETE(), RouteContext, GET(), POST(), querySchema, RouteContext, AnnouncementInput, CommentCreateInput (+94 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (102): AssetViewer(), openIdFor(), openIds, StripThumb(), useViewerState(), ViewerBody(), ViewerPage(), CopyButton() (+94 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (103): CHANNELS, ClaimedStep, composeEmail(), composeNotice(), composePlanDueNotice(), deliverEmail(), deliverStep(), HostelRow (+95 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (101): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), loadOverview(), Overview, AdminMoneyScreen(), loadMoney(), MoneyData (+93 more)

### Community 36 - "Community 36"
Cohesion: 0.02
Nodes (86): EMPTY_PAYOUT_DRAFT, METHODS, PayoutAccountDraft, PayoutAccountFields(), payoutAccountPayload(), DescriptionFacts, DescriptionSuggestions(), HostelType (+78 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (76): FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, monthStartPeriod(), Rate, RoomTypeOption, gregorianSpan(), MonthField (+68 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (96): PATCH(), storeCategorySchema, storeProductSchema, GET(), POST(), AddInput, addToCart(), CartItemRecord (+88 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (86): approveClaim(), assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck(), evidenceCheck(), fileCheck() (+78 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (74): BookButton(), SIZE, BookingAvailabilityView, BookingButton, CLOSED_REASONS, open, HostelSuggestions(), PublicComparePage() (+66 more)

### Community 41 - "Community 41"
Cohesion: 0.03
Nodes (76): getHostelLedger(), collectionTotals(), countInvoicesByField(), fromLedgerRow(), invoicesByIds(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor(), LedgerInvoice (+68 more)

### Community 42 - "Community 42"
Cohesion: 0.03
Nodes (76): TIER_TONE, PlanMark(), RAFTER, RIDGE, ROWS, EASE, PlanCards(), PlanLine() (+68 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (80): SORTS, StoreCategoryScreen(), addToCart(), cancelStoreOrder(), Cart, CartLine, CartResult, CartTotals (+72 more)

### Community 44 - "Community 44"
Cohesion: 0.03
Nodes (75): fromBs(), gregorianOf(), BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary (+67 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (60): EMPTY_SUMMARY, HostelAdminComplaintsPage, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine (+52 more)

### Community 46 - "Community 46"
Cohesion: 0.07
Nodes (67): BOOKING_DOCUMENT_KINDS, BookingDocumentInput, BookingDocumentKind, bookingDocumentLayout(), refundPolicyNotes(), renderBookingDocument(), bsFiscalYear(), amountInWords() (+59 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (65): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, aswin, bhadra (+57 more)
...
Cohesion: 0.05
Nodes (27): InlineText(), PlatformConfigAnnouncementsPageContent, PlatformConfigContentPageContent, PlatformConfigFacilitiesPageContent, FLAGS, PlatformConfigFeaturesPageContent, PlatformConfigLegalPageContent, PlatformConfigLocationsPageContent (+19 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (58): notifyHostelOfNewPost(), resolveHostelCommunityUserIds(), usersMutingNewPosts(), announceFoodReady(), dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord (+50 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (52): asRecord(), DrawnPush, readDrawnPush(), message, pushData, configureNativeNightPrompt(), NativeNightPrompt, takeNativePendingAnswers() (+44 more)

### Community 53 - "Community 53"
Cohesion: 0.06
Nodes (53): CSV_COLUMNS, GET(), POST(), safeEqual(), GET(), periodTotals(), csvCell(), csvFilename() (+45 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (55): approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal, checker, eventId (+47 more)
...
Cohesion: 0.06
Nodes (58): demoteToPublicAccount(), releaseGuardianAccounts(), guardianSchema, assertActiveReferralCode(), findActiveReferralCode(), linkReferralOnRegistration(), findLiveResidency(), LIVE_STATUSES (+50 more)

### Community 59 - "Community 59"
Cohesion: 0.05
Nodes (53): arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal, alreadyReviewedError() (+45 more)

### Community 60 - "Community 60"
Cohesion: 0.06
Nodes (43): PayoutAccountForReview, ReviewPayoutAccount(), STATUS_LABEL, List(), ReasonAction(), Row(), timeLeft(), Tone (+35 more)

### Community 61 - "Community 61"
Cohesion: 0.07
Nodes (48): receiptCounterSchema, storeCartSchema, storeOrderSchema, formatNpr(), itemsTable(), StoreEmailItem, mocks, allocateOrderNumber() (+40 more)

### Community 62 - "Community 62"
Cohesion: 0.08
Nodes (44): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, deleteHostelObjects() (+36 more)

### Community 63 - "Community 63"
Cohesion: 0.06
Nodes (46): GATEWAY_ORDER, getHostelPayMethods(), getPayInstructions(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod (+38 more)

### Community 64 - "Community 64"
Cohesion: 0.06
Nodes (45): addComplaintUpdate(), assertComplaintVoiceNote(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput (+37 more)

### Community 65 - "Community 65"
Cohesion: 0.06
Nodes (37): HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminRoomsPageContent(), PlatformDashboardPageContent(), DashboardCard(), DashboardCardProps, PlatformDashboardPageContent, PlatformServiceProvidersPageContent (+29 more)
...
Cohesion: 0.07
Nodes (51): addBsMonths(), BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsPeriodBounds(), bsPeriodOf(), bsPeriodsBetween() (+43 more)

### Community 68 - "Community 68"
Cohesion: 0.07
Nodes (39): hostelPeriodOf(), existingResidentListSchema, existingResidentRowSchema, checkExistingResidents(), moveInDateFor(), splitFullName(), buildExistingResidentsTemplate(), fieldTeam() (+31 more)

### Community 69 - "Community 69"
Cohesion: 0.07
Nodes (52): fill(), money(), PlanCard(), PricingScreen(), pricePlan(), PlanPicker(), BillingToggle(), listHeadingFor() (+44 more)

### Community 70 - "Community 70"
Cohesion: 0.05
Nodes (40): PortalDates, useHostelDayTurn(), useSiteConfig(), PlanBilling, PlanBillingInvoice, PlanBillingPayment, PlanBillingPlan, ContentSection (+32 more)
...
Cohesion: 0.08
Nodes (46): GET(), BookableHostel, BookingUnavailableReason, findRoom(), hostelAddress(), HostelAvailability, hostelCoverPhoto(), hostelCoverPhotos() (+38 more)

### Community 73 - "Community 73"
Cohesion: 0.06
Nodes (41): Offset, PhotoCropper(), buildIdCardData(), EMAIL_CHECK_HINTS, EmailCheck, Field(), FIELD_LABELS, formatCardDate() (+33 more)

### Community 74 - "Community 74"
Cohesion: 0.05
Nodes (37): FeedPayload, NewPostAlertsToggle(), SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES, avatarTone() (+29 more)

### Community 75 - "Community 75"
Cohesion: 0.05
Nodes (32): AuthExperiencePage(), CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS, CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS (+24 more)

### Community 76 - "Community 76"
Cohesion: 0.07
Nodes (42): BS_MONTHS, cellAt(), focusCell(), Props, BillPreview, CheckContext, CheckedRow, CheckResult (+34 more)

### Community 77 - "Community 77"
Cohesion: 0.06
Nodes (23): LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminPaymentsPage(), redirectToWorkspaceScreen() (+15 more)

### Community 78 - "Community 78"
Cohesion: 0.05
Nodes (42): account, answerBy, before, book(), Booking, compact, confirmed(), Consent (+34 more)

### Community 79 - "Community 79"
Cohesion: 0.06
Nodes (46): continueLabel(), isBlank(), buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, draftFromProfile() (+38 more)

### Community 80 - "Community 80"
Cohesion: 0.06
Nodes (41): DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), axisMonth(), monthLabel(), toNumber() (+33 more)
...
Cohesion: 0.07
Nodes (39): drawCertificationStamp(), footerLine(), formatDate(), formatLongDate(), MONTHS, ReceiptPdfInput, renderReceiptPdf(), renderStatementPdf() (+31 more)
...
Cohesion: 0.05
Nodes (32): auditFinanceAction(), FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), findingSchema, reconciliationRunSchema, checkAuditChain(), DRIFT_CODES (+24 more)
...
Cohesion: 0.06
Nodes (35): AcceptPlatformAdminInvitationInput, appUrl(), daysFromNow(), EmailAvailability, EmailAvailabilityResult, hashToken(), INVITABLE_ROLES, invitePlatformAdmin() (+27 more)
...
Cohesion: 0.06
Nodes (27): currency(), EmptyState(), Input(), TextArea(), ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent (+19 more)
...
Cohesion: 0.06
Nodes (22): field(), GuardianDashboard, GuardianDashboardPageContent(), LoadState, NightStatusRow, Notification, NotificationsPageContent(), optionalNumber() (+14 more)
...
Cohesion: 0.07
Nodes (27): blankRow(), Row, TeamInviteBox(), MemberActions(), Props, TeamMembersTable(), InviteResult, Member (+19 more)

### Community 97 - "Community 97"
Cohesion: 0.08
Nodes (37): announcedCount(), announcementSummary(), CookFoodPhoto, CookPhotoDay, FoodReadyAnnouncement, FoodReadySent, MealButton, mealButtonLabel() (+29 more)

### Community 98 - "Community 98"
Cohesion: 0.08
Nodes (31): bsMonthStart(), hostelCalendarDay(), hostelToday(), rateForRoomType(), hostelCalendarDay(), hostelMonthStart(), hostelToday(), once (+23 more)

### Community 99 - "Community 99"
Cohesion: 0.06
Nodes (34): ESEWA_CSV_PARSER, both, corrupted, debit, [first], FIXTURE, headerOnly, noDate (+26 more)
...
Cohesion: 0.08
Nodes (23): AuthGuard(), checkOnly(), EMPTY_PREFILL, ENVIRONMENT_OPTIONS, IdentityResponse, Prefill, Step, TalkToExpertButton() (+15 more)

### Community 107 - "Community 107"
Cohesion: 0.12
Nodes (28): bookingPolicyVersion(), BookingCancelStep, bookingCancelStepSchema, DEFAULT_BOOKING_CONFIG, DEFAULT_CANCEL_STEPS, mergeBookingConfig(), percent, bookingGuideIntro() (+20 more)

### Community 108 - "Community 108"
Cohesion: 0.11
Nodes (34): BookingEndCause, HostelBookingClosedCause, announceEnding(), assertAwaitingAnswer(), cancelBookingByHostel(), cancelBookingByPlatform(), cancelMyBooking(), declineBooking() (+26 more)

### Community 109 - "Community 109"
Cohesion: 0.09
Nodes (32): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), loadPayeeIdentity() (+24 more)

### Community 110 - "Community 110"
Cohesion: 0.07
Nodes (22): LoadingRows(), Select(), field(), HostelAdminReferralsPageContent(), HostelAdminServiceProvidersPageContent(), ListingFlag, LoadState, MaintenanceRequest (+14 more)

### Community 111 - "Community 111"
Cohesion: 0.07
Nodes (27): BookingError, ENDED, HOSTEL_BOOKING_TABS, HostelBookingTab, iso(), listHostelBookings(), PLATFORM_BOOKING_TABS, BOOKING_STATUSES (+19 more)
...
Cohesion: 0.07
Nodes (23): EASE, FaqEntry, FaqRole, FaqRow(), FAQS, PREVIEW_ROWS, PREVIEWS, ROLES (+15 more)
...
Cohesion: 0.1
Nodes (29): allowed(), BookingDocumentScope, refundScope(), assertSuperadmin(), Destination, loadTransfer(), loadTransferProof(), markTransferSent() (+21 more)
...
Cohesion: 0.11
Nodes (29): bookingConfigSchema, applyStrikeRule(), endBooking(), EndBookingInput, ENDING_FOR_STATUS, endingFor(), raiseTransfers(), announceBookingsPaused() (+21 more)

### Community 120 - "Community 120"
Cohesion: 0.1
Nodes (25): classifyCredit(), CreditClassification, LadderClaim, LadderInvoice, MatchContext, normalizeTxnId(), ANITA_CODE, claims (+17 more)

### Community 121 - "Community 121"
Cohesion: 0.11
Nodes (28): noticePushSchema, announceChange(), audit(), CreateInput, createNoticePush(), DEFAULT_PUSHES, deleteNoticePush(), emitNoticePush() (+20 more)
...
Cohesion: 0.07
Nodes (20): LegacyHostelAdminComplaintsPage(), Complaint, ComplaintSummary, field(), FoodMenu, HostelAdminComplaintsPage(), HostelAdminFoodPage(), HostelAdminNoticesPage() (+12 more)

### Community 124 - "Community 124"
Cohesion: 0.1
Nodes (27): UploadCard(), useIsUploading(), dismissUpload(), emit(), getUploadRows(), listeners, pruneUploads(), resetUploadQueue() (+19 more)
...
Cohesion: 0.1
Nodes (24): describeGrants(), GuardianRow(), PermissionSheet(), daysUntil(), describeGuardianOnRecord(), describeInvitation(), describeSharing(), EMPTY_INVITE_DRAFT (+16 more)

### Community 129 - "Community 129"
Cohesion: 0.13
Nodes (28): announceConfirmed(), directionsUrl(), HostelPlace, bookingDocumentAttachment(), moveBooking(), bookingFacts(), guestBookingPath(), hostelBookingsPath() (+20 more)
...
Cohesion: 0.09
Nodes (26): findOrphanClaims(), loadMatchContext(), statementImportSchema, ApprovedNotInStatementRow, approveMatchedRows(), approverNamesFor(), ClaimedNoTransactionRow, getReconciliation() (+18 more)

### Community 132 - "Community 132"
Cohesion: 0.11
Nodes (25): accountDeletionRequestedEmail(), AccountDeletionError, applyImmediateEffects(), cancelAccountDeletionForUser(), cancelUrlFor(), DeletionPathway, DeletionRequestRecord, getAccountDeletionStatus() (+17 more)

### Community 133 - "Community 133"
Cohesion: 0.09
Nodes (16): RouteContext, calendarDateSchema, emergencyContactCreateSchema, guardianCreateSchema, objectIdSchema, optionalHostelScopeSchema, residentCreateSchema, residentListQuerySchema (+8 more)
...
Cohesion: 0.09
Nodes (18): PortalShell(), metadata, navItems, GUARDIAN_NAV, GUARDIAN_SEARCH_ENTRIES, hostelAdminHref(), PortalIconName, PortalNavGroup (+10 more)

### Community 138 - "Community 138"
Cohesion: 0.09
Nodes (13): GoogleMap, LeafletMap, TYPE_COLORS, DraggablePinMap, FALLBACK_CENTER, LocationPicker(), LocationPickerValue, PART_LABELS (+5 more)

### Community 139 - "Community 139"
Cohesion: 0.08
Nodes (18): applyBookingConfig(), PLATFORM_SETTING_CHANGE_STATUSES, platformSettingChangeSchema, bookings, CollectionQr, isSettingChangeKey(), SETTING_CHANGES, SettingChangeDefinition (+10 more)
...
Cohesion: 0.11
Nodes (24): activeDevicesFor(), activeTokensFor(), androidChannel(), authHeaders(), chunk(), DeviceRow, EMPTY, ExpoDevice (+16 more)
...
Cohesion: 0.12
Nodes (23): documentFlags(), detectProvider(), headlineAmount(), labelledValue(), looksLikeStatement(), methodForProvider(), ParsedReceipt, parseReceipt() (+15 more)

### Community 149 - "Community 149"
Cohesion: 0.08
Nodes (14): AUDIENCE_LABEL, PlatformPushPageContent, PushRecord, Repeat, REPEAT_LABEL, ScheduleRecord, Urgency, WEEKDAYS (+6 more)
...
Cohesion: 0.15
Nodes (22): documentDownloadUrl(), issueInvoiceDocument(), allocateNumber(), ensureInvoiceRaised(), findOpenInvoice(), graceDeadline(), invoiceIdFor(), InvoiceRecord (+14 more)

### Community 153 - "Community 153"
Cohesion: 0.17
Nodes (19): confirmBooking(), CardBooking, checkInBooking(), returnHeldBed(), takeHeldBed(), CapacityError, claimBedForRoomType(), listAllRoomTypes() (+11 more)
...
Cohesion: 0.11
Nodes (24): Attendance / Night Safety, Build status (end of Phase 3), Build status (end of Phase 5 — verified 2026-08-02), code:typescript (export enum Role {), code:typescript (interface INightStatusLog {), code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface IComplaint {) (+16 more)
...
Cohesion: 0.16
Nodes (19): InquiryLinkScreen(), ReferralBody(), ReferralSummary, isValidReferralCode(), normalizeReferralCode(), parseReferralLink(), safeDecode(), valid() (+11 more)

### Community 158 - "Community 158"
Cohesion: 0.13
Nodes (22): maneuverIcon(), NavCard(), Guidance, GuidanceStatus, useGuidance(), NavigationFix, watchDeviceHeading(), watchNavigationPosition() (+14 more)

### Community 159 - "Community 159"
Cohesion: 0.17
Nodes (20): ProviderJobRow(), CATEGORY_ICONS, completedJobCount(), isOpenJob(), isOverdueJob(), jobActions(), jobCategoryIcon(), jobPlace() (+12 more)
...
Cohesion: 0.09
Nodes (19): countInvoicesByStatus(), latestInvoicePerResident(), addFieldsStage, filter, group, hostelId, invoiceId, lookups (+11 more)

### Community 162 - "Community 162"
Cohesion: 0.14
Nodes (14): applyWebhook(), WebhookResult, softmato(), SoftmatoNotConfiguredError, isSoftmatoConfigured(), SoftmatoConfig, softmatoWebhookSecret(), POST() (+6 more)

### Community 163 - "Community 163"
Cohesion: 0.14
Nodes (19): assertEnablable(), blockedReasonFor(), deleteGatewayConfig(), GATEWAY_REQUIREMENTS, GatewayConfigView, GatewaySecretView, listGatewayConfigs(), saveGatewayConfig() (+11 more)

### Community 164 - "Community 164"
Cohesion: 0.13
Nodes (20): appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind, creditOverpayment(), getCreditAmount(), getCreditBalance(), isDuplicateKey() (+12 more)
...
Cohesion: 0.13
Nodes (16): HostelGeoRecord, sleep(), HostelGeoLocation, resolveHostelGeo(), fetchNearbyPlaces(), fetchNearbyWithGoogle(), fetchNearbyWithOverpass(), GOOGLE_PLACE_TYPES (+8 more)

### Community 174 - "Community 174"
Cohesion: 0.14
Nodes (15): DeviceLocationStatus, formatDistance(), hostelCoordinates(), isUsableCoordinate(), KATHMANDU, hasGeolocation(), LocationOutcome, NavigationFix (+7 more)
...
Cohesion: 0.12
Nodes (20): findIndex(), index, indexesOf(), IndexSpec, promote, invoice, INVOICE_STATUSES, invoiceLineSchema (+12 more)
...
Cohesion: 0.13
Nodes (18): hostelOrThrow(), notifyPlatformOfPayoutReview(), PayoutAccountStatus, PayoutAccountView, PayoutActor, PayoutRecord, revealHostelPayoutAccount(), reviewHostelPayoutAccount() (+10 more)
...
Cohesion: 0.13
Nodes (23): code:typescript (interface INotice {), code:typescript ({), code:typescript (interface IMoveInChecklistItem {), code:typescript (interface IMoveOutChecklistItem {), code:typescript (interface IServiceProvider {), code:typescript (interface IServiceProvider {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IMaintenanceRequest {) (+15 more)
...
Cohesion: 0.16
Nodes (16): webPushSubscribeSchema, webPushUnsubscribeSchema, ensureConfigured(), isWebPushConfigured(), VapidConfig, webPushPublicKey(), countWebPushSubscriptions(), revokeWebPushSubscription() (+8 more)

### Community 192 - "Community 192"
Cohesion: 0.21
Nodes (21): CARD_NOUNS, CardVariant, drawBack(), drawBrandLockup(), drawFooterSweep(), drawFront(), drawHeaderSweep(), drawIdCard() (+13 more)
...
Cohesion: 0.19
Nodes (18): AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim(), buildAddressQuery(), definedParts(), geocodeAddress(), geocodeWithGoogle(), geocodeWithNominatim() (+10 more)
...
Cohesion: 0.18
Nodes (16): asPushTiming(), laterFromDelay(), nextNoticePushRun(), noticePushExpiry(), NoticePushRepeat, NoticePushTiming, sentAt, TUESDAY_NOON (+8 more)
...
Cohesion: 0.12
Nodes (17): buildHtml(), boundsCenter(), haversineMeters(), HostelWithDistance, KATHMANDU, sortByDistance(), distance, far (+9 more)

### Community 214 - "Community 214"
Cohesion: 0.23
Nodes (16): resolvePastedLink(), searchCandidates(), lookupLocation(), resolvePastedLink(), searchCandidates(), queryVariants(), reverseGeocode(), ParsedMapLink (+8 more)

### Community 215 - "Community 215"
Cohesion: 0.22
Nodes (17): getInvoiceDetailForHostel(), HostelScope, ResolvedDocument, resolveInvoiceDocument(), resolveReceiptDocument(), scopeFilter(), settledTotal(), trySoftmato() (+9 more)
...
Cohesion: 0.13
Nodes (16): cardinalFor(), chooseHeading(), headingDifference(), normaliseHeading(), smoothHeading(), corner, dogleg, heading (+8 more)
...
Cohesion: 0.18
Nodes (13): IssuedInvoice, OpenedCheckout, SettledReceipt, checkoutReturnUrl(), OpenCheckoutInput, openSoftmatoCheckout(), EnsureInvoiceInput, ensureSoftmatoInvoice() (+5 more)

### Community 221 - "Community 221"
Cohesion: 0.23
Nodes (17): openCheckoutSession(), readSettledReceipt(), allocateReceiptNumber(), applySettlement(), InvoiceRecord, loadInvoice(), logAccessFailure(), openHostelAfterPayment() (+9 more)

### Community 222 - "Community 222"
Cohesion: 0.13
Nodes (12): buildFormPostHandoff(), FormPostHandoff, HandoffError, IntentRecord, formPostIntent, hostelId, intentId, invoiceId (+4 more)
...
Cohesion: 0.15
Nodes (13): AuthSession, getResidentProfile(), submitResidentReview(), AppNavigator(), RootStackParamList, Stack, LoginScreen(), Props (+5 more)
...
Cohesion: 0.19
Nodes (15): dashboardHrefForRole(), destinationForRole(), isAllowedNextPath(), isHostelWorkspacePath(), isSafeLocalPath(), landingPathForRole(), ProtectedRouteRule, protectedRouteRuleForPath() (+7 more)

### Community 235 - "Community 235"
Cohesion: 0.12
Nodes (15): monthsBetween(), periodOf(), ResidentDoc, ResidentLedger, ResidentLedgerMonth, ResidentLedgerPayment, billed, eventId (+7 more)
...
Cohesion: 0.14
Nodes (15): platformPushScheduleSchema, NotificationCampaignError, PLATFORM_PUSH_AUDIENCES, PushRepeat, AUDIENCE_ROLES, deliverPush(), PlatformPushAudience, PlatformPushInput (+7 more)
...
Cohesion: 0.21
Nodes (14): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, metadata, HostelBookingView, HostelBookingRequestsReminder(), canAccessWorkspace(), defaultWorkspaceSlug(), isAuthBypassed() (+6 more)

### Community 245 - "Community 245"
Cohesion: 0.21
Nodes (13): isAuthBypassEnabled(), original, accessSecret(), isSoftSessionPath(), keepSessionAlive(), proxy(), redirectHome(), redirectToLogin() (+5 more)
...
Cohesion: 0.13
Nodes (17): 2.3 Hostel Rejected, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails, 4.2 Complaint Status Updated (+9 more)
...
Cohesion: 0.12
Nodes (13): documentUrl(), InvoiceLean, PaymentLean, PlatformInvoiceRow, PlatformPaymentRow, PlatformSubscriptionLedger, HOSTEL_SUBSCRIPTION_STATUSES, hostelSubscriptionSchema (+5 more)
...
Cohesion: 0.21
Nodes (16): AccountDeletionRequest, code:typescript ({), code:typescript (interface IAccountDeletionRequest {), code:block43 (packages/db/migrations/), code:typescript ({), code:typescript (interface IAccountDeletionRequest {), code:block46 (packages/db/migrations/), Consent & Privacy (+8 more)

### Community 265 - "Community 265"
Cohesion: 0.16
Nodes (16): 1.0 Signup One-Time Code, 1.2 Hostel Admin Credentials (Post-Approval), 1.3 Warden Credentials, 1.4 Resident QR Activation, 1.5 Guardian Invitation, 1.6 Password Reset, 1.7 Account Upgraded, 1. Authentication & Account Emails (+8 more)
...
Cohesion: 0.16
Nodes (13): ALLOWED_FAMILIES, ascii(), Family, looksTextual(), sniffFamily(), startsWith(), CSV, ELF (+5 more)

### Community 268 - "Community 268"
Cohesion: 0.15
Nodes (12): activateResident(), listResidentNotices(), markNoticeAsRead(), ResidentNotice, Props, ResidentActivationScreen(), styles, Props (+4 more)
...
Cohesion: 0.16
Nodes (10): PlatformHostelsPageContent(), PlatformHostelsPageContent, PortalPlaceholderAction, PortalPlaceholderPage(), PortalPlaceholderPageProps, GuardianScreenPage(), GuardianScreenPageProps, HostelAdminScreenPage() (+2 more)
...
Cohesion: 0.27
Nodes (7): CouldNotCreateFileException, NoContextException, NothingOpensThisException, UnreadableSourceException, UnsupportedOnThisAndroidException, file, intent
...
Cohesion: 0.2
Nodes (5): ReturnState, CheckoutReturnPage(), SUBSCRIPTION_INVOICE_STATUSES, subscriptionInvoiceSchema, metadata

### Community 330 - "Community 330"
Cohesion: 0.32
Nodes (10): softmatoDocsUrl(), dueBhadra29, filed, throughAswin25, CYCLE_LABELS, daysLeftThrough(), daysSpanned(), daysUntil() (+2 more)

### Community 331 - "Community 331"
Cohesion: 0.18
Nodes (9): maskEmail(), otherSuperadmin, requestFeeChange(), row, store, superadmin, token, tokenFromLastEmail() (+1 more)
...
Cohesion: 0.18
Nodes (11): 4.1 New Notice Posted, 4. Resident Activity Emails, 5.1 SOS Triggered, 5. Safety & Emergency Emails, code:typescript ({), Email Opt-In/Opt-Out Matrix, EMAIL_SYSTEM.md — Email Triggers & Templates, Guardian Control (+3 more)
...
Cohesion: 0.2
Nodes (11): apiRequest(), getActivationStatus(), listNotifications(), login(), markNotificationRead(), NotificationItem, refreshSession(), saveDeviceToken() (+3 more)
...
Cohesion: 0.24
Nodes (8): daysUntil(), HostelSubscriptionDueBanner(), rupees(), State, metadata, navItems, HOSTEL_ADMIN_NAV, HOSTEL_ADMIN_SEARCH_ENTRIES

### Community 349 - "Community 349"
Cohesion: 0.24
Nodes (9): cook, assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES, PermissionError, Principal, roleAllowedNextPrefixes (+1 more)
...
Cohesion: 0.2
Nodes (9): bsMonthsEnd(), hostelDayEnd(), at, bs(), dirname, dueAt, invoiceSet, settings (+1 more)
...
Cohesion: 0.18
Nodes (11): 7.1 Attendance Alert (Resident Absent), 7. Attendance & Location Tracking Emails, 9.1 Account Deletion Requested, 9.1a Account Deletion Request Needs Review *(added 2026-08-02)*, 9.2 Account Deletion Cancelled, 9.3 Location History Deletion Approved, 9. Account & Privacy Emails, code:typescript ({) (+3 more)
...
Cohesion: 0.22
Nodes (10): 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, 3.3 Payment Proof Uploaded (to Admin), code:typescript ({), code:typescript ({), code:block14 (---) (+2 more)
...
Cohesion: 0.22
Nodes (7): PublicHostelListingPageContent(), HostelFiltersState, HostelFiltersStore, initialHostelFilters, useHostelFiltersStore, UiStore, useUiStore
...
Cohesion: 0.25
Nodes (6): body, reserialised, result, signature, stale, timestamp
...
Cohesion: 0.25
Nodes (6): base, entityId, hostelId, mocks, principal, write()
...
Cohesion: 0.29
Nodes (6): assignOrphanSchema, bulkApproveStatementSchema, STATEMENT_PROVIDERS, StatementImportInput, statementImportSchema, statementListQuerySchema
...
Cohesion: 0.33
Nodes (5): BillingRunInput, BillingRunQuery, billingRunQuerySchema, billingRunSchema, periodSchema
...
## Knowledge Gaps
- **6145 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+6140 more)
...
- **Why does `cn()` connect `Community 4` to `Community 1`, `Community 5`, `Community 8`, `Community 137`, `Community 11`, `Community 140`, `Community 399`, `Community 16`, `Community 20`, `Community 149`, `Community 22`, `Community 31`, `Community 36`, `Community 37`, `Community 40`, `Community 42`, `Community 45`, `Community 50`, `Community 60`, `Community 318`, `Community 65`, `Community 69`, `Community 73`, `Community 74`, `Community 75`, `Community 76`, `Community 93`, `Community 96`, `Community 102`, `Community 106`, `Community 114`, `Community 123`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 1` to `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 138`, `Community 11`, `Community 13`, `Community 14`, `Community 18`, `Community 20`, `Community 21`, `Community 30`, `Community 31`, `Community 33`, `Community 35`, `Community 37`, `Community 43`, `Community 45`, `Community 57`, `Community 74`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 3` to `Community 0`, `Community 129`, `Community 131`, `Community 260`, `Community 132`, `Community 8`, `Community 10`, `Community 139`, `Community 12`, `Community 15`, `Community 143`, `Community 19`, `Community 148`, `Community 147`, `Community 23`, `Community 152`, `Community 24`, `Community 26`, `Community 153`, `Community 28`, `Community 29`, `Community 25`, `Community 31`, `Community 32`, `Community 161`, `Community 34`, `Community 162`, `Community 164`, `Community 163`, `Community 38`, `Community 39`, `Community 424`, `Community 41`, `Community 44`, `Community 173`, `Community 47`, `Community 48`, `Community 178`, `Community 51`, `Community 179`, `Community 53`, `Community 54`, `Community 58`, `Community 59`, `Community 61`, `Community 190`, `Community 63`, `Community 64`, `Community 191`, `Community 68`, `Community 72`, `Community 329`, `Community 330`, `Community 82`, `Community 84`, `Community 85`, `Community 215`, `Community 87`, `Community 219`, `Community 92`, `Community 221`, `Community 222`, `Community 98`, `Community 107`, `Community 108`, `Community 109`, `Community 235`, `Community 111`, `Community 237`, `Community 236`, `Community 244`, `Community 116`, `Community 120`, `Community 121`, `Community 125`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Are the 497 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 497 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `iosUrlScheme`, `{ defineConfig }`, `expoConfig` to the rest of the system?**
  _6145 weakly-connected nodes found - possible documentation gaps or missing edges._
