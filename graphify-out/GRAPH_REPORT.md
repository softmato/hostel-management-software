...
## Corpus Check
- 1358 files · ~2,171,267 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10694 nodes · 27631 edges · 429 communities (408 shown, 21 thin omitted)
...
1. `handleRouteError()` - 506 edges
2. `successResponse()` - 493 edges
3. `connectToDatabase()` - 332 edges
4. `cn()` - 238 edges
5. `connectToDatabase()` - 216 edges
6. `requireHostelCapability()` - 158 edges
7. `useAppTheme()` - 148 edges
...
## Communities (429 total, 21 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (138): DeletionPathway, DeletionStatus, PATHWAY_COPY, CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload, deferLoad() (+130 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (155): AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), Scanner(), GuardianInviteScreen(), BootGate(), FILTERS, NotificationCard() (+147 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (137): ConfirmOptions, Resolver, NotificationsPageContent(), Notification, Resident, MonthPicker, PeriodRow, HostelAdminMoveChecklistPage (+129 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (152): sendEmail(), listPublicFoodRoutine(), geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), listHostelAdminInquiries(), addHostelAdminProfilePhoto() (+144 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (117): POST(), PATCH(), POST(), RouteContext, POST(), POST(), POST(), POST() (+109 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (107): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), useConfirm(), field(), GuardianPermissions, LoadState (+99 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (116): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply() (+108 more)
...
Cohesion: 0.03
Nodes (117): CookTodayScreen(), CookMenuScreen(), api, ApiEnvelope, unwrap(), expoHostUri(), forEmulator(), hostOf() (+109 more)

### Community 9 - "Community 9"
Cohesion: 0.09
Nodes (62): AdminOverviewScreen(), loadOverview(), Overview, PORTAL_ROWS, Person, ProfileScreen(), ReferralRow(), CheckoutStatusScreen() (+54 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (87): HostelAdminCommunityPageContent, HostelAdminComplaintsPage, HostelAdminFeePlansPageContent, HostelAdminInquiriesPageContent, HostelAdminMaintenancePageContent, PRIORITIES, STATUS_ACTIONS, HostelAdminNightStatusPage (+79 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (68): checkoutSchema, POST(), POST(), POST(), RouteContext, complaintResolutionConfirmSchema, PATCH(), RouteContext (+60 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (89): GET(), POST(), querySchema, RouteContext, authorUserId, mocks, postId, residentId (+81 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (83): NightStatusForm(), NightStatusScreen(), InvoiceDetailScreen(), LedgerCard(), SummaryCard(), AmountCard(), methodIcon(), methodLabel() (+75 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (73): AttachmentGallery(), ComplaintDetail(), ComplaintCard(), PickedAttachment, AuthDivider(), GoogleSignInButton(), InquiryFields(), resolveHome() (+65 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (67): POST(), GET(), POST(), listHostelAdminFloors(), listHostelAdminInquiries(), listHostelAdminRooms(), scopedHostelFilter(), bedCreateSchema (+59 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (70): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, ENDPOINTS, esewaProvider, SIGNED_FIELDS, attempt, fetchMock (+62 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (69): AuditLogRecord, PlatformAuditLogQuery, RefRecord, summarizeResidentComplaints(), getResidentFinanceView(), InvoiceMatrix, InvoiceMatrixRow, listResidentClaims() (+61 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (76): PaginationMeta, PaginationQuery, paginationRange(), querySchema, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex(), HostelRecord (+68 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (78): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), base, entityId, hostelId, mocks, principal (+70 more)
...
Cohesion: 0.04
Nodes (65): GET(), POST(), GET(), POST(), listTrendingTags(), GET(), DELETE(), POST() (+57 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (67): EMPTY_SUMMARY, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine, formatWeekRange() (+59 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (52): GuardianDashboardPageContent(), GuardianDashboard, GuardianDashboardPageContent, GuardianSafetyPageContent, MatrixRow, MatrixTotals, PeriodSummary, ClaimFacts() (+44 more)
...
Cohesion: 0.04
Nodes (67): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, GATEWAY_ORDER, getPayInstructions() (+59 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (58): AuthGuard(), Offset, PhotoCropper(), CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole() (+50 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (50): TABS, SosScreen(), TABS, BottomChrome, BottomChromeContext, BottomChromeProvider(), CHROME_TIMING, useBottomChrome() (+42 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (47): PATCH(), RouteContext, POST(), RouteContext, GET(), GET(), PATCH(), RouteContext (+39 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (57): outstandingForResident(), depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, providedItemSchema, qrActivationSchema, residentSchema, auditMoveAction() (+49 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (60): IdCardFace(), BLOOD_OPTIONS, DIET_OPTIONS, EditIdentityScreen(), GENDER_OPTIONS, ID_TYPE_OPTIONS, IdentityForm(), OCCUPATION_OPTIONS (+52 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (58): commentOnPost(), findReadablePost(), findVisiblePostForResident(), listCommunityFeed(), listCommunityForModeration(), listPostComments(), namesByUserId(), notifyPostReaction() (+50 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (42): ComparePage(), hostels, metadata, rows, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), PlatformDashboardPageContent(), PlatformHostelReviewPageContent() (+34 more)
...
Cohesion: 0.05
Nodes (54): RootShell(), UploadToaster(), usePush(), useRealtime(), useUploads(), bindSessionHandlers(), ApiUser, fetchActivationStatus() (+46 more)
...
Cohesion: 0.06
Nodes (49): GET(), ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+41 more)

### Community 37 - "Community 37"
Cohesion: 0.07
Nodes (55): CommunityScreen(), Composer(), CommunityPostScreen(), CommentThread(), CommunityPostCard(), ReportSheet(), addPostComment(), CommunityComment (+47 more)
...
Cohesion: 0.05
Nodes (43): GET(), adminPrincipal, mocks, PLATFORM_LIMITS, POST(), mocks, readable, selectable (+35 more)
...
Cohesion: 0.05
Nodes (53): dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, getFoodRoutine(), isMonthEnd(), mealsOn() (+45 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (46): POST(), acceptGuardianInvitation(), daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput (+38 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (46): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), MediaViewerProvider() (+38 more)
...
Cohesion: 0.05
Nodes (47): classifyCredit(), CreditClassification, LadderClaim, LadderInvoice, MatchContext, normalizeTxnId(), ANITA_CODE, claims (+39 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (47): approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal, checker, eventId (+39 more)
...
Cohesion: 0.05
Nodes (41): assertHostelAccess(), canAccessHostel(), hostelScopedFilter(), TenantAccessError, TenantPrincipal, attendanceLogSchema, foodReadyLogSchema, referralSchema (+33 more)
...
Cohesion: 0.05
Nodes (37): complaintCategorySchema, complaintCreateSchema, complaintListQuerySchema, complaintReplySchema, complaintStatusSchema, complaintStatusUpdateSchema, objectIdSchema, POST() (+29 more)

### Community 54 - "Community 54"
Cohesion: 0.06
Nodes (43): isAuthBypassEnabled(), original, cook, assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES, PermissionError (+35 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (26): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminFoodPage(), HostelAdminPaymentsPage(), redirectToWorkspaceScreen(), HostelAdminReportsPageContent() (+18 more)
...
Cohesion: 0.07
Nodes (38): GET(), POST(), PATCH(), requireSuperadminPrincipal(), resetEmailIdentityCache(), GET(), PUT(), PUT() (+30 more)

### Community 60 - "Community 60"
Cohesion: 0.08
Nodes (43): collectionTotals(), invoicesByIds(), monthlySeries(), platformRollup(), getHostelViewStats(), foodFeedbackSchema, listingFlagSchema, paymentProofSchema (+35 more)

### Community 61 - "Community 61"
Cohesion: 0.07
Nodes (39): ApiPrincipal, deviceTokenSchema, notificationSchema, input, mocks, userId, asRecord(), DeviceTokenRevokeInput (+31 more)
...
Cohesion: 0.08
Nodes (35): requireHostelAdminPrincipal(), DEPRECATED_ALIASES, grantingPermissionKeys(), mocks, GET(), POST(), auditWardenAction(), createHostelWarden() (+27 more)

### Community 66 - "Community 66"
Cohesion: 0.06
Nodes (28): currency(), EmptyState(), Select(), ResidentActivationPageContent, ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent (+20 more)

### Community 67 - "Community 67"
Cohesion: 0.08
Nodes (34): addComplaintUpdate(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput, ComplaintListQuery (+26 more)

### Community 68 - "Community 68"
Cohesion: 0.07
Nodes (32): accountDeletionRequestSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, consentLogSchema, AccountDeletionError, applyImmediateEffects(), cancelAccountDeletionForUser() (+24 more)

### Community 69 - "Community 69"
Cohesion: 0.1
Nodes (30): DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList(), positiveInteger(), validateFileAssetMetadata(), r2Configured(), storePublicAsset() (+22 more)
...
Cohesion: 0.08
Nodes (29): AdminAlertsScreen(), ICONS, LABELS, TONES, alertCounts(), AlertKind, AlertRow, buildAlertFeed() (+21 more)

### Community 74 - "Community 74"
Cohesion: 0.1
Nodes (29): appBaseUrl(), dispatchOtpChallenge(), dispatchVerificationEmail(), findVerifiedRegistrationChallenge(), generateOtpCode(), GOOGLE_JWKS, hashOtpCode(), normalizeEmail() (+21 more)
...
Cohesion: 0.07
Nodes (21): LoadingRows(), TextArea(), field(), HostelAdminMaintenancePageContent(), HostelAdminReferralsPageContent(), ListingFlag, LoadState, MaintenanceRequest (+13 more)
...
Cohesion: 0.11
Nodes (30): GET(), resolvePastedLink(), searchCandidates(), hostelAdminGeocodeQuerySchema, AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim(), definedParts() (+22 more)

### Community 80 - "Community 80"
Cohesion: 0.09
Nodes (28): noticeReadStatusSchema, auditNoticeAction(), broadcastNotice(), createNotice(), definedUpdate(), listNotices(), listNoticesForResident(), markNoticeAsRead() (+20 more)

### Community 81 - "Community 81"
Cohesion: 0.13
Nodes (27): CSV_COLUMNS, GET(), GET(), periodTotals(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS (+19 more)
...
Cohesion: 0.07
Nodes (21): field(), GuardianDashboard, HostelAdminMoveChecklistPage(), LoadState, NightStatusRow, Notification, optionalNumber(), PlatformReviewsPageContent() (+13 more)
...
Cohesion: 0.07
Nodes (24): GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse, GoogleAuthUser, GoogleCredentialResponse, Window, ProviderDirectoryData, CATEGORIES (+16 more)
...
Cohesion: 0.09
Nodes (26): buildHtml(), NearbyStatus, boundsCenter(), Coordinates, haversineMeters(), hostelCoordinates(), HostelWithDistance, isUsableCoordinate() (+18 more)

### Community 88 - "Community 88"
Cohesion: 0.08
Nodes (24): csvField(), field(), numberField(), optionalField(), RoomConfiguration, RoomMapFloor, AddressFields, FORM_SECTIONS (+16 more)

### Community 89 - "Community 89"
Cohesion: 0.09
Nodes (17): GoogleMap, HostelMap(), LeafletMap, TYPE_COLORS, fetchNearbyPlaces(), fetchNearbyWithGoogle(), fetchNearbyWithOverpass(), GOOGLE_PLACE_TYPES (+9 more)

### Community 90 - "Community 90"
Cohesion: 0.09
Nodes (27): countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor(), LedgerInvoiceRow, ledgerPipeline() (+19 more)

### Community 91 - "Community 91"
Cohesion: 0.12
Nodes (26): UploadCard(), useIsUploading(), dismissUpload(), emit(), finishUpload(), getUploadRows(), isUploadActive(), listeners (+18 more)

### Community 92 - "Community 92"
Cohesion: 0.11
Nodes (26): DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity(), NAME_SUFFIX (+18 more)
...
Cohesion: 0.14
Nodes (20): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, base (+12 more)

### Community 97 - "Community 97"
Cohesion: 0.11
Nodes (23): AuthServiceError, resetPasswordWithToken(), revokeAllSessions(), signupWithEmailVerification(), verifyEmailWithToken(), POST(), ChangePasswordInput, emailSchema (+15 more)

### Community 98 - "Community 98"
Cohesion: 0.13
Nodes (22): DeletionPanel(), NotificationSettings(), THEME_OPTIONS, DeletionRequest, DeletionStatus, getDeletionStatus(), requestAccountDeletion(), canRequestDeletion() (+14 more)

### Community 99 - "Community 99"
Cohesion: 0.08
Nodes (20): LegacyHostelAdminComplaintsPage(), Complaint, ComplaintSummary, field(), FoodMenu, HostelAdminComplaintsPage(), HostelAdminNoticesPage(), HostelAdminResidentsPage() (+12 more)
...
Cohesion: 0.11
Nodes (26): ApiFailure, apiRequest(), ApiSuccess, AuthUser, getActivationStatus(), getResidentDashboard(), getResidentProfile(), listResidentFood() (+18 more)
...
Cohesion: 0.1
Nodes (26): evidenceFlags(), CREDIT_MARKERS, DEBIT_MARKERS, DirectionRead, directionRefusal(), EvidenceDirection, EvidenceOutcome, matched() (+18 more)
...
Cohesion: 0.09
Nodes (13): AuthShell(), AuthShellProps, SiteWordmark(), AuthExperiencePage(), ThemeToggle(), ThemeToggleProps, metadata, AuthResponse (+5 more)
...
Cohesion: 0.1
Nodes (21): attacker, attempt(), headers, jsonRequest(), routeMocks, verifyOtpChallenge(), GoogleAuthInput, googleAuthSchema (+13 more)
...
Cohesion: 0.14
Nodes (19): GuardianHomeScreen(), GuardianPaymentsScreen(), GuardianSafetyScreen(), GuardianPayment, GuardianPermissionKey, GuardianPermissions, GuardianReceipt, canSee() (+11 more)
...
Cohesion: 0.2
Nodes (16): otpCodeEmail(), fromHeaderFor(), replyToFor(), sosAlertEmail(), paymentVerifiedEmail(), complaintResolvedEmail(), residentNewNoticeEmail(), args (+8 more)
...
Cohesion: 0.16
Nodes (15): ProviderJobScreen(), getOwnProvider(), ProviderApplication, ProviderJob, ProviderJobStatus, updateProviderJobStatus(), isOpenJob(), jobActions() (+7 more)
...
Cohesion: 0.16
Nodes (14): addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery, HostelAdminInquiryStatusInput, InquiryNoteCreateInput, InquiryNoteRecord, InquiryRecord (+6 more)
...
Cohesion: 0.14
Nodes (12): logout(), MockSessionModel, owner, serviceMocks, session, user, readBodyRefreshToken(), blankRequest (+4 more)

### Community 163 - "Community 163"
Cohesion: 0.15
Nodes (14): login(), ResidentDashboard, triggerSOS(), RootStackParamList, LoginScreen(), Props, money(), Props (+6 more)
...
Cohesion: 0.11
Nodes (17): 1. Blockers — the app is broken in production until these are done, 2. M6 — finish public discovery, 3. M1–M5 — the open items that are code, not a device pass, 4. UI defects from the audit, 5. Screen-by-screen UI pass, 6. Device pass — [device], after everything above, 7. Found along the way, code:bash (npm run mobile:typecheck && npm run mobile:lint && npm run m) (+9 more)
...
Cohesion: 0.15
Nodes (11): activateResident(), AuthSession, submitResidentReview(), AppNavigator(), Stack, Props, ResidentActivationScreen(), styles (+3 more)
...
Cohesion: 0.22
Nodes (11): TradeDetailsStep(), FileUploader(), FileUploaderPresentation, FileUploaderProps, FileUploaderView(), TONE_CLASSES, UploaderTone, UploadedAsset (+3 more)
...
Cohesion: 0.2
Nodes (10): 7.2 Role Gate Test Template, 7.4 Account-Upgrade Test Template, 9.1 Seed Scripts, 9.2 Test Database Isolation, 9.3 Test Helpers, 9. Test Data & Seeding, code:typescript (describe('GET /api/v1/hostel/rooms - role access', () => {), code:typescript (describe('POST /api/v1/hostel/residents - account upgrade', ) (+2 more)
...
Cohesion: 0.39
Nodes (6): avatarInitial(), avatarToneIndex(), index, Avatar(), SIZES, TONES
...
Cohesion: 0.33
Nodes (4): listPublicHostels(), logout(), Props, PublicHomeScreen()
...
## Knowledge Gaps
- **3937 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+3932 more)
...
- **Why does `Button()` connect `Community 14` to `Community 0`, `Community 1`, `Community 98`, `Community 2`, `Community 5`, `Community 8`, `Community 73`, `Community 9`, `Community 138`, `Community 13`, `Community 22`, `Community 23`, `Community 88`, `Community 26`, `Community 27`, `Community 30`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 2` to `Community 0`, `Community 5`, `Community 264`, `Community 9`, `Community 10`, `Community 14`, `Community 147`, `Community 20`, `Community 22`, `Community 23`, `Community 26`, `Community 32`, `Community 33`, `Community 38`, `Community 41`, `Community 49`, `Community 56`, `Community 64`, `Community 71`, `Community 78`, `Community 207`, `Community 208`, `Community 83`, `Community 85`, `Community 95`, `Community 99`, `Community 109`, `Community 116`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `Role` connect `Community 40` to `Community 0`, `Community 3`, `Community 6`, `Community 11`, `Community 12`, `Community 269`, `Community 142`, `Community 17`, `Community 19`, `Community 21`, `Community 24`, `Community 26`, `Community 28`, `Community 29`, `Community 162`, `Community 36`, `Community 38`, `Community 166`, `Community 42`, `Community 43`, `Community 45`, `Community 47`, `Community 304`, `Community 175`, `Community 305`, `Community 51`, `Community 53`, `Community 54`, `Community 57`, `Community 59`, `Community 64`, `Community 65`, `Community 68`, `Community 69`, `Community 74`, `Community 76`, `Community 80`, `Community 85`, `Community 221`, `Community 100`, `Community 103`, `Community 106`, `Community 235`, `Community 109`, `Community 238`, `Community 237`, `Community 239`, `Community 119`, `Community 253`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Are the 327 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 327 INFERRED edges - model-reasoned connections that need verification._
