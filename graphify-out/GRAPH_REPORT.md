# Graph Report - hostel-management-software  (2026-09-26)

## Corpus Check
- 2380 files · ~5,152,975 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21463 nodes · 60741 edges · 609 communities (555 shown, 54 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 1199 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 767 edges
2. `successResponse()` - 739 edges
3. `connectToDatabase()` - 546 edges
4. `useAppTheme()` - 424 edges
5. `cn()` - 347 edges
6. `connectToDatabase()` - 284 edges
7. `string()` - 266 edges
8. `o()` - 258 edges
9. `u()` - 242 edges
10. `unwrap()` - 239 edges
...
## Communities (609 total, 54 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.0
Nodes (479): 594(), 978(), [A,P], {actionStateRoute:v,navigationState:P}, activate(), activeAnimationId(), activeThemeId(), {addKeyedListener:i} (+471 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (366): POST(), RouteContext, GET(), POST(), GET(), PATCH(), POST(), RouteContext (+358 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (270): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel() (+262 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (373): answerSchema, POST(), AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+365 more)
...
Cohesion: 0.01
Nodes (223): LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), csvField(), field(), Hostel, HostelAdminDashboardPageContent() (+215 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (304): loadOverview(), loadMoney(), loadToday(), NoticeArt(), loadFinance(), AdminInvoiceMatrix, AdminMaintenance, AdminModeration (+296 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (232): Scanner(), CookInviteScreen(), GuardianInviteScreen(), Choice, Compass(), MapButton(), ModeTab(), NOTHING_CHOSEN (+224 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (235): POST(), GET(), GET(), getFoodRoutinesByHostelId(), recordListingAppearances(), addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry() (+227 more)

### Community 9 - "Community 9"
Cohesion: 0.01
Nodes (233): DeletionPanel(), EmailSettings(), NotificationSettings(), SETTINGS_TITLES, THEME_OPTIONS, BookingForm(), METHODS, PackageCard() (+225 more)

### Community 10 - "Community 10"
Cohesion: 0.01
Nodes (234): AdminAlertsScreen(), AdminCommunityReportsScreen(), AdminHomeScreen(), AdminOverviewScreen(), AdminMoneyScreen(), AdminMoreScreen(), AdminResidentsScreen(), AdminTodayScreen() (+226 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (186): POST(), POST(), POST(), POST(), attacker, attempt(), headers, jsonRequest() (+178 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (255): aa(), Ac(), Ad(), af(), ai(), Al(), an(), array() (+247 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (186): BubbleBackground(), BubbleBackgroundProps, BubbleColors, BrandMark(), BrandWordmark(), WORDMARK, WORDMARK_SEGMENTS, ConfirmOptions (+178 more)
...
Cohesion: 0.03
Nodes (84): number(), toNumber(), statusCodeOf(), toNumber(), _(), 276(), 601(), a() (+76 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (140): HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend(), HostelHero() (+132 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (159): PaymentMonthStrip(), ClearFilters(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard(), AmountCard() (+151 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (24): Render the pamphlet.  One master per side: A4 + 3 mm bleed at 600 dpi. The A4, shoot(), __addChild(), addPendingGesture(), cancelEvent(), composedPath(), __destroy_into_raw(), disconnect() (+16 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (146): AdminCommunityScreen(), FILTERS, invalidateFeeds(), NIGHT_ANSWER_LABELS, nightAnswerText(), NightPromptAnswer(), NotificationCard(), NotificationRow() (+138 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (146): POST(), RouteContext, DELETE(), GET(), hostelId(), GET(), POST(), DELETE() (+138 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (122): FieldCashRow, PlanPaymentClaim, formatBsAdDate(), GetAppDialog(), Platform, GetPlanButton(), HostelAdminBillingPageContent(), InvoiceRow() (+114 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (119): ATTENDANCE_DEFAULTS, adminPrincipal, mocks, PLATFORM_LIMITS, afterMidnight, evening, meters, mocks (+111 more)

### Community 23 - "Community 23"
Cohesion: 0.06
Nodes (110): accountDeletionCancelledEmail(), idCardIssuedEmail(), accountUpgradedEmail(), verificationEmail(), submitFieldCash(), ATTACHED, dueWhen(), payOnWebsite() (+102 more)

### Community 24 - "Community 24"
Cohesion: 0.02
Nodes (131): CommunityPageContent(), grabDocument(), PayPlanPanel(), rupees(), labelled(), VideoSlot(), CollectionQrField(), OperationsConfig (+123 more)

### Community 25 - "Community 25"
Cohesion: 0.02
Nodes (123): getAttendanceConfig(), getAttendanceSettings(), updateAttendanceSettings(), RouteContext, escapeRegex(), objectIdSchema, paginationSchema, phoneSchema (+115 more)

### Community 26 - "Community 26"
Cohesion: 0.02
Nodes (113): BookingQuote, GuestBookingDetail, GuestBookingSummary, metadata, PayoutAccountForReview, ReviewPayoutAccount(), STATUS_LABEL, List() (+105 more)

### Community 27 - "Community 27"
Cohesion: 0.02
Nodes (123): summarizeResidentComplaints(), listResidentInvoices(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, getFoodRoutine(), isMonthEnd() (+115 more)

### Community 28 - "Community 28"
Cohesion: 0.02
Nodes (120): cropToGuide(), FILL, GuidedCapture(), GUIDES, GuideShape, loadManipulator(), Manipulator, IdCardPrompt() (+112 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (144): abort(), _adopt(), _animationLoop(), ar(), assignAnimationToWorker(), at(), broadcastMessage(), Bt() (+136 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (119): checkoutDocumentFor(), softmatoDocumentNumbers(), gateway, invoice, updateOne, documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument() (+111 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (128): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES (+120 more)
...
Cohesion: 0.02
Nodes (51): assert(), bubbles(), cancelable(), cancelBubble(), clear_slot(), composed(), computeBlankness(), current() (+43 more)
...
Cohesion: 0.03
Nodes (115): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult (+107 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (13): c, ga(), getImageAsync(), ls(), object(), openBrowserAsync(), requestMicrophonePermissionsAsync(), rs() (+5 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (103): DELETE(), RouteContext, GET(), POST(), querySchema, RouteContext, authorUserId, mocks (+95 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (96): PRIORITIES, STATUS_ACTIONS, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel, Overview, Report (+88 more)
...
Cohesion: 0.02
Nodes (113): ProfileScreen(), ReferralRow(), CheckoutStatusScreen(), ComplaintDetail(), ComplaintCard(), CategoryTile(), NewComplaintScreen(), PickedAttachment (+105 more)

### Community 41 - "Community 41"
Cohesion: 0.02
Nodes (99): EMPTY_PAYOUT_DRAFT, METHODS, PayoutAccountDraft, PayoutAccountFields(), payoutAccountPayload(), DescriptionFacts, DescriptionSuggestions(), HostelType (+91 more)

### Community 42 - "Community 42"
Cohesion: 0.02
Nodes (32): addChangeListener(), addEventListener(), addListenerForTag(), attachGestureHandler(), clearInteractionHandle(), configureNextLayoutAnimation(), createGestureHandler(), delete() (+24 more)

### Community 43 - "Community 43"
Cohesion: 0.02
Nodes (6): 42(), duration(), Eo(), measure(), n, sm_start()

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (107): accountDeletionRequestedEmail(), registeredYesterday, seen, today, absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord (+99 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (114): MESSAGES, POST(), RouteContext, BookingEndCause, HostelBookingClosedCause, announceConfirmed(), announceEnding(), assertAwaitingAnswer() (+106 more)

### Community 46 - "Community 46"
Cohesion: 0.03
Nodes (101): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, aswin, bhadra (+93 more)

### Community 47 - "Community 47"
Cohesion: 0.03
Nodes (109): addBsMonths(), BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthsEnd(), bsMonthStart(), bsPeriodBounds(), bsPeriodOf() (+101 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (92): GET(), BookableHostel, BookingUnavailableReason, findRoom(), hostelAddress(), HostelAvailability, hostelCoverPhoto(), hostelUnavailableReason() (+84 more)

### Community 49 - "Community 49"
Cohesion: 0.03
Nodes (54): StarLayer(), StarLayerProps, StarsBackground(), StarsBackgroundProps, InlineText(), TIER_TONE, PlanMark(), RAFTER (+46 more)
...
Cohesion: 0.03
Nodes (93): openStore(), SORTS, StoreCategoryScreen(), appBlurTarget, closeConfirm(), ConfirmRequest, emit(), getConfirmRequest() (+85 more)

### Community 53 - "Community 53"
Cohesion: 0.03
Nodes (84): AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, serializeAuditLog(), mocks, listTrendingTags(), feeScheduleListQuerySchema (+76 more)

### Community 54 - "Community 54"
Cohesion: 0.02
Nodes (11): build(), createInteractionHandle(), __getAnimatedValue(), __getValue(), impactAsync(), __onAnimatedValueUpdateReceived(), replace(), s (+3 more)

### Community 55 - "Community 55"
Cohesion: 0.04
Nodes (89): demoteToPublicAccount(), CardBooking, checkInBooking(), findHeldBooking(), returnHeldBed(), takeHeldBed(), notifyPlatform(), CapacityError (+81 more)
...
Cohesion: 0.03
Nodes (83): classifyCredit(), CreditClassification, findOrphanClaims(), LadderClaim, LadderInvoice, loadMatchContext(), MatchContext, normalizeTxnId() (+75 more)
...
Cohesion: 0.04
Nodes (65): notifyHostelOfNewPost(), resolveHostelCommunityUserIds(), usersMutingNewPosts(), AUDIENCE_HEADING, EmailPreferencesPage(), metadata, PageProps, POST() (+57 more)

### Community 60 - "Community 60"
Cohesion: 0.02
Nodes (47): deleteHostelObjects(), ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, purgeHostel(), RETAINED_BY_HOSTEL_ID (+39 more)

### Community 61 - "Community 61"
Cohesion: 0.03
Nodes (59): AdminTabs(), HIDDEN, RoleLayout(), TABS, TABS, AdminAlertsProvider(), AvatarTabIcon(), DISSOLVE (+51 more)

### Community 62 - "Community 62"
Cohesion: 0.04
Nodes (65): BookButton(), SIZE, BookingAvailabilityView, BookingButton, CLOSED_REASONS, open, HostelPhotoReminder(), CITY_OPTIONS (+57 more)

### Community 63 - "Community 63"
Cohesion: 0.03
Nodes (73): currentBsPeriod(), PlanId, Service, ServiceModule, ServiceModuleId, OfferTab(), Faq, PlatformConfigSeoPageContent (+65 more)

### Community 64 - "Community 64"
Cohesion: 0.04
Nodes (63): afterResponse(), mocks, work, hostelPeriodOf(), defaultJoinedDate(), BillPreview, CheckContext, CheckedRow (+55 more)
...
Cohesion: 0.03
Nodes (53): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, metadata, HostelBookingView, ExistingResidentsPanel(), Props, ExistingResidentsSheet(), HostelAdminExistingResidentsPage() (+45 more)

### Community 67 - "Community 67"
Cohesion: 0.08
Nodes (68): BookingDocumentInput, bookingDocumentLayout(), refundPolicyNotes(), renderBookingDocument(), destinationText(), bsFiscalYear(), bsMonthName(), amountInWords() (+60 more)

### Community 68 - "Community 68"
Cohesion: 0.05
Nodes (57): asRecord(), DrawnPush, readDrawnPush(), message, pushData, configureNativeNightPrompt(), NativeNightPrompt, readNativePendingAnswers() (+49 more)

### Community 69 - "Community 69"
Cohesion: 0.05
Nodes (66): noticePushSchema, platformPushScheduleSchema, announceChange(), audit(), CreateInput, createNoticePush(), DEFAULT_PUSHES, deleteNoticePush() (+58 more)

### Community 70 - "Community 70"
Cohesion: 0.03
Nodes (65): account, answerBy, before, book(), Booking, compact, confirmed(), Consent (+57 more)
...
Cohesion: 0.05
Nodes (65): GATEWAY_ORDER, getHostelPayMethods(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice() (+57 more)
...
Cohesion: 0.05
Nodes (66): AssetViewer(), openIdFor(), openIds, StripThumb(), useViewerState(), ViewerBody(), ViewerPage(), clampIndex() (+58 more)
...
Cohesion: 0.04
Nodes (49): secretsMatch(), ENDPOINTS, esewaProvider, getJson(), parseAmount(), SIGNED_FIELDS, attempt, fetchMock (+41 more)

### Community 79 - "Community 79"
Cohesion: 0.05
Nodes (59): otpResendCooldownMs(), softmatoDocsUrl(), dueBhadra29, filed, throughAswin25, BillingHistory, BillingInvoiceRow, BillingPaymentRow (+51 more)
...
Cohesion: 0.06
Nodes (61): BS_MONTHS, cellAt(), focusCell(), INPUT_MODES, Props, fullYear(), MONTH_SPELLINGS, monthFromWord() (+53 more)
...
Cohesion: 0.06
Nodes (61): getPresignedReadUrl(), userResidentProfileSchema, findLiveResidency(), LEGACY_ROLE_MAP, Role, ROLE_VALUES, CARD_LABELS, formatIssuedOn() (+53 more)

### Community 84 - "Community 84"
Cohesion: 0.04
Nodes (11): ensureConfig(), f(), get_slot_str(), getSlot(), notify(), preventDefault(), run(), scanFromURLAsync() (+3 more)
...
Cohesion: 0.06
Nodes (55): otpCodeEmail(), deliver(), loadInvoiceById(), loadProof(), PlanPaymentInstructions, ProofAsset, submitPlanPaymentClaim(), InvoiceRecord (+47 more)

### Community 89 - "Community 89"
Cohesion: 0.05
Nodes (50): readReturnState(), ReturnStep, ownerIdentitiesFor(), resolveOwnedHostel(), getPlanPaymentInstructions(), reviewPlanPaymentClaim(), getSubscriptionState(), hostelToday() (+42 more)

### Community 90 - "Community 90"
Cohesion: 0.04
Nodes (45): metadata, CheckoutHandoffButton(), Handoff, ORDER, ProgressStep, TransitionScreen(), useCheckoutHandoff(), Badge() (+37 more)
...
Cohesion: 0.04
Nodes (40): accountDeletionRequestSchema, deviceTokenSchema, notificationSchema, sessionSchema, describeDeposit(), notifyMoveOutCompleted(), hostelId, mocks (+32 more)

### Community 95 - "Community 95"
Cohesion: 0.07
Nodes (53): evidenceFlags(), AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance(), deadline(), DIGIT_CONFUSABLES (+45 more)

### Community 96 - "Community 96"
Cohesion: 0.05
Nodes (41): attendanceAlertResolveSchema, paginationQuerySchema, DEPRECATED_ALIASES, grantingPermissionKeys(), mocks, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex() (+33 more)
...
Cohesion: 0.06
Nodes (49): candidatesInRun(), canonicalize(), checkCharacter(), CONFUSABLES, decodeSequence(), deriveHostelPrefix(), encodeSequence(), extractReferenceCodes() (+41 more)
...
Cohesion: 0.05
Nodes (41): LIVE_ACCESS, releaseGuardianAccounts(), hostelId, mocks, userId, acceptGuardianInvitation(), daysFromNow(), enabledPermissionLabels() (+33 more)

### Community 101 - "Community 101"
Cohesion: 0.08
Nodes (44): collectionTotals(), countInvoicesByField(), invoicesByIds(), ledgerPipeline(), listRecentInvoices(), getHostelViewStats(), foodFeedbackSchema, listingFlagSchema (+36 more)
...
Cohesion: 0.04
Nodes (43): asObjectId(), claimAmount, dirname, dueAmount, eventId, fractional, hostels, invoiceBalances (+35 more)

### Community 105 - "Community 105"
Cohesion: 0.08
Nodes (44): fill(), money(), PlanCard(), PricingScreen(), UpgradeDialog(), BillingToggle(), listHeadingFor(), PlanCard() (+36 more)

### Community 106 - "Community 106"
Cohesion: 0.07
Nodes (38): DELETE(), POST(), PATCH(), accountAddresses(), getAccountEmailPreference(), setMutedTopics(), updateAccountEmailPreference(), revokeDeviceToken() (+30 more)
...
Cohesion: 0.06
Nodes (42): continueLabel(), isBlank(), buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, draftFromProfile() (+34 more)
...
Cohesion: 0.08
Nodes (34): cookPrincipal, mocks, resolveCookLabels(), CookServiceError, cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError (+26 more)
...
Cohesion: 0.08
Nodes (35): BOOKING_DOCUMENT_KINDS, BookingDocumentKind, allowed(), BookingDocumentScope, HostelScope, ResolvedDocument, resolveInvoiceDocument(), resolveReceiptDocument() (+27 more)

### Community 117 - "Community 117"
Cohesion: 0.08
Nodes (32): qrActivationSchema, before, expiresAt, mocks, staffPrincipal, ActivationCodeGenerateInput, ActivationCodeInput, activationSecret() (+24 more)
...
Cohesion: 0.09
Nodes (30): assertPlanRoom(), countLive(), notifyLimitReached(), NOUN, PlanLimitError, PlanSeat, hostelId, mocks (+22 more)
...
Cohesion: 0.09
Nodes (33): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags() (+25 more)
...
Cohesion: 0.11
Nodes (30): POST(), RealtimeConfig, RealtimeContext, RealtimeContextValue, RealtimeNotification, RealtimeProvider(), useRealtime(), GET() (+22 more)
...
Cohesion: 0.1
Nodes (29): assertPrimaryCredentialPrincipal(), PLATFORM_SETTING_CHANGE_STATUSES, platformSettingChangeSchema, GET(), PUT(), saveOperationsConfig(), isSettingChangeKey(), cancelSettingChange() (+21 more)
...
Cohesion: 0.08
Nodes (17): KNOWN_PATHS, marksRoleChange(), opensPlanBilling(), resolvePushPath(), REWRITES, ROLE_CHANGE_TYPES, blobNames, blobSizes (+9 more)
...
Cohesion: 0.07
Nodes (19): monthlySeries(), countListingAppearances(), complaintSchema, hostelPageViewSchema, inquirySchema, maintenanceRequestSchema, moveOutChecklistSchema, nightStatusSchema (+11 more)
...
Cohesion: 0.12
Nodes (26): activateResident(), ApiFailure, apiRequest(), ApiSuccess, AuthUser, confirmComplaintResolution(), createResidentComplaint(), getActivationStatus() (+18 more)
...
Cohesion: 0.15
Nodes (28): AuditLog, code:typescript (// One per resident, per hostel. Minted lazily on first dash), code:typescript (interface ISubscription {), code:typescript (interface IPlatformSetting {), code:typescript (interface IAuditLog {), code:typescript ({), code:typescript ({), code:typescript ({) (+20 more)
...
Cohesion: 0.12
Nodes (23): PLATFORM_NAME_PARTS, BRAND_GREEN, drawCertificationStamp(), drawStamp(), Font, footerLine(), formatDate(), formatLongDate() (+15 more)
...
Cohesion: 0.12
Nodes (22): 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.3 Hostel Rejected, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.3 Payment Proof Uploaded (to Admin) (+14 more)
...
Cohesion: 0.16
Nodes (13): login(), submitResidentReview(), triggerSOS(), RootStackParamList, LoginScreen(), Props, Props, styles (+5 more)
...
Cohesion: 0.21
Nodes (15): Guidance, GuidanceStatus, CARDINALS, directionWord(), distanceToPath(), hasArrived(), instructionFor(), isOffRoute() (+7 more)
...
Cohesion: 0.22
Nodes (14): code:typescript (interface IServiceProvider {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IInquiry {), code:typescript (interface IHostelPageView {), Inquiry, MaintenanceRequest, Move-in / Move-out (+6 more)

### Community 285 - "Community 285"
Cohesion: 0.26
Nodes (14): 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, 7.1 New Hostel Pending Approval (to Superadmin), 7.2 Subscription Expiring Soon, 7. Platform Admin Emails (+6 more)
...
Cohesion: 0.18
Nodes (9): AuthSession, register(), verifyOtp(), AppNavigator(), Stack, OtpVerificationScreen(), Props, ResidentActivationScreen() (+1 more)
...
Cohesion: 0.21
Nodes (8): ExpertConsultationCreateInput, ExpertConsultationError, ExpertConsultationRequestRecord, notifyTeamOfRequest(), expertConsultationCreateSchema, expertConsultationRequestSchema, getSiteConfigSection(), consultationRequestEmail()
...
## Knowledge Gaps
- **6959 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+6954 more)
...
- **Why does `string()` connect `Community 45` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 26`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 35`, `Community 36`, `Community 40`, `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 47`, `Community 48`, `Community 50`, `Community 52`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 58`, `Community 59`, `Community 62`, `Community 64`, `Community 65`, `Community 67`, `Community 70`, `Community 71`, `Community 72`, `Community 73`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 81`, `Community 83`, `Community 84`, `Community 87`, `Community 88`, `Community 89`, `Community 90`, `Community 95`, `Community 97`, `Community 99`, `Community 100`, `Community 104`, `Community 111`, `Community 113`, `Community 116`, `Community 118`, `Community 119`, `Community 120`, `Community 121`, `Community 127`, `Community 128`, `Community 131`, `Community 132`, `Community 133`, `Community 144`, `Community 157`, `Community 160`, `Community 164`, `Community 179`, `Community 184`, `Community 188`, `Community 197`, `Community 214`, `Community 235`, `Community 247`, `Community 295`, `Community 301`, `Community 386`, `Community 387`, `Community 431`, `Community 434`?**
  _High betweenness centrality (0.161) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 13` to `Community 2`, `Community 4`, `Community 5`, `Community 141`, `Community 14`, `Community 149`, `Community 21`, `Community 24`, `Community 26`, `Community 156`, `Community 34`, `Community 38`, `Community 39`, `Community 41`, `Community 49`, `Community 51`, `Community 62`, `Community 66`, `Community 77`, `Community 81`, `Community 82`, `Community 85`, `Community 90`, `Community 93`, `Community 99`, `Community 102`, `Community 105`, `Community 108`, `Community 250`, `Community 251`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 15` to `Community 1`, `Community 2`, `Community 9`, `Community 10`, `Community 11`, `Community 140`, `Community 14`, `Community 144`, `Community 17`, `Community 18`, `Community 145`, `Community 16`, `Community 21`, `Community 23`, `Community 24`, `Community 156`, `Community 28`, `Community 31`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 38`, `Community 39`, `Community 41`, `Community 42`, `Community 45`, `Community 46`, `Community 47`, `Community 178`, `Community 179`, `Community 56`, `Community 441`, `Community 58`, `Community 188`, `Community 62`, `Community 67`, `Community 197`, `Community 78`, `Community 79`, `Community 81`, `Community 212`, `Community 84`, `Community 214`, `Community 87`, `Community 101`, `Community 102`, `Community 104`, `Community 367`, `Community 113`, `Community 118`, `Community 119`, `Community 127`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Are the 540 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 540 INFERRED edges - model-reasoned connections that need verification._
