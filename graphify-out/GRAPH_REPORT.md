# Graph Report - hostel-management-software  (2026-09-14)

## Corpus Check
- 2059 files · ~3,247,487 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 16487 nodes · 45355 edges · 580 communities (553 shown, 27 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 747 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 655 edges
2. `successResponse()` - 635 edges
3. `connectToDatabase()` - 453 edges
4. `useAppTheme()` - 402 edges
5. `cn()` - 297 edges
6. `connectToDatabase()` - 252 edges
7. `unwrap()` - 209 edges
...
- `POST()` --calls--> `connectToDatabase()`  [INFERRED]
  apps/web/src/app/api/v1/cron/purge-expired-otps/route.ts → packages/db/src/connection.ts

## Communities (580 total, 27 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (274): POST(), GET(), POST(), GET(), PATCH(), POST(), RouteContext, GET() (+266 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (264): PATCH(), RouteContext, POST(), getOrCreateSubscription(), GET(), getOpenFeeSchedule(), GET(), POST() (+256 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (175): ICONS, LABELS, Segment, TONES, FILTERS, Pending, Overview, MANAGE_ROWS (+167 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (254): NightStatusPromptCard(), loadFinance(), PortalDates, useHostelDayTurn(), ActivationIssue, addCook(), addEmergencyContact(), addHostelPhoto() (+246 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (228): answerSchema, POST(), AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+220 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (228): DeletionPanel(), SORTS, AuthDivider(), GoogleSignInButton(), ResidencyInviteHost(), RoleGate(), UploadToaster(), accentForAccount() (+220 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (187): Scanner(), CookInviteScreen(), GuardianInviteScreen(), Assurance(), CallableRow(), IdentityCard(), PeopleSection(), SavedListRow() (+179 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (174): HIDDEN, RoleLayout(), TABS, FILTERS, invalidateFeeds(), NotificationRow(), TILE_GLYPH, TILE_TONES (+166 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (126): PlanPaymentClaim, HostelTable(), UserRecord, GuardianDashboard, CreateWardenResult, PERMISSION_LABELS, DeletionQueue, DeletionRequest (+118 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (156): AdminCommunityReportsScreen(), AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), AttendanceScreen(), RootShell(), NightStatusHistoryScreen(), NightStatusScreen() (+148 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (158): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), loadOverview(), AdminTabs(), AdminMoneyScreen(), loadMoney(), MoneyData (+150 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (141): DELETE(), GET(), hostelId(), GET(), POST(), DELETE(), PATCH(), RouteContext (+133 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (146): PaymentMonthStrip(), ManageRatesScreen(), ClearFilters(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard() (+138 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (113): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel() (+105 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (121): GET(), PATCH(), POST(), cookPrincipal, mocks, resolveCookLabels(), CookServiceError, resolveAdminHostelId() (+113 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (124): GET(), POST(), querySchema, RouteContext, AnnouncementInput, CommentCreateInput, commentOnPost(), CommentRecord (+116 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (92): GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, CITY_OPTIONS (+84 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (99): FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, monthStartPeriod(), Rate, RoomTypeOption, gregorianSpan(), MonthField (+91 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (105): AdminCommunityScreen(), BootGate(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD (+97 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (114): NightStatusForm(), ReviewForm(), ReviewScreen(), AlertRow(), SosScreen(), describeGrants(), GuardianRow(), PermissionSheet() (+106 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (117): POST(), GET(), DELETE(), POST(), PaginationQuery, PLATFORM_ROLES, findOrphanClaims(), loadMatchContext() (+109 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (110): AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, demoteToPublicAccount(), GET(), RouteContext (+102 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (93): Notification, grabDocument(), PayPlanPanel(), rupees(), FILTERS, Notification, NotificationRow(), PushState (+85 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (100): GET(), hashUserAgent(), HostelRef, newVisitorKey(), recordHostelPageView(), resolveVisitorKey(), getPresignedReadUrl(), hostelPageViewSchema (+92 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (92): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, notifyHostelOfNewPost(), resolveHostelCommunityUserIds() (+84 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (89): CommunityReportDialog(), REASONS, MonthOption(), BrowserPushRow(), ModerationButton(), PagerButton(), normalize(), PortalSearch() (+81 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (80): Campaign, HostelAdminNotificationsPageContent, Resident, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel, GatewayConfig (+72 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (87): GET(), POST(), GET(), querySchema, checkTeamOwnerEmail(), findHostelUsingEmail(), GET(), GET() (+79 more)

### Community 28 - "Community 28"
Cohesion: 0.09
Nodes (59): accountDeletionCancelledEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), METHOD_LABELS, PLATFORM_NAME_PARTS, cookInvitationEmail() (+51 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (80): DescriptionFacts, DescriptionSuggestions(), HostelType, since(), starters, typeWords, cityOptions, createDocument() (+72 more)

### Community 30 - "Community 30"
Cohesion: 0.02
Nodes (70): deleteHostelObjects(), ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, purgeArchivedHostel(), purgeHostel() (+62 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (67): csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, Inquiry, LoadState, Message() (+59 more)
...
Cohesion: 0.03
Nodes (86): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), sitemap() (+78 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (83): fromBs(), gregorianOf(), BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary (+75 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (83): listResidentClaims(), approveClaim(), assertNotAlreadyRecordedFromStatement(), bulkApproveClaims(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck() (+75 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (64): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), ApplyBlock(), ServiceProvidersScreen() (+56 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (65): ComparePage(), hostels, metadata, rows, AuthGuard(), VideoSlot(), CurrentUser, MeResponse (+57 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (57): metadata, AccountDeletionPanel, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails() (+49 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (44): ReturnState, CancelDeletionPageContent(), CheckoutReturnPage(), AcceptResult, CookInvitePageContent, ExistingResidentsPanel(), Props, ExistingResidentsSheet() (+36 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (63): CLAIMABLE_STATUSES, dispatchOtpChallenge(), findVerifiedRegistrationChallenge(), generateOtpCode(), GOOGLE_JWKS, hashOtpCode(), normalizeEmail(), normalizeOtpIdentifier() (+55 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (64): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, GATEWAY_ORDER, getHostelPayMethods() (+56 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (60): AttachmentGallery(), ComplaintDetail(), ComplaintCard(), CategoryTile(), NewComplaintScreen(), PickedAttachment, SwapButton(), CapturedPhoto (+52 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (59): notifyProviderOfAssignment(), notifyProviderOfMaintenanceNote(), notifyProviderOfStatusChange(), notifyStaffOfJobProgress(), notifyStaffOfNewMaintenanceRequest(), providerUserId(), readableCategory(), RequestLike (+51 more)
...
Cohesion: 0.05
Nodes (46): HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), PlatformDashboardPageContent(), PlatformHostelReviewPageContent(), PlatformHostelsPageContent(), PlatformUsersPageContent(), DashboardCard(), DashboardCardProps (+38 more)
...
Cohesion: 0.05
Nodes (51): hostelPeriodOf(), existingResidentListSchema, existingResidentRowSchema, BillPreview, CheckContext, CheckedRow, checkExistingResidents(), CheckResult (+43 more)
...
Cohesion: 0.06
Nodes (61): BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodBounds(), bsPeriodOf(), bsPeriodsBetween() (+53 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (59): BALANCE_ALIASES, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES, WITHDRAWAL_ALIASES (+51 more)
...
Cohesion: 0.06
Nodes (50): JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, ProviderStatusCard(), TILE_INK (+42 more)

### Community 55 - "Community 55"
Cohesion: 0.03
Nodes (36): mocks, readable, selectable, assetId, hostelId, mocks, otherHostelId, principal (+28 more)

### Community 56 - "Community 56"
Cohesion: 0.05
Nodes (53): escapeRegex(), SERVICE_PROVIDER_CATEGORIES, serviceProviderSchema, serviceProviderApplicationSchema, serviceProviderDocumentSchema, notifyServiceProviderDecision(), ACTIVE_APPLICATION_STATUSES, approveServiceProvider() (+45 more)
...
Cohesion: 0.08
Nodes (51): bsFiscalYear(), amountInWords(), GROUPS, ONES, TENS, underHundred(), underThousand(), documentAdDate() (+43 more)

### Community 59 - "Community 59"
Cohesion: 0.05
Nodes (56): buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, draftFromProfile(), emptyIdentityDraft(), firstIncompleteIdentityStep() (+48 more)

### Community 60 - "Community 60"
Cohesion: 0.12
Nodes (38): POST(), POST(), authenticateWithGoogle(), AuthServiceError, changePassword(), logout(), POST(), POST() (+30 more)

### Community 61 - "Community 61"
Cohesion: 0.05
Nodes (46): addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine, formatWeekRange(), HostelAdminFoodPage (+38 more)

### Community 62 - "Community 62"
Cohesion: 0.04
Nodes (41): FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), hasProvider(), IntentRow, recheckClosedAttempts(), SettlementReconSummary, computeCreditAmount() (+33 more)

### Community 63 - "Community 63"
Cohesion: 0.06
Nodes (54): AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance(), deadline(), DIGIT_CONFUSABLES, EvidenceRead (+46 more)

### Community 64 - "Community 64"
Cohesion: 0.05
Nodes (37): BROWSE_FACILITIES, BrowseByFacility(), BrowseByType(), CitiesRow(), CityCard(), Hero(), HERO_CHIPS, NearbyHostels() (+29 more)
...
Cohesion: 0.06
Nodes (34): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, ENDPOINTS, esewaProvider, SIGNED_FIELDS, attempt, fetchMock (+26 more)
...
Cohesion: 0.09
Nodes (38): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, ImageVariantRecord (+30 more)

### Community 70 - "Community 70"
Cohesion: 0.06
Nodes (23): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminFoodPage(), redirectToWorkspaceScreen(), HostelAdminMaintenancePageContent() (+15 more)

### Community 71 - "Community 71"
Cohesion: 0.07
Nodes (44): Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity() (+36 more)

### Community 72 - "Community 72"
Cohesion: 0.06
Nodes (38): Offset, PhotoCropper(), buildIdCardData(), EMAIL_CHECK_HINTS, EmailCheck, Field(), FIELD_LABELS, formatCardDate() (+30 more)

### Community 73 - "Community 73"
Cohesion: 0.07
Nodes (38): referralSchema, referralCodeSchema, referralRewardSchema, assertActiveReferralCode(), auditReferralAction(), confirmReferralJoined(), createReferredInquiry(), findActiveReferralCode() (+30 more)

### Community 74 - "Community 74"
Cohesion: 0.08
Nodes (30): POST(), POST(), POST(), POST(), periodOf(), runBillingCycleForAllHostels(), POST(), runGatewayHealth() (+22 more)
...
Cohesion: 0.07
Nodes (42): formatPeriodKey(), DeliveryWindowFields(), number(), text(), budgetLabel(), CountUp(), numberValue(), axisMonth() (+34 more)

### Community 80 - "Community 80"
Cohesion: 0.06
Nodes (28): currency(), Select(), TextArea(), ResidentActivationPageContent, ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent (+20 more)

### Community 81 - "Community 81"
Cohesion: 0.07
Nodes (36): drawCertificationStamp(), footerLine(), formatDate(), formatLongDate(), MONTHS, ReceiptPdfInput, renderReceiptPdf(), renderStatementPdf() (+28 more)
...
Cohesion: 0.06
Nodes (23): field(), GuardianDashboard, GuardianDashboardPageContent(), LoadState, NightStatusRow, Notification, NotificationsPageContent(), optionalNumber() (+15 more)
...
Cohesion: 0.08
Nodes (35): qrActivationSchema, before, expiresAt, mocks, staffPrincipal, activateResident(), ActivationCodeGenerateInput, ActivationCodeInput (+27 more)
...
Cohesion: 0.07
Nodes (36): getHostelLedger(), countInvoicesByStatus(), fromLedgerRow(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor(), LedgerInvoiceRow, LedgerScope (+28 more)

### Community 90 - "Community 90"
Cohesion: 0.07
Nodes (35): filterPushRecipients(), CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, readId(), activeDevicesFor(), activeTokensFor(), androidChannel() (+27 more)
...
Cohesion: 0.07
Nodes (35): LIVE_ACCESS, releaseGuardianAccounts(), hostelId, mocks, userId, acceptGuardianInvitation(), daysFromNow(), enabledPermissionLabels() (+27 more)

### Community 93 - "Community 93"
Cohesion: 0.07
Nodes (27): PortalShell(), navItems, navItems, GUARDIAN_NAV, GUARDIAN_SEARCH_ENTRIES, HOSTEL_ADMIN_NAV, HOSTEL_ADMIN_SEARCH_ENTRIES, hostelAdminHref() (+19 more)

### Community 94 - "Community 94"
Cohesion: 0.07
Nodes (28): metadata, CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+20 more)
...
Cohesion: 0.09
Nodes (35): Compass(), Guidance, GuidanceStatus, NavigationFix, watchDeviceHeading(), watchNavigationPosition(), cardinalFor(), CARDINALS (+27 more)
...
Cohesion: 0.12
Nodes (32): PreviewCard(), ResultRow(), FACILITY_ICONS, facilityIcon(), facilityKey(), HostelCard(), SaveButton(), HeadCell() (+24 more)

### Community 100 - "Community 100"
Cohesion: 0.12
Nodes (33): documentDownloadUrl(), issueInvoiceDocument(), openCheckoutSession(), readSettledReceipt(), allocateReceiptNumber(), applySettlement(), InvoiceRecord, loadInvoice() (+25 more)

### Community 101 - "Community 101"
Cohesion: 0.08
Nodes (29): buildFormPostHandoff(), FormPostHandoff, HandoffError, IntentRecord, formPostIntent, hostelId, intentId, invoiceId (+21 more)
...
Cohesion: 0.07
Nodes (25): inferKind(), MediaLightbox(), Choice, HOSTEL_TYPE_LABELS, HostelPanel(), MapButton(), MapCanvas, ModeTab() (+17 more)
...
Cohesion: 0.1
Nodes (32): directionOf(), EMPTY_TALLY, floorToStep(), phaseOf(), shouldRepost(), tallyUploads(), active, done (+24 more)

### Community 108 - "Community 108"
Cohesion: 0.09
Nodes (27): HostelSuggestions(), PublicHostel, checkOnly(), EMPTY_PREFILL, ENVIRONMENT_OPTIONS, IdentityResponse, Prefill, Step (+19 more)

### Community 109 - "Community 109"
Cohesion: 0.1
Nodes (31): cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath(), formatManeuverDistance(), hasArrived(), headingDifference() (+23 more)

### Community 110 - "Community 110"
Cohesion: 0.11
Nodes (33): money(), PlanCard(), pricePlan(), listHeadingFor(), PlanCard(), CatalogueTab(), CycleDiscount(), PublicServiceDetailPage() (+25 more)
...
Cohesion: 0.09
Nodes (26): native, NativeDownloads, openDownloaded(), openSavedFile(), SavedDownload, configureNativeNightPrompt(), claimNotificationSound(), claims (+18 more)
...
Cohesion: 0.12
Nodes (28): CsvTable, gridFromCsv(), peekHeaders(), readCsv(), stripBom(), stripPreamble(), [first], FIXTURES (+20 more)
...
Cohesion: 0.08
Nodes (23): BrowseParams, BUDGET_BANDS, FilterSheet(), HostelBrowser(), HostelBrowserProps, NearestToggle(), ViewSwitch(), useNearby() (+15 more)

### Community 119 - "Community 119"
Cohesion: 0.09
Nodes (27): buildHtml(), NearbyStatus, boundsCenter(), haversineMeters(), HostelWithDistance, isUsableCoordinate(), KATHMANDU, sortByDistance() (+19 more)

### Community 120 - "Community 120"
Cohesion: 0.09
Nodes (26): reviewModerationLogSchema, notifyHostelOfReview(), auditReviewAction(), averageOf(), createResidentReview(), hideReview(), listPlatformReviews(), listPublicHostelReviews() (+18 more)
...
Cohesion: 0.12
Nodes (29): BS_MONTHS, cellAt(), focusCell(), Props, ListRow, amountText(), blankSheetRow(), CellError (+21 more)

### Community 123 - "Community 123"
Cohesion: 0.08
Nodes (28): daysBetween(), DunningAction, DunningStage, DunningState, InvoiceRow, nextDunningAction(), OPEN_STATUSES, PaymentReminderRun (+20 more)
...
Cohesion: 0.1
Nodes (28): UploadCard(), useIsUploading(), ensureChannel(), startUploadNotifications(), dismissUpload(), emit(), isUploadActive(), listeners (+20 more)

### Community 126 - "Community 126"
Cohesion: 0.11
Nodes (26): InquiryLinkScreen(), ReferralBody(), Referral, ReferralCode, ReferralReward, ReferralStatus, ReferralSummary, ResidentReferral (+18 more)

### Community 127 - "Community 127"
Cohesion: 0.11
Nodes (27): softmatoDocsUrl(), dueBhadra29, filed, throughAswin25, BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan (+19 more)

### Community 128 - "Community 128"
Cohesion: 0.07
Nodes (21): EASE, FaqEntry, FaqRole, FaqRow(), FAQS, PREVIEW_ROWS, PREVIEWS, ROLES (+13 more)
...
Cohesion: 0.08
Nodes (19): EmptyState(), Panel(), field(), HostelAdminReferralsPageContent(), ListingFlag, LoadState, MaintenanceRequest, optionalField() (+11 more)

### Community 132 - "Community 132"
Cohesion: 0.1
Nodes (19): applyWebhook(), WebhookResult, softmato(), SoftmatoNotConfiguredError, SoftmatoConfig, softmatoWebhookSecret(), POST(), classify() (+11 more)
...
Cohesion: 0.1
Nodes (25): DownloadRow, DownloadStack(), progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster(), UploadRow (+17 more)

### Community 137 - "Community 137"
Cohesion: 0.11
Nodes (22): noticeSchema, noticeReadStatusSchema, auditNoticeAction(), broadcastNotice(), createNotice(), definedUpdate(), listNotices(), normalizeObjectIds() (+14 more)
...
Cohesion: 0.12
Nodes (25): ApiFailure, apiRequest(), ApiSuccess, AuthUser, getActivationStatus(), getResidentNightStatus(), listNotifications(), listResidentFood() (+17 more)
...
Cohesion: 0.11
Nodes (23): FILE_ASSET_KINDS, FileAssetKind, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), UploadItem, UploadKind, ApiEnvelope (+15 more)

### Community 150 - "Community 150"
Cohesion: 0.16
Nodes (23): HostelScope, ResolvedDocument, resolveInvoiceDocument(), resolveReceiptDocument(), scopeFilter(), settledTotal(), trySoftmato(), allocate() (+15 more)
...
Cohesion: 0.17
Nodes (25): subscriptionClaimReceivedEmail(), subscriptionClaimRejectedEmail(), deliver(), loadInvoiceById(), loadProof(), PlanPaymentInstructions, ProofAsset, reviewPlanPaymentClaim() (+17 more)
...
Cohesion: 0.14
Nodes (22): bsMonthStart(), hostelCalendarDay(), hostelToday(), hostelCalendarDay(), hostelMonthStart(), hostelToday(), once, AdmissionInvoiceResult (+14 more)
...
Cohesion: 0.14
Nodes (21): Choice, maneuverIcon(), MapButton(), MapScreen(), ModeTab(), NavCard(), NOTHING_CHOSEN, RouteCard() (+13 more)

### Community 164 - "Community 164"
Cohesion: 0.11
Nodes (15): searchHostels(), rows, PublicHostel, refreshedSnapshots(), SavedHostel, fresh, gone, items (+7 more)
...
Cohesion: 0.13
Nodes (20): getCurrentUser(), isApprovedServiceProvider(), issueSessionForUser(), login(), publicUser(), refreshAccessToken(), sameIds(), cook (+12 more)
...
Cohesion: 0.1
Nodes (22): CITY_OPTIONS, FACILITY_OPTIONS, hasHostelErrors(), hasUsableRooms(), HOSTEL_PLANS, HOSTEL_STEPS, HOSTEL_TYPES, HostelAttachment (+14 more)

### Community 182 - "Community 182"
Cohesion: 0.09
Nodes (16): DESCRIPTION_STARTERS, HostelWizard(), ID_PROOF_LABELS, MEALS_PER_DAY, MEALS_SERVED, RoomCard(), RoomSection(), SENT_ANIMATION (+8 more)
...
Cohesion: 0.13
Nodes (23): code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface INotice {), code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {), code:typescript ({), code:typescript (interface IMoveInChecklistItem {), code:typescript (interface IMoveOutChecklistItem {) (+15 more)

### Community 188 - "Community 188"
Cohesion: 0.11
Nodes (22): Attendance / Night Safety, Bed, Build status (end of Phase 3), Build status (end of Phase 5 — verified 2026-08-02), code:typescript (export enum Role {), code:typescript (interface IQRActivation {), code:typescript (interface INightStatusLog {), code:typescript (interface IRoomConfiguration {) (+14 more)
...
Cohesion: 0.13
Nodes (19): firstIncompleteProviderStep(), hasProviderErrors(), isProviderStepComplete(), PROVIDER_CATEGORIES, PROVIDER_STEPS, ProviderAttachment, ProviderCategory, providerCategoryLabel() (+11 more)

### Community 191 - "Community 191"
Cohesion: 0.13
Nodes (16): HostelMap(), Marker, PlaceMarker, hostelCoordinates(), groupNearbyPlaces(), humanizeNearbyType(), NEARBY_GLYPHS, NEARBY_GROUPS (+8 more)
...
Cohesion: 0.13
Nodes (17): acceptResidencyInvite(), AccountRow, askingAccount(), declineResidencyInvite(), findResidencyInvite(), LIVE, OPEN_INVOICES, ResidencyInviteError (+9 more)
...
Cohesion: 0.23
Nodes (18): GET(), resolvePastedLink(), searchCandidates(), lookupLocation(), resolvePastedLink(), searchCandidates(), queryVariants(), reverseGeocode() (+10 more)
...
Cohesion: 0.12
Nodes (14): deviceTokenSchema, pushTicketSchema, authHeaders(), chunk(), ExpoReceipt, fetchReceipts(), isConfigurationFailure(), ReceiptSweepResult (+6 more)

### Community 207 - "Community 207"
Cohesion: 0.1
Nodes (13): accountId, adminId, calls, compact, guardian, linkAt, NO_CLEARANCE, publicId (+5 more)
...
Cohesion: 0.11
Nodes (21): [0.5.2] - 2026-07-23 — Cook credential hand-off + dashboard visibility, [0.8.0] - 2026-08-01 — Phase 5: Growth, Maintenance & Polish, Added, Added, Added, Changed, Changed, Changed (+13 more)
...
Cohesion: 0.13
Nodes (15): AuthSession, getResidentProfile(), submitResidentReview(), triggerSOS(), AppNavigator(), RootStackParamList, Stack, ResidentFoodScreen() (+7 more)
...
Cohesion: 0.15
Nodes (15): robots(), IssuedInvoice, OpenedCheckout, SettledReceipt, documentUrl(), InvoiceLean, PaymentLean, PlatformInvoiceRow (+7 more)
...
Cohesion: 0.15
Nodes (16): appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind, creditOverpayment(), getCreditAmount(), getCreditBalance(), isDuplicateKey() (+8 more)
...
Cohesion: 0.16
Nodes (15): key(), ListingHostel, ListingProjection, projectSchedule(), projectScheduleOntoListing(), RoomConfiguration, hostel, result (+7 more)
...
Cohesion: 0.16
Nodes (13): downloadCaption(), cancelDownload(), canRetryDownload(), DownloadHandle, DownloadItem, downloadRate(), DownloadStatus, DownloadStore (+5 more)
...
Cohesion: 0.15
Nodes (11): DeviceRow, endpoints, mocks, payload, urls, CATEGORY_PATHS, NOTIFICATION_LIST, readId() (+3 more)
...
Cohesion: 0.15
Nodes (12): activateResident(), login(), register(), verifyOtp(), LoginScreen(), Props, OtpVerificationScreen(), Props (+4 more)
...
Cohesion: 0.17
Nodes (14): 10. Troubleshooting, 11. Location Tracking Defaults, 1. Prerequisites, 3. Secrets Handling, 4. Local Setup, 5. Commands, 5. Development Commands, 8. Monitoring & Logging (+6 more)
...
Cohesion: 0.26
Nodes (11): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, canAccessWorkspace(), defaultWorkspaceSlug(), isAuthBypassed(), listWorkspaceHostels(), previewHostels(), WorkspaceHostel (+3 more)
...
Cohesion: 0.15
Nodes (13): BANK_CSV_PARSER, BANK, both, empty, ESEWA, [first], ids, KHALTI (+5 more)
...
Cohesion: 0.15
Nodes (14): 0.1 The shared Softmato domain, 0.2 Categories — which mailbox a message comes from, 0.2a Where replies go, 0.3 Where the sender is configured, 0.4 Template structure, 0. Sending Infrastructure, 1.2 Hostel Admin Credentials (Post-Approval), code:block1 (softmato.com) (+6 more)

### Community 292 - "Community 292"
Cohesion: 0.19
Nodes (14): 1.0 Signup One-Time Code, 1.1 Email Verification (PUBLIC Signup), 1.3 Warden Credentials, 1.4 Resident QR Activation, 1.6 Password Reset, 1.7 Account Upgraded, 1. Authentication & Account Emails, code:typescript ({) (+6 more)

### Community 293 - "Community 293"
Cohesion: 0.16
Nodes (14): 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, 4.2 Complaint Status Updated, 4.3 Complaint Resolved, code:typescript ({) (+6 more)
...
Cohesion: 0.22
Nodes (11): formatBytes(), AttachedFile(), FileUploaderPresentation, FileUploaderProps, FileUploaderView(), previewSrc(), TONE_CLASSES, UploaderTone (+3 more)
...
Cohesion: 0.26
Nodes (11): canBuyerCancelStoreOrder(), canTransitionStoreOrder(), isTerminalStoreOrderStatus(), nextStoreOrderStatuses(), OPEN_STORE_ORDER_STATUSES, STORE_ORDER_STATUS_LABEL, STORE_ORDER_STATUSES, StoreOrderStatus (+3 more)
...
Cohesion: 0.18
Nodes (12): 1.5 Guardian Invitation, 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.3 Hostel Rejected, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, 3.3 Payment Proof Uploaded (to Admin), code:typescript ({) (+4 more)
...
Cohesion: 0.29
Nodes (8): addDays(), nepalDateOf(), nepalWallClockToUtc(), nextOccurrence(), PushRepeat, PushTiming, timing, weekdayOf()
...
Cohesion: 0.22
Nodes (7): ExpertConsultationCreateInput, ExpertConsultationError, ExpertConsultationRequestRecord, notifyTeamOfRequest(), expertConsultationCreateSchema, expertConsultationRequestSchema, getSiteConfigSection()
...
Cohesion: 0.25
Nodes (8): HostelPhotoReminder(), FALLBACK_ORDER, hasNoHostelPhotos(), HostelPhoto, HostelPhotoKind, photosOfKind(), resolveHostelPhotos(), resolveHostelPhotoUrls()
...
Cohesion: 0.2
Nodes (9): FeeScheduleCloseInput, feeScheduleCloseSchema, FeeScheduleCreateInput, feeScheduleCreateSchema, feeScheduleListQuerySchema, objectIdSchema, periodSchema, rateSchema (+1 more)
...
Cohesion: 0.27
Nodes (10): 4. Commands, Backend Tests, code:bash (npm run web:test), code:bash (npm --prefix apps/web run test:watch), code:bash (npm --prefix apps/web run test -- attendance-zone), code:bash (npm run web:lint), Frontend/Web Tests, Not yet wired up (+2 more)
...
Cohesion: 0.25
Nodes (8): [0.6.0] - 2026-08-01 — Phases 1-3 closed out, Changed, Changed, Fixed, Fixed, Fixed, Removed, Removed
...
Cohesion: 0.43
Nodes (6): clearRegistrationDraft(), DraftKind, keyFor(), readRegistrationDraft(), RegistrationDrafts, saveRegistrationDraft()
...
Cohesion: 0.29
Nodes (7): 7.3 Privacy/Guardian Permissions Test Template, 9.1 Seed Scripts, 9.2 Test Database Isolation, 9. Test Data & Seeding, code:typescript (describe('GET /api/v1/hostel/rooms - role access', () => {), code:typescript (describe('GET /api/v1/guardian/linked-resident - privacy', (), code:bash (npm run web:build)
...
Cohesion: 0.4
Nodes (4): HOSTEL_SUBSCRIPTION_STATUSES, hostelSubscriptionSchema, nullableCount, nullableWholeRupees
...
## Knowledge Gaps
- **5797 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+5792 more)
...
- **Why does `Button()` connect `Community 2` to `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 141`, `Community 17`, `Community 19`, `Community 22`, `Community 25`, `Community 31`, `Community 32`, `Community 163`, `Community 36`, `Community 38`, `Community 42`, `Community 182`, `Community 54`, `Community 61`, `Community 64`, `Community 118`, `Community 248`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 79` to `Community 0`, `Community 130`, `Community 3`, `Community 5`, `Community 6`, `Community 139`, `Community 12`, `Community 13`, `Community 142`, `Community 17`, `Community 18`, `Community 147`, `Community 22`, `Community 26`, `Community 28`, `Community 29`, `Community 31`, `Community 416`, `Community 37`, `Community 166`, `Community 40`, `Community 41`, `Community 300`, `Community 47`, `Community 179`, `Community 51`, `Community 53`, `Community 52`, `Community 183`, `Community 441`, `Community 58`, `Community 60`, `Community 63`, `Community 193`, `Community 201`, `Community 205`, `Community 341`, `Community 85`, `Community 88`, `Community 90`, `Community 91`, `Community 108`, `Community 121`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `Role` connect `Community 14` to `Community 0`, `Community 1`, `Community 4`, `Community 133`, `Community 391`, `Community 392`, `Community 11`, `Community 13`, `Community 15`, `Community 16`, `Community 20`, `Community 21`, `Community 279`, `Community 24`, `Community 283`, `Community 27`, `Community 413`, `Community 285`, `Community 35`, `Community 37`, `Community 39`, `Community 40`, `Community 298`, `Community 299`, `Community 171`, `Community 172`, `Community 43`, `Community 49`, `Community 51`, `Community 436`, `Community 437`, `Community 55`, `Community 57`, `Community 60`, `Community 194`, `Community 195`, `Community 323`, `Community 77`, `Community 207`, `Community 83`, `Community 86`, `Community 344`, `Community 345`, `Community 92`, `Community 93`, `Community 104`, `Community 366`, `Community 239`, `Community 242`, `Community 243`, `Community 251`, `Community 252`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Are the 448 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 448 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `iosUrlScheme`, `{ defineConfig }`, `expoConfig` to the rest of the system?**
  _5797 weakly-connected nodes found - possible documentation gaps or missing edges._
