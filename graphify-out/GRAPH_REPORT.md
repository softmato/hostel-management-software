# Graph Report - hostel-management-software  (2026-09-05)

## Corpus Check
- 1695 files · ~2,889,073 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 13637 nodes · 37594 edges · 468 communities (448 shown, 20 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 561 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 561 edges
2. `successResponse()` - 549 edges
3. `connectToDatabase()` - 374 edges
4. `useAppTheme()` - 340 edges
5. `cn()` - 244 edges
6. `connectToDatabase()` - 224 edges
7. `useResource()` - 187 edges
8. `unwrap()` - 186 edges
9. `Text()` - 168 edges
10. `requireHostelCapability()` - 166 edges
...
## Communities (468 total, 20 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (256): PATCH(), POST(), RouteContext, GET(), GET(), POST(), PATCH(), POST() (+248 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (228): AdminCommunityScreen(), Scanner(), GuardianInviteScreen(), MapScreen(), Assurance(), PlanCard(), CallableRow(), IdentityCard() (+220 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (235): POST(), POST(), GET(), sendEmail(), getOpenFeeSchedule(), GET(), POST(), getFoodRoutinesByHostelId() (+227 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (238): AttendanceScreen(), DayRow(), BootGate(), ReviewForm(), ReviewScreen(), DeletionPanel(), NotificationSettings(), SETTINGS_TITLES (+230 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (145): ICONS, LABELS, Segment, TONES, FILTERS, Pending, Overview, MANAGE_ROWS (+137 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (148): csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, HostelTable(), Inquiry, LoadState (+140 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (200): VoiceNotePlayer(), RoundButton(), VOICE_NOTE_RECORDING, VoiceNote, VoiceNoteRecorder(), ActivationIssue, addEmergencyContact(), addHostelPhoto() (+192 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (179): ProfileScreen(), ReferralRow(), CheckoutStatusScreen(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), InvoiceDetailScreen() (+171 more)
...
Cohesion: 0.02
Nodes (137): Filter, ModeratedPost, ModerationPayload, ConfirmOptions, Notification, LedgerMonth, LedgerPayment, ResidentLedger (+129 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (121): listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), GET(), POST(), querySchema, RouteContext (+113 more)
...
Cohesion: 0.02
Nodes (117): AdminCommunityReportsScreen(), AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen() (+109 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (123): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, dayKey(), overrideAttendance(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply() (+115 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (126): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), loadOverview(), AdminTabs(), HIDDEN, TABS, AdminMoneyScreen() (+118 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (115): POST(), RouteContext, DELETE(), GET(), hostelId(), GET(), POST(), DELETE() (+107 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (92): adminPrincipal, mocks, PLATFORM_LIMITS, AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, mocks (+84 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (98): HostelAdminCommunityPageContent, HostelAdminComplaintsPage, HostelAdminFeePlansPageContent, HostelAdminInquiriesPageContent, HostelAdminMaintenancePageContent, PRIORITIES, STATUS_ACTIONS, HostelAdminMoveChecklistPage (+90 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (94): FILTERS, NotificationCard(), NotificationRow(), TILE_GLYPH, TILE_TONES, CommunityScreen(), Composer(), CommunityBoard() (+86 more)
...
Cohesion: 0.05
Nodes (102): deleteResidentLocationHistory(), getResidentAttendance(), demoteToPublicAccount(), confirmComplaintResolution(), listResidentComplaints(), getResidentFinanceView(), listFoodForResident(), listPublicFoodRoutine() (+94 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (76): EMPTY_SUMMARY, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine, formatWeekRange() (+68 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (66): FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, monthStartPeriod(), Rate, RoomTypeOption, gregorianSpan(), MonthField (+58 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (79): cookPrincipal, mocks, announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError, FoodPhotoUploadInput (+71 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (66): CATEGORY_LABELS, NEARBY_GROUPS, PublicReview, PublicReviewData, RoomCard, ROUTINE_DAYS, ROUTINE_MEALS, maybePromptForResidentProfile() (+58 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (60): metadata, AccountDeletionPanel, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails() (+52 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (53): GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, hasFood() (+45 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (71): InvoiceHeaderBlock(), LedgerCard(), CopyButton(), methodIcon(), methodLabel(), methodProvider(), PayInvoiceScreen(), PROVIDER_LABEL (+63 more)

### Community 28 - "Community 28"
Cohesion: 0.1
Nodes (53): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), guardianInvitationEmail(), sosAlertEmail() (+45 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (78): SORTS, StoreCategoryScreen(), BadgeTone, addToCart(), cancelStoreOrder(), Cart, CartLine, CartResult (+70 more)
...
Cohesion: 0.04
Nodes (74): statementImportSchema, BANK_CSV_PARSER, CsvTable, gridFromCsv(), peekHeaders(), readCsv(), stripBom(), stripPreamble() (+66 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (68): POST(), RouteContext, listTrendingTags(), DELETE(), POST(), PaginationMeta, paginationQuerySchema, paginationRange() (+60 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (73): getHostelLedger(), collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES (+65 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (69): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult (+61 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (72): aswin, bhadra, bs(), card(), currentId, hostelId, inAswin, inOctober (+64 more)
...
Cohesion: 0.04
Nodes (50): ComparePage(), hostels, metadata, rows, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminRoomsPageContent(), PlatformDashboardPageContent() (+42 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (57): CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing, CurrentUser (+49 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (59): POST(), acceptGuardianInvitation(), daysFromNow(), enabledPermissionLabels(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags (+51 more)

### Community 40 - "Community 40"
Cohesion: 0.06
Nodes (54): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), prepare(), systemDocumentKind(), distance (+46 more)

### Community 41 - "Community 41"
Cohesion: 0.06
Nodes (54): CSV_COLUMNS, GET(), POST(), safeEqual(), GET(), periodTotals(), csvCell(), csvFilename() (+46 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (52): GatewayHealth, GatewayHealthSummary, IntentCounts, plural(), recordHealth(), runGatewayHealth(), runGatewayHealthForHostel(), SEVERITY (+44 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (66): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsPeriodBounds(), bsPeriodOf() (+58 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (57): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, GATEWAY_ORDER, getPayInstructions() (+49 more)
...
Cohesion: 0.05
Nodes (50): GET(), POST(), GET(), POST(), getMyExpertConsultationRequest(), GET(), POST(), cookPortalUpdateSchema (+42 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (42): auditLogSchema, incidentLogSchema, manualStatusOverrideSchema, nightStatusSchema, nightStatusLogSchema, ratingReviewSchema, residentSchema, reviewModerationLogSchema (+34 more)
...
Cohesion: 0.06
Nodes (52): Choice, MapButton(), ModeTab(), NOTHING_CHOSEN, ResultRow(), RouteCard(), buildShell(), MapExplorer (+44 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (41): currency(), EmptyState(), Input(), LoadingRows(), StatusBadge(), TextArea(), field(), ListingFlag (+33 more)
...
Cohesion: 0.06
Nodes (47): AttachmentGallery(), DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS, MealCard(), MonthEndSpecial(), RoutineMeal (+39 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (28): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminFoodPage(), HostelAdminResidentsPage(), redirectToWorkspaceScreen(), HostelAdminMaintenancePageContent(), HostelAdminReferralsPageContent() (+20 more)

### Community 56 - "Community 56"
Cohesion: 0.06
Nodes (41): outstandingForResident(), CapacityError, claimBedForRoomType(), listAllRoomTypes(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary() (+33 more)
...
Cohesion: 0.08
Nodes (33): POST(), POST(), getCurrentUser(), POST(), POST(), runBillingCycleForAllHostels(), POST(), POST() (+25 more)
...
Cohesion: 0.05
Nodes (41): accountDeletionRequestSchema, attendanceLogSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, consentLogSchema, sessionSchema, AccountDeletionError (+33 more)
...
Cohesion: 0.05
Nodes (44): amber, amount, assetId, checks, events, evidence, hostelId, invoice (+36 more)
...
Cohesion: 0.07
Nodes (48): renderIdCardPng(), getPresignedReadUrl(), hostelPageViewSchema, userResidentProfileSchema, LEGACY_ROLE_MAP, Role, ROLE_VALUES, CARD_LABELS (+40 more)

### Community 67 - "Community 67"
Cohesion: 0.07
Nodes (49): arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal, alreadyReviewedError() (+41 more)
...
Cohesion: 0.05
Nodes (46): REALTIME_TOPIC_VALUES, seedCommunityPost(), CachedQuery, clearQueryCache(), defined, entries, Entry, inflight (+38 more)

### Community 70 - "Community 70"
Cohesion: 0.06
Nodes (38): summarizeResidentComplaints(), listResidentInvoices(), renderStatementForResident(), getResidentLedger(), monthsBetween(), periodOf(), ResidentDoc, ResidentLedger (+30 more)

### Community 71 - "Community 71"
Cohesion: 0.08
Nodes (22): PlatformConfigAnnouncementsPageContent, PlatformConfigContentPageContent, PlatformConfigFacilitiesPageContent, FLAGS, PlatformConfigFeaturesPageContent, PlatformConfigLegalPageContent, PlatformConfigLocationsPageContent, PlatformConfigPricingPageContent (+14 more)

### Community 72 - "Community 72"
Cohesion: 0.05
Nodes (25): field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), LoadState, NightStatusRow, Notification (+17 more)
...
Cohesion: 0.07
Nodes (39): ComplaintDetail(), ComplaintCard(), CategoryTile(), NewComplaintScreen(), PickedAttachment, SwapButton(), CapturedPhoto, PhotoCapture() (+31 more)
...
Cohesion: 0.1
Nodes (33): PreviewCard(), FACILITY_ICONS, facilityIcon(), facilityKey(), HostelCard(), SaveButton(), HostelShowcase(), HostelShowcaseProps (+25 more)
...
Cohesion: 0.08
Nodes (38): serviceProviderApplicationSchema, serviceProviderDocumentSchema, notifyPlatformOfServiceProviderApplication(), ACTIVE_APPLICATION_STATUSES, approveServiceProvider(), auditProviderAction(), findOwnProvider(), findProviderOrThrow() (+30 more)

### Community 84 - "Community 84"
Cohesion: 0.07
Nodes (33): CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS, CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, MOCK_HOSTELS (+25 more)

### Community 85 - "Community 85"
Cohesion: 0.05
Nodes (27): AuthGuard(), cityOptions, createDocument(), createRoom(), DocumentConfig, DraftData, FACILITY_MINI, facilityOptions (+19 more)
...
Cohesion: 0.1
Nodes (37): hostelForm(), buildHostelPayload(), capacitySummary(), CITY_OPTIONS, emptyHostelForm(), emptyRoomRow(), FACILITY_OPTIONS, firstIncompleteHostelStep() (+29 more)

### Community 88 - "Community 88"
Cohesion: 0.07
Nodes (32): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+24 more)
...
Cohesion: 0.06
Nodes (34): CONTENT_ICON_SLUGS, everything, IDENTITY, page, rendered, coerceSection(), getSiteConfig(), PlatformSettingRecord (+26 more)
...
Cohesion: 0.08
Nodes (22): Claim, CouldNotCreateFileException, HostelHubDownloadsModule, NoContextException, NothingOpensThisException, UnreadableSourceException, UnsupportedOnThisAndroidException, chain (+14 more)
...
Cohesion: 0.07
Nodes (20): dashboardHrefForRole(), hasDashboard(), PublicHeader(), CATEGORIES, isApplicationOpen(), LandingStep(), MeResponse, OwnApplication (+12 more)
...
Cohesion: 0.11
Nodes (29): ApiFailure, apiRequest(), ApiSuccess, AuthUser, confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listResidentComplaints() (+21 more)
...
Cohesion: 0.07
Nodes (21): LegacyHostelAdminComplaintsPage(), Complaint, ComplaintSummary, field(), FoodMenu, HostelAdminComplaintsPage(), HostelAdminNoticesPage(), HostelAdminPaymentsPage() (+13 more)

### Community 108 - "Community 108"
Cohesion: 0.09
Nodes (22): noticeSchema, noticeReadStatusSchema, mocks, noticeInput, residentUserId, staffPrincipal, auditNoticeAction(), broadcastNotice() (+14 more)
...
Cohesion: 0.11
Nodes (22): averageRating(), cityCount(), group(), HomeStat, homeStats(), rated, stats, vacantBeds() (+14 more)
...
Cohesion: 0.09
Nodes (24): listResidentClaims(), approveClaim(), assertNotAlreadyRecordedFromStatement(), bulkApproveClaims(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck() (+16 more)
...
Cohesion: 0.11
Nodes (23): GET(), POST(), findResidentOwnedAccess(), revokeGuardianAccess(), updateGuardianPermissions(), DELETE(), activeSuperadminCount(), createPlatformAdmin() (+15 more)

### Community 118 - "Community 118"
Cohesion: 0.1
Nodes (26): findOrphanClaims(), loadMatchContext(), ApprovedNotInStatementRow, approveMatchedRows(), approverNamesFor(), assignOrphanCredit(), ClaimedNoTransactionRow, getReconciliation() (+18 more)
...
Cohesion: 0.11
Nodes (22): palette, native, NativeDownloads, openDownloaded(), SavedDownload, KNOWN_PATHS, marksRoleChange(), resolvePushPath() (+14 more)

### Community 122 - "Community 122"
Cohesion: 0.14
Nodes (22): ReportedPostCard(), AssetViewer(), useViewerState(), ViewerPage(), AdminModeratedPost, clampIndex(), closeAssetViewer(), emit() (+14 more)
...
Cohesion: 0.1
Nodes (22): PRODUCTION_RECOMMENDED, PRODUCTION_REQUIRED, ServerEnv, serverEnvSchema, serverEnvWarnings(), PRODUCTION_MINIMUM, pusher, snapshot (+14 more)

### Community 125 - "Community 125"
Cohesion: 0.13
Nodes (21): HostelSuggestions(), PublicHostel, TalkToExpertButton(), MyExpertConsultationRequest, useMyExpertConsultationRequest(), BudgetRange, budgetScore(), HostelMatch (+13 more)
...
Cohesion: 0.12
Nodes (22): uploadPublicFile(), FILE_ASSET_KINDS, FileAssetKind, FINANCIAL_KINDS, ApiEnvelope, parseEnvelope(), sendUpload(), sendWithProgress() (+14 more)
...
Cohesion: 0.1
Nodes (17): AddressFields, FORM_SECTIONS, HostelAdminProfilePageContent, PendingPhoto, PHOTO_LIMITS, SectionDef, SectionId, SECTIONS (+9 more)
...
Cohesion: 0.13
Nodes (19): Offset, PhotoCropper(), TradeDetailsStep(), isActive(), formatBytes(), UploadKind, AttachedFile(), FileUploader() (+11 more)
...
Cohesion: 0.14
Nodes (14): HostelMap(), Marker, PlaceMarker, groupNearbyPlaces(), humanizeNearbyType(), NEARBY_GLYPHS, NEARBY_GROUPS, NEARBY_ICONS (+6 more)
...
Cohesion: 0.18
Nodes (16): ProviderJobScreen(), ProviderJob, CATEGORY_ICONS, completedJobCount(), isOpenJob(), jobActions(), jobAddress(), jobCategoryIcon() (+8 more)

### Community 180 - "Community 180"
Cohesion: 0.13
Nodes (15): AdminNightStatusRow, filterRollCall(), NightStatusValue, OVERRIDE_OPTIONS, ROLL_CALL_SEGMENTS, rollCallCounts(), RollCallSegment, rollCallTone() (+7 more)
...
Cohesion: 0.15
Nodes (14): getResidentProfile(), submitResidentReview(), triggerSOS(), RootStackParamList, Props, Profile, Props, ResidentProfileScreen() (+6 more)
...
Cohesion: 0.12
Nodes (15): draftFromProfile(), emptyIdentityDraft(), hasIdentityErrors(), idCardNoun(), IdentityDraft, card, draft, errors (+7 more)
...
Cohesion: 0.14
Nodes (16): ProviderDirectoryData, DirectoryPageProps, EMPTY, metadata, ServiceProviderDirectoryPage(), ServiceProvidersPage(), getPublicServiceProviderStats(), listPublicServiceProviders() (+8 more)
...
Cohesion: 0.13
Nodes (14): BLOOD_GROUPS, clearIdentityPhoto(), DIETARY_PREFERENCES, GENDERS, getIdentity(), getIdentityQr(), GOVERNMENT_ID_TYPES, GovernmentIdType (+6 more)
...
Cohesion: 0.16
Nodes (14): 3.1 Payment Due Reminder, 3.3 Payment Proof Uploaded (to Admin), 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, 4.2 Complaint Status Updated, 4.3 Complaint Resolved, 4. Resident Activity Emails (+6 more)
...
Cohesion: 0.18
Nodes (12): buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, IdentityErrors, OCCUPATION_LABELS, phoneError() (+4 more)
...
Cohesion: 0.2
Nodes (11): 1.7 Account Upgraded, 2.1 Hostel Submission Received, 2.3 Hostel Rejected, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, 3.2 Payment Overdue, code:typescript ({), code:typescript ({) (+3 more)
...
Cohesion: 0.25
Nodes (7): HostelRegisterPayload, ProviderRegisterPayload, HostelApplicationStatus, listOwnHostelApplications(), OwnHostelApplication, registerHostelApplication(), registerServiceProvider()
...
Cohesion: 0.29
Nodes (6): calendarRoot, config, { getDefaultConfig }, netinfoShim, path, { withNativeWind }
...
Cohesion: 0.33
Nodes (6): 4.1 New Notice Posted, 5.1 SOS Triggered, 5. Safety & Emergency Emails, code:typescript ({), code:typescript ({), code:typescript ({)
...
## Knowledge Gaps
- **4852 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+4847 more)
...
- **Why does `Button()` connect `Community 4` to `Community 1`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 136`, `Community 9`, `Community 11`, `Community 12`, `Community 14`, `Community 21`, `Community 22`, `Community 24`, `Community 25`, `Community 27`, `Community 29`, `Community 51`, `Community 54`, `Community 61`, `Community 75`, `Community 81`, `Community 87`, `Community 216`, `Community 122`?**
  _High betweenness centrality (0.089) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 9` to `Community 3`, `Community 4`, `Community 5`, `Community 133`, `Community 11`, `Community 19`, `Community 21`, `Community 22`, `Community 24`, `Community 25`, `Community 26`, `Community 162`, `Community 37`, `Community 38`, `Community 45`, `Community 52`, `Community 71`, `Community 77`, `Community 78`, `Community 84`, `Community 85`, `Community 101`, `Community 102`, `Community 107`, `Community 242`, `Community 125`, `Community 126`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 43` to `Community 0`, `Community 1`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 11`, `Community 17`, `Community 22`, `Community 151`, `Community 24`, `Community 153`, `Community 23`, `Community 28`, `Community 30`, `Community 160`, `Community 33`, `Community 162`, `Community 44`, `Community 49`, `Community 50`, `Community 58`, `Community 326`, `Community 85`, `Community 86`, `Community 87`, `Community 344`, `Community 232`, `Community 125`, `Community 126`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Are the 369 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 369 INFERRED edges - model-reasoned connections that need verification._
