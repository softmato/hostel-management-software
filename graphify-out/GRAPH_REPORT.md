...
## Corpus Check
- 1373 files · ~2,197,837 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10825 nodes · 28125 edges · 440 communities (417 shown, 23 thin omitted)
...
## Communities (440 total, 23 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (171): PATCH(), POST(), RouteContext, GET(), GET(), POST(), PATCH(), POST() (+163 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (225): POST(), GET(), GET(), getFoodRoutinesByHostelId(), addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery (+217 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (145): DeletionPathway, DeletionStatus, PATHWAY_COPY, Filter, ModeratedPost, ModerationPayload, deferLoad(), HostelTable() (+137 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (141): Scanner(), GuardianInviteScreen(), ContactRow(), GuardianLoginScreen(), NewComplaintScreen(), DiscoveryHeader(), BUDGET_BANDS, FilterSheet() (+133 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (151): deleteResidentLocationHistory(), getResidentAttendance(), listAttendanceAlerts(), addComplaintUpdate(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory (+143 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (114): CommunityModerationPanel(), field(), GuardianPermissions, LoadState, Message(), NightStatusRow, Notification, optionalNumber() (+106 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (102): ConfirmOptions, MonthPicker, PeriodRow, humanizeValue(), ImportedProfileSummary(), ResidentPrefill, ResidentStatus, STATUS_ACTIONS (+94 more)
...
Cohesion: 0.03
Nodes (103): AdminAlertsScreen(), AdminOverviewScreen(), loadOverview(), PORTAL_ROWS, accentForAccount(), AccountShape, HomeRoute, readableRole() (+95 more)

### Community 9 - "Community 9"
Cohesion: 0.09
Nodes (65): ICONS, LABELS, TONES, Overview, CallableRow(), IdentityCard(), PeopleSection(), Person (+57 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (104): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags() (+96 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (83): AttachmentGallery(), CookTodayScreen(), CookMenuScreen(), MenuData, CookPhotosScreen(), PhotoDayCard(), PhotoFeed, announcedCount() (+75 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (71): adminPrincipal, mocks, PLATFORM_LIMITS, mocks, readable, selectable, mocks, proofBody (+63 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (65): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), useConfirm(), AcceptResult, GuardianInvitePageContent, KINDS (+57 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (63): HostelAdminMoveChecklistPage, MoveEvent, Ledger, OrphanAssignPicker, MatrixRow, MatrixTotals, PeriodSummary, ClaimFacts() (+55 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (63): ENDPOINTS, esewaProvider, SIGNED_FIELDS, attempt, fetchMock, forged, live, payload (+55 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (72): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply() (+64 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (77): NightStatusForm(), NotificationCard(), ProfileScreen(), ReferralBody(), ReferralRow(), CheckoutStatusScreen(), MEAL_ICONS, mealIcon() (+69 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (75): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, GATEWAY_ORDER, getPayInstructions() (+67 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (56): POST(), RouteContext, PaginationMeta, paginationQuerySchema, querySchema, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex() (+48 more)
...
Cohesion: 0.04
Nodes (54): TABS, SosScreen(), TABS, BottomChrome, BottomChromeContext, BottomChromeProvider(), CHROME_TIMING, useBottomChrome() (+46 more)
...
Cohesion: 0.04
Nodes (64): AuthGuard(), CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing (+56 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (60): SubmitClaimScreen(), InvoiceDetailScreen(), LedgerCard(), methodIcon(), methodLabel(), PayInvoiceScreen(), PROVIDER_LABEL, QrPanel() (+52 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (66): DiscoveryHeaderProps, IconButton(), IdCardFace(), IdCardPrompt(), Point(), BLOOD_OPTIONS, DIET_OPTIONS, EditIdentityScreen() (+58 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (66): RealtimeConfig, RealtimeContext, RealtimeContextValue, RealtimeNotification, RealtimeProvider(), dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine (+58 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (59): GET(), resolvePastedLink(), searchCandidates(), geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), hostelAdminGeocodeQuerySchema (+51 more)
...
Cohesion: 0.05
Nodes (59): AdminMoreScreen(), ActivateScreen(), BootGate(), RootShell(), SettingsScreen(), LoginScreen(), BrowseProfileScreen(), BrandSplash() (+51 more)

### Community 30 - "Community 30"
Cohesion: 0.06
Nodes (44): GenericPortalScreen(), portalRows(), portalTitle(), hasFood(), LoadState, PublicHostelListingPageContent(), PublicInquiryPage(), PublicInquiryPageContent() (+36 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (52): summarizeResidentComplaints(), accessId, adminPrincipal, codes, guardianId, guardianPrincipal, issue(), leanResult() (+44 more)
...
Cohesion: 0.07
Nodes (56): CommunityScreen(), Composer(), CommunityBoard(), CommunityBoardProps, Composer(), CommentThread(), CommunityPostCard(), MediaGrid() (+48 more)
...
Cohesion: 0.05
Nodes (47): collectionTotals(), invoicesByIds(), platformRollup(), getHostelViewStats(), complaintSchema, foodFeedbackSchema, inquirySchema, listingFlagSchema (+39 more)
...
Cohesion: 0.05
Nodes (48): GET(), POST(), GET(), POST(), POST(), createExpertConsultationRequest(), getMyExpertConsultationRequest(), GET() (+40 more)

### Community 39 - "Community 39"
Cohesion: 0.06
Nodes (43): HostelSuggestions(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, formatHostelAddress(), hostelTypeToUi(), mapPublicHostelToSummary() (+35 more)

### Community 40 - "Community 40"
Cohesion: 0.06
Nodes (48): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput, ConsentInput (+40 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (48): Hostel, EMPTY_SUMMARY, HostelAdminComplaintsPage, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS (+40 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (41): CancelDeletionPageContent(), csvField(), DemoDataBadge(), field(), numberField(), optionalField(), RoomMapFloor, AddressFields (+33 more)

### Community 43 - "Community 43"
Cohesion: 0.06
Nodes (40): listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), PATCH(), RouteContext, requirePlatformPrincipal(), reviewModerationLogSchema (+32 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (37): fadeUp, Feature, features, heroSlides, PublicHostelRegistrationLandingPage(), stagger, stats, cityOptions (+29 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (34): metadata, AccountDeletionPanel, LegalBody(), buildValues(), PublicAboutPage(), values, buildPosts(), posts (+26 more)
...
Cohesion: 0.06
Nodes (43): cookPrincipal, mocks, announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError, FoodPhotoUploadInput (+35 more)

### Community 50 - "Community 50"
Cohesion: 0.07
Nodes (41): UploadCard(), useIsUploading(), EMPTY_TALLY, floorToStep(), phaseOf(), shouldRepost(), tallyUploads(), active (+33 more)
...
Cohesion: 0.07
Nodes (41): GET(), POST(), POST(), RouteContext, requireSuperadminPrincipal(), resetEmailIdentityCache(), sponsorSchema, GET() (+33 more)

### Community 53 - "Community 53"
Cohesion: 0.08
Nodes (42): POST(), getFoodRoutine(), saveFoodRoutine(), serializeRoutine(), addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange() (+34 more)

### Community 54 - "Community 54"
Cohesion: 0.07
Nodes (39): FILTERS, NotificationsScreen(), DeletionPanel(), NotificationSettings(), THEME_OPTIONS, DeletionRequest, DeletionStatus, getDeletionStatus() (+31 more)

### Community 55 - "Community 55"
Cohesion: 0.07
Nodes (45): arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal, alreadyReviewedError() (+37 more)
...
Cohesion: 0.05
Nodes (25): field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminMoveChecklistPage(), LoadState, NightStatusRow, Notification, NotificationsPageContent() (+17 more)

### Community 60 - "Community 60"
Cohesion: 0.07
Nodes (41): Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity(), fromHeaderFor() (+33 more)
...
Cohesion: 0.07
Nodes (38): Offset, PhotoCropper(), uploadPublicFile(), FILE_ASSET_KINDS, FileAssetKind, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind() (+30 more)

### Community 63 - "Community 63"
Cohesion: 0.06
Nodes (36): POST(), acceptGuardianInvitation(), daysFromNow(), enabledPermissionLabels(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags (+28 more)

### Community 64 - "Community 64"
Cohesion: 0.06
Nodes (29): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, auditLogSchema, noticeReadStatusSchema, mocks, noticeInput (+21 more)
...
Cohesion: 0.07
Nodes (37): countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor(), LedgerInvoiceRow, ledgerPipeline() (+29 more)

### Community 67 - "Community 67"
Cohesion: 0.06
Nodes (26): currency(), EmptyState(), LoadingRows(), ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent, Complaint (+18 more)

### Community 68 - "Community 68"
Cohesion: 0.08
Nodes (33): loadSiteConfig, loadSiteName(), platformSettingSchema, DEFAULT_SITE_CONFIG, coerceSection(), getPublicSiteConfig(), getSiteConfig(), getSiteConfigSection() (+25 more)

### Community 69 - "Community 69"
Cohesion: 0.09
Nodes (31): ProviderJob, CATEGORY_ICONS, completedJobCount(), isOpenJob(), jobActions(), jobAddress(), jobCategoryIcon(), OPEN_JOB_STATUSES (+23 more)
...
Cohesion: 0.09
Nodes (30): CSV_COLUMNS, GET(), POST(), safeEqual(), GET(), csvCell(), csvFilename(), csvResponse() (+22 more)

### Community 72 - "Community 72"
Cohesion: 0.06
Nodes (33): InvoiceMatrix, InvoiceMatrixRow, PortalInvoice, ResidentFinanceView, ResidentInvoiceLine, ResidentInvoiceReceipt, ResidentPortalInvoice, ResidentRow (+25 more)
...
Cohesion: 0.1
Nodes (30): AdminResidentsScreen(), NightStatusScreen(), ReferralsScreen(), ComplaintDetailScreen(), GuardianHomeScreen(), GuardianMetrics(), GuardianMoreScreen(), GuardianPaymentsScreen() (+22 more)

### Community 75 - "Community 75"
Cohesion: 0.08
Nodes (32): serviceProviderApplicationSchema, serviceProviderDocumentSchema, notifyPlatformOfServiceProviderApplication(), ACTIVE_APPLICATION_STATUSES, approveServiceProvider(), auditProviderAction(), findProviderOrThrow(), getPlatformServiceProvider() (+24 more)
...
Cohesion: 0.08
Nodes (29): periodTotals(), assertHostelAccess(), canAccessHostel(), hostelScopedFilter(), TenantAccessError, TenantPrincipal, foodReadyLogSchema, DAYS (+21 more)
...
Cohesion: 0.1
Nodes (23): POST(), POST(), POST(), POST(), runBillingCycleForAllHostels(), POST(), runGatewayHealth(), runGatewayHealthForHostel() (+15 more)

### Community 81 - "Community 81"
Cohesion: 0.09
Nodes (30): referralCodeSchema, auditReferralAction(), confirmReferralJoined(), createReferredInquiry(), HostelAdminReferralListQuery, normalizeObjectIds(), referralCodeCandidate(), ReferralCodeRecord (+22 more)

### Community 82 - "Community 82"
Cohesion: 0.09
Nodes (29): DELETE(), POST(), notificationCampaignSchema, CampaignListQuery, CampaignRecord, createCampaign(), createHostelNotificationCampaign(), createPlatformNotificationCampaign() (+21 more)
...
Cohesion: 0.08
Nodes (22): PortalShell(), navItems, HOSTEL_ADMIN_NAV, HOSTEL_ADMIN_SEARCH_ENTRIES, hostelAdminHref(), PLATFORM_MODERATOR_NAV, PLATFORM_MODERATOR_SEARCH_ENTRIES, PLATFORM_NAV (+14 more)
...
Cohesion: 0.11
Nodes (29): userResidentProfileSchema, LEGACY_ROLE_MAP, Role, ROLE_VALUES, ageFromDateOfBirth(), cardPhotoImageUrl(), clearResidentIdentityPhoto(), generateResidentId() (+21 more)

### Community 89 - "Community 89"
Cohesion: 0.08
Nodes (26): attacker, attempt(), headers, jsonRequest(), routeMocks, hashOtpCode(), verifyOtpChallenge(), GoogleAuthInput (+18 more)
...
Cohesion: 0.08
Nodes (24): ComparePage(), hostels, metadata, rows, CurrentUser, DASHBOARD_ROLES, dashboardHrefForRole(), hasDashboard() (+16 more)
...
Cohesion: 0.08
Nodes (19): Input(), Select(), field(), HostelAdminReportsPageContent(), ListingFlag, LoadState, MaintenanceRequest, optionalField() (+11 more)
...
Cohesion: 0.15
Nodes (23): ImageVariantRecord, optimizeImage(), streamToBuffer(), VARIANT_CONFIG, VariantName, r2Configured(), storePublicAsset(), AccessLevel (+15 more)

### Community 98 - "Community 98"
Cohesion: 0.08
Nodes (18): bedSchema, depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, providedItemSchema, MoveChecklistServiceError, MoveInInput, MoveInRecord (+10 more)

### Community 99 - "Community 99"
Cohesion: 0.1
Nodes (24): appBaseUrl(), dispatchVerificationEmail(), requestPasswordReset(), resendVerificationEmail(), signupWithEmailVerification(), POST(), signPurposeToken(), POST() (+16 more)

### Community 100 - "Community 100"
Cohesion: 0.11
Nodes (24): authenticateWithGoogle(), CLAIMABLE_STATUSES, dispatchOtpChallenge(), findVerifiedRegistrationChallenge(), generateOtpCode(), GOOGLE_JWKS, normalizeEmail(), normalizeOtpIdentifier() (+16 more)
...
Cohesion: 0.29
Nodes (17): POST(), changePassword(), POST(), POST(), loginGuardian(), errorResponse(), accessTokenTtlSeconds(), parseDurationSeconds() (+9 more)
...
Cohesion: 0.11
Nodes (18): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), robots() (+10 more)
...
Cohesion: 0.1
Nodes (15): accountDeletionRequestSchema, attendanceLogSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, consentLogSchema, purgeAccount(), runAccountDeletionPurge() (+7 more)

### Community 124 - "Community 124"
Cohesion: 0.16
Nodes (24): AttendanceAlert, AttendanceLog, AuditLog, code:typescript ({), code:typescript ({), code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({) (+16 more)
...
Cohesion: 0.09
Nodes (18): emergencyContactSchema, BedRecord, EmergencyContactCreateInput, EmergencyContactRecord, GuardianCreateInput, GuardianRecord, ResidentAccountLink, ResidentCreateInput (+10 more)

### Community 133 - "Community 133"
Cohesion: 0.16
Nodes (22): issueSessionForUser(), login(), publicUser(), refreshAccessToken(), AuthTokenPayload, hashToken(), jwtSecret(), PurposeTokenPayload (+14 more)
...
Cohesion: 0.09
Nodes (16): hostelId, invoice, invoiceId, mocks, principal, qr, qrAssetId, residentId (+8 more)
...
Cohesion: 0.17
Nodes (21): demoteToPublicAccount(), assertActiveReferralCode(), findActiveReferralCode(), linkReferralOnRegistration(), auditResidentAction(), createResident(), definedUpdate(), deleteResident() (+13 more)
...
Cohesion: 0.14
Nodes (17): feeUpdateSchema, PATCH(), setResidentMonthlyFee(), POST(), GET(), generateMonthlyPayments(), getMonthlyPaymentMatrix(), resolveAdminHostelId() (+9 more)
...
Cohesion: 0.15
Nodes (14): confirmComplaintResolution(), createResidentComplaint(), ResidentComplaint, submitResidentReview(), triggerSOS(), RootStackParamList, LoginScreen(), Props (+6 more)
...
Cohesion: 0.12
Nodes (12): GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse, GoogleAuthUser, GoogleCredentialResponse, Window, AuthResponse, OtpRequestData (+4 more)
...
Cohesion: 0.18
Nodes (11): AuthServiceError, getCurrentUser(), resetPasswordWithToken(), revokeAllSessions(), verifyEmailWithToken(), getBearerToken(), verifyPurposeToken(), POST() (+3 more)
...
Cohesion: 0.15
Nodes (13): KHALTI_CSV_PARSER, bytes, [first], [, incoming], [outgoing, incoming], parse(), rows, CURRENT_PARSERS (+5 more)
...
Cohesion: 0.16
Nodes (8): AuthShell(), AuthShellProps, SiteWordmark(), ThemeToggle(), ThemeToggleProps, navItems, GUARDIAN_NAV, GUARDIAN_SEARCH_ENTRIES
...
Cohesion: 0.24
Nodes (10): POST(), RouteContext, ImageInsight, inspectImage(), isInspectableImage(), hashBytes(), normalizeMime(), UploadVerificationError (+2 more)
...
Cohesion: 0.16
Nodes (14): 3.1 Payment Due Reminder, 3.3 Payment Proof Uploaded (to Admin), 3.4 Payment Verified (to Resident), 3. Payment Emails, 4.1 New Notice Posted, 4.2 Complaint Status Updated, 4. Resident Activity Emails, 5.1 SOS Triggered (+6 more)
...
Cohesion: 0.18
Nodes (8): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, TXN_ID_ALIASES, WITHDRAWAL_ALIASES
...
Cohesion: 0.22
Nodes (10): apiRequest(), getActivationStatus(), listNotifications(), listResidentComplaints(), login(), markNotificationRead(), NotificationItem, refreshSession() (+2 more)
...
Cohesion: 0.39
Nodes (9): code:typescript ({), code:typescript (interface IQuestionCallClick {), code:typescript ({), Community Feature, CommunityComment, CommunityReaction, CommunityReport, QuestionCall Integration & Analytics (+1 more)
...
Cohesion: 0.39
Nodes (7): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, HostelPhotoReminder(), canAccessWorkspace(), workspaceHostelName(), hostelAdminNavForSlug(), searchEntriesFromNav()
...
Cohesion: 0.25
Nodes (8): 6. Production Deployment (Vercel), code:json ({ "level": "warn", "action": "public_asset_store_failed", "m), code:json ({), code:typescript (// app/api/cron/payment-reminders/route.ts), Deployment Steps, Post-Deployment Checks, Prerequisites, Steps
...
Cohesion: 0.33
Nodes (6): 4. Local Setup, 5. Commands, 8. Monitoring & Logging, code:json ({ "level": "warn", "action": "public_asset_store_failed", "m), code:bash (node --experimental-transform-types packages/db/src/migrate-), First-time setup
...
## Knowledge Gaps
- **3973 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+3968 more)
...
- **Why does `Button()` connect `Community 9` to `Community 2`, `Community 3`, `Community 6`, `Community 136`, `Community 41`, `Community 42`, `Community 11`, `Community 27`, `Community 13`, `Community 14`, `Community 144`, `Community 17`, `Community 21`, `Community 54`, `Community 24`, `Community 25`, `Community 91`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 6` to `Community 2`, `Community 5`, `Community 9`, `Community 13`, `Community 14`, `Community 144`, `Community 21`, `Community 23`, `Community 30`, `Community 32`, `Community 33`, `Community 34`, `Community 37`, `Community 39`, `Community 41`, `Community 44`, `Community 45`, `Community 315`, `Community 188`, `Community 59`, `Community 62`, `Community 70`, `Community 83`, `Community 84`, `Community 85`, `Community 218`, `Community 91`, `Community 94`, `Community 96`, `Community 104`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `Role` connect `Community 12` to `Community 0`, `Community 1`, `Community 2`, `Community 132`, `Community 133`, `Community 7`, `Community 139`, `Community 16`, `Community 145`, `Community 19`, `Community 148`, `Community 275`, `Community 22`, `Community 26`, `Community 31`, `Community 166`, `Community 38`, `Community 40`, `Community 168`, `Community 297`, `Community 43`, `Community 173`, `Community 48`, `Community 177`, `Community 49`, `Community 52`, `Community 55`, `Community 60`, `Community 63`, `Community 64`, `Community 199`, `Community 73`, `Community 76`, `Community 77`, `Community 83`, `Community 85`, `Community 89`, `Community 91`, `Community 92`, `Community 97`, `Community 100`, `Community 101`, `Community 241`, `Community 116`?**
...
- **What connects `{ defineConfig }`, `expoConfig`, `path` to the rest of the system?**
  _3973 weakly-connected nodes found - possible documentation gaps or missing edges._
