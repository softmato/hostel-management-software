...
## Corpus Check
- 1957 files · ~3,343,054 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15557 nodes · 42830 edges · 510 communities (487 shown, 23 thin omitted)
...
Cohesion: 0.02
Nodes (314): GET(), POST(), GET(), POST(), PATCH(), POST(), RouteContext, GET() (+306 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (282): deleteResidentLocationHistory(), listAttendanceAlerts(), demoteToPublicAccount(), addComplaintUpdate(), auditComplaintAction(), confirmComplaintResolution(), createComplaint(), findAdminComplaint() (+274 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (256): getOrCreateSubscription(), POST(), GET(), getOpenFeeSchedule(), GET(), getFoodRoutinesByHostelId(), serializeRoutine(), listPublicFoodRoutine() (+248 more)
...
Cohesion: 0.01
Nodes (248): loadOverview(), loadMoney(), loadToday(), loadFinance(), getAdminFoodRoutine(), getAdminHostel(), getAdminInvoices(), getAdminMaintenance() (+240 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (219): AdminCommunityReportsScreen(), Scanner(), AttendanceScreen(), FaqRow(), MethodCard(), CookInviteScreen(), GuardianInviteScreen(), NightStatusScreen() (+211 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (150): PlanPaymentClaim, deferLoad(), DemoDataBadge(), Hostel, HostelTable(), Inquiry, LoadState, Message() (+142 more)
...
Cohesion: 0.01
Nodes (131): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), field(), GuardianDashboard, HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage() (+123 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (172): ReviewForm(), ReviewScreen(), describeGrants(), GuardianRow(), PermissionSheet(), InviteGuardianScreen(), DeletionRequest, DeletionStatus (+164 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (147): POST(), attacker, attempt(), headers, jsonRequest(), routeMocks, appBaseUrl(), authenticateWithGoogle() (+139 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (151): POST(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus(), OPEN_STATUSES, OverdueComplaint, runComplaintSlaCheck(), hostelId (+143 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (133): AdminTabs(), HIDDEN, TABS, AdminMoreScreen(), ActivateScreen(), BootGate(), RootShell(), ApplyBlock() (+125 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (126): SosScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+118 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (120): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, summarizeResidentComplaints(), daysFromNow(), enabledPermissionLabels(), GuardianAccessRecord (+112 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (117): Offset, PhotoCropper(), VideoSlot(), CollectionQrField(), cityOptions, createDocument(), createRoom(), DocumentConfig (+109 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (80): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, LoadState, PublicPricingPage() (+72 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (104): FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, monthStartPeriod(), Rate, RoomTypeOption, MonthField, MonthOption() (+96 more)
...
Cohesion: 0.02
Nodes (123): AdminResidentsScreen(), NightStatusForm(), NotificationCard(), ProfileScreen(), ReferralRow(), DeletionPanel(), AlertRow(), CheckoutStatusScreen() (+115 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (111): CapacityError, claimBedForRoomType(), listAllRoomTypes(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary(), releaseBedForRoomType() (+103 more)
...
Cohesion: 0.03
Nodes (108): FILTERS, NotificationRow(), NotificationsScreen(), TILE_GLYPH, TILE_TONES, CommunityScreen(), Composer(), CommunityBoard() (+100 more)

### Community 23 - "Community 23"
Cohesion: 0.07
Nodes (83): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), subscriptionClaimReceivedEmail(), subscriptionClaimRejectedEmail() (+75 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (101): Notification, HostelAdminCooksPanel, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine (+93 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (107): AdminAlertsScreen(), AdminCommunityScreen(), AdminHomeScreen(), AdminOverviewScreen(), AdminMoneyScreen(), AdminTodayScreen(), AdminAlertsContext, AdminAlertsValue (+99 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (86): GET(), RouteContext, findResidentOwnedAccess(), revokeGuardianAccess(), updateGuardianPermissions(), purgeArchivedHostel(), purgeHostel(), runHostelArchivePurge() (+78 more)
...
Cohesion: 0.03
Nodes (102): PaymentMonthStrip(), ManageRatesScreen(), CreditRow(), ManageStatementScreen(), methodIcon(), SummaryCard(), AmountCard(), AdminLedger (+94 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (86): PRIORITIES, STATUS_ACTIONS, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel, GatewayConfig, GatewayHealthStatus (+78 more)
...
Cohesion: 0.02
Nodes (73): mocks, readable, selectable, mocks, proofBody, readAs(), readRequest(), hostelId (+65 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (93): GET(), POST(), querySchema, RouteContext, AnnouncementInput, CommentCreateInput, commentOnPost(), CommentRecord (+85 more)
...
Cohesion: 0.03
Nodes (80): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), PROVIDER_LABEL, QrPanel(), InvoiceDetailScreen() (+72 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (88): DAY_LABELS, DayStrip(), MEAL_ICONS, MealCard(), RoutineMeal, CookTodayScreen(), RoleLayout(), TABS (+80 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (83): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult (+75 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (85): BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan, BillingSkip (+77 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (64): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, daysUntil(), HostelSubscriptionDueBanner(), rupees(), State, normalize(), PortalSearch() (+56 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (62): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, AuthShell(), AuthShellProps, PANEL_COPY (+54 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (70): HostelPayeeIdentity, GATEWAY_ORDER, getHostelPayMethods(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod (+62 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (70): createExpertConsultationRequest(), hashUserAgent(), HostelRef, newVisitorKey(), recordHostelPageView(), resolveVisitorKey(), getPresignedReadUrl(), hostelPageViewSchema (+62 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (65): CommunityReportDialog(), REASONS, BrowserPushRow(), ModerationButton(), PagerButton(), PublicHostelListingPage(), ReferenceCheck(), CodeChip() (+57 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (73): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodBounds() (+65 more)
...
Cohesion: 0.05
Nodes (55): HostelSuggestions(), inferKind(), MediaLightbox(), PublicComparePage(), formatHostelAddress(), hasFood(), hostelTypeToUi(), mapPublicHostelToSummary() (+47 more)
...
Cohesion: 0.03
Nodes (39): deleteHostelObjects(), ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, RETAINED_BY_HOSTEL_ID, both (+31 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (50): BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan, Badge(), grabDocument(), HostelAdminBillingPageContent(), InvoiceRow() (+42 more)
...
Cohesion: 0.06
Nodes (56): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt, getInvoiceDetailForHostel() (+48 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (52): getR2Client(), classifyCredit(), CreditClassification, findOrphanClaims(), LadderClaim, LadderInvoice, loadMatchContext(), MatchContext (+44 more)
...
Cohesion: 0.05
Nodes (45): escapeRegex(), objectIdSchema, paginationSchema, phoneSchema, notifyStaffOfJobProgress(), serviceProviderApplicationSchema, serviceProviderDocumentSchema, hostelId (+37 more)

### Community 58 - "Community 58"
Cohesion: 0.07
Nodes (46): JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, getOwnProvider(), listProviderJobs() (+38 more)
...
Cohesion: 0.05
Nodes (48): getHostelLedger(), HostelLedger, HostelLedgerEntry, InvoiceMatrix, InvoiceMatrixRow, NotBilled, PortalInvoice, ResidentFinanceView (+40 more)

### Community 61 - "Community 61"
Cohesion: 0.05
Nodes (30): InlineText(), PlanMark(), RAFTER, RIDGE, ROWS, BillingToggle(), EASE, PlanCards() (+22 more)

### Community 62 - "Community 62"
Cohesion: 0.06
Nodes (46): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery (+38 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (42): notifyProviderOfAssignment(), notifyProviderOfMaintenanceNote(), notifyProviderOfStatusChange(), notifyStaffOfNewMaintenanceRequest(), providerUserId(), readableCategory(), RequestLike, STATUS_WORDS (+34 more)

### Community 64 - "Community 64"
Cohesion: 0.07
Nodes (47): Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity() (+39 more)

### Community 65 - "Community 65"
Cohesion: 0.07
Nodes (45): periodOf(), collectionTotals(), countInvoicesByField(), invoicesByIds(), ledgerPipeline(), monthlySeries(), getHostelViewStats(), foodFeedbackSchema (+37 more)
...
Cohesion: 0.05
Nodes (39): assertComplaintVoiceNote(), attachFiles(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput, ComplaintListQuery, ComplaintRecord (+31 more)

### Community 69 - "Community 69"
Cohesion: 0.08
Nodes (42): saveFoodRoutine(), addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange(), definedUpdate(), FoodFeedbackInput, FoodFeedbackRecord (+34 more)
...
Cohesion: 0.07
Nodes (42): cookLoginStem(), generateCookPassword(), mintCookLogin(), pick(), previousCookLabel(), acceptCookInvitation(), addCookAccount(), assertRoomForAnotherCook() (+34 more)

### Community 72 - "Community 72"
Cohesion: 0.07
Nodes (43): DELETE(), POST(), CampaignListQuery, CampaignRecord, createCampaign(), createHostelNotificationCampaign(), createPlatformNotificationCampaign(), dispatchCampaign() (+35 more)

### Community 73 - "Community 73"
Cohesion: 0.07
Nodes (47): fill(), money(), PlanCard(), PricingScreen(), pricePlan(), HostelRegistrationProgress(), Milestone, milestoneIndex() (+39 more)

### Community 74 - "Community 74"
Cohesion: 0.09
Nodes (38): POST(), RouteContext, computePerceptualHash(), systemDocumentKind(), cookieAccessToken(), isRole(), loadApiPrincipal(), authMocks (+30 more)
...
Cohesion: 0.08
Nodes (44): hostelForm(), buildHostelPayload(), capacitySummary(), CITY_OPTIONS, emptyHostelForm(), emptyRoomRow(), FACILITY_OPTIONS, firstIncompleteHostelStep() (+36 more)
...
Cohesion: 0.05
Nodes (36): PortalDates, useHostelDayTurn(), useSiteConfig(), PlanBilling, PlanBillingInvoice, PlanBillingPayment, PlanBillingPlan, ContentSection (+28 more)
...
Cohesion: 0.08
Nodes (40): mocks, allocateOrderNumber(), applyStatus(), CancelInput, cancelOrder(), CreateInput, getOrder(), hostelNames() (+32 more)
...
Cohesion: 0.09
Nodes (37): Compass(), cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath(), hasArrived(), headingDifference() (+29 more)
...
Cohesion: 0.07
Nodes (36): afterResponse(), mocks, filterPushRecipients(), CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, readId(), activeDevicesFor() (+28 more)

### Community 86 - "Community 86"
Cohesion: 0.08
Nodes (37): bsMonthStart(), hostelCalendarDay(), hostelDayParts(), hostelToday(), FeeScheduleRecord, rateForRoomType(), monthsBetween(), periodOf() (+29 more)

### Community 87 - "Community 87"
Cohesion: 0.05
Nodes (31): financeIntegrityHash(), findingSchema, reconciliationRunSchema, checkAuditChain(), checkCreditBalances(), DRIFT_CODES, LedgerDriftSummary, after (+23 more)
...
Cohesion: 0.12
Nodes (35): GET(), resolvePastedLink(), searchCandidates(), lookupLocation(), resolvePastedLink(), searchCandidates(), AddressParts, addressPartsFromGoogle() (+27 more)
...
Cohesion: 0.11
Nodes (35): CARD_NOUNS, CardVariant, drawBack(), drawBrandLockup(), drawFooterSweep(), drawFront(), drawHeaderSweep(), drawIdCard() (+27 more)

### Community 96 - "Community 96"
Cohesion: 0.08
Nodes (32): POST(), acceptPlatformAdminInvitation(), AcceptPlatformAdminInvitationInput, appUrl(), checkPlatformAdminEmail(), daysFromNow(), EmailAvailability, EmailAvailabilityResult (+24 more)

### Community 97 - "Community 97"
Cohesion: 0.08
Nodes (36): canonical(), canonicalDigits(), containsWithTolerance(), evidenceTextFlags(), extractClaimFields(), isDefinitelyNotPaymentEvidence(), looksLikePaymentReceipt(), matchClaimFacts() (+28 more)

### Community 98 - "Community 98"
Cohesion: 0.08
Nodes (32): NearbyStatus, Coordinates, haversineMeters(), hostelCoordinates(), HostelWithDistance, isUsableCoordinate(), KATHMANDU, sortByDistance() (+24 more)
...
Cohesion: 0.1
Nodes (33): EvidenceEngineMode, AMOUNT_LABELS, deadline(), DIGIT_CONFUSABLES, EvidenceRead, EvidenceTextMatch, ExtractedClaimFields, getWorker() (+25 more)
...
Cohesion: 0.07
Nodes (25): csvField(), field(), numberField(), optionalField(), AddressFields, FORM_SECTIONS, PendingPhoto, PHOTO_LIMITS (+17 more)
...
Cohesion: 0.1
Nodes (26): POST(), RouteContext, listTrendingTags(), sponsorSchema, GET(), loadPopularHostels(), PopularHostelRecord, assertWindow() (+18 more)
...
Cohesion: 0.15
Nodes (30): calendarExample(), formatAgoIn(), formatDateIn(), formatDateLongIn(), formatDateTimeIn(), formatDayMonthIn(), formatPeriodMonthIn(), formatPeriodYearIn() (+22 more)
...
Cohesion: 0.11
Nodes (28): UploadCard(), useIsUploading(), dismissUpload(), emit(), getUploadRows(), isUploadActive(), listeners, pruneUploads() (+20 more)

### Community 116 - "Community 116"
Cohesion: 0.07
Nodes (27): fromBs(), gregorianOf(), bhadra(), filter, hostelId, invoiceId, mocks, otherHostelId (+19 more)
...
Cohesion: 0.09
Nodes (26): documents, many, parsed, result, HostelForm, buildProviderPayload(), EMPTY_PROVIDER_FORM, firstIncompleteProviderStep() (+18 more)
...
Cohesion: 0.14
Nodes (23): storeCartSchema, storeCategorySchema, storeOrderSchema, serializeStoreCategory(), serializeStoreProduct(), StoreCategoryRecord, storeObjectId(), StoreProductRecord (+15 more)
...
Cohesion: 0.16
Nodes (27): AuditLog, code:typescript (// One per resident, per hostel. Minted lazily on first dash), code:typescript (interface ISubscription {), code:typescript (interface IPlatformSetting {), code:typescript (interface IAuditLog {), code:typescript ({), code:typescript ({), code:typescript (interface IFoodReadyLog {) (+19 more)
...
Cohesion: 0.11
Nodes (22): ApiFailure, ApiSuccess, AuthUser, getResidentReferral(), listResidentFood(), listResidentPayments(), ResidentFoodMenu, ResidentFoodPhoto (+14 more)

### Community 134 - "Community 134"
Cohesion: 0.17
Nodes (24): assertMatchesExtension(), downloadAndShareCsv(), downloadAndShareImage(), downloadToDevice(), forgetDownloadFolder(), LegacyFileSystem, loadLegacyFileSystem(), MAGIC (+16 more)
...
Cohesion: 0.16
Nodes (23): storeProductSchema, AddInput, addToCart(), CartItemRecord, CartRecord, clearCart(), emptyCart(), getCart() (+15 more)
...
Cohesion: 0.15
Nodes (19): Choice, maneuverIcon(), MapButton(), MapScreen(), ModeTab(), NavCard(), NOTHING_CHOSEN, RouteCard() (+11 more)
...
Cohesion: 0.13
Nodes (16): buildHtml(), Marker, PlaceMarker, buildShell(), boundsCenter(), humanizeNearbyType(), NEARBY_GLYPHS, NEARBY_GROUPS (+8 more)
...
Cohesion: 0.12
Nodes (9): GoogleMap, HostelMap(), LeafletMap, TYPE_COLORS, AddressParts, GeocodePrecision, MapProvider, NearbyPlace (+1 more)
...
Cohesion: 0.14
Nodes (15): activateResident(), login(), ResidentNotice, triggerSOS(), RootStackParamList, LoginScreen(), Props, Props (+7 more)
...
Cohesion: 0.18
Nodes (13): robots(), documentUrl(), InvoiceLean, PaymentLean, PlatformInvoiceRow, PlatformPaymentRow, PlatformSubscriptionLedger, r2Configured() (+5 more)
...
Cohesion: 0.16
Nodes (15): GET(), getBillingPeriodSummary(), BillingRunInput, BillingRunQuery, billingRunQuerySchema, billingRunSchema, periodSchema, deleteGatewayConfig() (+7 more)
...
Cohesion: 0.12
Nodes (9): ReturnState, CancelDeletionPageContent(), CheckoutReturnPage(), resetRoleHealForTests(), fetchMock, forbidden(), jsonResponse(), ok() (+1 more)
...
Cohesion: 0.23
Nodes (17): addHistory(), addMaintenanceComment(), assertBedInHostel(), assertProviderApproved(), assertRoomInHostel(), assertVoiceNoteUsable(), assignMaintenanceProvider(), auditMaintenanceAction() (+9 more)
...
Cohesion: 0.18
Nodes (17): code:typescript (interface IServiceProvider {), code:typescript (interface IServiceProvider {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IInquiry {), code:typescript (interface IHostelPageView {), Inquiry, MaintenanceRequest (+9 more)
...
Cohesion: 0.15
Nodes (11): AuthSession, getResidentProfile(), submitResidentReview(), AppNavigator(), Stack, ResidentPaymentsScreen(), Profile, Props (+3 more)

### Community 228 - "Community 228"
Cohesion: 0.27
Nodes (9): NightStatusAnswer, flushNightStatusQueue(), handleNightStatusResponse(), postAnswer(), dequeueNightStatus(), enqueueNightStatus(), QueuedNightStatus, readNightStatusQueue() (+1 more)
...
Cohesion: 0.21
Nodes (12): registerNightStatusCategory(), createAndroidChannels(), easProjectId(), fetchExpoPushToken(), forgetPushToken(), PUSH_CHANNEL, PushPermission, PushRegistration (+4 more)
...
Cohesion: 0.26
Nodes (10): GET(), platformAdminInviteSchema, GET(), getAgentSummary(), listAgentRegistrations(), listTeamInvites(), listTeamRegistrations(), listTeamRoster() (+2 more)
...
Cohesion: 0.17
Nodes (11): invalidateQuery(), resetQueryCache(), again, first, june, listener, load, may (+3 more)
...
Cohesion: 0.2
Nodes (11): apiRequest(), confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listResidentComplaints(), listResidentNotices(), markNoticeAsRead(), refreshSession() (+3 more)
...
Cohesion: 0.29
Nodes (9): isNightStatusPrompt(), NIGHT_STATUS_ACTIONS, NIGHT_STATUS_BUTTONS, NIGHT_STATUS_REASONS, NightStatusActionId, parseNightStatusAction(), reasonLabel(), SelfReportedStatus (+1 more)
...
Cohesion: 0.33
Nodes (7): readReturnState(), ownerIdentitiesFor(), resolveOwnedHostel(), selectPlan(), POST(), RouteContext, GET()
...
Cohesion: 0.28
Nodes (9): 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, code:typescript ({), code:typescript ({), code:typescript ({) (+1 more)
...
- **Why does `Button()` connect `Community 3` to `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 12`, `Community 13`, `Community 17`, `Community 19`, `Community 22`, `Community 24`, `Community 25`, `Community 28`, `Community 158`, `Community 30`, `Community 35`, `Community 36`, `Community 39`, `Community 43`, `Community 51`, `Community 58`, `Community 75`, `Community 76`, `Community 108`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 43` to `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 262`, `Community 8`, `Community 15`, `Community 16`, `Community 17`, `Community 21`, `Community 24`, `Community 29`, `Community 30`, `Community 34`, `Community 39`, `Community 40`, `Community 46`, `Community 47`, `Community 50`, `Community 59`, `Community 61`, `Community 189`, `Community 70`, `Community 73`, `Community 338`, `Community 93`, `Community 103`, `Community 106`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 135` to `Community 0`, `Community 4`, `Community 7`, `Community 137`, `Community 10`, `Community 12`, `Community 13`, `Community 15`, `Community 17`, `Community 18`, `Community 23`, `Community 27`, `Community 28`, `Community 29`, `Community 157`, `Community 44`, `Community 45`, `Community 46`, `Community 47`, `Community 50`, `Community 179`, `Community 52`, `Community 65`, `Community 199`, `Community 76`, `Community 82`, `Community 84`, `Community 85`, `Community 89`, `Community 91`, `Community 92`, `Community 97`, `Community 104`, `Community 108`, `Community 112`, `Community 122`?**
