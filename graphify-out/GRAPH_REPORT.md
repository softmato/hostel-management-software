# Graph Report - hostel-management-software  (2026-09-08)

## Corpus Check
- 1787 files · ~3,167,533 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14400 nodes · 39645 edges · 501 communities (481 shown, 20 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 622 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 586 edges
2. `successResponse()` - 574 edges
3. `connectToDatabase()` - 391 edges
4. `useAppTheme()` - 360 edges
5. `cn()` - 265 edges
6. `connectToDatabase()` - 228 edges
7. `unwrap()` - 192 edges
...
Cohesion: 0.02
Nodes (220): POST(), GET(), POST(), PATCH(), POST(), RouteContext, GET(), GET() (+212 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (264): AdminCommunityScreen(), APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), CookInviteScreen() (+256 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (222): summarizeResidentComplaints(), getCreditAmount(), ListedRoomRates, getHostelLedger(), getInvoiceMatrix(), getResidentFinanceView(), HostelLedger, HostelLedgerEntry (+214 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (232): GET(), getOpenFeeSchedule(), SetResidentFeeInput, GET(), listPublicFoodRoutine(), addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry() (+224 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (240): loadToday(), loadFinance(), ManageRatesScreen(), getAdminFoodRoutine(), getAdminMaintenance(), getAdminNightStatus(), listAdminNotices(), ActivationIssue (+232 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (184): AdminCommunityReportsScreen(), AdminMoreScreen(), MANAGE_ROWS, PORTAL_ROWS, ActivateScreen(), Scanner(), BootGate(), RootShell() (+176 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (138): ICONS, LABELS, Segment, TONES, FILTERS, Pending, Overview, MoneyData (+130 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (138): Filter, ModeratedPost, ModerationPayload, DemoDataBadge(), HostelTable(), UserRecord, GuardianDashboard, CreateWardenResult (+130 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (179): ReviewForm(), ReviewScreen(), describeGrants(), GuardianRow(), PermissionSheet(), InviteGuardianScreen(), SosInput, SosPhase (+171 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (153): PaymentMonthStrip(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), PortalDates, SummaryCard(), AmountCard() (+145 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (130): CommunityReportDialog(), REASONS, ConfirmOptions, Notification, BrowserPushRow(), FILTERS, Notification, NotificationRow() (+122 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (102): CookAccount, Credentials, HostelAdminCooksPanel, Issued, PRIORITIES, STATUS_ACTIONS, CATEGORIES, Campaign (+94 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (127): GET(), POST(), AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, PlatformAuditLogQueryInput (+119 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (122): voteOnComment(), createExpertConsultationRequest(), getMyExpertConsultationRequest(), GET(), POST(), ALLOWED_ROLES, GET(), POST() (+114 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (115): Offset, PhotoCropper(), VideoSlot(), FileUploadArea(), uploadPublicFile(), TradeDetailsStep(), downloadCaption(), DownloadRow (+107 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (114): CSV_COLUMNS, GET(), GET(), POST(), DELETE(), PATCH(), RouteContext, POST() (+106 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (112): AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput, ConsentInput, dayKey() (+104 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (80): adminPrincipal, mocks, PLATFORM_LIMITS, mocks, readable, selectable, mocks, proofBody (+72 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (84): HostelSuggestions(), GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS (+76 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (99): GET(), POST(), querySchema, RouteContext, AnnouncementInput, CommentCreateInput, commentOnPost(), CommentRecord (+91 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (99): AttachmentGallery(), DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS, MealCard(), MonthEndSpecial(), RoutineMeal (+91 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (96): AssetViewer(), useViewerState(), ViewerBody(), ViewerPage(), CopyButton(), ManualMethodPanel(), methodCaption(), methodKey() (+88 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (81): FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, monthStartPeriod(), Rate, RoomTypeOption, gregorianSpan(), MonthField (+73 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (74): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CancelDeletionPageContent() (+66 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (78): csvField(), deferLoad(), field(), Hostel, Inquiry, LoadState, Message(), numberField() (+70 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (96): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), loadOverview(), AdminMoneyScreen(), loadMoney(), AdminTodayScreen(), AdminAlertsContext (+88 more)
...
Cohesion: 0.03
Nodes (79): PaginationMeta, paginationQuerySchema, paginationRange(), querySchema, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex(), HostelRecord (+71 more)

### Community 28 - "Community 28"
Cohesion: 0.09
Nodes (63): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), cookInvitationEmail(), guardianInvitationEmail() (+55 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (75): CommunityScreen(), Composer(), CommunityPostScreen(), CommunityBoard(), CommunityBoardProps, Composer(), SORTS, CommentThread() (+67 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (83): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags() (+75 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (67): CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing, ActivationStatusResponse (+59 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (64): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), robots() (+56 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (57): metadata, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails(), RenderedSection (+49 more)

### Community 34 - "Community 34"
Cohesion: 0.05
Nodes (73): GET(), collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES (+65 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (76): demoteToPublicAccount(), runBillingCycle(), applyCreditToInvoice(), CapacityError, claimBedForRoomType(), listAllRoomTypes(), listAvailableRoomTypes(), loadConfigurations() (+68 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (60): ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, attempt, fetchMock, forged, live (+52 more)
...
Cohesion: 0.03
Nodes (63): TIER_TONE, PlanMark(), ROWS, EASE, PlanCards(), PlanLine(), PlansClosingCta(), PlansEditor (+55 more)
...
Cohesion: 0.06
Nodes (54): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, SystemDocumentKind (+46 more)
...
Cohesion: 0.04
Nodes (60): AdminResidentsScreen(), AttendanceScreen(), NightStatusForm(), NotificationCard(), ProfileScreen(), ReferralRow(), AlertRow(), CheckoutStatusScreen() (+52 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (41): metadata, CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+33 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (56): GATEWAY_ORDER, getHostelPayMethods(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice() (+48 more)
...
Cohesion: 0.06
Nodes (54): escapeRegex(), notifyStaffOfJobProgress(), serviceProviderApplicationSchema, serviceProviderDocumentSchema, PATCH(), GET(), notifyPlatformOfServiceProviderApplication(), notifyServiceProviderDecision() (+46 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (51): EMPTY_SUMMARY, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine, formatWeekRange() (+43 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (49): financeIntegrityHash(), appendEntry(), CreditBalanceView, CreditEntryKind, creditOverpayment(), getCreditBalance(), isDuplicateKey(), recomputeCreditBalance() (+41 more)
...
Cohesion: 0.06
Nodes (57): paymentProofSchema, alreadyReviewedError(), approvePaymentProof(), assertProofIsPending(), auditPaymentAction(), computeMonthlyDue(), createPaymentRecord(), creditVerifiedAmount() (+49 more)
...
Cohesion: 0.07
Nodes (46): GuardianNotShared(), GuardianNotShared(), GuardianWardCard(), GuardianHomeScreen(), GuardianMetrics(), GuardianPaymentsScreen(), GuardianSafetyScreen(), LoginResult (+38 more)
...
Cohesion: 0.06
Nodes (54): AMOUNT_LABELS, canonical(), canonicalDigits(), containsWithTolerance(), deadline(), DIGIT_CONFUSABLES, EvidenceRead, evidenceTextFlags() (+46 more)

### Community 56 - "Community 56"
Cohesion: 0.06
Nodes (51): AMOUNT_ALIASES, CREDIT_ALIASES, AMOUNT_ALIASES, CREDIT_ALIASES, DATE_ALIASES, DEBIT_ALIASES, NAME_ALIASES, readMoney() (+43 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (42): r2Configured(), storePublicAsset(), qrActivationSchema, before, expiresAt, mocks, staffPrincipal, activateResident() (+34 more)
...
Cohesion: 0.06
Nodes (26): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminPaymentsPage(), redirectToWorkspaceScreen(), HostelAdminReferralsPageContent() (+18 more)

### Community 60 - "Community 60"
Cohesion: 0.06
Nodes (40): EvidenceEngine, EvidenceEngineMode, EvidenceReadFailure, OcrResult, OcrWord, Attempt, billingPeriod(), DEFAULT_MODELS (+32 more)
...
Cohesion: 0.07
Nodes (39): referralSchema, referralCodeSchema, referralRewardSchema, assertActiveReferralCode(), auditReferralAction(), confirmReferralJoined(), createReferredInquiry(), findActiveReferralCode() (+31 more)
...
Cohesion: 0.07
Nodes (39): CLAIMABLE_STATUSES, dispatchOtpChallenge(), findVerifiedRegistrationChallenge(), generateOtpCode(), GOOGLE_JWKS, hashOtpCode(), normalizeEmail(), normalizeOtpIdentifier() (+31 more)
...
Cohesion: 0.09
Nodes (44): storeOrderSchema, addToCart(), clearCart(), getCart(), liveProduct(), readCart(), removeCartItem(), resolveStoreHostelId() (+36 more)
...
Cohesion: 0.07
Nodes (29): AdminTabs(), HIDDEN, TABS, FILTERS, NotificationRow(), TILE_GLYPH, TILE_TONES, TABS (+21 more)

### Community 71 - "Community 71"
Cohesion: 0.05
Nodes (26): ComparePage(), hostels, metadata, rows, CurrentUser, DASHBOARD_ROLES, dashboardHrefForRole(), hasDashboard() (+18 more)
...
Cohesion: 0.08
Nodes (44): BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsPeriodBounds(), bsPeriodOf(), bsPeriodsBetween() (+36 more)

### Community 74 - "Community 74"
Cohesion: 0.06
Nodes (28): currency(), Input(), LoadingRows(), ResidentActivationPageContent, ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent (+20 more)
...
Cohesion: 0.07
Nodes (35): afterResponse(), mocks, work, CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, readId(), activeDevicesFor() (+27 more)
...
Cohesion: 0.07
Nodes (33): buildHtml(), Marker, PlaceMarker, buildShell(), boundsCenter(), haversineMeters(), hostelCoordinates(), HostelWithDistance (+25 more)

### Community 80 - "Community 80"
Cohesion: 0.06
Nodes (26): csvField(), field(), Hostel, HostelAdminProfilePageContent(), Inquiry, LoadState, numberField(), optionalField() (+18 more)

### Community 81 - "Community 81"
Cohesion: 0.05
Nodes (26): AuthGuard(), cityOptions, createDocument(), createRoom(), DocumentConfig, DraftData, FACILITY_MINI, facilityOptions (+18 more)
...
Cohesion: 0.07
Nodes (34): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, ChargeBasis, computeInvoiceAmount() (+26 more)
...
Cohesion: 0.09
Nodes (35): addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange(), definedUpdate(), FoodFeedbackInput, FoodFeedbackRecord, FoodMenuCreateInput (+27 more)

### Community 86 - "Community 86"
Cohesion: 0.07
Nodes (28): searchHostels(), rows, ComparedHostel, comparePublicHostels(), definedParams(), Facility, getPublicHostel(), InquiryInput (+20 more)

### Community 87 - "Community 87"
Cohesion: 0.09
Nodes (37): fill(), money(), PlanCard(), PricingScreen(), BillingToggle(), listHeadingFor(), PlanCard(), CatalogueTab() (+29 more)

### Community 88 - "Community 88"
Cohesion: 0.09
Nodes (31): GET(), POST(), POST(), AccountDeletionError, applyImmediateEffects(), cancelAccountDeletionByToken(), cancelUrlFor(), DeletionPathway (+23 more)

### Community 89 - "Community 89"
Cohesion: 0.06
Nodes (28): findAccountForIntake(), linkResidentAccount(), residentDashboardUrl(), hasClearance(), PromotableUser, promoteAccountToResident(), PROTECTED_ROLES, ResidentPromotion (+20 more)
...
Cohesion: 0.06
Nodes (24): ProviderDirectoryData, CATEGORIES, isApplicationOpen(), LandingStep(), MeResponse, OwnApplication, ProviderStats, ProviderStatus (+16 more)
...
Cohesion: 0.06
Nodes (31): fromBs(), gregorianOf(), bhadra(), BillableResident, FeeScheduleRecord, { amount }, asar(), bhadra() (+23 more)
...
Cohesion: 0.08
Nodes (29): attacker, attempt(), headers, jsonRequest(), routeMocks, resetPasswordWithToken(), revokeAllSessions(), verifyEmailWithToken() (+21 more)

### Community 97 - "Community 97"
Cohesion: 0.09
Nodes (29): cookPrincipal, mocks, resolveCookLabels(), CookServiceError, cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError (+21 more)
...
Cohesion: 0.13
Nodes (29): JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, ProviderJobScreen(), ProviderJob (+21 more)
...
Cohesion: 0.1
Nodes (30): directionOf(), EMPTY_TALLY, floorToStep(), phaseOf(), shouldRepost(), tallyUploads(), active, done (+22 more)

### Community 105 - "Community 105"
Cohesion: 0.11
Nodes (31): GET(), resolvePastedLink(), searchCandidates(), hostelAdminGeocodeQuerySchema, AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim(), buildAddressQuery() (+23 more)
...
Cohesion: 0.07
Nodes (21): Panel(), StatusBadge(), field(), HostelAdminMaintenancePageContent(), HostelAdminServiceProvidersPageContent(), ListingFlag, LoadState, MaintenanceRequest (+13 more)
...
Cohesion: 0.1
Nodes (27): InquiryLinkScreen(), ReferralBody(), getResidentReferral(), Referral, ReferralCode, ReferralReward, ReferralStatus, ReferralSummary (+19 more)
...
Cohesion: 0.14
Nodes (23): appBaseUrl(), dispatchVerificationEmail(), requestPasswordReset(), resendVerificationEmail(), signupWithEmailVerification(), POST(), errorResponse(), signPurposeToken() (+15 more)

### Community 117 - "Community 117"
Cohesion: 0.09
Nodes (25): acceptGuardianInvitation(), daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags (+17 more)
...
Cohesion: 0.1
Nodes (25): documents, many, parsed, result, HostelForm, buildProviderPayload(), EMPTY_PROVIDER_FORM, firstIncompleteProviderStep() (+17 more)
...
Cohesion: 0.11
Nodes (23): isAuthBypassEnabled(), original, dashboardHrefForRole(), destinationForRole(), isAllowedNextPath(), isHostelWorkspacePath(), isSafeLocalPath(), landingPathForRole() (+15 more)

### Community 126 - "Community 126"
Cohesion: 0.08
Nodes (26): BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan, BillingSkip (+18 more)
...
Cohesion: 0.16
Nodes (23): announceFoodReady(), Candidate, dueMeals(), MealCallReminderResult, mealLabel(), RoutineRecord, runMealCallReminders(), canAnnounceMeal() (+15 more)

### Community 132 - "Community 132"
Cohesion: 0.14
Nodes (24): bsMonthStart(), hostelCalendarDay(), hostelToday(), rateForRoomType(), hostelCalendarDay(), hostelMonthStart(), hostelPeriodOf(), hostelToday() (+16 more)
...
Cohesion: 0.09
Nodes (16): accountDeletionRequestSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, consentLogSchema, deviceTokenSchema, questionCallClickSchema, purgeAccount() (+8 more)
...
Cohesion: 0.1
Nodes (20): classifyCredit(), CreditClassification, LadderClaim, LadderInvoice, MatchContext, normalizeTxnId(), ANITA_CODE, claims (+12 more)
...
Cohesion: 0.14
Nodes (20): Choice, maneuverIcon(), MapButton(), MapScreen(), ModeTab(), NavCard(), NOTHING_CHOSEN, RouteCard() (+12 more)

### Community 151 - "Community 151"
Cohesion: 0.09
Nodes (22): ContentPage, ContentSection, EMPTY_PAGE, FALLBACK_SITE_CONFIG, getSiteConfig(), MobileSiteConfig, SiteConfigResponse, SiteContent (+14 more)
...
Cohesion: 0.11
Nodes (18): DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), monthLabel(), describePreference(), formatMinutes() (+10 more)
...
Cohesion: 0.12
Nodes (19): addBsMonths(), approvalPeriod(), getPeriodSummary(), monthsBetween(), periodOf(), PeriodRow, PeriodSummary, august (+11 more)
...
Cohesion: 0.13
Nodes (23): code:typescript ({), code:typescript (interface IMoveInChecklistItem {), code:typescript (interface IMoveOutChecklistItem {), code:typescript (interface IServiceProvider {), code:typescript (interface IServiceProvider {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IInquiry {) (+15 more)

### Community 165 - "Community 165"
Cohesion: 0.12
Nodes (23): 5.1 SOS Triggered, 5. Safety & Emergency Emails, 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, 7.1 Attendance Alert (Resident Absent) (+15 more)

### Community 166 - "Community 166"
Cohesion: 0.11
Nodes (23): 0.4 Template structure, 1.0 Signup One-Time Code, 1.1 Email Verification (PUBLIC Signup), 1.2 Hostel Admin Credentials (Post-Approval), 1.3 Warden Credentials, 1.4 Resident QR Activation, 1.5 Guardian Invitation, 1.6 Password Reset (+15 more)
...
Cohesion: 0.22
Nodes (17): issueSessionForUser(), login(), publicUser(), refreshAccessToken(), AuthTokenPayload, hashToken(), jwtSecret(), PurposeTokenPayload (+9 more)

### Community 198 - "Community 198"
Cohesion: 0.12
Nodes (14): storeCartSchema, storeProductSchema, AddInput, CartItemRecord, CartRecord, emptyCart(), getCartCount(), notifyCartAdded() (+6 more)
...
Cohesion: 0.13
Nodes (14): draftFromProfile(), emptyIdentityDraft(), IdentityDraft, card, draft, errors, owner, payload (+6 more)
...
Cohesion: 0.18
Nodes (12): hasGeolocation(), LocationOutcome, NavigationFix, OrientationPermission, requestDeviceLocation(), requestHeadingPermission(), Unsubscribe, watchDeviceHeading() (+4 more)
...
Cohesion: 0.17
Nodes (13): geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), fetchNearbyPlaces(), fetchNearbyWithGoogle(), fetchNearbyWithOverpass(), GOOGLE_PLACE_TYPES (+5 more)
...
Cohesion: 0.13
Nodes (14): BLOOD_GROUPS, clearIdentityPhoto(), DIETARY_PREFERENCES, DietaryPreference, Gender, GENDERS, getIdentity(), getIdentityQr() (+6 more)
...
Cohesion: 0.16
Nodes (13): buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, idCardNoun(), IdentityTextField, OCCUPATION_LABELS (+5 more)
...
Cohesion: 0.31
Nodes (14): code:typescript (// One per resident, per hostel. Minted lazily on first dash), code:typescript (interface ISubscription {), code:typescript (interface IPlatformSetting {), code:typescript (interface IAuditLog {), code:typescript ({), HostelPageView, Inquiries, Referral, Notifications, Subscriptions, Inquiry (+6 more)
...
Cohesion: 0.18
Nodes (12): apiRequest(), confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listResidentComplaints(), refreshSession(), requestOtp(), ResidentComplaint (+4 more)
...
Cohesion: 0.31
Nodes (8): AuthServiceError, changePassword(), getCurrentUser(), sameIds(), POST(), getBearerToken(), verifyAccessToken(), changePasswordSchema
...
Cohesion: 0.2
Nodes (8): AuthSession, getResidentProfile(), AppNavigator(), Stack, Profile, Props, ResidentProfileScreen(), SignupScreen()
...
Cohesion: 0.22
Nodes (8): cookCreateSchema, cookInvitationAcceptSchema, cookNameSchema, cookPortalUpdateSchema, cookRemoveSchema, cookUpdateSchema, foodReadySchema, objectIdSchema
...
## Knowledge Gaps
- **5084 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+5079 more)
...
- **Why does `Button()` connect `Community 6` to `Community 1`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 20`, `Community 21`, `Community 150`, `Community 23`, `Community 22`, `Community 25`, `Community 24`, `Community 29`, `Community 33`, `Community 47`, `Community 52`, `Community 53`, `Community 65`, `Community 66`, `Community 227`, `Community 120`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 153` to `Community 0`, `Community 1`, `Community 131`, `Community 4`, `Community 5`, `Community 8`, `Community 9`, `Community 11`, `Community 14`, `Community 18`, `Community 22`, `Community 23`, `Community 152`, `Community 24`, `Community 28`, `Community 31`, `Community 161`, `Community 34`, `Community 36`, `Community 170`, `Community 49`, `Community 55`, `Community 56`, `Community 60`, `Community 64`, `Community 66`, `Community 73`, `Community 76`, `Community 78`, `Community 81`, `Community 82`, `Community 83`, `Community 105`, `Community 111`, `Community 116`, `Community 118`, `Community 121`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 10` to `Community 257`, `Community 5`, `Community 6`, `Community 7`, `Community 11`, `Community 14`, `Community 18`, `Community 22`, `Community 23`, `Community 24`, `Community 31`, `Community 32`, `Community 33`, `Community 38`, `Community 39`, `Community 41`, `Community 43`, `Community 45`, `Community 47`, `Community 54`, `Community 71`, `Community 72`, `Community 81`, `Community 87`, `Community 91`, `Community 95`, `Community 106`, `Community 107`, `Community 110`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Are the 386 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 386 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `{ defineConfig }`, `expoConfig`, `path` to the rest of the system?**
  _5084 weakly-connected nodes found - possible documentation gaps or missing edges._
