...
## Corpus Check
- 1076 files · ~1,902,257 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8693 nodes · 21688 edges · 376 communities (358 shown, 18 thin omitted)
...
- `requireHostelCapability()` --calls--> `connectToDatabase()`  [INFERRED]
  apps/web/src/lib/api-auth.ts → packages/db/src/connection.ts

## Communities (376 total, 18 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (125): Message(), UserRecord, GuardianDashboard, CATEGORIES, humanizeValue(), ImportedProfileSummary(), ResidentPrefill, ResidentStatus (+117 more)
...
Cohesion: 0.03
Nodes (161): deleteResidentLocationHistory(), getResidentAttendance(), listAttendanceAlerts(), querySchema, RouteContext, AnnouncementInput, CommentCreateInput, commentOnPost() (+153 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (91): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), verificationEmail(), ProviderDirectoryData, guardianInvitationEmail(), sosAlertEmail() (+83 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (78): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), useConfirm(), field(), LoadState, Message() (+70 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (84): HostelAdminCommunityPageContent, HostelAdminComplaintsPage, FeeSchedule, HostelAdminFeeSchedulePageContent, Rate, HostelAdminInquiriesPageContent, HostelAdminMaintenancePageContent, PRIORITIES (+76 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (84): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), voidInvoice(), approveCashPayment(), assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed() (+76 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (83): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, dayKey(), overrideAttendance(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply() (+75 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (51): attendanceAlertResolveSchema, attendanceListQuerySchema, attendanceSettingsSchema, consentSchema, locationPingSchema, objectIdSchema, DELETE(), GET() (+43 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (54): ComparePage(), hostels, metadata, rows, AuthExperiencePage(), HostelAdminDashboardPageContent(), PlatformDashboardPageContent(), PlatformHostelReviewPageContent() (+46 more)
...
Cohesion: 0.03
Nodes (62): CommunityPageContent(), csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, HostelTable(), Inquiry (+54 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (65): authorUserId, mocks, postId, residentId, residentPrincipal, staffPrincipal, mocks, readable (+57 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (66): Ledger, OrphanAssignPicker, MatrixRow, MatrixTotals, PeriodSummary, ClaimFacts(), ProofReviewModal, HostelAdminReconcilePageContent (+58 more)

### Community 14 - "Community 14"
Cohesion: 0.12
Nodes (52): LoadState, AnimatedPage(), AuthMode, Breadcrumbs(), FormField(), MetricCard(), metricIcons, NepalBannerGraphic() (+44 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (66): POST(), acceptGuardianInvitation(), daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput (+58 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (48): POST(), RouteContext, GET(), PATCH(), RouteContext, POST(), RouteContext, POST() (+40 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (71): addHostelAdminInquiryNote(), BedCreateInput, BedRecord, BedUpdateInput, DocumentRequestNotification, findScopedInquiry(), FloorCreateInput, FloorRecord (+63 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (66): announceFoodReady(), CookPortalUpdateInput, CookServiceError, FoodReadyInput, getCookPortalSettings(), HostelSettingsRecord, listFoodReadyLogs(), loadCookAccount() (+58 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (61): listTrendingTags(), CachedConnection, globalForMongoose, PaginationMeta, PaginationQuery, paginationQuerySchema, querySchema, auditListingFlagAction() (+53 more)
...
Cohesion: 0.06
Nodes (52): GET(), POST(), PATCH(), POST(), RouteContext, GET(), GET(), POST() (+44 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (61): CommunityReportDialog(), REASONS, ConfirmOptions, Resolver, ModerationButton(), PagerButton(), ReferenceCheck(), PublicHostelListingPage() (+53 more)
...
Cohesion: 0.04
Nodes (65): BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan, BillingSkip (+57 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (36): PATCH(), RouteContext, PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), POST(), GET(), POST() (+28 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (59): inferKind(), LightboxItem, MediaLightbox(), CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS, CITY_OPTIONS (+51 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (61): POST(), notifyPostReaction(), deviceTokenSchema, notificationSchema, notificationCampaignSchema, input, mocks, userId (+53 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (55): CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing, CurrentUser (+47 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (46): normalize(), PortalSearch(), PortalTone, scoreEntry(), toneStyles, iconMap, IconName, NavItem (+38 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (46): HostelSuggestions(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, PublicHostel, PublicHostelListingPageContent(), checkOnly() (+38 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (47): Notification, MonthPicker, PeriodRow, FILTERS, Notification, NotificationBell(), NotificationRow(), FILTERS (+39 more)
...
Cohesion: 0.08
Nodes (40): POST(), POST(), POST(), POST(), POST(), RouteContext, POST(), safeEqual() (+32 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (42): AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry() (+34 more)

### Community 36 - "Community 36"
Cohesion: 0.06
Nodes (47): assertQrAssetUsable(), EMPTY, getPaymentProfile(), PaymentProfileView, ProfileDocument, TEXT_FIELDS, toView(), updatePaymentProfile() (+39 more)
...
Cohesion: 0.07
Nodes (44): collectionTotals(), invoicesByIds(), platformRollup(), getHostelViewStats(), foodFeedbackSchema, listingFlagSchema, paymentProofSchema, ratingReviewSchema (+36 more)
...
Cohesion: 0.07
Nodes (51): demoteToPublicAccount(), assertActiveReferralCode(), findActiveReferralCode(), linkReferralOnRegistration(), addEmergencyContact(), addGuardian(), auditResidentAction(), BedRecord (+43 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (40): attachFiles(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput, ComplaintListQuery, ComplaintRecord, ComplaintReplyInput (+32 more)
...
Cohesion: 0.05
Nodes (42): cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal, checker, eventId, hostelId (+34 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (37): financeIntegrityHash(), runGatewayHealthForHostel(), hasProvider(), IntentRow, recheckClosedAttempts(), runSettlementRecon(), runSettlementReconForHostel(), SettlementReconSummary (+29 more)
...
Cohesion: 0.06
Nodes (31): attendanceOverrideSchema, GET(), POST(), PATCH(), RouteContext, objectIdSchema, platformReviewListQuerySchema, REVIEW_CATEGORY_KEYS (+23 more)
...
Cohesion: 0.06
Nodes (30): DeletionPathway, DeletionStatus, PATHWAY_COPY, CancelDeletionPageContent(), AcceptResult, GuardianInvitePageContent, CheckoutStatus, ResidentCheckoutPageContent (+22 more)

### Community 51 - "Community 51"
Cohesion: 0.07
Nodes (34): GET(), assertApiRoles(), requireHostelScopedPrincipal(), accountDeletionRequestSchema, attendanceLogSchema, communityCommentSchema, communityMediaSchema, communityPostSchema (+26 more)

### Community 52 - "Community 52"
Cohesion: 0.08
Nodes (33): DEPRECATED_ALIASES, mocks, GET(), POST(), auditWardenAction(), createHostelWarden(), deactivateHostelWarden(), findScopedWarden() (+25 more)
...
Cohesion: 0.07
Nodes (34): createExpertConsultationRequest(), ExpertConsultationCreateInput, ExpertConsultationError, ExpertConsultationRequestRecord, getMyExpertConsultationRequest(), notifyTeamOfRequest(), expertConsultationCreateSchema, expertConsultationRequestSchema (+26 more)
...
Cohesion: 0.07
Nodes (36): dashboardHrefForRole(), cook, HOSTEL_STAFF_ROLES, dashboardHrefForRole(), destinationForRole(), isAllowedNextPath(), isHostelWorkspacePath(), isSafeLocalPath() (+28 more)

### Community 57 - "Community 57"
Cohesion: 0.08
Nodes (20): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), redirectToWorkspaceScreen(), HostelAdminReferralsPageContent(), LegacyHostelAdminFeePlansPage(), LegacyHostelAdminIndexPage() (+12 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (26): emergencyContactSchema, incidentLogSchema, manualStatusOverrideSchema, nightStatusSchema, nightStatusLogSchema, sosAlertSchema, ComplaintRecord, firstPerResident() (+18 more)
...
Cohesion: 0.08
Nodes (30): auditHostelAction(), createHostelAdminFloor(), serializeFloor(), inquiryId, serviceMocks, staffPrincipal, BedCreateInput, BedRecord (+22 more)
...
Cohesion: 0.06
Nodes (23): EmptyState(), Panel(), field(), HostelAdminMaintenancePageContent(), HostelAdminReportsPageContent(), HostelAdminServiceProvidersPageContent(), ListingFlag, LoadState (+15 more)

### Community 66 - "Community 66"
Cohesion: 0.06
Nodes (25): csvField(), field(), Hostel, HostelAdminInquiriesPageContent(), HostelAdminProfilePageContent(), Inquiry, LoadState, numberField() (+17 more)

### Community 67 - "Community 67"
Cohesion: 0.08
Nodes (30): formatDate(), ReceiptPdfInput, renderReceiptPdf(), renderStatementPdf(), sanitize(), stampSystemDocument(), StatementPdfInput, StatementRow (+22 more)

### Community 68 - "Community 68"
Cohesion: 0.07
Nodes (31): EmailAttachment, fromAddress(), sendEmail(), SendEmailInput, SendEmailResult, cookEmailForSlug(), generatePassword(), provisionCookAccount() (+23 more)
...
Cohesion: 0.11
Nodes (26): computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, SystemDocumentKind, ImageVariantRecord, optimizeImage() (+18 more)
...
Cohesion: 0.09
Nodes (25): depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, providedItemSchema, auditMoveAction(), createMoveInChecklist(), createMoveOutChecklist(), findAdminResident() (+17 more)
...
Cohesion: 0.09
Nodes (29): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, FeeScheduleCloseInput, feeScheduleCloseSchema (+21 more)
...
Cohesion: 0.07
Nodes (29): BANK_CSV_PARSER, ESEWA_CSV_PARSER, both, corrupted, debit, [first], FIXTURE, headerOnly (+21 more)
...
Cohesion: 0.08
Nodes (12): PublicHostelListingPage(), ComparePageSkeleton(), HostelDetailPageSkeleton(), HostelListingPageSkeleton(), InquiryPageSkeleton(), emptyFilters, Filters, metadata (+4 more)

### Community 84 - "Community 84"
Cohesion: 0.09
Nodes (27): addHostelAdminProfilePhoto(), deleteHostelAdminProfilePhoto(), HostelAdminProfileQuery, HostelAdminProfileUpdateInput, HostelChangeRequestInput, HostelPhotoCreateInput, HostelPhotoDeleteQuery, LOCKED_NAME_STATUSES (+19 more)

### Community 85 - "Community 85"
Cohesion: 0.1
Nodes (24): CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload, AvailableRoomType, RoomMapFloor, PlatformCommunityPageContent, ResidentEmergencyContact (+16 more)
...
Cohesion: 0.12
Nodes (20): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), MediaViewerContext (+12 more)
...
Cohesion: 0.16
Nodes (22): createHostelAdminBed(), createHostelAdminRoom(), createPlatformHostelApplication(), definedUpdate(), findFloorInHostel(), findHostelByIdOrThrow(), findOrCreatePublicHostelOwner(), findRoomInHostel() (+14 more)
...
Cohesion: 0.13
Nodes (18): findIndex(), index, indexesOf(), IndexSpec, invoice, INVOICE_STATUSES, invoiceLineSchema, invoiceSchema (+10 more)

### Community 119 - "Community 119"
Cohesion: 0.11
Nodes (18): getInvoiceMatrix(), getResidentFinanceView(), InvoiceMatrix, InvoiceMatrixRow, listResidentClaims(), PortalInvoice, ResidentFinanceView, ResidentPortalInvoice (+10 more)
...
Cohesion: 0.12
Nodes (12): CATEGORIES, isApplicationOpen(), MeResponse, OwnApplication, ProviderStatus, ServiceProviderRegistrationPageContent(), ServiceProviderRegistrationPageProps, SessionUser (+4 more)

### Community 133 - "Community 133"
Cohesion: 0.16
Nodes (14): DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList(), positiveInteger(), validateFileAssetMetadata(), asset, fileAssetSchema (+6 more)
...
Cohesion: 0.2
Nodes (16): CheckoutStatus, closeIntent(), createPaymentIntent(), expireStaleIntents(), getCheckoutStatus(), handleProviderCallback(), IntentRecord, isUnconfirmable() (+8 more)
...
Cohesion: 0.15
Nodes (12): POST(), GET(), claimApproveSchema, ClaimRejectInput, ClaimRejectionReasonCode, claimRejectSchema, ClaimSubmitInput, claimSubmitSchema (+4 more)
...
Cohesion: 0.15
Nodes (13): §11 mockup alignment pass — 2026-08-10, 6.7 What we ask the hostel for, 6. Work breakdown, Block 0 — Security (blocks everything) 🔴 · ~3–4 days, Block 1 — Foundations, no visible change · ~4–5 days, Block 2 — Ledger refactor · ~8–10 days · the highest-risk block, Block 3 — Tier 0 complete · ~7–8 days, Block 4 — Tier 0.5 · ~6–7 days · best value per unit of effort (+5 more)
...
Cohesion: 0.42
Nodes (10): code:typescript (interface IHostelPageView {), code:typescript (// One per resident, per hostel. Minted lazily on first dash), code:typescript (interface ISubscription {), code:typescript (interface IPlatformSetting {), HostelPageView, Inquiries, Referral, Notifications, Subscriptions, Inquiry, Notification (+2 more)
...
## Knowledge Gaps
- **3326 isolated node(s):** `AuthUser`, `ResidentSummary`, `ResidentFoodRoutine`, `ApiSuccess`, `ApiFailure` (+3321 more)
...
- **Why does `Role` connect `Community 12` to `Community 0`, `Community 1`, `Community 2`, `Community 6`, `Community 7`, `Community 8`, `Community 267`, `Community 140`, `Community 269`, `Community 270`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 23`, `Community 26`, `Community 28`, `Community 29`, `Community 157`, `Community 158`, `Community 34`, `Community 37`, `Community 40`, `Community 41`, `Community 43`, `Community 47`, `Community 51`, `Community 52`, `Community 53`, `Community 56`, `Community 186`, `Community 59`, `Community 61`, `Community 190`, `Community 68`, `Community 205`, `Community 207`, `Community 208`, `Community 81`, `Community 82`, `Community 84`, `Community 227`, `Community 253`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 2` to `Community 1`, `Community 3`, `Community 6`, `Community 7`, `Community 8`, `Community 134`, `Community 139`, `Community 12`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 24`, `Community 27`, `Community 34`, `Community 35`, `Community 36`, `Community 37`, `Community 38`, `Community 40`, `Community 41`, `Community 43`, `Community 44`, `Community 45`, `Community 51`, `Community 52`, `Community 53`, `Community 54`, `Community 55`, `Community 57`, `Community 58`, `Community 59`, `Community 61`, `Community 63`, `Community 67`, `Community 68`, `Community 72`, `Community 73`, `Community 76`, `Community 82`, `Community 84`, `Community 225`, `Community 112`, `Community 113`, `Community 119`, `Community 252`, `Community 127`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 22` to `Community 0`, `Community 4`, `Community 132`, `Community 9`, `Community 138`, `Community 11`, `Community 13`, `Community 14`, `Community 23`, `Community 26`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 39`, `Community 171`, `Community 62`, `Community 65`, `Community 66`, `Community 69`, `Community 83`, `Community 88`, `Community 101`, `Community 107`, `Community 117`, `Community 126`?**
