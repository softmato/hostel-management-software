# Graph Report - hostel-management-software  (2026-09-18)

## Corpus Check
- 2240 files · ~3,400,318 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17859 nodes · 50205 edges · 572 communities (543 shown, 29 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 835 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 718 edges
2. `successResponse()` - 695 edges
3. `connectToDatabase()` - 508 edges
4. `useAppTheme()` - 422 edges
5. `cn()` - 316 edges
6. `connectToDatabase()` - 271 edges
7. `unwrap()` - 230 edges
...
- `sitemap()` --calls--> `listingTiers()`  [INFERRED]
  apps/web/src/app/sitemap.ts → packages/shared/src/plans/catalog.ts
...
- `ServiceDetailPage()` --calls--> `getService()`  [INFERRED]
...
- `GET()` --calls--> `connectToDatabase()`  [INFERRED]
  apps/web/src/app/api/v1/platform/community/route.ts → packages/db/src/connection.ts

## Communities (572 total, 29 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (239): GET(), POST(), POST(), POST(), recordConsent(), DELETE(), GET(), GET() (+231 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (315): loadToday(), NoticeArt(), loadFinance(), PortalDates, useHostelDayTurn(), getAdminFoodRoutine(), getAdminMaintenance(), getAdminNightStatus() (+307 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (246): PATCH(), RouteContext, POST(), getOrCreateSubscription(), selectPlan(), POST(), GET(), getOpenFeeSchedule() (+238 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (160): ICONS, LABELS, Segment, TONES, FILTERS, Pending, openStore(), Overview (+152 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (188): Choice, MapScreen(), NOTHING_CHOSEN, PreviewCard(), ResultRow(), SavedHostelsScreen(), SavedListRow(), METHODS (+180 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (197): auditFinanceAction(), FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment() (+189 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (140): PlanPaymentClaim, DemoDataBadge(), Hostel, HostelTable(), ReportGrid(), ReportRecord, UserRecord, GuardianDashboard (+132 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (207): loadOverview(), loadMoney(), SORTS, StoreCategoryScreen(), GuardianMetrics(), GuardianPaymentsScreen(), GuardianSafetyScreen(), DeletionRequest (+199 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (192): Scanner(), CookInviteScreen(), GuardianInviteScreen(), Compass(), MapButton(), ModeTab(), RouteCard(), Assurance() (+184 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (190): AdminCommunityReportsScreen(), AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), BootGate(), RootShell(), NightStatusHistoryScreen(), NightStatusForm() (+182 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (171): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, runPlanDueReminders(), notifyHostelOfNewPost() (+163 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (177): bsMonthStart(), fromBs(), gregorianOf(), BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure (+169 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (145): POST(), POST(), answerSchema, POST(), attacker, attempt(), headers, jsonRequest() (+137 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (124): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel() (+116 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (123): GET(), POST(), GET(), POST(), POST(), POST(), GET(), readReturnState() (+115 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (131): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, base, entityId, hostelId, mocks (+123 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (141): ReviewForm(), ReviewScreen(), AttachmentGallery(), DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS, MealCard() (+133 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (131): EMPTY_PAYOUT_DRAFT, METHODS, PayoutAccountDraft, PayoutAccountFields(), payoutAccountPayload(), DescriptionFacts, DescriptionSuggestions(), HostelType (+123 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (112): summarizeResidentComplaints(), listResidentInvoices(), renderStatementForResident(), getResidentLedger(), monthsBetween(), periodOf(), ResidentDoc, ResidentLedger (+104 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (131): deleteResidentLocationHistory(), listResidentComplaints(), rejectClaim(), getFoodRoutinesByHostelId(), saveFoodRoutine(), serializeRoutine(), addUtcDay(), auditFoodAction() (+123 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (118): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), PROVIDER_LABEL, QrPanel(), DetailsCard() (+110 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (112): GET(), POST(), querySchema, RouteContext, authorUserId, mocks, postId, residentId (+104 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (96): ConcessionBackfill, describeApplied(), FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, MonthDiscounts, monthStartPeriod(), Rate (+88 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (118): PaymentMonthStrip(), ClearFilters(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard(), AmountCard() (+110 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (107): AuthShellProps, PANEL_COPY, SiteWordmark(), BrandMark(), BrandWordmark(), WORDMARK, WORDMARK_SEGMENTS, HostelPreviewLink() (+99 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (114): cookPrincipal, mocks, resolveCookLabels(), CookServiceError, resolveAdminHostelId(), announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord (+106 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (106): HostelAdminCommunityPageContent, HostelAdminComplaintsPage, HostelAdminFeePlansPageContent, HostelAdminInquiriesPageContent, HostelAdminMaintenancePageContent, PRIORITIES, STATUS_ACTIONS, HostelAdminMoveChecklistPage (+98 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (101): HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend(), HostelHero() (+93 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (108): demoteToPublicAccount(), findCardBooking(), findHeldBooking(), mocks, work, LIVE_STATUSES, LiveResidency, liveResidencyMessage() (+100 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (89): getPlanPaymentInstructions(), bookingDocumentResponse(), resolveBookingDocument(), POST(), RouteContext, DELETE(), GET(), hostelId() (+81 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (99): AdminAlertsScreen(), AdminCommunityScreen(), AdminHomeScreen(), AdminOverviewScreen(), AdminMoneyScreen(), AdminTodayScreen(), AdminAlertsContext, AdminAlertsValue (+91 more)

### Community 31 - "Community 31"
Cohesion: 0.08
Nodes (70): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), bookingsPausedEmail(), hostelBookingsPausedEmail() (+62 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (89): POST(), GET(), POST(), mergeBookingConfig(), listPausedHostels(), listTransfersDue(), listPayoutAccounts(), GET() (+81 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (80): ComparePage(), generateMetadata(), hostels, metadata, rows, HostelSuggestions(), PublicComparePage(), PublicHostel (+72 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (67): GenericPortalScreen(), portalRows(), portalTitle(), CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS, CITY_OPTIONS (+59 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (76): metadata, AccountDeletionPanel, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails() (+68 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (82): PayPlanPanel(), rupees(), FILTERS, Notification, NotificationRow(), PushState, blankRow(), Row (+74 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (87): collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor() (+79 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (67): csvField(), field(), Hostel, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminProfilePageContent(), HostelAdminRoomsPageContent(), Inquiry (+59 more)

### Community 39 - "Community 39"
Cohesion: 0.02
Nodes (69): ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, RETAINED_BY_HOSTEL_ID, both, covered (+61 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (74): CommunityScreen(), Composer(), CommunityPostScreen(), AnimatedBlurView, CommunityBoard(), CommunityBoardProps, Composer(), NotificationBell() (+66 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (76): AuthGuard(), CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing (+68 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (75): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt, subscriptionClaimReceivedEmail() (+67 more)

### Community 43 - "Community 43"
Cohesion: 0.03
Nodes (72): approveClaim(), assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck(), evidenceCheck(), fileCheck() (+64 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (60): PATCH(), RouteContext, listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), getPlatformSubscriptionLedger(), listPlanPaymentClaims() (+52 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (63): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), ApplyBlock(), ServiceProvidersScreen() (+55 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (67): AdminTabs(), HIDDEN, RoleLayout(), TABS, FILTERS, NotificationCard(), NotificationRow(), TILE_GLYPH (+59 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (84): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags(), documentFlags() (+76 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (58): HostelBookingView, PayoutAccountForReview, ReviewPayoutAccount(), STATUS_LABEL, List(), ReasonAction(), Row(), timeLeft() (+50 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (65): HostelAdminExistingResidentsPage(), addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine, formatWeekRange() (+57 more)

### Community 50 - "Community 50"
Cohesion: 0.03
Nodes (56): Complaint, ComplaintSummary, currency(), field(), FoodMenu, HostelAdminFoodPage(), Input(), LoadingRows() (+48 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (65): downloadCaption(), DownloadRow, DownloadStack(), progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster() (+57 more)

### Community 52 - "Community 52"
Cohesion: 0.08
Nodes (63): BookingDocumentInput, renderBookingDocument(), bsFiscalYear(), amountInWords(), GROUPS, ONES, TENS, underHundred() (+55 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (64): BANK_CSV_PARSER, CsvTable, gridFromCsv(), peekHeaders(), readCsv(), stripBom(), stripPreamble(), ESEWA_CSV_PARSER (+56 more)
...
Cohesion: 0.05
Nodes (53): hostelPeriodOf(), existingResidentListSchema, existingResidentRowSchema, BillPreview, CheckContext, CheckedRow, checkExistingResidents(), CheckResult (+45 more)

### Community 56 - "Community 56"
Cohesion: 0.05
Nodes (59): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, GATEWAY_ORDER, getHostelPayMethods() (+51 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (64): BALANCE_ALIASES, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES, WITHDRAWAL_ALIASES (+56 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (29): PlatformConfigAnnouncementsPageContent, PlatformConfigContentPageContent, PlatformConfigFacilitiesPageContent, FLAGS, PlatformConfigFeaturesPageContent, PlatformConfigLegalPageContent, PlatformConfigLocationsPageContent, PlatformConfigPlanServicePageContent (+21 more)

### Community 59 - "Community 59"
Cohesion: 0.05
Nodes (48): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, metadata, daysUntil(), HostelSubscriptionDueBanner(), rupees(), State, PortalShell() (+40 more)
...
Cohesion: 0.05
Nodes (53): notifyProviderOfAssignment(), notifyProviderOfMaintenanceNote(), notifyProviderOfStatusChange(), notifyStaffOfJobProgress(), notifyStaffOfNewMaintenanceRequest(), providerUserId(), readableCategory(), RequestLike (+45 more)

### Community 62 - "Community 62"
Cohesion: 0.09
Nodes (56): dueWhen(), PlanDueInput, planDueSoonEmail(), planOverdueEmail(), composeEmail(), planSuspensionNoticeEmail(), formatRupees(), subscriptionInvoiceEmail() (+48 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (30): LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminMoveChecklistPage(), HostelAdminSOSAlertsPage(), HostelAdminComplaintsPage(), HostelAdminNoticesPage() (+22 more)

### Community 64 - "Community 64"
Cohesion: 0.05
Nodes (45): BookingQuote, GuestBookingDetail, GuestBookingSummary, metadata, BookingCheckoutPage(), Method, METHODS, nextStep() (+37 more)
...
Cohesion: 0.06
Nodes (55): formatPeriodKey(), cellAt(), focusCell(), Props, fullYear(), MONTH_SPELLINGS, monthFromWord(), readBsMonth() (+47 more)

### Community 68 - "Community 68"
Cohesion: 0.07
Nodes (46): JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, ProviderJobScreen(), listProviderJobs() (+38 more)

### Community 69 - "Community 69"
Cohesion: 0.04
Nodes (50): CHANNELS, ClaimedStep, composeNotice(), composePlanDueNotice(), deliverEmail(), deliverStep(), HostelRow, InvoiceRow (+42 more)

### Community 70 - "Community 70"
Cohesion: 0.06
Nodes (53): receiptSchema, arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal (+45 more)

### Community 71 - "Community 71"
Cohesion: 0.06
Nodes (46): addComplaintUpdate(), assertComplaintVoiceNote(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput (+38 more)

### Community 72 - "Community 72"
Cohesion: 0.05
Nodes (37): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, attempt (+29 more)

### Community 73 - "Community 73"
Cohesion: 0.06
Nodes (47): methodProvider(), createResident(), getIntakeQuote(), IntakeQuote, lookupResidentProfile(), ManagedHostel, RESIDENT_TYPES, ResidentIntakeResult (+39 more)

### Community 74 - "Community 74"
Cohesion: 0.06
Nodes (46): assertSuperadmin(), Destination, loadTransfer(), loadTransferProof(), markTransferSent(), PayoutAccountRow, payoutBlock(), revealTransferDestination() (+38 more)

### Community 75 - "Community 75"
Cohesion: 0.07
Nodes (50): userResidentProfileSchema, findLiveResidency(), LEGACY_ROLE_MAP, Role, ROLE_VALUES, CARD_LABELS, formatIssuedOn(), readPhotoBytes() (+42 more)

### Community 76 - "Community 76"
Cohesion: 0.06
Nodes (51): BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsPeriodBounds(), bsPeriodOf(), currentBsPeriod() (+43 more)

### Community 77 - "Community 77"
Cohesion: 0.06
Nodes (45): CITY_OPTIONS, FACILITY_OPTIONS, hasHostelErrors(), hasUsableRooms(), HOSTEL_PLANS, HOSTEL_STEPS, HOSTEL_TYPES, HostelAttachment (+37 more)

### Community 78 - "Community 78"
Cohesion: 0.06
Nodes (31): fill(), PricingScreen(), PlanPicker(), InlineText(), TIER_TONE, PlanMark(), RAFTER, RIDGE (+23 more)

### Community 79 - "Community 79"
Cohesion: 0.06
Nodes (45): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput, ConsentInput (+37 more)

### Community 80 - "Community 80"
Cohesion: 0.06
Nodes (39): GET(), GET(), querySchema, applicantSchema, billingCycleSchema, HostelRegistrationInput, hostelRegistrationSchema, registrationFields (+31 more)

### Community 81 - "Community 81"
Cohesion: 0.04
Nodes (48): PlanId, portalAccessLines(), Service, ServiceModule, ServiceModuleId, PLAN_MODULES, PLAN_SERVICES, PLAN_TIERS (+40 more)

### Community 82 - "Community 82"
Cohesion: 0.05
Nodes (43): BOOKING_DOCUMENT_KINDS, BookingDocumentKind, bookingDocumentLayout(), allowed(), bookingDocumentAttachment(), BookingDocumentScope, BookingError, applyStrikeRule() (+35 more)

### Community 83 - "Community 83"
Cohesion: 0.06
Nodes (41): serviceProviderApplicationSchema, serviceProviderDocumentSchema, hostelId, mocks, providerId, notifyPlatformOfServiceProviderApplication(), notifyServiceProviderDecision(), ACTIVE_APPLICATION_STATUSES (+33 more)

### Community 84 - "Community 84"
Cohesion: 0.06
Nodes (43): PLATFORM_ROLES, notificationCampaignSchema, CampaignListQuery, CampaignRecord, createCampaign(), createHostelNotificationCampaign(), createPlatformNotificationCampaign(), dispatchCampaign() (+35 more)

### Community 85 - "Community 85"
Cohesion: 0.1
Nodes (38): generateMetadata(), manifest(), notFound(), JsonLd(), JsonLdData, ContactPage(), generateMetadata(), FeaturesPage() (+30 more)

### Community 86 - "Community 86"
Cohesion: 0.06
Nodes (40): DELETE(), POST(), platformPushScheduleSchema, revokeDeviceToken(), campaignBaseSchema, deviceTokenRevokeSchema, deviceTokenSaveSchema, hostelNotificationCampaignSchema (+32 more)

### Community 87 - "Community 87"
Cohesion: 0.06
Nodes (46): buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, draftFromProfile(), emptyIdentityDraft(), firstIncompleteIdentityStep() (+38 more)

### Community 88 - "Community 88"
Cohesion: 0.06
Nodes (36): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, AuthShell(), GoogleAuthButton(), GoogleAuthButtonProps (+28 more)
...
Cohesion: 0.1
Nodes (36): POST(), RouteContext, computePerceptualHash(), deleteHostelObjects(), ImageVariantRecord, optimizeImage(), streamToBuffer(), VARIANT_CONFIG (+28 more)

### Community 92 - "Community 92"
Cohesion: 0.06
Nodes (37): qrActivationSchema, before, expiresAt, mocks, staffPrincipal, activateResident(), ActivationCodeGenerateInput, ActivationCodeInput (+29 more)
...
Cohesion: 0.05
Nodes (25): field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminNightStatusPage(), LoadState, NightStatusRow, Notification, NotificationsPageContent() (+17 more)

### Community 95 - "Community 95"
Cohesion: 0.07
Nodes (32): Entry, hostelEntries(), locationEntries(), sitemap(), STATIC_ROUTES, PublicCitiesPage(), OwnerCallout(), SeoChip() (+24 more)

### Community 96 - "Community 96"
Cohesion: 0.1
Nodes (41): BookableHostel, BookingUnavailableReason, findRoom(), hostelAddress(), HostelAvailability, hostelCoverPhoto(), hostelCoverPhotos(), hostelUnavailableReason() (+33 more)

### Community 97 - "Community 97"
Cohesion: 0.09
Nodes (39): noticePushSchema, announceChange(), audit(), CreateInput, createNoticePush(), DEFAULT_PUSHES, deleteNoticePush(), emitNoticePush() (+31 more)

### Community 98 - "Community 98"
Cohesion: 0.06
Nodes (31): BookButton(), SIZE, BookingAvailabilityView, BookingButton, CLOSED_REASONS, open, Avatar(), AVATAR_TONES (+23 more)

### Community 99 - "Community 99"
Cohesion: 0.1
Nodes (43): MESSAGES, POST(), RouteContext, BookingEndCause, HostelBookingClosedCause, announceEnding(), assertAwaitingAnswer(), cancelBookingByHostel() (+35 more)
...
Cohesion: 0.08
Nodes (37): isAuthBypassEnabled(), original, cook, assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES, PermissionError (+29 more)

### Community 102 - "Community 102"
Cohesion: 0.08
Nodes (39): useIsUploading(), useUploads(), directionOf(), EMPTY_TALLY, floorToStep(), phaseOf(), shouldRepost(), tallyUploads() (+31 more)

### Community 103 - "Community 103"
Cohesion: 0.06
Nodes (37): account, answerBy, before, book(), Booking, compact, confirmed(), Consent (+29 more)

### Community 104 - "Community 104"
Cohesion: 0.07
Nodes (36): CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, isPlanDueNotification(), readId(), activeDevicesFor(), activeTokensFor(), androidChannel() (+28 more)

### Community 105 - "Community 105"
Cohesion: 0.09
Nodes (39): candidateFontDirs(), ensureIdCardFonts(), FONT_DIR_SEGMENTS, FONT_FILES, CARD_NOUNS, CardVariant, drawBack(), drawBrandLockup() (+31 more)
...
Cohesion: 0.09
Nodes (37): Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity() (+29 more)
...
Cohesion: 0.07
Nodes (27): BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan, ExistingResidentsPanel(), Props, ExistingResidentsSheet(), Badge() (+19 more)

### Community 113 - "Community 113"
Cohesion: 0.1
Nodes (38): money(), PlanCard(), pricePlan(), PlanCard(), CatalogueTab(), CycleDiscount(), PublicListingBadgePage(), PublicServiceDetailPage() (+30 more)
...
Cohesion: 0.08
Nodes (31): AuthLayout(), metadata, CityHostelsPage(), generateMetadata(), PageParams, PublicLocationPage(), generateMetadata(), PageParams (+23 more)

### Community 116 - "Community 116"
Cohesion: 0.08
Nodes (28): outstandingForResident(), depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, providedItemSchema, auditMoveAction(), createMoveInChecklist(), createMoveOutChecklist() (+20 more)

### Community 117 - "Community 117"
Cohesion: 0.11
Nodes (33): cookLoginStem(), generateCookPassword(), mintCookLogin(), pick(), previousCookLabel(), acceptCookInvitation(), addCookAccount(), assertRoomForAnotherCook() (+25 more)

### Community 118 - "Community 118"
Cohesion: 0.09
Nodes (34): storeOrderSchema, mocks, allocateOrderNumber(), applyStatus(), CancelInput, cancelOrder(), CreateInput, hostelNames() (+26 more)

### Community 119 - "Community 119"
Cohesion: 0.07
Nodes (32): dispatchOtpChallenge(), generateOtpCode(), normalizeOtpIdentifier(), otpDeliveryProvider(), otpRateLimitMax(), otpRateLimitWindowMs(), otpResendCooldownMs(), otpTtlMs() (+24 more)
...
Cohesion: 0.07
Nodes (19): generateMetadata(), generateMetadata(), metadata, PublicBookingGuidePage(), PublicRefundPolicyPage(), generateMetadata(), generateMetadata(), generateMetadata() (+11 more)

### Community 122 - "Community 122"
Cohesion: 0.09
Nodes (29): SiteConfigProvider(), loadSiteConfig, loadSiteName(), CONTENT_ICON_SLUGS, everything, IDENTITY, page, rendered (+21 more)

### Community 123 - "Community 123"
Cohesion: 0.08
Nodes (31): acceptPlatformAdminInvitation(), AcceptPlatformAdminInvitationInput, appUrl(), checkPlatformAdminEmail(), daysFromNow(), EmailAvailability, EmailAvailabilityResult, findLiveInvite() (+23 more)
...
Cohesion: 0.09
Nodes (32): maneuverIcon(), NavCard(), cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath(), formatManeuverDistance() (+24 more)
...
Cohesion: 0.12
Nodes (32): announceConfirmed(), directionsUrl(), HostelPlace, announceBookingsPaused(), bell(), BookingAudience, bookingFacts(), deliver() (+24 more)
...
Cohesion: 0.11
Nodes (30): UploadCard(), beginDownload(), readDataUrl(), saveDataUrlToDevice(), saveToDevice(), dismissUpload(), emit(), finishUpload() (+22 more)

### Community 133 - "Community 133"
Cohesion: 0.12
Nodes (27): robots(), absoluteUrl(), formatNpr(), hostelJsonLd(), HostelJsonLdInput, JsonLd, LINE_SEPARATOR, organizationId() (+19 more)

### Community 134 - "Community 134"
Cohesion: 0.09
Nodes (26): classifyCredit(), CreditClassification, findOrphanClaims(), LadderClaim, LadderInvoice, MatchContext, normalizeTxnId(), ANITA_CODE (+18 more)
...
Cohesion: 0.09
Nodes (28): invalidateFeeds(), CachedQuery, clearQueryCache(), defined, entries, Entry, inflight, invalidateQuery() (+20 more)

### Community 137 - "Community 137"
Cohesion: 0.11
Nodes (28): ApiFailure, apiRequest(), ApiSuccess, AuthUser, confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listNotifications() (+20 more)

### Community 138 - "Community 138"
Cohesion: 0.09
Nodes (16): GoogleMap, HostelMap(), LeafletMap, TYPE_COLORS, DraggablePinMap, FALLBACK_CENTER, LocationPicker(), LocationPickerValue (+8 more)

### Community 139 - "Community 139"
Cohesion: 0.12
Nodes (28): refundPolicyNotes(), BookingEnding, bookingFee(), BookingSettlement, cancellationSchedule(), cancelRefundPercent(), FULL_REFUND_ENDINGS, holdDayAt() (+20 more)
...
Cohesion: 0.07
Nodes (24): allBlank, blankable, parsed, paths, result, validProfile, without, assetId (+16 more)

### Community 144 - "Community 144"
Cohesion: 0.1
Nodes (21): useRealtime(), claimNotificationSound(), claims, resetNotificationSoundClaims(), connectRealtime(), fetchConfig(), PusherModule, REALTIME_EVENT (+13 more)

### Community 145 - "Community 145"
Cohesion: 0.11
Nodes (19): applyWebhook(), WebhookResult, softmatoWebhookSecret(), formatPaisa(), paisaToRupees(), rupeesToPaisa(), POST(), classify() (+11 more)

### Community 146 - "Community 146"
Cohesion: 0.12
Nodes (22): CSV_COLUMNS, GET(), POST(), RouteContext, POST(), safeEqual(), ClickRecord, dayKey() (+14 more)

### Community 147 - "Community 147"
Cohesion: 0.09
Nodes (26): InvoiceDocumentInput, InvoicePresentation, documentFileName(), DocumentKind, InvoiceRow, invoiceStatus(), methodLabel(), PAYMENT_METHODS (+18 more)
...
Cohesion: 0.09
Nodes (10): ComparePageSkeleton(), HostelDetailPageSkeleton(), HostelListingPageSkeleton(), InquiryPageSkeleton(), emptyFilters, Filters, generateMetadata(), metadata (+2 more)
...
Cohesion: 0.14
Nodes (20): FILE_ASSET_KINDS, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), isPlatformOnlyAssetKind(), PLATFORM_ONLY_KINDS, DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES (+12 more)
...
Cohesion: 0.17
Nodes (20): NativeNightPrompt, takeNativePendingAnswers(), isNightStatusPrompt(), NIGHT_STATUS_ACTIONS, NIGHT_STATUS_BUTTONS, NIGHT_STATUS_REASONS, NightStatusActionId, NightStatusAnswer (+12 more)

### Community 161 - "Community 161"
Cohesion: 0.11
Nodes (15): EMPTY_DRAFT, HostelAdminPaymentProfilePageContent, PaymentProfile, SECTION_FIELDS, SectionId, BankMark(), EsewaMark(), KhaltiMark() (+7 more)

### Community 162 - "Community 162"
Cohesion: 0.14
Nodes (19): hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, drawCertificationStamp(), footerLine(), formatDate(), formatLongDate() (+11 more)

### Community 163 - "Community 163"
Cohesion: 0.1
Nodes (20): configuredLevel(), levelPriority, logger, LogLevel, normalizeMeta(), shouldLog(), write(), pushTicketSchema (+12 more)
...
Cohesion: 0.11
Nodes (20): addBsMonths(), bsPeriodsBetween(), approvalPeriod(), getPeriodSummary(), monthsBetween(), periodOf(), PeriodRow, PeriodSummary (+12 more)

### Community 166 - "Community 166"
Cohesion: 0.14
Nodes (19): ApiFailure, EXTENSION_MIME, isAudio(), PickedFile, resolveFileName(), resolveMimeType(), name, formatMegabytes() (+11 more)

### Community 167 - "Community 167"
Cohesion: 0.09
Nodes (15): PlatformBroadcastPanel, OperationsConfig, PendingSettingChange, PlanDueReminderSchedule, PlanReminderStep, PlatformOperationsPanel, REMINDER_CHANNELS, CHECK_TONES (+7 more)

### Community 168 - "Community 168"
Cohesion: 0.13
Nodes (18): geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), HostelGeoLocation, resolveHostelGeo(), fetchNearbyPlaces(), fetchNearbyWithGoogle() (+10 more)
...
Cohesion: 0.11
Nodes (21): softmatoDocsUrl(), dueBhadra29, filed, throughAswin25, CYCLE_LABELS, daysLeftThrough(), daysSpanned(), daysUntil() (+13 more)

### Community 171 - "Community 171"
Cohesion: 0.17
Nodes (19): CardBooking, checkInBooking(), returnHeldBed(), takeHeldBed(), notifyPlatform(), CapacityError, claimBedForRoomType(), listAllRoomTypes() (+11 more)
...
Cohesion: 0.13
Nodes (17): DeliveryPromise, formatHour(), DEFAULT_STORE_CONFIG, getStoreConfig(), PlatformSettingRecord, saveStoreConfig(), StoreConfig, storeConfigSchema (+9 more)

### Community 177 - "Community 177"
Cohesion: 0.16
Nodes (22): storeCartSchema, AddInput, addToCart(), CartItemRecord, CartRecord, clearCart(), emptyCart(), getCart() (+14 more)
...
Cohesion: 0.16
Nodes (18): InquiryLinkScreen(), ReferralBody(), ReferralSummary, isValidReferralCode(), normalizeReferralCode(), parseReferralLink(), safeDecode(), valid() (+10 more)
...
Cohesion: 0.13
Nodes (20): buildProviderPayload(), EMPTY_PROVIDER_FORM, firstIncompleteProviderStep(), hasProviderErrors(), isProviderStepComplete(), PROVIDER_CATEGORIES, PROVIDER_STEPS, ProviderAttachment (+12 more)
...
Cohesion: 0.13
Nodes (16): Guidance, GuidanceStatus, useGuidance(), formatDistance(), hostelCoordinates(), isUsableCoordinate(), KATHMANDU, hasGeolocation() (+8 more)
...
Cohesion: 0.12
Nodes (23): 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, 7.1 Attendance Alert (Resident Absent), 7.1 New Hostel Pending Approval (to Superadmin), 7.2 Subscription Expiring Soon (+15 more)

### Community 194 - "Community 194"
Cohesion: 0.11
Nodes (13): PlatformHostelsPageContent(), PlatformHostelsPageContent, PortalPlaceholderAction, PortalPlaceholderPage(), PortalPlaceholderPageProps, ResidentPaymentsPageContent, ResidentPaymentsPageContent(), ResidentProfilePageContent() (+5 more)
...
Cohesion: 0.13
Nodes (19): isUsableCoordinate(), fetchRoadRoute(), isRecord(), parseRoadRoute(), parseSteps(), RoadRoute, ROUTE_MODES, RouteMode (+11 more)
...
Cohesion: 0.14
Nodes (15): oauthAccountSchema, platformAdminInviteSchema, deleteTeamMember(), endSessions(), findMember(), MemberRecord, reinstateTeamMember(), removeTeamMember() (+7 more)
...
Cohesion: 0.14
Nodes (22): code:typescript ({), code:typescript (interface IMoveInChecklistItem {), code:typescript (interface IMoveOutChecklistItem {), code:typescript (interface IServiceProvider {), code:typescript (interface IServiceProvider {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IMaintenanceRequest {), code:typescript (interface IInquiry {) (+14 more)
...
Cohesion: 0.15
Nodes (18): AttendanceScreen(), DayRow(), AttendanceDay, AttendanceMonth, AttendanceSource, AttendanceSummary, AttendanceTone, AttendanceZone (+10 more)

### Community 210 - "Community 210"
Cohesion: 0.14
Nodes (18): documents, hostelForm(), many, parsed, result, buildHostelPayload(), capacitySummary(), emptyHostelForm() (+10 more)
...
Cohesion: 0.17
Nodes (18): ExistingCheck, ExistingCheckedRow, ExistingRow, ExistingRowInput, blankRow(), inputFromRow(), ListSection, listTotals() (+10 more)
...
Cohesion: 0.14
Nodes (16): now, count(), describeFanout(), SETTLED_SOS, SosFanoutTone, sosIsFlagged(), sosIsOpen(), sosMessagePayload() (+8 more)
...
Cohesion: 0.24
Nodes (16): resolvePastedLink(), searchCandidates(), lookupLocation(), resolvePastedLink(), searchCandidates(), queryVariants(), reverseGeocode(), searchPlaces() (+8 more)

### Community 221 - "Community 221"
Cohesion: 0.19
Nodes (17): AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim(), buildAddressQuery(), definedParts(), geocodeAddress(), geocodeWithGoogle(), geocodeWithNominatim() (+9 more)
...
Cohesion: 0.13
Nodes (13): buildFormPostHandoff(), FormPostHandoff, HandoffError, IntentRecord, formPostIntent, hostelId, intentId, invoiceId (+5 more)

### Community 224 - "Community 224"
Cohesion: 0.13
Nodes (16): POST(), GET(), POST(), FeeScheduleCloseInput, feeScheduleCloseSchema, FeeScheduleCreateInput, feeScheduleCreateSchema, feeScheduleListQuerySchema (+8 more)
...
Cohesion: 0.12
Nodes (16): buildHtml(), boundsCenter(), haversineMeters(), HostelWithDistance, KATHMANDU, distance, far, input (+8 more)

### Community 228 - "Community 228"
Cohesion: 0.15
Nodes (14): CommunityPageContent(), FeedPayload, NewPostAlertsToggle(), SidebarPayload, Space, SpacesPayload, CommunitySponsor, CommunitySponsorRail() (+6 more)
...
Cohesion: 0.15
Nodes (14): activateResident(), requestOtp(), signInWithGoogle(), submitResidentReview(), RootStackParamList, Props, ResidentActivationScreen(), styles (+6 more)
...
Cohesion: 0.14
Nodes (15): blankDraft(), clock(), DELAYS, Draft, draftFrom(), MODES, nepalToday(), NoticePush (+7 more)
...
Cohesion: 0.2
Nodes (14): findSuspendedHostelIds(), liftHostelSuspension(), objectIds(), OPEN_WHILE_SUSPENDED, serializeSuspension(), hostelObjectId(), HostelSuspensionError, liftPlatformHostelSuspension() (+6 more)
...
Cohesion: 0.12
Nodes (17): 5.1 Error codes, 5.2 Idempotency key format, 5.3 Audit envelope, 5.4 `ReconciliationRun` for every job, 5.5 Realtime and notifications, 5.6 The read facade, 5.7.1 Invoice status → what the screens display, 5.7.2 Provider → payment method (+9 more)
...
Cohesion: 0.28
Nodes (10): InquiryFields(), hasInquiryErrors(), InquiryDraft, InquiryErrors, normalizePhone(), validateInquiry(), sendHostelInquiry(), sendReferredInquiry() (+2 more)
...
Cohesion: 0.22
Nodes (13): Coordinates, hasLocationPermission(), hasPromptedForLocation(), LocationOutcome, NavigationFix, readPosition(), readPrecisePosition(), rememberLocationPrompt() (+5 more)

### Community 258 - "Community 258"
Cohesion: 0.17
Nodes (11): palette, claimBody(), ClaimNotice, ClaimOutcome, ClaimOutcomeTone, body, long, noSentenceEnd (+3 more)

### Community 259 - "Community 259"
Cohesion: 0.19
Nodes (11): BookingAvailability, BookState, CLOSED_REASONS, open, KNOWN_PATHS, marksRoleChange(), opensPlanBilling(), resolvePushPath() (+3 more)
...
Cohesion: 0.22
Nodes (16): AccountDeletionRequest, code:typescript ({), code:typescript ({), code:typescript (interface IAccountDeletionRequest {), code:block43 (packages/db/migrations/), code:typescript ({), code:typescript (interface IAccountDeletionRequest {), code:block46 (packages/db/migrations/) (+8 more)
...
Cohesion: 0.15
Nodes (11): AuthSession, getResidentProfile(), login(), AppNavigator(), Stack, LoginScreen(), Props, Profile (+3 more)

### Community 267 - "Community 267"
Cohesion: 0.19
Nodes (13): configureNativeNightPrompt(), createAndroidChannels(), easProjectId(), fetchExpoPushToken(), forgetPushToken(), PUSH_CHANNEL, PushPermission, PushRegistration (+5 more)
...
Cohesion: 0.23
Nodes (13): decodeKey(), decryptPersonalData(), encryptionKey(), encryptPersonalData(), isPersonalDataEncryptionConfigured(), personalLookupHash(), resetPersonalDataKeyCache(), envelope (+5 more)
...
Cohesion: 0.15
Nodes (15): 2.3 Hostel Rejected, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails, 4.3 Complaint Resolved (+7 more)
...
Cohesion: 0.26
Nodes (5): Claim, CouldNotCreateFileException, HostelHubDownloadsModule, UnreadableSourceException, UnsupportedOnThisAndroidException
...
Cohesion: 0.22
Nodes (11): getPresignedReadUrl(), claimSecret(), issueDocumentClaimToken(), isValidDocumentClaimToken(), RegistrationDocumentError, SubmittedDocument, GET(), isAssignedProvider() (+3 more)
...
Cohesion: 0.13
Nodes (4): routeMocks, staffPrincipal, routeMocks, staffPrincipal
...
Cohesion: 0.3
Nodes (13): askingEndsAt(), askingEndsMinuteOfNight(), isCurrentNight(), isSameNight(), minuteIsDue(), minuteOfNight(), parsePromptTime(), promptIsDue() (+5 more)

### Community 296 - "Community 296"
Cohesion: 0.19
Nodes (12): nightStatusPromptSchema, formatPromptTime(), nightEndsAt(), HostelRecord, nightAnswerData(), NightStatusPromptResult, PromptCandidate, promptMessage() (+4 more)
...
Cohesion: 0.22
Nodes (11): buildPage(), buildPinPage(), buildShell(), MapExplorer, MapExplorerProps, MapHandle, MapMarker, inlineJson() (+3 more)
...
Cohesion: 0.23
Nodes (12): Engine, FileScore, GOLDEN_DIR, isNear(), main(), ManifestEntry, paceMs(), percent() (+4 more)
...
Cohesion: 0.21
Nodes (10): POST(), listStatementImports(), GET(), POST(), assignOrphanSchema, bulkApproveStatementSchema, STATEMENT_PROVIDERS, StatementImportInput (+2 more)
...
Cohesion: 0.22
Nodes (13): code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface INotice {), code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {), Food, FoodMenu, FoodPhoto (+5 more)

### Community 314 - "Community 314"
Cohesion: 0.31
Nodes (13): AttendanceAlert, AttendanceLog, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({), code:typescript (interface IQuestionCallClick {), Community Feature (+5 more)
...
Cohesion: 0.18
Nodes (13): 7.1 Multi-Tenant Isolation Test Template, 7.2 Role Gate Test Template, 7.3 Privacy/Guardian Permissions Test Template, 7.5 Payment Precision Test Template, 7. Mandatory Test Templates, 9.2 Test Database Isolation, code:typescript (describe('GET /api/v1/hostel/rooms/:id - tenant isolation', ), code:typescript (describe('GET /api/v1/hostel/rooms - role access', () => {) (+5 more)

### Community 318 - "Community 318"
Cohesion: 0.15
Nodes (10): { body, title }, chase, due, first, HOSTEL, late, noAttendanceBlock, noNightStatusKey (+2 more)
...
Cohesion: 0.21
Nodes (9): PATCH(), POST(), RouteContext, GET(), regenerateActivationCode(), activationCodeGenerateSchema, activationCodeSchema, activationStatusQuerySchema (+1 more)
...
Cohesion: 0.18
Nodes (10): CANVAS_NATIVE, dirname, ID_CARD_FONTS, { loadEnvConfig }, nextConfig, repoRoot, require, SECURITY_HEADERS (+2 more)

### Community 347 - "Community 347"
Cohesion: 0.2
Nodes (6): Claim, FinanceView, Invoice, OPEN_STATUSES, Receipt, ResidentOfferProgramPageContent
...
Cohesion: 0.29
Nodes (9): isTerminalStoreOrderStatus(), nextStoreOrderStatuses(), OPEN_STORE_ORDER_STATUSES, STORE_ORDER_STATUS_LABEL, STORE_ORDER_STATUSES, StoreOrderStatus, nonTerminal, terminal (+1 more)
...
Cohesion: 0.18
Nodes (10): 9.1a Account Deletion Request Needs Review *(added 2026-08-02)*, 9.2 Account Deletion Cancelled, 9.3 Location History Deletion Approved, 9. Account & Privacy Emails, Email Opt-In/Opt-Out Matrix, EMAIL_SYSTEM.md — Email Triggers & Templates, Guardian Control, Implementation Checklist (+2 more)

### Community 358 - "Community 358"
Cohesion: 0.2
Nodes (11): 10. Troubleshooting, 4. Local Setup, 5. Commands, 8. Monitoring & Logging, code:json ({ "level": "warn", "action": "public_asset_store_failed", "m), code:bash (node scripts/r2-cors.mjs --apply), code:block3 (https://hostel-management-software-web-*.vercel.app), code:json ({) (+3 more)
...
Cohesion: 0.29
Nodes (7): nightKey(), nightHistory(), NightHistoryEntry, NightHistoryLog, previousNight(), entries, getResidentNightStatusHistory()
...
Cohesion: 0.33
Nodes (7): canRequestDeletion(), DeletionPathway, deletionReasonError(), PATHWAY_COPY, PathwayCopy, error, PATHWAYS
...
Cohesion: 0.31
Nodes (7): HostelRegistrationProgress(), Milestone, milestoneIndex(), MILESTONES, PaymentPanel(), rupees(), SubscriptionState
...
Cohesion: 0.22
Nodes (6): body, [drawn, oldBuild, iphone], fetchMock, [message], mocks, payload

### Community 394 - "Community 394"
Cohesion: 0.25
Nodes (7): DEFAULT_GUARDIAN_PERMISSIONS, guardianInvitationAcceptSchema, guardianInviteSchema, guardianLoginSchema, guardianPermissionsSchema, guardianPermissionsUpdateSchema, objectIdSchema

### Community 395 - "Community 395"
Cohesion: 0.28
Nodes (7): GET(), POST(), BillingRunInput, BillingRunQuery, billingRunQuerySchema, billingRunSchema, periodSchema
...
Cohesion: 0.25
Nodes (9): 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, 3.3 Payment Proof Uploaded (to Admin), code:typescript ({), code:typescript ({), code:typescript ({) (+1 more)

### Community 405 - "Community 405"
Cohesion: 0.22
Nodes (9): 4.1 New Notice Posted, 4.2 Complaint Status Updated, 4. Resident Activity Emails, 5.1 SOS Triggered, 5. Safety & Emergency Emails, code:typescript ({), code:typescript ({), code:typescript ({) (+1 more)
...
Cohesion: 0.22
Nodes (9): 6.1 Multi-Tenant Isolation ⭐ HIGHEST PRIORITY, 6.2 Auth & Account-Upgrade Logic ⭐ CRITICAL, 6.3 Role-Based Access Control (Every Endpoint), 6.4 Payments, 6.5 Privacy-Sensitive Views, 6.6 Business-Rule Constraints, 6.7 Audit Logging, 6. What Must Be Tested (Non-Negotiable) (+1 more)
...
Cohesion: 0.29
Nodes (3): ReturnState, CheckoutReturnPage(), metadata
...
Cohesion: 0.25
Nodes (7): 10. International Data Transfers, 13. Platform Owner Information, 5.1 Security Measures, 5.2 Your Responsibility, 5. Data Security, 9. Children's Privacy, PRIVACY_POLICY.md — Privacy Policy & Data Protection
...
Cohesion: 0.38
Nodes (3): NoContextException, NothingOpensThisException, intent
...
Cohesion: 0.29
Nodes (7): 7.4 Account-Upgrade Test Template, 9.1 Seed Scripts, 9.3 Test Helpers, 9. Test Data & Seeding, code:typescript (describe('POST /api/v1/hostel/residents - account upgrade', ), code:typescript (// tests/helpers/auth.ts), code:typescript (it.each([)
...
Cohesion: 0.5
Nodes (4): 6. Production Deployment (Vercel), Post-Deployment Checks, Prerequisites, Steps
...
## Knowledge Gaps
- **6163 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+6158 more)
...
- **Why does `cn()` connect `Community 24` to `Community 3`, `Community 261`, `Community 390`, `Community 6`, `Community 13`, `Community 17`, `Community 22`, `Community 152`, `Community 26`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 38`, `Community 41`, `Community 302`, `Community 48`, `Community 49`, `Community 50`, `Community 51`, `Community 58`, `Community 59`, `Community 60`, `Community 64`, `Community 67`, `Community 78`, `Community 94`, `Community 95`, `Community 98`, `Community 228`, `Community 112`, `Community 113`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 3` to `Community 1`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 138`, `Community 13`, `Community 16`, `Community 20`, `Community 22`, `Community 23`, `Community 24`, `Community 30`, `Community 35`, `Community 36`, `Community 40`, `Community 45`, `Community 49`, `Community 66`, `Community 73`, `Community 77`, `Community 255`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 19` to `Community 0`, `Community 128`, `Community 2`, `Community 5`, `Community 134`, `Community 10`, `Community 11`, `Community 12`, `Community 396`, `Community 14`, `Community 15`, `Community 140`, `Community 145`, `Community 18`, `Community 147`, `Community 146`, `Community 21`, `Community 151`, `Community 25`, `Community 156`, `Community 28`, `Community 29`, `Community 32`, `Community 163`, `Community 165`, `Community 37`, `Community 39`, `Community 168`, `Community 296`, `Community 170`, `Community 42`, `Community 171`, `Community 43`, `Community 47`, `Community 176`, `Community 177`, `Community 55`, `Community 56`, `Community 59`, `Community 61`, `Community 69`, `Community 70`, `Community 71`, `Community 201`, `Community 74`, `Community 75`, `Community 79`, `Community 80`, `Community 82`, `Community 83`, `Community 84`, `Community 86`, `Community 119`, `Community 89`, `Community 92`, `Community 223`, `Community 96`, `Community 97`, `Community 99`, `Community 100`, `Community 104`, `Community 116`, `Community 117`, `Community 246`, `Community 118`, `Community 122`, `Community 123`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Are the 503 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 503 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `iosUrlScheme`, `{ defineConfig }`, `expoConfig` to the rest of the system?**
  _6163 weakly-connected nodes found - possible documentation gaps or missing edges._
