...
## Corpus Check
- 775 files · ~1,611,100 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5966 nodes · 14754 edges · 295 communities (276 shown, 19 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 248 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 344 edges
2. `successResponse()` - 343 edges
3. `connectToDatabase()` - 210 edges
4. `cn()` - 191 edges
5. `connectToDatabase()` - 176 edges
6. `requireHostelStaffPrincipal()` - 109 edges
7. `requireHostelCapability()` - 107 edges
8. `browserApi()` - 90 edges
9. `requireResidentPrincipal()` - 68 edges
10. `usePortalResource()` - 61 edges
...
## Communities (295 total, 19 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (133): POST(), attacker, attempt(), jsonRequest(), routeMocks, appBaseUrl(), authenticateWithGoogle(), AuthServiceError (+125 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (84): PATCH(), POST(), RouteContext, PATCH(), RouteContext, resolveAttendanceAlert(), attendanceAlertResolveSchema, PlatformAuditLogQueryInput (+76 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (122): fromAddress(), sendEmail(), SendEmailInput, SendEmailResult, addHostelAdminProfilePhoto(), deleteHostelAdminProfilePhoto(), getHostelAdminProfile(), HostelAdminProfileQuery (+114 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (81): GET(), recordConsent(), attendanceListQuerySchema, attendanceSettingsSchema, consentSchema, locationPingSchema, objectIdSchema, POST() (+73 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (78): accountUpgradedEmail(), verificationEmail(), guardianInvitationEmail(), sosAlertEmail(), cookPortalEnabledEmail(), hostelDocumentsRequestedEmail(), hostelApprovedEmail(), hostelPublishedEmail() (+70 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (65): csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, Inquiry, LoadState, Message() (+57 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (71): EMPTY_SUMMARY, HostelAdminComplaintsPage, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine (+63 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (67): Notification, PagerButton(), PublicHostelListingPage(), PublicHostelListingPage(), InquiryPage(), cn(), Alert(), AlertAction() (+59 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (50): GET(), listAttendanceAlerts(), POST(), POST(), GET(), PATCH(), GET(), POST() (+42 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (50): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), field(), LoadState, Message(), NightStatusRow (+42 more)

### Community 10 - "Community 10"
Cohesion: 0.05
Nodes (51): PlatformConfigAnnouncementsPageContent, PlatformConfigFacilitiesPageContent, FLAGS, PlatformConfigFeaturesPageContent, PlatformConfigLegalPageContent, PlatformConfigLocationsPageContent, PlatformConfigPricingPageContent, ConfigCard() (+43 more)
...
Cohesion: 0.04
Nodes (48): auditGuardianAction(), createGuardianAccess(), expiresInDays(), findAdminResident(), getGuardianDashboard(), getGuardianSafetySummary(), GuardianAccessCreateInput, GuardianAccessRecord (+40 more)
...
Cohesion: 0.04
Nodes (45): HostelAdminTransactionsPageContent, Payment, TABS, CreateWardenResult, HostelAdminWardensPage, PERMISSION_LABELS, ComplaintsResponse, PlatformComplaint (+37 more)
...
Cohesion: 0.09
Nodes (47): PRIORITIES, STATUS_ACTIONS, AdminReferral, FILTERS, ReferralsResponse, Overview, Report, field() (+39 more)

### Community 19 - "Community 19"
Cohesion: 0.06
Nodes (53): extractJsonPayload(), parseModelJson(), sanitizeJsonPayload(), VALID_JSON_ESCAPES, buildMessages(), CHAT_ENDPOINTS, ChatCompletionResponse, ChatMessage (+45 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (35): MockSessionModel, serviceMocks, session, user, accessId, guardianId, guardianPrincipal, leanResult() (+27 more)

### Community 21 - "Community 21"
Cohesion: 0.09
Nodes (61): deleteResidentLocationHistory(), getResidentAttendance(), commentOnPost(), createCommunityPost(), deleteOwnPost(), findVisiblePostForResident(), listCommunityFeed(), listCommunityForModeration() (+53 more)

### Community 22 - "Community 22"
Cohesion: 0.1
Nodes (38): GuardianDashboard, EmptyInline(), InitialsAvatar(), MetricCard(), PortalPageHeader(), RoleButton(), SectionCard(), SoftBadge() (+30 more)

### Community 23 - "Community 23"
Cohesion: 0.06
Nodes (41): normalize(), PortalSearch(), PortalTone, scoreEntry(), toneStyles, iconMap, IconName, NavItem (+33 more)
...
Cohesion: 0.06
Nodes (25): HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminFoodPage(), HostelAdminPaymentsPage(), HostelAdminResidentsPage(), redirectToWorkspaceScreen(), HostelAdminMaintenancePageContent() (+17 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (39): authorUserId, mocks, postId, residentId, residentPrincipal, staffPrincipal, AnnouncementInput, CommentCreateInput (+31 more)
...
Cohesion: 0.06
Nodes (30): GET(), POST(), POST(), dayOfWeekSchema, foodFeedbackSchema, foodMenuCreateSchema, foodMenuListQuerySchema, foodMenuUpdateSchema (+22 more)

### Community 30 - "Community 30"
Cohesion: 0.1
Nodes (38): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, dayKey(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus() (+30 more)
...
Cohesion: 0.07
Nodes (32): referralSchema, referralCodeSchema, referralRewardSchema, auditReferralAction(), confirmReferralJoined(), createReferredInquiry(), HostelAdminReferralListQuery, listHostelAdminReferrals() (+24 more)

### Community 34 - "Community 34"
Cohesion: 0.09
Nodes (36): getHostelViewStats(), maintenanceRequestSchema, paymentProofSchema, averageResolutionDays(), bucketBoundaries(), collectionRate(), countByField(), CountingModel (+28 more)
...
Cohesion: 0.07
Nodes (34): listHostelAdminInquiries(), listPublicHostels(), inquiryId, serviceMocks, staffPrincipal, BedCreateInput, BedRecord, BedUpdateInput (+26 more)

### Community 37 - "Community 37"
Cohesion: 0.06
Nodes (25): currency(), StatusBadge(), ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent, Complaint, field() (+17 more)
...
Cohesion: 0.08
Nodes (32): announceFoodReady(), cookEmailForSlug(), CookPortalUpdateInput, CookServiceError, FoodReadyInput, generatePassword(), getCookPortalSettings(), HostelSettingsRecord (+24 more)
...
Cohesion: 0.07
Nodes (25): csvField(), field(), Hostel, HostelAdminInquiriesPageContent(), Inquiry, LoadState, numberField(), optionalField() (+17 more)
...
Cohesion: 0.08
Nodes (24): assertHostelAccess(), canAccessHostel(), hostelScopedFilter(), TenantAccessError, TenantPrincipal, depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema (+16 more)

### Community 46 - "Community 46"
Cohesion: 0.08
Nodes (26): auditLogSchema, noticeReadStatusSchema, mocks, noticeInput, residentUserId, staffPrincipal, auditNoticeAction(), broadcastNotice() (+18 more)

### Community 47 - "Community 47"
Cohesion: 0.07
Nodes (23): emergencyContactSchema, incidentLogSchema, manualStatusOverrideSchema, nightStatusLogSchema, sosAlertSchema, EmergencyContactRecord, findAdminResident(), listAdminNightStatus() (+15 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (21): AUDIT_ACTIVITY, AuditLog, CHART_LABELS, MetricTrend, PLACEHOLDER_OWNERS, PLACEHOLDER_PLANS, PlatformDashboardReport, PlatformPayment (+13 more)
...
Cohesion: 0.1
Nodes (27): hostelMemberSchema, auditWardenAction(), createHostelWarden(), deactivateHostelWarden(), findScopedWarden(), HostelMemberRecord, hydrateUser(), MemberStatus (+19 more)
...
Cohesion: 0.12
Nodes (29): addHistory(), addMaintenanceComment(), assertBedInHostel(), assertProviderApproved(), assertRoomInHostel(), auditMaintenanceAction(), BedRecord, createMaintenanceRequest() (+21 more)
...
Cohesion: 0.09
Nodes (20): attendanceOverrideSchema, GET(), POST(), PATCH(), RouteContext, nightStatusListQuerySchema, nightStatusOverrideSchema, nightStatusSchema (+12 more)
...
Cohesion: 0.08
Nodes (19): LegacyHostelAdminComplaintsPage(), Complaint, ComplaintSummary, field(), FoodMenu, HostelAdminComplaintsPage(), HostelAdminNoticesPage(), LoadState (+11 more)

### Community 62 - "Community 62"
Cohesion: 0.1
Nodes (17): inferKind(), LightboxItem, MediaLightbox(), CATEGORY_LABELS, NEARBY_GROUPS, PublicReview, PublicReviewData, RoomCard (+9 more)
...
Cohesion: 0.09
Nodes (16): Input(), field(), ListingFlag, LoadState, MaintenanceRequest, optionalField(), optionalNumber(), PlatformListingFlagsPageContent() (+8 more)
...
Cohesion: 0.15
Nodes (20): FileUploadArea(), acceptAttribute(), EXTENSION_BY_MIME, formatBytes(), joinTypes(), KIND_RULES, KindRule, labelsFor() (+12 more)

### Community 71 - "Community 71"
Cohesion: 0.09
Nodes (15): AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, CachedConnection, globalForMongoose, candidateRoots (+7 more)

### Community 72 - "Community 72"
Cohesion: 0.11
Nodes (14): ApiPrincipal, deviceTokenSchema, notificationSchema, residentSchema, DeviceTokenSaveInput, markNotificationRead(), NotificationRecord, NotificationServiceError (+6 more)
...
Cohesion: 0.14
Nodes (20): userResidentProfileSchema, ageFromDateOfBirth(), generateResidentId(), getResidentIdentity(), getResidentIdentityQr(), lookupResidentProfile(), mintResidentId(), normalizeResidentId() (+12 more)
...
Cohesion: 0.1
Nodes (20): 2026-07-21 session — what was done, 2026-07-23 session — Phase 3, what was done, Bugs & Fixes, code:typescript (// WRONG - client controls hostelId), Completed Work, Context Needed for Future Chats, Cook credentials — locked decisions (2026-07-23), Critical Architecture Patterns (+12 more)
...
Cohesion: 0.13
Nodes (14): PATCH(), POST(), GET(), monthlyPaymentGenerateSchema, monthSchema, objectIdSchema, paymentCreateSchema, paymentListQuerySchema (+6 more)
...
Cohesion: 0.15
Nodes (13): AuthSession, getResidentProfile(), triggerSOS(), AppNavigator(), RootStackParamList, Stack, LoginScreen(), Props (+5 more)

### Community 96 - "Community 96"
Cohesion: 0.12
Nodes (14): HostelTable(), ACTION_CONFIG, ActionKey, ACTIONS, HostelDetail, isAwaitingApproval(), isAwaitingKyc(), matchesTab() (+6 more)

### Community 97 - "Community 97"
Cohesion: 0.11
Nodes (19): [0.3.1] - 2026-07-21 — Phase 1 code-side completion, Added, Added, Added, Added, Added, Changed, Changed (+11 more)
...
Cohesion: 0.14
Nodes (15): activateResident(), apiRequest(), getActivationStatus(), listNotifications(), login(), markNotificationRead(), NotificationItem, refreshSession() (+7 more)
...
Cohesion: 0.12
Nodes (16): 10. Background/Scheduled Jobs, 11. Deployment Architecture, 12. MongoDB Collection Structure (High-Level), 13.1 60-Day Grace Period, 13.2 What Gets Deleted, 13. Account Deletion & Data Retention Architecture, 1. Final Tech Stack (decision locked), 2. Multi-Tenancy Model (+8 more)

### Community 107 - "Community 107"
Cohesion: 0.12
Nodes (17): [0.3.0] - 2026-07-20 — Phase 1 alignment (in progress, ~90%), Added, Added, Added, Added, Added, Changed, Changed (+9 more)

### Community 108 - "Community 108"
Cohesion: 0.19
Nodes (17): AuditLog, code:typescript (interface IHostelPageView {), code:typescript (interface IReferral {), code:typescript (interface INotification {), code:typescript (interface ISubscription {), code:typescript (interface IPlatformSetting {), code:typescript (interface IAuditLog {), HostelPageView (+9 more)
...
Cohesion: 0.16
Nodes (11): requestOtp(), signInWithGoogle(), submitResidentReview(), Props, ResidentActivationScreen(), styles, Props, ResidentReviewsScreen() (+3 more)
...
Cohesion: 0.25
Nodes (10): cook, destinationForRole(), isAllowedNextPath(), isHostelWorkspacePath(), isSafeLocalPath(), ProtectedRouteRule, protectedRouteRuleForPath(), protectedRouteRules (+2 more)
...
Cohesion: 0.2
Nodes (14): AccountDeletionRequest, code:typescript (interface IQuestionCallClick {), code:typescript ({), code:typescript ({), code:typescript (interface IAccountDeletionRequest {), code:block45 (packages/db/migrations/), code:block46 (packages/db/migrations/), Consent & Privacy (+6 more)
...
Cohesion: 0.18
Nodes (13): [0.5.2] - 2026-07-23 — Cook credential hand-off + dashboard visibility, [0.6.0] - 2026-08-01 — Phases 1-3 closed out, [0.7.0] - 2026-08-01 — Phase 4: Trust, Safety & Guardian, Added, Added, Changed, Changed, Changed (+5 more)

### Community 130 - "Community 130"
Cohesion: 0.24
Nodes (13): AttendanceAlert, AttendanceLog, code:typescript (interface INotification {), code:typescript (interface INotificationReceipt {), code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({), FoodReadyLog (+5 more)
...
Cohesion: 0.18
Nodes (10): Attendance maintenance (absence alerts + retention purge), Authentication, Complaint SLA breach check, cron-job.org setup (per job), CRON.md — Scheduled Jobs, Endpoints, Payment reminders and overdue chases, Purge expired OTP challenges (+2 more)

### Community 140 - "Community 140"
Cohesion: 0.29
Nodes (11): code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({), Community Feature, CommunityComment, CommunityPost, CommunityReaction (+3 more)
...
Cohesion: 0.22
Nodes (9): [0.3.2] - 2026-07-21 — Infra: R2, email, cron (patterns ported from QuestionCall), Added, Added, Added, Added, Changed, Changed, Changed (+1 more)
...
Cohesion: 0.28
Nodes (9): Attendance / Night Safety, code:typescript (interface INightStatusLog {), code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), Food, FoodMenu, FoodPhoto, FoodRoutine (+1 more)
...
Cohesion: 0.25
Nodes (8): [0.5.1] - 2026-07-23 — Cook credentials at approval + shared-credential hardening, Added, Added, Added, Changed, Changed, Changed, Known gap
...
Cohesion: 0.29
Nodes (7): [0.4.0] - 2026-07-22 — Phase 2: Public discovery + hostel core (gap completion), Added, Added, Added, Changed, Changed, Changed

### Community 199 - "Community 199"
Cohesion: 0.29
Nodes (7): [0.2.0] - 2026-07-14 (Late), Added, Added, Added, Added, Added, Added

### Community 200 - "Community 200"
Cohesion: 0.29
Nodes (7): [0.5.0] - 2026-07-23 — Phase 3: Resident system (gap completion), Added, Added, Added, Changed, Changed, Changed
...
Cohesion: 0.4
Nodes (5): 10.1 Community Admin (Hostel Admin / Warden), 10.1 Community Posts, 10.2 Community Comments, 10.3 Community Admin (Hostel Admin/Warden), 10. Community Feature
...
## Knowledge Gaps
- **2145 isolated node(s):** `AuthUser`, `ResidentSummary`, `ResidentFoodRoutine`, `ApiSuccess`, `ApiFailure` (+2140 more)
...
- **Why does `Role` connect `Community 20` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 138`, `Community 12`, `Community 17`, `Community 24`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 32`, `Community 35`, `Community 36`, `Community 39`, `Community 43`, `Community 44`, `Community 45`, `Community 46`, `Community 175`, `Community 50`, `Community 53`, `Community 56`, `Community 59`, `Community 194`, `Community 102`, `Community 103`, `Community 111`, `Community 120`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `browserApi()` connect `Community 9` to `Community 5`, `Community 6`, `Community 7`, `Community 10`, `Community 11`, `Community 14`, `Community 15`, `Community 18`, `Community 22`, `Community 151`, `Community 25`, `Community 28`, `Community 31`, `Community 37`, `Community 42`, `Community 43`, `Community 173`, `Community 48`, `Community 61`, `Community 62`, `Community 192`, `Community 65`, `Community 67`, `Community 85`, `Community 86`, `Community 96`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 7` to `Community 5`, `Community 6`, `Community 9`, `Community 10`, `Community 11`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 22`, `Community 23`, `Community 25`, `Community 28`, `Community 37`, `Community 43`, `Community 173`, `Community 48`, `Community 61`, `Community 62`, `Community 66`, `Community 70`, `Community 96`, `Community 99`, `Community 124`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Are the 205 inferred relationships involving `connectToDatabase()` (e.g. with `POST()` and `requireHostelCapability()`) actually correct?**
  _`connectToDatabase()` has 205 INFERRED edges - model-reasoned connections that need verification._
