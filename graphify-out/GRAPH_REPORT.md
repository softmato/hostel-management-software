...
## Corpus Check
- 1944 files · ~3,332,358 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15425 nodes · 42582 edges · 526 communities (502 shown, 24 thin omitted)
...
## Communities (526 total, 24 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (163): ICONS, LABELS, Segment, TONES, FILTERS, Pending, MoneyData, MANAGE_ROWS (+155 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (249): loadOverview(), loadMoney(), loadToday(), DAY_LABELS, DayStrip(), MEAL_ICONS, MealCard(), RoutineMeal (+241 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (151): PlanPaymentClaim, deferLoad(), DemoDataBadge(), Hostel, HostelTable(), Inquiry, LoadState, Message() (+143 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (189): AdminTabs(), HIDDEN, TABS, AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), Scanner(), FaqRow() (+181 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (157): PATCH(), POST(), GET(), POST(), PATCH(), POST(), POST(), DELETE() (+149 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (140): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel() (+132 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (162): AttendanceScreen(), BootGate(), BrandSplash(), DocumentScreen(), MobileLegal, AuthDivider(), GoogleSignInButton(), InfoActions() (+154 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (168): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, dayKey(), overrideAttendance(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintStatus() (+160 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (178): getOpenFeeSchedule(), getFoodRoutinesByHostelId(), serializeRoutine(), addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery, HostelAdminInquiryStatusInput (+170 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (142): ConfirmOptions, HostelPreviewLink(), blankRow(), Row, TeamInviteBox(), MemberActions(), Props, TeamMembersTable() (+134 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (142): POST(), attacker, attempt(), headers, jsonRequest(), routeMocks, appBaseUrl(), authenticateWithGoogle() (+134 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (142): HostelAdminAttendancePageContent, HostelAdminCommunityPageContent, EMPTY_SUMMARY, HostelAdminComplaintsPage, HostelAdminCooksPanel, HostelAdminFeePlansPageContent, FeeSchedule, formatDate() (+134 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (151): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+143 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (132): AuditLogRecord, PlatformAuditLogQuery, RefRecord, listPlatformHostels(), PaginationMeta, PaginationQuery, paginationQuerySchema, paginationRange() (+124 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (142): PaymentMonthStrip(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard(), AmountCard(), AdminLedger (+134 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (135): Badge(), grabDocument(), HostelAdminBillingPageContent(), InvoiceRow(), PaymentRow(), PlanCard(), rupees(), shortDate() (+127 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (91): recordConsent(), attendanceListQuerySchema, attendanceOverrideSchema, attendanceSettingsSchema, consentSchema, locationPingSchema, objectIdSchema, getPlanPaymentInstructions() (+83 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (109): AdminAlertsScreen(), AdminCommunityScreen(), AdminHomeScreen(), AdminOverviewScreen(), Overview, AdminTodayScreen(), HOSTEL, MONTHS (+101 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (93): GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, CITY_OPTIONS (+85 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (124): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, TXN_ID_ALIASES, WITHDRAWAL_ALIASES (+116 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (95): GET(), POST(), GET(), POST(), GET(), readReturnState(), ownerIdentitiesFor(), resolveOwnedHostel() (+87 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (91): Choice, HOSTEL_TYPE_LABELS, MapButton(), MapCanvas, ModeTab(), NavigationPanel(), NOTHING_CHOSEN, PublicMapPage() (+83 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (96): POST(), GET(), POST(), PATCH(), RouteContext, POST(), RouteContext, DELETE() (+88 more)

### Community 23 - "Community 23"
Cohesion: 0.08
Nodes (72): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), subscriptionClaimReceivedEmail(), subscriptionClaimRejectedEmail() (+64 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (103): NightStatusForm(), ProfileScreen(), ReferralRow(), DeletionPanel(), AlertRow(), CheckoutStatusScreen(), methodProvider(), SubscriptionDueCard() (+95 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (99): AdminMoneyScreen(), AdminAlertsContext, AdminAlertsValue, AlertActions, AlertCard(), EMPTY_COUNTS, ICONS, LABELS (+91 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (83): summarizeResidentComplaints(), latestInvoicePerResident(), listResidentInvoices(), dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput (+75 more)
...
Cohesion: 0.03
Nodes (88): ReviewForm(), ReviewScreen(), describeGrants(), GuardianRow(), PermissionSheet(), InviteGuardianScreen(), readApiErrorCode(), daysUntil() (+80 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (66): RouteContext, attendanceAlertResolveSchema, listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), getPlatformSubscriptionLedger(), listPlanPaymentClaims() (+58 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (87): GET(), POST(), querySchema, RouteContext, AnnouncementInput, CommentCreateInput, commentOnPost(), CommentRecord (+79 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (92): demoteToPublicAccount(), CapacityError, claimBedForRoomType(), listAllRoomTypes(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary() (+84 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (81): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), PROVIDER_LABEL, QrPanel(), InvoiceDetailScreen() (+73 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (83): AdminCommunityReportsScreen(), NightStatusScreen(), ReferralsScreen(), NotificationSettings(), SORTS, StoreCategoryScreen(), CommunityPostScreen(), ComplaintDetailScreen() (+75 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (45): InlineText(), PlanMark(), RAFTER, RIDGE, ROWS, EASE, listHeadingFor(), PlanCards() (+37 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (73): PRIORITIES, STATUS_ACTIONS, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel, GatewayConfig, GatewayHealthStatus (+65 more)
...
Cohesion: 0.05
Nodes (84): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), openCheckoutSession(), OpenedCheckout, readSettledReceipt(), SettledReceipt, deliver() (+76 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (82): DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), monthLabel(), collectionTotals(), countInvoicesByField() (+74 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (58): ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, RETAINED_BY_HOSTEL_ID, both, covered (+50 more)

### Community 41 - "Community 41"
Cohesion: 0.03
Nodes (79): fromBs(), gregorianOf(), BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary (+71 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (71): cookLoginStem(), generateCookPassword(), mintCookLogin(), pick(), previousCookLabel(), cookPrincipal, mocks, acceptCookInvitation() (+63 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (72): FILTERS, NotificationCard(), NotificationRow(), NotificationsScreen(), TILE_GLYPH, TILE_TONES, REALTIME_TOPIC_VALUES, RealtimeTopic (+64 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (68): GATEWAY_ORDER, getHostelPayMethods(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice() (+60 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (62): approveClaim(), assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck(), evidenceCheck(), fileCheck() (+54 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (61): GET(), resolvePastedLink(), searchCandidates(), geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), lookupLocation() (+53 more)

### Community 47 - "Community 47"
Cohesion: 0.03
Nodes (46): adminPrincipal, mocks, PLATFORM_LIMITS, mocks, readable, selectable, base, entityId (+38 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (55): CSV_COLUMNS, GET(), POST(), safeEqual(), GET(), periodTotals(), csvCell(), csvFilename() (+47 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (45): ComparePage(), hostels, metadata, rows, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), PlatformDashboardPageContent(), PlatformHostelReviewPageContent() (+37 more)
...
Cohesion: 0.07
Nodes (50): POST(), RouteContext, cookieAccessToken(), isRole(), loadApiPrincipal(), isFileAssetKind(), isFinancialAssetKind(), DEFAULT_DOCUMENT_MIME_TYPES (+42 more)
...
Cohesion: 0.04
Nodes (51): PortalDates, useSiteConfig(), AdminNightStatusRow, PlanBilling, PlanBillingInvoice, PlanBillingPayment, PlanBillingPlan, filterRollCall() (+43 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (60): publicHostelApplicationCreateSchema, documents, hostelForm(), many, parsed, result, buildHostelPayload(), capacitySummary() (+52 more)

### Community 56 - "Community 56"
Cohesion: 0.05
Nodes (51): escapeRegex(), objectIdSchema, paginationSchema, phoneSchema, notifyStaffOfJobProgress(), SERVICE_PROVIDER_CATEGORIES, serviceProviderSchema, serviceProviderApplicationSchema (+43 more)
...
Cohesion: 0.04
Nodes (44): metadata, CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+36 more)

### Community 59 - "Community 59"
Cohesion: 0.08
Nodes (37): POST(), POST(), verifyEmailWithToken(), POST(), POST(), RouteContext, POST(), runBillingCycleForAllHostels() (+29 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (56): Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity(), fromHeaderFor() (+48 more)
...
Cohesion: 0.05
Nodes (52): classifyCredit(), CreditClassification, findOrphanClaims(), LadderClaim, LadderInvoice, loadMatchContext(), MatchContext, normalizeTxnId() (+44 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (39): listHostelAdminInquiries(), hostelAdminInquiryListQuerySchema, hostelAdminInquiryStatusSchema, hostelPhotoCreateSchema, hostelRejectSchema, hostelResubmitDocumentsSchema, hostelTypeSchema, hostelUnpublishSchema (+31 more)

### Community 64 - "Community 64"
Cohesion: 0.07
Nodes (54): renderIdCardPng(), getPresignedReadUrl(), userResidentProfileSchema, LEGACY_ROLE_MAP, Role, ROLE_VALUES, CARD_LABELS, formatIssuedOn() (+46 more)
...
Cohesion: 0.06
Nodes (52): alreadyReviewedError(), approvePaymentProof(), assertProofIsPending(), auditPaymentAction(), computeMonthlyDue(), createPaymentRecord(), creditVerifiedAmount(), currentMonth() (+44 more)
...
Cohesion: 0.06
Nodes (38): AuthGuard(), HostelSuggestions(), checkOnly(), EMPTY_PREFILL, ENVIRONMENT_OPTIONS, IdentityResponse, Prefill, Step (+30 more)
...
Cohesion: 0.06
Nodes (26): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminSOSAlertsPage(), HostelAdminResidentsPage(), redirectToWorkspaceScreen(), HostelAdminReferralsPageContent(), HostelAdminReportsPageContent() (+18 more)
...
Cohesion: 0.08
Nodes (42): JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, ProviderJobScreen(), listProviderJobs() (+34 more)

### Community 74 - "Community 74"
Cohesion: 0.07
Nodes (46): Guidance, GuidanceStatus, useGuidance(), haversineMeters(), NavigationFix, watchDeviceHeading(), watchNavigationPosition(), cardinalFor() (+38 more)

### Community 75 - "Community 75"
Cohesion: 0.07
Nodes (40): Notification, BrowserPushRow(), FILTERS, Notification, NotificationRow(), PushState, FILTERS, NotificationCard (+32 more)

### Community 76 - "Community 76"
Cohesion: 0.04
Nodes (47): TIER_TONE, ListingTierTone, Plan, PlanId, portalAccessLines(), Service, ServiceModule, ServiceModuleId (+39 more)

### Community 77 - "Community 77"
Cohesion: 0.05
Nodes (37): CurrentUser, DASHBOARD_ROLES, dashboardHrefForRole(), hasDashboard(), MeResponse, moreItems, navItems, providerNavItems (+29 more)

### Community 78 - "Community 78"
Cohesion: 0.07
Nodes (47): BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsPeriodBounds(), bsPeriodOf(), currentBsPeriod() (+39 more)

### Community 79 - "Community 79"
Cohesion: 0.06
Nodes (37): GET(), GET(), querySchema, POST(), dayOfWeekSchema, foodFeedbackSchema, foodMenuCreateSchema, foodMenuListQuerySchema (+29 more)

### Community 80 - "Community 80"
Cohesion: 0.05
Nodes (36): auditFinanceAction(), FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), computeCreditAmount(), findingSchema, reconciliationRunSchema, checkAuditChain() (+28 more)

### Community 81 - "Community 81"
Cohesion: 0.07
Nodes (43): storeOrderSchema, mocks, allocateOrderNumber(), applyStatus(), CancelInput, cancelOrder(), CreateInput, getOrder() (+35 more)
...
Cohesion: 0.07
Nodes (39): notifyResidentOfComplaintReply(), addComplaintUpdate(), assertComplaintVoiceNote(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren() (+31 more)
...
Cohesion: 0.08
Nodes (44): AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance(), deadline(), DIGIT_CONFUSABLES, EvidenceRead (+36 more)

### Community 89 - "Community 89"
Cohesion: 0.08
Nodes (43): money(), PlanCard(), softmatoDocsUrl(), BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan, CYCLE_LABELS (+35 more)
...
Cohesion: 0.07
Nodes (32): buildFormPostHandoff(), FormPostHandoff, HandoffError, IntentRecord, formPostIntent, hostelId, intentId, invoiceId (+24 more)
...
Cohesion: 0.1
Nodes (38): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags(), documentFlags() (+30 more)

### Community 98 - "Community 98"
Cohesion: 0.08
Nodes (35): drawCertificationStamp(), footerLine(), formatDate(), formatLongDate(), MONTHS, ReceiptPdfInput, renderReceiptPdf(), renderStatementPdf() (+27 more)

### Community 99 - "Community 99"
Cohesion: 0.09
Nodes (30): isAuthBypassEnabled(), original, cook, assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES, PermissionError (+22 more)

### Community 100 - "Community 100"
Cohesion: 0.08
Nodes (31): afterResponse(), mocks, work, CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, readId(), activeDevicesFor() (+23 more)
...
Cohesion: 0.08
Nodes (28): dayLabel(), foodFacts(), leadDay(), ROUTINE_DAYS, ROUTINE_MEALS, RoutineDay, routineDays(), days (+20 more)
...
Cohesion: 0.07
Nodes (32): getResidentFinanceView(), HostelLedger, HostelLedgerEntry, InvoiceMatrix, InvoiceMatrixRow, listResidentClaims(), NotBilled, PortalInvoice (+24 more)
...
Cohesion: 0.06
Nodes (36): 1.1 Confirm EAS is signing with the keystore we already committed to, 1.2 Push notifications need the FCM key on EAS, 1. Before the first build, 2.1 Android APK — install and test, 2.2 iOS — install and test, 2.3 Store artefacts — only when the tested build is good, 2. The builds, 3.1 What it is (+28 more)
...
Cohesion: 0.1
Nodes (26): loadSiteConfig, loadSiteName(), platformSettingSchema, getListingTier(), getService(), listingTiers(), DEFAULT_PLANS, DEFAULT_SITE_CONFIG (+18 more)
...
Cohesion: 0.07
Nodes (26): EvidenceEngine, EvidenceEngineMode, EvidenceReadFailure, OcrResult, OcrWord, KEYS, saved, IMAGE (+18 more)
...
Cohesion: 0.07
Nodes (29): addBsMonths(), bsPeriodsBetween(), august, bhadra, dateAgo(), hostelId, invoice(), mocks (+21 more)
...
Cohesion: 0.1
Nodes (25): RootShell(), AssetViewer(), useViewerState(), BottomChrome, BottomChromeContext, BottomChromeProvider(), CHROME_TIMING, UploadToaster() (+17 more)
...
Cohesion: 0.09
Nodes (27): AcceptPlatformAdminInvitationInput, appUrl(), checkPlatformAdminEmail(), daysFromNow(), EmailAvailability, EmailAvailabilityResult, hashToken(), INVITABLE_ROLES (+19 more)
...
Cohesion: 0.07
Nodes (20): LoadingRows(), Panel(), StatusBadge(), field(), HostelAdminMaintenancePageContent(), ListingFlag, LoadState, MaintenanceRequest (+12 more)

### Community 122 - "Community 122"
Cohesion: 0.1
Nodes (25): NearbyStatus, Coordinates, HostelWithDistance, isUsableCoordinate(), KATHMANDU, sortByDistance(), distance, far (+17 more)

### Community 123 - "Community 123"
Cohesion: 0.07
Nodes (21): csvField(), field(), Hostel, HostelAdminRoomsPageContent(), Inquiry, LoadState, numberField(), optionalField() (+13 more)
...
Cohesion: 0.15
Nodes (26): announceFoodReady(), startOfToday(), Candidate, dueMeals(), MealCallReminderResult, mealLabel(), RoutineRecord, runMealCallReminders() (+18 more)
...
Cohesion: 0.15
Nodes (26): CARD_NOUNS, CardVariant, drawBack(), drawBrandLockup(), drawFooterSweep(), drawFront(), drawHeaderSweep(), drawIdCard() (+18 more)
...
Cohesion: 0.11
Nodes (21): accessToken(), annotateUrl(), assertion(), base64url(), billingPeriod(), boxOf(), isVisionConfigured(), readWithVision() (+13 more)
...
Cohesion: 0.1
Nodes (26): Attendance / Night Safety, Build status (end of Phase 3), Build status (end of Phase 5 — verified 2026-08-02), code:typescript (export enum Role {), code:typescript (interface INightStatusLog {), code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface INotice {) (+18 more)
...
Cohesion: 0.14
Nodes (22): bsMonthStart(), hostelCalendarDay(), hostelToday(), rateForRoomType(), hostelCalendarDay(), hostelMonthStart(), hostelPeriodOf(), hostelToday() (+14 more)

### Community 145 - "Community 145"
Cohesion: 0.11
Nodes (17): computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, SystemDocumentKind, base, ImageVariantRecord (+9 more)
...
Cohesion: 0.2
Nodes (24): assertMatchesExtension(), downloadAndShare(), downloadAndShareCsv(), downloadAndShareImage(), downloadToDevice(), forgetDownloadFolder(), LegacyFileSystem, loadLegacyFileSystem() (+16 more)

### Community 149 - "Community 149"
Cohesion: 0.09
Nodes (21): useRealtime(), connectRealtime(), fetchConfig(), PusherModule, REALTIME_EVENT, RealtimeConfig, RealtimeConnection, RealtimeHandlers (+13 more)
...
Cohesion: 0.12
Nodes (21): UploadCard(), dismissUpload(), listeners, pruneUploads(), resetUploadQueue(), rows, sweepUploads(), afterSuccessLinger (+13 more)
...
Cohesion: 0.13
Nodes (17): DeliveryPromise, formatHour(), DEFAULT_STORE_CONFIG, PlatformSettingRecord, saveStoreConfig(), StoreConfig, storeConfigSchema, CartTotals (+9 more)
...
Cohesion: 0.12
Nodes (17): buildHtml(), Marker, PlaceMarker, boundsCenter(), hostelCoordinates(), groupNearbyPlaces(), humanizeNearbyType(), NEARBY_GLYPHS (+9 more)

### Community 168 - "Community 168"
Cohesion: 0.09
Nodes (19): aswin, bhadra, bs(), card(), currentId, hostelId, inAswin, inOctober (+11 more)
...
Cohesion: 0.13
Nodes (17): feeUpdateSchema, SetResidentFeeInput, setResidentMonthlyFee(), POST(), GET(), generateMonthlyPayments(), getMonthlyPaymentMatrix(), resolveAdminHostelId() (+9 more)
...
Cohesion: 0.15
Nodes (18): Choice, Compass(), maneuverIcon(), MapButton(), ModeTab(), NavCard(), NOTHING_CHOSEN, RouteCard() (+10 more)
...
Cohesion: 0.13
Nodes (18): appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind, creditOverpayment(), getCreditAmount(), getCreditBalance(), isDuplicateKey() (+10 more)
...
Cohesion: 0.15
Nodes (14): login(), register(), triggerSOS(), verifyOtp(), RootStackParamList, LoginScreen(), Props, OtpVerificationScreen() (+6 more)
...
Cohesion: 0.13
Nodes (14): draftFromProfile(), emptyIdentityDraft(), hasIdentityErrors(), IdentityDraft, card, draft, errors, owner (+6 more)
...
Cohesion: 0.18
Nodes (15): findIndex(), index, indexesOf(), IndexSpec, promote, INVOICE_STATUSES, event, FROZEN_EVENT_FIELDS (+7 more)
...
Cohesion: 0.14
Nodes (17): 2.3 Hostel Rejected, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, 4.2 Complaint Status Updated, 4.3 Complaint Resolved (+9 more)
...
Cohesion: 0.12
Nodes (15): BLOOD_GROUPS, clearIdentityPhoto(), DIETARY_PREFERENCES, DietaryPreference, GENDERS, getIdentity(), getIdentityQr(), GOVERNMENT_ID_TYPES (+7 more)
...
Cohesion: 0.13
Nodes (12): storeCategorySchema, storeProductSchema, categoriesFor(), escapeRegex(), getStoreShelves(), ListQuery, SORTS, StoreCategoryRecord (+4 more)
...
Cohesion: 0.15
Nodes (14): apiRequest(), confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listResidentComplaints(), refreshSession(), requestOtp(), ResidentComplaint (+6 more)

### Community 237 - "Community 237"
Cohesion: 0.15
Nodes (11): activateResident(), AuthSession, getResidentProfile(), AppNavigator(), Stack, Props, ResidentActivationScreen(), styles (+3 more)
...
Cohesion: 0.14
Nodes (13): BLOOD_OPTIONS, DIET_OPTIONS, EditIdentityScreen(), GENDER_OPTIONS, ID_TYPE_OPTIONS, IdentityForm(), OCCUPATION_OPTIONS, idCardNoun() (+5 more)
...
Cohesion: 0.18
Nodes (12): buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, OCCUPATION_LABELS, phoneError(), validateIdentity() (+4 more)
...
Cohesion: 0.19
Nodes (9): DEFAULT_GUARDIAN_PERMISSIONS, guardianAccessCreateSchema, guardianInvitationAcceptSchema, guardianInviteSchema, guardianLoginSchema, guardianPermissionsSchema, guardianPermissionsUpdateSchema, objectIdSchema (+1 more)
...
Cohesion: 0.2
Nodes (7): PlatformHostelsPageContent(), PlatformHostelsPageContent, PortalPlaceholderAction, PortalPlaceholderPage(), PortalPlaceholderPageProps, GuardianScreenPageProps, PlatformScreenPageProps
...
Cohesion: 0.33
Nodes (12): AttendanceAlert, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({), code:typescript (interface IQuestionCallClick {), code:typescript ({), Community Feature (+4 more)
...
Cohesion: 0.18
Nodes (6): HostelAdminProfilePageContent(), emptyForm, HostelProfile, LegacyHostelAdminProfilePage(), ProfileData, ProfileForm
...
Cohesion: 0.24
Nodes (7): RouteContext, GET(), regenerateActivationCode(), activationCodeGenerateSchema, activationCodeSchema, activationStatusQuerySchema, objectIdSchema
...
Cohesion: 0.22
Nodes (9): 7.2 Role Gate Test Template, 9.1 Seed Scripts, 9.2 Test Database Isolation, 9.3 Test Helpers, 9. Test Data & Seeding, code:typescript (describe('GET /api/v1/hostel/rooms - role access', () => {), code:typescript (describe('POST /api/v1/hostel/residents - account upgrade', ), code:typescript (// tests/helpers/auth.ts) (+1 more)
...
Cohesion: 0.33
Nodes (7): 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, code:typescript ({), code:typescript ({), code:block14 (---)
...
## Knowledge Gaps
- **5418 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+5413 more)
...
- **Why does `Button()` connect `Community 0` to `Community 1`, `Community 258`, `Community 3`, `Community 2`, `Community 5`, `Community 6`, `Community 9`, `Community 11`, `Community 14`, `Community 24`, `Community 25`, `Community 27`, `Community 28`, `Community 29`, `Community 33`, `Community 174`, `Community 46`, `Community 58`, `Community 61`, `Community 70`, `Community 75`, `Community 82`, `Community 240`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 9` to `Community 0`, `Community 2`, `Community 5`, `Community 11`, `Community 141`, `Community 15`, `Community 271`, `Community 18`, `Community 21`, `Community 27`, `Community 35`, `Community 37`, `Community 49`, `Community 50`, `Community 58`, `Community 61`, `Community 65`, `Community 67`, `Community 68`, `Community 75`, `Community 76`, `Community 77`, `Community 89`, `Community 113`, `Community 119`, `Community 121`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 39` to `Community 1`, `Community 4`, `Community 5`, `Community 134`, `Community 6`, `Community 10`, `Community 11`, `Community 14`, `Community 15`, `Community 16`, `Community 143`, `Community 18`, `Community 19`, `Community 17`, `Community 23`, `Community 30`, `Community 36`, `Community 37`, `Community 166`, `Community 40`, `Community 46`, `Community 55`, `Community 57`, `Community 58`, `Community 69`, `Community 78`, `Community 91`, `Community 92`, `Community 94`, `Community 110`, `Community 245`, `Community 246`, `Community 117`, `Community 124`, `Community 126`?**
...
- **What connects `iosUrlScheme`, `{ defineConfig }`, `expoConfig` to the rest of the system?**
  _5418 weakly-connected nodes found - possible documentation gaps or missing edges._
