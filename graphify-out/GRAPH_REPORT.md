...
## Corpus Check
- 1566 files · ~2,531,958 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12344 nodes · 33468 edges · 454 communities (435 shown, 19 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 510 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 556 edges
2. `successResponse()` - 542 edges
3. `connectToDatabase()` - 367 edges
4. `useAppTheme()` - 276 edges
5. `cn()` - 239 edges
6. `connectToDatabase()` - 223 edges
7. `useResource()` - 170 edges
8. `unwrap()` - 170 edges
9. `requireHostelCapability()` - 165 edges
10. `Text()` - 144 edges
...
## Communities (454 total, 19 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (255): ProfileScreen(), ReferralRow(), CheckoutStatusScreen(), loadFinance(), ManageRatesScreen(), isProvider(), ManageGatewayScreen(), useSystemInsets() (+247 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (194): POST(), POST(), GET(), GET(), POST(), HostelAdminProfileQuery, HostelAdminProfileUpdateInput, HostelChangeRequestInput (+186 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (190): auditFinanceAction(), FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), base, entityId, hostelId, mocks (+182 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (167): Scanner(), GuardianInviteScreen(), Choice, MapButton(), MapScreen(), ModeTab(), NOTHING_CHOSEN, PreviewCard() (+159 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (133): PATCH(), POST(), RouteContext, PATCH(), RouteContext, attendanceAlertResolveSchema, attendanceListQuerySchema, attendanceOverrideSchema (+125 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (124): Filter, ModeratedPost, ModerationPayload, csvField(), deferLoad(), DemoDataBadge(), field(), Hostel (+116 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (145): POST(), attacker, attempt(), headers, jsonRequest(), routeMocks, appBaseUrl(), authenticateWithGoogle() (+137 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (88): ICONS, LABELS, Segment, TONES, MANAGE_ROWS, PORTAL_ROWS, Person, needsResident() (+80 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (139): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), loadOverview(), Overview, AdminTabs(), HIDDEN, TABS (+131 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (135): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus(), OPEN_STATUSES (+127 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (116): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel() (+108 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (156): deleteResidentLocationHistory(), demoteToPublicAccount(), addComplaintUpdate(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren() (+148 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (107): GET(), POST(), GET(), POST(), GET(), POST(), POST(), POST() (+99 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (120): GET(), POST(), querySchema, RouteContext, authorUserId, mocks, postId, residentId (+112 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (104): HostelAdminCommunityPageContent, HostelAdminDashboardPageContent, HostelAdminInquiriesPageContent, HostelAdminMaintenancePageContent, PRIORITIES, STATUS_ACTIONS, HostelAdminNightStatusPage, Campaign (+96 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (104): ConfirmOptions, Resident, HostelAdminMoveChecklistPage, MoveEvent, PlatformCommunityPageContent, avatarToneClasses, BreadcrumbItem, iconToneClasses (+96 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (103): AttachmentGallery(), DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS, MealCard(), MonthEndSpecial(), RoutineMeal (+95 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (84): summarizeResidentComplaints(), accessId, adminPrincipal, codes, guardianId, guardianPrincipal, issue(), leanResult() (+76 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (95): NightStatusForm(), SubmitClaimScreen(), InvoiceDetailScreen(), LedgerCard(), SummaryCard(), AmountCard(), methodIcon(), methodLabel() (+87 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (101): getHostelLedger(), getInvoiceMatrix(), HostelLedger, HostelLedgerEntry, InvoiceMatrix, InvoiceMatrixRow, PortalInvoice, ResidentFinanceView (+93 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (100): SORTS, StoreCategoryScreen(), listAdminResidents(), listClaims(), listComplaints(), listInquiries(), listSosAlerts(), unwrap() (+92 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (78): GET(), POST(), POST(), POST(), POST(), GET(), POST(), bulkApproveSchema (+70 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (77): CommunityScreen(), Composer(), CommunityBoard(), CommunityBoardProps, Composer(), SORTS, CommentThread(), CommunityPostCard() (+69 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (78): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), DocumentScreen(), MobileLegal (+70 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (83): AdminCommunityScreen(), AdminCommunityReportsScreen(), FILTERS, Pending, AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), NightStatusScreen() (+75 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (65): metadata, AccountDeletionPanel, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails() (+57 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (58): GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, formatHostelAddress() (+50 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (63): Ledger, OrphanAssignPicker, MatrixRow, MatrixTotals, PeriodSummary, ClaimFacts(), FLAG_LABELS, POSITIVE_FLAGS (+55 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (75): notificationCampaignSchema, input, mocks, userId, CampaignListQuery, CampaignRecord, createCampaign(), createHostelNotificationCampaign() (+67 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (65): PaginationMeta, PaginationQuery, paginationQuerySchema, querySchema, noticeReadStatusSchema, ratingReviewSchema, reviewModerationLogSchema, sponsorSchema (+57 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (69): dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, isMonthEnd(), ROUTINE_DAYS, ROUTINE_MEAL_TYPES (+61 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (62): IdCardFace(), initialsOf(), Portrait(), Point(), BLOOD_OPTIONS, DIET_OPTIONS, GENDER_OPTIONS, ID_TYPE_OPTIONS (+54 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (58): EMPTY_SUMMARY, HostelAdminComplaintsPage, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine (+50 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (54): GET(), resolvePastedLink(), searchCandidates(), geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), hostelAdminGeocodeQuerySchema (+46 more)

### Community 34 - "Community 34"
Cohesion: 0.14
Nodes (41): idCardIssuedEmail(), accountUpgradedEmail(), verificationEmail(), guardianInvitationEmail(), cookPortalEnabledEmail(), hostelDocumentsRequestedEmail(), hostelApprovedEmail(), hostelPublishedEmail() (+33 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (61): documents, hostelForm(), many, parsed, result, buildHostelPayload(), capacitySummary(), CITY_OPTIONS (+53 more)

### Community 36 - "Community 36"
Cohesion: 0.05
Nodes (51): rejectPlatformHostel(), hostelRejectSchema, GET(), escapeRegex(), objectIdSchema, paginationSchema, phoneSchema, serviceProviderApplicationSchema (+43 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (50): Notification, MonthPicker, PeriodRow, FILTERS, Notification, NotificationRow(), FILTERS, NotificationCard (+42 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (54): CapacityError, claimBedForRoomType(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary(), releaseBedForRoomType(), RoomConfiguration (+46 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (63): feeUpdateSchema, PATCH(), setResidentMonthlyFee(), arrangeProof(), leanResult(), mocks, paymentId, residentAId (+55 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (56): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), MediaViewerProvider() (+48 more)
...
Cohesion: 0.05
Nodes (49): GET(), POST(), CSV_COLUMNS, GET(), DELETE(), PATCH(), RouteContext, POST() (+41 more)
...
Cohesion: 0.05
Nodes (58): BALANCE_ALIASES, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, TXN_ID_ALIASES, WITHDRAWAL_ALIASES, AMOUNT_ALIASES (+50 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (40): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery (+32 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (39): metadata, CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+31 more)

### Community 47 - "Community 47"
Cohesion: 0.07
Nodes (51): notificationSchema, userResidentProfileSchema, LEGACY_ROLE_MAP, Role, ROLE_VALUES, CARD_LABELS, formatIssuedOn(), readPhotoBytes() (+43 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (47): daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags, GuardianPermissionsUpdateInput (+39 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (38): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, secretsMatch(), ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS (+30 more)

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (44): CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing, buildIdCardData() (+36 more)
...
Cohesion: 0.06
Nodes (23): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminResidentsPage(), redirectToWorkspaceScreen(), HostelAdminMaintenancePageContent() (+15 more)

### Community 54 - "Community 54"
Cohesion: 0.08
Nodes (37): BootGate(), GuardianLoginScreen(), BrandSplash(), AuthDivider(), GoogleSignInButton(), APP_NAME_PARTS, logo, accentForAccount() (+29 more)
...
Cohesion: 0.07
Nodes (29): HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), PlatformDashboardPageContent(), PlatformUsersPageContent(), DashboardCard(), DashboardCardProps, PlatformServiceProvidersPageContent(), PlatformDashboardPageContent (+21 more)

### Community 60 - "Community 60"
Cohesion: 0.1
Nodes (18): PlatformConfigAnnouncementsPageContent, PlatformConfigContentPageContent, PlatformConfigFacilitiesPageContent, FLAGS, PlatformConfigFeaturesPageContent, PlatformConfigLegalPageContent, PlatformConfigLocationsPageContent, PlatformConfigPricingPageContent (+10 more)

### Community 61 - "Community 61"
Cohesion: 0.07
Nodes (39): Offset, PhotoCropper(), FileUploadArea(), acceptAttribute(), EXTENSION_BY_MIME, FAMILY_BYTES, FAMILY_ORDER, familyOf() (+31 more)

### Community 62 - "Community 62"
Cohesion: 0.07
Nodes (38): BillableResident, ChargeBasis, computeInvoiceAmount(), countDaysInclusive(), dayBefore(), FeeScheduleRate, getOpenFeeSchedule(), InvoiceAmount (+30 more)

### Community 63 - "Community 63"
Cohesion: 0.06
Nodes (22): AuthShell(), AuthShellProps, SiteWordmark(), GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse, GoogleAuthUser, GoogleCredentialResponse (+14 more)

### Community 64 - "Community 64"
Cohesion: 0.08
Nodes (38): GATEWAY_ORDER, getPayInstructions(), InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice(), toView() (+30 more)

### Community 65 - "Community 65"
Cohesion: 0.09
Nodes (38): storeCategorySchema, storeOrderSchema, storeProductSchema, PATCH(), RouteContext, categoriesFor(), escapeRegex(), getStoreHome() (+30 more)
...
Cohesion: 0.07
Nodes (36): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+28 more)

### Community 68 - "Community 68"
Cohesion: 0.07
Nodes (27): SosScreen(), TABS, useBottomChrome(), AvatarTabIcon(), RoleTabs(), TabDef, SosFab(), SosOverlay() (+19 more)
...
Cohesion: 0.08
Nodes (30): outstandingForResident(), bedSchema, depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, providedItemSchema, auditMoveAction(), createMoveInChecklist() (+22 more)

### Community 71 - "Community 71"
Cohesion: 0.08
Nodes (36): GuardianHomeScreen(), GuardianMetrics(), GuardianMoreScreen(), GuardianPaymentsScreen(), GuardianSafetyScreen(), acceptGuardianInvitation(), getGuardianFood(), getGuardianNotices() (+28 more)

### Community 72 - "Community 72"
Cohesion: 0.08
Nodes (38): AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance(), DIGIT_CONFUSABLES, evidenceTextFlags(), EvidenceTextMatch (+30 more)
...
Cohesion: 0.08
Nodes (33): periodTotals(), assertHostelAccess(), canAccessHostel(), hostelScopedFilter(), TenantAccessError, TenantPrincipal, attendanceLogSchema, foodReadyLogSchema (+25 more)

### Community 76 - "Community 76"
Cohesion: 0.09
Nodes (33): ComplaintDetail(), ComplaintCard(), NewComplaintScreen(), PickedAttachment, ACTOR_LABELS, actorLabel(), Complaint, COMPLAINT_CATEGORIES (+25 more)
...
Cohesion: 0.07
Nodes (30): ComparePage(), hostels, metadata, rows, CurrentUser, DASHBOARD_ROLES, dashboardHrefForRole(), hasDashboard() (+22 more)
...
Cohesion: 0.07
Nodes (20): GET(), RouteContext, POST(), RouteContext, POST(), RouteContext, emergencyContactCreateSchema, guardianCreateSchema (+12 more)

### Community 81 - "Community 81"
Cohesion: 0.07
Nodes (29): PRODUCTION_RECOMMENDED, PRODUCTION_REQUIRED, ServerEnv, serverEnvSchema, serverEnvWarnings(), PRODUCTION_MINIMUM, pusher, snapshot (+21 more)
...
Cohesion: 0.06
Nodes (24): cityOptions, createDocument(), createRoom(), DocumentConfig, DraftData, FACILITY_MINI, facilityOptions, FIELD_KEY_STEP (+16 more)

### Community 84 - "Community 84"
Cohesion: 0.11
Nodes (32): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags(), evidenceFlags() (+24 more)
...
Cohesion: 0.13
Nodes (25): r2Configured(), storePublicAsset(), AccessLevel, bucketForAccessLevel(), deleteFromR2(), generateFileKey(), getPresignedUploadUrl(), getR2Client() (+17 more)

### Community 91 - "Community 91"
Cohesion: 0.08
Nodes (25): qrActivationSchema, before, expiresAt, mocks, staffPrincipal, ActivationCodeGenerateInput, ActivationCodeInput, activationSecret() (+17 more)
...
Cohesion: 0.09
Nodes (27): progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster(), UploadRow, UploadStack(), useIsHydrated() (+19 more)
...
Cohesion: 0.13
Nodes (23): DeletionPanel(), NotificationSettings(), SETTINGS_TITLES, THEME_OPTIONS, DeletionRequest, DeletionStatus, getDeletionStatus(), requestAccountDeletion() (+15 more)

### Community 96 - "Community 96"
Cohesion: 0.08
Nodes (19): Input(), TextArea(), field(), HostelAdminServiceProvidersPageContent(), ListingFlag, LoadState, MaintenanceRequest, optionalField() (+11 more)
...
Cohesion: 0.1
Nodes (25): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, FeeScheduleRecord, AdmissionInvoiceResult (+17 more)

### Community 99 - "Community 99"
Cohesion: 0.09
Nodes (27): BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan, BillingSkip (+19 more)

### Community 100 - "Community 100"
Cohesion: 0.09
Nodes (23): deviceTokenSchema, filterPushRecipients(), CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, readId(), activeTokensFor(), authHeaders() (+15 more)

### Community 101 - "Community 101"
Cohesion: 0.09
Nodes (26): RootShell(), AssetViewer(), useViewerState(), BottomChrome, BottomChromeContext, BottomChromeProvider(), CHROME_TIMING, UploadToaster() (+18 more)

### Community 102 - "Community 102"
Cohesion: 0.08
Nodes (21): currency(), EmptyState(), Select(), ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, Complaint, field() (+13 more)
...
Cohesion: 0.12
Nodes (21): EMPTY_TALLY, floorToStep(), phaseOf(), shouldRepost(), tallyUploads(), active, done, next (+13 more)
...
Cohesion: 0.15
Nodes (25): storeCartSchema, DELETE(), AddInput, addToCart(), CartItemRecord, CartRecord, clearCart(), emptyCart() (+17 more)

### Community 113 - "Community 113"
Cohesion: 0.1
Nodes (17): ResidentScan, ScannedCardType, ScannedMembership, scannedPhotoSource(), ScannedProfile, scanResident(), PaymentStanding, settled() (+9 more)
...
Cohesion: 0.09
Nodes (16): accountDeletionRequestSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, consentLogSchema, questionCallClickSchema, sessionSchema, purgeAccount() (+8 more)
...
Cohesion: 0.14
Nodes (20): UploadCard(), useIsUploading(), dismissUpload(), emit(), listeners, pruneUploads(), resetUploadQueue(), rows (+12 more)

### Community 120 - "Community 120"
Cohesion: 0.13
Nodes (20): ApiFailure, EXTENSION_MIME, PickedFile, resolveFileName(), resolveMimeType(), name, formatMegabytes(), PUBLIC_UPLOAD_TYPES (+12 more)

### Community 121 - "Community 121"
Cohesion: 0.1
Nodes (16): PortalShell(), navItems, navItems, GUARDIAN_NAV, GUARDIAN_SEARCH_ENTRIES, HOSTEL_ADMIN_NAV, HOSTEL_ADMIN_SEARCH_ENTRIES, hostelAdminHref() (+8 more)
...
Cohesion: 0.12
Nodes (19): classifyCredit(), CreditClassification, LadderClaim, LadderInvoice, MatchContext, normalizeTxnId(), ANITA_CODE, claims (+11 more)
...
Cohesion: 0.15
Nodes (18): ProviderJobScreen(), ProviderJob, ProviderJobStatus, updateProviderJobStatus(), CATEGORY_ICONS, completedJobCount(), isOpenJob(), jobActions() (+10 more)
...
Cohesion: 0.11
Nodes (13): CATEGORIES, isApplicationOpen(), MeResponse, OwnApplication, ProviderStatus, ServiceProviderRegistrationPageContent(), ServiceProviderRegistrationPageProps, SessionUser (+5 more)
...
Cohesion: 0.16
Nodes (15): DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList(), positiveInteger(), validateFileAssetMetadata(), getPresignedReadUrl(), asset (+7 more)
...
Cohesion: 0.1
Nodes (16): defaultDueDate(), DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), monthLabel(), periodCoverage() (+8 more)
...
Cohesion: 0.16
Nodes (14): KNOWN_PATHS, resolvePushPath(), REWRITES, createAndroidChannels(), easProjectId(), fetchExpoPushToken(), forgetPushToken(), PUSH_CHANNEL (+6 more)
...
Cohesion: 0.14
Nodes (12): DEPRECATED_ALIASES, grantingPermissionKeys(), mocks, DEFAULT_WARDEN_PERMISSIONS, DEPRECATED_WARDEN_PERMISSION_KEYS, DeprecatedWardenPermissionKey, objectIdSchema, optionalHostelScopeSchema (+4 more)

### Community 178 - "Community 178"
Cohesion: 0.11
Nodes (15): chain, close, closed, eventId, hostelId, intent, intentId, invoice (+7 more)
...
Cohesion: 0.15
Nodes (13): POST(), POST(), RouteContext, acceptGuardianInvitation(), DEFAULT_GUARDIAN_PERMISSIONS, guardianAccessCreateSchema, guardianInvitationAcceptSchema, guardianInviteSchema (+5 more)
...
Cohesion: 0.23
Nodes (15): CheckoutStatus, closeIntent(), createPaymentIntent(), expireStaleIntents(), getCheckoutStatus(), handleProviderCallback(), IntentRecord, isUnconfirmable() (+7 more)

### Community 196 - "Community 196"
Cohesion: 0.15
Nodes (16): 2.2 Hostel Approved, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.3 Payment Proof Uploaded (to Admin), 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, 4.1 New Notice Posted (+8 more)
...
Cohesion: 0.2
Nodes (11): buildHostelShare(), hostelPublicUrl(), message, cellWidth(), clampedFontScale(), columnsThatFit(), PhoneSize, phoneSizeFor() (+3 more)
...
Cohesion: 0.17
Nodes (15): 1.0 Signup One-Time Code, 1.1 Email Verification (PUBLIC Signup), 1.2 Hostel Admin Credentials (Post-Approval), 1.3 Warden Credentials, 1.4 Resident QR Activation, 1.5 Guardian Invitation, 1.6 Password Reset, 1. Authentication & Account Emails (+7 more)
...
Cohesion: 0.25
Nodes (11): dashboardHrefForRole(), destinationForRole(), isAllowedNextPath(), isHostelWorkspacePath(), isSafeLocalPath(), landingPathForRole(), ProtectedRouteRule, protectedRouteRuleForPath() (+3 more)

### Community 217 - "Community 217"
Cohesion: 0.19
Nodes (9): PLATFORM_MODERATOR_NAV, PLATFORM_MODERATOR_SEARCH_ENTRIES, PLATFORM_NAV, PLATFORM_SEARCH_ENTRIES, moderatorHrefs, websiteConfig, sessionRole(), navItems (+1 more)

### Community 218 - "Community 218"
Cohesion: 0.21
Nodes (12): categoryLabel(), PROVIDER_CATEGORIES, ProviderCard(), ProviderDirectoryData, PublicProvider, PublicServiceProviderDirectoryPage(), DirectoryPageProps, EMPTY (+4 more)
...
Cohesion: 0.18
Nodes (14): 4.2 Complaint Status Updated, 5.1 SOS Triggered, 5. Safety & Emergency Emails, 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails (+6 more)
...
Cohesion: 0.2
Nodes (7): august, hostelId, mocks, periodAgo(), periodAhead(), residentA, residentB
...
Cohesion: 0.22
Nodes (8): getResidentProfile(), login(), LoginScreen(), Props, Profile, Props, ResidentProfileScreen(), screenStyles
...
Cohesion: 0.2
Nodes (6): billed, eventId, hostelId, invoiceId, mocks, residentId
...
Cohesion: 0.22
Nodes (10): 1.7 Account Upgraded, 2.1 Hostel Submission Received, 2.3 Hostel Rejected, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, code:typescript ({), code:typescript ({), code:typescript ({) (+2 more)
...
Cohesion: 0.22
Nodes (10): 7.1 New Hostel Pending Approval (to Superadmin), 7.2 Subscription Expiring Soon, 7. Platform Admin Emails, 8.1 Community Post Engagement (Batched), 8. Community & Notification Emails, code:typescript ({), code:typescript ({), code:typescript ({) (+2 more)
...
Cohesion: 0.36
Nodes (7): currentRules(), loadRootEnv(), main(), origins(), root, rule(), resolve()
...
## Knowledge Gaps
- **4406 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+4401 more)
...
- **Why does `Button()` connect `Community 7` to `Community 0`, `Community 3`, `Community 5`, `Community 8`, `Community 10`, `Community 15`, `Community 16`, `Community 18`, `Community 20`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 27`, `Community 31`, `Community 32`, `Community 35`, `Community 37`, `Community 54`, `Community 68`, `Community 76`, `Community 95`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 15` to `Community 256`, `Community 0`, `Community 5`, `Community 7`, `Community 8`, `Community 10`, `Community 14`, `Community 25`, `Community 26`, `Community 27`, `Community 156`, `Community 32`, `Community 37`, `Community 41`, `Community 46`, `Community 50`, `Community 55`, `Community 59`, `Community 60`, `Community 61`, `Community 63`, `Community 66`, `Community 78`, `Community 82`, `Community 83`, `Community 89`, `Community 93`, `Community 232`, `Community 105`, `Community 121`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 169` to `Community 0`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 10`, `Community 140`, `Community 14`, `Community 18`, `Community 19`, `Community 148`, `Community 23`, `Community 280`, `Community 27`, `Community 33`, `Community 34`, `Community 35`, `Community 43`, `Community 44`, `Community 49`, `Community 50`, `Community 61`, `Community 69`, `Community 75`, `Community 83`, `Community 93`, `Community 95`, `Community 98`, `Community 104`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Are the 362 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 362 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `{ defineConfig }`, `expoConfig`, `path` to the rest of the system?**
  _4406 weakly-connected nodes found - possible documentation gaps or missing edges._
