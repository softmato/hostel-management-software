...
## Corpus Check
- 1539 files · ~2,499,901 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12125 nodes · 32698 edges · 446 communities (422 shown, 24 thin omitted)
...
Cohesion: 0.02
Nodes (191): PATCH(), POST(), RouteContext, GET(), POST(), PATCH(), POST(), RouteContext (+183 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (210): POST(), POST(), GET(), GET(), addHostelAdminProfilePhoto(), deleteHostelAdminProfilePhoto(), getHostelAdminProfile(), HostelAdminProfileQuery (+202 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (222): InquiryFields(), ActivationIssue, addEmergencyContact(), addHostelPhoto(), addResidentGuardian(), approveMatchedStatement(), assignOrphanPayment(), AttendanceAnalytics (+214 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (154): AdminTabs(), HIDDEN, TABS, AdminMoreScreen(), ActivateScreen(), Scanner(), GuardianInviteScreen(), RootShell() (+146 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (172): BootGate(), BrandSplash(), AuthDivider(), GoogleSignInButton(), accentForAccount(), AccountShape, HomeRoute, resolveHome() (+164 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (118): HostelTable(), UserRecord, GuardianDashboard, LedgerMonth, LedgerPayment, MonthRow(), ResidentLedger, Payment (+110 more)
...
Cohesion: 0.06
Nodes (83): ICONS, LABELS, Segment, TONES, Overview, MoneyData, MANAGE_ROWS, PORTAL_ROWS (+75 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (148): deleteResidentLocationHistory(), getResidentAttendance(), listAttendanceAlerts(), listResidentComplaints(), getResidentFinanceView(), recomputeInvoiceBalance(), reverseEvent(), getFoodRoutinesByHostelId() (+140 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (124): PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), GET(), POST(), querySchema, RouteContext, authorUserId (+116 more)
...
Cohesion: 0.03
Nodes (115): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus(), OPEN_STATUSES (+107 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (103): AdminCommunityReportsScreen(), FILTERS, Pending, loadOverview(), loadMoney(), loadToday(), AdminAlertsContext, AdminAlertsValue (+95 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (88): adminPrincipal, mocks, PLATFORM_LIMITS, hostelId, invoice, invoiceId, mocks, principal (+80 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (100): NightStatusForm(), NotificationCard(), ReferralRow(), SubmitClaimScreen(), InvoiceDetailScreen(), LedgerCard(), SummaryCard(), AmountCard() (+92 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (79): GenericPortalScreen(), portalRows(), portalTitle(), CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS, CITY_OPTIONS (+71 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (112): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags() (+104 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (102): PaginationMeta, querySchema, platformSettingSchema, storeCartSchema, storeCategorySchema, storeOrderSchema, storeProductSchema, AddInput (+94 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (76): FeeSchedule, HostelAdminFeeSchedulePageContent, Rate, PRIORITIES, STATUS_ACTIONS, Campaign, Resident, AttendanceAnalytics (+68 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (96): collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor() (+88 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (75): csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, Inquiry, LoadState, Message() (+67 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (82): ModerationButton(), PagerButton(), normalize(), PortalSearch(), PortalTone, scoreEntry(), toneStyles, iconMap (+74 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (80): AdminCommunityScreen(), FILTERS, CommunityScreen(), Composer(), CommunityPostScreen(), useReportedCount(), CommunityBoard(), CommunityBoardProps (+72 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (73): CommunityPageContent(), MonthPicker, PeriodRow, Ledger, OrphanAssignPicker, HostelAdminPaymentsPage, MatrixRow, MatrixTotals (+65 more)
...
Cohesion: 0.03
Nodes (71): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, attempt (+63 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (66): metadata, AccountDeletionPanel, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails() (+58 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (71): GET(), POST(), attendanceAlertResolveSchema, attendanceListQuerySchema, attendanceOverrideSchema, attendanceSettingsSchema, consentSchema, locationPingSchema (+63 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (77): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure (+69 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (75): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), AdminMoneyScreen(), AdminResidentsScreen(), AdminTodayScreen(), NightStatusScreen(), ProfileScreen() (+67 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (55): ComparePage(), hostels, metadata, rows, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminProfilePageContent(), HostelAdminRoomsPageContent() (+47 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (64): GET(), POST(), GET(), GET(), POST(), DELETE(), POST(), getMyExpertConsultationRequest() (+56 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (65): IdCardFace(), initialsOf(), Portrait(), IdCardPrompt(), Point(), BLOOD_OPTIONS, DIET_OPTIONS, EditIdentityScreen() (+57 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (69): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, HostelPayeeIdentity, GATEWAY_ORDER (+61 more)
...
Cohesion: 0.05
Nodes (59): HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend(), HostelHero() (+51 more)
...
Cohesion: 0.05
Nodes (69): addToCart(), cancelStoreOrder(), Cart, CartLine, CartResult, CartTotals, clearCart(), getCart() (+61 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (53): NotificationsPageContent(), Notification, HostelAdminResidentsPage, humanizeValue(), ImportedProfileSummary(), ResidentPrefill, ResidentStatus, STATUS_ACTIONS (+45 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (59): AttendanceAlert, AttendanceCalendar(), AttendanceRow, HostelAdminAttendancePageContent, Zone, ZONE_ORDER, ZONE_STYLES, HostelAdminCommunityPageContent (+51 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (59): POST(), RouteContext, complaintCategorySchema, complaintCreateSchema, complaintListQuerySchema, complaintReplySchema, complaintResolutionConfirmSchema, complaintStatusSchema (+51 more)
...
Cohesion: 0.04
Nodes (53): summarizeResidentComplaints(), dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, isMonthEnd(), mealsOn() (+45 more)

### Community 43 - "Community 43"
Cohesion: 0.12
Nodes (37): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), verificationEmail(), guardianInvitationEmail(), cookPortalEnabledEmail(), hostelDocumentsRequestedEmail() (+29 more)
...
Cohesion: 0.05
Nodes (44): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, HostelPhotoReminder(), PortalShell(), navItems, navItems, FALLBACK_ORDER, hasNoHostelPhotos() (+36 more)
...
Cohesion: 0.04
Nodes (39): metadata, FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES, avatarTone() (+31 more)
...
Cohesion: 0.07
Nodes (51): demoteToPublicAccount(), CapacityError, claimBedForRoomType(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary(), releaseBedForRoomType() (+43 more)

### Community 52 - "Community 52"
Cohesion: 0.06
Nodes (39): HostelSuggestions(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, checkOnly(), EMPTY_PREFILL, ENVIRONMENT_OPTIONS (+31 more)
...
Cohesion: 0.07
Nodes (44): CSV_COLUMNS, GET(), POST(), safeEqual(), GET(), periodTotals(), csvCell(), csvFilename() (+36 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (44): approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal, checker, eventId (+36 more)

### Community 56 - "Community 56"
Cohesion: 0.06
Nodes (41): addComplaintUpdate(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput, ComplaintListQuery (+33 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (35): AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry() (+27 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (42): isAuthBypassEnabled(), original, cook, assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES, PermissionError (+34 more)
...
Cohesion: 0.06
Nodes (39): assertHostelAccess(), canAccessHostel(), hostelScopedFilter(), TenantAccessError, TenantPrincipal, foodReadyLogSchema, noticeSchema, noticeReadStatusSchema (+31 more)

### Community 61 - "Community 61"
Cohesion: 0.06
Nodes (24): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminNoticesPage(), HostelAdminPaymentsPage(), redirectToWorkspaceScreen() (+16 more)

### Community 62 - "Community 62"
Cohesion: 0.05
Nodes (43): getInvoiceMatrix(), InvoiceMatrix, InvoiceMatrixRow, listResidentClaims(), PortalInvoice, ResidentFinanceView, ResidentInvoiceLine, ResidentInvoiceReceipt (+35 more)
...
Cohesion: 0.08
Nodes (35): DeletionPanel(), NotificationSettings(), SETTINGS_TITLES, THEME_OPTIONS, canRequestDeletion(), DeletionPathway, deletionReasonError(), PATHWAY_COPY (+27 more)

### Community 68 - "Community 68"
Cohesion: 0.09
Nodes (33): POST(), RouteContext, computePerceptualHash(), systemDocumentKind(), AccessLevel, bucketForAccessLevel(), deleteFromR2(), generateFileKey() (+25 more)

### Community 69 - "Community 69"
Cohesion: 0.07
Nodes (39): BALANCE_ALIASES, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, TXN_ID_ALIASES, WITHDRAWAL_ALIASES, AMOUNT_ALIASES (+31 more)
...
Cohesion: 0.08
Nodes (39): Compass(), Guidance, GuidanceStatus, useGuidance(), NavigationFix, watchDeviceHeading(), watchNavigationPosition(), cardinalFor() (+31 more)

### Community 73 - "Community 73"
Cohesion: 0.09
Nodes (17): PlatformConfigAnnouncementsPageContent, PlatformConfigContentPageContent, PlatformConfigFacilitiesPageContent, FLAGS, PlatformConfigFeaturesPageContent, PlatformConfigLegalPageContent, PlatformConfigLocationsPageContent, PlatformConfigPricingPageContent (+9 more)
...
Cohesion: 0.08
Nodes (28): outstandingForResident(), bedSchema, depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, providedItemSchema, roomSchema, auditMoveAction() (+20 more)

### Community 76 - "Community 76"
Cohesion: 0.09
Nodes (32): addHistory(), addMaintenanceComment(), assertBedInHostel(), assertProviderApproved(), assertRoomInHostel(), auditMaintenanceAction(), BedRecord, createMaintenanceRequest() (+24 more)

### Community 77 - "Community 77"
Cohesion: 0.06
Nodes (22): field(), GuardianDashboard, GuardianDashboardPageContent(), LoadState, NightStatusRow, Notification, optionalNumber(), PlatformReviewsPageContent() (+14 more)
...
Cohesion: 0.08
Nodes (31): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+23 more)
...
Cohesion: 0.1
Nodes (24): issueReceiptForEvent(), IssueReceiptInput, nextReceiptNumber(), periodCoverage(), periodOfDate(), renderReceiptById(), renderStatementForResident(), voidReceipt() (+16 more)

### Community 87 - "Community 87"
Cohesion: 0.07
Nodes (22): csvField(), field(), Hostel, Inquiry, LoadState, numberField(), optionalField(), PlatformHostelReviewPageContent() (+14 more)
...
Cohesion: 0.08
Nodes (29): coerceSection(), getSiteConfig(), PlatformSettingRecord, SiteConfigServiceError, updateSiteConfigSection(), announcementSchema, contentHighlightSchema, ContentPage (+21 more)

### Community 90 - "Community 90"
Cohesion: 0.12
Nodes (29): renderIdCardPng(), LEGACY_ROLE_MAP, Role, ROLE_VALUES, CARD_LABELS, formatIssuedOn(), readPhotoBytes(), readQrBytes() (+21 more)

### Community 91 - "Community 91"
Cohesion: 0.12
Nodes (17): POST(), POST(), POST(), POST(), periodOf(), POST(), POST(), POST() (+9 more)
...
Cohesion: 0.08
Nodes (19): Panel(), Select(), field(), HostelAdminReportsPageContent(), ListingFlag, LoadState, MaintenanceRequest, optionalField() (+11 more)

### Community 97 - "Community 97"
Cohesion: 0.11
Nodes (25): ComplaintDetail(), ComplaintCard(), NewComplaintScreen(), PickedAttachment, ACTOR_LABELS, actorLabel(), Complaint, ComplaintCategory (+17 more)
...
Cohesion: 0.12
Nodes (26): FileUploadArea(), acceptAttribute(), EXTENSION_BY_MIME, FAMILY_BYTES, FAMILY_ORDER, familyOf(), formatBytes(), joinTypes() (+18 more)
...
Cohesion: 0.09
Nodes (22): qrActivationSchema, residentSchema, ActivationCodeGenerateInput, ActivationCodeInput, activationSecret(), ActivationServiceError, ActivationStatus, ActivationStatusQuery (+14 more)
...
Cohesion: 0.11
Nodes (22): progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster(), UploadRow, useIsHydrated(), ToastInput (+14 more)
...
Cohesion: 0.11
Nodes (19): buildHtml(), Marker, PlaceMarker, buildShell(), boundsCenter(), hostelCoordinates(), groupNearbyPlaces(), humanizeNearbyType() (+11 more)
...
Cohesion: 0.14
Nodes (18): hammingDistance(), isPerceptualNearDuplicate(), distance, drawCertificationStamp(), footerLine(), formatDate(), formatLongDate(), MONTHS (+10 more)
...
Cohesion: 0.18
Nodes (19): ReviewForm(), ReviewScreen(), ResidentProfile, canReview(), emptyReviewDraft(), hasReviewErrors(), REVIEW_CATEGORIES, REVIEWABLE_STATUSES (+11 more)

### Community 132 - "Community 132"
Cohesion: 0.19
Nodes (20): AssetViewer(), useViewerState(), ViewerPage(), clampIndex(), closeAssetViewer(), emit(), getAssetViewerState(), isPreviewable() (+12 more)

### Community 133 - "Community 133"
Cohesion: 0.14
Nodes (19): UploadCard(), dismissUpload(), emit(), listeners, pruneUploads(), resetUploadQueue(), rows, startUpload() (+11 more)

### Community 134 - "Community 134"
Cohesion: 0.14
Nodes (16): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), QueryProvider() (+8 more)
...
Cohesion: 0.14
Nodes (17): GuardianHomeScreen(), GuardianMoreScreen(), GuardianPayment, GuardianPermissionKey, GuardianPermissions, GuardianReceipt, GUARDIAN_PERMISSION_LABELS, guardianOutstanding() (+9 more)
...
Cohesion: 0.16
Nodes (18): readQrPayeeFields(), cleanAccountNumber(), cleanName(), hasQrPayee(), looksLikeName(), normalizeDigits(), QrPayeeRead, readQrPayee() (+10 more)
...
Cohesion: 0.11
Nodes (21): 2.3 Hostel Rejected, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.3 Payment Proof Uploaded (to Admin), 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, 4.1 New Notice Posted (+13 more)
...
Cohesion: 0.16
Nodes (16): Choice, maneuverIcon(), MapButton(), ModeTab(), NavCard(), NOTHING_CHOSEN, RouteCard(), MapExplorer (+8 more)
...
Cohesion: 0.11
Nodes (15): defaultDueDate(), number(), text(), budgetLabel(), numberValue(), monthLabel(), toNumber(), nonZero() (+7 more)

### Community 171 - "Community 171"
Cohesion: 0.15
Nodes (19): 5.1 SOS Triggered, 5. Safety & Emergency Emails, 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, 7.1 New Hostel Pending Approval (to Superadmin) (+11 more)

### Community 172 - "Community 172"
Cohesion: 0.15
Nodes (14): getResidentNightStatus(), getResidentProfile(), login(), ResidentNightStatus, submitResidentReview(), RootStackParamList, LoginScreen(), Props (+6 more)
...
Cohesion: 0.14
Nodes (15): ProviderDirectoryData, DirectoryPageProps, EMPTY, metadata, ServiceProviderDirectoryPage(), ServiceProvidersPage(), listPublicServiceProviders(), hostelAdminServiceProviderListQuerySchema (+7 more)
...
Cohesion: 0.13
Nodes (13): activateResident(), AuthSession, triggerSOS(), AppNavigator(), Stack, Props, ResidentActivationScreen(), styles (+5 more)
...
Cohesion: 0.15
Nodes (12): CATEGORIES, clean(), DEMO, dirname, looseSchema, main(), PRODUCTS, repoRoot (+4 more)
...
Cohesion: 0.27
Nodes (9): robots(), sitemap(), STATIC_ROUTES, listPublishedHostelSlugs(), r2Configured(), storePublicAsset(), publicBucket(), siteUrl() (+1 more)
...
Cohesion: 0.17
Nodes (10): [0.6.0] - 2026-08-01 — Phases 1-3 closed out, Changed, Changed, code:markdown (## [Phase X] - YYYY-MM-DD), Fixed, Fixed, Fixed, Removed (+2 more)
...
Cohesion: 0.2
Nodes (9): POST(), DEFAULT_GUARDIAN_PERMISSIONS, guardianAccessCreateSchema, guardianInvitationAcceptSchema, guardianInviteSchema, guardianLoginSchema, guardianPermissionsSchema, guardianPermissionsUpdateSchema (+1 more)
...
## Knowledge Gaps
- **4342 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+4337 more)
...
- **Why does `Button()` connect `Community 7` to `Community 2`, `Community 131`, `Community 4`, `Community 3`, `Community 5`, `Community 10`, `Community 12`, `Community 14`, `Community 20`, `Community 21`, `Community 23`, `Community 24`, `Community 26`, `Community 282`, `Community 29`, `Community 32`, `Community 162`, `Community 37`, `Community 38`, `Community 39`, `Community 67`, `Community 78`, `Community 97`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 170` to `Community 0`, `Community 2`, `Community 4`, `Community 6`, `Community 263`, `Community 137`, `Community 10`, `Community 14`, `Community 146`, `Community 18`, `Community 20`, `Community 19`, `Community 23`, `Community 25`, `Community 33`, `Community 35`, `Community 36`, `Community 169`, `Community 43`, `Community 46`, `Community 50`, `Community 52`, `Community 60`, `Community 66`, `Community 67`, `Community 78`, `Community 86`, `Community 99`, `Community 242`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 21` to `Community 2`, `Community 5`, `Community 7`, `Community 10`, `Community 12`, `Community 15`, `Community 18`, `Community 20`, `Community 22`, `Community 23`, `Community 26`, `Community 30`, `Community 36`, `Community 38`, `Community 39`, `Community 166`, `Community 44`, `Community 47`, `Community 49`, `Community 52`, `Community 66`, `Community 73`, `Community 96`, `Community 225`, `Community 99`, `Community 102`, `Community 108`, `Community 116`?**
