# Graph Report - hostel-management-software  (2026-08-10)

## Corpus Check
- 1026 files · ~1,841,652 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8239 nodes · 20510 edges · 389 communities (368 shown, 21 thin omitted)
...
1. `handleRouteError()` - 470 edges
2. `successResponse()` - 459 edges
3. `connectToDatabase()` - 305 edges
4. `cn()` - 223 edges
5. `connectToDatabase()` - 205 edges
6. `requireHostelCapability()` - 150 edges
7. `requireHostelStaffPrincipal()` - 116 edges
8. `browserApi()` - 112 edges
9. `usePortalResource()` - 85 edges
10. `requireResidentPrincipal()` - 81 edges
...
Cohesion: 0.04
Nodes (130): POST(), attacker, attempt(), headers, jsonRequest(), routeMocks, appBaseUrl(), authenticateWithGoogle() (+122 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (151): EmailAttachment, fromAddress(), sendEmail(), SendEmailInput, SendEmailResult, listPublicFoodRoutine(), addHostelAdminProfilePhoto(), deleteHostelAdminProfilePhoto() (+143 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (98): csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, HostelTable(), Inquiry, LoadState (+90 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (96): ConfirmOptions, Resolver, Notification, Campaign, Resident, humanizeValue(), ImportedProfileSummary(), ResidentPrefill (+88 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (93): PATCH(), POST(), RouteContext, GET(), POST(), POST(), POST(), POST() (+85 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (62): POST(), communitySettingsSchema, PATCH(), resolveHostelId(), GET(), GET(), RouteContext, POST() (+54 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (86): HostelAdminCommunityPageContent, HostelAdminFeePlansPageContent, HostelAdminInquiriesPageContent, HostelAdminMaintenancePageContent, HostelAdminMoveChecklistPage, HostelAdminNightStatusPage, HostelAdminNoticesPage, HostelAdminNotificationsPageContent (+78 more)
...
Cohesion: 0.04
Nodes (64): deleteResidentLocationHistory(), confirmComplaintResolution(), outstandingForResident(), listResidentGuardians(), depositRefundSchema, incidentLogSchema, manualStatusOverrideSchema, moveInChecklistSchema (+56 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (70): auditFinanceAction(), BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan (+62 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (48): PATCH(), RouteContext, listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), POST(), RouteContext (+40 more)

### Community 11 - "Community 11"
Cohesion: 0.07
Nodes (43): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, hasFood(), LoadState (+35 more)
...
Cohesion: 0.05
Nodes (63): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, TXN_ID_ALIASES, WITHDRAWAL_ALIASES (+55 more)

### Community 15 - "Community 15"
Cohesion: 0.07
Nodes (48): POST(), GET(), POST(), POST(), POST(), POST(), POST(), RouteContext (+40 more)
...
Cohesion: 0.08
Nodes (44): GuardianDashboard, CATEGORIES, EmptyInline(), InitialsAvatar(), MetricCard(), PortalPageHeader(), RoleButton(), SectionCard() (+36 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (42): AuthShell(), AuthShellProps, SiteWordmark(), AccountDeletionPanel, LegalBody(), buildValues(), PublicAboutPage(), values (+34 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (48): ReportGrid(), ReportRecord, HostelAdminDashboardPageContent, StatementNudge, PlatformCommunityPageContent, AUDIT_ACTIVITY, AuditLog, CHART_LABELS (+40 more)
...
Cohesion: 0.15
Nodes (34): accountDeletionCancelledEmail(), idCardIssuedEmail(), accountUpgradedEmail(), verificationEmail(), guardianInvitationEmail(), sosAlertEmail(), cookPortalEnabledEmail(), hostelDocumentsRequestedEmail() (+26 more)
...
Cohesion: 0.06
Nodes (56): listAttendanceAlerts(), listTrendingTags(), listResidentComplaints(), listHostelAdminInquiries(), listPlatformHostels(), paginationRange(), listListingFlags(), sponsorSchema (+48 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (41): dayOfWeekFor(), mealsOn(), auditGuardianAction(), createGuardianAccess(), expiresInDays(), findAdminResident(), GuardianAccessCreateInput, GuardianAccessRecord (+33 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (33): DELETE(), GET(), POST(), POST(), RouteContext, POST(), PATCH(), RouteContext (+25 more)
...
Cohesion: 0.09
Nodes (49): notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus(), OPEN_STATUSES, OverdueComplaint, runComplaintSlaCheck(), daysBetween(), deliver() (+41 more)
...
Cohesion: 0.06
Nodes (46): POST(), RealtimeConfig, RealtimeContext, RealtimeContextValue, RealtimeNotification, RealtimeProvider(), ApiPrincipal, notificationSchema (+38 more)
...
Cohesion: 0.04
Nodes (44): getCreditAmount(), getInvoiceMatrix(), getResidentFinanceView(), InvoiceMatrix, InvoiceMatrixRow, listResidentClaims(), PortalInvoice, ResidentFinanceView (+36 more)

### Community 35 - "Community 35"
Cohesion: 0.07
Nodes (49): EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, getFoodRoutine(), ROUTINE_DAYS, ROUTINE_MEAL_TYPES, RoutineDay (+41 more)

### Community 36 - "Community 36"
Cohesion: 0.06
Nodes (46): escapeRegex(), objectIdSchema, paginationSchema, phoneSchema, serviceProviderApplicationSchema, serviceProviderDocumentSchema, notifyPlatformOfServiceProviderApplication(), ACTIVE_APPLICATION_STATUSES (+38 more)

### Community 37 - "Community 37"
Cohesion: 0.06
Nodes (38): AuditLogRecord, PlatformAuditLogQuery, RefRecord, PaginationMeta, PaginationQuery, querySchema, auditListingFlagAction(), DuplicateCheckResultRecord (+30 more)
...
Cohesion: 0.06
Nodes (38): assertHostelAccess(), canAccessHostel(), hostelScopedFilter(), TenantAccessError, TenantPrincipal, DAYS, foodRoutineSchema, MEALS (+30 more)

### Community 40 - "Community 40"
Cohesion: 0.07
Nodes (38): getHostelViewStats(), foodFeedbackSchema, listingFlagSchema, maintenanceRequestSchema, paymentProofSchema, ratingReviewSchema, averageResolutionDays(), bucketBoundaries() (+30 more)

### Community 41 - "Community 41"
Cohesion: 0.06
Nodes (37): HostelSuggestions(), PublicComparePage(), PublicHostel, maybePromptForResidentProfile(), requestResidentProfileForm(), checkOnly(), EMPTY_PREFILL, ENVIRONMENT_OPTIONS (+29 more)
...
Cohesion: 0.06
Nodes (32): attendanceOverrideSchema, GET(), POST(), PATCH(), RouteContext, objectIdSchema, platformReviewListQuerySchema, REVIEW_CATEGORY_KEYS (+24 more)

### Community 44 - "Community 44"
Cohesion: 0.07
Nodes (31): GET(), POST(), GET(), GET(), POST(), GET(), POST(), getMyExpertConsultationRequest() (+23 more)

### Community 45 - "Community 45"
Cohesion: 0.06
Nodes (30): ComparePage(), hostels, metadata, rows, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), PlatformDashboardPageContent(), PlatformUsersPageContent() (+22 more)

### Community 46 - "Community 46"
Cohesion: 0.07
Nodes (21): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminComplaintsPage(), redirectToWorkspaceScreen(), HostelAdminMaintenancePageContent() (+13 more)
...
Cohesion: 0.06
Nodes (23): field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminMoveChecklistPage(), LoadState, NightStatusRow, Notification, NotificationsPageContent() (+15 more)

### Community 50 - "Community 50"
Cohesion: 0.07
Nodes (36): classifyCredit(), CreditClassification, findOrphanClaims(), LadderClaim, LadderInvoice, loadMatchContext(), MatchContext, normalizeTxnId() (+28 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (31): FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), findingSchema, reconciliationRunSchema, checkAuditChain(), checkCreditBalances(), DRIFT_CODES (+23 more)

### Community 52 - "Community 52"
Cohesion: 0.09
Nodes (38): renderIdCardPng(), userResidentProfileSchema, LEGACY_ROLE_MAP, Role, ROLE_VALUES, CARD_LABELS, formatIssuedOn(), readPhotoBytes() (+30 more)

### Community 53 - "Community 53"
Cohesion: 0.06
Nodes (27): currency(), Input(), Select(), TextArea(), ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent (+19 more)

### Community 54 - "Community 54"
Cohesion: 0.08
Nodes (31): listResidentInvoices(), formatNPR(), formatDate(), ReceiptPdfInput, renderReceiptPdf(), renderStatementPdf(), sanitize(), StatementPdfInput (+23 more)

### Community 55 - "Community 55"
Cohesion: 0.07
Nodes (32): GET(), GET(), POST(), listHostelAdminFloors(), createHostelAdminFloor(), listHostelAdminFloors(), serializeFloor(), floorCreateSchema (+24 more)

### Community 56 - "Community 56"
Cohesion: 0.08
Nodes (33): qrActivationSchema, activateResident(), ActivationCodeGenerateInput, ActivationCodeInput, activationSecret(), ActivationServiceError, ActivationStatus, ActivationStatusQuery (+25 more)
...
Cohesion: 0.08
Nodes (33): generateMetadata(), RootLayout(), SiteConfigProvider(), loadSiteConfig, loadSiteName(), platformSettingSchema, DEFAULT_SITE_CONFIG, coerceSection() (+25 more)

### Community 60 - "Community 60"
Cohesion: 0.1
Nodes (32): candidatesInRun(), canonicalize(), checkCharacter(), CONFUSABLES, decodeSequence(), deriveHostelPrefix(), encodeSequence(), extractReferenceCodes() (+24 more)
...
Cohesion: 0.09
Nodes (30): announceFoodReady(), cookEmailForSlug(), CookPortalUpdateInput, CookServiceError, FoodReadyInput, generatePassword(), getCookPortalSettings(), HostelSettingsRecord (+22 more)
...
Cohesion: 0.07
Nodes (23): Complaint, ComplaintSummary, EmptyState(), field(), FoodMenu, HostelAdminFoodPage(), HostelAdminNoticesPage(), HostelAdminPaymentsPage() (+15 more)

### Community 65 - "Community 65"
Cohesion: 0.09
Nodes (26): referralSchema, referralCodeSchema, referralRewardSchema, auditReferralAction(), confirmReferralJoined(), createReferredInquiry(), getResidentReferral(), HostelAdminReferralListQuery (+18 more)
...
Cohesion: 0.09
Nodes (26): getPayInstructions(), InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, assertQrAssetUsable(), EMPTY, getPaymentProfile() (+18 more)
...
Cohesion: 0.07
Nodes (20): LoadingRows(), Panel(), StatusBadge(), field(), HostelAdminReferralsPageContent(), ListingFlag, LoadState, MaintenanceRequest (+12 more)

### Community 73 - "Community 73"
Cohesion: 0.08
Nodes (21): ProviderDirectoryData, CATEGORIES, isApplicationOpen(), MeResponse, OwnApplication, ProviderStatus, ServiceProviderRegistrationPage(), ServiceProviderRegistrationPageContent() (+13 more)

### Community 74 - "Community 74"
Cohesion: 0.08
Nodes (15): AuthExperiencePage(), PublicHomePage(), PublicPricingPage(), ResidentActivationPageContent, ResidentActivationPageContent(), ThemeToggle(), ThemeToggleProps, HomePage() (+7 more)
...
Cohesion: 0.09
Nodes (25): AnnouncementInput, CommentCreateInput, CommentRecord, CommunityServiceError, FeedQuery, HideInput, hostelNamesByIds(), isPlatformRole() (+17 more)
...
Cohesion: 0.1
Nodes (19): formatHostelAddress(), hostelTypeToUi(), mapPublicHostelToSummary(), roomTypeLabel(), CATEGORY_LABELS, NEARBY_GROUPS, PublicHostelDetailPage(), PublicReview (+11 more)
...
Cohesion: 0.11
Nodes (19): CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS, CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, MOCK_HOSTELS (+11 more)
...
Cohesion: 0.09
Nodes (15): accountDeletionRequestSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, consentLogSchema, sessionSchema, purgeAccount(), runAccountDeletionPurge() (+7 more)
...
Cohesion: 0.13
Nodes (23): collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor(), LedgerInvoice (+15 more)
...
Cohesion: 0.14
Nodes (18): cook, assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES, PermissionError, PLATFORM_ROLES, Principal (+10 more)
...
Cohesion: 0.11
Nodes (19): findIndex(), index, indexesOf(), IndexSpec, invoice, INVOICE_STATUSES, invoiceLineSchema, invoiceSchema (+11 more)
...
Cohesion: 0.11
Nodes (22): [0.5.2] - 2026-07-23 — Cook credential hand-off + dashboard visibility, [0.6.0] - 2026-08-01 — Phases 1-3 closed out, [0.7.0] - 2026-08-01 — Phase 4: Trust, Safety & Guardian, [0.8.0] - 2026-08-01 — Phase 5: Growth, Maintenance & Polish, Added, Added, Added, Added (+14 more)
...
Cohesion: 0.14
Nodes (15): activateResident(), getResidentProfile(), submitResidentReview(), RootStackParamList, Props, Props, ResidentActivationScreen(), styles (+7 more)
...
Cohesion: 0.11
Nodes (12): authMocks, request, ROLE_VALUES, hostelMemberSchema, rolePermissionSchema, userSchema, platformAdminCreateSchema, platformAdminRoleSchema (+4 more)

### Community 124 - "Community 124"
Cohesion: 0.14
Nodes (14): chelseaMarket, geistMono, geistSans, metadata, poppins, robots(), sitemap(), STATIC_ROUTES (+6 more)
...
Cohesion: 0.13
Nodes (13): attendanceAlertResolveSchema, attendanceListQuerySchema, attendanceSettingsSchema, consentSchema, locationPingSchema, objectIdSchema, POST(), POST() (+5 more)
...
Cohesion: 0.12
Nodes (13): adminPrincipal, mocks, PLATFORM_LIMITS, profileMocks, staffPrincipal, Role, accessSecret(), config (+5 more)
...
Cohesion: 0.13
Nodes (13): landingPathForRole(), ADMIN_ISSUABLE_ROLES, AdminIssuableRole, generateTemporaryPassword(), HIGH_PRIVILEGE_ROLES, loginUrl(), RegisterOrUpgradeInput, registerOrUpgradeUserByEmail() (+5 more)

### Community 137 - "Community 137"
Cohesion: 0.15
Nodes (16): Offset, PhotoCropper(), TradeDetailsStep(), AttachedFile(), FileUploader(), FileUploaderPresentation, FileUploaderProps, FileUploaderView() (+8 more)
...
Cohesion: 0.13
Nodes (17): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), similarEvidenceFlags(), submitClaim(), SubmitClaimResult, UsableAsset, CLAIM_REJECTION_REASONS (+9 more)

### Community 140 - "Community 140"
Cohesion: 0.2
Nodes (14): createCommunityPost(), listCommunityForModeration(), listCommunityModeration(), communityAnnouncementSchema, communityFeedQuerySchema, communityModerationQuerySchema, communityPostCreateSchema, communityReactionSchema (+6 more)

### Community 141 - "Community 141"
Cohesion: 0.13
Nodes (13): daysBetween(), OPEN_STATUSES, PaymentRecord, PaymentReminderRun, ResidentRecord, runPaymentReminders(), shouldChaseOverdue(), startOfDay() (+5 more)
...
Cohesion: 0.12
Nodes (17): 2. Environment Variables, App, Auth / JWT, Cloudflare R2, Cookies, limits, logging, Cron, Database, Email (Resend) (+9 more)
...
Cohesion: 0.22
Nodes (14): GET(), POST(), querySchema, RouteContext, commentOnPost(), findReadablePost(), findVisiblePostForResident(), getCommunityPost() (+6 more)

### Community 153 - "Community 153"
Cohesion: 0.15
Nodes (11): AuthSession, getResidentReferral(), ResidentReferral, ResidentReferralCode, AppNavigator(), Stack, LoginScreen(), ResidentFoodScreen() (+3 more)
...
Cohesion: 0.32
Nodes (10): CSV_COLUMNS, GET(), GET(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS, neutralize() (+2 more)
...
Cohesion: 0.26
Nodes (13): createCommunityAnnouncement(), decoratePosts(), deleteOwnPost(), findModeratablePost(), hideCommunityPost(), PostMedia, publishCommunityChange(), resolveAdminHostelId() (+5 more)
...
Cohesion: 0.13
Nodes (14): Account deletion purge, Attendance maintenance (absence alerts + retention purge), Authentication, Complaint SLA breach check, cron-job.org setup (per job), CRON.md — Scheduled Jobs, Dispatch scheduled notifications, Endpoints (+6 more)
...
Cohesion: 0.17
Nodes (10): latestInvoicePerResident(), complaintSchema, nightStatusSchema, ComplaintRecord, firstPerResident(), hostelNameMap(), listPlatformComplaints(), listPlatformDirectory() (+2 more)
...
Cohesion: 0.14
Nodes (11): amber, amount, assetId, checks, events, hostelId, invoice, invoiceId (+3 more)
...
Cohesion: 0.14
Nodes (10): addFieldsStage, group, hostelId, invoiceId, lookups, mocks, residentId, settledFrom (+2 more)
...
Cohesion: 0.15
Nodes (9): assetId, hashCall, hostelId, input, invoiceId, mocks, principal, residentId (+1 more)
...
Cohesion: 0.17
Nodes (10): claimConfirmed, hostelId, importId, invoiceId, mocks, orphanTierD, principal, residentId (+2 more)

### Community 190 - "Community 190"
Cohesion: 0.18
Nodes (10): assetId, chain(), CODE, failed, hostelId, importId, mocks, principal (+2 more)
...
Cohesion: 0.17
Nodes (12): 6.7 What we ask the hostel for, 6. Work breakdown, Block 0 — Security (blocks everything) 🔴 · ~3–4 days, Block 1 — Foundations, no visible change · ~4–5 days, Block 2 — Ledger refactor · ~8–10 days · the highest-risk block, Block 3 — Tier 0 complete · ~7–8 days, Block 4 — Tier 0.5 · ~6–7 days · best value per unit of effort, Block 5 — Reliability · ~4–5 days (+4 more)
...
Cohesion: 0.2
Nodes (8): assetId, claimInput, eventId, hostelId, invoiceId, mocks, principal, residentId
...
Cohesion: 0.2
Nodes (10): 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 7.1 New Hostel Pending Approval (to Superadmin), 7.2 Subscription Expiring Soon, 7. Platform Admin Emails, 8.1 Community Post Engagement (Batched), 8. Community & Notification Emails, code:typescript ({), code:typescript ({) (+2 more)

### Community 217 - "Community 217"
Cohesion: 0.2
Nodes (9): 5.1 SOS Triggered, 5. Safety & Emergency Emails, code:typescript ({), Email Opt-In/Opt-Out Matrix, EMAIL_SYSTEM.md — Email Triggers & Templates, Guardian Control, Implementation Checklist, Platform Control (PlatformConfig) (+1 more)
...
Cohesion: 0.22
Nodes (7): hostelId, invoice, invoiceId, mocks, principal, qrAssetId, residentId

### Community 227 - "Community 227"
Cohesion: 0.31
Nodes (7): refreshSession(), resetRoleHealForTests(), fetchMock, forbidden(), jsonResponse(), ok(), refreshSessionMock

### Community 228 - "Community 228"
Cohesion: 0.22
Nodes (8): GatewayCredentials, GatewayProvider, GatewayProviderName, PaymentIntent, PaymentIntentRequest, SettlementRecord, VerificationResult, WebhookClaim
...
Cohesion: 0.22
Nodes (9): 7.1 Attendance Alert (Resident Absent), 7. Attendance & Location Tracking Emails, 9.1 Account Deletion Requested, 9.1a Account Deletion Request Needs Review *(added 2026-08-02)*, 9.2 Account Deletion Cancelled, 9.3 Location History Deletion Approved, 9. Account & Privacy Emails, code:typescript ({) (+1 more)
...
Cohesion: 0.39
Nodes (6): flagPost(), queuePostIfWarranted(), reportPost(), communityReportSchema, POST(), RouteContext
...
Cohesion: 0.29
Nodes (8): 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6. Service Provider Emails, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({)
...
Cohesion: 0.47
Nodes (5): getPresignedReadUrl(), GET(), resolveVariantKey(), RouteContext, VALID_VARIANTS
...
Cohesion: 0.5
Nodes (3): COMMUNITY_DEFAULTS, CommunitySettings, getCommunitySettings()

### Community 341 - "Community 341"
Cohesion: 0.5
Nodes (3): voteOnComment(), communityVoteSchema, RouteContext
...
## Knowledge Gaps
- **3141 isolated node(s):** `AuthUser`, `ResidentSummary`, `ResidentFoodRoutine`, `ApiSuccess`, `ApiFailure` (+3136 more)
...
- **Why does `Role` connect `Community 131` to `Community 0`, `Community 1`, `Community 2`, `Community 5`, `Community 135`, `Community 136`, `Community 10`, `Community 18`, `Community 275`, `Community 276`, `Community 277`, `Community 274`, `Community 278`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 156`, `Community 29`, `Community 30`, `Community 31`, `Community 33`, `Community 34`, `Community 38`, `Community 39`, `Community 168`, `Community 297`, `Community 169`, `Community 43`, `Community 44`, `Community 176`, `Community 56`, `Community 188`, `Community 189`, `Community 190`, `Community 62`, `Community 75`, `Community 76`, `Community 79`, `Community 209`, `Community 210`, `Community 211`, `Community 85`, `Community 96`, `Community 226`, `Community 229`, `Community 104`, `Community 105`, `Community 122`, `Community 123`, `Community 252`, `Community 253`, `Community 254`, `Community 255`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 1` to `Community 0`, `Community 4`, `Community 5`, `Community 8`, `Community 9`, `Community 265`, `Community 139`, `Community 138`, `Community 13`, `Community 136`, `Community 15`, `Community 143`, `Community 141`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 35`, `Community 162`, `Community 37`, `Community 36`, `Community 39`, `Community 40`, `Community 169`, `Community 48`, `Community 177`, `Community 50`, `Community 51`, `Community 52`, `Community 54`, `Community 55`, `Community 56`, `Community 58`, `Community 59`, `Community 62`, `Community 191`, `Community 65`, `Community 67`, `Community 75`, `Community 76`, `Community 79`, `Community 92`, `Community 230`, `Community 112`, `Community 113`, `Community 122`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `browserApi()` connect `Community 7` to `Community 2`, `Community 3`, `Community 6`, `Community 11`, `Community 12`, `Community 16`, `Community 17`, `Community 19`, `Community 28`, `Community 32`, `Community 38`, `Community 41`, `Community 45`, `Community 49`, `Community 178`, `Community 53`, `Community 57`, `Community 187`, `Community 63`, `Community 64`, `Community 196`, `Community 72`, `Community 73`, `Community 77`, `Community 81`, `Community 85`, `Community 97`, `Community 225`, `Community 227`, `Community 121`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Are the 300 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 300 INFERRED edges - model-reasoned connections that need verification._
- **What connects `AuthUser`, `ResidentSummary`, `ResidentFoodRoutine` to the rest of the system?**
