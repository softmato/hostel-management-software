...
## Corpus Check
- 2104 files · ~3,287,261 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 16902 nodes · 46696 edges · 568 communities (527 shown, 41 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 765 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 659 edges
2. `successResponse()` - 639 edges
3. `connectToDatabase()` - 462 edges
4. `useAppTheme()` - 407 edges
5. `cn()` - 303 edges
6. `connectToDatabase()` - 256 edges
7. `unwrap()` - 210 edges
...
## Communities (568 total, 41 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (275): GET(), POST(), GET(), POST(), PATCH(), POST(), RouteContext, GET() (+267 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (321): getResidentAttendance(), listAttendanceAlerts(), demoteToPublicAccount(), getOrCreateSubscription(), selectPlan(), GET(), listResidentComplaints(), getOpenFeeSchedule() (+313 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (190): ICONS, LABELS, Segment, TONES, FILTERS, Pending, Overview, MANAGE_ROWS (+182 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (280): loadOverview(), loadMoney(), loadToday(), TodayData, AdminRollCallCard(), loadFinance(), AdminAlerts, AdminHostel (+272 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (219): Scanner(), FaqRow(), MethodCard(), CookInviteScreen(), GuardianInviteScreen(), Assurance(), CallableRow(), IdentityCard() (+211 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (181): GET(), PATCH(), RouteContext, POST(), GET(), readReturnState(), ownerIdentitiesFor(), resolveOwnedHostel() (+173 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (182): AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), BootGate(), RootShell(), NightStatusHistoryScreen(), NightStatusForm(), NotificationsScreen() (+174 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (158): generateMetadata(), chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout() (+150 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (157): HIDDEN, RoleLayout(), TABS, FILTERS, invalidateFeeds(), NotificationCard(), NotificationRow(), TILE_GLYPH (+149 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (144): AdminCommunityScreen(), SosScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD (+136 more)
...
Cohesion: 0.02
Nodes (157): CommunityReportDialog(), REASONS, MonthOption(), ActiveSuspension, HostelSuspendedScreen(), HostelSuspensionNotice(), isHostelPortal(), PayPlanPanel (+149 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (129): GET(), listFeeSchedules(), assetId, hostelId, mocks, otherHostelId, principal, LIVE_ACCESS (+121 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (142): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, notifyHostelOfNewPost(), resolveHostelCommunityUserIds(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply() (+134 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (117): GuardianDashboard, FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, monthStartPeriod(), Rate, RoomTypeOption, gregorianSpan() (+109 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (137): CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), InvoiceDetailScreen(), SummaryCard(), AmountCard(), AdminLedger (+129 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (118): GET(), POST(), querySchema, RouteContext, authorUserId, mocks, postId, residentId (+110 more)
...
Cohesion: 0.02
Nodes (110): AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, listTrendingTags(), auditFinanceAction(), FinanceAuditInput (+102 more)
...
Cohesion: 0.02
Nodes (114): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), AdminTabs(), AdminMoneyScreen(), MoneyData, AdminTodayScreen(), DeletionPanel() (+106 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (98): HostelAdminCommunityPageContent, HostelAdminMaintenancePageContent, PRIORITIES, STATUS_ACTIONS, HostelAdminMoveChecklistPage, HostelAdminNightStatusPage, HostelAdminNoticesPage, Campaign (+90 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (89): DeletionPathway, DeletionStatus, PATHWAY_COPY, csvField(), deferLoad(), field(), Hostel, HostelTable() (+81 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (98): POST(), summarizeResidentComplaints(), listResidentInvoices(), acceptGuardianInvitation(), listResidentGuardians(), auditGuardianAction(), createGuardianAccess(), expiresInDays() (+90 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (82): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel(), AcceptResult, CookInvitePageContent, field() (+74 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (98): ReportedPostCard(), AssetViewer(), useViewerState(), ViewerPage(), CopyButton(), ManualMethodPanel(), methodCaption(), methodKey() (+90 more)

### Community 26 - "Community 26"
Cohesion: 0.08
Nodes (73): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), subscriptionClaimReceivedEmail(), subscriptionClaimRejectedEmail() (+65 more)

### Community 27 - "Community 27"
Cohesion: 0.02
Nodes (63): PlanPaymentClaim, Filter, ModeratedPost, ModerationPayload, DemoDataBadge(), UserRecord, DeletionQueue, DeletionRequest (+55 more)

### Community 28 - "Community 28"
Cohesion: 0.02
Nodes (88): DescriptionFacts, DescriptionSuggestions(), HostelType, since(), starters, typeWords, HostelRegistrationProgress(), Milestone (+80 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (97): addComplaintUpdate(), assertComplaintVoiceNote(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput (+89 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (96): createExpertConsultationRequest(), ExpertConsultationCreateInput, ExpertConsultationError, ExpertConsultationRequestRecord, getMyExpertConsultationRequest(), expertConsultationCreateSchema, GET(), POST() (+88 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (80): metadata, AccountDeletionPanel, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails() (+72 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (98): openStore(), ProfileScreen(), ReferralRow(), CheckoutStatusScreen(), DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS (+90 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (95): AdminCommunityReportsScreen(), AttendanceScreen(), NightStatusScreen(), ReferralsScreen(), SORTS, StoreCategoryScreen(), ComplaintDetailScreen(), ComplaintsScreen() (+87 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (91): ReviewForm(), ReviewScreen(), describeGrants(), GuardianRow(), PermissionSheet(), InviteGuardianScreen(), inviteGuardian(), listGuardians() (+83 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (79): fill(), money(), PlanCard(), PricingScreen(), pricePlan(), PlanPicker(), InlineText(), TIER_TONE (+71 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (90): fromBs(), gregorianOf(), BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary (+82 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (70): Notification, FILTERS, Notification, NotificationRow(), PushState, FILTERS, NotificationCard, NotificationsPageContent (+62 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (82): dueWhen(), PlanDueInput, planDueSoonEmail(), planOverdueEmail(), CHANNELS, ClaimedStep, composeEmail(), composeNotice() (+74 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (57): CopyButton(), GatewayProviderName, ManualMethodPanel(), MethodIcon(), methodKey(), methodLabel(), PayMethod, PROVIDER_LABEL (+49 more)
...
Cohesion: 0.04
Nodes (67): GET(), POST(), GET(), querySchema, checkTeamOwnerEmail(), findHostelUsingEmail(), hostelId, mocks (+59 more)
...
Cohesion: 0.03
Nodes (67): Faq, PlatformConfigSeoPageContent, Step, loadSiteName(), CONTENT_ICON_SLUGS, everything, IDENTITY, page (+59 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (67): GATEWAY_ORDER, getHostelPayMethods(), getPayInstructions(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod (+59 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (66): DELETE(), POST(), notificationSchema, platformPushScheduleSchema, CampaignListQuery, CampaignRecord, createCampaign(), createHostelNotificationCampaign() (+58 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (65): approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal, checker, eventId (+57 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (47): HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminRoomsPageContent(), PlatformDashboardPageContent(), PlatformHostelReviewPageContent(), PlatformUsersPageContent(), DashboardCard(), DashboardCardProps (+39 more)

### Community 48 - "Community 48"
Cohesion: 0.03
Nodes (57): CookTodayScreen(), PortalDates, useHostelDayTurn(), useMinuteTick(), useSiteConfig(), AdminNightStatusRow, PlanBilling, PlanBillingInvoice (+49 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (40): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, metadata, LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminComplaintsPage(), HostelAdminFoodPage() (+32 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (64): paymentProofSchema, receiptSchema, arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId (+56 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (55): ComparePage(), generateMetadata(), hostels, metadata, rows, PublicComparePage(), CITY_OPTIONS, FACILITY_STATS (+47 more)
...
Cohesion: 0.06
Nodes (54): collectionTotals(), countInvoicesByField(), invoicesByIds(), ledgerPipeline(), monthlySeries(), countListingAppearances(), getHostelViewStats(), complaintSchema (+46 more)
...
Cohesion: 0.05
Nodes (58): documents, hostelForm(), many, parsed, result, buildHostelPayload(), capacitySummary(), emptyHostelForm() (+50 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (43): ReturnState, CancelDeletionPageContent(), CheckoutReturnPage(), CookAccount, Credentials, HostelAdminCooksPanel, Issued, addDays() (+35 more)

### Community 59 - "Community 59"
Cohesion: 0.05
Nodes (50): qrActivationSchema, before, expiresAt, mocks, staffPrincipal, ActivationCodeGenerateInput, ActivationCodeInput, activationSecret() (+42 more)
...
Cohesion: 0.05
Nodes (50): notifyStaffOfJobProgress(), serviceProviderApplicationSchema, serviceProviderDocumentSchema, ServiceProvidersPage(), hostelId, mocks, providerId, ACTIVE_APPLICATION_STATUSES (+42 more)

### Community 62 - "Community 62"
Cohesion: 0.05
Nodes (42): EMPTY_DRAFT, HostelAdminPaymentProfilePageContent, PaymentProfile, SECTION_FIELDS, SectionId, BankMark(), EsewaMark(), KhaltiMark() (+34 more)
...
Cohesion: 0.06
Nodes (49): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+41 more)

### Community 65 - "Community 65"
Cohesion: 0.06
Nodes (51): announceFoodReady(), dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, isMonthEnd(), mealsOn() (+43 more)

### Community 66 - "Community 66"
Cohesion: 0.05
Nodes (48): CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, isPlanDueNotification(), readId(), activeDevicesFor(), activeTokensFor(), androidChannel() (+40 more)

### Community 67 - "Community 67"
Cohesion: 0.08
Nodes (44): POST(), RouteContext, deleteHostelObjects(), purgeHostel(), isFileAssetKind(), isFinancialAssetKind(), r2Configured(), storePublicAsset() (+36 more)

### Community 68 - "Community 68"
Cohesion: 0.06
Nodes (55): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsMonthStart() (+47 more)

### Community 69 - "Community 69"
Cohesion: 0.04
Nodes (31): ConfirmOptions, useConfirm(), ExistingResidentsPanel(), Props, ExistingResidentsSheet(), HostelAdminExistingResidentsPage(), AUDIENCE_LABEL, PlatformPushPageContent (+23 more)
...
Cohesion: 0.05
Nodes (52): continueLabel(), isBlank(), buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, draftFromProfile() (+44 more)

### Community 72 - "Community 72"
Cohesion: 0.06
Nodes (48): Coordinates, isUsableCoordinate(), CARDINALS, chooseHeading(), directionWord(), distanceToPath(), hasArrived(), headingDifference() (+40 more)
...
Cohesion: 0.06
Nodes (46): hostelCalendarDay(), hostelToday(), BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped (+38 more)

### Community 77 - "Community 77"
Cohesion: 0.08
Nodes (43): JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, ProviderJobScreen(), listProviderJobs() (+35 more)
...
Cohesion: 0.07
Nodes (45): Offset, PhotoCropper(), VideoSlot(), CollectionQrField(), FileUploadArea(), PhotoStrip(), isActive(), acceptAttribute() (+37 more)
...
Cohesion: 0.08
Nodes (47): AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance(), deadline(), DIGIT_CONFUSABLES, EvidenceRead (+39 more)

### Community 83 - "Community 83"
Cohesion: 0.08
Nodes (41): nightStatusPromptSchema, askingEndsAt(), askingEndsMinuteOfNight(), formatPromptTime(), isSameNight(), minuteIsDue(), minuteOfNight(), nightEndsAt() (+33 more)
...
Cohesion: 0.05
Nodes (37): daysFromNow(), enabledPermissionLabels(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags, GuardianPermissionsUpdateInput, GuardianRecord (+29 more)
...
Cohesion: 0.08
Nodes (38): POST(), addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange(), definedUpdate(), FoodFeedbackInput, FoodFeedbackRecord (+30 more)
...
Cohesion: 0.07
Nodes (37): bedSchema, paymentSchema, roomSchema, auditMoveAction(), createMoveInChecklist(), createMoveOutChecklist(), findAdminResident(), getMoveInChecklist() (+29 more)

### Community 91 - "Community 91"
Cohesion: 0.07
Nodes (40): Choice, Compass(), maneuverIcon(), MapButton(), MapScreen(), ModeTab(), NavCard(), NOTHING_CHOSEN (+32 more)
...
Cohesion: 0.08
Nodes (36): isAuthBypassEnabled(), original, cook, assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES, PermissionError (+28 more)
...
Cohesion: 0.05
Nodes (31): categoryLabel(), PROVIDER_CATEGORIES, ProviderCard(), ProviderDirectoryData, PublicProvider, PublicServiceProviderDirectoryPage(), CATEGORIES, isApplicationOpen() (+23 more)
...
Cohesion: 0.06
Nodes (28): currency(), EmptyState(), Panel(), ResidentActivationPageContent, ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent (+20 more)

### Community 99 - "Community 99"
Cohesion: 0.04
Nodes (22): ERASED_BY_HOSTEL_ID, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, attendanceAlertSchema, communityCommentVoteSchema, communityReactionSchema, communityReportSchema (+14 more)

### Community 100 - "Community 100"
Cohesion: 0.08
Nodes (39): deliver(), loadInvoiceById(), loadProof(), PlanPaymentInstructions, ProofAsset, reviewPlanPaymentClaim(), submitPlanPaymentClaim(), Resolver (+31 more)
...
Cohesion: 0.08
Nodes (31): DEPRECATED_ALIASES, grantingPermissionKeys(), mocks, auditWardenAction(), createHostelWarden(), deactivateHostelWarden(), findScopedWarden(), HostelMemberRecord (+23 more)
...
Cohesion: 0.08
Nodes (36): addHistory(), addMaintenanceComment(), assertBedInHostel(), assertProviderApproved(), assertRoomInHostel(), assertVoiceNoteUsable(), assignMaintenanceProvider(), auditMaintenanceAction() (+28 more)
...
Cohesion: 0.08
Nodes (34): cookPrincipal, mocks, resolveCookLabels(), cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError, decodePhotoCursor() (+26 more)
...
Cohesion: 0.08
Nodes (38): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags() (+30 more)
...
Cohesion: 0.09
Nodes (34): NotificationSoundListener(), RealtimeConfig, RealtimeContext, RealtimeContextValue, RealtimeNotification, RealtimeProvider(), useRealtime(), attempt() (+26 more)
...
Cohesion: 0.11
Nodes (24): platformAdminInviteSchema, GET(), deleteTeamMember(), endSessions(), findMember(), MemberRecord, reinstateTeamMember(), removeTeamMember() (+16 more)
...
Cohesion: 0.12
Nodes (23): computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), distance, readQrPayeeFields(), cleanAccountNumber(), cleanName(), hasQrPayee() (+15 more)
...
Cohesion: 0.08
Nodes (17): accountDeletionRequestSchema, attendanceLogSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, consentLogSchema, questionCallClickSchema, sessionSchema (+9 more)
...
Cohesion: 0.2
Nodes (25): bootstrapSession(), assertMatchesExtension(), beginDownload(), downloadAndShare(), downloadAndShareCsv(), downloadAndShareImage(), downloadToDevice(), forgetDownloadFolder() (+17 more)

### Community 155 - "Community 155"
Cohesion: 0.1
Nodes (21): buildHtml(), HostelMap(), Marker, PlaceMarker, boundsCenter(), haversineMeters(), hostelCoordinates(), HostelWithDistance (+13 more)

### Community 156 - "Community 156"
Cohesion: 0.1
Nodes (23): CREDIT_MARKERS, DEBIT_MARKERS, DirectionRead, directionRefusal(), EvidenceDirection, EvidenceOutcome, matched(), OUTCOME_MARKERS (+15 more)
...
Cohesion: 0.12
Nodes (17): HostelGeoRecord, sleep(), HostelGeoLocation, resolveHostelGeo(), fetchNearbyPlaces(), fetchNearbyWithGoogle(), fetchNearbyWithOverpass(), GOOGLE_PLACE_TYPES (+9 more)

### Community 166 - "Community 166"
Cohesion: 0.2
Nodes (20): getInvoiceDetailForHostel(), HostelScope, ResolvedDocument, resolveInvoiceDocument(), resolveReceiptDocument(), scopeFilter(), settledTotal(), trySoftmato() (+12 more)
...
Cohesion: 0.17
Nodes (19): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), OpenedCheckout, readSettledReceipt(), SettledReceipt, allocateNumber(), ensureInvoiceRaised() (+11 more)
...
Cohesion: 0.19
Nodes (19): allocateReceiptNumber(), applySettlement(), InvoiceRecord, loadInvoice(), logAccessFailure(), openHostelAfterPayment(), openSubscriptionCheckout(), publishForSubscription() (+11 more)
...
Cohesion: 0.12
Nodes (18): InvoiceDocumentInput, InvoicePresentation, documentFileName(), DocumentKind, InvoiceRow, invoiceStatus(), loadIssuer(), methodLabel() (+10 more)
...
Cohesion: 0.17
Nodes (16): systemDocumentKind(), drawCertificationStamp(), footerLine(), formatDate(), formatLongDate(), MONTHS, ReceiptPdfInput, renderReceiptPdf() (+8 more)

### Community 207 - "Community 207"
Cohesion: 0.11
Nodes (16): defaultDueDate(), DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), axisMonth(), monthLabel() (+8 more)

### Community 208 - "Community 208"
Cohesion: 0.13
Nodes (14): candidateRoots, fillMissing(), findRepoRoot(), { loadEnvConfig }, loadRootEnv(), parseEnvFile(), require, filled (+6 more)
...
Cohesion: 0.25
Nodes (15): resolvePastedLink(), searchCandidates(), lookupLocation(), resolvePastedLink(), searchCandidates(), queryVariants(), reverseGeocode(), ParsedMapLink (+7 more)

### Community 215 - "Community 215"
Cohesion: 0.11
Nodes (15): documentUrl(), InvoiceLean, PaymentLean, PlatformInvoiceRow, PlatformPaymentRow, PlatformSubscriptionLedger, HOSTEL_SUBSCRIPTION_STATUSES, hostelSubscriptionSchema (+7 more)

### Community 216 - "Community 216"
Cohesion: 0.14
Nodes (19): 4.2 Complaint Status Updated, 4. Resident Activity Emails, 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, 7.1 New Hostel Pending Approval (to Superadmin) (+11 more)
...
Cohesion: 0.13
Nodes (13): activateResident(), AuthSession, getResidentReferral(), ResidentReferral, ResidentReferralCode, AppNavigator(), Stack, LoginScreen() (+5 more)
...
Cohesion: 0.21
Nodes (14): softmatoDocsUrl(), dueBhadra29, filed, throughAswin25, CYCLE_LABELS, daysLeftThrough(), daysSpanned(), daysUntil() (+6 more)
...
Cohesion: 0.15
Nodes (14): apiRequest(), confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listResidentComplaints(), login(), refreshSession(), register() (+6 more)
...
Cohesion: 0.19
Nodes (10): humanizeNearbyType(), NEARBY_GLYPHS, NEARBY_GROUPS, NEARBY_ICONS, nearbyGlyph(), NearbyGroup, nearbyIcon(), groups (+2 more)
...
Cohesion: 0.22
Nodes (8): openCheckoutSession(), checkoutReturnUrl(), OpenCheckoutInput, openSoftmatoCheckout(), softmato(), SoftmatoNotConfiguredError, isSoftmatoConfigured(), SoftmatoConfig
...
Cohesion: 0.24
Nodes (8): key(), ListingHostel, ListingProjection, projectSchedule(), RoomConfiguration, hostel, result, logger
...
## Knowledge Gaps
- **5922 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+5917 more)
...
- **Why does `cn()` connect `Community 11` to `Community 2`, `Community 7`, `Community 14`, `Community 17`, `Community 147`, `Community 21`, `Community 22`, `Community 24`, `Community 410`, `Community 27`, `Community 28`, `Community 31`, `Community 159`, `Community 35`, `Community 37`, `Community 39`, `Community 300`, `Community 47`, `Community 51`, `Community 58`, `Community 60`, `Community 63`, `Community 69`, `Community 74`, `Community 75`, `Community 79`, `Community 80`, `Community 81`, `Community 85`, `Community 92`, `Community 95`, `Community 98`, `Community 120`, `Community 121`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 2` to `Community 3`, `Community 4`, `Community 6`, `Community 135`, `Community 8`, `Community 9`, `Community 11`, `Community 14`, `Community 15`, `Community 20`, `Community 21`, `Community 22`, `Community 24`, `Community 25`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 37`, `Community 39`, `Community 56`, `Community 58`, `Community 70`, `Community 91`, `Community 112`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 1` to `Community 0`, `Community 132`, `Community 5`, `Community 7`, `Community 10`, `Community 12`, `Community 13`, `Community 142`, `Community 398`, `Community 16`, `Community 141`, `Community 18`, `Community 143`, `Community 23`, `Community 156`, `Community 29`, `Community 30`, `Community 36`, `Community 165`, `Community 38`, `Community 166`, `Community 40`, `Community 168`, `Community 42`, `Community 43`, `Community 44`, `Community 45`, `Community 46`, `Community 175`, `Community 41`, `Community 49`, `Community 178`, `Community 50`, `Community 180`, `Community 53`, `Community 54`, `Community 184`, `Community 59`, `Community 61`, `Community 64`, `Community 65`, `Community 66`, `Community 67`, `Community 73`, `Community 204`, `Community 76`, `Community 83`, `Community 84`, `Community 86`, `Community 215`, `Community 88`, `Community 90`, `Community 222`, `Community 223`, `Community 94`, `Community 99`, `Community 100`, `Community 101`, `Community 102`, `Community 104`, `Community 234`, `Community 106`, `Community 110`, `Community 116`, `Community 124`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Are the 457 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 457 INFERRED edges - model-reasoned connections that need verification._
