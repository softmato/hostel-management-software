...
## Corpus Check
- 1814 files · ~3,201,212 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14579 nodes · 40096 edges · 499 communities (478 shown, 21 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 627 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 590 edges
2. `successResponse()` - 578 edges
3. `connectToDatabase()` - 393 edges
4. `useAppTheme()` - 362 edges
5. `cn()` - 265 edges
6. `connectToDatabase()` - 230 edges
7. `unwrap()` - 192 edges
...
## Communities (499 total, 21 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (192): POST(), PATCH(), POST(), RouteContext, GET(), POST(), POST(), POST() (+184 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (232): POST(), POST(), GET(), getOpenFeeSchedule(), GET(), POST(), addHostelAdminInquiryNote(), auditInquiryAction() (+224 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (169): ICONS, LABELS, Segment, TONES, FILTERS, Pending, Overview, MoneyData (+161 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (221): Scanner(), CookInviteScreen(), GuardianInviteScreen(), ModeTab(), Assurance(), CallableRow(), IdentityCard(), PeopleSection() (+213 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (261): loadOverview(), loadMoney(), loadToday(), AdminRollCallCard(), loadFinance(), AdminInvoiceMatrix, AdminMaintenance, AdminMaintenanceRequest (+253 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (166): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), BootGate(), RootShell() (+158 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (135): UserRecord, GuardianDashboard, FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, monthStartPeriod(), Rate, RoomTypeOption (+127 more)
...
Cohesion: 0.03
Nodes (132): POST(), attacker, attempt(), headers, jsonRequest(), routeMocks, appBaseUrl(), authenticateWithGoogle() (+124 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (107): Choice, MapButton(), NOTHING_CHOSEN, PreviewCard(), ResultRow(), RouteCard(), SavedListRow(), BrowseParams (+99 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (138): AdminCommunityReportsScreen(), AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), AttendanceScreen(), MapScreen(), NightStatusForm(), NightStatusScreen() (+130 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (133): PaymentMonthStrip(), ManageRatesScreen(), ClearFilters(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard() (+125 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (117): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus(), OPEN_STATUSES (+109 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (121): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), methodProvider(), PROVIDER_LABEL, QrPanel() (+113 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (107): listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), GET(), POST(), querySchema, RouteContext (+99 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (88): AuthExperiencePage(), csvField(), field(), Hostel, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminProfilePageContent(), HostelAdminRoomsPageContent() (+80 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (93): GET(), POST(), GET(), GET(), POST(), DELETE(), POST(), getMyExpertConsultationRequest() (+85 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (98): PATCH(), RouteContext, POST(), RouteContext, GET(), PATCH(), RouteContext, GET() (+90 more)

### Community 18 - "Community 18"
Cohesion: 0.07
Nodes (76): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, DASHBOARD_ROLES, FACILITY_ICONS (+68 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (96): summarizeResidentComplaints(), latestInvoicePerResident(), LedgerInvoice, listResidentInvoices(), renderStatementForResident(), getResidentLedger(), accessId, adminPrincipal (+88 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (105): cookPrincipal, mocks, resolveCookLabels(), announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError (+97 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (77): field(), GuardianDashboard, GuardianDashboardPageContent(), LoadState, NightStatusRow, Notification, optionalNumber(), Resident (+69 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (74): csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, HostelTable(), Inquiry, LoadState (+66 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (100): deleteResidentLocationHistory(), confirmComplaintResolution(), listResidentComplaints(), getFoodRoutinesByHostelId(), listFoodForResident(), listPublicFoodRoutine(), submitFoodFeedback(), listResidentGuardians() (+92 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (83): PRIORITIES, STATUS_ACTIONS, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel, GatewayConfig, GatewayHealthStatus (+75 more)
...
Cohesion: 0.03
Nodes (80): HostelPhotoReminder(), HostelSuggestions(), inferKind(), MediaLightbox(), PublicComparePage(), formatHostelAddress(), hostelTypeToUi(), mapPublicHostelToSummary() (+72 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (84): CommunityReportDialog(), REASONS, MonthOption(), InlineText(), PlanMark(), ROWS, ModerationButton(), PagerButton() (+76 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (81): POST(), RouteContext, DELETE(), GET(), hostelId(), GET(), POST(), DELETE() (+73 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (82): AdminCommunityScreen(), CommunityScreen(), Composer(), ReportedPostCard(), useReportedCount(), CommunityBoard(), CommunityBoardProps, Composer() (+74 more)
...
Cohesion: 0.04
Nodes (92): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthStart(), bsPeriodBounds() (+84 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (82): approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal, checker, eventId (+74 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (68): ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, attempt, fetchMock, forged, live (+60 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (71): assetId, hostelId, mocks, otherHostelId, principal, CookServiceError, resolveAdminHostelId(), ApiPrincipal (+63 more)
...
Cohesion: 0.04
Nodes (70): AdminAlertsScreen(), AdminHomeScreen(), AdminOverviewScreen(), AdminTabs(), HIDDEN, TABS, AdminTodayScreen(), TABS (+62 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (53): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminAttendancePageContent, HostelAdminCommunityPageContent, HostelAdminDashboardPageContent (+45 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (79): ReferralRow(), ReviewForm(), ReviewScreen(), DeletionRequest, DeletionStatus, getDeletionStatus(), requestAccountDeletion(), api (+71 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (64): LegacyHostelAdminComplaintsPage(), EMPTY_SUMMARY, HostelAdminComplaintsPage, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS (+56 more)
...
Cohesion: 0.04
Nodes (69): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, GATEWAY_ORDER, getHostelPayMethods() (+61 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (64): notifyProviderOfAssignment(), notifyProviderOfMaintenanceNote(), notifyProviderOfStatusChange(), notifyStaffOfNewMaintenanceRequest(), providerUserId(), readableCategory(), RequestLike, STATUS_WORDS (+56 more)

### Community 44 - "Community 44"
Cohesion: 0.03
Nodes (48): AuthGuard(), cityOptions, createDocument(), createRoom(), DocumentConfig, DraftData, FACILITY_MINI, facilityOptions (+40 more)
...
Cohesion: 0.05
Nodes (59): GET(), countInvoicesByStatus(), fromLedgerRow(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor(), LedgerInvoiceRow, LedgerScope, LedgerTotals (+51 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (58): ComparePage(), hostels, metadata, rows, CurrentUser, DASHBOARD_ROLES, dashboardHrefForRole(), hasDashboard() (+50 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (58): AttachmentGallery(), ComplaintDetail(), ComplaintDetailScreen(), ComplaintCard(), CategoryTile(), NewComplaintScreen(), PickedAttachment, SwapButton() (+50 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (54): FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind, creditOverpayment() (+46 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (44): CopyButton(), GatewayProviderName, ManualMethodPanel(), MethodIcon(), methodKey(), methodLabel(), PayMethod, PROVIDER_LABEL (+36 more)

### Community 51 - "Community 51"
Cohesion: 0.13
Nodes (39): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), cookInvitationEmail(), guardianInvitationEmail() (+31 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (45): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, ROLE_VALUES, hostelMemberSchema, rolePermissionSchema, userSchema (+37 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (58): auditFinanceAction(), base, entityId, hostelId, mocks, principal, write(), aswin (+50 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (51): addComplaintUpdate(), assertComplaintVoiceNote(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput (+43 more)
...
Cohesion: 0.05
Nodes (53): approveClaim(), assertNotAlreadyRecordedFromStatement(), findClaim(), referralSchema, referralCodeSchema, referralRewardSchema, activeCode, codeId (+45 more)

### Community 57 - "Community 57"
Cohesion: 0.06
Nodes (56): BLOOD_OPTIONS, DIET_OPTIONS, EditIdentityScreen(), GENDER_OPTIONS, ID_TYPE_OPTIONS, IdentityForm(), OCCUPATION_OPTIONS, IdCardDetail() (+48 more)

### Community 58 - "Community 58"
Cohesion: 0.05
Nodes (52): PaginationMeta, PaginationQuery, querySchema, sponsorSchema, assertWindow(), CreateInput, createSponsor(), deleteSponsor() (+44 more)

### Community 59 - "Community 59"
Cohesion: 0.05
Nodes (53): deleteFromR2(), getR2Client(), classifyCredit(), CreditClassification, findOrphanClaims(), LadderClaim, LadderInvoice, loadMatchContext() (+45 more)
...
Cohesion: 0.06
Nodes (52): POST(), GET(), POST(), GET(), PATCH(), GET(), GET(), POST() (+44 more)

### Community 62 - "Community 62"
Cohesion: 0.06
Nodes (43): POST(), POST(), listTrendingTags(), POST(), hashUserAgent(), HostelRef, newVisitorKey(), recordHostelPageView() (+35 more)

### Community 63 - "Community 63"
Cohesion: 0.04
Nodes (53): CONTENT_ICON_SLUGS, everything, IDENTITY, page, rendered, platformSettingSchema, PLAN_MODULES, PLAN_SERVICES (+45 more)
...
Cohesion: 0.06
Nodes (44): nepalDayKey(), isCurrentNight(), isSelfReportable(), NIGHT_STATUS_OPTIONS, nightKey(), nightNote(), NightStanding, SelfReportableStatus (+36 more)
...
Cohesion: 0.05
Nodes (44): ProviderDirectoryData, notifyStaffOfJobProgress(), serviceProviderApplicationSchema, serviceProviderDocumentSchema, DirectoryPageProps, EMPTY, metadata, ServiceProviderDirectoryPage() (+36 more)

### Community 68 - "Community 68"
Cohesion: 0.07
Nodes (39): NotificationsPageContent(), Notification, BrowserPushRow(), FILTERS, Notification, NotificationRow(), PushState, FILTERS (+31 more)
...
Cohesion: 0.06
Nodes (46): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+38 more)
...
Cohesion: 0.06
Nodes (32): fill(), PricingScreen(), TIER_TONE, BillingToggle(), EASE, PlanCards(), PlanLine(), PlansClosingCta() (+24 more)

### Community 76 - "Community 76"
Cohesion: 0.05
Nodes (35): complaintCategorySchema, complaintListQuerySchema, complaintReplySchema, complaintStatusSchema, complaintStatusUpdateSchema, objectIdSchema, GET(), POST() (+27 more)
...
Cohesion: 0.07
Nodes (35): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, PortalShell(), navItems, canAccessWorkspace(), defaultWorkspaceSlug(), isAuthBypassed(), listWorkspaceHostels() (+27 more)

### Community 81 - "Community 81"
Cohesion: 0.07
Nodes (34): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), robots() (+26 more)
...
Cohesion: 0.08
Nodes (32): outstandingForResident(), depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, providedItemSchema, auditMoveAction(), createMoveInChecklist(), createMoveOutChecklist() (+24 more)
...
Cohesion: 0.05
Nodes (30): assetId, body, call, hashCall, hostelId, input, invoiceId, mocks (+22 more)

### Community 87 - "Community 87"
Cohesion: 0.08
Nodes (35): storeCartSchema, storeOrderSchema, mocks, allocateOrderNumber(), applyStatus(), CancelInput, cancelOrder(), CreateInput (+27 more)

### Community 88 - "Community 88"
Cohesion: 0.09
Nodes (35): renderIdCardPng(), hostelPageViewSchema, userResidentProfileSchema, LEGACY_ROLE_MAP, Role, ROLE_VALUES, CARD_LABELS, formatIssuedOn() (+27 more)

### Community 89 - "Community 89"
Cohesion: 0.07
Nodes (34): findIndex(), index, indexesOf(), IndexSpec, promote, BulkApproveResult, ClaimCheck, claimChecks() (+26 more)
...
Cohesion: 0.08
Nodes (32): ClaimDraft, clearClaimDraft(), keyFor(), readClaimDraft(), saveClaimDraft(), canonicalize(), CLAIM_METHODS, ClaimDraft (+24 more)

### Community 94 - "Community 94"
Cohesion: 0.1
Nodes (25): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, base (+17 more)
...
Cohesion: 0.09
Nodes (21): geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), GoogleMap, HostelMap(), LeafletMap, TYPE_COLORS (+13 more)

### Community 98 - "Community 98"
Cohesion: 0.11
Nodes (27): FILE_ASSET_KINDS, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList() (+19 more)
...
Cohesion: 0.1
Nodes (35): money(), PlanCard(), listHeadingFor(), PlanCard(), CatalogueTab(), CycleDiscount(), PublicListingBadgePage(), PublicServiceDetailPage() (+27 more)
...
Cohesion: 0.07
Nodes (28): CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing, buildIdCardData() (+20 more)

### Community 104 - "Community 104"
Cohesion: 0.08
Nodes (26): approvalPeriod(), getPeriodSummary(), monthsBetween(), periodOf(), PeriodRow, PeriodSummary, august, bhadra (+18 more)
...
Cohesion: 0.1
Nodes (28): hostelSettingsSchema, nightStatusPromptSchema, formatPromptTime(), isCurrentNight(), isSameNight(), minuteIsDue(), parsePromptTime(), promptIsDue() (+20 more)
...
Cohesion: 0.1
Nodes (29): BALANCE_ALIASES, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES, WITHDRAWAL_ALIASES (+21 more)
...
Cohesion: 0.1
Nodes (26): daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags, GuardianPermissionsUpdateInput (+18 more)
...
Cohesion: 0.11
Nodes (24): DownloadRow, DownloadStack(), progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster(), UploadRow (+16 more)
...
Cohesion: 0.08
Nodes (12): Contact, PlatformApplication, PlatformHostelDetail, PlatformHostelDocument, TABS, ACTION_PROGRESS, PlatformServiceProviderReviewPageContent, ProviderApplication (+4 more)
...
Cohesion: 0.1
Nodes (20): DayRow(), AttendanceDay, AttendanceMonth, AttendanceSource, AttendanceSummary, AttendanceTone, AttendanceZone, groupByMonth() (+12 more)
...
Cohesion: 0.13
Nodes (19): GET(), resolvePastedLink(), searchCandidates(), hostelAdminGeocodeQuerySchema, DraggablePinMap, FALLBACK_CENTER, LocationPicker(), LocationPickerValue (+11 more)

### Community 148 - "Community 148"
Cohesion: 0.15
Nodes (20): [first], FIXTURES, fromCsv, fromWorkbook, parse(), parseText(), read(), rows (+12 more)
...
Cohesion: 0.14
Nodes (20): uploadPublicFile(), FileAssetKind, ApiEnvelope, parseEnvelope(), sendUpload(), sendWithProgress(), UploadCanceledError, UploadError (+12 more)
...
Cohesion: 0.1
Nodes (20): CachedQuery, defined, entries, Entry, inflight, invalidateQuery(), Listener, listeners (+12 more)
...
Cohesion: 0.18
Nodes (16): announceFoodReady(), CookPhotoDay, CookPhotoFeed, CookResident, CookToday, FoodReadyAnnouncement, FoodReadyResult, FoodReadySent (+8 more)
...
Cohesion: 0.13
Nodes (21): 4.2 Complaint Status Updated, 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, 7.1 New Hostel Pending Approval (to Superadmin), 7.2 Subscription Expiring Soon (+13 more)
...
Cohesion: 0.13
Nodes (17): haversineMeters(), hostelCoordinates(), HostelWithDistance, isUsableCoordinate(), KATHMANDU, sortByDistance(), distance, far (+9 more)
...
Cohesion: 0.18
Nodes (18): AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim(), definedParts(), geocodeAddress(), geocodeWithGoogle(), geocodeWithNominatim(), GoogleAddressComponent (+10 more)
...
Cohesion: 0.17
Nodes (17): FileUploadArea(), EXTENSION_BY_MIME, FAMILY_BYTES, FAMILY_ORDER, familyOf(), formatBytes(), joinTypes(), KIND_RULES (+9 more)
...
Cohesion: 0.15
Nodes (12): AuthSession, login(), triggerSOS(), AppNavigator(), RootStackParamList, Stack, LoginScreen(), Props (+4 more)
...
Cohesion: 0.18
Nodes (13): buildHtml(), Marker, PlaceMarker, buildShell(), MapExplorer, MapExplorerProps, MapHandle, MapMarker (+5 more)
...
Cohesion: 0.14
Nodes (14): BANK_CSV_PARSER, ESEWA_PARSER, KHALTI_CSV_PARSER, bytes, [first], [, incoming], [outgoing, incoming], parse() (+6 more)
...
Cohesion: 0.15
Nodes (9): EASE, FaqEntry, FaqRole, FaqRow(), FAQS, PlansFaq(), PREVIEW_ROWS, ROLES (+1 more)
...
Cohesion: 0.26
Nodes (9): RoleLayout(), TABS, useMinuteTick(), useQueryValue(), prefetchCookPortal(), prefetchCookQuery(), prefetchGuardianQuery(), prefetchQuery() (+1 more)
...
Cohesion: 0.18
Nodes (10): AMOUNT_ALIASES, CREDIT_ALIASES, DATE_ALIASES, DEBIT_ALIASES, NAME_ALIASES, nonZero(), readMoney(), REMARKS_ALIASES (+2 more)
...
Cohesion: 0.33
Nodes (9): CsvTable, gridFromCsv(), peekHeaders(), readCsv(), stripBom(), stripPreamble(), buildTable(), tableFromGrid() (+1 more)
...
Cohesion: 0.22
Nodes (8): connectRealtime(), fetchConfig(), PusherModule, REALTIME_EVENT, RealtimeConfig, RealtimeConnection, RealtimeHandlers, RealtimeNotification
...
Cohesion: 0.24
Nodes (10): 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, 4.3 Complaint Resolved, code:typescript ({), code:typescript ({) (+2 more)
...
## Knowledge Gaps
- **5149 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+5144 more)
...
- **Why does `Button()` connect `Community 2` to `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 147`, `Community 22`, `Community 27`, `Community 29`, `Community 30`, `Community 35`, `Community 36`, `Community 38`, `Community 39`, `Community 45`, `Community 48`, `Community 50`, `Community 57`, `Community 68`, `Community 218`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 74` to `Community 0`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 17`, `Community 146`, `Community 147`, `Community 20`, `Community 22`, `Community 24`, `Community 280`, `Community 157`, `Community 31`, `Community 33`, `Community 34`, `Community 165`, `Community 42`, `Community 44`, `Community 45`, `Community 173`, `Community 174`, `Community 55`, `Community 314`, `Community 188`, `Community 62`, `Community 64`, `Community 69`, `Community 201`, `Community 93`, `Community 103`, `Community 362`, `Community 106`, `Community 108`, `Community 111`, `Community 115`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 27` to `Community 2`, `Community 3`, `Community 6`, `Community 7`, `Community 269`, `Community 270`, `Community 15`, `Community 18`, `Community 21`, `Community 22`, `Community 24`, `Community 26`, `Community 30`, `Community 289`, `Community 39`, `Community 44`, `Community 47`, `Community 50`, `Community 188`, `Community 192`, `Community 68`, `Community 69`, `Community 70`, `Community 75`, `Community 80`, `Community 100`, `Community 103`, `Community 119`, `Community 121`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Are the 388 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 388 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `{ defineConfig }`, `expoConfig`, `path` to the rest of the system?**
  _5149 weakly-connected nodes found - possible documentation gaps or missing edges._
