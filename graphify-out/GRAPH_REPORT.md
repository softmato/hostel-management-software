...
## Corpus Check
- 1683 files · ~2,841,562 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 13449 nodes · 37051 edges · 490 communities (470 shown, 20 thin omitted)
...
4. `useAppTheme()` - 323 edges
5. `cn()` - 243 edges
6. `connectToDatabase()` - 224 edges
7. `useResource()` - 185 edges
8. `unwrap()` - 185 edges
...
- `POST()` --calls--> `connectToDatabase()`  [INFERRED]
  apps/web/src/app/api/v1/resident/finance/evidence/[assetId]/read/route.ts → packages/db/src/connection.ts

## Communities (490 total, 20 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (173): ICONS, LABELS, Segment, TONES, FILTERS, Pending, MoneyData, MANAGE_ROWS (+165 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (241): AdminCommunityScreen(), loadOverview(), loadMoney(), loadToday(), ReportedPostCard(), useReportedCount(), VoiceNotePlayer(), RoundButton() (+233 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (183): Scanner(), GuardianInviteScreen(), Choice, Compass(), MapButton(), MapScreen(), ModeTab(), NOTHING_CHOSEN (+175 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (198): BootGate(), RootShell(), AttachmentGallery(), BrandSplash(), AuthDivider(), GoogleSignInButton(), RoleGate(), UploadToaster() (+190 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (156): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload (+148 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (151): CommunityReportDialog(), REASONS, GuardianDashboard, MonthPicker, PeriodRow, Ledger, OrphanAssignPicker, MatrixRow (+143 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (181): AdminAlertsScreen(), AdminCommunityReportsScreen(), AdminHomeScreen(), AdminMoneyScreen(), AdminMoreScreen(), AdminResidentsScreen(), AdminTodayScreen(), ActivateScreen() (+173 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (117): DeletionPathway, DeletionStatus, PATHWAY_COPY, csvField(), deferLoad(), DemoDataBadge(), field(), Hostel (+109 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (175): sendEmail(), addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery, HostelAdminInquiryStatusInput, InquiryNoteCreateInput, InquiryNoteRecord (+167 more)
...
Cohesion: 0.03
Nodes (120): PATCH(), POST(), RouteContext, GET(), GET(), POST(), POST(), POST() (+112 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (156): deleteResidentLocationHistory(), getResidentAttendance(), listAttendanceAlerts(), demoteToPublicAccount(), listResidentComplaints(), getOpenFeeSchedule(), getResidentFinanceView(), getFoodRoutinesByHostelId() (+148 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (133): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery (+125 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (134): PaymentMonthStrip(), ClearFilters(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard(), AmountCard() (+126 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (95): attendanceAlertResolveSchema, attendanceListQuerySchema, attendanceOverrideSchema, attendanceSettingsSchema, consentSchema, locationPingSchema, objectIdSchema, DELETE() (+87 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (113): Overview, HOSTEL, MONTHS, UiPreview(), AlertCard(), ACTION_TONES, AdminHomeHeader(), CARD_PAD (+105 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (91): GET(), POST(), GET(), POST(), authorUserId, leanResult(), mocks, postId (+83 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (101): GET(), POST(), querySchema, RouteContext, authorUserId, mocks, postId, residentId (+93 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (103): CommunityScreen(), Composer(), CommunityBoard(), CommunityBoardProps, Composer(), SORTS, CommentThread(), CommunityPostCard() (+95 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (109): FileUploadArea(), uploadPublicFile(), TradeDetailsStep(), downloadCaption(), DownloadRow, DownloadStack(), progressCaption(), secondsLabel() (+101 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (87): POST(), RouteContext, DELETE(), GET(), hostelId(), GET(), POST(), DELETE() (+79 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (72): AuthShell(), AuthShellProps, PANEL_COPY, SiteWordmark(), metadata, AccountDeletionPanel, ContentHeader(), ContentIntro() (+64 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (92): getHostelLedger(), collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES (+84 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (74): summarizeResidentComplaints(), LedgerInvoice, listResidentInvoices(), renderStatementForResident(), getResidentLedger(), monthsBetween(), periodOf(), ResidentDoc (+66 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (77): periodTotals(), SetResidentFeeInput, setResidentMonthlyFee(), ApiPrincipal, assertHostelAccess(), canAccessHostel(), hostelScopedFilter(), TenantAccessError (+69 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (66): CancelDeletionPageContent(), AcceptResult, GuardianInvitePageContent, MetricCard(), TabBar(), ActivationStatusResponse, ActivationTarget, CodeState (+58 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (83): CapacityError, claimBedForRoomType(), listAllRoomTypes(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary(), releaseBedForRoomType() (+75 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (51): PATCH(), RouteContext, PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), GET(), GET(), POST() (+43 more)
...
Cohesion: 0.05
Nodes (82): SORTS, StoreCategoryScreen(), BadgeTone, addToCart(), cancelStoreOrder(), Cart, CartLine, CartResult (+74 more)

### Community 31 - "Community 31"
Cohesion: 0.06
Nodes (52): GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, hasFood() (+44 more)
...
Cohesion: 0.04
Nodes (68): ComparePage(), hostels, metadata, rows, Offset, PhotoCropper(), CurrentUser, MeResponse (+60 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (53): POST(), RouteContext, GET(), complaintCategorySchema, complaintListQuerySchema, complaintReplySchema, complaintStatusSchema, complaintStatusUpdateSchema (+45 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (50): metadata, CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+42 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (66): cookPrincipal, mocks, announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError, FoodPhotoUploadInput (+58 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (66): storeCartSchema, storeOrderSchema, storeProductSchema, AddInput, addToCart(), CartItemRecord, CartRecord, clearCart() (+58 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (63): RealtimeConfig, RealtimeContext, RealtimeContextValue, RealtimeNotification, useRealtime(), PaginationQuery, notificationSchema, notificationCampaignSchema (+55 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (51): AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, PaginationMeta, paginationQuerySchema, querySchema (+43 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (55): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS, attempt (+47 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (53): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), ApplyBlock(), ServiceProvidersScreen() (+45 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (59): ReferenceStrip(), ClaimsCard(), InvoiceDetailScreen(), InvoiceHeaderBlock(), LedgerCard(), ReceiptsCard(), STATUS_ON_PAINT, methodIcon() (+51 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (63): paymentProofSchema, arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal (+55 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (59): GATEWAY_ORDER, getPayInstructions(), InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice(), assertQrAssetUsable() (+51 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (56): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse (+48 more)
...
Cohesion: 0.05
Nodes (55): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), MediaViewerProvider() (+47 more)
...
Cohesion: 0.05
Nodes (53): AdminOverviewScreen(), AdminAlertsContext, AdminAlertsValue, AlertActions, EMPTY_COUNTS, ICONS, LABELS, TONES (+45 more)

### Community 52 - "Community 52"
Cohesion: 0.06
Nodes (53): DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS, MealCard(), MonthEndSpecial(), RoutineMeal, CookTodayScreen() (+45 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (44): HostelAdminDashboardPageContent, hostelTypeLabels, StatementNudge, PlatformCommunityPageContent, ACTION_PROGRESS, AVAILABILITY, humanizeDocumentType(), ModerationAction (+36 more)

### Community 54 - "Community 54"
Cohesion: 0.07
Nodes (53): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthStart(), bsPeriodBounds() (+45 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (38): defaultDueDate(), DeliveryWindowFields(), formatPaisa(), number(), PlatformStorePageContent, StoreCategory, StoreProduct, StoreSettings (+30 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (54): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags(), evidenceFlags() (+46 more)
...
Cohesion: 0.05
Nodes (41): CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS, CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, MOCK_HOSTELS (+33 more)

### Community 59 - "Community 59"
Cohesion: 0.07
Nodes (41): CSV_COLUMNS, GET(), POST(), safeEqual(), GET(), csvCell(), csvFilename(), csvResponse() (+33 more)
...
Cohesion: 0.05
Nodes (39): financeIntegrityHash(), IntentRow, runSettlementRecon(), runSettlementReconForHostel(), SettlementReconSummary, computeCreditAmount(), invoiceBalanceSchema, paymentIntentSchema (+31 more)

### Community 62 - "Community 62"
Cohesion: 0.06
Nodes (37): accountDeletionRequestSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, deviceTokenSchema, sessionSchema, CachedConnection, disconnectFromDatabase() (+29 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (43): addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine, formatWeekRange(), HostelAdminFoodPage (+35 more)

### Community 64 - "Community 64"
Cohesion: 0.09
Nodes (40): FILE_ASSET_KINDS, FileAssetKind, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits() (+32 more)

### Community 65 - "Community 65"
Cohesion: 0.06
Nodes (23): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminResidentsPage(), redirectToWorkspaceScreen(), HostelAdminReferralsPageContent() (+15 more)

### Community 66 - "Community 66"
Cohesion: 0.07
Nodes (40): addComplaintUpdate(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput, ComplaintListQuery (+32 more)
...
Cohesion: 0.06
Nodes (34): escapeRegex(), objectIdSchema, paginationSchema, phoneSchema, serviceProviderSchema, serviceProviderApplicationSchema, serviceProviderDocumentSchema, ACTIVE_APPLICATION_STATUSES (+26 more)
...
Cohesion: 0.07
Nodes (31): NightStatusForm(), MEAL_ICONS, mealIcon(), MealRow(), ResidentQuickActions(), ResidentServiceGrid(), ResidentWaitingActions(), isCurrentNight() (+23 more)
...
Cohesion: 0.11
Nodes (22): POST(), POST(), POST(), POST(), periodOf(), runBillingCycleForAllHostels(), POST(), POST() (+14 more)
...
Cohesion: 0.06
Nodes (31): approveClaim(), assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck(), evidenceCheck(), findClaim() (+23 more)
...
Cohesion: 0.06
Nodes (30): fromBs(), gregorianOf(), bhadra(), BillableResident, { amount }, asar(), bhadra(), byRoomType (+22 more)
...
Cohesion: 0.09
Nodes (33): AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance(), DIGIT_CONFUSABLES, EvidenceTextMatch, extractClaimFields() (+25 more)

### Community 85 - "Community 85"
Cohesion: 0.08
Nodes (26): platformSettingSchema, storeCategorySchema, categoriesFor(), escapeRegex(), getStoreShelves(), ListQuery, SORTS, StoreCategoryRecord (+18 more)
...
Cohesion: 0.1
Nodes (25): HostelSuggestions(), checkOnly(), EMPTY_PREFILL, ENVIRONMENT_OPTIONS, IdentityResponse, Prefill, Step, TalkToExpertButton() (+17 more)
...
Cohesion: 0.09
Nodes (28): hostelPageViewSchema, userResidentProfileSchema, LEGACY_ROLE_MAP, Role, ROLE_VALUES, ageFromDateOfBirth(), cardPhotoImageUrl(), generateResidentId() (+20 more)
...
Cohesion: 0.09
Nodes (28): POST(), acceptGuardianInvitation(), daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput (+20 more)
...
Cohesion: 0.08
Nodes (19): Panel(), StatusBadge(), field(), HostelAdminMaintenancePageContent(), ListingFlag, LoadState, MaintenanceRequest, optionalField() (+11 more)
...
Cohesion: 0.08
Nodes (15): AuthExperiencePage(), PublicPricingPage(), ResidentActivationPageContent, ResidentActivationPageContent(), metadata, SignupForm(), generateMetadata(), HOSTEL_TYPE_LABEL (+7 more)
...
Cohesion: 0.09
Nodes (21): CouldNotCreateFileException, HostelHubDownloadsModule, NoContextException, NothingOpensThisException, UnreadableSourceException, UnsupportedOnThisAndroidException, chain, close (+13 more)

### Community 111 - "Community 111"
Cohesion: 0.12
Nodes (14): AdminTabs(), HIDDEN, TABS, TABS, AdminAlertsProvider(), AvatarTabIcon(), RoleTabs(), TabDef (+6 more)
...
Cohesion: 0.11
Nodes (22): filterPushRecipients(), CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, readId(), activeTokensFor(), authHeaders(), chunk() (+14 more)

### Community 114 - "Community 114"
Cohesion: 0.1
Nodes (24): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, rateForRoomType(), isActiveReferralCode() (+16 more)
...
Cohesion: 0.11
Nodes (18): ConfirmOptions, NEXT_STATUSES, OrdersPayload, OrderStatus, PlatformStoreOrdersPageContent, STATUS_TONE, StoreOrder, ViewAllLink() (+10 more)
...
Cohesion: 0.11
Nodes (19): palette, native, NativeDownloads, openDownloaded(), SavedDownload, KNOWN_PATHS, resolvePushPath(), REWRITES (+11 more)

### Community 125 - "Community 125"
Cohesion: 0.13
Nodes (22): UploadCard(), dismissUpload(), emit(), listeners, pruneUploads(), resetUploadQueue(), rows, startTransfer() (+14 more)
...
Cohesion: 0.13
Nodes (16): DeviceLocation, DeviceLocationStatus, formatDistance(), hostelCoordinates(), isUsableCoordinate(), KATHMANDU, hasGeolocation(), LocationOutcome (+8 more)
...
Cohesion: 0.12
Nodes (18): POST(), GET(), assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES, PermissionError, PLATFORM_ROLES (+10 more)

### Community 136 - "Community 136"
Cohesion: 0.14
Nodes (19): GET(), POST(), activeSuperadminCount(), createPlatformAdmin(), CreatePlatformAdminInput, generateTemporaryPassword(), listPlatformAdmins(), loginUrl() (+11 more)
...
Cohesion: 0.13
Nodes (16): ratingReviewSchema, reviewModerationLogSchema, auditReviewAction(), averageOf(), createResidentReview(), hideReview(), listPublicHostelReviews(), moderateReview() (+8 more)
...
Cohesion: 0.13
Nodes (18): Guidance, GuidanceStatus, useGuidance(), isUsableCoordinate(), hasLocationPermission(), hasPromptedForLocation(), LocationOutcome, NavigationFix (+10 more)
...
Cohesion: 0.12
Nodes (13): PortalShell(), navItems, HOSTEL_ADMIN_NAV, HOSTEL_ADMIN_SEARCH_ENTRIES, hostelAdminHref(), PortalIconName, PortalNavGroup, PortalNavItem (+5 more)

### Community 165 - "Community 165"
Cohesion: 0.13
Nodes (16): iconMap, IconName, NavItem, NOTIFICATIONS_HREF, planCopy, PortalShellProps, PortalTone, toneStyles (+8 more)
...
Cohesion: 0.18
Nodes (21): AttendanceAlert, AttendanceLog, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({), code:typescript (interface IQuestionCallClick {), code:typescript ({) (+13 more)
...
Cohesion: 0.14
Nodes (14): AuthSession, login(), submitResidentReview(), triggerSOS(), AppNavigator(), RootStackParamList, Stack, LoginScreen() (+6 more)
...
Cohesion: 0.19
Nodes (15): ProviderJob, CATEGORY_ICONS, completedJobCount(), isOpenJob(), jobActions(), jobAddress(), jobCategoryIcon(), OPEN_JOB_STATUSES (+7 more)
...
Cohesion: 0.13
Nodes (14): filterRollCall(), NightStatusValue, OVERRIDE_OPTIONS, ROLL_CALL_SEGMENTS, rollCallCounts(), RollCallSegment, rollCallTone(), ROW_TONES (+6 more)

### Community 187 - "Community 187"
Cohesion: 0.2
Nodes (18): assertMatchesExtension(), downloadAndShare(), downloadAndShareCsv(), downloadAndShareImage(), downloadToDevice(), forgetDownloadFolder(), LegacyFileSystem, loadLegacyFileSystem() (+10 more)
...
Cohesion: 0.14
Nodes (16): activateResident(), apiRequest(), confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listNotifications(), listResidentComplaints(), markNotificationRead() (+8 more)

### Community 199 - "Community 199"
Cohesion: 0.18
Nodes (15): ReviewScreen(), canReview(), emptyReviewDraft(), hasReviewErrors(), REVIEW_CATEGORIES, REVIEWABLE_STATUSES, ReviewCategoryKey, ReviewDraft (+7 more)
...
Cohesion: 0.25
Nodes (12): GET(), resolvePastedLink(), searchCandidates(), hostelAdminGeocodeQuerySchema, ParsedMapLink, parseMapLink(), placeFromPath(), POINT_PARAMS (+4 more)
...
Cohesion: 0.16
Nodes (11): getResidentProfile(), requestOtp(), signInWithGoogle(), Props, styles, Profile, Props, ResidentProfileScreen() (+3 more)
...
Cohesion: 0.22
Nodes (13): maneuverIcon(), NavCard(), CARDINALS, directionWord(), distanceToPath(), formatManeuverDistance(), instructionFor(), nextStep() (+5 more)
...
Cohesion: 0.21
Nodes (13): 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, 7.2 Subscription Expiring Soon, 9.1 Account Deletion Requested, code:typescript ({) (+5 more)
...
Cohesion: 0.27
Nodes (8): ManagedInquiry, BUCKETS, inquiriesIn(), InquiryAction, inquiryActions(), InquiryBucket, inquiryCounts(), rows
...
Cohesion: 0.26
Nodes (9): SosInput, SosPhase, count(), describeFanout(), SosFanoutTone, sosMessagePayload(), SosOutcome, fanout() (+1 more)
...
Cohesion: 0.28
Nodes (7): fetchNearbyPlaces(), fetchNearbyWithGoogle(), fetchNearbyWithOverpass(), GOOGLE_PLACE_TYPES, GooglePlacesResponse, OVERPASS_URLS, OverpassElement
...
Cohesion: 0.36
Nodes (6): DeletionPathway, deletionReasonError(), PATHWAY_COPY, PathwayCopy, error, PATHWAYS
...
Cohesion: 0.4
Nodes (6): 7.1 Multi-Tenant Isolation Test Template, 7.4 Account-Upgrade Test Template, 7.5 Payment Precision Test Template, 7. Mandatory Test Templates, code:typescript (describe('GET /api/v1/hostel/rooms/:id - tenant isolation', ), code:bash (npm --prefix apps/web run typecheck)
...
## Knowledge Gaps
- **4789 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+4784 more)
...
- **Why does `Button()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 13`, `Community 21`, `Community 25`, `Community 30`, `Community 165`, `Community 41`, `Community 42`, `Community 51`, `Community 52`, `Community 53`, `Community 63`, `Community 73`, `Community 98`, `Community 118`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 5` to `Community 0`, `Community 4`, `Community 7`, `Community 19`, `Community 21`, `Community 25`, `Community 31`, `Community 33`, `Community 35`, `Community 164`, `Community 165`, `Community 46`, `Community 53`, `Community 58`, `Community 63`, `Community 67`, `Community 70`, `Community 74`, `Community 78`, `Community 343`, `Community 91`, `Community 92`, `Community 100`, `Community 367`, `Community 245`, `Community 118`, `Community 123`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 55` to `Community 3`, `Community 132`, `Community 4`, `Community 6`, `Community 7`, `Community 5`, `Community 9`, `Community 13`, `Community 14`, `Community 15`, `Community 144`, `Community 19`, `Community 22`, `Community 279`, `Community 151`, `Community 24`, `Community 28`, `Community 32`, `Community 33`, `Community 40`, `Community 299`, `Community 47`, `Community 50`, `Community 54`, `Community 74`, `Community 338`, `Community 221`, `Community 103`, `Community 114`?**
...
- **What connects `{ defineConfig }`, `expoConfig`, `path` to the rest of the system?**
  _4789 weakly-connected nodes found - possible documentation gaps or missing edges._
