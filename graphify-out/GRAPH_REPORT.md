...
## Corpus Check
- 1384 files · ~2,211,904 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10892 nodes · 28304 edges · 427 communities (407 shown, 20 thin omitted)
...
Cohesion: 0.02
Nodes (176): Scanner(), GuardianInviteScreen(), Choice, MapButton(), MapScreen(), ModeTab(), NOTHING_CHOSEN, PreviewCard() (+168 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (211): deleteResidentLocationHistory(), listResidentComplaints(), sendEmail(), getResidentFinanceView(), listFoodForResident(), listPublicFoodRoutine(), submitFoodFeedback(), uploadFoodPhoto() (+203 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (112): CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload, DemoDataBadge(), Hostel, LoadState, UserRecord (+104 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (137): POST(), attacker, attempt(), headers, jsonRequest(), routeMocks, appBaseUrl(), authenticateWithGoogle() (+129 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (117): PATCH(), POST(), RouteContext, GET(), POST(), PATCH(), POST(), RouteContext (+109 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (147): AdminAlertsScreen(), AdminOverviewScreen(), loadOverview(), AttachmentGallery(), CookTodayScreen(), CookMenuScreen(), alertCounts(), AlertKind (+139 more)

### Community 6 - "Community 6"
Cohesion: 0.08
Nodes (75): ICONS, LABELS, TONES, Overview, PORTAL_ROWS, Person, CommunityScreen(), needsResident() (+67 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (107): CommunityReportDialog(), REASONS, ModerationButton(), PagerButton(), normalize(), PortalSearch(), PortalTone, scoreEntry() (+99 more)
...
Cohesion: 0.05
Nodes (82): DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton(), ConfirmOptions (+74 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (95): summarizeResidentComplaints(), listResidentInvoices(), announceFoodReady(), getCookToday(), startOfToday(), dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine (+87 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (76): ComparePage(), hostels, metadata, rows, csvField(), field(), Hostel, HostelAdminDashboardPageContent() (+68 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (81): POST(), adminPrincipal, mocks, PLATFORM_LIMITS, assetId, hostelId, mocks, otherHostelId (+73 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (89): POST(), HostelRef, notifyHostelOfInquiry(), notifyPlatformOfPendingHostel(), PaginationMeta, PaginationQuery, PLATFORM_ROLES, deviceTokenSchema (+81 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (72): GET(), POST(), GET(), GET(), POST(), GET(), DELETE(), POST() (+64 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (78): HostelAdminCommunityPageContent, HostelAdminInquiriesPageContent, HostelAdminMaintenancePageContent, PRIORITIES, STATUS_ACTIONS, HostelAdminMoveChecklistPage, HostelAdminNightStatusPage, HostelAdminNoticesPage (+70 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (88): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus(), OPEN_STATUSES (+80 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (73): Ledger, OrphanAssignPicker, MatrixRow, MatrixTotals, PeriodSummary, ClaimFacts(), FLAG_LABELS, POSITIVE_FLAGS (+65 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (67): HostelSuggestions(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, formatHostelAddress(), hostelTypeToUi(), mapPublicHostelToSummary() (+59 more)
...
Cohesion: 0.04
Nodes (65): POST(), GET(), POST(), bedCreateSchema, bedUpdateSchema, floorCreateSchema, hostelAdminProfileQuerySchema, hostelAdminProfileUpdateSchema (+57 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (75): AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), BootGate(), RootShell(), NightStatusScreen(), FILTERS, NotificationsScreen() (+67 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (65): metadata, AccountDeletionPanel, LegalBody(), buildValues(), PublicAboutPage(), values, buildPosts(), posts (+57 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (56): GenericPortalScreen(), portalRows(), portalTitle(), hasFood(), LoadState, PublicHostelListingPageContent(), PublicInquiryPage(), PublicInquiryPageContent() (+48 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (69): DeletionPanel(), NotificationSettings(), THEME_OPTIONS, DeletionRequest, DeletionStatus, getDeletionStatus(), requestAccountDeletion(), canRequestDeletion() (+61 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (69): cookPrincipal, mocks, cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError, FoodPhotoUploadInput, FoodReadyInput (+61 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (53): csvField(), deferLoad(), field(), HostelTable(), Inquiry, Message(), numberField(), optionalField() (+45 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (48): POST(), RouteContext, GET(), PATCH(), RouteContext, GET(), publicHostelCompareQuerySchema, GET() (+40 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (53): POST(), recordConsent(), consentSchema, POST(), DELETE(), POST(), checkoutSchema, POST() (+45 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (62): listTrendingTags(), POST(), RouteContext, computePerceptualHash(), systemDocumentKind(), cookieAccessToken(), isRole(), loadApiPrincipal() (+54 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (53): TABS, SosScreen(), TABS, ViewerBody(), BottomChrome, BottomChromeContext, BottomChromeProvider(), CHROME_TIMING (+45 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (63): IdCardFace(), IdCardPrompt(), Point(), BLOOD_OPTIONS, DIET_OPTIONS, EditIdentityScreen(), GENDER_OPTIONS, ID_TYPE_OPTIONS (+55 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (59): CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing, CurrentUser (+51 more)

### Community 33 - "Community 33"
Cohesion: 0.12
Nodes (45): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), guardianInvitationEmail(), sosAlertEmail() (+37 more)

### Community 34 - "Community 34"
Cohesion: 0.05
Nodes (61): NightStatusForm(), NotificationCard(), ProfileScreen(), CheckoutStatusScreen(), CookPhotosScreen(), SubmitClaimScreen(), InvoiceDetailScreen(), SummaryCard() (+53 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (61): paymentProofSchema, arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal (+53 more)
...
Cohesion: 0.04
Nodes (44): attendanceOverrideSchema, complaintCategorySchema, complaintCreateSchema, complaintListQuerySchema, complaintReplySchema, complaintStatusSchema, complaintStatusUpdateSchema, objectIdSchema (+36 more)
...
Cohesion: 0.07
Nodes (54): demoteToPublicAccount(), CapacityError, claimBedForRoomType(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary(), releaseBedForRoomType() (+46 more)
...
Cohesion: 0.07
Nodes (50): Composer(), Composer(), CommentThread(), CommunityPostCard(), relativeTime(), ReportSheet(), addPostComment(), CommunityComment (+42 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (36): AuthGuard(), fadeUp, Feature, features, heroSlides, PublicHostelRegistrationLandingPage(), stagger, stats (+28 more)
...
Cohesion: 0.05
Nodes (37): emergencyContactSchema, incidentLogSchema, manualStatusOverrideSchema, nightStatusSchema, nightStatusLogSchema, sosAlertSchema, sponsorSchema, normalizeObjectId() (+29 more)
...
Cohesion: 0.05
Nodes (41): escapeRegex(), objectIdSchema, paginationSchema, phoneSchema, serviceProviderApplicationSchema, serviceProviderDocumentSchema, serviceProviderApprovedEmail(), serviceProviderRejectedEmail() (+33 more)
...
Cohesion: 0.08
Nodes (44): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, FINANCE_ERROR_STATUS (+36 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (46): getInvoiceMatrix(), InvoiceMatrix, InvoiceMatrixRow, listResidentClaims(), PortalInvoice, ResidentFinanceView, ResidentInvoiceLine, ResidentInvoiceReceipt (+38 more)
...
Cohesion: 0.07
Nodes (44): assertQrAssetUsable(), EMPTY, PaymentProfileView, ProfileDocument, readQrPayeeFields(), TEXT_FIELDS, toView(), updatePaymentProfile() (+36 more)
...
Cohesion: 0.06
Nodes (34): CancelDeletionPageContent(), AcceptResult, GuardianInvitePageContent, RealtimeConfig, RealtimeContext, RealtimeContextValue, RealtimeNotification, RealtimeProvider() (+26 more)
...
Cohesion: 0.08
Nodes (36): SosOverlay(), ProviderJobScreen(), getOwnProvider(), listProviderJobs(), ProviderApplication, ProviderJob, ProviderJobStatus, updateProviderJobStatus() (+28 more)

### Community 62 - "Community 62"
Cohesion: 0.07
Nodes (35): buildFormPostHandoff(), FormPostHandoff, HandoffError, IntentRecord, formPostIntent, hostelId, intentId, invoiceId (+27 more)

### Community 63 - "Community 63"
Cohesion: 0.06
Nodes (33): financeIntegrityHash(), computeCreditAmount(), findingSchema, reconciliationRunSchema, checkAuditChain(), checkCreditBalances(), DRIFT_CODES, LedgerDriftSummary (+25 more)
...
Cohesion: 0.08
Nodes (41): AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance(), DIGIT_CONFUSABLES, evidenceTextFlags(), EvidenceTextMatch (+33 more)

### Community 67 - "Community 67"
Cohesion: 0.07
Nodes (20): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminNoticesPage(), redirectToWorkspaceScreen(), HostelAdminReferralsPageContent(), HostelAdminReportsPageContent() (+12 more)

### Community 68 - "Community 68"
Cohesion: 0.07
Nodes (33): AttendanceAlert, AttendanceCalendar(), AttendanceRow, HostelAdminAttendancePageContent, Zone, ZONE_ORDER, ZONE_STYLES, AvailableRoomType (+25 more)

### Community 69 - "Community 69"
Cohesion: 0.06
Nodes (27): currency(), EmptyState(), Select(), ResidentActivationPageContent, ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent (+19 more)
...
Cohesion: 0.09
Nodes (27): GET(), POST(), revokeGuardianAccess(), DELETE(), PATCH(), requireSuperadminPrincipal(), resetEmailIdentityCache(), GET() (+19 more)

### Community 73 - "Community 73"
Cohesion: 0.09
Nodes (34): candidatesInRun(), canonicalize(), checkCharacter(), CONFUSABLES, decodeSequence(), deriveHostelPrefix(), encodeSequence(), foldConfusables() (+26 more)
...
Cohesion: 0.08
Nodes (29): confirmSettlementByStatement(), classifyCredit(), CreditClassification, LadderClaim, LadderInvoice, MatchContext, normalizeTxnId(), ANITA_CODE (+21 more)
...
Cohesion: 0.06
Nodes (23): Input(), StatusBadge(), TextArea(), field(), HostelAdminMaintenancePageContent(), HostelAdminServiceProvidersPageContent(), ListingFlag, LoadState (+15 more)
...
Cohesion: 0.07
Nodes (21): field(), GuardianDashboard, HostelAdminMoveChecklistPage(), LoadState, NightStatusRow, Notification, NotificationsPageContent(), optionalNumber() (+13 more)
...
Cohesion: 0.06
Nodes (25): approveCashPayment(), afterReversal, checker, eventId, hostelId, invoiceId, ledger, maker (+17 more)
...
Cohesion: 0.09
Nodes (17): POST(), RouteContext, RouteContext, emergencyContactCreateSchema, guardianCreateSchema, objectIdSchema, optionalHostelScopeSchema, residentCreateSchema (+9 more)
...
Cohesion: 0.09
Nodes (20): AuditLogRecord, PlatformAuditLogQuery, RefRecord, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex(), HostelRecord, ListingFlagListQuery (+12 more)

### Community 92 - "Community 92"
Cohesion: 0.11
Nodes (23): CSV_COLUMNS, GET(), POST(), RouteContext, POST(), safeEqual(), questionCallClickSchema, ClickRecord (+15 more)

### Community 93 - "Community 93"
Cohesion: 0.09
Nodes (28): settleEvent(), findOrphanClaims(), loadMatchContext(), ApprovedNotInStatementRow, approveMatchedRows(), approverNamesFor(), askResidentAboutClaim(), assignOrphanCredit() (+20 more)

### Community 94 - "Community 94"
Cohesion: 0.11
Nodes (26): verifyPurposeToken(), AccountDeletionError, applyImmediateEffects(), cancelAccountDeletionByToken(), cancelAccountDeletionForUser(), cancelUrlFor(), DeletionPathway, DeletionRequestRecord (+18 more)

### Community 95 - "Community 95"
Cohesion: 0.11
Nodes (25): uploadPublicFile(), FILE_ASSET_KINDS, FileAssetKind, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), validateFileForUpload(), ApiEnvelope (+17 more)
...
Cohesion: 0.09
Nodes (25): hostelPageViewSchema, userResidentProfileSchema, LEGACY_ROLE_MAP, Role, ROLE_VALUES, ageFromDateOfBirth(), cardPhotoImageUrl(), generateResidentId() (+17 more)

### Community 101 - "Community 101"
Cohesion: 0.11
Nodes (21): getAttendanceConfig(), getAttendanceSettings(), listHostelAttendance(), resolveAdminHostelId(), resolveAttendanceAlert(), updateAttendanceSettings(), attendanceAlertResolveSchema, attendanceListQuerySchema (+13 more)
...
Cohesion: 0.12
Nodes (22): FileUploadArea(), acceptAttribute(), EXTENSION_BY_MIME, FAMILY_BYTES, FAMILY_ORDER, familyOf(), joinTypes(), KIND_RULES (+14 more)
...
Cohesion: 0.1
Nodes (19): activateResident(), AuthSession, requestOtp(), signInWithGoogle(), submitResidentReview(), triggerSOS(), AppNavigator(), RootStackParamList (+11 more)
...
Cohesion: 0.14
Nodes (20): assertEnablable(), blockedReasonFor(), deleteGatewayConfig(), GATEWAY_REQUIREMENTS, GatewayConfigView, GatewaySecretView, listGatewayConfigs(), saveGatewayConfig() (+12 more)
...
Cohesion: 0.17
Nodes (20): ReviewForm(), ReviewScreen(), getResidentProfile(), ResidentProfile, canReview(), emptyReviewDraft(), hasReviewErrors(), REVIEW_CATEGORIES (+12 more)
...
Cohesion: 0.14
Nodes (20): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, GATEWAY_ORDER, getPayInstructions() (+12 more)
...
Cohesion: 0.14
Nodes (16): ApiFailure, ApiSuccess, AuthUser, confirmComplaintResolution(), createResidentComplaint(), listPublicHostels(), listResidentComplaints(), logout() (+8 more)
...
Cohesion: 0.21
Nodes (17): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags(), evidenceFlags() (+9 more)
...
Cohesion: 0.14
Nodes (16): apiRequest(), createPublicInquiry(), getActivationStatus(), getPublicHostel(), listNotifications(), markNotificationRead(), NotificationItem, refreshSession() (+8 more)
...
Cohesion: 0.21
Nodes (13): dashboardHrefForRole(), cook, dashboardHrefForRole(), destinationForRole(), isAllowedNextPath(), isHostelWorkspacePath(), isSafeLocalPath(), landingPathForRole() (+5 more)
...
Cohesion: 0.19
Nodes (13): fetchRoadRoute(), isRecord(), parseRoadRoute(), RoadRoute, ROUTE_MODES, RouteMode, ROUTERS, routeUrl() (+5 more)
...
Cohesion: 0.19
Nodes (15): code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface INotice {), code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {), code:typescript ({), Food, FoodMenu (+7 more)
...
Cohesion: 0.19
Nodes (10): getResidentDashboard(), login(), ResidentDashboard, LoginScreen(), Props, Props, money(), Props (+2 more)
...
Cohesion: 0.17
Nodes (12): 12.1 Flaky Tests, 12.2 Tenant Isolation Bugs, 12.3 E2E Tests Timing Out, 12. Common Pitfalls & Debugging Tips, 7.2 Role Gate Test Template, 9.1 Seed Scripts, 9.2 Test Database Isolation, 9. Test Data & Seeding (+4 more)
...
Cohesion: 0.33
Nodes (6): assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES, PermissionError, Principal
...
## Knowledge Gaps
- **3989 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+3984 more)
...
- **Why does `Button()` connect `Community 6` to `Community 0`, `Community 2`, `Community 5`, `Community 7`, `Community 9`, `Community 17`, `Community 21`, `Community 24`, `Community 26`, `Community 31`, `Community 32`, `Community 34`, `Community 36`, `Community 43`, `Community 61`, `Community 65`, `Community 74`, `Community 76`, `Community 121`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 7` to `Community 2`, `Community 6`, `Community 9`, `Community 11`, `Community 15`, `Community 143`, `Community 17`, `Community 18`, `Community 22`, `Community 23`, `Community 26`, `Community 30`, `Community 32`, `Community 36`, `Community 39`, `Community 45`, `Community 64`, `Community 68`, `Community 71`, `Community 76`, `Community 77`, `Community 80`, `Community 210`, `Community 87`, `Community 96`, `Community 104`, `Community 111`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `Role` connect `Community 12` to `Community 256`, `Community 1`, `Community 3`, `Community 4`, `Community 7`, `Community 8`, `Community 138`, `Community 10`, `Community 268`, `Community 13`, `Community 14`, `Community 16`, `Community 25`, `Community 26`, `Community 27`, `Community 29`, `Community 287`, `Community 32`, `Community 35`, `Community 166`, `Community 40`, `Community 42`, `Community 171`, `Community 172`, `Community 46`, `Community 175`, `Community 305`, `Community 306`, `Community 52`, `Community 57`, `Community 70`, `Community 72`, `Community 201`, `Community 77`, `Community 211`, `Community 85`, `Community 88`, `Community 90`, `Community 93`, `Community 94`, `Community 98`, `Community 237`, `Community 239`?**
...
- **What connects `{ defineConfig }`, `expoConfig`, `path` to the rest of the system?**
  _3989 weakly-connected nodes found - possible documentation gaps or missing edges._
