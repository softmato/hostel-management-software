...
## Corpus Check
- 2321 files · ~4,845,678 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18621 nodes · 52343 edges · 591 communities (559 shown, 32 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 871 edges (avg confidence: 0.8)
...
Cohesion: 0.03
Nodes (251): ICONS, LABELS, Segment, TONES, AdminCommunityReportsScreen(), FILTERS, Pending, AdminOverviewScreen() (+243 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (244): AdminCommunityScreen(), CookInviteScreen(), GuardianInviteScreen(), MapScreen(), CallableRow(), IdentityCard(), PeopleSection(), SavedListRow() (+236 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (306): loadToday(), CalendarPreferenceCard(), NightStatusPromptCard(), loadFinance(), AdminMaintenance, AdminModeration, AdminModerationFilter, AdminNotice (+298 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (272): RouteContext, PATCH(), RouteContext, POST(), fileFieldCash(), startPlanPeriod(), POST(), GET() (+264 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (187): POST(), PATCH(), POST(), RouteContext, POST(), POST(), POST(), POST() (+179 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (228): ReviewForm(), ReviewScreen(), GuardianLoginScreen(), METHODS, PackageCard(), PayStep(), roomPhotoUris(), StatusCard() (+220 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (162): POST(), setHostelBookingPause(), getPlatformBooking(), listTransfersDue(), listPayoutAccounts(), checkoutSchema, POST(), RouteContext (+154 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (219): AdminAlertsScreen(), AdminHomeScreen(), loadOverview(), AdminTabs(), AdminMoneyScreen(), loadMoney(), MoneyData, AdminTodayScreen() (+211 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (181): AdminMoreScreen(), ActivateScreen(), Scanner(), BootGate(), RootShell(), NotificationsScreen(), ApplyBlock(), ServiceProvidersScreen() (+173 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (175): generateMetadata(), chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout() (+167 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (137): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload (+129 more)

### Community 11 - "Community 11"
Cohesion: 0.01
Nodes (131): LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminMoveChecklistPage() (+123 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (166): bookingDocumentResponse(), resolveBookingDocument(), getHostelPayoutAccount(), POST(), RouteContext, DELETE(), GET(), hostelId() (+158 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (159): GET(), listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), checkFieldCash(), listFieldCashToConfirm(), getPlatformSubscriptionLedger() (+151 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (149): BubbleBackground(), BubbleBackgroundProps, BubbleColors, StarLayer(), StarLayerProps, StarsBackground(), StarsBackgroundProps, BrandMark() (+141 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (112): FieldCashRow, PlanPaymentClaim, formatBsAdDate(), HostelTable(), UserRecord, GuardianDashboard, CreateWardenResult, PERMISSION_LABELS (+104 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (151): AssetViewer(), openIdFor(), openIds, StripThumb(), useViewerState(), ViewerBody(), ViewerPage(), CopyButton() (+143 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (134): POST(), POST(), POST(), attacker, attempt(), headers, jsonRequest(), routeMocks (+126 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (133): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, formatBsPeriod(), notifyHostelOfNewPost() (+125 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (93): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, hasFood(), roomTypeLabel() (+85 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (104): answerSchema, POST(), RouteContext, confirmComplaintResolution(), listResidentComplaints(), complaintCategorySchema, complaintCreateSchema, complaintListQuerySchema (+96 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (110): Platform, ConcessionBackfill, describeApplied(), FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, MonthDiscounts, monthStartPeriod() (+102 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (142): MESSAGES, POST(), RouteContext, BookingEndCause, HostelBookingClosedCause, announceConfirmed(), announceEnding(), assertAwaitingAnswer() (+134 more)

### Community 23 - "Community 23"
Cohesion: 0.01
Nodes (102): ATTENDANCE_DEFAULTS, adminPrincipal, mocks, PLATFORM_LIMITS, afterMidnight, evening, meters, mocks (+94 more)

### Community 24 - "Community 24"
Cohesion: 0.07
Nodes (101): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), dueWhen(), PlanDueInput (+93 more)
...
Cohesion: 0.03
Nodes (113): HIDDEN, RoleLayout(), TABS, invalidateFeeds(), writeFeedRead(), TABS, AvatarTabIcon(), DISSOLVE (+105 more)

### Community 28 - "Community 28"
Cohesion: 0.02
Nodes (98): AuthGuard(), HostelSuggestions(), PublicComparePage(), CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS, CITY_OPTIONS (+90 more)

### Community 29 - "Community 29"
Cohesion: 0.02
Nodes (98): currentBsPeriod(), GetPlanButton(), InlineText(), TIER_TONE, EASE, PlanCards(), PlanLine(), PlansClosingCta() (+90 more)
...
Cohesion: 0.04
Nodes (96): CommunityScreen(), Composer(), CommunityPostScreen(), AnimatedBlurView, CommunityBoard(), CommunityBoardProps, Composer(), SORTS (+88 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (102): DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), monthLabel(), collectionTotals(), countInvoicesByField() (+94 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (94): cropToGuide(), FILL, GuidedCapture(), GUIDES, GuideShape, loadManipulator(), Manipulator, AttachmentRow() (+86 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (87): BookButton(), SIZE, BookingAvailabilityView, BookingButton, CLOSED_REASONS, open, BookingQuote, GuestBookingDetail (+79 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (70): AccountDeletionPanel, DeletionPathway, DeletionStatus, PATHWAY_COPY, csvField(), deferLoad(), DemoDataBadge(), field() (+62 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (98): checkoutDocumentFor(), softmatoDocumentNumbers(), gateway, invoice, updateOne, documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument() (+90 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (76): PRIORITIES, STATUS_ACTIONS, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel, GatewayConfig, GatewayHealthStatus (+68 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (94): BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan, BillingSkip (+86 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (70): AuthShell(), AuthShellProps, PANEL_COPY, SiteWordmark(), metadata, RefundPolicy, AuthExperiencePage(), ContentHeader() (+62 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (78): GET(), POST(), GET(), POST(), GET(), POST(), DELETE(), POST() (+70 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (84): Assurance(), fill(), money(), PlanCard(), PricingScreen(), dueBhadra29, filed, throughAswin25 (+76 more)

### Community 42 - "Community 42"
Cohesion: 0.03
Nodes (73): NotificationsPageContent(), Notification, EMPTY_SUMMARY, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS (+65 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (83): cookPrincipal, mocks, resolveCookLabels(), announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError (+75 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (79): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, HostelPayeeIdentity, GATEWAY_ORDER (+71 more)

### Community 45 - "Community 45"
Cohesion: 0.03
Nodes (77): POST(), GET(), POST(), GET(), querySchema, POST(), RouteContext, acceptGuardianInvitation() (+69 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (81): returnHeldBed(), takeHeldBed(), CapacityError, claimBedForRoomType(), listAllRoomTypes(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes() (+73 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (80): StoreCategoryScreen(), addToCart(), cancelStoreOrder(), Cart, CartLine, CartResult, CartTotals, clearCart() (+72 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (64): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, secretsMatch(), ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS (+56 more)

### Community 49 - "Community 49"
Cohesion: 0.03
Nodes (61): summarizeResidentComplaints(), listResidentInvoices(), accessId, accessQuery, adminPrincipal, codes, guardianId, guardianPrincipal (+53 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (71): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult (+63 more)

### Community 51 - "Community 51"
Cohesion: 0.03
Nodes (46): deleteHostelObjects(), ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, RETAINED_BY_HOSTEL_ID, both (+38 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (70): NotificationSoundListener(), RealtimeConfig, RealtimeContext, RealtimeContextValue, RealtimeNotification, RealtimeProvider(), useRealtime(), attempt() (+62 more)
...
Cohesion: 0.05
Nodes (61): daysLeftThrough(), getBillingHistory(), CheckoutInvoice, checkoutView(), fail(), findHostelForCheckout(), HostelMatch, paymentState() (+53 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (57): BrowserPushRow(), FILTERS, Notification, NotificationRow(), PushState, blankRow(), Row, TeamInviteBox() (+49 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (66): GET(), BookableHostel, BookingUnavailableReason, findRoom(), hostelAddress(), HostelAvailability, hostelCoverPhoto(), hostelCoverPhotos() (+58 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (59): CommunityPageContent(), FeedPayload, NewPostAlertsToggle(), SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+51 more)
...
Cohesion: 0.05
Nodes (51): HostelBookingView, PayoutAccountForReview, ReviewPayoutAccount(), STATUS_LABEL, List(), ReasonAction(), Row(), timeLeft() (+43 more)

### Community 62 - "Community 62"
Cohesion: 0.06
Nodes (64): personalLookupHash(), getPresignedReadUrl(), notificationSchema, userResidentProfileSchema, findLiveResidency(), LIVE_STATUSES, LiveResidency, LiveRow (+56 more)

### Community 63 - "Community 63"
Cohesion: 0.06
Nodes (64): feeUpdateSchema, PATCH(), setResidentMonthlyFee(), POST(), GET(), alreadyReviewedError(), approvePaymentProof(), assertProofIsPending() (+56 more)

### Community 64 - "Community 64"
Cohesion: 0.05
Nodes (56): PATCH(), GET(), PLATFORM_ROLES, notifyStaffOfJobProgress(), serviceProviderApplicationSchema, serviceProviderDocumentSchema, PATCH(), ServiceProvidersPage() (+48 more)

### Community 65 - "Community 65"
Cohesion: 0.05
Nodes (62): CHANNELS, ClaimedStep, composeEmail(), composeNotice(), composePlanDueNotice(), deliverEmail(), deliverStep(), HostelRow (+54 more)
...
Cohesion: 0.04
Nodes (54): findCardBooking(), findHeldBooking(), account, answerBy, before, book(), Booking, compact (+46 more)

### Community 70 - "Community 70"
Cohesion: 0.06
Nodes (45): applyWebhook(), recordSoftmatoPayment(), WebhookResult, fileBookingRefund(), refileBookingRefund(), submitBookingRefund(), loadOwnBooking(), BookingSettlement (+37 more)
...
Cohesion: 0.06
Nodes (52): platformPushScheduleSchema, announceChange(), audit(), CreateInput, createNoticePush(), DEFAULT_PUSHES, deleteNoticePush(), emitNoticePush() (+44 more)

### Community 73 - "Community 73"
Cohesion: 0.05
Nodes (48): COLUMNS, Member, MemberData, RegistrationTrackSheet(), TrackSheetLoader(), metadata, HOSTEL_AGREEMENT_STATUSES, hostelAgreementSchema (+40 more)

### Community 74 - "Community 74"
Cohesion: 0.07
Nodes (47): GET(), AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput, ConsentInput (+39 more)

### Community 75 - "Community 75"
Cohesion: 0.05
Nodes (44): CookServiceError, resolveAdminHostelId(), ApiPrincipal, PaginationQuery, assertHostelAccess(), canAccessHostel(), hostelScopedFilter(), TenantAccessError (+36 more)

### Community 76 - "Community 76"
Cohesion: 0.06
Nodes (55): BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodBounds(), bsPeriodsBetween() (+47 more)

### Community 77 - "Community 77"
Cohesion: 0.06
Nodes (48): ComplaintDetail(), CategoryTile(), NewComplaintScreen(), PickedAttachment, SwapButton(), VoiceNotePlayer(), RoundButton(), VOICE_NOTE_RECORDING (+40 more)

### Community 78 - "Community 78"
Cohesion: 0.06
Nodes (46): bsMonthStart(), discountRent(), applyConcessionToIssuedInvoices(), ConcessionBackfill, EMPTY, InvoiceLine, settledAmountOf(), bill (+38 more)
...
Cohesion: 0.06
Nodes (48): addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange(), definedUpdate(), FoodFeedbackInput, FoodFeedbackRecord, FoodMenuCreateInput (+40 more)

### Community 81 - "Community 81"
Cohesion: 0.07
Nodes (49): submitFieldCash(), deliver(), loadInvoiceById(), loadProof(), PlanPaymentInstructions, ProofAsset, reviewPlanPaymentClaim(), submitPlanPaymentClaim() (+41 more)

### Community 82 - "Community 82"
Cohesion: 0.06
Nodes (44): POST(), RouteContext, POST(), safeEqual(), sponsorSchema, ClickRecord, dayKey(), getQuestionCallAnalytics() (+36 more)

### Community 83 - "Community 83"
Cohesion: 0.06
Nodes (48): openStore(), createResident(), getIntakeQuote(), IntakeQuote, lookupResidentProfile(), RESIDENT_TYPES, ResidentIntakeResult, ResidentOccupancy (+40 more)

### Community 84 - "Community 84"
Cohesion: 0.06
Nodes (43): NightStatusForm(), SosScreen(), SosInput, SosPhase, nepalDayKey(), isCurrentNight(), isSelfReportable(), NIGHT_STATUS_OPTIONS (+35 more)
...
Cohesion: 0.07
Nodes (47): documentUrl(), InvoiceLean, PaymentLean, PlatformInvoiceRow, PlatformPaymentRow, PlatformSubscriptionLedger, allowed(), BookingDocumentScope (+39 more)

### Community 87 - "Community 87"
Cohesion: 0.05
Nodes (41): incidentLogSchema, manualStatusOverrideSchema, nightStatusLogSchema, sosAlertSchema, answer, mocks, userId, settleNightStatusNotifications() (+33 more)

### Community 88 - "Community 88"
Cohesion: 0.05
Nodes (42): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), PortalDates, useHostelDayTurn() (+34 more)
...
Cohesion: 0.05
Nodes (42): daysBetween(), DunningAction, DunningStage, DunningState, InvoiceRow, nextDunningAction(), OPEN_STATUSES, PaymentReminderRun (+34 more)

### Community 92 - "Community 92"
Cohesion: 0.07
Nodes (44): Offset, PhotoCropper(), VideoSlot(), CollectionQrField(), PhotoStrip(), isActive(), acceptAttribute(), EXTENSION_BY_MIME (+36 more)

### Community 93 - "Community 93"
Cohesion: 0.06
Nodes (40): buildIdCardData(), EMAIL_CHECK_HINTS, EmailCheck, Field(), FIELD_LABELS, formatCardDate(), IdCardPanel(), identityDraftKey() (+32 more)

### Community 94 - "Community 94"
Cohesion: 0.06
Nodes (43): daysFromNow(), enabledPermissionLabels(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags, GuardianPermissionsUpdateInput, GuardianRecord (+35 more)

### Community 95 - "Community 95"
Cohesion: 0.13
Nodes (41): BOOKING_DOCUMENT_KINDS, BookingDocumentInput, BookingDocumentKind, bookingDocumentLayout(), refundPolicyNotes(), renderBookingDocument(), bsFiscalYear(), amountInWords() (+33 more)
...
Cohesion: 0.05
Nodes (33): configuredLevel(), levelPriority, LogLevel, normalizeMeta(), shouldLog(), write(), accountId, adminId (+25 more)
...
Cohesion: 0.06
Nodes (30): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, auditLogSchema, referralSchema, referralCodeSchema, referralRewardSchema (+22 more)

### Community 101 - "Community 101"
Cohesion: 0.06
Nodes (34): applyBookingConfig(), PLATFORM_SETTING_CHANGE_STATUSES, platformSettingChangeSchema, bookings, CollectionQr, isSettingChangeKey(), SETTING_CHANGES, SettingChangeDefinition (+26 more)

### Community 102 - "Community 102"
Cohesion: 0.06
Nodes (40): findIndex(), index, indexesOf(), IndexSpec, promote, ResidentDoc, ResidentLedger, ResidentLedgerMonth (+32 more)
...
Cohesion: 0.1
Nodes (40): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags() (+32 more)
...
Cohesion: 0.09
Nodes (29): outstandingForResident(), depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, providedItemSchema, auditMoveAction(), createMoveInChecklist(), createMoveOutChecklist() (+21 more)

### Community 118 - "Community 118"
Cohesion: 0.11
Nodes (35): askingEndsAt(), askingEndsMinuteOfNight(), formatPromptTime(), isCurrentNight(), isSameNight(), minuteIsDue(), minuteOfNight(), nightEndsAt() (+27 more)
...
Cohesion: 0.1
Nodes (31): geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim(), definedParts() (+23 more)

### Community 121 - "Community 121"
Cohesion: 0.06
Nodes (28): describePreference(), formatMinutes(), MUTABLE_CATEGORIES, NotificationPreference, parseMinutes(), base, claimAmount, dirname (+20 more)
...
Cohesion: 0.08
Nodes (29): deliver(), emailFacts(), hostelOrThrow(), notifyPlatformOfPayoutReview(), PayoutAccountStatus, PayoutAccountView, PayoutActor, PayoutRecord (+21 more)
...
Cohesion: 0.09
Nodes (24): REALTIME_TOPIC_VALUES, connectRealtime(), fetchConfig(), PusherModule, REALTIME_EVENT, RealtimeConfig, RealtimeConnection, RealtimeHandlers (+16 more)
...
Cohesion: 0.14
Nodes (23): bodySchema, POST(), FILE_ASSET_KINDS, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), isPlatformOnlyAssetKind(), PLATFORM_ONLY_KINDS (+15 more)

### Community 145 - "Community 145"
Cohesion: 0.1
Nodes (25): ROLE_VALUES, hostelMemberSchema, userSchema, ActivationCodeGenerateInput, ActivationCodeInput, activationSecret(), ActivationServiceError, ActivationStatus (+17 more)
...
Cohesion: 0.11
Nodes (16): hammingDistance(), isPerceptualNearDuplicate(), prepare(), systemDocumentKind(), distance, SystemDocumentKind, base, ImageVariantRecord (+8 more)
...
Cohesion: 0.15
Nodes (25): AccountDeletionRequest, code:typescript ({), code:typescript ({), code:typescript (interface IQuestionCallClick {), code:typescript ({), code:typescript ({), code:typescript (interface IAccountDeletionRequest {), code:block43 (packages/db/migrations/) (+17 more)

### Community 171 - "Community 171"
Cohesion: 0.1
Nodes (8): PublicHostelListingPage(), ComparePageSkeleton(), HostelDetailPageSkeleton(), HostelListingPageSkeleton(), InquiryPageSkeleton(), InquiryPage(), metadata, generateMetadata()
...
Cohesion: 0.12
Nodes (20): Attendance / Night Safety, Build status (end of Phase 3), Build status (end of Phase 5 — verified 2026-08-02), code:typescript (export enum Role {), code:typescript (interface IQRActivation {), code:typescript (interface INightStatusLog {), code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {) (+12 more)
...
Cohesion: 0.17
Nodes (17): Choice, maneuverIcon(), MapButton(), ModeTab(), NavCard(), NOTHING_CHOSEN, RouteCard(), buildShell() (+9 more)

### Community 211 - "Community 211"
Cohesion: 0.13
Nodes (17): buildPage(), buildPinPage(), CentrePin(), describeAddress(), HostelPinField(), HostelPinPicker(), KATHMANDU, MapLinkField() (+9 more)
...
Cohesion: 0.14
Nodes (14): AuthSession, getResidentProfile(), login(), submitResidentReview(), AppNavigator(), RootStackParamList, Stack, LoginScreen() (+6 more)
...
Cohesion: 0.14
Nodes (19): 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, 7.1 Attendance Alert (Resident Absent), 7.1 New Hostel Pending Approval (to Superadmin), 7.2 Subscription Expiring Soon, 7. Attendance & Location Tracking Emails (+11 more)
...
Cohesion: 0.14
Nodes (12): GetAppDialog(), EarningsRow(), Figure(), Registration, rupees(), Stat(), Summary, TeamDeskPage() (+4 more)
...
Cohesion: 0.17
Nodes (14): bsPeriodOf(), openOrder(), currentPeriod(), hostelId, mocks, principal, residentA, residentB (+6 more)
...
Cohesion: 0.16
Nodes (12): apiRequest(), getActivationStatus(), refreshSession(), register(), requestOtp(), signInWithGoogle(), triggerSOS(), verifyOtp() (+4 more)
...
Cohesion: 0.15
Nodes (10): filter, hostelId, invoiceId, mocks, otherHostelId, principal, residentA, residentB (+2 more)
...
Cohesion: 0.18
Nodes (13): 2.2 Hostel Approved, 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails, code:block14 (---) (+5 more)
...
Cohesion: 0.17
Nodes (10): toPortalInvoice(), first, goneId, hostelId, invoiceId, ledgerInvoice, mocks, receiptId (+2 more)
...
Cohesion: 0.22
Nodes (7): notificationPreferenceSchema, DEFAULT_NOTIFICATION_PREFERENCE, filterPushRecipients(), NotificationPreference, PreferenceRecord, mocks, night
...
Cohesion: 0.24
Nodes (7): activateResident(), Props, ResidentActivationScreen(), styles, Props, ResidentSOSScreen(), screenStyles
...
Cohesion: 0.33
Nodes (6): 4.2 Complaint Status Updated, 4.3 Complaint Resolved, 4. Resident Activity Emails, 6.1 Service Provider Registration Received, code:typescript ({), code:typescript ({)
...
## Knowledge Gaps
- **6507 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+6502 more)
...
- **Why does `cn()` connect `Community 14` to `Community 256`, `Community 0`, `Community 9`, `Community 10`, `Community 11`, `Community 15`, `Community 19`, `Community 21`, `Community 25`, `Community 153`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 34`, `Community 35`, `Community 39`, `Community 41`, `Community 42`, `Community 171`, `Community 54`, `Community 56`, `Community 58`, `Community 315`, `Community 61`, `Community 85`, `Community 89`, `Community 92`, `Community 93`, `Community 110`, `Community 252`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 0` to `Community 1`, `Community 2`, `Community 5`, `Community 133`, `Community 7`, `Community 8`, `Community 10`, `Community 14`, `Community 15`, `Community 16`, `Community 148`, `Community 21`, `Community 27`, `Community 31`, `Community 33`, `Community 35`, `Community 39`, `Community 41`, `Community 42`, `Community 56`, `Community 77`, `Community 210`, `Community 83`, `Community 211`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 3` to `Community 387`, `Community 4`, `Community 6`, `Community 9`, `Community 12`, `Community 13`, `Community 144`, `Community 17`, `Community 18`, `Community 145`, `Community 20`, `Community 22`, `Community 284`, `Community 29`, `Community 32`, `Community 36`, `Community 38`, `Community 40`, `Community 41`, `Community 43`, `Community 44`, `Community 45`, `Community 46`, `Community 48`, `Community 49`, `Community 50`, `Community 51`, `Community 52`, `Community 53`, `Community 55`, `Community 183`, `Community 57`, `Community 184`, `Community 59`, `Community 62`, `Community 63`, `Community 64`, `Community 65`, `Community 67`, `Community 70`, `Community 327`, `Community 71`, `Community 72`, `Community 74`, `Community 75`, `Community 73`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 86`, `Community 87`, `Community 346`, `Community 91`, `Community 348`, `Community 221`, `Community 94`, `Community 96`, `Community 98`, `Community 100`, `Community 101`, `Community 102`, `Community 103`, `Community 104`, `Community 231`, `Community 242`, `Community 117`, `Community 118`, `Community 120`, `Community 123`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Are the 523 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 523 INFERRED edges - model-reasoned connections that need verification._
