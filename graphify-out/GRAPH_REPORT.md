# Graph Report - hostel-management-software  (2026-09-23)

## Corpus Check
- 2327 files · ~4,847,663 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18672 nodes · 52524 edges · 591 communities (562 shown, 29 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 874 edges (avg confidence: 0.8)
...
3. `connectToDatabase()` - 532 edges
4. `useAppTheme()` - 422 edges
5. `cn()` - 343 edges
6. `connectToDatabase()` - 282 edges
7. `unwrap()` - 232 edges
...
- `PlanPicker()` --calls--> `billingCycles()`  [INFERRED]
  apps/web/src/app/_components/hostel-registration-progress.tsx → packages/shared/src/plans/catalog.ts
...
## Communities (591 total, 29 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (315): PATCH(), POST(), RouteContext, PATCH(), RouteContext, POST(), fileFieldCash(), GET() (+307 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (309): AdminCommunityReportsScreen(), AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), Scanner(), AttendanceScreen(), FaqRow(), MethodCard() (+301 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (314): loadOverview(), loadMoney(), loadToday(), TodayData, AdminAlertsContext, AdminAlertsValue, AlertActions, AlertCard() (+306 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (169): ICONS, LABELS, Segment, TONES, FILTERS, Pending, MoneyData, MANAGE_ROWS (+161 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (197): POST(), MESSAGES, POST(), RouteContext, POST(), GET(), POST(), PATCH() (+189 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (189): answerSchema, POST(), deleteResidentLocationHistory(), DELETE(), getPlanPaymentInstructions(), hostelCoverPhotos(), listMyBookings(), confirmComplaintResolution() (+181 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (140): CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload, GuardianDashboard, CATEGORIES, Payment, TABS (+132 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (167): POST(), POST(), attacker, attempt(), headers, jsonRequest(), routeMocks, appBaseUrl() (+159 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (163): AdminAlertsScreen(), AdminCommunityScreen(), AdminHomeScreen(), AdminOverviewScreen(), Overview, AdminTodayScreen(), HOSTEL, MONTHS (+155 more)

### Community 9 - "Community 9"
Cohesion: 0.01
Nodes (136): LegacyHostelAdminAttendancePage(), LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminMoveChecklistPage() (+128 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (188): BookingEndCause, HostelBookingClosedCause, announceConfirmed(), announceEnding(), assertAwaitingAnswer(), cancelBookingByHostel(), cancelBookingByPlatform(), cancelMyBooking() (+180 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (143): BootGate(), ApplyBlock(), ServiceProvidersScreen(), BrandSplash(), DocumentScreen(), MobileLegal, AuthDivider(), GoogleSignInButton() (+135 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (160): BookingForm(), METHODS, PackageCard(), roomPhotoUris(), StatusCard(), CentrePin(), describeAddress(), HostelPinField() (+152 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (148): otpResendCooldownMs(), checkoutDocumentFor(), softmatoDocumentNumbers(), gateway, invoice, updateOne, documentDownloadUrl(), IssuedInvoice (+140 more)

### Community 14 - "Community 14"
Cohesion: 0.01
Nodes (122): authorUserId, leanResult(), mocks, postId, reactorUserId, residentIn(), mocks, readable (+114 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (153): PaymentMonthStrip(), ClearFilters(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard(), AmountCard() (+145 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (118): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), ATTACHED, dueWhen() (+110 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (121): GET(), POST(), GET(), GET(), POST(), ownerIdentitiesFor(), resolveOwnedHostel(), invoiceIdFor() (+113 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (123): Platform, EMPTY_SUMMARY, ConcessionBackfill, describeApplied(), FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, MonthDiscounts (+115 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (136): AdminTabs(), HIDDEN, RoleLayout(), TABS, FILTERS, invalidateFeeds(), NIGHT_ANSWER_LABELS, nightAnswerText() (+128 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (88): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, roomTypeLabel(), LoadState (+80 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (87): DeletionPathway, DeletionStatus, PATHWAY_COPY, csvField(), deferLoad(), DemoDataBadge(), field(), Hostel (+79 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (109): listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), listFieldCashToConfirm(), getPlatformSubscriptionLedger(), listPlanPaymentClaims(), GET() (+101 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (110): getHostelPayoutAccount(), POST(), RouteContext, DELETE(), GET(), hostelId(), GET(), POST() (+102 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (99): PRIORITIES, STATUS_ACTIONS, Campaign, Resident, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel (+91 more)

### Community 25 - "Community 25"
Cohesion: 0.02
Nodes (85): csvField(), field(), Hostel, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminProfilePageContent(), HostelAdminRoomsPageContent(), Inquiry (+77 more)

### Community 26 - "Community 26"
Cohesion: 0.02
Nodes (110): ComplaintDetail(), ComplaintCard(), CategoryTile(), NewComplaintScreen(), PickedAttachment, SwapButton(), CapturedPhoto, PhotoCapture() (+102 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (110): GET(), appLoginUrl(), approvePlatformHostel(), grantHostelOwnerAccess(), provisionApprovalCookAccount(), hashUserAgent(), HostelRef, newVisitorKey() (+102 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (105): AssetViewer(), openIdFor(), openIds, StripThumb(), useViewerState(), ViewerBody(), ViewerPage(), CopyButton() (+97 more)

### Community 29 - "Community 29"
Cohesion: 0.02
Nodes (96): EMPTY_PAYOUT_DRAFT, METHODS, PayoutAccountDraft, PayoutAccountFields(), payoutAccountPayload(), DescriptionFacts, DescriptionSuggestions(), HostelType (+88 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (88): BubbleBackground(), BubbleBackgroundProps, BubbleColors, StarLayer(), StarLayerProps, StarsBackground(), StarsBackgroundProps, BookButton() (+80 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (98): notifyHostelOfNewPost(), resolveHostelCommunityUserIds(), usersMutingNewPosts(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus(), OPEN_STATUSES, OverdueComplaint (+90 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (100): fromBs(), gregorianOf(), BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary (+92 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (88): POST(), GET(), POST(), listResidentGuardians(), DEFAULT_GUARDIAN_PERMISSIONS, guardianAccessCreateSchema, guardianInvitationAcceptSchema, guardianInviteSchema (+80 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (73): metadata, AccountDeletionPanel, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails() (+65 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (80): BillingHistory, BillingInvoiceRow, BillingPaymentRow, BillingPlan, FieldCashRow, PlanPaymentClaim, formatBsAdDate(), metadata (+72 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (73): PayoutAccountForReview, ReviewPayoutAccount(), STATUS_LABEL, List(), ReasonAction(), Row(), timeLeft(), Tone (+65 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (81): HostelPhotoReminder(), PublicComparePage(), CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS, CITY_OPTIONS, FACILITY_STATS (+73 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (79): CommunityScreen(), Composer(), CommunityPostScreen(), FLAGGED, ReportedPostCard(), AnimatedBlurView, CommunityBoard(), CommunityBoardProps (+71 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (74): NotificationsPageContent(), Notification, FILTERS, Notification, NotificationRow(), PushState, FILTERS, NotificationCard (+66 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (77): BookingQuote, GuestBookingDetail, GuestBookingSummary, HostelBookingView, metadata, ComparePage(), generateMetadata(), hostels (+69 more)

### Community 41 - "Community 41"
Cohesion: 0.03
Nodes (88): Offset, PhotoCropper(), VideoSlot(), FileUploadArea(), FileUploadArea(), isApplicationOpen(), ServiceProviderRegistrationPageContent(), downloadCaption() (+80 more)

### Community 42 - "Community 42"
Cohesion: 0.03
Nodes (85): work, LIVE_STATUSES, LiveResidency, liveResidencyMessage(), LiveRow, AccountRow, askingAccount(), declineResidencyInvite() (+77 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (62): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CancelDeletionPageContent(), AcceptResult, CookInvitePageContent, field() (+54 more)
...
Cohesion: 0.03
Nodes (75): approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal, checker, eventId (+67 more)
...
Cohesion: 0.05
Nodes (85): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags() (+77 more)

### Community 49 - "Community 49"
Cohesion: 0.03
Nodes (67): summarizeResidentComplaints(), listResidentInvoices(), getFoodRoutine(), mealsOn(), friday, hostelId, mocks, nextFriday (+59 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (66): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, metadata, normalize(), PortalSearch(), PortalTone, scoreEntry(), toneStyles (+58 more)
...
Cohesion: 0.03
Nodes (72): RealtimeConfig, RealtimeContext, RealtimeContextValue, RealtimeNotification, RealtimeProvider(), useRealtime(), deviceTokenSchema, notificationSchema (+64 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (77): CHANNELS, ClaimedStep, composeEmail(), composeNotice(), composePlanDueNotice(), deliver(), deliverEmail(), deliverStep() (+69 more)

### Community 54 - "Community 54"
Cohesion: 0.04
Nodes (71): ReviewForm(), ReviewScreen(), NightHistoryEntry, getResidentReferral(), Referral, ReferralCode, ReferralReward, ResidentReferral (+63 more)

### Community 55 - "Community 55"
Cohesion: 0.04
Nodes (66): buildIdCardData(), EMAIL_CHECK_HINTS, EmailCheck, Field(), FIELD_LABELS, formatCardDate(), IdCardPanel(), identityDraftKey() (+58 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (68): openStore(), createNoticePush(), deleteNoticePush(), IntakeQuote, NoticePushInput, NoticePushRepeat, RESIDENT_TYPES, ResidentIntakeResult (+60 more)

### Community 57 - "Community 57"
Cohesion: 0.04
Nodes (72): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodBounds() (+64 more)

### Community 58 - "Community 58"
Cohesion: 0.05
Nodes (58): hostelPeriodOf(), BillPreview, CheckContext, CheckedRow, checkExistingResidents(), CheckResult, monthLabel(), moveInDateFor() (+50 more)

### Community 59 - "Community 59"
Cohesion: 0.03
Nodes (61): AnyProps, DOMMotionProps, mergeProps(), mergeRefs(), Slot(), SlotProps, WithAsChild, Align (+53 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (66): feeUpdateSchema, PATCH(), setResidentMonthlyFee(), POST(), GET(), arrangeProof(), leanResult(), mocks (+58 more)

### Community 61 - "Community 61"
Cohesion: 0.05
Nodes (62): GATEWAY_ORDER, getHostelPayMethods(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice() (+54 more)

### Community 62 - "Community 62"
Cohesion: 0.06
Nodes (59): collectionTotals(), countInvoicesByField(), invoicesByIds(), ledgerPipeline(), monthlySeries(), countListingAppearances(), getHostelViewStats(), complaintSchema (+51 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (61): notifyProviderOfAssignment(), notifyProviderOfMaintenanceNote(), notifyProviderOfStatusChange(), notifyStaffOfJobProgress(), notifyStaffOfNewMaintenanceRequest(), providerUserId(), readableCategory(), RequestLike (+53 more)

### Community 64 - "Community 64"
Cohesion: 0.05
Nodes (58): JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, AdminNightStatusRow, getOwnProvider() (+50 more)

### Community 65 - "Community 65"
Cohesion: 0.03
Nodes (63): Plan, PlanId, portalAccessLines(), Service, ServiceModule, ServiceModuleId, Faq, PlatformConfigSeoPageContent (+55 more)
...
Cohesion: 0.05
Nodes (63): formatPeriodKey(), cellAt(), focusCell(), INPUT_MODES, Props, cellAt(), focusCell(), Props (+55 more)

### Community 68 - "Community 68"
Cohesion: 0.05
Nodes (56): storeCartSchema, storeOrderSchema, DeliveryPromise, formatHour(), mocks, allocateOrderNumber(), applyStatus(), CancelInput (+48 more)

### Community 69 - "Community 69"
Cohesion: 0.05
Nodes (53): isAuthBypassEnabled(), original, CookieReader, hasSessionCookie(), LEGACY_ACCESS_TOKEN_COOKIES, LEGACY_REFRESH_TOKEN_COOKIES, readAccessTokenCookie(), readRefreshTokenCookieValue() (+45 more)

### Community 70 - "Community 70"
Cohesion: 0.05
Nodes (54): returnHeldBed(), takeHeldBed(), account, answerBy, before, book(), Booking, compact (+46 more)

### Community 71 - "Community 71"
Cohesion: 0.04
Nodes (49): CookServiceError, resolveAdminHostelId(), assertHostelAccess(), canAccessHostel(), hostelScopedFilter(), TenantAccessError, TenantPrincipal, auditLogSchema (+41 more)
...
Cohesion: 0.04
Nodes (45): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, AuthShell(), AuthShellProps, PANEL_COPY (+37 more)

### Community 75 - "Community 75"
Cohesion: 0.06
Nodes (42): generateMetadata(), generateMetadata(), manifest(), generateMetadata(), metadata, PublicOfferProgramPage(), PublicRefundPolicyPage(), FeatureModulePage() (+34 more)

### Community 76 - "Community 76"
Cohesion: 0.06
Nodes (48): GET(), SERVICE_PROVIDER_CATEGORIES, serviceProviderApplicationSchema, serviceProviderDocumentSchema, ServiceProvidersPage(), GET(), ACTIVE_APPLICATION_STATUSES, auditProviderAction() (+40 more)

### Community 77 - "Community 77"
Cohesion: 0.05
Nodes (45): CommunityPageContent(), FeedPayload, NewPostAlertsToggle(), SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+37 more)

### Community 78 - "Community 78"
Cohesion: 0.05
Nodes (48): referralSchema, referralCodeSchema, referralRewardSchema, activeCode, codeId, hostelId, joinedResidentId, mocks (+40 more)

### Community 79 - "Community 79"
Cohesion: 0.05
Nodes (44): FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind, creditOverpayment() (+36 more)

### Community 80 - "Community 80"
Cohesion: 0.06
Nodes (49): assertPlanRoom(), countLive(), notifyLimitReached(), NOUN, PlanLimitError, PlanSeat, hostelId, mocks (+41 more)

### Community 81 - "Community 81"
Cohesion: 0.05
Nodes (49): cookPrincipal, mocks, resolveCookLabels(), cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError, decodePhotoCursor() (+41 more)

### Community 82 - "Community 82"
Cohesion: 0.06
Nodes (48): announceFoodReady(), dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, getFoodRoutinesByHostelId(), isMonthEnd() (+40 more)
...
Cohesion: 0.07
Nodes (45): notFound(), CityHostelsPage(), generateMetadata(), PageParams, JsonLd(), JsonLdData, PublicLocationPage(), PublicServiceDetailPage() (+37 more)
...
Cohesion: 0.07
Nodes (41): bookingPolicyVersion(), newBookingCode(), applyBookingConfig(), BookingCancelStep, bookingCancelStepSchema, BookingConfig, bookingConfigSchema, DEFAULT_BOOKING_CONFIG (+33 more)

### Community 88 - "Community 88"
Cohesion: 0.06
Nodes (45): addUtcDay(), auditFoodAction(), createFoodMenu(), dayRange(), definedUpdate(), FoodFeedbackInput, FoodFeedbackRecord, FoodMenuCreateInput (+37 more)

### Community 89 - "Community 89"
Cohesion: 0.07
Nodes (48): fill(), money(), PlanCard(), PricingScreen(), BillingToggle(), PlanCard(), CatalogueTab(), CycleDiscount() (+40 more)

### Community 90 - "Community 90"
Cohesion: 0.07
Nodes (40): bsMonthStart(), hostelCalendarDay(), discountRent(), recomputeInvoiceBalance(), applyConcessionToIssuedInvoices(), ConcessionBackfill, EMPTY, InvoiceLine (+32 more)

### Community 91 - "Community 91"
Cohesion: 0.06
Nodes (42): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery (+34 more)

### Community 92 - "Community 92"
Cohesion: 0.07
Nodes (33): AuthGuard(), HostelSuggestions(), checkOnly(), EMPTY_PREFILL, ENVIRONMENT_OPTIONS, IdentityResponse, Prefill, Step (+25 more)

### Community 93 - "Community 93"
Cohesion: 0.07
Nodes (36): PLATFORM_SETTING_CHANGE_STATUSES, platformSettingChangeSchema, PUT(), saveOperationsConfig(), bookings, CollectionQr, isSettingChangeKey(), SETTING_CHANGES (+28 more)

### Community 94 - "Community 94"
Cohesion: 0.05
Nodes (43): hostelDayParts(), HOSTEL_AGREEMENT_STATUSES, hostelAgreementSchema, PLATFORM_DOCUMENT_KINDS, platformDocumentSequenceSchema, TRACK_SHEET_EVENT, AGREEMENT_STATUSES, agreementRef() (+35 more)

### Community 95 - "Community 95"
Cohesion: 0.1
Nodes (38): bodySchema, POST(), POST(), RouteContext, computePerceptualHash(), ImageVariantRecord, optimizeImage(), streamToBuffer() (+30 more)

### Community 96 - "Community 96"
Cohesion: 0.06
Nodes (45): AMOUNT_ALIASES, CREDIT_ALIASES, readMoney(), DATE_ALIASES, DEBIT_ALIASES, NAME_ALIASES, nonZero(), readMoney() (+37 more)

### Community 97 - "Community 97"
Cohesion: 0.09
Nodes (36): CSV_COLUMNS, GET(), GET(), periodTotals(), csvCell(), csvFilename(), csvResponse(), FORMULA_TRIGGERS (+28 more)
...
Cohesion: 0.05
Nodes (36): PortalDates, useHostelDayTurn(), useMinuteTick(), useSiteConfig(), PlanBillingInvoice, PlanBillingPayment, PlanBillingPlan, ContentSection (+28 more)
...
Cohesion: 0.06
Nodes (41): buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, draftFromProfile(), emptyIdentityDraft(), firstIncompleteIdentityStep() (+33 more)

### Community 102 - "Community 102"
Cohesion: 0.06
Nodes (35): countInvoicesByStatus(), fromLedgerRow(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor(), LedgerInvoiceRow, LedgerScope, LedgerTotals (+27 more)

### Community 103 - "Community 103"
Cohesion: 0.08
Nodes (38): GuardianMetrics(), GuardianPaymentsScreen(), GuardianSafetyScreen(), acceptGuardianInvitation(), getGuardianFood(), getGuardianNotices(), getGuardianPayments(), getGuardianSafetySummary() (+30 more)

### Community 104 - "Community 104"
Cohesion: 0.07
Nodes (31): demoteToPublicAccount(), GET(), RouteContext, POST(), RouteContext, addEmergencyContact(), addGuardian(), auditResidentAction() (+23 more)
...
Cohesion: 0.08
Nodes (38): Compass(), maneuverIcon(), NavCard(), NavigationFix, watchDeviceHeading(), watchNavigationPosition(), cardinalFor(), CARDINALS (+30 more)

### Community 108 - "Community 108"
Cohesion: 0.07
Nodes (39): publicHostelApplicationCreateSchema, documents, hostelForm(), many, parsed, result, buildHostelPayload(), capacitySummary() (+31 more)
...
Cohesion: 0.08
Nodes (32): POST(), RouteContext, listTrendingTags(), sponsorSchema, GET(), loadPopularHostels(), PopularHostelRecord, DELETE() (+24 more)
...
Cohesion: 0.09
Nodes (30): RootLayout(), InstallAppBanner(), Platform, ContactPage(), generateMetadata(), GET(), faqJsonLd(), loadSiteConfig (+22 more)

### Community 117 - "Community 117"
Cohesion: 0.09
Nodes (35): CsvTable, gridFromCsv(), peekHeaders(), readCsv(), stripBom(), stripPreamble(), ESEWA_PARSER, [first] (+27 more)

### Community 118 - "Community 118"
Cohesion: 0.09
Nodes (31): DEPRECATED_ALIASES, grantingPermissionKeys(), mocks, GET(), POST(), auditWardenAction(), createHostelWarden(), deactivateHostelWarden() (+23 more)
...
Cohesion: 0.07
Nodes (30): CheckoutHandoffButton(), Handoff, ORDER, ProgressStep, ProgressSteps(), TransitionScreen(), useCheckoutHandoff(), GetAppDialog() (+22 more)
...
Cohesion: 0.07
Nodes (32): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES (+24 more)

### Community 123 - "Community 123"
Cohesion: 0.1
Nodes (34): directionOf(), EMPTY_TALLY, floorToStep(), phaseOf(), shouldRepost(), tallyUploads(), active, done (+26 more)

### Community 124 - "Community 124"
Cohesion: 0.09
Nodes (26): resolveAttendanceAlert(), attendanceAlertResolveSchema, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex(), HostelRecord, ListingFlagListQuery, ListingFlagRecord (+18 more)

### Community 125 - "Community 125"
Cohesion: 0.07
Nodes (31): approveClaim(), assertNotAlreadyRecordedFromStatement(), BulkApproveResult, ClaimCheck, claimChecks(), directionCheck(), evidenceCheck(), fileCheck() (+23 more)
...
Cohesion: 0.08
Nodes (30): classifyCredit(), CreditClassification, LadderClaim, LadderInvoice, MatchContext, normalizeTxnId(), ANITA_CODE, claims (+22 more)

### Community 128 - "Community 128"
Cohesion: 0.09
Nodes (27): GET(), GET(), querySchema, focusSchema, POST(), assertTeamRegistrationIsNew(), checkTeamOwnerEmail(), findHostelUsingEmail() (+19 more)
...
Cohesion: 0.14
Nodes (29): resolvePastedLink(), searchCandidates(), lookupLocation(), resolvePastedLink(), searchCandidates(), AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim() (+21 more)

### Community 132 - "Community 132"
Cohesion: 0.1
Nodes (27): isCurrentNight(), isSelfReportable(), NIGHT_STATUS_OPTIONS, nightKey(), nightNote(), NightStanding, SelfReportableStatus, NIGHT_OF_17TH (+19 more)

### Community 133 - "Community 133"
Cohesion: 0.11
Nodes (30): UploadCard(), UploadToaster(), useIsUploading(), useUploads(), ensureChannel(), startUploadNotifications(), dismissUpload(), emit() (+22 more)

### Community 134 - "Community 134"
Cohesion: 0.07
Nodes (27): deliver(), emailFacts(), hostelOrThrow(), notifyPlatformOfPayoutReview(), PayoutAccountStatus, PayoutAccountView, PayoutActor, PayoutRecord (+19 more)

### Community 135 - "Community 135"
Cohesion: 0.08
Nodes (32): CREDIT_MARKERS, DEBIT_MARKERS, DirectionRead, EvidenceDirection, EvidenceOutcome, matched(), OUTCOME_MARKERS, readEvidenceDirection() (+24 more)
...
Cohesion: 0.11
Nodes (29): ApiFailure, apiRequest(), ApiSuccess, AuthUser, getActivationStatus(), getResidentNightStatus(), listNotifications(), listResidentFood() (+21 more)
...
Cohesion: 0.11
Nodes (27): cardinalFor(), CARDINALS, chooseHeading(), directionWord(), distanceToPath(), formatManeuverDistance(), headingDifference(), instructionFor() (+19 more)
...
Cohesion: 0.1
Nodes (24): noticeReadStatusSchema, mocks, noticeInput, residentUserId, staffPrincipal, auditNoticeAction(), broadcastNotice(), BroadcastOptions (+16 more)
...
Cohesion: 0.12
Nodes (25): robots(), bookingTask(), absoluteUrl(), HostelJsonLdInput, JsonLd, LINE_SEPARATOR, organizationId(), organizationJsonLd() (+17 more)

### Community 145 - "Community 145"
Cohesion: 0.1
Nodes (15): GoogleMap, LeafletMap, TYPE_COLORS, DraggablePinMap, FALLBACK_CENTER, LocationPicker(), LocationPickerValue, PART_LABELS (+7 more)
...
Cohesion: 0.14
Nodes (26): assertMatchesExtension(), beginDownload(), downloadAndShare(), downloadAndShareCsv(), downloadAndShareImage(), forgetDownloadFolder(), LegacyFileSystem, loadLegacyFileSystem() (+18 more)
...
Cohesion: 0.12
Nodes (21): Entry, hostelEntries(), locationEntries(), sitemap(), STATIC_ROUTES, PublicCitiesPage(), listPublishedHostelSlugs(), generateMetadata() (+13 more)
...
Cohesion: 0.11
Nodes (20): asRecord(), DrawnPush, readDrawnPush(), message, pushData, configureNativeNightPrompt(), registerNightStatusCategory(), drawn (+12 more)
...
Cohesion: 0.14
Nodes (23): hostelTypeLabel(), formatNpr(), hostelJsonLd(), photoAssetId(), PublicAsset, resolveSearchImageUrls(), searchImageUrls(), HostelLayout() (+15 more)

### Community 158 - "Community 158"
Cohesion: 0.12
Nodes (21): geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), geocodeAddress(), geocodeWithGoogle(), geocodeWithNominatim(), HostelGeoLocation (+13 more)
...
Cohesion: 0.1
Nodes (22): platformPushScheduleSchema, NotificationCampaignError, PLATFORM_PUSH_AUDIENCES, addDays(), nepalWallClockToUtc(), nextOccurrence(), PushRepeat, PushTiming (+14 more)
...
Cohesion: 0.17
Nodes (21): NativeNightPrompt, takeNativePendingAnswers(), isNightStatusPrompt(), NIGHT_STATUS_ACTIONS, NIGHT_STATUS_BUTTONS, NIGHT_STATUS_REASONS, NightStatusActionId, NightStatusAnswer (+13 more)

### Community 163 - "Community 163"
Cohesion: 0.08
Nodes (18): CookAccount, Credentials, HostelAdminCooksPanel, Issued, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek (+10 more)
...
Cohesion: 0.1
Nodes (22): BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, FeeScheduleCloseInput, feeScheduleCloseSchema (+14 more)
...
Cohesion: 0.1
Nodes (20): DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), axisMonth(), monthLabel(), describePreference() (+12 more)

### Community 173 - "Community 173"
Cohesion: 0.12
Nodes (20): chelseaMarket, geistMono, geistSans, metadata, poppins, MediaViewerProvider(), NotificationSoundListener(), ResidencyInvitePrompt() (+12 more)

### Community 174 - "Community 174"
Cohesion: 0.11
Nodes (21): findIndex(), index, indexesOf(), IndexSpec, promote, invoice, INVOICE_STATUSES, invoiceLineSchema (+13 more)
...
Cohesion: 0.12
Nodes (15): CITY_VISUALS, DEFAULT_CITY_VISUAL, OwnerCallout(), SeoChip(), SeoCrumbs(), SeoFaq(), SoftmatoCredit(), ComparisonPage() (+7 more)
...
Cohesion: 0.12
Nodes (19): buildHtml(), boundsCenter(), haversineMeters(), hostelCoordinates(), HostelWithDistance, isUsableCoordinate(), KATHMANDU, sortByDistance() (+11 more)
...
Cohesion: 0.16
Nodes (18): findSuspendedHostelIds(), liftHostelSuspension(), objectIds(), OPEN_WHILE_SUSPENDED, serializeSuspension(), hostelObjectId(), HostelSuspensionError, liftPlatformHostelSuspension() (+10 more)
...
Cohesion: 0.13
Nodes (16): nepalDayKey(), filterNotices(), groupNoticesByDay(), noticeCategories(), NoticeDay, NoticeStatus, days, read (+8 more)
...
Cohesion: 0.14
Nodes (15): activateResident(), ResidentNightStatus, submitResidentReview(), triggerSOS(), RootStackParamList, Props, Props, ResidentActivationScreen() (+7 more)
...
Cohesion: 0.14
Nodes (15): Guidance, GuidanceStatus, useGuidance(), hasGeolocation(), LocationOutcome, NavigationFix, OrientationPermission, requestDeviceLocation() (+7 more)
...
Cohesion: 0.12
Nodes (13): accountDeletionRequestSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, purgeAccount(), runAccountDeletionPurge(), sweepAbandonedUploads(), UPLOAD_VERIFICATION_EPOCH (+5 more)

### Community 225 - "Community 225"
Cohesion: 0.14
Nodes (18): daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags, GuardianPermissionsUpdateInput (+10 more)
...
Cohesion: 0.15
Nodes (16): fetchRoadRoute(), isRecord(), parseRoadRoute(), parseSteps(), ROUTE_MODES, ROUTERS, RouteStep, routeUrl() (+8 more)

### Community 229 - "Community 229"
Cohesion: 0.16
Nodes (16): DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS, MealCard(), MonthEndSpecial(), RoutineMeal, CookMenuScreen() (+8 more)

### Community 230 - "Community 230"
Cohesion: 0.14
Nodes (5): ComparePageSkeleton(), HostelDetailPageSkeleton(), HostelListingPageSkeleton(), InquiryPageSkeleton(), generateMetadata()

### Community 231 - "Community 231"
Cohesion: 0.16
Nodes (14): parsePlannedMoveIn(), hostelToday(), teamWalletEntrySchema, fit_width(), Builds the launch-screen art: the logo lockup and the "Powered by" strip.  Run f, commissionFor(), creditTeamCommission(), getAgentWallet() (+6 more)

### Community 232 - "Community 232"
Cohesion: 0.13
Nodes (16): getResidentLedger(), monthsBetween(), periodOf(), ResidentDoc, ResidentLedger, ResidentLedgerMonth, ResidentLedgerPayment, billed (+8 more)

### Community 233 - "Community 233"
Cohesion: 0.14
Nodes (15): questionCallClickSchema, ClickRecord, dayKey(), getQuestionCallAnalytics(), QuestionCallAnalyticsQuery, questionCallBaseUrl(), QuestionCallClickInput, QuestionCallConversionInput (+7 more)

### Community 234 - "Community 234"
Cohesion: 0.15
Nodes (19): Attendance / Night Safety, code:typescript (interface IQRActivation {), code:typescript (interface INightStatusLog {), code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface INotice {), code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {) (+11 more)
...
Cohesion: 0.13
Nodes (19): 1.0 Signup One-Time Code, 1.1 Email Verification (PUBLIC Signup), 1.2 Hostel Admin Credentials (Post-Approval), 1.3 Warden Credentials, 1.4 Resident QR Activation, 1.5 Guardian Invitation, 1.6 Password Reset, 1.7 Account Upgraded (+11 more)
...
Cohesion: 0.17
Nodes (13): open, native, NativeDownloads, openDownloaded(), openSavedFile(), SavedDownload, KNOWN_PATHS, marksRoleChange() (+5 more)
...
Cohesion: 0.13
Nodes (13): AuthSession, register(), requestOtp(), signInWithGoogle(), verifyOtp(), AppNavigator(), Stack, LoginScreen() (+5 more)
...
Cohesion: 0.16
Nodes (17): 6.1 Service Provider Registration Received, 6.2 Service Provider Approved, 6.3 Service Provider Rejected, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, 7.1 New Hostel Pending Approval (to Superadmin), 7.2 Subscription Expiring Soon, 7. Platform Admin Emails (+9 more)
...
Cohesion: 0.16
Nodes (11): softmatoWebhookSecret(), POST(), RawDelivery, body, reserialised, result, signature, stale (+3 more)
...
Cohesion: 0.2
Nodes (13): DeckCard(), bust(), helmet(), HELMETED, PALETTE, prop(), CATEGORIES, drawings (+5 more)
...
Cohesion: 0.2
Nodes (9): recordListingAppearances(), listPublicHostels(), publicHostelListQuerySchema, publicListingImpressionSchema, GET(), POST(), afterResponse(), mocks (+1 more)
...
Cohesion: 0.27
Nodes (15): AttendanceAlert, AttendanceLog, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({), code:typescript (interface IQuestionCallClick {), code:typescript ({) (+7 more)
...
Cohesion: 0.26
Nodes (11): NearbyStatus, Coordinates, hasLocationPermission(), hasPromptedForLocation(), LocationOutcome, readPosition(), readPrecisePosition(), rememberLocationPrompt() (+3 more)

### Community 294 - "Community 294"
Cohesion: 0.34
Nodes (8): InquiryFields(), hasInquiryErrors(), InquiryDraft, InquiryErrors, normalizePhone(), validateInquiry(), ReferralInquiryScreen(), HostelInquiryScreen()
...
Cohesion: 0.2
Nodes (11): POST(), assignOrphanCredit(), listStatementImports(), GET(), POST(), assignOrphanSchema, bulkApproveStatementSchema, STATEMENT_PROVIDERS (+3 more)
...
Cohesion: 0.21
Nodes (9): findHostelForCheckout(), challengeId, mocks, other, owned, ownerId, typed, hostelCode() (+1 more)
...
Cohesion: 0.17
Nodes (12): BANK, both, empty, ESEWA, [first], ids, KHALTI, odd (+4 more)
...
Cohesion: 0.17
Nodes (12): 4.1 New Notice Posted, 4. Resident Activity Emails, 5.1 SOS Triggered, 5. Safety & Emergency Emails, code:typescript ({), code:typescript ({), Email Opt-In/Opt-Out Matrix, EMAIL_SYSTEM.md — Email Triggers & Templates (+4 more)
...
Cohesion: 0.2
Nodes (12): 7.1 Multi-Tenant Isolation Test Template, 7.2 Role Gate Test Template, 7.3 Privacy/Guardian Permissions Test Template, 7.5 Payment Precision Test Template, 7. Mandatory Test Templates, 9.2 Test Database Isolation, code:typescript (describe('GET /api/v1/hostel/rooms/:id - tenant isolation', ), code:typescript (describe('GET /api/v1/hostel/rooms - role access', () => {) (+4 more)
...
Cohesion: 0.42
Nodes (6): SignaturePad(), drawSignature(), isSignatureComplete(), serializeSignature(), SignatureStroke, signatureStrokes()
...
Cohesion: 0.2
Nodes (9): HostelRegisterPayload, ProviderRegisterPayload, HostelApplicationStatus, listOwnHostelApplications(), LocationMatch, lookupRegistrationLocation(), OwnHostelApplication, registerHostelApplication() (+1 more)
...
Cohesion: 0.29
Nodes (8): canonical(), providersWithTxnIdRules(), RULES, REAL_ESEWA, rules, TXN_ID_FLAGS, TxnIdRule, TxnIdVerdict
...
Cohesion: 0.38
Nodes (10): code:typescript (interface IFoodReadyLog {), code:typescript ({), code:typescript ({), FoodReadyLog, Notification, Notification, Notification (as built), NotificationCampaign (+2 more)
...
Cohesion: 0.36
Nodes (7): HostelForm, clearRegistrationDraft(), DraftKind, keyFor(), readRegistrationDraft(), RegistrationDrafts, saveRegistrationDraft()
...
Cohesion: 0.29
Nodes (8): 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, 3.3 Payment Proof Uploaded (to Admin), code:typescript ({), code:typescript ({), code:typescript ({)
...
Cohesion: 0.38
Nodes (5): claimSecret(), issueDocumentClaimToken(), isValidDocumentClaimToken(), RegistrationDocumentError, SubmittedDocument
...
Cohesion: 0.33
Nodes (6): 7.4 Account-Upgrade Test Template, 9.1 Seed Scripts, 9.3 Test Helpers, 9. Test Data & Seeding, code:typescript (describe('POST /api/v1/hostel/residents - account upgrade', ), code:typescript (// tests/helpers/auth.ts)
...
## Knowledge Gaps
- **6529 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+6524 more)
...
- **Why does `cn()` connect `Community 30` to `Community 3`, `Community 6`, `Community 9`, `Community 18`, `Community 20`, `Community 21`, `Community 24`, `Community 25`, `Community 29`, `Community 34`, `Community 35`, `Community 36`, `Community 163`, `Community 37`, `Community 39`, `Community 40`, `Community 41`, `Community 38`, `Community 43`, `Community 50`, `Community 310`, `Community 183`, `Community 55`, `Community 59`, `Community 67`, `Community 74`, `Community 77`, `Community 83`, `Community 89`, `Community 92`, `Community 352`, `Community 120`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 3` to `Community 1`, `Community 2`, `Community 6`, `Community 8`, `Community 11`, `Community 12`, `Community 15`, `Community 145`, `Community 18`, `Community 19`, `Community 21`, `Community 24`, `Community 26`, `Community 28`, `Community 30`, `Community 34`, `Community 163`, `Community 294`, `Community 38`, `Community 39`, `Community 43`, `Community 50`, `Community 54`, `Community 56`, `Community 77`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 5` to `Community 0`, `Community 4`, `Community 134`, `Community 7`, `Community 10`, `Community 13`, `Community 398`, `Community 142`, `Community 141`, `Community 17`, `Community 14`, `Community 22`, `Community 278`, `Community 23`, `Community 151`, `Community 27`, `Community 157`, `Community 158`, `Community 31`, `Community 32`, `Community 159`, `Community 160`, `Community 33`, `Community 426`, `Community 171`, `Community 42`, `Community 46`, `Community 47`, `Community 48`, `Community 49`, `Community 51`, `Community 52`, `Community 53`, `Community 58`, `Community 60`, `Community 61`, `Community 318`, `Community 63`, `Community 62`, `Community 68`, `Community 69`, `Community 71`, `Community 72`, `Community 201`, `Community 76`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 85`, `Community 86`, `Community 87`, `Community 88`, `Community 90`, `Community 91`, `Community 93`, `Community 94`, `Community 95`, `Community 224`, `Community 225`, `Community 97`, `Community 102`, `Community 231`, `Community 232`, `Community 105`, `Community 233`, `Community 104`, `Community 112`, `Community 113`, `Community 244`, `Community 116`, `Community 118`, `Community 124`, `Community 125`, `Community 127`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Are the 526 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 526 INFERRED edges - model-reasoned connections that need verification._
