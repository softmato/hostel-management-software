...
## Corpus Check
- 2117 files · ~3,294,796 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17013 nodes · 47057 edges · 558 communities (528 shown, 30 thin omitted)
...
Cohesion: 0.02
Nodes (240): PATCH(), POST(), RouteContext, GET(), GET(), POST(), PATCH(), POST() (+232 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (175): FILTERS, Pending, Overview, MoneyData, MANAGE_ROWS, PORTAL_ROWS, TodayData, Person (+167 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (281): loadToday(), NightStatusPromptCard(), NoticeArt(), loadFinance(), getAdminFoodRoutine(), getAdminMaintenance(), getAdminNightStatus(), listAdminNotices() (+273 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (254): PATCH(), RouteContext, getOrCreateSubscription(), selectPlan(), GET(), getOpenFeeSchedule(), GET(), getFoodRoutinesByHostelId() (+246 more)
...
Cohesion: 0.02
Nodes (156): PlanPaymentClaim, deferLoad(), DemoDataBadge(), Hostel, HostelTable(), Inquiry, LoadState, Message() (+148 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (232): AdminCommunityReportsScreen(), AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), Scanner(), AttendanceScreen(), CookInviteScreen(), GuardianInviteScreen() (+224 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (206): SORTS, StoreCategoryScreen(), DeletionRequest, DeletionStatus, getDeletionStatus(), requestAccountDeletion(), removeCook(), ResidentScan (+198 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (182): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, AttendanceConfig, AttendanceZone, POST(), notifyHostelOfNewPost() (+174 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (189): answerSchema, POST(), ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError (+181 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (155): POST(), RouteContext, DELETE(), GET(), hostelId(), GET(), POST(), DELETE() (+147 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (145): POST(), POST(), attacker, attempt(), headers, jsonRequest(), routeMocks, appBaseUrl() (+137 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (123): HostelSuggestions(), GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS (+115 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (152): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult (+144 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (137): BrandMark(), BrandWordmark(), WORDMARK, WORDMARK_SEGMENTS, ConfirmOptions, LedgerMonth, LedgerPayment, ResidentLedger (+129 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (133): summarizeResidentComplaints(), collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES (+125 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (142): bsPeriodBounds(), formatBsPeriod(), formatBsPeriodMonth(), formatBsPeriodYear(), isBsPeriod(), periodParts(), periodStartDate(), PaymentMonthStrip() (+134 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (116): BootGate(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader(), CARD_PAD, EarningsTrend() (+108 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (127): SavedListRow(), cropToGuide(), FILL, GuidedCapture(), GUIDES, GuideShape, loadManipulator(), Manipulator (+119 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (133): CommunityPageContent(), PayPlanPanel(), rupees(), HostelRegistrationProgress(), Milestone, milestoneIndex(), MILESTONES, PaymentPanel() (+125 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (134): bsMonthStart(), hostelToday(), BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped (+126 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (126): periodTotals(), cookPrincipal, mocks, resolveCookLabels(), announceFoodReady(), cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput (+118 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (113): listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), querySchema, RouteContext, authorUserId, mocks (+105 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (107): POST(), POST(), POST(), runPlanDueReminders(), POST(), DELETE(), POST(), periodOf() (+99 more)

### Community 24 - "Community 24"
Cohesion: 0.02
Nodes (101): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), ApplyBlock(), ServiceProvidersScreen() (+93 more)

### Community 25 - "Community 25"
Cohesion: 0.02
Nodes (117): CapacityError, claimBedForRoomType(), listAllRoomTypes(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary(), releaseBedForRoomType() (+109 more)

### Community 26 - "Community 26"
Cohesion: 0.02
Nodes (108): Notification, MatrixRow, MatrixTotals, PeriodSummary, humanizeValue(), ImportedProfileSummary(), PrefillOccupancy, PrefillPhoto (+100 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (96): generateMetadata(), generateMetadata(), manifest(), robots(), Entry, hostelEntries(), locationEntries(), sitemap() (+88 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (111): AdminAlertsScreen(), ICONS, LABELS, Segment, TONES, AdminHomeScreen(), AdminOverviewScreen(), loadOverview() (+103 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (86): FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, monthStartPeriod(), Rate, RoomTypeOption, gregorianSpan(), MonthField (+78 more)

### Community 30 - "Community 30"
Cohesion: 0.02
Nodes (84): adminPrincipal, mocks, PLATFORM_LIMITS, mocks, readable, selectable, mocks, proofBody (+76 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (92): AdminCommunityScreen(), AdminTabs(), HIDDEN, RoleLayout(), TABS, FILTERS, invalidateFeeds(), NotificationRow() (+84 more)
...
Cohesion: 0.04
Nodes (86): CSV_COLUMNS, GET(), POST(), safeEqual(), GET(), querySchema, GET(), checkTeamOwnerEmail() (+78 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (81): GET(), escapeRegex(), objectIdSchema, paginationSchema, phoneSchema, auditListingFlagAction(), DuplicateCheckResultRecord, escapeRegex() (+73 more)
...
Cohesion: 0.03
Nodes (82): GET(), POST(), GET(), GET(), readReturnState(), ownerIdentitiesFor(), resolveOwnedHostel(), getPlanPaymentInstructions() (+74 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (82): CopyButton(), ManualMethodPanel(), methodCaption(), methodKey(), methodLabel(), methodProvider(), PROVIDER_LABEL, DetailsCard() (+74 more)

### Community 38 - "Community 38"
Cohesion: 0.09
Nodes (59): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), PLATFORM_NAME_PARTS, cookInvitationEmail() (+51 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (83): ReviewForm(), ReviewScreen(), describeGrants(), GuardianRow(), PermissionSheet(), InviteGuardianScreen(), readApiErrorCode(), daysUntil() (+75 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (73): GATEWAY_ORDER, getHostelPayMethods(), getPayInstructions(), HostelPayMethods, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod (+65 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (61): AuthShell(), AuthShellProps, PANEL_COPY, SiteWordmark(), metadata, AuthExperiencePage(), ContentHeader(), ContentIntro() (+53 more)

### Community 42 - "Community 42"
Cohesion: 0.03
Nodes (47): deleteHostelObjects(), ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, RETAINED_BY_HOSTEL_ID, both (+39 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (69): fill(), money(), PlanCard(), PricingScreen(), pricePlan(), PlanPicker(), TIER_TONE, BillingToggle() (+61 more)

### Community 44 - "Community 44"
Cohesion: 0.03
Nodes (65): Faq, PlatformConfigSeoPageContent, Step, app, base, cleared, fill, html (+57 more)
...
Cohesion: 0.04
Nodes (62): POST(), GET(), POST(), DEFAULT_GUARDIAN_PERMISSIONS, guardianAccessCreateSchema, guardianInvitationAcceptSchema, guardianInviteSchema, guardianLoginSchema (+54 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (56): complaintCategorySchema, complaintCreateSchema, complaintListQuerySchema, complaintReplySchema, complaintResolutionConfirmSchema, complaintStatusSchema, complaintStatusUpdateSchema, objectIdSchema (+48 more)

### Community 51 - "Community 51"
Cohesion: 0.03
Nodes (51): HostelAdminAttendancePageContent, HostelAdminCommunityPageContent, HostelAdminComplaintsPage, HostelAdminCooksPanel, HostelAdminFeePlansPageContent, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings (+43 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (59): openStore(), createResident(), getIntakeQuote(), IntakeQuote, lookupResidentProfile(), RESIDENT_TYPES, ResidentIntakeResult, ResidentOccupancy (+51 more)
...
Cohesion: 0.06
Nodes (56): documentDownloadUrl(), IssuedInvoice, issueInvoiceDocument(), OpenedCheckout, readSettledReceipt(), SettledReceipt, allocateNumber(), ensureInvoiceRaised() (+48 more)
...
Cohesion: 0.05
Nodes (40): HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), PlatformDashboardPageContent(), PlatformHostelReviewPageContent(), PlatformUsersPageContent(), DashboardCard(), DashboardCardProps, PlatformServiceProvidersPageContent() (+32 more)
...
Cohesion: 0.05
Nodes (46): daysFromNow(), enabledPermissionLabels(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags, GuardianPermissionsUpdateInput, GuardianRecord (+38 more)

### Community 62 - "Community 62"
Cohesion: 0.07
Nodes (54): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags(), documentFlags() (+46 more)
...
Cohesion: 0.05
Nodes (33): useConfirm(), ExistingResidentsPanel(), Props, ExistingResidentsSheet(), HostelAdminExistingResidentsPage(), blankRow(), Row, TeamInviteBox() (+25 more)
...
Cohesion: 0.05
Nodes (41): qrActivationSchema, residentSchema, userSchema, before, expiresAt, mocks, staffPrincipal, activateResident() (+33 more)

### Community 68 - "Community 68"
Cohesion: 0.06
Nodes (37): chelseaMarket, geistMono, geistSans, metadata, poppins, RootLayout(), AccountDeletionPanel, MediaViewerProvider() (+29 more)
...
Cohesion: 0.05
Nodes (35): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, auditLogSchema, referralSchema, referralCodeSchema, referralRewardSchema (+27 more)

### Community 71 - "Community 71"
Cohesion: 0.07
Nodes (39): isFileAssetKind(), isFinancialAssetKind(), DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList(), positiveInteger(), validateFileAssetMetadata() (+31 more)
...
Cohesion: 0.06
Nodes (23): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminComplaintsPage(), HostelAdminPaymentsPage(), redirectToWorkspaceScreen() (+15 more)

### Community 74 - "Community 74"
Cohesion: 0.06
Nodes (43): paymentProofSchema, receiptSchema, arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId (+35 more)
...
Cohesion: 0.05
Nodes (40): findIndex(), index, indexesOf(), IndexSpec, promote, invoice, INVOICE_STATUSES, invoiceLineSchema (+32 more)

### Community 78 - "Community 78"
Cohesion: 0.08
Nodes (40): hostelPeriodOf(), existingResidentListSchema, existingResidentRowSchema, BillPreview, CheckContext, CheckedRow, checkExistingResidents(), CheckResult (+32 more)

### Community 79 - "Community 79"
Cohesion: 0.08
Nodes (41): documentUrl(), InvoiceLean, PaymentLean, PlatformInvoiceRow, PlatformPaymentRow, PlatformSubscriptionLedger, deliver(), loadInvoiceById() (+33 more)
...
Cohesion: 0.05
Nodes (38): CHANNELS, ClaimedStep, composeNotice(), composePlanDueNotice(), deliverEmail(), deliverStep(), HostelRow, InvoiceRow (+30 more)

### Community 84 - "Community 84"
Cohesion: 0.06
Nodes (28): currency(), LoadingRows(), Panel(), ResidentActivationPageContent, ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent (+20 more)

### Community 85 - "Community 85"
Cohesion: 0.08
Nodes (40): personalLookupHash(), userResidentProfileSchema, findLiveResidency(), LEGACY_ROLE_MAP, Role, ROLE_VALUES, ageFromDateOfBirth(), ASSET_KINDS (+32 more)
...
Cohesion: 0.08
Nodes (39): formatPeriodKey(), defaultDueDate(), DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), axisMonth() (+31 more)

### Community 90 - "Community 90"
Cohesion: 0.06
Nodes (22): field(), GuardianDashboard, GuardianDashboardPageContent(), HostelAdminSOSAlertsPage(), LoadState, NightStatusRow, Notification, NotificationsPageContent() (+14 more)
...
Cohesion: 0.07
Nodes (27): openCheckoutSession(), applyWebhook(), WebhookResult, checkoutReturnUrl(), OpenCheckoutInput, openSoftmatoCheckout(), softmato(), SoftmatoNotConfiguredError (+19 more)
...
Cohesion: 0.07
Nodes (29): FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES, avatarTone(), CommunityComment (+21 more)

### Community 96 - "Community 96"
Cohesion: 0.15
Nodes (32): dueWhen(), PlanDueInput, planDueSoonEmail(), planOverdueEmail(), composeEmail(), planSuspensionNoticeEmail(), subscriptionClaimReceivedEmail(), subscriptionClaimRejectedEmail() (+24 more)
...
Cohesion: 0.08
Nodes (36): AMOUNT_ALIASES, CREDIT_ALIASES, AMOUNT_ALIASES, CREDIT_ALIASES, DATE_ALIASES, DEBIT_ALIASES, NAME_ALIASES, readMoney() (+28 more)
...
Cohesion: 0.08
Nodes (33): Choice, maneuverIcon(), MapButton(), ModeTab(), NavCard(), NOTHING_CHOSEN, RouteCard(), buildPage() (+25 more)
...
Cohesion: 0.1
Nodes (33): nightStatusPromptSchema, askingEndsMinuteOfNight(), formatPromptTime(), isCurrentNight(), isSameNight(), minuteIsDue(), minuteOfNight(), nightEndsAt() (+25 more)

### Community 107 - "Community 107"
Cohesion: 0.07
Nodes (27): searchHostels(), rows, ComparedHostel, comparePublicHostels(), definedParams(), Facility, getPublicHostel(), InquiryInput (+19 more)

### Community 108 - "Community 108"
Cohesion: 0.09
Nodes (33): Compass(), Guidance, GuidanceStatus, useGuidance(), cardinalFor(), CARDINALS, chooseHeading(), directionWord() (+25 more)
...
Cohesion: 0.08
Nodes (24): AuthGuard(), maybePromptForResidentProfile(), requestResidentProfileForm(), checkOnly(), EMPTY_PREFILL, ENVIRONMENT_OPTIONS, IdentityResponse, Prefill (+16 more)
...
Cohesion: 0.08
Nodes (25): outstandingForResident(), depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, providedItemSchema, auditMoveAction(), createMoveInChecklist(), createMoveOutChecklist() (+17 more)
...
Cohesion: 0.09
Nodes (30): DAY_LABELS, DayStrip(), MEAL_ICONS, MealCard(), RoutineMeal, CookMenuScreen(), CookPhotosScreen(), CookPortalSettings (+22 more)

### Community 119 - "Community 119"
Cohesion: 0.11
Nodes (25): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, SystemDocumentKind (+17 more)
...
Cohesion: 0.07
Nodes (24): EASE, FaqEntry, FaqRole, FaqRow(), FAQS, PlansFaq(), PREVIEW_ROWS, PREVIEWS (+16 more)
...
Cohesion: 0.09
Nodes (23): asRecord(), DrawnPush, readDrawnPush(), message, pushData, registerNightStatusCategory(), drawn, drawPush() (+15 more)
...
Cohesion: 0.11
Nodes (27): candidateFontDirs(), ensureIdCardFonts(), FONT_DIR_SEGMENTS, FONT_FILES, IdCardData, PlatformIdCardType, CardImages, renderIdCardPng() (+19 more)

### Community 131 - "Community 131"
Cohesion: 0.13
Nodes (30): assertMatchesExtension(), beginDownload(), downloadAndShare(), downloadAndShareCsv(), downloadAndShareImage(), forgetDownloadFolder(), LegacyFileSystem, loadLegacyFileSystem() (+22 more)
...
Cohesion: 0.07
Nodes (20): Select(), StatusBadge(), TextArea(), field(), HostelAdminReportsPageContent(), ListingFlag, LoadState, MaintenanceRequest (+12 more)
...
Cohesion: 0.1
Nodes (31): Attendance / Night Safety, code:typescript (interface INightStatusLog {), code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface INotice {), code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {), code:typescript ({) (+23 more)
...
Cohesion: 0.07
Nodes (21): Complaint, ComplaintSummary, EmptyState(), field(), FoodMenu, HostelAdminFoodPage(), HostelAdminNoticesPage(), HostelAdminResidentsPage() (+13 more)
...
Cohesion: 0.12
Nodes (24): UploadCard(), UploadToaster(), useIsUploading(), useUploads(), dismissUpload(), listeners, pruneUploads(), resetUploadQueue() (+16 more)
...
Cohesion: 0.09
Nodes (21): csvField(), field(), numberField(), optionalField(), AddressFields, FORM_SECTIONS, HostelAdminProfilePageContent, PendingPhoto (+13 more)
...
Cohesion: 0.14
Nodes (23): GuardianHomeScreen(), GuardianMetrics(), GuardianPaymentsScreen(), GuardianPayment, GuardianPermissions, canSee(), GUARDIAN_PERMISSION_LABELS, guardianDueAmount() (+15 more)

### Community 150 - "Community 150"
Cohesion: 0.17
Nodes (21): configureNativeNightPrompt(), NativeNightPrompt, takeNativePendingAnswers(), isNightStatusPrompt(), NIGHT_STATUS_ACTIONS, NIGHT_STATUS_BUTTONS, NIGHT_STATUS_REASONS, NightStatusActionId (+13 more)
...
Cohesion: 0.09
Nodes (22): initialState, notificationsSlice, NotificationsState, CalendarPreference, initialState, ThemePreference, uiSlice, UiState (+14 more)
...
Cohesion: 0.1
Nodes (15): buildFormPostHandoff(), FormPostHandoff, HandoffError, IntentRecord, formPostIntent, hostelId, intentId, invoiceId (+7 more)

### Community 164 - "Community 164"
Cohesion: 0.13
Nodes (18): purgeArchivedHostel(), purgeHostel(), platformAdminInviteSchema, deleteTeamMember(), endSessions(), findMember(), MemberRecord, reinstateTeamMember() (+10 more)
...
Cohesion: 0.16
Nodes (17): isCurrentNight(), isSelfReportable(), NIGHT_STATUS_OPTIONS, nightKey(), nightNote(), NightStanding, SelfReportableStatus, NIGHT_OF_17TH (+9 more)

### Community 171 - "Community 171"
Cohesion: 0.12
Nodes (13): fieldTeam(), fieldTeamExistingResidents, hostelStaffExistingResidents, Resolve, RouteContext, Scope, ExistingResidentRowInput, existingResidentRowSchema (+5 more)
...
Cohesion: 0.12
Nodes (14): DeviceLocationStatus, formatDistance(), hostelCoordinates(), isUsableCoordinate(), KATHMANDU, hasGeolocation(), LocationOutcome, NavigationFix (+6 more)
...
Cohesion: 0.14
Nodes (14): AuthSession, getResidentProfile(), login(), verifyOtp(), AppNavigator(), RootStackParamList, Stack, LoginScreen() (+6 more)
...
Cohesion: 0.19
Nodes (15): formatNPR(), drawCertificationStamp(), footerLine(), formatDate(), formatLongDate(), MONTHS, ReceiptPdfInput, renderReceiptPdf() (+7 more)
...
Cohesion: 0.18
Nodes (14): isAuthBypassEnabled(), original, dashboardHrefForRole(), landingPathForRole(), accessSecret(), config, proxy(), redirectHome() (+6 more)
...
Cohesion: 0.17
Nodes (13): SosInput, SosPhase, count(), describeFanout(), SETTLED_SOS, SosFanoutTone, sosMessagePayload(), SosOutcome (+5 more)
...
Cohesion: 0.17
Nodes (16): 1.0 Signup One-Time Code, 1.1 Email Verification (PUBLIC Signup), 1.2 Hostel Admin Credentials (Post-Approval), 1.3 Warden Credentials, 1.4 Resident QR Activation, 1.5 Guardian Invitation, 1.6 Password Reset, 1.7 Account Upgraded (+8 more)
...
Cohesion: 0.15
Nodes (14): apiRequest(), confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listResidentComplaints(), refreshSession(), register(), requestOtp() (+6 more)
...
Cohesion: 0.23
Nodes (12): destinationForRole(), isAllowedNextPath(), isHostelWorkspacePath(), isSafeLocalPath(), ProtectedRouteRule, protectedRouteRuleForPath(), protectedRouteRules, allowed (+4 more)
...
Cohesion: 0.16
Nodes (11): activateResident(), submitResidentReview(), triggerSOS(), Props, ResidentActivationScreen(), styles, Props, ResidentReviewsScreen() (+3 more)
...
Cohesion: 0.15
Nodes (12): advice, bare, creditReceipt, debitReceipt, eblQrReceipt, load, noisy, read (+4 more)
...
Cohesion: 0.26
Nodes (9): paymentDueReminderEmail(), ReminderStage, wording(), paymentOverdueEmail(), paymentProofUploadedEmail(), residentRegisteredEmail(), ResidentSignIn, emailDate() (+1 more)
...
Cohesion: 0.26
Nodes (9): NightStatusReasonCode, reasonLabel(), groupNightsByMonth(), nightDetail(), NightHistoryEntry, NightHistoryMonth, nightInstant(), summarizeNights() (+1 more)
...
Cohesion: 0.22
Nodes (4): ENDPOINTS, esewaProvider, parseAmount(), SIGNED_FIELDS
...
Cohesion: 0.25
Nodes (9): 2.1 Hostel Submission Received, 2.3 Hostel Rejected, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, 3.3 Payment Proof Uploaded (to Admin), code:typescript ({), code:typescript ({), code:typescript ({) (+1 more)
...
Cohesion: 0.36
Nodes (6): KNOWN_PATHS, marksRoleChange(), opensPlanBilling(), resolvePushPath(), REWRITES, ROLE_CHANGE_TYPES
...
Cohesion: 0.29
Nodes (7): 4.1 New Notice Posted, 4.3 Complaint Resolved, 4. Resident Activity Emails, 5.1 SOS Triggered, 5. Safety & Emergency Emails, code:typescript ({), code:typescript ({)
...
Cohesion: 0.38
Nodes (4): GoogleMap, HostelMap(), LeafletMap, useMapProvider()
...
## Knowledge Gaps
- **5955 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+5950 more)
...
- **Why does `cn()` connect `Community 14` to `Community 128`, `Community 1`, `Community 4`, `Community 133`, `Community 5`, `Community 134`, `Community 138`, `Community 12`, `Community 19`, `Community 148`, `Community 26`, `Community 27`, `Community 29`, `Community 32`, `Community 295`, `Community 41`, `Community 43`, `Community 48`, `Community 51`, `Community 53`, `Community 59`, `Community 65`, `Community 68`, `Community 76`, `Community 84`, `Community 95`, `Community 111`, `Community 116`, `Community 121`, `Community 250`, `Community 124`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 1` to `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 145`, `Community 24`, `Community 26`, `Community 28`, `Community 29`, `Community 35`, `Community 37`, `Community 39`, `Community 41`, `Community 178`, `Community 51`, `Community 52`, `Community 60`, `Community 64`, `Community 102`, `Community 118`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `Role` connect `Community 30` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 264`, `Community 9`, `Community 265`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 8`, `Community 10`, `Community 144`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 25`, `Community 33`, `Community 34`, `Community 36`, `Community 164`, `Community 424`, `Community 425`, `Community 45`, `Community 49`, `Community 186`, `Community 188`, `Community 61`, `Community 319`, `Community 63`, `Community 67`, `Community 71`, `Community 74`, `Community 77`, `Community 82`, `Community 83`, `Community 91`, `Community 227`, `Community 104`, `Community 105`, `Community 239`, `Community 240`, `Community 369`, `Community 243`, `Community 244`, `Community 379`?**
