...
## Corpus Check
- 2324 files · ~4,847,782 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18637 nodes · 52395 edges · 618 communities (588 shown, 30 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 872 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 750 edges
2. `successResponse()` - 722 edges
3. `connectToDatabase()` - 530 edges
4. `useAppTheme()` - 422 edges
5. `cn()` - 343 edges
6. `connectToDatabase()` - 281 edges
7. `unwrap()` - 232 edges
...
- `loadPopularHostels()` --calls--> `connectToDatabase()`  [INFERRED]
  apps/web/src/app/api/v1/community/sidebar/route.ts → packages/db/src/connection.ts

## Communities (618 total, 30 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (320): loadToday(), DAY_LABELS, DayStrip(), MEAL_ICONS, MealCard(), MonthEndSpecial(), RoutineMeal, CookMenuScreen() (+312 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (173): ICONS, LABELS, Segment, TONES, FILTERS, Pending, openStore(), Overview (+165 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (169): LegacyHostelAdminAttendancePage(), DeletionPathway, DeletionStatus, PATHWAY_COPY, BusyContext, BusyForm(), BusyFormProps, SubmitButton() (+161 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (241): ReviewForm(), ReviewScreen(), SORTS, StoreCategoryScreen(), answerHostelBooking(), CardBooking, findCardBooking(), getPayoutAccount() (+233 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (178): POST(), GET(), POST(), GET(), POST(), GET(), POST(), GET() (+170 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (198): ActivateScreen(), Scanner(), CookInviteScreen(), GuardianInviteScreen(), Compass(), MapButton(), ModeTab(), RouteCard() (+190 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (169): HIDDEN, RoleLayout(), TABS, FILTERS, invalidateFeeds(), NIGHT_ANSWER_LABELS, nightAnswerText(), NightPromptAnswer() (+161 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (164): GET(), answerSchema, POST(), AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput (+156 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (143): Choice, NOTHING_CHOSEN, PreviewCard(), ResultRow(), SavedListRow(), PackageCard(), PayStep(), roomPhotoUris() (+135 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (143): Platform, ConcessionBackfill, describeApplied(), FeeSchedule, formatDate(), HostelAdminFeeSchedulePageContent, MonthDiscounts, monthStartPeriod() (+135 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (137): LegacyHostelAdminBookingsPage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), csvField(), field(), Hostel, HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent() (+129 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (171): hostelCoverPhotos(), listMyBookings(), POST(), RouteContext, GET(), POST(), DELETE(), PATCH() (+163 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (153): generateMetadata(), manifest(), Entry, hostelEntries(), locationEntries(), sitemap(), STATIC_ROUTES, notFound() (+145 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (112): FieldCashRow, PlanPaymentClaim, formatBsAdDate(), Hostel, HostelTable(), ReportGrid(), ReportRecord, UserRecord (+104 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (155): applySettlement(), publishForSubscription(), graceDeadline(), startPlanPeriod(), sendEmail(), getOpenFeeSchedule(), listPublicFoodRoutine(), addHostelAdminProfilePhoto() (+147 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (146): robots(), otpResendCooldownMs(), checkoutDocumentFor(), softmatoDocumentNumbers(), gateway, invoice, updateOne, documentDownloadUrl() (+138 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (152): AdminCommunityReportsScreen(), AdminOverviewScreen(), AdminMoreScreen(), MANAGE_ROWS, PORTAL_ROWS, AdminResidentsScreen(), AttendanceScreen(), MapScreen() (+144 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (124): PATCH(), RouteContext, listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), POST(), listFieldCashToConfirm() (+116 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (100): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, COMPARISON_AMENITIES, comparisonAmenities() (+92 more)

### Community 19 - "Community 19"
Cohesion: 0.06
Nodes (109): accountDeletionCancelledEmail(), idCardIssuedEmail(), accountUpgradedEmail(), otpCodeEmail(), verificationEmail(), dueWhen(), PlanDueInput, planDueSoonEmail() (+101 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (120): FINANCE_ERROR_STATUS, FinanceErrorCode, FinanceServiceError, GATEWAY_ORDER, getHostelPayMethods(), HostelPayMethods, InvoiceRecord, methodsFrom() (+112 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (93): MESSAGES, POST(), RouteContext, getPlatformBooking(), listPausedHostels(), listPlatformBookings(), transfersByBooking(), getHostelPayoutAccount() (+85 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (139): bsMonthStart(), BY_OCCUPANCY, EXACT, normalizeBedType(), normalizeKey(), register(), mapped, BillableResidentRow (+131 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (127): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus(), OPEN_STATUSES (+119 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (117): BootGate(), RootShell(), GuardianLoginScreen(), LoginScreen(), BootSplashCover(), BrandSplash(), AuthDivider(), GoogleSignInButton() (+109 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (126): ClearFilters(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon(), SummaryCard(), AmountCard(), AdminLedger (+118 more)

### Community 26 - "Community 26"
Cohesion: 0.02
Nodes (95): PATCH(), POST(), RouteContext, GET(), GET(), PATCH(), RouteContext, GET() (+87 more)

### Community 27 - "Community 27"
Cohesion: 0.02
Nodes (108): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult (+100 more)
...
Cohesion: 0.02
Nodes (101): EMPTY_PAYOUT_DRAFT, METHODS, PayoutAccountDraft, PayoutAccountFields(), payoutAccountPayload(), DescriptionFacts, DescriptionSuggestions(), HostelType (+93 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (106): DELETE(), RouteContext, GET(), POST(), querySchema, RouteContext, AnnouncementInput, CommentCreateInput (+98 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (101): POST(), POST(), POST(), POST(), GET(), POST(), bulkApproveSchema, POST() (+93 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (103): AssetViewer(), openIdFor(), openIds, StripThumb(), useViewerState(), ViewerBody(), ViewerPage(), CopyButton() (+95 more)

### Community 33 - "Community 33"
Cohesion: 0.02
Nodes (108): AdminAlertsScreen(), AdminCommunityScreen(), AdminHomeScreen(), loadOverview(), AdminTabs(), AdminMoneyScreen(), loadMoney(), AdminTodayScreen() (+100 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (90): PRIORITIES, STATUS_ACTIONS, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel, GatewayConfig, GatewayHealthStatus (+82 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (92): PATCH(), PaginationMeta, PaginationQuery, paginationQuerySchema, paginationRange(), querySchema, auditListingFlagAction(), DuplicateCheckResultRecord (+84 more)

### Community 36 - "Community 36"
Cohesion: 0.02
Nodes (86): GetPlanButton(), InlineText(), TIER_TONE, PlanMark(), RAFTER, RIDGE, ROWS, EASE (+78 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (82): generateMetadata(), AuthShell(), AuthShellProps, PANEL_COPY, SiteWordmark(), metadata, AccountDeletionPanel, BrandMark() (+74 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (73): field(), GuardianDashboard, GuardianDashboardPageContent(), LoadState, NightStatusRow, Notification, optionalNumber(), PlatformReviewsPageContent() (+65 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (77): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), ApplyBlock(), ServiceProvidersScreen() (+69 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (91): cookLoginStem(), generateCookPassword(), mintCookLogin(), pick(), previousCookLabel(), cookPrincipal, mocks, acceptCookInvitation() (+83 more)

### Community 41 - "Community 41"
Cohesion: 0.03
Nodes (76): BookButton(), SIZE, BookingAvailabilityView, BookingButton, CLOSED_REASONS, open, HostelSuggestions(), inferKind() (+68 more)

### Community 42 - "Community 42"
Cohesion: 0.03
Nodes (79): BubbleBackground(), BubbleBackgroundProps, BubbleColors, StarLayer(), StarLayerProps, StarsBackground(), StarsBackgroundProps, CommunityReportDialog() (+71 more)

### Community 43 - "Community 43"
Cohesion: 0.03
Nodes (82): AuthGuard(), CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing (+74 more)

### Community 44 - "Community 44"
Cohesion: 0.03
Nodes (73): NotificationsPageContent(), Notification, FILTERS, Notification, NotificationRow(), PushState, FILTERS, NotificationCard (+65 more)

### Community 45 - "Community 45"
Cohesion: 0.02
Nodes (63): ATTENDANCE_DEFAULTS, adminPrincipal, mocks, PLATFORM_LIMITS, afterMidnight, evening, meters, mocks (+55 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (79): appBaseUrl(), AuthServiceError, changePassword(), CLAIMABLE_STATUSES, dispatchOtpChallenge(), dispatchVerificationEmail(), findVerifiedRegistrationChallenge(), generateOtpCode() (+71 more)

### Community 47 - "Community 47"
Cohesion: 0.03
Nodes (76): GET(), POST(), POST(), PATCH(), RouteContext, setHostelBookingPause(), mergeBookingConfig(), listTransfersDue() (+68 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (81): Assurance(), fill(), money(), PlanCard(), PricingScreen(), BillingInvoiceRow, BillingPaymentRow, BillingPlan (+73 more)

### Community 49 - "Community 49"
Cohesion: 0.03
Nodes (68): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, metadata, normalize(), PortalSearch(), PortalTone, scoreEntry(), toneStyles (+60 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (70): listBookingPaymentsToCheck(), GET(), POST(), getFoodRoutine(), getFoodRoutinesByHostelId(), saveFoodRoutine(), serializeRoutine(), addUtcDay() (+62 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (76): demoteToPublicAccount(), CardBooking, checkInBooking(), findCardBooking(), findHeldBooking(), returnHeldBed(), takeHeldBed(), notifyPlatform() (+68 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (60): summarizeResidentComplaints(), listResidentInvoices(), outstandingForResident(), renderStatementForResident(), getResidentLedger(), bedSchema, depositRefundSchema, foodMenuSchema (+52 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (68): NoticeArt(), createManagedNotice(), createNoticePush(), deleteNoticePush(), listManagedNotices(), ManagedNotice, NOTICE_CATEGORIES, NoticeAudience (+60 more)
...
Cohesion: 0.05
Nodes (61): addComplaintUpdate(), assertComplaintVoiceNote(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren(), ComplaintCreateInput (+53 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (56): chelseaMarket, geistMono, geistSans, metadata, poppins, RootLayout(), BookingQuote, GuestBookingDetail (+48 more)

### Community 57 - "Community 57"
Cohesion: 0.03
Nodes (40): ComparePage(), generateMetadata(), hostels, metadata, rows, AuthExperiencePage(), CurrentUser, DASHBOARD_ROLES (+32 more)

### Community 58 - "Community 58"
Cohesion: 0.05
Nodes (59): POST(), RouteContext, addHistory(), addMaintenanceComment(), assertBedInHostel(), assertProviderApproved(), assertRoomInHostel(), assertVoiceNoteUsable() (+51 more)

### Community 59 - "Community 59"
Cohesion: 0.05
Nodes (54): monthsBetween(), periodOf(), hostelPeriodOf(), existingResidentListSchema, existingResidentRowSchema, BillPreview, CheckContext, CheckedRow (+46 more)

### Community 60 - "Community 60"
Cohesion: 0.06
Nodes (52): checkFieldCash(), fileFieldCash(), submitFieldCash(), applyWebhook(), recordSoftmatoPayment(), WebhookResult, refileBookingRefund(), submitBookingRefund() (+44 more)
...
Cohesion: 0.03
Nodes (42): deleteHostelObjects(), ERASED_BY_HOSTEL_ID, ERASED_MODEL_NAMES, FileAssetRow, PULLED_FROM_HOSTEL_IDS, PurgeableModel, purgeHostel(), RETAINED_BY_HOSTEL_ID (+34 more)

### Community 63 - "Community 63"
Cohesion: 0.06
Nodes (58): BOOKING_DOCUMENT_KINDS, BookingDocumentKind, bookingDocumentLayout(), refundPolicyNotes(), allowed(), bookingDocumentResponse(), BookingDocumentScope, resolveBookingDocument() (+50 more)

### Community 64 - "Community 64"
Cohesion: 0.04
Nodes (57): findIndex(), index, indexesOf(), IndexSpec, promote, ResidentDoc, ResidentLedger, ResidentLedgerMonth (+49 more)

### Community 65 - "Community 65"
Cohesion: 0.05
Nodes (59): CHANNELS, ClaimedStep, composeEmail(), composeNotice(), composePlanDueNotice(), deliverEmail(), deliverStep(), HostelRow (+51 more)

### Community 66 - "Community 66"
Cohesion: 0.05
Nodes (52): GET(), SERVICE_PROVIDER_CATEGORIES, serviceProviderSchema, serviceProviderApplicationSchema, serviceProviderDocumentSchema, PATCH(), GET(), notifyPlatformOfServiceProviderApplication() (+44 more)

### Community 67 - "Community 67"
Cohesion: 0.05
Nodes (61): addBsMonths(), BS_MONTHS, BsDate, bsDayOfMonth(), bsDaysInMonth(), bsMonthName(), bsMonthsEnd(), bsPeriodBounds() (+53 more)

### Community 68 - "Community 68"
Cohesion: 0.04
Nodes (50): financeIntegrityHash(), appendEntry(), applyCreditToInvoice(), CreditBalanceView, CreditEntryKind, creditOverpayment(), getCreditBalance(), isDuplicateKey() (+42 more)

### Community 69 - "Community 69"
Cohesion: 0.04
Nodes (47): EMPTY_DRAFT, HostelAdminPaymentProfilePageContent, PaymentProfile, SECTION_FIELDS, SectionId, HostelAdminReconcilePageContent, labelled(), PROVIDERS (+39 more)
...
Cohesion: 0.05
Nodes (50): HostelAdminCooksPanel, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine, formatWeekRange() (+42 more)

### Community 73 - "Community 73"
Cohesion: 0.05
Nodes (51): hostelDayParts(), COLUMNS, Member, MemberData, RegistrationTrackSheet(), TrackSheetLoader(), metadata, HOSTEL_AGREEMENT_STATUSES (+43 more)

### Community 74 - "Community 74"
Cohesion: 0.06
Nodes (49): isAuthBypassEnabled(), original, CookieReader, hasSessionCookie(), LEGACY_ACCESS_TOKEN_COOKIES, LEGACY_REFRESH_TOKEN_COOKIES, readAccessTokenCookie(), readRefreshTokenCookieValue() (+41 more)

### Community 75 - "Community 75"
Cohesion: 0.06
Nodes (50): notifyHostelOfNewPost(), resolveHostelCommunityUserIds(), usersMutingNewPosts(), announceFoodReady(), dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord (+42 more)

### Community 76 - "Community 76"
Cohesion: 0.06
Nodes (56): AMOUNT_LABELS, canonical(), canonicalDigits(), ClaimFacts, containsWithTolerance(), deadline(), DIGIT_CONFUSABLES, EvidenceRead (+48 more)

### Community 77 - "Community 77"
Cohesion: 0.07
Nodes (44): collectionTotals(), listRecentInvoices(), getHostelViewStats(), foodFeedbackSchema, listingFlagSchema, paymentProofSchema, referralSchema, referralRewardSchema (+36 more)

### Community 78 - "Community 78"
Cohesion: 0.08
Nodes (22): PlatformConfigAnnouncementsPageContent, PlatformConfigContentPageContent, PlatformConfigFacilitiesPageContent, FLAGS, PlatformConfigFeaturesPageContent, PlatformConfigLegalPageContent, PlatformConfigLocationsPageContent, PlatformConfigPlanServicePageContent (+14 more)

### Community 79 - "Community 79"
Cohesion: 0.06
Nodes (44): CATEGORY_PATHS, deepLinkForNotification(), DeepLinkInput, isPlanDueNotification(), readId(), activeDevicesFor(), activeTokensFor(), androidChannel() (+36 more)

### Community 80 - "Community 80"
Cohesion: 0.07
Nodes (41): CSV_COLUMNS, GET(), POST(), RouteContext, POST(), safeEqual(), webPushSubscribeSchema, webPushUnsubscribeSchema (+33 more)

### Community 81 - "Community 81"
Cohesion: 0.06
Nodes (45): qrActivationSchema, residentSchema, activateResident(), ActivationCodeGenerateInput, ActivationCodeInput, activationSecret(), ActivationServiceError, ActivationStatus (+37 more)

### Community 82 - "Community 82"
Cohesion: 0.06
Nodes (48): candidatesInRun(), canonicalize(), checkCharacter(), CONFUSABLES, decodeSequence(), deriveHostelPrefix(), encodeSequence(), extractReferenceCodes() (+40 more)

### Community 83 - "Community 83"
Cohesion: 0.06
Nodes (42): GET(), GET(), POST(), acceptPlatformAdminInvitation(), AcceptPlatformAdminInvitationInput, appUrl(), checkPlatformAdminEmail(), daysFromNow() (+34 more)

### Community 84 - "Community 84"
Cohesion: 0.08
Nodes (48): BookingEndCause, HostelBookingClosedCause, announceEnding(), assertAwaitingAnswer(), cancelBookingByHostel(), cancelBookingByPlatform(), cancelMyBooking(), confirmBooking() (+40 more)

### Community 85 - "Community 85"
Cohesion: 0.06
Nodes (46): receiptSchema, arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal (+38 more)

### Community 86 - "Community 86"
Cohesion: 0.07
Nodes (42): Guidance, GuidanceStatus, useGuidance(), hasGeolocation(), LocationOutcome, NavigationFix, OrientationPermission, requestDeviceLocation() (+34 more)

### Community 87 - "Community 87"
Cohesion: 0.06
Nodes (35): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, logAccessFailure(), openHostelAfterPayment(), approvalPeriod(), getPeriodSummary() (+27 more)

### Community 88 - "Community 88"
Cohesion: 0.1
Nodes (46): announceConfirmed(), directionsUrl(), HostelPlace, bookingDocumentAttachment(), applyStrikeRule(), endBooking(), EndBookingInput, ENDING_FOR_STATUS (+38 more)

### Community 89 - "Community 89"
Cohesion: 0.08
Nodes (37): bodySchema, POST(), FILE_ASSET_KINDS, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), isPlatformOnlyAssetKind(), PLATFORM_ONLY_KINDS (+29 more)
...
Cohesion: 0.1
Nodes (41): GET(), BookableHostel, BookingUnavailableReason, findRoom(), hostelAddress(), HostelAvailability, hostelCoverPhoto(), hostelUnavailableReason() (+33 more)

### Community 92 - "Community 92"
Cohesion: 0.09
Nodes (43): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeIsPlausible(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags() (+35 more)

### Community 93 - "Community 93"
Cohesion: 0.06
Nodes (40): NotificationSoundListener(), RealtimeConfig, RealtimeContext, RealtimeContextValue, RealtimeNotification, RealtimeProvider(), useRealtime(), attempt() (+32 more)
...
Cohesion: 0.1
Nodes (35): JobRowDivider(), ProviderHero(), ProviderHeroRegister(), ProviderJobRow(), TILE_INK, TILE_TINT, getOwnProvider(), listProviderJobs() (+27 more)

### Community 97 - "Community 97"
Cohesion: 0.07
Nodes (36): HostelBookingView, PayoutAccountForReview, ReviewPayoutAccount(), STATUS_LABEL, List(), ReasonAction(), Row(), timeLeft() (+28 more)
...
Cohesion: 0.09
Nodes (38): noticePushSchema, announceChange(), audit(), CreateInput, createNoticePush(), DEFAULT_PUSHES, deleteNoticePush(), emitNoticePush() (+30 more)
...
Cohesion: 0.07
Nodes (26): ExistingResidentsPanel(), Props, ExistingResidentsSheet(), grabDocument(), HostelAdminBillingPageContent(), InvoiceRow(), PaymentRow(), PlanCard() (+18 more)

### Community 102 - "Community 102"
Cohesion: 0.05
Nodes (36): fromBs(), gregorianOf(), bhadra(), filter, hostelId, invoiceId, mocks, otherHostelId (+28 more)
...
Cohesion: 0.06
Nodes (33): attacker, attempt(), headers, jsonRequest(), routeMocks, verifyOtpChallenge(), GoogleAuthInput, googleAuthSchema (+25 more)
...
Cohesion: 0.12
Nodes (35): resolvePastedLink(), searchCandidates(), lookupLocation(), resolvePastedLink(), searchCandidates(), AddressParts, addressPartsFromGoogle(), addressPartsFromNominatim() (+27 more)

### Community 107 - "Community 107"
Cohesion: 0.07
Nodes (36): countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor(), LedgerInvoice (+28 more)

### Community 108 - "Community 108"
Cohesion: 0.06
Nodes (26): issue(), auditGuardianAction(), createGuardianAccess(), expiresInDays(), findAdminResident(), GuardianAccessCreateInput, GuardianAccessRecord, GuardianLoginInput (+18 more)
...
Cohesion: 0.06
Nodes (28): applyBookingConfig(), bookingConfigSchema, PLATFORM_SETTING_CHANGE_STATUSES, platformSettingChangeSchema, bookings, CollectionQr, isSettingChangeKey(), SETTING_CHANGES (+20 more)

### Community 112 - "Community 112"
Cohesion: 0.09
Nodes (35): Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity() (+27 more)
...
Cohesion: 0.1
Nodes (34): nightStatusPromptSchema, askingEndsMinuteOfNight(), formatPromptTime(), isCurrentNight(), isSameNight(), minuteIsDue(), minuteOfNight(), nightEndsAt() (+26 more)

### Community 115 - "Community 115"
Cohesion: 0.09
Nodes (34): cellAt(), focusCell(), INPUT_MODES, Props, cellAt(), focusCell(), Props, SheetCell (+26 more)

### Community 116 - "Community 116"
Cohesion: 0.07
Nodes (28): ReturnState, BookingReturnState, CheckoutHandoffButton(), Handoff, ORDER, ProgressStep, ProgressSteps(), TransitionScreen() (+20 more)

### Community 117 - "Community 117"
Cohesion: 0.18
Nodes (23): POST(), POST(), authenticateWithGoogle(), logout(), POST(), loginGuardian(), accessTokenTtlSeconds(), parseDurationSeconds() (+15 more)

### Community 118 - "Community 118"
Cohesion: 0.07
Nodes (31): AuthError(), AuthField(), AuthHeading(), PasswordInput(), PasswordInputProps, GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse (+23 more)

### Community 119 - "Community 119"
Cohesion: 0.11
Nodes (28): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), systemDocumentKind(), distance, ImageVariantRecord (+20 more)
...
Cohesion: 0.08
Nodes (26): CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES, avatarTone() (+18 more)

### Community 122 - "Community 122"
Cohesion: 0.1
Nodes (28): nepalDayKey(), isCurrentNight(), isSelfReportable(), NIGHT_STATUS_OPTIONS, nightKey(), nightNote(), NightStanding, SelfReportableStatus (+20 more)
...
Cohesion: 0.11
Nodes (31): directionOf(), EMPTY_TALLY, floorToStep(), phaseOf(), shouldRepost(), tallyUploads(), active, done (+23 more)

### Community 128 - "Community 128"
Cohesion: 0.12
Nodes (27): BookingCancelStep, bookingCancelStepSchema, BookingConfig, DEFAULT_BOOKING_CONFIG, DEFAULT_CANCEL_STEPS, percent, bookingGuideIntro(), bookingGuideSections() (+19 more)

### Community 129 - "Community 129"
Cohesion: 0.08
Nodes (31): daysBetween(), deliver(), DunningAction, DunningStage, DunningState, escalateToHostel(), InvoiceRow, nextDunningAction() (+23 more)
...
Cohesion: 0.06
Nodes (28): CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, TRUST_POINTS, CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, MOCK_HOSTELS (+20 more)
...
Cohesion: 0.09
Nodes (31): buildHostelPayload(), capacitySummary(), FACILITY_OPTIONS, firstIncompleteHostelStep(), hasHostelErrors(), hasUsableRooms(), HOSTEL_PLANS, HOSTEL_STEPS (+23 more)
...
Cohesion: 0.08
Nodes (25): ENDED, HOSTEL_BOOKING_TABS, HostelBookingTab, iso(), listHostelBookings(), PLATFORM_BOOKING_TABS, TransferRecord, BOOKING_STATUSES (+17 more)
...
Cohesion: 0.11
Nodes (27): formatPeriodKey(), fullYear(), MONTH_SPELLINGS, monthFromWord(), readBsMonth(), readMonthsDue(), readPhone(), readRupees() (+19 more)
...
Cohesion: 0.12
Nodes (25): GuardianMetrics(), GuardianPaymentsScreen(), GuardianSafetyScreen(), GuardianPayment, GuardianPermissionKey, GuardianPermissions, GuardianReceipt, canSee() (+17 more)

### Community 141 - "Community 141"
Cohesion: 0.09
Nodes (16): TYPE_COLORS, DraggablePinMap, FALLBACK_CENTER, LocationPicker(), LocationPickerValue, PART_LABELS, fetchNearbyWithGoogle(), GOOGLE_PLACE_TYPES (+8 more)

### Community 142 - "Community 142"
Cohesion: 0.09
Nodes (26): BANK_CSV_PARSER, peekHeaders(), BANK, both, empty, ESEWA, [first], ids (+18 more)
...
Cohesion: 0.1
Nodes (25): LIVE_ACCESS, releaseGuardianAccounts(), daysFromNow(), enabledPermissionLabels(), findResidentOwnedAccess(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput (+17 more)
...
Cohesion: 0.11
Nodes (22): describeGrants(), GuardianRow(), PermissionSheet(), daysUntil(), describeGuardianOnRecord(), describeInvitation(), describeSharing(), EMPTY_INVITE_DRAFT (+14 more)

### Community 150 - "Community 150"
Cohesion: 0.1
Nodes (24): useIsUploading(), ensureChannel(), startUploadNotifications(), dismissUpload(), listeners, pruneUploads(), resetUploadQueue(), rows (+16 more)

### Community 151 - "Community 151"
Cohesion: 0.18
Nodes (26): assertMatchesExtension(), beginDownload(), downloadAndShare(), downloadAndShareCsv(), downloadAndShareImage(), downloadToDevice(), forgetDownloadFolder(), LegacyFileSystem (+18 more)
...
Cohesion: 0.1
Nodes (23): notificationSchema, userResidentProfileSchema, findLiveResidency(), ageFromDateOfBirth(), lookupResidentProfile(), normalizeResidentId(), readProfile(), ResidentIdentityError (+15 more)
...
Cohesion: 0.09
Nodes (24): BALANCE_ALIASES, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES, WITHDRAWAL_ALIASES (+16 more)

### Community 156 - "Community 156"
Cohesion: 0.1
Nodes (21): notificationPreferenceSchema, DEFAULT_NOTIFICATION_PREFERENCE, filterPushRecipients(), NotificationPreference, PreferenceRecord, mocks, night, isWithinQuietHours() (+13 more)
...
Cohesion: 0.12
Nodes (21): native, NativeDownloads, openDownloaded(), openSavedFile(), SavedDownload, configureNativeNightPrompt(), claimNotificationSound(), claims (+13 more)
...
Cohesion: 0.12
Nodes (21): EXTENSION_BY_MIME, FAMILY_BYTES, FAMILY_ORDER, familyOf(), joinTypes(), KIND_RULES, KindRule, labelsFor() (+13 more)
...
Cohesion: 0.12
Nodes (15): oauthAccountSchema, platformAdminInviteSchema, sessionSchema, deleteTeamMember(), endSessions(), findMember(), MemberRecord, removeTeamMember() (+7 more)

### Community 176 - "Community 176"
Cohesion: 0.19
Nodes (19): CsvTable, gridFromCsv(), readCsv(), stripBom(), stripPreamble(), buildTable(), tableFromGrid(), decodeText() (+11 more)
...
Cohesion: 0.1
Nodes (19): draftFromProfile(), emptyIdentityDraft(), blank, BOTH_ASSETS, card, draft, drawn, errors (+11 more)

### Community 190 - "Community 190"
Cohesion: 0.13
Nodes (17): acceptResidencyInvite(), AccountRow, askingAccount(), declineResidencyInvite(), findResidencyInvite(), LIVE, OPEN_INVOICES, ResidencyInvite (+9 more)
...
Cohesion: 0.15
Nodes (18): BookingError, assertSuperadmin(), Destination, loadTransfer(), loadTransferProof(), markTransferSent(), PayoutAccountRow, payoutBlock() (+10 more)
...
Cohesion: 0.11
Nodes (22): 5.1 Service Provider Registration, 5.2 Hostel Maintenance Module, 5.3 Hostel Comparison, 5.4 Referral System, 5.5 Duplicate / Ghost Listing Detection, 5.6 Reports, 5.7 Production Hardening, 5.8 QA Tasks (+14 more)

### Community 200 - "Community 200"
Cohesion: 0.13
Nodes (18): firstIncompleteProviderStep(), hasProviderErrors(), isProviderStepComplete(), PROVIDER_CATEGORIES, PROVIDER_STEPS, ProviderAttachment, ProviderCategory, providerCategoryLabel() (+10 more)

### Community 201 - "Community 201"
Cohesion: 0.13
Nodes (17): candidateFontDirs(), ensureIdCardFonts(), FONT_DIR_SEGMENTS, FONT_FILES, IdCardData, IdCardFace, PlatformIdCardType, CardImages (+9 more)

### Community 202 - "Community 202"
Cohesion: 0.16
Nodes (19): personalLookupHash(), LEGACY_ROLE_MAP, Role, ROLE_VALUES, ASSET_KINDS, cardPhotoImageUrl(), generateResidentId(), isCardPhotoImage() (+11 more)
...
Cohesion: 0.15
Nodes (19): BookingEnding, bookingFee(), BookingSettlement, cancellationSchedule(), cancelRefundPercent(), FULL_REFUND_ENDINGS, holdDayAt(), holdEndsAt() (+11 more)
...
Cohesion: 0.14
Nodes (17): downloadCaption(), DownloadRow, DownloadStack(), progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster() (+9 more)
...
Cohesion: 0.14
Nodes (15): activateResident(), login(), ResidentNightStatus, submitResidentReview(), RootStackParamList, LoginScreen(), Props, Props (+7 more)
...
Cohesion: 0.18
Nodes (18): accountDeletionRequestedEmail(), AccountDeletionError, applyImmediateEffects(), cancelAccountDeletionForUser(), cancelUrlFor(), DeletionPathway, DeletionRequestRecord, getAccountDeletionStatus() (+10 more)
...
Cohesion: 0.13
Nodes (18): buildIdCard(), CARD_NOUNS, CARD_VARIANTS, cardDate(), CardVariant, firstIncompleteIdentityStep(), hasIdentityErrors(), IDENTITY_STEP_FIELDS (+10 more)

### Community 221 - "Community 221"
Cohesion: 0.11
Nodes (16): body, decoder, EvidenceFields, EvidenceReference, EvidenceStage, FetchLike, lines, message (+8 more)
...
Cohesion: 0.18
Nodes (15): drawCertificationStamp(), footerLine(), formatDate(), formatLongDate(), MONTHS, ReceiptPdfInput, renderReceiptPdf(), renderStatementPdf() (+7 more)

### Community 225 - "Community 225"
Cohesion: 0.11
Nodes (15): DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), axisMonth(), monthLabel(), toNumber() (+7 more)

### Community 226 - "Community 226"
Cohesion: 0.12
Nodes (17): UploadStack(), cancelUpload(), canRetryUpload(), handles, isActive(), retryUpload(), UploadHandle, UploadItem (+9 more)
...
Cohesion: 0.17
Nodes (13): hostelToday(), teamWalletEntrySchema, fit_width(), Builds the launch-screen art: the logo lockup and the "Powered by" strip.  Run f, commissionFor(), creditTeamCommission(), getAgentWallet(), payoutSchema (+5 more)
...
Cohesion: 0.16
Nodes (13): monthlySeries(), countListingAppearances(), hostelListingImpressionSchema, moveOutChecklistSchema, compare(), countMoveOuts(), getHostelPerformanceReport(), LIVE_STATUSES (+5 more)
...
Cohesion: 0.16
Nodes (18): Attendance / Night Safety, code:typescript (interface INightStatusLog {), code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {), code:typescript (interface INotice {), code:typescript (interface IComplaint {), code:typescript (interface IComplaintUpdate {), code:typescript ({) (+10 more)
...
Cohesion: 0.12
Nodes (8): Footer(), IdCardFace(), initialsOf(), Portrait(), SIGNATURE_BOX, SignatureInk(), CARD_COLORS, IdCard

### Community 244 - "Community 244"
Cohesion: 0.12
Nodes (16): BLOOD_GROUPS, BloodGroup, DIETARY_PREFERENCES, DietaryPreference, EmailCheckStatus, Gender, GENDERS, GOVERNMENT_ID_TYPES (+8 more)

### Community 245 - "Community 245"
Cohesion: 0.13
Nodes (13): applicantSchema, billingCycleSchema, HostelRegistrationInput, hostelRegistrationSchema, registrationFields, RegistrationPlanChoice, registrationPlanChoiceSchema, TeamHostelRegistrationInput (+5 more)
...
Cohesion: 0.19
Nodes (12): geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), HostelGeoLocation, resolveHostelGeo(), fetchNearbyPlaces(), LocationSource (+4 more)
...
Cohesion: 0.15
Nodes (14): platformPushScheduleSchema, NotificationCampaignError, PushRepeat, AUDIENCE_ROLES, deliverPush(), PlatformPushAudience, PlatformPushInput, PushLogRecord (+6 more)
...
Cohesion: 0.13
Nodes (17): 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.3 Payment Proof Uploaded (to Admin), 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3.6 Plan billing (a hostel paying the platform) *(added 2026-09-15)*, 3. Payment Emails, 4.3 Complaint Resolved (+9 more)
...
Cohesion: 0.14
Nodes (17): 10.1 GitHub Actions Workflow, 7.1 Multi-Tenant Isolation Test Template, 7.2 Role Gate Test Template, 7.3 Privacy/Guardian Permissions Test Template, 7.5 Payment Precision Test Template, 7. Mandatory Test Templates, 9.1 Seed Scripts, 9.2 Test Database Isolation (+9 more)
...
Cohesion: 0.23
Nodes (17): AuditLog, code:typescript (interface IAuditLog {), code:typescript ({), code:typescript ({), code:typescript (interface IFoodReadyLog {), code:typescript ({), FoodReadyLog, Notification (+9 more)
...
Cohesion: 0.16
Nodes (16): 6.2 Service Provider Approved, 6.4 Service Provider Login Credentials Reissued (Planned for Phase 6), 6. Service Provider Emails, 7.1 Attendance Alert (Resident Absent), 7.1 New Hostel Pending Approval (to Superadmin), 7.2 Subscription Expiring Soon, 7. Attendance & Location Tracking Emails, 7. Platform Admin Emails (+8 more)
...
Cohesion: 0.25
Nodes (16): AttendanceAlert, AttendanceLog, code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({), code:typescript ({), code:typescript (interface IQuestionCallClick {) (+8 more)
...
Cohesion: 0.13
Nodes (13): haversineMeters(), KATHMANDU, distance, far, input, middle, near, oneDegree (+5 more)

### Community 280 - "Community 280"
Cohesion: 0.23
Nodes (12): hasLocationPermission(), hasPromptedForLocation(), LocationOutcome, NavigationFix, readPosition(), readPrecisePosition(), rememberLocationPrompt(), requestDeviceLocation() (+4 more)

### Community 281 - "Community 281"
Cohesion: 0.22
Nodes (13): deliver(), emailFacts(), hostelOrThrow(), notifyPlatformOfPayoutReview(), PayoutAccountStatus, PayoutAccountView, PayoutActor, PayoutRecord (+5 more)
...
Cohesion: 0.14
Nodes (15): 4.1 New Notice Posted, 4.2 Complaint Status Updated, 4. Resident Activity Emails, 5.1 SOS Triggered, 5. Safety & Emergency Emails, 6.1 Service Provider Registration Received, 6.3 Service Provider Rejected, 8.1 Community Post Engagement (Batched) (+7 more)
...
Cohesion: 0.18
Nodes (13): categoryLabel(), PROVIDER_CATEGORIES, ProviderCard(), ProviderDirectoryData, PublicProvider, PublicServiceProviderDirectoryPage(), DirectoryPageProps, EMPTY (+5 more)
...
Cohesion: 0.18
Nodes (11): cancelDownload(), canRetryDownload(), DownloadHandle, DownloadItem, DownloadStatus, DownloadStore, handles, isDownloadActive() (+3 more)
...
Cohesion: 0.14
Nodes (13): 10. Location Tracking Configuration Defaults, 11. Location Tracking Defaults, 1. Prerequisites, 3. Secrets Handling, 5. Development Commands, 7. Database Migrations (Mongoose), 9. Phase 6 (Mobile) Additional Setup, 9. QuestionCall Integration (Phase 5) (+5 more)
...
Cohesion: 0.14
Nodes (13): 0. Reading order, 12. Notifications, 2. The tier model, 5.1 Format, 5.2 Rules, 5.3 What to do when the resident forgets it, 5. The reference code, 8.1 Evidence hashing (+5 more)
...
Cohesion: 0.24
Nodes (14): AccountDeletionRequest, code:typescript ({), code:typescript (interface IAccountDeletionRequest {), code:block43 (packages/db/migrations/), code:typescript ({), code:typescript (interface IAccountDeletionRequest {), code:block46 (packages/db/migrations/), Consent & Privacy (+6 more)

### Community 310 - "Community 310"
Cohesion: 0.2
Nodes (14): code:typescript (interface IMoveInChecklistItem {), code:typescript (interface IMoveOutChecklistItem {), code:typescript (interface IServiceProvider {), code:typescript (interface IServiceProvider {), code:typescript (interface IMaintenanceRequest {), Complaint, ComplaintUpdate, Move-in / Move-out (+6 more)
...
Cohesion: 0.15
Nodes (11): claimConfirmed, hostelId, importId, invoiceId, mocks, orphanTierD, principal, residentId (+3 more)

### Community 319 - "Community 319"
Cohesion: 0.17
Nodes (11): AMOUNT_ALIASES, CREDIT_ALIASES, DATE_ALIASES, DEBIT_ALIASES, NAME_ALIASES, nonZero(), readMoney(), REMARKS_ALIASES (+3 more)
...
Cohesion: 0.18
Nodes (12): apiRequest(), confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), getResidentNightStatus(), listResidentComplaints(), refreshSession(), ResidentComplaint (+4 more)

### Community 332 - "Community 332"
Cohesion: 0.18
Nodes (9): AuthSession, getResidentProfile(), AppNavigator(), Stack, ResidentNightStatusScreen(), Profile, Props, ResidentProfileScreen() (+1 more)
...
Cohesion: 0.21
Nodes (10): Offset, PhotoCropper(), formatBytes(), AttachedFile(), FileUploaderPresentation, FileUploaderProps, FileUploaderView(), previewSrc() (+2 more)
...
Cohesion: 0.24
Nodes (9): createPlatformAdmin(), CreatePlatformAdminInput, generateTemporaryPassword(), loginUrl(), PlatformAdminRole, PlatformAdminServiceError, roleLabel(), serialize() (+1 more)
...
Cohesion: 0.31
Nodes (10): CARD_LABELS, formatIssuedOn(), readPhotoBytes(), readQrBytes(), readSignatureBytes(), sendIdCardEmail(), getResidentIdentity(), getResidentIdentityQr() (+2 more)
...
Cohesion: 0.25
Nodes (8): liveUserIds(), notifyRateCardChanged(), ratesByRoomType(), ashaId, binodId, hostelId, mocks, notify()

### Community 371 - "Community 371"
Cohesion: 0.24
Nodes (8): filterNotices(), groupNoticesByDay(), noticeCategories(), NoticeDay, NoticeStatus, days, read, rows
...
Cohesion: 0.33
Nodes (8): cellWidth(), clampedFontScale(), columnsThatFit(), PhoneSize, phoneSizeFor(), scaledHeight(), cell, HANDSET_WIDTHS
...
Cohesion: 0.22
Nodes (6): hostelNameKey(), hostelId, mocks, PHONE_ONLY, refused, userId
...
Cohesion: 0.22
Nodes (5): hostelId, memberId, mocks, otherHostelId, userId
...
Cohesion: 0.29
Nodes (8): 2.1 Hostel Submission Received, 2.2 Hostel Approved, 2.3 Hostel Rejected, 2.4 Inquiry Received (to Hostel Admin), 2. Hostel Management Emails, code:typescript ({), code:typescript ({), code:block14 (---)
...
Cohesion: 0.43
Nodes (6): configuredLevel(), levelPriority, LogLevel, normalizeMeta(), shouldLog(), write()
...
## Knowledge Gaps
- **6511 isolated node(s):** `iosUrlScheme`, `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }` (+6506 more)
...
- **Why does `cn()` connect `Community 42` to `Community 1`, `Community 2`, `Community 131`, `Community 9`, `Community 10`, `Community 268`, `Community 13`, `Community 12`, `Community 16`, `Community 18`, `Community 29`, `Community 34`, `Community 36`, `Community 37`, `Community 38`, `Community 41`, `Community 43`, `Community 44`, `Community 48`, `Community 49`, `Community 54`, `Community 56`, `Community 57`, `Community 69`, `Community 72`, `Community 330`, `Community 78`, `Community 207`, `Community 349`, `Community 97`, `Community 101`, `Community 115`, `Community 116`, `Community 121`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 13`, `Community 141`, `Community 16`, `Community 24`, `Community 25`, `Community 32`, `Community 33`, `Community 37`, `Community 38`, `Community 39`, `Community 42`, `Community 44`, `Community 48`, `Community 49`, `Community 53`, `Community 69`, `Community 71`, `Community 72`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 14` to `Community 128`, `Community 129`, `Community 4`, `Community 7`, `Community 136`, `Community 10`, `Community 11`, `Community 12`, `Community 15`, `Community 144`, `Community 17`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 281`, `Community 26`, `Community 27`, `Community 156`, `Community 153`, `Community 30`, `Community 31`, `Community 35`, `Community 40`, `Community 46`, `Community 47`, `Community 175`, `Community 50`, `Community 51`, `Community 52`, `Community 55`, `Community 58`, `Community 59`, `Community 60`, `Community 445`, `Community 62`, `Community 63`, `Community 64`, `Community 65`, `Community 193`, `Community 190`, `Community 68`, `Community 66`, `Community 73`, `Community 202`, `Community 75`, `Community 77`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 85`, `Community 87`, `Community 88`, `Community 89`, `Community 216`, `Community 91`, `Community 92`, `Community 93`, `Community 99`, `Community 100`, `Community 104`, `Community 233`, `Community 361`, `Community 235`, `Community 108`, `Community 236`, `Community 107`, `Community 111`, `Community 114`, `Community 117`, `Community 247`, `Community 252`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Are the 524 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 524 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `iosUrlScheme`, `{ defineConfig }`, `expoConfig` to the rest of the system?**
  _6511 weakly-connected nodes found - possible documentation gaps or missing edges._