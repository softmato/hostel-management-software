...
## Corpus Check
- 1585 files · ~2,576,332 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12519 nodes · 33967 edges · 447 communities (428 shown, 19 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 515 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3cb9f92c`
...
## Communities (447 total, 19 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (254): ReferralRow(), CheckoutStatusScreen(), FinanceData, loadFinance(), isProvider(), ManageGatewayScreen(), ActivationIssue, addEmergencyContact() (+246 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (164): PATCH(), POST(), RouteContext, GET(), POST(), POST(), POST(), POST() (+156 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (154): Scanner(), FaqRow(), MethodCard(), GuardianInviteScreen(), Choice, Compass(), MapButton(), MapScreen() (+146 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (104): FILTERS, Pending, APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), ComplaintDetail(), ComplaintCard() (+96 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (161): DeletionPanel(), NotificationSettings(), SETTINGS_TITLES, THEME_OPTIONS, SosInput, SosPhase, BLOOD_OPTIONS, DIET_OPTIONS (+153 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (149): AdminAlertsScreen(), ICONS, LABELS, Segment, TONES, AdminHomeScreen(), AdminOverviewScreen(), loadOverview() (+141 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (166): sitemap(), STATIC_ROUTES, geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), listHostelAdminInquiries(), addHostelAdminProfilePhoto() (+158 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (138): POST(), attacker, attempt(), headers, jsonRequest(), routeMocks, appBaseUrl(), authenticateWithGoogle() (+130 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (146): NightStatusForm(), NotificationCard(), AlertCard(), PaymentMonthStrip(), CreditRow(), ManageStatementScreen(), METHOD_ICONS, methodIcon() (+138 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (100): HostelTable(), LoadState, UserRecord, GuardianSafetyPageContent, FeeSchedule, HostelAdminFeeSchedulePageContent, Rate, MonthRow() (+92 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (124): AdminMoreScreen(), MANAGE_ROWS, PORTAL_ROWS, ActivateScreen(), BootGate(), RootShell(), ApplyBlock(), CallableRow() (+116 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (131): auditFinanceAction(), FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment() (+123 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (90): GET(), PATCH(), RouteContext, listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), POST() (+82 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (98): HostelSuggestions(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS (+90 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (89): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CommunityModerationPanel(), Filter, ModeratedPost, ModerationPayload (+81 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (105): GET(), POST(), querySchema, RouteContext, authorUserId, mocks, postId, residentId (+97 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (74): ComparePage(), hostels, metadata, rows, AuthExperiencePage(), HostelAdminDashboardPageContent(), HostelAdminInquiriesPageContent(), HostelAdminProfilePageContent() (+66 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (94): POST(), RouteContext, DELETE(), GET(), hostelId(), GET(), POST(), DELETE() (+86 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (101): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, dayKey(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus() (+93 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (82): EMPTY_SUMMARY, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine, formatWeekRange() (+74 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (78): GET(), POST(), POST(), GET(), POST(), getCurrentUser(), POST(), POST() (+70 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (86): Overview, FILTERS, NotificationsScreen(), HOSTEL, MONTHS, UiPreview(), ACTION_TONES, AdminHomeHeader() (+78 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (75): GET(), POST(), adminPrincipal, mocks, PLATFORM_LIMITS, cook, createUser(), createUserDoc() (+67 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (102): deleteResidentLocationHistory(), getResidentAttendance(), addComplaintUpdate(), attachFiles(), auditComplaintAction(), ComplaintAttachmentRecord, ComplaintCategory, complaintChildren() (+94 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (97): AdminCommunityReportsScreen(), NightStatusScreen(), ReferralsScreen(), SavedHostelsScreen(), SORTS, StoreCategoryScreen(), CommunityPostScreen(), ComplaintDetailScreen() (+89 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (71): AuthShell(), AuthShellProps, SiteWordmark(), metadata, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon() (+63 more)
...
Cohesion: 0.05
Nodes (74): AdminCommunityScreen(), CommunityScreen(), Composer(), ReportedPostCard(), useReportedCount(), CommunityBoard(), CommunityBoardProps, Composer() (+66 more)
...
Cohesion: 0.04
Nodes (88): BALANCE_ALIASES, BANK_CSV_PARSER, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, nonZero(), TXN_ID_ALIASES (+80 more)
...
Cohesion: 0.04
Nodes (73): AttachmentGallery(), DAY_LABELS, DayStrip(), FoodRoutineWeek(), MEAL_ICONS, MealCard(), MonthEndSpecial(), RoutineMeal (+65 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (60): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, daysFromNow(), enabledPermissionLabels(), GuardianAccessRecord, GuardianInvitationAcceptInput (+52 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (54): AccountDeletionPanel, DeletionPathway, DeletionStatus, PATHWAY_COPY, csvField(), deferLoad(), DemoDataBadge(), field() (+46 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (70): demoteToPublicAccount(), CapacityError, claimBedForRoomType(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary(), releaseBedForRoomType() (+62 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (60): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, normalize(), PortalSearch(), PortalTone, scoreEntry(), toneStyles, iconMap (+52 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (59): Notification, MonthPicker, PeriodRow, HostelAdminResidentsPage, humanizeValue(), ImportedProfileSummary(), ResidentPrefill, ResidentStatus (+51 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (67): POST(), dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, isMonthEnd(), mealsOn() (+59 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (56): cityOptions, createDocument(), createRoom(), DocumentConfig, DraftData, FACILITY_MINI, facilityOptions, FIELD_KEY_STEP (+48 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (69): BillableResidentRow, BilledInvoice, BillingCycleInput, BillingCycleResult, BillingFailure, BillingPeriodSummary, BillingPlan, BillingSkip (+61 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (70): publicHostelApplicationCreateSchema, documents, hostelForm(), many, parsed, result, buildHostelPayload(), capacitySummary() (+62 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (48): MetricCard(), SectionCard(), CheckoutStatus, ResidentCheckoutPageContent, APP_METHODS, METHODS, PayInstructions, Rejection (+40 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (59): CommunityReportDialog(), REASONS, ModerationButton(), PagerButton(), ReferenceCheck(), CodeChip(), CopyButton(), PublicHostelListingPage() (+51 more)

### Community 43 - "Community 43"
Cohesion: 0.15
Nodes (42): PublicPricingPage(), GenericPortalScreen(), portalRows(), portalTitle(), PublicHostelDetailPage(), PublicInquiryPage(), AnimatedPage(), AuthMode (+34 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (54): robots(), buildFormPostHandoff(), FormPostHandoff, HandoffError, IntentRecord, formPostIntent, hostelId, intentId (+46 more)
...
Cohesion: 0.05
Nodes (50): addHistory(), addMaintenanceComment(), assertBedInHostel(), assertProviderApproved(), assertRoomInHostel(), auditMaintenanceAction(), BedRecord, createMaintenanceRequest() (+42 more)
...
Cohesion: 0.05
Nodes (50): downloadCaption(), DownloadRow, DownloadStack(), progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster() (+42 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (51): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), MediaViewerProvider() (+43 more)

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (49): GATEWAY_ORDER, getPayInstructions(), InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice(), assertQrAssetUsable() (+41 more)
...
Cohesion: 0.06
Nodes (52): IdCardData, IdCardFace, PlatformIdCardType, CardImages, renderIdCardPng(), BASE, PNG_MAGIC, types (+44 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (51): defaultDueDate(), DeliveryWindowFields(), number(), text(), budgetLabel(), numberValue(), monthLabel(), toNumber() (+43 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (46): assertHostelAccess(), canAccessHostel(), hostelScopedFilter(), TenantAccessError, TenantPrincipal, referralSchema, referralCodeSchema, referralRewardSchema (+38 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (34): HostelPhotoReminder(), inferKind(), MediaLightbox(), CATEGORY_LABELS, NEARBY_GROUPS, PublicReview, PublicReviewData, RoomCard (+26 more)
...
Cohesion: 0.05
Nodes (40): complaintCategorySchema, complaintCreateSchema, complaintListQuerySchema, complaintReplySchema, complaintResolutionConfirmSchema, complaintStatusSchema, complaintStatusUpdateSchema, objectIdSchema (+32 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (43): GatewayHealth, GatewayHealthSummary, getGatewayHealth(), IntentCounts, plural(), recordHealth(), runGatewayHealth(), runGatewayHealthForHostel() (+35 more)

### Community 59 - "Community 59"
Cohesion: 0.07
Nodes (49): assertAmountWithinBounds(), assertClaimAssetUsable(), assertEvidenceNotAlreadyClaimed(), assertRejectedCodeNotRetriedForever(), assertTransactionCodeNotReused(), describePriorClaim(), directionFlags(), documentFlags() (+41 more)

### Community 60 - "Community 60"
Cohesion: 0.07
Nodes (48): arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal, alreadyReviewedError() (+40 more)

### Community 61 - "Community 61"
Cohesion: 0.07
Nodes (28): SosScreen(), TABS, AdminSearchBar(), ViewerBody(), BottomChrome, BottomChromeContext, BottomChromeProvider(), CHROME_TIMING (+20 more)

### Community 62 - "Community 62"
Cohesion: 0.05
Nodes (34): HostelAdminCommunityPageContent, HostelAdminComplaintsPage, HostelAdminInquiriesPageContent, HostelAdminMaintenancePageContent, HostelAdminMoveChecklistPage, HostelAdminNightStatusPage, HostelAdminNotificationsPageContent, GatewayConfig (+26 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (40): getHostelLedger(), getInvoiceMatrix(), getResidentFinanceView(), HostelLedger, HostelLedgerEntry, InvoiceMatrix, InvoiceMatrixRow, listResidentClaims() (+32 more)

### Community 64 - "Community 64"
Cohesion: 0.06
Nodes (40): GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse, GoogleAuthUser, GoogleCredentialResponse, Window, dashboardHrefForRole(), isAuthBypassEnabled() (+32 more)

### Community 65 - "Community 65"
Cohesion: 0.06
Nodes (38): cookPrincipal, mocks, cookEmailForSlug(), CookFoodPhotoRecord, CookPortalUpdateInput, CookServiceError, FoodPhotoUploadInput, FoodReadyInput (+30 more)
...
Cohesion: 0.05
Nodes (33): accessId, adminPrincipal, codes, guardianId, guardianPrincipal, issue(), leanResult(), mocks (+25 more)

### Community 69 - "Community 69"
Cohesion: 0.07
Nodes (40): Offset, PhotoCropper(), FileUploadArea(), isActive(), EXTENSION_BY_MIME, FAMILY_BYTES, FAMILY_ORDER, familyOf() (+32 more)
...
Cohesion: 0.06
Nodes (33): accountDeletionRequestSchema, attendanceLogSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, consentLogSchema, sessionSchema, AccountDeletionError (+25 more)

### Community 72 - "Community 72"
Cohesion: 0.06
Nodes (37): AuthGuard(), CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing (+29 more)
...
Cohesion: 0.07
Nodes (19): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminResidentsPage(), redirectToWorkspaceScreen(), HostelAdminReferralsPageContent(), HostelAdminReportsPageContent() (+11 more)
...
Cohesion: 0.07
Nodes (35): notificationCampaignSchema, CampaignListQuery, CampaignRecord, createCampaign(), createHostelNotificationCampaign(), createPlatformNotificationCampaign(), dispatchCampaign(), dispatchDueCampaigns() (+27 more)
...
Cohesion: 0.06
Nodes (26): currency(), LoadingRows(), StatusBadge(), ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent, Complaint (+18 more)
...
Cohesion: 0.07
Nodes (28): summarizeResidentComplaints(), bedSchema, roomSchema, invoiceRow(), objectId(), paymentProofRecord(), paymentRecord(), receiptRecord() (+20 more)

### Community 83 - "Community 83"
Cohesion: 0.06
Nodes (25): emergencyContactSchema, incidentLogSchema, manualStatusOverrideSchema, nightStatusSchema, nightStatusLogSchema, residentSchema, sosAlertSchema, EmergencyContactRecord (+17 more)
...
Cohesion: 0.11
Nodes (30): Resolver, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity(), fromHeaderFor() (+22 more)

### Community 89 - "Community 89"
Cohesion: 0.09
Nodes (26): PaginationMeta, PaginationQuery, noticeReadStatusSchema, mocks, noticeInput, residentUserId, staffPrincipal, auditNoticeAction() (+18 more)
...
Cohesion: 0.07
Nodes (21): Input(), TextArea(), field(), HostelAdminMaintenancePageContent(), HostelAdminServiceProvidersPageContent(), ListingFlag, LoadState, MaintenanceRequest (+13 more)
...
Cohesion: 0.09
Nodes (25): getAttendanceConfig(), getAttendanceSettings(), listHostelAttendance(), recordConsent(), resolveAdminHostelId(), updateAttendanceSettings(), attendanceAlertResolveSchema, attendanceListQuerySchema (+17 more)
...
Cohesion: 0.12
Nodes (25): r2Configured(), storePublicAsset(), AccessLevel, bucketForAccessLevel(), deleteFromR2(), generateFileKey(), getPresignedReadUrl(), getPresignedUploadUrl() (+17 more)

### Community 97 - "Community 97"
Cohesion: 0.07
Nodes (21): LegacyHostelAdminComplaintsPage(), Complaint, ComplaintSummary, field(), FoodMenu, HostelAdminComplaintsPage(), HostelAdminFoodPage(), HostelAdminNoticesPage() (+13 more)
...
Cohesion: 0.08
Nodes (24): ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery, AttendanceLogRecord, AttendanceOverrideInput, AttendanceServiceError, AttendanceSettingsInput (+16 more)

### Community 101 - "Community 101"
Cohesion: 0.09
Nodes (24): AvailableRoomType, RoomMapFloor, Claim, FinanceView, Invoice, OPEN_STATUSES, Receipt, ResidentOfferProgramPageContent (+16 more)

### Community 102 - "Community 102"
Cohesion: 0.11
Nodes (25): HostelServiceError, hashUserAgent(), HostelRef, newVisitorKey(), recordHostelPageView(), resolveVisitorKey(), evaluateProfilePrompt(), auditWardenAction() (+17 more)
...
Cohesion: 0.09
Nodes (27): findOrphanClaims(), loadMatchContext(), ApprovedNotInStatementRow, approveMatchedRows(), approverNamesFor(), askResidentAboutClaim(), assignOrphanCredit(), ClaimedNoTransactionRow (+19 more)
...
Cohesion: 0.08
Nodes (20): buildIdCardData(), Field(), FIELD_LABELS, formatCardDate(), IdCardPanel(), identityPhotoUrl(), IdentityResponse, Modal() (+12 more)
...
Cohesion: 0.12
Nodes (18): addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery, HostelAdminInquiryStatusInput, InquiryNoteCreateInput, InquiryNoteRecord, InquiryRecord (+10 more)
...
Cohesion: 0.18
Nodes (17): ProviderJobScreen(), ProviderJob, CATEGORY_ICONS, completedJobCount(), isOpenJob(), jobActions(), jobAddress(), jobCategoryIcon() (+9 more)
...
Cohesion: 0.11
Nodes (18): feeUpdateSchema, PATCH(), setResidentMonthlyFee(), POST(), GET(), generateMonthlyPayments(), setResidentMonthlyFee(), monthlyPaymentGenerateSchema (+10 more)
...
Cohesion: 0.1
Nodes (15): csvField(), field(), Hostel, Inquiry, LoadState, numberField(), optionalField(), ReportRecord (+7 more)
...
Cohesion: 0.18
Nodes (18): downloadAndShare(), downloadAndShareCsv(), downloadAndShareImage(), downloadToDevice(), forgetDownloadFolder(), LegacyFileSystem, loadLegacyFileSystem(), resolveDownloadFolder() (+10 more)
...
Cohesion: 0.12
Nodes (13): storeCategorySchema, storeProductSchema, categoriesFor(), escapeRegex(), getStoreProduct(), getStoreShelves(), ListQuery, SORTS (+5 more)
...
Cohesion: 0.14
Nodes (15): activateResident(), apiRequest(), confirmComplaintResolution(), createResidentComplaint(), getActivationStatus(), listResidentComplaints(), refreshSession(), register() (+7 more)
...
Cohesion: 0.15
Nodes (12): getResidentProfile(), requestOtp(), signInWithGoogle(), Props, ResidentActivationScreen(), styles, Profile, Props (+4 more)
...
Cohesion: 0.16
Nodes (15): 4.2 Complaint Status Updated, 6.1 Service Provider Registration Received, 6.3 Service Provider Rejected, 6. Service Provider Emails, 7.1 New Hostel Pending Approval (to Superadmin), 7.2 Subscription Expiring Soon, 7. Platform Admin Emails, 8.1 Community Post Engagement (Batched) (+7 more)
...
Cohesion: 0.24
Nodes (11): NearbyStatus, Coordinates, isUsableCoordinate(), hasLocationPermission(), hasPromptedForLocation(), LocationOutcome, readPosition(), rememberLocationPrompt() (+3 more)
...
Cohesion: 0.18
Nodes (11): POST(), acceptGuardianInvitation(), DEFAULT_GUARDIAN_PERMISSIONS, guardianAccessCreateSchema, guardianInvitationAcceptSchema, guardianInviteSchema, guardianLoginSchema, guardianPermissionsSchema (+3 more)
...
Cohesion: 0.18
Nodes (11): 3.3 Payment Proof Uploaded (to Admin), 4.1 New Notice Posted, 4.3 Complaint Resolved, 4. Resident Activity Emails, 5.1 SOS Triggered, 5. Safety & Emergency Emails, code:typescript ({), code:typescript ({) (+3 more)
...
## Knowledge Gaps
- **4456 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+4451 more)
...
- **Why does `Button()` connect `Community 3` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 8`, `Community 9`, `Community 10`, `Community 14`, `Community 143`, `Community 19`, `Community 24`, `Community 25`, `Community 27`, `Community 31`, `Community 33`, `Community 35`, `Community 36`, `Community 40`, `Community 41`, `Community 42`, `Community 61`, `Community 74`?**
  _High betweenness centrality (0.089) - this node is a cross-community bridge._
- **Why does `number()` connect `Community 53` to `Community 0`, `Community 1`, `Community 4`, `Community 7`, `Community 8`, `Community 136`, `Community 11`, `Community 13`, `Community 14`, `Community 271`, `Community 146`, `Community 19`, `Community 21`, `Community 26`, `Community 28`, `Community 29`, `Community 30`, `Community 33`, `Community 38`, `Community 40`, `Community 47`, `Community 48`, `Community 56`, `Community 184`, `Community 69`, `Community 72`, `Community 74`, `Community 76`, `Community 93`, `Community 95`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 42` to `Community 2`, `Community 3`, `Community 5`, `Community 9`, `Community 10`, `Community 13`, `Community 14`, `Community 16`, `Community 19`, `Community 21`, `Community 25`, `Community 153`, `Community 28`, `Community 35`, `Community 36`, `Community 38`, `Community 41`, `Community 43`, `Community 48`, `Community 55`, `Community 69`, `Community 70`, `Community 72`, `Community 79`, `Community 80`, `Community 97`, `Community 230`, `Community 110`, `Community 116`, `Community 251`?**
