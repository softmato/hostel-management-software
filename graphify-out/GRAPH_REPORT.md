...
## Corpus Check
- 1039 files · ~1,857,781 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8359 nodes · 20820 edges · 373 communities (354 shown, 19 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 367 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 482 edges
2. `successResponse()` - 471 edges
3. `connectToDatabase()` - 313 edges
4. `cn()` - 223 edges
5. `connectToDatabase()` - 207 edges
6. `requireHostelCapability()` - 154 edges
7. `requireHostelStaffPrincipal()` - 116 edges
8. `browserApi()` - 112 edges
9. `requireResidentPrincipal()` - 85 edges
10. `usePortalResource()` - 85 edges
...
## Communities (373 total, 19 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (168): addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery, HostelAdminInquiryStatusInput, InquiryNoteCreateInput, InquiryNoteRecord, InquiryRecord (+160 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (103): GET(), POST(), querySchema, RouteContext, authorUserId, mocks, postId, residentId (+95 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (109): POST(), notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus(), OPEN_STATUSES, OverdueComplaint, runComplaintSlaCheck(), createExpertConsultationRequest() (+101 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (81): PRIORITIES, STATUS_ACTIONS, Campaign, Resident, AttendanceAnalytics, FoodAnalytics, HostelAdminAttendanceAnalyticsPanel, HostelAdminFoodAnalyticsPanel (+73 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (72): DeletionPathway, DeletionStatus, PATHWAY_COPY, CommunityPageContent(), csvField(), deferLoad(), DemoDataBadge(), field() (+64 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (82): PATCH(), POST(), RouteContext, GET(), POST(), POST(), POST(), POST() (+74 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (93): deleteResidentLocationHistory(), getResidentAttendance(), listResidentComplaints(), getCreditAmount(), getInvoiceMatrix(), getResidentFinanceView(), InvoiceMatrix, InvoiceMatrixRow (+85 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (65): POST(), attendanceAlertResolveSchema, attendanceListQuerySchema, attendanceSettingsSchema, consentSchema, locationPingSchema, objectIdSchema, POST() (+57 more)

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (67): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), verificationEmail(), POST(), guardianInvitationEmail(), sosAlertEmail() (+59 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (57): Filter, ModeratedPost, ModerationPayload, FeeSchedule, HostelAdminFeeSchedulePageContent, Rate, HostelAdminTransactionsPageContent, Payment (+49 more)

### Community 10 - "Community 10"
Cohesion: 0.05
Nodes (67): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CancelDeletionPageContent(), CommunityModerationPanel(), useConfirm(), field() (+59 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (61): GenericPortalScreen(), portalRows(), portalTitle(), CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS, MOCK_HOSTELS, MockHostel (+53 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (70): CommunityReportDialog(), REASONS, ConfirmOptions, Resolver, ModerationButton(), PagerButton(), PublicHostelListingPage(), SiteAnnouncementBanner() (+62 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (56): PATCH(), POST(), RouteContext, PATCH(), RouteContext, POST(), RouteContext, RouteContext (+48 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (62): listResidentInvoices(), auditGuardianAction(), createGuardianAccess(), expiresInDays(), findAdminResident(), getGuardianDashboard(), getGuardianSafetySummary(), GuardianAccessCreateInput (+54 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (66): listPlatformHostels(), PaginationMeta, PaginationQuery, paginationRange(), querySchema, noticeReadStatusSchema, notificationCampaignSchema, ratingReviewSchema (+58 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (57): adminPrincipal, mocks, PLATFORM_LIMITS, assetId, hostelId, mocks, otherHostelId, principal (+49 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (59): HostelSuggestions(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS (+51 more)

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (56): GuardianDashboard, Review, CreateWardenResult, PERMISSION_LABELS, PlatformFeePlansPageContent, avatarToneClasses, BreadcrumbItem, DataTable() (+48 more)
...
Cohesion: 0.05
Nodes (71): collectionTotals(), countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), invoicesByIds(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor() (+63 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (58): Notification, humanizeValue(), ImportedProfileSummary(), ResidentPrefill, ResidentStatus, STATUS_ACTIONS, FILTERS, Notification (+50 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (65): announceFoodReady(), cookEmailForSlug(), CookPortalUpdateInput, CookServiceError, FoodReadyInput, generatePassword(), getCookPortalSettings(), HostelSettingsRecord (+57 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (46): RouteContext, POST(), GET(), createPublicHostelInquiry(), listHostelAdminInquiries(), listHostelAdminRooms(), scopedHostelFilter(), hostelRejectSchema (+38 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (55): HostelAdminCommunityPageContent, EMPTY_SUMMARY, HostelAdminComplaintsPage, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS (+47 more)
...
Cohesion: 0.06
Nodes (53): GET(), GET(), serviceProviderApplicationSchema, serviceProviderDocumentSchema, PATCH(), DirectoryPageProps, EMPTY, metadata (+45 more)
...
Cohesion: 0.06
Nodes (40): GET(), listPlatformAuditLogs(), PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), GET(), GET(), hostelRequestDocumentsSchema (+32 more)
...
Cohesion: 0.05
Nodes (43): AuditLogRecord, PlatformAuditLogQuery, RefRecord, listTrendingTags(), CachedConnection, globalForMongoose, auditListingFlagAction(), DuplicateCheckResultRecord (+35 more)
...
Cohesion: 0.06
Nodes (26): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminResidentsPage(), redirectToWorkspaceScreen(), HostelAdminMaintenancePageContent() (+18 more)
...
Cohesion: 0.06
Nodes (35): GET(), POST(), GET(), GET(), POST(), getMyExpertConsultationRequest(), GET(), POST() (+27 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (37): financeIntegrityHash(), findingSchema, reconciliationRunSchema, currentParserFor(), resolveParser(), checkAuditChain(), checkCreditBalances(), DRIFT_CODES (+29 more)
...
Cohesion: 0.06
Nodes (32): attendanceOverrideSchema, complaintCategorySchema, complaintCreateSchema, complaintListQuerySchema, complaintReplySchema, complaintResolutionConfirmSchema, complaintStatusSchema, complaintStatusUpdateSchema (+24 more)
...
Cohesion: 0.06
Nodes (26): LegalBody(), buildValues(), PublicAboutPage(), values, buildPosts(), posts, PublicBlogPage(), buildContactMethods() (+18 more)
...
Cohesion: 0.09
Nodes (41): demoteToPublicAccount(), assertActiveReferralCode(), findActiveReferralCode(), linkReferralOnRegistration(), addEmergencyContact(), addGuardian(), auditResidentAction(), BedRecord (+33 more)
...
Cohesion: 0.07
Nodes (31): auditFinanceAction(), FinanceAuditInput, previousEntryHash(), base, entityId, hostelId, mocks, principal (+23 more)
...
Cohesion: 0.08
Nodes (27): referralSchema, referralCodeSchema, referralRewardSchema, auditReferralAction(), confirmReferralJoined(), createReferredInquiry(), getResidentReferral(), HostelAdminReferralListQuery (+19 more)

### Community 60 - "Community 60"
Cohesion: 0.12
Nodes (24): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), distance, ImageVariantRecord, optimizeImage() (+16 more)

### Community 61 - "Community 61"
Cohesion: 0.07
Nodes (21): LoadingRows(), Select(), field(), HostelAdminReferralsPageContent(), HostelAdminServiceProvidersPageContent(), ListingFlag, LoadState, MaintenanceRequest (+13 more)

### Community 62 - "Community 62"
Cohesion: 0.11
Nodes (31): GATEWAY_ORDER, getPayInstructions(), InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice(), assertQrAssetUsable() (+23 more)
...
Cohesion: 0.2
Nodes (20): POST(), authenticateWithGoogle(), AuthServiceError, logout(), POST(), accessTokenTtlSeconds(), parseDurationSeconds(), refreshTokenTtlSeconds() (+12 more)
...
Cohesion: 0.1
Nodes (24): GET(), POST(), DELETE(), requireSuperadminPrincipal(), GET(), PUT(), updateSiteConfigSection(), PUT() (+16 more)
...
Cohesion: 0.13
Nodes (26): changePassword(), getCurrentUser(), issueSessionForUser(), login(), publicUser(), refreshAccessToken(), POST(), AuthTokenPayload (+18 more)
...
Cohesion: 0.11
Nodes (22): issueReceiptForEvent(), IssueReceiptInput, nextReceiptNumber(), periodOfDate(), renderReceiptById(), renderStatementForResident(), voidReceipt(), eventId (+14 more)
...
Cohesion: 0.09
Nodes (18): inferKind(), LightboxItem, MediaLightbox(), CATEGORY_LABELS, NEARBY_GROUPS, PublicReview, PublicReviewData, RoomCard (+10 more)
...
Cohesion: 0.09
Nodes (23): platformSettingSchema, coerceSection(), getSiteConfig(), PlatformSettingRecord, SiteConfigServiceError, announcementSchema, facilitiesSchema, featuresSchema (+15 more)
...
Cohesion: 0.1
Nodes (22): findOrphanClaims(), loadMatchContext(), statementImportSchema, approveMatchedRows(), ClaimedNoTransactionRow, getReconciliation(), MatchedRow, namesFor() (+14 more)
...
Cohesion: 0.14
Nodes (21): AvailableRoomType, Resident, RoomMapFloor, ResidentEmergencyContact, ResidentGuardian, useAvailableRoomTypes(), useHostelWardens(), useResidentContacts() (+13 more)
...
Cohesion: 0.12
Nodes (14): ENDPOINTS, esewaProvider, SIGNED_FIELDS, GatewayCredentials, GatewayProvider, GatewayProviderName, IntentHandoff, PaymentIntent (+6 more)

### Community 96 - "Community 96"
Cohesion: 0.14
Nodes (18): DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList(), positiveInteger(), validateFileAssetMetadata(), getPresignedReadUrl(), getPresignedUploadUrl() (+10 more)
...
Cohesion: 0.14
Nodes (14): activateResident(), AuthSession, triggerSOS(), verifyOtp(), AppNavigator(), RootStackParamList, Stack, OtpVerificationScreen() (+6 more)
...
Cohesion: 0.14
Nodes (17): Offset, PhotoCropper(), UploadKind, AttachedFile(), FileUploader(), FileUploaderPresentation, FileUploaderProps, FileUploaderView() (+9 more)

### Community 128 - "Community 128"
Cohesion: 0.14
Nodes (17): EmailAttachment, fromAddress(), sendEmail(), SendEmailInput, SendEmailResult, activeSuperadminCount(), createPlatformAdmin(), CreatePlatformAdminInput (+9 more)
...
Cohesion: 0.15
Nodes (16): ApiFailure, ApiSuccess, AuthUser, getResidentNightStatus(), listNotifications(), markNotificationRead(), NotificationItem, ResidentFoodRoutine (+8 more)

### Community 132 - "Community 132"
Cohesion: 0.18
Nodes (16): CheckoutStatus, closeIntent(), createPaymentIntent(), expireStaleIntents(), getCheckoutStatus(), handleProviderCallback(), IntentRecord, markSucceeded() (+8 more)
...
Cohesion: 0.17
Nodes (14): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, HostelPhotoReminder(), FALLBACK_ORDER, hasNoHostelPhotos(), HostelPhoto, HostelPhotoKind, photosOfKind() (+6 more)
...
Cohesion: 0.22
Nodes (13): generateMetadata(), RootLayout(), FALLBACK, SiteConfigContext, SiteConfigProvider(), useFeatureFlag(), loadSiteConfig, loadSiteName() (+5 more)
...
Cohesion: 0.12
Nodes (13): close, closed, eventId, hostelId, intent, intentId, invoice, invoiceId (+5 more)

### Community 154 - "Community 154"
Cohesion: 0.12
Nodes (15): Account deletion purge, Attendance maintenance (absence alerts + retention purge), Authentication, Complaint SLA breach check, cron-job.org setup (per job), CRON.md — Scheduled Jobs, Dispatch scheduled notifications, Endpoints (+7 more)
...
Cohesion: 0.16
Nodes (11): getResidentProfile(), login(), submitResidentReview(), LoginScreen(), Props, Profile, Props, ResidentProfileScreen() (+3 more)
...
Cohesion: 0.14
Nodes (12): [0.5.0] - 2026-07-23 — Phase 3: Resident system (gap completion), Added, Added, Added, Changed, Changed, Changed, Changed (+4 more)
...
## Knowledge Gaps
- **3187 isolated node(s):** `AuthUser`, `ResidentSummary`, `ResidentFoodRoutine`, `ApiSuccess`, `ApiFailure` (+3182 more)
...
- **Why does `Role` connect `Community 16` to `Community 0`, `Community 1`, `Community 2`, `Community 128`, `Community 4`, `Community 133`, `Community 8`, `Community 265`, `Community 11`, `Community 139`, `Community 13`, `Community 14`, `Community 15`, `Community 22`, `Community 152`, `Community 153`, `Community 28`, `Community 31`, `Community 33`, `Community 35`, `Community 36`, `Community 38`, `Community 168`, `Community 41`, `Community 43`, `Community 44`, `Community 47`, `Community 175`, `Community 49`, `Community 53`, `Community 56`, `Community 185`, `Community 187`, `Community 195`, `Community 68`, `Community 69`, `Community 70`, `Community 71`, `Community 76`, `Community 210`, `Community 211`, `Community 86`, `Community 92`, `Community 96`, `Community 225`, `Community 116`, `Community 118`, `Community 247`, `Community 249`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `browserApi()` connect `Community 10` to `Community 3`, `Community 4`, `Community 136`, `Community 9`, `Community 264`, `Community 11`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 24`, `Community 33`, `Community 37`, `Community 174`, `Community 51`, `Community 52`, `Community 55`, `Community 61`, `Community 64`, `Community 73`, `Community 77`, `Community 81`, `Community 209`, `Community 88`, `Community 93`, `Community 102`, `Community 126`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 0` to `Community 128`, `Community 1`, `Community 2`, `Community 132`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 137`, `Community 139`, `Community 14`, `Community 15`, `Community 16`, `Community 20`, `Community 22`, `Community 23`, `Community 25`, `Community 27`, `Community 29`, `Community 31`, `Community 34`, `Community 36`, `Community 38`, `Community 39`, `Community 40`, `Community 42`, `Community 43`, `Community 46`, `Community 47`, `Community 49`, `Community 53`, `Community 54`, `Community 56`, `Community 59`, `Community 62`, `Community 190`, `Community 65`, `Community 69`, `Community 70`, `Community 71`, `Community 74`, `Community 76`, `Community 83`, `Community 84`, `Community 86`, `Community 104`, `Community 110`, `Community 117`, `Community 118`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Are the 308 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 308 INFERRED edges - model-reasoned connections that need verification._
