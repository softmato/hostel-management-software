# Graph Report - hostel-management-software  (2026-08-19)

## Corpus Check
- 1426 files · ~2,291,297 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11278 nodes · 29363 edges · 446 communities (427 shown, 19 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 413 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 507 edges
2. `successResponse()` - 494 edges
3. `connectToDatabase()` - 334 edges
4. `cn()` - 238 edges
5. `useAppTheme()` - 216 edges
6. `connectToDatabase()` - 216 edges
7. `requireHostelCapability()` - 158 edges
8. `browserApi()` - 117 edges
9. `requireHostelStaffPrincipal()` - 116 edges
10. `unwrap()` - 106 edges
...
## Communities (446 total, 19 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (204): Scanner(), GuardianInviteScreen(), Choice, Compass(), MapButton(), MapScreen(), ModeTab(), NOTHING_CHOSEN (+196 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (213): POST(), POST(), GET(), GET(), POST(), addHostelAdminProfilePhoto(), deleteHostelAdminProfilePhoto(), getHostelAdminProfile() (+205 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (114): ICONS, LABELS, TONES, loadOverview(), Overview, PORTAL_ROWS, Person, ProfileScreen() (+106 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (113): DeletionPathway, DeletionStatus, PATHWAY_COPY, Filter, ModeratedPost, ModerationPayload, DemoDataBadge(), Message() (+105 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (152): BootGate(), RootShell(), GuardianLoginScreen(), AttachmentGallery(), BrandSplash(), AuthDivider(), GoogleSignInButton(), UploadToaster() (+144 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (107): POST(), recordConsent(), attendanceListQuerySchema, attendanceOverrideSchema, consentSchema, locationPingSchema, objectIdSchema, POST() (+99 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (120): CommunityReportDialog(), REASONS, ConfirmOptions, Resolver, Notification, MonthPicker, PeriodRow, humanizeValue() (+112 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (102): PATCH(), POST(), RouteContext, GET(), POST(), POST(), POST(), POST() (+94 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (111): GET(), POST(), querySchema, RouteContext, authorUserId, mocks, postId, residentId (+103 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (97): FeeSchedule, Rate, PRIORITIES, STATUS_ACTIONS, CATEGORIES, Campaign, Resident, AttendanceAnalytics (+89 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (115): deleteResidentLocationHistory(), getResidentAttendance(), listAttendanceAlerts(), demoteToPublicAccount(), listResidentComplaints(), listFoodForResident(), submitFoodFeedback(), uploadFoodPhoto() (+107 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (101): notifyAdminsOfNewComplaint(), notifyResidentOfComplaintReply(), notifyResidentOfComplaintStatus(), OPEN_STATUSES, OverdueComplaint, runComplaintSlaCheck(), hostelId, mocks (+93 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (82): EMPTY_SUMMARY, HostelAdminComplaintsPage, addDays(), COOK_PORTAL_DEFAULTS, CookPortalSettings, DayOfWeek, DAYS, FoodRoutine (+74 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (80): BusyContext, BusyForm(), BusyFormProps, SubmitButton(), CancelDeletionPageContent(), CommunityModerationPanel(), useConfirm(), field() (+72 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (63): GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, ROUTINE_DAYS, ROUTINE_MEALS, hasFood() (+55 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (72): GET(), POST(), GET(), GET(), attendanceSettingsSchema, GET(), DELETE(), POST() (+64 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (73): csvField(), deferLoad(), field(), Hostel, HostelTable(), Inquiry, LoadState, numberField() (+65 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (71): adminPrincipal, mocks, PLATFORM_LIMITS, hostelId, invoice, invoiceId, mocks, principal (+63 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (61): GuardianDashboard, CreateWardenResult, HostelAdminWardensPage, PERMISSION_LABELS, EmptyInline(), InitialsAvatar(), MetricCard(), PortalPageHeader() (+53 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (59): PATCH(), RouteContext, POST(), RouteContext, GET(), PATCH(), RouteContext, requireHostelStaffPrincipal() (+51 more)

### Community 20 - "Community 20"
Cohesion: 0.06
Nodes (69): CommunityScreen(), Composer(), CommunityBoard(), CommunityBoardProps, Composer(), SORTS, CommentThread(), CommunityPostCard() (+61 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (60): summarizeResidentComplaints(), CachedConnection, globalForMongoose, bedSchema, depositRefundSchema, emergencyContactSchema, moveInChecklistSchema, moveOutChecklistSchema (+52 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (55): metadata, AccountDeletionPanel, ContentHeader(), ContentIntro(), ContentNote(), ContentSectionIcon(), ContentSections(), LinkedEmails() (+47 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (67): POST(), PaginationMeta, PaginationQuery, querySchema, deviceTokenSchema, notificationSchema, notificationCampaignSchema, input (+59 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (64): IdCardFace(), initialsOf(), Portrait(), Point(), BLOOD_OPTIONS, DIET_OPTIONS, EditIdentityScreen(), GENDER_OPTIONS (+56 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (60): UploadCard(), useIsUploading(), ApiFailure, EXTENSION_MIME, PickedFile, resolveFileName(), resolveMimeType(), name (+52 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (53): GET(), resolvePastedLink(), searchCandidates(), geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), hostelAdminGeocodeQuerySchema (+45 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (56): POST(), acceptGuardianInvitation(), daysFromNow(), enabledPermissionLabels(), GuardianAccessRecord, GuardianInvitationAcceptInput, GuardianInviteInput, GuardianPermissionFlags (+48 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (63): AdminMoreScreen(), AdminResidentsScreen(), ActivateScreen(), NightStatusScreen(), FILTERS, NotificationCard(), NotificationsScreen(), ApplyBlock() (+55 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (50): APP_ANSWERS, buildContactMethods(), ContactMethod, ContactScreen(), FaqRow(), MethodCard(), DocumentScreen(), MobileLegal (+42 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (55): DAY_LABELS, FoodRoutineWeek(), MEAL_ICONS, MealCard(), MonthEndSpecial(), RoutineMeal, Footer(), CookTodayScreen() (+47 more)
...
Cohesion: 0.05
Nodes (53): GATEWAY_ORDER, InvoiceRecord, methodsFrom(), PayInstructions, PayMethod, qrNotice(), assertQrAssetUsable(), EMPTY (+45 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (53): getResidentFinanceView(), InvoiceMatrix, InvoiceMatrixRow, listResidentClaims(), PortalInvoice, ResidentFinanceView, ResidentInvoiceLine, ResidentInvoiceReceipt (+45 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (42): AuthShell(), AuthShellProps, SiteWordmark(), GoogleAuthButton(), GoogleAuthButtonProps, GoogleAuthResponse, GoogleAuthUser, GoogleCredentialResponse (+34 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (45): LedgerCard(), methodIcon(), methodLabel(), PayInvoiceScreen(), PROVIDER_LABEL, QrPanel(), HandoffPlan, isCheckoutFinished() (+37 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (48): auditFinanceAction(), approveCashPayment(), cashThresholdFor(), RecordCashInput, recordCashPayment(), RecordCashResult, afterReversal, checker (+40 more)
...
Cohesion: 0.07
Nodes (52): arrangeProof(), leanResult(), mocks, paymentId, residentAId, residentBId, staffPrincipal, alreadyReviewedError() (+44 more)

### Community 42 - "Community 42"
Cohesion: 0.14
Nodes (30): accountDeletionCancelledEmail(), accountDeletionRequestedEmail(), idCardIssuedEmail(), accountUpgradedEmail(), verificationEmail(), guardianInvitationEmail(), cookPortalEnabledEmail(), hostelDocumentsRequestedEmail() (+22 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (35): AuthGuard(), cityOptions, createDocument(), createRoom(), DocumentConfig, DraftData, FACILITY_MINI, facilityOptions (+27 more)
...
Cohesion: 0.06
Nodes (43): CLAIMABLE_STATUSES, dispatchOtpChallenge(), findVerifiedRegistrationChallenge(), generateOtpCode(), GOOGLE_JWKS, hashOtpCode(), normalizeEmail(), normalizeOtpIdentifier() (+35 more)

### Community 47 - "Community 47"
Cohesion: 0.07
Nodes (42): collectionTotals(), invoicesByIds(), getHostelViewStats(), foodFeedbackSchema, listingFlagSchema, maintenanceRequestSchema, paymentProofSchema, ratingReviewSchema (+34 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (41): CapacityError, claimBedForRoomType(), listAvailableRoomTypes(), loadConfigurations(), moveBedBetweenRoomTypes(), refreshCapacitySummary(), releaseBedForRoomType(), RoomConfiguration (+33 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (41): ApiPrincipal, qrActivationSchema, residentSchema, sponsorSchema, ActivationCodeGenerateInput, ActivationCodeInput, activationSecret(), ActivationServiceError (+33 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (37): FinanceAuditInput, financeIntegrityHash(), previousEntryHash(), runGatewayHealthForHostel(), computeCreditAmount(), invoiceBalanceSchema, findingSchema, reconciliationRunSchema (+29 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (36): HostelAdminWorkspaceLayout(), HostelAdminWorkspaceLayoutProps, PortalShell(), navItems, navItems, canAccessWorkspace(), defaultWorkspaceSlug(), isAuthBypassed() (+28 more)

### Community 52 - "Community 52"
Cohesion: 0.06
Nodes (23): LegacyHostelAdminAttendancePage(), LegacyHostelAdminCommunityPage(), LegacyHostelAdminComplaintsPage(), HostelAdminMoveChecklistPage(), HostelAdminNightStatusPage(), HostelAdminSOSAlertsPage(), HostelAdminComplaintsPage(), HostelAdminNoticesPage() (+15 more)
...
Cohesion: 0.06
Nodes (33): AuditLogRecord, PlatformAuditLogQuery, RefRecord, mocks, addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery (+25 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (35): assertHostelAccess(), canAccessHostel(), hostelScopedFilter(), TenantAccessError, TenantPrincipal, foodReadyLogSchema, noticeSchema, noticeReadStatusSchema (+27 more)
...
Cohesion: 0.07
Nodes (37): DeletionPanel(), NotificationSettings(), SETTINGS_TITLES, THEME_OPTIONS, DeletionRequest, DeletionStatus, getDeletionStatus(), requestAccountDeletion() (+29 more)

### Community 58 - "Community 58"
Cohesion: 0.07
Nodes (36): GET(), POST(), requireSuperadminPrincipal(), resetEmailIdentityCache(), GET(), PUT(), PUT(), RouteContext (+28 more)

### Community 59 - "Community 59"
Cohesion: 0.06
Nodes (37): referralSchema, referralCodeSchema, referralRewardSchema, activeCode, codeId, hostelId, joinedResidentId, mocks (+29 more)

### Community 60 - "Community 60"
Cohesion: 0.06
Nodes (36): buildFormPostHandoff(), FormPostHandoff, HandoffError, IntentRecord, formPostIntent, hostelId, intentId, invoiceId (+28 more)
...
Cohesion: 0.06
Nodes (32): metadata, CommunityPageContent(), FeedPayload, SidebarPayload, Space, SpacesPayload, Avatar(), AVATAR_TONES (+24 more)

### Community 63 - "Community 63"
Cohesion: 0.07
Nodes (37): absenceStreak(), ABSENT_ZONES, runAttendanceMaintenance(), SettingsRecord, ATTENDANCE_DEFAULTS, AttendanceAlertResolveInput, AttendanceConfig, AttendanceListQuery (+29 more)
...
Cohesion: 0.06
Nodes (28): currency(), Panel(), Select(), ResidentActivationPageContent, ResidentComplaintsPageContent, ResidentFoodPageContent, ResidentNoticesPageContent, ResidentPaymentsPageContent (+20 more)

### Community 66 - "Community 66"
Cohesion: 0.09
Nodes (39): renderIdCardPng(), userResidentProfileSchema, LEGACY_ROLE_MAP, Role, ROLE_VALUES, CARD_LABELS, formatIssuedOn(), readPhotoBytes() (+31 more)
...
Cohesion: 0.07
Nodes (21): GET(), RouteContext, POST(), RouteContext, RouteContext, GET(), RouteContext, emergencyContactCreateSchema (+13 more)

### Community 70 - "Community 70"
Cohesion: 0.08
Nodes (40): directionFlags(), evidenceFlags(), payeeFlags(), AMOUNT_LABELS, canonical(), canonicalDigits(), containsWithTolerance(), DIGIT_CONFUSABLES (+32 more)

### Community 71 - "Community 71"
Cohesion: 0.08
Nodes (36): serviceProviderApplicationSchema, serviceProviderDocumentSchema, ACTIVE_APPLICATION_STATUSES, approveServiceProvider(), auditProviderAction(), findOwnProvider(), findProviderOrThrow(), getOwnServiceProviderApplication() (+28 more)
...
Cohesion: 0.08
Nodes (34): ComplaintDetail(), ComplaintCard(), NewComplaintScreen(), PickedAttachment, ACTOR_LABELS, actorLabel(), Complaint, COMPLAINT_CATEGORIES (+26 more)
...
Cohesion: 0.07
Nodes (36): AMOUNT_ALIASES, CREDIT_ALIASES, readMoney(), DATE_ALIASES, DEBIT_ALIASES, NAME_ALIASES, nonZero(), readMoney() (+28 more)

### Community 77 - "Community 77"
Cohesion: 0.07
Nodes (29): AdminAlertsScreen(), AdminOverviewScreen(), alertCounts(), AlertKind, AlertRow, buildAlertFeed(), occupancyRate(), empty (+21 more)

### Community 78 - "Community 78"
Cohesion: 0.1
Nodes (30): NightStatusForm(), ReviewForm(), ReviewScreen(), isCurrentNight(), isSelfReportable(), NIGHT_STATUS_OPTIONS, nightKey(), nightNote() (+22 more)

### Community 79 - "Community 79"
Cohesion: 0.09
Nodes (32): BANK_CSV_PARSER, peekHeaders(), BANK, both, empty, ESEWA, [first], ids (+24 more)
...
Cohesion: 0.08
Nodes (31): countInvoicesByField(), countInvoicesByStatus(), fromLedgerRow(), latestInvoicePerResident(), LEDGER_UNSETTLED_STATUSES, ledgerFilterFor(), LedgerInvoiceRow, ledgerPipeline() (+23 more)
...
Cohesion: 0.1
Nodes (28): BALANCE_ALIASES, BANK_MARKERS, DATE_ALIASES, DEPOSIT_ALIASES, NARRATION_ALIASES, TXN_ID_ALIASES, WITHDRAWAL_ALIASES, CsvTable (+20 more)
...
Cohesion: 0.2
Nodes (21): POST(), authenticateWithGoogle(), AuthServiceError, logout(), POST(), loginGuardian(), accessTokenTtlSeconds(), parseDurationSeconds() (+13 more)

### Community 86 - "Community 86"
Cohesion: 0.11
Nodes (31): DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, EmailIdentity, EmailIdentityResolver, envEmailDomain(), fallbackEmailIdentity(), fromHeaderFor() (+23 more)
...
Cohesion: 0.09
Nodes (26): attacker, attempt(), headers, jsonRequest(), routeMocks, resetPasswordWithToken(), revokeAllSessions(), verifyEmailWithToken() (+18 more)
...
Cohesion: 0.09
Nodes (26): progressCaption(), secondsLabel(), Toast, TOAST_TONE, Toaster(), UploadRow, UploadStack(), useIsHydrated() (+18 more)
...
Cohesion: 0.16
Nodes (23): r2Configured(), storePublicAsset(), AccessLevel, bucketForAccessLevel(), deleteFromR2(), generateFileKey(), getPresignedUploadUrl(), getR2Client() (+15 more)
...
Cohesion: 0.07
Nodes (21): Complaint, ComplaintSummary, field(), FoodMenu, HostelAdminFoodPage(), HostelAdminPaymentsPage(), HostelAdminResidentsPage(), LoadState (+13 more)

### Community 101 - "Community 101"
Cohesion: 0.1
Nodes (16): TABS, TABS, AvatarTabIcon(), RoleTabs(), TabDef, ColorScheme, radius, roleAccent (+8 more)
...
Cohesion: 0.08
Nodes (26): dayOfWeekFor(), EMPTY_ROUTINE, FoodRoutine, FoodRoutineRecord, FoodRoutineSaveInput, getFoodRoutinesByHostelId(), isMonthEnd(), mealsOn() (+18 more)
...
Cohesion: 0.09
Nodes (25): CurrentUser, DASHBOARD_ROLES, dashboardHrefForRole(), hasDashboard(), MeResponse, moreItems, navItems, providerNavItems (+17 more)

### Community 106 - "Community 106"
Cohesion: 0.11
Nodes (22): getOwnProvider(), listProviderJobs(), ProviderApplication, ProviderJob, ProviderJobStatus, updateProviderJobStatus(), CATEGORY_ICONS, completedJobCount() (+14 more)
...
Cohesion: 0.12
Nodes (21): POST(), RouteContext, computePerceptualHash(), hammingDistance(), isPerceptualNearDuplicate(), prepare(), systemDocumentKind(), systemDocumentKindFromText() (+13 more)
...
Cohesion: 0.11
Nodes (20): HostelPhotoReminder(), formatHostelAddress(), hostelTypeToUi(), mapPublicHostelToSummary(), CATEGORY_LABELS, NEARBY_GROUPS, PublicHostelDetailPage(), PublicReview (+12 more)
...
Cohesion: 0.16
Nodes (24): changePassword(), getCurrentUser(), issueSessionForUser(), login(), publicUser(), refreshAccessToken(), POST(), AuthTokenPayload (+16 more)

### Community 114 - "Community 114"
Cohesion: 0.07
Nodes (26): CONTENT_ICON_SLUGS, everything, IDENTITY, page, rendered, announcementSchema, contentHighlightSchema, ContentPage (+18 more)
...
Cohesion: 0.12
Nodes (22): uploadPublicFile(), FILE_ASSET_KINDS, FileAssetKind, FINANCIAL_KINDS, isFileAssetKind(), isFinancialAssetKind(), ApiEnvelope, parseEnvelope() (+14 more)

### Community 118 - "Community 118"
Cohesion: 0.11
Nodes (20): chelseaMarket, geistMono, geistSans, generateMetadata(), metadata, poppins, RootLayout(), robots() (+12 more)
...
Cohesion: 0.11
Nodes (22): digitsOnly(), extractPayee(), HostelPayeeIdentity, matchesIdentity(), NAME_STOPWORDS, nameTokens(), PayeeRead, payeeRefusal() (+14 more)
...
Cohesion: 0.1
Nodes (25): Attendance / Night Safety, Build status (end of Phase 3), Build status (end of Phase 5 — verified 2026-08-02), code:typescript (export enum Role {), code:typescript (interface IQRActivation {), code:typescript (interface INightStatusLog {), code:typescript (interface IFoodRoutine {), code:typescript (interface IFoodPhoto {) (+17 more)
...
Cohesion: 0.11
Nodes (16): attendanceAlertResolveSchema, paginationQuerySchema, listingFlagListQuerySchema, listingFlagResolveSchema, GET(), PATCH(), resolveSchema, RouteContext (+8 more)
...
Cohesion: 0.1
Nodes (15): accountDeletionRequestSchema, communityCommentSchema, communityMediaSchema, communityPostSchema, consentLogSchema, questionCallClickSchema, purgeAccount(), runAccountDeletionPurge() (+7 more)
...
Cohesion: 0.16
Nodes (15): platformSettingSchema, DEFAULT_SITE_CONFIG, coerceSection(), getPublicSiteConfig(), getSiteConfig(), PlatformSettingRecord, PublicSiteConfig, SiteConfigServiceError (+7 more)
...
Cohesion: 0.15
Nodes (17): POST(), safeEqual(), ClickRecord, dayKey(), getQuestionCallAnalytics(), QuestionCallAnalyticsQuery, questionCallBaseUrl(), QuestionCallClickInput (+9 more)
...
Cohesion: 0.1
Nodes (20): 1. Blockers — the app is broken in production until these are done, 2. M6 — finish public discovery, 3. M1–M5 — the open items that are code, not a device pass, 4. UI defects from the audit, 5. Screen-by-screen UI pass, 6. Device pass — [device], after everything above, 7. Found along the way, 8. Partner & programme screens — owner report of 2026-08-19 (+12 more)
...
Cohesion: 0.17
Nodes (18): maneuverIcon(), NavCard(), Guidance, GuidanceStatus, CARDINALS, directionWord(), distanceToPath(), formatManeuverDistance() (+10 more)
...
Cohesion: 0.15
Nodes (13): AuthSession, getResidentProfile(), login(), AppNavigator(), RootStackParamList, Stack, LoginScreen(), Props (+5 more)
...
Cohesion: 0.27
Nodes (12): assertWholeRupees(), formatNPR(), isWholeRupees(), prorate(), roundToRupee(), splitAmount(), sumAmounts(), credit (+4 more)
...
Cohesion: 0.19
Nodes (12): documents, hostelForm(), many, parsed, result, emptyHostelForm(), emptyRoomRow(), form() (+4 more)
...
Cohesion: 0.23
Nodes (7): paymentClearedEmail(), paymentDueReminderEmail(), paymentRejectedEmail(), paymentReversedEmail(), paymentProofReceivedEmail(), paymentProofUploadedEmail(), monthName()
...
Cohesion: 0.31
Nodes (8): SosScreen(), count(), describeFanout(), SosFanoutTone, sosMessagePayload(), fanout(), outcome, validateSosMessage()
...
Cohesion: 0.24
Nodes (10): 3.1 Payment Due Reminder, 3.2 Payment Overdue, 3.4 Payment Verified (to Resident), 3.5 Payment Rejected (to Resident), 3. Payment Emails, code:typescript ({), code:typescript ({), code:typescript ({) (+2 more)
...
Cohesion: 0.24
Nodes (7): activateResident(), Props, ResidentActivationScreen(), styles, Props, ResidentReviewsScreen(), screenStyles
...
Cohesion: 0.22
Nodes (9): 7.1 Attendance Alert (Resident Absent), 7.1 New Hostel Pending Approval (to Superadmin), 7. Attendance & Location Tracking Emails, 8.1 Community Post Engagement (Batched), 8. Community & Notification Emails, code:typescript ({), code:typescript ({), code:typescript ({) (+1 more)
...
Cohesion: 0.4
Nodes (4): BADGE_TONES, BadgeTone, STATUS_TONES, statusTone()
...
## Knowledge Gaps
- **4112 isolated node(s):** `{ defineConfig }`, `expoConfig`, `path`, `{ getDefaultConfig }`, `{ withNativeWind }` (+4107 more)
...
- **Why does `Button()` connect `Community 2` to `Community 0`, `Community 3`, `Community 4`, `Community 6`, `Community 9`, `Community 12`, `Community 13`, `Community 16`, `Community 18`, `Community 22`, `Community 24`, `Community 28`, `Community 29`, `Community 30`, `Community 38`, `Community 57`, `Community 73`, `Community 78`, `Community 216`, `Community 106`?**
  _High betweenness centrality (0.115) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 6` to `Community 129`, `Community 2`, `Community 3`, `Community 9`, `Community 12`, `Community 13`, `Community 14`, `Community 16`, `Community 18`, `Community 20`, `Community 22`, `Community 31`, `Community 33`, `Community 37`, `Community 43`, `Community 44`, `Community 171`, `Community 51`, `Community 62`, `Community 64`, `Community 65`, `Community 84`, `Community 95`, `Community 100`, `Community 229`, `Community 105`, `Community 110`, `Community 115`, `Community 123`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `Role` connect `Community 17` to `Community 128`, `Community 257`, `Community 1`, `Community 3`, `Community 5`, `Community 7`, `Community 8`, `Community 11`, `Community 15`, `Community 19`, `Community 21`, `Community 155`, `Community 27`, `Community 288`, `Community 36`, `Community 37`, `Community 39`, `Community 41`, `Community 46`, `Community 48`, `Community 49`, `Community 51`, `Community 53`, `Community 310`, `Community 55`, `Community 183`, `Community 58`, `Community 190`, `Community 63`, `Community 324`, `Community 69`, `Community 75`, `Community 219`, `Community 93`, `Community 98`, `Community 103`, `Community 104`, `Community 105`, `Community 109`, `Community 113`, `Community 115`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Are the 329 inferred relationships involving `connectToDatabase()` (e.g. with `loadPopularHostels()` and `POST()`) actually correct?**
  _`connectToDatabase()` has 329 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `{ defineConfig }`, `expoConfig`, `path` to the rest of the system?**
  _4112 weakly-connected nodes found - possible documentation gaps or missing edges._
